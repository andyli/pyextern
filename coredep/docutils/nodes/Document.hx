...
@:pythonImport("docutils.nodes", "document") extern class Document {
	...
	**/
	@:native("__init__")
	public function ___init__(settings:Dynamic, reporter:Dynamic, ?args:python.VarArgs<Dynamic>, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(settings:Dynamic, reporter:Dynamic, ?args:python.VarArgs<Dynamic>, ?kwargs:python.KwArgs<Dynamic>):Void;
	/**
	...
	**/
	...
	public function get_decoration():Dynamic;
	/**
	...
	**/
	...
	public function has_name(name:Dynamic):Dynamic;
	...
	**/
	...
	public function note_anonymous_target(target:Dynamic):Dynamic;
	public function note_autofootnote(footnote:Dynamic):Dynamic;
	public function note_autofootnote_ref(ref:Dynamic):Dynamic;
	public function note_citation(citation:Dynamic):Dynamic;
	public function note_citation_ref(ref:Dynamic):Dynamic;
	public function note_explicit_target(target:Dynamic, ?msgnode:Dynamic):Dynamic;
	public function note_footnote(footnote:Dynamic):Dynamic;
	public function note_footnote_ref(ref:Dynamic):Dynamic;
	public function note_implicit_target(target:Dynamic, ?msgnode:Dynamic):Dynamic;
	public function note_indirect_target(target:Dynamic):Dynamic;
	public function note_parse_message(message:Dynamic):Dynamic;
	public function note_pending(pending:Dynamic, ?priority:Dynamic):Dynamic;
	/**
		Note that this Element has been referenced by its name
		`name` or id `id`.
	**/
	public function note_referenced_by(?name:Dynamic, ?id:Dynamic):Dynamic;
	public function note_refid(node:Dynamic):Dynamic;
	public function note_refname(node:Dynamic):Dynamic;
	public function note_source(source:Dynamic, offset:Dynamic):Dynamic;
	public function note_substitution_def(subdef:Dynamic, def_name:Dynamic, ?msgnode:Dynamic):Dynamic;
	public function note_substitution_ref(subref:Dynamic, refname:Dynamic):Dynamic;
	public function note_symbol_footnote(footnote:Dynamic):Dynamic;
	public function note_symbol_footnote_ref(ref:Dynamic):Dynamic;
	public function note_transform_message(message:Dynamic):Dynamic;
	...
	**/
	...
	public function set_duplicate_name_id(node:Dynamic, id:Dynamic, name:Dynamic, msgnode:Dynamic, explicit:Dynamic):Dynamic;
	public function set_id(node:Dynamic, ?msgnode:Dynamic, ?suggested_prefix:Dynamic):Dynamic;
	/**
	...
	**/
	public function set_name_id_map(node:Dynamic, id:Dynamic, ?msgnode:Dynamic, ?explicit:Dynamic):Dynamic;
