...
@:pythonImport("docutils.nodes", "system_message") extern class System_message {
	...
	**/
	@:native("__init__")
	public function ___init__(?message:Dynamic, ?children:python.VarArgs<Dynamic>, ?attributes:python.KwArgs<Dynamic>):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(?message:Dynamic, ?children:python.VarArgs<Dynamic>, ?attributes:python.KwArgs<Dynamic>):Void;
	/**
