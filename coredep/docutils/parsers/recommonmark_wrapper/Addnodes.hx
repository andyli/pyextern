...
package docutils.parsers.recommonmark_wrapper;
@:pythonImport("docutils.parsers.recommonmark_wrapper", "addnodes") extern class Addnodes {
	...
	**/
	@:native("__init__")
	public function ___init__(transform:Dynamic, ?details:Dynamic, ?rawsource:Dynamic, ?children:python.VarArgs<Dynamic>, ?attributes:python.KwArgs<Dynamic>):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(transform:Dynamic, ?details:Dynamic, ?rawsource:Dynamic, ?children:python.VarArgs<Dynamic>, ?attributes:python.KwArgs<Dynamic>):Void;
	/**
