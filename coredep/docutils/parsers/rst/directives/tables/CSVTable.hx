...
@:pythonImport("docutils.parsers.rst.directives.tables", "CSVTable") extern class CSVTable {
	/**
		CSV dialect for `csv_table` directive.
	**/
	static public function DocutilsDialect(options:Dynamic):Dynamic;
	/**
		CSV dialect to use for the "header" option data.
	**/
	static public function HeaderDialect():Dynamic;
	...
	**/
	...
	public function check_requirements():Dynamic;
	...
	static public function decode_from_csv(s:Dynamic):Dynamic;
	/**
	...
	**/
	...
	static public function encode_for_csv(s:Dynamic):Dynamic;
	public function error(message:Dynamic):Dynamic;
	public function extend_short_rows_with_empty_cells(columns:Dynamic, parts:Dynamic):Dynamic;
	static public var final_argument_whitespace : Dynamic;
	public function get_column_widths(n_cols:Dynamic):Dynamic;
	/**
		Get CSV data from the directive content, from an external
		file, or from a URL reference.
	**/
	public function get_csv_data():Dynamic;
	static public var has_content : Dynamic;
	public function info(message:Dynamic):Dynamic;
	public function make_title():Dynamic;
	static public var option_spec : Dynamic;
	static public var optional_arguments : Dynamic;
	public function parse_csv_data_into_rows(csv_data:Dynamic, dialect:Dynamic, source:Dynamic):Dynamic;
	public function process_header_option():Dynamic;
	static public var required_arguments : Dynamic;
	public function run():Dynamic;
	public function set_table_width(table_node:Dynamic):Dynamic;
