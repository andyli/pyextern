...
package docutils.parsers.rst.directives.html;
@:pythonImport("docutils.parsers.rst.directives.html", "MetaBody") extern class MetaBody {
	...
	**/
	static public function meta(?rawsource:Dynamic, ?children:python.VarArgs<Dynamic>, ?attributes:python.KwArgs<Dynamic>):Dynamic;
	...
	**/
	...
	public function parsemeta(match:Dynamic):Dynamic;
