...
@:pythonImport("docutils.parsers.rst.states", "SubstitutionDef") extern class SubstitutionDef {
	...
	**/
	...
	public function embedded_directive(match:Dynamic, context:Dynamic, next_state:Dynamic):Dynamic;
	@:native("enum")
