...
@:pythonImport("docutils.parsers.rst.states", "Line") extern class Line {
	...
	**/
	...
	static public var eofcheck : Dynamic;
	/**
	...
	**/
	...
	public function short_overline(context:Dynamic, blocktext:Dynamic, lineno:Dynamic, ?lines:Dynamic):Dynamic;
	public function state_correction(context:Dynamic, ?lines:Dynamic):Dynamic;
	/**
