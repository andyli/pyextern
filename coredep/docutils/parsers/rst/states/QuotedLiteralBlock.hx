...
@:pythonImport("docutils.parsers.rst.states", "QuotedLiteralBlock") extern class QuotedLiteralBlock {
	...
	**/
	public function initial_quoted(match:Dynamic, context:Dynamic, next_state:Dynamic):Dynamic;
	...
	**/
	public function quoted(match:Dynamic, context:Dynamic, next_state:Dynamic):Dynamic;
	/**
