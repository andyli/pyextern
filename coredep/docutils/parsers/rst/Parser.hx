...
@:pythonImport("docutils.parsers.rst", "Parser") extern class Parser {
	...
	**/
	@:native("__init__")
	public function ___init__(?rfc2822:Dynamic, ?inliner:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(?rfc2822:Dynamic, ?inliner:Dynamic):Void;
	/**
	...
	**/
	public function finish_parse():Dynamic;
	/**
	...
	**/
	public function parse(inputstring:Dynamic, document:Dynamic):Dynamic;
	...
	**/
	public function setup_parse(inputstring:Dynamic, document:Dynamic):Dynamic;
