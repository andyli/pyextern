...
package docutils;
@:pythonImport("docutils", "VersionInfo") extern class VersionInfo {
	/**
		Return self+value.
	**/
	...
	**/
	static public function __new__(cls:Dynamic, ?major:Dynamic, ?minor:Dynamic, ?micro:Dynamic, ?releaselevel:Dynamic, ?serial:Dynamic, ?release:Dynamic):Dynamic;
	/**
		Helper for pickle.
	**/
