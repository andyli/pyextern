...
package docutils.writers.manpage;
@:pythonImport("docutils.writers.manpage", "Translator") extern class Translator {
	...
	**/
	public function append_header():Dynamic;
	/**
	...
	**/
	public function comment(text:Dynamic):Dynamic;
	/**
		Return commented version of the passed text WITHOUT end of
		line/comment.
	**/
	public function comment_begin(text:Dynamic):Dynamic;
	public function dedent():Dynamic;
	...
	public function deunicode(text:Dynamic):Dynamic;
	/**
	...
	**/
	...
	static public var document_start : Dynamic;
	/**
		Ensure the last line in body is terminated by new line.
	**/
	public function ensure_eol():Dynamic;
	public function first_child(node:Dynamic):Dynamic;
	public function footnote_backrefs(node:Dynamic):Dynamic;
	public function header():Dynamic;
	public function indent(?by:Dynamic):Dynamic;
	public function list_end():Dynamic;
	public function list_start(node:Dynamic):Dynamic;
	static public var optional : Dynamic;
	static public var possibly_a_roff_command : Dynamic;
	...
	**/
	...
	public function visit_admonition(node:Dynamic, ?name:Dynamic):Dynamic;
