...
@:pythonImport("docutils.writers.latex2e", "DocumentClass") extern class DocumentClass {
	...
	**/
	@:native("__init__")
	public function ___init__(document_class:Dynamic, ?with_part:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(document_class:Dynamic, ?with_part:Dynamic):Void;
	/**
	...
	**/
	public function latex_section_depth(depth:Dynamic):Dynamic;
	/**
	...
	**/
	public function section(level:Dynamic):Dynamic;
}