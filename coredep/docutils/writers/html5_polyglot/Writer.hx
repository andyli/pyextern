...
package docutils.writers.html5_polyglot;
@:pythonImport("docutils.writers.html5_polyglot", "Writer") extern class Writer {
	...
	**/
	...
	public function apply_template():Dynamic;
	/**
	...
	**/
	...
	public function interpolation_dict():Dynamic;
