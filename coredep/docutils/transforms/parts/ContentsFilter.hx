...
@:pythonImport("docutils.transforms.parts", "ContentsFilter") extern class ContentsFilter {
	...
	**/
	...
	public function get_entry_text():Dynamic;
	public function get_tree_copy():Dynamic;
	public function ignore_node_but_process_children(node:Dynamic):Dynamic;
