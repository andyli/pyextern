...
@:pythonImport("docutils.transforms.parts", "SectNum") extern class SectNum {
	...
	**/
	...
	public function update_section_numbers(node:Dynamic, ?prefix:Dynamic, ?depth:Dynamic):Dynamic;
}