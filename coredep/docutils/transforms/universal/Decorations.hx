...
@:pythonImport("docutils.transforms.universal", "Decorations") extern class Decorations {
	...
	**/
	...
	public function generate_footer():Dynamic;
	public function generate_header():Dynamic;
}