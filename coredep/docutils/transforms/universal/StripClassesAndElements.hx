...
@:pythonImport("docutils.transforms.universal", "StripClassesAndElements") extern class StripClassesAndElements {
	...
	**/
	...
	public function check_classes(node:Dynamic):Dynamic;
