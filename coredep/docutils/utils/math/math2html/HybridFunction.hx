...
@:pythonImport("docutils.utils.math.math2html", "HybridFunction") extern class HybridFunction {
	...
	**/
	public function computehybridsize():Dynamic;
	/**
	...
	**/
	public function getliteralvalue(name:Dynamic):Dynamic;
	/**
		Get a parameter as parsed.
	**/
	public function getparam(name:Dynamic):Dynamic;
	/**
	...
	**/
	public function paramdefs(readtemplate:Dynamic):Dynamic;
	...
	**/
	public function readparams(readtemplate:Dynamic, pos:Dynamic):Dynamic;
	/**
		Get the tag corresponding to the given index. Does parameter substitution.
	**/
	public function readtag(pos:Dynamic):Dynamic;
	/**
	...
	**/
	public function writebracket(direction:Dynamic, character:Dynamic):Dynamic;
	/**
		Write a single function f0,...,fn.
	**/
	public function writefunction(pos:Dynamic):Dynamic;
	/**
		Write a single param of the form $0, $x...
	**/
	public function writeparam(pos:Dynamic):Dynamic;
	/**
		Write all params according to the template
	**/
	public function writeparams(writetemplate:Dynamic):Dynamic;
	/**
		Write all params as read in the parse position.
	**/
	public function writepos(pos:Dynamic):Dynamic;
}