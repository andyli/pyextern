...
@:pythonImport("docutils.utils.math.math2html", "TaggedBit") extern class TaggedBit {
	...
	**/
	...
	/**
		Set the constant and the tag
	**/
	public function constant(constant:Dynamic, tag:Dynamic):Dynamic;
	/**
	...
	**/
	public function selfcomplete(tag:Dynamic):Dynamic;
	/**
