...
@:pythonImport("docutils.utils.math.math2html", "FormulaArray") extern class FormulaArray {
	...
	**/
	...
	/**
		Add an empty row.
	**/
	public function addempty():Dynamic;
	/**
		Add a row to the contents and to the list of rows.
	**/
	public function addrow(row:Dynamic):Dynamic;
	...
	**/
	public function iteraterows(pos:Dynamic):Dynamic;
	/**
	...
	**/
	public function parsealignments(pos:Dynamic):Dynamic;
	/**
		Parse the array
	**/
	...
	**/
	public function parserows(pos:Dynamic):Dynamic;
	/**
	...
	**/
	...
	static public var piece : Dynamic;
	/**
		Process contents
	**/
