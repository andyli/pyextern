...
@:pythonImport("docutils.utils.math.math2html", "MacroFunction") extern class MacroFunction {
	...
	**/
	public function addfilter(index:Dynamic, value:Dynamic):Dynamic;
	...
	**/
	public function completemacro(_macro:Dynamic):Dynamic;
	/**
	...
	**/
	public function parsemacroparameter(pos:Dynamic, remaining:Dynamic):Dynamic;
	/**
		Parse a number of mandatory parameters.
	**/
	public function parsemandatory(pos:Dynamic, number:Dynamic):Dynamic;
	/**
		Parse the remaining parameters as a running number.
	**/
	public function parsenumbers(pos:Dynamic, remaining:Dynamic):Dynamic;
	/**
		Parse optional parameters.
	**/
	public function parseoptional(pos:Dynamic, defaults:Dynamic):Dynamic;
	/**
	...
	**/
	public function parseparameters(pos:Dynamic, _macro:Dynamic):Dynamic;
	/**
