...
@:pythonImport("docutils.utils.math.math2html", "MacroDefinition") extern class MacroDefinition {
	...
	**/
	...
	static public var macros : Dynamic;
	...
	**/
	public function parsenewcommand(pos:Dynamic):Dynamic;
	/**
	...
	**/
	public function parseparameters(pos:Dynamic):Dynamic;
	/**
