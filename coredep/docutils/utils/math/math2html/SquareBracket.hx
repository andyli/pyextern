...
@:pythonImport("docutils.utils.math.math2html", "SquareBracket") extern class SquareBracket {
	...
	**/
	...
	static public var ending : Dynamic;
	/**
	...
	**/
	public function innerformula(pos:Dynamic):Dynamic;
	/**
		Parse a literal inside the bracket, which does not generate HTML.
	**/
	public function innerliteral(pos:Dynamic):Dynamic;
	/**
		Parse some text inside the bracket, following textual rules.
	**/
	public function innertext(pos:Dynamic):Dynamic;
	/**
	...
	**/
	public function parsecomplete(pos:Dynamic, innerparser:Dynamic):Dynamic;
	/**
