...
@:pythonImport("docutils.utils.math.latex2mathml", "mstyle") extern class Mstyle {
	...
	**/
	@:native("__init__")
	public function ___init__(?children:Dynamic, ?nchildren:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
		math([children]) -> MathML element
		
		children can be one child or a list of children.
	**/
	public function new(?children:Dynamic, ?nchildren:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Void;
	/**
