...
@:pythonImport("docutils.utils.math.latex2mathml", "MathSchema") extern class MathSchema {
	...
	**/
	@:native("__init__")
	public function ___init__(?children:python.VarArgs<Dynamic>, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
		Set up node with `children` and `attributes`.
	...
	**/
	public function new(?children:python.VarArgs<Dynamic>, ?kwargs:python.KwArgs<Dynamic>):Void;
	/**
