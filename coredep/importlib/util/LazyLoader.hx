...
@:pythonImport("importlib.util", "LazyLoader") extern class LazyLoader {
	static public function _LazyLoader__check_eager_loader(loader:Dynamic):Dynamic;
	...
	**/
	static public function factory(loader:Dynamic):Dynamic;
	/**
