...
@:pythonImport("importlib.metadata", "EntryPoint") extern class EntryPoint {
	/**
		Return self+value.
	**/
	...
	**/
	...
	/**
		Create new instance of EntryPointBase(name, value, group)
	**/
	static public function __new__(_cls:Dynamic, name:Dynamic, value:Dynamic, group:Dynamic):Dynamic;
	/**
		Helper for pickle.
	**/
	...
	**/
	...
	static public function _from_config(config:Dynamic):Dynamic;
	static public function _from_text(text:Dynamic):Dynamic;
	/**
		Make a new EntryPointBase object from a sequence or iterable
	**/
	static public function _make(iterable:Dynamic):Dynamic;
	/**
		Return a new EntryPointBase object replacing specified fields with new values
	**/
	...
	**/
	...
	static public var pattern : Dynamic;
	/**
