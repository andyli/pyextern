...
@:pythonImport("importlib.abc", "FileLoader") extern class FileLoader {
	...
	**/
	...
	public function get_resource_reader(?name:Dynamic, ?args:python.VarArgs<Dynamic>, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
