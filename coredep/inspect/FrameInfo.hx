...
package inspect;
@:pythonImport("inspect", "FrameInfo") extern class FrameInfo {
	/**
		Return self+value.
	**/
	...
	**/
	static public function __new__(_cls:Dynamic, frame:Dynamic, filename:Dynamic, lineno:Dynamic, _function:Dynamic, code_context:Dynamic, index:Dynamic):Dynamic;
	/**
		helper for pickle
	**/
	...
	**/
	static public var code_context : Dynamic;
	/**
