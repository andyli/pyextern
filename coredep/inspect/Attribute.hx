...
package inspect;
@:pythonImport("inspect", "Attribute") extern class Attribute {
	/**
		Return self+value.
	**/
	...
	**/
	static public function __new__(_cls:Dynamic, name:Dynamic, kind:Dynamic, defining_class:Dynamic, object:Dynamic):Dynamic;
	/**
		helper for pickle
	**/
	...
	**/
	static public var defining_class : Dynamic;
	/**
