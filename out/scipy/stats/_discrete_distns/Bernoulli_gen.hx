...
@:pythonImport("scipy.stats._discrete_distns", "bernoulli_gen") extern class Bernoulli_gen {
	/**
	...
	**/
	public function __init__(?a:Dynamic, ?b:Dynamic, ?name:Dynamic, ?badvalue:Dynamic, ?moment_tol:Dynamic, ?values:Dynamic, ?inc:Dynamic, ?longname:Dynamic, ?shapes:Dynamic, ?extradoc:Dynamic, ?seed:Dynamic):Dynamic;
	/**
		Return self<=value.
	**/
	...
	**/
	public function _argcheck(p:Dynamic):Dynamic;
	public function _cdf(x:Dynamic, p:Dynamic):Dynamic;
	...
	**/
	...
	public function _pmf(x:Dynamic, p:Dynamic):Dynamic;
	public function _ppf(q:Dynamic, p:Dynamic):Dynamic;
	public function _rvs(p:Dynamic):Dynamic;
	public function _sf(x:Dynamic, p:Dynamic):Dynamic;
	public function _stats(p:Dynamic):Dynamic;
	/**
