...
@:pythonImport("scipy.stats._discrete_distns", "yulesimon_gen") extern class Yulesimon_gen {
	/**
	...
	**/
	public function _argcheck(alpha:Dynamic):Dynamic;
	public function _argcheck_rvs(?args:python.VarArgs<Dynamic>, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	public function _cdf(x:Dynamic, alpha:Dynamic):Dynamic;
	...
	**/
	...
	public function _logpmf(x:Dynamic, alpha:Dynamic):Dynamic;
	public function _logsf(x:Dynamic, alpha:Dynamic):Dynamic;
	...
	public function _pmf(x:Dynamic, alpha:Dynamic):Dynamic;
	public function _ppf(q:Dynamic, ?args:python.VarArgs<Dynamic>):Dynamic;
	public function _rvs(alpha:Dynamic):Dynamic;
	public function _sf(x:Dynamic, alpha:Dynamic):Dynamic;
	public function _stats(alpha:Dynamic):Dynamic;
