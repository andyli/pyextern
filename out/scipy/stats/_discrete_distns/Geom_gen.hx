...
@:pythonImport("scipy.stats._discrete_distns", "geom_gen") extern class Geom_gen {
	/**
	...
	**/
	...
	public function _logpmf(k:Dynamic, p:Dynamic):Dynamic;
	public function _logsf(x:Dynamic, p:Dynamic):Dynamic;
	public function _munp(n:Dynamic, args:Dynamic):Dynamic;
	public function _nonzero(k:Dynamic, args:Dynamic):Dynamic;
	public function _pmf(k:Dynamic, p:Dynamic):Dynamic;
