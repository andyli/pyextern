...
@:pythonImport("scipy.stats._discrete_distns", "zipf_gen") extern class Zipf_gen {
	/**
	...
	**/
	public function _argcheck(a:Dynamic):Dynamic;
	...
	**/
	...
	public function _munp(n:Dynamic, a:Dynamic):Dynamic;
