...
@:pythonImport("scipy.stats._discrete_distns", "nbinom_gen") extern class Nbinom_gen {
	/**
	...
	**/
	...
	public function _sf_skip(x:Dynamic, n:Dynamic, p:Dynamic):Dynamic;
	public function _stats(n:Dynamic, p:Dynamic):Dynamic;
	/**
