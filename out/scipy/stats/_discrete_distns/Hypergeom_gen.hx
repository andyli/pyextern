...
@:pythonImport("scipy.stats._discrete_distns", "hypergeom_gen") extern class Hypergeom_gen {
	...
	**/
	...
	public function _cdf(x:Dynamic, ?args:python.VarArgs<Dynamic>):Dynamic;
	...
	/**
		...
		*must not* set or change any of the class members, as these members
		...
		a, b : numeric (float, or int or +/-np.inf)
		    ...
		    shape parameters.
	**/
	public function _get_support(M:Dynamic, n:Dynamic, N:Dynamic):Dynamic;
	public function _isf(q:Dynamic, ?args:python.VarArgs<Dynamic>):Dynamic;
	public function _logcdf(k:Dynamic, M:Dynamic, n:Dynamic, N:Dynamic):Dynamic;
