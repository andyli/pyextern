...
@:pythonImport("scipy.stats._discrete_distns", "hypergeom_gen") extern class Hypergeom_gen {
	/**
	...
	**/
	public function _argcheck(M:Dynamic, n:Dynamic, N:Dynamic):Dynamic;
	public function _cdf(x:Dynamic, args:Dynamic):Dynamic;
	...
	**/
	...
	public function _entropy(M:Dynamic, n:Dynamic, N:Dynamic):Dynamic;
	...
	public function _rvs(M:Dynamic, n:Dynamic, N:Dynamic):Dynamic;
	/**
