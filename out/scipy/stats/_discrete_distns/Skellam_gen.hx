...
@:pythonImport("scipy.stats._discrete_distns", "skellam_gen") extern class Skellam_gen {
	/**
	...
	**/
	...
	public function _cdf(x:Dynamic, mu1:Dynamic, mu2:Dynamic):Dynamic;
	...
	**/
	...
	public function _pmf(x:Dynamic, mu1:Dynamic, mu2:Dynamic):Dynamic;
	public function _ppf(q:Dynamic, args:Dynamic):Dynamic;
	public function _rvs(mu1:Dynamic, mu2:Dynamic):Dynamic;
	public function _sf(x:Dynamic, args:Dynamic):Dynamic;
	public function _stats(mu1:Dynamic, mu2:Dynamic):Dynamic;
	/**
