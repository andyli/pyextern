...
@:pythonImport("scipy.stats._discrete_distns", "poisson_gen") extern class Poisson_gen {
	/**
	...
	**/
	...
	public function _cdf(x:Dynamic, mu:Dynamic):Dynamic;
	...
	**/
	...
	public function _logpmf(k:Dynamic, mu:Dynamic):Dynamic;
	...
	public function _pmf(k:Dynamic, mu:Dynamic):Dynamic;
	public function _ppf(q:Dynamic, mu:Dynamic):Dynamic;
	public function _rvs(mu:Dynamic):Dynamic;
	public function _sf(x:Dynamic, mu:Dynamic):Dynamic;
	public function _stats(mu:Dynamic):Dynamic;
	/**
