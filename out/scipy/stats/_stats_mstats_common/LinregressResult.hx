...
@:pythonImport("scipy.stats._stats_mstats_common", "LinregressResult") extern class LinregressResult {
	/**
		Return self+value.
	**/
	...
	**/
	...
	/**
		Create new instance of LinregressResult(slope, intercept, rvalue, pvalue, stderr)
	**/
	static public function __new__(_cls:Dynamic, slope:Dynamic, intercept:Dynamic, rvalue:Dynamic, pvalue:Dynamic, stderr:Dynamic):Dynamic;
	/**
		helper for pickle
	**/
	...
	**/
	...
	/**
		Make a new LinregressResult object from a sequence or iterable
	**/
	static public function _make(iterable:Dynamic, ?_new:Dynamic, ?len:Dynamic):Dynamic;
	/**
		Return a new LinregressResult object replacing specified fields with new values
	**/
