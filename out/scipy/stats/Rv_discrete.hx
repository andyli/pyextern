...
package scipy.stats;
@:native("scipy.stats.rv_discrete") extern class Rv_discrete {
	...
	public function logpmf(args:haxe.extern.Rest<Dynamic>):Dynamic;
	...
	public function pmf(args:haxe.extern.Rest<Dynamic>):Dynamic;
