...
@:pythonImport("scipy.stats._multivariate", "invwishart_gen") extern class Invwishart_gen {
	/**
	...
	**/
	public function _logpdf(x:Dynamic, dim:Dynamic, df:Dynamic, scale:Dynamic, log_det_scale:Dynamic):Dynamic;
	/**
		Parameters
		----------
		dim : int
	...
	**/
	public function mode(df:Dynamic, scale:Dynamic):Float;
	/**
