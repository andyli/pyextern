...
@:pythonImport("scipy.stats._binned_statistic", "BinnedStatisticResult") extern class BinnedStatisticResult {
	/**
		Return self+value.
	**/
	...
	**/
	...
	/**
		Create new instance of BinnedStatisticResult(statistic, bin_edges, binnumber)
	**/
	...
	**/
	...
	/**
		Make a new BinnedStatisticResult object from a sequence or iterable
	**/
	static public function _make(iterable:Dynamic, ?_new:Dynamic, ?len:Dynamic):Dynamic;
	/**
		Return a new BinnedStatisticResult object replacing specified fields with new values
	**/
