...
@:pythonImport("scipy.stats._binned_statistic", "BinnedStatisticddResult") extern class BinnedStatisticddResult {
	/**
		Return self+value.
	**/
	...
	**/
	...
	/**
		Create new instance of BinnedStatisticddResult(statistic, bin_edges, binnumber)
	**/
	static public function __new__(_cls:Dynamic, statistic:Dynamic, bin_edges:Dynamic, binnumber:Dynamic):Dynamic;
	/**
		helper for pickle
	**/
	...
	**/
	...
	/**
		Make a new BinnedStatisticddResult object from a sequence or iterable
	**/
	static public function _make(iterable:Dynamic, ?_new:Dynamic, ?len:Dynamic):Dynamic;
	/**
		Return a new BinnedStatisticddResult object replacing specified fields with new values
	**/
