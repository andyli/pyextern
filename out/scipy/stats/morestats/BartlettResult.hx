...
@:pythonImport("scipy.stats.morestats", "BartlettResult") extern class BartlettResult {
	/**
		Return self+value.
	**/
	...
	**/
	...
	/**
		Create new instance of BartlettResult(statistic, pvalue)
	**/
	...
	**/
	...
	/**
		Make a new BartlettResult object from a sequence or iterable
	**/
	static public function _make(iterable:Dynamic, ?_new:Dynamic, ?len:Dynamic):Dynamic;
	/**
		Return a new BartlettResult object replacing specified fields with new values
	**/
