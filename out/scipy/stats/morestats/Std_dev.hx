...
@:pythonImport("scipy.stats.morestats", "Std_dev") extern class Std_dev {
	/**
		Return self+value.
	**/
	...
	**/
	...
	/**
		Create new instance of Std_dev(statistic, minmax)
	**/
	...
	**/
	...
	/**
		Make a new Std_dev object from a sequence or iterable
	**/
	static public function _make(iterable:Dynamic, ?_new:Dynamic, ?len:Dynamic):Dynamic;
	/**
		Return a new Std_dev object replacing specified fields with new values
	**/
