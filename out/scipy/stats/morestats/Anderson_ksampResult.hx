...
@:pythonImport("scipy.stats.morestats", "Anderson_ksampResult") extern class Anderson_ksampResult {
	/**
		Return self+value.
	**/
	...
	**/
	...
	/**
		Create new instance of Anderson_ksampResult(statistic, critical_values, significance_level)
	**/
	static public function __new__(_cls:Dynamic, statistic:Dynamic, critical_values:Dynamic, significance_level:Dynamic):Dynamic;
	/**
		helper for pickle
	**/
	...
	**/
	...
	/**
		Make a new Anderson_ksampResult object from a sequence or iterable
	**/
	static public function _make(iterable:Dynamic, ?_new:Dynamic, ?len:Dynamic):Dynamic;
	/**
		Return a new Anderson_ksampResult object replacing specified fields with new values
	**/
