...
@:pythonImport("scipy.stats.morestats", "Mean") extern class Mean {
	/**
		Return self+value.
	**/
	...
	**/
	...
	/**
		Create new instance of Mean(statistic, minmax)
	**/
	...
	**/
	...
	/**
		Make a new Mean object from a sequence or iterable
	**/
	static public function _make(iterable:Dynamic, ?_new:Dynamic, ?len:Dynamic):Dynamic;
	/**
		Return a new Mean object replacing specified fields with new values
	**/
