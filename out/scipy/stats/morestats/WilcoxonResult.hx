...
@:pythonImport("scipy.stats.morestats", "WilcoxonResult") extern class WilcoxonResult {
	/**
		Return self+value.
	**/
	...
	**/
	...
	/**
		Create new instance of WilcoxonResult(statistic, pvalue)
	**/
	...
	**/
	...
	/**
		Make a new WilcoxonResult object from a sequence or iterable
	**/
	static public function _make(iterable:Dynamic, ?_new:Dynamic, ?len:Dynamic):Dynamic;
	/**
		Return a new WilcoxonResult object replacing specified fields with new values
	**/
