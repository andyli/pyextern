...
@:pythonImport("scipy.stats.morestats", "LeveneResult") extern class LeveneResult {
	/**
		Return self+value.
	**/
	...
	**/
	...
	/**
		Create new instance of LeveneResult(statistic, pvalue)
	**/
	...
	**/
	...
	/**
		Make a new LeveneResult object from a sequence or iterable
	**/
	static public function _make(iterable:Dynamic, ?_new:Dynamic, ?len:Dynamic):Dynamic;
	/**
		Return a new LeveneResult object replacing specified fields with new values
	**/
