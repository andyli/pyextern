...
@:pythonImport("scipy.stats.morestats", "Variance") extern class Variance {
	/**
		Return self+value.
	**/
	...
	**/
	...
	/**
		Create new instance of Variance(statistic, minmax)
	**/
	static public function __new__(_cls:Dynamic, statistic:Dynamic, minmax:Dynamic):Dynamic;
	/**
		helper for pickle
	**/
	...
	**/
	...
	/**
		Make a new Variance object from a sequence or iterable
	**/
	static public function _make(iterable:Dynamic, ?_new:Dynamic, ?len:Dynamic):Dynamic;
	/**
		Return a new Variance object replacing specified fields with new values
	**/
