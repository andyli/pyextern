...
@:pythonImport("scipy.stats.morestats", "AnsariResult") extern class AnsariResult {
	/**
		Return self+value.
	**/
	...
	**/
	...
	/**
		Create new instance of AnsariResult(statistic, pvalue)
	**/
	...
	**/
	...
	/**
		Make a new AnsariResult object from a sequence or iterable
	**/
	static public function _make(iterable:Dynamic, ?_new:Dynamic, ?len:Dynamic):Dynamic;
	/**
		Return a new AnsariResult object replacing specified fields with new values
	**/
