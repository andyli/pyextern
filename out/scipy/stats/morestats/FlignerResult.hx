...
@:pythonImport("scipy.stats.morestats", "FlignerResult") extern class FlignerResult {
	/**
		Return self+value.
	**/
	...
	**/
	...
	/**
		Create new instance of FlignerResult(statistic, pvalue)
	**/
	...
	**/
	...
	/**
		Make a new FlignerResult object from a sequence or iterable
	**/
	static public function _make(iterable:Dynamic, ?_new:Dynamic, ?len:Dynamic):Dynamic;
	/**
		Return a new FlignerResult object replacing specified fields with new values
	**/
