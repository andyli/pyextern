...
@:pythonImport("scipy.stats.morestats", "AndersonResult") extern class AndersonResult {
	/**
		Return self+value.
	**/
	...
	**/
	...
	/**
		Create new instance of AndersonResult(statistic, critical_values, significance_level)
	**/
	...
	**/
	...
	/**
		Make a new AndersonResult object from a sequence or iterable
	**/
	static public function _make(iterable:Dynamic, ?_new:Dynamic, ?len:Dynamic):Dynamic;
	/**
		Return a new AndersonResult object replacing specified fields with new values
	**/
