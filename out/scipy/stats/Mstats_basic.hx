...
package scipy.stats;
@:pythonImport("scipy.stats.mstats_basic") extern class Mstats_basic {
	...
	**/
	...
	static public var genmissingvaldoc : Dynamic;
	/**
	...
	**/
	...
	/**
		...
		KS D-value, p-value
	**/
	static public function ks_twosamp_old(data1:Dynamic, data2:Dynamic):Dynamic;
	/**
