...
@:pythonImport("scipy.stats.mstats_basic", "ModeResult") extern class ModeResult {
	/**
		Return self+value.
	**/
	...
	**/
	...
	/**
		Create new instance of ModeResult(mode, count)
	**/
	static public function __new__(_cls:Dynamic, mode:Dynamic, count:Dynamic):Dynamic;
	/**
		helper for pickle
	**/
	...
	**/
	...
	/**
		Make a new ModeResult object from a sequence or iterable
	**/
	static public function _make(iterable:Dynamic, ?_new:Dynamic, ?len:Dynamic):Dynamic;
	/**
		Return a new ModeResult object replacing specified fields with new values
	**/
