...
@:pythonImport("scipy.stats.mstats_basic", "SpearmanrResult") extern class SpearmanrResult {
	/**
		Return self+value.
	**/
	...
	**/
	...
	/**
		Create new instance of SpearmanrResult(correlation, pvalue)
	**/
	...
	**/
	...
	/**
		Make a new SpearmanrResult object from a sequence or iterable
	**/
	static public function _make(iterable:Dynamic, ?_new:Dynamic, ?len:Dynamic):Dynamic;
	/**
		Return a new SpearmanrResult object replacing specified fields with new values
	**/
