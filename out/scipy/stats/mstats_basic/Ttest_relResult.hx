...
@:pythonImport("scipy.stats.mstats_basic", "Ttest_relResult") extern class Ttest_relResult {
	/**
		Return self+value.
	**/
	...
	**/
	...
	/**
		Create new instance of Ttest_relResult(statistic, pvalue)
	**/
	...
	**/
	...
	/**
		Make a new Ttest_relResult object from a sequence or iterable
	**/
	static public function _make(iterable:Dynamic, ?_new:Dynamic, ?len:Dynamic):Dynamic;
	/**
		Return a new Ttest_relResult object replacing specified fields with new values
	**/
