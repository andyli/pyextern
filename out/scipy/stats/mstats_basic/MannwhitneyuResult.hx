...
@:pythonImport("scipy.stats.mstats_basic", "MannwhitneyuResult") extern class MannwhitneyuResult {
	/**
		Return self+value.
	**/
	...
	**/
	...
	/**
		Create new instance of MannwhitneyuResult(statistic, pvalue)
	**/
	...
	**/
	...
	/**
		Make a new MannwhitneyuResult object from a sequence or iterable
	**/
	static public function _make(iterable:Dynamic, ?_new:Dynamic, ?len:Dynamic):Dynamic;
	/**
		Return a new MannwhitneyuResult object replacing specified fields with new values
	**/
