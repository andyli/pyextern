...
@:pythonImport("scipy.stats.mstats_basic", "Ttest_indResult") extern class Ttest_indResult {
	/**
		Return self+value.
	**/
	...
	**/
	...
	/**
		Create new instance of Ttest_indResult(statistic, pvalue)
	**/
	...
	**/
	...
	/**
		Make a new Ttest_indResult object from a sequence or iterable
	**/
	static public function _make(iterable:Dynamic, ?_new:Dynamic, ?len:Dynamic):Dynamic;
	/**
		Return a new Ttest_indResult object replacing specified fields with new values
	**/
