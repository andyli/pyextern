...
@:pythonImport("scipy.stats.mstats_basic", "F_onewayResult") extern class F_onewayResult {
	/**
		Return self+value.
	**/
	...
	**/
	...
	/**
		Create new instance of F_onewayResult(statistic, pvalue)
	**/
	...
	**/
	...
	/**
		Make a new F_onewayResult object from a sequence or iterable
	**/
	static public function _make(iterable:Dynamic, ?_new:Dynamic, ?len:Dynamic):Dynamic;
	/**
		Return a new F_onewayResult object replacing specified fields with new values
	**/
