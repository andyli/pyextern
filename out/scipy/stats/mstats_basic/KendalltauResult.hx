...
@:pythonImport("scipy.stats.mstats_basic", "KendalltauResult") extern class KendalltauResult {
	/**
		Return self+value.
	**/
	...
	**/
	...
	/**
		Create new instance of KendalltauResult(correlation, pvalue)
	**/
	...
	**/
	...
	/**
		Make a new KendalltauResult object from a sequence or iterable
	**/
	static public function _make(iterable:Dynamic, ?_new:Dynamic, ?len:Dynamic):Dynamic;
	/**
		Return a new KendalltauResult object replacing specified fields with new values
	**/
