...
@:pythonImport("scipy.stats.mstats_basic", "PointbiserialrResult") extern class PointbiserialrResult {
	/**
		Return self+value.
	**/
	...
	**/
	...
	/**
		Create new instance of PointbiserialrResult(correlation, pvalue)
	**/
	static public function __new__(_cls:Dynamic, correlation:Dynamic, pvalue:Dynamic):Dynamic;
	/**
		helper for pickle
	**/
	...
	**/
	...
	/**
		Make a new PointbiserialrResult object from a sequence or iterable
	**/
	static public function _make(iterable:Dynamic, ?_new:Dynamic, ?len:Dynamic):Dynamic;
	/**
		Return a new PointbiserialrResult object replacing specified fields with new values
	**/
