...
@:pythonImport("scipy.stats.mstats_basic", "FriedmanchisquareResult") extern class FriedmanchisquareResult {
	/**
		Return self+value.
	**/
	...
	**/
	...
	/**
		Create new instance of FriedmanchisquareResult(statistic, pvalue)
	**/
	static public function __new__(_cls:Dynamic, statistic:Dynamic, pvalue:Dynamic):Dynamic;
	/**
		helper for pickle
	**/
	...
	**/
	...
	/**
		Make a new FriedmanchisquareResult object from a sequence or iterable
	**/
	static public function _make(iterable:Dynamic, ?_new:Dynamic, ?len:Dynamic):Dynamic;
	/**
		Return a new FriedmanchisquareResult object replacing specified fields with new values
	**/
