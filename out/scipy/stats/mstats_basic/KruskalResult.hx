...
@:pythonImport("scipy.stats.mstats_basic", "KruskalResult") extern class KruskalResult {
	/**
		Return self+value.
	**/
	...
	**/
	...
	/**
		Create new instance of KruskalResult(statistic, pvalue)
	**/
	...
	**/
	...
	/**
		Make a new KruskalResult object from a sequence or iterable
	**/
	static public function _make(iterable:Dynamic, ?_new:Dynamic, ?len:Dynamic):Dynamic;
	/**
		Return a new KruskalResult object replacing specified fields with new values
	**/
