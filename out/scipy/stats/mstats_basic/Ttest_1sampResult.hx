...
@:pythonImport("scipy.stats.mstats_basic", "Ttest_1sampResult") extern class Ttest_1sampResult {
	/**
		Return self+value.
	**/
	...
	**/
	...
	/**
		Create new instance of Ttest_1sampResult(statistic, pvalue)
	**/
	...
	**/
	...
	/**
		Make a new Ttest_1sampResult object from a sequence or iterable
	**/
	static public function _make(iterable:Dynamic, ?_new:Dynamic, ?len:Dynamic):Dynamic;
	/**
		Return a new Ttest_1sampResult object replacing specified fields with new values
	**/
