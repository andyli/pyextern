...
@:pythonImport("scipy.stats.mstats_basic", "NormaltestResult") extern class NormaltestResult {
	/**
		Return self+value.
	**/
	...
	**/
	...
	/**
		Create new instance of NormaltestResult(statistic, pvalue)
	**/
	...
	**/
	...
	/**
		Make a new NormaltestResult object from a sequence or iterable
	**/
	static public function _make(iterable:Dynamic, ?_new:Dynamic, ?len:Dynamic):Dynamic;
	/**
		Return a new NormaltestResult object replacing specified fields with new values
	**/
