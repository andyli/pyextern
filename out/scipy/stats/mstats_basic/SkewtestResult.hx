...
@:pythonImport("scipy.stats.mstats_basic", "SkewtestResult") extern class SkewtestResult {
	/**
		Return self+value.
	**/
	...
	**/
	...
	/**
		Create new instance of SkewtestResult(statistic, pvalue)
	**/
	...
	**/
	...
	/**
		Make a new SkewtestResult object from a sequence or iterable
	**/
	static public function _make(iterable:Dynamic, ?_new:Dynamic, ?len:Dynamic):Dynamic;
	/**
		Return a new SkewtestResult object replacing specified fields with new values
	**/
