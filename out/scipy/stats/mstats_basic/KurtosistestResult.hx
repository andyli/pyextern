...
@:pythonImport("scipy.stats.mstats_basic", "KurtosistestResult") extern class KurtosistestResult {
	/**
		Return self+value.
	**/
	...
	**/
	...
	/**
		Create new instance of KurtosistestResult(statistic, pvalue)
	**/
	...
	**/
	...
	/**
		Make a new KurtosistestResult object from a sequence or iterable
	**/
	static public function _make(iterable:Dynamic, ?_new:Dynamic, ?len:Dynamic):Dynamic;
	/**
		Return a new KurtosistestResult object replacing specified fields with new values
	**/
