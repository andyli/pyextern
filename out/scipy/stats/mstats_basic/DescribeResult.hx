...
@:pythonImport("scipy.stats.mstats_basic", "DescribeResult") extern class DescribeResult {
	/**
		Return self+value.
	**/
	...
	**/
	static public function __new__(_cls:Dynamic, nobs:Dynamic, minmax:Dynamic, mean:Dynamic, variance:Dynamic, skewness:Dynamic, kurtosis:Dynamic):Dynamic;
	/**
		helper for pickle
	**/
