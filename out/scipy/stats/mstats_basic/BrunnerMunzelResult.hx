...
@:pythonImport("scipy.stats.mstats_basic", "BrunnerMunzelResult") extern class BrunnerMunzelResult {
	/**
		Return self+value.
	**/
	...
	**/
	...
	/**
		Create new instance of BrunnerMunzelResult(statistic, pvalue)
	**/
	...
	**/
	...
	/**
		Make a new BrunnerMunzelResult object from a sequence or iterable
	**/
	static public function _make(iterable:Dynamic, ?_new:Dynamic, ?len:Dynamic):Dynamic;
	/**
		Return a new BrunnerMunzelResult object replacing specified fields with new values
	**/
