...
@:pythonImport("scipy.stats.stats", "KstestResult") extern class KstestResult {
	/**
		Return self+value.
	**/
	...
	**/
	...
	/**
		Create new instance of KstestResult(statistic, pvalue)
	**/
	...
	**/
	...
	/**
		Make a new KstestResult object from a sequence or iterable
	**/
	static public function _make(iterable:Dynamic, ?_new:Dynamic, ?len:Dynamic):Dynamic;
	/**
		Return a new KstestResult object replacing specified fields with new values
	**/
