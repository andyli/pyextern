...
@:pythonImport("scipy.stats.stats", "HistogramResult") extern class HistogramResult {
	/**
		Return self+value.
	**/
	...
	**/
	...
	/**
		Create new instance of HistogramResult(count, lowerlimit, binsize, extrapoints)
	**/
	static public function __new__(_cls:Dynamic, count:Dynamic, lowerlimit:Dynamic, binsize:Dynamic, extrapoints:Dynamic):Dynamic;
	/**
		helper for pickle
	**/
	...
	**/
	...
	/**
		Make a new HistogramResult object from a sequence or iterable
	**/
	static public function _make(iterable:Dynamic, ?_new:Dynamic, ?len:Dynamic):Dynamic;
	/**
		Return a new HistogramResult object replacing specified fields with new values
	**/
