...
@:pythonImport("scipy.stats.stats", "SigmaclipResult") extern class SigmaclipResult {
	/**
		Return self+value.
	**/
	...
	**/
	...
	/**
		Create new instance of SigmaclipResult(clipped, lower, upper)
	**/
	static public function __new__(_cls:Dynamic, clipped:Dynamic, lower:Dynamic, upper:Dynamic):Dynamic;
	/**
		helper for pickle
	**/
	...
	**/
	...
	/**
		Make a new SigmaclipResult object from a sequence or iterable
	**/
	static public function _make(iterable:Dynamic, ?_new:Dynamic, ?len:Dynamic):Dynamic;
	/**
		Return a new SigmaclipResult object replacing specified fields with new values
	**/
