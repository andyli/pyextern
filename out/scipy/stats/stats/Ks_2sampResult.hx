...
@:pythonImport("scipy.stats.stats", "Ks_2sampResult") extern class Ks_2sampResult {
	/**
		Return self+value.
	**/
	...
	**/
	...
	/**
		Create new instance of Ks_2sampResult(statistic, pvalue)
	**/
	...
	**/
	...
	/**
		Make a new Ks_2sampResult object from a sequence or iterable
	**/
	static public function _make(iterable:Dynamic, ?_new:Dynamic, ?len:Dynamic):Dynamic;
	/**
		Return a new Ks_2sampResult object replacing specified fields with new values
	**/
