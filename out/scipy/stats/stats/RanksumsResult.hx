...
@:pythonImport("scipy.stats.stats", "RanksumsResult") extern class RanksumsResult {
	/**
		Return self+value.
	**/
	...
	**/
	...
	/**
		Create new instance of RanksumsResult(statistic, pvalue)
	**/
	...
	**/
	...
	/**
		Make a new RanksumsResult object from a sequence or iterable
	**/
	static public function _make(iterable:Dynamic, ?_new:Dynamic, ?len:Dynamic):Dynamic;
	/**
		Return a new RanksumsResult object replacing specified fields with new values
	**/
