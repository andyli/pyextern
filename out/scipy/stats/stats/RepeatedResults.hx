...
@:pythonImport("scipy.stats.stats", "RepeatedResults") extern class RepeatedResults {
	/**
		Return self+value.
	**/
	...
	**/
	...
	/**
		Create new instance of RepeatedResults(values, counts)
	**/
	static public function __new__(_cls:Dynamic, values:Dynamic, counts:Dynamic):Dynamic;
	/**
		helper for pickle
	**/
	...
	**/
	...
	/**
		Make a new RepeatedResults object from a sequence or iterable
	**/
	static public function _make(iterable:Dynamic, ?_new:Dynamic, ?len:Dynamic):Dynamic;
	/**
		Return a new RepeatedResults object replacing specified fields with new values
	**/
