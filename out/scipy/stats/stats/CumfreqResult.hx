...
@:pythonImport("scipy.stats.stats", "CumfreqResult") extern class CumfreqResult {
	/**
		Return self+value.
	**/
	...
	**/
	...
	/**
		Create new instance of CumfreqResult(cumcount, lowerlimit, binsize, extrapoints)
	**/
	static public function __new__(_cls:Dynamic, cumcount:Dynamic, lowerlimit:Dynamic, binsize:Dynamic, extrapoints:Dynamic):Dynamic;
	/**
		helper for pickle
	**/
	...
	**/
	...
	/**
		Make a new CumfreqResult object from a sequence or iterable
	**/
	static public function _make(iterable:Dynamic, ?_new:Dynamic, ?len:Dynamic):Dynamic;
	/**
		Return a new CumfreqResult object replacing specified fields with new values
	**/
