...
@:pythonImport("scipy.stats.stats", "WeightedTauResult") extern class WeightedTauResult {
	/**
		Return self+value.
	**/
	...
	**/
	...
	/**
		Create new instance of WeightedTauResult(correlation, pvalue)
	**/
	...
	**/
	...
	/**
		Make a new WeightedTauResult object from a sequence or iterable
	**/
	static public function _make(iterable:Dynamic, ?_new:Dynamic, ?len:Dynamic):Dynamic;
	/**
		Return a new WeightedTauResult object replacing specified fields with new values
	**/
