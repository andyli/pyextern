...
@:pythonImport("scipy.stats.stats", "RelfreqResult") extern class RelfreqResult {
	/**
		Return self+value.
	**/
	...
	**/
	...
	/**
		Create new instance of RelfreqResult(frequency, lowerlimit, binsize, extrapoints)
	**/
	static public function __new__(_cls:Dynamic, frequency:Dynamic, lowerlimit:Dynamic, binsize:Dynamic, extrapoints:Dynamic):Dynamic;
	/**
		helper for pickle
	**/
	...
	**/
	...
	/**
		Make a new RelfreqResult object from a sequence or iterable
	**/
	static public function _make(iterable:Dynamic, ?_new:Dynamic, ?len:Dynamic):Dynamic;
	/**
		Return a new RelfreqResult object replacing specified fields with new values
	**/
	...
	**/
	static public var frequency : Dynamic;
	/**
