...
@:pythonImport("scipy.stats._continuous_distns", "rv_histogram") extern class Rv_histogram {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(histogram:Dynamic, ?args:python.VarArgs<Dynamic>, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
		Create a new distribution using the given histogram
		...
		histogram : tuple of array_like
		  ...
		  In particular the return value np.histogram is accepted
	**/
	public function new(histogram:Dynamic, ?args:python.VarArgs<Dynamic>, ?kwargs:python.KwArgs<Dynamic>):Void;
	/**
	...
	**/
	public function _munp(n:Dynamic):Dynamic;
	...
	**/
	public function _pdf(x:Dynamic):Dynamic;
	/**
	...
	**/
	public function _ppf(x:Dynamic):Dynamic;
