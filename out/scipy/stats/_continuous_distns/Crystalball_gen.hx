...
@:pythonImport("scipy.stats._continuous_distns", "crystalball_gen") extern class Crystalball_gen {
	/**
	...
	**/
	public function _argcheck(beta:Dynamic, m:Dynamic):Dynamic;
	public function _argcheck_rvs(?args:python.VarArgs<Dynamic>, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
		Return CDF of the crystalball function
	**/
	public function _cdf(x:Dynamic, beta:Dynamic, m:Dynamic):Dynamic;
	...
	**/
	public function _logpdf(x:Dynamic, beta:Dynamic, m:Dynamic):Dynamic;
	...
	**/
	public function _munp(n:Dynamic, beta:Dynamic, m:Dynamic):Dynamic;
	...
	/**
		...
		crystalball.pdf(x, beta, m) =  N * |
		                                   | A * (B - x)**(-m), for x <= -beta
		                                    --
	**/
	public function _pdf(x:Dynamic, beta:Dynamic, m:Dynamic):Dynamic;
	/**
	...
	**/
	...
	public function _ppf(p:Dynamic, beta:Dynamic, m:Dynamic):Dynamic;
