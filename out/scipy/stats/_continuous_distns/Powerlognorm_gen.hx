...
@:pythonImport("scipy.stats._continuous_distns", "powerlognorm_gen") extern class Powerlognorm_gen {
	/**
	...
	**/
	...
	public function _cdf(x:Dynamic, c:Dynamic, s:Dynamic):Dynamic;
	...
	**/
	...
	public function _pdf(x:Dynamic, c:Dynamic, s:Dynamic):Dynamic;
	/**
	...
	**/
	...
	public function _ppf(q:Dynamic, c:Dynamic, s:Dynamic):Dynamic;
