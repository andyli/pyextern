...
@:pythonImport("scipy.stats._continuous_distns", "argus_gen") extern class Argus_gen {
	/**
	...
	**/
	public function _cdf(x:Dynamic, chi:Dynamic):Dynamic;
	...
	**/
	public function _sf(x:Dynamic, chi:Dynamic):Dynamic;
