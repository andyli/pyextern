...
@:pythonImport("scipy.stats._continuous_distns", "reciprocal_gen") extern class Reciprocal_gen {
	/**
	...
	**/
	public function _argcheck(a:Dynamic, b:Dynamic):Dynamic;
	public function _argcheck_rvs(?args:python.VarArgs<Dynamic>, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	public function _cdf(x:Dynamic, a:Dynamic, b:Dynamic):Dynamic;
	...
	**/
	...
	public function _entropy(a:Dynamic, b:Dynamic):Dynamic;
	/**
	...
	/**
		...
		*must not* set or change any of the class members, as these members
		...
		a, b : numeric (float, or int or +/-np.inf)
		    ...
		    shape parameters.
	**/
	public function _get_support(a:Dynamic, b:Dynamic):Dynamic;
	...
	public function _logpdf(x:Dynamic, a:Dynamic, b:Dynamic):Dynamic;
	...
	public function _munp(n:Dynamic, a:Dynamic, b:Dynamic):Dynamic;
	...
	public function _pdf(x:Dynamic, a:Dynamic, b:Dynamic):Dynamic;
	/**
	...
	**/
	...
	public function _ppf(q:Dynamic, a:Dynamic, b:Dynamic):Dynamic;
