...
@:pythonImport("scipy.stats._continuous_distns", "genextreme_gen") extern class Genextreme_gen {
	/**
	...
	**/
	public function _argcheck(c:Dynamic):Dynamic;
	...
	/**
		...
		*must not* set or change any of the class members, as these members
		...
		a, b : numeric (float, or int or +/-np.inf)
		    ...
		    shape parameters.
	**/
	public function _get_support(c:Dynamic):Dynamic;
	public function _isf(q:Dynamic, c:Dynamic):Dynamic;
	public function _logcdf(x:Dynamic, c:Dynamic):Dynamic;
	public function _loglogcdf(x:Dynamic, c:Dynamic):Dynamic;
	...
	**/
	...
	public function _stats(c:Dynamic):Dynamic;
