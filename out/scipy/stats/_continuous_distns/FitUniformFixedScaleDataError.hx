...
@:pythonImport("scipy.stats._continuous_distns", "FitUniformFixedScaleDataError") extern class FitUniformFixedScaleDataError {
	/**
		exception cause
	**/
	...
	**/
	@:native("__init__")
	public function ___init__(ptp:Dynamic, fscale:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(ptp:Dynamic, fscale:Dynamic):Void;
	/**
