...
@:pythonImport("scipy.stats._continuous_distns", "pearson3_gen") extern class Pearson3_gen {
	/**
	...
	**/
	public function _argcheck(skew:Dynamic):Dynamic;
	public function _cdf(x:Dynamic, skew:Dynamic):Dynamic;
	...
	**/
	...
	public function _logpdf(x:Dynamic, skew:Dynamic):Dynamic;
	...
	public function _pdf(x:Dynamic, skew:Dynamic):Dynamic;
	/**
	...
	**/
	...
	public function _ppf(q:Dynamic, skew:Dynamic):Dynamic;
	...
	public function _preprocess(x:Dynamic, skew:Dynamic):Dynamic;
	public function _reduce_func(args:Dynamic, kwds:Dynamic):Dynamic;
	public function _rvs(skew:Dynamic):Dynamic;
	public function _sf(x:Dynamic, args:Dynamic):Dynamic;
	public function _stats(skew:Dynamic):Dynamic;
	/**
