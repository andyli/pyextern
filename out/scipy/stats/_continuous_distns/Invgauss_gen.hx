...
@:pythonImport("scipy.stats._continuous_distns", "invgauss_gen") extern class Invgauss_gen {
	/**
	...
	**/
	...
	public function _logpdf(x:Dynamic, mu:Dynamic):Dynamic;
	...
	public function _pdf(x:Dynamic, mu:Dynamic):Dynamic;
	/**
