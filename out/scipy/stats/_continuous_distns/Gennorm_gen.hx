...
@:pythonImport("scipy.stats._continuous_distns", "gennorm_gen") extern class Gennorm_gen {
	/**
	...
	**/
	...
	public function _cdf(x:Dynamic, beta:Dynamic):Dynamic;
	...
	**/
	...
	public function _entropy(beta:Dynamic):Dynamic;
	/**
	...
	**/
	...
	public function _isf(x:Dynamic, beta:Dynamic):Dynamic;
	public function _logcdf(x:Dynamic, ?args:python.VarArgs<Dynamic>):Dynamic;
	public function _logpdf(x:Dynamic, beta:Dynamic):Dynamic;
	...
	public function _pdf(x:Dynamic, beta:Dynamic):Dynamic;
	/**
	...
	**/
	...
	public function _ppf(x:Dynamic, beta:Dynamic):Dynamic;
	...
	public function _sf(x:Dynamic, beta:Dynamic):Dynamic;
	public function _stats(beta:Dynamic):Dynamic;
	/**
