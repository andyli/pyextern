...
@:pythonImport("scipy.stats._continuous_distns", "vonmises_gen") extern class Vonmises_gen {
	/**
	...
	**/
	...
	public function _cdf(x:Dynamic, kappa:Dynamic):Dynamic;
	...
	**/
	...
	public function _pdf(x:Dynamic, kappa:Dynamic):Dynamic;
	/**
