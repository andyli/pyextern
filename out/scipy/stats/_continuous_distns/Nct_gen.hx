...
@:pythonImport("scipy.stats._continuous_distns", "nct_gen") extern class Nct_gen {
	/**
	...
	**/
	public function _argcheck(df:Dynamic, nc:Dynamic):Dynamic;
	public function _cdf(x:Dynamic, df:Dynamic, nc:Dynamic):Dynamic;
	...
	**/
	...
	public function _pdf(x:Dynamic, df:Dynamic, nc:Dynamic):Dynamic;
	/**
	...
	**/
	...
	public function _ppf(q:Dynamic, df:Dynamic, nc:Dynamic):Dynamic;
	...
	public function _rvs(df:Dynamic, nc:Dynamic):Dynamic;
	public function _sf(x:Dynamic, args:Dynamic):Dynamic;
	public function _stats(df:Dynamic, nc:Dynamic, ?moments:Dynamic):Dynamic;
	/**
