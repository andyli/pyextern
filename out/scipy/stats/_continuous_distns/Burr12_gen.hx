...
@:pythonImport("scipy.stats._continuous_distns", "burr12_gen") extern class Burr12_gen {
	/**
	...
	**/
	...
	public function _cdf(x:Dynamic, c:Dynamic, d:Dynamic):Dynamic;
	...
	**/
	...
	public function _logcdf(x:Dynamic, c:Dynamic, d:Dynamic):Dynamic;
	public function _logpdf(x:Dynamic, c:Dynamic, d:Dynamic):Dynamic;
	public function _logsf(x:Dynamic, c:Dynamic, d:Dynamic):Dynamic;
	...
	public function _munp(n:Dynamic, c:Dynamic, d:Dynamic):Dynamic;
	...
	public function _pdf(x:Dynamic, c:Dynamic, d:Dynamic):Dynamic;
	/**
	...
	**/
	...
	public function _ppf(q:Dynamic, c:Dynamic, d:Dynamic):Dynamic;
	...
	public function _sf(x:Dynamic, c:Dynamic, d:Dynamic):Dynamic;
