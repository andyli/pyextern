...
@:pythonImport("scipy.stats._continuous_distns", "gausshyper_gen") extern class Gausshyper_gen {
	/**
	...
	**/
	public function _argcheck(a:Dynamic, b:Dynamic, c:Dynamic, z:Dynamic):Dynamic;
	...
	**/
	...
	public function _munp(n:Dynamic, a:Dynamic, b:Dynamic, c:Dynamic, z:Dynamic):Dynamic;
	public function _nnlf(x:Dynamic, args:Dynamic):Dynamic;
	public function _pdf(x:Dynamic, a:Dynamic, b:Dynamic, c:Dynamic, z:Dynamic):Dynamic;
	/**
