...
@:pythonImport("scipy.stats._continuous_distns", "levy_stable_gen") extern class Levy_stable_gen {
	/**
	...
	**/
	public function _argcheck(alpha:Dynamic, beta:Dynamic):Dynamic;
	public function _argcheck_rvs(?args:python.VarArgs<Dynamic>, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	public function _cdf(x:Dynamic, alpha:Dynamic, beta:Dynamic):Dynamic;
	...
	**/
	static public function _cdf_single_value_zolotarev(x:Dynamic, alpha:Dynamic, beta:Dynamic):Dynamic;
	static public function _cf(t:Dynamic, alpha:Dynamic, beta:Dynamic):Dynamic;
	/**
	...
	**/
	...
	public function _fitstart(data:Dynamic):Dynamic;
	/**
	...
	**/
	...
	public function _pdf(x:Dynamic, alpha:Dynamic, beta:Dynamic):Dynamic;
	/**
		Calculates pdf from cf using fft. Using region around 0 with N=2**q points
		separated by distance h. As suggested by [MS].
	**/
	static public function _pdf_from_cf_with_fft(cf:Dynamic, ?h:Dynamic, ?q:Dynamic):Dynamic;
	static public function _pdf_single_value_best(x:Dynamic, alpha:Dynamic, beta:Dynamic):Dynamic;
	static public function _pdf_single_value_cf_integrate(x:Dynamic, alpha:Dynamic, beta:Dynamic):Dynamic;
	/**
		Calculate pdf using Zolotarev's methods as detailed in [BS].
		        
	**/
	static public function _pdf_single_value_zolotarev(x:Dynamic, alpha:Dynamic, beta:Dynamic):Dynamic;
	/**
	...
	**/
	...
	public function _rvs(alpha:Dynamic, beta:Dynamic):Dynamic;
	public function _sf(x:Dynamic, ?args:python.VarArgs<Dynamic>):Dynamic;
	public function _stats(alpha:Dynamic, beta:Dynamic):Dynamic;
