...
@:pythonImport("scipy.stats._continuous_distns", "kappa4_gen") extern class Kappa4_gen {
	/**
	...
	**/
	public function _argcheck(h:Dynamic, k:Dynamic):Dynamic;
	public function _argcheck_rvs(?args:python.VarArgs<Dynamic>, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	public function _cdf(x:Dynamic, h:Dynamic, k:Dynamic):Dynamic;
	...
	/**
		...
		*must not* set or change any of the class members, as these members
		...
		a, b : numeric (float, or int or +/-np.inf)
		    ...
		    shape parameters.
	**/
	public function _get_support(h:Dynamic, k:Dynamic):Dynamic;
	public function _isf(q:Dynamic, ?args:python.VarArgs<Dynamic>):Dynamic;
	public function _logcdf(x:Dynamic, h:Dynamic, k:Dynamic):Dynamic;
	public function _logpdf(x:Dynamic, h:Dynamic, k:Dynamic):Dynamic;
	...
	public function _pdf(x:Dynamic, h:Dynamic, k:Dynamic):Dynamic;
	/**
	...
	**/
	...
	public function _ppf(q:Dynamic, h:Dynamic, k:Dynamic):Dynamic;
	...
	public function _stats(h:Dynamic, k:Dynamic):Dynamic;
