...
@:pythonImport("scipy.stats._continuous_distns", "gengamma_gen") extern class Gengamma_gen {
	/**
	...
	**/
	public function _argcheck(a:Dynamic, c:Dynamic):Dynamic;
	public function _argcheck_rvs(?args:python.VarArgs<Dynamic>, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	public function _cdf(x:Dynamic, a:Dynamic, c:Dynamic):Dynamic;
	...
	**/
	...
	public function _entropy(a:Dynamic, c:Dynamic):Dynamic;
	/**
	...
	**/
	...
	public function _isf(q:Dynamic, a:Dynamic, c:Dynamic):Dynamic;
	public function _logcdf(x:Dynamic, ?args:python.VarArgs<Dynamic>):Dynamic;
	public function _logpdf(x:Dynamic, a:Dynamic, c:Dynamic):Dynamic;
	...
	public function _munp(n:Dynamic, a:Dynamic, c:Dynamic):Dynamic;
	...
	public function _pdf(x:Dynamic, a:Dynamic, c:Dynamic):Dynamic;
	/**
	...
	**/
	...
	public function _ppf(q:Dynamic, a:Dynamic, c:Dynamic):Dynamic;
	...
	public function _sf(x:Dynamic, a:Dynamic, c:Dynamic):Dynamic;
