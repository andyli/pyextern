...
@:pythonImport("scipy.stats._continuous_distns", "truncexpon_gen") extern class Truncexpon_gen {
	/**
	...
	**/
	...
	public function _entropy(b:Dynamic):Dynamic;
	/**
	...
	/**
		...
		*must not* set or change any of the class members, as these members
		...
		a, b : numeric (float, or int or +/-np.inf)
		    ...
		    shape parameters.
	**/
	public function _get_support(b:Dynamic):Dynamic;
	...
	public function _logpdf(x:Dynamic, b:Dynamic):Dynamic;
	...
	**/
	...
	public function _ppf(q:Dynamic, b:Dynamic):Dynamic;
