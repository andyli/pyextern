...
@:pythonImport("scipy.stats._continuous_distns", "mielke_gen") extern class Mielke_gen {
	/**
	...
	**/
	...
	public function _cdf(x:Dynamic, k:Dynamic, s:Dynamic):Dynamic;
	...
	**/
	...
	public function _pdf(x:Dynamic, k:Dynamic, s:Dynamic):Dynamic;
	/**
	...
	**/
	...
	public function _ppf(q:Dynamic, k:Dynamic, s:Dynamic):Dynamic;
