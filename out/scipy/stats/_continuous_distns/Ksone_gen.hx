...
@:pythonImport("scipy.stats._continuous_distns", "ksone_gen") extern class Ksone_gen {
	/**
	...
	**/
	...
	public function _cdf(x:Dynamic, n:Dynamic):Dynamic;
	...
	**/
	...
	public function _isf(q:Dynamic, n:Dynamic):Dynamic;
	...
	public function _pdf(x:Dynamic, n:Dynamic):Dynamic;
	/**
	...
	**/
	...
	public function _ppf(q:Dynamic, n:Dynamic):Dynamic;
	...
	public function _sf(x:Dynamic, n:Dynamic):Dynamic;
