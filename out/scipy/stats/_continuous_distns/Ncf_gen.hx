...
@:pythonImport("scipy.stats._continuous_distns", "ncf_gen") extern class Ncf_gen {
	/**
	...
	**/
	...
	public function _cdf(x:Dynamic, dfn:Dynamic, dfd:Dynamic, nc:Dynamic):Dynamic;
	...
	**/
	...
	public function _logpdf(x:Dynamic, args:Dynamic):Dynamic;
	...
	public function _munp(n:Dynamic, dfn:Dynamic, dfd:Dynamic, nc:Dynamic):Dynamic;
	public function _nnlf(x:Dynamic, args:Dynamic):Dynamic;
	public function _pdf(x:Dynamic, args:Dynamic):Dynamic;
	public function _pdf_skip(x:Dynamic, dfn:Dynamic, dfd:Dynamic, nc:Dynamic):Dynamic;
	/**
	...
	**/
	...
	public function _ppf(q:Dynamic, dfn:Dynamic, dfd:Dynamic, nc:Dynamic):Dynamic;
	...
	public function _rvs(dfn:Dynamic, dfd:Dynamic, nc:Dynamic):Dynamic;
	public function _sf(x:Dynamic, args:Dynamic):Dynamic;
	public function _stats(dfn:Dynamic, dfd:Dynamic, nc:Dynamic):Dynamic;
	/**
