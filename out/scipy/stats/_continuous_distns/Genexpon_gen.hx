...
@:pythonImport("scipy.stats._continuous_distns", "genexpon_gen") extern class Genexpon_gen {
	/**
	...
	**/
	...
	public function _cdf(x:Dynamic, a:Dynamic, b:Dynamic, c:Dynamic):Dynamic;
	...
	**/
	...
	public function _logpdf(x:Dynamic, a:Dynamic, b:Dynamic, c:Dynamic):Dynamic;
	...
	public function _pdf(x:Dynamic, a:Dynamic, b:Dynamic, c:Dynamic):Dynamic;
	/**
