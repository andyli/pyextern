...
@:pythonImport("scipy.stats._continuous_distns", "nakagami_gen") extern class Nakagami_gen {
	/**
	...
	**/
	...
	public function _cdf(x:Dynamic, nu:Dynamic):Dynamic;
	...
	**/
	...
	public function _pdf(x:Dynamic, nu:Dynamic):Dynamic;
	/**
	...
	**/
	...
	public function _ppf(q:Dynamic, nu:Dynamic):Dynamic;
	...
	public function _stats(nu:Dynamic):Dynamic;
	/**
