...
@:pythonImport("scipy.stats._continuous_distns", "t_gen") extern class T_gen {
	/**
	...
	**/
	...
	public function _isf(q:Dynamic, df:Dynamic):Dynamic;
	public function _logcdf(x:Dynamic, ?args:python.VarArgs<Dynamic>):Dynamic;
	public function _logpdf(x:Dynamic, df:Dynamic):Dynamic;
	...
	public function _pdf(x:Dynamic, df:Dynamic):Dynamic;
	/**
	...
	**/
	...
	public function _ppf(q:Dynamic, df:Dynamic):Dynamic;
	...
	public function _rvs(df:Dynamic):Dynamic;
	public function _sf(x:Dynamic, df:Dynamic):Dynamic;
	public function _stats(df:Dynamic):Dynamic;
