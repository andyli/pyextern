...
@:pythonImport("scipy.stats._continuous_distns", "norm_gen") extern class Norm_gen {
	/**
	...
	**/
	...
	public function _logcdf(x:Dynamic):Dynamic;
	public function _logpdf(x:Dynamic):Dynamic;
	public function _logsf(x:Dynamic):Dynamic;
	...
	**/
	...
	public function _sf(x:Dynamic):Dynamic;
	...
	**/
	...
	/**
		...
		is ignored.
	**/
	public function fit(data:Dynamic, ?kwds:python.KwArgs<Dynamic>):Dynamic;
	/**
