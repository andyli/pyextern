...
@:pythonImport("scipy.stats._continuous_distns", "ncx2_gen") extern class Ncx2_gen {
	/**
	...
	**/
	...
	public function _logpdf(x:Dynamic, df:Dynamic, nc:Dynamic):Dynamic;
	...
	**/
	...
	public function _stats(df:Dynamic, nc:Dynamic):Dynamic;
