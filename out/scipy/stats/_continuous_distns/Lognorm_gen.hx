...
@:pythonImport("scipy.stats._continuous_distns", "lognorm_gen") extern class Lognorm_gen {
	/**
	...
	**/
	...
	public function _cdf(x:Dynamic, s:Dynamic):Dynamic;
	...
	**/
	...
	public function _entropy(s:Dynamic):Dynamic;
	/**
	...
	**/
	...
	public function _logcdf(x:Dynamic, s:Dynamic):Dynamic;
	public function _logpdf(x:Dynamic, s:Dynamic):Dynamic;
	public function _logsf(x:Dynamic, s:Dynamic):Dynamic;
	...
	public function _pdf(x:Dynamic, s:Dynamic):Dynamic;
	/**
	...
	**/
	...
	public function _ppf(q:Dynamic, s:Dynamic):Dynamic;
	...
	public function _rvs(s:Dynamic):Dynamic;
	public function _sf(x:Dynamic, s:Dynamic):Dynamic;
	public function _stats(s:Dynamic):Dynamic;
