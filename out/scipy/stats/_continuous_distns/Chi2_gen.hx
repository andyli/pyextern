...
@:pythonImport("scipy.stats._continuous_distns", "chi2_gen") extern class Chi2_gen {
	/**
	...
	**/
	...
	public function _isf(p:Dynamic, df:Dynamic):Dynamic;
	...
	**/
	...
	public function _ppf(p:Dynamic, df:Dynamic):Dynamic;
