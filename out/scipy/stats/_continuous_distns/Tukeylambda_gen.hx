...
@:pythonImport("scipy.stats._continuous_distns", "tukeylambda_gen") extern class Tukeylambda_gen {
	/**
	...
	**/
	public function _argcheck(lam:Dynamic):Dynamic;
	public function _cdf(x:Dynamic, lam:Dynamic):Dynamic;
	...
	**/
	...
	public function _entropy(lam:Dynamic):Dynamic;
	/**
	...
	**/
	...
	public function _pdf(x:Dynamic, lam:Dynamic):Dynamic;
	/**
	...
	**/
	...
	public function _ppf(q:Dynamic, lam:Dynamic):Dynamic;
	...
	public function _stats(lam:Dynamic):Dynamic;
	/**
