...
@:pythonImport("scipy.stats._continuous_distns", "exponnorm_gen") extern class Exponnorm_gen {
	/**
	...
	**/
	...
	public function _cdf(x:Dynamic, K:Dynamic):Dynamic;
	...
	**/
	...
	public function _logpdf(x:Dynamic, K:Dynamic):Dynamic;
	...
	public function _pdf(x:Dynamic, K:Dynamic):Dynamic;
	/**
	...
	**/
	...
	public function _rvs(K:Dynamic):Dynamic;
	public function _sf(x:Dynamic, K:Dynamic):Dynamic;
	public function _stats(K:Dynamic):Dynamic;
	/**
