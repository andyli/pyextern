...
@:pythonImport("scipy.stats._continuous_distns", "f_gen") extern class F_gen {
	/**
	...
	**/
	...
	public function _cdf(x:Dynamic, dfn:Dynamic, dfd:Dynamic):Dynamic;
	...
	**/
	...
	public function _logpdf(x:Dynamic, dfn:Dynamic, dfd:Dynamic):Dynamic;
	...
	public function _pdf(x:Dynamic, dfn:Dynamic, dfd:Dynamic):Dynamic;
	/**
	...
	**/
	...
	public function _ppf(q:Dynamic, dfn:Dynamic, dfd:Dynamic):Dynamic;
	...
	public function _rvs(dfn:Dynamic, dfd:Dynamic):Dynamic;
	public function _sf(x:Dynamic, dfn:Dynamic, dfd:Dynamic):Dynamic;
	public function _stats(dfn:Dynamic, dfd:Dynamic):Dynamic;
	/**
