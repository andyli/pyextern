...
@:pythonImport("scipy.stats._continuous_distns", "truncnorm_gen") extern class Truncnorm_gen {
	/**
	...
	**/
	...
	public function _get_norms(a:Dynamic, b:Dynamic):Dynamic;
	/**
	...
	**/
	...
	public function _stats(a:Dynamic, b:Dynamic):Dynamic;
