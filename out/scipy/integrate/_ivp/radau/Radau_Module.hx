...
@:pythonImport("scipy.integrate._ivp.radau") extern class Radau_Module {
	...
	static public var MU_COMPLEX : Dynamic;
	static public var MU_REAL : Dynamic;
	static public var NEWTON_MAXITER : Dynamic;
	static public var P : Dynamic;
	static public var S6 : Dynamic;
	static public var T : Dynamic;
	static public var TI : Dynamic;
	static public var TI_COMPLEX : Dynamic;
	static public var TI_REAL : Dynamic;
	...
	**/
	static public function predict_factor(h_abs:Dynamic, h_abs_old:Dynamic, error_norm:Dynamic, error_norm_old:Dynamic):Float;
	...
	**/
	static public function solve_collocation_system(fun:Dynamic, t:Dynamic, y:Dynamic, h:Dynamic, Z0:Dynamic, scale:Dynamic, tol:Dynamic, LU_real:Dynamic, LU_complex:Dynamic, solve_lu:Dynamic):Bool;
	/**
