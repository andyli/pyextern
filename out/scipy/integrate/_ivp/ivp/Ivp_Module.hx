...
package scipy.integrate._ivp.ivp;
@:pythonImport("scipy.integrate._ivp.ivp") extern class Ivp_Module {
	...
	**/
	static public function find_active_events(g:Dynamic, g_new:Dynamic, direction:Dynamic):Dynamic;
	/**
	...
	**/
	static public function handle_events(sol:Dynamic, events:Dynamic, active_events:Dynamic, is_terminal:Dynamic, t_old:Dynamic, t:Dynamic):Dynamic;
	/**
		Standardize event functions and extract is_terminal and direction.
	**/
	static public function prepare_events(events:Dynamic):Dynamic;
	...
	/**
		...
		root : float
		    Found solution.
	**/
	static public function solve_event_equation(event:Dynamic, sol:Dynamic, t_old:Dynamic, t:Dynamic):Float;
	/**
