...
package scipy.linalg.flinalg;
@:pythonImport("scipy.linalg.flinalg") extern class Flinalg_Module {
	...
	**/
	...
	static public function has_column_major_storage(arr:Dynamic):Dynamic;
