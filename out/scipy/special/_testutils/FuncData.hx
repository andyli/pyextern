...
package scipy.special._testutils;
@:pythonImport("scipy.special._testutils", "FuncData") extern class FuncData {
	...
	**/
	public function check(?data:Dynamic, ?dtype:Dynamic):Dynamic;
	public function get_tolerances(dtype:Dynamic):Dynamic;
}