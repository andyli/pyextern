...
@:pythonImport("scipy.special.cython_special") extern class Cython_special_Module {
	...
	static public function _hyp1f2_pywrap(args:haxe.extern.Rest<Dynamic>):Dynamic;
	static public function _hyp2f0_pywrap(x0:Dynamic, x1:Dynamic, x2:Dynamic, x3:Dynamic):Dynamic;
	static public function _hyp3f0_pywrap(args:haxe.extern.Rest<Dynamic>):Dynamic;
	...
	**/
	static public function pdtr(x0:Dynamic, x1:Dynamic):Dynamic;
	/**
		See the documentation for scipy.special.pdtrc
	**/
	static public function pdtrc(x0:Dynamic, x1:Dynamic):Dynamic;
	/**
