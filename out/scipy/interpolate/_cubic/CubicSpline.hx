...
@:pythonImport("scipy.interpolate._cubic", "CubicSpline") extern class CubicSpline {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(x:Dynamic, y:Dynamic, ?axis:Dynamic, ?bc_type:Dynamic, ?extrapolate:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(x:Dynamic, y:Dynamic, ?axis:Dynamic, ?bc_type:Dynamic, ?extrapolate:Dynamic):Void;
	/**
	...
	**/
	...
	/**
		...
		y : ndarray
		    ...
		    complex dtype.
	**/
	static public function _validate_bc(bc_type:Dynamic, y:Dynamic, expected_deriv_shape:Dynamic, axis:Dynamic):Dynamic;
	/**
