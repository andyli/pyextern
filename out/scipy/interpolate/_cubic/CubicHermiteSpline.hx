...
@:pythonImport("scipy.interpolate._cubic", "CubicHermiteSpline") extern class CubicHermiteSpline {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(x:Dynamic, y:Dynamic, dydx:Dynamic, ?axis:Dynamic, ?extrapolate:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(x:Dynamic, y:Dynamic, dydx:Dynamic, ?axis:Dynamic, ?extrapolate:Dynamic):Void;
	/**
