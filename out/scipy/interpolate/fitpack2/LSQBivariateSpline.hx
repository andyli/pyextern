...
@:pythonImport("scipy.interpolate.fitpack2", "LSQBivariateSpline") extern class LSQBivariateSpline {
	/**
	...
	**/
	...
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(x:Dynamic, y:Dynamic, z:Dynamic, tx:Dynamic, ty:Dynamic, ?w:Dynamic, ?bbox:Dynamic, ?kx:Dynamic, ?ky:Dynamic, ?eps:Dynamic):Void;
	/**
		Return self<=value.
	**/
