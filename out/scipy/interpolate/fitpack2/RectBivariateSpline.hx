...
@:pythonImport("scipy.interpolate.fitpack2", "RectBivariateSpline") extern class RectBivariateSpline {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(x:Dynamic, y:Dynamic, z:Dynamic, ?bbox:Dynamic, ?kx:Dynamic, ?ky:Dynamic, ?s:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(x:Dynamic, y:Dynamic, z:Dynamic, ?bbox:Dynamic, ?kx:Dynamic, ?ky:Dynamic, ?s:Dynamic):Void;
	/**
		Return self<=value.
	**/
