...
@:pythonImport("scipy.interpolate.fitpack2", "InterpolatedUnivariateSpline") extern class InterpolatedUnivariateSpline {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(x:Dynamic, y:Dynamic, ?w:Dynamic, ?bbox:Dynamic, ?k:Dynamic, ?ext:Dynamic, ?check_finite:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(x:Dynamic, y:Dynamic, ?w:Dynamic, ?bbox:Dynamic, ?k:Dynamic, ?ext:Dynamic, ?check_finite:Dynamic):Void;
	/**
