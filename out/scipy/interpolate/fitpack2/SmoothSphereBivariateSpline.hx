...
@:pythonImport("scipy.interpolate.fitpack2", "SmoothSphereBivariateSpline") extern class SmoothSphereBivariateSpline {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(theta:Dynamic, phi:Dynamic, r:Dynamic, ?w:Dynamic, ?s:Dynamic, ?eps:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(theta:Dynamic, phi:Dynamic, r:Dynamic, ?w:Dynamic, ?s:Dynamic, ?eps:Dynamic):Void;
	/**
