...
@:pythonImport("scipy.interpolate._monotone", "Akima1DInterpolator") extern class Akima1DInterpolator {
	/**
	...
	**/
	public function __init__(x:Dynamic, y:Dynamic, ?axis:Dynamic):Dynamic;
	/**
		Return self<=value.
	**/
	...
	**/
	public function extend():Dynamic;
