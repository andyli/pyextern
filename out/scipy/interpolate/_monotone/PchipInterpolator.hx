...
@:pythonImport("scipy.interpolate._monotone", "PchipInterpolator") extern class PchipInterpolator {
	/**
	...
	**/
	public function __init__(x:Dynamic, y:Dynamic, ?axis:Dynamic, ?extrapolate:Dynamic):Dynamic;
	/**
		Return self<=value.
	**/
