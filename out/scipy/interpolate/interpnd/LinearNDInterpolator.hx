...
@:pythonImport("scipy.interpolate.interpnd", "LinearNDInterpolator") extern class LinearNDInterpolator {
	/**
		interpolator(xi)
	...
	**/
	...
	public function __init__(points:Dynamic, values:Dynamic, ?fill_value:Dynamic, ?rescale:Dynamic):Dynamic;
	/**
		Return self<=value.
	**/
