...
@:pythonImport("scipy.interpolate.interpolate", "ppform") extern class Ppform {
	/**
	...
	**/
	public function __init__(coeffs:Dynamic, breaks:Dynamic, ?fill:Dynamic, ?sort:Dynamic):Dynamic;
	/**
		Return self<=value.
	**/
	...
	**/
	...
	static public function fromspline(xk:Dynamic, cvals:Dynamic, order:Dynamic, ?fill:Dynamic):Dynamic;
	/**
