...
@:pythonImport("scipy.interpolate.rbf", "Rbf") extern class Rbf {
	...
	**/
	...
	public function _h_linear(r:Dynamic):Dynamic;
	public function _h_multiquadric(r:Dynamic):Dynamic;
	public function _h_quintic(r:Dynamic):Dynamic;
	public function _h_thin_plate(r:Dynamic):Dynamic;
	public function _init_function(r:Dynamic):Dynamic;
}