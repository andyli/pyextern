...
@:pythonImport("scipy._lib.decorator", "FunctionMaker") extern class FunctionMaker {
	...
	**/
	...
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(?func:Dynamic, ?name:Dynamic, ?signature:Dynamic, ?defaults:Dynamic, ?doc:Dynamic, ?module:Dynamic, ?funcdict:Dynamic):Void;
	/**
		Return self<=value.
	**/
	...
	**/
	...
	static public var _compile_count : Dynamic;
	/**
