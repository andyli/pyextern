...
@:pythonImport("scipy._lib.decorator", "ArgSpec") extern class ArgSpec {
	/**
		Return self+value.
	**/
	...
	**/
	...
	/**
		Create new instance of ArgSpec(args, varargs, varkw, defaults)
	**/
	static public function __new__(_cls:Dynamic, args:Dynamic, varargs:Dynamic, varkw:Dynamic, defaults:Dynamic):Dynamic;
	/**
		helper for pickle
	**/
