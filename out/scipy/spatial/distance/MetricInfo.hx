...
@:pythonImport("scipy.spatial.distance", "MetricInfo") extern class MetricInfo {
	...
	**/
	...
	/**
		Create new instance of MetricInfo(aka, types, validator)
	**/
	static public function __new__(_cls:Dynamic, aka:Dynamic, ?types:Dynamic, ?validator:Dynamic):Dynamic;
	/**
		helper for pickle
	**/
	...
	**/
	...
	/**
		Make a new MetricInfo object from a sequence or iterable
	**/
	static public function _make(iterable:Dynamic, ?_new:Dynamic, ?len:Dynamic):Dynamic;
	/**
		Return a new MetricInfo object replacing specified fields with new values
	**/
