...
@:pythonImport("scipy.spatial.qhull", "HalfspaceIntersection") extern class HalfspaceIntersection {
	...
	**/
	...
	@:native("__init__")
	public function ___init__(halfspaces:Dynamic, interior_point:Dynamic, ?incremental:Dynamic, ?qhull_options:Dynamic):Dynamic;
	public function new(halfspaces:Dynamic, interior_point:Dynamic, ?incremental:Dynamic, ?qhull_options:Dynamic):Void;
	/**
	...
	**/
	public function add_halfspaces(halfspaces:Dynamic, ?restart:Dynamic):Dynamic;
	/**
		close()
	...
	**/
	...
	public var dual_vertices : Dynamic;
	public var halfspaces : Dynamic;
}