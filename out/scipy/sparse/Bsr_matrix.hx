...
@:native("scipy.sparse.bsr_matrix") extern class Bsr_matrix {
	...
	public function getdata(ind:Dynamic):Void;
	...
	public function matmat(other:Dynamic):Void;
	public function matvec(other:Dynamic):Void;
	...
	public function tobsr(?blocksize:Dynamic = null, ?copy:Dynamic = false):Void;
