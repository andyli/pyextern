...
@:pythonImport("scipy.sparse.linalg.matfuncs", "MatrixPowerOperator") extern class MatrixPowerOperator {
	/**
		Hermitian adjoint.
	...
	**/
	@:native("__init__")
	public function ___init__(A:Dynamic, p:Dynamic, ?structure:Dynamic):Dynamic;
	/**
		Initialize this LinearOperator.
		...
		be convertible to a length-2 tuple.
	**/
	public function new(A:Dynamic, p:Dynamic, ?structure:Dynamic):Void;
	/**
		Return self<=value.
	**/
