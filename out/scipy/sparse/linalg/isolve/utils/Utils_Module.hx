...
package scipy.sparse.linalg.isolve.utils;
@:pythonImport("scipy.sparse.linalg.isolve.utils") extern class Utils_Module {
	...
	static public var _coerce_rules : Dynamic;
