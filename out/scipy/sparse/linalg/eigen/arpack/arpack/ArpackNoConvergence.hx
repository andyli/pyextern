...
@:pythonImport("scipy.sparse.linalg.eigen.arpack.arpack", "ArpackNoConvergence") extern class ArpackNoConvergence {
	/**
		exception cause
	**/
	...
	**/
	...
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(msg:Dynamic, eigenvalues:Dynamic, eigenvectors:Dynamic):Void;
	/**
		Return self<=value.
	**/
