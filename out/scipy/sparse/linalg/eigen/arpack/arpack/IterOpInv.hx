...
@:pythonImport("scipy.sparse.linalg.eigen.arpack.arpack", "IterOpInv") extern class IterOpInv {
	/**
		Hermitian adjoint.
	...
	**/
	@:native("__init__")
	public function ___init__(A:Dynamic, M:Dynamic, sigma:Dynamic, ?ifunc:Dynamic, ?tol:Dynamic):Dynamic;
	/**
		Initialize this LinearOperator.
		...
		be convertible to a length-2 tuple.
	**/
	public function new(A:Dynamic, M:Dynamic, sigma:Dynamic, ?ifunc:Dynamic, ?tol:Dynamic):Void;
	/**
