...
@:pythonImport("scipy.sparse.linalg.eigen.arpack.arpack", "ArpackError") extern class ArpackError {
	/**
		exception cause
	**/
	...
	**/
	public function __init__(info:Dynamic, ?infodict:Dynamic):Dynamic;
	/**
		Return self<=value.
	**/
