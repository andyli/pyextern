...
@:pythonImport("scipy.sparse.linalg.interface", "_AdjointMatrixOperator") extern class _AdjointMatrixOperator {
	/**
		Hermitian adjoint.
	...
	**/
	@:native("__init__")
	public function ___init__(adjoint:Dynamic):Dynamic;
	/**
		Initialize this LinearOperator.
		...
		be convertible to a length-2 tuple.
	**/
	public function new(adjoint:Dynamic):Void;
	/**
		Return self<=value.
	**/
