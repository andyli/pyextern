...
@:pythonImport("scipy.sparse.linalg.interface", "_ScaledLinearOperator") extern class _ScaledLinearOperator {
	/**
		Hermitian adjoint.
	...
	**/
	@:native("__init__")
	public function ___init__(A:Dynamic, alpha:Dynamic):Dynamic;
	/**
		Initialize this LinearOperator.
		...
		be convertible to a length-2 tuple.
	**/
	public function new(A:Dynamic, alpha:Dynamic):Void;
	/**
