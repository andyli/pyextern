...
@:pythonImport("scipy.sparse.linalg.interface", "_PowerLinearOperator") extern class _PowerLinearOperator {
	/**
		Hermitian adjoint.
	...
	**/
	...
	/**
		...
		be convertible to a length-2 tuple.
	**/
	public function new(A:Dynamic, p:Dynamic):Void;
	/**
		Return self<=value.
	**/
	...
	**/
	...
	public function _power(fun:Dynamic, x:Dynamic):Dynamic;
	/**
