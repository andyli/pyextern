...
@:pythonImport("scipy.sparse.linalg.interface", "_CustomLinearOperator") extern class _CustomLinearOperator {
	/**
		Hermitian adjoint.
	...
	**/
	@:native("__init__")
	public function ___init__(shape:Dynamic, matvec:Dynamic, ?rmatvec:Dynamic, ?matmat:Dynamic, ?dtype:Dynamic):Dynamic;
	/**
		Initialize this LinearOperator.
		...
		be convertible to a length-2 tuple.
	**/
	public function new(shape:Dynamic, matvec:Dynamic, ?rmatvec:Dynamic, ?matmat:Dynamic, ?dtype:Dynamic):Void;
	/**
		Return self<=value.
	**/
