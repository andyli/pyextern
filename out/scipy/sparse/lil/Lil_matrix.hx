...
@:pythonImport("scipy.sparse.lil", "lil_matrix") extern class Lil_matrix {
	...
	**/
	public function _asindices(idx:Dynamic, N:Dynamic):Dynamic;
	...
	/**
		...
		col_slice : slice
		    Columns indexed
	**/
	public function _get_row_ranges(rows:Dynamic, col_slice:Dynamic):Dynamic;
	...
	**/
	public function getrowview(i:Dynamic):Dynamic;
	/**
