...
@:pythonImport("scipy.sparse", "dok_matrix") extern class Dok_matrix {
	...
	public function conjtransp(?kwargs:python.KwArgs<Dynamic>):Dynamic;
	...
	public function get(key:Dynamic, ?_default:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	...
	public function resize(shape:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	...
	public function todok(?copy:Dynamic = false, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
