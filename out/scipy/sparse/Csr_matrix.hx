...
@:pythonImport("scipy.sparse", "csr_matrix") extern class Csr_matrix {
	...
	public function getcol(i:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	...
	public function tobsr(?blocksize:Dynamic = null, ?copy:Dynamic = true, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	...
	public function tocsr(?copy:Dynamic = false, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
