...
@:pythonImport("scipy.io.wavfile") extern class Wavfile_Module {
	...
	static public function _read_data_chunk(fid:Dynamic, comp:Dynamic, noc:Dynamic, bits:Dynamic, is_big_endian:Dynamic, ?mmap:Dynamic):Dynamic;
	static public function _read_fmt_chunk(fid:Dynamic, is_big_endian:Dynamic):Dynamic;
