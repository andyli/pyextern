...
@:pythonImport("scipy.io.arff.arffread", "DateAttribute") extern class DateAttribute {
	...
	**/
	@:native("__init__")
	public function ___init__(name:Dynamic, date_format:Dynamic, datetime_unit:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(name:Dynamic, date_format:Dynamic, datetime_unit:Dynamic):Void;
	/**
	...
	**/
	...
	static public function _get_date_format(atrv:Dynamic):Dynamic;
	/**
