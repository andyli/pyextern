...
@:pythonImport("scipy.io.arff.arffread", "NumericAttribute") extern class NumericAttribute {
	...
	**/
	...
	public function _basic_stats(data:Dynamic):Dynamic;
	/**
	...
	**/
	...
	/**
		...
		nan
	**/
	public function parse_data(data_str:Dynamic):Float;
