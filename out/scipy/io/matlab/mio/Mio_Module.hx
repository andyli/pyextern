...
@:pythonImport("scipy.io.matlab.mio") extern class Mio_Module {
	...
	**/
	static public function _open_file(file_like:Dynamic, appendmat:Dynamic, ?mode:Dynamic):Dynamic;
	static public function _open_file_context(file_like:Dynamic, appendmat:Dynamic, ?mode:Dynamic):Dynamic;
