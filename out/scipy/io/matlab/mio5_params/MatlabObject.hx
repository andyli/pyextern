...
@:pythonImport("scipy.io.matlab.mio5_params", "MatlabObject") extern class MatlabObject {
	/**
	...
	**/
	static public function __new__(cls:Dynamic, input_array:Dynamic, ?classname:Dynamic):Dynamic;
	/**
		Return self|value.
	**/
