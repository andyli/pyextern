...
@:pythonImport("scipy.io.matlab.mio5_params", "MatlabFunction") extern class MatlabFunction {
	/**
	...
	**/
	static public function __new__(cls:Dynamic, input_array:Dynamic):Dynamic;
	/**
		Return self|value.
	**/
