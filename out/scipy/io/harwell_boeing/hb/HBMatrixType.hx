...
@:pythonImport("scipy.io.harwell_boeing.hb", "HBMatrixType") extern class HBMatrixType {
	...
	**/
	...
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(value_type:Dynamic, structure:Dynamic, ?storage:Dynamic):Void;
	/**
		Return self<=value.
	**/
