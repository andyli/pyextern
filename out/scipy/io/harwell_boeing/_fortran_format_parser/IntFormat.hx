...
@:pythonImport("scipy.io.harwell_boeing._fortran_format_parser", "IntFormat") extern class IntFormat {
	...
	**/
	@:native("__init__")
	public function ___init__(width:Dynamic, ?min:Dynamic, ?repeat:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(width:Dynamic, ?min:Dynamic, ?repeat:Dynamic):Void;
	/**
