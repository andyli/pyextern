...
@:pythonImport("scipy.optimize._hessian_update_strategy", "SR1") extern class SR1 {
	...
	**/
	@:native("__init__")
	public function ___init__(?min_denominator:Dynamic, ?init_scale:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(?min_denominator:Dynamic, ?init_scale:Dynamic):Void;
	/**
