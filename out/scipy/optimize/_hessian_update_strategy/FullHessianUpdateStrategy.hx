...
@:pythonImport("scipy.optimize._hessian_update_strategy", "FullHessianUpdateStrategy") extern class FullHessianUpdateStrategy {
	...
	**/
	@:native("__init__")
	public function ___init__(?init_scale:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(?init_scale:Dynamic):Void;
	/**
