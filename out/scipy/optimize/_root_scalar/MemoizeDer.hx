...
@:pythonImport("scipy.optimize._root_scalar", "MemoizeDer") extern class MemoizeDer {
	/**
	...
	**/
	public function fprime(x:Dynamic, ?args:python.VarArgs<Dynamic>):Dynamic;
	/**
		Calculate f'' or use a cached value if available
	**/
	public function fprime2(x:Dynamic, ?args:python.VarArgs<Dynamic>):Dynamic;
	public function ncalls():Dynamic;
}