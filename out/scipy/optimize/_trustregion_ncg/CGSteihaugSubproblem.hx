...
package scipy.optimize._trustregion_ncg;
@:pythonImport("scipy.optimize._trustregion_ncg", "CGSteihaugSubproblem") extern class CGSteihaugSubproblem {
	/**
	...
	**/
	...
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(x:Dynamic, fun:Dynamic, jac:Dynamic, ?hess:Dynamic, ?hessp:Dynamic):Void;
	/**
		Return self<=value.
	**/
