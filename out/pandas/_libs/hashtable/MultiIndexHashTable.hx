...
@:pythonImport("pandas._libs.hashtable", "MultiIndexHashTable") extern class MultiIndexHashTable {
	...
	**/
	...
	public function _check_for_collisions(args:haxe.extern.Rest<Dynamic>):Dynamic;
