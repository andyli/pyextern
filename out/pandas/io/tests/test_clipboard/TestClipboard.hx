...
package pandas.io.tests.test_clipboard;
@:pythonImport("pandas.io.tests.test_clipboard", "TestClipboard") extern class TestClipboard {
	/**
	...
	**/
	...
	public function check_round_trip_frame(data_type:Dynamic, ?excel:Dynamic, ?sep:Dynamic):Dynamic;
	...
	**/
	...
	public function test_read_clipboard_infer_excel():Dynamic;
	public function test_round_trip_frame():Dynamic;
	public function test_round_trip_frame_sep():Dynamic;
	public function test_round_trip_frame_string():Dynamic;
}