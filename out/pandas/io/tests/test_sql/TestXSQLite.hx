...
@:pythonImport("pandas.io.tests.test_sql", "TestXSQLite") extern class TestXSQLite {
	/**
	...
	**/
	...
	public function _check_roundtrip(frame:Dynamic):Dynamic;
	...
	**/
	...
	public function test_execute():Dynamic;
	public function test_execute_closed_connection():Dynamic;
	public function test_execute_fail():Dynamic;
	public function test_if_exists():Dynamic;
	/**
		        
	**/
	public function test_keyword_as_column_names():Dynamic;
	public function test_na_roundtrip():Dynamic;
	public function test_onecolumn_of_integer():Dynamic;
	public function test_schema():Dynamic;
	public function test_tquery():Dynamic;
	public function test_uquery():Dynamic;
	public function test_write_row_by_row():Dynamic;
}