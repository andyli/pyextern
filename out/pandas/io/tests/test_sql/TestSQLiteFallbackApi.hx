...
@:pythonImport("pandas.io.tests.test_sql", "TestSQLiteFallbackApi") extern class TestSQLiteFallbackApi {
	/**
	...
	**/
	...
	public function _get_sqlite_column_type(schema:Dynamic, column:Dynamic):Dynamic;
	...
	**/
	...
	public function connect(?database:Dynamic):Dynamic;
	...
	**/
	...
	public function test_get_schema2():Dynamic;
	...
	public function test_safe_names_warning():Dynamic;
	public function test_sql_open_close():Dynamic;
	public function test_sqlite_type_mapping():Dynamic;
