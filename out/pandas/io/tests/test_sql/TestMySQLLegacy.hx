...
@:pythonImport("pandas.io.tests.test_sql", "TestMySQLLegacy") extern class TestMySQLLegacy {
	/**
	...
	**/
	...
	public function _get_sqlite_column_type(table:Dynamic, column:Dynamic):Dynamic;
	...
	**/
	...
	public function test_a_deprecation():Dynamic;
	public function test_create_and_drop_table():Dynamic;
	...
	public function test_illegal_names():Dynamic;
	public function test_invalid_flavor():Dynamic;
	public function test_notnull_dtype():Dynamic;
	public function test_read_sql():Dynamic;
