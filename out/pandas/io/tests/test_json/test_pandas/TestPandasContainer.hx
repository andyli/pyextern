...
package pandas.io.tests.test_json.test_pandas;
@:pythonImport("pandas.io.tests.test_json.test_pandas", "TestPandasContainer") extern class TestPandasContainer {
	/**
	...
	**/
	...
	public function test_axis_dates():Dynamic;
	public function test_blocks_compat_GH9037():Dynamic;
	public function test_convert_dates():Dynamic;
	public function test_convert_dates_infer():Dynamic;
	public function test_date_format_frame():Dynamic;
	public function test_date_format_series():Dynamic;
	public function test_date_unit():Dynamic;
	public function test_default_handler():Dynamic;
	public function test_default_handler_raises():Dynamic;
	public function test_doc_example():Dynamic;
	public function test_frame_double_encoded_labels():Dynamic;
	public function test_frame_empty():Dynamic;
	public function test_frame_empty_mixedtype():Dynamic;
	public function test_frame_from_json_bad_data():Dynamic;
	public function test_frame_from_json_nones():Dynamic;
	public function test_frame_from_json_precise_float():Dynamic;
	public function test_frame_from_json_to_json():Dynamic;
	public function test_frame_mixedtype_orient():Dynamic;
	public function test_frame_non_unique_columns():Dynamic;
	public function test_frame_non_unique_index():Dynamic;
	public function test_frame_to_json_except():Dynamic;
	public function test_misc_example():Dynamic;
	public function test_mixed_timedelta_datetime():Dynamic;
	public function test_path():Dynamic;
	public function test_reconstruction_index():Dynamic;
	public function test_round_trip_exception_():Dynamic;
	public function test_series_from_json_precise_float():Dynamic;
	public function test_series_from_json_to_json():Dynamic;
	public function test_series_non_unique_index():Dynamic;
	public function test_series_to_json_except():Dynamic;
	public function test_timedelta():Dynamic;
	public function test_typ():Dynamic;
	public function test_url():Dynamic;
	public function test_v12_compat():Dynamic;
	public function test_weird_nested_json():Dynamic;
}