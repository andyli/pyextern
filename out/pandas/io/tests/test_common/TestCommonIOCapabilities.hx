...
package pandas.io.tests.test_common;
@:pythonImport("pandas.io.tests.test_common", "TestCommonIOCapabilities") extern class TestCommonIOCapabilities {
	/**
	...
	**/
	...
	public function test_expand_user():Dynamic;
	public function test_expand_user_normal_path():Dynamic;
	public function test_get_filepath_or_buffer_with_buffer():Dynamic;
	public function test_get_filepath_or_buffer_with_path():Dynamic;
}