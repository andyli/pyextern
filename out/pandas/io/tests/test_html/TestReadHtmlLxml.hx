...
@:pythonImport("pandas.io.tests.test_html", "TestReadHtmlLxml") extern class TestReadHtmlLxml {
	/**
	...
	**/
	...
	public function test_data_fail():Dynamic;
	public function test_fallback_success():Dynamic;
	public function test_parse_dates_combine():Dynamic;
	public function test_parse_dates_list():Dynamic;
	public function test_works_on_valid_markup():Dynamic;
}