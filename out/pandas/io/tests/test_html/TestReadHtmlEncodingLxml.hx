...
@:pythonImport("pandas.io.tests.test_html", "TestReadHtmlEncodingLxml") extern class TestReadHtmlEncodingLxml {
	/**
	...
	**/
	...
	public function read_file_like(f:Dynamic, encoding:Dynamic):Dynamic;
	public function read_filename(f:Dynamic, encoding:Dynamic):Dynamic;
	public function read_html(args:Dynamic, kwargs:Dynamic):Dynamic;
	public function read_string(f:Dynamic, encoding:Dynamic):Dynamic;
	...
	**/
	...
	public function test_encode():Dynamic;
}