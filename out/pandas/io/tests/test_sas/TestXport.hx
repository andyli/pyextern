...
package pandas.io.tests.test_sas;
@:pythonImport("pandas.io.tests.test_sas", "TestXport") extern class TestXport {
	/**
	...
	**/
	...
	public function test1():Dynamic;
	public function test1_incremental():Dynamic;
	public function test1_index():Dynamic;
	public function test2():Dynamic;
	public function test3():Dynamic;
}