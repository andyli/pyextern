...
@:pythonImport("pandas.io.tests.test_gbq", "TestReadGBQUnitTests") extern class TestReadGBQUnitTests {
	/**
	...
	**/
	...
	public function test_read_gbq_with_no_project_id_given_should_fail():Dynamic;
	public function test_should_return_bigquery_booleans_as_python_booleans():Dynamic;
	public function test_should_return_bigquery_floats_as_python_floats():Dynamic;
	public function test_should_return_bigquery_integers_as_python_floats():Dynamic;
	public function test_should_return_bigquery_strings_as_python_strings():Dynamic;
	public function test_should_return_bigquery_timestamps_as_numpy_datetime():Dynamic;
	public function test_that_parse_data_works_properly():Dynamic;
	public function test_to_gbq_should_fail_if_invalid_table_name_passed():Dynamic;
	public function test_to_gbq_with_no_project_id_given_should_fail():Dynamic;
}