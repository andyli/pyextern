...
@:pythonImport("pandas.io.tests.test_gbq", "TestGBQConnectorIntegration") extern class TestGBQConnectorIntegration {
	/**
	...
	**/
	...
	public function test_should_be_able_to_get_a_bigquery_service():Dynamic;
	public function test_should_be_able_to_get_results_from_query():Dynamic;
	public function test_should_be_able_to_get_schema_from_query():Dynamic;
	public function test_should_be_able_to_get_valid_credentials():Dynamic;
	public function test_should_be_able_to_make_a_connector():Dynamic;
}