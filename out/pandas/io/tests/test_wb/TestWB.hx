...
package pandas.io.tests.test_wb;
@:pythonImport("pandas.io.tests.test_wb", "TestWB") extern class TestWB {
	/**
	...
	**/
	...
	public function test_wdi_download():Dynamic;
	public function test_wdi_download_w_crash_inducing_countrycode():Dynamic;
	public function test_wdi_download_w_retired_indicator():Dynamic;
	public function test_wdi_get_countries():Dynamic;
	public function test_wdi_search():Dynamic;
}