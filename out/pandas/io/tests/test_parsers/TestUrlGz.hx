...
@:pythonImport("pandas.io.tests.test_parsers", "TestUrlGz") extern class TestUrlGz {
	/**
	...
	**/
	...
	public function test_url_gz():Dynamic;
	public function test_url_gz_infer():Dynamic;
}