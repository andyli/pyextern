...
@:pythonImport("pandas.io.tests.test_parsers", "TestCParserHighMemory") extern class TestCParserHighMemory {
	/**
	...
	**/
	...
	public function test_dtype_and_names_error():Dynamic;
	...
	public function test_parse_dates_empty_string():Dynamic;
	...
	public function test_skiprows_lineterminator():Dynamic;
	...
	public function test_trailing_spaces():Dynamic;
