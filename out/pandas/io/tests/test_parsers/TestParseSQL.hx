...
@:pythonImport("pandas.io.tests.test_parsers", "TestParseSQL") extern class TestParseSQL {
	/**
	...
	**/
	...
	public function test_convert_sql_column_bools():Dynamic;
	public function test_convert_sql_column_decimals():Dynamic;
	public function test_convert_sql_column_floats():Dynamic;
	public function test_convert_sql_column_ints():Dynamic;
	public function test_convert_sql_column_longs():Dynamic;
	public function test_convert_sql_column_strings():Dynamic;
	public function test_convert_sql_column_unicode():Dynamic;
}