...
@:pythonImport("pandas.io.tests.test_parsers", "TestFwfColspaceSniffing") extern class TestFwfColspaceSniffing {
	/**
	...
	**/
	...
	public function test_full_file():Dynamic;
	public function test_full_file_with_missing():Dynamic;
	public function test_full_file_with_spaces():Dynamic;
	public function test_full_file_with_spaces_and_missing():Dynamic;
	public function test_messed_up_data():Dynamic;
	public function test_multiple_delimiters():Dynamic;
	public function test_variable_width_unicode():Dynamic;
}