...
package pandas.io.tests.test_date_converters;
@:pythonImport("pandas.io.tests.test_date_converters", "TestConverters") extern class TestConverters {
	/**
	...
	**/
	...
	public function test_dateparser_resolution_if_not_ns():Dynamic;
	public function test_datetime_fractional_seconds():Dynamic;
	public function test_datetime_six_col():Dynamic;
	public function test_generic():Dynamic;
	public function test_parse_date_fields():Dynamic;
	public function test_parse_date_time():Dynamic;
}