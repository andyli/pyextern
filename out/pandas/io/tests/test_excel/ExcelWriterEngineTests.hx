...
@:pythonImport("pandas.io.tests.test_excel", "ExcelWriterEngineTests") extern class ExcelWriterEngineTests {
	/**
	...
	**/
	...
	public function test_ExcelWriter_dispatch():Dynamic;
	public function test_register_writer():Dynamic;
}