...
@:pythonImport("pandas.io.tests.test_excel", "Openpyxl20Tests") extern class Openpyxl20Tests {
	/**
	...
	**/
	...
	static public function check_skip(args:Dynamic, kwargs:Dynamic):Dynamic;
	...
	**/
	...
	public function test_write_cells_merge_styled():Dynamic;
