...
@:pythonImport("pandas.io.tests.test_data", "TestDataReader") extern class TestDataReader {
	/**
	...
	**/
	...
	public function test_is_s3_url():Dynamic;
	public function test_read_famafrench():Dynamic;
	public function test_read_fred():Dynamic;
	public function test_read_google():Dynamic;
	public function test_read_yahoo():Dynamic;
}