...
@:pythonImport("pandas.io.tests.test_data", "TestFred") extern class TestFred {
	/**
	...
	**/
	...
	public function test_fred():Dynamic;
	public function test_fred_multi():Dynamic;
	public function test_fred_multi_bad_series():Dynamic;
	public function test_fred_nan():Dynamic;
	public function test_fred_part2():Dynamic;
	public function test_fred_parts():Dynamic;
	public function test_invalid_series():Dynamic;
}