...
package pandas.io.tests.test_json_norm;
@:pythonImport("pandas.io.tests.test_json_norm", "TestJSONNormalize") extern class TestJSONNormalize {
	/**
	...
	**/
	...
	public function test_meta_name_conflict():Dynamic;
	public function test_more_deeply_nested():Dynamic;
	public function test_record_prefix():Dynamic;
	public function test_shallow_nested():Dynamic;
	public function test_simple_normalize():Dynamic;
	public function test_simple_records():Dynamic;
}