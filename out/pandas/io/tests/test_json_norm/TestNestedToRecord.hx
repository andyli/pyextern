...
@:pythonImport("pandas.io.tests.test_json_norm", "TestNestedToRecord") extern class TestNestedToRecord {
	/**
	...
	**/
	...
	public function test_flat_stays_flat():Dynamic;
	public function test_nested_flattens():Dynamic;
	public function test_one_level_deep_flattens():Dynamic;
}