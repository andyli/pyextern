...
@:pythonImport("pandas.io.tests.test_packers", "TestCompression") extern class TestCompression {
	/**
	...
	**/
	...
	public function test_compression_blosc():Dynamic;
	public function test_compression_zlib():Dynamic;
	public function test_plain():Dynamic;
}