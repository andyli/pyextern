...
@:pythonImport("pandas.io.tests.test_packers", "TestSparse") extern class TestSparse {
	/**
	...
	**/
	...
	public function _check_roundtrip(obj:Dynamic, comparator:Dynamic, kwargs:Dynamic):Dynamic;
	...
	**/
	...
	public function test_sparse_frame():Dynamic;
	public function test_sparse_panel():Dynamic;
	public function test_sparse_series():Dynamic;
}