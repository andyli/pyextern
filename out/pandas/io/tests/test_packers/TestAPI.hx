...
@:pythonImport("pandas.io.tests.test_packers", "TestAPI") extern class TestAPI {
	/**
	...
	**/
	...
	public function test_invalid_arg():Dynamic;
	public function test_iterator_with_string_io():Dynamic;
