...
@:pythonImport("pandas.io.tests.test_packers", "TestNDFrame") extern class TestNDFrame {
	/**
	...
	**/
	...
	public function test_basic_frame():Dynamic;
	public function test_basic_panel():Dynamic;
	public function test_dataframe_duplicate_column_names():Dynamic;
	public function test_iterator():Dynamic;
	public function test_multi():Dynamic;
	public function tests_datetimeindex_freq_issue():Dynamic;
}