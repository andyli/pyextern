...
@:pythonImport("pandas.io.tests.test_packers", "TestIndex") extern class TestIndex {
	/**
	...
	**/
	...
	public function test_basic_index():Dynamic;
	public function test_multi_index():Dynamic;
