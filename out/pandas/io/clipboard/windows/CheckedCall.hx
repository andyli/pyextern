...
package pandas.io.clipboard.windows;
@:pythonImport("pandas.io.clipboard.windows", "CheckedCall") extern class CheckedCall {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(f:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
