...
@:pythonImport("pandas.io.clipboard") extern class Clipboard_Module {
	static public var CHECK_CMD : Dynamic;
	...
	static public function clipboard_get(?args:python.VarArgs<Dynamic>, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	static public function clipboard_set(?args:python.VarArgs<Dynamic>, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	static public function copy(?args:python.VarArgs<Dynamic>, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	static public function determine_clipboard():Dynamic;
	static public function init_gtk_clipboard():Dynamic;
	static public function init_klipper_clipboard():Dynamic;
	static public function init_no_clipboard():Dynamic;
	static public function init_osx_clipboard():Dynamic;
	...
	static public function paste(?args:python.VarArgs<Dynamic>, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
