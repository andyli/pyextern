...
@:pythonImport("pandas.io.excel", "_XlwtWriter") extern class _XlwtWriter {
	...
	**/
	@:native("__init__")
	public function ___init__(path:Dynamic, ?engine:Dynamic, ?encoding:Dynamic, ?engine_kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(path:Dynamic, ?engine:Dynamic, ?encoding:Dynamic, ?engine_kwargs:python.KwArgs<Dynamic>):Void;
	/**
