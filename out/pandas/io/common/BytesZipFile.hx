...
@:pythonImport("pandas.io.common", "BytesZipFile") extern class BytesZipFile {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(file:Dynamic, mode:Dynamic, ?compression:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
		Open the ZIP file with mode read 'r', write 'w', exclusive create 'x',
		or append 'a'.
	**/
	public function new(file:Dynamic, mode:Dynamic, ?compression:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Void;
	/**
	...
	**/
	public function writestr(zinfo_or_arcname:Dynamic, data:Dynamic, ?compress_type:Dynamic):Dynamic;
}