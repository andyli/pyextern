...
@:pythonImport("pandas.io.pytables", "LegacySeriesFixed") extern class LegacySeriesFixed {
	/**
	...
	**/
	...
	public function read_index_legacy(key:Dynamic, ?start:Dynamic, ?stop:Dynamic):Dynamic;
