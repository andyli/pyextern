...
@:pythonImport("pandas.io.pytables", "AppendableFrameTable") extern class AppendableFrameTable {
	/**
	...
	**/
	...
	/**
		...
		axes
	**/
	public function read(?where:Dynamic, ?columns:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
	...
	**/
	...
	public function write(obj:Dynamic, ?axes:Dynamic, ?append:Dynamic, ?complib:Dynamic, ?complevel:Dynamic, ?fletcher32:Dynamic, ?min_itemsize:Dynamic, ?chunksize:Dynamic, ?expectedrows:Dynamic, ?dropna:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
