...
package pandas._window;
@:pythonImport("pandas._window") extern class _Window_Module {
	...
	**/
	static public function roll_max(input:Dynamic, win:Dynamic, minp:Dynamic, index:Dynamic):Dynamic;
	...
	/**
		...
		index: ndarray, optional
		   index for window computation
	**/
	static public function roll_min(input:Dynamic, win:Dynamic, minp:Dynamic, index:Dynamic):Dynamic;
	/**
