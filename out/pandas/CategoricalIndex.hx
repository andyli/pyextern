...
package pandas;
@:pythonImport("pandas", "CategoricalIndex") extern class CategoricalIndex {
	public function add_categories(?varargs:python.VarArgs<Dynamic>, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	...
	public function as_ordered(?varargs:python.VarArgs<Dynamic>, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	public function as_unordered(?varargs:python.VarArgs<Dynamic>, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	...
	public function get_loc(key:Dynamic, ?method:Dynamic = null, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	...
	public function groupby(to_groupby:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	...
	public function is_type_compatible(kind:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	public function isin(values:Dynamic, ?level:Dynamic = null, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	...
	public function map(mapper:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	...
	public function remove_categories(?varargs:python.VarArgs<Dynamic>, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	public function remove_unused_categories(?varargs:python.VarArgs<Dynamic>, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	public function rename(name:Dynamic, ?inplace:Dynamic = false, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	public function rename_categories(?varargs:python.VarArgs<Dynamic>, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	public function reorder_categories(?varargs:python.VarArgs<Dynamic>, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	public function repeat(n:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	public function searchsorted(key:Dynamic, ?side:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	public function set_categories(?varargs:python.VarArgs<Dynamic>, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	...
	public function shift(?periods:Dynamic, ?freq:Dynamic = null, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	...
	public function take(indexer:Dynamic, ?axis:Dynamic, ?allow_fill:Dynamic = true, ?fill_value:Dynamic = null, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	...
	public function to_series(?varargs:python.VarArgs<Dynamic>, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
