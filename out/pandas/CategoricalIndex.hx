...
package pandas;
@:native("pandas.CategoricalIndex") extern class CategoricalIndex {
	public function add_categories(args:haxe.extern.Rest<Dynamic>):Dynamic;
	...
	public function as_ordered(args:haxe.extern.Rest<Dynamic>):Void;
	public function as_unordered(args:haxe.extern.Rest<Dynamic>):Void;
	...
	public function get_loc(key:Dynamic, ?method:Dynamic = null):Dynamic;
	...
	public function remove_categories(args:haxe.extern.Rest<Dynamic>):Dynamic;
	public function remove_unused_categories(args:haxe.extern.Rest<Dynamic>):Dynamic;
	public function rename(name:Dynamic, ?inplace:Dynamic = false):Dynamic;
	public function rename_categories(args:haxe.extern.Rest<Dynamic>):Dynamic;
	public function reorder_categories(args:haxe.extern.Rest<Dynamic>):Dynamic;
	public function repeat(n:Dynamic):Void;
	public function searchsorted(key:Dynamic, ?side:Dynamic):Void;
	public function set_categories(args:haxe.extern.Rest<Dynamic>):Dynamic;
	...
	public function take(indexer:Dynamic, ?axis:Dynamic, ?allow_fill:Dynamic = true, ?fill_value:Dynamic = null):Void;
