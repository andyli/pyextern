...
package pandas.sparse.list;
@:pythonImport("pandas.sparse.list", "SparseList") extern class SparseList {
	/**
	...
	**/
	public function __init__(?data:Dynamic, ?fill_value:Dynamic):Dynamic;
	/**
		Return self<=value.
	**/
	...
	**/
	...
	public function __setitem__(i:Dynamic, value:Dynamic):Dynamic;
	/**
		__sizeof__() -> int
