...
@:pythonImport("pandas.sparse.tests.test_list", "TestSparseList") extern class TestSparseList {
	/**
	...
	**/
	...
	public function test_append_na():Dynamic;
	public function test_append_zero():Dynamic;
