...
@:pythonImport("pandas.sparse.tests.test_libsparse", "TestBlockIndex") extern class TestBlockIndex {
	/**
	...
	**/
	...
	public function test_check_integrity():Dynamic;
	public function test_equals():Dynamic;
	public function test_to_block_index():Dynamic;
	public function test_to_int_index():Dynamic;
}