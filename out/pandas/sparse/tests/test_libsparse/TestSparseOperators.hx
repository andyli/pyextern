...
package pandas.sparse.tests.test_libsparse;
@:pythonImport("pandas.sparse.tests.test_libsparse", "TestSparseOperators") extern class TestSparseOperators {
	/**
	...
	**/
	...
	public function _nan_op_tests(sparse_op:Dynamic, python_op:Dynamic):Dynamic;
	public function _op_tests(sparse_op:Dynamic, python_op:Dynamic):Dynamic;
	...
	**/
	...
	public function test_floordiv():Dynamic;
	public function test_mul():Dynamic;
	public function test_nanadd():Dynamic;
	public function test_nanfloordiv():Dynamic;
	public function test_nanmul():Dynamic;
	public function test_nansub():Dynamic;
	public function test_nantruediv():Dynamic;
