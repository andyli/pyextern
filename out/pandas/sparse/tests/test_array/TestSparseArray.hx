...
package pandas.sparse.tests.test_array;
@:pythonImport("pandas.sparse.tests.test_array", "TestSparseArray") extern class TestSparseArray {
	/**
	...
	**/
	...
	public function test_bad_take():Dynamic;
	public function test_binary_operators():Dynamic;
	public function test_constructor_copy():Dynamic;
	public function test_constructor_from_sparse():Dynamic;
	public function test_copy_shallow():Dynamic;
	public function test_get_item():Dynamic;
	public function test_getitem():Dynamic;
	public function test_getslice():Dynamic;
	public function test_pickle():Dynamic;
	public function test_set_item():Dynamic;
	public function test_values_asarray():Dynamic;
}