...
@:pythonImport("pandas.tseries.converter", "MilliSecondLocator") extern class MilliSecondLocator {
	static public var MAXTICKS : Dynamic;
	static public var UNIT : Dynamic;
	/**
	...
	**/
	public function __init__(tz:Dynamic):Dynamic;
	/**
		Return self<=value.
	**/
