...
package pandas.tseries.tests.test_daterange;
@:pythonImport("pandas.tseries.tests.test_daterange", "TestDateRange") extern class TestDateRange {
	/**
	...
	**/
	...
	public function test_cached_range():Dynamic;
	public function test_cached_range_bug():Dynamic;
	public function test_comparison():Dynamic;
	public function test_constructor():Dynamic;
	public function test_copy():Dynamic;
	public function test_date_parse_failure():Dynamic;
	public function test_daterange_bug_456():Dynamic;
	public function test_equals():Dynamic;
	public function test_error_with_zero_monthends():Dynamic;
	public function test_freq_divides_end_in_nanos():Dynamic;
	public function test_getitem():Dynamic;
	public function test_getitem_matplotlib_hackaround():Dynamic;
	public function test_identical():Dynamic;
	public function test_intersection():Dynamic;
	public function test_intersection_bug():Dynamic;
	public function test_misc():Dynamic;
	public function test_month_range_union_tz_dateutil():Dynamic;
	public function test_month_range_union_tz_pytz():Dynamic;
	public function test_naive_aware_conflicts():Dynamic;
	public function test_outer_join():Dynamic;
	public function test_pickle_unpickle():Dynamic;
	public function test_range_bug():Dynamic;
	public function test_range_closed():Dynamic;
	public function test_range_tz_dateutil():Dynamic;
	public function test_range_tz_dst_straddle_pytz():Dynamic;
	public function test_range_tz_pytz():Dynamic;
	public function test_repr():Dynamic;
	public function test_shift():Dynamic;
	public function test_summary():Dynamic;
	public function test_summary_dateutil():Dynamic;
	public function test_summary_pytz():Dynamic;
	public function test_timezone_comparaison_assert():Dynamic;
	public function test_timezone_comparaison_bug():Dynamic;
	public function test_union():Dynamic;
	public function test_union_not_cacheable():Dynamic;
	public function test_years_only():Dynamic;
}