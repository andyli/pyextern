...
@:pythonImport("pandas.tseries.tests.test_daterange", "TestGenRangeGeneration") extern class TestGenRangeGeneration {
	/**
	...
	**/
	...
	public function test_generate():Dynamic;
	public function test_generate_cday():Dynamic;
	public function test_precision_finer_than_offset():Dynamic;
}