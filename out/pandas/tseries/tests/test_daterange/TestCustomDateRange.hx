...
@:pythonImport("pandas.tseries.tests.test_daterange", "TestCustomDateRange") extern class TestCustomDateRange {
	/**
	...
	**/
	...
	public function test_cdaterange():Dynamic;
	public function test_cdaterange_holidays():Dynamic;
	public function test_cdaterange_weekmask():Dynamic;
	public function test_cdaterange_weekmask_and_holidays():Dynamic;
