...
@:pythonImport("pandas.tseries.tests.test_tslib", "TestDatetimeParsingWrappers") extern class TestDatetimeParsingWrappers {
	/**
	...
	**/
	...
	public function test_parsers():Dynamic;
	public function test_parsers_dayfirst_yearfirst():Dynamic;
	public function test_parsers_monthfreq():Dynamic;
	public function test_parsers_quarter_invalid():Dynamic;
	public function test_parsers_quarterly_with_freq():Dynamic;
	public function test_parsers_timestring():Dynamic;
}