...
@:pythonImport("pandas.tseries.tests.test_tslib", "TestTimestampNsOperations") extern class TestTimestampNsOperations {
	/**
	...
	**/
	...
	public function assert_ns_timedelta(modified_timestamp:Dynamic, expected_value:Dynamic):Dynamic;
	/**
	...
	**/
	...
	public function test_nanosecond_string_parsing():Dynamic;
	public function test_nanosecond_timestamp():Dynamic;
	public function test_nat_arithmetic():Dynamic;
	public function test_timedelta_ms_arithmetic():Dynamic;
	public function test_timedelta_ns_arithmetic():Dynamic;
	public function test_timedelta_ns_based_arithmetic():Dynamic;
	public function test_timedelta_us_arithmetic():Dynamic;
}