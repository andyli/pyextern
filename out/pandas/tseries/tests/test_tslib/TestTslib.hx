...
@:pythonImport("pandas.tseries.tests.test_tslib", "TestTslib") extern class TestTslib {
	/**
	...
	**/
	...
	public function test_intraday_conversion_factors():Dynamic;
	public function test_period_ordinal_business_day():Dynamic;
	public function test_period_ordinal_start_values():Dynamic;
	public function test_period_ordinal_week():Dynamic;
	public function test_shift_months():Dynamic;
	public function test_tslib_tz_convert():Dynamic;
}