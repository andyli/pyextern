...
@:pythonImport("pandas.tseries.tests.test_tslib", "TestArrayToDatetime") extern class TestArrayToDatetime {
	/**
	...
	**/
	...
	public function test_coerce_of_invalid_datetimes():Dynamic;
	public function test_coercing_dates_outside_of_datetime64_ns_bounds():Dynamic;
	public function test_number_looking_strings_not_into_datetime():Dynamic;
	public function test_parsing_timezone_offsets():Dynamic;
	public function test_parsing_valid_dates():Dynamic;
}