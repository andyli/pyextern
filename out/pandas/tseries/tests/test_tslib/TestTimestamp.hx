...
package pandas.tseries.tests.test_tslib;
@:pythonImport("pandas.tseries.tests.test_tslib", "TestTimestamp") extern class TestTimestamp {
	/**
	...
	**/
	...
	public function test_barely_oob_dts():Dynamic;
	public function test_bounds_with_different_units():Dynamic;
	public function test_constructor():Dynamic;
	public function test_constructor_invalid():Dynamic;
	public function test_constructor_with_stringoffset():Dynamic;
	public function test_conversion():Dynamic;
	public function test_fields():Dynamic;
	public function test_nat_fields():Dynamic;
	public function test_now():Dynamic;
	public function test_repr():Dynamic;
	public function test_today():Dynamic;
	public function test_tz():Dynamic;
	public function test_tz_convert_roundtrip():Dynamic;
	public function test_tz_localize_ambiguous():Dynamic;
	public function test_tz_localize_roundtrip():Dynamic;
	public function test_utc_z_designator():Dynamic;
}