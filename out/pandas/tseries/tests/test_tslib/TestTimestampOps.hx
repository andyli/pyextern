...
@:pythonImport("pandas.tseries.tests.test_tslib", "TestTimestampOps") extern class TestTimestampOps {
	/**
	...
	**/
	...
	public function test_addition_subtraction_preserve_frequency():Dynamic;
	public function test_addition_subtraction_types():Dynamic;
	public function test_resolution():Dynamic;
	public function test_timestamp_and_datetime():Dynamic;
	public function test_timestamp_and_series():Dynamic;
}