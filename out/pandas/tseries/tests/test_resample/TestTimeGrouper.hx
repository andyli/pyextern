...
@:pythonImport("pandas.tseries.tests.test_resample", "TestTimeGrouper") extern class TestTimeGrouper {
	/**
	...
	**/
	...
	public function test_aggregate_normal():Dynamic;
	public function test_aggregate_with_nat():Dynamic;
	public function test_apply():Dynamic;
	public function test_apply_iteration():Dynamic;
	public function test_count():Dynamic;
	public function test_fails_on_no_datetime_index():Dynamic;
	public function test_numpy_reduction():Dynamic;
	public function test_panel_aggregation():Dynamic;
}