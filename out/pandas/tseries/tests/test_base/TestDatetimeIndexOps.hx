...
@:pythonImport("pandas.tseries.tests.test_base", "TestDatetimeIndexOps") extern class TestDatetimeIndexOps {
	/**
	...
	**/
	...
	public function test_ops_properties_basic():Dynamic;
	...
	public function test_resolution():Dynamic;
