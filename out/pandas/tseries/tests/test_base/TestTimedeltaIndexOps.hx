...
package pandas.tseries.tests.test_base;
@:pythonImport("pandas.tseries.tests.test_base", "TestTimedeltaIndexOps") extern class TestTimedeltaIndexOps {
	/**
	...
	**/
	...
	public function check_ops_properties(props:Dynamic, ?filter:Dynamic, ?ignore_failures:Dynamic):Dynamic;
	...
	**/
	...
	public function test_add_iadd():Dynamic;
	public function test_addition_ops():Dynamic;
	public function test_asobject_tolist():Dynamic;
	public function test_binary_ops_docs():Dynamic;
	public function test_drop_duplicates_metadata():Dynamic;
	public function test_dti_dti_deprecated_ops():Dynamic;
	public function test_dti_tdi_numeric_ops():Dynamic;
	public function test_getitem():Dynamic;
	public function test_infer_freq():Dynamic;
	public function test_minmax():Dynamic;
	public function test_nonunique_contains():Dynamic;
	public function test_ops_compat():Dynamic;
	public function test_ops_properties():Dynamic;
	public function test_order():Dynamic;
	public function test_representation():Dynamic;
	public function test_representation_to_series():Dynamic;
	public function test_sub_isub():Dynamic;
	public function test_subtraction_ops():Dynamic;
	public function test_subtraction_ops_with_tz():Dynamic;
	public function test_summary():Dynamic;
	public function test_take():Dynamic;
	public function test_unknown_attribute():Dynamic;
	public function test_value_counts_unique():Dynamic;
}