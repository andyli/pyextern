...
@:pythonImport("pandas.tseries.tests.test_period") extern class Test_period {
	...
	static public function _permute(obj:Dynamic):Dynamic;
	/**
	...
	**/
	...
	static public function noWrap(item:Dynamic):Dynamic;
	/**
		Return a fixed frequency datetime index, with day (calendar) as the default
		frequency
