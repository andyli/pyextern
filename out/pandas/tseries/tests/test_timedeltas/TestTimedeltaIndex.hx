...
@:pythonImport("pandas.tseries.tests.test_timedeltas", "TestTimedeltaIndex") extern class TestTimedeltaIndex {
	/**
	...
	**/
	...
	public function test_components():Dynamic;
	...
	public function test_pass_TimedeltaIndex_to_index():Dynamic;
	...
	public function test_total_seconds():Dynamic;
	public function test_total_seconds_scalar():Dynamic;
