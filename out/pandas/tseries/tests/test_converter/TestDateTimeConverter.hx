...
package pandas.tseries.tests.test_converter;
@:pythonImport("pandas.tseries.tests.test_converter", "TestDateTimeConverter") extern class TestDateTimeConverter {
	/**
	...
	**/
	...
	public function test_conversion_float():Dynamic;
	public function test_convert_accepts_unicode():Dynamic;
	public function test_dateindex_conversion():Dynamic;
	public function test_resolution():Dynamic;
	public function test_time_formatter():Dynamic;
}