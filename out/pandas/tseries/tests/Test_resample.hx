...
@:pythonImport("pandas.tseries.tests.test_resample") extern class Test_resample {
	...
	static public function _simple_pts(start:Dynamic, end:Dynamic, ?freq:Dynamic):Dynamic;
