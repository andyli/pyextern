...
@:pythonImport("pandas.tseries.tests.test_timezones", "TestTimeZoneCacheKey") extern class TestTimeZoneCacheKey {
	/**
	...
	**/
	...
	public function test_cache_keys_are_distinct_for_pytz_vs_dateutil():Dynamic;
}