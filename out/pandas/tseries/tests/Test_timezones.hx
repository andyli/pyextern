...
@:pythonImport("pandas.tseries.tests.test_timezones") extern class Test_timezones {
	...
	**/
	...
	static public var fixed_off : Dynamic;
	static public var fixed_off_no_name : Dynamic;
	/**
