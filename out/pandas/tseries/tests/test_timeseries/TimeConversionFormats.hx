...
@:pythonImport("pandas.tseries.tests.test_timeseries", "TimeConversionFormats") extern class TimeConversionFormats {
	/**
	...
	**/
	...
	public function test_parse_nanoseconds_with_formula():Dynamic;
	public function test_to_datetime_format():Dynamic;
	public function test_to_datetime_format_YYYYMMDD():Dynamic;
	public function test_to_datetime_format_integer():Dynamic;
	public function test_to_datetime_format_microsecond():Dynamic;
	public function test_to_datetime_format_time():Dynamic;
	public function test_to_datetime_format_weeks():Dynamic;
	public function test_to_datetime_with_non_exact():Dynamic;
}