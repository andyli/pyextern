...
@:pythonImport("pandas.tseries.tests.test_timeseries", "TestDateTimeIndexToJulianDate") extern class TestDateTimeIndexToJulianDate {
	/**
	...
	**/
	...
	public function test_1700():Dynamic;
	public function test_2000():Dynamic;
