...
@:pythonImport("pandas.tseries.tests.test_timeseries", "TestTimeSeriesDuplicates") extern class TestTimeSeriesDuplicates {
	/**
	...
	**/
	...
	public function test_duplicate_dates_indexing():Dynamic;
	public function test_groupby_average_dup_values():Dynamic;
	public function test_index_dupes_contains():Dynamic;
	public function test_index_unique():Dynamic;
	public function test_indexing():Dynamic;
	public function test_indexing_over_size_cutoff():Dynamic;
	public function test_indexing_unordered():Dynamic;
	public function test_is_unique_monotonic():Dynamic;
	public function test_range_slice():Dynamic;
