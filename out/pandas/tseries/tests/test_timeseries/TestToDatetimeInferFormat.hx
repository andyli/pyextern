...
@:pythonImport("pandas.tseries.tests.test_timeseries", "TestToDatetimeInferFormat") extern class TestToDatetimeInferFormat {
	/**
	...
	**/
	...
	public function test_to_datetime_infer_datetime_format_consistent_format():Dynamic;
	public function test_to_datetime_infer_datetime_format_inconsistent_format():Dynamic;
	public function test_to_datetime_infer_datetime_format_series_starting_with_nans():Dynamic;
	public function test_to_datetime_infer_datetime_format_series_with_nans():Dynamic;
}