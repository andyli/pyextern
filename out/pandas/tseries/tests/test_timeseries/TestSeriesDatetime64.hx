...
@:pythonImport("pandas.tseries.tests.test_timeseries", "TestSeriesDatetime64") extern class TestSeriesDatetime64 {
	/**
	...
	**/
	...
	public function test_NaT_cast():Dynamic;
	public function test_NaT_scalar():Dynamic;
	public function test_auto_conversion():Dynamic;
	public function test_between():Dynamic;
	public function test_constructor_cant_cast_datetime64():Dynamic;
	public function test_date_range_bms_bug():Dynamic;
	public function test_date_range_businesshour():Dynamic;
	public function test_intercept_astype_object():Dynamic;
	public function test_intersection():Dynamic;
	public function test_series_comparison_scalars():Dynamic;
	public function test_set_none_nan():Dynamic;
	public function test_string_index_series_name_converted():Dynamic;
