...
@:pythonImport("pandas.tseries.tests.test_timeseries", "TestGuessDatetimeFormat") extern class TestGuessDatetimeFormat {
	/**
	...
	**/
	...
	public function test_guess_datetime_format_for_array():Dynamic;
	public function test_guess_datetime_format_invalid_inputs():Dynamic;
	public function test_guess_datetime_format_nopadding():Dynamic;
	public function test_guess_datetime_format_with_dayfirst():Dynamic;
	public function test_guess_datetime_format_with_locale_specific_formats():Dynamic;
	public function test_guess_datetime_format_with_parseable_formats():Dynamic;
}