...
@:pythonImport("pandas.tseries.tests.test_timeseries", "TestDaysInMonth") extern class TestDaysInMonth {
	/**
	...
	**/
	...
	public function test_coerce_deprecation():Dynamic;
	public function test_day_not_in_month_coerce():Dynamic;
	public function test_day_not_in_month_ignore():Dynamic;
	public function test_day_not_in_month_raise():Dynamic;
}