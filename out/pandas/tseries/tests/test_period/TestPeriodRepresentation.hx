...
@:pythonImport("pandas.tseries.tests.test_period", "TestPeriodRepresentation") extern class TestPeriodRepresentation {
	/**
	...
	**/
	...
	public function _check_freq(freq:Dynamic, base_date:Dynamic):Dynamic;
	...
	**/
	...
	public function test_daily():Dynamic;
	public function test_hourly():Dynamic;
	public function test_microsecondly():Dynamic;
	public function test_millisecondly():Dynamic;
	public function test_minutely():Dynamic;
	public function test_monthly():Dynamic;
	public function test_nanosecondly():Dynamic;
	public function test_negone_ordinals():Dynamic;
	public function test_secondly():Dynamic;
