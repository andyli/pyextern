...
@:pythonImport("pandas.tseries.tests.test_period", "TestMethods") extern class TestMethods {
	/**
	...
	**/
	...
	public function test_add_offset():Dynamic;
	public function test_add_offset_nat():Dynamic;
	public function test_nat_ops():Dynamic;
	public function test_pi_ops_array():Dynamic;
	public function test_pi_ops_nat():Dynamic;
	public function test_sub_offset():Dynamic;
	public function test_sub_offset_nat():Dynamic;
}