...
package pandas.tseries.tests.test_holiday;
@:pythonImport("pandas.tseries.tests.test_holiday", "TestObservanceRules") extern class TestObservanceRules {
	/**
	...
	**/
	...
	public function test_after_nearest_workday():Dynamic;
	public function test_before_nearest_workday():Dynamic;
	public function test_nearest_workday():Dynamic;
	public function test_next_monday():Dynamic;
	public function test_next_monday_or_tuesday():Dynamic;
	public function test_next_workday():Dynamic;
	public function test_previous_friday():Dynamic;
	public function test_previous_workday():Dynamic;
	public function test_sunday_to_monday():Dynamic;
	public function test_weekend_to_monday():Dynamic;
}