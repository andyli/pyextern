...
@:pythonImport("pandas.tseries.tests.test_holiday", "TestHoliday") extern class TestHoliday {
	/**
	...
	**/
	...
	public function check_results(holiday:Dynamic, start:Dynamic, end:Dynamic, expected:Dynamic):Dynamic;
	...
	**/
	...
	public function test_argument_types():Dynamic;
	public function test_easter():Dynamic;
	public function test_factory():Dynamic;
	public function test_get_calendar():Dynamic;
	public function test_non_observed_holiday():Dynamic;
	public function test_special_holidays():Dynamic;
	public function test_usmemorialday():Dynamic;
	public function test_usthanksgivingday():Dynamic;
}