...
@:pythonImport("pandas.tseries.tests.test_frequencies", "TestFrequencyCode") extern class TestFrequencyCode {
	/**
	...
	**/
	...
	public function test_freq_code():Dynamic;
	public function test_freq_group():Dynamic;
	public function test_freq_to_reso():Dynamic;
	public function test_get_freq_code():Dynamic;
	public function test_get_to_timestamp_base():Dynamic;
}