...
@:pythonImport("pandas.tseries.tests.test_offsets", "TestCommon") extern class TestCommon {
	/**
	...
	**/
	...
	public function _check_offsetfunc_works(offset:Dynamic, funcname:Dynamic, dt:Dynamic, expected:Dynamic, ?normalize:Dynamic):Dynamic;
	...
	**/
	...
	public function test_offset_freqstr():Dynamic;
	public function test_offset_n():Dynamic;
	public function test_onOffset():Dynamic;
	public function test_pickle_v0_15_2():Dynamic;
	public function test_return_type():Dynamic;
	public function test_rollback():Dynamic;
	public function test_rollforward():Dynamic;
