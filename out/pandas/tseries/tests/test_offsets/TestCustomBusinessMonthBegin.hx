...
@:pythonImport("pandas.tseries.tests.test_offsets", "TestCustomBusinessMonthBegin") extern class TestCustomBusinessMonthBegin {
	/**
	...
	**/
	static public function _object(?n:Dynamic, ?normalize:Dynamic, ?weekmask:Dynamic, ?holidays:Dynamic, ?calendar:Dynamic, kwds:Dynamic):Dynamic;
	static public var _offset : Dynamic;
