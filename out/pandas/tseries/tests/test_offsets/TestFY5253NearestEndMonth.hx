...
@:pythonImport("pandas.tseries.tests.test_offsets", "TestFY5253NearestEndMonth") extern class TestFY5253NearestEndMonth {
	/**
	...
	**/
	...
	public function test_get_target_month_end():Dynamic;
	public function test_get_year_end():Dynamic;
