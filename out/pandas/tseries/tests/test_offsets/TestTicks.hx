...
@:pythonImport("pandas.tseries.tests.test_offsets", "TestTicks") extern class TestTicks {
	/**
	...
	**/
	...
	public function test_MillisecondTimestampArithmetic():Dynamic;
	public function test_Minute():Dynamic;
	public function test_Nanosecond():Dynamic;
	public function test_NanosecondGeneric():Dynamic;
	public function test_Second():Dynamic;
	public function test_compare_ticks():Dynamic;
	public function test_tick_equalities():Dynamic;
	public function test_tick_offset():Dynamic;
	public function test_tick_operators():Dynamic;
	public function test_tick_zero():Dynamic;
	public function test_ticks():Dynamic;
	static public var ticks : Dynamic;
}