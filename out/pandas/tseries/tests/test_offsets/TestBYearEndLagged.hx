...
@:pythonImport("pandas.tseries.tests.test_offsets", "TestBYearEndLagged") extern class TestBYearEndLagged {
	/**
	...
	**/
	...
	public function test_bad_month_fail():Dynamic;
	public function test_offset():Dynamic;
	public function test_onOffset():Dynamic;
	public function test_roll():Dynamic;
