...
@:pythonImport("pandas.tseries.tests.test_offsets", "TestFY5253LastOfMonthQuarter") extern class TestFY5253LastOfMonthQuarter {
	/**
	...
	**/
	...
	public function test_equality():Dynamic;
	public function test_get_weeks():Dynamic;
	public function test_isAnchored():Dynamic;
	public function test_offset():Dynamic;
	public function test_onOffset():Dynamic;
	public function test_year_has_extra_week():Dynamic;
