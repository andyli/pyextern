...
@:pythonImport("pandas.tseries.tests.test_offsets", "TestOffsetAliases") extern class TestOffsetAliases {
	/**
	...
	**/
	...
	public function test_alias_equality():Dynamic;
	public function test_rule_code():Dynamic;
}