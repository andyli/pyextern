...
@:pythonImport("pandas.tseries.tests.test_offsets", "TestParseTimeString") extern class TestParseTimeString {
	/**
	...
	**/
	...
	public function test_parse_time_quarter_w_dash():Dynamic;
	public function test_parse_time_string():Dynamic;
}