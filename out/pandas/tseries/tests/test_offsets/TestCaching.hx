...
@:pythonImport("pandas.tseries.tests.test_offsets", "TestCaching") extern class TestCaching {
	/**
	...
	**/
	...
	public function run_X_index_creation(cls:Dynamic):Dynamic;
	/**
	...
	**/
	...
	public function test_all_cacheableoffsets():Dynamic;
	public function test_bmonth_end_index_creation():Dynamic;
	public function test_month_end_index_creation():Dynamic;
	public function test_should_cache_bmonth_end():Dynamic;
	public function test_should_cache_month_end():Dynamic;
	public function test_should_cache_week_month():Dynamic;
	public function test_week_of_month_index_creation():Dynamic;
}