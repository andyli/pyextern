...
@:pythonImport("pandas.tseries.tests.test_offsets", "TestBusinessHour") extern class TestBusinessHour {
	/**
	...
	**/
	...
	/**
		...
		.. versionadded: 0.16.1
	**/
	static public function _offset(?n:Dynamic, ?normalize:Dynamic, kwds:Dynamic):Dynamic;
	...
	**/
	...
	public function test_apply_nanoseconds():Dynamic;
	public function test_apply_out_of_range():Dynamic;
	public function test_constructor_errors():Dynamic;
	...
	public function test_opening_time():Dynamic;
