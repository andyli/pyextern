...
@:pythonImport("pandas.tseries.tests.test_offsets", "TestDST") extern class TestDST {
	/**
	...
	**/
	...
	public function _make_timestamp(string:Dynamic, hrs_offset:Dynamic, tz:Dynamic):Dynamic;
	public function _test_all_offsets(n:Dynamic, kwds:Dynamic):Dynamic;
	public function _test_offset(offset_name:Dynamic, offset_n:Dynamic, tstart:Dynamic, expected_utc_offset:Dynamic):Dynamic;
	...
	**/
	...
	public function test_all_offset_classes():Dynamic;
	/**
		test moving from daylight savings to standard time
	**/
	public function test_fallback_plural():Dynamic;
	public function test_fallback_singular():Dynamic;
	/**
		test moving from standard to daylight savings
	**/
	public function test_springforward_plural():Dynamic;
	public function test_springforward_singular():Dynamic;
	static public var timezone_utc_offsets : Dynamic;
	static public var ts_pre_fallback : Dynamic;
	static public var ts_pre_springfwd : Dynamic;
	static public var valid_date_offsets_plural : Dynamic;
	static public var valid_date_offsets_singular : Dynamic;
}