...
package pandas.tseries.tests.test_util;
@:pythonImport("pandas.tseries.tests.test_util", "TestPivotAnnual") extern class TestPivotAnnual {
	/**
	...
	**/
	...
	public function test_period_daily():Dynamic;
	public function test_period_monthly():Dynamic;
	public function test_period_weekly():Dynamic;
