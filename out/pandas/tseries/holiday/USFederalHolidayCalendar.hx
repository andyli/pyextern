...
@:pythonImport("pandas.tseries.holiday", "USFederalHolidayCalendar") extern class USFederalHolidayCalendar {
	...
	**/
	...
	static public function __metaclass__(clsname:Dynamic, bases:Dynamic, attrs:Dynamic):Dynamic;
