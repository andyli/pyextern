...
@:pythonImport("pandas.tseries.offsets", "WeekOfMonth") extern class WeekOfMonth {
	...
	**/
	@:native("__init__")
	public function ___init__(?n:Dynamic, ?normalize:Dynamic, ?week:Dynamic, ?weekday:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(?n:Dynamic, ?normalize:Dynamic, ?week:Dynamic, ?weekday:Dynamic):Void;
	/**
	...
	**/
	...
	/**
		...
		day : int
	**/
	public function _get_offset_day(other:Dynamic):Int;
