...
@:pythonImport("pandas.tseries.offsets", "CustomBusinessHour") extern class CustomBusinessHour {
	...
	**/
	@:native("__init__")
	public function ___init__(?n:Dynamic, ?normalize:Dynamic, ?weekmask:Dynamic, ?holidays:Dynamic, ?calendar:Dynamic, ?start:Dynamic, ?end:Dynamic, ?offset:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(?n:Dynamic, ?normalize:Dynamic, ?weekmask:Dynamic, ?holidays:Dynamic, ?calendar:Dynamic, ?start:Dynamic, ?end:Dynamic, ?offset:Dynamic):Void;
	/**
