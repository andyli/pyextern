...
@:pythonImport("pandas.tseries.offsets", "Easter") extern class Easter {
	...
	**/
	@:native("__init__")
	public function ___init__(?n:Dynamic, ?kwds:python.KwArgs<Dynamic>):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(?n:Dynamic, ?kwds:python.KwArgs<Dynamic>):Void;
	/**
		Return self<=value.
	**/
