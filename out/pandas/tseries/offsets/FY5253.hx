...
@:pythonImport("pandas.tseries.offsets", "FY5253") extern class FY5253 {
	...
	**/
	...
	public function _get_prefix():Dynamic;
	public function _get_suffix_prefix():Dynamic;
	public function _get_year_end_last(dt:Dynamic):Dynamic;
	public function _get_year_end_nearest(dt:Dynamic):Dynamic;
	...
	static public function _parse_suffix(varion_code:Dynamic, startingMonth_code:Dynamic, weekday_code:Dynamic):Dynamic;
	static public var _prefix : Dynamic;
	public function _should_cache():Dynamic;
	static public var _suffix_prefix_last : Dynamic;
	static public var _suffix_prefix_nearest : Dynamic;
	...
	**/
	...
	public function get_target_month_end(dt:Dynamic):Dynamic;
