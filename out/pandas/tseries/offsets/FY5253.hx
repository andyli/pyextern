...
@:pythonImport("pandas.tseries.offsets", "FY5253") extern class FY5253 {
	...
	**/
	@:native("__init__")
	public function ___init__(?n:Dynamic, ?normalize:Dynamic, ?weekday:Dynamic, ?startingMonth:Dynamic, ?variation:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(?n:Dynamic, ?normalize:Dynamic, ?weekday:Dynamic, ?startingMonth:Dynamic, ?variation:Dynamic):Void;
	/**
