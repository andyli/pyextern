...
@:pythonImport("pandas.tseries.offsets", "BusinessDay") extern class BusinessDay {
	...
	**/
	@:native("__init__")
	public function ___init__(?n:Dynamic, ?normalize:Dynamic, ?offset:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(?n:Dynamic, ?normalize:Dynamic, ?offset:Dynamic):Void;
	/**
