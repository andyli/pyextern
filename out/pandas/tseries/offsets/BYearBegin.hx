...
@:pythonImport("pandas.tseries.offsets", "BYearBegin") extern class BYearBegin {
	...
	**/
	@:native("__init__")
	public function ___init__(?n:Dynamic, ?normalize:Dynamic, ?month:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(?n:Dynamic, ?normalize:Dynamic, ?month:Dynamic):Void;
	/**
	...
	**/
	...
	static public var _default_month : Dynamic;
