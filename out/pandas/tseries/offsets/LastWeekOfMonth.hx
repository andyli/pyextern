...
@:pythonImport("pandas.tseries.offsets", "LastWeekOfMonth") extern class LastWeekOfMonth {
	...
	**/
	@:native("__init__")
	public function ___init__(?n:Dynamic, ?normalize:Dynamic, ?weekday:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(?n:Dynamic, ?normalize:Dynamic, ?weekday:Dynamic):Void;
	/**
