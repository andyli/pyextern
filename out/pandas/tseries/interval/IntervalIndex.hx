...
@:pythonImport("pandas.tseries.interval", "IntervalIndex") extern class IntervalIndex {
	/**
	...
	**/
	static public function __new__(self:Dynamic, starts:Dynamic, ends:Dynamic):Dynamic;
