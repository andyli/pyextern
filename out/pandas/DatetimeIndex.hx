...
package pandas;
@:native("pandas.DatetimeIndex") extern class DatetimeIndex {
	...
	public function indexer_at_time(time:Dynamic, ?asof:Dynamic = false):Dynamic;
	public function indexer_between_time(start_time:Dynamic, end_time:Dynamic, ?include_start:Dynamic = true, ?include_end:Dynamic = true):Dynamic;
	...
	public function slice_indexer(?start:Dynamic = null, ?end:Dynamic = null, ?step:Dynamic = null, ?kind:Dynamic = null):Void;
	public function slice_locs(?start:Dynamic = null, ?end:Dynamic = null, ?step:Dynamic = null, ?kind:Dynamic = null):Dynamic;
	public function snap(?freq:Dynamic):Void;
	...
	public function union_many(others:Dynamic):Void;
