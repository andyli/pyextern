...
@:pythonImport("pandas.util.testing", "SubclassedDataFrame") extern class SubclassedDataFrame {
	/**
	...
	**/
	public function __init__(?data:Dynamic, ?index:Dynamic, ?columns:Dynamic, ?dtype:Dynamic, ?copy:Dynamic):Dynamic;
	...
	**/
	public function apply(func:Dynamic, ?axis:Dynamic, ?broadcast:Dynamic, ?raw:Dynamic, ?reduce:Dynamic, ?args:Dynamic, kwds:Dynamic):Dynamic;
	/**
