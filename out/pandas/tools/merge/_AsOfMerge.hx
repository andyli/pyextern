...
@:pythonImport("pandas.tools.merge", "_AsOfMerge") extern class _AsOfMerge {
	...
	**/
	@:native("__init__")
	public function ___init__(left:Dynamic, right:Dynamic, ?on:Dynamic, ?by:Dynamic, ?left_on:Dynamic, ?right_on:Dynamic, ?axis:Dynamic, ?suffixes:Dynamic, ?copy:Dynamic, ?fill_method:Dynamic, ?how:Dynamic, ?tolerance:Dynamic, ?allow_exact_matches:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(left:Dynamic, right:Dynamic, ?on:Dynamic, ?by:Dynamic, ?left_on:Dynamic, ?right_on:Dynamic, ?axis:Dynamic, ?suffixes:Dynamic, ?copy:Dynamic, ?fill_method:Dynamic, ?how:Dynamic, ?tolerance:Dynamic, ?allow_exact_matches:Dynamic):Void;
	/**
		Return self<=value.
	**/
	...
	**/
	public function _get_merge_data():Dynamic;
	/**
