...
@:pythonImport("pandas.tools.tests.test_pivot", "TestCrosstab") extern class TestCrosstab {
	/**
	...
	**/
	...
	public function test_crosstab_dropna():Dynamic;
	public function test_crosstab_margins():Dynamic;
	public function test_crosstab_multiple():Dynamic;
	public function test_crosstab_ndarray():Dynamic;
	public function test_crosstab_pass_values():Dynamic;
	public function test_crosstab_single():Dynamic;
}