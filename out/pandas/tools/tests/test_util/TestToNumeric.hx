...
package pandas.tools.tests.test_util;
@:pythonImport("pandas.tools.tests.test_util", "TestToNumeric") extern class TestToNumeric {
	/**
	...
	**/
	...
	public function test_all_nan():Dynamic;
	public function test_error():Dynamic;
	public function test_list():Dynamic;
	public function test_numeric():Dynamic;
