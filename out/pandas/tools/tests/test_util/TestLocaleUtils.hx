...
@:pythonImport("pandas.tools.tests.test_util", "TestLocaleUtils") extern class TestLocaleUtils {
	/**
	...
	**/
	...
	public function test_get_locales():Dynamic;
	public function test_get_locales_prefix():Dynamic;
	public function test_set_locale():Dynamic;
}