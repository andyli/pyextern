...
@:pythonImport("pandas.tools.tests.test_merge", "TestOrderedMerge") extern class TestOrderedMerge {
	/**
	...
	**/
	...
	public function test_empty_sequence_concat():Dynamic;
	public function test_ffill():Dynamic;
	public function test_merge_type():Dynamic;
	public function test_multigroup():Dynamic;
}