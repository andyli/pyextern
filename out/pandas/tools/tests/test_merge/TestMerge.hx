...
package pandas.tools.tests.test_merge;
@:pythonImport("pandas.tools.tests.test_merge", "TestMerge") extern class TestMerge {
	/**
	...
	**/
	...
	public function test_append_dtype_coerce():Dynamic;
	public function test_cython_inner_join():Dynamic;
	public function test_cython_left_outer_join():Dynamic;
	public function test_cython_right_outer_join():Dynamic;
	public function test_full_outer_join():Dynamic;
	public function test_handle_join_key_pass_array():Dynamic;
	public function test_handle_overlap():Dynamic;
	public function test_handle_overlap_arbitrary_key():Dynamic;
	public function test_indicator():Dynamic;
	public function test_inner_join():Dynamic;
	public function test_intelligently_handle_join_key():Dynamic;
	public function test_join_append_timedeltas():Dynamic;
	public function test_join_empty_bug():Dynamic;
	public function test_join_float64_float32():Dynamic;
	public function test_join_hierarchical_mixed():Dynamic;
	public function test_join_index_mixed():Dynamic;
	public function test_join_inner_multiindex():Dynamic;
	public function test_join_many_non_unique_index():Dynamic;
	public function test_join_multiindex():Dynamic;
	public function test_join_on():Dynamic;
	public function test_join_on_fails_with_different_column_counts():Dynamic;
	public function test_join_on_fails_with_different_left_index():Dynamic;
	public function test_join_on_fails_with_different_right_index():Dynamic;
	public function test_join_on_inner():Dynamic;
	public function test_join_on_pass_vector():Dynamic;
	public function test_join_on_series():Dynamic;
	public function test_join_on_series_buglet():Dynamic;
	public function test_join_on_singlekey_list():Dynamic;
	public function test_join_sort():Dynamic;
	public function test_join_unconsolidated():Dynamic;
	public function test_join_with_len0():Dynamic;
	public function test_left_merge_empty_dataframe():Dynamic;
	public function test_left_outer_join():Dynamic;
	public function test_merge_common():Dynamic;
	public function test_merge_copy():Dynamic;
	public function test_merge_different_column_key_names():Dynamic;
	public function test_merge_index_singlekey_inner():Dynamic;
	public function test_merge_index_singlekey_right_vs_left():Dynamic;
	public function test_merge_left_empty_right_empty():Dynamic;
	public function test_merge_left_empty_right_notempty():Dynamic;
	public function test_merge_left_notempty_right_empty():Dynamic;
	public function test_merge_misspecified():Dynamic;
	public function test_merge_nan_right():Dynamic;
	public function test_merge_nocopy():Dynamic;
	public function test_merge_non_unique_index_many_to_many():Dynamic;
	public function test_merge_non_unique_indexes():Dynamic;
	public function test_merge_nosort():Dynamic;
	public function test_merge_overlap():Dynamic;
	public function test_merge_type():Dynamic;
	public function test_mixed_type_join_with_suffix():Dynamic;
	public function test_no_overlap_more_informative_error():Dynamic;
	public function test_overlapping_columns_error_message():Dynamic;
	public function test_right_outer_join():Dynamic;
}