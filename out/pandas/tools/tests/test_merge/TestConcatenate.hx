...
@:pythonImport("pandas.tools.tests.test_merge", "TestConcatenate") extern class TestConcatenate {
	/**
	...
	**/
	...
	public function test_append_different_columns():Dynamic;
	public function test_append_length0_frame():Dynamic;
	public function test_append_many():Dynamic;
	public function test_append_missing_column_proper_upcast():Dynamic;
	public function test_append_preserve_index_name():Dynamic;
	public function test_append_records():Dynamic;
	public function test_concat_bug_1719():Dynamic;
	public function test_concat_bug_2972():Dynamic;
	public function test_concat_bug_3602():Dynamic;
	public function test_concat_copy():Dynamic;
	public function test_concat_dataframe_keys_bug():Dynamic;
	public function test_concat_datetime64_block():Dynamic;
	public function test_concat_dict():Dynamic;
	public function test_concat_exclude_none():Dynamic;
	public function test_concat_ignore_index():Dynamic;
	public function test_concat_invalid():Dynamic;
	public function test_concat_invalid_first_argument():Dynamic;
	public function test_concat_iterables():Dynamic;
	public function test_concat_keys_and_levels():Dynamic;
	public function test_concat_keys_levels_no_overlap():Dynamic;
	public function test_concat_keys_specific_levels():Dynamic;
	public function test_concat_keys_with_none():Dynamic;
	public function test_concat_mixed_objs():Dynamic;
	public function test_concat_multiindex_with_keys():Dynamic;
	public function test_concat_multiindex_with_tz():Dynamic;
	public function test_concat_rename_index():Dynamic;
	public function test_concat_series():Dynamic;
	public function test_concat_series_axis1():Dynamic;
	public function test_concat_series_axis1_same_names_ignore_index():Dynamic;
	public function test_concat_series_partial_columns_names():Dynamic;
	public function test_concat_single_with_key():Dynamic;
	public function test_concat_timedelta64_block():Dynamic;
	public function test_concat_with_group_keys():Dynamic;
	public function test_crossed_dtypes_weird_corner():Dynamic;
	public function test_dups_index():Dynamic;
	public function test_handle_empty_objects():Dynamic;
	public function test_join_dups():Dynamic;
	public function test_join_many():Dynamic;
	public function test_join_many_mixed():Dynamic;
	public function test_panel4d_concat():Dynamic;
	public function test_panel4d_concat_mixed_type():Dynamic;
	public function test_panel_concat_buglet():Dynamic;
	public function test_panel_concat_other_axes():Dynamic;
	public function test_panel_join():Dynamic;
	public function test_panel_join_many():Dynamic;
	public function test_panel_join_overlap():Dynamic;
	public function test_with_mixed_tuples():Dynamic;
}