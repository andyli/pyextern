...
package pandas.tools.rplot;
@:pythonImport("pandas.tools.rplot", "ScaleGradient") extern class ScaleGradient {
	/**
	...
	**/
	public function __init__(column:Dynamic, colour1:Dynamic, colour2:Dynamic):Dynamic;
	/**
		Return self<=value.
	**/
