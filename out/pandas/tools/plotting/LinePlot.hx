...
@:pythonImport("pandas.tools.plotting", "LinePlot") extern class LinePlot {
	...
	**/
	...
	static public function _plot(ax:Dynamic, x:Dynamic, y:Dynamic, ?style:Dynamic, ?column_num:Dynamic, ?stacking_id:Dynamic, kwds:Dynamic):Dynamic;
