...
@:pythonImport("pandas.tools.plotting", "KdePlot") extern class KdePlot {
	...
	**/
	@:native("__init__")
	public function ___init__(data:Dynamic, ?bw_method:Dynamic, ?ind:Dynamic, kwargs:Dynamic):Dynamic;
	/**
		Return self<=value.
	**/
	...
	**/
	...
	static public function _plot(ax:Dynamic, y:Dynamic, ?style:Dynamic, ?bw_method:Dynamic, ?ind:Dynamic, ?column_num:Dynamic, ?stacking_id:Dynamic, kwds:Dynamic):Dynamic;
