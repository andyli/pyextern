...
@:pythonImport("pandas.tools.plotting", "HexBinPlot") extern class HexBinPlot {
	...
	**/
	@:native("__init__")
	public function ___init__(data:Dynamic, x:Dynamic, y:Dynamic, ?C:Dynamic, kwargs:Dynamic):Dynamic;
	/**
		Return self<=value.
	**/
