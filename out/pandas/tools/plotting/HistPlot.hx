...
@:pythonImport("pandas.tools.plotting", "HistPlot") extern class HistPlot {
	...
	**/
	@:native("__init__")
	public function ___init__(data:Dynamic, ?bins:Dynamic, ?bottom:Dynamic, kwargs:Dynamic):Dynamic;
	/**
		Return self<=value.
	**/
	...
	**/
	...
	static public function _plot(ax:Dynamic, y:Dynamic, ?style:Dynamic, ?bins:Dynamic, ?bottom:Dynamic, ?column_num:Dynamic, ?stacking_id:Dynamic, kwds:Dynamic):Dynamic;
