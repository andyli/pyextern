...
@:pythonImport("pandas.tools.plotting", "BarhPlot") extern class BarhPlot {
	...
	**/
	public function __init__(data:Dynamic, kwargs:Dynamic):Dynamic;
	/**
		Return self<=value.
	**/
	...
	**/
	...
	public function _decorate_ticks(ax:Dynamic, name:Dynamic, ticklabels:Dynamic, start_edge:Dynamic, end_edge:Dynamic):Dynamic;
	...
	**/
	...
	static public function _plot(ax:Dynamic, x:Dynamic, y:Dynamic, w:Dynamic, ?start:Dynamic, ?log:Dynamic, kwds:Dynamic):Dynamic;
	...
	**/
	...
	static public var _start_base : Dynamic;
