...
@:pythonImport("pandas.stats.fama_macbeth", "FamaMacBeth") extern class FamaMacBeth {
	/**
	...
	**/
	...
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(y:Dynamic, x:Dynamic, ?intercept:Dynamic, ?nw_lags:Dynamic, ?nw_lags_beta:Dynamic, ?entity_effects:Dynamic, ?time_effects:Dynamic, ?x_effects:Dynamic, ?cluster:Dynamic, ?dropped_dummies:Dynamic, ?verbose:Dynamic):Void;
	/**
		Return self<=value.
	**/
