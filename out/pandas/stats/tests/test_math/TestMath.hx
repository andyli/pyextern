...
package pandas.stats.tests.test_math;
@:pythonImport("pandas.stats.tests.test_math", "TestMath") extern class TestMath {
	/**
	...
	**/
	...
	public function test_inv_illformed():Dynamic;
	public function test_rank_1d():Dynamic;
	public function test_solve_rect():Dynamic;
}