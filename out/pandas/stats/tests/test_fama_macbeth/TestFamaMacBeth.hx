...
package pandas.stats.tests.test_fama_macbeth;
@:pythonImport("pandas.stats.tests.test_fama_macbeth", "TestFamaMacBeth") extern class TestFamaMacBeth {
	/**
	...
	**/
	...
	public function _check_stuff_works(result:Dynamic):Dynamic;
	...
	**/
	...
	public function checkFamaMacBethExtended(window_type:Dynamic, x:Dynamic, y:Dynamic, kwds:Dynamic):Dynamic;
	...
	**/
	...
	public function testFamaMacBethRolling():Dynamic;
}