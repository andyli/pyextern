...
@:pythonImport("pandas.stats.tests.test_ols", "TestOLSFilter") extern class TestOLSFilter {
	/**
	...
	**/
	...
	public function testFilterWithDataFrameRHS():Dynamic;
	public function testFilterWithDictRHS():Dynamic;
	public function testFilterWithSeriesRHS():Dynamic;
	public function testFilterWithSeriesRHS2():Dynamic;
	public function testFilterWithSeriesRHS3():Dynamic;
	public function tsAssertEqual(ts1:Dynamic, ts2:Dynamic):Dynamic;
}