...
@:pythonImport("pandas.stats.tests.test_ols", "TestOLSMisc") extern class TestOLSMisc {
	/**
	...
	**/
	...
	public function test_catch_regressor_overlap():Dynamic;
	public function test_columns_tuples_summary():Dynamic;
	public function test_f_test():Dynamic;
	public function test_longpanel_series_combo():Dynamic;
	public function test_plm_attrs():Dynamic;
	public function test_plm_ctor():Dynamic;
	public function test_plm_exclude_dummy_corner():Dynamic;
	public function test_plm_f_test():Dynamic;
	public function test_plm_lagged_y_predict():Dynamic;
	public function test_predict():Dynamic;
	public function test_predict_longer_exog():Dynamic;
	public function test_r2_no_intercept():Dynamic;
	public function test_series_rhs():Dynamic;
	public function test_summary_many_terms():Dynamic;
	public function test_various_attributes():Dynamic;
	public function test_y_predict():Dynamic;
}