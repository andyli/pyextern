...
@:pythonImport("pandas.stats.tests.test_ols", "TestOLS") extern class TestOLS {
	...
	**/
	...
	public function _check_wls(x:Dynamic, y:Dynamic, weights:Dynamic):Dynamic;
	...
	**/
	...
	public function checkDataSet(dataset:Dynamic, ?start:Dynamic, ?end:Dynamic, ?skip_moving:Dynamic):Dynamic;
	public function checkMovingOLS(window_type:Dynamic, x:Dynamic, y:Dynamic, ?weights:Dynamic, kwds:Dynamic):Dynamic;
	public function checkOLS(exog:Dynamic, endog:Dynamic, x:Dynamic, y:Dynamic):Dynamic;
	...
	**/
	...
	public function testOLSWithDatasets_ccard():Dynamic;
	public function testOLSWithDatasets_copper():Dynamic;
	public function testOLSWithDatasets_scotland():Dynamic;
	public function testWLS():Dynamic;
	public function test_ols_object_dtype():Dynamic;
}