...
@:pythonImport("pandas.stats.tests.test_moments") extern class Test_moments {
	...
	static public var _consistency_data : Dynamic;
	static public function _create_consistency_data():Dynamic;
	/**
