...
package pandas.stats.tests.test_moments;
@:pythonImport("pandas.stats.tests.test_moments", "TestMomentsConsistency") extern class TestMomentsConsistency {
	/**
	...
	**/
	...
	public function _check_binary_ew(func:Dynamic):Dynamic;
	public function _check_expanding(func:Dynamic, static_comp:Dynamic, ?has_min_periods:Dynamic, ?has_time_rule:Dynamic, ?preserve_nan:Dynamic):Dynamic;
	public function _check_expanding_ndarray(func:Dynamic, static_comp:Dynamic, ?has_min_periods:Dynamic, ?has_time_rule:Dynamic, ?preserve_nan:Dynamic):Dynamic;
	public function _check_expanding_structures(func:Dynamic):Dynamic;
	public function _check_pairwise_moment(func:Dynamic, args:Dynamic, kwargs:Dynamic):Dynamic;
	static public var _classSetupFailed : Dynamic;
	public function _create_data():Dynamic;
	...
	**/
	...
	static public var _inf_locs : Dynamic;
	static public var _multiprocess_can_split_ : Dynamic;
	static public var _nan_locs : Dynamic;
	public function _test_moments_consistency(min_periods:Dynamic, count:Dynamic, mean:Dynamic, mock_mean:Dynamic, corr:Dynamic, ?var_unbiased:Dynamic, ?std_unbiased:Dynamic, ?cov_unbiased:Dynamic, ?var_biased:Dynamic, ?std_biased:Dynamic, ?cov_biased:Dynamic, ?var_debiasing_factors:Dynamic):Dynamic;
	...
	**/
	...
	static public var base_functions : Dynamic;
	...
	**/
	...
	static public var no_nan_functions : Dynamic;
	...
	**/
	...
	public function test_corr_sanity():Dynamic;
	public function test_ewm_consistency():Dynamic;
	public function test_ewmcorr():Dynamic;
	public function test_ewmcorr_pairwise():Dynamic;
	public function test_ewmcov():Dynamic;
	public function test_ewmcov_pairwise():Dynamic;
	public function test_expanding_apply():Dynamic;
	public function test_expanding_apply_args_kwargs():Dynamic;
	public function test_expanding_consistency():Dynamic;
	public function test_expanding_corr():Dynamic;
	public function test_expanding_corr_diff_index():Dynamic;
	public function test_expanding_corr_pairwise():Dynamic;
	public function test_expanding_corr_pairwise_diff_length():Dynamic;
	public function test_expanding_count():Dynamic;
	public function test_expanding_cov():Dynamic;
	public function test_expanding_cov_diff_index():Dynamic;
	public function test_expanding_cov_pairwise():Dynamic;
	public function test_expanding_cov_pairwise_diff_length():Dynamic;
	public function test_expanding_max():Dynamic;
	public function test_expanding_quantile():Dynamic;
	public function test_flex_binary_frame():Dynamic;
	public function test_flex_binary_moment():Dynamic;
	public function test_moment_functions_zero_length():Dynamic;
	public function test_pairwise_stats_column_names_order():Dynamic;
	public function test_rolling_consistency():Dynamic;
	public function test_rolling_corr():Dynamic;
	public function test_rolling_corr_diff_length():Dynamic;
	public function test_rolling_corr_pairwise():Dynamic;
	public function test_rolling_cov():Dynamic;
	public function test_rolling_cov_diff_length():Dynamic;
	public function test_rolling_cov_pairwise():Dynamic;
	public function test_rolling_functions_window_non_shrinkage():Dynamic;
	public function test_rolling_kurt_edge_cases():Dynamic;
	/**
		Replicate result expected in GH #6297
	**/
	public function test_rolling_max_gh6297():Dynamic;
	public function test_rolling_max_how_resample():Dynamic;
	public function test_rolling_median_how_resample():Dynamic;
	public function test_rolling_min_how_resample():Dynamic;
	public function test_rolling_skew_edge_cases():Dynamic;
}