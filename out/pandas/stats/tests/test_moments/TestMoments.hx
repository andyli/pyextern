...
@:pythonImport("pandas.stats.tests.test_moments", "TestMoments") extern class TestMoments {
	/**
	...
	**/
	...
	public function _check_ew(func:Dynamic):Dynamic;
	public function _check_ew_ndarray(func:Dynamic, ?preserve_nan:Dynamic):Dynamic;
	public function _check_ew_structures(func:Dynamic):Dynamic;
	public function _check_moment_func(func:Dynamic, static_comp:Dynamic, ?window:Dynamic, ?has_min_periods:Dynamic, ?has_center:Dynamic, ?has_time_rule:Dynamic, ?preserve_nan:Dynamic, ?fill_value:Dynamic, ?test_stable:Dynamic):Dynamic;
	public function _check_ndarray(func:Dynamic, static_comp:Dynamic, ?window:Dynamic, ?has_min_periods:Dynamic, ?preserve_nan:Dynamic, ?has_center:Dynamic, ?fill_value:Dynamic, ?test_stable:Dynamic, ?test_window:Dynamic):Dynamic;
	public function _check_structures(func:Dynamic, static_comp:Dynamic, ?has_min_periods:Dynamic, ?has_time_rule:Dynamic, ?has_center:Dynamic, ?fill_value:Dynamic):Dynamic;
	...
	**/
	...
	public function test_centered_axis_validation():Dynamic;
	public function test_cmov_mean():Dynamic;
	public function test_cmov_window():Dynamic;
	public function test_cmov_window_corner():Dynamic;
	public function test_cmov_window_frame():Dynamic;
	public function test_cmov_window_na_min_periods():Dynamic;
	public function test_cmov_window_regular():Dynamic;
	public function test_cmov_window_regular_linear_range():Dynamic;
	public function test_cmov_window_regular_missing_data():Dynamic;
	public function test_cmov_window_special():Dynamic;
	public function test_cmov_window_special_linear_range():Dynamic;
	public function test_ew_empty_arrays():Dynamic;
	public function test_ewma():Dynamic;
	public function test_ewma_halflife_arg():Dynamic;
	public function test_ewma_nan_handling():Dynamic;
	public function test_ewma_span_com_args():Dynamic;
	public function test_ewmvar():Dynamic;
	public function test_ewmvol():Dynamic;
	public function test_fperr_robustness():Dynamic;
	public function test_moment_preserve_series_name():Dynamic;
	public function test_rolling_apply():Dynamic;
	public function test_rolling_apply_out_of_bounds():Dynamic;
	public function test_rolling_count():Dynamic;
	public function test_rolling_kurt():Dynamic;
	public function test_rolling_max():Dynamic;
	public function test_rolling_mean():Dynamic;
	public function test_rolling_median():Dynamic;
	public function test_rolling_min():Dynamic;
	public function test_rolling_quantile():Dynamic;
	public function test_rolling_skew():Dynamic;
	public function test_rolling_std():Dynamic;
	public function test_rolling_std_1obs():Dynamic;
	public function test_rolling_std_neg_sqrt():Dynamic;
	public function test_rolling_sum():Dynamic;
	public function test_rolling_var():Dynamic;
}