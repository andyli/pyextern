...
@:pythonImport("pandas.stats.var", "VAR") extern class VAR {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(data:Dynamic, ?p:Dynamic, ?intercept:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(data:Dynamic, ?p:Dynamic, ?intercept:Dynamic):Void;
	/**
		Return self<=value.
	**/
