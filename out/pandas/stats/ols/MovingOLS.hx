...
@:pythonImport("pandas.stats.ols", "MovingOLS") extern class MovingOLS {
	...
	**/
	public function __init__(y:Dynamic, x:Dynamic, ?weights:Dynamic, ?window_type:Dynamic, ?window:Dynamic, ?min_periods:Dynamic, ?intercept:Dynamic, ?nw_lags:Dynamic, ?nw_overlap:Dynamic):Dynamic;
	/**
		Return self<=value.
	**/
