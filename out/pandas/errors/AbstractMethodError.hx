...
@:pythonImport("pandas.errors", "AbstractMethodError") extern class AbstractMethodError {
	/**
		exception cause
	**/
	...
	**/
	@:native("__init__")
	public function ___init__(class_instance:Dynamic, ?methodtype:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(class_instance:Dynamic, ?methodtype:Dynamic):Void;
	/**
