...
@:pythonImport("pandas.core.sparse.frame", "SparseDataFrame") extern class SparseDataFrame {
	/**
	...
	**/
	...
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(?data:Dynamic, ?index:Dynamic, ?columns:Dynamic, ?default_kind:Dynamic, ?default_fill_value:Dynamic, ?dtype:Dynamic, ?copy:Dynamic):Void;
	/**
	...
	**/
	public function _apply_columns(func:Dynamic):Dynamic;
	/**
	...
	**/
	...
	public function _get_op_result_fill_value(other:Dynamic, func:Dynamic):Dynamic;
	/**
	...
	**/
	public function _init_spmatrix(data:Dynamic, index:Dynamic, columns:Dynamic, ?dtype:Dynamic, ?fill_value:Dynamic):Dynamic;
	...
	**/
	...
	public function _prep_index(data:Dynamic, index:Dynamic, columns:Dynamic):Dynamic;
	/**
	...
	**/
	...
	public function _reindex_columns(columns:Dynamic, method:Dynamic, copy:Dynamic, level:Dynamic, ?fill_value:Dynamic, ?limit:Dynamic, ?takeable:Dynamic):Dynamic;
	...
	**/
	public function _sanitize_column(key:Dynamic, value:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
		internal compat with SelectionMixin 
	**/
	...
	**/
	public function apply(func:Dynamic, ?axis:Dynamic, ?broadcast:Dynamic, ?reduce:Dynamic, ?result_type:Dynamic):Dynamic;
	/**
	...
	**/
	...
	/**
		...
		Myla      1
	**/
	public function count(?axis:Dynamic, ?kwds:python.KwArgs<Dynamic>):Dynamic;
	/**
	...
	**/
	...
	/**
		...
		-------
		SparseDataFrame
		    Mask of bool values for each element in SparseDataFrame that
		    indicates whether an element is not an NA value.
		
		See Also
		--------
		SparseDataFrame.isnull : Alias of isna.
		SparseDataFrame.notna : Boolean inverse of isna.
		SparseDataFrame.dropna : Omit axes labels with missing values.
		isna : Top-level isna.
	...
	**/
	...
	/**
		...
		See Also
		--------
		SparseDataFrame.notnull : Alias of notna.
		SparseDataFrame.isna : Boolean inverse of notna.
		SparseDataFrame.dropna : Omit axes labels with missing values.
