...
@:pythonImport("pandas.core.sparse.array", "SparseArray") extern class SparseArray {
	/**
	...
	**/
	...
	public function disable(other:Dynamic):Dynamic;
	/**
		a.dot(b, out=None)
	...
	**/
	public function get_values(?fill:Dynamic):Dynamic;
	/**
	...
	**/
	...
	/**
		...
		arr : NumPy array
	**/
	public function to_dense(?fill:Dynamic):Dynamic;
	/**
		a.tobytes(order='C')
