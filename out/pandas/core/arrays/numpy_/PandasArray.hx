...
package pandas.core.arrays.numpy_;
@:pythonImport("pandas.core.arrays.numpy_", "PandasArray") extern class PandasArray {
	...
	**/
	...
	public function __imatmul__(other:Dynamic):Dynamic;
	...
	**/
	...
	public function max(?axis:Dynamic, ?out:Dynamic, ?keepdims:Dynamic, ?skipna:Dynamic):Dynamic;
	...
	public function min(?axis:Dynamic, ?out:Dynamic, ?keepdims:Dynamic, ?skipna:Dynamic):Dynamic;
	/**
	...
	**/
	...
	public function prod(?axis:Dynamic, ?dtype:Dynamic, ?out:Dynamic, ?keepdims:Dynamic, ?initial:Dynamic, ?skipna:Dynamic, ?min_count:Dynamic):Dynamic;
	/**
