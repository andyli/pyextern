...
@:pythonImport("pandas.core.indexes.range", "RangeIndex") extern class RangeIndex {
	...
	**/
	static public function __new__(cls:Dynamic, ?start:Dynamic, ?stop:Dynamic, ?step:Dynamic, ?name:Dynamic, ?dtype:Dynamic, ?fastpath:Dynamic, ?copy:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	...
	**/
	...
	static public var _int64index : Dynamic;
	/**
	...
	**/
	public function _max_fitting_element(upper_limit:Dynamic):Dynamic;
	/**
	...
	**/
	static public function _simple_new(start:Dynamic, ?stop:Dynamic, ?step:Dynamic, ?name:Dynamic, ?dtype:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
	...
	**/
	static public function from_range(data:Dynamic, ?name:Dynamic, ?dtype:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
