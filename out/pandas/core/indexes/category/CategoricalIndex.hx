...
@:pythonImport("pandas.core.indexes.category", "CategoricalIndex") extern class CategoricalIndex {
	...
	**/
	static public function __new__(cls:Dynamic, ?data:Dynamic, ?categories:Dynamic, ?ordered:Dynamic, ?dtype:Dynamic, ?copy:Dynamic, ?name:Dynamic, ?fastpath:Dynamic):Dynamic;
	...
	**/
	...
	/**
		*this is an internal non-public method*
		...
		Categorical
	**/
	static public function _create_categorical(self:Dynamic, data:Dynamic, ?categories:Dynamic, ?ordered:Dynamic, ?dtype:Dynamic):Dynamic;
	/**
		*this is an internal non-public method*
	...
	**/
	public function _shallow_copy(?values:Dynamic, ?categories:Dynamic, ?ordered:Dynamic, ?dtype:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
	...
	**/
	static public function _simple_new(values:Dynamic, ?name:Dynamic, ?categories:Dynamic, ?ordered:Dynamic, ?dtype:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
	...
	**/
	...
	/**
		...
		numpy.ndarray.take
	**/
	public function take_nd(indices:Dynamic, ?axis:Dynamic, ?allow_fill:Dynamic, ?fill_value:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
