...
@:pythonImport("pandas.core.indexes.category", "CategoricalIndex") extern class CategoricalIndex {
	...
	**/
	...
	/**
		*this is an internal non-public method*
		...
		Categorical
	**/
	static public function _create_categorical(data:Dynamic, ?dtype:Dynamic):Dynamic;
	/**
		*this is an internal non-public method*
		...
		CategoricalIndex
	**/
	public function _create_from_codes(codes:Dynamic, ?dtype:Dynamic, ?name:Dynamic):Dynamic;
	...
	**/
	public function _shallow_copy(?values:Dynamic, ?dtype:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
