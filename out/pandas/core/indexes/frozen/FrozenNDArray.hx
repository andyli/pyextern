...
@:pythonImport("pandas.core.indexes.frozen", "FrozenNDArray") extern class FrozenNDArray {
	/**
	...
	**/
	static public function __new__(cls:Dynamic, data:Dynamic, ?dtype:Dynamic, ?copy:Dynamic):Dynamic;
	/**
		Return self|value.
	**/
	...
	**/
	...
	public function _shallow_copy():Dynamic;
	/**
