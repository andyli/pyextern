...
@:pythonImport("pandas.core.indexes.timedeltas", "TimedeltaIndex") extern class TimedeltaIndex {
	/**
	...
	**/
	static public function __new__(cls:Dynamic, ?data:Dynamic, ?unit:Dynamic, ?freq:Dynamic, ?start:Dynamic, ?end:Dynamic, ?periods:Dynamic, ?closed:Dynamic, ?dtype:Dynamic, ?copy:Dynamic, ?name:Dynamic, ?verify_integrity:Dynamic):Dynamic;
	...
	**/
	...
	public function _partial_td_slice(key:Dynamic):Dynamic;
	...
	**/
	static public function _simple_new(values:Dynamic, ?name:Dynamic, ?freq:Dynamic, ?dtype:Dynamic):Dynamic;
	/**
	...
	**/
	...
	/**
		...
		datetimes : ndarray
	**/
	public function to_pytimedelta(?args:python.VarArgs<Dynamic>, ?kwargs:python.KwArgs<Dynamic>):numpy.Ndarray;
	/**
