...
@:pythonImport("pandas.core.internals.blocks", "FloatBlock") extern class FloatBlock {
	/**
	...
	**/
	public function to_native_types(?slicer:Dynamic, ?na_rep:Dynamic, ?float_format:Dynamic, ?decimal:Dynamic, ?quoting:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
