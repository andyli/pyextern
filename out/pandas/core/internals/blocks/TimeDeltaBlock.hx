...
@:pythonImport("pandas.core.internals.blocks", "TimeDeltaBlock") extern class TimeDeltaBlock {
	/**
	...
	**/
	public function fillna(value:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
