...
@:pythonImport("pandas.core.internals.blocks", "CategoricalBlock") extern class CategoricalBlock {
	/**
	...
	**/
	static public function _concatenator(to_concat:Dynamic, ?axis:Dynamic):Dynamic;
