...
@:pythonImport("pandas.core.internals", "ObjectBlock") extern class ObjectBlock {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(values:Dynamic, ?ndim:Dynamic, ?fastpath:Dynamic, ?placement:Dynamic, kwargs:Dynamic):Dynamic;
	/**
		Return self<=value.
	**/
	...
	**/
	public function convert(args:Dynamic, kwargs:Dynamic):Dynamic;
