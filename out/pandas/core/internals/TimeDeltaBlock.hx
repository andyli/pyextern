...
@:pythonImport("pandas.core.internals", "TimeDeltaBlock") extern class TimeDeltaBlock {
	/**
	...
	**/
	public function __init__(values:Dynamic, placement:Dynamic, ?ndim:Dynamic, ?fastpath:Dynamic):Dynamic;
	/**
		Return self<=value.
	**/
