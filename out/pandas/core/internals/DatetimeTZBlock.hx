...
@:pythonImport("pandas.core.internals", "DatetimeTZBlock") extern class DatetimeTZBlock {
	...
	**/
	...
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(values:Dynamic, placement:Dynamic, ?ndim:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Void;
	/**
		Return self<=value.
	**/
	...
	**/
	...
	/**
		...
		compatibility.
	**/
	public function replace(?args:python.VarArgs<Dynamic>, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
		Parameters
		----------
