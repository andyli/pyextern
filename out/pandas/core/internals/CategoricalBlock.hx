...
@:pythonImport("pandas.core.internals", "CategoricalBlock") extern class CategoricalBlock {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(values:Dynamic, placement:Dynamic, ?fastpath:Dynamic, kwargs:Dynamic):Dynamic;
	/**
		Return self<=value.
	**/
	...
	**/
	public function _astype(dtype:Dynamic, ?copy:Dynamic, ?raise_on_error:Dynamic, ?values:Dynamic, ?klass:Dynamic):Dynamic;
	...
	**/
	...
	/**
		...
		'c'
	**/
	static public function _holder(values:Dynamic, ?categories:Dynamic, ?ordered:Dynamic, ?name:Dynamic, ?fastpath:Dynamic, ?levels:Dynamic):Dynamic;
	/**
	...
	**/
	...
	public function _replace_single(to_replace:Dynamic, value:Dynamic, ?inplace:Dynamic, ?filter:Dynamic, ?regex:Dynamic):Dynamic;
	/**
	...
	**/
	...
	public function _try_cast(element:Dynamic):Dynamic;
	...
	**/
	...
	public function interpolate(?method:Dynamic, ?axis:Dynamic, ?inplace:Dynamic, ?limit:Dynamic, ?fill_value:Dynamic, kwargs:Dynamic):Dynamic;
	/**
	...
	**/
	public function to_native_types(?slicer:Dynamic, ?na_rep:Dynamic, ?quoting:Dynamic, kwargs:Dynamic):Dynamic;
