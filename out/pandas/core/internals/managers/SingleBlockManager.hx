...
@:pythonImport("pandas.core.internals.managers", "SingleBlockManager") extern class SingleBlockManager {
	...
	**/
	...
	/**
		...
		Block Manager (new object)
	**/
	public function quantile(?axis:Dynamic, ?consolidate:Dynamic, ?transposed:Dynamic, ?interpolation:Dynamic, ?qs:Dynamic, ?numeric_only:Dynamic):Dynamic;
	/**
	...
	**/
	public function set(item:Dynamic, value:Dynamic):Dynamic;
	...
	**/
	public function unstack(unstacker_func:Dynamic, fill_value:Dynamic):Dynamic;
