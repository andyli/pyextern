...
package pandas.core.panel4d;
@:pythonImport("pandas.core.panel4d") extern class Panel4d_Module {
	...
	**/
	...
	static public function panel4d_init(self:Dynamic, ?data:Dynamic, ?labels:Dynamic, ?items:Dynamic, ?major_axis:Dynamic, ?minor_axis:Dynamic, ?copy:Dynamic, ?dtype:Dynamic):Dynamic;
}