...
@:pythonImport("pandas.core.groupby.grouper", "Grouper") extern class Grouper {
	...
	**/
	@:native("__init__")
	public function ___init__(?key:Dynamic, ?level:Dynamic, ?freq:Dynamic, ?axis:Dynamic, ?sort:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(?key:Dynamic, ?level:Dynamic, ?freq:Dynamic, ?axis:Dynamic, ?sort:Dynamic):Void;
	/**
