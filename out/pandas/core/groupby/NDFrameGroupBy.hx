...
@:pythonImport("pandas.core.groupby", "NDFrameGroupBy") extern class NDFrameGroupBy {
	/**
	...
	**/
	...
	public function _cython_agg_blocks(how:Dynamic, ?alt:Dynamic, ?numeric_only:Dynamic):Dynamic;
