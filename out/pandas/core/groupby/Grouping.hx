...
@:pythonImport("pandas.core.groupby", "Grouping") extern class Grouping {
	...
	**/
	public function __init__(index:Dynamic, ?grouper:Dynamic, ?obj:Dynamic, ?name:Dynamic, ?level:Dynamic, ?sort:Dynamic, ?in_axis:Dynamic):Dynamic;
