...
@:pythonImport("pandas.core.index", "NumericIndex") extern class NumericIndex {
	/**
	...
	**/
	static public function __new__(cls:Dynamic, ?data:Dynamic, ?dtype:Dynamic, ?copy:Dynamic, ?name:Dynamic, ?fastpath:Dynamic, ?tupleize_cols:Dynamic, kwargs:Dynamic):Dynamic;
