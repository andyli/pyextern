...
@:pythonImport("pandas.core.indexing", "_IXIndexer") extern class _IXIndexer {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(name:Dynamic, obj:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(name:Dynamic, obj:Dynamic):Void;
	/**
	...
	**/
	...
	static public var _ix_deprecation_warning : Dynamic;
	/**
