...
@:pythonImport("pandas.core.window", "_Rolling_and_Expanding") extern class _Rolling_and_Expanding {
	...
	**/
	...
	public function max(?how:Dynamic, ?args:python.VarArgs<Dynamic>, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	...
	public function min(?how:Dynamic, ?args:python.VarArgs<Dynamic>, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
