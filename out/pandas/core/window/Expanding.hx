...
@:pythonImport("pandas.core.window", "Expanding") extern class Expanding {
	...
	**/
	@:native("__init__")
	public function ___init__(obj:Dynamic, ?min_periods:Dynamic, ?center:Dynamic, ?axis:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(obj:Dynamic, ?min_periods:Dynamic, ?center:Dynamic, ?axis:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Void;
	/**
