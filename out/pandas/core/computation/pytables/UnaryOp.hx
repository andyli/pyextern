...
@:pythonImport("pandas.core.computation.pytables", "UnaryOp") extern class UnaryOp {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(op:Dynamic, operand:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(op:Dynamic, operand:Dynamic):Void;
	/**
