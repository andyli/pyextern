...
@:pythonImport("pandas.core.computation.pytables", "Constant") extern class Constant {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(value:Dynamic, env:Dynamic, ?side:Dynamic, ?encoding:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(value:Dynamic, env:Dynamic, ?side:Dynamic, ?encoding:Dynamic):Void;
	/**
