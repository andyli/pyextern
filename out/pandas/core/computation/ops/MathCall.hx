...
@:pythonImport("pandas.core.computation.ops", "MathCall") extern class MathCall {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(func:Dynamic, args:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(func:Dynamic, args:Dynamic):Void;
	/**
