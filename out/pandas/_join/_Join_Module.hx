...
package pandas._join;
@:pythonImport("pandas._join") extern class _Join_Module {
	...
	static public function asof_join_double(args:haxe.extern.Rest<Dynamic>):Dynamic;
	static public function asof_join_double_by_int64_t(args:haxe.extern.Rest<Dynamic>):Dynamic;
	static public function asof_join_double_by_object(args:haxe.extern.Rest<Dynamic>):Dynamic;
	static public function asof_join_int64_t(args:haxe.extern.Rest<Dynamic>):Dynamic;
	static public function asof_join_int64_t_by_int64_t(args:haxe.extern.Rest<Dynamic>):Dynamic;
	static public function asof_join_int64_t_by_object(args:haxe.extern.Rest<Dynamic>):Dynamic;
