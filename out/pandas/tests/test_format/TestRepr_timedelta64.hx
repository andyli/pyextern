...
@:pythonImport("pandas.tests.test_format", "TestRepr_timedelta64") extern class TestRepr_timedelta64 {
	/**
	...
	**/
	...
	public function test_all():Dynamic;
	public function test_even_day():Dynamic;
	public function test_long():Dynamic;
	public function test_none():Dynamic;
	public function test_sub_day():Dynamic;
}