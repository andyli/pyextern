...
@:pythonImport("pandas.tests.test_format", "TestDatetime64Formatter") extern class TestDatetime64Formatter {
	/**
	...
	**/
	...
	public function test_date_nanos():Dynamic;
	public function test_dates():Dynamic;
	public function test_dates_display():Dynamic;
