...
@:pythonImport("pandas.tests.test_format", "TestTimedelta64Formatter") extern class TestTimedelta64Formatter {
	/**
	...
	**/
	...
	public function test_days():Dynamic;
	public function test_days_neg():Dynamic;
	public function test_subdays():Dynamic;
	public function test_subdays_neg():Dynamic;
	public function test_zero():Dynamic;
}