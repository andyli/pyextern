...
@:pythonImport("pandas.tests.test_format", "TestFloatArrayFormatter") extern class TestFloatArrayFormatter {
	/**
	...
	**/
	...
	public function test_output_significant_digits():Dynamic;
	public function test_too_long():Dynamic;
}