...
@:pythonImport("pandas.tests.test_format", "TestStringRepTimestamp") extern class TestStringRepTimestamp {
	/**
	...
	**/
	...
	public function test_no_tz():Dynamic;
	public function test_tz_dateutil():Dynamic;
	public function test_tz_pytz():Dynamic;
}