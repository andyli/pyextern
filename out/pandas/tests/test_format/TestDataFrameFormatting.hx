...
package pandas.tests.test_format;
@:pythonImport("pandas.tests.test_format", "TestDataFrameFormatting") extern class TestDataFrameFormatting {
	/**
	...
	**/
	...
	public function test_auto_detect():Dynamic;
	public function test_csv_to_string():Dynamic;
	public function test_dict_entries():Dynamic;
	public function test_east_asian_unicode_frame():Dynamic;
	public function test_eng_float_formatter():Dynamic;
	public function test_expand_frame_repr():Dynamic;
	public function test_fake_qtconsole_repr_html():Dynamic;
	public function test_float_trim_zeros():Dynamic;
	public function test_frame_info_encoding():Dynamic;
	public function test_index_with_nan():Dynamic;
	public function test_info_repr():Dynamic;
	public function test_info_repr_html():Dynamic;
	public function test_info_repr_max_cols():Dynamic;
	public function test_long_series():Dynamic;
	public function test_nonunicode_nonascii_alignment():Dynamic;
	/**
		if the test fails, the stack will overflow and nose crash,
		but it won't hang.
	**/
	public function test_pprint_pathological_object():Dynamic;
	public function test_pprint_thing():Dynamic;
	public function test_repr_chop_threshold():Dynamic;
	public function test_repr_corner():Dynamic;
	public function test_repr_embedded_ndarray():Dynamic;
	public function test_repr_html():Dynamic;
	public function test_repr_html_float():Dynamic;
	public function test_repr_html_long():Dynamic;
	public function test_repr_html_long_and_wide():Dynamic;
	public function test_repr_html_long_multiindex():Dynamic;
	public function test_repr_html_wide():Dynamic;
	public function test_repr_html_wide_multiindex_cols():Dynamic;
	public function test_repr_is_valid_construction_code():Dynamic;
	public function test_repr_max_columns_max_rows():Dynamic;
	public function test_repr_no_backslash():Dynamic;
	public function test_repr_non_interactive():Dynamic;
	public function test_repr_obeys_max_seq_limit():Dynamic;
	public function test_repr_should_return_str():Dynamic;
	public function test_repr_truncation():Dynamic;
	public function test_repr_tuples():Dynamic;
	public function test_round_dataframe():Dynamic;
	public function test_show_dimensions():Dynamic;
	public function test_show_null_counts():Dynamic;
	public function test_str_max_colwidth():Dynamic;
	public function test_string_repr_encoding():Dynamic;
	public function test_to_csv_date_format():Dynamic;
	public function test_to_csv_decimal():Dynamic;
	public function test_to_csv_doublequote():Dynamic;
	public function test_to_csv_escapechar():Dynamic;
	public function test_to_csv_quotechar():Dynamic;
	public function test_to_html():Dynamic;
	public function test_to_html_columns_arg():Dynamic;
	public function test_to_html_escape_disabled():Dynamic;
	public function test_to_html_escaped():Dynamic;
	public function test_to_html_filename():Dynamic;
	public function test_to_html_index():Dynamic;
	public function test_to_html_index_formatter():Dynamic;
	public function test_to_html_justify():Dynamic;
	public function test_to_html_multiindex():Dynamic;
	public function test_to_html_multiindex_index_false():Dynamic;
	public function test_to_html_multiindex_sparsify():Dynamic;
	public function test_to_html_multiindex_sparsify_false_multi_sparse():Dynamic;
	public function test_to_html_regression_GH6098():Dynamic;
	public function test_to_html_truncate():Dynamic;
	public function test_to_html_truncate_multi_index():Dynamic;
	public function test_to_html_truncate_multi_index_sparse_off():Dynamic;
	public function test_to_html_unicode():Dynamic;
	public function test_to_html_with_classes():Dynamic;
	public function test_to_html_with_col_space():Dynamic;
	public function test_to_html_with_empty_string_label():Dynamic;
	public function test_to_html_with_no_bold():Dynamic;
	public function test_to_latex():Dynamic;
	public function test_to_latex_escape():Dynamic;
	public function test_to_latex_escape_special_chars():Dynamic;
	public function test_to_latex_filename():Dynamic;
	public function test_to_latex_format():Dynamic;
	public function test_to_latex_longtable():Dynamic;
	public function test_to_latex_multiindex():Dynamic;
	public function test_to_string():Dynamic;
	public function test_to_string_ascii_error():Dynamic;
	public function test_to_string_buffer_all_unicode():Dynamic;
	public function test_to_string_float_formatting():Dynamic;
	public function test_to_string_float_index():Dynamic;
	public function test_to_string_format_na():Dynamic;
	public function test_to_string_index_formatter():Dynamic;
	public function test_to_string_int_formatting():Dynamic;
	public function test_to_string_left_justify_cols():Dynamic;
	public function test_to_string_line_width():Dynamic;
	public function test_to_string_no_header():Dynamic;
	public function test_to_string_no_index():Dynamic;
	public function test_to_string_repr_unicode():Dynamic;
	public function test_to_string_small_float_values():Dynamic;
	public function test_to_string_truncate_indices():Dynamic;
	public function test_to_string_truncate_multilevel():Dynamic;
	public function test_to_string_unicode_columns():Dynamic;
	public function test_to_string_unicode_three():Dynamic;
	public function test_to_string_unicode_two():Dynamic;
	public function test_to_string_utf8_columns():Dynamic;
	public function test_to_string_with_col_space():Dynamic;
	public function test_to_string_with_formatters():Dynamic;
	public function test_to_string_with_formatters_unicode():Dynamic;
	public function test_unicode_problem_decoding_as_ascii():Dynamic;
	public function test_wide_repr():Dynamic;
	public function test_wide_repr_multiindex():Dynamic;
	public function test_wide_repr_multiindex_cols():Dynamic;
	public function test_wide_repr_named():Dynamic;
	public function test_wide_repr_unicode():Dynamic;
	public function test_wide_repr_wide_columns():Dynamic;
	public function test_wide_repr_wide_long_columns():Dynamic;
}