...
@:pythonImport("pandas.tests.test_format", "TestEngFormatter") extern class TestEngFormatter {
	/**
	...
	**/
	...
	public function compare(formatter:Dynamic, input:Dynamic, output:Dynamic):Dynamic;
	/**
		Parameters:
		-----------
	...
	**/
	public function compare_all(formatter:Dynamic, in_out:Dynamic):Dynamic;
	...
	**/
	...
	public function test_exponents_with_eng_prefix():Dynamic;
	public function test_exponents_without_eng_prefix():Dynamic;
	public function test_rounding():Dynamic;
}