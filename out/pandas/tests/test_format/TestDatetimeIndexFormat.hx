...
@:pythonImport("pandas.tests.test_format", "TestDatetimeIndexFormat") extern class TestDatetimeIndexFormat {
	/**
	...
	**/
	...
	public function test_date_explict_date_format():Dynamic;
	public function test_date_tz():Dynamic;
