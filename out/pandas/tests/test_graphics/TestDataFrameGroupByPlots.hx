...
@:pythonImport("pandas.tests.test_graphics", "TestDataFrameGroupByPlots") extern class TestDataFrameGroupByPlots {
	/**
	...
	**/
	...
	public function test_hist_single_row():Dynamic;
	public function test_plot_submethod_works():Dynamic;
	public function test_plotting_with_float_index_works():Dynamic;
	public function test_series_groupby_plotting_nominally_works():Dynamic;
}