...
@:pythonImport("pandas.tests.test_reshape", "TestMelt") extern class TestMelt {
	/**
	...
	**/
	...
	public function test_col_level():Dynamic;
	public function test_custom_value_name():Dynamic;
	public function test_custom_var_and_value_name():Dynamic;
	public function test_custom_var_name():Dynamic;
	public function test_default_col_names():Dynamic;
	public function test_multiindex():Dynamic;
	public function test_value_vars():Dynamic;
}