...
package pandas.tests.test_index;
@:pythonImport("pandas.tests.test_index", "TestMultiIndex") extern class TestMultiIndex {
	/**
	...
	**/
	...
	static public var _compat_props : Dynamic;
	...
	**/
	static public function _holder(?levels:Dynamic, ?labels:Dynamic, ?sortorder:Dynamic, ?names:Dynamic, ?copy:Dynamic, ?verify_integrity:Dynamic, ?_set_identity:Dynamic, ?name:Dynamic, kwargs:Dynamic):Dynamic;
	...
	**/
	...
	public function assert_multiindex_copied(copy:Dynamic, original:Dynamic):Dynamic;
	/**
	...
	**/
	...
	public function check_level_names(index:Dynamic, names:Dynamic):Dynamic;
	public function countTestCases():Dynamic;
	public function create_index():Dynamic;
	/**
	...
	**/
	...
	public function setup_indices():Dynamic;
	/**
	...
	**/
	...
	public function test_boolean_context_compat():Dynamic;
	public function test_boolean_context_compat2():Dynamic;
	public function test_bounds():Dynamic;
	public function test_bytestring_with_unicode():Dynamic;
	public function test_changing_names():Dynamic;
	public function test_compat():Dynamic;
	public function test_consistency():Dynamic;
	public function test_constructor_mismatched_label_levels():Dynamic;
	public function test_constructor_no_levels():Dynamic;
	public function test_constructor_single_level():Dynamic;
	public function test_contains():Dynamic;
	public function test_copy():Dynamic;
	public function test_copy_and_deepcopy():Dynamic;
	public function test_copy_in_constructor():Dynamic;
	public function test_delete_base():Dynamic;
	public function test_difference():Dynamic;
	public function test_difference_base():Dynamic;
	public function test_dims():Dynamic;
	public function test_drop():Dynamic;
	public function test_droplevel_multiple():Dynamic;
	public function test_droplevel_with_names():Dynamic;
	public function test_dtype_str():Dynamic;
	public function test_duplicate_meta_data():Dynamic;
	public function test_duplicate_names():Dynamic;
	public function test_duplicates():Dynamic;
	public function test_equals():Dynamic;
	public function test_equals_op():Dynamic;
	public function test_equals_operator():Dynamic;
	public function test_format():Dynamic;
	public function test_format_integer_names():Dynamic;
	public function test_format_sparse_config():Dynamic;
	public function test_format_sparse_display():Dynamic;
	public function test_from_arrays():Dynamic;
	public function test_from_product():Dynamic;
	public function test_from_product_datetimeindex():Dynamic;
	public function test_from_tuples():Dynamic;
	public function test_from_tuples_index_values():Dynamic;
	public function test_get_indexer():Dynamic;
	public function test_get_indexer_nearest():Dynamic;
	public function test_get_level_number_integer():Dynamic;
	public function test_get_level_values():Dynamic;
	public function test_get_level_values_na():Dynamic;
	public function test_get_loc():Dynamic;
	public function test_get_loc_duplicates():Dynamic;
	public function test_get_loc_level():Dynamic;
	public function test_getitem():Dynamic;
	public function test_getitem_group_select():Dynamic;
	public function test_groupby():Dynamic;
	public function test_hash_error():Dynamic;
	public function test_identical():Dynamic;
	public function test_index_name_retained():Dynamic;
	public function test_inplace_mutation_resets_values():Dynamic;
	public function test_insert():Dynamic;
	public function test_insert_base():Dynamic;
	public function test_intersection():Dynamic;
	public function test_intersection_base():Dynamic;
	public function test_is_():Dynamic;
	public function test_is_all_dates():Dynamic;
	public function test_is_numeric():Dynamic;
	public function test_isin():Dynamic;
	public function test_isin_level_kwarg():Dynamic;
	public function test_isin_nan():Dynamic;
	public function test_isnull_behavior():Dynamic;
	public function test_iter():Dynamic;
	public function test_join_level():Dynamic;
	public function test_join_multi():Dynamic;
	public function test_join_self():Dynamic;
	public function test_labels_dtypes():Dynamic;
	public function test_legacy_pickle():Dynamic;
	public function test_legacy_v2_unpickle():Dynamic;
	public function test_level_setting_resets_attributes():Dynamic;
	public function test_logical_compat():Dynamic;
	public function test_metadata_immutable():Dynamic;
	public function test_mutability():Dynamic;
	public function test_names():Dynamic;
	public function test_ndarray_compat_properties():Dynamic;
	public function test_nlevels():Dynamic;
	public function test_numeric_compat():Dynamic;
	public function test_numpy_ufuncs():Dynamic;
	public function test_order():Dynamic;
	public function test_pickle():Dynamic;
	public function test_pickle_compat_construction():Dynamic;
	public function test_reference_duplicate_name():Dynamic;
	public function test_reindex():Dynamic;
	public function test_reindex_base():Dynamic;
	public function test_reindex_level():Dynamic;
	public function test_reindex_lvl_preserves_names_when_target_is_list_or_array():Dynamic;
	public function test_reindex_lvl_preserves_type_if_target_is_empty_list_or_array():Dynamic;
	public function test_reindex_preserves_names_when_target_is_list_or_ndarray():Dynamic;
	public function test_reorder_levels():Dynamic;
	public function test_repr_max_seq_item_setting():Dynamic;
	public function test_repr_roundtrip():Dynamic;
	public function test_repr_with_unicode_data():Dynamic;
	public function test_roundtrip_pickle_with_tz():Dynamic;
	public function test_set_labels():Dynamic;
	public function test_set_levels():Dynamic;
	public function test_set_levels_labels_names_bad_input():Dynamic;
	public function test_set_name_methods():Dynamic;
	public function test_set_value_keeps_names():Dynamic;
	public function test_setops_errorcases():Dynamic;
	public function test_shallow_copy():Dynamic;
	public function test_slice_keep_name():Dynamic;
	public function test_slice_locs():Dynamic;
	public function test_slice_locs_not_contained():Dynamic;
	public function test_slice_locs_not_sorted():Dynamic;
	public function test_slice_locs_partial():Dynamic;
	public function test_slice_locs_with_type_mismatch():Dynamic;
	public function test_sort():Dynamic;
	public function test_sortlevel():Dynamic;
	public function test_sortlevel_deterministic():Dynamic;
	public function test_sortlevel_not_sort_remaining():Dynamic;
	public function test_str():Dynamic;
	public function test_symmetric_diff():Dynamic;
	public function test_take():Dynamic;
	public function test_take_preserve_name():Dynamic;
	public function test_to_hierarchical():Dynamic;
	...
	public function test_union():Dynamic;
	public function test_union_base():Dynamic;
	public function test_values_boxed():Dynamic;
	public function test_view():Dynamic;
	public function test_wrong_number_names():Dynamic;
	public function verify_pickle(index:Dynamic):Dynamic;
}