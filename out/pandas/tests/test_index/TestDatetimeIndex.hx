...
@:pythonImport("pandas.tests.test_index", "TestDatetimeIndex") extern class TestDatetimeIndex {
	/**
	...
	**/
	...
	public function test_construction_with_alt():Dynamic;
	...
	public function test_reindex_preserves_tz_if_target_is_empty_list_or_array():Dynamic;
	...
	public function test_time_loc():Dynamic;
	public function test_time_overflow_for_32bit_machines():Dynamic;
