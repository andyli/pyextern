...
@:pythonImport("pandas.tests.test_index", "TestCategoricalIndex") extern class TestCategoricalIndex {
	/**
	...
	**/
	static public function _holder(?data:Dynamic, ?categories:Dynamic, ?ordered:Dynamic, ?dtype:Dynamic, ?copy:Dynamic, ?name:Dynamic, ?fastpath:Dynamic, kwargs:Dynamic):Dynamic;
	...
	**/
	...
	public function create_index(?categories:Dynamic, ?ordered:Dynamic):Dynamic;
	/**
	...
	**/
	...
	public function test_construction():Dynamic;
	public function test_construction_with_dtype():Dynamic;
	...
	public function test_disallow_set_ops():Dynamic;
	...
	public function test_method_delegation():Dynamic;
	...
	public function test_reindexing():Dynamic;
	...
	public function test_string_categorical_index_repr():Dynamic;
