...
@:pythonImport("pandas.tests.test_index", "TestTimedeltaIndex") extern class TestTimedeltaIndex {
	/**
	...
	**/
	static public function _holder(?data:Dynamic, ?unit:Dynamic, ?freq:Dynamic, ?start:Dynamic, ?end:Dynamic, ?periods:Dynamic, ?copy:Dynamic, ?name:Dynamic, ?closed:Dynamic, ?verify_integrity:Dynamic, kwargs:Dynamic):Dynamic;
