...
package pandas.tests.test_msgpack.test_sequnpack;
@:pythonImport("pandas.tests.test_msgpack.test_sequnpack", "TestPack") extern class TestPack {
	/**
	...
	**/
	...
	public function test_foobar():Dynamic;
	public function test_foobar_skip():Dynamic;
	public function test_issue124():Dynamic;
	public function test_maxbuffersize():Dynamic;
	public function test_partialdata():Dynamic;
	public function test_readbytes():Dynamic;
}