...
package pandas.tests.test_msgpack.test_unpack;
@:pythonImport("pandas.tests.test_msgpack.test_unpack", "TestUnpack") extern class TestUnpack {
	/**
	...
	**/
	...
	public function test_unpack_array_header_from_file():Dynamic;
	public function test_unpacker_ext_hook():Dynamic;
	public function test_unpacker_hook_refcnt():Dynamic;
}