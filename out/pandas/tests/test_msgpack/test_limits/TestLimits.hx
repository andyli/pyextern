...
package pandas.tests.test_msgpack.test_limits;
@:pythonImport("pandas.tests.test_msgpack.test_limits", "TestLimits") extern class TestLimits {
	/**
	...
	**/
	...
	public function test_array_header():Dynamic;
	public function test_integer():Dynamic;
	public function test_map_header():Dynamic;
	public function test_max_array_len():Dynamic;
	public function test_max_bin_len():Dynamic;
	public function test_max_ext_len():Dynamic;
	public function test_max_map_len():Dynamic;
	public function test_max_str_len():Dynamic;
}