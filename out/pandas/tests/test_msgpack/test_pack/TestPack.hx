...
package pandas.tests.test_msgpack.test_pack;
@:pythonImport("pandas.tests.test_msgpack.test_pack", "TestPack") extern class TestPack {
	/**
	...
	**/
	...
	public function check(data:Dynamic, ?use_list:Dynamic):Dynamic;
	...
	**/
	...
	public function testArraySize(?sizes:Dynamic):Dynamic;
	public function testDecodeBinary():Dynamic;
	public function testIgnoreErrorsPack():Dynamic;
	public function testIgnoreUnicodeErrors():Dynamic;
	public function testMapSize(?sizes:Dynamic):Dynamic;
	public function testNoEncoding():Dynamic;
	public function testPack():Dynamic;
	public function testPackBytes():Dynamic;
	public function testPackFloat():Dynamic;
	public function testPackUTF32():Dynamic;
	public function testPackUnicode():Dynamic;
	public function testStrictUnicodePack():Dynamic;
	public function testStrictUnicodeUnpack():Dynamic;
	public function test_manualreset(?sizes:Dynamic):Dynamic;
	public function test_odict():Dynamic;
	public function test_pairlist():Dynamic;
}