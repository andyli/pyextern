...
@:pythonImport("pandas.tests.test_msgpack.test_buffer") extern class Test_buffer {
	...
	**/
	...
	static public function test_unpack_buffer():Dynamic;
	static public function test_unpack_bytearray():Dynamic;
	/**
