...
package pandas.tests.test_msgpack.test_obj;
@:pythonImport("pandas.tests.test_msgpack.test_obj", "TestObj") extern class TestObj {
	/**
	...
	**/
	...
	public function _arr_to_str(arr:Dynamic):Dynamic;
	/**
	...
	**/
	...
	public function _decode_complex(obj:Dynamic):Dynamic;
	public function _deprecate():Dynamic;
	static public var _diffThreshold : Dynamic;
	public function _encode_complex(obj:Dynamic):Dynamic;
	...
	**/
	...
	public function bad_complex_decoder(o:Dynamic):Dynamic;
	...
	**/
	...
	public function test_an_exception_in_objecthook1():Dynamic;
	public function test_an_exception_in_objecthook2():Dynamic;
	public function test_array_hook():Dynamic;
	public function test_bad_hook():Dynamic;
	public function test_decode_hook():Dynamic;
	public function test_decode_pairs_hook():Dynamic;
	public function test_encode_hook():Dynamic;
	public function test_only_one_obj_hook():Dynamic;
}