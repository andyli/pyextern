...
package pandas.tests.test_msgpack.test_except;
@:pythonImport("pandas.tests.test_msgpack.test_except", "TestExceptions") extern class TestExceptions {
	/**
	...
	**/
	...
	public function test_invalidvalue():Dynamic;
	public function test_raise_from_object_hook():Dynamic;
	public function test_raise_on_find_unsupported_value():Dynamic;
}