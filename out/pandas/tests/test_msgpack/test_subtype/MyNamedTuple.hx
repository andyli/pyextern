...
package pandas.tests.test_msgpack.test_subtype;
@:pythonImport("pandas.tests.test_msgpack.test_subtype", "MyNamedTuple") extern class MyNamedTuple {
	/**
		Return self+value.
	**/
	...
	**/
	...
	/**
		Create new instance of MyNamedTuple(x, y)
	**/
	static public function __new__(_cls:Dynamic, x:Dynamic, y:Dynamic):Dynamic;
	/**
		helper for pickle
	**/
	...
	**/
	...
	/**
		Make a new MyNamedTuple object from a sequence or iterable
	**/
	static public function _make(iterable:Dynamic, ?_new:Dynamic, ?len:Dynamic):Dynamic;
	/**
		Return a new MyNamedTuple object replacing specified fields with new values
	**/
