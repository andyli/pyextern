...
package pandas.tests.test_panelnd;
@:pythonImport("pandas.tests.test_panelnd", "TestPanelnd") extern class TestPanelnd {
	/**
	...
	**/
	...
	public function test_4d_construction():Dynamic;
	public function test_4d_construction_alt():Dynamic;
	public function test_4d_construction_error():Dynamic;
	public function test_5d_construction():Dynamic;
}