...
@:pythonImport("pandas.tests.test_rplot", "TestScaleSize") extern class TestScaleSize {
	/**
	...
	**/
	...
	public function test_scale_overflow():Dynamic;
	public function test_scale_size():Dynamic;
}