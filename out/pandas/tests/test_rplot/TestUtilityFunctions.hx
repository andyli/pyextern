...
package pandas.tests.test_rplot;
@:pythonImport("pandas.tests.test_rplot", "TestUtilityFunctions") extern class TestUtilityFunctions {
	/**
	...
	**/
	...
	public function test_dictionary_union():Dynamic;
	public function test_make_aes1():Dynamic;
	public function test_make_aes2():Dynamic;
	public function test_merge_aes():Dynamic;
	public function test_sequence_layers():Dynamic;
}