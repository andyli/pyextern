...
@:pythonImport("pandas.tests.test_rplot", "TestTrellis") extern class TestTrellis {
	/**
	...
	**/
	...
	public function test_grid_sizes():Dynamic;
	public function test_trellis_cols_rows():Dynamic;
}