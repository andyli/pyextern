...
@:pythonImport("pandas.tests.test_rplot", "TestRPlot") extern class TestRPlot {
	/**
	...
	**/
	...
	public function test_rplot1():Dynamic;
	public function test_rplot2():Dynamic;
	public function test_rplot3():Dynamic;
	public function test_rplot_iris():Dynamic;
}