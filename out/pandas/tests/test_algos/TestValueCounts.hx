...
@:pythonImport("pandas.tests.test_algos", "TestValueCounts") extern class TestValueCounts {
	/**
	...
	**/
	...
	public function test_categorical_nans():Dynamic;
	public function test_categorical_zeroes():Dynamic;
	public function test_dropna():Dynamic;
	public function test_value_counts():Dynamic;
	public function test_value_counts_bins():Dynamic;
	public function test_value_counts_dtypes():Dynamic;
	public function test_value_counts_nat():Dynamic;
}