...
@:pythonImport("pandas.tests.test_algos", "TestFactorize") extern class TestFactorize {
	/**
	...
	**/
	...
	public function test_datelike():Dynamic;
	public function test_factorize_nan():Dynamic;
	public function test_mixed():Dynamic;
	public function test_vector_resize():Dynamic;
	public function test_warn():Dynamic;
}