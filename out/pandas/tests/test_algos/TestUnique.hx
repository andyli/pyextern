...
@:pythonImport("pandas.tests.test_algos", "TestUnique") extern class TestUnique {
	/**
	...
	**/
	...
	public function test_datetime64_dtype_array_returned():Dynamic;
	public function test_ints():Dynamic;
	public function test_object_refcount_bug():Dynamic;
	public function test_objects():Dynamic;
	public function test_on_index_object():Dynamic;
	public function test_timedelta64_dtype_array_returned():Dynamic;
}