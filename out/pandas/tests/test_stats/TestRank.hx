...
package pandas.tests.test_stats;
@:pythonImport("pandas.tests.test_stats", "TestRank") extern class TestRank {
	/**
	...
	**/
	...
	static public var results : Dynamic;
	...
	**/
	...
	public function test_rank_2d_tie_methods():Dynamic;
	public function test_rank_dense_method():Dynamic;
	public function test_rank_descending():Dynamic;
	public function test_rank_int():Dynamic;
	public function test_rank_methods_frame():Dynamic;
	public function test_rank_methods_series():Dynamic;
	public function test_rank_tie_methods():Dynamic;
}