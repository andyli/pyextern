...
@:pythonImport("pandas.tests.test_common", "TestFormattBase") extern class TestFormattBase {
	/**
	...
	**/
	...
	public function test_adjoin():Dynamic;
	public function test_adjoin_unicode():Dynamic;
	public function test_ambiguous_width():Dynamic;
	public function test_east_asian_len():Dynamic;
	public function test_justify():Dynamic;
}