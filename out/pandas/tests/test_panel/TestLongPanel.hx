...
@:pythonImport("pandas.tests.test_panel", "TestLongPanel") extern class TestLongPanel {
	/**
	...
	**/
	...
	public function test_arith_flex_panel():Dynamic;
	public function test_axis_dummies():Dynamic;
	public function test_combineFrame():Dynamic;
	public function test_combinePanel():Dynamic;
	public function test_combine_scalar():Dynamic;
	public function test_combine_series():Dynamic;
	...
	public function test_ops_differently_indexed():Dynamic;
	public function test_ops_scalar():Dynamic;
