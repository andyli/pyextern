...
package pandas.tests.test_dtypes;
@:pythonImport("pandas.tests.test_dtypes", "TestDatetimeTZDtype") extern class TestDatetimeTZDtype {
	/**
	...
	**/
	...
	public function test_construction_from_string():Dynamic;
	public function test_dst():Dynamic;
	public function test_equality():Dynamic;
	public function test_equality_invalid():Dynamic;
	public function test_hash():Dynamic;
	public function test_is_dtype():Dynamic;
	public function test_numpy_informed():Dynamic;
	public function test_pickle():Dynamic;
	public function test_subclass():Dynamic;
}