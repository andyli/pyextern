...
@:pythonImport("pandas.tests.test_series", "TestSeriesNonUnique") extern class TestSeriesNonUnique {
	/**
	...
	**/
	...
	public function test_basic_indexing():Dynamic;
	public function test_datetime_indexing():Dynamic;
	public function test_datetime_timedelta_quantiles():Dynamic;
	public function test_int_indexing():Dynamic;
	public function test_repeat():Dynamic;
	public function test_replace():Dynamic;
	public function test_reset_index():Dynamic;
	public function test_set_index_makes_timeseries():Dynamic;
	public function test_timeseries_coercion():Dynamic;
	public function test_unique_data_ownership():Dynamic;
}