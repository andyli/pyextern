...
@:pythonImport("pandas.tests.test_series", "TestNanops") extern class TestNanops {
	/**
	...
	**/
	...
	public function test_nansum_buglet():Dynamic;
	public function test_overflow():Dynamic;
	public function test_sum_zero():Dynamic;
}