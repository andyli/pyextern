...
@:pythonImport("pandas.tests.test_compat", "TestBuiltinIterators") extern class TestBuiltinIterators {
	/**
	...
	**/
	...
	public function check_result(actual:Dynamic, expected:Dynamic, lengths:Dynamic):Dynamic;
	...
	**/
	...
	public function test_range():Dynamic;
	public function test_zip():Dynamic;
}