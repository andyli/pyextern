...
@:pythonImport("pandas.tests.test_graphics_others", "TestDataFramePlots") extern class TestDataFramePlots {
	/**
	...
	**/
	...
	public function test_andrews_curves():Dynamic;
	public function test_boxplot_axis_limits():Dynamic;
	public function test_boxplot_empty_column():Dynamic;
	public function test_boxplot_legacy():Dynamic;
	public function test_boxplot_return_type_legacy():Dynamic;
	public function test_hist_df_legacy():Dynamic;
	public function test_hist_layout():Dynamic;
	public function test_parallel_coordinates():Dynamic;
	public function test_radviz():Dynamic;
	public function test_scatter_matrix_axis():Dynamic;
	public function test_scatter_plot_legacy():Dynamic;
}