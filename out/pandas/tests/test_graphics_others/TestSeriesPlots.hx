...
@:pythonImport("pandas.tests.test_graphics_others", "TestSeriesPlots") extern class TestSeriesPlots {
	/**
	...
	**/
	...
	public function test_autocorrelation_plot():Dynamic;
	public function test_bootstrap_plot():Dynamic;
	public function test_hist_bins_legacy():Dynamic;
	public function test_hist_by_no_extra_plots():Dynamic;
	...
	public function test_lag_plot():Dynamic;
	public function test_plot_fails_when_ax_differs_from_figure():Dynamic;
}