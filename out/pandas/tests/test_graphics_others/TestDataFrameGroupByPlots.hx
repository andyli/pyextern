...
package pandas.tests.test_graphics_others;
@:pythonImport("pandas.tests.test_graphics_others", "TestDataFrameGroupByPlots") extern class TestDataFrameGroupByPlots {
	/**
	...
	**/
	...
	public function test_axis_share_x():Dynamic;
	public function test_axis_share_xy():Dynamic;
	public function test_axis_share_y():Dynamic;
	public function test_boxplot_legacy():Dynamic;
	public function test_grouped_box_layout():Dynamic;
	public function test_grouped_box_multiple_axes():Dynamic;
	public function test_grouped_box_return_type():Dynamic;
	public function test_grouped_hist_layout():Dynamic;
	public function test_grouped_hist_legacy():Dynamic;
	public function test_grouped_hist_legacy2():Dynamic;
	public function test_grouped_hist_multiple_axes():Dynamic;
	public function test_grouped_plot_fignums():Dynamic;
}