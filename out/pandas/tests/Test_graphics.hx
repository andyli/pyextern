...
@:pythonImport("pandas.tests.test_graphics") extern class Test_graphics {
	...
	static public function _generate_4_axes_via_gridspec():Dynamic;
	...
	**/
	...
	static public function assert_is_valid_plot_return_object(objs:Dynamic):Dynamic;
	/**
