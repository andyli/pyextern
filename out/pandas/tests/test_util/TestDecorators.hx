...
package pandas.tests.test_util;
@:pythonImport("pandas.tests.test_util", "TestDecorators") extern class TestDecorators {
	/**
	...
	**/
	...
	public function test_bad_deprecate_kwarg():Dynamic;
	public function test_callable_deprecate_kwarg():Dynamic;
	public function test_deprecate_kwarg():Dynamic;
	public function test_dict_deprecate_kwarg():Dynamic;
	public function test_missing_deprecate_kwarg():Dynamic;
}