...
@:pythonImport("pandas.tests.test_internals", "TestBlockPlacement") extern class TestBlockPlacement {
	/**
	...
	**/
	...
	public function test_array_to_slice_conversion():Dynamic;
	public function test_blockplacement_add():Dynamic;
	public function test_blockplacement_add_int():Dynamic;
	public function test_not_slice_like_arrays():Dynamic;
	public function test_not_slice_like_slices():Dynamic;
	public function test_slice_iter():Dynamic;
	public function test_slice_len():Dynamic;
	public function test_slice_to_array_conversion():Dynamic;
	public function test_unbounded_slice_raises():Dynamic;
	public function test_zero_step_raises():Dynamic;
}