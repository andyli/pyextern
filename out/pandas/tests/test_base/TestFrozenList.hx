...
package pandas.tests.test_base;
@:pythonImport("pandas.tests.test_base", "TestFrozenList") extern class TestFrozenList {
	/**
	...
	**/
	...
	public function check_mutable_error(args:Dynamic, kwargs:Dynamic):Dynamic;
	public function check_result(result:Dynamic, expected:Dynamic, ?klass:Dynamic):Dynamic;
	...
	**/
	...
	static public var mutable_methods : Dynamic;
	static public var mutable_regex : Dynamic;
	...
	**/
	...
	public function test_inplace():Dynamic;
	public function test_no_mutable_funcs():Dynamic;
	public function test_slicing_maintains_type():Dynamic;
	public function test_string_methods_dont_fail():Dynamic;
	public function test_tricky_container():Dynamic;
	static public var unicode_container : Dynamic;
}