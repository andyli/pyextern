...
@:pythonImport("pandas.tests.test_base", "TestIndexOps") extern class TestIndexOps {
	/**
	...
	**/
	...
	public function test_nanops():Dynamic;
	public function test_ndarray_compat_properties():Dynamic;
	public function test_none_comparison():Dynamic;
	public function test_ops():Dynamic;
	public function test_value_counts_inferred():Dynamic;
	public function test_value_counts_unique_nunique():Dynamic;
}