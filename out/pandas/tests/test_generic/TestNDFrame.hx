...
@:pythonImport("pandas.tests.test_generic", "TestNDFrame") extern class TestNDFrame {
	/**
	...
	**/
	...
	public function test_describe_raises():Dynamic;
	public function test_equals():Dynamic;
	public function test_pipe():Dynamic;
	public function test_pipe_panel():Dynamic;
	public function test_pipe_tuple():Dynamic;
	public function test_pipe_tuple_error():Dynamic;
