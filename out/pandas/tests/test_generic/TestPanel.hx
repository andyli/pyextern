...
@:pythonImport("pandas.tests.test_generic", "TestPanel") extern class TestPanel {
	/**
	...
	**/
	static public function _typ(?data:Dynamic, ?items:Dynamic, ?major_axis:Dynamic, ?minor_axis:Dynamic, ?copy:Dynamic, ?dtype:Dynamic):Dynamic;
	/**
