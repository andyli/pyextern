...
package pandas.tests.test_testing;
@:pythonImport("pandas.tests.test_testing", "TestAssertAlmostEqual") extern class TestAssertAlmostEqual {
	/**
	...
	**/
	...
	public function _assert_almost_equal_both(a:Dynamic, b:Dynamic, kwargs:Dynamic):Dynamic;
	public function _assert_not_almost_equal_both(a:Dynamic, b:Dynamic, kwargs:Dynamic):Dynamic;
	/**
	...
	**/
	...
	public function test_assert_almost_equal_dict_like_object():Dynamic;
	public function test_assert_almost_equal_dicts():Dynamic;
	public function test_assert_almost_equal_edge_case_ndarrays():Dynamic;
	public function test_assert_almost_equal_inf():Dynamic;
	public function test_assert_almost_equal_iterables():Dynamic;
	public function test_assert_almost_equal_null():Dynamic;
	public function test_assert_almost_equal_numbers():Dynamic;
	public function test_assert_almost_equal_numbers_with_mixed():Dynamic;
	public function test_assert_almost_equal_numbers_with_zeros():Dynamic;
	public function test_assert_almost_equal_strings():Dynamic;
}