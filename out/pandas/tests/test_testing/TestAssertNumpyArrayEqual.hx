...
@:pythonImport("pandas.tests.test_testing", "TestAssertNumpyArrayEqual") extern class TestAssertNumpyArrayEqual {
	/**
	...
	**/
	...
	public function test_assert_almost_equal_iterable_message():Dynamic;
	public function test_numpy_array_equal_message():Dynamic;
}