...
@:pythonImport("pandas.tests.test_testing", "TestAssertIndexEqual") extern class TestAssertIndexEqual {
	/**
	...
	**/
	...
	public function test_index_equal_message():Dynamic;
	public function test_index_equal_metadata_message():Dynamic;
}