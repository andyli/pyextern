...
@:pythonImport("pandas.tests.test_testing", "TestAssertFrameEqual") extern class TestAssertFrameEqual {
	/**
	...
	**/
	...
	public function test_empty_dtypes():Dynamic;
	public function test_frame_equal_message():Dynamic;
