...
@:pythonImport("pandas.tests.test_testing", "TestAssertSeriesEqual") extern class TestAssertSeriesEqual {
	/**
	...
	**/
	...
	public function _assert_equal(x:Dynamic, y:Dynamic, kwargs:Dynamic):Dynamic;
	public function _assert_not_equal(a:Dynamic, b:Dynamic, kwargs:Dynamic):Dynamic;
	/**
	...
	**/
	...
	public function test_index_dtype():Dynamic;
	public function test_less_precise():Dynamic;
	public function test_multiindex_dtype():Dynamic;
	public function test_not_equal():Dynamic;
	public function test_series_equal_message():Dynamic;
}