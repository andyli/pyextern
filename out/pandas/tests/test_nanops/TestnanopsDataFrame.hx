...
package pandas.tests.test_nanops;
@:pythonImport("pandas.tests.test_nanops", "TestnanopsDataFrame") extern class TestnanopsDataFrame {
	/**
	...
	**/
	...
	public function _argminmax_wrap(value:Dynamic, ?axis:Dynamic, ?func:Dynamic):Dynamic;
	public function _badobj_wrap(value:Dynamic, func:Dynamic, ?allow_complex:Dynamic, kwargs:Dynamic):Dynamic;
	/**
	...
	**/
	...
	public function _minmax_wrap(value:Dynamic, ?axis:Dynamic, ?func:Dynamic):Dynamic;
	public function _skew_kurt_wrap(values:Dynamic, ?axis:Dynamic, ?func:Dynamic):Dynamic;
	...
	**/
	...
	public function check_bool(func:Dynamic, value:Dynamic, correct:Dynamic, args:Dynamic, kwargs:Dynamic):Dynamic;
	public function check_fun(testfunc:Dynamic, targfunc:Dynamic, testar:Dynamic, ?targar:Dynamic, ?targarnan:Dynamic, kwargs:Dynamic):Dynamic;
	public function check_fun_data(testfunc:Dynamic, targfunc:Dynamic, testarval:Dynamic, targarval:Dynamic, targarnanval:Dynamic, kwargs:Dynamic):Dynamic;
	public function check_funs(testfunc:Dynamic, targfunc:Dynamic, ?allow_complex:Dynamic, ?allow_all_nan:Dynamic, ?allow_str:Dynamic, ?allow_date:Dynamic, ?allow_tdelta:Dynamic, ?allow_obj:Dynamic, kwargs:Dynamic):Dynamic;
	public function check_funs_ddof(testfunc:Dynamic, targfunc:Dynamic, ?allow_complex:Dynamic, ?allow_all_nan:Dynamic, ?allow_str:Dynamic, ?allow_date:Dynamic, ?allow_tdelta:Dynamic, ?allow_obj:Dynamic):Dynamic;
	public function check_nancomp(checkfun:Dynamic, targ0:Dynamic):Dynamic;
	public function check_nancorr_nancov_1d(checkfun:Dynamic, targ0:Dynamic, targ1:Dynamic, kwargs:Dynamic):Dynamic;
	public function check_nancorr_nancov_2d(checkfun:Dynamic, targ0:Dynamic, targ1:Dynamic, kwargs:Dynamic):Dynamic;
	public function check_results(targ:Dynamic, res:Dynamic, axis:Dynamic):Dynamic;
	...
	**/
	...
	public function test__bn_ok_dtype():Dynamic;
	public function test__has_infs():Dynamic;
	public function test__isfinite():Dynamic;
	public function test_nanall():Dynamic;
	public function test_nanany():Dynamic;
	public function test_nanargmax():Dynamic;
	public function test_nanargmin():Dynamic;
	public function test_nancorr():Dynamic;
	public function test_nancorr_kendall():Dynamic;
	public function test_nancorr_pearson():Dynamic;
	public function test_nancorr_spearman():Dynamic;
	public function test_nancov():Dynamic;
	public function test_naneq():Dynamic;
	public function test_nange():Dynamic;
	public function test_nangt():Dynamic;
	public function test_nankurt():Dynamic;
	public function test_nanle():Dynamic;
	public function test_nanlt():Dynamic;
	public function test_nanmax():Dynamic;
	public function test_nanmean():Dynamic;
	public function test_nanmean_overflow():Dynamic;
	public function test_nanmedian():Dynamic;
	public function test_nanmin():Dynamic;
	public function test_nanne():Dynamic;
	public function test_nanprod():Dynamic;
	public function test_nansem():Dynamic;
	public function test_nanskew():Dynamic;
	public function test_nanstd():Dynamic;
	public function test_nansum():Dynamic;
	public function test_nanvar():Dynamic;
	public function test_returned_dtype():Dynamic;
}