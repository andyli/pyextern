...
@:pythonImport("pandas.tests.test_nanops", "TestEnsureNumeric") extern class TestEnsureNumeric {
	/**
	...
	**/
	...
	public function test_convertable_values():Dynamic;
	public function test_ndarray():Dynamic;
	public function test_non_convertable_values():Dynamic;
	public function test_numeric_values():Dynamic;
}