...
@:pythonImport("pandas.tests.test_frame", "TestDataFrameEvalNumExprPython") extern class TestDataFrameEvalNumExprPython {
	/**
	...
	**/
	...
	public function test_bool_arith_expr():Dynamic;
	public function test_invalid_type_for_operator_raises():Dynamic;
	public function test_simple_expr():Dynamic;
}