...
@:pythonImport("pandas.tests.test_indexing", "TestCategoricalIndex") extern class TestCategoricalIndex {
	/**
	...
	**/
	...
	public function test_boolean_selection():Dynamic;
	public function test_loc_listlike():Dynamic;
	public function test_loc_scalar():Dynamic;
	public function test_loc_slice():Dynamic;
	public function test_read_only_source():Dynamic;
