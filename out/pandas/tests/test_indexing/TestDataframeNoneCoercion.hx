...
@:pythonImport("pandas.tests.test_indexing", "TestDataframeNoneCoercion") extern class TestDataframeNoneCoercion {
	static public var EXPECTED_SINGLE_ROW_RESULTS : Dynamic;
	/**
	...
	**/
	...
	public function test_coercion_with_loc():Dynamic;
	public function test_coercion_with_setitem_and_dataframe():Dynamic;
	public function test_none_coercion_loc_and_dataframe():Dynamic;
	public function test_none_coercion_mixed_dtypes():Dynamic;
}