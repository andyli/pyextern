...
@:pythonImport("pandas.tests.test_indexing", "TestSeriesNoneCoercion") extern class TestSeriesNoneCoercion {
	static public var EXPECTED_RESULTS : Dynamic;
	/**
	...
	**/
	...
	public function test_coercion_with_loc_and_series():Dynamic;
	public function test_coercion_with_loc_setitem():Dynamic;
	public function test_coercion_with_setitem():Dynamic;
	public function test_coercion_with_setitem_and_series():Dynamic;
}