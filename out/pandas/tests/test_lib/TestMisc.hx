...
@:pythonImport("pandas.tests.test_lib", "TestMisc") extern class TestMisc {
	/**
	...
	**/
	...
	public function test_infer_dtype_bytes():Dynamic;
	public function test_max_len_string_array():Dynamic;
	public function test_maybe_indices_to_slice_both_edges():Dynamic;
	public function test_maybe_indices_to_slice_left_edge():Dynamic;
	public function test_maybe_indices_to_slice_middle():Dynamic;
	public function test_maybe_indices_to_slice_right_edge():Dynamic;
}