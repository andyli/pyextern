...
package pandas.tests.test_lib;
@:pythonImport("pandas.tests.test_lib", "Testisscalar") extern class Testisscalar {
	/**
	...
	**/
	...
	public function test_isscalar_builtin_nonscalars():Dynamic;
	public function test_isscalar_builtin_scalars():Dynamic;
	public function test_isscalar_numpy_array_scalars():Dynamic;
	public function test_isscalar_numpy_arrays():Dynamic;
	public function test_isscalar_numpy_zerodim_arrays():Dynamic;
	public function test_isscalar_pandas_scalars():Dynamic;
	public function test_lisscalar_pandas_containers():Dynamic;
}