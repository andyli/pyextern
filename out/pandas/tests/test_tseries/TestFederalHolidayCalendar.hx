...
@:pythonImport("pandas.tests.test_tseries", "TestFederalHolidayCalendar") extern class TestFederalHolidayCalendar {
	/**
	...
	**/
	...
	public function test_memorial_day():Dynamic;
	public function test_no_mlk_before_1984():Dynamic;
}