...
@:pythonImport("pandas.tests.test_tseries", "TestTsUtil") extern class TestTsUtil {
	/**
	...
	**/
	...
	public function test_max_valid():Dynamic;
	public function test_min_valid():Dynamic;
	public function test_to_datetime_bijective():Dynamic;
}