...
@:pythonImport("pandas.tests.test_tseries", "TestHolidayConflictingArguments") extern class TestHolidayConflictingArguments {
	/**
	...
	**/
	...
	public function test_both_offset_observance_raises():Dynamic;
}