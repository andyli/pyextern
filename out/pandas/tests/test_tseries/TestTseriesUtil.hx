...
@:pythonImport("pandas.tests.test_tseries", "TestTseriesUtil") extern class TestTseriesUtil {
	/**
	...
	**/
	...
	public function test_backfill():Dynamic;
	public function test_combineFunc():Dynamic;
	public function test_groupby():Dynamic;
	public function test_groupby_withnull():Dynamic;
