...
package pandas.tests.test_tseries;
@:pythonImport("pandas.tests.test_tseries", "TestTypeInference") extern class TestTypeInference {
	/**
	...
	**/
	...
	public function test_bools():Dynamic;
	public function test_categorical():Dynamic;
	public function test_date():Dynamic;
	public function test_datetime():Dynamic;
	public function test_floats():Dynamic;
	public function test_integers():Dynamic;
	public function test_length_zero():Dynamic;
	public function test_object():Dynamic;
	public function test_string():Dynamic;
	public function test_to_object_array_tuples():Dynamic;
