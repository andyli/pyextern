...
@:pythonImport("pandas.tests.test_tseries", "TestPeriodField") extern class TestPeriodField {
	/**
	...
	**/
	...
	public function test_get_period_field_array_raises_on_out_of_range():Dynamic;
	public function test_get_period_field_raises_on_out_of_range():Dynamic;
}