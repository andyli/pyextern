...
package pandas.computation.engines;
@:pythonImport("pandas.computation.engines", "AbstractEngine") extern class AbstractEngine {
	...
	**/
	...
	static public var has_neg_frac : Dynamic;
}