...
@:pythonImport("pandas.computation.tests.test_eval", "TestMathNumExprPython") extern class TestMathNumExprPython {
	/**
	...
	**/
	...
	public function check_result_type(dtype:Dynamic, expect_dtype:Dynamic):Dynamic;
	...
	**/
	...
	public function test_binary_functions():Dynamic;
	public function test_df_arithmetic_subexpression():Dynamic;
	public function test_df_use_case():Dynamic;
	public function test_keyword_arg():Dynamic;
	public function test_result_types():Dynamic;
	public function test_unary_functions():Dynamic;
	public function test_undefined_func():Dynamic;
}