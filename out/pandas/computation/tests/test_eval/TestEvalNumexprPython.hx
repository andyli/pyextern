...
@:pythonImport("pandas.computation.tests.test_eval", "TestEvalNumexprPython") extern class TestEvalNumexprPython {
	/**
	...
	**/
	...
	public function check_alignment(result:Dynamic, nlhs:Dynamic, ghs:Dynamic, op:Dynamic):Dynamic;
	public function check_binary_arith_op(lhs:Dynamic, arith1:Dynamic, rhs:Dynamic):Dynamic;
	public function check_chained_cmp_op(lhs:Dynamic, cmp1:Dynamic, mid:Dynamic, cmp2:Dynamic, rhs:Dynamic):Dynamic;
	public function check_complex_cmp_op(lhs:Dynamic, cmp1:Dynamic, rhs:Dynamic, binop:Dynamic, cmp2:Dynamic):Dynamic;
	public function check_compound_invert_op(lhs:Dynamic, cmp1:Dynamic, rhs:Dynamic):Dynamic;
	public function check_floor_division(lhs:Dynamic, arith1:Dynamic, rhs:Dynamic):Dynamic;
	public function check_modulus(lhs:Dynamic, arith1:Dynamic, rhs:Dynamic):Dynamic;
	public function check_pow(lhs:Dynamic, arith1:Dynamic, rhs:Dynamic):Dynamic;
	public function check_simple_cmp_op(lhs:Dynamic, cmp1:Dynamic, rhs:Dynamic):Dynamic;
	public function check_single_invert_op(lhs:Dynamic, cmp1:Dynamic, rhs:Dynamic):Dynamic;
	...
	**/
	...
	public function ex(op:Dynamic, ?var_name:Dynamic):Dynamic;
	/**
	...
	**/
	...
	public function get_expected_pow_result(lhs:Dynamic, rhs:Dynamic):Dynamic;
	...
	**/
	...
	public function setup_data():Dynamic;
	public function setup_ops():Dynamic;
	/**
	...
	**/
	...
	public function test_binary_arith_ops():Dynamic;
	public function test_chained_cmp_op():Dynamic;
	public function test_complex_cmp_ops():Dynamic;
	public function test_compound_invert_op():Dynamic;
	public function test_disallow_scalar_bool_ops():Dynamic;
	public function test_floor_division():Dynamic;
	public function test_frame_invert():Dynamic;
	public function test_frame_negate():Dynamic;
	public function test_frame_pos():Dynamic;
	public function test_identical():Dynamic;
	public function test_modulus():Dynamic;
	public function test_pow():Dynamic;
	public function test_scalar_unary():Dynamic;
	public function test_series_invert():Dynamic;
	public function test_series_negate():Dynamic;
	public function test_series_pos():Dynamic;
	public function test_simple_cmp_ops():Dynamic;
	public function test_single_invert_op():Dynamic;
}