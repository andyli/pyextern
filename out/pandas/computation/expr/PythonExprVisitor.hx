...
@:pythonImport("pandas.computation.expr", "PythonExprVisitor") extern class PythonExprVisitor {
	...
	**/
	...
	public function visit_BoolOp(args:Dynamic, kwargs:Dynamic):Dynamic;
	...
	**/
	...
	public function visit_Dict(args:Dynamic, kwargs:Dynamic):Dynamic;
	...
	**/
	...
	public function visit_In(args:Dynamic, kwargs:Dynamic):Dynamic;
	/**
		df.index[4] 
	**/
	...
	**/
	...
	public function visit_Not(args:Dynamic, kwargs:Dynamic):Dynamic;
	/**
		Return a partial function with an Op subclass with an operator
		already passed.
	...
	**/
	...
	public function visit_NotIn(args:Dynamic, kwargs:Dynamic):Dynamic;
