...
@:pythonImport("pandas.computation.pytables", "JointConditionBinOp") extern class JointConditionBinOp {
	/**
	...
	**/
	public function __init__(op:Dynamic, lhs:Dynamic, rhs:Dynamic, queryables:Dynamic, encoding:Dynamic):Dynamic;
