...
package pandas.plotting._style;
@:pythonImport("pandas.plotting._style", "_Options") extern class _Options {
	static public var _ALIASES : Dynamic;
	static public var _DEFAULT_KEYS : Dynamic;
	...
	**/
	@:native("__init__")
	public function ___init__(?deprecated:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(?deprecated:Dynamic):Void;
	/**
	...
	**/
	...
	/**
		...
		Aliasing allowed.
	**/
	public function use(key:Dynamic, value:Dynamic):Dynamic;
	/**
