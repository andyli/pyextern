...
@:pythonImport("pandas.sandbox.qtpandas", "DataFrameWidget") extern class DataFrameWidget {
	...
	**/
	@:native("__init__")
	public function ___init__(dataFrame:Dynamic, ?parent:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(dataFrame:Dynamic, ?parent:Dynamic):Void;
	/**
		Return self<=value.
	**/
