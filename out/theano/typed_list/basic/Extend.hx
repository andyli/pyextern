...
@:pythonImport("theano.typed_list.basic", "Extend") extern class Extend {
	...
	**/
	...
	public function _c_code_(node:Dynamic, name:Dynamic, inp:Dynamic, out:Dynamic, sub:Dynamic):Dynamic;
	/**
	...
	**/
	...
	public function c_code_cache_version_():Dynamic;
	/**
		Return a tuple of integers indicating the version of this Op.
	...
	**/
	public function make_node(x:Dynamic, toAppend:Dynamic):Dynamic;
	/**
