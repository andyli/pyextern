...
@:pythonImport("theano.scan_module.scan_opt", "PushOutScanOutput") extern class PushOutScanOutput {
	/**
	...
	**/
	...
	public function add_nitsot_outputs(fgraph:Dynamic, old_scan_node:Dynamic, old_scan_args:Dynamic, new_outputs_inner:Dynamic):Dynamic;
	/**
	...
	**/
	...
	public function get_outer_ndim(_var:Dynamic, scan_args:Dynamic):Dynamic;
	/**
		...
		axis).
	**/
	public function inner_sitsot_only_last_step_used(_var:Dynamic, scan_args:Dynamic):Dynamic;
	/**
	...
	**/
	...
	public function process_node(fgraph:Dynamic, node:Dynamic):Dynamic;
	public function push_out_inner_vars(fgraph:Dynamic, inner_vars:Dynamic, old_scan_node:Dynamic, old_scan_args:Dynamic):Dynamic;
}