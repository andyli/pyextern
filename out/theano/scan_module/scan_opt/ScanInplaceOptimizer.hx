...
@:pythonImport("theano.scan_module.scan_opt", "ScanInplaceOptimizer") extern class ScanInplaceOptimizer {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(?typeInfer:Dynamic, ?gpu_flag:Dynamic, ?gpua_flag:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(?typeInfer:Dynamic, ?gpu_flag:Dynamic, ?gpua_flag:Dynamic):Void;
	/**
	...
	**/
	...
	/**
		...
		alloc_ops : list of Op classes
		    ...
		    on them.
	**/
	public function attempt_scan_inplace(fgraph:Dynamic, node:Dynamic, output_indices:Dynamic, alloc_ops:Dynamic):Dynamic;
	/**
