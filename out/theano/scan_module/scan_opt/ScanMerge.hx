...
@:pythonImport("theano.scan_module.scan_opt", "ScanMerge") extern class ScanMerge {
	/**
	...
	**/
	public function belongs_to_set(node:Dynamic, set_nodes:Dynamic):Dynamic;
	public function merge(nodes:Dynamic):Dynamic;
	/**
