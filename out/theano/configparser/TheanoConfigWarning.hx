...
@:pythonImport("theano.configparser", "TheanoConfigWarning") extern class TheanoConfigWarning {
	/**
		exception cause
	**/
	...
	**/
	...
	static public function warn(message:Dynamic, ?stacklevel:Dynamic):Dynamic;
	/**
