...
@:pythonImport("theano.scalar.basic_scipy", "Jv") extern class Jv {
	...
	**/
	...
	public function impl(v:Dynamic, x:Dynamic):Dynamic;
	/**
	...
	**/
	...
	static public function st_impl(v:Dynamic, x:Dynamic):Dynamic;
	/**
