...
@:pythonImport("theano.scalar.basic_scipy", "Chi2SF") extern class Chi2SF {
	...
	**/
	...
	public function impl(x:Dynamic, k:Dynamic):Dynamic;
	/**
	...
	**/
	...
	static public function st_impl(x:Dynamic, k:Dynamic):Dynamic;
	/**
