...
@:pythonImport("theano.scalar.basic_scipy", "GammaIncC") extern class GammaIncC {
	...
	**/
	...
	public function impl(k:Dynamic, x:Dynamic):Dynamic;
	/**
	...
	**/
	...
	static public function st_impl(k:Dynamic, x:Dynamic):Dynamic;
	/**
