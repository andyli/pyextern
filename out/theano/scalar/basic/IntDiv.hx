...
@:pythonImport("theano.scalar.basic", "IntDiv") extern class IntDiv {
	...
	**/
	...
	static public var complex_error : Dynamic;
	...
	**/
	...
	public function grad(inputs:Dynamic, g_output:Dynamic):Dynamic;
	public function impl(x:Dynamic, y:Dynamic):Dynamic;
	/**
