...
@:pythonImport("theano.scalar.basic", "ComplexFromPolar") extern class ComplexFromPolar {
	...
	**/
	...
	public function impl(r:Dynamic, theta:Dynamic):Dynamic;
	/**
	...
	**/
	...
	static public function output_types_preference(x:Dynamic, y:Dynamic):Dynamic;
	/**
