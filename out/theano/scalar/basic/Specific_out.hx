...
@:pythonImport("theano.scalar.basic", "specific_out") extern class Specific_out {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(?spec:python.VarArgs<Dynamic>):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(?spec:python.VarArgs<Dynamic>):Void;
	/**
