...
@:pythonImport("theano.scalar.basic", "FixedLogicalComparison") extern class FixedLogicalComparison {
	...
	**/
	...
	public function output_types(?input_dtypes:python.VarArgs<Dynamic>):Dynamic;
	/**
