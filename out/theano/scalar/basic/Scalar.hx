...
@:pythonImport("theano.scalar.basic", "Scalar") extern class Scalar {
	/**
	...
	**/
	...
	public function upcast(?others:python.VarArgs<Dynamic>):Dynamic;
	/**
	...
	**/
	...
	/**
		...
		bool
	**/
	public function values_eq_approx(a:Dynamic, b:Dynamic, ?tolerance:Dynamic):Dynamic;
}