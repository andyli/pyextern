...
@:pythonImport("theano.scalar.basic", "Cast") extern class Cast {
	...
	**/
	@:native("__init__")
	public function ___init__(o_type:Dynamic, ?name:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(o_type:Dynamic, ?name:Dynamic):Void;
	/**
	...
	**/
	...
	public function impl(input:Dynamic):Dynamic;
	/**
