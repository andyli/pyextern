...
@:pythonImport("theano.scalar.basic", "transfer_type") extern class Transfer_type {
	/**
		Call self as a function.
	**/
	public function __call__(?types:python.VarArgs<Dynamic>):Dynamic;
	...
	**/
	@:native("__init__")
	public function ___init__(?transfer:python.VarArgs<Dynamic>):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(?transfer:python.VarArgs<Dynamic>):Void;
	/**
