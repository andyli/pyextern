...
@:pythonImport("theano.scalar.basic", "Composite") extern class Composite {
	public function L_op(inputs:Dynamic, outputs:Dynamic, output_gradients:Dynamic):Dynamic;
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(inputs:Dynamic, outputs:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(inputs:Dynamic, outputs:Dynamic):Void;
	/**
	...
	**/
	...
	/**
		...
		MethodNotDefined
		    The subclass does not override this method.
	**/
	public function c_code(node:Dynamic, nodename:Dynamic, inames:Dynamic, onames:Dynamic, sub:Dynamic):Dynamic;
	/**
	...
	**/
	public function c_code_contiguous(node:Dynamic, name:Dynamic, inp:Dynamic, out:Dynamic, sub:Dynamic):Dynamic;
	/**
	...
	**/
	...
	public function clone_float32():Dynamic;
	...
	**/
	...
	public function impl(?inputs:python.VarArgs<Dynamic>):Dynamic;
	/**
		Assemble the C code for this Composite Op.
		
		The result is assigned to `self._c_code`.
	**/
	public function init_c_code():Dynamic;
	public function init_fgraph():Dynamic;
	/**
		Return a readable string representation of self.fgraph.
	**/
	public function init_name():Dynamic;
	static public var init_param : Dynamic;
	/**
		Return a list of functions that compute each output of self.
	**/
	public function init_py_impls():Dynamic;
	/**
	...
	**/
	public function make_new_inplace(?output_types_preference:Dynamic, ?name:Dynamic):Dynamic;
	/**
	...
	**/
	...
	public function output_types(input_types:Dynamic):Dynamic;
	/**
		...
		MethodNotDefined
		    The subclass does not override this method.
	**/
	public function perform(node:Dynamic, inputs:Dynamic, output_storage:Dynamic):Dynamic;
	/**
