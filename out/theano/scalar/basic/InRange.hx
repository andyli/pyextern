...
@:pythonImport("theano.scalar.basic", "InRange") extern class InRange {
	...
	**/
	@:native("__init__")
	public function ___init__(openlow:Dynamic, openhi:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(openlow:Dynamic, openhi:Dynamic):Void;
	/**
	...
	**/
	...
	public function get_grad(elem:Dynamic):Dynamic;
	public function grad(inputs:Dynamic, gout:Dynamic):Dynamic;
	public function impl(x:Dynamic, low:Dynamic, hi:Dynamic):Dynamic;
	/**
