...
@:pythonImport("theano.scalar.basic_sympy", "SymPyCCode") extern class SymPyCCode {
	...
	**/
	@:native("__init__")
	public function ___init__(inputs:Dynamic, expr:Dynamic, ?name:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(inputs:Dynamic, expr:Dynamic, ?name:Dynamic):Void;
	/**
	...
	**/
	...
	public function _info():Dynamic;
	public function _sympy_c_code():Dynamic;
	/**
	...
	**/
	...
	/**
		...
		MethodNotDefined
		    The subclass does not override this method.
	**/
	public function c_code(node:Dynamic, name:Dynamic, input_names:Dynamic, output_names:Dynamic, sub:Dynamic):Dynamic;
	/**
	...
	**/
	...
	public function output_types(types:Dynamic):Dynamic;
	public function output_types_preference(?inputs:python.VarArgs<Dynamic>):Dynamic;
	/**
