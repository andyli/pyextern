...
package theano.raise_op;
@:pythonImport("theano.raise_op", "Raise") extern class Raise {
	...
	**/
	@:native("__init__")
	public function ___init__(?msg:Dynamic, ?exc:Dynamic):Dynamic;
	/**
		msg - the argument to the exception
		exc - an exception class to raise in self.perform
	**/
	public function new(?msg:Dynamic, ?exc:Dynamic):Void;
	/**
