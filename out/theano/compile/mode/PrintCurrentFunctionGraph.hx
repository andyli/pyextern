...
@:pythonImport("theano.compile.mode", "PrintCurrentFunctionGraph") extern class PrintCurrentFunctionGraph {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(header:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(header:Dynamic):Void;
	/**
