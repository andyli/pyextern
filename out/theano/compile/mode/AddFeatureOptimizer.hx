...
@:pythonImport("theano.compile.mode", "AddFeatureOptimizer") extern class AddFeatureOptimizer {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(feature:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(feature:Dynamic):Void;
	/**
