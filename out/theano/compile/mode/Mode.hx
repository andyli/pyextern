...
@:pythonImport("theano.compile.mode", "Mode") extern class Mode {
	...
	**/
	@:native("__init__")
	public function ___init__(?linker:Dynamic, ?optimizer:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(?linker:Dynamic, ?optimizer:Dynamic):Void;
	/**
