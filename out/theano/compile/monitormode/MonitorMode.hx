...
package theano.compile.monitormode;
@:pythonImport("theano.compile.monitormode", "MonitorMode") extern class MonitorMode {
	...
	**/
	@:native("__init__")
	public function ___init__(?pre_func:Dynamic, ?post_func:Dynamic, ?optimizer:Dynamic, ?linker:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(?pre_func:Dynamic, ?post_func:Dynamic, ?optimizer:Dynamic, ?linker:Dynamic):Void;
	/**
	...
	**/
	public function eval(i:Dynamic, node:Dynamic, fn:Dynamic):Dynamic;
