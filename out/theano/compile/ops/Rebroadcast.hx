...
@:pythonImport("theano.compile.ops", "Rebroadcast") extern class Rebroadcast {
	...
	**/
	@:native("__init__")
	public function ___init__(?axis:python.VarArgs<Dynamic>):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(?axis:python.VarArgs<Dynamic>):Void;
	/**
