...
@:pythonImport("theano.compile.ops", "FromFunctionOp") extern class FromFunctionOp {
	...
	**/
	@:native("__init__")
	public function ___init__(fn:Dynamic, itypes:Dynamic, otypes:Dynamic, infer_shape:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(fn:Dynamic, itypes:Dynamic, otypes:Dynamic, infer_shape:Dynamic):Void;
	/**
	...
	**/
	...
	public function _infer_shape(node:Dynamic, input_shapes:Dynamic):Dynamic;
	/**
