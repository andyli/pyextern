...
@:pythonImport("theano.compile.builders", "OpFromGraph") extern class OpFromGraph {
	...
	**/
	...
	static public function _filter_grad_var(grad:Dynamic, inp:Dynamic):Dynamic;
	static public function _filter_rop_var(inpJ:Dynamic, out:Dynamic):Dynamic;
	/**
	...
	**/
	public function _recompute_rop_op():Dynamic;
	/**
	...
	**/
	public function set_rop_overrides(rop_overrides:Dynamic):Dynamic;
}