...
@:pythonImport("theano.compile.debugmode", "_Linker") extern class _Linker {
	...
	**/
	@:native("__init__")
	public function ___init__(maker:Dynamic, ?schedule:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(maker:Dynamic, ?schedule:Dynamic):Void;
	/**
