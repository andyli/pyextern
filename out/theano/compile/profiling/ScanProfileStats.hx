...
@:pythonImport("theano.compile.profiling", "ScanProfileStats") extern class ScanProfileStats {
	...
	**/
	@:native("__init__")
	public function ___init__(?atexit_print:Dynamic, ?name:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(?atexit_print:Dynamic, ?name:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Void;
	/**
	...
	**/
	...
	static public var call_time : Dynamic;
	static public var callcount : Dynamic;
	/**
	...
	**/
	...
	static public var nbsteps : Dynamic;
	/**
		dict op -> total number of thunk calls
	**/
	...
	**/
	...
	public function print_extra(file:Dynamic):Dynamic;
	...
	**/
	...
	static public var variable_offset : Dynamic;
