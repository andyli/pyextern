...
@:pythonImport("theano.gpuarray.nnet", "GpuCrossentropySoftmax1HotWithBiasDx") extern class GpuCrossentropySoftmax1HotWithBiasDx {
	...
	**/
	public function make_node(dnll:Dynamic, sm:Dynamic, y_idx:Dynamic):Dynamic;
	/**
