...
@:pythonImport("theano.gpuarray.multinomial", "GPUAChoiceFromUniform") extern class GPUAChoiceFromUniform {
	...
	**/
	@:native("__init__")
	public function ___init__(odtype:Dynamic, ?replace:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(odtype:Dynamic, ?replace:Dynamic):Void;
	/**
