...
@:pythonImport("theano.gpuarray.multinomial", "GPUAMultinomialWOReplacementFromUniform") extern class GPUAMultinomialWOReplacementFromUniform {
	...
	**/
	public function c_code(node:Dynamic, name:Dynamic, inp:Dynamic, outputs:Dynamic, sub:Dynamic):Dynamic;
	/**
