...
@:pythonImport("theano.gpuarray.blas", "GpuCorrMM_gradWeights") extern class GpuCorrMM_gradWeights {
	...
	**/
	@:native("__init__")
	public function ___init__(?border_mode:Dynamic, ?subsample:Dynamic, ?filter_dilation:Dynamic, ?num_groups:Dynamic, ?unshared:Dynamic):Dynamic;
	/**
		Sections are loaded from files in order with sections in later
		files overriding sections in previous files.
	**/
	public function new(?border_mode:Dynamic, ?subsample:Dynamic, ?filter_dilation:Dynamic, ?num_groups:Dynamic, ?unshared:Dynamic):Void;
	/**
	...
	**/
	...
	public function _type_macros(node:Dynamic):Dynamic;
	/**
