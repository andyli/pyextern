...
@:pythonImport("theano.gpuarray.blas", "GpuGemv") extern class GpuGemv {
	...
	**/
	public function make_node(y:Dynamic, alpha:Dynamic, A:Dynamic, x:Dynamic, beta:Dynamic):Dynamic;
	/**
