...
@:pythonImport("theano.gpuarray.elemwise", "GpuCAReduceCuda") extern class GpuCAReduceCuda {
	...
	**/
	@:native("__init__")
	public function ___init__(scalar_op:Dynamic, ?axis:Dynamic, ?reduce_mask:Dynamic, ?dtype:Dynamic, ?acc_dtype:Dynamic, ?pre_scalar_op:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(scalar_op:Dynamic, ?axis:Dynamic, ?reduce_mask:Dynamic, ?dtype:Dynamic, ?acc_dtype:Dynamic, ?pre_scalar_op:Dynamic):Void;
	/**
	...
	**/
	...
	public function _acc_dtype(idtype:Dynamic):Dynamic;
	/**
	...
	**/
	public function _k_decl(node:Dynamic, nodename:Dynamic, ?pattern:Dynamic, ?ndim:Dynamic, ?reduce_mask:Dynamic):Dynamic;
	public function _k_init(node:Dynamic, nodename:Dynamic):Dynamic;
	/**
		WRITEME
	...
	**/
	public function _k_reduce_buf(z_pos:Dynamic, node:Dynamic, name:Dynamic, sub:Dynamic):Dynamic;
	public function _k_reduce_buf_multiple(z_pos:Dynamic, node:Dynamic, name:Dynamic, nb_reduce:Dynamic):Dynamic;
	/**
		...
		The return value looks something like:
		    ...
		    .. code-block:: c
		        ...
		        %(err_check)s
	**/
	public function _makecall(node:Dynamic, name:Dynamic, x:Dynamic, z:Dynamic, fail:Dynamic, ?pattern:Dynamic, ?extra_dims:Dynamic, ?extra_strides:Dynamic):Dynamic;
	public function _output_dtype(idtype:Dynamic):Dynamic;
	/**
	...
	**/
	...
	public function c_code_reduce_010(sio:Dynamic, node:Dynamic, name:Dynamic, x:Dynamic, z:Dynamic, fail:Dynamic):Dynamic;
	public function c_code_reduce_0101(sio:Dynamic, node:Dynamic, name:Dynamic, x:Dynamic, z:Dynamic, fail:Dynamic):Dynamic;
	public function c_code_reduce_011(sio:Dynamic, node:Dynamic, name:Dynamic, x:Dynamic, z:Dynamic, fail:Dynamic):Dynamic;
	public function c_code_reduce_0111(sio:Dynamic, node:Dynamic, name:Dynamic, x:Dynamic, z:Dynamic, fail:Dynamic):Dynamic;
	/**
		Parameters
		----------
		N
		    ...
		    Work for N=1,2,3.
	**/
	public function c_code_reduce_01X(sio:Dynamic, node:Dynamic, name:Dynamic, x:Dynamic, z:Dynamic, fail:Dynamic, N:Dynamic):Dynamic;
	public function c_code_reduce_1(sio:Dynamic, node:Dynamic, name:Dynamic, x:Dynamic, z:Dynamic, fail:Dynamic):Dynamic;
	public function c_code_reduce_10(sio:Dynamic, node:Dynamic, name:Dynamic, x:Dynamic, z:Dynamic, fail:Dynamic):Dynamic;
	public function c_code_reduce_100(sio:Dynamic, node:Dynamic, name:Dynamic, x:Dynamic, z:Dynamic, fail:Dynamic):Dynamic;
	public function c_code_reduce_101(sio:Dynamic, node:Dynamic, name:Dynamic, x:Dynamic, z:Dynamic, fail:Dynamic):Dynamic;
	public function c_code_reduce_1011(sio:Dynamic, node:Dynamic, name:Dynamic, x:Dynamic, z:Dynamic, fail:Dynamic):Dynamic;
	public function c_code_reduce_11(sio:Dynamic, node:Dynamic, name:Dynamic, x:Dynamic, z:Dynamic, fail:Dynamic):Dynamic;
	public function c_code_reduce_110(sio:Dynamic, node:Dynamic, name:Dynamic, x:Dynamic, z:Dynamic, fail:Dynamic):Dynamic;
	...
	**/
	public function make_node(x:Dynamic):Dynamic;
	/**
	...
	**/
	...
	/**
		...
		MethodNotDefined
		    The subclass does not override this method.
	**/
	public function perform(node:Dynamic, inp:Dynamic, out:Dynamic, ctx:Dynamic):Dynamic;
	/**
	...
	**/
	...
	public function set_ufunc(scalar_op:Dynamic):Dynamic;
	/**
