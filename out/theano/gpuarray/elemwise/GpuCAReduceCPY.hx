...
@:pythonImport("theano.gpuarray.elemwise", "GpuCAReduceCPY") extern class GpuCAReduceCPY {
	...
	**/
	@:native("__init__")
	public function ___init__(scalar_op:Dynamic, ?axis:Dynamic, ?dtype:Dynamic, ?acc_dtype:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(scalar_op:Dynamic, ?axis:Dynamic, ?dtype:Dynamic, ?acc_dtype:Dynamic):Void;
	/**
	...
	**/
	...
	public function generate_kernel(node:Dynamic, odtype:Dynamic, redux:Dynamic):Dynamic;
	public function get_gpu_context(node:Dynamic):Dynamic;
	public function get_gpu_context_c_name(params_c_name:Dynamic):Dynamic;
	public function get_kernel_cache(node:Dynamic):Dynamic;
	...
	**/
	public function make_node(input:Dynamic):Dynamic;
	/**
