...
@:pythonImport("theano.gpuarray.cudnn_defs", "CuDNNV7") extern class CuDNNV7 {
	...
	**/
	...
	static public function cudnnDeterminism_t(?name:Dynamic):Dynamic;
	static public function cudnnMathType_t(?name:Dynamic):Dynamic;
