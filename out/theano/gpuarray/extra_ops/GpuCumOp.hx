...
@:pythonImport("theano.gpuarray.extra_ops", "GpuCumOp") extern class GpuCumOp {
	...
	**/
	...
	static public var SUPPORTED_NDIMS : Dynamic;
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(axis:Dynamic, ?mode:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(axis:Dynamic, ?mode:Dynamic):Void;
	/**
