...
@:pythonImport("theano.gpuarray.extra_ops", "GpuCumsumOp") extern class GpuCumsumOp {
	...
	**/
	static public function __new__(typ:Dynamic, ?args:python.VarArgs<Dynamic>, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
