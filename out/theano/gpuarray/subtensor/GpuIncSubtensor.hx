...
@:pythonImport("theano.gpuarray.subtensor", "GpuIncSubtensor") extern class GpuIncSubtensor {
	...
	**/
	@:native("__init__")
	public function ___init__(idx_list:Dynamic, ?inplace:Dynamic, ?set_instead_of_inc:Dynamic, ?destroyhandler_tolerate_aliased:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(idx_list:Dynamic, ?inplace:Dynamic, ?set_instead_of_inc:Dynamic, ?destroyhandler_tolerate_aliased:Dynamic):Void;
	/**
	...
	**/
	...
	/**
		...
		add fails.
	**/
	public function add_to_zview(nodename:Dynamic, x:Dynamic, fail:Dynamic):Dynamic;
	/**
	...
	**/
	...
	/**
		...
		MethodNotDefined
		    Subclass does not implement this method.
	**/
	public function c_support_code_struct(node:Dynamic, nodename:Dynamic):Dynamic;
	...
	**/
	public function copy_into(view:Dynamic, source:Dynamic):Dynamic;
	/**
		Parameters
		----------
		x
	...
	**/
	public function copy_of_x(x:Dynamic):Dynamic;
	public function decl_view():Dynamic;
	...
	**/
	public function do_type_checking(node:Dynamic):Dynamic;
	/**
		Return a dictionary of arguments to use with helper_c_code.
	**/
	public function get_helper_c_code_args():Dynamic;
	...
	**/
	...
	/**
		...
		inputs: TODO WRITEME
	**/
	public function make_node(x:Dynamic, y:Dynamic, ?inputs:python.VarArgs<Dynamic>):Dynamic;
	/**
	...
	**/
	public function make_view_array(x:Dynamic, view_ndim:Dynamic):Dynamic;
	...
	/**
		...
		MethodNotDefined
		    The subclass does not override this method.
	**/
	public function perform(node:Dynamic, inputs:Dynamic, out_:Dynamic, ctx:Dynamic):Dynamic;
	/**
