...
@:pythonImport("theano.gpuarray.subtensor", "GpuAllocDiag") extern class GpuAllocDiag {
	...
	**/
	@:native("__init__")
	public function ___init__(?offset:Dynamic, ?axis1:Dynamic, ?axis2:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(?offset:Dynamic, ?axis1:Dynamic, ?axis2:Dynamic):Void;
	/**
	...
	**/
	...
	public function infer_shape(nodes:Dynamic, shapes:Dynamic):Dynamic;
	/**
	...
	**/
	public function make_node(diag:Dynamic):Dynamic;
	/**
