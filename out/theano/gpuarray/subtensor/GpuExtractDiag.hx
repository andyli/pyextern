...
@:pythonImport("theano.gpuarray.subtensor", "GpuExtractDiag") extern class GpuExtractDiag {
	...
	**/
	@:native("__init__")
	public function ___init__(?offset:Dynamic, ?axis1:Dynamic, ?axis2:Dynamic, ?view:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(?offset:Dynamic, ?axis1:Dynamic, ?axis2:Dynamic, ?view:Dynamic):Void;
	/**
	...
	**/
	public function make_node(_x:Dynamic):Dynamic;
	/**
