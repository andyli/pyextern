...
@:pythonImport("theano.gpuarray.subtensor", "GpuAdvancedBooleanIncSubtensor") extern class GpuAdvancedBooleanIncSubtensor {
	...
	**/
	...
	public function grad(inpt:Dynamic, output_gradients:Dynamic):Dynamic;
