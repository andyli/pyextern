...
@:pythonImport("theano.gpuarray.nerv", "Gemm16") extern class Gemm16 {
	static public var KERN_NAMES : Dynamic;
	...
	**/
	@:native("__init__")
	public function ___init__(?relu:Dynamic, ?inplace:Dynamic):Dynamic;
	/**
		Sections are loaded from files in order with sections in later
		files overriding sections in previous files.
	**/
	public function new(?relu:Dynamic, ?inplace:Dynamic):Void;
	/**
	...
	**/
	public function c_cleanup_code_struct(node:Dynamic, nodename:Dynamic):Dynamic;
	/**
	...
	**/
	public function c_init_code_struct(node:Dynamic, nodename:Dynamic, sub:Dynamic):Dynamic;
	/**
	...
	**/
	...
	static public function cubin_to_code(name:Dynamic):Dynamic;
	...
	**/
	...
	static public function init_gpukernel(name:Dynamic, fail:Dynamic):Dynamic;
	/**
	...
	**/
	public function make_node(C:Dynamic, alpha:Dynamic, A:Dynamic, B:Dynamic, beta:Dynamic):Dynamic;
	/**
