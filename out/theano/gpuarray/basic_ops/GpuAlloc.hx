...
@:pythonImport("theano.gpuarray.basic_ops", "GpuAlloc") extern class GpuAlloc {
	...
	**/
	public function __call__(val:Dynamic, ?shapes:python.VarArgs<Dynamic>, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	...
	**/
	@:native("__init__")
	public function ___init__(context_name:Dynamic, ?memset_0:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(context_name:Dynamic, ?memset_0:Dynamic):Void;
	/**
	...
	**/
	public function make_node(value:Dynamic, ?shape:python.VarArgs<Dynamic>):Dynamic;
	/**
	...
	**/
	...
	/**
		...
		MethodNotDefined
		    The subclass does not override this method.
	**/
	public function perform(node:Dynamic, inputs:Dynamic, outs:Dynamic, params:Dynamic):Dynamic;
	/**
	...
	**/
	...
	public function validate_shape(shape:Dynamic):Dynamic;
}