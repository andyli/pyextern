...
@:pythonImport("theano.gpuarray.basic_ops", "GpuFromHost") extern class GpuFromHost {
	...
	**/
	@:native("__init__")
	public function ___init__(context_name:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(context_name:Dynamic):Void;
	/**
	...
	**/
	...
	public function infer_shape(node:Dynamic, xshp:Dynamic):Dynamic;
	/**
