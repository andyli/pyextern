...
@:pythonImport("theano.gpuarray.basic_ops", "GpuJoin") extern class GpuJoin {
	...
	**/
	@:native("__init__")
	public function ___init__(?view:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(?view:Dynamic):Void;
	/**
	...
	**/
	...
	public function _make_node_internal(axis:Dynamic, tensors:Dynamic, as_tensor_variable_args:Dynamic, output_maker:Dynamic):Dynamic;
	/**
	...
	**/
	public function c_code(node:Dynamic, name:Dynamic, inputs:Dynamic, out_:Dynamic, sub:Dynamic):Dynamic;
	/**
	...
	**/
	public function grad(axis_and_tensors:Dynamic, grads:Dynamic):Dynamic;
	...
	**/
	...
	/**
		...
		A symbolic Variable
		    ...
		    dtype.
	**/
	public function make_node(axis:Dynamic, ?tensors:python.VarArgs<Dynamic>):Dynamic;
	/**
	...
	**/
	...
	/**
		...
		MethodNotDefined
		    The subclass does not override this method.
	**/
	public function perform(node:Dynamic, axis_and_tensors:Dynamic, out_:Dynamic, ctx:Dynamic):Dynamic;
	/**
