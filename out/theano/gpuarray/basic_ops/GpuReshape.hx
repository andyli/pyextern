...
@:pythonImport("theano.gpuarray.basic_ops", "GpuReshape") extern class GpuReshape {
	...
	**/
	@:native("__init__")
	public function ___init__(ndim:Dynamic, ?name:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(ndim:Dynamic, ?name:Dynamic):Void;
	/**
	...
	**/
	public function make_node(x:Dynamic, shp:Dynamic):Dynamic;
	/**
