...
@:pythonImport("theano.gpuarray.basic_ops", "GpuAllocEmpty") extern class GpuAllocEmpty {
	...
	**/
	@:native("__init__")
	public function ___init__(dtype:Dynamic, context_name:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(dtype:Dynamic, context_name:Dynamic):Void;
	/**
	...
	**/
	...
	public function debug_perform(node:Dynamic, inputs:Dynamic, out_:Dynamic, ctx:Dynamic):Dynamic;
	...
	**/
	...
	public function grad(?args:python.VarArgs<Dynamic>):Dynamic;
	...
	**/
	public function make_node(?shape:python.VarArgs<Dynamic>):Dynamic;
	/**
