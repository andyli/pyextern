...
@:pythonImport("theano.gpuarray.basic_ops", "CGpuKernelBase") extern class CGpuKernelBase {
	...
	**/
	@:native("__init__")
	public function ___init__(func_files:Dynamic, ?func_name:Dynamic):Dynamic;
	/**
		Sections are loaded from files in order with sections in later
		files overriding sections in previous files.
	**/
	public function new(func_files:Dynamic, ?func_name:Dynamic):Void;
	/**
