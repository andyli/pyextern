...
@:pythonImport("theano.gpuarray.type", "GpuArraySharedVariable") extern class GpuArraySharedVariable {
	...
	**/
	...
	public function _as_GpuArrayVariable(context_name:Dynamic):Dynamic;
