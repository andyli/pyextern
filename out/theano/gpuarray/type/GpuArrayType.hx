...
@:pythonImport("theano.gpuarray.type", "GpuArrayType") extern class GpuArrayType {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(dtype:Dynamic, broadcastable:Dynamic, ?context_name:Dynamic, ?name:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(dtype:Dynamic, broadcastable:Dynamic, ?context_name:Dynamic, ?name:Dynamic):Void;
	/**
