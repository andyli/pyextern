...
@:pythonImport("theano.gpuarray.dnn", "GpuDnnPool") extern class GpuDnnPool {
	...
	**/
	@:native("__init__")
	public function ___init__(?mode:Dynamic):Dynamic;
	/**
		Sections are loaded from files in order with sections in later
		files overriding sections in previous files.
	**/
	public function new(?mode:Dynamic):Void;
	/**
	...
	**/
	...
	static public var c_file : Dynamic;
	static public var c_function : Dynamic;
	/**
	...
	**/
	public function make_node(img:Dynamic, ws:Dynamic, stride:Dynamic, pad:Dynamic):Dynamic;
	/**
