...
@:pythonImport("theano.gpuarray.dnn", "GpuDnnConv") extern class GpuDnnConv {
	...
	**/
	@:native("__init__")
	public function ___init__(?algo:Dynamic, ?inplace:Dynamic, ?num_groups:Dynamic):Dynamic;
	/**
		Sections are loaded from files in order with sections in later
		files overriding sections in previous files.
	**/
	public function new(?algo:Dynamic, ?inplace:Dynamic, ?num_groups:Dynamic):Void;
	/**
	...
	**/
	...
	/**
		...
		or scalar.
	**/
	static public function get_out_shape(ishape:Dynamic, kshape:Dynamic, border_mode:Dynamic, subsample:Dynamic, dilation:Dynamic):Dynamic;
