...
@:pythonImport("theano.gpuarray.dnn", "GpuDnnTransformerGradI") extern class GpuDnnTransformerGradI {
	...
	**/
	public function make_node(img:Dynamic, grid:Dynamic, dy:Dynamic):Dynamic;
	/**
