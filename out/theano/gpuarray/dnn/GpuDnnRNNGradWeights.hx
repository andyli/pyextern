...
@:pythonImport("theano.gpuarray.dnn", "GpuDnnRNNGradWeights") extern class GpuDnnRNNGradWeights {
	...
	**/
	public function make_node(desc:Dynamic, x:Dynamic, hx:Dynamic, y:Dynamic, reserve:Dynamic, w:Dynamic):Dynamic;
	/**
