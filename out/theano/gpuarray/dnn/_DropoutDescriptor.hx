...
@:pythonImport("theano.gpuarray.dnn", "_DropoutDescriptor") extern class _DropoutDescriptor {
	...
	**/
	public function make_node(dropout:Dynamic, seed:Dynamic, context_name:Dynamic):Dynamic;
	/**
