...
@:pythonImport("theano.gpuarray.dnn", "GpuDnnConvGradW") extern class GpuDnnConvGradW {
	...
	**/
	@:native("__init__")
	public function ___init__(?inplace:Dynamic, ?algo:Dynamic, ?num_groups:Dynamic):Dynamic;
	/**
		Sections are loaded from files in order with sections in later
		files overriding sections in previous files.
	**/
	public function new(?inplace:Dynamic, ?algo:Dynamic, ?num_groups:Dynamic):Void;
	/**
	...
	**/
	public function make_node(img:Dynamic, topgrad:Dynamic, output:Dynamic, desc:Dynamic, ?alpha:Dynamic, ?beta:Dynamic):Dynamic;
	/**
	...
	**/
	...
	public function op_may_fail_with_beta(img:Dynamic, beta:Dynamic):Dynamic;
	public function op_may_fail_with_subsample(img:Dynamic, desc:Dynamic):Dynamic;
