...
@:pythonImport("theano.gpuarray.dnn", "_RNNDescriptor") extern class _RNNDescriptor {
	...
	**/
	public function make_node(hidden_size:Dynamic, num_layers:Dynamic, ddesc:Dynamic, input_mode:Dynamic, direction_mode:Dynamic, rnn_mode:Dynamic, dtype:Dynamic):Dynamic;
	/**
