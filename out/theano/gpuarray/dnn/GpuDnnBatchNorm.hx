...
@:pythonImport("theano.gpuarray.dnn", "GpuDnnBatchNorm") extern class GpuDnnBatchNorm {
	...
	**/
	@:native("__init__")
	public function ___init__(?mode:Dynamic, ?running_averages:Dynamic, ?inplace_running_mean:Dynamic, ?inplace_running_var:Dynamic, ?inplace_output:Dynamic):Dynamic;
	/**
		Sections are loaded from files in order with sections in later
		files overriding sections in previous files.
	**/
	public function new(?mode:Dynamic, ?running_averages:Dynamic, ?inplace_running_mean:Dynamic, ?inplace_running_var:Dynamic, ?inplace_output:Dynamic):Void;
	/**
	...
	**/
	public function make_node(x:Dynamic, scale:Dynamic, bias:Dynamic, ?epsilon:Dynamic, ?running_average_factor:Dynamic, ?running_mean:Dynamic, ?running_var:Dynamic):Dynamic;
	/**
