...
@:pythonImport("theano.gpuarray.dnn", "DnnBase") extern class DnnBase {
	...
	**/
	@:native("__init__")
	public function ___init__(?files:Dynamic, ?c_func:Dynamic):Dynamic;
	/**
		Sections are loaded from files in order with sections in later
		files overriding sections in previous files.
	**/
	public function new(?files:Dynamic, ?c_func:Dynamic):Void;
	/**
