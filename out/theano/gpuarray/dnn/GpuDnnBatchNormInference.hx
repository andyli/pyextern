...
@:pythonImport("theano.gpuarray.dnn", "GpuDnnBatchNormInference") extern class GpuDnnBatchNormInference {
	...
	**/
	@:native("__init__")
	public function ___init__(?mode:Dynamic, ?inplace:Dynamic):Dynamic;
	/**
		Sections are loaded from files in order with sections in later
		files overriding sections in previous files.
	**/
	public function new(?mode:Dynamic, ?inplace:Dynamic):Void;
	/**
