...
@:pythonImport("theano.gpuarray.dnn", "GpuDnnTransformerSampler") extern class GpuDnnTransformerSampler {
	...
	**/
	...
	/**
		...
		grid : GpuDnnTransformerGrid
		    ...
		    the inputs images.
	**/
	public function make_node(img:Dynamic, grid:Dynamic):Dynamic;
	/**
