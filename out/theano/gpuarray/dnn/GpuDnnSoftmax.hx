...
@:pythonImport("theano.gpuarray.dnn", "GpuDnnSoftmax") extern class GpuDnnSoftmax {
	...
	**/
	@:native("__init__")
	public function ___init__(algo:Dynamic, mode:Dynamic):Dynamic;
	/**
		Sections are loaded from files in order with sections in later
		files overriding sections in previous files.
	**/
	public function new(algo:Dynamic, mode:Dynamic):Void;
	/**
	...
	**/
	...
	static public var c_func : Dynamic;
	/**
