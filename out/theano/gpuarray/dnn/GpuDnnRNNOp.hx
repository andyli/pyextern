...
@:pythonImport("theano.gpuarray.dnn", "GpuDnnRNNOp") extern class GpuDnnRNNOp {
	...
	**/
	@:native("__init__")
	public function ___init__(rnn_mode:Dynamic, direction_mode:Dynamic):Dynamic;
	/**
		Sections are loaded from files in order with sections in later
		files overriding sections in previous files.
	**/
	public function new(rnn_mode:Dynamic, direction_mode:Dynamic):Void;
	/**
	...
	**/
	public function make_node(desc:Dynamic, w:Dynamic, x:Dynamic, hx:Dynamic, ?cx:Dynamic):Dynamic;
	/**
