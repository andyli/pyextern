...
@:pythonImport("theano.gpuarray.dnn", "GpuDnnRNNGradInputs") extern class GpuDnnRNNGradInputs {
	...
	**/
	@:native("__init__")
	public function ___init__(rnn_mode:Dynamic, grad_h:Dynamic, grad_c:Dynamic):Dynamic;
	/**
		Sections are loaded from files in order with sections in later
		files overriding sections in previous files.
	**/
	public function new(rnn_mode:Dynamic, grad_h:Dynamic, grad_c:Dynamic):Void;
	/**
	...
	**/
	public function make_node(desc:Dynamic, x:Dynamic, y:Dynamic, dy:Dynamic, dhy:Dynamic, dcy:Dynamic, w:Dynamic, hx:Dynamic, cx:Dynamic, reserve:Dynamic):Dynamic;
	/**
