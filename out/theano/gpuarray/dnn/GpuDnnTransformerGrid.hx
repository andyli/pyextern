...
@:pythonImport("theano.gpuarray.dnn", "GpuDnnTransformerGrid") extern class GpuDnnTransformerGrid {
	...
	**/
	public function make_node(theta:Dynamic, out_dims:Dynamic):Dynamic;
	/**
