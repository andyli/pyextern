...
@:pythonImport("theano.gpuarray.dnn", "_RNNParamSize") extern class _RNNParamSize {
	...
	**/
	public function make_node(desc:Dynamic, input_size:Dynamic, typecode:Dynamic):Dynamic;
	/**
