...
@:pythonImport("theano.gpuarray.dnn", "GpuDnnDropoutOp") extern class GpuDnnDropoutOp {
	...
	**/
	public function make_node(inp:Dynamic, descriptor:Dynamic, state:Dynamic):Dynamic;
	/**
	...
	**/
	...
	/**
		...
		good to do so.
	**/
	public function prepare_node(node:Dynamic, storage_map:Dynamic, compute_map:Dynamic):Dynamic;
