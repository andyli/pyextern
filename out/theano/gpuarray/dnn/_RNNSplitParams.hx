...
@:pythonImport("theano.gpuarray.dnn", "_RNNSplitParams") extern class _RNNSplitParams {
	...
	**/
	@:native("__init__")
	public function ___init__(rnn_mode:Dynamic):Dynamic;
	/**
		Sections are loaded from files in order with sections in later
		files overriding sections in previous files.
	**/
	public function new(rnn_mode:Dynamic):Void;
	/**
	...
	**/
	public function make_node(w:Dynamic, desc:Dynamic, layer:Dynamic, isize:Dynamic, typecode:Dynamic):Dynamic;
	/**
