...
@:pythonImport("theano.gpuarray.dnn", "GpuDnnReduction") extern class GpuDnnReduction {
	...
	**/
	@:native("__init__")
	public function ___init__(red_op:Dynamic, axis:Dynamic, acc_dtype:Dynamic, dtype:Dynamic, return_indices:Dynamic):Dynamic;
	/**
		Sections are loaded from files in order with sections in later
		files overriding sections in previous files.
	**/
	public function new(red_op:Dynamic, axis:Dynamic, acc_dtype:Dynamic, dtype:Dynamic, return_indices:Dynamic):Void;
	/**
	...
	**/
	...
	public function _convert_axis(axis:Dynamic):Dynamic;
	...
	**/
	public function make_node(inp:Dynamic):Dynamic;
	/**
