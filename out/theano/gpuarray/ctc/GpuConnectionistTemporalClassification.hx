...
@:pythonImport("theano.gpuarray.ctc", "GpuConnectionistTemporalClassification") extern class GpuConnectionistTemporalClassification {
	...
	**/
	@:native("__init__")
	public function ___init__(?compute_grad:Dynamic):Dynamic;
	/**
		Sections are loaded from files in order with sections in later
		files overriding sections in previous files.
	**/
	public function new(?compute_grad:Dynamic):Void;
	/**
