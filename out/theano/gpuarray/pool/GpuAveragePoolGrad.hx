...
@:pythonImport("theano.gpuarray.pool", "GpuAveragePoolGrad") extern class GpuAveragePoolGrad {
	...
	**/
	public function make_node(inp:Dynamic, out_grad:Dynamic, ws:Dynamic, ?stride:Dynamic, ?pad:Dynamic):Dynamic;
	/**
