...
@:pythonImport("theano.gpuarray.pool", "GpuMaxPoolRop") extern class GpuMaxPoolRop {
	...
	**/
	public function make_node(inp:Dynamic, eval_point:Dynamic, ws:Dynamic, ?stride:Dynamic, ?pad:Dynamic):Dynamic;
	/**
