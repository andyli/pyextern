...
@:pythonImport("theano.gpuarray.pool", "GpuDownsampleFactorMaxGradGrad") extern class GpuDownsampleFactorMaxGradGrad {
	...
	**/
	public function make_node(inp:Dynamic, out:Dynamic, out_grad:Dynamic, ws:Dynamic, ?stride:Dynamic, ?pad:Dynamic):Dynamic;
	/**
