...
@:pythonImport("theano.gpuarray.opt", "GraphToGPU") extern class GraphToGPU {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(local_optimizers_all:Dynamic, local_optimizers_map:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(local_optimizers_all:Dynamic, local_optimizers_map:Dynamic):Void;
	/**
