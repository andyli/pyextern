...
@:pythonImport("theano.gpuarray.sort", "GpuTopKOp") extern class GpuTopKOp {
	public function L_op(inputs:Dynamic, outputs:Dynamic, out_grads:Dynamic):Dynamic;
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(?axis:Dynamic, ?sorted:Dynamic, ?idx_dtype:Dynamic, ?return_values:Dynamic, ?return_indices:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(?axis:Dynamic, ?sorted:Dynamic, ?idx_dtype:Dynamic, ?return_values:Dynamic, ?return_indices:Dynamic):Void;
	/**
	...
	**/
	public function c_code(node:Dynamic, nodename:Dynamic, inps:Dynamic, outs:Dynamic, sub:Dynamic):Dynamic;
	/**
	...
	**/
	...
	public function infer_shape(node:Dynamic, inp_shapes:Dynamic):Dynamic;
	/**
	...
	**/
	public function make_node(inp:Dynamic, kth:Dynamic):Dynamic;
	/**
