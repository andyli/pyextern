...
@:pythonImport("theano.gpuarray.linalg", "GpuCusolverSolve") extern class GpuCusolverSolve {
	...
	**/
	@:native("__init__")
	public function ___init__(?A_structure:Dynamic, ?trans:Dynamic, ?inplace:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(?A_structure:Dynamic, ?trans:Dynamic, ?inplace:Dynamic):Void;
	/**
	...
	**/
	...
	public function check_dev_info(dev_info:Dynamic):Dynamic;
	...
	**/
	public function make_node(inp1:Dynamic, inp2:Dynamic):Dynamic;
	/**
