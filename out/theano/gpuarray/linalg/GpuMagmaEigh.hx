...
@:pythonImport("theano.gpuarray.linalg", "GpuMagmaEigh") extern class GpuMagmaEigh {
	...
	**/
	@:native("__init__")
	public function ___init__(?UPLO:Dynamic, ?compute_v:Dynamic):Dynamic;
	/**
		Sections are loaded from files in order with sections in later
		files overriding sections in previous files.
	**/
	public function new(?UPLO:Dynamic, ?compute_v:Dynamic):Void;
	/**
