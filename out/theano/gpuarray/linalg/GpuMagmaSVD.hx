...
@:pythonImport("theano.gpuarray.linalg", "GpuMagmaSVD") extern class GpuMagmaSVD {
	...
	**/
	@:native("__init__")
	public function ___init__(?full_matrices:Dynamic, ?compute_uv:Dynamic):Dynamic;
	/**
		Sections are loaded from files in order with sections in later
		files overriding sections in previous files.
	**/
	public function new(?full_matrices:Dynamic, ?compute_uv:Dynamic):Void;
	/**
