...
@:pythonImport("theano.gpuarray.linalg", "GpuCublasTriangularSolve") extern class GpuCublasTriangularSolve {
	...
	**/
	@:native("__init__")
	public function ___init__(?lower:Dynamic, ?trans:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(?lower:Dynamic, ?trans:Dynamic):Void;
	/**
