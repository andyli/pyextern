...
@:pythonImport("theano.gpuarray.linalg", "GpuMagmaQR") extern class GpuMagmaQR {
	...
	**/
	@:native("__init__")
	public function ___init__(?complete:Dynamic):Dynamic;
	/**
		Sections are loaded from files in order with sections in later
		files overriding sections in previous files.
	**/
	public function new(?complete:Dynamic):Void;
	/**
