...
@:pythonImport("theano.gpuarray.linalg", "GpuMagmaCholesky") extern class GpuMagmaCholesky {
	...
	**/
	@:native("__init__")
	public function ___init__(?lower:Dynamic, ?inplace:Dynamic):Dynamic;
	/**
		Sections are loaded from files in order with sections in later
		files overriding sections in previous files.
	**/
	public function new(?lower:Dynamic, ?inplace:Dynamic):Void;
	/**
	...
	**/
	public function make_node(A:Dynamic):Dynamic;
	/**
