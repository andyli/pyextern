...
package theano.updates;
@:pythonImport("theano.updates", "OrderedUpdates") extern class OrderedUpdates {
	...
	**/
	@:native("__init__")
	public function ___init__(?key:python.VarArgs<Dynamic>, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(?key:python.VarArgs<Dynamic>, ?kwargs:python.KwArgs<Dynamic>):Void;
	/**
	...
	**/
	...
	static public function __radd__(other:Dynamic, self:Dynamic):Dynamic;
	/**
