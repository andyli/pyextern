...
@:pythonImport("theano.printing", "Print") extern class Print {
	...
	**/
	@:native("__init__")
	public function ___init__(?message:Dynamic, ?attrs:Dynamic, ?global_fn:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(?message:Dynamic, ?attrs:Dynamic, ?global_fn:Dynamic):Void;
	/**
	...
	**/
	public function make_node(xin:Dynamic):Dynamic;
	/**
