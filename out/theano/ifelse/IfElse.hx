...
@:pythonImport("theano.ifelse", "IfElse") extern class IfElse {
	...
	**/
	@:native("__init__")
	public function ___init__(n_outs:Dynamic, ?as_view:Dynamic, ?gpu:Dynamic, ?name:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(n_outs:Dynamic, ?as_view:Dynamic, ?gpu:Dynamic, ?name:Dynamic):Void;
	/**
	...
	**/
	...
	public function grad(ins:Dynamic, grads:Dynamic):Dynamic;
	...
	**/
	public function make_node(c:Dynamic, ?args:python.VarArgs<Dynamic>):Dynamic;
	/**
