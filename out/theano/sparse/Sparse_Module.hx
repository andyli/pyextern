...
@:pythonImport("theano.sparse") extern class Sparse_Module {
	...
	**/
	...
	static public var enable_sparse : Dynamic;
	...
	**/
	...
	static public var scipy_ver : Dynamic;
	...
	/**
		...
		writeme
	**/
	static public function shared(value:Dynamic, ?name:Dynamic, ?strict:Dynamic, ?allow_downcast:Dynamic, ?borrow:Dynamic, ?format:Dynamic):Dynamic;
