...
@:pythonImport("theano.sparse.basic", "StructuredDotGradCSC") extern class StructuredDotGradCSC {
	...
	**/
	public function make_node(a_indices:Dynamic, a_indptr:Dynamic, b:Dynamic, g_ab:Dynamic):Dynamic;
	/**
