...
@:pythonImport("theano.sparse.basic", "CSMGrad") extern class CSMGrad {
	...
	**/
	public function make_node(x_data:Dynamic, x_indices:Dynamic, x_indptr:Dynamic, x_shape:Dynamic, g_data:Dynamic, g_indices:Dynamic, g_indptr:Dynamic, g_shape:Dynamic):Dynamic;
	/**
