...
@:pythonImport("theano.sparse.basic", "CSMProperties") extern class CSMProperties {
	...
	**/
	@:native("__init__")
	public function ___init__(?kmap:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(?kmap:Dynamic):Void;
	/**
	...
	**/
	...
	public function grad(inputs:Dynamic, g:Dynamic):Dynamic;
	/**
	...
	**/
	public function make_node(csm:Dynamic):Dynamic;
	/**
	...
	**/
	...
	/**
		...
		MethodNotDefined
		    The subclass does not override this method.
	**/
	public function perform(node:Dynamic, inputs:Dynamic, out:Dynamic):Dynamic;
	/**
