...
@:pythonImport("theano.sparse.basic", "GetItem2ListsGrad") extern class GetItem2ListsGrad {
	...
	**/
	public function make_node(x:Dynamic, ind1:Dynamic, ind2:Dynamic, gz:Dynamic):Dynamic;
	/**
