...
@:pythonImport("theano.sparse.basic", "SpSum") extern class SpSum {
	...
	**/
	@:native("__init__")
	public function ___init__(?axis:Dynamic, ?sparse_grad:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(?axis:Dynamic, ?sparse_grad:Dynamic):Void;
	/**
