...
@:pythonImport("theano.sparse.basic", "SparseFromDense") extern class SparseFromDense {
	...
	**/
	@:native("__init__")
	public function ___init__(format:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(format:Dynamic):Void;
	/**
