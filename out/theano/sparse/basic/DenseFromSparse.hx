...
@:pythonImport("theano.sparse.basic", "DenseFromSparse") extern class DenseFromSparse {
	...
	**/
	@:native("__init__")
	public function ___init__(?structured:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(?structured:Dynamic):Void;
	/**
