...
@:pythonImport("theano.sparse.basic", "TrueDot") extern class TrueDot {
	...
	**/
	@:native("__init__")
	public function ___init__(?grad_preserves_dense:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(?grad_preserves_dense:Dynamic):Void;
	/**
