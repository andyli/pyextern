...
@:pythonImport("theano.sparse.basic", "CSM") extern class CSM {
	...
	**/
	@:native("__init__")
	public function ___init__(format:Dynamic, ?kmap:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(format:Dynamic, ?kmap:Dynamic):Void;
	/**
	...
	**/
	public function make_node(data:Dynamic, indices:Dynamic, indptr:Dynamic, shape:Dynamic):Dynamic;
	/**
