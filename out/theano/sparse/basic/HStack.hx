...
@:pythonImport("theano.sparse.basic", "HStack") extern class HStack {
	...
	**/
	public function make_node(?mat:python.VarArgs<Dynamic>):Dynamic;
	/**
	...
	**/
	...
	/**
		...
		MethodNotDefined
		    The subclass does not override this method.
	**/
	public function perform(node:Dynamic, block:Dynamic, outputs:Dynamic):Dynamic;
	/**
