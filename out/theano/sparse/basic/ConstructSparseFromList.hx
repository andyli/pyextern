...
@:pythonImport("theano.sparse.basic", "ConstructSparseFromList") extern class ConstructSparseFromList {
	...
	**/
	public function make_node(x:Dynamic, values:Dynamic, ilist:Dynamic):Dynamic;
	/**
