...
@:pythonImport("theano.sparse.opt", "StructuredDotCSR") extern class StructuredDotCSR {
	...
	**/
	public function make_node(a_val:Dynamic, a_ind:Dynamic, a_ptr:Dynamic, b:Dynamic):Dynamic;
	/**
