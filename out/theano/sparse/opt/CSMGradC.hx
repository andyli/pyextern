...
@:pythonImport("theano.sparse.opt", "CSMGradC") extern class CSMGradC {
	...
	**/
	public function make_node(a_val:Dynamic, a_ind:Dynamic, a_ptr:Dynamic, a_dim:Dynamic, b_val:Dynamic, b_ind:Dynamic, b_ptr:Dynamic, b_dim:Dynamic):Dynamic;
	/**
