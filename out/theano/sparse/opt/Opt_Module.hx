...
@:pythonImport("theano.sparse.opt") extern class Opt_Module {
	...
	**/
	...
	/**
		...
		This instance does: Elemwise{sub,no_inplace}(z, Elemwise{mul,no_inplace}(alpha subject to <function <lambda> at 0x7fa7498769d8>, SparseDot(x, y))) -> Usmm{no_inplace}(Elemwise{neg,no_inplace}(alpha), x, y, z)
	**/
