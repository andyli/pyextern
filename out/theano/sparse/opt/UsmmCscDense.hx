...
@:pythonImport("theano.sparse.opt", "UsmmCscDense") extern class UsmmCscDense {
	...
	**/
	public function make_node(alpha:Dynamic, x_val:Dynamic, x_ind:Dynamic, x_ptr:Dynamic, x_nrows:Dynamic, y:Dynamic, z:Dynamic):Dynamic;
	/**
