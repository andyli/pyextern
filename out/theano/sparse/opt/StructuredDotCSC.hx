...
@:pythonImport("theano.sparse.opt", "StructuredDotCSC") extern class StructuredDotCSC {
	...
	**/
	public function make_node(a_val:Dynamic, a_ind:Dynamic, a_ptr:Dynamic, a_nrows:Dynamic, b:Dynamic):Dynamic;
	/**
