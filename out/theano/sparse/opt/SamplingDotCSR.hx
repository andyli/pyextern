...
@:pythonImport("theano.sparse.opt", "SamplingDotCSR") extern class SamplingDotCSR {
	...
	**/
	public function make_node(x:Dynamic, y:Dynamic, p_data:Dynamic, p_ind:Dynamic, p_ptr:Dynamic, p_ncols:Dynamic):Dynamic;
	/**
