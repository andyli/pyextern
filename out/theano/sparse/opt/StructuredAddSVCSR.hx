...
@:pythonImport("theano.sparse.opt", "StructuredAddSVCSR") extern class StructuredAddSVCSR {
	...
	**/
	public function make_node(a_data:Dynamic, a_indices:Dynamic, a_indptr:Dynamic, b:Dynamic):Dynamic;
	/**
