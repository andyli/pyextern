...
package theano.sparse.type;
@:pythonImport("theano.sparse.type", "SparseType") extern class SparseType {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(format:Dynamic, dtype:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(format:Dynamic, dtype:Dynamic):Void;
	/**
	...
	**/
	...
	static public var dtype_set : Dynamic;
	/**
	...
	**/
	public function filter(value:Dynamic, ?strict:Dynamic, ?allow_downcast:Dynamic):Dynamic;
	/**
	...
	**/
	...
	static public var format_cls : Dynamic;
	...
	**/
	...
	/**
		...
		bool
	**/
	public function values_eq_approx(a:Dynamic, b:Dynamic, ?eps:Dynamic):Dynamic;
}