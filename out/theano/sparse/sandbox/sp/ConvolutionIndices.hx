...
@:pythonImport("theano.sparse.sandbox.sp", "ConvolutionIndices") extern class ConvolutionIndices {
	...
	**/
	...
	static public function conv_eval(inshp:Dynamic, kshp:Dynamic, ?strides:Dynamic, ?mode:Dynamic):Dynamic;
	...
	**/
	static public function evaluate(inshp:Dynamic, kshp:Dynamic, ?strides:Dynamic, ?nkern:Dynamic, ?mode:Dynamic, ?ws:Dynamic):Dynamic;
