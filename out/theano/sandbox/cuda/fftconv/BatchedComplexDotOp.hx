...
@:pythonImport("theano.sandbox.cuda.fftconv", "BatchedComplexDotOp") extern class BatchedComplexDotOp {
	...
	**/
	public function make_thunk(node:Dynamic, storage_map:Dynamic, _:Dynamic, _2:Dynamic, ?impl:Dynamic):Dynamic;
