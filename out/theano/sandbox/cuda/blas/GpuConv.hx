...
@:pythonImport("theano.sandbox.cuda.blas", "GpuConv") extern class GpuConv {
	...
	**/
	@:native("__init__")
	public function ___init__(border_mode:Dynamic, ?subsample:Dynamic, ?logical_img_hw:Dynamic, ?logical_kern_hw:Dynamic, ?logical_kern_align_top:Dynamic, ?version:Dynamic, ?direction_hint:Dynamic, ?verbose:Dynamic, ?kshp:Dynamic, ?imshp:Dynamic, ?max_threads_dim0:Dynamic, ?nkern:Dynamic, ?bsize:Dynamic, ?fft_opt:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(border_mode:Dynamic, ?subsample:Dynamic, ?logical_img_hw:Dynamic, ?logical_kern_hw:Dynamic, ?logical_kern_align_top:Dynamic, ?version:Dynamic, ?direction_hint:Dynamic, ?verbose:Dynamic, ?kshp:Dynamic, ?imshp:Dynamic, ?max_threads_dim0:Dynamic, ?nkern:Dynamic, ?bsize:Dynamic, ?fft_opt:Dynamic):Void;
	/**
	...
	**/
	...
	/**
		...
		MethodNotDefined
		    The subclass does not override this method.
	**/
	public function c_code(node:Dynamic, nodename:Dynamic, inp:Dynamic, out_:Dynamic, sub:Dynamic):Dynamic;
	/**
	...
	**/
	...
	static public function logical_output_shape_2d(imshp:Dynamic, kshp:Dynamic, mode:Dynamic):Dynamic;
	/**
	...
	**/
	public function make_node(img:Dynamic, kern:Dynamic):Dynamic;
	/**
