...
@:pythonImport("theano.sandbox.cuda.blas", "GpuBatchedDot") extern class GpuBatchedDot {
	...
	**/
	@:native("__init__")
	public function ___init__(?stream_threshold:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(?stream_threshold:Dynamic):Void;
	/**
	...
	**/
	...
	public function output_type(inp1:Dynamic, inp2:Dynamic):Dynamic;
	/**
