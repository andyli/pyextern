...
@:pythonImport("theano.sandbox.cuda.blas", "GpuDownsampleFactorMaxGrad") extern class GpuDownsampleFactorMaxGrad {
	...
	**/
	public function make_node(x:Dynamic, z:Dynamic, gz:Dynamic):Dynamic;
	/**
