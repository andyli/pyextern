...
@:pythonImport("theano.sandbox.cuda.blas", "GpuCorr3dMM_gradWeights") extern class GpuCorr3dMM_gradWeights {
	...
	**/
	@:native("__init__")
	public function ___init__(?border_mode:Dynamic, ?subsample:Dynamic, ?filter_dilation:Dynamic, ?pad:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(?border_mode:Dynamic, ?subsample:Dynamic, ?filter_dilation:Dynamic, ?pad:Dynamic):Void;
	/**
	...
	**/
	...
	/**
		...
		depth
		    ...
		    Not required otherwise, but if a value is given this will be checked.
	**/
	public function c_code_helper(bottom:Dynamic, weights:Dynamic, top:Dynamic, direction:Dynamic, sub:Dynamic, ?height:Dynamic, ?width:Dynamic, ?depth:Dynamic):Dynamic;
	/**
