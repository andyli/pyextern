...
@:pythonImport("theano.sandbox.cuda.blas", "GpuDownsampleFactorMaxGradGrad") extern class GpuDownsampleFactorMaxGradGrad {
	...
	**/
	@:native("__init__")
	public function ___init__(ds:Dynamic, ignore_border:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(ds:Dynamic, ignore_border:Dynamic):Void;
	/**
	...
	**/
	public function make_node(x:Dynamic, z:Dynamic, gx:Dynamic):Dynamic;
	/**
