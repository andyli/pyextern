...
package theano.sandbox.cuda.type;
@:pythonImport("theano.sandbox.cuda.type", "CudaNdarrayType") extern class CudaNdarrayType {
	/**
	...
	**/
	static public function SharedVariable(name:Dynamic, type:Dynamic, value:Dynamic, strict:Dynamic, ?allow_downcast:Dynamic, ?container:Dynamic):Dynamic;
	/**
		Define a few properties and conversion methods for CudaNdarray Variables.
	...
	**/
	@:native("__init__")
	public function ___init__(broadcastable:Dynamic, ?name:Dynamic, ?dtype:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(broadcastable:Dynamic, ?name:Dynamic, ?dtype:Dynamic):Void;
	/**
	...
	**/
	...
	static public function bound(a:Dynamic):Dynamic;
	/**
	...
	**/
	public function c_extract(name:Dynamic, sub:Dynamic, ?check_input:Dynamic, ?check_broadcast:Dynamic):Dynamic;
	/**
		To allow the hack to skip check_broadcast.
	**/
	public function c_extract_out(name:Dynamic, sub:Dynamic, ?check_input:Dynamic, ?check_broadcast:Dynamic):Dynamic;
	/**
	...
	**/
	...
	public function filter_inplace(data:Dynamic, old_data:Dynamic, ?strict:Dynamic, ?allow_downcast:Dynamic):Dynamic;
	/**
	...
	**/
	...
	static public var typenum : Dynamic;
	/**
	...
	**/
	static public function values_eq(a:Dynamic, b:Dynamic):Dynamic;
	/**
