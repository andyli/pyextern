...
@:pythonImport("theano.sandbox.cuda.rng_curand", "CURAND_Uniform") extern class CURAND_Uniform {
	...
	**/
	@:native("__init__")
	public function ___init__(output_type:Dynamic, seed:Dynamic, destructive:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(output_type:Dynamic, seed:Dynamic, destructive:Dynamic):Void;
	/**
	...
	**/
	public function _config():Dynamic;
	public function _curand_call_str(?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
	...
	**/
	public function as_destructive():Dynamic;
	/**
	...
	**/
	...
	/**
		...
		MethodNotDefined
		    The subclass does not override this method.
	**/
	public function c_code(node:Dynamic, nodename:Dynamic, inp:Dynamic, out:Dynamic, sub:Dynamic):Dynamic;
	/**
	...
	**/
	public function make_node(generator:Dynamic, size:Dynamic):Dynamic;
	/**
	...
	**/
	static public function new_auto_update(generator:Dynamic, ndim:Dynamic, dtype:Dynamic, size:Dynamic, seed:Dynamic):Dynamic;
	/**
