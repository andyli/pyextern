...
@:pythonImport("theano.sandbox.cuda.blocksparse", "GpuSparseBlockGemv") extern class GpuSparseBlockGemv {
	...
	**/
	...
	/**
		...
		MethodNotDefined
		    The subclass does not override this method.
	**/
	public function c_code(node:Dynamic, nodename:Dynamic, inputs:Dynamic, outputs:Dynamic, sub:Dynamic):Dynamic;
	/**
	...
	**/
	public function make_node(o:Dynamic, W:Dynamic, h:Dynamic, inputIdx:Dynamic, outputIdx:Dynamic):Dynamic;
	/**
