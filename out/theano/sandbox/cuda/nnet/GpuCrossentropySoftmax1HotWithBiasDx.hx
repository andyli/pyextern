...
@:pythonImport("theano.sandbox.cuda.nnet", "GpuCrossentropySoftmax1HotWithBiasDx") extern class GpuCrossentropySoftmax1HotWithBiasDx {
	...
	**/
	public function make_node(dy:Dynamic, sm:Dynamic, y_idx:Dynamic):Dynamic;
	/**
