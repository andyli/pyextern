...
package theano.sandbox.cuda._var;
@:pythonImport("theano.sandbox.cuda.var", "CudaNdarraySharedVariable") extern class CudaNdarraySharedVariable {
	...
	**/
	...
	public function _as_CudaNdarrayVariable():Dynamic;
	public function _as_TensorVariable():Dynamic;
	...
	**/
	...
	static public var get_value_return_ndarray : Dynamic;
	/**
	...
	**/
	public function set_value(value:Dynamic, ?borrow:Dynamic):Dynamic;
