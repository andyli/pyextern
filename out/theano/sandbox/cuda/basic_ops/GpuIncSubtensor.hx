...
@:pythonImport("theano.sandbox.cuda.basic_ops", "GpuIncSubtensor") extern class GpuIncSubtensor {
	...
	**/
	...
	/**
		...
		add fails.
	**/
	public function add_to_zview(name:Dynamic, x:Dynamic, fail:Dynamic):Dynamic;
	/**
