...
@:pythonImport("theano.sandbox.cuda.basic_ops", "GpuAlloc") extern class GpuAlloc {
	...
	**/
	@:native("__init__")
	public function ___init__(?memset_0:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(?memset_0:Dynamic):Void;
	/**
