...
@:pythonImport("theano.sandbox.cuda.basic_ops", "GpuElemwise") extern class GpuElemwise {
	...
	**/
	@:native("__init__")
	public function ___init__(scalar_op:Dynamic, ?inplace_pattern:Dynamic, ?sync:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(scalar_op:Dynamic, ?inplace_pattern:Dynamic, ?sync:Dynamic):Void;
	/**
	...
	**/
	...
	/**
		...
		MethodNotDefined
		    The subclass does not override this method.
	**/
	public function c_code(?args:python.VarArgs<Dynamic>, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
	...
	**/
	...
	/**
		...
		MethodNotDefined
		    Subclass does not implement this method.
	**/
	public function c_support_code(?args:python.VarArgs<Dynamic>, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
		...
		MethodNotDefined
		    Subclass does not implement this method.
	**/
	public function c_support_code_apply(?args:python.VarArgs<Dynamic>, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
		Optional: return utility code for use by an `Op` that will be
