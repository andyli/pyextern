...
@:pythonImport("theano.sandbox.cuda.basic_ops", "GpuCAReduce") extern class GpuCAReduce {
	...
	**/
	@:native("__init__")
	public function ___init__(reduce_mask:Dynamic, scalar_op:Dynamic, ?pre_scalar_op:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(reduce_mask:Dynamic, scalar_op:Dynamic, ?pre_scalar_op:Dynamic):Void;
	/**
	...
	**/
	...
	public function _k_init(?args:python.VarArgs<Dynamic>):Dynamic;
	/**
		WRITEME
	...
	**/
	public function _makecall(node:Dynamic, name:Dynamic, x:Dynamic, z:Dynamic, fail:Dynamic, ?pattern:Dynamic):Dynamic;
	/**
	...
	**/
	...
	/**
		...
		MethodNotDefined
		    Subclass does not implement this method.
	**/
	public function c_support_code_apply(node:Dynamic, nodename:Dynamic):Dynamic;
	/**
		Optional: return utility code for use by an `Op` that will be
