...
@:pythonImport("theano.sandbox.cuda.basic_ops", "GpuJoin") extern class GpuJoin {
	...
	**/
	...
	/**
		...
		A symbolic Variable
		    ...
		    dtype.
	**/
	public function make_node(?axis_and_tensors:python.VarArgs<Dynamic>):Dynamic;
	/**
	...
	**/
	...
	/**
		...
		MethodNotDefined
		    The subclass does not override this method.
	**/
	public function perform(node:Dynamic, axis_and_tensors:Dynamic, out_:Dynamic):Dynamic;
	/**
