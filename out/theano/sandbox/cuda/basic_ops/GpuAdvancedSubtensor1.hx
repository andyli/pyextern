...
@:pythonImport("theano.sandbox.cuda.basic_ops", "GpuAdvancedSubtensor1") extern class GpuAdvancedSubtensor1 {
	...
	**/
	...
	static public var max_threads : Dynamic;
	/**
	...
	**/
	...
	static public var perform_using_take : Dynamic;
	/**
