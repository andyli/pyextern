...
@:pythonImport("theano.sandbox.cuda.basic_ops", "GpuDimShuffle") extern class GpuDimShuffle {
	...
	**/
	@:native("__init__")
	public function ___init__(input_broadcastable:Dynamic, new_order:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(input_broadcastable:Dynamic, new_order:Dynamic):Void;
	/**
