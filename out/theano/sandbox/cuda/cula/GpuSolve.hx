...
package theano.sandbox.cuda.cula;
@:pythonImport("theano.sandbox.cuda.cula", "GpuSolve") extern class GpuSolve {
	...
	**/
	@:native("__init__")
	public function ___init__(?trans:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(?trans:Dynamic):Void;
	/**
	...
	**/
	public function make_thunk(node:Dynamic, storage_map:Dynamic, _:Dynamic, no_recycling:Dynamic, ?impl:Dynamic):Dynamic;
	public function output_type(inp:Dynamic):Dynamic;
	/**
