...
@:pythonImport("theano.sandbox.cuda.dnn", "GpuDnnPoolDesc") extern class GpuDnnPoolDesc {
	...
	**/
	@:native("__init__")
	public function ___init__(?ws:Dynamic, ?stride:Dynamic, ?mode:Dynamic, ?pad:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(?ws:Dynamic, ?stride:Dynamic, ?mode:Dynamic, ?pad:Dynamic):Void;
	/**
	...
	**/
	...
	public function get_ndim():Dynamic;
	/**
	...
	**/
	public function make_node():Dynamic;
	/**
