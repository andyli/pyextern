...
@:pythonImport("theano.sandbox.cuda.dnn", "GpuDnnConv3d") extern class GpuDnnConv3d {
	...
	**/
	@:native("__init__")
	public function ___init__(?workmem:Dynamic, ?inplace:Dynamic, ?algo:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(?workmem:Dynamic, ?inplace:Dynamic, ?algo:Dynamic):Void;
	/**
	...
	**/
	...
	static public var __input_name__ : Dynamic;
	/**
		Return self<=value.
	**/
	...
	**/
	...
	/**
		...
		or scalar.
	**/
	static public function get_out_shape(ishape:Dynamic, kshape:Dynamic, border_mode:Dynamic, subsample:Dynamic):Dynamic;
	/**
	...
	**/
	public function make_node(img:Dynamic, kern:Dynamic, output:Dynamic, desc:Dynamic, ?alpha:Dynamic, ?beta:Dynamic):Dynamic;
	/**
