...
@:pythonImport("theano.sandbox.cuda.dnn", "GpuDnnBatchNormGrad") extern class GpuDnnBatchNormGrad {
	...
	**/
	@:native("__init__")
	public function ___init__(?mode:Dynamic, ?epsilon:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(?mode:Dynamic, ?epsilon:Dynamic):Void;
	/**
	...
	**/
	public function make_node(x:Dynamic, dy:Dynamic, scale:Dynamic, x_mean:Dynamic, x_invstd:Dynamic):Dynamic;
	/**
