...
@:pythonImport("theano.sandbox.cuda.dnn", "GpuDnnSoftmaxGrad") extern class GpuDnnSoftmaxGrad {
	...
	**/
	@:native("__init__")
	public function ___init__(tensor_format:Dynamic, algo:Dynamic, mode:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(tensor_format:Dynamic, algo:Dynamic, mode:Dynamic):Void;
	/**
	...
	**/
	public function make_node(dy:Dynamic, sm:Dynamic):Dynamic;
	/**
	...
	**/
	...
	static public var softmax_inputs : Dynamic;
}