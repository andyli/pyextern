...
@:pythonImport("theano.sandbox.cuda.dnn", "GpuDnnBatchNormInference") extern class GpuDnnBatchNormInference {
	...
	**/
	@:native("__init__")
	public function ___init__(?mode:Dynamic, ?epsilon:Dynamic, ?inplace:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(?mode:Dynamic, ?epsilon:Dynamic, ?inplace:Dynamic):Void;
	/**
	...
	**/
	public function make_node(x:Dynamic, scale:Dynamic, bias:Dynamic, estimated_mean:Dynamic, estimated_variance:Dynamic):Dynamic;
	/**
