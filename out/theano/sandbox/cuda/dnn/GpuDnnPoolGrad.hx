...
@:pythonImport("theano.sandbox.cuda.dnn", "GpuDnnPoolGrad") extern class GpuDnnPoolGrad {
	...
	**/
	public function make_node(inp:Dynamic, out:Dynamic, inp_grad:Dynamic, ws:Dynamic, stride:Dynamic, pad:Dynamic):Dynamic;
	/**
