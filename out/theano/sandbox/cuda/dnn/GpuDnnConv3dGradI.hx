...
@:pythonImport("theano.sandbox.cuda.dnn", "GpuDnnConv3dGradI") extern class GpuDnnConv3dGradI {
	...
	**/
	@:native("__init__")
	public function ___init__(?inplace:Dynamic, ?workmem:Dynamic, ?algo:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(?inplace:Dynamic, ?workmem:Dynamic, ?algo:Dynamic):Void;
	/**
	...
	**/
	public function make_node(kern:Dynamic, topgrad:Dynamic, output:Dynamic, desc:Dynamic, ?alpha:Dynamic, ?beta:Dynamic):Dynamic;
	/**
