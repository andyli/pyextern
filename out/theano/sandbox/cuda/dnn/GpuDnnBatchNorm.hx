...
@:pythonImport("theano.sandbox.cuda.dnn", "GpuDnnBatchNorm") extern class GpuDnnBatchNorm {
	...
	**/
	@:native("__init__")
	public function ___init__(?mode:Dynamic, ?epsilon:Dynamic, ?running_average_factor:Dynamic, ?running_averages:Dynamic, ?inplace_running_mean:Dynamic, ?inplace_running_var:Dynamic, ?inplace_output:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(?mode:Dynamic, ?epsilon:Dynamic, ?running_average_factor:Dynamic, ?running_averages:Dynamic, ?inplace_running_mean:Dynamic, ?inplace_running_var:Dynamic, ?inplace_output:Dynamic):Void;
	/**
	...
	**/
	...
	public function infer_shape(node:Dynamic, shape:Dynamic):Dynamic;
	/**
	...
	**/
	public function make_node(x:Dynamic, scale:Dynamic, bias:Dynamic, ?running_mean:Dynamic, ?running_var:Dynamic):Dynamic;
	/**
	...
	**/
	...
	static public var tensor_descs : Dynamic;
}