...
@:pythonImport("theano.sandbox.fourier", "FFT") extern class FFT {
	...
	**/
	@:native("__init__")
	public function ___init__(?half:Dynamic, ?inverse:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(?half:Dynamic, ?inverse:Dynamic):Void;
	/**
	...
	**/
	...
	public function grad(inp:Dynamic, out:Dynamic):Dynamic;
	...
	**/
	public function make_node(frames:Dynamic, n:Dynamic, axis:Dynamic):Dynamic;
	/**
