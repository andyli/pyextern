...
@:pythonImport("theano.sandbox.rng_mrg", "GPU_mrg_uniform") extern class GPU_mrg_uniform {
	...
	**/
	@:native("__init__")
	public function ___init__(output_type:Dynamic, ?inplace:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(output_type:Dynamic, ?inplace:Dynamic):Void;
	/**
	...
	**/
	public function make_node(rstate:Dynamic, size:Dynamic):Dynamic;
	/**
