...
@:pythonImport("theano.sandbox.rng_mrg", "DotModulo") extern class DotModulo {
	...
	**/
	public function make_node(A:Dynamic, s:Dynamic, m:Dynamic, A2:Dynamic, s2:Dynamic, m2:Dynamic):Dynamic;
	/**
