...
@:pythonImport("theano.sandbox.linalg.ops", "Hint") extern class Hint {
	...
	**/
	...
	public function grad(inputs:Dynamic, g_out:Dynamic):Dynamic;
	/**
	...
	**/
	...
	/**
		...
		MethodNotDefined
		    The subclass does not override this method.
	**/
	public function perform(node:Dynamic, inputs:Dynamic, outstor:Dynamic):Dynamic;
	/**
