...
@:pythonImport("theano.sandbox.linalg.ops", "HintsFeature") extern class HintsFeature {
	...
	**/
	...
	public function add_hint(r:Dynamic, k:Dynamic, v:Dynamic):Dynamic;
	public function ensure_init_r(r:Dynamic):Dynamic;
	...
	public function update_second_from_first(r0:Dynamic, r1:Dynamic):Dynamic;
}