...
@:pythonImport("theano.sandbox.multinomial", "GpuMultinomialFromUniform") extern class GpuMultinomialFromUniform {
	...
	**/
	@:native("__init__")
	public function ___init__(odtype:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(odtype:Dynamic):Void;
	/**
	...
	**/
	public function make_node(pvals:Dynamic, unis:Dynamic):Dynamic;
	/**
