...
@:pythonImport("theano.sandbox.multinomial", "ChoiceFromUniform") extern class ChoiceFromUniform {
	...
	**/
	@:native("__init__")
	public function ___init__(odtype:Dynamic, ?replace:Dynamic, ?args:python.VarArgs<Dynamic>, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(odtype:Dynamic, ?replace:Dynamic, ?args:python.VarArgs<Dynamic>, ?kwargs:python.KwArgs<Dynamic>):Void;
	/**
	...
	**/
	...
	/**
		...
		MethodNotDefined
		    The subclass does not override this method.
	**/
	public function c_code(node:Dynamic, name:Dynamic, ins:Dynamic, outs:Dynamic, sub:Dynamic):Dynamic;
	/**
	...
	**/
	...
	public function grad(ins:Dynamic, outgrads:Dynamic):Dynamic;
	/**
	...
	**/
	public function make_node(pvals:Dynamic, unis:Dynamic, ?n:Dynamic):Dynamic;
	/**
	...
	**/
	...
	/**
		...
		MethodNotDefined
		    The subclass does not override this method.
	**/
	public function perform(node:Dynamic, ins:Dynamic, outs:Dynamic):Dynamic;
	/**
