...
package theano.tensor.type_other;
@:pythonImport("theano.tensor.type_other", "MakeSlice") extern class MakeSlice {
	...
	**/
	public function make_node(slc:Dynamic, ?stop:Dynamic, ?step:Dynamic):Dynamic;
	/**
