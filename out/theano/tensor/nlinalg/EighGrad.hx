...
@:pythonImport("theano.tensor.nlinalg", "EighGrad") extern class EighGrad {
	...
	**/
	public function make_node(x:Dynamic, w:Dynamic, v:Dynamic, gw:Dynamic, gv:Dynamic):Dynamic;
	/**
