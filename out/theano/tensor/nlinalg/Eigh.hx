...
@:pythonImport("theano.tensor.nlinalg", "Eigh") extern class Eigh {
	...
	**/
	@:native("__init__")
	public function ___init__(?UPLO:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(?UPLO:Dynamic):Void;
	/**
	...
	**/
	static public function _numop(a:Dynamic, ?UPLO:Dynamic):Dynamic;
	/**
