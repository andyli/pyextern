...
@:pythonImport("theano.tensor.nlinalg", "TensorInv") extern class TensorInv {
	...
	**/
	@:native("__init__")
	public function ___init__(?ind:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(?ind:Dynamic):Void;
	/**
	...
	**/
	...
	/**
		...
		True
	**/
	static public function _numop(a:Dynamic, ?ind:Dynamic):Dynamic;
	/**
