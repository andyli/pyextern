...
@:pythonImport("theano.tensor.sort", "SortOp") extern class SortOp {
	...
	**/
	public function _SortOp__get_argsort_indices(a:Dynamic, axis:Dynamic):Dynamic;
	public function _SortOp__get_expanded_dim(a:Dynamic, axis:Dynamic, i:Dynamic):Dynamic;
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(kind:Dynamic, ?order:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(kind:Dynamic, ?order:Dynamic):Void;
	/**
	...
	**/
	...
	public function infer_shape(node:Dynamic, inputs_shapes:Dynamic):Dynamic;
	/**
	...
	**/
	public function make_node(input:Dynamic, ?axis:Dynamic):Dynamic;
	/**
