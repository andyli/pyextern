...
@:pythonImport("theano.tensor.blas", "Dot22Scalar") extern class Dot22Scalar {
	...
	**/
	public function make_node(x:Dynamic, y:Dynamic, a:Dynamic):Dynamic;
	/**
	...
	**/
	...
	static public var setup_z_Nz_Sz : Dynamic;
}