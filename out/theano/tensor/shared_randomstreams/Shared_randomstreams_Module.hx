...
@:pythonImport("theano.tensor.shared_randomstreams") extern class Shared_randomstreams_Module {
	...
	**/
	static public function randomstate_constructor(value:Dynamic, ?name:Dynamic, ?strict:Dynamic, ?allow_downcast:Dynamic, ?borrow:Dynamic):Dynamic;
	/**
