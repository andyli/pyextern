...
@:pythonImport("theano.tensor.opt", "FusionOptimizer") extern class FusionOptimizer {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(local_optimizer:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(local_optimizer:Dynamic):Void;
	/**
