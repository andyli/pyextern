...
@:pythonImport("theano.tensor.opt", "Assert") extern class Assert {
	...
	**/
	@:native("__init__")
	public function ___init__(?msg:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(?msg:Dynamic):Void;
	/**
	...
	**/
	...
	public function __setstate__(attrs:Dynamic):Dynamic;
	/**
		__sizeof__() -> int
	...
	**/
	...
	public function grad(input:Dynamic, output_gradients:Dynamic):Dynamic;
	...
	**/
	public function make_node(value:Dynamic, ?conds:python.VarArgs<Dynamic>):Dynamic;
	/**
