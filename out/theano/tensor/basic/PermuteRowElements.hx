...
@:pythonImport("theano.tensor.basic", "PermuteRowElements") extern class PermuteRowElements {
	...
	**/
	public function _rec_perform(node:Dynamic, x:Dynamic, y:Dynamic, inverse:Dynamic, out:Dynamic, curdim:Dynamic):Dynamic;
	/**
	...
	**/
	public function make_node(x:Dynamic, y:Dynamic, inverse:Dynamic):Dynamic;
	/**
