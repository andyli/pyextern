...
@:pythonImport("theano.tensor.basic", "Argmax") extern class Argmax {
	static public var E_axis : Dynamic;
	...
	**/
	public function make_node(x:Dynamic, ?axis:Dynamic):Dynamic;
	/**
	...
	**/
	...
	/**
		...
		MethodNotDefined
		    The subclass does not override this method.
	**/
	public function perform(node:Dynamic, inp:Dynamic, outs:Dynamic, params:Dynamic):Dynamic;
	/**
