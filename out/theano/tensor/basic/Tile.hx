...
@:pythonImport("theano.tensor.basic", "Tile") extern class Tile {
	...
	**/
	@:native("__init__")
	public function ___init__(ndim:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(ndim:Dynamic):Void;
	/**
	...
	**/
	public function make_node(x:Dynamic, reps:Dynamic):Dynamic;
	/**
