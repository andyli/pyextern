...
@:pythonImport("theano.tensor.io", "MPIRecv") extern class MPIRecv {
	...
	**/
	@:native("__init__")
	public function ___init__(source:Dynamic, tag:Dynamic, shape:Dynamic, dtype:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(source:Dynamic, tag:Dynamic, shape:Dynamic, dtype:Dynamic):Void;
	/**
