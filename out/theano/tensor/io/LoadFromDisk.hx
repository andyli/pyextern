...
@:pythonImport("theano.tensor.io", "LoadFromDisk") extern class LoadFromDisk {
	...
	**/
	@:native("__init__")
	public function ___init__(dtype:Dynamic, broadcastable:Dynamic, ?mmap_mode:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(dtype:Dynamic, broadcastable:Dynamic, ?mmap_mode:Dynamic):Void;
	/**
	...
	**/
	public function make_node(path:Dynamic):Dynamic;
	/**
