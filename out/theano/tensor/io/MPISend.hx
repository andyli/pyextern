...
@:pythonImport("theano.tensor.io", "MPISend") extern class MPISend {
	...
	**/
	@:native("__init__")
	public function ___init__(dest:Dynamic, tag:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(dest:Dynamic, tag:Dynamic):Void;
	/**
	...
	**/
	public function make_node(data:Dynamic):Dynamic;
	/**
