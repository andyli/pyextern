...
@:pythonImport("theano.tensor.slinalg", "Solve") extern class Solve {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(?A_structure:Dynamic, ?lower:Dynamic, ?overwrite_A:Dynamic, ?overwrite_b:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(?A_structure:Dynamic, ?lower:Dynamic, ?overwrite_A:Dynamic, ?overwrite_b:Dynamic):Void;
	/**
	...
	**/
	public function make_node(A:Dynamic, b:Dynamic):Dynamic;
	/**
