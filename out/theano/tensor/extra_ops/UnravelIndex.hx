...
@:pythonImport("theano.tensor.extra_ops", "UnravelIndex") extern class UnravelIndex {
	...
	**/
	@:native("__init__")
	public function ___init__(ndim:Dynamic, ?order:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(ndim:Dynamic, ?order:Dynamic):Void;
	/**
	...
	**/
	public function make_node(indices:Dynamic, dims:Dynamic):Dynamic;
	/**
