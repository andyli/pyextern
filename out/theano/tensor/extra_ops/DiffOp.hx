...
@:pythonImport("theano.tensor.extra_ops", "DiffOp") extern class DiffOp {
	...
	**/
	@:native("__init__")
	public function ___init__(?n:Dynamic, ?axis:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(?n:Dynamic, ?axis:Dynamic):Void;
	/**
	...
	**/
	...
	public function infer_shape(node:Dynamic, ins_shapes:Dynamic):Dynamic;
	/**
