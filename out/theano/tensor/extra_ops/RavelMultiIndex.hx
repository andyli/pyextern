...
@:pythonImport("theano.tensor.extra_ops", "RavelMultiIndex") extern class RavelMultiIndex {
	...
	**/
	@:native("__init__")
	public function ___init__(?mode:Dynamic, ?order:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(?mode:Dynamic, ?order:Dynamic):Void;
	/**
	...
	**/
	public function make_node(?inp:python.VarArgs<Dynamic>):Dynamic;
	/**
