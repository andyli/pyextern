...
@:pythonImport("theano.tensor.extra_ops", "SearchsortedOp") extern class SearchsortedOp {
	...
	**/
	@:native("__init__")
	public function ___init__(?side:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(?side:Dynamic):Void;
	/**
	...
	**/
	public function make_node(x:Dynamic, v:Dynamic, ?sorter:Dynamic):Dynamic;
	/**
