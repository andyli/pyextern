...
@:pythonImport("theano.tensor.extra_ops", "FillDiagonalOffset") extern class FillDiagonalOffset {
	...
	**/
	public function grad(inp:Dynamic, cost_grad:Dynamic):Dynamic;
	...
	**/
	public function make_node(a:Dynamic, val:Dynamic, offset:Dynamic):Dynamic;
	/**
