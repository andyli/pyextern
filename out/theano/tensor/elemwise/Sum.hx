...
@:pythonImport("theano.tensor.elemwise", "Sum") extern class Sum {
	...
	**/
	@:native("__init__")
	public function ___init__(?axis:Dynamic, ?dtype:Dynamic, ?acc_dtype:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(?axis:Dynamic, ?dtype:Dynamic, ?acc_dtype:Dynamic):Void;
	/**
