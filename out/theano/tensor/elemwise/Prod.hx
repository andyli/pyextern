...
@:pythonImport("theano.tensor.elemwise", "Prod") extern class Prod {
	/**
	...
	**/
	public function L_op(inp:Dynamic, out:Dynamic, grads:Dynamic):Dynamic;
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(?axis:Dynamic, ?dtype:Dynamic, ?acc_dtype:Dynamic, ?no_zeros_in_input:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(?axis:Dynamic, ?dtype:Dynamic, ?acc_dtype:Dynamic, ?no_zeros_in_input:Dynamic):Void;
	/**
	...
	**/
	...
	/**
		...
		MethodNotDefined
		    The subclass does not override this method.
	**/
	public function c_code(node:Dynamic, name:Dynamic, inames:Dynamic, onames:Dynamic, sub:Dynamic):Dynamic;
	/**
