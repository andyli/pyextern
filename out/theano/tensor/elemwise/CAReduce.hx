...
@:pythonImport("theano.tensor.elemwise", "CAReduce") extern class CAReduce {
	...
	**/
	@:native("__init__")
	public function ___init__(scalar_op:Dynamic, ?axis:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(scalar_op:Dynamic, ?axis:Dynamic):Void;
	/**
	...
	**/
	...
	public function _output_dtype(input_dtype:Dynamic):Dynamic;
	/**
