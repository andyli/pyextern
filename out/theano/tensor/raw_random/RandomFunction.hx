...
@:pythonImport("theano.tensor.raw_random", "RandomFunction") extern class RandomFunction {
	...
	**/
	@:native("__init__")
	public function ___init__(fn:Dynamic, outtype:Dynamic, ?inplace:Dynamic, ?ndim_added:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(fn:Dynamic, outtype:Dynamic, ?inplace:Dynamic, ?ndim_added:Dynamic):Void;
	/**
	...
	**/
	...
	public function grad(inputs:Dynamic, outputs:Dynamic):Dynamic;
	...
	**/
	...
	/**
		...
		Apply
		    ...
		    draw.
	**/
	public function make_node(r:Dynamic, shape:Dynamic, ?args:python.VarArgs<Dynamic>):Dynamic;
	/**
