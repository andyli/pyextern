...
package theano.tensor.fourier;
@:pythonImport("theano.tensor.fourier", "Fourier") extern class Fourier {
	...
	**/
	public function grad(inputs:Dynamic, cost_grad:Dynamic):Dynamic;
	...
	**/
	public function make_node(a:Dynamic, n:Dynamic, axis:Dynamic):Dynamic;
	/**
