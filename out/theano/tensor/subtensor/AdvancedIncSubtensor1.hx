...
@:pythonImport("theano.tensor.subtensor", "AdvancedIncSubtensor1") extern class AdvancedIncSubtensor1 {
	...
	**/
	@:native("__init__")
	public function ___init__(?inplace:Dynamic, ?set_instead_of_inc:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(?inplace:Dynamic, ?set_instead_of_inc:Dynamic):Void;
	/**
	...
	**/
	...
	public function clone_inplace():Dynamic;
	...
	**/
	public function make_node(x:Dynamic, y:Dynamic, ilist:Dynamic):Dynamic;
	/**
	...
	**/
	...
	/**
		...
		MethodNotDefined
		    The subclass does not override this method.
	**/
	public function perform(node:Dynamic, inp:Dynamic, out_:Dynamic, params:Dynamic):Dynamic;
	/**
