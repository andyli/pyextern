...
@:pythonImport("theano.tensor.subtensor", "AdvancedBooleanSubtensor") extern class AdvancedBooleanSubtensor {
	...
	**/
	public function make_node(x:Dynamic, ?index:python.VarArgs<Dynamic>):Dynamic;
	/**
