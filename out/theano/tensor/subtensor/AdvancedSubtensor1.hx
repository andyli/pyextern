...
@:pythonImport("theano.tensor.subtensor", "AdvancedSubtensor1") extern class AdvancedSubtensor1 {
	...
	**/
	@:native("__init__")
	public function ___init__(?sparse_grad:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(?sparse_grad:Dynamic):Void;
	/**
	...
	**/
	public function make_node(x:Dynamic, ilist:Dynamic):Dynamic;
	/**
