...
@:pythonImport("theano.tensor.blas_scipy", "ScipyGer") extern class ScipyGer {
	...
	**/
	@:native("__init__")
	public function ___init__(destructive:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(destructive:Dynamic):Void;
	/**
	...
	**/
	public function make_node(A:Dynamic, alpha:Dynamic, x:Dynamic, y:Dynamic):Dynamic;
	/**
