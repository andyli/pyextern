...
@:pythonImport("theano.tensor.nnet.sigm", "ScalarSigmoid") extern class ScalarSigmoid {
	...
	**/
	@:native("__init__")
	public function ___init__(?output_types_preference:Dynamic, ?name:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(?output_types_preference:Dynamic, ?name:Dynamic):Void;
	/**
	...
	**/
	public function c_code_contiguous(node:Dynamic, name:Dynamic, inputs:Dynamic, outputs:Dynamic, sub:Dynamic):Dynamic;
	public function c_code_contiguous_disabled(node:Dynamic, name:Dynamic, inp:Dynamic, out:Dynamic, sub:Dynamic):Dynamic;
	public function c_code_contiguous_raw(dtype:Dynamic, n:Dynamic, i:Dynamic, o:Dynamic):Dynamic;
	/**
	...
	**/
	static public function gen_graph():Dynamic;
	...
	**/
	...
	static public function st_impl(x:Dynamic):Dynamic;
	/**
