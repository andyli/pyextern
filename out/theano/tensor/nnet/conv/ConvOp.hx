...
@:pythonImport("theano.tensor.nnet.conv", "ConvOp") extern class ConvOp {
	...
	**/
	...
	static public var _ConvOp__attrnames : Dynamic;
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(?imshp:Dynamic, ?kshp:Dynamic, ?nkern:Dynamic, ?bsize:Dynamic, ?dx:Dynamic, ?dy:Dynamic, ?output_mode:Dynamic, ?unroll_batch:Dynamic, ?unroll_kern:Dynamic, ?unroll_patch:Dynamic, ?imshp_logical:Dynamic, ?kshp_logical:Dynamic, ?kshp_logical_top_aligned:Dynamic, ?verbose:Dynamic, ?version:Dynamic, ?direction_hint:Dynamic, ?openmp:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(?imshp:Dynamic, ?kshp:Dynamic, ?nkern:Dynamic, ?bsize:Dynamic, ?dx:Dynamic, ?dy:Dynamic, ?output_mode:Dynamic, ?unroll_batch:Dynamic, ?unroll_kern:Dynamic, ?unroll_patch:Dynamic, ?imshp_logical:Dynamic, ?kshp_logical:Dynamic, ?kshp_logical_top_aligned:Dynamic, ?verbose:Dynamic, ?version:Dynamic, ?direction_hint:Dynamic, ?openmp:Dynamic):Void;
	/**
	...
	**/
	...
	public function _rehash():Dynamic;
	/**
	...
	**/
	public function flops(inputs:Dynamic, outputs:Dynamic):Dynamic;
	/**
	...
	**/
	static public function getOutputShape(inshp:Dynamic, kshp:Dynamic, ?stride:Dynamic, ?mode:Dynamic):Dynamic;
	public function grad(inp:Dynamic, grads:Dynamic):Dynamic;
	static public var gxx_support_openmp : Dynamic;
	static public function has_all_shape(imshp:Dynamic, kshp:Dynamic, ?nkern:Dynamic, ?bsize:Dynamic):Dynamic;
	...
	**/
	public function make_node(inputs:Dynamic, kerns:Dynamic):Dynamic;
	/**
	...
	**/
	...
	static public var speed_unroll_batch_kern : Dynamic;
	static public var speed_unroll_patch_noshape : Dynamic;
	static public var speed_unroll_patch_shape : Dynamic;
	/**
	...
	**/
	public function use_blas():Dynamic;
}