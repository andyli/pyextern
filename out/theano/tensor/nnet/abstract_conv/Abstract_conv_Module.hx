...
@:pythonImport("theano.tensor.nnet.abstract_conv") extern class Abstract_conv_Module {
	...
	**/
	static public function bilinear_upsampling(input:Dynamic, ratio:Dynamic, ?batch_size:Dynamic, ?num_input_channels:Dynamic, ?use_1D_kernel:Dynamic):Dynamic;
	/**
	...
	**/
	static public function conv2d(input:Dynamic, filters:Dynamic, ?input_shape:Dynamic, ?filter_shape:Dynamic, ?border_mode:Dynamic, ?subsample:Dynamic, ?filter_flip:Dynamic, ?filter_dilation:Dynamic):Dynamic;
	/**
	...
	**/
	...
	/**
		...
		:note: This is only supported in Theano 0.8 or the development
		    version until it is released.
	**/
	static public function conv2d_grad_wrt_weights(input:Dynamic, output_grad:Dynamic, filter_shape:Dynamic, ?input_shape:Dynamic, ?border_mode:Dynamic, ?subsample:Dynamic, ?filter_flip:Dynamic, ?filter_dilation:Dynamic):Dynamic;
	/**
		This function will build the symbolic graph for convolving a mini-batch of a
	...
	**/
	...
	/**
		...
		:note: This is only supported in Theano 0.8 or the development
		    version until it is released.
	**/
	static public function conv3d_grad_wrt_inputs(output_grad:Dynamic, filters:Dynamic, input_shape:Dynamic, ?filter_shape:Dynamic, ?border_mode:Dynamic, ?subsample:Dynamic, ?filter_flip:Dynamic, ?filter_dilation:Dynamic):Dynamic;
	/**
		Compute conv output gradient w.r.t its weights
		...
		:note: This is only supported in Theano 0.8 or the development
		    version until it is released.
	**/
	static public function conv3d_grad_wrt_weights(input:Dynamic, output_grad:Dynamic, filter_shape:Dynamic, ?input_shape:Dynamic, ?border_mode:Dynamic, ?subsample:Dynamic, ?filter_flip:Dynamic, ?filter_dilation:Dynamic):Dynamic;
	/**
	...
	**/
	static public function get_conv_gradinputs_shape(kernel_shape:Dynamic, top_shape:Dynamic, border_mode:Dynamic, subsample:Dynamic, ?filter_dilation:Dynamic):Dynamic;
	/**
		This function tries to compute the image shape of convolution gradInputs.
	...
	**/
	...
	/**
		...
		kernel_shape: tuple of int (symbolic or numeric) corresponding to the
		    ...
		    width (and possibly depth) of the kernel. None where undefined.
	**/
	static public function get_conv_gradweights_shape(image_shape:Dynamic, top_shape:Dynamic, border_mode:Dynamic, subsample:Dynamic, ?filter_dilation:Dynamic):Dynamic;
	/**
