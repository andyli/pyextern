...
@:pythonImport("theano.tensor.nnet.abstract_conv", "AbstractConv2d_gradWeights") extern class AbstractConv2d_gradWeights {
	...
	**/
	@:native("__init__")
	public function ___init__(?imshp:Dynamic, ?kshp:Dynamic, ?border_mode:Dynamic, ?subsample:Dynamic, ?filter_flip:Dynamic, ?filter_dilation:Dynamic, ?num_groups:Dynamic, ?unshared:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(?imshp:Dynamic, ?kshp:Dynamic, ?border_mode:Dynamic, ?subsample:Dynamic, ?filter_flip:Dynamic, ?filter_dilation:Dynamic, ?num_groups:Dynamic, ?unshared:Dynamic):Void;
	/**
	...
	**/
	public function make_node(img:Dynamic, topgrad:Dynamic, shape:Dynamic, ?add_assert_shape:Dynamic):Dynamic;
	/**
