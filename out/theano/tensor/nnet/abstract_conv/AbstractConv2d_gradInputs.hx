...
@:pythonImport("theano.tensor.nnet.abstract_conv", "AbstractConv2d_gradInputs") extern class AbstractConv2d_gradInputs {
	...
	**/
	public function make_node(kern:Dynamic, topgrad:Dynamic, shape:Dynamic, ?add_assert_shape:Dynamic):Dynamic;
	/**
