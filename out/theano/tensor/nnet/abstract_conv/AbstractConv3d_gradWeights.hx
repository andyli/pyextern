...
@:pythonImport("theano.tensor.nnet.abstract_conv", "AbstractConv3d_gradWeights") extern class AbstractConv3d_gradWeights {
	...
	**/
	@:native("__init__")
	public function ___init__(?imshp:Dynamic, ?kshp:Dynamic, ?border_mode:Dynamic, ?subsample:Dynamic, ?filter_flip:Dynamic, ?filter_dilation:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(?imshp:Dynamic, ?kshp:Dynamic, ?border_mode:Dynamic, ?subsample:Dynamic, ?filter_flip:Dynamic, ?filter_dilation:Dynamic):Void;
	/**
