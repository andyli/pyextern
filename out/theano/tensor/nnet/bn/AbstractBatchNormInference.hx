...
@:pythonImport("theano.tensor.nnet.bn", "AbstractBatchNormInference") extern class AbstractBatchNormInference {
	...
	**/
	public function make_node(x:Dynamic, scale:Dynamic, bias:Dynamic, estimated_mean:Dynamic, estimated_variance:Dynamic, ?epsilon:Dynamic):Dynamic;
	/**
