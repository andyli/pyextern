...
@:pythonImport("theano.tensor.nnet.bn", "AbstractBatchNormTrainGrad") extern class AbstractBatchNormTrainGrad {
	...
	**/
	public function make_node(x:Dynamic, dy:Dynamic, scale:Dynamic, x_mean:Dynamic, x_invstd:Dynamic, ?epsilon:Dynamic):Dynamic;
	/**
