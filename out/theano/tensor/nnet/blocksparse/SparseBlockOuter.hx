...
@:pythonImport("theano.tensor.nnet.blocksparse", "SparseBlockOuter") extern class SparseBlockOuter {
	...
	**/
	public function make_node(o:Dynamic, x:Dynamic, y:Dynamic, xIdx:Dynamic, yIdx:Dynamic, ?alpha:Dynamic):Dynamic;
	/**
	...
	**/
	...
	static public var registered_opts : Dynamic;
}