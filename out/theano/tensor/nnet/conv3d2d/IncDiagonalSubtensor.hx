...
@:pythonImport("theano.tensor.nnet.conv3d2d", "IncDiagonalSubtensor") extern class IncDiagonalSubtensor {
	...
	**/
	public function make_node(x:Dynamic, i0:Dynamic, i1:Dynamic, amt:Dynamic):Dynamic;
	/**
