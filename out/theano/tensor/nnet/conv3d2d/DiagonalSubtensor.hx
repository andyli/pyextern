...
@:pythonImport("theano.tensor.nnet.conv3d2d", "DiagonalSubtensor") extern class DiagonalSubtensor {
	...
	**/
	public function make_node(x:Dynamic, i0:Dynamic, i1:Dynamic):Dynamic;
	/**
