...
@:pythonImport("theano.tensor.nnet.corr3d", "Corr3dMM_gradInputs") extern class Corr3dMM_gradInputs {
	...
	**/
	public function make_node(kern:Dynamic, topgrad:Dynamic, ?shape:Dynamic):Dynamic;
	/**
