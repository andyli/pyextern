...
package theano.tensor.nnet.convGrad3D;
@:pythonImport("theano.tensor.nnet.ConvGrad3D", "ConvGrad3D") extern class ConvGrad3D {
	...
	**/
	public function make_node(V:Dynamic, d:Dynamic, WShape:Dynamic, dCdH:Dynamic):Dynamic;
	/**
