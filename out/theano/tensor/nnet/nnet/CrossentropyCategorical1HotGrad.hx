...
@:pythonImport("theano.tensor.nnet.nnet", "CrossentropyCategorical1HotGrad") extern class CrossentropyCategorical1HotGrad {
	...
	**/
	public function make_node(g_y:Dynamic, coding_dist:Dynamic, true_one_of_n:Dynamic):Dynamic;
	/**
