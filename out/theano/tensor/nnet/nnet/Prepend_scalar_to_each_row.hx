...
@:pythonImport("theano.tensor.nnet.nnet", "Prepend_scalar_to_each_row") extern class Prepend_scalar_to_each_row {
	...
	**/
	public function make_node(val:Dynamic, mat:Dynamic):Dynamic;
	/**
