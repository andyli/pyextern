...
@:pythonImport("theano.tensor.nnet.nnet", "CrossentropySoftmaxArgmax1HotWithBias") extern class CrossentropySoftmaxArgmax1HotWithBias {
	...
	**/
	public function make_node(x:Dynamic, b:Dynamic, y_idx:Dynamic):Dynamic;
	/**
