...
@:pythonImport("theano.tensor.nnet.nnet", "CrossentropyCategorical1Hot") extern class CrossentropyCategorical1Hot {
	...
	**/
	...
	/**
		...
		dvector
	**/
	public function make_node(coding_dist:Dynamic, true_one_of_n:Dynamic):Dynamic;
	/**
