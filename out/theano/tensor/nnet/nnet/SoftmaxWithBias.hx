...
@:pythonImport("theano.tensor.nnet.nnet", "SoftmaxWithBias") extern class SoftmaxWithBias {
	public function L_op(inp:Dynamic, outputs:Dynamic, grads:Dynamic):Dynamic;
	/**
	...
	**/
	static public function c_code_cache_version():Dynamic;
	/**
		Return a tuple of integers indicating the version of this Op.
	...
	**/
	...
	static public function c_code_template(dtype:Dynamic):Dynamic;
	/**
	...
	**/
	public function make_node(x:Dynamic, b:Dynamic):Dynamic;
	/**
	...
	**/
	...
	/**
		...
		MethodNotDefined
		    The subclass does not override this method.
	**/
	public function perform(node:Dynamic, input_storage:Dynamic, output_storage:Dynamic):Dynamic;
	/**
