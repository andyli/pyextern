...
@:pythonImport("theano.tensor.nnet.nnet", "Prepend_scalar_constant_to_each_row") extern class Prepend_scalar_constant_to_each_row {
	...
	**/
	public function make_node(mat:Dynamic):Dynamic;
	/**
