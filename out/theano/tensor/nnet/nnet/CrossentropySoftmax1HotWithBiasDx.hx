...
@:pythonImport("theano.tensor.nnet.nnet", "CrossentropySoftmax1HotWithBiasDx") extern class CrossentropySoftmax1HotWithBiasDx {
	...
	**/
	public function make_node(dy:Dynamic, sm:Dynamic, y_idx:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
