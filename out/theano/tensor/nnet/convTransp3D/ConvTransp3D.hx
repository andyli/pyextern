...
package theano.tensor.nnet.convTransp3D;
@:pythonImport("theano.tensor.nnet.ConvTransp3D", "ConvTransp3D") extern class ConvTransp3D {
	...
	**/
	public function make_node(W:Dynamic, b:Dynamic, d:Dynamic, H:Dynamic, ?RShape:Dynamic):Dynamic;
	/**
