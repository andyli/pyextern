...
@:pythonImport("theano.tensor.nnet.neighbours", "Images2Neibs") extern class Images2Neibs {
	static public function BORDER_MODE(?name:Dynamic):Dynamic;
	...
	/**
		...
		matrix
		    ...
		    .. note:: The op isn't necessarily implemented internally with these
		        ...
		        pattern.
	**/
	public function make_node(ten4:Dynamic, neib_shape:Dynamic, ?neib_step:Dynamic):Dynamic;
	/**
