...
@:pythonImport("theano.tensor.signal.pool", "MaxPoolGrad") extern class MaxPoolGrad {
	...
	**/
	@:native("__init__")
	public function ___init__(ignore_border:Dynamic, ?ndim:Dynamic, ?openmp:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(ignore_border:Dynamic, ?ndim:Dynamic, ?openmp:Dynamic):Void;
	/**
	...
	**/
	public function make_node(x:Dynamic, maxout:Dynamic, gz:Dynamic, ws:Dynamic, ?stride:Dynamic, ?pad:Dynamic):Dynamic;
	/**
