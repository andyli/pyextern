...
@:pythonImport("theano.tensor.signal.pool", "Pool") extern class Pool {
	...
	**/
	@:native("__init__")
	public function ___init__(?ignore_border:Dynamic, ?mode:Dynamic, ?ndim:Dynamic, ?openmp:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(?ignore_border:Dynamic, ?mode:Dynamic, ?ndim:Dynamic, ?openmp:Dynamic):Void;
	/**
	...
	**/
	public function make_node(x:Dynamic, ws:Dynamic, ?stride:Dynamic, ?pad:Dynamic):Dynamic;
	/**
	...
	**/
	static public function out_shape(imgshape:Dynamic, ?ws:Dynamic, ?ignore_border:Dynamic, ?stride:Dynamic, ?pad:Dynamic, ?ndim:Dynamic, ?ds:Dynamic, ?st:Dynamic, ?padding:Dynamic):Dynamic;
