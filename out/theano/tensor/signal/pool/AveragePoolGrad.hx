...
@:pythonImport("theano.tensor.signal.pool", "AveragePoolGrad") extern class AveragePoolGrad {
	...
	**/
	@:native("__init__")
	public function ___init__(ignore_border:Dynamic, ?mode:Dynamic, ?ndim:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(ignore_border:Dynamic, ?mode:Dynamic, ?ndim:Dynamic):Void;
	/**
	...
	**/
	public function make_node(x:Dynamic, gz:Dynamic, ws:Dynamic, ?stride:Dynamic, ?pad:Dynamic, ?dummy:Dynamic):Dynamic;
	/**
