...
@:pythonImport("theano.tensor.signal.pool", "MaxPoolRop") extern class MaxPoolRop {
	...
	**/
	public function make_node(x:Dynamic, eval_point:Dynamic, ws:Dynamic, ?stride:Dynamic, ?pad:Dynamic):Dynamic;
	/**
