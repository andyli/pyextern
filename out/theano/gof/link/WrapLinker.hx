...
@:pythonImport("theano.gof.link", "WrapLinker") extern class WrapLinker {
	...
	**/
	@:native("__init__")
	public function ___init__(linkers:Dynamic, wrapper:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(linkers:Dynamic, wrapper:Dynamic):Void;
	/**
	...
	**/
	...
	public function pre(f:Dynamic, inputs:Dynamic, order:Dynamic, thunk_groups:Dynamic):Dynamic;
