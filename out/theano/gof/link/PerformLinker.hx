...
@:pythonImport("theano.gof.link", "PerformLinker") extern class PerformLinker {
	...
	**/
	@:native("__init__")
	public function ___init__(?allow_gc:Dynamic, ?schedule:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(?allow_gc:Dynamic, ?schedule:Dynamic):Void;
	/**
	...
	**/
	...
	/**
		...
		object
		    ...
		    (for all programs).
	**/
	public function make_all(?input_storage:Dynamic, ?output_storage:Dynamic, ?storage_map:Dynamic):Dynamic;
	/**
