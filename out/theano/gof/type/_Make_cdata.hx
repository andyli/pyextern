...
@:pythonImport("theano.gof.type", "_make_cdata") extern class _Make_cdata {
	...
	**/
	@:native("__init__")
	public function ___init__(rtype:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(rtype:Dynamic):Void;
	/**
	...
	**/
	public function make_node(val:Dynamic):Dynamic;
	/**
