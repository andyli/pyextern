...
@:pythonImport("theano.gof.vm", "LoopGC") extern class LoopGC {
	/**
		Run the machine.
	...
	**/
	@:native("__init__")
	public function ___init__(nodes:Dynamic, thunks:Dynamic, pre_call_clear:Dynamic, post_thunk_clear:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(nodes:Dynamic, thunks:Dynamic, pre_call_clear:Dynamic, post_thunk_clear:Dynamic):Void;
	/**
