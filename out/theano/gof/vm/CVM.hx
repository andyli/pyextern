...
@:pythonImport("theano.gof.vm", "CVM") extern class CVM {
	/**
	...
	**/
	public var call_counts : Dynamic;
	/**
		total runtime in each thunk
	**/
	public var call_times : Dynamic;
	/**
	...
	**/
	...
	/**
		bool: nonzero means Function.__call__ must implement update mechanism
	**/
	public var need_update_inputs : Dynamic;
	/**
		list of nodes
	**/
	...
	**/
	public var position_of_error : Dynamic;
	/**
		list of thunks in program
	**/
	public var thunks : Dynamic;
	/**
		bool: nonzero means call will time thunks
	**/
	public var time_thunks : Dynamic;
	/**
