...
package theano.gof.callcache;
@:pythonImport("theano.gof.callcache", "CallCache") extern class CallCache {
	...
	**/
	public function call(fn:Dynamic, ?args:Dynamic, ?key:Dynamic):Dynamic;
	/**
		Cache "filename" as a pickle file
	**/
	public function persist(?filename:Dynamic):Dynamic;
}