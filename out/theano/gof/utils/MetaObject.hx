...
@:pythonImport("theano.gof.utils", "MetaObject") extern class MetaObject {
	...
	**/
	static public function __new__(cls:Dynamic, name:Dynamic, bases:Dynamic, dct:Dynamic):Dynamic;
	/**
		__prepare__() -> dict
