...
@:pythonImport("theano.gof.toolbox", "ReplaceValidate") extern class ReplaceValidate {
	...
	**/
	...
	public function consistent_(fgraph:Dynamic):Dynamic;
	/**
	...
	**/
	...
	public function replace_all_validate(fgraph:Dynamic, replacements:Dynamic, ?reason:Dynamic, ?verbose:Dynamic):Dynamic;
	/**
		As replace_all_validate, revert the replacement if the ops
		in the list remove are still in the graph. Also print a warning.
	**/
	public function replace_all_validate_remove(fgraph:Dynamic, replacements:Dynamic, remove:Dynamic, ?reason:Dynamic, ?warn:Dynamic):Dynamic;
	public function replace_validate(fgraph:Dynamic, r:Dynamic, new_r:Dynamic, ?reason:Dynamic):Dynamic;
	/**
		Reverts the graph to whatever it was at the provided
		checkpoint (undoes all replacements). A checkpoint at any
		given time can be obtained using self.checkpoint().
	**/
	public function revert(fgraph:Dynamic, checkpoint:Dynamic):Dynamic;
	...
	**/
	public function validate_(fgraph:Dynamic):Dynamic;
}