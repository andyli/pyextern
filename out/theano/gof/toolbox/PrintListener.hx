...
@:pythonImport("theano.gof.toolbox", "PrintListener") extern class PrintListener {
	...
	**/
	@:native("__init__")
	public function ___init__(?active:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(?active:Dynamic):Void;
	/**
