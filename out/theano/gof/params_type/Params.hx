...
@:pythonImport("theano.gof.params_type", "Params") extern class Params {
	...
	**/
	@:native("__init__")
	public function ___init__(params_type:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(params_type:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Void;
	/**
