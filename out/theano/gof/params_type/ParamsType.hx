...
package theano.gof.params_type;
@:pythonImport("theano.gof.params_type", "ParamsType") extern class ParamsType {
	/**
	...
	**/
	...
	/**
		...
		MethodNotDefined
		    The subclass does not override this method.
	**/
	public function c_no_compile_args(c_compiler:Dynamic):Dynamic;
	/**
	...
	/**
		...
		**Example**::
		...
		.. note::
		    ...
		    method to do that.
	**/
	public function enum_from_alias(alias:Dynamic):Dynamic;
	/**
	...
	**/
	public function extended(?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
	...
	**/
	...
	public function generate_struct_name():Dynamic;
	/**
		...
		**Example**::
		    ...
		    print(wrapper.TWO)
	**/
	public function get_enum(key:Dynamic):Dynamic;
	/**
	...
	**/
	public function get_field(theano_type:Dynamic):Dynamic;
	/**
		...
		**Example**::
		    ...
		    print(params)
	**/
	public function get_params(?objects:python.VarArgs<Dynamic>, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
		Return the Theano type associated to the given field name
		in the current ParamsType.
	**/
	public function get_type(field_name:Dynamic):Dynamic;
	/**
		Return True if current ParamsType contains the specified Theano type.
	**/
	public function has_type(theano_type:Dynamic):Dynamic;
	/**
