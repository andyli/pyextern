...
@:pythonImport("theano.gof.op") extern class Op_Module {
	...
	**/
	static public function _open_u(file:Dynamic, ?mode:Dynamic, ?buffering:Dynamic, ?encoding:Dynamic, ?errors:Dynamic, ?newline:Dynamic, ?closefd:Dynamic, ?opener:Dynamic):Dynamic;
	static public var absolute_import : Dynamic;
	static public function apply_meth(tag:Dynamic):Dynamic;
	static public var config : Dynamic;
	/**
		Customized assert with options to ignore the assert
		with just a warning
	**/
	static public function debug_assert(condition:Dynamic, ?msg:Dynamic):Dynamic;
	/**
	...
	**/
	static public function debug_error_message(msg:Dynamic):Dynamic;
	...
	**/
	static public function get_test_value(v:Dynamic):Dynamic;
	/**
	...
	**/
	static public function missing_test_message(msg:Dynamic):Dynamic;
	static public var ops_with_inner_function : Dynamic;
	static public var print_function : Dynamic;
	static public function simple_meth(tag:Dynamic):Dynamic;
}