...
@:pythonImport("theano.gof.cc", "OpWiseCLinker") extern class OpWiseCLinker {
	static public var __cache__ : Dynamic;
	...
	**/
	@:native("__init__")
	public function ___init__(?fallback_on_perform:Dynamic, ?allow_gc:Dynamic, ?nice_errors:Dynamic, ?schedule:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(?fallback_on_perform:Dynamic, ?allow_gc:Dynamic, ?nice_errors:Dynamic, ?schedule:Dynamic):Void;
	/**
