...
@:pythonImport("theano.gof.opt", "OpSub") extern class OpSub {
	...
	**/
	@:native("__init__")
	public function ___init__(op1:Dynamic, op2:Dynamic, ?transfer_tags:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(op1:Dynamic, op2:Dynamic, ?transfer_tags:Dynamic):Void;
	/**
	...
	**/
	...
	static public var reentrant : Dynamic;
	static public var retains_inputs : Dynamic;
	/**
