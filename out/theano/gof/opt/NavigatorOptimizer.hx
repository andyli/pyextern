...
@:pythonImport("theano.gof.opt", "NavigatorOptimizer") extern class NavigatorOptimizer {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(local_opt:Dynamic, ?ignore_newtrees:Dynamic, ?failure_callback:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(local_opt:Dynamic, ?ignore_newtrees:Dynamic, ?failure_callback:Dynamic):Void;
	/**
