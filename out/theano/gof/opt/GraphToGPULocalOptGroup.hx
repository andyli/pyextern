...
@:pythonImport("theano.gof.opt", "GraphToGPULocalOptGroup") extern class GraphToGPULocalOptGroup {
	...
	**/
	@:native("__init__")
	public function ___init__(?optimizers:python.VarArgs<Dynamic>, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(?optimizers:python.VarArgs<Dynamic>, ?kwargs:python.KwArgs<Dynamic>):Void;
	/**
	...
	**/
	public function transform(op:Dynamic, context_name:Dynamic, inputs:Dynamic, outputs:Dynamic):Dynamic;
}