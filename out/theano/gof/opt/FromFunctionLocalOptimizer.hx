...
@:pythonImport("theano.gof.opt", "FromFunctionLocalOptimizer") extern class FromFunctionLocalOptimizer {
	...
	**/
	@:native("__init__")
	public function ___init__(fn:Dynamic, ?tracks:Dynamic, ?requirements:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(fn:Dynamic, ?tracks:Dynamic, ?requirements:Dynamic):Void;
	/**
