...
@:pythonImport("theano.gof.opt", "MergeFeature") extern class MergeFeature {
	...
	**/
	...
	public function get_merged_assert_input(node:Dynamic, candidate:Dynamic):Dynamic;
	...
	**/
	public function process_constant(fgraph:Dynamic, c:Dynamic):Dynamic;
	/**
