...
@:pythonImport("theano.gof.opt", "EquilibriumOptimizer") extern class EquilibriumOptimizer {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(optimizers:Dynamic, ?failure_callback:Dynamic, ?ignore_newtrees:Dynamic, ?tracks_on_change_inputs:Dynamic, ?max_use_ratio:Dynamic, ?final_optimizers:Dynamic, ?cleanup_optimizers:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(optimizers:Dynamic, ?failure_callback:Dynamic, ?ignore_newtrees:Dynamic, ?tracks_on_change_inputs:Dynamic, ?max_use_ratio:Dynamic, ?final_optimizers:Dynamic, ?cleanup_optimizers:Dynamic):Void;
	/**
	...
	**/
	...
	public function get_local_optimizers():Dynamic;
