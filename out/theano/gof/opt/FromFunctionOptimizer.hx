...
@:pythonImport("theano.gof.opt", "FromFunctionOptimizer") extern class FromFunctionOptimizer {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(fn:Dynamic, ?requirements:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(fn:Dynamic, ?requirements:Dynamic):Void;
	/**
