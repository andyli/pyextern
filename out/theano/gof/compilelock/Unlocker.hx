...
@:pythonImport("theano.gof.compilelock", "Unlocker") extern class Unlocker {
	...
	**/
	@:native("__init__")
	public function ___init__(tmp_dir:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(tmp_dir:Dynamic):Void;
	/**
	...
	**/
	...
	/**
		...
		their timeout limit).
	**/
	public function unlock(?force:Dynamic):Dynamic;
}