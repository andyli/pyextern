...
@:pythonImport("theano.gof.optdb", "LocalGroupDB") extern class LocalGroupDB {
	...
	**/
	@:native("__init__")
	public function ___init__(?apply_all_opts:Dynamic, ?profile:Dynamic, ?local_opt:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(?apply_all_opts:Dynamic, ?profile:Dynamic, ?local_opt:Dynamic):Void;
	/**
