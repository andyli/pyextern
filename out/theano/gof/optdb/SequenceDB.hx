...
@:pythonImport("theano.gof.optdb", "SequenceDB") extern class SequenceDB {
	...
	**/
	@:native("__init__")
	public function ___init__(?failure_callback:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(?failure_callback:Dynamic):Void;
	/**
	...
	**/
	public function register(name:Dynamic, obj:Dynamic, position:Dynamic, ?tags:python.VarArgs<Dynamic>):Dynamic;
	...
	/**
		...
		sequentially.
	**/
	static public function seq_opt(?opts:python.VarArgs<Dynamic>, ?kw:python.KwArgs<Dynamic>):Dynamic;
}