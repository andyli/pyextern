...
@:pythonImport("theano.gof.optdb", "TopoDB") extern class TopoDB {
	...
	**/
	@:native("__init__")
	public function ___init__(db:Dynamic, ?order:Dynamic, ?ignore_newtrees:Dynamic, ?failure_callback:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(db:Dynamic, ?order:Dynamic, ?ignore_newtrees:Dynamic, ?failure_callback:Dynamic):Void;
	/**
	...
	**/
	public function register(name:Dynamic, obj:Dynamic, ?tags:python.VarArgs<Dynamic>, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
