...
@:pythonImport("theano.gradient", "GradScale") extern class GradScale {
	...
	**/
	@:native("__init__")
	public function ___init__(multiplier:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(multiplier:Dynamic):Void;
	/**
