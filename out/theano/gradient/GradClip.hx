...
@:pythonImport("theano.gradient", "GradClip") extern class GradClip {
	...
	**/
	@:native("__init__")
	public function ___init__(clip_lower_bound:Dynamic, clip_upper_bound:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(clip_lower_bound:Dynamic, clip_upper_bound:Dynamic):Void;
	/**
	...
	**/
	...
	static public var c_code_and_version : Dynamic;
	/**
	...
	**/
	...
	public function grad(args:Dynamic, g_outs:Dynamic):Dynamic;
