...
package theano.misc.ordered_set;
@:pythonImport("theano.misc.ordered_set", "OrderedSet") extern class OrderedSet {
	...
	**/
	@:native("__init__")
	public function ___init__(?iterable:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	...
	**/
	...
	public function difference_update(s:Dynamic):Dynamic;
	/**
		Remove an element.  Do not raise an exception if absent.
	**/
	public function discard(key:Dynamic):Dynamic;
	public function intersection_update(s:Dynamic):Dynamic;
	/**
	...
	**/
	public function pop(?last:Dynamic):Dynamic;
	/**
		Remove an element. If not a member, raise a KeyError.
	**/
	public function remove(value:Dynamic):Dynamic;
	public function union(s:Dynamic):Dynamic;
	public function update(iterable:Dynamic):Dynamic;
}