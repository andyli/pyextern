...
package pyQt5.qtMultimediaWidgets;
@:pythonImport("PyQt5.QtMultimediaWidgets", "QGraphicsVideoItem") extern class QGraphicsVideoItem {
	/**
		int([x]) -> integer
	...
	**/
	public function aspectRatioMode():Dynamic;
	/**
	...
	**/
	public function nativeSize():Dynamic;
	/**
		nativeSizeChanged(self, QSizeF) [signal]
	**/
	public var nativeSizeChanged : Dynamic;
	/**
		objectName(self) -> str
	**/
	...
	**/
	public function setAspectRatioMode(Qt:Dynamic):Void;
	/**
	...
	**/
	public function setOffset(Union:Dynamic):Void;
	/**
