...
package pyQt5.qtQuickWidgets;
@:pythonImport("PyQt5.QtQuickWidgets", "QQuickWidget") extern class QQuickWidget {
	...
	**/
	public function quickWindow():Dynamic;
	/**
		raise_(self)
	**/
	...
	**/
	public function setResizeMode(QQuickWidget:Dynamic):Void;
	/**
