...
@:pythonImport("PyQt5.QtXmlPatterns", "QXmlSchemaValidator") extern class QXmlSchemaValidator {
	...
	**/
	public function setSchema(QXmlSchema:Dynamic):Void;
	/**
	...
	**/
	public function validate(args:haxe.extern.Rest<Dynamic>):Bool;
}