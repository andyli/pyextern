...
package pyQt5.qtSql;
@:pythonImport("PyQt5.QtSql", "QSqlError") extern class QSqlError {
	...
	**/
	public function setDatabaseText(str:String):Void;
	/**
		setDriverText(self, str)
	**/
	public function setDriverText(str:String):Void;
	/**
		setNumber(self, int)
	**/
	public function setNumber(int:Int):Void;
	/**
		setType(self, QSqlError.ErrorType)
	**/
	public function setType(QSqlError:Dynamic):Void;
	/**
		swap(self, QSqlError)
	**/
	public function swap(QSqlError:Dynamic):Void;
	/**
		text(self) -> str
	**/
