...
@:pythonImport("PyQt5.QtNetwork", "QTcpServer") extern class QTcpServer {
	...
	**/
	public function addPendingConnection(QTcpSocket:Dynamic):Void;
	/**
	...
	**/
	public function setSocketDescriptor(sip:Dynamic):Bool;
	/**
