...
@:pythonImport("PyQt5.QtNetwork", "QNetworkCacheMetaData") extern class QNetworkCacheMetaData {
	...
	**/
	public function rawHeaders():Dynamic;
	/**
	...
	**/
	public function setAttributes(Dict:Dynamic):Void;
	/**
	...
	**/
	public function setLastModified(Union:Dynamic):Void;
	/**
		setRawHeaders(self, Iterable[Tuple[Union[QByteArray, bytes, bytearray], Union[QByteArray, bytes, bytearray]]])
	**/
	public function setRawHeaders(Iterable:Dynamic):Void;
	/**
		setSaveToDisk(self, bool)
	**/
	public function setSaveToDisk(bool:Bool):Void;
	/**
		setUrl(self, QUrl)
	**/
	...
	**/
	public function swap(QNetworkCacheMetaData:Dynamic):Void;
	/**
		url(self) -> QUrl
	**/
