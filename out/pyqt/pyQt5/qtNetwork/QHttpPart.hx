...
@:pythonImport("PyQt5.QtNetwork", "QHttpPart") extern class QHttpPart {
	...
	**/
	public function setBody(Union:Dynamic):Void;
	/**
		setBodyDevice(self, QIODevice)
	**/
	public function setBodyDevice(QIODevice:Dynamic):Void;
	/**
	...
	**/
	...
	/**
		swap(self, QHttpPart)
	**/
	public function swap(QHttpPart:Dynamic):Void;
}