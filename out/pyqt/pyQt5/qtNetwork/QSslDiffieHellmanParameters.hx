...
@:pythonImport("PyQt5.QtNetwork", "QSslDiffieHellmanParameters") extern class QSslDiffieHellmanParameters {
	/**
		int([x]) -> integer
	...
	**/
	...
	static public var InvalidInputDataError : Dynamic;
	static public var NoError : Dynamic;
	static public var UnsafeParametersError : Dynamic;
	...
	**/
	static public function defaultParameters():Dynamic;
	/**
	...
	**/
	public function swap(QSslDiffieHellmanParameters:Dynamic):Void;
}