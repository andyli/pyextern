...
@:pythonImport("PyQt5.QtNetwork", "QUdpSocket") extern class QUdpSocket {
	...
	**/
	public function joinMulticastGroup(Union:Dynamic, args:haxe.extern.Rest<Dynamic>):Bool;
	/**
		killTimer(self, int)
	**/
	...
	**/
	public function leaveMulticastGroup(Union:Dynamic, args:haxe.extern.Rest<Dynamic>):Bool;
	/**
	...
	**/
	public function multicastInterface():Dynamic;
	/**
		objectName(self) -> str
	**/
	...
	**/
	public function readDatagram(int:Int):Dynamic;
	/**
	...
	**/
	public function receiveDatagram(?maxSize:Dynamic):Dynamic;
	/**
	...
	**/
	public function setMulticastInterface(QNetworkInterface:Dynamic):Void;
	/**
	...
	**/
	public function writeDatagram(args:haxe.extern.Rest<Dynamic>):Int;
}