...
@:pythonImport("PyQt5.QtNetwork", "QHstsPolicy") extern class QHstsPolicy {
	static public var IncludeSubDomains : Dynamic;
	/**
		int([x]) -> integer
	...
	**/
	static public function PolicyFlags(args:haxe.extern.Rest<Dynamic>):Void;
	...
	**/
	public function expiry():Dynamic;
	/**
	...
	**/
	public function setExpiry(Union:Dynamic):Void;
	/**
	...
	**/
	public function setIncludesSubDomains(bool:Bool):Void;
	/**
		swap(self, QHstsPolicy)
	**/
	public function swap(QHstsPolicy:Dynamic):Void;
}