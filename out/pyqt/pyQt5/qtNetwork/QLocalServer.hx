...
@:pythonImport("PyQt5.QtNetwork", "QLocalServer") extern class QLocalServer {
	...
	**/
	static public function SocketOptions(args:haxe.extern.Rest<Dynamic>):Void;
	...
	**/
	public function incomingConnection(sip:Dynamic):Void;
	/**
	...
	**/
	public function listen(args:haxe.extern.Rest<Dynamic>):Bool;
	/**
	...
	**/
	static public function removeServer(str:String):Bool;
	/**
		sender(self) -> QObject
	**/
	...
	**/
	public function serverError():Dynamic;
	/**
		serverName(self) -> str
	**/
	...
	**/
	public function setSocketOptions(Union:Dynamic):Void;
	/**
	...
	**/
	public function socketOptions():Dynamic;
	/**
	...
	**/
	public function waitForNewConnection(?msecs:Dynamic):Dynamic;
}