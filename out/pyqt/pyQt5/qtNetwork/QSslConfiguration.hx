...
@:pythonImport("PyQt5.QtNetwork", "QSslConfiguration") extern class QSslConfiguration {
	...
	**/
	public function backendConfiguration():Dynamic;
	/**
	...
	**/
	public function diffieHellmanParameters():Dynamic;
	/**
	...
	**/
	public function ephemeralServerKey():Dynamic;
	/**
		isNull(self) -> bool
	**/
	...
	**/
	public function preSharedKeyIdentityHint():Dynamic;
	/**
	...
	**/
	public function setBackendConfiguration(?backendConfiguration:Dynamic):Void;
	/**
		setBackendConfigurationOption(self, Union[QByteArray, bytes, bytearray], Any)
	**/
	public function setBackendConfigurationOption(Union:Dynamic, Any:Dynamic):Void;
	/**
	...
	**/
	public function setDiffieHellmanParameters(QSslDiffieHellmanParameters:Dynamic):Void;
	/**
	...
	**/
	public function setPreSharedKeyIdentityHint(Union:Dynamic):Void;
	/**
