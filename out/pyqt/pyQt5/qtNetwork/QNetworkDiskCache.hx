...
@:pythonImport("PyQt5.QtNetwork", "QNetworkDiskCache") extern class QNetworkDiskCache {
	...
	**/
	public function data(QUrl:Dynamic):Dynamic;
	/**
		deleteLater(self)
	**/
	...
	**/
	public function fileMetaData(str:String):Dynamic;
	/**
	...
	**/
	public function insert(QIODevice:Dynamic):Void;
	/**
	...
	**/
	public function metaData(QUrl:Dynamic):Dynamic;
	/**
	...
	**/
	public function prepare(QNetworkCacheMetaData:Dynamic):Dynamic;
	/**
	...
	**/
	public function remove(QUrl:Dynamic):Bool;
	/**
	...
	**/
	public function setCacheDirectory(str:String):Void;
	/**
		setMaximumCacheSize(self, int)
	**/
	public function setMaximumCacheSize(int:Int):Void;
	/**
	...
	**/
	public function updateMetaData(QNetworkCacheMetaData:Dynamic):Void;
}