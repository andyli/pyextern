...
@:pythonImport("PyQt5.QtNetwork", "QAuthenticator") extern class QAuthenticator {
	...
	**/
	...
	/**
		option(self, str) -> Any
	**/
	public function option(str:String):Dynamic;
	/**
	...
	**/
	public function setOption(str:String, Any:Dynamic):Void;
	/**
