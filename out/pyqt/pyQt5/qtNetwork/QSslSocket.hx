...
@:pythonImport("PyQt5.QtNetwork", "QSslSocket") extern class QSslSocket {
	...
	**/
	public function addCaCertificate(QSslCertificate:Dynamic):Void;
	/**
	...
	**/
	static public function addDefaultCaCertificate(QSslCertificate:Dynamic):Void;
	/**
	...
	**/
	public function connectToHost(str:String, int:Int, ?mode:Dynamic, ?protocol:Dynamic):Void;
	/**
	...
	**/
	public function connectToHostEncrypted(str:String, int:Int, args:haxe.extern.Rest<Dynamic>):Void;
	/**
	...
	**/
	static public function defaultCaCertificates():Dynamic;
	/**
		defaultCiphers() -> List[QSslCipher]
	**/
	static public function defaultCiphers():Dynamic;
	/**
		deleteLater(self)
	**/
	...
	**/
	public var encryptedBytesWritten : Dynamic;
	/**
	...
	**/
	public var modeChanged : Dynamic;
	/**
	...
	**/
	public var peerVerifyError : Dynamic;
	/**
	...
	**/
	...
	/**
		...
		setCiphers(self, str)
	**/
	public function setCiphers(args:haxe.extern.Rest<Dynamic>):Void;
	/**
	...
	**/
	static public function setDefaultCaCertificates(Iterable:Dynamic):Void;
	/**
		setDefaultCiphers(Iterable[QSslCipher])
	**/
	static public function setDefaultCiphers(Iterable:Dynamic):Void;
	/**
	...
	**/
	public function setLocalCertificate(args:haxe.extern.Rest<Dynamic>):Void;
	/**
	...
	**/
	public function setPeerVerifyName(str:String):Void;
	/**
	...
	**/
	public function setPrivateKey(args:haxe.extern.Rest<Dynamic>):Void;
	/**
	...
	**/
	static public function sslLibraryBuildVersionNumber():Int;
	/**
		sslLibraryBuildVersionString() -> str
	**/
	static public function sslLibraryBuildVersionString():String;
	/**
		sslLibraryVersionNumber() -> int
	**/
	static public function sslLibraryVersionNumber():Int;
	/**
		sslLibraryVersionString() -> str
	**/
	static public function sslLibraryVersionString():String;
	/**
		startClientEncryption(self)
	**/
	public function startClientEncryption():Void;
	/**
		startServerEncryption(self)
	**/
	public function startServerEncryption():Void;
	/**
	...
	**/
	...
	/**
		supportsSsl() -> bool
	**/
	static public function supportsSsl():Bool;
	/**
	...
	**/
	public function waitForEncrypted(?msecs:Dynamic):Bool;
	/**
