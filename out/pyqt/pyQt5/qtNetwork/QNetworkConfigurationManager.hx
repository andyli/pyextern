...
@:pythonImport("PyQt5.QtNetwork", "QNetworkConfigurationManager") extern class QNetworkConfigurationManager {
	...
	**/
	public function allConfigurations(?flags:Dynamic):Dynamic;
	/**
	...
	**/
	public var configurationAdded : Dynamic;
	/**
		configurationChanged(self, QNetworkConfiguration) [signal]
	**/
	public var configurationChanged : Dynamic;
	/**
		configurationFromIdentifier(self, str) -> QNetworkConfiguration
	**/
	public function configurationFromIdentifier(str:String):Dynamic;
	/**
		configurationRemoved(self, QNetworkConfiguration) [signal]
	**/
	public var configurationRemoved : Dynamic;
	/**
	...
	**/
	public function defaultConfiguration():Dynamic;
	/**
		deleteLater(self)
	**/
	...
	**/
	public var onlineStateChanged : Dynamic;
	/**
		parent(self) -> QObject
	**/
	...
	**/
	public var updateCompleted : Dynamic;
	/**
