...
@:pythonImport("PyQt5.QtSerialPort", "QSerialPortInfo") extern class QSerialPortInfo {
	...
	**/
	static public function availablePorts():Dynamic;
	/**
	...
	**/
	static public function standardBaudRates():Dynamic;
	/**
		swap(self, QSerialPortInfo)
	**/
	public function swap(QSerialPortInfo:Dynamic):Void;
	/**
