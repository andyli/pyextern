...
@:pythonImport("PyQt5.QtSensors", "QOrientationReading") extern class QOrientationReading {
	static public var FaceDown : Dynamic;
	static public var FaceUp : Dynamic;
	static public var LeftUp : Dynamic;
	/**
		int([x]) -> integer
	...
	**/
	...
	static public var RightUp : Dynamic;
	static public var TopDown : Dynamic;
	static public var TopUp : Dynamic;
	...
	**/
	public function setOrientation(QOrientationReading:Dynamic):Void;
	/**
