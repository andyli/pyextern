...
@:pythonImport("PyQt5.QtSensors", "QCompassReading") extern class QCompassReading {
	...
	**/
	public function setAzimuth(float:Float):Void;
	/**
		setCalibrationLevel(self, float)
	**/
	public function setCalibrationLevel(float:Float):Void;
	/**
