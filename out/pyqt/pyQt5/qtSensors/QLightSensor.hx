...
@:pythonImport("PyQt5.QtSensors", "QLightSensor") extern class QLightSensor {
	...
	**/
	public var fieldOfViewChanged : Dynamic;
	/**
	...
	**/
	public function setFieldOfView(float:Float):Void;
	/**
