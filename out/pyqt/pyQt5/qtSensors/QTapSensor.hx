...
@:pythonImport("PyQt5.QtSensors", "QTapSensor") extern class QTapSensor {
	...
	**/
	public var returnDoubleTapEventsChanged : Dynamic;
	/**
		sender(self) -> QObject
	**/
	...
	**/
	public function setReturnDoubleTapEvents(bool:Bool):Void;
	/**
