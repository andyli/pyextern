...
@:pythonImport("PyQt5.QtSensors", "QTiltReading") extern class QTiltReading {
	...
	**/
	public function setXRotation(float:Float):Void;
	/**
		setYRotation(self, float)
	**/
	public function setYRotation(float:Float):Void;
	/**
