...
@:pythonImport("PyQt5.QtSensors", "QAccelerometer") extern class QAccelerometer {
	/**
		int([x]) -> integer
		...
		4
	**/
	public function AccelerationMode(args:haxe.extern.Rest<Dynamic>):Dynamic;
	...
	**/
	...
	static public var Combined : Dynamic;
	/**
		int([x]) -> integer
		int(x, base=10) -> integer
	...
	**/
	public function accelerationMode():Dynamic;
	/**
		accelerationModeChanged(self, QAccelerometer.AccelerationMode) [signal]
	**/
	public var accelerationModeChanged : Dynamic;
	/**
	...
	**/
	public function setAccelerationMode(QAccelerometer:Dynamic):Void;
	/**
		setActive(self, bool)
	**/
