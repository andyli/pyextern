...
@:pythonImport("PyQt5.QtSensors", "QTapReading") extern class QTapReading {
	/**
		int([x]) -> integer
		...
		4
	**/
	public function TapDirection(args:haxe.extern.Rest<Dynamic>):Dynamic;
	static public var Undefined : Dynamic;
	static public var X : Dynamic;
	static public var X_Both : Dynamic;
	static public var X_Neg : Dynamic;
	static public var X_Pos : Dynamic;
	static public var Y : Dynamic;
	static public var Y_Both : Dynamic;
	static public var Y_Neg : Dynamic;
	static public var Y_Pos : Dynamic;
	static public var Z : Dynamic;
	static public var Z_Both : Dynamic;
	static public var Z_Neg : Dynamic;
	static public var Z_Pos : Dynamic;
	...
	**/
	public function setDoubleTap(bool:Bool):Void;
	/**
	...
	**/
	public function setTapDirection(QTapReading:Dynamic):Void;
	/**
	...
	**/
	public function tapDirection():Dynamic;
	/**
		thread(self) -> QThread
	**/
	...
	**/
	...
	/**
		value(self, int) -> Any
	**/
	public function value(int:Int):Dynamic;
	/**
		valueCount(self) -> int
	**/
