...
@:pythonImport("PyQt5.QtSensors", "QMagnetometer") extern class QMagnetometer {
	...
	**/
	public var returnGeoValuesChanged : Dynamic;
	/**
		sender(self) -> QObject
	**/
	...
	**/
	public function setReturnGeoValues(bool:Bool):Void;
	/**
