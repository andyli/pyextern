...
@:pythonImport("PyQt5.QtSensors", "QLidReading") extern class QLidReading {
	...
	**/
	public var backLidChanged : Dynamic;
	/**
	...
	**/
	public var frontLidChanged : Dynamic;
	/**
	...
	**/
	public function setBackLidClosed(bool:Bool):Void;
	/**
		setFrontLidClosed(self, bool)
	**/
	public function setFrontLidClosed(bool:Bool):Void;
	/**
