...
@:pythonImport("PyQt5.QtSensors", "QAmbientLightReading") extern class QAmbientLightReading {
	...
	/**
		...
		4
	**/
	public function LightLevel(args:haxe.extern.Rest<Dynamic>):Dynamic;
	static public var Sunny : Dynamic;
	static public var Twilight : Dynamic;
	...
	**/
	public function lightLevel():Dynamic;
	/**
	...
	**/
	public function setLightLevel(QAmbientLightReading:Dynamic):Void;
	/**
