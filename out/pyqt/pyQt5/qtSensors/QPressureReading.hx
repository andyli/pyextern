...
@:pythonImport("PyQt5.QtSensors", "QPressureReading") extern class QPressureReading {
	...
	**/
	public function setPressure(float:Float):Void;
	/**
	...
	**/
	public function setTemperature(float:Float):Void;
	/**
