...
@:pythonImport("PyQt5.QtSensors", "QHumidityReading") extern class QHumidityReading {
	...
	**/
	public function setAbsoluteHumidity(float:Float):Void;
	/**
	...
	**/
	public function setRelativeHumidity(float:Float):Void;
	/**
