...
@:pythonImport("PyQt5.QtQuick", "QSGDynamicTexture") extern class QSGDynamicTexture {
	static public var Anisotropy16x : Dynamic;
	static public var Anisotropy2x : Dynamic;
	static public var Anisotropy4x : Dynamic;
	static public var Anisotropy8x : Dynamic;
	/**
		int([x]) -> integer
		...
		4
	**/
	public function AnisotropyLevel(args:haxe.extern.Rest<Dynamic>):Dynamic;
	static public var AnisotropyNone : Dynamic;
	...
	**/
	public function convertToNormalizedSourceRect(QRectF:Dynamic):Dynamic;
	/**
	...
	**/
	public function normalizedTextureSubRect():Dynamic;
	/**
		objectName(self) -> str
	**/
	...
	**/
	public function removedFromAtlas():Dynamic;
	/**
		sender(self) -> QObject
	**/
	...
	**/
	public function updateBindOptions(?force:Dynamic):Void;
	/**
