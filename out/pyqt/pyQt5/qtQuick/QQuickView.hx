...
@:pythonImport("PyQt5.QtQuick", "QQuickView") extern class QQuickView {
	...
	**/
	static public function CreateTextureOptions(args:haxe.extern.Rest<Dynamic>):Void;
	...
	static public var NativeTextRendering : Dynamic;
	...
	static public var QtTextRendering : Dynamic;
	...
	**/
	...
	/**
		...
		4
	**/
	public function TextRenderType(args:haxe.extern.Rest<Dynamic>):Dynamic;
	...
	**/
	public function activeFocusItem():Dynamic;
	/**
		activeFocusItemChanged(self) [signal]
	**/
	public var activeFocusItemChanged : Dynamic;
	/**
		afterAnimating(self) [signal]
	**/
	public var afterAnimating : Dynamic;
	/**
		afterRendering(self) [signal]
	**/
	public var afterRendering : Dynamic;
	/**
		afterSynchronizing(self) [signal]
	**/
	public var afterSynchronizing : Dynamic;
	/**
		alert(self, int)
	**/
	...
	**/
	public var beforeRendering : Dynamic;
	/**
		beforeSynchronizing(self) [signal]
	**/
	public var beforeSynchronizing : Dynamic;
	/**
	...
	**/
	public function contentItem():Dynamic;
	/**
	...
	**/
	public function createImageNode():Dynamic;
	/**
		createRectangleNode(self) -> QSGRectangleNode
	**/
	public function createRectangleNode():Dynamic;
	/**
	...
	**/
	public function createTextureFromId(int:Int, QSize:Dynamic, ?options:Dynamic):Dynamic;
	/**
	...
	**/
	public function createTextureFromImage(QImage:Dynamic, args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
		cursor(self) -> QCursor
	**/
	...
	**/
	public var frameSwapped : Dynamic;
	/**
	...
	**/
	public function grabWindow():Dynamic;
	/**
		hasDefaultAlphaBuffer() -> bool
	**/
	static public function hasDefaultAlphaBuffer():Bool;
	/**
		height(self) -> int
	**/
	...
	**/
	public function initialSize():Dynamic;
	/**
	...
	**/
	public function openglContext():Dynamic;
	/**
		openglContextCreated(self, QOpenGLContext) [signal]
	**/
	public var openglContextCreated : Dynamic;
	/**
		parent(self) -> QWindow
	...
	**/
	public function renderTarget():Dynamic;
	/**
	...
	**/
	public function renderTargetSize():Dynamic;
	/**
		rendererInterface(self) -> QSGRendererInterface
	**/
	public function rendererInterface():Dynamic;
	/**
	...
	**/
	public function rootObject():Dynamic;
	/**
		sceneGraphAboutToStop(self) [signal]
	**/
	public var sceneGraphAboutToStop : Dynamic;
	/**
		sceneGraphBackend() -> str
	**/
	static public function sceneGraphBackend():String;
	/**
		sceneGraphError(self, QQuickWindow.SceneGraphError, str) [signal]
	**/
	public var sceneGraphError : Dynamic;
	/**
		sceneGraphInitialized(self) [signal]
	**/
	public var sceneGraphInitialized : Dynamic;
	/**
		sceneGraphInvalidated(self) [signal]
	**/
	public var sceneGraphInvalidated : Dynamic;
	/**
		scheduleRenderJob(self, QRunnable, QQuickWindow.RenderStage)
	**/
	public function scheduleRenderJob(QRunnable:Dynamic, QQuickWindow:Dynamic):Void;
	/**
		screen(self) -> QScreen
	**/
	...
	**/
	public function sendEvent(QQuickItem:Dynamic, QEvent:Dynamic):Bool;
	/**
		sender(self) -> QObject
	**/
	...
	**/
	public function setClearBeforeRendering(bool:Bool):Void;
	/**
	...
	**/
	static public function setDefaultAlphaBuffer(bool:Bool):Void;
	/**
	...
	**/
	public function setFlag(Qt:Dynamic, ?on:Dynamic):Void;
	/**
	...
	**/
	public function setPersistentOpenGLContext(bool:Bool):Void;
	/**
		setPersistentSceneGraph(self, bool)
	**/
	public function setPersistentSceneGraph(bool:Bool):Void;
	/**
	...
	**/
	public function setRenderTarget(args:haxe.extern.Rest<Dynamic>):Void;
	/**
		setResizeMode(self, QQuickView.ResizeMode)
	**/
	public function setResizeMode(QQuickView:Dynamic):Void;
	/**
		setSceneGraphBackend(QSGRendererInterface.GraphicsApi)
		setSceneGraphBackend(str)
	**/
	static public function setSceneGraphBackend(args:haxe.extern.Rest<Dynamic>):Void;
	/**
	...
	**/
	static public function setTextRenderType(QQuickWindow:Dynamic):Void;
	/**
		setTitle(self, str)
	**/
	...
	**/
	public function setWindowStates(Union:Dynamic):Void;
	/**
		setX(self, int)
	**/
	...
	**/
	static public function textRenderType():Dynamic;
	/**
		thread(self) -> QThread
	**/
	...
	**/
	public function windowStates():Dynamic;
	/**
