...
@:pythonImport("PyQt5.QtQuick", "QQuickRenderControl") extern class QQuickRenderControl {
	...
	**/
	...
	/**
		polishItems(self)
	**/
	public function polishItems():Void;
	/**
		prepareThread(self, QThread)
	**/
	public function prepareThread(QThread:Dynamic):Void;
	/**
	...
	**/
	public var renderRequested : Dynamic;
	/**
		renderWindow(self, QPoint) -> QWindow
	**/
	public function renderWindow(QPoint:Dynamic):Dynamic;
	/**
		renderWindowFor(QQuickWindow, offset: QPoint = None) -> QWindow
	**/
	static public function renderWindowFor(QQuickWindow:Dynamic, ?offset:Dynamic):Dynamic;
	/**
		sceneChanged(self) [signal]
	**/
	public var sceneChanged : Dynamic;
	/**
		sender(self) -> QObject
	**/
