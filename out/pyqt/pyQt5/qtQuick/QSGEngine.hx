...
@:pythonImport("PyQt5.QtQuick", "QSGEngine") extern class QSGEngine {
	/**
		int([x]) -> integer
	...
	**/
	public function createTextureFromImage(QImage:Dynamic, ?options:Dynamic):Dynamic;
	/**
	...
	**/
	public function initialize(QOpenGLContext:Dynamic):Void;
	/**
