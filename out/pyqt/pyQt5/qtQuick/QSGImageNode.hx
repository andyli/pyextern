...
@:pythonImport("PyQt5.QtQuick", "QSGImageNode") extern class QSGImageNode {
	...
	**/
	static public function TextureCoordinatesTransformMode(args:haxe.extern.Rest<Dynamic>):Void;
	...
	**/
	public function material():Dynamic;
	/**
	...
	**/
	public function opaqueMaterial():Dynamic;
	/**
	...
	**/
	static public function rebuildGeometry(QSGGeometry:Dynamic, QSGTexture:Dynamic, QRectF:Dynamic, QRectF:Dynamic, Union:Dynamic):Void;
	/**
		rect(self) -> QRectF
	**/
	...
	**/
	public function setMaterial(QSGMaterial:Dynamic):Void;
	/**
	...
	**/
	public function setOpaqueMaterial(QSGMaterial:Dynamic):Void;
	/**
		setOwnsTexture(self, bool)
	**/
	public function setOwnsTexture(bool:Bool):Void;
	/**
		setRect(self, QRectF)
	...
	**/
	public function setSourceRect(args:haxe.extern.Rest<Dynamic>):Void;
	/**
	...
	**/
	public function setTextureCoordinatesTransform(Union:Dynamic):Void;
	/**
		sourceRect(self) -> QRectF
	**/
	public function sourceRect():Dynamic;
	/**
	...
	**/
	public function textureCoordinatesTransform():Dynamic;
	/**
