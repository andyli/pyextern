...
@:pythonImport("PyQt5.QtQuick", "QQuickPaintedItem") extern class QQuickPaintedItem {
	...
	**/
	static public function PerformanceHints(args:haxe.extern.Rest<Dynamic>):Void;
	/**
		int([x]) -> integer
		int(x, base=10) -> integer
	...
	**/
	...
	/**
		QQuickItem.UpdatePaintNodeData(QQuickItem.UpdatePaintNodeData)
	**/
	static public function UpdatePaintNodeData(QQuickItem:Dynamic):Void;
	...
	**/
	public function containmentMask():Dynamic;
	/**
		containmentMaskChanged(self) [signal]
	**/
	public var containmentMaskChanged : Dynamic;
	/**
	...
	**/
	public function contentsBoundingRect():Dynamic;
	/**
	...
	**/
	public var contentsScaleChanged : Dynamic;
	/**
	...
	**/
	public function fillColor():Dynamic;
	/**
		fillColorChanged(self) [signal]
	**/
	public var fillColorChanged : Dynamic;
	/**
	...
	**/
	public function isAncestorOf(QQuickItem:Dynamic):Bool;
	/**
	...
	**/
	public function mapFromGlobal(Union:Dynamic):Dynamic;
	/**
	...
	**/
	public function mapToGlobal(Union:Dynamic):Dynamic;
	/**
	...
	**/
	...
	/**
		paint(self, QPainter)
	**/
	public function paint(QPainter:Dynamic):Void;
	/**
		parent(self) -> QObject
	**/
	...
	**/
	public function performanceHints():Dynamic;
	/**
		polish(self)
	**/
	...
	**/
	public var renderTargetChanged : Dynamic;
	/**
	...
	**/
	public function resetContentsSize():Void;
	/**
		resetHeight(self)
	**/
	...
	**/
	public function setContainmentMask(QObject:Dynamic):Void;
	/**
		setContentsScale(self, float)
	**/
	public function setContentsScale(float:Float):Void;
	/**
		setContentsSize(self, QSize)
	**/
	public function setContentsSize(QSize:Dynamic):Void;
	/**
	...
	**/
	public function setFillColor(Union:Dynamic):Void;
	/**
	...
	**/
	...
	/**
		setMipmap(self, bool)
	**/
	public function setMipmap(bool:Bool):Void;
	/**
	...
	**/
	public function setOpaquePainting(bool:Bool):Void;
	/**
	...
	**/
	public function setPerformanceHint(QQuickPaintedItem:Dynamic, ?enabled:Dynamic):Void;
	/**
		setPerformanceHints(self, Union[QQuickPaintedItem.PerformanceHints, QQuickPaintedItem.PerformanceHint])
	**/
	public function setPerformanceHints(Union:Dynamic):Void;
	/**
	...
	**/
	public function setRenderTarget(QQuickPaintedItem:Dynamic):Void;
	/**
	...
	**/
	public function setTextureSize(QSize:Dynamic):Void;
	/**
	...
	**/
	public function textureSize():Dynamic;
	/**
		textureSizeChanged(self) [signal]
	**/
	public var textureSizeChanged : Dynamic;
	/**
		thread(self) -> QThread
	**/
	...
	**/
	public function update(?rect:Dynamic):Void;
	/**
