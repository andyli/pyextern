...
@:pythonImport("PyQt5.QtPositioning", "QGeoAreaMonitorSource") extern class QGeoAreaMonitorSource {
	static public var AccessError : Dynamic;
	static public var AnyAreaMonitorFeature : Dynamic;
	/**
		int([x]) -> integer
		...
		4
	**/
	public function AreaMonitorFeature(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	static public function AreaMonitorFeatures(args:haxe.extern.Rest<Dynamic>):Void;
	/**
		int([x]) -> integer
		int(x, base=10) -> integer
	...
	**/
	...
	static public var InsufficientPositionInfo : Dynamic;
	static public var NoError : Dynamic;
	static public var PersistentAreaMonitorFeature : Dynamic;
	...
	**/
	public function activeMonitors(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
		areaEntered(self, QGeoAreaMonitorInfo, QGeoPositionInfo) [signal]
	**/
	public var areaEntered : Dynamic;
	/**
		areaExited(self, QGeoAreaMonitorInfo, QGeoPositionInfo) [signal]
	**/
	public var areaExited : Dynamic;
	/**
	...
	**/
	public var monitorExpired : Dynamic;
	/**
	...
	**/
	public function positionInfoSource():Dynamic;
	/**
	...
	**/
	public function requestUpdate(QGeoAreaMonitorInfo:Dynamic, str:String):Bool;
	/**
		sender(self) -> QObject
	**/
	...
	**/
	public function setPositionInfoSource(QGeoPositionInfoSource:Dynamic):Void;
	/**
	...
	**/
	public function startMonitoring(QGeoAreaMonitorInfo:Dynamic):Bool;
	/**
	...
	**/
	public function stopMonitoring(QGeoAreaMonitorInfo:Dynamic):Bool;
	/**
		supportedAreaMonitorFeatures(self) -> QGeoAreaMonitorSource.AreaMonitorFeatures
	**/
	public function supportedAreaMonitorFeatures():Dynamic;
	/**
		thread(self) -> QThread
	**/
