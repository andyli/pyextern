...
@:pythonImport("PyQt5.QtPositioning", "QGeoAddress") extern class QGeoAddress {
	...
	**/
	public function setCountryCode(str:String):Void;
	/**
		setCounty(self, str)
	**/
	public function setCounty(str:String):Void;
	/**
		setDistrict(self, str)
	**/
	public function setDistrict(str:String):Void;
	/**
		setPostalCode(self, str)
	**/
	public function setPostalCode(str:String):Void;
	/**
		setState(self, str)
	**/
