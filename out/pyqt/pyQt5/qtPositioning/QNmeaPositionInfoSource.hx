...
@:pythonImport("PyQt5.QtPositioning", "QNmeaPositionInfoSource") extern class QNmeaPositionInfoSource {
	static public var AccessError : Dynamic;
	static public var AllPositioningMethods : Dynamic;
	static public var ClosedError : Dynamic;
	/**
		int([x]) -> integer
	...
	**/
	...
	static public var NoPositioningMethods : Dynamic;
	static public var NonSatellitePositioningMethods : Dynamic;
	/**
		int([x]) -> integer
		int(x, base=10) -> integer
		...
		4
	**/
	public function PositioningMethod(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	static public function PositioningMethods(args:haxe.extern.Rest<Dynamic>):Void;
	static public var RealTimeMode : Dynamic;
	static public var SatellitePositioningMethods : Dynamic;
	static public var SimulationMode : Dynamic;
	static public var UnknownSourceError : Dynamic;
	/**
		int([x]) -> integer
		int(x, base=10) -> integer
		...
		4
	**/
	public function UpdateMode(args:haxe.extern.Rest<Dynamic>):Dynamic;
	...
	**/
	static public function availableSources():Dynamic;
	/**
	...
	**/
	static public function createDefaultSource(QObject:Dynamic):Dynamic;
	/**
		createSource(str, QObject) -> QGeoPositionInfoSource
	**/
	static public function createSource(str:String, QObject:Dynamic):Dynamic;
	/**
	...
	**/
	public function lastKnownPosition(?fromSatellitePositioningMethodsOnly:Dynamic):Dynamic;
	/**
	...
	**/
	public function parsePosInfoFromNmeaData(str:String, int:Int, QGeoPositionInfo:Dynamic):Dynamic;
	/**
		positionUpdated(self, QGeoPositionInfo) [signal]
	**/
	public var positionUpdated : Dynamic;
	/**
		preferredPositioningMethods(self) -> QGeoPositionInfoSource.PositioningMethods
	**/
	public function preferredPositioningMethods():Dynamic;
	/**
	...
	**/
	public function requestUpdate(?timeout:Dynamic):Void;
	/**
		sender(self) -> QObject
	**/
	...
	**/
	public function setPreferredPositioningMethods(Union:Dynamic):Void;
	/**
	...
	**/
	public function setUpdateInterval(int:Int):Void;
	/**
		setUserEquivalentRangeError(self, float)
	**/
	public function setUserEquivalentRangeError(float:Float):Void;
	/**
	...
	**/
	public function supportedPositioningMethods():Dynamic;
	/**
		supportedPositioningMethodsChanged(self) [signal]
	**/
	public var supportedPositioningMethodsChanged : Dynamic;
	/**
		thread(self) -> QThread
	**/
	...
	**/
	public function updateMode():Dynamic;
	/**
		updateTimeout(self) [signal]
	**/
	public var updateTimeout : Dynamic;
	/**
