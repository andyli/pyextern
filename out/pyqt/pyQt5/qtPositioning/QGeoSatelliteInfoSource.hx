...
@:pythonImport("PyQt5.QtPositioning", "QGeoSatelliteInfoSource") extern class QGeoSatelliteInfoSource {
	...
	**/
	public var requestTimeout : Dynamic;
	/**
	...
	**/
	public var satellitesInUseUpdated : Dynamic;
	/**
		satellitesInViewUpdated(self, Iterable[QGeoSatelliteInfo]) [signal]
	**/
	public var satellitesInViewUpdated : Dynamic;
	/**
		sender(self) -> QObject
	**/
