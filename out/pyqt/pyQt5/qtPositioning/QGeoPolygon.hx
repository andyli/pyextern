...
@:pythonImport("PyQt5.QtPositioning", "QGeoPolygon") extern class QGeoPolygon {
	...
	**/
	...
	/**
		...
		addHole(self, Any)
	**/
	public function addHole(args:haxe.extern.Rest<Dynamic>):Void;
	/**
	...
	**/
	public function hole(int:Int):Dynamic;
	/**
		holePath(self, int) -> List[QGeoCoordinate]
	**/
	public function holePath(int:Int):Dynamic;
	/**
		holesCount(self) -> int
	**/
	...
	**/
	public function perimeter():Dynamic;
	/**
	...
	**/
	...
	/**
		removeHole(self, int)
	**/
	public function removeHole(int:Int):Void;
	/**
	...
	**/
	public function setPerimeter(Iterable:Dynamic):Void;
	/**
		size(self) -> int
	**/
