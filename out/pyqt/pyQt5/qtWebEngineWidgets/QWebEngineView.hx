...
@:pythonImport("PyQt5.QtWebEngineWidgets", "QWebEngineView") extern class QWebEngineView {
	...
	**/
	public function createWindow(QWebEnginePage:Dynamic):Dynamic;
	/**
	...
	**/
	public function findText(str:String, ?options:Dynamic, ?resultCallback:Dynamic):Void;
	/**
	...
	**/
	...
	/**
		iconUrl(self) -> QUrl
	**/
	public function iconUrl():Dynamic;
	/**
		iconUrlChanged(self, QUrl) [signal]
	**/
	public var iconUrlChanged : Dynamic;
	/**
	...
	**/
	public function pageAction(QWebEnginePage:Dynamic):Dynamic;
	/**
	...
	**/
	public var renderProcessTerminated : Dynamic;
	/**
		repaint(self)
	...
	**/
	public function setPage(QWebEnginePage:Dynamic):Void;
	/**
	...
	**/
	public function triggerPageAction(QWebEnginePage:Dynamic, ?checked:Dynamic):Void;
	/**
