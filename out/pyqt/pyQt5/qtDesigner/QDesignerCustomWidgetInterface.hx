...
@:pythonImport("PyQt5.QtDesigner", "QDesignerCustomWidgetInterface") extern class QDesignerCustomWidgetInterface {
	...
	**/
	public function initialize(QDesignerFormEditorInterface:Dynamic):Void;
	/**
