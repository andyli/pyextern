...
@:pythonImport("PyQt5.QtDesigner", "QExtensionFactory") extern class QExtensionFactory {
	...
	**/
	public function createExtension(QObject:Dynamic, str:String, QObject:Dynamic):Dynamic;
	/**
