...
@:pythonImport("PyQt5.QtDesigner", "QPyDesignerTaskMenuExtension") extern class QPyDesignerTaskMenuExtension {
	...
	**/
	public function preferredEditAction():Dynamic;
	/**
	...
	**/
	public function taskActions():Dynamic;
	/**
		thread(self) -> QThread
	**/
