...
@:pythonImport("PyQt5.QtDesigner", "QDesignerFormEditorInterface") extern class QDesignerFormEditorInterface {
	...
	**/
	public function actionEditor():Dynamic;
	/**
	...
	**/
	public function extensionManager():Dynamic;
	/**
	...
	**/
	public function formWindowManager():Dynamic;
	/**
	...
	**/
	public function objectInspector():Dynamic;
	/**
		objectName(self) -> str
	**/
	...
	**/
	public function propertyEditor():Dynamic;
	/**
	...
	**/
	public function setActionEditor(QDesignerActionEditorInterface:Dynamic):Void;
	/**
		setObjectInspector(self, QDesignerObjectInspectorInterface)
	**/
	public function setObjectInspector(QDesignerObjectInspectorInterface:Dynamic):Void;
	/**
	...
	**/
	public function setPropertyEditor(QDesignerPropertyEditorInterface:Dynamic):Void;
	/**
		setWidgetBox(self, QDesignerWidgetBoxInterface)
	**/
	public function setWidgetBox(QDesignerWidgetBoxInterface:Dynamic):Void;
	/**
	...
	**/
	public function topLevel():Dynamic;
	/**
	...
	**/
	public function widgetBox():Dynamic;
}