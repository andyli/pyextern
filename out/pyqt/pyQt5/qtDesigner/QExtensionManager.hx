...
@:pythonImport("PyQt5.QtDesigner", "QExtensionManager") extern class QExtensionManager {
	...
	**/
	public function registerExtensions(QAbstractExtensionFactory:Dynamic, ?iid:Dynamic):Void;
	/**
	...
	**/
	public function unregisterExtensions(QAbstractExtensionFactory:Dynamic, ?iid:Dynamic):Void;
}