...
@:pythonImport("PyQt5.QtChart", "QHPieModelMapper") extern class QHPieModelMapper {
	...
	**/
	...
	/**
		labelsRowChanged(self) [signal]
	**/
	public var labelsRowChanged : Dynamic;
	/**
	...
	**/
	...
	/**
		setLabelsRow(self, int)
	**/
	public function setLabelsRow(int:Int):Void;
	/**
	...
	**/
	...
	/**
		setValuesRow(self, int)
	**/
	public function setValuesRow(int:Int):Void;
	/**
	...
	**/
	...
	/**
		valuesRowChanged(self) [signal]
	**/
	public var valuesRowChanged : Dynamic;
}