...
@:pythonImport("PyQt5.QtChart", "QVBarModelMapper") extern class QVBarModelMapper {
	...
	**/
	...
	/**
		firstBarSetColumn(self) -> int
	**/
	public function firstBarSetColumn():Int;
	/**
		firstBarSetColumnChanged(self) [signal]
	**/
	public var firstBarSetColumnChanged : Dynamic;
	/**
		firstRow(self) -> int
	**/
	public function firstRow():Int;
	/**
		firstRowChanged(self) [signal]
	**/
	public var firstRowChanged : Dynamic;
	/**
	...
	**/
	...
	/**
		lastBarSetColumn(self) -> int
	**/
	public function lastBarSetColumn():Int;
	/**
		lastBarSetColumnChanged(self) [signal]
	**/
	public var lastBarSetColumnChanged : Dynamic;
	/**
	...
	**/
	...
	/**
		rowCountChanged(self) [signal]
	**/
	public var rowCountChanged : Dynamic;
	/**
		sender(self) -> QObject
	**/
	...
	**/
	...
	/**
		series(self) -> QAbstractBarSeries
	**/
	...
	**/
	...
	/**
		setFirstBarSetColumn(self, int)
	**/
	public function setFirstBarSetColumn(int:Int):Void;
	/**
		setFirstRow(self, int)
	**/
	public function setFirstRow(int:Int):Void;
	/**
		setLastBarSetColumn(self, int)
	**/
	public function setLastBarSetColumn(int:Int):Void;
	/**
	...
	**/
	...
	/**
		setSeries(self, QAbstractBarSeries)
	**/
	public function setSeries(QAbstractBarSeries:Dynamic):Void;
	/**
