...
@:pythonImport("PyQt5.QtChart", "QHXYModelMapper") extern class QHXYModelMapper {
	...
	**/
	...
	/**
		setSeries(self, QXYSeries)
	**/
	public function setSeries(QXYSeries:Dynamic):Void;
	/**
		setXRow(self, int)
	**/
	public function setXRow(int:Int):Void;
	/**
		setYRow(self, int)
	**/
	public function setYRow(int:Int):Void;
	/**
	...
	**/
	...
	/**
		xRowChanged(self) [signal]
	**/
	public var xRowChanged : Dynamic;
	/**
		yRow(self) -> int
	**/
	public function yRow():Int;
	/**
		yRowChanged(self) [signal]
	**/
	public var yRowChanged : Dynamic;
}