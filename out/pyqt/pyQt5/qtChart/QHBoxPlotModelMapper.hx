...
@:pythonImport("PyQt5.QtChart", "QHBoxPlotModelMapper") extern class QHBoxPlotModelMapper {
	...
	**/
	...
	/**
		firstBoxSetRow(self) -> int
	**/
	public function firstBoxSetRow():Int;
	/**
		firstBoxSetRowChanged(self) [signal]
	**/
	public var firstBoxSetRowChanged : Dynamic;
	/**
	...
	**/
	...
	/**
		lastBoxSetRow(self) -> int
	**/
	public function lastBoxSetRow():Int;
	/**
		lastBoxSetRowChanged(self) [signal]
	**/
	public var lastBoxSetRowChanged : Dynamic;
	/**
	...
	**/
	...
	/**
		setFirstBoxSetRow(self, int)
	**/
	public function setFirstBoxSetRow(int:Int):Void;
	/**
		setFirstColumn(self, int)
	**/
	public function setFirstColumn(int:Int):Void;
	/**
		setLastBoxSetRow(self, int)
	**/
	public function setLastBoxSetRow(int:Int):Void;
	/**
