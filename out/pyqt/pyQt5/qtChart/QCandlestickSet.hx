...
@:pythonImport("PyQt5.QtChart", "QCandlestickSet") extern class QCandlestickSet {
	...
	**/
	...
	/**
		closeChanged(self) [signal]
	**/
	public var closeChanged : Dynamic;
	/**
	...
	**/
	...
	/**
		highChanged(self) [signal]
	**/
	public var highChanged : Dynamic;
	/**
	...
	**/
	...
	/**
		lowChanged(self) [signal]
	**/
	public var lowChanged : Dynamic;
	/**
	...
	**/
	...
	/**
		openChanged(self) [signal]
	**/
	public var openChanged : Dynamic;
	/**
		parent(self) -> QObject
	**/
	...
	**/
	...
	/**
		setClose(self, float)
	**/
	public function setClose(float:Float):Void;
	/**
		setHigh(self, float)
	**/
	public function setHigh(float:Float):Void;
	/**
		setLow(self, float)
	**/
	public function setLow(float:Float):Void;
	/**
	...
	**/
	...
	/**
		setOpen(self, float)
	**/
	public function setOpen(float:Float):Void;
	/**
	...
	**/
	...
	/**
		setTimestamp(self, float)
	**/
	public function setTimestamp(float:Float):Void;
	/**
	...
	**/
	...
	/**
		timestampChanged(self) [signal]
	**/
	public var timestampChanged : Dynamic;
	/**
