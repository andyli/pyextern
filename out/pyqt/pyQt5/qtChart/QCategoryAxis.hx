...
@:pythonImport("PyQt5.QtChart", "QCategoryAxis") extern class QCategoryAxis {
	/**
		int([x]) -> integer
		...
		4
	**/
	public function AxisLabelsPosition(args:haxe.extern.Rest<Dynamic>):Dynamic;
	static public var AxisLabelsPositionCenter : Dynamic;
	static public var AxisLabelsPositionOnValue : Dynamic;
	/**
		int([x]) -> integer
		int(x, base=10) -> integer
	...
	**/
	...
	/**
		...
		4
	**/
	public function TickType(args:haxe.extern.Rest<Dynamic>):Dynamic;
	static public var TicksDynamic : Dynamic;
	static public var TicksFixed : Dynamic;
	...
	**/
	...
	/**
		append(self, str, float)
	**/
	public function append(str:String, float:Float):Void;
	/**
		applyNiceNumbers(self)
	**/
	public function applyNiceNumbers():Void;
	/**
		blockSignals(self, bool) -> bool
	**/
	public function blockSignals(bool:Bool):Bool;
	/**
		categoriesChanged(self) [signal]
	**/
	public var categoriesChanged : Dynamic;
	/**
		categoriesLabels(self) -> List[str]
	**/
	public function categoriesLabels():Dynamic;
	/**
	...
	**/
	...
	/**
		endValue(self, str) -> float
	**/
	public function endValue(str:String):Float;
	/**
	...
	**/
	...
	/**
		labelsPosition(self) -> QCategoryAxis.AxisLabelsPosition
	**/
	public function labelsPosition():Dynamic;
	/**
		labelsPositionChanged(self, QCategoryAxis.AxisLabelsPosition) [signal]
	**/
	...
	**/
	...
	/**
		replaceLabel(self, str, str)
	**/
	public function replaceLabel(str:String, str:String):Void;
	/**
	...
	**/
	...
	/**
		setLabelsPosition(self, QCategoryAxis.AxisLabelsPosition)
	**/
	public function setLabelsPosition(QCategoryAxis:Dynamic):Void;
	/**
	...
	**/
	...
	/**
		setStartValue(self, float)
	**/
	public function setStartValue(float:Float):Void;
	/**
		setTickAnchor(self, float)
	**/
	public function setTickAnchor(float:Float):Void;
	/**
		setTickCount(self, int)
	**/
	public function setTickCount(int:Int):Void;
	/**
		setTickInterval(self, float)
	**/
	public function setTickInterval(float:Float):Void;
	/**
		setTickType(self, QValueAxis.TickType)
	**/
	public function setTickType(QValueAxis:Dynamic):Void;
	/**
	...
	**/
	public function startValue(?categoryLabel:Dynamic):Float;
	...
	**/
	public var tickAnchorChanged : Dynamic;
	/**
		tickCount(self) -> int
	**/
	...
	**/
	public var tickIntervalChanged : Dynamic;
	/**
		tickType(self) -> QValueAxis.TickType
	**/
	public function tickType():Dynamic;
	/**
		tickTypeChanged(self, QValueAxis.TickType) [signal]
	**/
	public var tickTypeChanged : Dynamic;
	/**
