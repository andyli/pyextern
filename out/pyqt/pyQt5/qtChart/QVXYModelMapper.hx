...
@:pythonImport("PyQt5.QtChart", "QVXYModelMapper") extern class QVXYModelMapper {
	...
	**/
	...
	/**
		setXColumn(self, int)
	**/
	public function setXColumn(int:Int):Void;
	/**
		setYColumn(self, int)
	**/
	public function setYColumn(int:Int):Void;
	/**
	...
	**/
	...
	/**
		xColumnChanged(self) [signal]
	**/
	public var xColumnChanged : Dynamic;
	/**
		yColumn(self) -> int
	**/
	public function yColumn():Int;
	/**
		yColumnChanged(self) [signal]
	**/
	public var yColumnChanged : Dynamic;
}