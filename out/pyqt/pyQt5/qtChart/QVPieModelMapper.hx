...
@:pythonImport("PyQt5.QtChart", "QVPieModelMapper") extern class QVPieModelMapper {
	...
	**/
	...
	/**
		labelsColumn(self) -> int
	**/
	public function labelsColumn():Int;
	/**
		labelsColumnChanged(self) [signal]
	**/
	public var labelsColumnChanged : Dynamic;
	/**
	...
	**/
	...
	/**
		setLabelsColumn(self, int)
	**/
	public function setLabelsColumn(int:Int):Void;
	/**
	...
	**/
	...
	/**
		setSeries(self, QPieSeries)
	**/
	public function setSeries(QPieSeries:Dynamic):Void;
	/**
		setValuesColumn(self, int)
	**/
	public function setValuesColumn(int:Int):Void;
	/**
	...
	**/
	...
	/**
		valuesColumn(self) -> int
	**/
	public function valuesColumn():Int;
	/**
		valuesColumnChanged(self) [signal]
	**/
	public var valuesColumnChanged : Dynamic;
}