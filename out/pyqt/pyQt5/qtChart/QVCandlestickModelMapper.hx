...
@:pythonImport("PyQt5.QtChart", "QVCandlestickModelMapper") extern class QVCandlestickModelMapper {
	...
	**/
	...
	/**
		closeRowChanged(self) [signal]
	**/
	public var closeRowChanged : Dynamic;
	/**
	...
	**/
	...
	/**
		firstSetColumnChanged(self) [signal]
	**/
	public var firstSetColumnChanged : Dynamic;
	/**
	...
	**/
	...
	/**
		highRowChanged(self) [signal]
	**/
	public var highRowChanged : Dynamic;
	/**
	...
	**/
	...
	/**
		lastSetColumnChanged(self) [signal]
	**/
	public var lastSetColumnChanged : Dynamic;
	/**
	...
	**/
	...
	/**
		lowRowChanged(self) [signal]
	**/
	public var lowRowChanged : Dynamic;
	/**
	...
	**/
	...
	/**
		openRowChanged(self) [signal]
	**/
	public var openRowChanged : Dynamic;
	/**
	...
	**/
	...
	/**
		setCloseRow(self, int)
	**/
	public function setCloseRow(int:Int):Void;
	/**
		setFirstSetColumn(self, int)
	**/
	public function setFirstSetColumn(int:Int):Void;
	/**
	...
	**/
	...
	/**
		setHighRow(self, int)
	**/
	public function setHighRow(int:Int):Void;
	/**
		setLastSetColumn(self, int)
	**/
	public function setLastSetColumn(int:Int):Void;
	/**
	...
	**/
	...
	/**
		setLowRow(self, int)
	**/
	public function setLowRow(int:Int):Void;
	/**
	...
	**/
	...
	/**
		setOpenRow(self, int)
	**/
	public function setOpenRow(int:Int):Void;
	/**
	...
	**/
	...
	/**
		setTimestampRow(self, int)
	**/
	public function setTimestampRow(int:Int):Void;
	/**
	...
	**/
	...
	/**
		timestampRowChanged(self) [signal]
	**/
	public var timestampRowChanged : Dynamic;
	/**
