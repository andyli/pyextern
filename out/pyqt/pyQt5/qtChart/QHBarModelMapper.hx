...
@:pythonImport("PyQt5.QtChart", "QHBarModelMapper") extern class QHBarModelMapper {
	...
	**/
	...
	/**
		columnCountChanged(self) [signal]
	**/
	public var columnCountChanged : Dynamic;
	/**
	...
	**/
	...
	/**
		firstBarSetRow(self) -> int
	**/
	public function firstBarSetRow():Int;
	/**
		firstBarSetRowChanged(self) [signal]
	**/
	public var firstBarSetRowChanged : Dynamic;
	/**
		firstColumn(self) -> int
	**/
	public function firstColumn():Int;
	/**
		firstColumnChanged(self) [signal]
	**/
	public var firstColumnChanged : Dynamic;
	/**
	...
	**/
	...
	/**
		lastBarSetRow(self) -> int
	**/
	public function lastBarSetRow():Int;
	/**
		lastBarSetRowChanged(self) [signal]
	**/
	public var lastBarSetRowChanged : Dynamic;
	/**
	...
	**/
	...
	/**
		setFirstBarSetRow(self, int)
	**/
	public function setFirstBarSetRow(int:Int):Void;
	/**
		setFirstColumn(self, int)
	**/
	public function setFirstColumn(int:Int):Void;
	/**
		setLastBarSetRow(self, int)
	**/
	public function setLastBarSetRow(int:Int):Void;
	/**
