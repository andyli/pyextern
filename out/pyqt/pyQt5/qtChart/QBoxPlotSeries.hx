...
@:pythonImport("PyQt5.QtChart", "QBoxPlotSeries") extern class QBoxPlotSeries {
	/**
		int([x]) -> integer
	...
	**/
	...
	/**
		append(self, QBoxSet) -> bool
		append(self, Iterable[QBoxSet]) -> bool
	**/
	...
	**/
	...
	/**
		boxOutlineVisibilityChanged(self) [signal]
	**/
	public var boxOutlineVisibilityChanged : Dynamic;
	/**
		boxOutlineVisible(self) -> bool
	**/
	public function boxOutlineVisible():Bool;
	/**
		boxSets(self) -> List[QBoxSet]
	**/
	public function boxSets():Dynamic;
	/**
		boxWidth(self) -> float
	**/
	public function boxWidth():Float;
	/**
		boxWidthChanged(self) [signal]
	**/
	public var boxWidthChanged : Dynamic;
	/**
		boxsetsAdded(self, Iterable[QBoxSet]) [signal]
	**/
	public var boxsetsAdded : Dynamic;
	/**
		boxsetsRemoved(self, Iterable[QBoxSet]) [signal]
	**/
	public var boxsetsRemoved : Dynamic;
	/**
		brush(self) -> QBrush
	**/
	...
	**/
	...
	/**
		doubleClicked(self, QBoxSet) [signal]
	**/
	...
	**/
	...
	/**
		hovered(self, bool, QBoxSet) [signal]
	**/
	...
	**/
	...
	/**
		insert(self, int, QBoxSet) -> bool
	**/
	public function insert(int:Int, QBoxSet:Dynamic):Bool;
	/**
	...
	**/
	...
	/**
		released(self, QBoxSet) [signal]
	**/
	public var released : Dynamic;
	/**
		remove(self, QBoxSet) -> bool
	**/
	public function remove(QBoxSet:Dynamic):Bool;
	/**
	...
	**/
	...
	/**
		setBoxOutlineVisible(self, bool)
	**/
	public function setBoxOutlineVisible(bool:Bool):Void;
	/**
		setBoxWidth(self, float)
	**/
	public function setBoxWidth(float:Float):Void;
	/**
	...
	**/
	...
	/**
		take(self, QBoxSet) -> bool
	**/
	public function take(QBoxSet:Dynamic):Bool;
	/**
		thread(self) -> QThread
	**/
