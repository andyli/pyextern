...
@:pythonImport("PyQt5.QtChart", "QPolarChart") extern class QPolarChart {
	static public var AllAnimations : Dynamic;
	/**
		int([x]) -> integer
		...
		4
	**/
	public function AnimationOption(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
		QChart.AnimationOptions()
		QChart.AnimationOptions(Union[QChart.AnimationOptions, QChart.AnimationOption])
		QChart.AnimationOptions(QChart.AnimationOptions)
	**/
	static public function AnimationOptions(args:haxe.extern.Rest<Dynamic>):Void;
	/**
		int([x]) -> integer
		int(x, base=10) -> integer
	...
	**/
	...
	/**
		...
		4
	**/
	public function ChartTheme(args:haxe.extern.Rest<Dynamic>):Dynamic;
	static public var ChartThemeBlueCerulean : Dynamic;
	static public var ChartThemeBlueIcy : Dynamic;
	static public var ChartThemeBlueNcs : Dynamic;
	static public var ChartThemeBrownSand : Dynamic;
	static public var ChartThemeDark : Dynamic;
	static public var ChartThemeHighContrast : Dynamic;
	static public var ChartThemeLight : Dynamic;
	static public var ChartThemeQt : Dynamic;
	/**
		int([x]) -> integer
		int(x, base=10) -> integer
		...
		4
	**/
	public function ChartType(args:haxe.extern.Rest<Dynamic>):Dynamic;
	static public var ChartTypeCartesian : Dynamic;
	static public var ChartTypePolar : Dynamic;
	static public var ChartTypeUndefined : Dynamic;
	...
	**/
	static public function GraphicsItemFlags(args:haxe.extern.Rest<Dynamic>):Void;
	static public var GridAxisAnimations : Dynamic;
	...
	static public var NoAnimation : Dynamic;
	...
	**/
	...
	/**
		...
		4
	**/
	public function PolarOrientation(args:haxe.extern.Rest<Dynamic>):Dynamic;
	static public var PolarOrientationAngular : Dynamic;
	static public var PolarOrientationRadial : Dynamic;
	/**
		QPolarChart.PolarOrientations()
		QPolarChart.PolarOrientations(Union[QPolarChart.PolarOrientations, QPolarChart.PolarOrientation])
		QPolarChart.PolarOrientations(QPolarChart.PolarOrientations)
	**/
	static public function PolarOrientations(args:haxe.extern.Rest<Dynamic>):Void;
	static public var SceneModal : Dynamic;
	static public var SeriesAnimations : Dynamic;
	...
	**/
	...
	/**
		addAxis(self, QAbstractAxis, QPolarChart.PolarOrientation)
	**/
	public function addAxis(QAbstractAxis:Dynamic, QPolarChart:Dynamic):Void;
	/**
		addSeries(self, QAbstractSeries)
	**/
	public function addSeries(QAbstractSeries:Dynamic):Void;
	/**
		adjustSize(self)
	**/
	...
	/**
		advance(self, int)
	**/
	public function advance(int:Int):Void;
	/**
	...
	**/
	public function animationEasingCurve():Dynamic;
	/**
		animationOptions(self) -> QChart.AnimationOptions
	**/
	public function animationOptions():Dynamic;
	/**
		autoFillBackground(self) -> bool
	**/
	public function autoFillBackground():Bool;
	/**
		axes(self, polarOrientation: QPolarChart.PolarOrientations = QFlags&lt;QtCharts.QPolarChart.PolarOrientation&gt;(QFlag(3)), series: QAbstractSeries = None) -> List[QAbstractAxis]
	**/
	public function axes(?polarOrientation:Dynamic, ?series:Dynamic):Dynamic;
	/**
		axisPolarOrientation(QAbstractAxis) -> QPolarChart.PolarOrientation
	**/
	static public function axisPolarOrientation(QAbstractAxis:Dynamic):Dynamic;
	/**
		axisX(self, series: QAbstractSeries = None) -> QAbstractAxis
	**/
	public function axisX(?series:Dynamic):Dynamic;
	/**
		axisY(self, series: QAbstractSeries = None) -> QAbstractAxis
	**/
	public function axisY(?series:Dynamic):Dynamic;
	/**
	...
	**/
	public function backgroundPen():Dynamic;
	/**
	...
	**/
	public function boundingRegion(QTransform:Dynamic):Dynamic;
	/**
	...
	**/
	public function cacheMode():Dynamic;
	/**
	...
	**/
	public function chartType():Dynamic;
	/**
	...
	**/
	public function childrenBoundingRect():Dynamic;
	/**
		clearFocus(self)
	**/
	...
	**/
	public function collidesWithItem(QGraphicsItem:Dynamic, ?mode:Dynamic):Bool;
	/**
		collidesWithPath(self, QPainterPath, mode: Qt.ItemSelectionMode = Qt.IntersectsItemShape) -> bool
	**/
	public function collidesWithPath(QPainterPath:Dynamic, ?mode:Dynamic):Bool;
	/**
		collidingItems(self, mode: Qt.ItemSelectionMode = Qt.IntersectsItemShape) -> List[QGraphicsItem]
	**/
	public function collidingItems(?mode:Dynamic):Dynamic;
	/**
		commonAncestorItem(self, QGraphicsItem) -> QGraphicsItem
	**/
	public function commonAncestorItem(QGraphicsItem:Dynamic):Dynamic;
	/**
	...
	**/
	public function createDefaultAxes():Void;
	/**
		cursor(self) -> QCursor
	**/
	...
	**/
	public function deviceTransform(QTransform:Dynamic):Dynamic;
	/**
		disconnect(self)
	**/
	...
	**/
	public var enabledChanged : Dynamic;
	/**
	...
	**/
	public function ensureVisible(args:haxe.extern.Rest<Dynamic>):Void;
	/**
	...
	**/
	public function getWindowFrameMargins():Dynamic;
	/**
	...
	**/
	public function grabKeyboardEvent(QEvent:Dynamic):Void;
	/**
		grabMouse(self)
	**/
	...
	**/
	public function grabMouseEvent(QEvent:Dynamic):Void;
	/**
	...
	**/
	public function hoverEnterEvent(QGraphicsSceneHoverEvent:Dynamic):Void;
	/**
		hoverLeaveEvent(self, QGraphicsSceneHoverEvent)
	**/
	public function hoverLeaveEvent(QGraphicsSceneHoverEvent:Dynamic):Void;
	/**
		hoverMoveEvent(self, QGraphicsSceneHoverEvent)
	**/
	public function hoverMoveEvent(QGraphicsSceneHoverEvent:Dynamic):Void;
	/**
	...
	**/
	public function initStyleOption(QStyleOption:Dynamic):Void;
	/**
	...
	**/
	public function installSceneEventFilter(QGraphicsItem:Dynamic):Void;
	/**
		isActive(self) -> bool
	**/
	...
	**/
	public function isAncestorOf(QGraphicsItem:Dynamic):Bool;
	/**
	...
	**/
	public function isBlockedByModalPanel():Dynamic;
	/**
		isClipped(self) -> bool
	**/
	...
	**/
	public function isObscured(args:haxe.extern.Rest<Dynamic>):Bool;
	/**
		isObscuredBy(self, QGraphicsItem) -> bool
	**/
	public function isObscuredBy(QGraphicsItem:Dynamic):Bool;
	/**
		isPanel(self) -> bool
	**/
	...
	**/
	public function isVisibleTo(QGraphicsItem:Dynamic):Bool;
	/**
		isWidget(self) -> bool
	**/
	...
	**/
	public function itemChange(QGraphicsItem:Dynamic, Any:Dynamic):Dynamic;
	/**
		itemTransform(self, QGraphicsItem) -> Tuple[QTransform, bool]
	**/
	public function itemTransform(QGraphicsItem:Dynamic):Dynamic;
	/**
	...
	**/
	...
	/**
		legend(self) -> QLegend
	**/
	public function legend():Dynamic;
	/**
		locale(self) -> QLocale
	**/
	...
	**/
	public function mapFromItem(QGraphicsItem:Dynamic, args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	public function mapRectFromItem(QGraphicsItem:Dynamic, args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	public function mapRectToItem(QGraphicsItem:Dynamic, args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	public function mapToItem(QGraphicsItem:Dynamic, args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	public function mapToPosition(Union:Dynamic, ?series:Dynamic):Dynamic;
	/**
	...
	**/
	public function mapToValue(Union:Dynamic, ?series:Dynamic):Dynamic;
	/**
		margins(self) -> QMargins
	**/
	public function margins():Dynamic;
	/**
	...
	**/
	public function moveBy(float:Float, float:Float):Void;
	/**
		moveEvent(self, QGraphicsSceneMoveEvent)
	**/
	public function moveEvent(QGraphicsSceneMoveEvent:Dynamic):Void;
	/**
	...
	**/
	public function opaqueArea():Dynamic;
	/**
	...
	**/
	public function paint(QPainter:Dynamic, QStyleOptionGraphicsItem:Dynamic, ?widget:Dynamic):Void;
	/**
		paintWindowFrame(self, QPainter, QStyleOptionGraphicsItem, widget: QWidget = None)
	**/
	public function paintWindowFrame(QPainter:Dynamic, QStyleOptionGraphicsItem:Dynamic, ?widget:Dynamic):Void;
	/**
	...
	**/
	public function panel():Dynamic;
	/**
		panelModality(self) -> QGraphicsItem.PanelModality
	**/
	public function panelModality():Dynamic;
	/**
		parent(self) -> QObject
	**/
	...
	**/
	public var parentChanged : Dynamic;
	/**
	...
	**/
	public function parentObject():Dynamic;
	/**
	...
	**/
	public function plotArea():Dynamic;
	/**
		plotAreaBackgroundBrush(self) -> QBrush
	**/
	public function plotAreaBackgroundBrush():Dynamic;
	/**
		plotAreaBackgroundPen(self) -> QPen
	**/
	public function plotAreaBackgroundPen():Dynamic;
	/**
		plotAreaChanged(self, QRectF) [signal]
	**/
	public var plotAreaChanged : Dynamic;
	/**
		polishEvent(self)
	**/
	public function polishEvent():Void;
	/**
		pos(self) -> QPointF
	**/
	...
	**/
	public function prepareGeometryChange():Void;
	/**
	...
	**/
	public function removeAxis(QAbstractAxis:Dynamic):Void;
	/**
	...
	**/
	public function removeSceneEventFilter(QGraphicsItem:Dynamic):Void;
	/**
		removeSeries(self, QAbstractSeries)
	**/
	public function removeSeries(QAbstractSeries:Dynamic):Void;
	/**
		resetTransform(self)
	**/
	...
	**/
	public function resizeEvent(QGraphicsSceneResizeEvent:Dynamic):Void;
	/**
		rotation(self) -> float
	**/
	...
	**/
	public var rotationChanged : Dynamic;
	/**
		scale(self) -> float
	**/
	...
	**/
	public var scaleChanged : Dynamic;
	/**
		scene(self) -> QGraphicsScene
	**/
	public function scene():Dynamic;
	/**
		sceneBoundingRect(self) -> QRectF
	**/
	public function sceneBoundingRect():Dynamic;
	/**
		sceneEvent(self, QEvent) -> bool
	**/
	public function sceneEvent(QEvent:Dynamic):Bool;
	/**
		sceneEventFilter(self, QGraphicsItem, QEvent) -> bool
	**/
	public function sceneEventFilter(QGraphicsItem:Dynamic, QEvent:Dynamic):Bool;
	/**
		scenePos(self) -> QPointF
	**/
	public function scenePos():Dynamic;
	/**
		sceneTransform(self) -> QTransform
	**/
	public function sceneTransform():Dynamic;
	/**
		scroll(self, float, float)
	**/
	public function scroll(float:Float, float:Float):Void;
	/**
		sender(self) -> QObject
	**/
	...
	**/
	public function setAcceptTouchEvents(bool:Bool):Void;
	/**
	...
	**/
	public function setAnimationDuration(int:Int):Void;
	/**
		setAnimationEasingCurve(self, Union[QEasingCurve, QEasingCurve.Type])
	**/
	public function setAnimationEasingCurve(Union:Dynamic):Void;
	/**
		setAnimationOptions(self, Union[QChart.AnimationOptions, QChart.AnimationOption])
	**/
	public function setAnimationOptions(Union:Dynamic):Void;
	/**
	...
	**/
	public function setAxisX(QAbstractAxis:Dynamic, ?series:Dynamic):Void;
	/**
		setAxisY(self, QAbstractAxis, series: QAbstractSeries = None)
	**/
	public function setAxisY(QAbstractAxis:Dynamic, ?series:Dynamic):Void;
	/**
	...
	**/
	public function setBackgroundPen(Union:Dynamic):Void;
	/**
		setBackgroundRoundness(self, float)
	**/
	public function setBackgroundRoundness(float:Float):Void;
	/**
		setBackgroundVisible(self, visible: bool = True)
	**/
	public function setBackgroundVisible(?visible:Dynamic):Void;
	/**
		setBoundingRegionGranularity(self, float)
	**/
	public function setBoundingRegionGranularity(float:Float):Void;
	/**
		setCacheMode(self, QGraphicsItem.CacheMode, logicalCacheSize: QSize = QSize())
	**/
	public function setCacheMode(QGraphicsItem:Dynamic, ?logicalCacheSize:Dynamic):Void;
	/**
	...
	**/
	public function setDropShadowEnabled(?enabled:Dynamic):Void;
	/**
	...
	**/
	public function setFiltersChildEvents(bool:Bool):Void;
	/**
		setFlag(self, QGraphicsItem.GraphicsItemFlag, enabled: bool = True)
	**/
	public function setFlag(QGraphicsItem:Dynamic, ?enabled:Dynamic):Void;
	/**
	...
	**/
	public function setFocusProxy(QGraphicsItem:Dynamic):Void;
	/**
		setFont(self, QFont)
	**/
	...
	**/
	public function setGroup(QGraphicsItemGroup:Dynamic):Void;
	/**
	...
	**/
	public function setLayout(QGraphicsLayout:Dynamic):Void;
	/**
	...
	**/
	public function setLocalizeNumbers(bool:Bool):Void;
	/**
		setMargins(self, QMargins)
	**/
	public function setMargins(QMargins:Dynamic):Void;
	/**
	...
	**/
	public function setPanelModality(QGraphicsItem:Dynamic):Void;
	/**
	...
	**/
	public function setParentItem(QGraphicsItem:Dynamic):Void;
	/**
	...
	**/
	public function setPlotArea(QRectF:Dynamic):Void;
	/**
		setPlotAreaBackgroundBrush(self, Union[QBrush, QColor, Qt.GlobalColor, QGradient])
	**/
	public function setPlotAreaBackgroundBrush(Union:Dynamic):Void;
	/**
		setPlotAreaBackgroundPen(self, Union[QPen, QColor, Qt.GlobalColor, QGradient])
	**/
	public function setPlotAreaBackgroundPen(Union:Dynamic):Void;
	/**
		setPlotAreaBackgroundVisible(self, visible: bool = True)
	**/
	public function setPlotAreaBackgroundVisible(?visible:Dynamic):Void;
	/**
		setPos(self, Union[QPointF, QPoint])
		setPos(self, float, float)
	**/
	public function setPos(args:haxe.extern.Rest<Dynamic>):Void;
	/**
	...
	**/
	static public function setTabOrder(QGraphicsWidget:Dynamic, QGraphicsWidget:Dynamic):Void;
	/**
		setTheme(self, QChart.ChartTheme)
	**/
	public function setTheme(QChart:Dynamic):Void;
	/**
		setTitle(self, str)
	**/
	...
	**/
	public function setTransformOriginPoint(args:haxe.extern.Rest<Dynamic>):Void;
	/**
		setTransformations(self, Iterable[QGraphicsTransform])
	**/
	public function setTransformations(Iterable:Dynamic):Void;
	/**
	...
	**/
	public function setWindowFrameMargins(float:Float, float:Float, float:Float, float:Float):Void;
	/**
	...
	**/
	public function setZValue(float:Float):Void;
	/**
		shape(self) -> QPainterPath
	**/
	public function shape():Dynamic;
	/**
		show(self)
	**/
	...
	**/
	public function stackBefore(QGraphicsItem:Dynamic):Void;
	/**
	...
	**/
	public function toGraphicsObject():Dynamic;
	/**
		toolTip(self) -> str
	**/
	...
	**/
	public function topLevelItem():Dynamic;
	/**
		topLevelWidget(self) -> QGraphicsWidget
	**/
	public function topLevelWidget():Dynamic;
	/**
	...
	**/
	public function transformOriginPoint():Dynamic;
	/**
		transformations(self) -> List[QGraphicsTransform]
	**/
	public function transformations():Dynamic;
	/**
		type(self) -> int
	**/
	...
	**/
	...
	/**
		ungrabKeyboard(self)
	**/
	public function ungrabKeyboard():Void;
	/**
		ungrabKeyboardEvent(self, QEvent)
	**/
	public function ungrabKeyboardEvent(QEvent:Dynamic):Void;
	/**
		ungrabMouse(self)
	**/
	...
	**/
	public function ungrabMouseEvent(QEvent:Dynamic):Void;
	/**
		unsetCursor(self)
	**/
	...
	**/
	public function unsetWindowFrameMargins():Void;
	/**
	...
	**/
	public function windowFrameEvent(QEvent:Dynamic):Bool;
	/**
		windowFrameGeometry(self) -> QRectF
	**/
	public function windowFrameGeometry():Dynamic;
	/**
		windowFrameRect(self) -> QRectF
	**/
	public function windowFrameRect():Dynamic;
	/**
		windowFrameSectionAt(self, Union[QPointF, QPoint]) -> Qt.WindowFrameSection
	**/
	public function windowFrameSectionAt(Union:Dynamic):Dynamic;
	/**
	...
	**/
	...
	/**
		zoom(self, float)
	**/
	public function zoom(float:Float):Void;
	/**
		zoomIn(self)
		zoomIn(self, QRectF)
	**/
	public function zoomIn(args:haxe.extern.Rest<Dynamic>):Void;
	/**
		zoomOut(self)
	**/
