...
@:pythonImport("PyQt5.QtChart", "QBarCategoryAxis") extern class QBarCategoryAxis {
	/**
		int([x]) -> integer
	...
	**/
	...
	/**
		insert(self, int, str)
	**/
	public function insert(int:Int, str:String):Void;
	/**
	...
	**/
	...
	/**
		rangeChanged(self, str, str) [signal]
	**/
	...
	**/
	...
	/**
		replace(self, str, str)
	**/
	public function replace(str:String, str:String):Void;
	/**
	...
	**/
	...
	/**
		setCategories(self, Iterable[str])
	**/
	...
	**/
	...
	/**
		setMax(self, str)
	**/
	public function setMax(str:String):Void;
	/**
		setMin(self, str)
	**/
	public function setMin(str:String):Void;
	/**
	...
	**/
	...
	/**
		setRange(self, str, str)
	**/
	public function setRange(str:String, str:String):Void;
	/**
