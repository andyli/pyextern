...
@:pythonImport("PyQt5.QtChart", "QAbstractAxis") extern class QAbstractAxis {
	/**
		int([x]) -> integer
	...
	**/
	...
	/**
		setMax(self, Any)
	**/
	public function setMax(Any:Dynamic):Void;
	/**
		setMin(self, Any)
	**/
	public function setMin(Any:Dynamic):Void;
	/**
	...
	**/
	...
	/**
		setRange(self, Any, Any)
	**/
	public function setRange(Any:Dynamic, Any:Dynamic):Void;
	/**
