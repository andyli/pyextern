...
@:pythonImport("PyQt5.QtChart", "QScatterSeries") extern class QScatterSeries {
	/**
		int([x]) -> integer
	...
	**/
	...
	/**
		append(self, float, float)
		append(self, Union[QPointF, QPoint])
		append(self, Iterable[Union[QPointF, QPoint]])
	**/
	...
	**/
	...
	/**
		markerShape(self) -> QScatterSeries.MarkerShape
	**/
	public function markerShape():Dynamic;
	/**
		markerShapeChanged(self, QScatterSeries.MarkerShape) [signal]
	**/
	...
	**/
	...
	/**
		markerSizeChanged(self, float) [signal]
	**/
	public var markerSizeChanged : Dynamic;
	/**
	...
	**/
	public var pointLabelsClippingChanged : Dynamic;
	/**
		pointLabelsColor(self) -> QColor
	**/
	public function pointLabelsColor():Dynamic;
	/**
		pointLabelsColorChanged(self, Union[QColor, Qt.GlobalColor, QGradient]) [signal]
	**/
	public var pointLabelsColorChanged : Dynamic;
	/**
		pointLabelsFont(self) -> QFont
	**/
	public function pointLabelsFont():Dynamic;
	/**
		pointLabelsFontChanged(self, QFont) [signal]
	**/
	public var pointLabelsFontChanged : Dynamic;
	/**
	...
	**/
	public var pointLabelsFormatChanged : Dynamic;
	/**
		pointLabelsVisibilityChanged(self, bool) [signal]
	**/
	public var pointLabelsVisibilityChanged : Dynamic;
	/**
	...
	**/
	public var pointRemoved : Dynamic;
	/**
		pointReplaced(self, int) [signal]
	**/
	public var pointReplaced : Dynamic;
	/**
		pointsRemoved(self, int, int) [signal]
	**/
	public var pointsRemoved : Dynamic;
	/**
		pointsReplaced(self) [signal]
	**/
	public var pointsReplaced : Dynamic;
	/**
		pointsVector(self) -> List[QPointF]
	**/
	public function pointsVector():Dynamic;
	/**
	...
	**/
	...
	/**
		remove(self, float, float)
		remove(self, Union[QPointF, QPoint])
		remove(self, int)
	**/
	public function remove(args:haxe.extern.Rest<Dynamic>):Void;
	/**
		removeEventFilter(self, QObject)
	**/
	public function removeEventFilter(QObject:Dynamic):Void;
	/**
		removePoints(self, int, int)
	**/
	public function removePoints(int:Int, int:Int):Void;
	/**
		replace(self, float, float, float, float)
		replace(self, Union[QPointF, QPoint], Union[QPointF, QPoint])
		replace(self, Iterable[Union[QPointF, QPoint]])
		replace(self, int, float, float)
	...
	**/
	...
	/**
		setMarkerShape(self, QScatterSeries.MarkerShape)
	**/
	public function setMarkerShape(QScatterSeries:Dynamic):Void;
	/**
		setMarkerSize(self, float)
	**/
	public function setMarkerSize(float:Float):Void;
	/**
		setName(self, str)
	**/
	...
	**/
	...
	/**
		setPen(self, Union[QPen, QColor, Qt.GlobalColor])
	**/
	public function setPen(Union:Dynamic):Void;
	/**
		setPointLabelsClipping(self, enable: bool = True)
	**/
	public function setPointLabelsClipping(?enable:Dynamic):Void;
	/**
		setPointLabelsColor(self, Union[QColor, Qt.GlobalColor, QGradient])
	**/
	public function setPointLabelsColor(Union:Dynamic):Void;
	/**
		setPointLabelsFont(self, QFont)
	**/
	public function setPointLabelsFont(QFont:Dynamic):Void;
	/**
		setPointLabelsFormat(self, str)
	**/
	public function setPointLabelsFormat(str:String):Void;
	/**
		setPointLabelsVisible(self, visible: bool = True)
	**/
	public function setPointLabelsVisible(?visible:Dynamic):Void;
	/**
		setPointsVisible(self, visible: bool = True)
	**/
	public function setPointsVisible(?visible:Dynamic):Void;
	/**
