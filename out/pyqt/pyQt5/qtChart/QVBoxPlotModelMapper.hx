...
@:pythonImport("PyQt5.QtChart", "QVBoxPlotModelMapper") extern class QVBoxPlotModelMapper {
	...
	**/
	...
	/**
		firstBoxSetColumn(self) -> int
	**/
	public function firstBoxSetColumn():Int;
	/**
		firstBoxSetColumnChanged(self) [signal]
	**/
	public var firstBoxSetColumnChanged : Dynamic;
	/**
		firstRow(self) -> int
	**/
	...
	**/
	...
	/**
		lastBoxSetColumn(self) -> int
	**/
	public function lastBoxSetColumn():Int;
	/**
		lastBoxSetColumnChanged(self) [signal]
	**/
	public var lastBoxSetColumnChanged : Dynamic;
	/**
	...
	**/
	...
	/**
		setFirstBoxSetColumn(self, int)
	**/
	public function setFirstBoxSetColumn(int:Int):Void;
	/**
		setFirstRow(self, int)
	**/
	public function setFirstRow(int:Int):Void;
	/**
		setLastBoxSetColumn(self, int)
	**/
	public function setLastBoxSetColumn(int:Int):Void;
	/**
	...
	**/
	...
	/**
		setSeries(self, QBoxPlotSeries)
	**/
	public function setSeries(QBoxPlotSeries:Dynamic):Void;
	/**
