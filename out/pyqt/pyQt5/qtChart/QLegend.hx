...
@:pythonImport("PyQt5.QtChart", "QLegend") extern class QLegend {
	/**
		int([x]) -> integer
	...
	**/
	...
	/**
		...
		4
	**/
	public function MarkerShape(args:haxe.extern.Rest<Dynamic>):Dynamic;
	static public var MarkerShapeCircle : Dynamic;
	static public var MarkerShapeDefault : Dynamic;
	static public var MarkerShapeFromSeries : Dynamic;
	static public var MarkerShapeRectangle : Dynamic;
	...
	**/
	...
	/**
		attachToChart(self)
	**/
	public function attachToChart():Void;
	/**
		autoFillBackground(self) -> bool
	**/
	public function autoFillBackground():Bool;
	/**
		backgroundVisibleChanged(self, bool) [signal]
	**/
	public var backgroundVisibleChanged : Dynamic;
	/**
	...
	**/
	...
	/**
		detachFromChart(self)
	**/
	public function detachFromChart():Void;
	/**
	...
	**/
	public var fontChanged : Dynamic;
	/**
	...
	**/
	...
	/**
		markerShape(self) -> QLegend.MarkerShape
	**/
	public function markerShape():Dynamic;
	/**
		markerShapeChanged(self, QLegend.MarkerShape) [signal]
	**/
	public var markerShapeChanged : Dynamic;
	/**
		markers(self, series: QAbstractSeries = None) -> List[QLegendMarker]
	**/
	public function markers(?series:Dynamic):Dynamic;
	/**
	...
	**/
	...
	/**
		reverseMarkers(self) -> bool
	**/
	public function reverseMarkers():Bool;
	/**
		reverseMarkersChanged(self, bool) [signal]
	**/
	public var reverseMarkersChanged : Dynamic;
	/**
		rotation(self) -> float
	**/
	...
	**/
	public function scroll(float:Float, float:Float, ?rect:Dynamic):Void;
	/**
		sender(self) -> QObject
	**/
	...
	**/
	...
	/**
		setMarkerShape(self, QLegend.MarkerShape)
	**/
	public function setMarkerShape(QLegend:Dynamic):Void;
	/**
	...
	**/
	...
	/**
		setReverseMarkers(self, reverseMarkers: bool = True)
	**/
	public function setReverseMarkers(?reverseMarkers:Dynamic):Void;
	/**
	...
	**/
	...
	/**
		setShowToolTips(self, bool)
	**/
	public function setShowToolTips(bool:Bool):Void;
	/**
	...
	**/
	...
	/**
		showToolTips(self) -> bool
	**/
	public function showToolTips():Bool;
	/**
		showToolTipsChanged(self, bool) [signal]
	**/
	public var showToolTipsChanged : Dynamic;
	/**
