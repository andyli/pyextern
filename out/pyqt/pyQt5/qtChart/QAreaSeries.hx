...
@:pythonImport("PyQt5.QtChart", "QAreaSeries") extern class QAreaSeries {
	/**
		int([x]) -> integer
	...
	**/
	public function lowerSeries():Dynamic;
	/**
	...
	**/
	public function setLowerSeries(QLineSeries:Dynamic):Void;
	/**
		setName(self, str)
	**/
	...
	**/
	public function setUpperSeries(QLineSeries:Dynamic):Void;
	/**
	...
	**/
	public function upperSeries():Dynamic;
	/**
		useOpenGL(self) -> bool
	**/
