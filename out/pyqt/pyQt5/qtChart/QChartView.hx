...
@:pythonImport("PyQt5.QtChart", "QChartView") extern class QChartView {
	...
	**/
	static public function CacheMode(args:haxe.extern.Rest<Dynamic>):Void;
	/**
		int([x]) -> integer
	...
	**/
	...
	static public var HorizontalRubberBand : Dynamic;
	...
	static public var NoRubberBand : Dynamic;
	...
	**/
	static public function OptimizationFlags(args:haxe.extern.Rest<Dynamic>):Void;
	/**
		int([x]) -> integer
		int(x, base=10) -> integer
	...
	**/
	...
	static public var RectangleRubberBand : Dynamic;
	/**
		int([x]) -> integer
		int(x, base=10) -> integer
	...
	**/
	...
	/**
		...
		4
	**/
	public function RubberBand(args:haxe.extern.Rest<Dynamic>):Dynamic;
	static public var RubberBandDrag : Dynamic;
	/**
		QChartView.RubberBands()
		QChartView.RubberBands(Union[QChartView.RubberBands, QChartView.RubberBand])
		QChartView.RubberBands(QChartView.RubberBands)
	**/
	static public function RubberBands(args:haxe.extern.Rest<Dynamic>):Void;
	...
	**/
	...
	static public var VerticalRubberBand : Dynamic;
	/**
		int([x]) -> integer
		int(x, base=10) -> integer
	...
	**/
	public function centerOn(args:haxe.extern.Rest<Dynamic>):Void;
	/**
	...
	**/
	public function dragMode():Dynamic;
	/**
	...
	**/
	public function fitInView(args:haxe.extern.Rest<Dynamic>):Void;
	/**
	...
	**/
	public function invalidateScene(?rect:Dynamic, ?layers:Dynamic):Void;
	/**
	...
	**/
	public function optimizationFlags():Dynamic;
	/**
	...
	**/
	public function resetCachedContent():Void;
	/**
		resetTransform(self)
	**/
	...
	**/
	public function resizeAnchor():Dynamic;
	/**
	...
	**/
	public function rubberBand():Dynamic;
	/**
		rubberBandChanged(self, QRect, Union[QPointF, QPoint], Union[QPointF, QPoint]) [signal]
	**/
	public var rubberBandChanged : Dynamic;
	/**
		rubberBandRect(self) -> QRect
	**/
	public function rubberBandRect():Dynamic;
	/**
		rubberBandSelectionMode(self) -> Qt.ItemSelectionMode
	**/
	public function rubberBandSelectionMode():Dynamic;
	/**
	...
	**/
	public function setCacheMode(Union:Dynamic):Void;
	/**
		setChart(self, QChart)
	**/
	public function setChart(QChart:Dynamic):Void;
	/**
	...
	**/
	public function setDragMode(QGraphicsView:Dynamic):Void;
	/**
	...
	**/
	public function setInteractive(bool:Bool):Void;
	/**
	...
	**/
	public function setOptimizationFlag(QGraphicsView:Dynamic, ?enabled:Dynamic):Void;
	/**
		setOptimizationFlags(self, Union[QGraphicsView.OptimizationFlags, QGraphicsView.OptimizationFlag])
	**/
	public function setOptimizationFlags(Union:Dynamic):Void;
	/**
	...
	**/
	public function setRenderHints(Union:Dynamic):Void;
	/**
		setResizeAnchor(self, QGraphicsView.ViewportAnchor)
	**/
	public function setResizeAnchor(QGraphicsView:Dynamic):Void;
	/**
		setRubberBand(self, Union[QChartView.RubberBands, QChartView.RubberBand])
	**/
	public function setRubberBand(Union:Dynamic):Void;
	/**
		setRubberBandSelectionMode(self, Qt.ItemSelectionMode)
	**/
	public function setRubberBandSelectionMode(Qt:Dynamic):Void;
	/**
		setScene(self, QGraphicsScene)
	**/
	public function setScene(QGraphicsScene:Dynamic):Void;
	/**
	...
	**/
	public function setTransformationAnchor(QGraphicsView:Dynamic):Void;
	/**
	...
	**/
	public function setViewportUpdateMode(QGraphicsView:Dynamic):Void;
	/**
	...
	**/
	public function transformationAnchor():Dynamic;
	/**
	...
	**/
	public function updateScene(Iterable:Dynamic):Void;
	/**
		updateSceneRect(self, QRectF)
	**/
	public function updateSceneRect(QRectF:Dynamic):Void;
	/**
	...
	**/
	public function viewportTransform():Dynamic;
	/**
		viewportUpdateMode(self) -> QGraphicsView.ViewportUpdateMode
	**/
	public function viewportUpdateMode():Dynamic;
	/**
