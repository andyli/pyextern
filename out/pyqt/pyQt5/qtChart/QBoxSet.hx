...
@:pythonImport("PyQt5.QtChart", "QBoxSet") extern class QBoxSet {
	static public var LowerExtreme : Dynamic;
	static public var LowerQuartile : Dynamic;
	static public var Median : Dynamic;
	static public var UpperExtreme : Dynamic;
	static public var UpperQuartile : Dynamic;
	/**
		int([x]) -> integer
		...
		4
	**/
	public function ValuePositions(args:haxe.extern.Rest<Dynamic>):Dynamic;
	...
	**/
	...
	/**
		setValue(self, int, float)
	**/
	public function setValue(int:Int, float:Float):Void;
	/**
	...
	**/
	...
	/**
		valuesChanged(self) [signal]
	**/
	public var valuesChanged : Dynamic;
}