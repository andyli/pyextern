...
@:pythonImport("PyQt5.QtChart", "QChart") extern class QChart {
	...
	**/
	public function addAxis(QAbstractAxis:Dynamic, Union:Dynamic):Void;
	/**
	...
	**/
	public function axes(?orientation:Dynamic, ?series:Dynamic):Dynamic;
	/**
