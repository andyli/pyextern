...
@:pythonImport("PyQt5.QtChart", "QDateTimeAxis") extern class QDateTimeAxis {
	/**
		int([x]) -> integer
	...
	**/
	...
	/**
		formatChanged(self, str) [signal]
	**/
	public var formatChanged : Dynamic;
	/**
	...
	**/
	...
	/**
		maxChanged(self, Union[QDateTime, datetime.datetime]) [signal]
	**/
	...
	**/
	...
	/**
		minChanged(self, Union[QDateTime, datetime.datetime]) [signal]
	**/
	...
	**/
	...
	/**
		rangeChanged(self, Union[QDateTime, datetime.datetime], Union[QDateTime, datetime.datetime]) [signal]
	**/
	...
	**/
	...
	/**
		setMax(self, Union[QDateTime, datetime.datetime])
	**/
	public function setMax(Union:Dynamic):Void;
	/**
		setMin(self, Union[QDateTime, datetime.datetime])
	**/
	public function setMin(Union:Dynamic):Void;
	/**
	...
	**/
	...
	/**
		setRange(self, Union[QDateTime, datetime.datetime], Union[QDateTime, datetime.datetime])
	**/
	public function setRange(Union:Dynamic, Union:Dynamic):Void;
	/**
