...
@:pythonImport("PyQt5.QtChart", "QBarLegendMarker") extern class QBarLegendMarker {
	/**
		int([x]) -> integer
		...
		4
	**/
	public function LegendMarkerType(args:haxe.extern.Rest<Dynamic>):Dynamic;
	static public var LegendMarkerTypeArea : Dynamic;
	static public var LegendMarkerTypeBar : Dynamic;
	static public var LegendMarkerTypeBoxPlot : Dynamic;
	static public var LegendMarkerTypeCandlestick : Dynamic;
	static public var LegendMarkerTypePie : Dynamic;
	static public var LegendMarkerTypeXY : Dynamic;
	...
	**/
	...
	/**
		barset(self) -> QBarSet
	**/
	public function barset():Dynamic;
	/**
	...
	**/
	...
	/**
		setShape(self, QLegend.MarkerShape)
	**/
	public function setShape(QLegend:Dynamic):Void;
	/**
		setVisible(self, bool)
	**/
	public function setVisible(bool:Bool):Void;
	/**
		shape(self) -> QLegend.MarkerShape
	**/
	public function shape():Dynamic;
	/**
		shapeChanged(self) [signal]
	**/
	public var shapeChanged : Dynamic;
	/**
