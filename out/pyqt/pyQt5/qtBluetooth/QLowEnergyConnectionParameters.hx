...
@:pythonImport("PyQt5.QtBluetooth", "QLowEnergyConnectionParameters") extern class QLowEnergyConnectionParameters {
	...
	**/
	public function setIntervalRange(float:Float, float:Float):Void;
	/**
		setLatency(self, int)
	**/
	public function setLatency(int:Int):Void;
	/**
		setSupervisionTimeout(self, int)
	**/
	public function setSupervisionTimeout(int:Int):Void;
	/**
	...
	**/
	public function swap(QLowEnergyConnectionParameters:Dynamic):Void;
}