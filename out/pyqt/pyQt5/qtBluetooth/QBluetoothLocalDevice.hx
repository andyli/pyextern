...
@:pythonImport("PyQt5.QtBluetooth", "QBluetoothLocalDevice") extern class QBluetoothLocalDevice {
	static public var AuthorizedPaired : Dynamic;
	/**
		int([x]) -> integer
	...
	**/
	...
	static public var HostConnectable : Dynamic;
	static public var HostDiscoverable : Dynamic;
	static public var HostDiscoverableLimitedInquiry : Dynamic;
	/**
		int([x]) -> integer
		int(x, base=10) -> integer
		...
		4
	**/
	public function HostMode(args:haxe.extern.Rest<Dynamic>):Dynamic;
	static public var HostPoweredOff : Dynamic;
	static public var NoError : Dynamic;
	static public var Paired : Dynamic;
	/**
		int([x]) -> integer
		int(x, base=10) -> integer
		...
		4
	**/
	public function Pairing(args:haxe.extern.Rest<Dynamic>):Dynamic;
	static public var PairingError : Dynamic;
	static public var UnknownError : Dynamic;
	static public var Unpaired : Dynamic;
	...
	**/
	static public function allDevices():Dynamic;
	/**
	...
	**/
	public function connectedDevices():Dynamic;
	/**
	...
	**/
	public var deviceConnected : Dynamic;
	/**
		deviceDisconnected(self, QBluetoothAddress) [signal]
	**/
	public var deviceDisconnected : Dynamic;
	/**
		disconnect(self)
	**/
	...
	**/
	public function hostMode():Dynamic;
	/**
		hostModeStateChanged(self, QBluetoothLocalDevice.HostMode) [signal]
	**/
	public var hostModeStateChanged : Dynamic;
	/**
	...
	**/
	public function requestPairing(QBluetoothAddress:Dynamic, QBluetoothLocalDevice:Dynamic):Void;
	/**
		sender(self) -> QObject
	**/
	...
	**/
	public function setHostMode(QBluetoothLocalDevice:Dynamic):Void;
	/**
