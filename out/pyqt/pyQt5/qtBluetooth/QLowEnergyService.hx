...
@:pythonImport("PyQt5.QtBluetooth", "QLowEnergyService") extern class QLowEnergyService {
	static public var CharacteristicReadError : Dynamic;
	static public var CharacteristicWriteError : Dynamic;
	static public var DescriptorReadError : Dynamic;
	static public var DescriptorWriteError : Dynamic;
	static public var DiscoveringServices : Dynamic;
	static public var DiscoveryRequired : Dynamic;
	static public var IncludedService : Dynamic;
	static public var InvalidService : Dynamic;
	static public var LocalService : Dynamic;
	static public var NoError : Dynamic;
	static public var OperationError : Dynamic;
	static public var PrimaryService : Dynamic;
	static public var ServiceDiscovered : Dynamic;
	/**
		int([x]) -> integer
		...
		4
	**/
	public function ServiceError(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
		int([x]) -> integer
		int(x, base=10) -> integer
		...
		4
	**/
	public function ServiceState(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
		int([x]) -> integer
		int(x, base=10) -> integer
		...
		4
	**/
	public function ServiceType(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	static public function ServiceTypes(args:haxe.extern.Rest<Dynamic>):Void;
	...
	/**
		...
		4
	**/
	public function WriteMode(args:haxe.extern.Rest<Dynamic>):Dynamic;
	static public var WriteSigned : Dynamic;
	static public var WriteWithResponse : Dynamic;
	static public var WriteWithoutResponse : Dynamic;
	...
	**/
	public function discoverDetails():Void;
	/**
		dumpObjectInfo(self)
	**/
	...
	**/
	public function includedServices():Dynamic;
	/**
	...
	**/
	public function readCharacteristic(QLowEnergyCharacteristic:Dynamic):Void;
	/**
		readDescriptor(self, QLowEnergyDescriptor)
	**/
	public function readDescriptor(QLowEnergyDescriptor:Dynamic):Void;
	/**
	...
	**/
	public function writeCharacteristic(QLowEnergyCharacteristic:Dynamic, Union:Dynamic, ?mode:Dynamic):Void;
	/**
		writeDescriptor(self, QLowEnergyDescriptor, Union[QByteArray, bytes, bytearray])
	**/
	public function writeDescriptor(QLowEnergyDescriptor:Dynamic, Union:Dynamic):Void;
}