...
@:pythonImport("PyQt5.QtBluetooth", "QLowEnergyDescriptorData") extern class QLowEnergyDescriptorData {
	...
	**/
	public function setReadPermissions(bool:Bool, ?constraints:Dynamic):Void;
	/**
	...
	**/
	public function setWritePermissions(bool:Bool, ?constraints:Dynamic):Void;
	/**
		swap(self, QLowEnergyDescriptorData)
	**/
	public function swap(QLowEnergyDescriptorData:Dynamic):Void;
	/**
