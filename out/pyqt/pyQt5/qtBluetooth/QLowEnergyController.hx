...
@:pythonImport("PyQt5.QtBluetooth", "QLowEnergyController") extern class QLowEnergyController {
	static public var AdvertisingError : Dynamic;
	static public var AdvertisingState : Dynamic;
	static public var CentralRole : Dynamic;
	static public var ClosingState : Dynamic;
	static public var ConnectedState : Dynamic;
	static public var ConnectingState : Dynamic;
	static public var ConnectionError : Dynamic;
	/**
		int([x]) -> integer
		...
		4
	**/
	public function ControllerState(args:haxe.extern.Rest<Dynamic>):Dynamic;
	static public var DiscoveredState : Dynamic;
	static public var DiscoveringState : Dynamic;
	/**
		int([x]) -> integer
		int(x, base=10) -> integer
	...
	**/
	...
	static public var InvalidBluetoothAdapterError : Dynamic;
	static public var NetworkError : Dynamic;
	static public var NoError : Dynamic;
	static public var PeripheralRole : Dynamic;
	static public var PublicAddress : Dynamic;
	static public var RandomAddress : Dynamic;
	/**
		int([x]) -> integer
		int(x, base=10) -> integer
		...
		4
	**/
	public function RemoteAddressType(args:haxe.extern.Rest<Dynamic>):Dynamic;
	...
	/**
		...
		4
	**/
	public function Role(args:haxe.extern.Rest<Dynamic>):Dynamic;
	static public var UnconnectedState : Dynamic;
	static public var UnknownError : Dynamic;
	static public var UnknownRemoteDeviceError : Dynamic;
	...
	**/
	public function addService(QLowEnergyServiceData:Dynamic, ?parent:Dynamic):Dynamic;
	/**
	...
	**/
	public function connectToDevice():Void;
	/**
	...
	**/
	public var connectionUpdated : Dynamic;
	/**
		createCentral(QBluetoothDeviceInfo, parent: QObject = None) -> QLowEnergyController
	**/
	static public function createCentral(QBluetoothDeviceInfo:Dynamic, ?parent:Dynamic):Dynamic;
	/**
		createPeripheral(parent: QObject = None) -> QLowEnergyController
	**/
	static public function createPeripheral(?parent:Dynamic):Dynamic;
	/**
		createServiceObject(self, QBluetoothUuid, parent: QObject = None) -> QLowEnergyService
	**/
	public function createServiceObject(QBluetoothUuid:Dynamic, ?parent:Dynamic):Dynamic;
	/**
	...
	**/
	public var discoveryFinished : Dynamic;
	/**
		dumpObjectInfo(self)
	**/
	...
	**/
	public function remoteAddress():Dynamic;
	/**
		remoteAddressType(self) -> QLowEnergyController.RemoteAddressType
	**/
	public function remoteAddressType():Dynamic;
	/**
		remoteDeviceUuid(self) -> QBluetoothUuid
	**/
	public function remoteDeviceUuid():Dynamic;
	/**
		remoteName(self) -> str
	**/
	...
	**/
	public function requestConnectionUpdate(QLowEnergyConnectionParameters:Dynamic):Void;
	/**
		role(self) -> QLowEnergyController.Role
	**/
	public function role():Dynamic;
	/**
		sender(self) -> QObject
	**/
	...
	**/
	public var serviceDiscovered : Dynamic;
	/**
		services(self) -> List[QBluetoothUuid]
	**/
	public function services():Dynamic;
	/**
	...
	**/
	public function setRemoteAddressType(QLowEnergyController:Dynamic):Void;
	/**
	...
	**/
	public function startAdvertising(QLowEnergyAdvertisingParameters:Dynamic, QLowEnergyAdvertisingData:Dynamic, ?scanResponseData:Dynamic):Void;
	/**
	...
	**/
	public function stopAdvertising():Void;
	/**
		thread(self) -> QThread
	**/
