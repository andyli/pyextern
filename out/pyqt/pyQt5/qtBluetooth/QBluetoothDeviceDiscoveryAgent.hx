...
@:pythonImport("PyQt5.QtBluetooth", "QBluetoothDeviceDiscoveryAgent") extern class QBluetoothDeviceDiscoveryAgent {
	/**
		int([x]) -> integer
		...
		4
	**/
	public function DiscoveryMethod(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	static public function DiscoveryMethods(args:haxe.extern.Rest<Dynamic>):Void;
	/**
		int([x]) -> integer
		int(x, base=10) -> integer
	...
	**/
	...
	static public var GeneralUnlimitedInquiry : Dynamic;
	static public var InputOutputError : Dynamic;
	/**
		int([x]) -> integer
		int(x, base=10) -> integer
		...
		4
	**/
	public function InquiryType(args:haxe.extern.Rest<Dynamic>):Dynamic;
	static public var InvalidBluetoothAdapterError : Dynamic;
	static public var LimitedInquiry : Dynamic;
	static public var NoError : Dynamic;
	static public var PoweredOffError : Dynamic;
	static public var UnknownError : Dynamic;
	static public var UnsupportedDiscoveryMethod : Dynamic;
	static public var UnsupportedPlatformError : Dynamic;
	...
	**/
	public function discoveredDevices():Dynamic;
	/**
		dumpObjectInfo(self)
	**/
	...
	**/
	public function inquiryType():Dynamic;
	/**
	...
	**/
	public function setInquiryType(QBluetoothDeviceDiscoveryAgent:Dynamic):Void;
	/**
		setLowEnergyDiscoveryTimeout(self, int)
	**/
	public function setLowEnergyDiscoveryTimeout(int:Int):Void;
	/**
	...
	**/
	static public function supportedDiscoveryMethods():Dynamic;
	/**
		thread(self) -> QThread
	**/
