...
@:pythonImport("PyQt5.QtCore", "QSettings") extern class QSettings {
	...
	**/
	public function allKeys():Dynamic;
	/**
	...
	**/
	...
	/**
		beginGroup(self, str)
	**/
	public function beginGroup(str:String):Void;
	/**
		beginReadArray(self, str) -> int
	**/
	public function beginReadArray(str:String):Int;
	/**
		beginWriteArray(self, str, size: int = -1)
	**/
	public function beginWriteArray(str:String, ?size:Dynamic):Void;
	/**
	...
	**/
	public function childGroups():Dynamic;
	/**
		childKeys(self) -> List[str]
	**/
	public function childKeys():Dynamic;
	/**
	...
	**/
	public function iniCodec():Dynamic;
	/**
	...
	**/
	public function setArrayIndex(int:Int):Void;
	/**
		setAtomicSyncRequired(self, bool)
	**/
	public function setAtomicSyncRequired(bool:Bool):Void;
	/**
		setDefaultFormat(QSettings.Format)
	**/
	static public function setDefaultFormat(QSettings:Dynamic):Void;
	/**
		setFallbacksEnabled(self, bool)
	**/
	public function setFallbacksEnabled(bool:Bool):Void;
	/**
		setIniCodec(self, QTextCodec)
		setIniCodec(self, str)
	**/
	public function setIniCodec(args:haxe.extern.Rest<Dynamic>):Void;
	/**
	...
	**/
	static public function setPath(QSettings:Dynamic, QSettings:Dynamic, str:String):Void;
	/**
	...
	**/
	public function setValue(str:String, Any:Dynamic):Void;
	/**
	...
	**/
	public function value(str:String, ?defaultValue:Dynamic, ?type:Dynamic):Dynamic;
}