...
@:pythonImport("PyQt5.QtCore", "QWaitCondition") extern class QWaitCondition {
	...
	**/
	public function wait(args:haxe.extern.Rest<Dynamic>):Bool;
	/**
		wakeAll(self)
	**/
