...
@:pythonImport("PyQt5.QtCore", "QThreadPool") extern class QThreadPool {
	...
	**/
	public function cancel(QRunnable:Dynamic):Void;
	/**
	...
	**/
	static public function globalInstance():Dynamic;
	/**
	...
	**/
	...
	/**
		releaseThread(self)
	**/
	public function releaseThread():Void;
	/**
	...
	**/
	...
	/**
		reserveThread(self)
	**/
	public function reserveThread():Void;
	/**
		sender(self) -> QObject
	**/
	...
	**/
	public function setExpiryTimeout(int:Int):Void;
	/**
		setMaxThreadCount(self, int)
	**/
	public function setMaxThreadCount(int:Int):Void;
	/**
	...
	**/
	public function start(QRunnable:Dynamic, ?priority:Dynamic):Void;
	/**
	...
	**/
	public function tryStart(QRunnable:Dynamic):Bool;
	/**
		tryTake(self, QRunnable) -> bool
	**/
	public function tryTake(QRunnable:Dynamic):Bool;
	/**
		waitForDone(self, msecs: int = -1) -> bool
	**/
	public function waitForDone(?msecs:Dynamic):Bool;
}