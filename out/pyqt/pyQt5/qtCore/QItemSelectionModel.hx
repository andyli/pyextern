...
@:pythonImport("PyQt5.QtCore", "QItemSelectionModel") extern class QItemSelectionModel {
	...
	**/
	static public function SelectionFlags(args:haxe.extern.Rest<Dynamic>):Void;
	...
	**/
	public function columnIntersectsSelection(int:Int, QModelIndex:Dynamic):Bool;
	/**
	...
	**/
	public var currentColumnChanged : Dynamic;
	/**
	...
	**/
	public function emitSelectionChanged(QItemSelection:Dynamic, QItemSelection:Dynamic):Void;
	/**
	...
	**/
	public function isColumnSelected(int:Int, QModelIndex:Dynamic):Bool;
	/**
		isRowSelected(self, int, QModelIndex) -> bool
	**/
	public function isRowSelected(int:Int, QModelIndex:Dynamic):Bool;
	/**
		isSelected(self, QModelIndex) -> bool
	**/
	public function isSelected(QModelIndex:Dynamic):Bool;
	/**
	...
	**/
	public var modelChanged : Dynamic;
	/**
	...
	**/
	public function rowIntersectsSelection(int:Int, QModelIndex:Dynamic):Bool;
	/**
	...
	**/
	public function select(args:haxe.extern.Rest<Dynamic>):Void;
	/**
		selectedColumns(self, row: int = 0) -> List[QModelIndex]
	**/
	public function selectedColumns(?row:Dynamic):Dynamic;
	/**
	...
	**/
	public function selectedRows(?column:Dynamic):Dynamic;
	/**
	...
	**/
	public function setCurrentIndex(QModelIndex:Dynamic, Union:Dynamic):Void;
	/**
