...
@:pythonImport("PyQt5.QtCore", "QItemSelectionRange") extern class QItemSelectionRange {
	...
	**/
	public function intersected(QItemSelectionRange:Dynamic):Dynamic;
	/**
		intersects(self, QItemSelectionRange) -> bool
	**/
	public function intersects(QItemSelectionRange:Dynamic):Bool;
	/**
		isEmpty(self) -> bool
	**/
	...
	**/
	public function swap(QItemSelectionRange:Dynamic):Void;
	/**
		top(self) -> int
	**/
