...
@:pythonImport("PyQt5.QtCore", "QResource") extern class QResource {
	...
	**/
	static public function registerResource(str:String, ?mapRoot:Dynamic):Bool;
	/**
		registerResourceData(bytes, mapRoot: str = '') -> bool
	**/
	static public function registerResourceData(bytes:Dynamic, ?mapRoot:Dynamic):Bool;
	/**
	...
	**/
	static public function unregisterResource(str:String, ?mapRoot:Dynamic):Bool;
	/**
		unregisterResourceData(bytes, mapRoot: str = '') -> bool
	**/
	static public function unregisterResourceData(bytes:Dynamic, ?mapRoot:Dynamic):Bool;
}