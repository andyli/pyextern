...
@:pythonImport("PyQt5.QtCore", "QSizeF") extern class QSizeF {
	/**
		Return self+value.
	**/
	...
	**/
	public function boundedTo(QSizeF:Dynamic):Dynamic;
	/**
		expandedTo(self, QSizeF) -> QSizeF
	**/
	public function expandedTo(QSizeF:Dynamic):Dynamic;
	/**
		height(self) -> float
	**/
	...
	**/
	...
	/**
		toSize(self) -> QSize
	**/
	public function toSize():Dynamic;
	/**
		transpose(self)
	**/
