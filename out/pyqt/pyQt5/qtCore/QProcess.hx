...
@:pythonImport("PyQt5.QtCore", "QProcess") extern class QProcess {
	...
	**/
	public function closeReadChannel(QProcess:Dynamic):Void;
	/**
		closeWriteChannel(self)
	**/
	public function closeWriteChannel():Void;
	/**
	...
	**/
	...
	/**
		...
		execute(str) -> int
	**/
	static public function execute(str:String, args:haxe.extern.Rest<Dynamic>):Int;
	/**
		exitCode(self) -> int
	**/
	...
	**/
	public function exitStatus():Dynamic;
	/**
	...
	**/
	public function inputChannelMode():Dynamic;
	/**
	...
	**/
	...
	/**
		nullDevice() -> str
	**/
	static public function nullDevice():String;
	/**
		objectName(self) -> str
	**/
	...
	**/
	public function open(?mode:Dynamic):Bool;
	/**
	...
	**/
	public function processChannelMode():Dynamic;
	/**
		processEnvironment(self) -> QProcessEnvironment
	**/
	public function processEnvironment():Dynamic;
	/**
		processId(self) -> int
	**/
	...
	**/
	public function readAllStandardError():Dynamic;
	/**
		readAllStandardOutput(self) -> QByteArray
	**/
	public function readAllStandardOutput():Dynamic;
	/**
		readChannel(self) -> QProcess.ProcessChannel
	**/
	public function readChannel():Dynamic;
	/**
	...
	**/
	public var readyReadStandardError : Dynamic;
	/**
		readyReadStandardOutput(self) [signal]
	**/
	public var readyReadStandardOutput : Dynamic;
	/**
	...
	**/
	public function setInputChannelMode(QProcess:Dynamic):Void;
	/**
	...
	**/
	public function setProcessChannelMode(QProcess:Dynamic):Void;
	/**
		setProcessEnvironment(self, QProcessEnvironment)
	**/
	public function setProcessEnvironment(QProcessEnvironment:Dynamic):Void;
	/**
		setProcessState(self, QProcess.ProcessState)
	**/
	public function setProcessState(QProcess:Dynamic):Void;
	/**
		setProgram(self, str)
	**/
	public function setProgram(str:String):Void;
	/**
	...
	**/
	public function setReadChannel(QProcess:Dynamic):Void;
	/**
		setStandardErrorFile(self, str, mode: Union[QIODevice.OpenMode, QIODevice.OpenModeFlag] = QIODevice.Truncate)
	**/
	public function setStandardErrorFile(str:String, ?mode:Dynamic):Void;
	/**
		setStandardInputFile(self, str)
	**/
	public function setStandardInputFile(str:String):Void;
	/**
		setStandardOutputFile(self, str, mode: Union[QIODevice.OpenMode, QIODevice.OpenModeFlag] = QIODevice.Truncate)
	**/
	public function setStandardOutputFile(str:String, ?mode:Dynamic):Void;
	/**
		setStandardOutputProcess(self, QProcess)
	**/
	public function setStandardOutputProcess(QProcess:Dynamic):Void;
	/**
	...
	**/
	public function setWorkingDirectory(str:String):Void;
	/**
		setupChildProcess(self)
	**/
	public function setupChildProcess():Void;
	/**
	...
	**/
	public function start(args:haxe.extern.Rest<Dynamic>):Void;
	/**
	...
	**/
	static public function systemEnvironment():Dynamic;
	/**
		terminate(self)
	**/
	...
	**/
	public function waitForFinished(?msecs:Dynamic):Bool;
	/**
	...
	**/
	public function waitForStarted(?msecs:Dynamic):Bool;
	/**
