...
@:pythonImport("PyQt5.QtCore", "QCommandLineOption") extern class QCommandLineOption {
	/**
		int([x]) -> integer
	...
	**/
	...
	static public var HiddenFromHelp : Dynamic;
	static public var ShortOptionStyle : Dynamic;
	...
	**/
	public function defaultValues():Dynamic;
	/**
	...
	**/
	public function setDefaultValue(str:String):Void;
	/**
		setDefaultValues(self, Iterable[str])
	**/
	public function setDefaultValues(Iterable:Dynamic):Void;
	/**
	...
	**/
	public function setValueName(str:String):Void;
	/**
		swap(self, QCommandLineOption)
	**/
	public function swap(QCommandLineOption:Dynamic):Void;
	/**
		valueName(self) -> str
	**/
