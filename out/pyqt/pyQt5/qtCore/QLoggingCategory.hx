...
@:pythonImport("PyQt5.QtCore", "QLoggingCategory") extern class QLoggingCategory {
	/**
	...
	**/
	static public function defaultCategory():Dynamic;
	/**
	...
	**/
	public function isEnabled(QtMsgType:Dynamic):Bool;
	/**
	...
	**/
	public function setEnabled(QtMsgType:Dynamic, bool:Bool):Void;
	/**
		setFilterRules(str)
	**/
	static public function setFilterRules(str:String):Void;
}