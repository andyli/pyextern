...
@:pythonImport("PyQt5.QtCore", "QMimeType") extern class QMimeType {
	...
	**/
	public function allAncestors():Dynamic;
	/**
		comment(self) -> str
	**/
	...
	**/
	public function globPatterns():Dynamic;
	/**
		iconName(self) -> str
	**/
	...
	**/
	public function parentMimeTypes():Dynamic;
	/**
	...
	**/
	public function suffixes():Dynamic;
	/**
		swap(self, QMimeType)
	**/
	public function swap(QMimeType:Dynamic):Void;
}