...
@:pythonImport("PyQt5.QtCore", "QTemporaryFile") extern class QTemporaryFile {
	...
	**/
	public function rename(str:String):Bool;
	/**
		reset(self) -> bool
	**/
	...
	**/
	public function setAutoRemove(bool:Bool):Void;
	/**
	...
	**/
	public function setFileTemplate(str:String):Void;
	/**
