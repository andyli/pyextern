...
@:pythonImport("PyQt5.QtCore", "QSortFilterProxyModel") extern class QSortFilterProxyModel {
	...
	**/
	public function filterRegularExpression():Dynamic;
	/**
		filterRole(self) -> int
	**/
	...
	**/
	public function setFilterRegularExpression(args:haxe.extern.Rest<Dynamic>):Void;
	/**
	...
	**/
	public function setRecursiveFilteringEnabled(bool:Bool):Void;
	/**
