...
@:pythonImport("PyQt5.QtCore", "QTimeLine") extern class QTimeLine {
	...
	**/
	public function curveShape():Dynamic;
	/**
	...
	**/
	public var frameChanged : Dynamic;
	/**
		frameForTime(self, int) -> int
	**/
	public function frameForTime(int:Int):Int;
	/**
	...
	**/
	public function setCurveShape(QTimeLine:Dynamic):Void;
	/**
		setDirection(self, QTimeLine.Direction)
	**/
	public function setDirection(QTimeLine:Dynamic):Void;
	/**
	...
	**/
	public function setEndFrame(int:Int):Void;
	/**
		setFrameRange(self, int, int)
	**/
	public function setFrameRange(int:Int, int:Int):Void;
	/**
	...
	**/
	public function setStartFrame(int:Int):Void;
	/**
	...
	**/
	public function valueForTime(int:Int):Float;
}