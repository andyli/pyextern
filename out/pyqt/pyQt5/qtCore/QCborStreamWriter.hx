...
@:pythonImport("PyQt5.QtCore", "QCborStreamWriter") extern class QCborStreamWriter {
	...
	**/
	public function appendUndefined():Void;
	/**
	...
	**/
	...
	/**
		endArray(self) -> bool
	**/
	public function endArray():Bool;
	/**
		endMap(self) -> bool
	**/
	public function endMap():Bool;
	/**
	...
	**/
	...
	/**
		...
		startArray(self, int)
	**/
	public function startArray(args:haxe.extern.Rest<Dynamic>):Void;
	/**
		startMap(self)
		startMap(self, int)
	**/
	public function startMap(args:haxe.extern.Rest<Dynamic>):Void;
}