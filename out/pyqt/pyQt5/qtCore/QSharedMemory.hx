...
@:pythonImport("PyQt5.QtCore", "QSharedMemory") extern class QSharedMemory {
	/**
		int([x]) -> integer
	...
	**/
	...
	static public var InvalidSize : Dynamic;
	static public var KeyError : Dynamic;
	static public var LockError : Dynamic;
	...
	/**
		...
		4
	**/
	public function SharedMemoryError(args:haxe.extern.Rest<Dynamic>):Dynamic;
	...
	**/
	public function attach(?mode:Dynamic):Bool;
	/**
	...
	**/
	public function constData():Dynamic;
	/**
		create(self, int, mode: QSharedMemory.AccessMode = QSharedMemory.ReadWrite) -> bool
	**/
	public function create(int:Int, ?mode:Dynamic):Bool;
	/**
	...
	**/
	public function setNativeKey(str:String):Void;
	/**
