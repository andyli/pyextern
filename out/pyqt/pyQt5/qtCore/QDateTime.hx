...
@:pythonImport("PyQt5.QtCore", "QDateTime") extern class QDateTime {
	...
	**/
	static public function currentSecsSinceEpoch():Int;
	/**
		date(self) -> QDate
	**/
	...
	**/
	static public function fromSecsSinceEpoch(int:Int, args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	public function setSecsSinceEpoch(int:Int):Void;
	/**
