...
@:pythonImport("PyQt5.QtCore", "QLockFile") extern class QLockFile {
	/**
		int([x]) -> integer
		...
		4
	**/
	public function LockError(args:haxe.extern.Rest<Dynamic>):Dynamic;
	static public var LockFailedError : Dynamic;
	...
	**/
	public function getLockInfo():Dynamic;
	/**
		isLocked(self) -> bool
	**/
	...
	**/
	public function setStaleLockTime(int:Int):Void;
	/**
	...
	**/
	public function tryLock(?timeout:Dynamic):Bool;
	/**
		unlock(self)
	**/
