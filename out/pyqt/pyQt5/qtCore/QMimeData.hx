...
@:pythonImport("PyQt5.QtCore", "QMimeData") extern class QMimeData {
	...
	**/
	...
	/**
		colorData(self) -> Any
	**/
	public function colorData():Dynamic;
	/**
	...
	**/
	public function data(str:String):Dynamic;
	/**
		deleteLater(self)
	**/
	...
	**/
	public function hasFormat(str:String):Bool;
	/**
		hasHtml(self) -> bool
	**/
	...
	**/
	...
	/**
		imageData(self) -> Any
	**/
	public function imageData():Dynamic;
	/**
	...
	**/
	public function removeFormat(str:String):Void;
	/**
		retrieveData(self, str, QVariant.Type) -> Any
	**/
	public function retrieveData(str:String, QVariant:Dynamic):Dynamic;
	/**
		sender(self) -> QObject
	**/
	...
	**/
	public function setColorData(Any:Dynamic):Void;
	/**
		setData(self, str, Union[QByteArray, bytes, bytearray])
	**/
	public function setData(str:String, Union:Dynamic):Void;
	/**
		setHtml(self, str)
	**/
	...
	**/
	public function setImageData(Any:Dynamic):Void;
	/**
	...
	**/
	public function setUrls(Iterable:Dynamic):Void;
	/**
