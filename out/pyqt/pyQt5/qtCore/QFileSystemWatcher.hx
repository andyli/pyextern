...
@:pythonImport("PyQt5.QtCore", "QFileSystemWatcher") extern class QFileSystemWatcher {
	...
	**/
	public function addPath(str:String):Bool;
	/**
		addPaths(self, Iterable[str]) -> List[str]
	**/
	public function addPaths(Iterable:Dynamic):Dynamic;
	/**
	...
	**/
	public function directories():Dynamic;
	/**
		directoryChanged(self, str) [signal]
	**/
	public var directoryChanged : Dynamic;
	/**
		disconnect(self)
	**/
	...
	**/
	public var fileChanged : Dynamic;
	/**
		files(self) -> List[str]
	**/
	public function files():Dynamic;
	/**
	...
	**/
	public function removePath(str:String):Bool;
	/**
		removePaths(self, Iterable[str]) -> List[str]
	**/
	public function removePaths(Iterable:Dynamic):Dynamic;
	/**
		sender(self) -> QObject
	**/
