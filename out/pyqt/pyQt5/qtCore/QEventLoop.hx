...
@:pythonImport("PyQt5.QtCore", "QEventLoop") extern class QEventLoop {
	...
	**/
	static public function ProcessEventsFlags(args:haxe.extern.Rest<Dynamic>):Void;
	...
	**/
	public function exec(?flags:Dynamic):Int;
	/**
		exec_(self, flags: QEventLoop.ProcessEventsFlags = QEventLoop.AllEvents) -> int
	**/
	public function exec_(?flags:Dynamic):Int;
	/**
