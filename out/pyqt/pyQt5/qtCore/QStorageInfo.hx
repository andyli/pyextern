...
@:pythonImport("PyQt5.QtCore", "QStorageInfo") extern class QStorageInfo {
	...
	**/
	public function fileSystemType():Dynamic;
	/**
	...
	**/
	static public function mountedVolumes():Dynamic;
	/**
		name(self) -> str
	**/
	...
	**/
	public function subvolume():Dynamic;
	/**
		swap(self, QStorageInfo)
	**/
	public function swap(QStorageInfo:Dynamic):Void;
}