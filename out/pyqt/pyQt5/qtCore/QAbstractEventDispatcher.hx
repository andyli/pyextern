...
@:pythonImport("PyQt5.QtCore", "QAbstractEventDispatcher") extern class QAbstractEventDispatcher {
	/**
	...
	**/
	static public function TimerInfo(args:haxe.extern.Rest<Dynamic>):Void;
	...
	**/
	public var aboutToBlock : Dynamic;
	/**
		awake(self) [signal]
	**/
	public var awake : Dynamic;
	/**
	...
	**/
	...
	/**
		closingDown(self)
	**/
	public function closingDown():Void;
	/**
	...
	**/
	public function filterNativeEvent(Union:Dynamic, sip:Dynamic):Dynamic;
	/**
	...
	**/
	static public function instance(?thread:Dynamic):Dynamic;
	/**
		interrupt(self)
	**/
	...
	**/
	public function processEvents(Union:Dynamic):Bool;
	/**
	...
	**/
	public function registerSocketNotifier(QSocketNotifier:Dynamic):Void;
	/**
		registerTimer(self, int, Qt.TimerType, QObject) -> int
		registerTimer(self, int, int, Qt.TimerType, QObject)
	**/
	public function registerTimer(int:Int, args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
		registeredTimers(self, QObject) -> List[QAbstractEventDispatcher.TimerInfo]
	**/
	public function registeredTimers(QObject:Dynamic):Dynamic;
	/**
		remainingTime(self, int) -> int
	**/
	public function remainingTime(int:Int):Int;
	/**
	...
	**/
	...
	/**
		startingUp(self)
	**/
	public function startingUp():Void;
	...
	**/
	public function unregisterSocketNotifier(QSocketNotifier:Dynamic):Void;
	/**
		unregisterTimer(self, int) -> bool
	**/
	public function unregisterTimer(int:Int):Bool;
	/**
		unregisterTimers(self, QObject) -> bool
	**/
	public function unregisterTimers(QObject:Dynamic):Bool;
	/**
		wakeUp(self)
	**/
