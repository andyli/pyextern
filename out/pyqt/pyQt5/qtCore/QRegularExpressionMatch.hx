...
@:pythonImport("PyQt5.QtCore", "QRegularExpressionMatch") extern class QRegularExpressionMatch {
	...
	**/
	public function captured(args:haxe.extern.Rest<Dynamic>):String;
	/**
		capturedEnd(self, nth: int = 0) -> int
		capturedEnd(self, str) -> int
	**/
	public function capturedEnd(args:haxe.extern.Rest<Dynamic>):Int;
	/**
		capturedLength(self, nth: int = 0) -> int
		capturedLength(self, str) -> int
	**/
	public function capturedLength(args:haxe.extern.Rest<Dynamic>):Int;
	/**
		capturedStart(self, nth: int = 0) -> int
		capturedStart(self, str) -> int
	**/
	public function capturedStart(args:haxe.extern.Rest<Dynamic>):Int;
	/**
	...
	**/
	public function matchOptions():Dynamic;
	/**
		matchType(self) -> QRegularExpression.MatchType
	**/
	public function matchType():Dynamic;
	/**
		regularExpression(self) -> QRegularExpression
	**/
	public function regularExpression():Dynamic;
	/**
		swap(self, QRegularExpressionMatch)
	**/
	public function swap(QRegularExpressionMatch:Dynamic):Void;
}