...
@:pythonImport("PyQt5.QtWebEngine", "QQuickWebEngineScript") extern class QQuickWebEngineScript {
	static public var ApplicationWorld : Dynamic;
	static public var Deferred : Dynamic;
	static public var DocumentCreation : Dynamic;
	static public var DocumentReady : Dynamic;
	/**
		int([x]) -> integer
		...
		4
	**/
	public function InjectionPoint(args:haxe.extern.Rest<Dynamic>):Dynamic;
	static public var MainWorld : Dynamic;
	/**
		int([x]) -> integer
		int(x, base=10) -> integer
		...
		4
	**/
	public function ScriptWorldId(args:haxe.extern.Rest<Dynamic>):Dynamic;
	static public var UserWorld : Dynamic;
	...
	**/
	public function injectionPoint():Dynamic;
	/**
		injectionPointChanged(self, QQuickWebEngineScript.InjectionPoint) [signal]
	**/
	public var injectionPointChanged : Dynamic;
	/**
	...
	**/
	public var runOnSubframesChanged : Dynamic;
	/**
		sender(self) -> QObject
	**/
	...
	**/
	public function setInjectionPoint(QQuickWebEngineScript:Dynamic):Void;
	/**
		setName(self, str)
	**/
	...
	**/
	public function setRunOnSubframes(bool:Bool):Void;
	/**
		setSourceCode(self, str)
	**/
	public function setSourceCode(str:String):Void;
	/**
		setSourceUrl(self, QUrl)
	**/
	public function setSourceUrl(QUrl:Dynamic):Void;
	/**
		setWorldId(self, QQuickWebEngineScript.ScriptWorldId)
	**/
	public function setWorldId(QQuickWebEngineScript:Dynamic):Void;
	/**
	...
	**/
	public var sourceCodeChanged : Dynamic;
	/**
		sourceUrl(self) -> QUrl
	**/
	public function sourceUrl():Dynamic;
	/**
		sourceUrlChanged(self, QUrl) [signal]
	**/
	public var sourceUrlChanged : Dynamic;
	/**
	...
	**/
	public function worldId():Dynamic;
	/**
		worldIdChanged(self, QQuickWebEngineScript.ScriptWorldId) [signal]
	**/
	public var worldIdChanged : Dynamic;
}