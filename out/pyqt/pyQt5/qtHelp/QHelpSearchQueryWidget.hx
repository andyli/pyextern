...
@:pythonImport("PyQt5.QtHelp", "QHelpSearchQueryWidget") extern class QHelpSearchQueryWidget {
	...
	**/
	public function collapseExtendedSearch():Void;
	/**
		colorCount(self) -> int
	**/
	...
	**/
	public function expandExtendedSearch():Void;
	/**
	...
	**/
	public function setCompactMode(bool:Bool):Void;
	/**
	...
	**/
	public function setQuery(Iterable:Dynamic):Void;
	/**
		setSearchInput(self, str)
	**/
	public function setSearchInput(str:String):Void;
	/**
