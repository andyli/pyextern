...
@:pythonImport("PyQt5.QtHelp", "QHelpIndexWidget") extern class QHelpIndexWidget {
	...
	**/
	public function activateCurrentItem():Void;
	/**
		activateWindow(self)
	**/
	...
	**/
	public function filterIndices(str:String, ?wildcard:Dynamic):Void;
	/**
	...
	**/
	public var linksActivated : Dynamic;
	/**
		locale(self) -> QLocale
	**/
