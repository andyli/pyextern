...
@:pythonImport("PyQt5.QtHelp", "QHelpSearchResultWidget") extern class QHelpSearchResultWidget {
	...
	**/
	public function linkAt(QPoint:Dynamic):Dynamic;
	/**
		locale(self) -> QLocale
	**/
	...
	**/
	public var requestShowLink : Dynamic;
	/**
		resize(self, QSize)
		resize(self, int, int)
	**/
