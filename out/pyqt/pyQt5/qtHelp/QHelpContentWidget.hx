...
@:pythonImport("PyQt5.QtHelp", "QHelpContentWidget") extern class QHelpContentWidget {
	...
	**/
	public function indexOf(QUrl:Dynamic):Dynamic;
	/**
	...
	**/
	public var linkActivated : Dynamic;
	/**
		locale(self) -> QLocale
	**/
