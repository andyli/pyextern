...
@:pythonImport("PyQt5.QtHelp", "QHelpIndexModel") extern class QHelpIndexModel {
	/**
		An enumeration.
	**/
	...
	**/
	public function createIndex(str:String):Void;
	/**
	...
	**/
	public function filter(str:String, ?wildcard:Dynamic):Dynamic;
	/**
	...
	**/
	public function index(int:Int, ?column:Dynamic, ?parent:Dynamic):Dynamic;
	/**
		indexCreated(self) [signal]
	**/
	public var indexCreated : Dynamic;
	/**
		indexCreationStarted(self) [signal]
	**/
	public var indexCreationStarted : Dynamic;
	/**
	...
	**/
	public function setStringList(Iterable:Dynamic):Void;
	/**
	...
	**/
	public function stringList():Dynamic;
	/**
		submit(self) -> bool
	**/
