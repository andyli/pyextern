...
@:pythonImport("PyQt5.QtHelp", "QHelpSearchEngine") extern class QHelpSearchEngine {
	...
	**/
	public function cancelSearching():Void;
	/**
	...
	**/
	public function hits(int:Int, int:Int):Dynamic;
	/**
		indexingFinished(self) [signal]
	**/
	public var indexingFinished : Dynamic;
	/**
		indexingStarted(self) [signal]
	**/
	public var indexingStarted : Dynamic;
	/**
	...
	**/
	public function queryWidget():Dynamic;
	/**
	...
	**/
	public function reindexDocumentation():Void;
	/**
	...
	**/
	public function resultWidget():Dynamic;
	/**
		search(self, Iterable[QHelpSearchQuery])
		search(self, str)
	**/
	public function search(args:haxe.extern.Rest<Dynamic>):Void;
	/**
	...
	**/
	public function searchResults(int:Int, int:Int):Dynamic;
	/**
		searchingFinished(self, int) [signal]
	**/
	public var searchingFinished : Dynamic;
	/**
		searchingStarted(self) [signal]
	**/
	public var searchingStarted : Dynamic;
	/**
		sender(self) -> QObject
	**/
