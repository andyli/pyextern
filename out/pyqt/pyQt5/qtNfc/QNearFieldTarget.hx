...
@:pythonImport("PyQt5.QtNfc", "QNearFieldTarget") extern class QNearFieldTarget {
	...
	**/
	...
	static public var CommandError : Dynamic;
	/**
		int([x]) -> integer
		int(x, base=10) -> integer
	...
	**/
	public function reportError(QNearFieldTarget:Dynamic, QNearFieldTarget:Dynamic):Void;
	/**
	...
	**/
	public function setKeepConnection(bool:Bool):Bool;
	/**
	...
	**/
	public function writeNdefMessages(Iterable:Dynamic):Dynamic;
}