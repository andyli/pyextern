...
package pyQt5.qtNfc;
@:pythonImport("PyQt5.QtNfc", "QQmlNdefRecord") extern class QQmlNdefRecord {
	...
	**/
	public var recordChanged : Dynamic;
	/**
	...
	**/
	public function setRecord(QNdefRecord:Dynamic):Void;
	/**
		setType(self, str)
	**/
	...
	**/
	public function setTypeNameFormat(QQmlNdefRecord:Dynamic):Void;
	/**
	...
	**/
	public var typeNameFormatChanged : Dynamic;
}