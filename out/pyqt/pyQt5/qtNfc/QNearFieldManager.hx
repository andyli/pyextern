...
package pyQt5.qtNfc;
@:pythonImport("PyQt5.QtNfc", "QNearFieldManager") extern class QNearFieldManager {
	/**
		An enumeration.
	**/
	static public function AdapterState(value:Dynamic, ?names:Dynamic, ?module:Dynamic, ?qualname:Dynamic, ?type:Dynamic, ?start:Dynamic):Dynamic;
	static public var NdefReadTargetAccess : Dynamic;
	static public var NdefWriteTargetAccess : Dynamic;
	static public var NoTargetAccess : Dynamic;
	static public var TagTypeSpecificTargetAccess : Dynamic;
	/**
		int([x]) -> integer
		...
		4
	**/
	public function TargetAccessMode(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	static public function TargetAccessModes(args:haxe.extern.Rest<Dynamic>):Void;
	...
	**/
	public var adapterStateChanged : Dynamic;
	/**
	...
	**/
	public function registerNdefMessageHandler(args:haxe.extern.Rest<Dynamic>):Int;
	/**
	...
	**/
	public function setTargetAccessModes(Union:Dynamic):Void;
	/**
	...
	**/
	public function stopTargetDetection():Void;
	/**
		targetAccessModes(self) -> QNearFieldManager.TargetAccessModes
	**/
	public function targetAccessModes():Dynamic;
	/**
	...
	**/
	public function unregisterNdefMessageHandler(int:Int):Bool;
}