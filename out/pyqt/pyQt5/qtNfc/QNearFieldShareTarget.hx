...
package pyQt5.qtNfc;
@:pythonImport("PyQt5.QtNfc", "QNearFieldShareTarget") extern class QNearFieldShareTarget {
	...
	**/
	public function share(args:haxe.extern.Rest<Dynamic>):Bool;
	/**
	...
	**/
	public var shareFinished : Dynamic;
	/**
