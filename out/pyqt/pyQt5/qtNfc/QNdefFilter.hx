...
package pyQt5.qtNfc;
@:pythonImport("PyQt5.QtNfc", "QNdefFilter") extern class QNdefFilter {
	/**
		QNdefFilter.Record()
		QNdefFilter.Record(QNdefFilter.Record)
	**/
	static public function Record(args:haxe.extern.Rest<Dynamic>):Void;
	...
	**/
	public function appendRecord(args:haxe.extern.Rest<Dynamic>):Void;
	/**
		clear(self)
	**/
	...
	**/
	public function recordAt(int:Int):Dynamic;
	/**
	...
	**/
	public function setOrderMatch(bool:Bool):Void;
}