...
package pyQt5.uic.compiler.compiler;
@:pythonImport("PyQt5.uic.Compiler.compiler", "UICompiler") extern class UICompiler {
	...
	**/
	...
	public function compileUi(input_stream:Dynamic, output_stream:Dynamic, from_imports:Dynamic, resource_suffix:Dynamic, import_from:Dynamic):Dynamic;
