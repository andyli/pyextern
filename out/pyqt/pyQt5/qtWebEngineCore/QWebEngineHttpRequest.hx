...
@:pythonImport("PyQt5.QtWebEngineCore", "QWebEngineHttpRequest") extern class QWebEngineHttpRequest {
	...
	**/
	...
	static public var Post : Dynamic;
	...
	**/
	public function hasHeader(Union:Dynamic):Bool;
	/**
		header(self, Union[QByteArray, bytes, bytearray]) -> QByteArray
	**/
	public function header(Union:Dynamic):Dynamic;
	/**
	...
	**/
	public function postData():Dynamic;
	/**
		postRequest(QUrl, Dict[str, str]) -> QWebEngineHttpRequest
	**/
	static public function postRequest(QUrl:Dynamic, Dict:Dynamic):Dynamic;
	/**
		setHeader(self, Union[QByteArray, bytes, bytearray], Union[QByteArray, bytes, bytearray])
	**/
	public function setHeader(Union:Dynamic, Union:Dynamic):Void;
	/**
		setMethod(self, QWebEngineHttpRequest.Method)
	**/
	public function setMethod(QWebEngineHttpRequest:Dynamic):Void;
	/**
		setPostData(self, Union[QByteArray, bytes, bytearray])
	**/
	public function setPostData(Union:Dynamic):Void;
	/**
		setUrl(self, QUrl)
	**/
	...
	**/
	public function swap(QWebEngineHttpRequest:Dynamic):Void;
	/**
		unsetHeader(self, Union[QByteArray, bytes, bytearray])
	**/
	public function unsetHeader(Union:Dynamic):Void;
	/**
		url(self) -> QUrl
	**/
