...
@:pythonImport("PyQt5.QtWebEngineCore", "QWebEngineUrlSchemeHandler") extern class QWebEngineUrlSchemeHandler {
	...
	**/
	public function requestStarted(QWebEngineUrlRequestJob:Dynamic):Void;
	/**
		sender(self) -> QObject
	**/
