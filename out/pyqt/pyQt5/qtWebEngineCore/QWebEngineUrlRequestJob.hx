...
@:pythonImport("PyQt5.QtWebEngineCore", "QWebEngineUrlRequestJob") extern class QWebEngineUrlRequestJob {
	/**
		int([x]) -> integer
	...
	**/
	...
	static public var RequestAborted : Dynamic;
	static public var RequestDenied : Dynamic;
	static public var RequestFailed : Dynamic;
	static public var UrlInvalid : Dynamic;
	static public var UrlNotFound : Dynamic;
	...
	**/
	public function fail(QWebEngineUrlRequestJob:Dynamic):Void;
	/**
	...
	**/
	...
	/**
		initiator(self) -> QUrl
	**/
	public function initiator():Dynamic;
	/**
	...
	**/
	public function reply(Union:Dynamic, QIODevice:Dynamic):Void;
	/**
