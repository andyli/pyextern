...
@:pythonImport("PyQt5.QtWebEngineCore", "QWebEngineUrlRequestInterceptor") extern class QWebEngineUrlRequestInterceptor {
	...
	**/
	public function interceptRequest(QWebEngineUrlRequestInfo:Dynamic):Void;
	/**
