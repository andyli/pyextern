...
@:pythonImport("PyQt5.QtWebEngineCore", "QWebEngineCookieStore") extern class QWebEngineCookieStore {
	/**
		QWebEngineCookieStore.FilterRequest()
		QWebEngineCookieStore.FilterRequest(QWebEngineCookieStore.FilterRequest)
	**/
	static public function FilterRequest(args:haxe.extern.Rest<Dynamic>):Void;
	...
	**/
	public var cookieAdded : Dynamic;
	/**
		cookieRemoved(self, QNetworkCookie) [signal]
	**/
	public var cookieRemoved : Dynamic;
	/**
	...
	**/
	public function deleteCookie(QNetworkCookie:Dynamic, ?origin:Dynamic):Void;
	/**
		deleteLater(self)
	**/
	...
	**/
	...
	/**
		loadAllCookies(self)
	**/
	public function loadAllCookies():Void;
	/**
	...
	**/
	public function setCookie(QNetworkCookie:Dynamic, ?origin:Dynamic):Void;
	/**
		setCookieFilter(self, filterCallback: Callable[[FilterRequest], bool] = 0)
	**/
	public function setCookieFilter(?filterCallback:Dynamic):Void;
	/**
