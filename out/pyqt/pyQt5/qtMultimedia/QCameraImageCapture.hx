...
@:pythonImport("PyQt5.QtMultimedia", "QCameraImageCapture") extern class QCameraImageCapture {
	/**
		int([x]) -> integer
	...
	**/
	static public function CaptureDestinations(args:haxe.extern.Rest<Dynamic>):Void;
	...
	**/
	public function bufferFormat():Dynamic;
	/**
		bufferFormatChanged(self, QVideoFrame.PixelFormat) [signal]
	**/
	public var bufferFormatChanged : Dynamic;
	/**
		cancelCapture(self)
	**/
	...
	**/
	public function capture(?file:Dynamic):Int;
	/**
		captureDestination(self) -> QCameraImageCapture.CaptureDestinations
	**/
	public function captureDestination():Dynamic;
	/**
	...
	**/
	public var captureDestinationChanged : Dynamic;
	/**
	...
	**/
	public function encodingSettings():Dynamic;
	/**
	...
	**/
	public var imageAvailable : Dynamic;
	/**
		imageCaptured(self, int, QImage) [signal]
	**/
	public var imageCaptured : Dynamic;
	/**
		imageCodecDescription(self, str) -> str
	**/
	public function imageCodecDescription(str:String):String;
	/**
		imageExposed(self, int) [signal]
	**/
	public var imageExposed : Dynamic;
	/**
		imageMetadataAvailable(self, int, str, Any) [signal]
	**/
	public var imageMetadataAvailable : Dynamic;
	/**
		imageSaved(self, int, str) [signal]
	**/
	public var imageSaved : Dynamic;
	/**
	...
	**/
	public function isCaptureDestinationSupported(Union:Dynamic):Bool;
	/**
	...
	**/
	public var readyForCaptureChanged : Dynamic;
	/**
	...
	**/
	public function setBufferFormat(QVideoFrame:Dynamic):Void;
	/**
		setCaptureDestination(self, Union[QCameraImageCapture.CaptureDestinations, QCameraImageCapture.CaptureDestination])
	**/
	public function setCaptureDestination(Union:Dynamic):Void;
	/**
		setEncodingSettings(self, QImageEncoderSettings)
	**/
	public function setEncodingSettings(QImageEncoderSettings:Dynamic):Void;
	/**
	...
	**/
	public function supportedBufferFormats():Dynamic;
	/**
		supportedImageCodecs(self) -> List[str]
	**/
	public function supportedImageCodecs():Dynamic;
	/**
