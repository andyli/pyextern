...
@:pythonImport("PyQt5.QtMultimedia", "QSound") extern class QSound {
	...
	**/
	...
	/**
		...
		play(self)
	**/
	static public function play(args:haxe.extern.Rest<Dynamic>):Void;
	/**
	...
	**/
	...
	/**
		setLoops(self, int)
	**/
	public function setLoops(int:Int):Void;
	/**
