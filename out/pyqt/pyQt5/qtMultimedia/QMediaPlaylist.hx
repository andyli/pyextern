...
@:pythonImport("PyQt5.QtMultimedia", "QMediaPlaylist") extern class QMediaPlaylist {
	...
	**/
	public function addMedia(args:haxe.extern.Rest<Dynamic>):Bool;
	/**
	...
	**/
	public function insertMedia(int:Int, args:haxe.extern.Rest<Dynamic>):Bool;
	/**
	...
	**/
	public function media(int:Int):Dynamic;
	/**
		mediaAboutToBeInserted(self, int, int) [signal]
	**/
	public var mediaAboutToBeInserted : Dynamic;
	/**
		mediaAboutToBeRemoved(self, int, int) [signal]
	**/
	public var mediaAboutToBeRemoved : Dynamic;
	/**
	...
	**/
	public var mediaInserted : Dynamic;
	/**
	...
	**/
	public var mediaRemoved : Dynamic;
	/**
	...
	**/
	public function moveMedia(int:Int, int:Int):Bool;
	/**
	...
	**/
	public function nextIndex(?steps:Dynamic):Int;
	/**
		objectName(self) -> str
	**/
	...
	**/
	public function playbackMode():Dynamic;
	/**
		playbackModeChanged(self, QMediaPlaylist.PlaybackMode) [signal]
	**/
	public var playbackModeChanged : Dynamic;
	/**
		previous(self)
	**/
	...
	**/
	public function previousIndex(?steps:Dynamic):Int;
	/**
	...
	**/
	public function removeMedia(int:Int, args:haxe.extern.Rest<Dynamic>):Bool;
	/**
	...
	**/
	public function setPlaybackMode(QMediaPlaylist:Dynamic):Void;
	/**
