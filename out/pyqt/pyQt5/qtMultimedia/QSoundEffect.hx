...
@:pythonImport("PyQt5.QtMultimedia", "QSoundEffect") extern class QSoundEffect {
	...
	**/
	public var categoryChanged : Dynamic;
	/**
	...
	**/
	public var loadedChanged : Dynamic;
	/**
		loopCount(self) -> int
	**/
	...
	**/
	public var loopCountChanged : Dynamic;
	/**
	...
	**/
	public var loopsRemainingChanged : Dynamic;
	/**
	...
	**/
	public var playingChanged : Dynamic;
	/**
	...
	**/
	public function setCategory(str:String):Void;
	/**
