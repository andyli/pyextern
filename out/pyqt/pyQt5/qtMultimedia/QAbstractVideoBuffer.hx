...
@:pythonImport("PyQt5.QtMultimedia", "QAbstractVideoBuffer") extern class QAbstractVideoBuffer {
	static public var CoreImageHandle : Dynamic;
	static public var EGLImageHandle : Dynamic;
	static public var GLTextureHandle : Dynamic;
	/**
		int([x]) -> integer
	...
	**/
	...
	static public var NoHandle : Dynamic;
	static public var NotMapped : Dynamic;
	static public var QPixmapHandle : Dynamic;
	static public var ReadOnly : Dynamic;
	static public var ReadWrite : Dynamic;
	static public var UserHandle : Dynamic;
	static public var WriteOnly : Dynamic;
	static public var XvShmImageHandle : Dynamic;
	...
	**/
	public function map(QAbstractVideoBuffer:Dynamic):Dynamic;
	/**
