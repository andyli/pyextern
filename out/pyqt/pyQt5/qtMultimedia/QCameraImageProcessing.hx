...
@:pythonImport("PyQt5.QtMultimedia", "QCameraImageProcessing") extern class QCameraImageProcessing {
	/**
		int([x]) -> integer
		...
		4
	**/
	public function ColorFilter(args:haxe.extern.Rest<Dynamic>):Dynamic;
	static public var ColorFilterAqua : Dynamic;
	static public var ColorFilterBlackboard : Dynamic;
	static public var ColorFilterGrayscale : Dynamic;
	static public var ColorFilterNegative : Dynamic;
	static public var ColorFilterNone : Dynamic;
	static public var ColorFilterPosterize : Dynamic;
	static public var ColorFilterSepia : Dynamic;
	static public var ColorFilterSolarize : Dynamic;
	static public var ColorFilterVendor : Dynamic;
	static public var ColorFilterWhiteboard : Dynamic;
	static public var WhiteBalanceAuto : Dynamic;
	static public var WhiteBalanceCloudy : Dynamic;
	static public var WhiteBalanceFlash : Dynamic;
	static public var WhiteBalanceFluorescent : Dynamic;
	static public var WhiteBalanceManual : Dynamic;
	/**
		int([x]) -> integer
		int(x, base=10) -> integer
		...
		4
	**/
	public function WhiteBalanceMode(args:haxe.extern.Rest<Dynamic>):Dynamic;
	static public var WhiteBalanceShade : Dynamic;
	static public var WhiteBalanceSunlight : Dynamic;
	static public var WhiteBalanceSunset : Dynamic;
	static public var WhiteBalanceTungsten : Dynamic;
	static public var WhiteBalanceVendor : Dynamic;
	...
	**/
	public function colorFilter():Dynamic;
	/**
	...
	**/
	public function isColorFilterSupported(QCameraImageProcessing:Dynamic):Bool;
	/**
	...
	**/
	public function isWhiteBalanceModeSupported(QCameraImageProcessing:Dynamic):Bool;
	/**
	...
	**/
	public function setBrightness(float:Float):Void;
	/**
		setColorFilter(self, QCameraImageProcessing.ColorFilter)
	**/
	public function setColorFilter(QCameraImageProcessing:Dynamic):Void;
	/**
		setContrast(self, float)
	**/
	public function setContrast(float:Float):Void;
	/**
		setDenoisingLevel(self, float)
	**/
	public function setDenoisingLevel(float:Float):Void;
	/**
		setManualWhiteBalance(self, float)
	**/
	public function setManualWhiteBalance(float:Float):Void;
	/**
	...
	**/
	public function setSaturation(float:Float):Void;
	/**
		setSharpeningLevel(self, float)
	**/
	public function setSharpeningLevel(float:Float):Void;
	/**
		setWhiteBalanceMode(self, QCameraImageProcessing.WhiteBalanceMode)
	**/
	public function setWhiteBalanceMode(QCameraImageProcessing:Dynamic):Void;
	/**
	...
	**/
	public function whiteBalanceMode():Dynamic;
}