...
package pyQt5.qtQml;
@:pythonImport("PyQt5.QtQml", "QQmlContext") extern class QQmlContext {
	/**
		QQmlContext.PropertyPair()
		QQmlContext.PropertyPair(QQmlContext.PropertyPair)
	**/
	static public function PropertyPair(args:haxe.extern.Rest<Dynamic>):Void;
	...
	**/
	public function contextObject():Dynamic;
	/**
		contextProperty(self, str) -> Any
	**/
	public function contextProperty(str:String):Dynamic;
	/**
	...
	**/
	public function nameForObject(QObject:Dynamic):String;
	/**
		objectName(self) -> str
	**/
	...
	**/
	public function parentContext():Dynamic;
	/**
	...
	**/
	public function resolvedUrl(QUrl:Dynamic):Dynamic;
	/**
		sender(self) -> QObject
	**/
	...
	**/
	public function setContextObject(QObject:Dynamic):Void;
	/**
		setContextProperties(self, Iterable[QQmlContext.PropertyPair])
	**/
	public function setContextProperties(Iterable:Dynamic):Void;
	/**
		setContextProperty(self, str, QObject)
		setContextProperty(self, str, Any)
	**/
	public function setContextProperty(str:String, args:haxe.extern.Rest<Dynamic>):Void;
	/**
