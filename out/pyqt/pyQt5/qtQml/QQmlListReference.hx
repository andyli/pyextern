...
package pyQt5.qtQml;
@:pythonImport("PyQt5.QtQml", "QQmlListReference") extern class QQmlListReference {
	...
	**/
	public function append(QObject:Dynamic):Bool;
	/**
		at(self, int) -> QObject
	**/
	...
	**/
	public function listElementType():Dynamic;
	/**
		object(self) -> QObject
	**/
