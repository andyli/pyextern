...
package pyQt5.qtQml;
@:pythonImport("PyQt5.QtQml", "QQmlApplicationEngine") extern class QQmlApplicationEngine {
	...
	**/
	public function importModule(str:String):Dynamic;
	/**
	...
	**/
	public function importPlugin(str:String, str:String, Iterable:Dynamic):Bool;
	/**
	...
	**/
	public function loadData(Union:Dynamic, ?url:Dynamic):Void;
	/**
	...
	**/
	public function newErrorObject(QJSValue:Dynamic, ?message:Dynamic):Dynamic;
	/**
	...
	**/
	public function newQMetaObject(QMetaObject:Dynamic):Dynamic;
	/**
	...
	**/
	public var objectCreated : Dynamic;
	/**
		objectName(self) -> str
	**/
	...
	**/
	public function offlineStorageDatabaseFilePath(str:String):String;
	/**
	...
	**/
	...
	/**
		retranslate(self)
	**/
	public function retranslate():Void;
	/**
	...
	**/
	public function rootObjects():Dynamic;
	/**
		sender(self) -> QObject
	**/
	...
	**/
	public function singletonInstance(int:Int):Dynamic;
	/**
	...
	**/
	public function throwError(args:haxe.extern.Rest<Dynamic>):Void;
	/**
