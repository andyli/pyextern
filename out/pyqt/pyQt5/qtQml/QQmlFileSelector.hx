...
package pyQt5.qtQml;
@:pythonImport("PyQt5.QtQml", "QQmlFileSelector") extern class QQmlFileSelector {
	...
	**/
	static public function get(QQmlEngine:Dynamic):Dynamic;
	/**
	...
	**/
	public function selector():Dynamic;
	/**
		sender(self) -> QObject
	**/
	...
	**/
	public function setExtraSelectors(Iterable:Dynamic):Void;
	/**
	...
	**/
	public function setSelector(QFileSelector:Dynamic):Void;
	/**
