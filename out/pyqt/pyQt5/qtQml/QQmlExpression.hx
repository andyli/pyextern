...
package pyQt5.qtQml;
@:pythonImport("PyQt5.QtQml", "QQmlExpression") extern class QQmlExpression {
	...
	**/
	public function scopeObject():Dynamic;
	/**
		sender(self) -> QObject
	**/
	...
	**/
	public function setExpression(str:String):Void;
	/**
		setNotifyOnValueChanged(self, bool)
	**/
	public function setNotifyOnValueChanged(bool:Bool):Void;
	/**
	...
	**/
	public function setSourceLocation(str:String, int:Int, ?column:Dynamic):Void;
	/**
