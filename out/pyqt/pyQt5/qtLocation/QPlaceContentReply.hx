...
@:pythonImport("PyQt5.QtLocation", "QPlaceContentReply") extern class QPlaceContentReply {
	static public var BadArgumentError : Dynamic;
	static public var CancelError : Dynamic;
	static public var CategoryDoesNotExistError : Dynamic;
	static public var CommunicationError : Dynamic;
	static public var ContentReply : Dynamic;
	static public var DetailsReply : Dynamic;
	/**
		int([x]) -> integer
	...
	**/
	...
	static public var IdReply : Dynamic;
	static public var MatchReply : Dynamic;
	static public var NoError : Dynamic;
	static public var ParseError : Dynamic;
	static public var PermissionsError : Dynamic;
	static public var PlaceDoesNotExistError : Dynamic;
	static public var Reply : Dynamic;
	static public var SearchReply : Dynamic;
	static public var SearchSuggestionReply : Dynamic;
	/**
		int([x]) -> integer
		int(x, base=10) -> integer
	...
	**/
	public function content():Dynamic;
	/**
		contentUpdated(self) [signal]
	**/
	public var contentUpdated : Dynamic;
	/**
	...
	**/
	public function nextPageRequest():Dynamic;
	/**
		objectName(self) -> str
	**/
	...
	**/
	public function previousPageRequest():Dynamic;
	/**
	...
	**/
	public function setContent(Dict:Dynamic):Void;
	/**
		setError(self, QPlaceReply.Error, str)
	**/
	public function setError(QPlaceReply:Dynamic, str:String):Void;
	/**
	...
	**/
	public function setNextPageRequest(QPlaceContentRequest:Dynamic):Void;
	/**
	...
	**/
	public function setPreviousPageRequest(QPlaceContentRequest:Dynamic):Void;
	/**
	...
	**/
	public function setRequest(QPlaceContentRequest:Dynamic):Void;
	/**
		setTotalCount(self, int)
	**/
	public function setTotalCount(int:Int):Void;
	/**
