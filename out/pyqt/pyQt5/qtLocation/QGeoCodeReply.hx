...
@:pythonImport("PyQt5.QtLocation", "QGeoCodeReply") extern class QGeoCodeReply {
	static public var CombinationError : Dynamic;
	static public var CommunicationError : Dynamic;
	static public var EngineNotSetError : Dynamic;
	/**
		int([x]) -> integer
	...
	**/
	...
	static public var UnsupportedOptionError : Dynamic;
	...
	**/
	public function addLocation(QGeoLocation:Dynamic):Void;
	/**
	...
	**/
	public function locations():Dynamic;
	/**
	...
	**/
	public function setError(QGeoCodeReply:Dynamic, str:String):Void;
	/**
	...
	**/
	public function setLocations(Iterable:Dynamic):Void;
	/**
	...
	**/
	public function setViewport(QGeoShape:Dynamic):Void;
	/**
