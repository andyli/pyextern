...
@:pythonImport("PyQt5.QtLocation", "QPlaceManager") extern class QPlaceManager {
	...
	**/
	public function childCategories(?parentId:Dynamic):Dynamic;
	/**
		childCategoryIds(self, parentId: str = '') -> List[str]
	**/
	public function childCategoryIds(?parentId:Dynamic):Dynamic;
	/**
	...
	**/
	public function saveCategory(QPlaceCategory:Dynamic, ?parentId:Dynamic):Dynamic;
	/**
