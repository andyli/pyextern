...
@:pythonImport("PyQt5.QtLocation", "QGeoCodingManagerEngine") extern class QGeoCodingManagerEngine {
	...
	**/
	public function geocode(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	public function reverseGeocode(QGeoCoordinate:Dynamic, QGeoShape:Dynamic):Dynamic;
	/**
		sender(self) -> QObject
	**/
