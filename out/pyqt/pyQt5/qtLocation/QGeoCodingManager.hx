...
@:pythonImport("PyQt5.QtLocation", "QGeoCodingManager") extern class QGeoCodingManager {
	...
	**/
	public function reverseGeocode(QGeoCoordinate:Dynamic, ?bounds:Dynamic):Dynamic;
	/**
		sender(self) -> QObject
	**/
