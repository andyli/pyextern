...
@:pythonImport("PyQt5.QtLocation", "QPlaceSearchReply") extern class QPlaceSearchReply {
	...
	**/
	public function results():Dynamic;
	/**
		sender(self) -> QObject
	**/
	...
	**/
	public function setNextPageRequest(QPlaceSearchRequest:Dynamic):Void;
	/**
	...
	**/
	public function setPreviousPageRequest(QPlaceSearchRequest:Dynamic):Void;
	/**
	...
	**/
	public function setRequest(QPlaceSearchRequest:Dynamic):Void;
	/**
		setResults(self, Iterable[QPlaceSearchResult])
	**/
	public function setResults(Iterable:Dynamic):Void;
	/**
