...
@:pythonImport("PyQt5.QtLocation", "QPlaceMatchReply") extern class QPlaceMatchReply {
	...
	**/
	public function places():Dynamic;
	/**
	...
	**/
	public function setPlaces(Iterable:Dynamic):Void;
	/**
	...
	**/
	public function setRequest(QPlaceMatchRequest:Dynamic):Void;
	/**
