...
@:pythonImport("PyQt5.QtLocation", "QGeoRouteReply") extern class QGeoRouteReply {
	...
	**/
	public function addRoutes(Iterable:Dynamic):Void;
	/**
	...
	**/
	public function routes():Dynamic;
	/**
		sender(self) -> QObject
	**/
	...
	**/
	public function setError(QGeoRouteReply:Dynamic, str:String):Void;
	/**
	...
	**/
	public function setRoutes(Iterable:Dynamic):Void;
	/**
