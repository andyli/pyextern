...
@:pythonImport("PyQt5.QtLocation", "QPlaceManagerEngine") extern class QPlaceManagerEngine {
	...
	**/
	public function category(str:String):Dynamic;
	/**
		categoryAdded(self, QPlaceCategory, str) [signal]
	**/
	public var categoryAdded : Dynamic;
	/**
		categoryRemoved(self, str, str) [signal]
	**/
	public var categoryRemoved : Dynamic;
	/**
		categoryUpdated(self, QPlaceCategory, str) [signal]
	**/
	public var categoryUpdated : Dynamic;
	/**
		childCategories(self, str) -> List[QPlaceCategory]
	**/
	public function childCategories(str:String):Dynamic;
	/**
		childCategoryIds(self, str) -> List[str]
	**/
	public function childCategoryIds(str:String):Dynamic;
	/**
	...
	**/
	public function compatiblePlace(QPlace:Dynamic):Dynamic;
	/**
	...
	**/
	public function constructIconUrl(QPlaceIcon:Dynamic, QSize:Dynamic):Dynamic;
	/**
	...
	**/
	public function getPlaceContent(QPlaceContentRequest:Dynamic):Dynamic;
	/**
		getPlaceDetails(self, str) -> QPlaceDetailsReply
	**/
	public function getPlaceDetails(str:String):Dynamic;
	/**
	...
	**/
	public function initializeCategories():Dynamic;
	/**
	...
	**/
	public function locales():Dynamic;
	/**
	...
	**/
	public function matchingPlaces(QPlaceMatchRequest:Dynamic):Dynamic;
	/**
	...
	**/
	public function parentCategoryId(str:String):String;
	/**
		placeAdded(self, str) [signal]
	**/
	public var placeAdded : Dynamic;
	/**
		placeRemoved(self, str) [signal]
	**/
	public var placeRemoved : Dynamic;
	/**
		placeUpdated(self, str) [signal]
	**/
	public var placeUpdated : Dynamic;
	/**
	...
	**/
	public function removeCategory(str:String):Dynamic;
	/**
	...
	**/
	public function removePlace(str:String):Dynamic;
	/**
		saveCategory(self, QPlaceCategory, str) -> QPlaceIdReply
	**/
	public function saveCategory(QPlaceCategory:Dynamic, str:String):Dynamic;
	/**
		savePlace(self, QPlace) -> QPlaceIdReply
	**/
	public function savePlace(QPlace:Dynamic):Dynamic;
	/**
		search(self, QPlaceSearchRequest) -> QPlaceSearchReply
	**/
	public function search(QPlaceSearchRequest:Dynamic):Dynamic;
	/**
		searchSuggestions(self, QPlaceSearchRequest) -> QPlaceSearchSuggestionReply
	**/
	public function searchSuggestions(QPlaceSearchRequest:Dynamic):Dynamic;
	/**
		sender(self) -> QObject
	**/
	...
	**/
	public function setLocales(Iterable:Dynamic):Void;
	/**
