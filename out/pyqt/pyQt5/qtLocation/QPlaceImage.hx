...
@:pythonImport("PyQt5.QtLocation", "QPlaceImage") extern class QPlaceImage {
	...
	**/
	...
	/**
		setImageId(self, str)
	**/
	public function setImageId(str:String):Void;
	/**
		setMimeType(self, str)
	**/
	public function setMimeType(str:String):Void;
	/**
