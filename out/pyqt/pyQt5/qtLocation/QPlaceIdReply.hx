...
@:pythonImport("PyQt5.QtLocation", "QPlaceIdReply") extern class QPlaceIdReply {
	...
	**/
	...
	/**
		...
		4
	**/
	public function OperationType(args:haxe.extern.Rest<Dynamic>):Dynamic;
	...
	static public var RemoveCategory : Dynamic;
	static public var RemovePlace : Dynamic;
	static public var Reply : Dynamic;
	static public var SaveCategory : Dynamic;
	static public var SavePlace : Dynamic;
	...
	**/
	public function operationType():Dynamic;
	/**
		parent(self) -> QObject
	**/
	...
	**/
	...
	/**
		setId(self, str)
	**/
	public function setId(str:String):Void;
	/**
