...
@:pythonImport("PyQt5.QtLocation", "QPlaceSearchSuggestionReply") extern class QPlaceSearchSuggestionReply {
	...
	**/
	public function setSuggestions(Iterable:Dynamic):Void;
	/**
	...
	**/
	public function suggestions():Dynamic;
	/**
		thread(self) -> QThread
	**/
