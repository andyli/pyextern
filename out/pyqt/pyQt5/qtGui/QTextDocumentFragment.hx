...
package pyQt5.qtGui;
@:pythonImport("PyQt5.QtGui", "QTextDocumentFragment") extern class QTextDocumentFragment {
	...
	**/
	static public function fromHtml(str:String, args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
		fromPlainText(str) -> QTextDocumentFragment
	**/
	static public function fromPlainText(str:String):Dynamic;
	/**
		isEmpty(self) -> bool
	**/
