...
package pyQt5.qtGui;
@:pythonImport("PyQt5.QtGui", "QInputMethodEvent") extern class QInputMethodEvent {
	...
	**/
	static public function Attribute(QInputMethodEvent:Dynamic, args:haxe.extern.Rest<Dynamic>):Void;
	/**
		int([x]) -> integer
	...
	**/
	...
	static public var Ruby : Dynamic;
	...
	**/
	public function setCommitString(str:String, ?from:Dynamic, ?length:Dynamic):Void;
	/**
