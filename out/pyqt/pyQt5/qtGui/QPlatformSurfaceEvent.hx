...
package pyQt5.qtGui;
@:pythonImport("PyQt5.QtGui", "QPlatformSurfaceEvent") extern class QPlatformSurfaceEvent {
	...
	static public var SurfaceAboutToBeDestroyed : Dynamic;
	static public var SurfaceCreated : Dynamic;
	/**
		int([x]) -> integer
		...
		4
	**/
	public function SurfaceEventType(args:haxe.extern.Rest<Dynamic>):Dynamic;
	...
	**/
	public function surfaceEventType():Dynamic;
	/**
