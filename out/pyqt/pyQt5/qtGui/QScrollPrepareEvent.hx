...
package pyQt5.qtGui;
@:pythonImport("PyQt5.QtGui", "QScrollPrepareEvent") extern class QScrollPrepareEvent {
	...
	**/
	public function contentPos():Dynamic;
	/**
		contentPosRange(self) -> QRectF
	**/
	public function contentPosRange():Dynamic;
	/**
		ignore(self)
	**/
	...
	**/
	public function setContentPos(Union:Dynamic):Void;
	/**
		setContentPosRange(self, QRectF)
	**/
	public function setContentPosRange(QRectF:Dynamic):Void;
	/**
		setViewportSize(self, QSizeF)
	**/
	public function setViewportSize(QSizeF:Dynamic):Void;
	/**
	...
	**/
	public function startPos():Dynamic;
	/**
	...
	**/
	public function viewportSize():Dynamic;
}