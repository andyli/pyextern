...
package pyQt5.qtGui;
@:pythonImport("PyQt5.QtGui", "QInputMethod") extern class QInputMethod {
	/**
		int([x]) -> integer
	...
	**/
	public function anchorRectangle():Dynamic;
	/**
		anchorRectangleChanged(self) [signal]
	**/
	public var anchorRectangleChanged : Dynamic;
	/**
		animatingChanged(self) [signal]
	**/
	public var animatingChanged : Dynamic;
	/**
	...
	**/
	public function cursorRectangle():Dynamic;
	/**
		cursorRectangleChanged(self) [signal]
	**/
	public var cursorRectangleChanged : Dynamic;
	/**
	...
	**/
	public function inputDirection():Dynamic;
	/**
		inputDirectionChanged(self, Qt.LayoutDirection) [signal]
	**/
	public var inputDirectionChanged : Dynamic;
	/**
		inputItemClipRectangle(self) -> QRectF
	**/
	public function inputItemClipRectangle():Dynamic;
	/**
		inputItemClipRectangleChanged(self) [signal]
	**/
	public var inputItemClipRectangleChanged : Dynamic;
	/**
		inputItemRectangle(self) -> QRectF
	**/
	public function inputItemRectangle():Dynamic;
	/**
		inputItemTransform(self) -> QTransform
	**/
	public function inputItemTransform():Dynamic;
	/**
	...
	**/
	public function invokeAction(QInputMethod:Dynamic, int:Int):Void;
	/**
	...
	**/
	public function keyboardRectangle():Dynamic;
	/**
		keyboardRectangleChanged(self) [signal]
	**/
	public var keyboardRectangleChanged : Dynamic;
	/**
		killTimer(self, int)
	**/
	...
	**/
	public var localeChanged : Dynamic;
	/**
	...
	**/
	static public function queryFocusObject(Qt:Dynamic, Any:Dynamic):Dynamic;
	/**
	...
	**/
	public function setInputItemRectangle(QRectF:Dynamic):Void;
	/**
		setInputItemTransform(self, QTransform)
	**/
	public function setInputItemTransform(QTransform:Dynamic):Void;
	/**
	...
	**/
	public function update(Union:Dynamic):Void;
	/**
