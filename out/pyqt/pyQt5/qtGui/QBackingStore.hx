...
package pyQt5.qtGui;
@:pythonImport("PyQt5.QtGui", "QBackingStore") extern class QBackingStore {
	...
	**/
	public function beginPaint(QRegion:Dynamic):Void;
	/**
		endPaint(self)
	**/
	...
	**/
	public function flush(QRegion:Dynamic, ?window:Dynamic, ?offset:Dynamic):Void;
	/**
	...
	**/
	...
	/**
		resize(self, QSize)
	**/
	public function resize(QSize:Dynamic):Void;
	/**
		scroll(self, QRegion, int, int) -> bool
	**/
	public function scroll(QRegion:Dynamic, int:Int, int:Int):Bool;
	/**
		setStaticContents(self, QRegion)
	**/
	public function setStaticContents(QRegion:Dynamic):Void;
	/**
		size(self) -> QSize
	**/
	...
	**/
	public function staticContents():Dynamic;
	/**
		window(self) -> QWindow
	**/
