...
package pyQt5.qtGui;
@:pythonImport("PyQt5.QtGui", "QSyntaxHighlighter") extern class QSyntaxHighlighter {
	...
	**/
	public function currentBlock():Dynamic;
	/**
	...
	**/
	public function currentBlockUserData():Dynamic;
	/**
	...
	**/
	public function highlightBlock(str:String):Void;
	/**
	...
	**/
	...
	/**
		rehighlight(self)
	**/
	public function rehighlight():Void;
	/**
		rehighlightBlock(self, QTextBlock)
	**/
	public function rehighlightBlock(QTextBlock:Dynamic):Void;
	/**
	...
	**/
	public function setCurrentBlockState(int:Int):Void;
	/**
		setCurrentBlockUserData(self, QTextBlockUserData)
	**/
	public function setCurrentBlockUserData(QTextBlockUserData:Dynamic):Void;
	/**
	...
	**/
	public function setFormat(int:Int, int:Int, args:haxe.extern.Rest<Dynamic>):Void;
	/**
