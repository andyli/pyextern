...
package pyQt5.qtGui;
@:pythonImport("PyQt5.QtGui", "QDrag") extern class QDrag {
	...
	**/
	public var actionChanged : Dynamic;
	/**
	...
	**/
	public function dragCursor(Qt:Dynamic):Dynamic;
	/**
		dumpObjectInfo(self)
	**/
	...
	**/
	public function setDragCursor(QPixmap:Dynamic, Qt:Dynamic):Void;
	/**
		setHotSpot(self, QPoint)
	**/
	public function setHotSpot(QPoint:Dynamic):Void;
	/**
		setMimeData(self, QMimeData)
	**/
	public function setMimeData(QMimeData:Dynamic):Void;
	/**
	...
	**/
	public function supportedActions():Dynamic;
	/**
		target(self) -> QObject
	**/
	...
	**/
	public var targetChanged : Dynamic;
	/**
		thread(self) -> QThread
	**/
