...
package pyQt5.qtGui;
@:pythonImport("PyQt5.QtGui", "QOpenGLTimeMonitor") extern class QOpenGLTimeMonitor {
	...
	**/
	public function objectIds():Dynamic;
	/**
		objectName(self) -> str
	**/
	...
	**/
	public function setSampleCount(int:Int):Void;
	/**
	...
	**/
	public function waitForIntervals():Dynamic;
	/**
		waitForSamples(self) -> List[int]
	**/
	public function waitForSamples():Dynamic;
}