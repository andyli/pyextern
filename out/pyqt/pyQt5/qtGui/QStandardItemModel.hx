...
package pyQt5.qtGui;
@:pythonImport("PyQt5.QtGui", "QStandardItemModel") extern class QStandardItemModel {
	/**
		An enumeration.
	**/
	...
	**/
	public function appendColumn(Iterable:Dynamic):Void;
	/**
		appendRow(self, Iterable[QStandardItem])
		appendRow(self, QStandardItem)
	**/
	public function appendRow(args:haxe.extern.Rest<Dynamic>):Void;
	/**
	...
	**/
	public function clearItemData(QModelIndex:Dynamic):Bool;
	/**
	...
	**/
	public function findItems(str:String, ?flags:Dynamic, ?column:Dynamic):Dynamic;
	/**
	...
	**/
	public function indexFromItem(QStandardItem:Dynamic):Dynamic;
	/**
	...
	**/
	public function insertColumn(int:Int, args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	public function insertRow(int:Int, args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	public function item(int:Int, ?column:Dynamic):Dynamic;
	/**
	...
	**/
	public function setHorizontalHeaderItem(int:Int, QStandardItem:Dynamic):Void;
	/**
	...
	**/
	public function setItem(int:Int, args:haxe.extern.Rest<Dynamic>):Void;
	/**
	...
	**/
	public function setItemPrototype(QStandardItem:Dynamic):Void;
	/**
		setItemRoleNames(self, Dict[int, Union[QByteArray, bytes, bytearray]])
	**/
	public function setItemRoleNames(Dict:Dynamic):Void;
	/**
	...
	**/
	public function setVerticalHeaderItem(int:Int, QStandardItem:Dynamic):Void;
	/**
	...
	**/
	public function takeColumn(int:Int):Dynamic;
	/**
	...
	**/
	public function takeItem(int:Int, ?column:Dynamic):Dynamic;
	/**
		takeRow(self, int) -> List[QStandardItem]
	**/
	public function takeRow(int:Int):Dynamic;
	/**
