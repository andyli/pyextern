...
package pyQt5.qtGui;
@:pythonImport("PyQt5.QtGui", "QVector2D") extern class QVector2D {
	/**
		Return self+value.
	**/
	...
	**/
	public function distanceToLine(QVector2D:Dynamic, QVector2D:Dynamic):Float;
	/**
		distanceToPoint(self, QVector2D) -> float
	**/
	public function distanceToPoint(QVector2D:Dynamic):Float;
	/**
		dotProduct(QVector2D, QVector2D) -> float
	**/
	static public function dotProduct(QVector2D:Dynamic, QVector2D:Dynamic):Float;
	/**
		isNull(self) -> bool
	**/
