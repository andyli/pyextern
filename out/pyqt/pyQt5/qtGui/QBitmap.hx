...
package pyQt5.qtGui;
@:pythonImport("PyQt5.QtGui", "QBitmap") extern class QBitmap {
	/**
		int([x]) -> integer
	...
	**/
	static public function fromData(QSize:Dynamic, bytes:Dynamic, ?format:Dynamic):Dynamic;
	/**
	...
	**/
	...
	/**
		swap(self, QBitmap)
	**/
	public function swap(QBitmap:Dynamic):Void;
	/**
		toImage(self) -> QImage
	**/
	...
	**/
	public function transformed(QTransform:Dynamic):Dynamic;
	/**
