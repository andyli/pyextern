...
package pyQt5.qtGui;
@:pythonImport("PyQt5.QtGui", "QOpenGLPaintDevice") extern class QOpenGLPaintDevice {
	/**
		int([x]) -> integer
	...
	**/
	public function ensureActiveTarget():Void;
	/**
		height(self) -> int
	**/
	...
	**/
	public function setDotsPerMeterX(float:Float):Void;
	/**
		setDotsPerMeterY(self, float)
	**/
	public function setDotsPerMeterY(float:Float):Void;
	/**
		setPaintFlipped(self, bool)
	**/
	public function setPaintFlipped(bool:Bool):Void;
	/**
		setSize(self, QSize)
	**/
