...
package pyQt5.qtGui;
@:pythonImport("PyQt5.QtGui", "QOpenGLTextureBlitter") extern class QOpenGLTextureBlitter {
	/**
		int([x]) -> integer
	...
	**/
	...
	static public var OriginBottomLeft : Dynamic;
	static public var OriginTopLeft : Dynamic;
	...
	**/
	public function blit(int:Int, QMatrix4x4:Dynamic, args:haxe.extern.Rest<Dynamic>):Void;
	/**
		create(self) -> bool
	**/
	...
	**/
	public function setRedBlueSwizzle(bool:Bool):Void;
	/**
		sourceTransform(QRectF, QSize, QOpenGLTextureBlitter.Origin) -> QMatrix3x3
	**/
	static public function sourceTransform(QRectF:Dynamic, QSize:Dynamic, QOpenGLTextureBlitter:Dynamic):Dynamic;
	/**
	...
	**/
	static public function targetTransform(QRectF:Dynamic, QRect:Dynamic):Dynamic;
}