...
@:pythonImport("PyQt5.QtGui", "QGuiApplication") extern class QGuiApplication {
	...
	**/
	public var applicationDisplayNameChanged : Dynamic;
	/**
	...
	**/
	...
	/**
		desktopFileName() -> str
	**/
	static public function desktopFileName():String;
	/**
	...
	**/
	static public function inputMethod():Dynamic;
	/**
	...
	**/
	static public function screenAt(QPoint:Dynamic):Dynamic;
	/**
	...
	**/
	static public function setDesktopFileName(str:String):Void;
	/**
	...
	**/
	static public function styleHints():Dynamic;
	/**
		sync()
	**/
