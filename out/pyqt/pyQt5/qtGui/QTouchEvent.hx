...
package pyQt5.qtGui;
@:pythonImport("PyQt5.QtGui", "QTouchEvent") extern class QTouchEvent {
	...
	**/
	public function setDevice(QTouchDevice:Dynamic):Void;
	/**
	...
	**/
	public function touchPointStates():Dynamic;
	/**
		touchPoints(self) -> List[QTouchEvent.TouchPoint]
	**/
	public function touchPoints():Dynamic;
	/**
