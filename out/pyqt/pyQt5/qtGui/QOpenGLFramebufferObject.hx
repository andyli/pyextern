...
@:pythonImport("PyQt5.QtGui", "QOpenGLFramebufferObject") extern class QOpenGLFramebufferObject {
	...
	**/
	...
	static public var DontRestoreFramebufferBinding : Dynamic;
	/**
		int([x]) -> integer
		int(x, base=10) -> integer
		...
		4
	**/
	public function FramebufferRestorePolicy(args:haxe.extern.Rest<Dynamic>):Dynamic;
	static public var NoAttachment : Dynamic;
	static public var RestoreFrameBufferBinding : Dynamic;
	static public var RestoreFramebufferBindingToDefault : Dynamic;
