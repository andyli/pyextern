...
package pyQt5.qtGui;
@:pythonImport("PyQt5.QtGui", "QOpenGLContext") extern class QOpenGLContext {
	...
	**/
	public var aboutToBeDestroyed : Dynamic;
	/**
		areSharing(QOpenGLContext, QOpenGLContext) -> bool
	**/
	static public function areSharing(QOpenGLContext:Dynamic, QOpenGLContext:Dynamic):Bool;
	/**
	...
	**/
	public function getProcAddress(Union:Dynamic):Dynamic;
	/**
		globalShareContext() -> QOpenGLContext
	**/
	static public function globalShareContext():Dynamic;
	/**
		hasExtension(self, Union[QByteArray, bytes, bytearray]) -> bool
	**/
	public function hasExtension(Union:Dynamic):Bool;
	/**
	...
	**/
	public function makeCurrent(QSurface:Dynamic):Bool;
	/**
	...
	**/
	static public function openGLModuleHandle():Dynamic;
	/**
		openGLModuleType() -> QOpenGLContext.OpenGLModuleType
	**/
	static public function openGLModuleType():Dynamic;
	/**
		parent(self) -> QObject
	**/
	...
	**/
	public function setNativeHandle(Any:Dynamic):Void;
	/**
	...
	**/
	public function setShareContext(QOpenGLContext:Dynamic):Void;
	/**
		shareContext(self) -> QOpenGLContext
	**/
	public function shareContext():Dynamic;
	/**
		shareGroup(self) -> QOpenGLContextGroup
	**/
	public function shareGroup():Dynamic;
	/**
	...
	**/
	static public function supportsThreadedOpenGL():Bool;
	/**
		surface(self) -> QSurface
	**/
	public function surface():Dynamic;
	/**
		swapBuffers(self, QSurface)
	**/
	public function swapBuffers(QSurface:Dynamic):Void;
	/**
		thread(self) -> QThread
	**/
	...
	**/
	public function versionFunctions(?versionProfile:Dynamic):Dynamic;
}