...
package pyQt5.qtGui;
@:pythonImport("PyQt5.QtGui", "QOpenGLTimerQuery") extern class QOpenGLTimerQuery {
	...
	**/
	public function recordTimestamp():Void;
	/**
	...
	**/
	public function waitForResult():Int;
	/**
		waitForTimestamp(self) -> int
	**/
	public function waitForTimestamp():Int;
}