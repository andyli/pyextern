...
@:pythonImport("PyQt5.QtGui", "QIcon") extern class QIcon {
	...
	**/
	static public function fallbackSearchPaths():Dynamic;
	/**
		fallbackThemeName() -> str
	**/
	static public function fallbackThemeName():String;
	/**
		fromTheme(str) -> QIcon
		fromTheme(str, QIcon) -> QIcon
	**/
	static public function fromTheme(str:String, args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	static public function setFallbackSearchPaths(Iterable:Dynamic):Void;
	/**
		setFallbackThemeName(str)
	**/
	static public function setFallbackThemeName(str:String):Void;
	/**
		setIsMask(self, bool)
	**/
