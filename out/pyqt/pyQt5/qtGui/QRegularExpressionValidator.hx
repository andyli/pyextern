...
package pyQt5.qtGui;
@:pythonImport("PyQt5.QtGui", "QRegularExpressionValidator") extern class QRegularExpressionValidator {
	...
	**/
	public function setRegularExpression(QRegularExpression:Dynamic):Void;
	/**
