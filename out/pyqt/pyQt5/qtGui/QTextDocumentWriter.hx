...
package pyQt5.qtGui;
@:pythonImport("PyQt5.QtGui", "QTextDocumentWriter") extern class QTextDocumentWriter {
	...
	**/
	static public function supportedDocumentFormats():Dynamic;
	/**
		write(self, QTextDocument) -> bool
		write(self, QTextDocumentFragment) -> bool
	**/
	public function write(args:haxe.extern.Rest<Dynamic>):Bool;
}