...
package pyQt5.qtGui;
@:pythonImport("PyQt5.QtGui", "QScrollEvent") extern class QScrollEvent {
	...
	static public var ScrollFinished : Dynamic;
	static public var ScrollPrepare : Dynamic;
	static public var ScrollStarted : Dynamic;
	/**
		int([x]) -> integer
		...
		4
	**/
	public function ScrollState(args:haxe.extern.Rest<Dynamic>):Dynamic;
	static public var ScrollUpdated : Dynamic;
	...
	**/
	public function overshootDistance():Dynamic;
	/**
	...
	**/
	public function scrollState():Dynamic;
	/**
