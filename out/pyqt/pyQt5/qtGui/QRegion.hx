...
package pyQt5.qtGui;
@:pythonImport("PyQt5.QtGui", "QRegion") extern class QRegion {
	static public var Ellipse : Dynamic;
	...
	/**
		...
		4
	**/
	public function RegionType(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
		Return self+value.
	**/
	...
	**/
	public function rects():Dynamic;
	/**
		setRects(self, Iterable[QRect])
	**/
	public function setRects(Iterable:Dynamic):Void;
	/**
		subtracted(self, QRegion) -> QRegion
	**/
	public function subtracted(QRegion:Dynamic):Dynamic;
	/**
		swap(self, QRegion)
	**/
	public function swap(QRegion:Dynamic):Void;
	/**
	...
	**/
	public function xored(QRegion:Dynamic):Dynamic;
}