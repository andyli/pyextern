...
package pyQt5.qtGui;
@:pythonImport("PyQt5.QtGui", "QClipboard") extern class QClipboard {
	...
	**/
	public function clear(?mode:Dynamic):Void;
	/**
	...
	**/
	public var findBufferChanged : Dynamic;
	/**
	...
	**/
	public function image(?mode:Dynamic):Dynamic;
	/**
	...
	**/
	public function mimeData(?mode:Dynamic):Dynamic;
	/**
	...
	**/
	public function pixmap(?mode:Dynamic):Dynamic;
	/**
	...
	**/
	public function setImage(QImage:Dynamic, ?mode:Dynamic):Void;
	/**
		setMimeData(self, QMimeData, mode: QClipboard.Mode = QClipboard.Clipboard)
	**/
	public function setMimeData(QMimeData:Dynamic, ?mode:Dynamic):Void;
	/**
	...
	**/
	public function setPixmap(QPixmap:Dynamic, ?mode:Dynamic):Void;
	/**
	...
	**/
	public function setText(str:String, ?mode:Dynamic):Void;
	/**
