...
@:pythonImport("PyQt5.QtGui", "QOpenGLShaderProgram") extern class QOpenGLShaderProgram {
	...
	**/
	public function addCacheableShaderFromSourceCode(Union:Dynamic, args:haxe.extern.Rest<Dynamic>):Bool;
	/**
		addCacheableShaderFromSourceFile(self, Union[QOpenGLShader.ShaderType, QOpenGLShader.ShaderTypeBit], str) -> bool
	**/
	public function addCacheableShaderFromSourceFile(Union:Dynamic, str:String):Bool;
	/**
