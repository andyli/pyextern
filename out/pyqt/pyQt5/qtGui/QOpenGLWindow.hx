...
package pyQt5.qtGui;
@:pythonImport("PyQt5.QtGui", "QOpenGLWindow") extern class QOpenGLWindow {
	/**
		int([x]) -> integer
	...
	**/
	...
	static public var PartialUpdateBlend : Dynamic;
	static public var PartialUpdateBlit : Dynamic;
	...
	**/
	public function grabFramebuffer():Dynamic;
	/**
		height(self) -> int
	**/
	...
	**/
	...
	/**
		paintOverGL(self)
	**/
	public function paintOverGL():Void;
	/**
		paintUnderGL(self)
	**/
	public function paintUnderGL():Void;
	/**
	...
	**/
	public function updateBehavior():Dynamic;
	/**
