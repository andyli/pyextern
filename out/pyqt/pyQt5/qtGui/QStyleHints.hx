...
@:pythonImport("PyQt5.QtGui", "QStyleHints") extern class QStyleHints {
	...
	**/
	public var mousePressAndHoldIntervalChanged : Dynamic;
	/**
	...
	**/
	public var mouseQuickSelectionThresholdChanged : Dynamic;
	/**
	...
	**/
	public function setUseHoverEffects(bool:Bool):Void;
	/**
	...
	**/
	public var tabFocusBehaviorChanged : Dynamic;
	/**
		thread(self) -> QThread
	**/
	...
	**/
	public var useHoverEffectsChanged : Dynamic;
	/**
	...
	**/
	public var wheelScrollLinesChanged : Dynamic;
}