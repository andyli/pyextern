...
package pyQt5.qtGui;
@:pythonImport("PyQt5.QtGui", "QStaticText") extern class QStaticText {
	static public var AggressiveCaching : Dynamic;
	static public var ModerateCaching : Dynamic;
	/**
		int([x]) -> integer
	...
	**/
	public function performanceHint():Dynamic;
	/**
		prepare(self, matrix: QTransform = QTransform(), font: QFont = QFont())
	**/
	public function prepare(?matrix:Dynamic, ?font:Dynamic):Void;
	/**
		setPerformanceHint(self, QStaticText.PerformanceHint)
	**/
	public function setPerformanceHint(QStaticText:Dynamic):Void;
	/**
		setText(self, str)
	**/
	...
	**/
	public function swap(QStaticText:Dynamic):Void;
	/**
		text(self) -> str
	**/
