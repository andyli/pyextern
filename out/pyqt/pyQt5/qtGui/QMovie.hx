...
package pyQt5.qtGui;
@:pythonImport("PyQt5.QtGui", "QMovie") extern class QMovie {
	...
	**/
	public function currentImage():Dynamic;
	/**
		currentPixmap(self) -> QPixmap
	**/
	public function currentPixmap():Dynamic;
	/**
	...
	**/
	public function jumpToFrame(int:Int):Bool;
	/**
	...
	**/
	public function setCacheMode(QMovie:Dynamic):Void;
	/**
	...
	**/
	static public function supportedFormats():Dynamic;
	/**
		thread(self) -> QThread
	**/
