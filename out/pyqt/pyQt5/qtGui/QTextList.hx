...
package pyQt5.qtGui;
@:pythonImport("PyQt5.QtGui", "QTextList") extern class QTextList {
	...
	**/
	...
	/**
		add(self, QTextBlock)
	**/
	public function add(QTextBlock:Dynamic):Void;
	/**
		blockFormatChanged(self, QTextBlock)
	**/
	public function blockFormatChanged(QTextBlock:Dynamic):Void;
	/**
		blockInserted(self, QTextBlock)
	**/
	public function blockInserted(QTextBlock:Dynamic):Void;
	/**
		blockList(self) -> List[QTextBlock]
	**/
	public function blockList():Dynamic;
	/**
		blockRemoved(self, QTextBlock)
	**/
	public function blockRemoved(QTextBlock:Dynamic):Void;
	/**
	...
	**/
	public function itemNumber(QTextBlock:Dynamic):Int;
	/**
		itemText(self, QTextBlock) -> str
	**/
	public function itemText(QTextBlock:Dynamic):String;
	/**
		killTimer(self, int)
	**/
	...
	**/
	public function remove(QTextBlock:Dynamic):Void;
	/**
	...
	**/
	public function setFormat(QTextListFormat:Dynamic):Void;
	/**
