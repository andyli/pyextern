...
@:pythonImport("PyQt5.QtDBus", "QDBusServiceWatcher") extern class QDBusServiceWatcher {
	static public var WatchForOwnerChange : Dynamic;
	static public var WatchForRegistration : Dynamic;
	static public var WatchForUnregistration : Dynamic;
	/**
	...
	**/
	static public function WatchMode(args:haxe.extern.Rest<Dynamic>):Void;
	/**
		int([x]) -> integer
		...
		4
	**/
	public function WatchModeFlag(args:haxe.extern.Rest<Dynamic>):Dynamic;
	...
	**/
	public function addWatchedService(str:String):Void;
	/**
	...
	**/
	public function removeWatchedService(str:String):Bool;
	/**
		sender(self) -> QObject
	**/
	...
	**/
	public var serviceOwnerChanged : Dynamic;
	/**
	...
	**/
	public function setConnection(QDBusConnection:Dynamic):Void;
	/**
	...
	**/
	public function setWatchMode(Union:Dynamic):Void;
	/**
		setWatchedServices(self, Iterable[str])
	**/
	public function setWatchedServices(Iterable:Dynamic):Void;
	/**
	...
	**/
	public function watchMode():Dynamic;
	/**
		watchedServices(self) -> List[str]
	**/
	public function watchedServices():Dynamic;
}