...
@:pythonImport("PyQt5.QtWidgets", "QUndoView") extern class QUndoView {
	...
	**/
	public function cleanIcon():Dynamic;
	/**
		clearFocus(self)
	**/
	...
	**/
	public function setCleanIcon(QIcon:Dynamic):Void;
	/**
	...
	**/
	public function setEmptyLabel(str:String):Void;
	/**
	...
	**/
	public function setGroup(QUndoGroup:Dynamic):Void;
	/**
		setHidden(self, bool)
	**/
	...
	**/
	public function setStack(QUndoStack:Dynamic):Void;
	/**
