...
@:pythonImport("PyQt5.QtWidgets", "QLabel") extern class QLabel {
	...
	**/
	public function setBuddy(QWidget:Dynamic):Void;
	/**
	...
	**/
	...
	/**
		setMargin(self, int)
	**/
	public function setMargin(int:Int):Void;
	/**
	...
	**/
	public function setMovie(QMovie:Dynamic):Void;
	/**
		setNum(self, float)
		setNum(self, int)
	**/
	public function setNum(args:haxe.extern.Rest<Dynamic>):Void;
	/**
	...
	**/
	public function setScaledContents(bool:Bool):Void;
	/**
		setSelection(self, int, int)
	**/
	public function setSelection(int:Int, int:Int):Void;
	/**
