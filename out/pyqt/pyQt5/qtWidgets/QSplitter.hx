...
@:pythonImport("PyQt5.QtWidgets", "QSplitter") extern class QSplitter {
	...
	**/
	public function closestLegalPosition(int:Int, int:Int):Int;
	/**
		colorCount(self) -> int
	**/
	...
	**/
	public function createHandle():Dynamic;
	/**
	...
	**/
	public function getRange(int:Int):Dynamic;
	/**
	...
	**/
	public function handle(int:Int):Dynamic;
	/**
	...
	**/
	public function insertWidget(int:Int, QWidget:Dynamic):Void;
	/**
	...
	**/
	public function isCollapsible(int:Int):Bool;
	/**
		isEnabled(self) -> bool
	**/
	...
	**/
	public function moveSplitter(int:Int, int:Int):Void;
	/**
	...
	**/
	public function replaceWidget(int:Int, QWidget:Dynamic):Dynamic;
	/**
		resize(self, QSize)
		resize(self, int, int)
	**/
	...
	**/
	public function setChildrenCollapsible(bool:Bool):Void;
	/**
		setCollapsible(self, int, bool)
	**/
	public function setCollapsible(int:Int, bool:Bool):Void;
	/**
	...
	**/
	public function setHandleWidth(int:Int):Void;
	/**
		setHidden(self, bool)
	**/
	...
	**/
	public function setOpaqueResize(?opaque:Dynamic):Void;
	/**
	...
	**/
	public function setRubberBand(int:Int):Void;
	/**
	...
	**/
	public function setSizes(Iterable:Dynamic):Void;
	/**
	...
	**/
	public function setStretchFactor(int:Int, int:Int):Void;
	/**
	...
	**/
	public var splitterMoved : Dynamic;
	/**
