...
@:pythonImport("PyQt5.QtWidgets", "QGraphicsAnchorLayout") extern class QGraphicsAnchorLayout {
	...
	**/
	public function addAnchor(QGraphicsLayoutItem:Dynamic, Qt:Dynamic, QGraphicsLayoutItem:Dynamic, Qt:Dynamic):Dynamic;
	/**
	...
	**/
	public function addAnchors(QGraphicsLayoutItem:Dynamic, QGraphicsLayoutItem:Dynamic, ?orientations:Dynamic):Void;
	/**
	...
	**/
	public function addCornerAnchors(QGraphicsLayoutItem:Dynamic, Qt:Dynamic, QGraphicsLayoutItem:Dynamic, Qt:Dynamic):Void;
	/**
		anchor(self, QGraphicsLayoutItem, Qt.AnchorPoint, QGraphicsLayoutItem, Qt.AnchorPoint) -> QGraphicsAnchor
	**/
	public function anchor(QGraphicsLayoutItem:Dynamic, Qt:Dynamic, QGraphicsLayoutItem:Dynamic, Qt:Dynamic):Dynamic;
	/**
