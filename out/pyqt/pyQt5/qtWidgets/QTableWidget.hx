...
@:pythonImport("PyQt5.QtWidgets", "QTableWidget") extern class QTableWidget {
	...
	**/
	public var cellActivated : Dynamic;
	/**
		cellChanged(self, int, int) [signal]
	**/
	public var cellChanged : Dynamic;
	/**
		cellClicked(self, int, int) [signal]
	**/
	public var cellClicked : Dynamic;
	/**
		cellDoubleClicked(self, int, int) [signal]
	**/
	public var cellDoubleClicked : Dynamic;
	/**
		cellEntered(self, int, int) [signal]
	**/
	public var cellEntered : Dynamic;
	/**
		cellPressed(self, int, int) [signal]
	**/
	public var cellPressed : Dynamic;
	/**
		cellWidget(self, int, int) -> QWidget
	**/
	public function cellWidget(int:Int, int:Int):Dynamic;
	/**
	...
	**/
	public function closePersistentEditor(QTableWidgetItem:Dynamic):Void;
	/**
		colorCount(self) -> int
	**/
	...
	**/
	public function column(QTableWidgetItem:Dynamic):Int;
	/**
	...
	**/
	public function columnMoved(int:Int, int:Int, int:Int):Void;
	/**
	...
	**/
	public function columnSpan(int:Int, int:Int):Int;
	/**
	...
	**/
	public var currentCellChanged : Dynamic;
	/**
	...
	**/
	public function dropMimeData(int:Int, int:Int, QMimeData:Dynamic, Qt:Dynamic):Bool;
	/**
		dumpObjectInfo(self)
	**/
	...
	**/
	public function editItem(QTableWidgetItem:Dynamic):Void;
	/**
	...
	**/
	public function findItems(str:String, Union:Dynamic):Dynamic;
	/**
	...
	**/
	public function gridStyle():Dynamic;
	/**
	...
	**/
	...
	/**
		hideRow(self, int)
	**/
	public function hideRow(int:Int):Void;
	/**
		horizontalHeader(self) -> QHeaderView
	**/
	public function horizontalHeader():Dynamic;
	/**
		horizontalHeaderItem(self, int) -> QTableWidgetItem
	**/
	public function horizontalHeaderItem(int:Int):Dynamic;
	/**
	...
	**/
	public function indexFromItem(QTableWidgetItem:Dynamic):Dynamic;
	/**
	...
	**/
	public function insertColumn(int:Int):Void;
	/**
		insertRow(self, int)
	**/
	public function insertRow(int:Int):Void;
	/**
	...
	**/
	public function isPersistentEditorOpen(QTableWidgetItem:Dynamic):Bool;
	/**
	...
	**/
	public function isRowHidden(int:Int):Bool;
	/**
	...
	**/
	public function item(int:Int, int:Int):Dynamic;
	/**
	...
	**/
	public function itemPrototype():Dynamic;
	/**
	...
	**/
	public function items(QMimeData:Dynamic):Dynamic;
	/**
	...
	**/
	public function openPersistentEditor(QTableWidgetItem:Dynamic):Void;
	/**
	...
	**/
	public function removeCellWidget(int:Int, int:Int):Void;
	/**
		removeColumn(self, int)
	**/
	public function removeColumn(int:Int):Void;
	/**
	...
	**/
	...
	/**
		removeRow(self, int)
	**/
	public function removeRow(int:Int):Void;
	/**
	...
	**/
	public function resizeColumnsToContents():Void;
	/**
	...
	**/
	public function resizeRowToContents(int:Int):Void;
	/**
		resizeRowsToContents(self)
	**/
	public function resizeRowsToContents():Void;
	/**
	...
	**/
	public function row(QTableWidgetItem:Dynamic):Int;
	/**
		rowAt(self, int) -> int
	**/
	public function rowAt(int:Int):Int;
	/**
		rowCount(self) -> int
	**/
	...
	**/
	public function rowCountChanged(int:Int, int:Int):Void;
	/**
		rowHeight(self, int) -> int
	**/
	public function rowHeight(int:Int):Int;
	/**
		rowMoved(self, int, int, int)
	**/
	public function rowMoved(int:Int, int:Int, int:Int):Void;
	/**
		rowResized(self, int, int, int)
	**/
	public function rowResized(int:Int, int:Int, int:Int):Void;
	/**
		rowSpan(self, int, int) -> int
	**/
	public function rowSpan(int:Int, int:Int):Int;
	/**
		rowViewportPosition(self, int) -> int
	**/
	public function rowViewportPosition(int:Int):Int;
	/**
	...
	**/
	public function scrollToItem(QTableWidgetItem:Dynamic, ?hint:Dynamic):Void;
	/**
		scrollToTop(self)
	**/
	...
	**/
	public function selectColumn(int:Int):Void;
	/**
		selectRow(self, int)
	**/
	public function selectRow(int:Int):Void;
	/**
	...
	**/
	public function selectedRanges():Dynamic;
	/**
	...
	**/
	public function setCellWidget(int:Int, int:Int, QWidget:Dynamic):Void;
	/**
	...
	**/
	public function setCornerButtonEnabled(bool:Bool):Void;
	/**
	...
	**/
	public function setCurrentCell(int:Int, int:Int, args:haxe.extern.Rest<Dynamic>):Void;
	/**
	...
	**/
	public function setCurrentItem(QTableWidgetItem:Dynamic, args:haxe.extern.Rest<Dynamic>):Void;
	/**
	...
	**/
	public function setGridStyle(Qt:Dynamic):Void;
	/**
		setHidden(self, bool)
	**/
	...
	**/
	public function setHorizontalHeader(QHeaderView:Dynamic):Void;
	/**
		setHorizontalHeaderItem(self, int, QTableWidgetItem)
	**/
	public function setHorizontalHeaderItem(int:Int, QTableWidgetItem:Dynamic):Void;
	/**
		setHorizontalHeaderLabels(self, Iterable[str])
	**/
	public function setHorizontalHeaderLabels(Iterable:Dynamic):Void;
	/**
	...
	**/
	public function setItem(int:Int, int:Int, QTableWidgetItem:Dynamic):Void;
	/**
	...
	**/
	public function setItemPrototype(QTableWidgetItem:Dynamic):Void;
	/**
	...
	**/
	public function setRangeSelected(QTableWidgetSelectionRange:Dynamic, bool:Bool):Void;
	/**
	...
	**/
	public function setRowCount(int:Int):Void;
	/**
		setRowHeight(self, int, int)
	**/
	public function setRowHeight(int:Int, int:Int):Void;
	/**
		setRowHidden(self, int, bool)
	**/
	public function setRowHidden(int:Int, bool:Bool):Void;
	/**
	...
	**/
	public function setShowGrid(bool:Bool):Void;
	/**
	...
	**/
	public function setSpan(int:Int, int:Int, int:Int, int:Int):Void;
	/**
	...
	**/
	public function setVerticalHeader(QHeaderView:Dynamic):Void;
	/**
		setVerticalHeaderItem(self, int, QTableWidgetItem)
	**/
	public function setVerticalHeaderItem(int:Int, QTableWidgetItem:Dynamic):Void;
	/**
		setVerticalHeaderLabels(self, Iterable[str])
	**/
	public function setVerticalHeaderLabels(Iterable:Dynamic):Void;
	/**
	...
	**/
	...
	/**
		showRow(self, int)
	**/
	public function showRow(int:Int):Void;
	/**
	...
	**/
	public function sortItems(int:Int, ?order:Dynamic):Void;
	/**
	...
	**/
	public function takeHorizontalHeaderItem(int:Int):Dynamic;
	/**
		takeItem(self, int, int) -> QTableWidgetItem
	**/
	public function takeItem(int:Int, int:Int):Dynamic;
	/**
		takeVerticalHeaderItem(self, int) -> QTableWidgetItem
	**/
	public function takeVerticalHeaderItem(int:Int):Dynamic;
	/**
	...
	**/
	public function verticalHeader():Dynamic;
	/**
		verticalHeaderItem(self, int) -> QTableWidgetItem
	**/
	public function verticalHeaderItem(int:Int):Dynamic;
	/**
	...
	**/
	public function visualColumn(int:Int):Int;
	/**
		visualItemRect(self, QTableWidgetItem) -> QRect
	**/
	public function visualItemRect(QTableWidgetItem:Dynamic):Dynamic;
	/**
	...
	**/
	public function visualRow(int:Int):Int;
	/**
		whatsThis(self) -> str
	**/
