...
@:pythonImport("PyQt5.QtWidgets", "QStyleOptionButton") extern class QStyleOptionButton {
	static public var AutoDefaultButton : Dynamic;
	/**
		int([x]) -> integer
		...
		4
	**/
	public function ButtonFeature(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	static public function ButtonFeatures(args:haxe.extern.Rest<Dynamic>):Void;
	static public var CommandLinkButton : Dynamic;
	static public var DefaultButton : Dynamic;
