...
@:pythonImport("PyQt5.QtWidgets", "QUndoStack") extern class QUndoStack {
	...
	**/
	...
	/**
		beginMacro(self, str)
	**/
	public function beginMacro(str:String):Void;
	/**
	...
	**/
	public var canRedoChanged : Dynamic;
	/**
		canUndo(self) -> bool
	**/
	...
	**/
	public var canUndoChanged : Dynamic;
	/**
	...
	**/
	public var cleanChanged : Dynamic;
	/**
		cleanIndex(self) -> int
	**/
	...
	**/
	public function command(int:Int):Dynamic;
	/**
	...
	**/
	public function createRedoAction(QObject:Dynamic, ?prefix:Dynamic):Dynamic;
	/**
		createUndoAction(self, QObject, prefix: str = '') -> QAction
	**/
	public function createUndoAction(QObject:Dynamic, ?prefix:Dynamic):Dynamic;
	/**
	...
	**/
	public var indexChanged : Dynamic;
	/**
	...
	**/
	public function push(QUndoCommand:Dynamic):Void;
	/**
	...
	**/
	public var redoTextChanged : Dynamic;
	/**
	...
	**/
	...
	/**
		resetClean(self)
	**/
	public function resetClean():Void;
	/**
		sender(self) -> QObject
	**/
	...
	**/
	public function setActive(?active:Dynamic):Void;
	/**
		setClean(self)
	**/
	...
	/**
		setIndex(self, int)
	**/
	public function setIndex(int:Int):Void;
	/**
	...
	**/
	public function setUndoLimit(int:Int):Void;
	/**
	...
	**/
	public var undoTextChanged : Dynamic;
}