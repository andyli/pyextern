...
@:pythonImport("PyQt5.QtWidgets", "QProgressBar") extern class QProgressBar {
	...
	**/
	public function initStyleOption(QStyleOptionProgressBar:Dynamic):Void;
	/**
	...
	**/
	public function setTextDirection(QProgressBar:Dynamic):Void;
	/**
		setTextVisible(self, bool)
	**/
	public function setTextVisible(bool:Bool):Void;
	/**
		setToolTip(self, str)
	**/
