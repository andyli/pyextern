...
@:pythonImport("PyQt5.QtWidgets", "QStyleOptionSlider") extern class QStyleOptionSlider {
	/**
		int([x]) -> integer
	...
	**/
	...
	public var dialWrapping : Dynamic;
	...
	**/
	...
	public var notchTarget : Dynamic;
	public var orientation : Dynamic;
	public var pageStep : Dynamic;
	public var palette : Dynamic;
	public var rect : Dynamic;
	public var singleStep : Dynamic;
	public var sliderPosition : Dynamic;
	public var sliderValue : Dynamic;
	public var state : Dynamic;
	public var styleObject : Dynamic;
	public var subControls : Dynamic;
	public var tickInterval : Dynamic;
	public var tickPosition : Dynamic;
	public var type : Dynamic;
	public var upsideDown : Dynamic;
