...
@:pythonImport("PyQt5.QtWidgets", "QDirModel") extern class QDirModel {
	/**
		An enumeration.
	**/
	...
	**/
	public function refresh(?parent:Dynamic):Void;
	/**
	...
	**/
	public function setLazyChildCount(bool:Bool):Void;
	/**
