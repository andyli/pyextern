...
@:pythonImport("PyQt5.QtWidgets", "QStyleOptionHeader") extern class QStyleOptionHeader {
	...
	**/
	...
	static public var SortDown : Dynamic;
	/**
		int([x]) -> integer
		int(x, base=10) -> integer
		...
		4
	**/
	public function SortIndicator(args:haxe.extern.Rest<Dynamic>):Dynamic;
	static public var SortUp : Dynamic;
	/**
		int([x]) -> integer
		int(x, base=10) -> integer
	...
	**/
	...
	public var iconAlignment : Dynamic;
	/**
	...
	**/
	...
	public var sortIndicator : Dynamic;
