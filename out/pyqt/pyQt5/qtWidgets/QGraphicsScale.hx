...
@:pythonImport("PyQt5.QtWidgets", "QGraphicsScale") extern class QGraphicsScale {
	...
	**/
	public function applyTo(QMatrix4x4:Dynamic):Void;
	/**
	...
	**/
	public function origin():Dynamic;
	/**
		originChanged(self) [signal]
	**/
	public var originChanged : Dynamic;
	/**
		parent(self) -> QObject
	**/
	...
	**/
	public function setOrigin(QVector3D:Dynamic):Void;
	/**
	...
	**/
	public function setXScale(float:Float):Void;
	/**
		setYScale(self, float)
	**/
	public function setYScale(float:Float):Void;
	/**
		setZScale(self, float)
	**/
	public function setZScale(float:Float):Void;
	/**
	...
	**/
	public var xScaleChanged : Dynamic;
	/**
		yScale(self) -> float
	**/
	...
	**/
	public var yScaleChanged : Dynamic;
	/**
		zScale(self) -> float
	**/
	...
	**/
	public var zScaleChanged : Dynamic;
}