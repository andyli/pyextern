...
@:pythonImport("PyQt5.QtWidgets", "QUndoGroup") extern class QUndoGroup {
	...
	**/
	public function activeStack():Dynamic;
	/**
		activeStackChanged(self, QUndoStack) [signal]
	**/
	public var activeStackChanged : Dynamic;
	/**
		addStack(self, QUndoStack)
	**/
	public function addStack(QUndoStack:Dynamic):Void;
	/**
	...
	**/
	public function removeStack(QUndoStack:Dynamic):Void;
	/**
		sender(self) -> QObject
	**/
	...
	**/
	public function setActiveStack(QUndoStack:Dynamic):Void;
	/**
	...
	**/
	public function stacks():Dynamic;
	/**
