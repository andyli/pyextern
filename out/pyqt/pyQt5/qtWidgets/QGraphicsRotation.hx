...
@:pythonImport("PyQt5.QtWidgets", "QGraphicsRotation") extern class QGraphicsRotation {
	...
	**/
	public var angleChanged : Dynamic;
	/**
	...
	**/
	public var axisChanged : Dynamic;
	/**
	...
	**/
	public function setAxis(args:haxe.extern.Rest<Dynamic>):Void;
	/**
