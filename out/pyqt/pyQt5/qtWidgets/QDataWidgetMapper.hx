...
@:pythonImport("PyQt5.QtWidgets", "QDataWidgetMapper") extern class QDataWidgetMapper {
	...
	**/
	public function addMapping(QWidget:Dynamic, int:Int, args:haxe.extern.Rest<Dynamic>):Void;
	/**
	...
	**/
	public function mappedPropertyName(QWidget:Dynamic):Dynamic;
	/**
		mappedSection(self, QWidget) -> int
	**/
	public function mappedSection(QWidget:Dynamic):Int;
	/**
		mappedWidgetAt(self, int) -> QWidget
	**/
	public function mappedWidgetAt(int:Int):Dynamic;
	/**
	...
	**/
	public function removeMapping(QWidget:Dynamic):Void;
	/**
		revert(self)
	**/
	...
	**/
	public function setCurrentModelIndex(QModelIndex:Dynamic):Void;
	/**
	...
	**/
	public function setSubmitPolicy(QDataWidgetMapper:Dynamic):Void;
	/**
	...
	**/
	public function submitPolicy():Dynamic;
	/**
		thread(self) -> QThread
	**/
