...
@:pythonImport("PyQt5.QtWidgets", "QHeaderView") extern class QHeaderView {
	...
	**/
	public function closePersistentEditor(QModelIndex:Dynamic):Void;
	/**
		colorCount(self) -> int
	**/
	...
	**/
	public function defaultAlignment():Dynamic;
	/**
	...
	**/
	public var geometriesChanged : Dynamic;
	/**
		geometry(self) -> QRect
	**/
	...
	**/
	public function headerDataChanged(Qt:Dynamic, int:Int, int:Int):Void;
	/**
		height(self) -> int
	**/
	...
	**/
	public function hideSection(int:Int):Void;
	/**
	...
	**/
	public function initStyleOption(QStyleOptionHeader:Dynamic):Void;
	/**
		initialize(self)
	**/
	...
	**/
	public function initializeSections(args:haxe.extern.Rest<Dynamic>):Void;
	/**
	...
	**/
	public function isPersistentEditorOpen(QModelIndex:Dynamic):Bool;
	/**
	...
	**/
	public function isSectionHidden(int:Int):Bool;
	/**
	...
	**/
	public function logicalIndex(int:Int):Int;
	/**
		logicalIndexAt(self, int) -> int
		logicalIndexAt(self, int, int) -> int
		logicalIndexAt(self, QPoint) -> int
	**/
	public function logicalIndexAt(args:haxe.extern.Rest<Dynamic>):Int;
	/**
		lower(self)
	**/
	...
	**/
	public function moveSection(int:Int, int:Int):Void;
	/**
	...
	**/
	public function openPersistentEditor(QModelIndex:Dynamic):Void;
	/**
	...
	**/
	public function paintSection(QPainter:Dynamic, QRect:Dynamic, int:Int):Void;
	/**
	...
	**/
	public function resetDefaultSectionSize():Void;
	/**
	...
	**/
	public function resizeSection(int:Int, int:Int):Void;
	/**
		resizeSections(self)
		resizeSections(self, QHeaderView.ResizeMode)
	**/
	public function resizeSections(args:haxe.extern.Rest<Dynamic>):Void;
	/**
	...
	**/
	public function restoreState(Union:Dynamic):Bool;
	/**
	...
	**/
	public function scrollTo(QModelIndex:Dynamic, QAbstractItemView:Dynamic):Void;
	/**
		scrollToBottom(self)
	**/
	...
	**/
	public var sectionClicked : Dynamic;
	/**
		sectionCountChanged(self, int, int) [signal]
	**/
	public var sectionCountChanged : Dynamic;
	/**
		sectionDoubleClicked(self, int) [signal]
	**/
	public var sectionDoubleClicked : Dynamic;
	/**
		sectionEntered(self, int) [signal]
	**/
	public var sectionEntered : Dynamic;
	/**
		sectionHandleDoubleClicked(self, int) [signal]
	**/
	public var sectionHandleDoubleClicked : Dynamic;
	/**
		sectionMoved(self, int, int, int) [signal]
	**/
	public var sectionMoved : Dynamic;
	/**
		sectionPosition(self, int) -> int
	**/
	public function sectionPosition(int:Int):Int;
	/**
		sectionPressed(self, int) [signal]
	**/
	public var sectionPressed : Dynamic;
	/**
		sectionResizeMode(self, int) -> QHeaderView.ResizeMode
	**/
	public function sectionResizeMode(int:Int):Dynamic;
	/**
		sectionResized(self, int, int, int) [signal]
	**/
	public var sectionResized : Dynamic;
	/**
		sectionSize(self, int) -> int
	**/
	public function sectionSize(int:Int):Int;
	/**
		sectionSizeFromContents(self, int) -> QSize
	**/
	public function sectionSizeFromContents(int:Int):Dynamic;
	/**
		sectionSizeHint(self, int) -> int
	**/
	public function sectionSizeHint(int:Int):Int;
	/**
		sectionViewportPosition(self, int) -> int
	**/
	public function sectionViewportPosition(int:Int):Int;
	/**
		sectionsAboutToBeRemoved(self, QModelIndex, int, int)
	**/
	public function sectionsAboutToBeRemoved(QModelIndex:Dynamic, int:Int, int:Int):Void;
	/**
	...
	**/
	public function sectionsInserted(QModelIndex:Dynamic, int:Int, int:Int):Void;
	/**
	...
	**/
	public function setCascadingSectionResizes(bool:Bool):Void;
	/**
	...
	**/
	public function setDefaultAlignment(Union:Dynamic):Void;
	/**
	...
	**/
	public function setDefaultSectionSize(int:Int):Void;
	/**
	...
	**/
	public function setFirstSectionMovable(bool:Bool):Void;
	/**
	...
	**/
	public function setHighlightSections(bool:Bool):Void;
	/**
	...
	**/
	public function setMaximumSectionSize(int:Int):Void;
	/**
	...
	**/
	public function setMinimumSectionSize(int:Int):Void;
	/**
	...
	**/
	...
	/**
		setOffset(self, int)
	**/
	public function setOffset(int:Int):Void;
	/**
		setOffsetToLastSection(self)
	**/
	public function setOffsetToLastSection():Void;
	/**
		setOffsetToSectionPosition(self, int)
	**/
	public function setOffsetToSectionPosition(int:Int):Void;
	/**
	...
	**/
	public function setResizeContentsPrecision(int:Int):Void;
	/**
	...
	**/
	public function setSectionHidden(int:Int, bool:Bool):Void;
	/**
		setSectionResizeMode(self, int, QHeaderView.ResizeMode)
		setSectionResizeMode(self, QHeaderView.ResizeMode)
	**/
	public function setSectionResizeMode(args:haxe.extern.Rest<Dynamic>):Void;
	/**
		setSectionsClickable(self, bool)
	**/
	public function setSectionsClickable(bool:Bool):Void;
	/**
		setSectionsMovable(self, bool)
	**/
	public function setSectionsMovable(bool:Bool):Void;
	/**
	...
	**/
	public function setSortIndicator(int:Int, Qt:Dynamic):Void;
	/**
		setSortIndicatorShown(self, bool)
	**/
	public function setSortIndicatorShown(bool:Bool):Void;
	/**
	...
	**/
	public function setStretchLastSection(bool:Bool):Void;
	/**
	...
	**/
	public function showSection(int:Int):Void;
	/**
	...
	**/
	public var sortIndicatorChanged : Dynamic;
	/**
		sortIndicatorOrder(self) -> Qt.SortOrder
	**/
	public function sortIndicatorOrder():Dynamic;
	/**
	...
	**/
	public function swapSections(int:Int, int:Int):Void;
	/**
	...
	**/
	public function updateSection(int:Int):Void;
	/**
	...
	**/
	public function visualIndex(int:Int):Int;
	/**
		visualIndexAt(self, int) -> int
	**/
	public function visualIndexAt(int:Int):Int;
	/**
