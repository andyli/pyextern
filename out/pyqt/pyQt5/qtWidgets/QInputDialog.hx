...
@:pythonImport("PyQt5.QtWidgets", "QInputDialog") extern class QInputDialog {
	...
	**/
	static public function InputDialogOptions(args:haxe.extern.Rest<Dynamic>):Void;
	/**
		int([x]) -> integer
		int(x, base=10) -> integer
	...
	**/
	public function comboBoxItems():Dynamic;
	/**
	...
	**/
	public var doubleValueChanged : Dynamic;
	/**
		doubleValueSelected(self, float) [signal]
	**/
	public var doubleValueSelected : Dynamic;
	/**
	...
	**/
	static public function getDouble(QWidget:Dynamic, str:String, str:String, args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	static public function getInt(QWidget:Dynamic, str:String, str:String, ?value:Dynamic, ?min:Dynamic, ?max:Dynamic, ?step:Dynamic, ?flags:Dynamic):Dynamic;
	/**
	...
	**/
	static public function getItem(QWidget:Dynamic, str:String, str:String, Iterable:Dynamic, ?current:Dynamic, ?editable:Dynamic, ?flags:Dynamic, ?inputMethodHints:Dynamic):Dynamic;
	/**
	...
	**/
	static public function getMultiLineText(QWidget:Dynamic, str:String, str:String, ?text:Dynamic, ?flags:Dynamic, ?inputMethodHints:Dynamic):Dynamic;
	/**
	...
	**/
	static public function getText(QWidget:Dynamic, str:String, str:String, ?echo:Dynamic, ?text:Dynamic, ?flags:Dynamic, ?inputMethodHints:Dynamic):Dynamic;
	/**
	...
	**/
	public function inputMode():Dynamic;
	/**
	...
	**/
	public var intValueChanged : Dynamic;
	/**
		intValueSelected(self, int) [signal]
	**/
	public var intValueSelected : Dynamic;
	/**
	...
	**/
	public function setCancelButtonText(str:String):Void;
	/**
		setComboBoxEditable(self, bool)
	**/
	public function setComboBoxEditable(bool:Bool):Void;
	/**
		setComboBoxItems(self, Iterable[str])
	**/
	public function setComboBoxItems(Iterable:Dynamic):Void;
	/**
	...
	**/
	public function setDoubleDecimals(int:Int):Void;
	/**
		setDoubleMaximum(self, float)
	**/
	public function setDoubleMaximum(float:Float):Void;
	/**
		setDoubleMinimum(self, float)
	**/
	public function setDoubleMinimum(float:Float):Void;
	/**
		setDoubleRange(self, float, float)
	**/
	public function setDoubleRange(float:Float, float:Float):Void;
	/**
		setDoubleStep(self, float)
	**/
	public function setDoubleStep(float:Float):Void;
	/**
		setDoubleValue(self, float)
	**/
	public function setDoubleValue(float:Float):Void;
	/**
	...
	**/
	public function setInputMode(QInputDialog:Dynamic):Void;
	/**
		setIntMaximum(self, int)
	**/
	public function setIntMaximum(int:Int):Void;
	/**
		setIntMinimum(self, int)
	**/
	public function setIntMinimum(int:Int):Void;
	/**
		setIntRange(self, int, int)
	**/
	public function setIntRange(int:Int, int:Int):Void;
	/**
		setIntStep(self, int)
	**/
	public function setIntStep(int:Int):Void;
	/**
		setIntValue(self, int)
	**/
	public function setIntValue(int:Int):Void;
	/**
	...
	**/
	public function setOkButtonText(str:String):Void;
	/**
		setOption(self, QInputDialog.InputDialogOption, on: bool = True)
	**/
	public function setOption(QInputDialog:Dynamic, ?on:Dynamic):Void;
	/**
	...
	**/
	public function setTextEchoMode(QLineEdit:Dynamic):Void;
	/**
		setTextValue(self, str)
	**/
	public function setTextValue(str:String):Void;
	/**
		setToolTip(self, str)
	**/
	...
	**/
	public function testOption(QInputDialog:Dynamic):Bool;
	/**
		textEchoMode(self) -> QLineEdit.EchoMode
	**/
	public function textEchoMode():Dynamic;
	/**
		textValue(self) -> str
	**/
	...
	**/
	public var textValueChanged : Dynamic;
	/**
		textValueSelected(self, str) [signal]
	**/
	public var textValueSelected : Dynamic;
	/**
		thread(self) -> QThread
	**/
