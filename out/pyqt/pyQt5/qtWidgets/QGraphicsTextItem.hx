...
@:pythonImport("PyQt5.QtWidgets", "QGraphicsTextItem") extern class QGraphicsTextItem {
	/**
		int([x]) -> integer
	...
	**/
	public function defaultTextColor():Dynamic;
	/**
		deleteLater(self)
	**/
	...
	**/
	public var linkHovered : Dynamic;
	/**
	...
	**/
	public function setDefaultTextColor(Union:Dynamic):Void;
	/**
