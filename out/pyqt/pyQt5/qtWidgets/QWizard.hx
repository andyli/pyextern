...
@:pythonImport("PyQt5.QtWidgets", "QWizard") extern class QWizard {
	...
	**/
	static public function WizardOptions(args:haxe.extern.Rest<Dynamic>):Void;
	/**
		int([x]) -> integer
		int(x, base=10) -> integer
	...
	**/
	public function addPage(QWizardPage:Dynamic):Int;
	/**
		adjustSize(self)
	**/
	...
	**/
	public function button(QWizard:Dynamic):Dynamic;
	/**
		buttonText(self, QWizard.WizardButton) -> str
	**/
	public function buttonText(QWizard:Dynamic):String;
	/**
	...
	**/
	public function cleanupPage(int:Int):Void;
	/**
		clearFocus(self)
	**/
	...
	**/
	public var currentIdChanged : Dynamic;
	/**
		currentPage(self) -> QWizardPage
	**/
	public function currentPage():Dynamic;
	/**
		cursor(self) -> QCursor
	**/
	...
	**/
	public var customButtonClicked : Dynamic;
	/**
	...
	**/
	...
	/**
		field(self, str) -> Any
	**/
	public function field(str:String):Dynamic;
	/**
	...
	**/
	public function hasVisitedPage(int:Int):Bool;
	/**
		height(self) -> int
	**/
	...
	**/
	public var helpRequested : Dynamic;
	/**
		hide(self)
	**/
	...
	**/
	public function initializePage(int:Int):Void;
	/**
	...
	**/
	public function page(int:Int):Dynamic;
	/**
		pageAdded(self, int) [signal]
	**/
	public var pageAdded : Dynamic;
	/**
		pageIds(self) -> List[int]
	**/
	public function pageIds():Dynamic;
	/**
		pageRemoved(self, int) [signal]
	**/
	public var pageRemoved : Dynamic;
	/**
	...
	**/
	public function pixmap(QWizard:Dynamic):Dynamic;
	/**
		pos(self) -> QPoint
	**/
	...
	**/
	...
	/**
		removePage(self, int)
	**/
	public function removePage(int:Int):Void;
	/**
	...
	**/
	public function setButton(QWizard:Dynamic, QAbstractButton:Dynamic):Void;
	/**
		setButtonLayout(self, Iterable[QWizard.WizardButton])
	**/
	public function setButtonLayout(Iterable:Dynamic):Void;
	/**
		setButtonText(self, QWizard.WizardButton, str)
	**/
	public function setButtonText(QWizard:Dynamic, str:String):Void;
	/**
	...
	**/
	public function setDefaultProperty(str:String, str:String, PYQT:Dynamic):Void;
	/**
	...
	**/
	public function setField(str:String, Any:Dynamic):Void;
	/**
	...
	**/
	public function setOption(QWizard:Dynamic, ?on:Dynamic):Void;
	/**
	...
	**/
	public function setPage(int:Int, QWizardPage:Dynamic):Void;
	/**
	...
	**/
	public function setPixmap(QWizard:Dynamic, QPixmap:Dynamic):Void;
	/**
	...
	**/
	public function setSideWidget(QWidget:Dynamic):Void;
	/**
	...
	**/
	...
	/**
		setStartId(self, int)
	**/
	public function setStartId(int:Int):Void;
	/**
	...
	**/
	public function setSubTitleFormat(Qt:Dynamic):Void;
	/**
	...
	**/
	public function setTitleFormat(Qt:Dynamic):Void;
	/**
		setToolTip(self, str)
	**/
	...
	**/
	public function setWizardStyle(QWizard:Dynamic):Void;
	/**
	...
	**/
	public function sideWidget():Dynamic;
	/**
	...
	**/
	public function subTitleFormat():Dynamic;
	/**
	...
	**/
	public function testOption(QWizard:Dynamic):Bool;
	/**
		thread(self) -> QThread
	**/
	...
	**/
	public function titleFormat():Dynamic;
	/**
		toolTip(self) -> str
	**/
	...
	**/
	public function visitedPages():Dynamic;
	/**
		whatsThis(self) -> str
	**/
	...
	**/
	public function wizardStyle():Dynamic;
	/**
		x(self) -> int
	**/
