...
@:pythonImport("PyQt5.QtWidgets", "QSystemTrayIcon") extern class QSystemTrayIcon {
	/**
		int([x]) -> integer
	...
	**/
	public function contextMenu():Dynamic;
	/**
	...
	**/
	static public function isSystemTrayAvailable():Bool;
	/**
		isVisible(self) -> bool
	**/
	...
	**/
	public var messageClicked : Dynamic;
	/**
	...
	**/
	public function setContextMenu(QMenu:Dynamic):Void;
	/**
		setIcon(self, QIcon)
	**/
	...
	**/
	public function showMessage(str:String, str:String, args:haxe.extern.Rest<Dynamic>):Void;
	/**
	...
	**/
	static public function supportsMessages():Bool;
	/**
		thread(self) -> QThread
	**/
