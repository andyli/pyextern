...
@:pythonImport("PyQt5.QtWidgets", "QOpenGLWidget") extern class QOpenGLWidget {
	...
	**/
	public var aboutToCompose : Dynamic;
	/**
		aboutToResize(self) [signal]
	**/
	public var aboutToResize : Dynamic;
	/**
	...
	**/
	public function setTextureFormat(int:Int):Void;
	/**
		setToolTip(self, str)
	**/
	...
	**/
	public function setUpdateBehavior(QOpenGLWidget:Dynamic):Void;
	/**
