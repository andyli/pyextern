...
@:pythonImport("PyQt5.QtWidgets", "QScrollArea") extern class QScrollArea {
	...
	**/
	public function ensureVisible(int:Int, int:Int, ?xMargin:Dynamic, ?yMargin:Dynamic):Void;
	/**
		ensureWidgetVisible(self, QWidget, xMargin: int = 50, yMargin: int = 50)
	**/
	public function ensureWidgetVisible(QWidget:Dynamic, ?xMargin:Dynamic, ?yMargin:Dynamic):Void;
	/**
	...
	**/
	public function setWidgetResizable(bool:Bool):Void;
	/**
	...
	**/
	public function takeWidget():Dynamic;
	/**
