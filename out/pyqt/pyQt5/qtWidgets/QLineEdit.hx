...
@:pythonImport("PyQt5.QtWidgets", "QLineEdit") extern class QLineEdit {
	/**
		int([x]) -> integer
	...
	**/
	public function createStandardContextMenu():Dynamic;
	/**
	...
	**/
	public function cursorBackward(bool:Bool, ?steps:Dynamic):Void;
	/**
		cursorForward(self, bool, steps: int = 1)
	**/
	public function cursorForward(bool:Bool, ?steps:Dynamic):Void;
	/**
	...
	**/
	public function cursorPositionAt(QPoint:Dynamic):Int;
	/**
	...
	**/
	public function cursorRect():Dynamic;
	/**
		cursorWordBackward(self, bool)
	**/
	public function cursorWordBackward(bool:Bool):Void;
	/**
		cursorWordForward(self, bool)
	**/
	public function cursorWordForward(bool:Bool):Void;
	/**
	...
	**/
	public function echoMode():Dynamic;
	/**
	...
	**/
	public function end(bool:Bool):Void;
	/**
		ensurePolished(self)
	**/
	...
	**/
	public function getTextMargins():Dynamic;
	/**
	...
	**/
	...
	/**
		home(self, bool)
	**/
	public function home(bool:Bool):Void;
	/**
	...
	**/
	public var inputRejected : Dynamic;
	/**
		insert(self, str)
	**/
	...
	**/
	public var returnPressed : Dynamic;
	/**
	...
	**/
	public function setClearButtonEnabled(bool:Bool):Void;
	/**
	...
	**/
	public function setCursorPosition(int:Int):Void;
	/**
	...
	**/
	public function setEchoMode(QLineEdit:Dynamic):Void;
	/**
	...
	**/
	public function setInputMask(str:String):Void;
	/**
	...
	**/
	public function setMaxLength(int:Int):Void;
	/**
	...
	**/
	public function setModified(bool:Bool):Void;
	/**
	...
	**/
	public function setTextMargins(args:haxe.extern.Rest<Dynamic>):Void;
	/**
		setToolTip(self, str)
	**/
	...
	**/
	public var textEdited : Dynamic;
	/**
		textMargins(self) -> QMargins
	**/
	public function textMargins():Dynamic;
	/**
		thread(self) -> QThread
	**/
