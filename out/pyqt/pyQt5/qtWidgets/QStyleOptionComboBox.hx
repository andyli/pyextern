...
@:pythonImport("PyQt5.QtWidgets", "QStyleOptionComboBox") extern class QStyleOptionComboBox {
	/**
		int([x]) -> integer
	...
	**/
	...
	public var currentIcon : Dynamic;
	public var currentText : Dynamic;
	public var direction : Dynamic;
	public var editable : Dynamic;
