...
@:pythonImport("PyQt5.QtWidgets", "QTextBrowser") extern class QTextBrowser {
	...
	**/
	static public function AutoFormatting(args:haxe.extern.Rest<Dynamic>):Void;
	/**
		int([x]) -> integer
	...
	**/
	static public function ExtraSelection(args:haxe.extern.Rest<Dynamic>):Void;
	...
	**/
	public function anchorAt(QPoint:Dynamic):String;
	/**
		anchorClicked(self, QUrl) [signal]
	**/
	public var anchorClicked : Dynamic;
	/**
		append(self, str)
	**/
	...
	**/
	public function autoFormatting():Dynamic;
	/**
	...
	**/
	public var backwardAvailable : Dynamic;
	/**
	...
	**/
	public function canInsertFromMimeData(QMimeData:Dynamic):Bool;
	/**
		canPaste(self) -> bool
	**/
	...
	**/
	public var copyAvailable : Dynamic;
	/**
	...
	**/
	public function createMimeDataFromSelection():Dynamic;
	/**
	...
	**/
	public function currentCharFormat():Dynamic;
	/**
		currentCharFormatChanged(self, QTextCharFormat) [signal]
	**/
	public var currentCharFormatChanged : Dynamic;
	/**
	...
	**/
	public function cursorForPosition(QPoint:Dynamic):Dynamic;
	/**
	...
	**/
	public function extraSelections():Dynamic;
	/**
	...
	**/
	public function find(args:haxe.extern.Rest<Dynamic>):Bool;
	/**
	...
	**/
	public var forwardAvailable : Dynamic;
	/**
	...
	**/
	public var historyChanged : Dynamic;
	/**
		historyTitle(self, int) -> str
	**/
	public function historyTitle(int:Int):String;
	/**
		historyUrl(self, int) -> QUrl
	**/
	public function historyUrl(int:Int):Dynamic;
	/**
		home(self)
	**/
	...
	**/
	public function insertFromMimeData(QMimeData:Dynamic):Void;
	/**
		insertHtml(self, str)
	**/
	...
	**/
	public function insertPlainText(str:String):Void;
	/**
	...
	**/
	public function lineWrapMode():Dynamic;
	/**
	...
	**/
	public function mergeCurrentCharFormat(QTextCharFormat:Dynamic):Void;
	/**
	...
	**/
	public function moveCursor(QTextCursor:Dynamic, ?mode:Dynamic):Void;
	/**
	...
	**/
	public function searchPaths():Dynamic;
	/**
		selectAll(self)
	**/
	...
	**/
	public function setAcceptRichText(bool:Bool):Void;
	/**
	...
	**/
	public function setAutoFormatting(Union:Dynamic):Void;
	/**
	...
	**/
	public function setCurrentCharFormat(QTextCharFormat:Dynamic):Void;
	/**
	...
	**/
	public function setCursorWidth(int:Int):Void;
	/**
	...
	**/
	public function setDocument(QTextDocument:Dynamic):Void;
	/**
		setDocumentTitle(self, str)
	**/
	public function setDocumentTitle(str:String):Void;
	/**
	...
	**/
	public function setExtraSelections(Iterable:Dynamic):Void;
	/**
	...
	**/
	public function setLineWrapColumnOrWidth(int:Int):Void;
	/**
		setLineWrapMode(self, QTextEdit.LineWrapMode)
	**/
	public function setLineWrapMode(QTextEdit:Dynamic):Void;
	/**
	...
	**/
	public function setOpenExternalLinks(bool:Bool):Void;
	/**
		setOpenLinks(self, bool)
	**/
	public function setOpenLinks(bool:Bool):Void;
	/**
		setOverwriteMode(self, bool)
	**/
	public function setOverwriteMode(bool:Bool):Void;
	/**
	...
	**/
	public function setPlaceholderText(str:String):Void;
	/**
	...
	**/
	public function setSearchPaths(Iterable:Dynamic):Void;
	/**
	...
	**/
	...
	/**
		setSource(self, QUrl)
	**/
	public function setSource(QUrl:Dynamic):Void;
	/**
	...
	**/
	public function setTabChangesFocus(bool:Bool):Void;
	/**
	...
	**/
	public function setTabStopDistance(float:Float):Void;
	/**
		setTabStopWidth(self, int)
	**/
	public function setTabStopWidth(int:Int):Void;
	/**
	...
	**/
	public function setTextBackgroundColor(Union:Dynamic):Void;
	/**
		setTextColor(self, Union[QColor, Qt.GlobalColor, QGradient])
	**/
	public function setTextColor(Union:Dynamic):Void;
	/**
		setTextCursor(self, QTextCursor)
	**/
	public function setTextCursor(QTextCursor:Dynamic):Void;
	/**
		setTextInteractionFlags(self, Union[Qt.TextInteractionFlags, Qt.TextInteractionFlag])
	**/
	public function setTextInteractionFlags(Union:Dynamic):Void;
	/**
		setToolTip(self, str)
	**/
	...
	**/
	public function setWordWrapMode(QTextOption:Dynamic):Void;
	/**
	...
	**/
	public var sourceChanged : Dynamic;
	/**
	...
	**/
	public function textBackgroundColor():Dynamic;
	/**
		textChanged(self) [signal]
	**/
	public var textChanged : Dynamic;
	/**
		textColor(self) -> QColor
	**/
	public function textColor():Dynamic;
	/**
		textCursor(self) -> QTextCursor
	**/
	public function textCursor():Dynamic;
	/**
		textInteractionFlags(self) -> Qt.TextInteractionFlags
	**/
	public function textInteractionFlags():Dynamic;
	/**
		thread(self) -> QThread
	**/
	...
	**/
	public function wordWrapMode():Dynamic;
	/**
		x(self) -> int
	**/
	...
	**/
	public function zoomIn(?range:Dynamic):Void;
	/**
		zoomOut(self, range: int = 1)
	**/
	public function zoomOut(?range:Dynamic):Void;
}