...
@:pythonImport("PyQt5.QtWidgets", "QGestureEvent") extern class QGestureEvent {
	...
	**/
	public function activeGestures():Dynamic;
	/**
		canceledGestures(self) -> List[QGesture]
	**/
	public function canceledGestures():Dynamic;
	/**
		gesture(self, Qt.GestureType) -> QGesture
	**/
	public function gesture(Qt:Dynamic):Dynamic;
	/**
		gestures(self) -> List[QGesture]
	**/
	public function gestures():Dynamic;
	/**
		ignore(self)
	...
	**/
	public function isAccepted(args:haxe.extern.Rest<Dynamic>):Bool;
	/**
		mapToGraphicsScene(self, Union[QPointF, QPoint]) -> QPointF
	**/
	public function mapToGraphicsScene(Union:Dynamic):Dynamic;
	/**
	...
	**/
	public function setAccepted(args:haxe.extern.Rest<Dynamic>):Void;
	/**
