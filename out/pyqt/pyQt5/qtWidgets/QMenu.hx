...
@:pythonImport("PyQt5.QtWidgets", "QMenu") extern class QMenu {
	...
	**/
	public var aboutToHide : Dynamic;
	/**
		aboutToShow(self) [signal]
	**/
	public var aboutToShow : Dynamic;
	/**
	...
	**/
	public function actionAt(QPoint:Dynamic):Dynamic;
	/**
	...
	**/
	public function actionGeometry(QAction:Dynamic):Dynamic;
	/**
	...
	**/
	public function activeAction():Dynamic;
	/**
	...
	**/
	public function addSeparator():Dynamic;
	/**
		adjustSize(self)
	**/
	...
	**/
	public function defaultAction():Dynamic;
	/**
		deleteLater(self)
	**/
	...
	**/
	public function hideTearOffMenu():Void;
	/**
	...
	**/
	public function initStyleOption(QStyleOptionMenuItem:Dynamic, QAction:Dynamic):Void;
	/**
	...
	**/
	public function insertMenu(QAction:Dynamic, QMenu:Dynamic):Dynamic;
	/**
		insertSection(self, QAction, str) -> QAction
		insertSection(self, QAction, QIcon, str) -> QAction
	**/
	public function insertSection(QAction:Dynamic, args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
		insertSeparator(self, QAction) -> QAction
	**/
	public function insertSeparator(QAction:Dynamic):Dynamic;
	/**
	...
	**/
	public function menuAction():Dynamic;
	/**
	...
	**/
	public function popup(QPoint:Dynamic, ?action:Dynamic):Void;
	/**
		pos(self) -> QPoint
	**/
	...
	**/
	public function setActiveAction(QAction:Dynamic):Void;
	/**
	...
	**/
	public function setDefaultAction(QAction:Dynamic):Void;
	/**
	...
	**/
	public function setNoReplayFor(QWidget:Dynamic):Void;
	/**
	...
	**/
	public function setSeparatorsCollapsible(bool:Bool):Void;
	/**
	...
	**/
	public function setTearOffEnabled(bool:Bool):Void;
	/**
		setTitle(self, str)
	**/
	...
	**/
	public function setToolTipsVisible(bool:Bool):Void;
	/**
	...
	**/
	public function showTearOffMenu(args:haxe.extern.Rest<Dynamic>):Void;
	/**
