...
@:pythonImport("PyQt5.QtWidgets", "QGraphicsColorizeEffect") extern class QGraphicsColorizeEffect {
	/**
		int([x]) -> integer
	...
	**/
	public function setStrength(float:Float):Void;
	/**
	...
	**/
	public var strengthChanged : Dynamic;
	/**
		thread(self) -> QThread
	**/
