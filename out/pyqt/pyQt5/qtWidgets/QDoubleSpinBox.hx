...
@:pythonImport("PyQt5.QtWidgets", "QDoubleSpinBox") extern class QDoubleSpinBox {
	...
	**/
	public function setDecimals(int:Int):Void;
	/**
	...
	**/
	public function setMaximum(float:Float):Void;
	/**
	...
	**/
	public function setMinimum(float:Float):Void;
	/**
	...
	**/
	public function setSingleStep(float:Float):Void;
	/**
	...
	**/
	public function setStepType(QAbstractSpinBox:Dynamic):Void;
	/**
	...
	**/
	...
	/**
		setSuffix(self, str)
	**/
	public function setSuffix(str:String):Void;
	/**
	...
	**/
	...
	/**
		setValue(self, float)
	**/
	public function setValue(float:Float):Void;
	/**
	...
	**/
	public function stepType():Dynamic;
	/**
		stepUp(self)
	**/
	...
	**/
	public function textFromValue(float:Float):String;
	/**
		thread(self) -> QThread
	**/
	...
	**/
	public function valueFromText(str:String):Float;
	/**
