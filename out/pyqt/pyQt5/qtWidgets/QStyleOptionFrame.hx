...
@:pythonImport("PyQt5.QtWidgets", "QStyleOptionFrame") extern class QStyleOptionFrame {
	...
	/**
		...
		4
	**/
	public function FrameFeature(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	static public function FrameFeatures(args:haxe.extern.Rest<Dynamic>):Void;
