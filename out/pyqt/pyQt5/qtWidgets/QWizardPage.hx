...
@:pythonImport("PyQt5.QtWidgets", "QWizardPage") extern class QWizardPage {
	...
	**/
	...
	/**
		cleanupPage(self)
	**/
	public function cleanupPage():Void;
	/**
		clearFocus(self)
	**/
	...
	**/
	public var completeChanged : Dynamic;
	/**
	...
	**/
	public function registerField(str:String, QWidget:Dynamic, ?property:Dynamic, ?changedSignal:Dynamic):Void;
	/**
	...
	**/
	public function setCommitPage(bool:Bool):Void;
	/**
	...
	**/
	public function setFinalPage(bool:Bool):Void;
	/**
	...
	**/
	public function setSubTitle(str:String):Void;
	/**
	...
	**/
	...
	/**
		wizard(self) -> QWizard
	**/
	public function wizard():Dynamic;
	/**
		x(self) -> int
	**/
