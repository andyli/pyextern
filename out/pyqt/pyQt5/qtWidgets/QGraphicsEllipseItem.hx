...
@:pythonImport("PyQt5.QtWidgets", "QGraphicsEllipseItem") extern class QGraphicsEllipseItem {
	/**
		int([x]) -> integer
	...
	**/
	public function setRect(args:haxe.extern.Rest<Dynamic>):Void;
	/**
	...
	**/
	public function setSpanAngle(int:Int):Void;
	/**
		setStartAngle(self, int)
	**/
	public function setStartAngle(int:Int):Void;
	/**
		setToolTip(self, str)
	**/
