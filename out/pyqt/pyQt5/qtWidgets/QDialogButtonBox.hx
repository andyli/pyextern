...
@:pythonImport("PyQt5.QtWidgets", "QDialogButtonBox") extern class QDialogButtonBox {
	static public var Abort : Dynamic;
	static public var AcceptRole : Dynamic;
	static public var ActionRole : Dynamic;
	static public var AndroidLayout : Dynamic;
	...
	**/
	public function button(QDialogButtonBox:Dynamic):Dynamic;
	/**
	...
	**/
	public function setCenterButtons(bool:Bool):Void;
	/**
