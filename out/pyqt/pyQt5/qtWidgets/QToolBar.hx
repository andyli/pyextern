...
@:pythonImport("PyQt5.QtWidgets", "QToolBar") extern class QToolBar {
	...
	**/
	public function addWidget(QWidget:Dynamic):Dynamic;
	/**
		adjustSize(self)
	**/
	...
	**/
	public function initStyleOption(QStyleOptionToolBar:Dynamic):Void;
	/**
	...
	**/
	public function insertWidget(QAction:Dynamic, QWidget:Dynamic):Dynamic;
	/**
	...
	**/
	public var movableChanged : Dynamic;
	/**
		move(self, QPoint)
		move(self, int, int)
	**/
	...
	**/
	public function setFloatable(bool:Bool):Void;
	/**
		setFocus(self)
	...
	**/
	public function widgetForAction(QAction:Dynamic):Dynamic;
	/**
		width(self) -> int
	**/
