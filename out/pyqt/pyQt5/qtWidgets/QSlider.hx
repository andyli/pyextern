...
@:pythonImport("PyQt5.QtWidgets", "QSlider") extern class QSlider {
	...
	**/
	public var actionTriggered : Dynamic;
	/**
	...
	**/
	public function initStyleOption(QStyleOptionSlider:Dynamic):Void;
	/**
	...
	**/
	public function repeatAction():Dynamic;
	/**
		resize(self, QSize)
		resize(self, int, int)
	**/
	...
	**/
	public function setInvertedAppearance(bool:Bool):Void;
	/**
		setInvertedControls(self, bool)
	**/
	public function setInvertedControls(bool:Bool):Void;
	/**
	...
	**/
	...
	/**
		setMaximum(self, int)
	**/
	public function setMaximum(int:Int):Void;
	/**
	...
	**/
	...
	/**
		setMinimum(self, int)
	**/
	public function setMinimum(int:Int):Void;
	/**
	...
	**/
	public function setOrientation(Qt:Dynamic):Void;
	/**
		setPageStep(self, int)
	**/
	public function setPageStep(int:Int):Void;
	/**
	...
	**/
	public function setRange(int:Int, int:Int):Void;
	/**
		setRepeatAction(self, QAbstractSlider.SliderAction, thresholdTime: int = 500, repeatTime: int = 50)
	**/
	public function setRepeatAction(QAbstractSlider:Dynamic, ?thresholdTime:Dynamic, ?repeatTime:Dynamic):Void;
	/**
	...
	**/
	public function setSingleStep(int:Int):Void;
	/**
	...
	**/
	public function setSliderDown(bool:Bool):Void;
	/**
		setSliderPosition(self, int)
	**/
	public function setSliderPosition(int:Int):Void;
	/**
	...
	**/
	public function setTickInterval(int:Int):Void;
	/**
		setTickPosition(self, QSlider.TickPosition)
	**/
	public function setTickPosition(QSlider:Dynamic):Void;
	/**
		setToolTip(self, str)
	**/
	...
	**/
	public function setTracking(bool:Bool):Void;
	/**
	...
	**/
	public function sliderChange(QAbstractSlider:Dynamic):Void;
	/**
		sliderMoved(self, int) [signal]
	**/
	public var sliderMoved : Dynamic;
	/**
	...
	**/
	public var sliderPressed : Dynamic;
	/**
		sliderReleased(self) [signal]
	**/
	public var sliderReleased : Dynamic;
	/**
	...
	**/
	public function tickPosition():Dynamic;
	/**
	...
	**/
	public function triggerAction(QAbstractSlider:Dynamic):Void;
	/**
