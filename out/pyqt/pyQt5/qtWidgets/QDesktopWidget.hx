...
@:pythonImport("PyQt5.QtWidgets", "QDesktopWidget") extern class QDesktopWidget {
	...
	**/
	public function screen(?screen:Dynamic):Dynamic;
	/**
	...
	**/
	public var screenCountChanged : Dynamic;
	/**
	...
	**/
	public function screenNumber(args:haxe.extern.Rest<Dynamic>):Int;
	/**
		scroll(self, int, int)
	...
	**/
	public var workAreaResized : Dynamic;
	/**
		x(self) -> int
	**/
