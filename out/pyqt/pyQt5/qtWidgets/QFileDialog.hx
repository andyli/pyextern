...
@:pythonImport("PyQt5.QtWidgets", "QFileDialog") extern class QFileDialog {
	...
	**/
	static public function Options(args:haxe.extern.Rest<Dynamic>):Void;
	/**
		int([x]) -> integer
		int(x, base=10) -> integer
	...
	**/
	public function acceptMode():Dynamic;
	/**
	...
	**/
	public var currentUrlChanged : Dynamic;
	/**
		cursor(self) -> QCursor
	**/
	...
	**/
	...
	/**
		directory(self) -> QDir
	**/
	public function directory():Dynamic;
	/**
		directoryEntered(self, str) [signal]
	**/
	public var directoryEntered : Dynamic;
	/**
		directoryUrl(self) -> QUrl
	**/
	public function directoryUrl():Dynamic;
	/**
		directoryUrlEntered(self, QUrl) [signal]
	**/
	public var directoryUrlEntered : Dynamic;
	/**
		disconnect(self)
	**/
	...
	**/
	public function done(int:Int):Void;
	/**
	...
	**/
	public function fileMode():Dynamic;
	/**
		fileSelected(self, str) [signal]
	**/
	public var fileSelected : Dynamic;
	/**
		filesSelected(self, Iterable[str]) [signal]
	**/
	public var filesSelected : Dynamic;
	/**
	...
	**/
	public var filterSelected : Dynamic;
	/**
	...
	**/
	static public function getExistingDirectory(?parent:Dynamic, ?caption:Dynamic, ?directory:Dynamic, ?options:Dynamic):String;
	/**
	...
	**/
	static public function getExistingDirectoryUrl(?parent:Dynamic, ?caption:Dynamic, ?directory:Dynamic, ?options:Dynamic, ?supportedSchemes:Dynamic):Dynamic;
	/**
	...
	**/
	static public function getOpenFileName(?parent:Dynamic, ?caption:Dynamic, ?directory:Dynamic, ?filter:Dynamic, ?initialFilter:Dynamic, ?options:Dynamic):Dynamic;
	/**
	...
	**/
	static public function getOpenFileNames(?parent:Dynamic, ?caption:Dynamic, ?directory:Dynamic, ?filter:Dynamic, ?initialFilter:Dynamic, ?options:Dynamic):Dynamic;
	/**
	...
	**/
	static public function getOpenFileUrl(?parent:Dynamic, ?caption:Dynamic, ?directory:Dynamic, ?filter:Dynamic, ?initialFilter:Dynamic, ?options:Dynamic, ?supportedSchemes:Dynamic):Dynamic;
	/**
	...
	**/
	static public function getOpenFileUrls(?parent:Dynamic, ?caption:Dynamic, ?directory:Dynamic, ?filter:Dynamic, ?initialFilter:Dynamic, ?options:Dynamic, ?supportedSchemes:Dynamic):Dynamic;
	/**
	...
	**/
	static public function getSaveFileName(?parent:Dynamic, ?caption:Dynamic, ?directory:Dynamic, ?filter:Dynamic, ?initialFilter:Dynamic, ?options:Dynamic):Dynamic;
	/**
	...
	**/
	static public function getSaveFileUrl(?parent:Dynamic, ?caption:Dynamic, ?directory:Dynamic, ?filter:Dynamic, ?initialFilter:Dynamic, ?options:Dynamic, ?supportedSchemes:Dynamic):Dynamic;
	/**
	...
	**/
	public function labelText(QFileDialog:Dynamic):String;
	/**
		layout(self) -> QLayout
	**/
	...
	**/
	public function mimeTypeFilters():Dynamic;
	/**
	...
	**/
	public function proxyModel():Dynamic;
	/**
	...
	**/
	...
	/**
		selectFile(self, str)
	**/
	public function selectFile(str:String):Void;
	/**
		selectMimeTypeFilter(self, str)
	**/
	public function selectMimeTypeFilter(str:String):Void;
	/**
		selectNameFilter(self, str)
	**/
	public function selectNameFilter(str:String):Void;
	/**
		selectUrl(self, QUrl)
	**/
	public function selectUrl(QUrl:Dynamic):Void;
	/**
		selectedFiles(self) -> List[str]
	**/
	public function selectedFiles():Dynamic;
	/**
	...
	**/
	public function selectedUrls():Dynamic;
	/**
		sender(self) -> QObject
	**/
	...
	**/
	public function setAcceptMode(QFileDialog:Dynamic):Void;
	/**
	...
	**/
	public function setDefaultSuffix(str:String):Void;
	/**
		setDirectory(self, str)
		setDirectory(self, QDir)
	**/
	public function setDirectory(args:haxe.extern.Rest<Dynamic>):Void;
	/**
		setDirectoryUrl(self, QUrl)
	**/
	public function setDirectoryUrl(QUrl:Dynamic):Void;
	/**
	...
	**/
	public function setFileMode(QFileDialog:Dynamic):Void;
	/**
	...
	**/
	public function setHistory(Iterable:Dynamic):Void;
	/**
	...
	**/
	public function setLabelText(QFileDialog:Dynamic, str:String):Void;
	/**
	...
	**/
	public function setMimeTypeFilters(Iterable:Dynamic):Void;
	/**
	...
	**/
	...
	/**
		setModal(self, bool)
	**/
	public function setModal(bool:Bool):Void;
	/**
	...
	**/
	public function setNameFilter(str:String):Void;
	/**
	...
	**/
	public function setOption(QFileDialog:Dynamic, ?on:Dynamic):Void;
	/**
	...
	**/
	public function setProxyModel(QAbstractProxyModel:Dynamic):Void;
	/**
		setResult(self, int)
	**/
	public function setResult(int:Int):Void;
	/**
	...
	**/
	public function setSidebarUrls(Iterable:Dynamic):Void;
	/**
		setSizeGripEnabled(self, bool)
	**/
	public function setSizeGripEnabled(bool:Bool):Void;
	/**
	...
	**/
	public function setSupportedSchemes(Iterable:Dynamic):Void;
	/**
	...
	**/
	public function setViewMode(QFileDialog:Dynamic):Void;
	/**
	...
	**/
	public function sidebarUrls():Dynamic;
	/**
	...
	**/
	public function testOption(QFileDialog:Dynamic):Bool;
	/**
		thread(self) -> QThread
	**/
	...
	**/
	public var urlSelected : Dynamic;
	/**
		urlsSelected(self, Iterable[QUrl]) [signal]
	**/
	public var urlsSelected : Dynamic;
	/**
