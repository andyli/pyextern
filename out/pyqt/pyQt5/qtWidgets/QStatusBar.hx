...
@:pythonImport("PyQt5.QtWidgets", "QStatusBar") extern class QStatusBar {
	...
	**/
	public function addPermanentWidget(QWidget:Dynamic, ?stretch:Dynamic):Void;
	/**
		addWidget(self, QWidget, stretch: int = 0)
	**/
	public function addWidget(QWidget:Dynamic, ?stretch:Dynamic):Void;
	/**
		adjustSize(self)
	**/
	...
	**/
	public function insertPermanentWidget(int:Int, QWidget:Dynamic, ?stretch:Dynamic):Int;
	/**
		insertWidget(self, int, QWidget, stretch: int = 0) -> int
	**/
	public function insertWidget(int:Int, QWidget:Dynamic, ?stretch:Dynamic):Int;
	/**
	...
	**/
	public var messageChanged : Dynamic;
	/**
	...
	**/
	public function showMessage(str:String, ?msecs:Dynamic):Void;
	/**
		showMinimized(self)
	**/
