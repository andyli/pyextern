...
@:pythonImport("PyQt5.QtWidgets", "QColorDialog") extern class QColorDialog {
	...
	/**
		...
		4
	**/
	public function ColorDialogOption(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	static public function ColorDialogOptions(args:haxe.extern.Rest<Dynamic>):Void;
	/**
		int([x]) -> integer
		int(x, base=10) -> integer
	...
	**/
	...
	static public var ShowAlphaChannel : Dynamic;
	...
	**/
	public var colorSelected : Dynamic;
	/**
	...
	**/
	public function currentColor():Dynamic;
	/**
		currentColorChanged(self, Union[QColor, Qt.GlobalColor, QGradient]) [signal]
	**/
	public var currentColorChanged : Dynamic;
	/**
		cursor(self) -> QCursor
	**/
	...
	**/
	static public function customColor(int:Int):Dynamic;
	/**
	...
	**/
	...
	/**
		customCount() -> int
	**/
	static public function customCount():Int;
	/**
	...
	**/
	static public function getColor(?initial:Dynamic, ?parent:Dynamic, ?title:Dynamic, ?options:Dynamic):Dynamic;
	/**
	...
	**/
	public function selectedColor():Dynamic;
	/**
		sender(self) -> QObject
	**/
	...
	**/
	public function setCurrentColor(Union:Dynamic):Void;
	/**
	...
	**/
	static public function setCustomColor(int:Int, Union:Dynamic):Void;
	/**
	...
	**/
	public function setOption(QColorDialog:Dynamic, ?on:Dynamic):Void;
	/**
	...
	**/
	static public function setStandardColor(int:Int, Union:Dynamic):Void;
	/**
	...
	**/
	static public function standardColor(int:Int):Dynamic;
	/**
	...
	**/
	public function testOption(QColorDialog:Dynamic):Bool;
	/**
		thread(self) -> QThread
	**/
