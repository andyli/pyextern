...
@:pythonImport("PyQt5.QtWidgets", "QGraphicsPolygonItem") extern class QGraphicsPolygonItem {
	/**
		int([x]) -> integer
	...
	**/
	public function polygon():Dynamic;
	/**
		pos(self) -> QPointF
	**/
	...
	**/
	public function setPolygon(QPolygonF:Dynamic):Void;
	/**
