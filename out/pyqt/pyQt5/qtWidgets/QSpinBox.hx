...
@:pythonImport("PyQt5.QtWidgets", "QSpinBox") extern class QSpinBox {
	...
	**/
	public function setDisplayIntegerBase(int:Int):Void;
	/**
	...
	**/
	public function textFromValue(int:Int):String;
	/**
		thread(self) -> QThread
	**/
	...
	**/
	public function valueFromText(str:String):Int;
	/**
