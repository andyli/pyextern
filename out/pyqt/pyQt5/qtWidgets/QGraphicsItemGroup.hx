...
@:pythonImport("PyQt5.QtWidgets", "QGraphicsItemGroup") extern class QGraphicsItemGroup {
	/**
		int([x]) -> integer
	...
	**/
	public function addToGroup(QGraphicsItem:Dynamic):Void;
	/**
		advance(self, int)
	**/
	...
	**/
	public function removeFromGroup(QGraphicsItem:Dynamic):Void;
	/**
