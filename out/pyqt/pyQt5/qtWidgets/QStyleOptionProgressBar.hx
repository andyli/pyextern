...
@:pythonImport("PyQt5.QtWidgets", "QStyleOptionProgressBar") extern class QStyleOptionProgressBar {
	/**
		int([x]) -> integer
	...
	**/
	...
	public var bottomToTop : Dynamic;
	...
	**/
	...
	public var invertedAppearance : Dynamic;
	...
	public var textVisible : Dynamic;
