...
@:pythonImport("PyQt5.QtWidgets", "QPanGesture") extern class QPanGesture {
	...
	**/
	public function lastOffset():Dynamic;
	/**
	...
	**/
	public function setAcceleration(float:Float):Void;
	/**
	...
	**/
	public function setLastOffset(Union:Dynamic):Void;
	/**
