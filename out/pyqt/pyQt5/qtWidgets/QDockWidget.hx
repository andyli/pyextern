...
@:pythonImport("PyQt5.QtWidgets", "QDockWidget") extern class QDockWidget {
	...
	**/
	static public function DockWidgetFeatures(args:haxe.extern.Rest<Dynamic>):Void;
	...
	**/
	public function allowedAreas():Dynamic;
	/**
		allowedAreasChanged(self, Union[Qt.DockWidgetAreas, Qt.DockWidgetArea]) [signal]
	**/
	public var allowedAreasChanged : Dynamic;
	/**
	...
	**/
	public var dockLocationChanged : Dynamic;
	/**
	...
	**/
	public var featuresChanged : Dynamic;
	/**
	...
	**/
	public function initStyleOption(QStyleOptionDockWidget:Dynamic):Void;
	/**
	...
	**/
	public function isAreaAllowed(Qt:Dynamic):Bool;
	/**
		isEnabled(self) -> bool
	**/
	...
	**/
	public function setAllowedAreas(Union:Dynamic):Void;
	/**
	...
	**/
	public function setFloating(bool:Bool):Void;
	/**
		setFocus(self)
	...
	**/
	public function setTitleBarWidget(QWidget:Dynamic):Void;
	/**
		setToolTip(self, str)
	**/
	...
	**/
	public function titleBarWidget():Dynamic;
	/**
		toggleViewAction(self) -> QAction
	**/
	public function toggleViewAction():Dynamic;
	/**
		toolTip(self) -> str
	**/
	...
	**/
	public var topLevelChanged : Dynamic;
	/**
