...
@:pythonImport("PyQt5.QtWidgets", "QTabBar") extern class QTabBar {
	/**
		int([x]) -> integer
	...
	**/
	public function accessibleTabName(int:Int):String;
	/**
	...
	**/
	public function addTab(args:haxe.extern.Rest<Dynamic>):Int;
	/**
		adjustSize(self)
	**/
	...
	**/
	public function initStyleOption(QStyleOptionTab:Dynamic, int:Int):Void;
	/**
	...
	**/
	public function insertTab(int:Int, args:haxe.extern.Rest<Dynamic>):Int;
	/**
	...
	**/
	public function minimumTabSizeHint(int:Int):Dynamic;
	/**
	...
	**/
	public function moveTab(int:Int, int:Int):Void;
	/**
	...
	**/
	public function selectionBehaviorOnRemove():Dynamic;
	/**
		sender(self) -> QObject
	**/
	...
	**/
	public function setAccessibleTabName(int:Int, str:String):Void;
	/**
	...
	**/
	public function setAutoHide(bool:Bool):Void;
	/**
	...
	**/
	public function setChangeCurrentOnDrag(bool:Bool):Void;
	/**
	...
	**/
	public function setDrawBase(bool:Bool):Void;
	/**
	...
	**/
	public function setExpanding(bool:Bool):Void;
	/**
	...
	**/
	public function setSelectionBehaviorOnRemove(QTabBar:Dynamic):Void;
	/**
		setShape(self, QTabBar.Shape)
	**/
	public function setShape(QTabBar:Dynamic):Void;
	/**
	...
	**/
	public function setTabButton(int:Int, QTabBar:Dynamic, QWidget:Dynamic):Void;
	/**
		setTabData(self, int, Any)
	**/
	public function setTabData(int:Int, Any:Dynamic):Void;
	/**
	...
	**/
	public function setTabTextColor(int:Int, Union:Dynamic):Void;
	/**
	...
	**/
	public function tabAt(QPoint:Dynamic):Int;
	/**
	...
	**/
	public function tabButton(int:Int, QTabBar:Dynamic):Dynamic;
	/**
	...
	**/
	public function tabData(int:Int):Dynamic;
	/**
	...
	**/
	public function tabLayoutChange():Void;
	/**
		tabMoved(self, int, int) [signal]
	**/
	public var tabMoved : Dynamic;
	/**
		tabRect(self, int) -> QRect
	**/
	public function tabRect(int:Int):Dynamic;
	/**
		tabRemoved(self, int)
	**/
	...
	**/
	public function tabSizeHint(int:Int):Dynamic;
	/**
	...
	**/
	public function tabTextColor(int:Int):Dynamic;
	/**
