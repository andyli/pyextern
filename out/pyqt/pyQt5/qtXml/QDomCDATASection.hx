...
package pyQt5.qtXml;
@:pythonImport("PyQt5.QtXml", "QDomCDATASection") extern class QDomCDATASection {
	...
	**/
	public function deleteData(int:Int, int:Int):Void;
	/**
	...
	**/
	public function insertData(int:Int, str:String):Void;
	/**
		isAttr(self) -> bool
	**/
	...
	**/
	public function replaceData(int:Int, int:Int, str:String):Void;
	/**
	...
	**/
	public function splitText(int:Int):Dynamic;
	/**
		substringData(self, int, int) -> str
	**/
	public function substringData(int:Int, int:Int):String;
	/**
