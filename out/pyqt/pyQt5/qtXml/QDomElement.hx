...
package pyQt5.qtXml;
@:pythonImport("PyQt5.QtXml", "QDomElement") extern class QDomElement {
	...
	**/
	public function attributeNode(str:String):Dynamic;
	/**
		attributeNodeNS(self, str, str) -> QDomAttr
	**/
	public function attributeNodeNS(str:String, str:String):Dynamic;
	/**
	...
	**/
	public function removeAttributeNode(QDomAttr:Dynamic):Dynamic;
	/**
	...
	**/
	...
	/**
		...
		setAttribute(self, str, int)
	**/
	public function setAttribute(str:String, args:haxe.extern.Rest<Dynamic>):Void;
	/**
		...
		setAttributeNS(self, str, str, int)
	**/
	public function setAttributeNS(str:String, str:String, args:haxe.extern.Rest<Dynamic>):Void;
	/**
		setAttributeNode(self, QDomAttr) -> QDomAttr
	**/
	public function setAttributeNode(QDomAttr:Dynamic):Dynamic;
	/**
		setAttributeNodeNS(self, QDomAttr) -> QDomAttr
	**/
	public function setAttributeNodeNS(QDomAttr:Dynamic):Dynamic;
	/**
	...
	**/
	...
	/**
		setTagName(self, str)
	**/
	public function setTagName(str:String):Void;
	/**
		tagName(self) -> str
	**/
