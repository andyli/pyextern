...
package pkgutil;
@:pythonImport("pkgutil", "ImpLoader") extern class ImpLoader {
	...
	**/
	...
	public function _fix_name(fullname:Dynamic):Dynamic;
	public function _get_delegate():Dynamic;
	public function _reopen():Dynamic;
	static public var code : Dynamic;
	public function get_code(?fullname:Dynamic):Dynamic;
	public function get_data(pathname:Dynamic):Dynamic;
