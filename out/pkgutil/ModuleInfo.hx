...
package pkgutil;
@:pythonImport("pkgutil", "ModuleInfo") extern class ModuleInfo {
	/**
		Return self+value.
	**/
	...
	**/
	static public function __new__(_cls:Dynamic, module_finder:Dynamic, name:Dynamic, ispkg:Dynamic):Dynamic;
	/**
		helper for pickle
	**/
	...
	**/
	public var ispkg : Dynamic;
	/**
		Alias for field number 0
	**/
	public var module_finder : Dynamic;
	/**
