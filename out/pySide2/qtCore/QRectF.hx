...
@:pythonImport("PySide2.QtCore", "QRectF") extern class QRectF {
	/**
		Return self+value.
	**/
	...
	**/
	...
	public function toAlignedRect(args:haxe.extern.Rest<Dynamic>):Dynamic;
	public function toRect(args:haxe.extern.Rest<Dynamic>):Dynamic;
