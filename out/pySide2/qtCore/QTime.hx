...
@:pythonImport("PySide2.QtCore", "QTime") extern class QTime {
	/**
		self != 0
	**/
	...
	**/
	...
	static public function currentTime(args:haxe.extern.Rest<Dynamic>):Dynamic;
	public function elapsed(args:haxe.extern.Rest<Dynamic>):Dynamic;
	static public function fromMSecsSinceStartOfDay(args:haxe.extern.Rest<Dynamic>):Dynamic;
	static public function fromString(args:haxe.extern.Rest<Dynamic>):Dynamic;
	public function hour(args:haxe.extern.Rest<Dynamic>):Dynamic;
	...
	public function minute(args:haxe.extern.Rest<Dynamic>):Dynamic;
	public function msec(args:haxe.extern.Rest<Dynamic>):Dynamic;
	public function msecsSinceStartOfDay(args:haxe.extern.Rest<Dynamic>):Dynamic;
	...
	public function second(args:haxe.extern.Rest<Dynamic>):Dynamic;
	public function secsTo(args:haxe.extern.Rest<Dynamic>):Dynamic;
	public function setHMS(args:haxe.extern.Rest<Dynamic>):Dynamic;
