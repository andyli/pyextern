...
@:pythonImport("PySide2.QtCore", "QFileSelector") extern class QFileSelector {
	...
	**/
	...
	public function allSelectors(args:haxe.extern.Rest<Dynamic>):Dynamic;
	...
	public function extraSelectors(args:haxe.extern.Rest<Dynamic>):Dynamic;
	...
	public function setExtraSelectors(args:haxe.extern.Rest<Dynamic>):Dynamic;
