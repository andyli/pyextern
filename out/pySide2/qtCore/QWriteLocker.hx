...
@:pythonImport("PySide2.QtCore", "QWriteLocker") extern class QWriteLocker {
	...
	**/
	...
	public function readWriteLock(args:haxe.extern.Rest<Dynamic>):Dynamic;
	public function relock(args:haxe.extern.Rest<Dynamic>):Dynamic;
