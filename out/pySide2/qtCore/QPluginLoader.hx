...
@:pythonImport("PySide2.QtCore", "QPluginLoader") extern class QPluginLoader {
	...
	**/
	...
	public function instance(args:haxe.extern.Rest<Dynamic>):Dynamic;
	...
	static public function staticInstances(args:haxe.extern.Rest<Dynamic>):Dynamic;
