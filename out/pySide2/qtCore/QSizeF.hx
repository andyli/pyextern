...
@:pythonImport("PySide2.QtCore", "QSizeF") extern class QSizeF {
	/**
		Return self+value.
	**/
	...
	**/
	...
	public function boundedTo(args:haxe.extern.Rest<Dynamic>):Dynamic;
	public function expandedTo(args:haxe.extern.Rest<Dynamic>):Dynamic;
	...
	public function toSize(args:haxe.extern.Rest<Dynamic>):Dynamic;
