...
@:pythonImport("PySide2.QtCore", "QSocketNotifier") extern class QSocketNotifier {
	static public var Exception : Dynamic;
	...
	**/
	...
	public function socket(args:haxe.extern.Rest<Dynamic>):Dynamic;
