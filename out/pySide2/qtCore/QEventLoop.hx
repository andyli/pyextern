...
@:pythonImport("PySide2.QtCore", "QEventLoop") extern class QEventLoop {
	static public var AllEvents : Dynamic;
	static public var DialogExec : Dynamic;
	static public var EventLoopExec : Dynamic;
	static public var ExcludeSocketNotifiers : Dynamic;
	static public var ExcludeUserInputEvents : Dynamic;
	public function ProcessEventsFlag(args:haxe.extern.Rest<Dynamic>):Dynamic;
	public function ProcessEventsFlags(args:haxe.extern.Rest<Dynamic>):Dynamic;
	static public var WaitForMoreEvents : Dynamic;
	static public var X11ExcludeTimers : Dynamic;
