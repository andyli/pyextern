...
@:pythonImport("PySide2.QtCore", "QJsonArray") extern class QJsonArray {
	/**
		Return self+value.
	**/
	...
	**/
	...
	static public function fromVariantList(args:haxe.extern.Rest<Dynamic>):Dynamic;
	...
	public function toVariantList(args:haxe.extern.Rest<Dynamic>):Dynamic;
}