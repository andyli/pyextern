...
@:pythonImport("PySide2.QtCore", "QBuffer") extern class QBuffer {
	...
	**/
	...
	public function buffer(args:haxe.extern.Rest<Dynamic>):Dynamic;
	...
	public function setBuffer(args:haxe.extern.Rest<Dynamic>):Dynamic;
