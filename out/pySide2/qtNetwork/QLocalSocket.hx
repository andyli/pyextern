...
@:pythonImport("PySide2.QtNetwork", "QLocalSocket") extern class QLocalSocket {
	...
	public function LocalSocketError(args:haxe.extern.Rest<Dynamic>):Dynamic;
	public function LocalSocketState(args:haxe.extern.Rest<Dynamic>):Dynamic;
	...
	static public var PeerClosedError : Dynamic;
	static public var ReadOnly : Dynamic;
	static public var ReadWrite : Dynamic;
	static public var ServerNotFoundError : Dynamic;
	...
	**/
	...
	public function connectToServer(args:haxe.extern.Rest<Dynamic>):Dynamic;
	...
	public function disconnectFromServer(args:haxe.extern.Rest<Dynamic>):Dynamic;
