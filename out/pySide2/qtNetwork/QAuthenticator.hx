...
@:pythonImport("PySide2.QtNetwork", "QAuthenticator") extern class QAuthenticator {
	/**
		self != 0
	**/
	...
	**/
	...
	public function realm(args:haxe.extern.Rest<Dynamic>):Dynamic;
	...
	public function setRealm(args:haxe.extern.Rest<Dynamic>):Dynamic;
