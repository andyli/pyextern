...
package pySide2.qtQuickWidgets;
@:pythonImport("PySide2.QtQuickWidgets", "QQuickWidget") extern class QQuickWidget {
	...
	**/
	...
	public function quickWindow(args:haxe.extern.Rest<Dynamic>):Dynamic;
