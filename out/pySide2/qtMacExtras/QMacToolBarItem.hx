...
@:pythonImport("PySide2.QtMacExtras", "QMacToolBarItem") extern class QMacToolBarItem {
	static public var FlexibleSpace : Dynamic;
	static public var NoStandardItem : Dynamic;
	static public var Space : Dynamic;
	public function StandardItem(args:haxe.extern.Rest<Dynamic>):Dynamic;
	...
	**/
	...
	public function selectable(args:haxe.extern.Rest<Dynamic>):Dynamic;
	...
	public function setStandardItem(args:haxe.extern.Rest<Dynamic>):Dynamic;
