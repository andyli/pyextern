...
@:pythonImport("PySide2.QtQml", "QQmlExtensionPlugin") extern class QQmlExtensionPlugin {
	...
	**/
	...
	public function initializeEngine(args:haxe.extern.Rest<Dynamic>):Dynamic;
	...
	public function registerTypes(args:haxe.extern.Rest<Dynamic>):Dynamic;
