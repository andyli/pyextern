...
@:pythonImport("PySide2.QtWebEngineWidgets", "QWebEngineHistoryItem") extern class QWebEngineHistoryItem {
	...
	**/
	...
	public function lastVisited(args:haxe.extern.Rest<Dynamic>):Dynamic;
	public function originalUrl(args:haxe.extern.Rest<Dynamic>):Dynamic;
