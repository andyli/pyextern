...
@:pythonImport("PySide2.QtMultimedia", "QMediaRecorderControl") extern class QMediaRecorderControl {
	...
	**/
	...
	public function applySettings(args:haxe.extern.Rest<Dynamic>):Dynamic;
