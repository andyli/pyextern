...
@:pythonImport("PySide2.QtMultimedia", "QImageEncoderControl") extern class QImageEncoderControl {
	...
	**/
	...
	public function imageSettings(args:haxe.extern.Rest<Dynamic>):Dynamic;
	...
	public function setImageSettings(args:haxe.extern.Rest<Dynamic>):Dynamic;
