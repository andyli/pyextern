...
@:pythonImport("PySide2.QtMultimedia", "QMediaPlayerControl") extern class QMediaPlayerControl {
	...
	**/
	...
	public function availablePlaybackRanges(args:haxe.extern.Rest<Dynamic>):Dynamic;
	public function availablePlaybackRangesChanged(args:haxe.extern.Rest<Dynamic>):Dynamic;
