...
@:pythonImport("PySide2.QtMultimedia", "QCameraControl") extern class QCameraControl {
	static public var CaptureMode : Dynamic;
	static public var ImageEncodingSettings : Dynamic;
	public function PropertyChangeType(args:haxe.extern.Rest<Dynamic>):Dynamic;
	static public var VideoEncodingSettings : Dynamic;
	static public var Viewfinder : Dynamic;
	static public var ViewfinderSettings : Dynamic;
	...
	**/
	...
	public function canChangeProperty(args:haxe.extern.Rest<Dynamic>):Dynamic;
