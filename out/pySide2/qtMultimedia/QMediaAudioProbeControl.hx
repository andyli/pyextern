...
@:pythonImport("PySide2.QtMultimedia", "QMediaAudioProbeControl") extern class QMediaAudioProbeControl {
	...
	**/
	...
	public function audioBufferProbed(args:haxe.extern.Rest<Dynamic>):Dynamic;
