...
@:pythonImport("PySide2.QtMultimedia", "QAbstractVideoFilter") extern class QAbstractVideoFilter {
	...
	**/
	...
	public function createFilterRunnable(args:haxe.extern.Rest<Dynamic>):Dynamic;
