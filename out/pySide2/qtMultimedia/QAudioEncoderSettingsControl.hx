...
@:pythonImport("PySide2.QtMultimedia", "QAudioEncoderSettingsControl") extern class QAudioEncoderSettingsControl {
	...
	**/
	...
	public function codecDescription(args:haxe.extern.Rest<Dynamic>):Dynamic;
