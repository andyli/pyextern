...
@:pythonImport("PySide2.QtMultimedia", "QSound") extern class QSound {
	...
	**/
	...
	public function loops(args:haxe.extern.Rest<Dynamic>):Dynamic;
	...
	public function setLoops(args:haxe.extern.Rest<Dynamic>):Dynamic;
