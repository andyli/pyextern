...
@:pythonImport("PySide2.QtMultimedia", "QMediaNetworkAccessControl") extern class QMediaNetworkAccessControl {
	...
	**/
	...
	public function currentConfiguration(args:haxe.extern.Rest<Dynamic>):Dynamic;
	...
	public function setConfigurations(args:haxe.extern.Rest<Dynamic>):Dynamic;
