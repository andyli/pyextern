...
@:pythonImport("PySide2.QtMultimedia", "QCameraImageCaptureControl") extern class QCameraImageCaptureControl {
	...
	**/
	...
	public function setDriveMode(args:haxe.extern.Rest<Dynamic>):Dynamic;
