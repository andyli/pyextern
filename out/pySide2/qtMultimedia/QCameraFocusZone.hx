...
@:pythonImport("PySide2.QtMultimedia", "QCameraFocusZone") extern class QCameraFocusZone {
	public function FocusZoneStatus(args:haxe.extern.Rest<Dynamic>):Dynamic;
	static public var Focused : Dynamic;
	static public var Invalid : Dynamic;
	static public var Selected : Dynamic;
	static public var Unused : Dynamic;
	...
	**/
	...
	public function area(args:haxe.extern.Rest<Dynamic>):Dynamic;
