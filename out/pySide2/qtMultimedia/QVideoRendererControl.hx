...
@:pythonImport("PySide2.QtMultimedia", "QVideoRendererControl") extern class QVideoRendererControl {
	...
	**/
	...
	public function setSurface(args:haxe.extern.Rest<Dynamic>):Dynamic;
