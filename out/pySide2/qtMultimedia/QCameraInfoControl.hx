...
@:pythonImport("PySide2.QtMultimedia", "QCameraInfoControl") extern class QCameraInfoControl {
	...
	**/
	...
	public function cameraOrientation(args:haxe.extern.Rest<Dynamic>):Dynamic;
	public function cameraPosition(args:haxe.extern.Rest<Dynamic>):Dynamic;
