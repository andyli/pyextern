...
@:pythonImport("PySide2.QtMultimedia", "QAbstractAudioInput") extern class QAbstractAudioInput {
	...
	**/
	...
	public function bytesReady(args:haxe.extern.Rest<Dynamic>):Dynamic;
