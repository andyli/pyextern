...
@:pythonImport("PySide2.QtXml", "QXmlNamespaceSupport") extern class QXmlNamespaceSupport {
	...
	**/
	...
	public function processName(args:haxe.extern.Rest<Dynamic>):Dynamic;
	...
	public function splitName(args:haxe.extern.Rest<Dynamic>):Dynamic;
	public function uri(args:haxe.extern.Rest<Dynamic>):Dynamic;
}