...
@:pythonImport("PySide2.QtXml", "QXmlInputSource") extern class QXmlInputSource {
	...
	**/
	...
	public function fetchData(args:haxe.extern.Rest<Dynamic>):Dynamic;
	public function fromRawData(args:haxe.extern.Rest<Dynamic>):Dynamic;
