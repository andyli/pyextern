...
@:pythonImport("PySide2.QtXml", "QDomAttr") extern class QDomAttr {
	...
	**/
	...
	public function ownerElement(args:haxe.extern.Rest<Dynamic>):Dynamic;
	...
	public function specified(args:haxe.extern.Rest<Dynamic>):Dynamic;
