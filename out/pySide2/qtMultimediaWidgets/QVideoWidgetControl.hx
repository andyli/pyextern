...
package pySide2.qtMultimediaWidgets;
@:pythonImport("PySide2.QtMultimediaWidgets", "QVideoWidgetControl") extern class QVideoWidgetControl {
	...
	**/
	...
	public function videoWidget(args:haxe.extern.Rest<Dynamic>):Dynamic;
}