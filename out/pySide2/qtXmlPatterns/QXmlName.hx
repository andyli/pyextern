...
@:pythonImport("PySide2.QtXmlPatterns", "QXmlName") extern class QXmlName {
	/**
		self != 0
	**/
	...
	**/
	...
	static public function fromClarkName(args:haxe.extern.Rest<Dynamic>):Dynamic;
	static public function isNCName(args:haxe.extern.Rest<Dynamic>):Dynamic;
	...
	public function toClarkName(args:haxe.extern.Rest<Dynamic>):Dynamic;
}