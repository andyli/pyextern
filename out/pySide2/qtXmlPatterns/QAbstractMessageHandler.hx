...
@:pythonImport("PySide2.QtXmlPatterns", "QAbstractMessageHandler") extern class QAbstractMessageHandler {
	...
	**/
	...
	public function handleMessage(args:haxe.extern.Rest<Dynamic>):Dynamic;
