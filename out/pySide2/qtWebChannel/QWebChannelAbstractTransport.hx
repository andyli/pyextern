...
@:pythonImport("PySide2.QtWebChannel", "QWebChannelAbstractTransport") extern class QWebChannelAbstractTransport {
	...
	**/
	...
	public function messageReceived(args:haxe.extern.Rest<Dynamic>):Dynamic;
	...
	public function sendMessage(args:haxe.extern.Rest<Dynamic>):Dynamic;
