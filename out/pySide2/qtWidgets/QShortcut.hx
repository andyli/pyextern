...
@:pythonImport("PySide2.QtWidgets", "QShortcut") extern class QShortcut {
	...
	**/
	...
	public function activatedAmbiguously(args:haxe.extern.Rest<Dynamic>):Dynamic;
	...
	public function setContext(args:haxe.extern.Rest<Dynamic>):Dynamic;
