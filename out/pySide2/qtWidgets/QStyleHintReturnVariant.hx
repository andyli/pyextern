...
@:pythonImport("PySide2.QtWidgets", "QStyleHintReturnVariant") extern class QStyleHintReturnVariant {
	public function HintReturnType(args:haxe.extern.Rest<Dynamic>):Dynamic;
	static public var SH_Default : Dynamic;
	static public var SH_Mask : Dynamic;
	static public var SH_Variant : Dynamic;
