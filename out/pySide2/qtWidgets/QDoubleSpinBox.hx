...
@:pythonImport("PySide2.QtWidgets", "QDoubleSpinBox") extern class QDoubleSpinBox {
	...
	**/
	...
	public function decimals(args:haxe.extern.Rest<Dynamic>):Dynamic;
	...
	public function setDecimals(args:haxe.extern.Rest<Dynamic>):Dynamic;
