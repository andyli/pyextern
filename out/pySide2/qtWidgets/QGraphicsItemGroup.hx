...
@:pythonImport("PySide2.QtWidgets", "QGraphicsItemGroup") extern class QGraphicsItemGroup {
	...
	**/
	...
	public function addToGroup(args:haxe.extern.Rest<Dynamic>):Dynamic;
	...
	public function removeFromGroup(args:haxe.extern.Rest<Dynamic>):Dynamic;
