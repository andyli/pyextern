...
@:pythonImport("PySide2.QtWidgets", "QStyleOptionViewItem") extern class QStyleOptionViewItem {
	...
	public function ViewItemFeatures(args:haxe.extern.Rest<Dynamic>):Dynamic;
