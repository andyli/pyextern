...
@:pythonImport("PySide2.QtWidgets", "QStyleOptionGraphicsItem") extern class QStyleOptionGraphicsItem {
	...
	**/
	...
	public var exposedRect : Dynamic;
	...
	public var levelOfDetail : Dynamic;
	static public function levelOfDetailFromTransform(args:haxe.extern.Rest<Dynamic>):Dynamic;
