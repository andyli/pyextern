...
@:pythonImport("PySide2.QtWidgets", "QGraphicsPixmapItem") extern class QGraphicsPixmapItem {
	...
	**/
	...
	public function setShapeMode(args:haxe.extern.Rest<Dynamic>):Dynamic;
	...
	public function setTransformationMode(args:haxe.extern.Rest<Dynamic>):Dynamic;
