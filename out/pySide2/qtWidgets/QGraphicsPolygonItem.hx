...
@:pythonImport("PySide2.QtWidgets", "QGraphicsPolygonItem") extern class QGraphicsPolygonItem {
	...
	**/
	...
	public function polygon(args:haxe.extern.Rest<Dynamic>):Dynamic;
	...
	public function setPolygon(args:haxe.extern.Rest<Dynamic>):Dynamic;
