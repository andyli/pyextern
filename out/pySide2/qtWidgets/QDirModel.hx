...
@:pythonImport("PySide2.QtWidgets", "QDirModel") extern class QDirModel {
	...
	**/
	...
	public function lazyChildCount(args:haxe.extern.Rest<Dynamic>):Dynamic;
	...
	public function setLazyChildCount(args:haxe.extern.Rest<Dynamic>):Dynamic;
