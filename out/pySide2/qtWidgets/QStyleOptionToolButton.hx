...
@:pythonImport("PySide2.QtWidgets", "QStyleOptionToolButton") extern class QStyleOptionToolButton {
	...
	public function ToolButtonFeatures(args:haxe.extern.Rest<Dynamic>):Dynamic;
