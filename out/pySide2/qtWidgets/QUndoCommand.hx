...
@:pythonImport("PySide2.QtWidgets", "QUndoCommand") extern class QUndoCommand {
	...
	**/
	...
	public function actionText(args:haxe.extern.Rest<Dynamic>):Dynamic;
	...
	public function mergeWith(args:haxe.extern.Rest<Dynamic>):Dynamic;
