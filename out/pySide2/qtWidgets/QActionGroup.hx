...
@:pythonImport("PySide2.QtWidgets", "QActionGroup") extern class QActionGroup {
	...
	**/
	...
	public function checkedAction(args:haxe.extern.Rest<Dynamic>):Dynamic;
	...
	public function isExclusive(args:haxe.extern.Rest<Dynamic>):Dynamic;
