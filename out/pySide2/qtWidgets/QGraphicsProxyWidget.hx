...
@:pythonImport("PySide2.QtWidgets", "QGraphicsProxyWidget") extern class QGraphicsProxyWidget {
	...
	**/
	...
	public function createProxyForChildWidget(args:haxe.extern.Rest<Dynamic>):Dynamic;
	...
	public function newProxyWidget(args:haxe.extern.Rest<Dynamic>):Dynamic;
	...
	public function subWidgetRect(args:haxe.extern.Rest<Dynamic>):Dynamic;
