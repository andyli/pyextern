...
@:pythonImport("PySide2.QtWidgets", "QGraphicsSceneWheelEvent") extern class QGraphicsSceneWheelEvent {
	...
	**/
	...
	public function setDelta(args:haxe.extern.Rest<Dynamic>):Dynamic;
