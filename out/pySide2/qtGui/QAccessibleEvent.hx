...
@:pythonImport("PySide2.QtGui", "QAccessibleEvent") extern class QAccessibleEvent {
	...
	**/
	...
	public function accessibleInterface(args:haxe.extern.Rest<Dynamic>):Dynamic;
	public function child(args:haxe.extern.Rest<Dynamic>):Dynamic;
	public var m_object : Dynamic;
