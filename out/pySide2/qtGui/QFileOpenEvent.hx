...
@:pythonImport("PySide2.QtGui", "QFileOpenEvent") extern class QFileOpenEvent {
	...
	**/
	...
	public function file(args:haxe.extern.Rest<Dynamic>):Dynamic;
	...
	public function openFile(args:haxe.extern.Rest<Dynamic>):Dynamic;
