...
@:pythonImport("PySide2.QtGui", "QHoverEvent") extern class QHoverEvent {
	...
	**/
	...
	public function oldPos(args:haxe.extern.Rest<Dynamic>):Dynamic;
	public function oldPosF(args:haxe.extern.Rest<Dynamic>):Dynamic;
