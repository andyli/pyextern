...
@:pythonImport("PySide2.QtGui", "QTextDocumentWriter") extern class QTextDocumentWriter {
	...
	**/
	...
	static public function supportedDocumentFormats(args:haxe.extern.Rest<Dynamic>):Dynamic;
