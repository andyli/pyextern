...
@:pythonImport("PySide2.QtGui", "QStyleHints") extern class QStyleHints {
	...
	**/
	...
	public function cursorFlashTime(args:haxe.extern.Rest<Dynamic>):Dynamic;
	public function cursorFlashTimeChanged(args:haxe.extern.Rest<Dynamic>):Dynamic;
	...
	public function fontSmoothingGamma(args:haxe.extern.Rest<Dynamic>):Dynamic;
	...
	public function keyboardAutoRepeatRate(args:haxe.extern.Rest<Dynamic>):Dynamic;
	public function keyboardInputInterval(args:haxe.extern.Rest<Dynamic>):Dynamic;
	public function keyboardInputIntervalChanged(args:haxe.extern.Rest<Dynamic>):Dynamic;
	...
	public function mouseDoubleClickInterval(args:haxe.extern.Rest<Dynamic>):Dynamic;
	public function mouseDoubleClickIntervalChanged(args:haxe.extern.Rest<Dynamic>):Dynamic;
	public function mousePressAndHoldInterval(args:haxe.extern.Rest<Dynamic>):Dynamic;
	...
	public function passwordMaskCharacter(args:haxe.extern.Rest<Dynamic>):Dynamic;
	public function passwordMaskDelay(args:haxe.extern.Rest<Dynamic>):Dynamic;
	...
	public function setCursorFlashTime(args:haxe.extern.Rest<Dynamic>):Dynamic;
	public function setFocusOnTouchRelease(args:haxe.extern.Rest<Dynamic>):Dynamic;
	public function setKeyboardInputInterval(args:haxe.extern.Rest<Dynamic>):Dynamic;
	public function setMouseDoubleClickInterval(args:haxe.extern.Rest<Dynamic>):Dynamic;
	...
	public function setStartDragDistance(args:haxe.extern.Rest<Dynamic>):Dynamic;
	public function setStartDragTime(args:haxe.extern.Rest<Dynamic>):Dynamic;
	public function showIsFullScreen(args:haxe.extern.Rest<Dynamic>):Dynamic;
	public function showIsMaximized(args:haxe.extern.Rest<Dynamic>):Dynamic;
	public function signalsBlocked(args:haxe.extern.Rest<Dynamic>):Dynamic;
	public function singleClickActivation(args:haxe.extern.Rest<Dynamic>):Dynamic;
	public function startDragDistance(args:haxe.extern.Rest<Dynamic>):Dynamic;
	public function startDragDistanceChanged(args:haxe.extern.Rest<Dynamic>):Dynamic;
	public function startDragTime(args:haxe.extern.Rest<Dynamic>):Dynamic;
	public function startDragTimeChanged(args:haxe.extern.Rest<Dynamic>):Dynamic;
	public function startDragVelocity(args:haxe.extern.Rest<Dynamic>):Dynamic;
	...
	public function useRtlExtensions(args:haxe.extern.Rest<Dynamic>):Dynamic;
}