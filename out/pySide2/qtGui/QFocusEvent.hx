...
@:pythonImport("PySide2.QtGui", "QFocusEvent") extern class QFocusEvent {
	...
	**/
	...
	public function gotFocus(args:haxe.extern.Rest<Dynamic>):Dynamic;
	...
	public function lostFocus(args:haxe.extern.Rest<Dynamic>):Dynamic;
