...
@:pythonImport("PySide2.QtGui", "QWindowStateChangeEvent") extern class QWindowStateChangeEvent {
	...
	**/
	...
	public function isOverride(args:haxe.extern.Rest<Dynamic>):Dynamic;
	public function oldState(args:haxe.extern.Rest<Dynamic>):Dynamic;
