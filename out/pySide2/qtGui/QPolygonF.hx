...
@:pythonImport("PySide2.QtGui", "QPolygonF") extern class QPolygonF {
	/**
		Return self+value.
	**/
	...
	**/
	...
	public function isClosed(args:haxe.extern.Rest<Dynamic>):Dynamic;
	...
	public function toPolygon(args:haxe.extern.Rest<Dynamic>):Dynamic;
