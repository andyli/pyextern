...
@:pythonImport("PySide2.QtGui", "QMouseEvent") extern class QMouseEvent {
	...
	**/
	...
	public function localPos(args:haxe.extern.Rest<Dynamic>):Dynamic;
	...
	public function windowPos(args:haxe.extern.Rest<Dynamic>):Dynamic;
