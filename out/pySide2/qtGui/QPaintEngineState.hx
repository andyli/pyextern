...
@:pythonImport("PySide2.QtGui", "QPaintEngineState") extern class QPaintEngineState {
	...
	**/
	...
	public function brushNeedsResolving(args:haxe.extern.Rest<Dynamic>):Dynamic;
	...
	public var dirtyFlags : Dynamic;
	public function font(args:haxe.extern.Rest<Dynamic>):Dynamic;
	public function isClipEnabled(args:haxe.extern.Rest<Dynamic>):Dynamic;
	...
	public function penNeedsResolving(args:haxe.extern.Rest<Dynamic>):Dynamic;
