...
@:pythonImport("PySide2.QtQuick", "QQuickTextureFactory") extern class QQuickTextureFactory {
	...
	**/
	...
	public function createTexture(args:haxe.extern.Rest<Dynamic>):Dynamic;
	...
	public function textureByteCount(args:haxe.extern.Rest<Dynamic>):Dynamic;
	static public function textureFactoryForImage(args:haxe.extern.Rest<Dynamic>):Dynamic;
