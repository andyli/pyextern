...
@:pythonImport("PySide2.QtQuick", "QQuickItemGrabResult") extern class QQuickItemGrabResult {
	...
	**/
	...
	public function ready(args:haxe.extern.Rest<Dynamic>):Dynamic;
	...
	public function saveToFile(args:haxe.extern.Rest<Dynamic>):Dynamic;
