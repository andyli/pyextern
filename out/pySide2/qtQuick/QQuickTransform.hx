...
@:pythonImport("PySide2.QtQuick", "QQuickTransform") extern class QQuickTransform {
	...
	**/
	...
	public function appendToItem(args:haxe.extern.Rest<Dynamic>):Dynamic;
	...
	public function prependToItem(args:haxe.extern.Rest<Dynamic>):Dynamic;
