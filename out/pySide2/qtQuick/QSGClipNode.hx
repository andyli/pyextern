...
@:pythonImport("PySide2.QtQuick", "QSGClipNode") extern class QSGClipNode {
	...
	**/
	...
	public function isRectangular(args:haxe.extern.Rest<Dynamic>):Dynamic;
	...
	public function setIsRectangular(args:haxe.extern.Rest<Dynamic>):Dynamic;
