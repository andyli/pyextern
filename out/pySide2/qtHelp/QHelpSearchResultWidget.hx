...
@:pythonImport("PySide2.QtHelp", "QHelpSearchResultWidget") extern class QHelpSearchResultWidget {
	...
	**/
	...
	public function linkAt(args:haxe.extern.Rest<Dynamic>):Dynamic;
	...
	public function requestShowLink(args:haxe.extern.Rest<Dynamic>):Dynamic;
