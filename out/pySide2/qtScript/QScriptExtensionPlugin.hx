...
@:pythonImport("PySide2.QtScript", "QScriptExtensionPlugin") extern class QScriptExtensionPlugin {
	...
	**/
	...
	public function setupPackage(args:haxe.extern.Rest<Dynamic>):Dynamic;
