...
package inspect;
@:pythonImport("inspect", "FullArgSpec") extern class FullArgSpec {
	/**
		Return self+value.
	**/
	...
	**/
	static public function __new__(_cls:Dynamic, args:Dynamic, varargs:Dynamic, varkw:Dynamic, defaults:Dynamic, kwonlyargs:Dynamic, kwonlydefaults:Dynamic, annotations:Dynamic):Dynamic;
	/**
		helper for pickle
	**/
