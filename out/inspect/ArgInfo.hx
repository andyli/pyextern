...
package inspect;
@:pythonImport("inspect", "ArgInfo") extern class ArgInfo {
	/**
		Return self+value.
	**/
	...
	**/
	static public function __new__(_cls:Dynamic, args:Dynamic, varargs:Dynamic, keywords:Dynamic, locals:Dynamic):Dynamic;
	/**
		helper for pickle
	**/
	...
	**/
	static public var locals : Dynamic;
	/**
