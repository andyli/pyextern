...
@:pythonImport("selenium.webdriver.common.bidi.cdp", "CdpConnectionClosed") extern class CdpConnectionClosed {
	/**
		exception cause
	**/
	...
	**/
	@:native("__init__")
	public function ___init__(reason:Dynamic):Dynamic;
	/**
		Constructor.
		:param reason:
		:type reason: wsproto.frame_protocol.CloseReason
	**/
	public function new(reason:Dynamic):Void;
	/**
