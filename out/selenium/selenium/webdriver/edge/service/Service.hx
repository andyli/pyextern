...
package selenium.webdriver.edge.service;
@:pythonImport("selenium.webdriver.edge.service", "Service") extern class Service {
	...
	**/
	@:native("__init__")
	public function ___init__(?executable_path:Dynamic, ?port:Dynamic, ?verbose:Dynamic, ?log_path:Dynamic, ?service_args:Dynamic, ?env:Dynamic):Dynamic;
	/**
		Creates a new instance of the EdgeDriver service.
		EdgeDriver provides an interface for Microsoft WebDriver to use
		with Microsoft Edge.
		...
		:Args:
		 ...
		 - service_args : List of args to pass to the WebDriver service.
	**/
	public function new(?executable_path:Dynamic, ?port:Dynamic, ?verbose:Dynamic, ?log_path:Dynamic, ?service_args:Dynamic, ?env:Dynamic):Void;
	/**
