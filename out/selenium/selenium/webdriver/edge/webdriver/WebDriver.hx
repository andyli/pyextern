...
package selenium.webdriver.edge.webdriver;
@:pythonImport("selenium.webdriver.edge.webdriver", "WebDriver") extern class WebDriver {
	...
	**/
	@:native("__init__")
	public function ___init__(?executable_path:Dynamic, ?port:Dynamic, ?options:Dynamic, ?service_args:Dynamic, ?capabilities:Dynamic, ?service_log_path:Dynamic, ?service:Dynamic, ?keep_alive:Dynamic, ?verbose:Dynamic):Dynamic;
	/**
		Creates a new instance of the edge driver.
		Starts the service and then creates new instance of edge driver.
	...
	**/
	public function new(?executable_path:Dynamic, ?port:Dynamic, ?options:Dynamic, ?service_args:Dynamic, ?capabilities:Dynamic, ?service_log_path:Dynamic, ?service:Dynamic, ?keep_alive:Dynamic, ?verbose:Dynamic):Void;
	/**
