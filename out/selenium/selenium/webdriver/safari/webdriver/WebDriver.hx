...
package selenium.webdriver.safari.webdriver;
@:pythonImport("selenium.webdriver.safari.webdriver", "WebDriver") extern class WebDriver {
	...
	**/
	@:native("__init__")
	public function ___init__(?port:Dynamic, ?executable_path:Dynamic, ?reuse_service:Dynamic, ?desired_capabilities:Dynamic, ?quiet:Dynamic, ?keep_alive:Dynamic, ?service_args:Dynamic, ?options:Dynamic, ?service:Dynamic):Dynamic;
	/**
		Creates a new Safari driver instance and launches or finds a running safaridriver service.
		...
		:Args:
		 ...
		 - service - Service object for handling the browser driver if you need to pass extra details
	**/
	public function new(?port:Dynamic, ?executable_path:Dynamic, ?reuse_service:Dynamic, ?desired_capabilities:Dynamic, ?quiet:Dynamic, ?keep_alive:Dynamic, ?service_args:Dynamic, ?options:Dynamic, ?service:Dynamic):Void;
	/**
	...
	**/
	...
	public function get_permission(permission:Dynamic):Dynamic;
	/**
	...
	**/
	...
	public function set_permission(permission:Dynamic, value:Dynamic):Dynamic;
	/**
