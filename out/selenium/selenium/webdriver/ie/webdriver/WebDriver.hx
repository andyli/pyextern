...
@:pythonImport("selenium.webdriver.ie.webdriver", "WebDriver") extern class WebDriver {
	...
	**/
	@:native("__init__")
	public function ___init__(?executable_path:Dynamic, ?capabilities:Dynamic, ?port:Dynamic, ?timeout:Dynamic, ?host:Dynamic, ?log_level:Dynamic, ?service_log_path:Dynamic, ?options:Dynamic, ?service:Dynamic, ?desired_capabilities:Dynamic, ?keep_alive:Dynamic):Dynamic;
	/**
		Creates a new instance of the Ie driver.
		...
		:Args:
		 ...
		 - keep_alive - Deprecated: Whether to configure RemoteConnection to use HTTP keep-alive.
	**/
	public function new(?executable_path:Dynamic, ?capabilities:Dynamic, ?port:Dynamic, ?timeout:Dynamic, ?host:Dynamic, ?log_level:Dynamic, ?service_log_path:Dynamic, ?options:Dynamic, ?service:Dynamic, ?desired_capabilities:Dynamic, ?keep_alive:Dynamic):Void;
	/**
