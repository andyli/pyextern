...
package selenium.webdriver.wpewebkit.webdriver;
@:pythonImport("selenium.webdriver.wpewebkit.webdriver", "WebDriver") extern class WebDriver {
	...
	**/
	@:native("__init__")
	public function ___init__(?executable_path:Dynamic, ?port:Dynamic, ?options:Dynamic, ?desired_capabilities:Dynamic, ?service_log_path:Dynamic):Dynamic;
	/**
		Creates a new instance of the WPEWebKit driver.
		...
		:Args:
		 ...
		 - service_log_path : Path to write service stdout and stderr output.
	**/
	public function new(?executable_path:Dynamic, ?port:Dynamic, ?options:Dynamic, ?desired_capabilities:Dynamic, ?service_log_path:Dynamic):Void;
	/**
