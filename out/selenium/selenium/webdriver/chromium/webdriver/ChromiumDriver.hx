...
package selenium.webdriver.chromium.webdriver;
@:pythonImport("selenium.webdriver.chromium.webdriver", "ChromiumDriver") extern class ChromiumDriver {
	...
	**/
	@:native("__init__")
	public function ___init__(browser_name:Dynamic, vendor_prefix:Dynamic, ?port:Dynamic, ?options:Dynamic, ?service_args:Dynamic, ?desired_capabilities:Dynamic, ?service_log_path:Dynamic, ?service:Dynamic, ?keep_alive:Dynamic):Dynamic;
	/**
		Creates a new WebDriver instance of the ChromiumDriver.
		Starts the service and then creates new WebDriver instance of ChromiumDriver.
		...
		:Args:
		 ...
		 - keep_alive - Deprecated: Whether to configure ChromiumRemoteConnection to use HTTP keep-alive.
	**/
	public function new(browser_name:Dynamic, vendor_prefix:Dynamic, ?port:Dynamic, ?options:Dynamic, ?service_args:Dynamic, ?desired_capabilities:Dynamic, ?service_log_path:Dynamic, ?service:Dynamic, ?keep_alive:Dynamic):Void;
	/**
	...
	**/
	public function delete_network_conditions():Dynamic;
	/**
	...
	**/
	public function get_issue_message():Dynamic;
	/**
	...
	**/
	public function get_sinks():Dynamic;
	/**
	...
	**/
	public function set_permissions(name:Dynamic, value:Dynamic):Dynamic;
	/**
	...
	**/
	public function set_sink_to_use(sink_name:Dynamic):Dynamic;
	/**
	...
	**/
	...
	/**
		...
		:Args:
		 - sink_name: Name of the sink to use as the target.
	**/
	public function start_tab_mirroring(sink_name:Dynamic):Dynamic;
	/**
	...
	**/
	public function stop_casting(sink_name:Dynamic):Dynamic;
	/**
