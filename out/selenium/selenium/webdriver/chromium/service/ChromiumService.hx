...
package selenium.webdriver.chromium.service;
@:pythonImport("selenium.webdriver.chromium.service", "ChromiumService") extern class ChromiumService {
	...
	**/
	@:native("__init__")
	public function ___init__(executable_path:Dynamic, ?port:Dynamic, ?service_args:Dynamic, ?log_path:Dynamic, ?env:Dynamic, ?start_error_message:Dynamic):Dynamic;
	/**
		Creates a new instance of the Service
		...
		:Args:
		 ...
		 - log_path : Path for the WebDriver service to log to
	**/
	public function new(executable_path:Dynamic, ?port:Dynamic, ?service_args:Dynamic, ?log_path:Dynamic, ?env:Dynamic, ?start_error_message:Dynamic):Void;
	/**
