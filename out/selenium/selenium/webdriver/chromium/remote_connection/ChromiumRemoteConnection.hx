...
package selenium.webdriver.chromium.remote_connection;
@:pythonImport("selenium.webdriver.chromium.remote_connection", "ChromiumRemoteConnection") extern class ChromiumRemoteConnection {
	...
	**/
	@:native("__init__")
	public function ___init__(remote_server_addr:Dynamic, vendor_prefix:Dynamic, browser_name:Dynamic, ?keep_alive:Dynamic, ?ignore_proxy:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(remote_server_addr:Dynamic, vendor_prefix:Dynamic, browser_name:Dynamic, ?keep_alive:Dynamic, ?ignore_proxy:Dynamic):Void;
	/**
