...
@:pythonImport("selenium.webdriver.remote.remote_connection", "RemoteConnection") extern class RemoteConnection {
	...
	**/
	@:native("__init__")
	public function ___init__(remote_server_addr:Dynamic, ?keep_alive:Dynamic, ?resolve_ip:Dynamic, ?ignore_proxy:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(remote_server_addr:Dynamic, ?keep_alive:Dynamic, ?resolve_ip:Dynamic, ?ignore_proxy:Dynamic):Void;
	/**
