...
@:pythonImport("selenium.webdriver.remote.webdriver", "WebDriver") extern class WebDriver {
	...
	**/
	@:native("__init__")
	public function ___init__(?command_executor:Dynamic, ?desired_capabilities:Dynamic, ?browser_profile:Dynamic, ?proxy:Dynamic, ?keep_alive:Dynamic, ?file_detector:Dynamic, ?options:Dynamic):Dynamic;
	/**
		Create a new driver that will issue commands using the wire protocol.
		...
		:Args:
		 ...
		 - options - instance of a driver options.Options class
	**/
	public function new(?command_executor:Dynamic, ?desired_capabilities:Dynamic, ?browser_profile:Dynamic, ?proxy:Dynamic, ?keep_alive:Dynamic, ?file_detector:Dynamic, ?options:Dynamic):Void;
	/**
