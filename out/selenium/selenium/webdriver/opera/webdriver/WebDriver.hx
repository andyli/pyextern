...
@:pythonImport("selenium.webdriver.opera.webdriver", "WebDriver") extern class WebDriver {
	static public function ServiceType():Dynamic;
	...
	**/
	@:native("__init__")
	public function ___init__(?desired_capabilities:Dynamic, ?executable_path:Dynamic, ?port:Dynamic, ?service_log_path:Dynamic, ?service_args:Dynamic, ?options:Dynamic):Dynamic;
	/**
		Creates a new instance of the operadriver.
		...
		:Args:
		 ...
		 - service_log_path - Where to log information from the driver.
		   capabilities only, such as "proxy" or "loggingPref".
	**/
	public function new(?desired_capabilities:Dynamic, ?executable_path:Dynamic, ?port:Dynamic, ?service_log_path:Dynamic, ?service_args:Dynamic, ?options:Dynamic):Void;
	/**
