...
@:pythonImport("selenium.webdriver.safari.webdriver", "WebDriver") extern class WebDriver {
	...
	**/
	@:native("__init__")
	public function ___init__(?port:Dynamic, ?executable_path:Dynamic, ?reuse_service:Dynamic, ?desired_capabilities:Dynamic, ?quiet:Dynamic, ?keep_alive:Dynamic, ?service_args:Dynamic):Dynamic;
	/**
		Creates a new Safari driver instance and launches or finds a running safaridriver service.
		...
		:Args:
		 ...
		 - service_args : List of args to pass to the safaridriver service
	**/
	public function new(?port:Dynamic, ?executable_path:Dynamic, ?reuse_service:Dynamic, ?desired_capabilities:Dynamic, ?quiet:Dynamic, ?keep_alive:Dynamic, ?service_args:Dynamic):Void;
	/**
