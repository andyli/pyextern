...
package selenium.webdriver.phantomjs.webdriver;
@:pythonImport("selenium.webdriver.phantomjs.webdriver", "WebDriver") extern class WebDriver {
	...
	**/
	@:native("__init__")
	public function ___init__(?executable_path:Dynamic, ?port:Dynamic, ?desired_capabilities:Dynamic, ?service_args:Dynamic, ?service_log_path:Dynamic):Dynamic;
	/**
		Creates a new instance of the PhantomJS / Ghostdriver.
		...
		:Args:
		 ...
		 - service_log_path: Path for phantomjs service to log to.
	**/
	public function new(?executable_path:Dynamic, ?port:Dynamic, ?desired_capabilities:Dynamic, ?service_args:Dynamic, ?service_log_path:Dynamic):Void;
	/**
