...
@:pythonImport("selenium.webdriver.edge.service", "Service") extern class Service {
	...
	**/
	@:native("__init__")
	public function ___init__(executable_path:Dynamic, ?port:Dynamic, ?verbose:Dynamic, ?log_path:Dynamic):Dynamic;
	/**
		Creates a new instance of the EdgeDriver service.
		...
		:param log_path: Optional path for the webdriver binary to log to.
		    Defaults to None which disables logging.
	**/
	public function new(executable_path:Dynamic, ?port:Dynamic, ?verbose:Dynamic, ?log_path:Dynamic):Void;
	/**
