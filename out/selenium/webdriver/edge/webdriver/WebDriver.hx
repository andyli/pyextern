...
@:pythonImport("selenium.webdriver.edge.webdriver", "WebDriver") extern class WebDriver {
	...
	**/
	@:native("__init__")
	public function ___init__(?executable_path:Dynamic, ?capabilities:Dynamic, ?port:Dynamic, ?verbose:Dynamic, ?service_log_path:Dynamic, ?log_path:Dynamic, ?keep_alive:Dynamic):Dynamic;
	/**
		Creates a new instance of the chrome driver.
	...
	**/
	public function new(?executable_path:Dynamic, ?capabilities:Dynamic, ?port:Dynamic, ?verbose:Dynamic, ?service_log_path:Dynamic, ?log_path:Dynamic, ?keep_alive:Dynamic):Void;
	/**
