...
@:pythonImport("selenium.webdriver.blackberry.webdriver", "WebDriver") extern class WebDriver {
	...
	**/
	@:native("__init__")
	public function ___init__(device_password:Dynamic, ?bb_tools_dir:Dynamic, ?hostip:Dynamic, ?port:Dynamic, ?desired_capabilities:Dynamic):Dynamic;
	/**
		Create a new driver that will issue commands using the wire protocol.
		...
		:Args:
		 ...
		 - options - instance of a driver options.Options class
	**/
	public function new(device_password:Dynamic, ?bb_tools_dir:Dynamic, ?hostip:Dynamic, ?port:Dynamic, ?desired_capabilities:Dynamic):Void;
	/**
