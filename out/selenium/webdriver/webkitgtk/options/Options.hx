...
package selenium.webdriver.webkitgtk.options;
@:pythonImport("selenium.webdriver.webkitgtk.options", "Options") extern class Options {
	...
	**/
	public var overlay_scrollbars_enabled : Dynamic;
	/**
		Sets a capability.
	**/
