...
package selenium.webdriver.webkitgtk.webdriver;
@:pythonImport("selenium.webdriver.webkitgtk.webdriver", "WebDriver") extern class WebDriver {
	...
	**/
	@:native("__init__")
	public function ___init__(?executable_path:Dynamic, ?port:Dynamic, ?options:Dynamic, ?desired_capabilities:Dynamic, ?service_log_path:Dynamic, ?keep_alive:Dynamic):Dynamic;
	/**
		Creates a new instance of the WebKitGTK driver.
		...
		:Args:
		 ...
		 - keep_alive : Whether to configure RemoteConnection to use HTTP keep-alive.
	**/
	public function new(?executable_path:Dynamic, ?port:Dynamic, ?options:Dynamic, ?desired_capabilities:Dynamic, ?service_log_path:Dynamic, ?keep_alive:Dynamic):Void;
	/**
