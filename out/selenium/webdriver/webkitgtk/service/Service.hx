...
package selenium.webdriver.webkitgtk.service;
@:pythonImport("selenium.webdriver.webkitgtk.service", "Service") extern class Service {
	...
	**/
	@:native("__init__")
	public function ___init__(executable_path:Dynamic, ?port:Dynamic, ?log_path:Dynamic):Dynamic;
	/**
		Creates a new instance of the Service
		...
		:Args:
		 ...
		 - log_path : Path for the WebKitGTKDriver service to log to
	**/
	public function new(executable_path:Dynamic, ?port:Dynamic, ?log_path:Dynamic):Void;
	/**
