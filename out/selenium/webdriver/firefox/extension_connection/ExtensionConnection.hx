...
package selenium.webdriver.firefox.extension_connection;
@:pythonImport("selenium.webdriver.firefox.extension_connection", "ExtensionConnection") extern class ExtensionConnection {
	...
	**/
	@:native("__init__")
	public function ___init__(host:Dynamic, firefox_profile:Dynamic, ?firefox_binary:Dynamic, ?timeout:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(host:Dynamic, firefox_profile:Dynamic, ?firefox_binary:Dynamic, ?timeout:Dynamic):Void;
	/**
	...
	**/
	static public function connect_and_quit():Dynamic;
	/**
	...
	**/
	static public function is_connectable():Dynamic;
	public function quit(?sessionId:Dynamic):Dynamic;
	/**
