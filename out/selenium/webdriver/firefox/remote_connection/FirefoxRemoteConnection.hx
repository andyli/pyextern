...
package selenium.webdriver.firefox.remote_connection;
@:pythonImport("selenium.webdriver.firefox.remote_connection", "FirefoxRemoteConnection") extern class FirefoxRemoteConnection {
	...
	**/
	@:native("__init__")
	public function ___init__(remote_server_addr:Dynamic, ?keep_alive:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(remote_server_addr:Dynamic, ?keep_alive:Dynamic):Void;
	/**
