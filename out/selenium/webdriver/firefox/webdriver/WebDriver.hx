...
@:pythonImport("selenium.webdriver.firefox.webdriver", "WebDriver") extern class WebDriver {
	...
	static public var NATIVE_EVENTS_ALLOWED : Dynamic;
	...
	**/
	@:native("__init__")
	public function ___init__(?firefox_profile:Dynamic, ?firefox_binary:Dynamic, ?timeout:Dynamic, ?capabilities:Dynamic, ?proxy:Dynamic, ?executable_path:Dynamic, ?options:Dynamic, ?service_log_path:Dynamic, ?firefox_options:Dynamic, ?service_args:Dynamic, ?desired_capabilities:Dynamic, ?log_path:Dynamic, ?keep_alive:Dynamic):Dynamic;
	/**
		Starts a new local session of Firefox.
		...
		:param keep_alive: Whether to configure remote_connection.RemoteConnection to use
		     HTTP keep-alive.
	**/
	public function new(?firefox_profile:Dynamic, ?firefox_binary:Dynamic, ?timeout:Dynamic, ?capabilities:Dynamic, ?proxy:Dynamic, ?executable_path:Dynamic, ?options:Dynamic, ?service_log_path:Dynamic, ?firefox_options:Dynamic, ?service_args:Dynamic, ?desired_capabilities:Dynamic, ?log_path:Dynamic, ?keep_alive:Dynamic):Void;
	/**
