...
@:pythonImport("selenium.webdriver.chrome.webdriver", "WebDriver") extern class WebDriver {
	...
	**/
	@:native("__init__")
	public function ___init__(?executable_path:Dynamic, ?port:Dynamic, ?options:Dynamic, ?service_args:Dynamic, ?desired_capabilities:Dynamic, ?service_log_path:Dynamic, ?chrome_options:Dynamic, ?keep_alive:Dynamic):Dynamic;
	/**
		Creates a new instance of the chrome driver.
		...
		:Args:
		 ...
		 - keep_alive - Whether to configure ChromeRemoteConnection to use HTTP keep-alive.
	**/
	public function new(?executable_path:Dynamic, ?port:Dynamic, ?options:Dynamic, ?service_args:Dynamic, ?desired_capabilities:Dynamic, ?service_log_path:Dynamic, ?chrome_options:Dynamic, ?keep_alive:Dynamic):Void;
	/**
