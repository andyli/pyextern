...
package selenium.webdriver.ie.webdriver;
@:pythonImport("selenium.webdriver.ie.webdriver", "WebDriver") extern class WebDriver {
	...
	**/
	@:native("__init__")
	public function ___init__(?executable_path:Dynamic, ?capabilities:Dynamic, ?port:Dynamic, ?timeout:Dynamic, ?host:Dynamic, ?log_level:Dynamic, ?service_log_path:Dynamic, ?options:Dynamic, ?ie_options:Dynamic, ?desired_capabilities:Dynamic, ?log_file:Dynamic, ?keep_alive:Dynamic):Dynamic;
	/**
		Creates a new instance of the chrome driver.
		...
		:Args:
		 ...
		 - keep_alive - Whether to configure RemoteConnection to use HTTP keep-alive.
	**/
	public function new(?executable_path:Dynamic, ?capabilities:Dynamic, ?port:Dynamic, ?timeout:Dynamic, ?host:Dynamic, ?log_level:Dynamic, ?service_log_path:Dynamic, ?options:Dynamic, ?ie_options:Dynamic, ?desired_capabilities:Dynamic, ?log_file:Dynamic, ?keep_alive:Dynamic):Void;
	/**
