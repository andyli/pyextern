...
package selenium.webdriver.android.webdriver;
@:pythonImport("selenium.webdriver.android.webdriver", "WebDriver") extern class WebDriver {
	...
	**/
	@:native("__init__")
	public function ___init__(?host:Dynamic, ?port:Dynamic, ?desired_capabilities:Dynamic):Dynamic;
	/**
		Creates a new instance of Selendroid using the WebView app
		...
		:Args:
		 ...
		 - desired_capabilities: Dictionary object with capabilities
	**/
	public function new(?host:Dynamic, ?port:Dynamic, ?desired_capabilities:Dynamic):Void;
	/**
