...
@:pythonImport("selenium.common.exceptions", "ErrorInResponseException") extern class ErrorInResponseException {
	/**
		exception cause
	**/
	...
	**/
	@:native("__init__")
	public function ___init__(response:Dynamic, msg:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(response:Dynamic, msg:Dynamic):Void;
	/**
