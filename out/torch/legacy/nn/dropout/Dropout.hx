...
package torch.legacy.nn.dropout;
@:pythonImport("torch.legacy.nn.Dropout", "Dropout") extern class Dropout {
	...
	**/
	@:native("__init__")
	public function ___init__(?p:Dynamic, ?inplace:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(?p:Dynamic, ?inplace:Dynamic):Void;
	/**
