...
package torch.legacy.nn.volumetricMaxPooling;
@:pythonImport("torch.legacy.nn.VolumetricMaxPooling", "VolumetricMaxPooling") extern class VolumetricMaxPooling {
	...
	**/
	@:native("__init__")
	public function ___init__(kT:Dynamic, kW:Dynamic, kH:Dynamic, ?dT:Dynamic, ?dW:Dynamic, ?dH:Dynamic, ?padT:Dynamic, ?padW:Dynamic, ?padH:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(kT:Dynamic, kW:Dynamic, kH:Dynamic, ?dT:Dynamic, ?dW:Dynamic, ?dH:Dynamic, ?padT:Dynamic, ?padW:Dynamic, ?padH:Dynamic):Void;
	/**
