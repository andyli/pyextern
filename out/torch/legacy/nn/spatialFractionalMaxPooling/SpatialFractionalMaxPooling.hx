...
package torch.legacy.nn.spatialFractionalMaxPooling;
@:pythonImport("torch.legacy.nn.SpatialFractionalMaxPooling", "SpatialFractionalMaxPooling") extern class SpatialFractionalMaxPooling {
	...
	**/
	@:native("__init__")
	public function ___init__(poolSizeW:Dynamic, poolSizeH:Dynamic, arg1:Dynamic, arg2:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(poolSizeW:Dynamic, poolSizeH:Dynamic, arg1:Dynamic, arg2:Dynamic):Void;
	/**
	...
	**/
	...
	public function _getBufferSize(input:Dynamic):Dynamic;
	public function _getOutputSizes(input:Dynamic):Dynamic;
	public function _initSampleBuffer(input:Dynamic):Dynamic;
	...
	public function fixPoolingRegions(?val:Dynamic):Dynamic;
