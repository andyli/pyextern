...
package torch.legacy.nn.mM;
@:pythonImport("torch.legacy.nn.MM", "MM") extern class MM {
	...
	**/
	@:native("__init__")
	public function ___init__(?transA:Dynamic, ?transB:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(?transA:Dynamic, ?transB:Dynamic):Void;
	/**
