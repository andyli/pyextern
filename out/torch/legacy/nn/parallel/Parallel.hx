...
package torch.legacy.nn.parallel;
@:pythonImport("torch.legacy.nn.Parallel", "Parallel") extern class Parallel {
	...
	**/
	@:native("__init__")
	public function ___init__(inputDimension:Dynamic, outputDimension:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(inputDimension:Dynamic, outputDimension:Dynamic):Void;
	/**
