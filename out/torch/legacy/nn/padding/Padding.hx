...
package torch.legacy.nn.padding;
@:pythonImport("torch.legacy.nn.Padding", "Padding") extern class Padding {
	...
	**/
	@:native("__init__")
	public function ___init__(dim:Dynamic, pad:Dynamic, ?value:Dynamic, ?index:Dynamic, ?nInputDim:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(dim:Dynamic, pad:Dynamic, ?value:Dynamic, ?index:Dynamic, ?nInputDim:Dynamic):Void;
	/**
