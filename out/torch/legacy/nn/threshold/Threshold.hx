...
package torch.legacy.nn.threshold;
@:pythonImport("torch.legacy.nn.Threshold", "Threshold") extern class Threshold {
	...
	**/
	@:native("__init__")
	public function ___init__(?threshold:Dynamic, ?value:Dynamic, ?inplace:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(?threshold:Dynamic, ?value:Dynamic, ?inplace:Dynamic):Void;
	/**
	...
	**/
	...
	public function validateParameters():Dynamic;
