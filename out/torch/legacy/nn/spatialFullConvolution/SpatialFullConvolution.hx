...
package torch.legacy.nn.spatialFullConvolution;
@:pythonImport("torch.legacy.nn.SpatialFullConvolution", "SpatialFullConvolution") extern class SpatialFullConvolution {
	...
	**/
	@:native("__init__")
	public function ___init__(nInputPlane:Dynamic, nOutputPlane:Dynamic, kW:Dynamic, kH:Dynamic, ?dW:Dynamic, ?dH:Dynamic, ?padW:Dynamic, ?padH:Dynamic, ?adjW:Dynamic, ?adjH:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(nInputPlane:Dynamic, nOutputPlane:Dynamic, kW:Dynamic, kH:Dynamic, ?dW:Dynamic, ?dH:Dynamic, ?padW:Dynamic, ?padH:Dynamic, ?adjW:Dynamic, ?adjH:Dynamic):Void;
	/**
	...
	**/
	...
	public function _calculateAdj(targetSize:Dynamic, ker:Dynamic, pad:Dynamic, stride:Dynamic):Dynamic;
