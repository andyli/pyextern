...
package torch.legacy.nn.sqrt;
@:pythonImport("torch.legacy.nn.Sqrt", "Sqrt") extern class Sqrt {
	...
	**/
	@:native("__init__")
	public function ___init__(?b:Dynamic, ?eps:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(?b:Dynamic, ?eps:Dynamic):Void;
	/**
