...
package torch.legacy.nn.linear;
@:pythonImport("torch.legacy.nn.Linear", "Linear") extern class Linear {
	...
	**/
	@:native("__init__")
	public function ___init__(inputSize:Dynamic, outputSize:Dynamic, ?bias:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(inputSize:Dynamic, outputSize:Dynamic, ?bias:Dynamic):Void;
	/**
	...
	**/
	...
	public function _updateAddBuffer(input:Dynamic):Dynamic;
