...
package torch.legacy.nn.weightedEuclidean;
@:pythonImport("torch.legacy.nn.WeightedEuclidean", "WeightedEuclidean") extern class WeightedEuclidean {
	...
	**/
	@:native("__init__")
	public function ___init__(inputSize:Dynamic, outputSize:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(inputSize:Dynamic, outputSize:Dynamic):Void;
	/**
	...
	**/
	...
	public function _view(res:Dynamic, src:Dynamic, ?args:python.VarArgs<Dynamic>):Dynamic;
