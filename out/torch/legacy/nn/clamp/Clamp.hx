...
package torch.legacy.nn.clamp;
@:pythonImport("torch.legacy.nn.Clamp", "Clamp") extern class Clamp {
	...
	**/
	@:native("__init__")
	public function ___init__(min_value:Dynamic, max_value:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(min_value:Dynamic, max_value:Dynamic):Void;
	/**
