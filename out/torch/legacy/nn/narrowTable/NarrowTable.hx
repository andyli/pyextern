...
package torch.legacy.nn.narrowTable;
@:pythonImport("torch.legacy.nn.NarrowTable", "NarrowTable") extern class NarrowTable {
	...
	**/
	@:native("__init__")
	public function ___init__(offset:Dynamic, ?length:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(offset:Dynamic, ?length:Dynamic):Void;
	/**
