...
package torch.legacy.nn.volumetricBatchNormalization;
@:pythonImport("torch.legacy.nn.VolumetricBatchNormalization", "VolumetricBatchNormalization") extern class VolumetricBatchNormalization {
	...
	**/
	@:native("__init__")
	public function ___init__(nOutput:Dynamic, ?eps:Dynamic, ?momentum:Dynamic, ?affine:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(nOutput:Dynamic, ?eps:Dynamic, ?momentum:Dynamic, ?affine:Dynamic):Void;
	/**
	...
	**/
	...
	public function _backward(input:Dynamic, gradOutput:Dynamic, scale:Dynamic, ?gradInput:Dynamic, ?gradWeight:Dynamic, ?gradBias:Dynamic):Dynamic;
	public function _checkInputDim(input:Dynamic):Dynamic;
	...
	public function read(file:Dynamic, version:Dynamic):Dynamic;
