...
package torch.legacy.nn.add;
@:pythonImport("torch.legacy.nn.Add", "Add") extern class Add {
	...
	**/
	@:native("__init__")
	public function ___init__(inputSize:Dynamic, ?scalar:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(inputSize:Dynamic, ?scalar:Dynamic):Void;
	/**
