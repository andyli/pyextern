...
package torch.legacy.nn.rReLU;
@:pythonImport("torch.legacy.nn.RReLU", "RReLU") extern class RReLU {
	...
	**/
	@:native("__init__")
	public function ___init__(?lower:Dynamic, ?upper:Dynamic, ?inplace:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(?lower:Dynamic, ?upper:Dynamic, ?inplace:Dynamic):Void;
	/**
