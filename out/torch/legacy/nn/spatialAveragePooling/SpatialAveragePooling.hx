...
package torch.legacy.nn.spatialAveragePooling;
@:pythonImport("torch.legacy.nn.SpatialAveragePooling", "SpatialAveragePooling") extern class SpatialAveragePooling {
	...
	**/
	@:native("__init__")
	public function ___init__(kW:Dynamic, kH:Dynamic, ?dW:Dynamic, ?dH:Dynamic, ?padW:Dynamic, ?padH:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(kW:Dynamic, kH:Dynamic, ?dW:Dynamic, ?dH:Dynamic, ?padW:Dynamic, ?padH:Dynamic):Void;
	/**
	...
	**/
	...
	public function setCountExcludePad():Dynamic;
	public function setCountIncludePad():Dynamic;
