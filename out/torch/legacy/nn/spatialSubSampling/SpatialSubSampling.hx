...
package torch.legacy.nn.spatialSubSampling;
@:pythonImport("torch.legacy.nn.SpatialSubSampling", "SpatialSubSampling") extern class SpatialSubSampling {
	...
	**/
	@:native("__init__")
	public function ___init__(nInputPlane:Dynamic, kW:Dynamic, kH:Dynamic, ?dW:Dynamic, ?dH:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(nInputPlane:Dynamic, kW:Dynamic, kH:Dynamic, ?dW:Dynamic, ?dH:Dynamic):Void;
	/**
