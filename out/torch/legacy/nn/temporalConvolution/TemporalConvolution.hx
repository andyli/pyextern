...
package torch.legacy.nn.temporalConvolution;
@:pythonImport("torch.legacy.nn.TemporalConvolution", "TemporalConvolution") extern class TemporalConvolution {
	...
	**/
	@:native("__init__")
	public function ___init__(inputFrameSize:Dynamic, outputFrameSize:Dynamic, kW:Dynamic, ?dW:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(inputFrameSize:Dynamic, outputFrameSize:Dynamic, kW:Dynamic, ?dW:Dynamic):Void;
	/**
