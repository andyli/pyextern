...
package torch.legacy.nn.bilinear;
@:pythonImport("torch.legacy.nn.Bilinear", "Bilinear") extern class Bilinear {
	...
	**/
	@:native("__init__")
	public function ___init__(inputSize1:Dynamic, inputSize2:Dynamic, outputSize:Dynamic, ?bias:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(inputSize1:Dynamic, inputSize2:Dynamic, outputSize:Dynamic, ?bias:Dynamic):Void;
	/**
	...
	**/
	...
	public function _assertInput(input:Dynamic):Dynamic;
	public function _assertInputGradOutput(input:Dynamic, gradOutput:Dynamic):Dynamic;
