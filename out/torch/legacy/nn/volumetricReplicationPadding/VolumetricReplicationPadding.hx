...
package torch.legacy.nn.volumetricReplicationPadding;
@:pythonImport("torch.legacy.nn.VolumetricReplicationPadding", "VolumetricReplicationPadding") extern class VolumetricReplicationPadding {
	...
	**/
	@:native("__init__")
	public function ___init__(pleft:Dynamic, ?pright:Dynamic, ?ptop:Dynamic, ?pbottom:Dynamic, ?pfront:Dynamic, ?pback:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(pleft:Dynamic, ?pright:Dynamic, ?ptop:Dynamic, ?pbottom:Dynamic, ?pfront:Dynamic, ?pback:Dynamic):Void;
	/**
