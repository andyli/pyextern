...
package torch.legacy.nn.volumetricConvolution;
@:pythonImport("torch.legacy.nn.VolumetricConvolution", "VolumetricConvolution") extern class VolumetricConvolution {
	...
	**/
	@:native("__init__")
	public function ___init__(nInputPlane:Dynamic, nOutputPlane:Dynamic, kT:Dynamic, kW:Dynamic, kH:Dynamic, ?dT:Dynamic, ?dW:Dynamic, ?dH:Dynamic, ?padT:Dynamic, ?padW:Dynamic, ?padH:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(nInputPlane:Dynamic, nOutputPlane:Dynamic, kT:Dynamic, kW:Dynamic, kH:Dynamic, ?dT:Dynamic, ?dW:Dynamic, ?dH:Dynamic, ?padT:Dynamic, ?padW:Dynamic, ?padH:Dynamic):Void;
	/**
