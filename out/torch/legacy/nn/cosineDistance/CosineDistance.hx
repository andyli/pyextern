...
package torch.legacy.nn.cosineDistance;
@:pythonImport("torch.legacy.nn.CosineDistance", "CosineDistance") extern class CosineDistance {
	...
	**/
	...
	public function _makeContiguous(input1:Dynamic, input2:Dynamic):Dynamic;
