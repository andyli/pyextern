...
package torch.legacy.nn.criterionTable;
@:pythonImport("torch.legacy.nn.CriterionTable", "CriterionTable") extern class CriterionTable {
	...
	**/
	@:native("__init__")
	public function ___init__(criterion:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(criterion:Dynamic):Void;
	/**
	...
	**/
	...
	public function updateGradInput(input:Dynamic, grad_output:Dynamic):Dynamic;
