...
package torch.legacy.nn.spatialZeroPadding;
@:pythonImport("torch.legacy.nn.SpatialZeroPadding", "SpatialZeroPadding") extern class SpatialZeroPadding {
	...
	**/
	@:native("__init__")
	public function ___init__(pad_l:Dynamic, ?pad_r:Dynamic, ?pad_t:Dynamic, ?pad_b:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(pad_l:Dynamic, ?pad_r:Dynamic, ?pad_t:Dynamic, ?pad_b:Dynamic):Void;
	/**
