...
package torch.legacy.nn.flattenTable;
@:pythonImport("torch.legacy.nn.FlattenTable", "FlattenTable") extern class FlattenTable {
	...
	**/
	...
	public function _checkMapping(output:Dynamic, input:Dynamic, input_map:Dynamic):Dynamic;
	public function _flatten(output:Dynamic, input:Dynamic):Dynamic;
	static public var _flattenTensorBuffer : Dynamic;
	public function _inverseFlatten(gradOutput:Dynamic, input_map:Dynamic):Dynamic;
