...
package torch.legacy.nn.spatialConvolutionMap;
@:pythonImport("torch.legacy.nn.SpatialConvolutionMap", "SpatialConvolutionMap") extern class SpatialConvolutionMap {
	...
	**/
	@:native("__init__")
	public function ___init__(conMatrix:Dynamic, kW:Dynamic, kH:Dynamic, ?dW:Dynamic, ?dH:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(conMatrix:Dynamic, kW:Dynamic, kH:Dynamic, ?dW:Dynamic, ?dH:Dynamic):Void;
	/**
	...
	**/
	...
	static public function maps():Dynamic;
