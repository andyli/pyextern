...
package torch.legacy.nn.spatialContrastiveNormalization;
@:pythonImport("torch.legacy.nn.SpatialContrastiveNormalization", "SpatialContrastiveNormalization") extern class SpatialContrastiveNormalization {
	...
	**/
	@:native("__init__")
	public function ___init__(?nInputPlane:Dynamic, ?kernel:Dynamic, ?threshold:Dynamic, ?thresval:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(?nInputPlane:Dynamic, ?kernel:Dynamic, ?threshold:Dynamic, ?thresval:Dynamic):Void;
	/**
