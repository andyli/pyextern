...
package torch.legacy.nn.depthConcat;
@:pythonImport("torch.legacy.nn.DepthConcat", "DepthConcat") extern class DepthConcat {
	...
	**/
	@:native("__init__")
	public function ___init__(dimension:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(dimension:Dynamic):Void;
	/**
	...
	**/
	...
	public function windowNarrow(output:Dynamic, currentOutput:Dynamic, offset:Dynamic):Dynamic;
