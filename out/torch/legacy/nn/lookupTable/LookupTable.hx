...
package torch.legacy.nn.lookupTable;
@:pythonImport("torch.legacy.nn.LookupTable", "LookupTable") extern class LookupTable {
	...
	**/
	@:native("__init__")
	public function ___init__(nIndex:Dynamic, nOutput:Dynamic, ?paddingValue:Dynamic, ?maxNorm:Dynamic, ?normType:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(nIndex:Dynamic, nOutput:Dynamic, ?paddingValue:Dynamic, ?maxNorm:Dynamic, ?normType:Dynamic):Void;
	/**
	...
	**/
	...
	public function _makeInputContiguous(input:Dynamic):Dynamic;
	...
	public function accUpdateOnly():Dynamic;
	...
	public function renorm(input:Dynamic):Dynamic;
	public function replace(callback:Dynamic):Dynamic;
	public function reset(?stdv:Dynamic):Dynamic;
	public function scaleGradByFreq():Dynamic;
	public function setMaxNorm(maxNorm:Dynamic):Dynamic;
	public function setNormType(normType:Dynamic):Dynamic;
	public function setPadding(paddingValue:Dynamic):Dynamic;
