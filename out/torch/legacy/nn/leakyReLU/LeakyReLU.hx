...
package torch.legacy.nn.leakyReLU;
@:pythonImport("torch.legacy.nn.LeakyReLU", "LeakyReLU") extern class LeakyReLU {
	...
	**/
	@:native("__init__")
	public function ___init__(?negval:Dynamic, ?inplace:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(?negval:Dynamic, ?inplace:Dynamic):Void;
	/**
