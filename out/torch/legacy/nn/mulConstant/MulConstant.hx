...
package torch.legacy.nn.mulConstant;
@:pythonImport("torch.legacy.nn.MulConstant", "MulConstant") extern class MulConstant {
	...
	**/
	@:native("__init__")
	public function ___init__(constant_scalar:Dynamic, ?inplace:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(constant_scalar:Dynamic, ?inplace:Dynamic):Void;
	/**
