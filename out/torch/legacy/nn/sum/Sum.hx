...
package torch.legacy.nn.sum;
@:pythonImport("torch.legacy.nn.Sum", "Sum") extern class Sum {
	...
	**/
	@:native("__init__")
	public function ___init__(?dimension:Dynamic, ?sizeAverage:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(?dimension:Dynamic, ?sizeAverage:Dynamic):Void;
	/**
	...
	**/
	...
	public function _getPositiveDimension(input:Dynamic):Dynamic;
