...
package torch.legacy.nn.volumetricDropout;
@:pythonImport("torch.legacy.nn.VolumetricDropout", "VolumetricDropout") extern class VolumetricDropout {
	...
	**/
	...
	public function setp(p:Dynamic):Dynamic;
