...
package torch.legacy.nn.spatialAdaptiveMaxPooling;
@:pythonImport("torch.legacy.nn.SpatialAdaptiveMaxPooling", "SpatialAdaptiveMaxPooling") extern class SpatialAdaptiveMaxPooling {
	...
	**/
	@:native("__init__")
	public function ___init__(w:Dynamic, h:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(w:Dynamic, h:Dynamic):Void;
	/**
