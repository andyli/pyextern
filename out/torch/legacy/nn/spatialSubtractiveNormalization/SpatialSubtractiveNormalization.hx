...
@:pythonImport("torch.legacy.nn.SpatialSubtractiveNormalization", "SpatialSubtractiveNormalization") extern class SpatialSubtractiveNormalization {
	...
	**/
	@:native("__init__")
	public function ___init__(?nInputPlane:Dynamic, ?kernel:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(?nInputPlane:Dynamic, ?kernel:Dynamic):Void;
	/**
