...
package torch.legacy.nn.spatialDilatedConvolution;
@:pythonImport("torch.legacy.nn.SpatialDilatedConvolution", "SpatialDilatedConvolution") extern class SpatialDilatedConvolution {
	...
	**/
	@:native("__init__")
	public function ___init__(nInputPlane:Dynamic, nOutputPlane:Dynamic, kW:Dynamic, kH:Dynamic, ?dW:Dynamic, ?dH:Dynamic, ?padW:Dynamic, ?padH:Dynamic, ?dilationH:Dynamic, ?dilationW:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(nInputPlane:Dynamic, nOutputPlane:Dynamic, kW:Dynamic, kH:Dynamic, ?dW:Dynamic, ?dH:Dynamic, ?padW:Dynamic, ?padH:Dynamic, ?dilationH:Dynamic, ?dilationW:Dynamic):Void;
	/**
	...
	**/
	...
	public function noBias():Dynamic;
