...
package torch.legacy.nn.pReLU;
@:pythonImport("torch.legacy.nn.PReLU", "PReLU") extern class PReLU {
	...
	**/
	@:native("__init__")
	public function ___init__(?nOutputPlane:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(?nOutputPlane:Dynamic):Void;
	/**
