...
package torch.legacy.nn.select;
@:pythonImport("torch.legacy.nn.Select", "Select") extern class Select {
	...
	**/
	@:native("__init__")
	public function ___init__(dimension:Dynamic, index:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(dimension:Dynamic, index:Dynamic):Void;
	/**
