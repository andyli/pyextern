...
package torch.legacy.nn.eLU;
@:pythonImport("torch.legacy.nn.ELU", "ELU") extern class ELU {
	...
	**/
	@:native("__init__")
	public function ___init__(?alpha:Dynamic, ?inplace:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(?alpha:Dynamic, ?inplace:Dynamic):Void;
	/**
