...
package torch.legacy.nn.gradientReversal;
@:pythonImport("torch.legacy.nn.GradientReversal", "GradientReversal") extern class GradientReversal {
	...
	**/
	@:native("__init__")
	public function ___init__(?lambd:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(?lambd:Dynamic):Void;
	/**
	...
	**/
	...
	public function setLambda(lambd:Dynamic):Dynamic;
