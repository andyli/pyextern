...
package torch.legacy.nn.narrow;
@:pythonImport("torch.legacy.nn.Narrow", "Narrow") extern class Narrow {
	...
	**/
	@:native("__init__")
	public function ___init__(dimension:Dynamic, offset:Dynamic, ?length:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(dimension:Dynamic, offset:Dynamic, ?length:Dynamic):Void;
	/**
