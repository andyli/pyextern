...
package torch.legacy.nn.spatialLPPooling;
@:pythonImport("torch.legacy.nn.SpatialLPPooling", "SpatialLPPooling") extern class SpatialLPPooling {
	...
	**/
	@:native("__init__")
	public function ___init__(nInputPlane:Dynamic, pnorm:Dynamic, kW:Dynamic, kH:Dynamic, ?dW:Dynamic, ?dH:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(nInputPlane:Dynamic, pnorm:Dynamic, kW:Dynamic, kH:Dynamic, ?dW:Dynamic, ?dH:Dynamic):Void;
	/**
	...
	**/
	...
	public function _iter_with_prev():Dynamic;
	public function accGradParameters(input:Dynamic, gradOutput:Dynamic):Dynamic;
	public function accUpdateGradParameters(input:Dynamic, gradOutput:Dynamic, lr:Dynamic):Dynamic;
	public function add(module:Dynamic):Dynamic;
	public function apply(callback:Dynamic):Dynamic;
	public function applyToModules(func:Dynamic):Dynamic;
	...
	public function insert(module:Dynamic, index:Dynamic):Dynamic;
	...
	public function reset(?stdev:Dynamic):Dynamic;
	public function share(mlp:Dynamic, ?args:python.VarArgs<Dynamic>):Dynamic;
