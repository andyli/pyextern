...
package torch.legacy.nn.concatTable;
@:pythonImport("torch.legacy.nn.ConcatTable", "ConcatTable") extern class ConcatTable {
	...
	**/
	...
	public function _backward(method:Dynamic, input:Dynamic, gradOutput:Dynamic, ?scale:Dynamic):Dynamic;
	public function _flatten(?parameters:Dynamic):Dynamic;
	static public var _flattenTensorBuffer : Dynamic;
	public function _map_list(l1:Dynamic, l2:Dynamic, f:Dynamic):Dynamic;
