...
package torch.legacy.nn.spatialReflectionPadding;
@:pythonImport("torch.legacy.nn.SpatialReflectionPadding", "SpatialReflectionPadding") extern class SpatialReflectionPadding {
