...
package torch.legacy.nn.volumetricFullConvolution;
@:pythonImport("torch.legacy.nn.VolumetricFullConvolution", "VolumetricFullConvolution") extern class VolumetricFullConvolution {
	...
	**/
	@:native("__init__")
	public function ___init__(nInputPlane:Dynamic, nOutputPlane:Dynamic, kT:Dynamic, kW:Dynamic, kH:Dynamic, ?dT:Dynamic, ?dW:Dynamic, ?dH:Dynamic, ?padT:Dynamic, ?padW:Dynamic, ?padH:Dynamic, ?adjT:Dynamic, ?adjW:Dynamic, ?adjH:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(nInputPlane:Dynamic, nOutputPlane:Dynamic, kT:Dynamic, kW:Dynamic, kH:Dynamic, ?dT:Dynamic, ?dW:Dynamic, ?dH:Dynamic, ?padT:Dynamic, ?padW:Dynamic, ?padH:Dynamic, ?adjT:Dynamic, ?adjW:Dynamic, ?adjH:Dynamic):Void;
	/**
	...
	**/
	...
	static public function _calculateAdj(targetSize:Dynamic, ker:Dynamic, pad:Dynamic, stride:Dynamic):Dynamic;
