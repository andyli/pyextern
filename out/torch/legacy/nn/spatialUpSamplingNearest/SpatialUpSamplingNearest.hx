...
package torch.legacy.nn.spatialUpSamplingNearest;
@:pythonImport("torch.legacy.nn.SpatialUpSamplingNearest", "SpatialUpSamplingNearest") extern class SpatialUpSamplingNearest {
	...
	**/
	@:native("__init__")
	public function ___init__(scale:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(scale:Dynamic):Void;
	/**
