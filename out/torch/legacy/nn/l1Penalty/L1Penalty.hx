...
@:pythonImport("torch.legacy.nn.L1Penalty", "L1Penalty") extern class L1Penalty {
	...
	**/
	@:native("__init__")
	public function ___init__(l1weight:Dynamic, ?sizeAverage:Dynamic, ?provideOutput:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(l1weight:Dynamic, ?sizeAverage:Dynamic, ?provideOutput:Dynamic):Void;
	/**
