...
package torch.legacy.nn.partialLinear;
@:pythonImport("torch.legacy.nn.PartialLinear", "PartialLinear") extern class PartialLinear {
	...
	**/
	...
	public function resetPartition():Dynamic;
	public function setPartition(indices:Dynamic):Dynamic;
