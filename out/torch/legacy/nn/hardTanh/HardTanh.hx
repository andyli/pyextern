...
package torch.legacy.nn.hardTanh;
@:pythonImport("torch.legacy.nn.HardTanh", "HardTanh") extern class HardTanh {
	...
	**/
	@:native("__init__")
	public function ___init__(?min_value:Dynamic, ?max_value:Dynamic, ?inplace:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(?min_value:Dynamic, ?max_value:Dynamic, ?inplace:Dynamic):Void;
	/**
