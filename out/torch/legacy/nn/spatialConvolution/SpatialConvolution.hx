...
package torch.legacy.nn.spatialConvolution;
@:pythonImport("torch.legacy.nn.SpatialConvolution", "SpatialConvolution") extern class SpatialConvolution {
	...
	**/
	@:native("__init__")
	public function ___init__(nInputPlane:Dynamic, nOutputPlane:Dynamic, kW:Dynamic, kH:Dynamic, ?dW:Dynamic, ?dH:Dynamic, ?padW:Dynamic, ?padH:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(nInputPlane:Dynamic, nOutputPlane:Dynamic, kW:Dynamic, kH:Dynamic, ?dW:Dynamic, ?dH:Dynamic, ?padW:Dynamic, ?padH:Dynamic):Void;
	/**
