...
package torch.legacy.nn.spatialReplicationPadding;
@:pythonImport("torch.legacy.nn.SpatialReplicationPadding", "SpatialReplicationPadding") extern class SpatialReplicationPadding {
