...
package torch.legacy.nn.spatialBatchNormalization;
@:pythonImport("torch.legacy.nn.SpatialBatchNormalization", "SpatialBatchNormalization") extern class SpatialBatchNormalization {
