...
package torch.legacy.nn.volumetricMaxUnpooling;
@:pythonImport("torch.legacy.nn.VolumetricMaxUnpooling", "VolumetricMaxUnpooling") extern class VolumetricMaxUnpooling {
	...
	**/
	@:native("__init__")
	public function ___init__(poolingModule:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(poolingModule:Dynamic):Void;
	/**
	...
	**/
	...
	public function _setParams():Dynamic;
