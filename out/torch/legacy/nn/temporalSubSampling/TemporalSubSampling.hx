...
package torch.legacy.nn.temporalSubSampling;
@:pythonImport("torch.legacy.nn.TemporalSubSampling", "TemporalSubSampling") extern class TemporalSubSampling {
	...
	**/
	@:native("__init__")
	public function ___init__(inputFrameSize:Dynamic, kW:Dynamic, ?dW:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(inputFrameSize:Dynamic, kW:Dynamic, ?dW:Dynamic):Void;
	/**
