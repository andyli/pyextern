...
package torch.legacy.nn.temporalMaxPooling;
@:pythonImport("torch.legacy.nn.TemporalMaxPooling", "TemporalMaxPooling") extern class TemporalMaxPooling {
	...
	**/
	@:native("__init__")
	public function ___init__(kW:Dynamic, ?dW:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(kW:Dynamic, ?dW:Dynamic):Void;
	/**
