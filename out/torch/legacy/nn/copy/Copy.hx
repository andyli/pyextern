...
package torch.legacy.nn.copy;
@:pythonImport("torch.legacy.nn.Copy", "Copy") extern class Copy {
	...
	**/
	@:native("__init__")
	public function ___init__(intype:Dynamic, outtype:Dynamic, ?dontCast:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(intype:Dynamic, outtype:Dynamic, ?dontCast:Dynamic):Void;
	/**
