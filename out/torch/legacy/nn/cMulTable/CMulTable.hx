...
package torch.legacy.nn.cMulTable;
@:pythonImport("torch.legacy.nn.CMulTable", "CMulTable") extern class CMulTable {
	...
	**/
	...
	public function updateGradInput_efficient(input:Dynamic, gradOutput:Dynamic):Dynamic;
