...
package torch.legacy.nn.replicate;
@:pythonImport("torch.legacy.nn.Replicate", "Replicate") extern class Replicate {
	...
	**/
	@:native("__init__")
	public function ___init__(nf:Dynamic, ?dim:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(nf:Dynamic, ?dim:Dynamic):Void;
	/**
