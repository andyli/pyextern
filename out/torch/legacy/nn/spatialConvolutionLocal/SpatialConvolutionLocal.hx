...
package torch.legacy.nn.spatialConvolutionLocal;
@:pythonImport("torch.legacy.nn.SpatialConvolutionLocal", "SpatialConvolutionLocal") extern class SpatialConvolutionLocal {
	...
	**/
	@:native("__init__")
	public function ___init__(nInputPlane:Dynamic, nOutputPlane:Dynamic, iW:Dynamic, iH:Dynamic, kW:Dynamic, kH:Dynamic, ?dW:Dynamic, ?dH:Dynamic, ?padW:Dynamic, ?padH:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(nInputPlane:Dynamic, nOutputPlane:Dynamic, iW:Dynamic, iH:Dynamic, kW:Dynamic, kH:Dynamic, ?dW:Dynamic, ?dH:Dynamic, ?padW:Dynamic, ?padH:Dynamic):Void;
	/**
	...
	**/
	...
	public function __tostring__():Dynamic;
	/**
		list of weak references to the object (if defined)
	**/
	public var __weakref__ : Dynamic;
	public function _checkInputSize(input:Dynamic):Dynamic;
	public function _checkOutputSize(input:Dynamic, output:Dynamic):Dynamic;
	public function _flatten(?parameters:Dynamic):Dynamic;
	static public var _flattenTensorBuffer : Dynamic;
	public function _makeContiguous(input:Dynamic, ?gradOutput:Dynamic):Dynamic;
	public function _unviewWeight():Dynamic;
	public function _viewWeight():Dynamic;
	...
	public function reset(?stdv:Dynamic):Dynamic;
