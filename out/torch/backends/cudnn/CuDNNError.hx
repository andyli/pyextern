...
@:pythonImport("torch.backends.cudnn", "CuDNNError") extern class CuDNNError {
	/**
		exception cause
	**/
	...
	**/
	@:native("__init__")
	public function ___init__(status:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(status:Dynamic):Void;
	/**
