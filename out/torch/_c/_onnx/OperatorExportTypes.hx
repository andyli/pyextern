...
@:pythonImport("torch._C._onnx", "OperatorExportTypes") extern class OperatorExportTypes {
	static public var ONNX : Dynamic;
	static public var ONNX_ATEN : Dynamic;
	static public var ONNX_ATEN_FALLBACK : Dynamic;
