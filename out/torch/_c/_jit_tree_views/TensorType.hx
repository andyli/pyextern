...
@:pythonImport("torch._C._jit_tree_views", "TensorType") extern class TensorType {
	...
	**/
	...
	/**
		__init__(self: torch._C._jit_tree_views.TensorType, arg0: torch._C._jit_tree_views.SourceRange) -> None
	**/
	@:native("__init__")
