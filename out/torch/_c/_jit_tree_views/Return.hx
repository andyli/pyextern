...
@:pythonImport("torch._C._jit_tree_views", "Return") extern class Return {
	...
	**/
	...
	/**
		__init__(self: torch._C._jit_tree_views.Return, arg0: torch._C._jit_tree_views.SourceRange, arg1: List[torch._C._jit_tree_views.Expr]) -> None
	**/
	@:native("__init__")
