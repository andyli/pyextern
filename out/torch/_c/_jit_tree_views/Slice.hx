...
@:pythonImport("torch._C._jit_tree_views", "Slice") extern class Slice {
	...
	**/
	...
	/**
		__init__(self: torch._C._jit_tree_views.Slice, arg0: torch._C._jit_tree_views.Expr, arg1: torch._C._jit_tree_views.Expr, arg2: torch._C._jit_tree_views.Expr) -> None
	**/
	@:native("__init__")
