...
@:pythonImport("torch._C._jit_tree_views", "Assign") extern class Assign {
	...
	**/
	...
	/**
		__init__(self: torch._C._jit_tree_views.Assign, arg0: List[torch._C._jit_tree_views.Expr], arg1: str, arg2: torch._C._jit_tree_views.Expr) -> None
	**/
	@:native("__init__")
