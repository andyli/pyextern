...
@:pythonImport("torch._C._jit_tree_views", "Gather") extern class Gather {
	...
	**/
	...
	/**
		__init__(self: torch._C._jit_tree_views.Gather, arg0: torch._C._jit_tree_views.Expr, arg1: torch._C._jit_tree_views.Expr) -> None
	**/
	@:native("__init__")
