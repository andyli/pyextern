...
@:pythonImport("torch._C._jit_tree_views", "Subscript") extern class Subscript {
	...
	**/
	...
	/**
		__init__(self: torch._C._jit_tree_views.Subscript, arg0: torch._C._jit_tree_views.Expr, arg1: List[torch._C._jit_tree_views.Expr]) -> None
	**/
	@:native("__init__")
