...
@:pythonImport("torch._C._jit_tree_views", "ListLiteral") extern class ListLiteral {
	...
	**/
	...
	/**
		__init__(self: torch._C._jit_tree_views.ListLiteral, arg0: torch._C._jit_tree_views.SourceRange, arg1: List[torch._C._jit_tree_views.Expr]) -> None
	**/
	@:native("__init__")
