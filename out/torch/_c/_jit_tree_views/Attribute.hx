...
@:pythonImport("torch._C._jit_tree_views", "Attribute") extern class Attribute {
	...
	**/
	...
	/**
		__init__(self: torch._C._jit_tree_views.Attribute, arg0: torch._C._jit_tree_views.Ident, arg1: torch::jit::script::Expr) -> None
	**/
	@:native("__init__")
