...
@:pythonImport("torch._C._jit_tree_views", "TupleLiteral") extern class TupleLiteral {
	...
	**/
	...
	/**
		__init__(self: torch._C._jit_tree_views.TupleLiteral, arg0: torch._C._jit_tree_views.SourceRange, arg1: List[torch._C._jit_tree_views.Expr]) -> None
	**/
	@:native("__init__")
