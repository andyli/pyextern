...
@:pythonImport("torch._C._jit_tree_views", "ExprStmt") extern class ExprStmt {
	...
	**/
	...
	/**
		__init__(self: torch._C._jit_tree_views.ExprStmt, arg0: List[torch._C._jit_tree_views.Expr]) -> None
	**/
	@:native("__init__")
