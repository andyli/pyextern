...
package torch._c;
@:pythonImport("torch._C", "TracingState") extern class TracingState {
	...
	**/
	public function graph(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
		pop_scope(self: torch._C.TracingState) -> None
	**/
	public function pop_scope(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
		push_scope(self: torch._C.TracingState, arg0: str) -> None
	**/
	public function push_scope(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
		set_graph(self: torch._C.TracingState, arg0: torch._C.Graph) -> None
	**/
	public function set_graph(args:haxe.extern.Rest<Dynamic>):Dynamic;
}