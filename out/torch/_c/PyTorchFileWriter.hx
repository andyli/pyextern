...
package torch._c;
@:pythonImport("torch._C", "PyTorchFileWriter") extern class PyTorchFileWriter {
	...
	**/
	public function write_end_of_file(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
		write_record(self: torch._C.PyTorchFileWriter, arg0: str, arg1: str, arg2: int) -> None
	**/
	public function write_record(args:haxe.extern.Rest<Dynamic>):Dynamic;
}