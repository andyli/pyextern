...
@:pythonImport("torch.cuda.streams", "Event") extern class Event {
	static public var BLOCKING_SYNC : Dynamic;
	static public var DEFAULT : Dynamic;
	static public var DISABLE_TIMING : Dynamic;
	static public var INTERPROCESS : Dynamic;
	...
	**/
	@:native("__init__")
	public function ___init__(?enable_timing:Dynamic, ?blocking:Dynamic, ?interprocess:Dynamic, ?_handle:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(?enable_timing:Dynamic, ?blocking:Dynamic, ?interprocess:Dynamic, ?_handle:Dynamic):Void;
	/**
