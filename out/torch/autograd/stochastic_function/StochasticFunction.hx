...
package torch.autograd.stochastic_function;
@:pythonImport("torch.autograd.stochastic_function", "StochasticFunction") extern class StochasticFunction {
	...
	**/
	public function backward(?grad_output:python.VarArgs<Dynamic>):Dynamic;
