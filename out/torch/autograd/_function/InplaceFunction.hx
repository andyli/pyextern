...
@:pythonImport("torch.autograd.function", "InplaceFunction") extern class InplaceFunction {
	...
	**/
	...
	/**
		...
		output.
	**/
	static public function backward(ctx:Dynamic, ?grad_outputs:python.VarArgs<Dynamic>):Dynamic;
	...
	**/
	static public function forward(ctx:Dynamic, ?args:python.VarArgs<Dynamic>, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
