...
@:pythonImport("torch.autograd.function", "FunctionMeta") extern class FunctionMeta {
	...
	**/
	@:native("__init__")
	public function ___init__(name:Dynamic, bases:Dynamic, attrs:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(name:Dynamic, bases:Dynamic, attrs:Dynamic):Void;
	/**
