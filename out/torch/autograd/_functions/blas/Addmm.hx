...
@:pythonImport("torch.autograd._functions.blas", "Addmm") extern class Addmm {
	...
	**/
	public function forward(add_matrix:Dynamic, matrix1:Dynamic, matrix2:Dynamic):Dynamic;
	/**
