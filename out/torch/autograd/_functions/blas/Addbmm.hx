...
@:pythonImport("torch.autograd._functions.blas", "Addbmm") extern class Addbmm {
	...
	**/
	public function forward(add_matrix:Dynamic, batch1:Dynamic, batch2:Dynamic):Dynamic;
	/**
