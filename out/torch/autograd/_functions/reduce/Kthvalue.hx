...
package torch.autograd._functions.reduce;
@:pythonImport("torch.autograd._functions.reduce", "Kthvalue") extern class Kthvalue {
	...
	**/
	@:native("__init__")
	public function ___init__(k:Dynamic, ?dim:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(k:Dynamic, ?dim:Dynamic):Void;
	/**
	...
	**/
	...
	static public var additional_args : Dynamic;
	/**
	...
	**/
	public function backward(grad_output:Dynamic, ?grad_indices:Dynamic):Dynamic;
	...
	**/
	...
	static public var has_all_reduce : Dynamic;
	/**
