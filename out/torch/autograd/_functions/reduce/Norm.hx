...
@:pythonImport("torch.autograd._functions.reduce", "Norm") extern class Norm {
	...
	**/
	@:native("__init__")
	public function ___init__(?norm_type:Dynamic, ?dim:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(?norm_type:Dynamic, ?dim:Dynamic):Void;
	/**
