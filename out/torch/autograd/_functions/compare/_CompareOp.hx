...
package torch.autograd._functions.compare;
@:pythonImport("torch.autograd._functions.compare", "_CompareOp") extern class _CompareOp {
	...
	**/
	@:native("__init__")
	public function ___init__(?scalar:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(?scalar:Dynamic):Void;
	/**
	...
	**/
	public function forward(tensor1:Dynamic, ?tensor2:Dynamic):Dynamic;
	/**
