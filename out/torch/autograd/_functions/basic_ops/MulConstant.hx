...
@:pythonImport("torch.autograd._functions.basic_ops", "MulConstant") extern class MulConstant {
	...
	**/
	@:native("__init__")
	public function ___init__(constant:Dynamic, ?inplace:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(constant:Dynamic, ?inplace:Dynamic):Void;
	/**
