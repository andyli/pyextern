...
@:pythonImport("torch.autograd._functions.basic_ops", "PowConstant") extern class PowConstant {
	...
	**/
	@:native("__init__")
	public function ___init__(constant:Dynamic, ?tensor_power:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(constant:Dynamic, ?tensor_power:Dynamic):Void;
	/**
