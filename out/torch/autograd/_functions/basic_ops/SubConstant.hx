...
@:pythonImport("torch.autograd._functions.basic_ops", "SubConstant") extern class SubConstant {
	...
	**/
	@:native("__init__")
	public function ___init__(constant:Dynamic, ?sub_tensor:Dynamic, ?inplace:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(constant:Dynamic, ?sub_tensor:Dynamic, ?inplace:Dynamic):Void;
	/**
