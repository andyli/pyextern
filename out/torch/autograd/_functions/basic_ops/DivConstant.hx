...
package torch.autograd._functions.basic_ops;
@:pythonImport("torch.autograd._functions.basic_ops", "DivConstant") extern class DivConstant {
	...
	**/
	@:native("__init__")
	public function ___init__(constant:Dynamic, ?div_by_tensor:Dynamic, ?inplace:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(constant:Dynamic, ?div_by_tensor:Dynamic, ?inplace:Dynamic):Void;
	/**
	...
	**/
	public function forward(a:Dynamic):Dynamic;
	/**
