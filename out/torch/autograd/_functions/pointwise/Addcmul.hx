...
@:pythonImport("torch.autograd._functions.pointwise", "Addcmul") extern class Addcmul {
	...
	**/
	public function forward(add_tensor:Dynamic, mul_tensor1:Dynamic, mul_tensor2:Dynamic):Dynamic;
	/**
