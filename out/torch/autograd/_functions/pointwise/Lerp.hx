...
@:pythonImport("torch.autograd._functions.pointwise", "Lerp") extern class Lerp {
	...
	**/
	@:native("__init__")
	public function ___init__(weight:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(weight:Dynamic):Void;
	/**
