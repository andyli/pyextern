...
@:pythonImport("torch.autograd._functions.pointwise", "CminConstant") extern class CminConstant {
	...
	**/
	@:native("__init__")
	public function ___init__(constant:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(constant:Dynamic):Void;
	/**
