...
package torch.autograd._functions.pointwise;
@:pythonImport("torch.autograd._functions.pointwise", "Addcdiv") extern class Addcdiv {
	...
	**/
	@:native("__init__")
	public function ___init__(?scale:Dynamic, ?inplace:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(?scale:Dynamic, ?inplace:Dynamic):Void;
	/**
	...
	**/
	public function forward(add_tensor:Dynamic, div_tensor1:Dynamic, div_tensor2:Dynamic):Dynamic;
	/**
