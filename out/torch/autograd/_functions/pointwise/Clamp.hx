...
@:pythonImport("torch.autograd._functions.pointwise", "Clamp") extern class Clamp {
	...
	**/
	@:native("__init__")
	public function ___init__(min_val:Dynamic, max_val:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(min_val:Dynamic, max_val:Dynamic):Void;
	/**
