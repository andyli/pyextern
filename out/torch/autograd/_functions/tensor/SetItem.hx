...
@:pythonImport("torch.autograd._functions.tensor", "SetItem") extern class SetItem {
	...
	**/
	@:native("__init__")
	public function ___init__(index:Dynamic, ?value:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(index:Dynamic, ?value:Dynamic):Void;
	/**
	...
	**/
	public function forward(i:Dynamic, ?value:Dynamic):Dynamic;
	/**
