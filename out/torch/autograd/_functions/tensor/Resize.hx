...
@:pythonImport("torch.autograd._functions.tensor", "Resize") extern class Resize {
	...
	**/
	@:native("__init__")
	public function ___init__(?sizes:python.VarArgs<Dynamic>):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(?sizes:python.VarArgs<Dynamic>):Void;
	/**
	...
	**/
	public function forward(tensor:Dynamic):Dynamic;
	/**
