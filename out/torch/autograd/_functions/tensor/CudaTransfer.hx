...
@:pythonImport("torch.autograd._functions.tensor", "CudaTransfer") extern class CudaTransfer {
	...
	**/
	@:native("__init__")
	public function ___init__(?device_id:Dynamic, ?async:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(?device_id:Dynamic, ?async:Dynamic):Void;
	/**
