...
@:pythonImport("torch.autograd._functions.tensor", "Repeat") extern class Repeat {
	...
	**/
	@:native("__init__")
	public function ___init__(repeats:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(repeats:Dynamic):Void;
	/**
