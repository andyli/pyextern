...
@:pythonImport("torch.autograd._functions.tensor", "Chunk") extern class Chunk {
	...
	**/
	@:native("__init__")
	public function ___init__(num_chunks:Dynamic, ?dim:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(num_chunks:Dynamic, ?dim:Dynamic):Void;
	/**
