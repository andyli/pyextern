...
@:pythonImport("torch.autograd._functions.tensor", "Expand") extern class Expand {
	...
	**/
	@:native("__init__")
	public function ___init__(sizes:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(sizes:Dynamic):Void;
	/**
