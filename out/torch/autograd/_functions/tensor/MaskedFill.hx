...
@:pythonImport("torch.autograd._functions.tensor", "MaskedFill") extern class MaskedFill {
	...
	**/
	@:native("__init__")
	public function ___init__(value:Dynamic, ?inplace:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(value:Dynamic, ?inplace:Dynamic):Void;
	/**
	...
	**/
	public function forward(tensor:Dynamic, mask:Dynamic):Dynamic;
	/**
