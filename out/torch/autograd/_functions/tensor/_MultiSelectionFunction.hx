...
@:pythonImport("torch.autograd._functions.tensor", "_MultiSelectionFunction") extern class _MultiSelectionFunction {
	...
	**/
	@:native("__init__")
	public function ___init__(dim:Dynamic, return_indices:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(dim:Dynamic, return_indices:Dynamic):Void;
	/**
