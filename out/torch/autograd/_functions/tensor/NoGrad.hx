...
@:pythonImport("torch.autograd._functions.tensor", "NoGrad") extern class NoGrad {
	...
	**/
	...
	public function _do_forward(?args:python.VarArgs<Dynamic>, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
