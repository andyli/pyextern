...
@:pythonImport("torch.autograd._functions.tensor", "Permute") extern class Permute {
	...
	**/
	@:native("__init__")
	public function ___init__(dim_indices:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(dim_indices:Dynamic):Void;
	/**
