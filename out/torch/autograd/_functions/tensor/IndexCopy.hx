...
@:pythonImport("torch.autograd._functions.tensor", "IndexCopy") extern class IndexCopy {
	...
	**/
	@:native("__init__")
	public function ___init__(dim:Dynamic, ?inplace:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(dim:Dynamic, ?inplace:Dynamic):Void;
	/**
	...
	**/
	public function forward(tensor1:Dynamic, index:Dynamic, tensor2:Dynamic):Dynamic;
	/**
