...
@:pythonImport("torch.autograd._functions.tensor", "IndexFill") extern class IndexFill {
	...
	**/
	@:native("__init__")
	public function ___init__(dim:Dynamic, value:Dynamic, ?inplace:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(dim:Dynamic, value:Dynamic, ?inplace:Dynamic):Void;
	/**
	...
	**/
	public function forward(tensor:Dynamic, index:Dynamic):Dynamic;
	/**
