...
@:pythonImport("torch.autograd._functions.tensor", "Topk") extern class Topk {
	...
	**/
	@:native("__init__")
	public function ___init__(k:Dynamic, ?dim:Dynamic, ?largest:Dynamic, ?sort:Dynamic, ?return_indices:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(k:Dynamic, ?dim:Dynamic, ?largest:Dynamic, ?sort:Dynamic, ?return_indices:Dynamic):Void;
	/**
