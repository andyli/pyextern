...
@:pythonImport("torch.autograd._functions.tensor", "MaskedCopy") extern class MaskedCopy {
	...
	**/
	public function forward(tensor1:Dynamic, mask:Dynamic, tensor2:Dynamic):Dynamic;
	/**
