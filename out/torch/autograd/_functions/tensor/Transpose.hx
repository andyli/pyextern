...
@:pythonImport("torch.autograd._functions.tensor", "Transpose") extern class Transpose {
	...
	**/
	@:native("__init__")
	public function ___init__(?dims:python.VarArgs<Dynamic>):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(?dims:python.VarArgs<Dynamic>):Void;
	/**
