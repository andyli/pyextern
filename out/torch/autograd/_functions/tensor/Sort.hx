...
@:pythonImport("torch.autograd._functions.tensor", "Sort") extern class Sort {
	...
	**/
	@:native("__init__")
	public function ___init__(?dim:Dynamic, ?descending:Dynamic, ?return_indices:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(?dim:Dynamic, ?descending:Dynamic, ?return_indices:Dynamic):Void;
	/**
