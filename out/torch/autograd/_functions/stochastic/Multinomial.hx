...
package torch.autograd._functions.stochastic;
@:pythonImport("torch.autograd._functions.stochastic", "Multinomial") extern class Multinomial {
	...
	**/
	@:native("__init__")
	public function ___init__(num_samples:Dynamic, with_replacement:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(num_samples:Dynamic, with_replacement:Dynamic):Void;
	/**
	...
	**/
	...
	public function _do_backward(grad_output:Dynamic, retain_variables:Dynamic):Dynamic;
	public function _do_forward(?inputs:python.VarArgs<Dynamic>):Dynamic;
	...
	public function _reinforce(reward:Dynamic):Dynamic;
	/**
	...
	**/
	public function backward(reward:Dynamic):Dynamic;
	...
	**/
	public function forward(probs:Dynamic):Dynamic;
	/**
