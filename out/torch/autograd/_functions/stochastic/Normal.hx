...
@:pythonImport("torch.autograd._functions.stochastic", "Normal") extern class Normal {
	...
	**/
	@:native("__init__")
	public function ___init__(?stddev:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(?stddev:Dynamic):Void;
	/**
	...
	**/
	public function forward(means:Dynamic, ?stddevs:Dynamic):Dynamic;
	/**
