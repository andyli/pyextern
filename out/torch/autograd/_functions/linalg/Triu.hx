...
package torch.autograd._functions.linalg;
@:pythonImport("torch.autograd._functions.linalg", "Triu") extern class Triu {
	...
	**/
	@:native("__init__")
	public function ___init__(?diagonal_idx:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(?diagonal_idx:Dynamic):Void;
	/**
