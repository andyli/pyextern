...
@:pythonImport("torch.distributed", "PrefixStore") extern class PrefixStore {
	...
	**/
	...
	/**
		__init__(self: torch.distributed.PrefixStore, arg0: str, arg1: torch.distributed.Store) -> None
	**/
	@:native("__init__")
