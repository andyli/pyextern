...
@:pythonImport("torch.distributed", "ReduceOp") extern class ReduceOp {
	...
	**/
	...
	/**
		__eq__(self: torch.distributed.ReduceOp, arg0: torch.distributed.ReduceOp) -> bool
	**/
	...
	**/
	...
	/**
		__getstate__(self: torch.distributed.ReduceOp) -> tuple
	**/
	...
	**/
	...
	/**
		__hash__(self: torch.distributed.ReduceOp) -> int
	**/
	public function __hash__(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
		__init__(self: torch.distributed.ReduceOp, arg0: int) -> None
	**/
	@:native("__init__")
	...
	**/
	...
	/**
		__int__(self: torch.distributed.ReduceOp) -> int
	**/
	...
	**/
	...
	/**
		__ne__(self: torch.distributed.ReduceOp, arg0: torch.distributed.ReduceOp) -> bool
	**/
	...
	**/
	...
	/**
		__repr__(self: torch.distributed.ReduceOp) -> str
	**/
	...
	**/
	...
	/**
		__setstate__(self: torch.distributed.ReduceOp, arg0: tuple) -> None
	**/
