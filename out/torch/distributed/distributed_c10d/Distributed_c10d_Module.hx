...
@:pythonImport("torch.distributed.distributed_c10d") extern class Distributed_c10d_Module {
	...
	/**
		...
		assertion
	**/
	static public function _check_default_pg():Dynamic;
	/**
	...
	**/
	...
	static public var _default_pg : Dynamic;
	static public var _default_pg_init_method : Dynamic;
	static public var _default_pg_timeout : Dynamic;
	/**
	...
	**/
	static public function _new_process_group_helper(world_size:Dynamic, rank:Dynamic, group_ranks:Dynamic, in_group:Dynamic, group_name:Dynamic, ?timeout:Dynamic):Dynamic;
