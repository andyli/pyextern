...
@:pythonImport("torch.optim.lr_scheduler", "MultiStepLR") extern class MultiStepLR {
	...
	**/
	@:native("__init__")
	public function ___init__(optimizer:Dynamic, milestones:Dynamic, ?gamma:Dynamic, ?last_epoch:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(optimizer:Dynamic, milestones:Dynamic, ?gamma:Dynamic, ?last_epoch:Dynamic):Void;
	/**
