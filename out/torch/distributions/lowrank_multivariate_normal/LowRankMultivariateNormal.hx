...
@:pythonImport("torch.distributions.lowrank_multivariate_normal", "LowRankMultivariateNormal") extern class LowRankMultivariateNormal {
	...
	**/
	@:native("__init__")
	public function ___init__(loc:Dynamic, cov_factor:Dynamic, cov_diag:Dynamic, ?validate_args:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(loc:Dynamic, cov_factor:Dynamic, cov_diag:Dynamic, ?validate_args:Dynamic):Void;
	/**
