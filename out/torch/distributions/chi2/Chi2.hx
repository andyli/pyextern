...
@:pythonImport("torch.distributions.chi2", "Chi2") extern class Chi2 {
	...
	**/
	@:native("__init__")
	public function ___init__(df:Dynamic, ?validate_args:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(df:Dynamic, ?validate_args:Dynamic):Void;
	/**
