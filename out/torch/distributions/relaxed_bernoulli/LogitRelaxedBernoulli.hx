...
package torch.distributions.relaxed_bernoulli;
@:pythonImport("torch.distributions.relaxed_bernoulli", "LogitRelaxedBernoulli") extern class LogitRelaxedBernoulli {
	...
	**/
	@:native("__init__")
	public function ___init__(temperature:Dynamic, ?probs:Dynamic, ?logits:Dynamic, ?validate_args:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(temperature:Dynamic, ?probs:Dynamic, ?logits:Dynamic, ?validate_args:Dynamic):Void;
	/**
