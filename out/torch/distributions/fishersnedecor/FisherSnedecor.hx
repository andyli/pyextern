...
@:pythonImport("torch.distributions.fishersnedecor", "FisherSnedecor") extern class FisherSnedecor {
	...
	**/
	@:native("__init__")
	public function ___init__(df1:Dynamic, df2:Dynamic, ?validate_args:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(df1:Dynamic, df2:Dynamic, ?validate_args:Dynamic):Void;
	/**
