...
package torch.distributions.half_cauchy;
@:pythonImport("torch.distributions.half_cauchy", "HalfCauchy") extern class HalfCauchy {
	...
	**/
	@:native("__init__")
	public function ___init__(scale:Dynamic, ?validate_args:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(scale:Dynamic, ?validate_args:Dynamic):Void;
	/**
	...
	**/
	...
	/**
		...
		transform(s) and computing the score of the base distribution.
	**/
	public function icdf(prob:Dynamic):Dynamic;
	/**
