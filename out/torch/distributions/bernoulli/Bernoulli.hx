...
@:pythonImport("torch.distributions.bernoulli", "Bernoulli") extern class Bernoulli {
	...
	**/
	@:native("__init__")
	public function ___init__(?probs:Dynamic, ?logits:Dynamic, ?validate_args:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(?probs:Dynamic, ?logits:Dynamic, ?validate_args:Dynamic):Void;
	/**
