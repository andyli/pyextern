...
package torch.distributions.gamma;
@:pythonImport("torch.distributions.gamma", "Gamma") extern class Gamma {
	...
	**/
	@:native("__init__")
	public function ___init__(concentration:Dynamic, rate:Dynamic, ?validate_args:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(concentration:Dynamic, rate:Dynamic, ?validate_args:Dynamic):Void;
	/**
	...
	**/
	public function _log_normalizer(x:Dynamic, y:Dynamic):Dynamic;
