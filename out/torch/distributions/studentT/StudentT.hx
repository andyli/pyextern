...
@:pythonImport("torch.distributions.studentT", "StudentT") extern class StudentT {
	...
	**/
	@:native("__init__")
	public function ___init__(df:Dynamic, ?loc:Dynamic, ?scale:Dynamic, ?validate_args:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(df:Dynamic, ?loc:Dynamic, ?scale:Dynamic, ?validate_args:Dynamic):Void;
	/**
