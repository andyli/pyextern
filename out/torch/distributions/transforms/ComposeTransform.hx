...
@:pythonImport("torch.distributions.transforms", "ComposeTransform") extern class ComposeTransform {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(parts:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(parts:Dynamic):Void;
	/**
