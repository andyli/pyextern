...
@:pythonImport("torch.distributions.utils", "_Finfo") extern class _Finfo {
	/**
		Return self+value.
	**/
	...
	**/
	...
	/**
		Create new instance of _Finfo(eps, tiny)
	**/
	static public function __new__(_cls:Dynamic, eps:Dynamic, tiny:Dynamic):Dynamic;
	/**
		helper for pickle
	**/
	...
	**/
	...
	/**
		Make a new _Finfo object from a sequence or iterable
	**/
	static public function _make(iterable:Dynamic, ?_new:Dynamic, ?len:Dynamic):Dynamic;
	/**
		Return a new _Finfo object replacing specified fields with new values
	**/
