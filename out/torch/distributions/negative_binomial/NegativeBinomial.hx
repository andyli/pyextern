...
package torch.distributions.negative_binomial;
@:pythonImport("torch.distributions.negative_binomial", "NegativeBinomial") extern class NegativeBinomial {
	...
	**/
	@:native("__init__")
	public function ___init__(total_count:Dynamic, ?probs:Dynamic, ?logits:Dynamic, ?validate_args:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(total_count:Dynamic, ?probs:Dynamic, ?logits:Dynamic, ?validate_args:Dynamic):Void;
	/**
	...
	**/
	...
	static public var _gamma : Dynamic;
	...
	**/
	...
	static public var logits : Dynamic;
	/**
	...
	**/
	...
	static public var probs : Dynamic;
	/**
