...
@:pythonImport("torch.distributions.multivariate_normal", "MultivariateNormal") extern class MultivariateNormal {
	...
	**/
	@:native("__init__")
	public function ___init__(loc:Dynamic, ?covariance_matrix:Dynamic, ?precision_matrix:Dynamic, ?scale_tril:Dynamic, ?validate_args:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(loc:Dynamic, ?covariance_matrix:Dynamic, ?precision_matrix:Dynamic, ?scale_tril:Dynamic, ?validate_args:Dynamic):Void;
	/**
	...
	**/
	...
	static public var covariance_matrix : Dynamic;
	/**
	...
	**/
	...
	static public var precision_matrix : Dynamic;
	/**
	...
	**/
	...
	static public var scale_tril : Dynamic;
