...
package torch.jit;
@:pythonImport("torch.jit", "ScriptMethodStub") extern class ScriptMethodStub {
	/**
		Return self+value.
	**/
	...
	**/
	...
	/**
		Make a new ScriptMethodStub object from a sequence or iterable
	**/
	static public function _make(iterable:Dynamic, ?_new:Dynamic, ?len:Dynamic):Dynamic;
	/**
		Return a new ScriptMethodStub object replacing specified fields with new values
	**/
	...
	**/
	public var original_method : Dynamic;
	/**
		Alias for field number 0
	**/
	public var resolution_callback : Dynamic;
}