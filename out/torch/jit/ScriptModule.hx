...
package torch.jit;
@:pythonImport("torch.jit", "ScriptModule") extern class ScriptModule {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(?optimize:Dynamic):Dynamic;
	/**
		__init__(self: torch._C.ScriptModule) -> None
	**/
	public function new(?optimize:Dynamic):Void;
	/**
