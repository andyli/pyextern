...
@:pythonImport("torch.jit.frontend", "FrontendTypeError") extern class FrontendTypeError {
	/**
		exception cause
	**/
	...
	**/
	@:native("__init__")
	public function ___init__(source_range:Dynamic, msg:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(source_range:Dynamic, msg:Dynamic):Void;
	/**
