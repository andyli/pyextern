...
@:pythonImport("torch.jit.frontend", "SourceContext") extern class SourceContext {
	...
	**/
	@:native("__init__")
	public function ___init__(source:Dynamic, ?uses_true_division:Dynamic):Dynamic;
	/**
		__init__(self: torch._C._jit_tree_views.SourceRangeFactory, arg0: str) -> None
	**/
	public function new(source:Dynamic, ?uses_true_division:Dynamic):Void;
	/**
	...
	**/
	public function make_raw_range(args:haxe.extern.Rest<Dynamic>):Dynamic;
