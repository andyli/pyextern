...
package torch.jit;
@:pythonImport("torch.jit", "LegacyTracedModule") extern class LegacyTracedModule {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(inner:Dynamic, ?force_outplace:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(inner:Dynamic, ?force_outplace:Dynamic):Void;
	/**
