...
@:pythonImport("torch.utils._cpp_extension_versioner", "Entry") extern class Entry {
	/**
		Return self+value.
	**/
	...
	**/
	...
	/**
		Create new instance of Entry(version, hash)
	**/
	static public function __new__(_cls:Dynamic, version:Dynamic, hash:Dynamic):Dynamic;
	/**
		helper for pickle
	**/
