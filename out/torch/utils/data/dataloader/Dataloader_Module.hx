...
@:pythonImport("torch.utils.data.dataloader") extern class Dataloader_Module {
	...
	static public var MP_STATUS_CHECK_INTERVAL : Dynamic;
	...
	static public function _pin_memory_loop(in_queue:Dynamic, out_queue:Dynamic, device_id:Dynamic, done_event:Dynamic):Dynamic;
	static public var _python_exit_status : Dynamic;
	...
	static public function _set_python_exit_flag():Dynamic;
	...
	static public function _worker_loop(dataset:Dynamic, index_queue:Dynamic, data_queue:Dynamic, done_event:Dynamic, collate_fn:Dynamic, seed:Dynamic, init_fn:Dynamic, worker_id:Dynamic):Dynamic;
	/**
