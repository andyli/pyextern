...
package torch.nn._functions.padding;
@:pythonImport("torch.nn._functions.padding", "ConstantPadNd") extern class ConstantPadNd {
	...
	**/
	static public function forward(ctx:Dynamic, input:Dynamic, pad:Dynamic, ?value:Dynamic):Dynamic;
	...
	**/
	...
	static public function symbolic(g:Dynamic, input:Dynamic, pad:Dynamic, ?value:Dynamic):Dynamic;
