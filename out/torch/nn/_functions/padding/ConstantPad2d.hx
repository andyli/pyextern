...
@:pythonImport("torch.nn._functions.padding", "ConstantPad2d") extern class ConstantPad2d {
	...
	**/
	@:native("__init__")
	public function ___init__(pad:Dynamic, ?value:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(pad:Dynamic, ?value:Dynamic):Void;
	/**
