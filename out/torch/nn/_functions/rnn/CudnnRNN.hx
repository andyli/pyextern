...
@:pythonImport("torch.nn._functions.rnn", "CudnnRNN") extern class CudnnRNN {
	public function __call__(?input:python.VarArgs<Dynamic>):Dynamic;
	...
	**/
	@:native("__init__")
	public function ___init__(mode:Dynamic, input_size:Dynamic, hidden_size:Dynamic, ?num_layers:Dynamic, ?batch_first:Dynamic, ?dropout:Dynamic, ?train:Dynamic, ?bidirectional:Dynamic, ?batch_sizes:Dynamic, ?dropout_state:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(mode:Dynamic, input_size:Dynamic, hidden_size:Dynamic, ?num_layers:Dynamic, ?batch_first:Dynamic, ?dropout:Dynamic, ?train:Dynamic, ?bidirectional:Dynamic, ?batch_sizes:Dynamic, ?dropout_state:Dynamic):Void;
	/**
	...
	**/
	...
	public function _do_backward(gradients:Dynamic, retain_variables:Dynamic):Dynamic;
	public function _do_forward(?input:python.VarArgs<Dynamic>):Dynamic;
	...
	**/
	public function backward(?gradients:python.VarArgs<Dynamic>):Dynamic;
	public function backward_extended(grad_output:Dynamic, grad_hy:Dynamic):Dynamic;
	...
	**/
	...
	public function forward_extended(input:Dynamic, weight:Dynamic, hx:Dynamic):Dynamic;
	/**
		...
		**This should be called at most once, only from inside the**
		...
		modification.
	**/
	public function mark_dirty(?args:python.VarArgs<Dynamic>, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
	...
	**/
	public function mark_non_differentiable(?args:python.VarArgs<Dynamic>, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
	...
	**/
	public function save_for_backward(?args:python.VarArgs<Dynamic>):Dynamic;
