...
package torch.nn._functions.vision;
@:pythonImport("torch.nn._functions.vision", "AffineGridGenerator") extern class AffineGridGenerator {
	...
	**/
	...
	static public function _enforce_cudnn(input:Dynamic):Dynamic;
	...
	/**
		...
		output.
	**/
	static public function backward(ctx:Dynamic, grad_grid:Dynamic):Dynamic;
	...
	**/
	static public function forward(ctx:Dynamic, theta:Dynamic, size:Dynamic):Dynamic;
