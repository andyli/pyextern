...
@:pythonImport("torch.nn._functions.dropout", "FeatureDropout") extern class FeatureDropout {
	...
	**/
	@:native("__init__")
	public function ___init__(?p:Dynamic, ?train:Dynamic, ?inplace:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(?p:Dynamic, ?train:Dynamic, ?inplace:Dynamic):Void;
	/**
	...
	**/
	...
	public function _make_noise(input:Dynamic):Dynamic;
