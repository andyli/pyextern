...
@:pythonImport("torch.nn._functions.dropout", "FeatureAlphaDropout") extern class FeatureAlphaDropout {
	...
	**/
	...
	static public function _make_noise(input:Dynamic):Dynamic;
	...
	**/
	static public function forward(ctx:Dynamic, input:Dynamic, ?p:Dynamic, ?train:Dynamic, ?inplace:Dynamic):Dynamic;
	...
	**/
	...
	static public function symbolic(g:Dynamic, input:Dynamic, ?p:Dynamic, ?train:Dynamic, ?inplace:Dynamic):Dynamic;
