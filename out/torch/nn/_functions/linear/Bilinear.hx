...
package torch.nn._functions.linear;
@:pythonImport("torch.nn._functions.linear", "Bilinear") extern class Bilinear {
	...
	**/
	public function forward(input1:Dynamic, input2:Dynamic, weight:Dynamic, ?bias:Dynamic):Dynamic;
	/**
