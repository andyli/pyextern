...
package torch.nn._functions.conv;
@:pythonImport("torch.nn._functions.conv", "ConvNd") extern class ConvNd {
	...
	**/
	@:native("__init__")
	public function ___init__(stride:Dynamic, padding:Dynamic, dilation:Dynamic, transposed:Dynamic, output_padding:Dynamic, groups:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(stride:Dynamic, padding:Dynamic, dilation:Dynamic, transposed:Dynamic, output_padding:Dynamic, groups:Dynamic):Void;
	/**
	...
	**/
	...
	public function _grad_input(input:Dynamic, weight:Dynamic, grad_output:Dynamic):Dynamic;
	public function _grad_params(input:Dynamic, weight:Dynamic, bias:Dynamic, grad_output:Dynamic):Dynamic;
	public function _output_size(input:Dynamic, weight:Dynamic):Dynamic;
	...
	public function _thnn(fn_name:Dynamic, input:Dynamic, weight:Dynamic, ?args:python.VarArgs<Dynamic>):Dynamic;
	public function _update_output(input:Dynamic, weight:Dynamic, bias:Dynamic):Dynamic;
	/**
	...
	**/
	public function forward(input:Dynamic, weight:Dynamic, ?bias:Dynamic):Dynamic;
	public function is_dilated():Dynamic;
	/**
	...
	**/
	...
	public function thnn_class_name(input:Dynamic):Dynamic;
