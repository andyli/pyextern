...
package torch.nn._functions.thnn.loss;
@:pythonImport("torch.nn._functions.thnn.loss", "BCELoss") extern class BCELoss {
	...
	**/
	...
	public function _resize_weight(target:Dynamic):Dynamic;
	public function _unresize_weight():Dynamic;
	/**
