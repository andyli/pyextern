...
@:pythonImport("torch.nn._functions.thnn.auto", "MultiLabelMarginLoss") extern class MultiLabelMarginLoss {
	...
	**/
	...
	static public function forward(ctx:Dynamic, input:Dynamic, target:Dynamic, ?args:python.VarArgs<Dynamic>):Dynamic;
