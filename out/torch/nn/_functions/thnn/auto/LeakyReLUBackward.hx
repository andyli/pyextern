...
@:pythonImport("torch.nn._functions.thnn.auto", "LeakyReLUBackward") extern class LeakyReLUBackward {
	...
	**/
	...
	static public function forward(ctx:Dynamic, input:Dynamic, grad_output:Dynamic, additional_args_ctx:Dynamic, backend_ctx:Dynamic, buffers_ctx:Dynamic, ?params:python.VarArgs<Dynamic>):Dynamic;
