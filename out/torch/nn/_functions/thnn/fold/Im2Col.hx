...
@:pythonImport("torch.nn._functions.thnn.fold", "Im2Col") extern class Im2Col {
	...
	**/
	static public function forward(ctx:Dynamic, input:Dynamic, kernel_size:Dynamic, dilation:Dynamic, padding:Dynamic, stride:Dynamic):Dynamic;
