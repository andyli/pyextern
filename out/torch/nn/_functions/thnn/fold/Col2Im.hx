...
package torch.nn._functions.thnn.fold;
@:pythonImport("torch.nn._functions.thnn.fold", "Col2Im") extern class Col2Im {
	...
	**/
	static public function forward(ctx:Dynamic, input:Dynamic, output_size:Dynamic, kernel_size:Dynamic, dilation:Dynamic, padding:Dynamic, stride:Dynamic):Dynamic;
