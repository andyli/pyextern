...
@:pythonImport("torch.nn._functions.thnn.sparse", "EmbeddingBag") extern class EmbeddingBag {
	...
	**/
	...
	static public function _renorm(ctx:Dynamic, indices:Dynamic, weight:Dynamic, max_norm:Dynamic, norm_type:Dynamic):Dynamic;
	...
	**/
	static public function forward(ctx:Dynamic, weight:Dynamic, indices:Dynamic, offsets:Dynamic, max_norm:Dynamic, norm_type:Dynamic, scale_grad_by_freq:Dynamic, mode:Dynamic):Dynamic;
