...
package torch.nn._functions.thnn.sparse;
@:pythonImport("torch.nn._functions.thnn.sparse", "Embedding") extern class Embedding {
	...
	**/
	@:native("__init__")
	public function ___init__(padding_idx:Dynamic, max_norm:Dynamic, norm_type:Dynamic, scale_grad_by_freq:Dynamic, ?sparse:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(padding_idx:Dynamic, max_norm:Dynamic, norm_type:Dynamic, scale_grad_by_freq:Dynamic, ?sparse:Dynamic):Void;
	/**
	...
	**/
	...
	public function _renorm(indices:Dynamic, weight:Dynamic):Dynamic;
	/**
	...
	**/
	public function forward(indices:Dynamic, weight:Dynamic):Dynamic;
	/**
