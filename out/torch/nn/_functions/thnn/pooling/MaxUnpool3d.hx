...
@:pythonImport("torch.nn._functions.thnn.pooling", "MaxUnpool3d") extern class MaxUnpool3d {
	...
	**/
	@:native("__init__")
	public function ___init__(output_size:Dynamic, stride:Dynamic, padding:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(output_size:Dynamic, stride:Dynamic, padding:Dynamic):Void;
	/**
	...
	**/
	public function forward(input:Dynamic, indices:Dynamic):Dynamic;
	/**
