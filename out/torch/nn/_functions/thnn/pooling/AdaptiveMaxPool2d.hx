...
@:pythonImport("torch.nn._functions.thnn.pooling", "AdaptiveMaxPool2d") extern class AdaptiveMaxPool2d {
	...
	**/
	@:native("__init__")
	public function ___init__(output_size:Dynamic, ?return_indices:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(output_size:Dynamic, ?return_indices:Dynamic):Void;
	/**
