...
@:pythonImport("torch.nn._functions.thnn.pooling", "AvgPool2d") extern class AvgPool2d {
	...
	**/
	@:native("__init__")
	public function ___init__(kernel_size:Dynamic, ?stride:Dynamic, ?padding:Dynamic, ?ceil_mode:Dynamic, ?count_include_pad:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(kernel_size:Dynamic, ?stride:Dynamic, ?padding:Dynamic, ?ceil_mode:Dynamic, ?count_include_pad:Dynamic):Void;
	/**
