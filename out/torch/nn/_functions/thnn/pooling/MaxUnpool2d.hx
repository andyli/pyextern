...
@:pythonImport("torch.nn._functions.thnn.pooling", "MaxUnpool2d") extern class MaxUnpool2d {
	...
	**/
	@:native("__init__")
	public function ___init__(output_size:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(output_size:Dynamic):Void;
	/**
