...
@:pythonImport("torch.nn._functions.thnn.pooling", "MaxPool1d") extern class MaxPool1d {
	...
	**/
	@:native("__init__")
	public function ___init__(kernel_size:Dynamic, ?stride:Dynamic, ?padding:Dynamic, ?dilation:Dynamic, ?return_indices:Dynamic, ?ceil_mode:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(kernel_size:Dynamic, ?stride:Dynamic, ?padding:Dynamic, ?dilation:Dynamic, ?return_indices:Dynamic, ?ceil_mode:Dynamic):Void;
	/**
	...
	**/
	public function backward(grad_output:Dynamic, ?_indices_grad:Dynamic):Dynamic;
