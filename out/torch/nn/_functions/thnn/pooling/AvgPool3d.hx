...
@:pythonImport("torch.nn._functions.thnn.pooling", "AvgPool3d") extern class AvgPool3d {
	...
	**/
	@:native("__init__")
	public function ___init__(kernel_size:Dynamic, ?stride:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(kernel_size:Dynamic, ?stride:Dynamic):Void;
	/**
