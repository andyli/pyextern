...
package torch.nn._functions.thnn.pooling;
@:pythonImport("torch.nn._functions.thnn.pooling", "FractionalMaxPool2d") extern class FractionalMaxPool2d {
	...
	**/
	@:native("__init__")
	public function ___init__(kh:Dynamic, kw:Dynamic, ?output_size:Dynamic, ?output_ratio:Dynamic, ?return_indices:Dynamic, ?_random_samples:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(kh:Dynamic, kw:Dynamic, ?output_size:Dynamic, ?output_ratio:Dynamic, ?return_indices:Dynamic, ?_random_samples:Dynamic):Void;
	/**
	...
	**/
	public function backward(grad_output:Dynamic, ?_grad_indices:Dynamic):Dynamic;
