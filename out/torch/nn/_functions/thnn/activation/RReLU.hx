...
package torch.nn._functions.thnn.activation;
@:pythonImport("torch.nn._functions.thnn.activation", "RReLU") extern class RReLU {
	...
	**/
	@:native("__init__")
	public function ___init__(lower:Dynamic, upper:Dynamic, train:Dynamic, ?inplace:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(lower:Dynamic, upper:Dynamic, train:Dynamic, ?inplace:Dynamic):Void;
	/**
