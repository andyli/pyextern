...
@:pythonImport("torch.nn._functions.thnn.upsampling", "_UpsamplingBase") extern class _UpsamplingBase {
	...
	**/
	@:native("__init__")
	public function ___init__(?size:Dynamic, ?scale_factor:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(?size:Dynamic, ?scale_factor:Dynamic):Void;
	/**
