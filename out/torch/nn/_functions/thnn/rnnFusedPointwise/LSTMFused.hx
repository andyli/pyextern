...
@:pythonImport("torch.nn._functions.thnn.rnnFusedPointwise", "LSTMFused") extern class LSTMFused {
	...
	**/
	public function backward(?gradOutput:python.VarArgs<Dynamic>):Dynamic;
	...
	**/
	public function forward(input_gate:Dynamic, hidden_gate:Dynamic, cx:Dynamic, ?ibias:Dynamic, ?hbias:Dynamic):Dynamic;
	/**
