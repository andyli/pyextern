...
package torch.nn._functions.thnn.rnnFusedPointwise;
@:pythonImport("torch.nn._functions.thnn.rnnFusedPointwise", "LSTMFused") extern class LSTMFused {
	...
	**/
	...
	/**
		...
		output.
	**/
	static public function backward(ctx:Dynamic, ?gradOutput:python.VarArgs<Dynamic>):Dynamic;
	...
	**/
	static public function forward(ctx:Dynamic, input_gate:Dynamic, hidden_gate:Dynamic, cx:Dynamic, ?ibias:Dynamic, ?hbias:Dynamic):Dynamic;
