...
@:pythonImport("torch.nn._functions.thnn.rnnFusedPointwise", "GRUFused") extern class GRUFused {
	...
	**/
	public function backward(gradOutput:Dynamic):Dynamic;
	...
	**/
	public function forward(input_gate:Dynamic, hidden_gate:Dynamic, hx:Dynamic, ?ibias:Dynamic, ?hbias:Dynamic):Dynamic;
	/**
