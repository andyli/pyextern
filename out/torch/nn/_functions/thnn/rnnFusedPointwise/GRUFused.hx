...
@:pythonImport("torch.nn._functions.thnn.rnnFusedPointwise", "GRUFused") extern class GRUFused {
	...
	**/
	...
	/**
		...
		output.
	**/
	static public function backward(ctx:Dynamic, gradOutput:Dynamic):Dynamic;
	...
	**/
	static public function forward(ctx:Dynamic, input_gate:Dynamic, hidden_gate:Dynamic, hx:Dynamic, ?ibias:Dynamic, ?hbias:Dynamic):Dynamic;
