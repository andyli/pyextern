...
package torch.nn._functions.packing;
@:pythonImport("torch.nn._functions.packing", "PackPadded") extern class PackPadded {
	...
	**/
	...
	/**
		...
		output.
	**/
	static public function backward(ctx:Dynamic, grad_steps:Dynamic, grad_batch_sizes:Dynamic):Dynamic;
	...
	**/
	static public function forward(ctx:Dynamic, input:Dynamic, lengths:Dynamic, batch_first:Dynamic):Dynamic;
