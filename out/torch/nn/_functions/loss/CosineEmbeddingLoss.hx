...
package torch.nn._functions.loss;
@:pythonImport("torch.nn._functions.loss", "CosineEmbeddingLoss") extern class CosineEmbeddingLoss {
	...
	**/
	@:native("__init__")
	public function ___init__(?margin:Dynamic, ?size_average:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(?margin:Dynamic, ?size_average:Dynamic):Void;
	/**
	...
	**/
	public function forward(input1:Dynamic, input2:Dynamic, y:Dynamic):Dynamic;
	/**
