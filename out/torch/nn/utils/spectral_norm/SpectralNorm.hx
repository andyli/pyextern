...
@:pythonImport("torch.nn.utils.spectral_norm", "SpectralNorm") extern class SpectralNorm {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(?name:Dynamic, ?n_power_iterations:Dynamic, ?dim:Dynamic, ?eps:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(?name:Dynamic, ?n_power_iterations:Dynamic, ?dim:Dynamic, ?eps:Dynamic):Void;
	/**
