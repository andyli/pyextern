...
package torch.nn.parallel.deprecated.distributed;
@:pythonImport("torch.nn.parallel.deprecated.distributed", "DistributedDataParallel") extern class DistributedDataParallel {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(module:Dynamic, ?device_ids:Dynamic, ?output_device:Dynamic, ?dim:Dynamic, ?broadcast_buffers:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(module:Dynamic, ?device_ids:Dynamic, ?output_device:Dynamic, ?dim:Dynamic, ?broadcast_buffers:Dynamic):Void;
	/**
	...
	**/
	public function _dist_broadcast_coalesced(tensors:Dynamic, buffer_size:Dynamic):Dynamic;
	...
	**/
	...
	public function _make_param_hook(param:Dynamic, device_idx:Dynamic):Dynamic;
	/**
	...
	**/
	...
	public function _queue_reduction(bucket_idx:Dynamic):Dynamic;
	static public function _reduction_thread_fn(queue:Dynamic, group_id:Dynamic, device_ids:Dynamic, reduction_streams:Dynamic, nccl_streams:Dynamic):Dynamic;
	public function _register_grad_hooks():Dynamic;
	/**
	...
	**/
	public function _register_nccl_grad_hook():Dynamic;
	/**
	...
	**/
	...
	public function _start_reduction_threads():Dynamic;
