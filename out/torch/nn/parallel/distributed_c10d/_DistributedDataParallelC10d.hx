...
@:pythonImport("torch.nn.parallel.distributed_c10d", "_DistributedDataParallelC10d") extern class _DistributedDataParallelC10d {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(module:Dynamic, process_group:Dynamic, ?device_ids:Dynamic, ?output_device:Dynamic, ?dim:Dynamic, ?broadcast_buffers:Dynamic, ?bucket_cap_mb:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(module:Dynamic, process_group:Dynamic, ?device_ids:Dynamic, ?output_device:Dynamic, ?dim:Dynamic, ?broadcast_buffers:Dynamic, ?bucket_cap_mb:Dynamic):Void;
	/**
