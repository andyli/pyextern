...
@:pythonImport("torch.nn.parallel._functions", "Scatter") extern class Scatter {
	...
	**/
	@:native("__init__")
	public function ___init__(target_gpus:Dynamic, ?chunk_sizes:Dynamic, ?dim:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(target_gpus:Dynamic, ?chunk_sizes:Dynamic, ?dim:Dynamic):Void;
	/**
