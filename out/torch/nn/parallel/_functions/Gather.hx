...
@:pythonImport("torch.nn.parallel._functions", "Gather") extern class Gather {
	...
	**/
	@:native("__init__")
	public function ___init__(target_device:Dynamic, ?dim:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(target_device:Dynamic, ?dim:Dynamic):Void;
	/**
