...
@:pythonImport("torch.nn.parallel._functions", "ReduceAddCoalesced") extern class ReduceAddCoalesced {
	...
	**/
	static public function forward(ctx:Dynamic, destination:Dynamic, num_inputs:Dynamic, ?grads:python.VarArgs<Dynamic>):Dynamic;
