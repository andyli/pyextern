...
@:pythonImport("torch.nn.parallel._functions", "Broadcast") extern class Broadcast {
	...
	**/
	@:native("__init__")
	public function ___init__(target_gpus:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(target_gpus:Dynamic):Void;
	/**
	...
	**/
	public function backward(?grad_outputs:python.VarArgs<Dynamic>):Dynamic;
