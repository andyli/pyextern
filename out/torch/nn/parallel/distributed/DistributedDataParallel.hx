...
@:pythonImport("torch.nn.parallel.distributed", "DistributedDataParallel") extern class DistributedDataParallel {
	...
	**/
	@:native("__init__")
	public function ___init__(module:Dynamic, ?device_ids:Dynamic, ?output_device:Dynamic, ?dim:Dynamic, ?broadcast_buffers:Dynamic, ?process_group:Dynamic, ?bucket_cap_mb:Dynamic, ?check_reduction:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(module:Dynamic, ?device_ids:Dynamic, ?output_device:Dynamic, ?dim:Dynamic, ?broadcast_buffers:Dynamic, ?process_group:Dynamic, ?bucket_cap_mb:Dynamic, ?check_reduction:Dynamic):Void;
	/**
	...
	**/
	...
	public function _check_previous_reduction():Dynamic;
	/**
	...
	**/
	public function _ddp_init_helper():Dynamic;
	...
	**/
	...
	public function _sync_reduction_works():Dynamic;
