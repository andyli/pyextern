...
@:pythonImport("torch.nn.modules.instancenorm", "InstanceNorm3d") extern class InstanceNorm3d {
	...
	**/
	@:native("__init__")
	public function ___init__(num_features:Dynamic, ?eps:Dynamic, ?momentum:Dynamic, ?affine:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(num_features:Dynamic, ?eps:Dynamic, ?momentum:Dynamic, ?affine:Dynamic):Void;
	/**
