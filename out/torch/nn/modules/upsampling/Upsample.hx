...
@:pythonImport("torch.nn.modules.upsampling", "Upsample") extern class Upsample {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(?size:Dynamic, ?scale_factor:Dynamic, ?mode:Dynamic, ?align_corners:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(?size:Dynamic, ?scale_factor:Dynamic, ?mode:Dynamic, ?align_corners:Dynamic):Void;
	/**
