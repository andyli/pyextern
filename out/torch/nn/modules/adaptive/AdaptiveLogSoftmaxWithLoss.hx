...
@:pythonImport("torch.nn.modules.adaptive", "AdaptiveLogSoftmaxWithLoss") extern class AdaptiveLogSoftmaxWithLoss {
	...
	**/
	@:native("__init__")
	public function ___init__(in_features:Dynamic, n_classes:Dynamic, cutoffs:Dynamic, ?div_value:Dynamic, ?head_bias:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(in_features:Dynamic, n_classes:Dynamic, cutoffs:Dynamic, ?div_value:Dynamic, ?head_bias:Dynamic):Void;
	/**
