...
@:pythonImport("torch.nn.modules.pixelshuffle", "PixelShuffle") extern class PixelShuffle {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(upscale_factor:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(upscale_factor:Dynamic):Void;
	/**
