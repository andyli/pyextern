...
@:pythonImport("torch.nn.modules.fold", "Unfold") extern class Unfold {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(kernel_size:Dynamic, ?dilation:Dynamic, ?padding:Dynamic, ?stride:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(kernel_size:Dynamic, ?dilation:Dynamic, ?padding:Dynamic, ?stride:Dynamic):Void;
	/**
