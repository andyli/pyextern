...
@:pythonImport("torch.nn.modules.linear", "Bilinear") extern class Bilinear {
	...
	**/
	@:native("__init__")
	public function ___init__(in1_features:Dynamic, in2_features:Dynamic, out_features:Dynamic, ?bias:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(in1_features:Dynamic, in2_features:Dynamic, out_features:Dynamic, ?bias:Dynamic):Void;
	/**
