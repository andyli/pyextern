...
@:pythonImport("torch.nn.modules.linear", "Linear") extern class Linear {
	...
	**/
	@:native("__init__")
	public function ___init__(in_features:Dynamic, out_features:Dynamic, ?bias:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(in_features:Dynamic, out_features:Dynamic, ?bias:Dynamic):Void;
	/**
