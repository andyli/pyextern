...
@:pythonImport("torch.nn.modules.normalization", "GroupNorm") extern class GroupNorm {
	...
	**/
	@:native("__init__")
	public function ___init__(num_groups:Dynamic, num_channels:Dynamic, ?eps:Dynamic, ?affine:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(num_groups:Dynamic, num_channels:Dynamic, ?eps:Dynamic, ?affine:Dynamic):Void;
	/**
