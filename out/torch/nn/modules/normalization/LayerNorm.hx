...
@:pythonImport("torch.nn.modules.normalization", "LayerNorm") extern class LayerNorm {
	...
	**/
	@:native("__init__")
	public function ___init__(normalized_shape:Dynamic, ?eps:Dynamic, ?elementwise_affine:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(normalized_shape:Dynamic, ?eps:Dynamic, ?elementwise_affine:Dynamic):Void;
	/**
