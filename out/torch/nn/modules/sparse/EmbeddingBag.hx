...
@:pythonImport("torch.nn.modules.sparse", "EmbeddingBag") extern class EmbeddingBag {
	...
	**/
	@:native("__init__")
	public function ___init__(num_embeddings:Dynamic, embedding_dim:Dynamic, ?max_norm:Dynamic, ?norm_type:Dynamic, ?scale_grad_by_freq:Dynamic, ?mode:Dynamic, ?sparse:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(num_embeddings:Dynamic, embedding_dim:Dynamic, ?max_norm:Dynamic, ?norm_type:Dynamic, ?scale_grad_by_freq:Dynamic, ?mode:Dynamic, ?sparse:Dynamic):Void;
	/**
	...
	**/
	public function forward(input:Dynamic, ?offsets:Dynamic):Dynamic;
	/**
