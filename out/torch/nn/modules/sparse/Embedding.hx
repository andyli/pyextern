...
@:pythonImport("torch.nn.modules.sparse", "Embedding") extern class Embedding {
	...
	**/
	@:native("__init__")
	public function ___init__(num_embeddings:Dynamic, embedding_dim:Dynamic, ?padding_idx:Dynamic, ?max_norm:Dynamic, ?norm_type:Dynamic, ?scale_grad_by_freq:Dynamic, ?sparse:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(num_embeddings:Dynamic, embedding_dim:Dynamic, ?padding_idx:Dynamic, ?max_norm:Dynamic, ?norm_type:Dynamic, ?scale_grad_by_freq:Dynamic, ?sparse:Dynamic):Void;
	/**
