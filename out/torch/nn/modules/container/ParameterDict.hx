...
@:pythonImport("torch.nn.modules.container", "ParameterDict") extern class ParameterDict {
	/**
	...
	**/
	...
	public function __setitem__(key:Dynamic, parameter:Dynamic):Dynamic;
	...
	**/
	public function pop(key:Dynamic):Dynamic;
	/**
	...
	**/
	...
	/**
		Update the ParameterDict with the key/value pairs from a mapping or
	...
	**/
	public function update(parameters:Dynamic):Dynamic;
	/**
