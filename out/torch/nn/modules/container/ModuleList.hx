...
@:pythonImport("torch.nn.modules.container", "ModuleList") extern class ModuleList {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(?modules:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(?modules:Dynamic):Void;
	/**
