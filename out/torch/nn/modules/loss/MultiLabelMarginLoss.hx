...
@:pythonImport("torch.nn.modules.loss", "MultiLabelMarginLoss") extern class MultiLabelMarginLoss {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(?size_average:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(?size_average:Dynamic):Void;
	/**
