...
@:pythonImport("torch.nn.modules.loss", "_WeightedLoss") extern class _WeightedLoss {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(?weight:Dynamic, ?size_average:Dynamic, ?reduce:Dynamic, ?reduction:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(?weight:Dynamic, ?size_average:Dynamic, ?reduce:Dynamic, ?reduction:Dynamic):Void;
	/**
