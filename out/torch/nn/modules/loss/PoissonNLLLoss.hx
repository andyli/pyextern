...
@:pythonImport("torch.nn.modules.loss", "PoissonNLLLoss") extern class PoissonNLLLoss {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(?log_input:Dynamic, ?full:Dynamic, ?size_average:Dynamic, ?eps:Dynamic, ?reduce:Dynamic, ?reduction:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(?log_input:Dynamic, ?full:Dynamic, ?size_average:Dynamic, ?eps:Dynamic, ?reduce:Dynamic, ?reduction:Dynamic):Void;
	/**
	...
	**/
	public function forward(log_input:Dynamic, target:Dynamic):Dynamic;
	/**
