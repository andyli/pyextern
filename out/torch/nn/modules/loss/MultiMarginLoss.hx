...
@:pythonImport("torch.nn.modules.loss", "MultiMarginLoss") extern class MultiMarginLoss {
	...
	**/
	@:native("__init__")
	public function ___init__(?p:Dynamic, ?margin:Dynamic, ?weight:Dynamic, ?size_average:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(?p:Dynamic, ?margin:Dynamic, ?weight:Dynamic, ?size_average:Dynamic):Void;
	/**
