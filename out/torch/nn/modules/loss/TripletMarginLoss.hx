...
@:pythonImport("torch.nn.modules.loss", "TripletMarginLoss") extern class TripletMarginLoss {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(?margin:Dynamic, ?p:Dynamic, ?eps:Dynamic, ?swap:Dynamic, ?size_average:Dynamic, ?reduce:Dynamic, ?reduction:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(?margin:Dynamic, ?p:Dynamic, ?eps:Dynamic, ?swap:Dynamic, ?size_average:Dynamic, ?reduce:Dynamic, ?reduction:Dynamic):Void;
	/**
	...
	**/
	public function forward(anchor:Dynamic, positive:Dynamic, negative:Dynamic):Dynamic;
	/**
