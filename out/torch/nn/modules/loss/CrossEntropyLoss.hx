...
@:pythonImport("torch.nn.modules.loss", "CrossEntropyLoss") extern class CrossEntropyLoss {
	...
	**/
	@:native("__init__")
	public function ___init__(?weight:Dynamic, ?size_average:Dynamic, ?ignore_index:Dynamic, ?reduce:Dynamic, ?reduction:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(?weight:Dynamic, ?size_average:Dynamic, ?ignore_index:Dynamic, ?reduce:Dynamic, ?reduction:Dynamic):Void;
	/**
