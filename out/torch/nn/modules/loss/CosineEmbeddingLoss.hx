...
@:pythonImport("torch.nn.modules.loss", "CosineEmbeddingLoss") extern class CosineEmbeddingLoss {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(?margin:Dynamic, ?size_average:Dynamic, ?reduce:Dynamic, ?reduction:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(?margin:Dynamic, ?size_average:Dynamic, ?reduce:Dynamic, ?reduction:Dynamic):Void;
	/**
	...
	**/
	public function forward(input1:Dynamic, input2:Dynamic, target:Dynamic):Dynamic;
	/**
