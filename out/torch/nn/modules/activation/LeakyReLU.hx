...
@:pythonImport("torch.nn.modules.activation", "LeakyReLU") extern class LeakyReLU {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(?negative_slope:Dynamic, ?inplace:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(?negative_slope:Dynamic, ?inplace:Dynamic):Void;
	/**
