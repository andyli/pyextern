...
@:pythonImport("torch.nn.modules.rnn", "LSTMCell") extern class LSTMCell {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(input_size:Dynamic, hidden_size:Dynamic, ?bias:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(input_size:Dynamic, hidden_size:Dynamic, ?bias:Dynamic):Void;
	/**
