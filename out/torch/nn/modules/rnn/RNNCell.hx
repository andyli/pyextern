...
@:pythonImport("torch.nn.modules.rnn", "RNNCell") extern class RNNCell {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(input_size:Dynamic, hidden_size:Dynamic, ?bias:Dynamic, ?nonlinearity:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(input_size:Dynamic, hidden_size:Dynamic, ?bias:Dynamic, ?nonlinearity:Dynamic):Void;
	/**
