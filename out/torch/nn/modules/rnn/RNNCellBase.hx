...
@:pythonImport("torch.nn.modules.rnn", "RNNCellBase") extern class RNNCellBase {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(input_size:Dynamic, hidden_size:Dynamic, bias:Dynamic, num_chunks:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(input_size:Dynamic, hidden_size:Dynamic, bias:Dynamic, num_chunks:Dynamic):Void;
	/**
