...
@:pythonImport("torch.nn.modules.rnn", "RNNBase") extern class RNNBase {
	...
	**/
	@:native("__init__")
	public function ___init__(mode:Dynamic, input_size:Dynamic, hidden_size:Dynamic, ?num_layers:Dynamic, ?bias:Dynamic, ?batch_first:Dynamic, ?dropout:Dynamic, ?bidirectional:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(mode:Dynamic, input_size:Dynamic, hidden_size:Dynamic, ?num_layers:Dynamic, ?bias:Dynamic, ?batch_first:Dynamic, ?dropout:Dynamic, ?bidirectional:Dynamic):Void;
	/**
	...
	**/
	...
	public var _flat_weights : Dynamic;
