...
@:pythonImport("torch.nn.modules.pooling", "MaxUnpool1d") extern class MaxUnpool1d {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(kernel_size:Dynamic, ?stride:Dynamic, ?padding:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(kernel_size:Dynamic, ?stride:Dynamic, ?padding:Dynamic):Void;
	/**
	...
	**/
	public function forward(input:Dynamic, indices:Dynamic, ?output_size:Dynamic):Dynamic;
	/**
