...
@:pythonImport("torch.nn.modules.padding", "ReplicationPad2d") extern class ReplicationPad2d {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(padding:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(padding:Dynamic):Void;
	/**
