...
@:pythonImport("torch.nn.modules.padding", "ConstantPad1d") extern class ConstantPad1d {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(padding:Dynamic, value:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(padding:Dynamic, value:Dynamic):Void;
	/**
