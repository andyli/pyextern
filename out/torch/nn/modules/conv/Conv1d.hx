...
@:pythonImport("torch.nn.modules.conv", "Conv1d") extern class Conv1d {
	...
	**/
	@:native("__init__")
	public function ___init__(in_channels:Dynamic, out_channels:Dynamic, kernel_size:Dynamic, ?stride:Dynamic, ?padding:Dynamic, ?dilation:Dynamic, ?groups:Dynamic, ?bias:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(in_channels:Dynamic, out_channels:Dynamic, kernel_size:Dynamic, ?stride:Dynamic, ?padding:Dynamic, ?dilation:Dynamic, ?groups:Dynamic, ?bias:Dynamic):Void;
	/**
