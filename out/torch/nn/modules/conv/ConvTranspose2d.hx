...
@:pythonImport("torch.nn.modules.conv", "ConvTranspose2d") extern class ConvTranspose2d {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(in_channels:Dynamic, out_channels:Dynamic, kernel_size:Dynamic, ?stride:Dynamic, ?padding:Dynamic, ?output_padding:Dynamic, ?groups:Dynamic, ?bias:Dynamic, ?dilation:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(in_channels:Dynamic, out_channels:Dynamic, kernel_size:Dynamic, ?stride:Dynamic, ?padding:Dynamic, ?output_padding:Dynamic, ?groups:Dynamic, ?bias:Dynamic, ?dilation:Dynamic):Void;
	/**
