...
@:pythonImport("keras.engine.input_layer", "InputLayer") extern class InputLayer {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(?input_shape:Dynamic, ?batch_size:Dynamic, ?batch_input_shape:Dynamic, ?dtype:Dynamic, ?input_tensor:Dynamic, ?sparse:Dynamic, ?name:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(?input_shape:Dynamic, ?batch_size:Dynamic, ?batch_input_shape:Dynamic, ?dtype:Dynamic, ?input_tensor:Dynamic, ?sparse:Dynamic, ?name:Dynamic):Void;
	/**
