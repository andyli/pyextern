...
@:pythonImport("keras.layers.recurrent", "Recurrent") extern class Recurrent {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(?return_sequences:Dynamic, ?return_state:Dynamic, ?go_backwards:Dynamic, ?stateful:Dynamic, ?unroll:Dynamic, ?implementation:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(?return_sequences:Dynamic, ?return_state:Dynamic, ?go_backwards:Dynamic, ?stateful:Dynamic, ?unroll:Dynamic, ?implementation:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Void;
	/**
