...
package keras.layers.pooling;
@:pythonImport("keras.layers.pooling", "AveragePooling1D") extern class AveragePooling1D {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(?pool_size:Dynamic, ?strides:Dynamic, ?padding:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(?pool_size:Dynamic, ?strides:Dynamic, ?padding:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Void;
	/**
	...
	**/
	...
	public function _pooling_function(inputs:Dynamic, pool_size:Dynamic, strides:Dynamic, padding:Dynamic, data_format:Dynamic):Dynamic;
	/**
