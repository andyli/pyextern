...
@:pythonImport("keras.preprocessing.image") extern class Image_Module {
	...
	/**
		...
		# Returns
		    ...
		    the directory.
	**/
	static public function _count_valid_files_in_directory(directory:Dynamic, white_list_formats:Dynamic, follow_links:Dynamic):Dynamic;
	/**
	...
	**/
	static public function _list_valid_filenames_in_directory(directory:Dynamic, white_list_formats:Dynamic, class_indices:Dynamic, follow_links:Dynamic):Dynamic;
	...
	**/
	...
	static public function list_pictures(directory:Dynamic, ?ext:Dynamic):Dynamic;
	/**
	...
	**/
	...
	static public var pil_image : Dynamic;
	...
	**/
	...
	static public function transform_matrix_offset_center(matrix:Dynamic, x:Dynamic, y:Dynamic):Dynamic;
}