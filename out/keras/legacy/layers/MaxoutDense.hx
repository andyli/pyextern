...
@:pythonImport("keras.legacy.layers", "MaxoutDense") extern class MaxoutDense {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(output_dim:Dynamic, ?nb_feature:Dynamic, ?init:Dynamic, ?weights:Dynamic, ?W_regularizer:Dynamic, ?b_regularizer:Dynamic, ?activity_regularizer:Dynamic, ?W_constraint:Dynamic, ?b_constraint:Dynamic, ?bias:Dynamic, ?input_dim:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(output_dim:Dynamic, ?nb_feature:Dynamic, ?init:Dynamic, ?weights:Dynamic, ?W_regularizer:Dynamic, ?b_regularizer:Dynamic, ?activity_regularizer:Dynamic, ?W_constraint:Dynamic, ?b_constraint:Dynamic, ?bias:Dynamic, ?input_dim:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Void;
	/**
	...
	**/
	public function call(x:Dynamic):Dynamic;
	/**
