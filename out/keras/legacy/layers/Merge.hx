...
@:pythonImport("keras.legacy.layers", "Merge") extern class Merge {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(?layers:Dynamic, ?mode:Dynamic, ?concat_axis:Dynamic, ?dot_axes:Dynamic, ?output_shape:Dynamic, ?output_mask:Dynamic, ?arguments:Dynamic, ?node_indices:Dynamic, ?tensor_indices:Dynamic, ?name:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(?layers:Dynamic, ?mode:Dynamic, ?concat_axis:Dynamic, ?dot_axes:Dynamic, ?output_shape:Dynamic, ?output_mask:Dynamic, ?arguments:Dynamic, ?node_indices:Dynamic, ?tensor_indices:Dynamic, ?name:Dynamic):Void;
	/**
	...
	**/
	...
	/**
		...
		as appropriate.
	**/
	public function _arguments_validation(layers:Dynamic, mode:Dynamic, concat_axis:Dynamic, dot_axes:Dynamic, node_indices:Dynamic, tensor_indices:Dynamic):Dynamic;
	/**
