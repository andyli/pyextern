...
@:pythonImport("keras.legacy.layers", "Highway") extern class Highway {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(?init:Dynamic, ?activation:Dynamic, ?weights:Dynamic, ?W_regularizer:Dynamic, ?b_regularizer:Dynamic, ?activity_regularizer:Dynamic, ?W_constraint:Dynamic, ?b_constraint:Dynamic, ?bias:Dynamic, ?input_dim:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(?init:Dynamic, ?activation:Dynamic, ?weights:Dynamic, ?W_regularizer:Dynamic, ?b_regularizer:Dynamic, ?activity_regularizer:Dynamic, ?W_constraint:Dynamic, ?b_constraint:Dynamic, ?bias:Dynamic, ?input_dim:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Void;
	/**
