...
@:pythonImport("seaborn.tests.test_categorical", "TestFactorPlot") extern class TestFactorPlot {
	...
	**/
	...
	public function test_bad_plot_kind_error():Dynamic;
	public function test_facet_organization():Dynamic;
	public function test_plot_colors():Dynamic;
	public function test_plot_elements():Dynamic;
