...
@:pythonImport("seaborn.categorical", "_StripPlotter") extern class _StripPlotter {
	...
	**/
	public function __init__(x:Dynamic, y:Dynamic, hue:Dynamic, data:Dynamic, order:Dynamic, hue_order:Dynamic, jitter:Dynamic, split:Dynamic, orient:Dynamic, color:Dynamic, palette:Dynamic):Dynamic;
	/**
		Return self<=value.
	**/
	...
	**/
	public function draw_stripplot(ax:Dynamic, kws:Dynamic):Dynamic;
	/**
