...
@:pythonImport("seaborn.categorical", "_LVPlotter") extern class _LVPlotter {
	...
	**/
	...
	/**
		...
		letter-value plot.
	**/
	public function _lv_box_ends(vals:Dynamic, ?k_depth:Dynamic, ?outlier_prop:Dynamic):Dynamic;
	/**
		Find the outliers based on the letter value depth.
	**/
	public function _lv_outliers(vals:Dynamic, k:Dynamic):Dynamic;
	public function _lvplot(box_data:Dynamic, positions:Dynamic, ?color:Dynamic, ?vert:Dynamic, ?widths:Dynamic, ?k_depth:Dynamic, ?ax:Dynamic, ?outlier_prop:Dynamic, ?scale:Dynamic, ?kws:python.KwArgs<Dynamic>):Dynamic;
