...
@:pythonImport("seaborn.categorical", "_ViolinPlotter") extern class _ViolinPlotter {
	...
	**/
	@:native("__init__")
	public function ___init__(x:Dynamic, y:Dynamic, hue:Dynamic, data:Dynamic, order:Dynamic, hue_order:Dynamic, bw:Dynamic, cut:Dynamic, scale:Dynamic, scale_hue:Dynamic, gridsize:Dynamic, width:Dynamic, inner:Dynamic, split:Dynamic, dodge:Dynamic, orient:Dynamic, linewidth:Dynamic, color:Dynamic, palette:Dynamic, saturation:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(x:Dynamic, y:Dynamic, hue:Dynamic, data:Dynamic, order:Dynamic, hue_order:Dynamic, bw:Dynamic, cut:Dynamic, scale:Dynamic, scale_hue:Dynamic, gridsize:Dynamic, width:Dynamic, inner:Dynamic, split:Dynamic, dodge:Dynamic, orient:Dynamic, linewidth:Dynamic, color:Dynamic, palette:Dynamic, saturation:Dynamic):Void;
	/**
