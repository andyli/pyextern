...
@:pythonImport("numpy.testing.noseclasses", "NumpyDocTestCase") extern class NumpyDocTestCase {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(test:Dynamic, ?optionflags:Dynamic, ?setUp:Dynamic, ?tearDown:Dynamic, ?checker:Dynamic, ?obj:Dynamic, ?result_var:Dynamic):Dynamic;
	/**
		Return self<=value.
	**/
	...
	**/
	...
	public function _displayhook(value:Dynamic):Dynamic;
	...
	**/
	...
	public function format_failure(err:Dynamic):Dynamic;
	...
	public function runTest():Dynamic;
	/**
