...
package numpy;
@:native("numpy.generic") extern class Generic {
	private function __array__():Void;
	private var __array_interface__ : Dynamic;
	private var __array_priority__ : Dynamic;
	private var __array_struct__ : Dynamic;
	private function __array_wrap__():Void;
