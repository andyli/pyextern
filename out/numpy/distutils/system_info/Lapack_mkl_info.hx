...
@:pythonImport("numpy.distutils.system_info", "lapack_mkl_info") extern class Lapack_mkl_info {
	...
	**/
	...
	static public var _lib_mkl : Dynamic;
	/**
	...
	**/
	...
	public function get_mkl_rootdir():Dynamic;
