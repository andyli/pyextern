...
@:pythonImport("numpy.distutils.system_info", "openblas_lapack_info") extern class Openblas_lapack_info {
	...
	**/
	...
	public function check_embedded_lapack(info:Dynamic):Dynamic;
	/**
