...
@:pythonImport("numpy.distutils.system_info", "lapack_atlas_3_10_threads_info") extern class Lapack_atlas_3_10_threads_info {
	...
	**/
	...
	static public var _lib_atlas : Dynamic;
	static public var _lib_lapack : Dynamic;
	public function _lib_list(lib_dir:Dynamic, libs:Dynamic, exts:Dynamic):Dynamic;
	static public var _lib_names : Dynamic;
	/**
