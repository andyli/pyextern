...
package numpy.distutils.command.build_ext;
@:pythonImport("numpy.distutils.command.build_ext", "build_ext") extern class Build_ext {
	...
	**/
	...
	public function _add_dummy_mingwex_sym(c_sources:Dynamic):Dynamic;
	...
	public function _libs_with_msvc_and_fortran(fcompiler:Dynamic, c_libraries:Dynamic, c_library_dirs:Dynamic):Dynamic;
	/**
	...
	**/
	public function swig_sources(sources:Dynamic):Dynamic;
