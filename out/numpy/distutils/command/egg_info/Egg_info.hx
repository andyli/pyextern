...
package numpy.distutils.command.egg_info;
@:pythonImport("numpy.distutils.command.egg_info", "egg_info") extern class Egg_info {
	...
	**/
	...
	public function check_broken_egg_info():Dynamic;
	...
	**/
	public function delete_file(filename:Dynamic):Dynamic;
	...
	**/
	public function find_sources():Dynamic;
	...
	**/
	...
	static public function get_svn_revision():Dynamic;
	/**
	...
	**/
	...
	public function save_version_info(filename:Dynamic):Dynamic;
	/**
	...
	**/
	...
	public function tagged_version():Dynamic;
	...
	/**
		...
		to the file.
	**/
	public function write_file(what:Dynamic, filename:Dynamic, data:Dynamic):Dynamic;
	/**
	...
	**/
	public function write_or_delete_file(what:Dynamic, filename:Dynamic, data:Dynamic, ?force:Dynamic):Dynamic;
}