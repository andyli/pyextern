...
package numpy.distutils.command.bdist_rpm;
@:pythonImport("numpy.distutils.command.bdist_rpm", "bdist_rpm") extern class Bdist_rpm {
	...
	**/
	...
	public function _dist_path(path:Dynamic):Dynamic;
	...
	**/
	public function _format_changelog(changelog:Dynamic):Dynamic;
	/**
		Generate the text of an RPM spec file and return it as a
		list of strings (one per line).
	**/
	public function _make_spec_file():Dynamic;
	/**
	...
	**/
	...
	public function finalize_package_data():Dynamic;
