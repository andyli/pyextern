...
package numpy.distutils.command.build_clib;
@:pythonImport("numpy.distutils.command.build_clib", "build_clib") extern class Build_clib {
	...
	**/
	...
	public function build_a_library(build_info:Dynamic, lib_name:Dynamic, libraries:Dynamic):Dynamic;
	public function build_libraries(libraries:Dynamic):Dynamic;
	/**
	...
	**/
	public function check_library_list(libraries:Dynamic):Dynamic;
	...
	**/
	...
	public function get_library_names():Dynamic;
	...
	**/
	...
	public function have_cxx_sources():Dynamic;
	public function have_f_sources():Dynamic;
