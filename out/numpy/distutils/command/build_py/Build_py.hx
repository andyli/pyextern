...
package numpy.distutils.command.build_py;
@:pythonImport("numpy.distutils.command.build_py", "build_py") extern class Build_py {
	...
	**/
	...
	public function build_module(module:Dynamic, module_file:Dynamic, _package:Dynamic):Dynamic;
	public function build_modules():Dynamic;
	/**
		Copy data files into build directory
	**/
	public function build_package_data():Dynamic;
	public function build_packages():Dynamic;
	public function byte_compile(files:Dynamic):Dynamic;
	public function check_module(module:Dynamic, module_file:Dynamic):Dynamic;
	public function check_package(_package:Dynamic, package_dir:Dynamic):Dynamic;
	...
	**/
	public function find_all_modules():Dynamic;
	/**
		Return filenames for package's data files in 'src_dir'
	**/
	public function find_data_files(_package:Dynamic, src_dir:Dynamic):Dynamic;
	/**
		...
		module.
	**/
	public function find_modules():Dynamic;
	public function find_package_modules(_package:Dynamic, package_dir:Dynamic):Dynamic;
	public function get_command_name():Dynamic;
	/**
		Generate list of '(package,src_dir,build_dir,filenames)' tuples
	**/
	public function get_data_files():Dynamic;
	/**
	...
	**/
	...
	public function get_module_outfile(build_dir:Dynamic, _package:Dynamic, module:Dynamic):Dynamic;
	public function get_outputs(?include_bytecode:Dynamic):Dynamic;
	/**
		Return the directory, relative to the top of the source
		distribution, where package 'package' should be found
		(at least according to the 'package_dir' option, if any).
	**/
	public function get_package_dir(_package:Dynamic):Dynamic;
