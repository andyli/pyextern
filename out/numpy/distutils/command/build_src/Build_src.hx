...
package numpy.distutils.command.build_src;
@:pythonImport("numpy.distutils.command.build_src", "build_src") extern class Build_src {
	...
	**/
	...
	public function _build_npy_pkg_config(info:Dynamic, gd:Dynamic):Dynamic;
	...
	**/
	...
	public function build_data_files_sources():Dynamic;
	public function build_extension(ext:Dynamic):Dynamic;
	public function build_extension_sources(ext:Dynamic):Dynamic;
	public function build_extensions():Dynamic;
	public function build_library_sources(lib_name:Dynamic, build_info:Dynamic):Dynamic;
	public function build_npy_pkg_config():Dynamic;
	public function build_py_modules_sources():Dynamic;
	public function build_sources():Dynamic;
	/**
	...
	**/
	...
	public function f2py_sources(sources:Dynamic, extension:Dynamic):Dynamic;
	public function filter_files(sources:Dynamic, ?exts:Dynamic):Dynamic;
	public function filter_h_files(sources:Dynamic):Dynamic;
	public function filter_py_files(sources:Dynamic):Dynamic;
	/**
	...
	**/
	...
	public function generate_a_pyrex_source(base:Dynamic, ext_name:Dynamic, source:Dynamic, extension:Dynamic):Dynamic;
	public function generate_sources(sources:Dynamic, extension:Dynamic):Dynamic;
	...
	**/
	...
	public function pyrex_sources(sources:Dynamic, extension:Dynamic):Dynamic;
	...
	**/
	...
	public function template_sources(sources:Dynamic, extension:Dynamic):Dynamic;
