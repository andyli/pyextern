...
package numpy.distutils.pathccompiler;
@:pythonImport("numpy.distutils.pathccompiler", "PathScaleCCompiler") extern class PathScaleCCompiler {
	...
	**/
	...
	static public var cxx_exe : Dynamic;
