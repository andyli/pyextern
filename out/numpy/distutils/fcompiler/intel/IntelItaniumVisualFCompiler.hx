...
package numpy.distutils.fcompiler.intel;
@:pythonImport("numpy.distutils.fcompiler.intel", "IntelItaniumVisualFCompiler") extern class IntelItaniumVisualFCompiler {
