...
package numpy.distutils.fcompiler.compaq;
@:pythonImport("numpy.distutils.fcompiler.compaq", "CompaqVisualFCompiler") extern class CompaqVisualFCompiler {
	...
	**/
	...
	static public var ar_exe : Dynamic;
	...
	**/
	...
	static public var fc_exe : Dynamic;
	/**
