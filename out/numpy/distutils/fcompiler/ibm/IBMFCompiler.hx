...
package numpy.distutils.fcompiler.ibm;
@:pythonImport("numpy.distutils.fcompiler.ibm", "IBMFCompiler") extern class IBMFCompiler {
	...
	**/
	...
	public function get_version(args:Dynamic, kwds:Dynamic):Dynamic;
	/**
