...
package numpy.distutils.fcompiler.sun;
@:pythonImport("numpy.distutils.fcompiler.sun", "SunFCompiler") extern class SunFCompiler {
	...
	**/
	...
	public function get_arch():Dynamic;
	/**
	...
	**/
	...
	public function get_opt():Dynamic;
