...
package numpy.distutils.fcompiler.gnu;
@:pythonImport("numpy.distutils.fcompiler.gnu", "Gnu95FCompiler") extern class Gnu95FCompiler {
	...
	**/
	public function _universal_flags(cmd:Dynamic):Dynamic;
	/**
