...
@:pythonImport("numpy.matrixlib.defmatrix", "matrix") extern class Matrix {
	/**
	...
	**/
	static public function __new__(subtype:Dynamic, data:Dynamic, ?dtype:Dynamic, ?copy:Dynamic):Dynamic;
	/**
		Return self|value.
	**/
	...
	**/
	...
	/**
		...
		orientation.
	**/
	public function _align(axis:Dynamic):Dynamic;
	/**
		A convenience function for operations that want to collapse
		to a scalar like _align, but are using keepdims=True
	**/
	public function _collapse(axis:Dynamic):Dynamic;
	/**
