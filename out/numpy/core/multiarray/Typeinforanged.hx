...
@:pythonImport("numpy.core.multiarray", "typeinforanged") extern class Typeinforanged {
	/**
		Return self+value.
	**/
	...
	**/
	...
	static public var n_fields : Dynamic;
	static public var n_sequence_fields : Dynamic;
	static public var n_unnamed_fields : Dynamic;
	/**
