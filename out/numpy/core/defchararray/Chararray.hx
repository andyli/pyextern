...
@:pythonImport("numpy.core.defchararray", "chararray") extern class Chararray {
	/**
	...
	**/
	...
	/**
		Return self[key].
	**/
	public function __getitem__(obj:Dynamic):Dynamic;
	/**
		Return (self > other) element-wise.
	...
	**/
	...
	/**
		...
		mod
	**/
	public function __mod__(i:Dynamic):Dynamic;
	...
	/**
		...
		multiply
	**/
	public function __mul__(i:Dynamic):Dynamic;
	/**
		Return (self != other) element-wise.
	...
	**/
	static public function __new__(subtype:Dynamic, shape:Dynamic, ?itemsize:Dynamic, ?unicode:Dynamic, ?buffer:Dynamic, ?offset:Dynamic, ?strides:Dynamic, ?order:Dynamic):Dynamic;
	/**
		Return self|value.
	**/
	...
	**/
	...
	/**
		...
		multiply
	**/
	public function __rmul__(i:Dynamic):Dynamic;
	/**
		Return value|self.
	**/
	...
	**/
	...
	/**
		...
		char.count
	**/
	public function count(sub:Dynamic, ?start:Dynamic, ?end:Dynamic):Dynamic;
	/**
	...
	**/
	...
	/**
		...
		char.endswith
	**/
	public function endswith(suffix:Dynamic, ?start:Dynamic, ?end:Dynamic):Dynamic;
	/**
	...
	**/
	...
	/**
		...
		char.join
	**/
	public function join(seq:Dynamic):Dynamic;
	/**
	...
	**/
	...
	/**
		...
		char.startswith
	**/
	public function startswith(prefix:Dynamic, ?start:Dynamic, ?end:Dynamic):Dynamic;
	/**
