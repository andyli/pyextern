...
@:pythonImport("numpy.core.records", "format_parser") extern class Format_parser {
	...
	**/
	public function _parseFormats(formats:Dynamic, ?aligned:Dynamic):Dynamic;
	/**
		convert input field names into a list and assign to the _names
		attribute 
	**/
	public function _setfieldnames(names:Dynamic, titles:Dynamic):Dynamic;
}