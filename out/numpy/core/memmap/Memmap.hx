...
@:pythonImport("numpy.core.memmap", "memmap") extern class Memmap {
	/**
	...
	**/
	static public function __new__(subtype:Dynamic, filename:Dynamic, ?dtype:Dynamic, ?mode:Dynamic, ?offset:Dynamic, ?shape:Dynamic, ?order:Dynamic):Dynamic;
	/**
		Return self|value.
	**/
