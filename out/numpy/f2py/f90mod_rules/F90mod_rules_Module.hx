...
package numpy.f2py.f90mod_rules;
@:pythonImport("numpy.f2py.f90mod_rules") extern class F90mod_rules_Module {
	...
	static public function buildhooks(pymod:Dynamic):Dynamic;
	static public function dictappend(rd:Dynamic, ar:Dynamic):Dynamic;
	static public var division : Dynamic;
	static public var f2py_version : Dynamic;
	static public var fgetdims1 : Dynamic;
	static public var fgetdims2 : Dynamic;
	static public var fgetdims2_sa : Dynamic;
	static public function findf90modules(m:Dynamic):Dynamic;
