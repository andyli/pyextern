...
@:pythonImport("numpy.polynomial.laguerre") extern class Laguerre_Module {
	...
	**/
	...
	static public var lagdomain : Dynamic;
	/**
	...
	**/
	static public function lagfit(x:Dynamic, y:Dynamic, deg:Dynamic, ?rcond:Dynamic, ?full:Dynamic, ?w:Dynamic):Dynamic;
	/**
	...
	**/
	...
	/**
		...
		array([[-0.5, -4. ],
		       [-4.5, -2. ]])
	**/
	static public function lagval(x:Dynamic, c:Dynamic, ?tensor:Dynamic):Dynamic;
	/**
