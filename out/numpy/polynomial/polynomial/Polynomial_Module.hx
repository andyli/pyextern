...
@:pythonImport("numpy.polynomial.polynomial") extern class Polynomial_Module {
	...
	**/
	...
	static public var polydomain : Dynamic;
	/**
	...
	**/
	static public function polyfit(x:Dynamic, y:Dynamic, deg:Dynamic, ?rcond:Dynamic, ?full:Dynamic, ?w:Dynamic):Dynamic;
	/**
	...
	**/
	...
	/**
		...
		array([ 2.,  7.])
	**/
	static public function polyval(x:Dynamic, c:Dynamic, ?tensor:Dynamic):Dynamic;
	/**
