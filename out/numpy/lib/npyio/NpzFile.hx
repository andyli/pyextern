...
@:pythonImport("numpy.lib.npyio", "NpzFile") extern class NpzFile {
	...
	**/
	public function __init__(fid:Dynamic, ?own_fid:Dynamic, ?allow_pickle:Dynamic, ?pickle_kwargs:Dynamic):Dynamic;
