...
@:pythonImport("numpy.lib.utils", "SafeEval") extern class SafeEval {
	...
	**/
	...
	public function visitNameConstant(node:Dynamic):Dynamic;
	public function visitNum(node:Dynamic):Dynamic;
	public function visitStr(node:Dynamic):Dynamic;
	public function visitTuple(node:Dynamic):Dynamic;
	public function visitUnaryOp(node:Dynamic):Dynamic;
}