...
package paho.mqtt.packettypes;
@:pythonImport("paho.mqtt.packettypes", "PacketTypes") extern class PacketTypes {
	...
	static public var WILLMESSAGE : Dynamic;
	...
	**/
	...
	static public var indexes : Dynamic;
}