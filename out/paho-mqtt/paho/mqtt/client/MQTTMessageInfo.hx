...
@:pythonImport("paho.mqtt.client", "MQTTMessageInfo") extern class MQTTMessageInfo {
	...
	**/
	@:native("__init__")
	public function ___init__(mid:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(mid:Dynamic):Void;
	/**
	...
	**/
	...
	public var _condition : Dynamic;
	public var _iterpos : Dynamic;
	public var _published : Dynamic;
	public function _set_as_published():Dynamic;
	/**
		Returns True if the message associated with this object has been
		published, else returns False.
	**/
	public function is_published():Dynamic;
	public var mid : Dynamic;
	public function next():Dynamic;
	public var rc : Dynamic;
	/**
		...
		reason.
	**/
	public function wait_for_publish(?timeout:Dynamic):Dynamic;
}