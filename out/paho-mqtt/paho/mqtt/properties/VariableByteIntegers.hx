...
@:pythonImport("paho.mqtt.properties", "VariableByteIntegers") extern class VariableByteIntegers {
	...
	**/
	static public function decode(buffer:Dynamic):Dynamic;
	/**
		Convert an integer 0 <= x <= 268435455 into multi-byte format.
		Returns the buffer convered from the integer.
	**/
	static public function encode(x:Dynamic):Dynamic;
}