...
package tensorflow.compat.v1.saved_model.signature_def_utils;
@:pythonImport("tensorflow.compat.v1.saved_model.signature_def_utils") extern class Signature_def_utils_Module {
