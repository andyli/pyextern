...
package tensorflow.compat.v1.keras.applications.inception_v3;
@:pythonImport("tensorflow.compat.v1.keras.applications.inception_v3") extern class Inception_v3_Module {
