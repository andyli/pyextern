...
@:pythonImport("tensorflow.tensorboard.plugins.projector.projector_plugin", "EmbeddingMetadata") extern class EmbeddingMetadata {
	...
	**/
	@:native("__init__")
	public function ___init__(num_points:Dynamic):Dynamic;
	/**
		Constructs a metadata for an embedding of the specified size.
		...
		Args:
		  num_points: Number of points in the embedding.
	**/
	public function new(num_points:Dynamic):Void;
	/**
	...
	**/
	public function add_column(column_name:Dynamic, column_values:Dynamic):Dynamic;
}