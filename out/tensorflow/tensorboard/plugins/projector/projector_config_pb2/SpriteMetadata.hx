...
package tensorflow.tensorboard.plugins.projector.projector_config_pb2;
@:pythonImport("tensorflow.tensorboard.plugins.projector.projector_config_pb2", "SpriteMetadata") extern class SpriteMetadata {
	/**
	...
	**/
	...
	static public var IMAGE_PATH_FIELD_NUMBER : Dynamic;
	/**
	...
	**/
	...
	static public var SINGLE_IMAGE_DIM_FIELD_NUMBER : Dynamic;
	/**
