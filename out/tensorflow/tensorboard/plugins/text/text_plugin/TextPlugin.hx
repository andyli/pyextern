...
@:pythonImport("tensorflow.tensorboard.plugins.text.text_plugin", "TextPlugin") extern class TextPlugin {
	...
	**/
	public function get_plugin_apps(multiplexer:Dynamic, unused_logdir:Dynamic):Dynamic;
	public function index_impl():Dynamic;
	/**
	...
	**/
	...
	public function runs_route(request:Dynamic):Dynamic;
	public function text_impl(run:Dynamic, tag:Dynamic):Dynamic;
	public function text_route(request:Dynamic):Dynamic;
}