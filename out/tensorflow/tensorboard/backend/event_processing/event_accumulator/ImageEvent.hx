...
@:pythonImport("tensorflow.tensorboard.backend.event_processing.event_accumulator", "ImageEvent") extern class ImageEvent {
	/**
		Return self+value.
	**/
	...
	**/
	...
	/**
		Create new instance of ImageEvent(wall_time, step, encoded_image_string, width, height)
	**/
	static public function __new__(_cls:Dynamic, wall_time:Dynamic, step:Dynamic, encoded_image_string:Dynamic, width:Dynamic, height:Dynamic):Dynamic;
	/**
		helper for pickle
	**/
	...
	**/
	...
	/**
		Make a new ImageEvent object from a sequence or iterable
	**/
	static public function _make(iterable:Dynamic, ?_new:Dynamic, ?len:Dynamic):Dynamic;
	/**
		Return a new ImageEvent object replacing specified fields with new values
	**/
	...
	**/
	public var encoded_image_string : Dynamic;
	/**
