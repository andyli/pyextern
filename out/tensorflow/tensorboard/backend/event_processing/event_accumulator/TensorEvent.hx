...
@:pythonImport("tensorflow.tensorboard.backend.event_processing.event_accumulator", "TensorEvent") extern class TensorEvent {
	/**
		Return self+value.
	**/
	...
	**/
	...
	/**
		Create new instance of TensorEvent(wall_time, step, tensor_proto)
	**/
	static public function __new__(_cls:Dynamic, wall_time:Dynamic, step:Dynamic, tensor_proto:Dynamic):Dynamic;
	/**
		helper for pickle
	**/
	...
	**/
	...
	/**
		Make a new TensorEvent object from a sequence or iterable
	**/
	static public function _make(iterable:Dynamic, ?_new:Dynamic, ?len:Dynamic):Dynamic;
	/**
		Return a new TensorEvent object replacing specified fields with new values
	**/
