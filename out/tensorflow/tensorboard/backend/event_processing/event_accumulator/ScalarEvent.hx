...
@:pythonImport("tensorflow.tensorboard.backend.event_processing.event_accumulator", "ScalarEvent") extern class ScalarEvent {
	/**
		Return self+value.
	**/
	...
	**/
	...
	/**
		Create new instance of ScalarEvent(wall_time, step, value)
	**/
	static public function __new__(_cls:Dynamic, wall_time:Dynamic, step:Dynamic, value:Dynamic):Dynamic;
	/**
		helper for pickle
	**/
	...
	**/
	...
	/**
		Make a new ScalarEvent object from a sequence or iterable
	**/
	static public function _make(iterable:Dynamic, ?_new:Dynamic, ?len:Dynamic):Dynamic;
	/**
		Return a new ScalarEvent object replacing specified fields with new values
	**/
