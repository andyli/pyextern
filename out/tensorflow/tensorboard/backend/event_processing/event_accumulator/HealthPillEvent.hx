...
@:pythonImport("tensorflow.tensorboard.backend.event_processing.event_accumulator", "HealthPillEvent") extern class HealthPillEvent {
	/**
		Return self+value.
	**/
	...
	**/
	...
	/**
		Create new instance of HealthPillEvent(wall_time, step, node_name, output_slot, value)
	**/
	static public function __new__(_cls:Dynamic, wall_time:Dynamic, step:Dynamic, node_name:Dynamic, output_slot:Dynamic, value:Dynamic):Dynamic;
	/**
		helper for pickle
	**/
	...
	**/
	...
	/**
		Make a new HealthPillEvent object from a sequence or iterable
	**/
	static public function _make(iterable:Dynamic, ?_new:Dynamic, ?len:Dynamic):Dynamic;
	/**
		Return a new HealthPillEvent object replacing specified fields with new values
	**/
