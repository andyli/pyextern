...
@:pythonImport("tensorflow.tensorboard.backend.event_processing.event_accumulator", "HistogramValue") extern class HistogramValue {
	/**
		Return self+value.
	**/
	...
	**/
	...
	/**
		Create new instance of HistogramValue(min, max, num, sum, sum_squares, bucket_limit, bucket)
	**/
	static public function __new__(_cls:Dynamic, min:Dynamic, max:Dynamic, num:Dynamic, sum:Dynamic, sum_squares:Dynamic, bucket_limit:Dynamic, bucket:Dynamic):Dynamic;
	/**
		helper for pickle
	**/
	...
	**/
	...
	/**
		Make a new HistogramValue object from a sequence or iterable
	**/
	static public function _make(iterable:Dynamic, ?_new:Dynamic, ?len:Dynamic):Dynamic;
	/**
		Return a new HistogramValue object replacing specified fields with new values
	**/
