...
@:pythonImport("tensorflow.tensorboard.backend.event_processing.event_file_inspector", "Observation") extern class Observation {
	/**
		Return self+value.
	**/
	...
	**/
	...
	/**
		Create new instance of Observation(step, wall_time, tag)
	**/
	static public function __new__(_cls:Dynamic, step:Dynamic, wall_time:Dynamic, tag:Dynamic):Dynamic;
	/**
		helper for pickle
	**/
