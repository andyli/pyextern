...
@:pythonImport("tensorflow.tools.tfprof.tfprof_output_pb2", "TFProfTensorProto") extern class TFProfTensorProto {
	/**
	...
	**/
	...
	static public var VALUE_DOUBLE_FIELD_NUMBER : Dynamic;
	static public var VALUE_INT64_FIELD_NUMBER : Dynamic;
	static public var VALUE_STR_FIELD_NUMBER : Dynamic;
	/**
