...
@:pythonImport("tensorflow.tools.tfprof.tfprof_output_pb2", "TFGraphNodeProto") extern class TFGraphNodeProto {
	/**
	...
	**/
	...
	static public var TOTAL_INPUTS_FIELD_NUMBER : Dynamic;
