...
@:pythonImport("tensorflow.tools.compatibility.ast_edits", "_FileEditRecorder") extern class _FileEditRecorder {
	...
	**/
	...
	/**
		...
		Returns:
		  None
	**/
	public function add(comment:Dynamic, line:Dynamic, start:Dynamic, old:Dynamic, _new:Dynamic, ?error:Dynamic):Dynamic;
	/**
	...
	**/
	public function process(text:Dynamic):Dynamic;
}