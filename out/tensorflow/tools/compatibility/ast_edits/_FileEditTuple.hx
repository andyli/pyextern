...
@:pythonImport("tensorflow.tools.compatibility.ast_edits", "_FileEditTuple") extern class _FileEditTuple {
	/**
		Return self+value.
	**/
	...
	**/
	...
	/**
		Create new instance of _FileEditTuple(comment, line, start, old, new)
	**/
	static public function __new__(_cls:Dynamic, comment:Dynamic, line:Dynamic, start:Dynamic, old:Dynamic, _new:Dynamic):Dynamic;
	/**
		helper for pickle
	**/
	...
	**/
	...
	/**
		Make a new _FileEditTuple object from a sequence or iterable
	**/
	static public function _make(iterable:Dynamic, ?_new:Dynamic, ?len:Dynamic):Dynamic;
	/**
		Return a new _FileEditTuple object replacing specified fields with new values
	**/
	...
	**/
	@:native("new")
	public var _new : Dynamic;
	/**
		Alias for field number 3
	**/
	public var old : Dynamic;
	/**
