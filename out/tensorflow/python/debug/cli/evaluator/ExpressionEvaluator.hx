...
@:pythonImport("tensorflow.python.debug.cli.evaluator", "ExpressionEvaluator") extern class ExpressionEvaluator {
	...
	**/
	@:native("__init__")
	public function ___init__(dump:Dynamic):Dynamic;
	/**
		Constructor of ExpressionEvaluator.
		...
		Args:
		  dump: an instance of `DebugDumpDir`.
	**/
	public function new(dump:Dynamic):Void;
	/**
	...
	**/
	public function evaluate(expression:Dynamic):Dynamic;
}