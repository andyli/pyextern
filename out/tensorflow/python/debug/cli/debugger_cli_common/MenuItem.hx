...
@:pythonImport("tensorflow.python.debug.cli.debugger_cli_common", "MenuItem") extern class MenuItem {
	...
	**/
	@:native("__init__")
	public function ___init__(caption:Dynamic, content:Dynamic, ?enabled:Dynamic):Dynamic;
	/**
		Menu constructor.
		...
		Args:
		  ...
		  enabled: (bool) whether this menu item is enabled.
	**/
	public function new(caption:Dynamic, content:Dynamic, ?enabled:Dynamic):Void;
	/**
