...
package tensorflow.python.debug.cli.readline_ui;
@:pythonImport("tensorflow.python.debug.cli.readline_ui", "ReadlineUI") extern class ReadlineUI {
	...
	**/
	...
	public function _display_output(screen_output:Dynamic):Dynamic;
	public function _get_user_command():Dynamic;
	public function _init_input():Dynamic;
	/**
