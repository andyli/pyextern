...
@:pythonImport("tensorflow.python.debug.lib.grpc_debug_server", "DebugWatch") extern class DebugWatch {
	/**
		Return self+value.
	**/
	...
	**/
	...
	/**
		Create new instance of DebugWatch(node_name, output_slot, debug_op)
	**/
	static public function __new__(_cls:Dynamic, node_name:Dynamic, output_slot:Dynamic, debug_op:Dynamic):Dynamic;
	/**
		helper for pickle
	**/
	...
	**/
	...
	/**
		Make a new DebugWatch object from a sequence or iterable
	**/
	static public function _make(iterable:Dynamic, ?_new:Dynamic, ?len:Dynamic):Dynamic;
	/**
		Return a new DebugWatch object replacing specified fields with new values
	**/
