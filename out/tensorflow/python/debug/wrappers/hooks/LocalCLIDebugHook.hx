...
@:pythonImport("tensorflow.python.debug.wrappers.hooks", "LocalCLIDebugHook") extern class LocalCLIDebugHook {
	...
	**/
	@:native("__init__")
	public function ___init__(?ui_type:Dynamic, ?dump_root:Dynamic, ?thread_name_filter:Dynamic):Dynamic;
	/**
		Create a local debugger command-line interface (CLI) hook.
		...
		Args:
		  ...
		  thread_name_filter: Regular-expression white list for threads on which the
		    ...
		    more details.
	**/
	public function new(?ui_type:Dynamic, ?dump_root:Dynamic, ?thread_name_filter:Dynamic):Void;
	/**
	...
	**/
	public function _decorate_options_for_debug(options:Dynamic, graph:Dynamic, watch_options:Dynamic):Dynamic;
	/**
