...
@:pythonImport("tensorflow.python.debug.wrappers.grpc_wrapper", "TensorBoardDebugWrapperSession") extern class TensorBoardDebugWrapperSession {
	...
	**/
	@:native("__init__")
	public function ___init__(sess:Dynamic, grpc_debug_server_addresses:Dynamic, ?thread_name_filter:Dynamic, ?send_traceback_and_source_code:Dynamic, ?log_usage:Dynamic):Dynamic;
	/**
		Constructor of TensorBoardDebugWrapperSession.
		...
		Args:
		  ...
		  log_usage: Whether the usage of this class is to be logged (if
		    applicable).
	**/
	public function new(sess:Dynamic, grpc_debug_server_addresses:Dynamic, ?thread_name_filter:Dynamic, ?send_traceback_and_source_code:Dynamic, ?log_usage:Dynamic):Void;
	/**
