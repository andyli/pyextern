...
package tensorflow.python.saved_model.signature_constants;
@:pythonImport("tensorflow.python.saved_model.signature_constants") extern class Signature_constants_Module {
	...
	static public var SUPERVISED_EVAL_METHOD_NAME : Dynamic;
	static public var SUPERVISED_TRAIN_METHOD_NAME : Dynamic;
