...
@:pythonImport("tensorflow.python.saved_model.builder_impl", "_SavedModelBuilder") extern class _SavedModelBuilder {
	...
	**/
	public function _save_and_write_assets(meta_graph_def:Dynamic, ?assets_list:Dynamic):Dynamic;
	/**
	...
	**/
	public function add_meta_graph(tags:Dynamic, ?signature_def_map:Dynamic, ?assets_list:Dynamic, ?clear_devices:Dynamic, ?init_op:Dynamic, ?train_op:Dynamic, ?saver:Dynamic):Dynamic;
	/**
	...
	**/
	public function add_meta_graph_and_variables(sess:Dynamic, tags:Dynamic, ?signature_def_map:Dynamic, ?assets_list:Dynamic, ?clear_devices:Dynamic, ?init_op:Dynamic, ?train_op:Dynamic, ?strip_default_attrs:Dynamic, ?saver:Dynamic):Dynamic;
	/**
