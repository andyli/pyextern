...
@:pythonImport("tensorflow.python.saved_model.saved_object_graph_pb2", "SavedPolymorphicFunction") extern class SavedPolymorphicFunction {
	/**
	...
	**/
	...
	/**
		Field tensorflow.SavedPolymorphicFunction.monomorphic_function
	**/
	public var monomorphic_function : Dynamic;
}