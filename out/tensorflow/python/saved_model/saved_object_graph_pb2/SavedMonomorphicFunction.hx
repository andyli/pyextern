...
@:pythonImport("tensorflow.python.saved_model.saved_object_graph_pb2", "SavedMonomorphicFunction") extern class SavedMonomorphicFunction {
	/**
	...
	**/
	...
	/**
		Field tensorflow.SavedMonomorphicFunction.concrete_function
	**/
