...
@:pythonImport("tensorflow.python.saved_model.saved_object_graph_pb2", "SavedAsset") extern class SavedAsset {
	/**
	...
	**/
	...
	/**
		Field tensorflow.SavedAsset.asset_file_def_index
	**/
	public var asset_file_def_index : Dynamic;
}