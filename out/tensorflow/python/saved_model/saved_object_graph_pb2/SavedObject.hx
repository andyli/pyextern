...
package tensorflow.python.saved_model.saved_object_graph_pb2;
@:pythonImport("tensorflow.python.saved_model.saved_object_graph_pb2", "SavedObject") extern class SavedObject {
	/**
