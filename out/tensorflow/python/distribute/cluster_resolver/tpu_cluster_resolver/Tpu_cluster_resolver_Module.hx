...
@:pythonImport("tensorflow.python.distribute.cluster_resolver.tpu_cluster_resolver") extern class Tpu_cluster_resolver_Module {
	...
	static public var _TPU_CONN_RETRIES : Dynamic;
	static public var _TPU_DEVICE_REGEX : Dynamic;
	...
	**/
	...
	static public function get_accelerator_devices(master:Dynamic, config_proto:Dynamic):Dynamic;
