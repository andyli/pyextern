...
package tensorflow.python.distribute.distribute_config;
@:pythonImport("tensorflow.python.distribute.distribute_config", "DistributeConfig") extern class DistributeConfig {
	/**
		Return self+value.
	**/
	...
	**/
	static public function __new__(cls:Dynamic, ?train_distribute:Dynamic, ?eval_distribute:Dynamic, ?remote_cluster:Dynamic):Dynamic;
	/**
		helper for pickle
	**/
	...
	**/
	...
	/**
		Make a new DistributeConfig object from a sequence or iterable
	**/
	static public function _make(iterable:Dynamic, ?_new:Dynamic, ?len:Dynamic):Dynamic;
	/**
		Return a new DistributeConfig object replacing specified fields with new values
	**/
	...
	**/
	public var remote_cluster : Dynamic;
	/**
