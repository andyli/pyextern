...
@:pythonImport("tensorflow.python.distribute.values", "InputIteratorImpl") extern class InputIteratorImpl {
	...
	**/
	@:native("__init__")
	public function ___init__(worker_device_pairs:Dynamic, iterators:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(worker_device_pairs:Dynamic, iterators:Dynamic):Void;
	/**
