...
@:pythonImport("tensorflow.python.distribute.values", "_ReplicaLocalSaveable") extern class _ReplicaLocalSaveable {
	...
	**/
	@:native("__init__")
	public function ___init__(replica_local_variable:Dynamic, name:Dynamic):Dynamic;
	/**
		Creates a `SaveableObject` object.
		...
		Args:
		  ...
		  name: the name to save the object under.
	**/
	public function new(replica_local_variable:Dynamic, name:Dynamic):Void;
	/**
