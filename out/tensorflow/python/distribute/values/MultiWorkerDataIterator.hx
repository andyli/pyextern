...
@:pythonImport("tensorflow.python.distribute.values", "MultiWorkerDataIterator") extern class MultiWorkerDataIterator {
	...
	**/
	@:native("__init__")
	public function ___init__(iterators:Dynamic, worker_device_pairs:Dynamic):Dynamic;
	/**
		Initialize the MultiWorkerDataIterator object.
		...
		Raises:
		  ValueError: if iterators and worker_device_pairs are not compatible.
	**/
	public function new(iterators:Dynamic, worker_device_pairs:Dynamic):Void;
	/**
