...
@:pythonImport("tensorflow.python.distribute.distribute_lib", "DistributionStrategy") extern class DistributionStrategy {
	...
	**/
	@:native("__init__")
	public function ___init__(extended:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(extended:Dynamic):Void;
	/**
