...
@:pythonImport("tensorflow.python.distribute.distribute_coordinator", "_Barrier") extern class _Barrier {
	...
	**/
	@:native("__init__")
	public function ___init__(num_participants:Dynamic):Dynamic;
	/**
		Initializes the barrier object.
		...
		Args:
		  num_participants: an integer which is the expected number of calls of
		    `wait` pass to through this barrier.
	**/
	public function new(num_participants:Dynamic):Void;
	/**
