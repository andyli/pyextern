...
@:pythonImport("tensorflow.python.distribute.mirrored_strategy", "MirroredReplicaContext") extern class MirroredReplicaContext {
	...
	**/
	public function _merge_call(fn:Dynamic, args:Dynamic, kwargs:Dynamic):Dynamic;
