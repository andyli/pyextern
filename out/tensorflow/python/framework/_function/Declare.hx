...
@:pythonImport("tensorflow.python.framework.function", "Declare") extern class Declare {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(func_name:Dynamic, inputs:Dynamic, outputs:Dynamic):Dynamic;
	/**
		Creates a `Declare` object.
		...
		Args:
		  ...
		  outputs: A list of (name, data type) pairs of function return values.
	**/
	public function new(func_name:Dynamic, inputs:Dynamic, outputs:Dynamic):Void;
	/**
