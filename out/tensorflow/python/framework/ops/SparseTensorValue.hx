...
@:pythonImport("tensorflow.python.framework.ops", "SparseTensorValue") extern class SparseTensorValue {
	/**
		Return self+value.
	**/
	...
	**/
	static public function __new__(_cls:Dynamic, indices:Dynamic, values:Dynamic, shape:Dynamic):Dynamic;
	/**
		helper for pickle
	**/
