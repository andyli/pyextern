...
@:pythonImport("tensorflow.python.framework.subscribe", "_ControlOutputCache") extern class _ControlOutputCache {
	...
	**/
	public function calc_control_outputs(graph:Dynamic):Dynamic;
	/**
	...
	**/
	public function get_control_outputs(op:Dynamic):Dynamic;
}