...
@:pythonImport("tensorflow.python.framework.errors_impl", "UnknownError") extern class UnknownError {
	/**
		exception cause
	**/
	...
	**/
	@:native("__init__")
	public function ___init__(node_def:Dynamic, op:Dynamic, message:Dynamic, ?error_code:Dynamic):Dynamic;
	/**
		Creates an `UnknownError`.
	**/
	public function new(node_def:Dynamic, op:Dynamic, message:Dynamic, ?error_code:Dynamic):Void;
	/**
