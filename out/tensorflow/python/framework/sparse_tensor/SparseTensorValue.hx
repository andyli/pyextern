...
@:pythonImport("tensorflow.python.framework.sparse_tensor", "SparseTensorValue") extern class SparseTensorValue {
	/**
		Return self+value.
	**/
	...
	**/
	static public function __new__(_cls:Dynamic, indices:Dynamic, values:Dynamic, dense_shape:Dynamic):Dynamic;
	/**
		helper for pickle
	**/
