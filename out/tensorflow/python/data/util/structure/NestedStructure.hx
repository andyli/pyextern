...
@:pythonImport("tensorflow.python.data.util.structure", "NestedStructure") extern class NestedStructure {
	...
	**/
	@:native("__init__")
	public function ___init__(nested_structure:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(nested_structure:Dynamic):Void;
	/**
