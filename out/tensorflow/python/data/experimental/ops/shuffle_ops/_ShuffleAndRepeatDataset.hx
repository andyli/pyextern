...
@:pythonImport("tensorflow.python.data.experimental.ops.shuffle_ops", "_ShuffleAndRepeatDataset") extern class _ShuffleAndRepeatDataset {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(input_dataset:Dynamic, buffer_size:Dynamic, ?count:Dynamic, ?seed:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(input_dataset:Dynamic, buffer_size:Dynamic, ?count:Dynamic, ?seed:Dynamic):Void;
	/**
