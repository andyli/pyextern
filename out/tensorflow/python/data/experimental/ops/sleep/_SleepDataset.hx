...
@:pythonImport("tensorflow.python.data.experimental.ops.sleep", "_SleepDataset") extern class _SleepDataset {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(input_dataset:Dynamic, sleep_microseconds:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(input_dataset:Dynamic, sleep_microseconds:Dynamic):Void;
	/**
