...
package tensorflow.python.data.experimental.ops.scan_ops;
@:pythonImport("tensorflow.python.data.experimental.ops.scan_ops", "_ScanDataset") extern class _ScanDataset {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(input_dataset:Dynamic, initial_state:Dynamic, scan_func:Dynamic):Dynamic;
	/**
		See `scan()` for details.
	**/
	public function new(input_dataset:Dynamic, initial_state:Dynamic, scan_func:Dynamic):Void;
	/**
