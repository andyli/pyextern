...
package tensorflow.python.data.experimental.ops.stats_options;
@:pythonImport("tensorflow.python.data.experimental.ops.stats_options", "StatsOptions") extern class StatsOptions {
