...
@:pythonImport("tensorflow.python.data.experimental.ops.stats_ops", "_SetStatsAggregatorDataset") extern class _SetStatsAggregatorDataset {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(input_dataset:Dynamic, stats_aggregator:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(input_dataset:Dynamic, stats_aggregator:Dynamic):Void;
	/**
