...
@:pythonImport("tensorflow.python.data.experimental.ops.stats_ops", "_StatsDataset") extern class _StatsDataset {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(input_dataset:Dynamic, op_function:Dynamic, tag:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(input_dataset:Dynamic, op_function:Dynamic, tag:Dynamic):Void;
	/**
