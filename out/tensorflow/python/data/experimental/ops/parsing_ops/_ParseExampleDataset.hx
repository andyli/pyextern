...
@:pythonImport("tensorflow.python.data.experimental.ops.parsing_ops", "_ParseExampleDataset") extern class _ParseExampleDataset {
	...
	**/
	@:native("__init__")
	public function ___init__(input_dataset:Dynamic, features:Dynamic, num_parallel_calls:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(input_dataset:Dynamic, features:Dynamic, num_parallel_calls:Dynamic):Void;
	/**
