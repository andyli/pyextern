...
@:pythonImport("tensorflow.python.data.experimental.ops.batching", "_MapAndBatchDataset") extern class _MapAndBatchDataset {
	...
	**/
	@:native("__init__")
	public function ___init__(input_dataset:Dynamic, map_func:Dynamic, batch_size:Dynamic, num_parallel_calls:Dynamic, drop_remainder:Dynamic):Dynamic;
	/**
		See `Dataset.map()` for details.
	**/
	public function new(input_dataset:Dynamic, map_func:Dynamic, batch_size:Dynamic, num_parallel_calls:Dynamic, drop_remainder:Dynamic):Void;
	/**
