...
@:pythonImport("tensorflow.python.data.experimental.ops.iterator_ops", "_Saveable") extern class _Saveable {
	...
	**/
	@:native("__init__")
	public function ___init__(iterator_resource:Dynamic):Dynamic;
	/**
		Creates a `SaveableObject` object.
		...
		Args:
		  ...
		  name: the name to save the object under.
	**/
	public function new(iterator_resource:Dynamic):Void;
	/**
