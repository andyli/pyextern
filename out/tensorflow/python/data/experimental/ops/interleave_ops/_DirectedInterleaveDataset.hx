...
@:pythonImport("tensorflow.python.data.experimental.ops.interleave_ops", "_DirectedInterleaveDataset") extern class _DirectedInterleaveDataset {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(selector_input:Dynamic, data_inputs:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(selector_input:Dynamic, data_inputs:Dynamic):Void;
	/**
