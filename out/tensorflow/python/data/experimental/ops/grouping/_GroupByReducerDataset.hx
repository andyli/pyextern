...
@:pythonImport("tensorflow.python.data.experimental.ops.grouping", "_GroupByReducerDataset") extern class _GroupByReducerDataset {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(input_dataset:Dynamic, key_func:Dynamic, reducer:Dynamic):Dynamic;
	/**
		See `group_by_reducer()` for details.
	**/
	public function new(input_dataset:Dynamic, key_func:Dynamic, reducer:Dynamic):Void;
	/**
	...
	**/
	public function _make_finalize_func(finalize_func:Dynamic):Dynamic;
	/**
		Make wrapping defun for init_func.
	**/
	public function _make_init_func(init_func:Dynamic):Dynamic;
	/**
