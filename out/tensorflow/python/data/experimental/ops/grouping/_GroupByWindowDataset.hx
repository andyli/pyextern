...
@:pythonImport("tensorflow.python.data.experimental.ops.grouping", "_GroupByWindowDataset") extern class _GroupByWindowDataset {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(input_dataset:Dynamic, key_func:Dynamic, reduce_func:Dynamic, window_size_func:Dynamic):Dynamic;
	/**
		See `group_by_window()` for details.
	**/
	public function new(input_dataset:Dynamic, key_func:Dynamic, reduce_func:Dynamic, window_size_func:Dynamic):Void;
	/**
