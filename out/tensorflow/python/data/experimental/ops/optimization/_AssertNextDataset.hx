...
@:pythonImport("tensorflow.python.data.experimental.ops.optimization", "_AssertNextDataset") extern class _AssertNextDataset {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(input_dataset:Dynamic, transformations:Dynamic):Dynamic;
	/**
		See `assert_next()` for details.
	**/
	public function new(input_dataset:Dynamic, transformations:Dynamic):Void;
	/**
