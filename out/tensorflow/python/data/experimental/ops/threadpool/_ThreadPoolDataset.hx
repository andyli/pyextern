...
@:pythonImport("tensorflow.python.data.experimental.ops.threadpool", "_ThreadPoolDataset") extern class _ThreadPoolDataset {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(input_dataset:Dynamic, thread_pool:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(input_dataset:Dynamic, thread_pool:Dynamic):Void;
	/**
