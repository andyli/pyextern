...
@:pythonImport("tensorflow.python.data.experimental.ops.prefetching_ops", "_PrefetchToDeviceEagerIterator") extern class _PrefetchToDeviceEagerIterator {
	...
	**/
	@:native("__init__")
	public function ___init__(input_dataset:Dynamic, device:Dynamic, buffer_size:Dynamic):Dynamic;
	/**
		Creates a new iterator over the given dataset.
		...
		Raises:
		  RuntimeError: When invoked without eager execution enabled.
	**/
	public function new(input_dataset:Dynamic, device:Dynamic, buffer_size:Dynamic):Void;
	/**
