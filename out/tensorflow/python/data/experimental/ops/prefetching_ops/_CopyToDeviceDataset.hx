...
@:pythonImport("tensorflow.python.data.experimental.ops.prefetching_ops", "_CopyToDeviceDataset") extern class _CopyToDeviceDataset {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(input_dataset:Dynamic, target_device:Dynamic, ?source_device:Dynamic):Dynamic;
	/**
		Constructs a _CopyToDeviceDataset.
		...
		Args:
		  ...
		  source_device: Device where input_dataset would be placed.
	**/
	public function new(input_dataset:Dynamic, target_device:Dynamic, ?source_device:Dynamic):Void;
	/**
