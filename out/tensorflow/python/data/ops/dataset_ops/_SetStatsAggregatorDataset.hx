...
@:pythonImport("tensorflow.python.data.ops.dataset_ops", "_SetStatsAggregatorDataset") extern class _SetStatsAggregatorDataset {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(input_dataset:Dynamic, aggregator:Dynamic, prefix:Dynamic, counter_prefix:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(input_dataset:Dynamic, aggregator:Dynamic, prefix:Dynamic, counter_prefix:Dynamic):Void;
	/**
