...
@:pythonImport("tensorflow.python.data.ops.dataset_ops", "BatchDataset") extern class BatchDataset {
	...
	**/
	@:native("__init__")
	public function ___init__(input_dataset:Dynamic, batch_size:Dynamic, drop_remainder:Dynamic):Dynamic;
	/**
		See `Dataset.batch()` for details.
	**/
	public function new(input_dataset:Dynamic, batch_size:Dynamic, drop_remainder:Dynamic):Void;
	/**
