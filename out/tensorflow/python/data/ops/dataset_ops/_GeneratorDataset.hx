...
@:pythonImport("tensorflow.python.data.ops.dataset_ops", "_GeneratorDataset") extern class _GeneratorDataset {
	...
	**/
	@:native("__init__")
	public function ___init__(init_args:Dynamic, init_func:Dynamic, next_func:Dynamic, finalize_func:Dynamic):Dynamic;
	/**
		Constructs a `_GeneratorDataset`.
		...
		Args:
		  ...
		  finalize_func: A TensorFlow function that will be called on the result of
		    ...
		    destroyed. The return value is ignored.
	**/
	public function new(init_args:Dynamic, init_func:Dynamic, next_func:Dynamic, finalize_func:Dynamic):Void;
	/**
