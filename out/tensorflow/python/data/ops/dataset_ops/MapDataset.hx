...
@:pythonImport("tensorflow.python.data.ops.dataset_ops", "MapDataset") extern class MapDataset {
	...
	**/
	@:native("__init__")
	public function ___init__(input_dataset:Dynamic, map_func:Dynamic, ?use_inter_op_parallelism:Dynamic, ?preserve_cardinality:Dynamic):Dynamic;
	/**
		See `Dataset.map()` for details.
	**/
	public function new(input_dataset:Dynamic, map_func:Dynamic, ?use_inter_op_parallelism:Dynamic, ?preserve_cardinality:Dynamic):Void;
	/**
