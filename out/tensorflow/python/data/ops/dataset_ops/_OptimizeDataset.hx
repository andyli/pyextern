...
@:pythonImport("tensorflow.python.data.ops.dataset_ops", "_OptimizeDataset") extern class _OptimizeDataset {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(input_dataset:Dynamic, optimizations:Dynamic):Dynamic;
	/**
		See `optimize()` for details.
	**/
	public function new(input_dataset:Dynamic, optimizations:Dynamic):Void;
	/**
