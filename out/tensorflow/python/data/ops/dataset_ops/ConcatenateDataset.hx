...
@:pythonImport("tensorflow.python.data.ops.dataset_ops", "ConcatenateDataset") extern class ConcatenateDataset {
	...
	**/
	@:native("__init__")
	public function ___init__(input_dataset:Dynamic, dataset_to_concatenate:Dynamic):Dynamic;
	/**
		See `Dataset.concatenate()` for details.
	**/
	public function new(input_dataset:Dynamic, dataset_to_concatenate:Dynamic):Void;
	/**
