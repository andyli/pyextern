...
@:pythonImport("tensorflow.python.data.ops.dataset_ops", "InterleaveDataset") extern class InterleaveDataset {
	...
	**/
	@:native("__init__")
	public function ___init__(input_dataset:Dynamic, map_func:Dynamic, cycle_length:Dynamic, block_length:Dynamic):Dynamic;
	/**
		See `Dataset.interleave()` for details.
	**/
	public function new(input_dataset:Dynamic, map_func:Dynamic, cycle_length:Dynamic, block_length:Dynamic):Void;
	/**
