...
@:pythonImport("tensorflow.python.data.ops.dataset_ops", "_PrivateThreadPoolDataset") extern class _PrivateThreadPoolDataset {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(input_dataset:Dynamic, num_threads:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(input_dataset:Dynamic, num_threads:Dynamic):Void;
	/**
