...
@:pythonImport("tensorflow.python.data.ops.dataset_ops", "_MaxIntraOpParallelismDataset") extern class _MaxIntraOpParallelismDataset {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(input_dataset:Dynamic, max_intra_op_parallelism:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(input_dataset:Dynamic, max_intra_op_parallelism:Dynamic):Void;
	/**
