...
@:pythonImport("tensorflow.python.data.ops.dataset_ops", "ShuffleDataset") extern class ShuffleDataset {
	...
	**/
	@:native("__init__")
	public function ___init__(input_dataset:Dynamic, buffer_size:Dynamic, ?seed:Dynamic, ?reshuffle_each_iteration:Dynamic):Dynamic;
	/**
		Randomly shuffles the elements of this dataset.
		...
		Raises:
		  ValueError: if invalid arguments are provided.
	**/
	public function new(input_dataset:Dynamic, buffer_size:Dynamic, ?seed:Dynamic, ?reshuffle_each_iteration:Dynamic):Void;
	/**
