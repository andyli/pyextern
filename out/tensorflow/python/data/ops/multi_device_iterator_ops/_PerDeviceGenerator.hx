...
@:pythonImport("tensorflow.python.data.ops.multi_device_iterator_ops", "_PerDeviceGenerator") extern class _PerDeviceGenerator {
	...
	**/
	@:native("__init__")
	public function ___init__(shard_num:Dynamic, multi_device_iterator_resource:Dynamic, incarnation_id:Dynamic, source_device:Dynamic, target_device:Dynamic, element_structure:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(shard_num:Dynamic, multi_device_iterator_resource:Dynamic, incarnation_id:Dynamic, source_device:Dynamic, target_device:Dynamic, element_structure:Dynamic):Void;
	/**
