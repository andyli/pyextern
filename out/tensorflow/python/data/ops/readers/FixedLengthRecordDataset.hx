...
@:pythonImport("tensorflow.python.data.ops.readers", "FixedLengthRecordDataset") extern class FixedLengthRecordDataset {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(filenames:Dynamic, record_bytes:Dynamic, ?header_bytes:Dynamic, ?footer_bytes:Dynamic, ?buffer_size:Dynamic):Dynamic;
	/**
		Creates a `FixedLengthRecordDataset`.
		...
		Args:
		  ...
		  buffer_size: (Optional.) A `tf.int64` scalar representing the number of
		    bytes to buffer when reading.
	**/
	public function new(filenames:Dynamic, record_bytes:Dynamic, ?header_bytes:Dynamic, ?footer_bytes:Dynamic, ?buffer_size:Dynamic):Void;
	/**
