...
@:pythonImport("tensorflow.python.data.ops.readers", "TFRecordDatasetV1") extern class TFRecordDatasetV1 {
	...
	**/
	@:native("__init__")
	public function ___init__(filenames:Dynamic, ?compression_type:Dynamic, ?buffer_size:Dynamic, ?num_parallel_reads:Dynamic):Dynamic;
	/**
		Creates a `TFRecordDataset` to read one or more TFRecord files.
		...
		Raises:
		  ...
		  ValueError: If any argument does not have the expected shape.
	**/
	public function new(filenames:Dynamic, ?compression_type:Dynamic, ?buffer_size:Dynamic, ?num_parallel_reads:Dynamic):Void;
	/**
	...
	**/
	...
	public function _clone(?filenames:Dynamic, ?compression_type:Dynamic, ?buffer_size:Dynamic, ?num_parallel_reads:Dynamic):Dynamic;
	/**
