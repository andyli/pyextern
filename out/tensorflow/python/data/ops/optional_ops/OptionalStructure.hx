...
@:pythonImport("tensorflow.python.data.ops.optional_ops", "OptionalStructure") extern class OptionalStructure {
	...
	**/
	@:native("__init__")
	public function ___init__(value_structure:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(value_structure:Dynamic):Void;
	/**
