...
@:pythonImport("tensorflow.python.eager.function") extern class _Function_Module {
	...
	**/
	static public function _copy_handle_data(source_t:Dynamic, target_t:Dynamic):Dynamic;
	/**
	...
	**/
	static public function _flatten(sequence:Dynamic):Dynamic;
	/**
	...
	**/
	static public function _get_defun_inputs_from_args(args:Dynamic):Dynamic;
	/**
		Maps a signature to graph-construction inputs.
	**/
	static public function _get_defun_inputs_from_signature(signature:Dynamic):Dynamic;
	/**
		Returns a tuple of device functions representing the device stack.
	**/
	static public function _get_device_functions(ctx:Dynamic, graph:Dynamic):Dynamic;
	/**
	...
	**/
	static public function _register(fn:Dynamic):Dynamic;
	static public function _validate_signature(signature:Dynamic):Dynamic;
	...
	**/
	...
	/**
		...
		Returns:
		  ...
		  graph.
	**/
	static public function defun_with_attributes(?func:Dynamic, ?input_signature:Dynamic, ?attributes:Dynamic):Dynamic;
	...
	/**
		...
		Raises:
		  TypeError: If any of `python_func`'s return values is neither `None` nor a
		    `Tensor`.
	**/
	static public function func_graph_from_py_func(name:Dynamic, python_func:Dynamic, args:Dynamic, kwargs:Dynamic, ?signature:Dynamic, ?func_graph:Dynamic):Dynamic;
	/**
