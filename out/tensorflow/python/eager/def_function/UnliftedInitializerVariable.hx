...
@:pythonImport("tensorflow.python.eager.def_function", "UnliftedInitializerVariable") extern class UnliftedInitializerVariable {
	...
	**/
	@:native("__init__")
	public function ___init__(?initial_value:Dynamic, ?trainable:Dynamic, ?caching_device:Dynamic, ?name:Dynamic, ?dtype:Dynamic, ?constraint:Dynamic, ?unused_kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
		Creates a variable.
		...
		Raises:
		  ...
		  RuntimeError: If called outside of a function definition.
	**/
	public function new(?initial_value:Dynamic, ?trainable:Dynamic, ?caching_device:Dynamic, ?name:Dynamic, ?dtype:Dynamic, ?constraint:Dynamic, ?unused_kwargs:python.KwArgs<Dynamic>):Void;
	/**
