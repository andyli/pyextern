...
@:pythonImport("tensorflow.python.eager.backprop") extern class Backprop_Module {
	...
	**/
	static public function _gradient_function(op_name:Dynamic, attr_tuple:Dynamic, num_inputs:Dynamic, inputs:Dynamic, outputs:Dynamic, out_grads:Dynamic):Dynamic;
	/**
	...
	**/
	...
	static public function _record_gradient(op_name:Dynamic, inputs:Dynamic, attrs:Dynamic, results:Dynamic, name:Dynamic):Dynamic;
	/**
