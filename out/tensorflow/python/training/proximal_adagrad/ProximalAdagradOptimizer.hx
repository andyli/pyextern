...
package tensorflow.python.training.proximal_adagrad;
@:pythonImport("tensorflow.python.training.proximal_adagrad", "ProximalAdagradOptimizer") extern class ProximalAdagradOptimizer {
	...
	**/
	@:native("__init__")
	public function ___init__(learning_rate:Dynamic, ?initial_accumulator_value:Dynamic, ?l1_regularization_strength:Dynamic, ?l2_regularization_strength:Dynamic, ?use_locking:Dynamic, ?name:Dynamic):Dynamic;
	/**
		Construct a new ProximalAdagrad optimizer.
		...
		Raises:
		  ValueError: If the `initial_accumulator_value` is invalid.
	**/
	public function new(learning_rate:Dynamic, ?initial_accumulator_value:Dynamic, ?l1_regularization_strength:Dynamic, ?l2_regularization_strength:Dynamic, ?use_locking:Dynamic, ?name:Dynamic):Void;
	/**
