...
package tensorflow.python.training.saveable_object;
@:pythonImport("tensorflow.python.training.saveable_object", "SaveSpec") extern class SaveSpec {
	...
	**/
	@:native("__init__")
	public function ___init__(tensor:Dynamic, slice_spec:Dynamic, name:Dynamic, ?dtype:Dynamic):Dynamic;
	/**
		Creates a `SaveSpec` object.
		...
		Args:
		  ...
		  dtype: The data type of the Tensor. Required if `tensor` is callable.
		    Used for error checking in the restore op.
	**/
	public function new(tensor:Dynamic, slice_spec:Dynamic, name:Dynamic, ?dtype:Dynamic):Void;
	/**
