...
package tensorflow.python.training.gradient_descent;
@:pythonImport("tensorflow.python.training.gradient_descent", "GradientDescentOptimizer") extern class GradientDescentOptimizer {
