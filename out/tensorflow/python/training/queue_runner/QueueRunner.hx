...
@:pythonImport("tensorflow.python.training.queue_runner", "QueueRunner") extern class QueueRunner {
	...
	**/
	@:native("__init__")
	public function ___init__(?queue:Dynamic, ?enqueue_ops:Dynamic, ?close_op:Dynamic, ?cancel_op:Dynamic, ?queue_runner_def:Dynamic):Dynamic;
	/**
		Create a QueueRunner.
		...
		Raises:
		  ...
		  ValueError: If `queue` or `enqueue_ops` are not provided when not
		    restoring from `queue_runner_def`.
	**/
	public function new(?queue:Dynamic, ?enqueue_ops:Dynamic, ?close_op:Dynamic, ?cancel_op:Dynamic, ?queue_runner_def:Dynamic):Void;
	/**
		Return self<=value.
	**/
