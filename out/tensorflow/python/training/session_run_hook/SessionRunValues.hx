...
@:pythonImport("tensorflow.python.training.session_run_hook", "SessionRunValues") extern class SessionRunValues {
	/**
		Return self+value.
	**/
	...
	**/
	static public function __new__(_cls:Dynamic, results:Dynamic, options:Dynamic, run_metadata:Dynamic):Dynamic;
	/**
		helper for pickle
	**/
	...
	**/
	...
	/**
		Return a new SessionRunValues object replacing specified fields with new values
	**/
