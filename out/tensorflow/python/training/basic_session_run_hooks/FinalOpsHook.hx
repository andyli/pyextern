...
@:pythonImport("tensorflow.python.training.basic_session_run_hooks", "FinalOpsHook") extern class FinalOpsHook {
	...
	**/
	@:native("__init__")
	public function ___init__(final_ops:Dynamic, ?final_ops_feed_dict:Dynamic):Dynamic;
	/**
		Initializes `FinalOpHook` with ops to run at the end of the session.
		...
		Args:
		  ...
		  final_ops_feed_dict: A feed dictionary to use when running
		    `final_ops_dict`.
	**/
	public function new(final_ops:Dynamic, ?final_ops_feed_dict:Dynamic):Void;
	/**
	...
	**/
	...
	public var final_ops_values : Dynamic;
}