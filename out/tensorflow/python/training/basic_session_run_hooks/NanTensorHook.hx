...
@:pythonImport("tensorflow.python.training.basic_session_run_hooks", "NanTensorHook") extern class NanTensorHook {
	...
	**/
	@:native("__init__")
	public function ___init__(loss_tensor:Dynamic, ?fail_on_nan_loss:Dynamic):Dynamic;
	/**
		Initializes a `NanTensorHook`.
		...
		Args:
		  ...
		  fail_on_nan_loss: `bool`, whether to raise exception when loss is NaN.
	**/
	public function new(loss_tensor:Dynamic, ?fail_on_nan_loss:Dynamic):Void;
	/**
