...
@:pythonImport("tensorflow.python.training.basic_session_run_hooks", "GlobalStepWaiterHook") extern class GlobalStepWaiterHook {
	...
	**/
	@:native("__init__")
	public function ___init__(wait_until_step:Dynamic):Dynamic;
	/**
		Initializes a `GlobalStepWaiterHook`.
		...
		Args:
		  wait_until_step: an `int` shows until which global step should we wait.
	**/
	public function new(wait_until_step:Dynamic):Void;
	/**
