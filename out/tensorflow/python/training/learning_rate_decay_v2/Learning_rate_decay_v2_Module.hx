...
package tensorflow.python.training.learning_rate_decay_v2;
@:pythonImport("tensorflow.python.training.learning_rate_decay_v2") extern class Learning_rate_decay_v2_Module {
