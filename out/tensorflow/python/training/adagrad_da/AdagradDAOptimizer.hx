...
package tensorflow.python.training.adagrad_da;
@:pythonImport("tensorflow.python.training.adagrad_da", "AdagradDAOptimizer") extern class AdagradDAOptimizer {
	...
	**/
	@:native("__init__")
	public function ___init__(learning_rate:Dynamic, global_step:Dynamic, ?initial_gradient_squared_accumulator_value:Dynamic, ?l1_regularization_strength:Dynamic, ?l2_regularization_strength:Dynamic, ?use_locking:Dynamic, ?name:Dynamic):Dynamic;
	/**
		Construct a new AdagradDA optimizer.
		...
		Raises:
		  ...
		  invalid.
	**/
	public function new(learning_rate:Dynamic, global_step:Dynamic, ?initial_gradient_squared_accumulator_value:Dynamic, ?l1_regularization_strength:Dynamic, ?l2_regularization_strength:Dynamic, ?use_locking:Dynamic, ?name:Dynamic):Void;
	/**
