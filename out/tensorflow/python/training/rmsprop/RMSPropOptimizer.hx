...
@:pythonImport("tensorflow.python.training.rmsprop", "RMSPropOptimizer") extern class RMSPropOptimizer {
	...
	**/
	@:native("__init__")
	public function ___init__(learning_rate:Dynamic, ?decay:Dynamic, ?momentum:Dynamic, ?epsilon:Dynamic, ?use_locking:Dynamic, ?name:Dynamic):Dynamic;
	/**
		Construct a new RMSProp optimizer.
		...
		Args:
		  ...
		  name: Optional name prefix for the operations created when applying
		    gradients. Defaults to "RMSProp".
	**/
	public function new(learning_rate:Dynamic, ?decay:Dynamic, ?momentum:Dynamic, ?epsilon:Dynamic, ?use_locking:Dynamic, ?name:Dynamic):Void;
	/**
		Return self<=value.
	**/
