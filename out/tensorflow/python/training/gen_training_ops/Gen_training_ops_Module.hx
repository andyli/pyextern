...
@:pythonImport("tensorflow.python.training.gen_training_ops") extern class Gen_training_ops_Module {
	...
	static public var _apply_adadelta_outputs : Dynamic;
	static public var _apply_adagrad_outputs : Dynamic;
	static public var _apply_adam_outputs : Dynamic;
	static public var _apply_ftrl_outputs : Dynamic;
	static public var _apply_gradient_descent_outputs : Dynamic;
	static public var _apply_momentum_outputs : Dynamic;
	static public var _apply_proximal_adagrad_outputs : Dynamic;
	static public var _apply_proximal_gradient_descent_outputs : Dynamic;
	static public var _apply_rms_prop_outputs : Dynamic;
	static public var _op_def_lib : Dynamic;
	static public var _sparse_apply_adadelta_outputs : Dynamic;
	static public var _sparse_apply_adagrad_outputs : Dynamic;
	static public var _sparse_apply_ftrl_outputs : Dynamic;
	static public var _sparse_apply_momentum_outputs : Dynamic;
	static public var _sparse_apply_proximal_adagrad_outputs : Dynamic;
	static public var _sparse_apply_proximal_gradient_descent_outputs : Dynamic;
	static public var _sparse_apply_rms_prop_outputs : Dynamic;
	/**
