...
package tensorflow.python.training.ftrl;
@:pythonImport("tensorflow.python.training.ftrl", "FtrlOptimizer") extern class FtrlOptimizer {
	...
	**/
	@:native("__init__")
	public function ___init__(learning_rate:Dynamic, ?learning_rate_power:Dynamic, ?initial_accumulator_value:Dynamic, ?l1_regularization_strength:Dynamic, ?l2_regularization_strength:Dynamic, ?use_locking:Dynamic, ?name:Dynamic):Dynamic;
	/**
		Construct a new FTRL optimizer.
		...
		Raises:
		  ValueError: If one of the arguments is invalid.
	**/
	public function new(learning_rate:Dynamic, ?learning_rate_power:Dynamic, ?initial_accumulator_value:Dynamic, ?l1_regularization_strength:Dynamic, ?l2_regularization_strength:Dynamic, ?use_locking:Dynamic, ?name:Dynamic):Void;
	/**
		Return self<=value.
	**/
