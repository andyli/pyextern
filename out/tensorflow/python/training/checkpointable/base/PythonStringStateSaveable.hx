...
@:pythonImport("tensorflow.python.training.checkpointable.base", "PythonStringStateSaveable") extern class PythonStringStateSaveable {
	...
	**/
	@:native("__init__")
	public function ___init__(name:Dynamic, state_callback:Dynamic, ?restore_callback:Dynamic):Dynamic;
	/**
		Configure saving.
		...
		Args:
		  ...
		  restore_callback: A function taking a Python string, used to restore
		    state. Optional; defaults to doing nothing.
	**/
	public function new(name:Dynamic, state_callback:Dynamic, ?restore_callback:Dynamic):Void;
	/**
	...
	**/
	public function python_restore(restored_strings:Dynamic):Dynamic;
	/**
