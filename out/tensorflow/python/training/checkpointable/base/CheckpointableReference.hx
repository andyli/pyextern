...
@:pythonImport("tensorflow.python.training.checkpointable.base", "CheckpointableReference") extern class CheckpointableReference {
	/**
		Return self+value.
	**/
	...
	**/
	...
	/**
		Create new instance of CheckpointableReference(name, ref)
	**/
	static public function __new__(_cls:Dynamic, name:Dynamic, ref:Dynamic):Dynamic;
	/**
		helper for pickle
	**/
	...
	**/
	...
	/**
		Make a new CheckpointableReference object from a sequence or iterable
	**/
	static public function _make(iterable:Dynamic, ?_new:Dynamic, ?len:Dynamic):Dynamic;
	/**
		Return a new CheckpointableReference object replacing specified fields with new values
	**/
