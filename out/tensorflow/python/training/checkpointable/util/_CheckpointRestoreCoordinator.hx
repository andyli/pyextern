...
@:pythonImport("tensorflow.python.training.checkpointable.util", "_CheckpointRestoreCoordinator") extern class _CheckpointRestoreCoordinator {
	...
	**/
	@:native("__init__")
	public function ___init__(object_graph_proto:Dynamic, save_path:Dynamic, save_path_tensor:Dynamic, restore_op_cache:Dynamic, saveable_object_cache:Dynamic):Dynamic;
	/**
		Specify the checkpoint being loaded.
		...
		Args:
		  ...
		  saveable_object_cache: A mapping of checkpointable objects -> attribute
		    ...
		    create their own ops every restore.
	**/
	public function new(object_graph_proto:Dynamic, save_path:Dynamic, save_path_tensor:Dynamic, restore_op_cache:Dynamic, saveable_object_cache:Dynamic):Void;
	/**
