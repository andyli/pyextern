...
@:pythonImport("tensorflow.python.training.checkpointable.util", "_NameBasedRestoreCoordinator") extern class _NameBasedRestoreCoordinator {
	...
	**/
	@:native("__init__")
	public function ___init__(save_path:Dynamic, ?dtype_map:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(save_path:Dynamic, ?dtype_map:Dynamic):Void;
	/**
	...
	**/
	public function eager_restore(checkpointable:Dynamic):Dynamic;
	/**
	...
	**/
	public function globally_named_object_attributes(checkpointable:Dynamic):Dynamic;
}