...
@:pythonImport("tensorflow.python.training.monitored_session", "_RecoverableSession") extern class _RecoverableSession {
	...
	**/
	@:native("__init__")
	public function ___init__(sess_creator:Dynamic):Dynamic;
	/**
		Create a new `_RecoverableSession`.
		...
		Args:
		  sess_creator: A 'SessionCreator' to be wrapped by recoverable.
	**/
	public function new(sess_creator:Dynamic):Void;
	/**
