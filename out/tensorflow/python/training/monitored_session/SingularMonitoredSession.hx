...
@:pythonImport("tensorflow.python.training.monitored_session", "SingularMonitoredSession") extern class SingularMonitoredSession {
	...
	**/
	@:native("__init__")
	public function ___init__(?hooks:Dynamic, ?scaffold:Dynamic, ?master:Dynamic, ?config:Dynamic, ?checkpoint_dir:Dynamic, ?stop_grace_period_secs:Dynamic):Dynamic;
	/**
		Creates a SingularMonitoredSession.
		...
		Args:
		  ...
		  stop_grace_period_secs: Number of seconds given to threads to stop after
		    `close()` has been called.
	**/
	public function new(?hooks:Dynamic, ?scaffold:Dynamic, ?master:Dynamic, ?config:Dynamic, ?checkpoint_dir:Dynamic, ?stop_grace_period_secs:Dynamic):Void;
	/**
