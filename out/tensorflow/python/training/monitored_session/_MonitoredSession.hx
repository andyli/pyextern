...
@:pythonImport("tensorflow.python.training.monitored_session", "_MonitoredSession") extern class _MonitoredSession {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(session_creator:Dynamic, hooks:Dynamic, should_recover:Dynamic, ?stop_grace_period_secs:Dynamic):Dynamic;
	/**
		Sets up a Monitored or Hooked Session.
		...
		Args:
		  ...
		  stop_grace_period_secs: Number of seconds given to threads to stop after
		    `close()` has been called.
	**/
	public function new(session_creator:Dynamic, hooks:Dynamic, should_recover:Dynamic, ?stop_grace_period_secs:Dynamic):Void;
	/**
