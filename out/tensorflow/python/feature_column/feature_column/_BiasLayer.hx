...
@:pythonImport("tensorflow.python.feature_column.feature_column", "_BiasLayer") extern class _BiasLayer {
	/**
	...
	**/
	...
	@:native("__init__")
	public function ___init__(?units:Dynamic, ?trainable:Dynamic, ?weight_collections:Dynamic, ?name:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	public function new(?units:Dynamic, ?trainable:Dynamic, ?weight_collections:Dynamic, ?name:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Void;
	/**
