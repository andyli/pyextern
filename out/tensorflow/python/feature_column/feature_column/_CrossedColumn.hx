...
@:pythonImport("tensorflow.python.feature_column.feature_column", "_CrossedColumn") extern class _CrossedColumn {
	/**
	...
	**/
	...
	/**
		Create new instance of _CrossedColumn(keys, hash_bucket_size, hash_key)
	**/
