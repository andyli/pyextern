...
@:pythonImport("tensorflow.python.feature_column.feature_column") extern class Feature_column_Module {
	...
	**/
	static public function _add_to_collections(_var:Dynamic, weight_collections:Dynamic):Dynamic;
	static public function _as_tuple(value:Dynamic):Dynamic;
	static public function _assert_key_is_string(key:Dynamic):Dynamic;
	...
	**/
	static public function _bucketized_column(source_column:Dynamic, boundaries:Dynamic):Dynamic;
	/**
	...
	**/
	static public function _categorical_column_with_hash_bucket(key:Dynamic, hash_bucket_size:Dynamic, ?dtype:Dynamic):Dynamic;
	/**
	...
	**/
	static public function _categorical_column_with_identity(key:Dynamic, num_buckets:Dynamic, ?default_value:Dynamic):Dynamic;
	/**
		...
		Raises:
		  ...
		  ValueError: `dtype` is neither string nor integer.
	**/
	static public function _categorical_column_with_vocabulary_file(key:Dynamic, vocabulary_file:Dynamic, ?vocabulary_size:Dynamic, ?num_oov_buckets:Dynamic, ?default_value:Dynamic, ?dtype:Dynamic):Dynamic;
	/**
	...
	**/
	static public function _categorical_column_with_vocabulary_list(key:Dynamic, vocabulary_list:Dynamic, ?dtype:Dynamic, ?default_value:Dynamic, ?num_oov_buckets:Dynamic):Dynamic;
	/**
	...
	**/
	...
	/**
		...
		sparse_combiner = "sum".
	**/
	static public function _create_categorical_column_weighted_sum(column:Dynamic, builder:Dynamic, units:Dynamic, sparse_combiner:Dynamic, weight_collections:Dynamic, trainable:Dynamic, ?weight_var:Dynamic):Dynamic;
	/**
		Create a weighted sum of a dense column for linear_model.
	**/
	static public function _create_dense_column_weighted_sum(column:Dynamic, builder:Dynamic, units:Dynamic, weight_collections:Dynamic, trainable:Dynamic, ?weight_var:Dynamic):Dynamic;
	/**
	...
	**/
	static public function _create_weighted_sum(column:Dynamic, builder:Dynamic, units:Dynamic, sparse_combiner:Dynamic, weight_collections:Dynamic, trainable:Dynamic, ?weight_var:Dynamic):Dynamic;
	/**
	...
	**/
	static public function _crossed_column(keys:Dynamic, hash_bucket_size:Dynamic, ?hash_key:Dynamic):Dynamic;
	/**
	...
	**/
	static public function _embedding_column(categorical_column:Dynamic, dimension:Dynamic, ?combiner:Dynamic, ?initializer:Dynamic, ?ckpt_to_load_from:Dynamic, ?tensor_name_in_ckpt:Dynamic, ?max_norm:Dynamic, ?trainable:Dynamic):Dynamic;
	static public function _get_expanded_variable_list(variable:Dynamic):Dynamic;
	static public function _get_graph_for_variable(_var:Dynamic):Dynamic;
	/**
		...
		Returns:
		  An `_IndicatorColumn`.
	**/
	static public function _indicator_column(categorical_column:Dynamic):Dynamic;
	/**
		See input_layer. `scope` is a name or variable scope to use.
	**/
	static public function _internal_input_layer(features:Dynamic, feature_columns:Dynamic, ?weight_collections:Dynamic, ?trainable:Dynamic, ?cols_to_vars:Dynamic, ?scope:Dynamic, ?cols_to_output_tensors:Dynamic, ?from_template:Dynamic):Dynamic;
	/**
	...
	**/
	...
	/**
		...
		Raises:
		  ...
		  ValueError: if `dtype` is not convertible to `tf.float32`.
	**/
	static public function _numeric_column(key:Dynamic, ?shape:Dynamic, ?default_value:Dynamic, ?dtype:Dynamic, ?normalizer_fn:Dynamic):Dynamic;
	/**
		Returns a [batch_size] Tensor with per-example sequence length.
	**/
	static public function _sequence_length_from_sparse_tensor(sp_tensor:Dynamic, ?num_elements:Dynamic):Dynamic;
	/**
		Returns moving offset for each dimension given shape.
	**/
	static public function _shape_offsets(shape:Dynamic):Dynamic;
	static public function _strip_leading_slashes(name:Dynamic):Dynamic;
	/**
	...
	**/
	static public function _weighted_categorical_column(categorical_column:Dynamic, weight_feature_key:Dynamic, ?dtype:Dynamic):Dynamic;
