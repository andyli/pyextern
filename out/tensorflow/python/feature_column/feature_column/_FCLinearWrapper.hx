...
@:pythonImport("tensorflow.python.feature_column.feature_column", "_FCLinearWrapper") extern class _FCLinearWrapper {
	/**
	...
	**/
	...
	@:native("__init__")
	public function ___init__(feature_column:Dynamic, ?units:Dynamic, ?sparse_combiner:Dynamic, ?weight_collections:Dynamic, ?trainable:Dynamic, ?name:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	public function new(feature_column:Dynamic, ?units:Dynamic, ?sparse_combiner:Dynamic, ?weight_collections:Dynamic, ?trainable:Dynamic, ?name:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Void;
	/**
	...
	**/
	public function call(builder:Dynamic):Dynamic;
	/**
