...
@:pythonImport("tensorflow.python.feature_column.feature_column", "_WeightedCategoricalColumn") extern class _WeightedCategoricalColumn {
	/**
	...
	**/
	...
	/**
		Create new instance of _WeightedCategoricalColumn(categorical_column, weight_feature_key, dtype)
	**/
	...
	**/
	...
	/**
		Make a new _WeightedCategoricalColumn object from a sequence or iterable
	**/
	...
	**/
	...
	/**
		Return a new _WeightedCategoricalColumn object replacing specified fields with new values
	**/
