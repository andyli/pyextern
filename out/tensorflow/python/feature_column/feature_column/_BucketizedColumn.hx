...
@:pythonImport("tensorflow.python.feature_column.feature_column", "_BucketizedColumn") extern class _BucketizedColumn {
	/**
	...
	**/
	...
	/**
		Create new instance of _BucketizedColumn(source_column, boundaries)
	**/
