...
@:pythonImport("tensorflow.python.feature_column.feature_column", "_SharedEmbeddingColumn") extern class _SharedEmbeddingColumn {
	...
	**/
	...
	/**
		Create new instance of _SharedEmbeddingColumn(categorical_column, dimension, combiner, initializer, shared_embedding_collection_name, ckpt_to_load_from, tensor_name_in_ckpt, max_norm, trainable)
	**/
