...
@:pythonImport("tensorflow.python.feature_column.feature_column", "_VocabularyListCategoricalColumn") extern class _VocabularyListCategoricalColumn {
	/**
	...
	**/
	...
	/**
		Create new instance of _VocabularyListCategoricalColumn(key, vocabulary_list, dtype, default_value)
	**/
	static public function __new__(_cls:Dynamic, key:Dynamic, vocabulary_list:Dynamic, dtype:Dynamic, default_value:Dynamic):Dynamic;
	/**
		helper for pickle
	**/
	...
	**/
	...
	/**
		Make a new _VocabularyListCategoricalColumn object from a sequence or iterable
	**/
	...
	**/
	...
	/**
		Return a new _VocabularyListCategoricalColumn object replacing specified fields with new values
	**/
