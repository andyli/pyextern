...
@:pythonImport("tensorflow.python.feature_column.feature_column", "_IdentityCategoricalColumn") extern class _IdentityCategoricalColumn {
	/**
	...
	**/
	...
	/**
		Create new instance of _IdentityCategoricalColumn(key, num_buckets, default_value)
	**/
	static public function __new__(_cls:Dynamic, key:Dynamic, num_buckets:Dynamic, default_value:Dynamic):Dynamic;
	/**
		helper for pickle
	**/
	...
	**/
	...
	/**
		Make a new _IdentityCategoricalColumn object from a sequence or iterable
	**/
	...
	**/
	...
	/**
		Return a new _IdentityCategoricalColumn object replacing specified fields with new values
	**/
