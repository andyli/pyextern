...
@:pythonImport("tensorflow.python.feature_column.feature_column", "_VocabularyFileCategoricalColumn") extern class _VocabularyFileCategoricalColumn {
	/**
	...
	**/
	...
	/**
		Create new instance of _VocabularyFileCategoricalColumn(key, vocabulary_file, vocabulary_size, num_oov_buckets, dtype, default_value)
	**/
	static public function __new__(_cls:Dynamic, key:Dynamic, vocabulary_file:Dynamic, vocabulary_size:Dynamic, num_oov_buckets:Dynamic, dtype:Dynamic, default_value:Dynamic):Dynamic;
	/**
		helper for pickle
	**/
	...
	**/
	...
	/**
		Make a new _VocabularyFileCategoricalColumn object from a sequence or iterable
	**/
	...
	**/
	...
	/**
		Return a new _VocabularyFileCategoricalColumn object replacing specified fields with new values
	**/
