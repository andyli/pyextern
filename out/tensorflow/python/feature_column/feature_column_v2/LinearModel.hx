...
@:pythonImport("tensorflow.python.feature_column.feature_column_v2", "LinearModel") extern class LinearModel {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(feature_columns:Dynamic, ?units:Dynamic, ?sparse_combiner:Dynamic, ?trainable:Dynamic, ?name:Dynamic, ?shared_state_manager:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
		Constructs a LinearModel.
		...
		Raises:
		  ValueError: if an item in `feature_columns` is neither a `DenseColumn`
		    nor `CategoricalColumn`.
	**/
	public function new(feature_columns:Dynamic, ?units:Dynamic, ?sparse_combiner:Dynamic, ?trainable:Dynamic, ?name:Dynamic, ?shared_state_manager:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Void;
	/**
	...
	**/
	...
	public var bias_variable : Dynamic;
	/**
