...
@:pythonImport("tensorflow.python.feature_column.feature_column_v2", "FeatureLayer") extern class FeatureLayer {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(feature_columns:Dynamic, ?trainable:Dynamic, ?name:Dynamic, ?shared_state_manager:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
		Constructs a FeatureLayer.
		...
		Raises:
		  ValueError: if an item in `feature_columns` is not a `DenseColumn`.
	**/
	public function new(feature_columns:Dynamic, ?trainable:Dynamic, ?name:Dynamic, ?shared_state_manager:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Void;
	/**
	...
	**/
	public function call(features:Dynamic, ?cols_to_output_tensors:Dynamic):Dynamic;
	/**
