...
@:pythonImport("tensorflow.python.feature_column.feature_column_v2", "_LinearModelLayer") extern class _LinearModelLayer {
	/**
	...
	**/
	...
	@:native("__init__")
	public function ___init__(feature_columns:Dynamic, ?units:Dynamic, ?sparse_combiner:Dynamic, ?trainable:Dynamic, ?name:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	public function new(feature_columns:Dynamic, ?units:Dynamic, ?sparse_combiner:Dynamic, ?trainable:Dynamic, ?name:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Void;
	/**
