...
@:pythonImport("tensorflow.python.feature_column.feature_column_v2", "SharedEmbeddingColumnCreator") extern class SharedEmbeddingColumnCreator {
	...
	**/
	@:native("__init__")
	public function ___init__(dimension:Dynamic, initializer:Dynamic, ckpt_to_load_from:Dynamic, tensor_name_in_ckpt:Dynamic, num_buckets:Dynamic, trainable:Dynamic, ?name:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(dimension:Dynamic, initializer:Dynamic, ckpt_to_load_from:Dynamic, tensor_name_in_ckpt:Dynamic, num_buckets:Dynamic, trainable:Dynamic, ?name:Dynamic):Void;
	/**
