...
@:pythonImport("tensorflow.python.feature_column.feature_column_v2", "SharedEmbeddingColumn") extern class SharedEmbeddingColumn {
	...
	**/
	...
	/**
		Create new instance of SharedEmbeddingColumn(categorical_column, shared_embedding_column_creator, combiner, max_norm)
	**/
	static public function __new__(_cls:Dynamic, categorical_column:Dynamic, shared_embedding_column_creator:Dynamic, combiner:Dynamic, max_norm:Dynamic):Dynamic;
	/**
		helper for pickle
	**/
