...
@:pythonImport("tensorflow.python.feature_column.feature_column_v2", "SharedEmbeddingColumn") extern class SharedEmbeddingColumn {
	/**
	...
	**/
	...
	/**
		Create new instance of SharedEmbeddingColumn(categorical_column, dimension, combiner, initializer, shared_embedding_collection_name, ckpt_to_load_from, tensor_name_in_ckpt, max_norm, trainable)
	**/
	static public function __new__(_cls:Dynamic, categorical_column:Dynamic, dimension:Dynamic, combiner:Dynamic, initializer:Dynamic, shared_embedding_collection_name:Dynamic, ckpt_to_load_from:Dynamic, tensor_name_in_ckpt:Dynamic, max_norm:Dynamic, trainable:Dynamic):Dynamic;
	/**
		helper for pickle
	**/
	...
	**/
	...
	/**
		...
		referred to.
	**/
	public var shared_collection_name : Dynamic;
	/**
