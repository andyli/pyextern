...
@:pythonImport("tensorflow.python.feature_column.feature_column_v2", "SharedEmbeddingStateManager") extern class SharedEmbeddingStateManager {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(?trainable:Dynamic, ?name:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
		Constructs a `SharedEmbeddingStateManager`.
		...
		Args:
		  ...
		  **kwargs: Keyword arguments.
	**/
	public function new(?trainable:Dynamic, ?name:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Void;
	/**
	...
	**/
	public function create_variable(name:Dynamic, shape:Dynamic, ?dtype:Dynamic, ?trainable:Dynamic, ?initializer:Dynamic):Dynamic;
