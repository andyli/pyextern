...
@:pythonImport("tensorflow.python.client.timeline", "AllocationMaximum") extern class AllocationMaximum {
	/**
		Return self+value.
	**/
	...
	**/
	...
	/**
		Create new instance of AllocationMaximum(timestamp, num_bytes, tensors)
	**/
	static public function __new__(_cls:Dynamic, timestamp:Dynamic, num_bytes:Dynamic, tensors:Dynamic):Dynamic;
	/**
		helper for pickle
	**/
	...
	**/
	...
	/**
		Make a new AllocationMaximum object from a sequence or iterable
	**/
	static public function _make(iterable:Dynamic, ?_new:Dynamic, ?len:Dynamic):Dynamic;
	/**
		Return a new AllocationMaximum object replacing specified fields with new values
	**/
