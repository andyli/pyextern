...
@:pythonImport("tensorflow.python.ops.variables", "RefVariable") extern class RefVariable {
	...
	**/
	@:native("__init__")
	public function ___init__(?initial_value:Dynamic, ?trainable:Dynamic, ?collections:Dynamic, ?validate_shape:Dynamic, ?caching_device:Dynamic, ?name:Dynamic, ?variable_def:Dynamic, ?dtype:Dynamic, ?expected_shape:Dynamic, ?import_scope:Dynamic, ?constraint:Dynamic):Dynamic;
	/**
		Creates a new variable with value `initial_value`.
		...
		Raises:
		  ...
		  RuntimeError: If eager execution is enabled.
	**/
	public function new(?initial_value:Dynamic, ?trainable:Dynamic, ?collections:Dynamic, ?validate_shape:Dynamic, ?caching_device:Dynamic, ?name:Dynamic, ?variable_def:Dynamic, ?dtype:Dynamic, ?expected_shape:Dynamic, ?import_scope:Dynamic, ?constraint:Dynamic):Void;
	/**
	...
	**/
	public function _init_from_args(?initial_value:Dynamic, ?trainable:Dynamic, ?collections:Dynamic, ?validate_shape:Dynamic, ?caching_device:Dynamic, ?name:Dynamic, ?dtype:Dynamic, ?expected_shape:Dynamic, ?constraint:Dynamic):Dynamic;
	/**
