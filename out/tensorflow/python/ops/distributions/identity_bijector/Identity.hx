...
package tensorflow.python.ops.distributions.identity_bijector;
@:pythonImport("tensorflow.python.ops.distributions.identity_bijector", "Identity") extern class Identity {
	...
	**/
	@:native("__init__")
	public function ___init__(?validate_args:Dynamic, ?event_ndims:Dynamic, ?name:Dynamic):Dynamic;
	/**
		Constructs Bijector.
		...
		Args:
		  ...
		  name: The name to give Ops created by the initializer.
	**/
	public function new(?validate_args:Dynamic, ?event_ndims:Dynamic, ?name:Dynamic):Void;
	/**
