...
@:pythonImport("tensorflow.python.ops.distributions.normal", "NormalWithSoftplusScale") extern class NormalWithSoftplusScale {
	...
	**/
	public function _inv_z(z:Dynamic):Dynamic;
	/**
	...
	**/
	public function _z(x:Dynamic):Dynamic;
	/**
