...
@:pythonImport("tensorflow.python.ops.distributions.categorical", "Categorical") extern class Categorical {
	...
	**/
	...
	public function _log_prob(k:Dynamic):Dynamic;
	...
	**/
	...
	public function _prob(k:Dynamic):Dynamic;
