...
@:pythonImport("tensorflow.python.ops.distributions.dirichlet", "Dirichlet") extern class Dirichlet {
	...
	**/
	...
	/**
		...
		Args:
		  ...
		  name: Python `str` name prefixed to Ops created by this class.
	**/
	public function new(concentration:Dynamic, ?validate_args:Dynamic, ?allow_nan_stats:Dynamic, ?name:Dynamic):Void;
	/**
