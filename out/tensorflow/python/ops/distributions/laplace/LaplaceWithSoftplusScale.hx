...
package tensorflow.python.ops.distributions.laplace;
@:pythonImport("tensorflow.python.ops.distributions.laplace", "LaplaceWithSoftplusScale") extern class LaplaceWithSoftplusScale {
	...
	**/
	...
	public function _median():Dynamic;
