...
@:pythonImport("tensorflow.python.ops.distributions.bernoulli", "Bernoulli") extern class Bernoulli {
	...
	**/
	...
	/**
		...
		Raises:
		  ValueError: If p and logits are passed, or if neither are passed.
	**/
	public function new(?logits:Dynamic, ?probs:Dynamic, ?dtype:Dynamic, ?validate_args:Dynamic, ?allow_nan_stats:Dynamic, ?name:Dynamic):Void;
	/**
	...
	**/
	...
	public function _log_prob(event:Dynamic):Dynamic;
	public function _log_survival_function(value:Dynamic):Dynamic;
	public function _maybe_assert_valid_sample(event:Dynamic, ?check_integer:Dynamic):Dynamic;
	...
	**/
	...
	public function _prob(event:Dynamic):Dynamic;
