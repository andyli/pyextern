...
package tensorflow.python.ops.distributions.dirichlet_multinomial;
@:pythonImport("tensorflow.python.ops.distributions.dirichlet_multinomial", "DirichletMultinomial") extern class DirichletMultinomial {
	...
	**/
	...
	/**
		...
		Args:
		  ...
		  name: Python `str` name prefixed to Ops created by this class.
	**/
	public function new(total_count:Dynamic, concentration:Dynamic, ?validate_args:Dynamic, ?allow_nan_stats:Dynamic, ?name:Dynamic):Void;
	/**
	...
	**/
	public function _variance_scale_term():Dynamic;
	/**
	...
	**/
	public var total_concentration : Dynamic;
	/**
