...
@:pythonImport("tensorflow.python.ops.io_ops", "TextLineReader") extern class TextLineReader {
	...
	**/
	@:native("__init__")
	public function ___init__(?skip_header_lines:Dynamic, ?name:Dynamic):Dynamic;
	/**
		Create a TextLineReader. (deprecated)
		...
		Args:
		  ...
		  name: A name for the operation (optional).
	**/
	public function new(?skip_header_lines:Dynamic, ?name:Dynamic):Void;
	/**
