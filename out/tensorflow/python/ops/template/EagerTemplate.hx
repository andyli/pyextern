...
@:pythonImport("tensorflow.python.ops.template", "EagerTemplate") extern class EagerTemplate {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(name:Dynamic, func:Dynamic, ?create_scope_now:Dynamic, ?custom_getter:Dynamic, ?create_graph_function:Dynamic):Dynamic;
	/**
		Creates a template for the given function.
		...
		Raises:
		  RuntimeError: if eager execution is not enabled.
	**/
	public function new(name:Dynamic, func:Dynamic, ?create_scope_now:Dynamic, ?custom_getter:Dynamic, ?create_graph_function:Dynamic):Void;
	/**
