...
@:pythonImport("tensorflow.python.ops.ragged.ragged_dispatch", "UnaryRaggedElementwiseDispatcher") extern class UnaryRaggedElementwiseDispatcher {
	...
	**/
	@:native("__init__")
	public function ___init__(original_op:Dynamic, ?arg_is_list:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(original_op:Dynamic, ?arg_is_list:Dynamic):Void;
	/**
