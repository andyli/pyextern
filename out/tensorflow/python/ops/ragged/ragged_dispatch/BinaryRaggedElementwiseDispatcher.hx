...
@:pythonImport("tensorflow.python.ops.ragged.ragged_dispatch", "BinaryRaggedElementwiseDispatcher") extern class BinaryRaggedElementwiseDispatcher {
	...
	**/
	@:native("__init__")
	public function ___init__(original_op:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(original_op:Dynamic):Void;
	/**
