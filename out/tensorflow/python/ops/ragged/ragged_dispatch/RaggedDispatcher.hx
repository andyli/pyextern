...
@:pythonImport("tensorflow.python.ops.ragged.ragged_dispatch", "RaggedDispatcher") extern class RaggedDispatcher {
	...
	**/
	@:native("__init__")
	public function ___init__(original_op:Dynamic, ragged_op:Dynamic, ragged_args:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(original_op:Dynamic, ragged_op:Dynamic, ragged_args:Dynamic):Void;
	/**
	...
	**/
	...
	public function is_supported(args:Dynamic, kwargs:Dynamic):Dynamic;
	/**
