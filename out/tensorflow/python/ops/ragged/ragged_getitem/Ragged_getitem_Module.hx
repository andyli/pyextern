...
@:pythonImport("tensorflow.python.ops.ragged.ragged_getitem") extern class Ragged_getitem_Module {
	...
	/**
		...
		Returns:
		  A 1-D int64 tensor.
	**/
	static public function _add_offset_to_ranges(offset:Dynamic, starts:Dynamic, limits:Dynamic):Dynamic;
	/**
	...
	**/
	...
	/**
		...
		Examples:
		  ...
		  ```
	**/
	static public function ragged_tensor_getitem(self:Dynamic, key:Dynamic):Dynamic;
}