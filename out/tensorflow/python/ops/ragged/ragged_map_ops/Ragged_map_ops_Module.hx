...
@:pythonImport("tensorflow.python.ops.ragged.ragged_map_ops") extern class Ragged_map_ops_Module {
	...
	static public function _concat_ragged_tensor_components(rt_ta:Dynamic):Dynamic;
	/**
		Convert outputs which are `Tensor`s into `_RaggedTensorComponents`.
	**/
	static public function _convert_declared(fn_output_flat:Dynamic, output_declared:Dynamic):Dynamic;
	/**
		Decompose dtypes into composite tensors (if necessary).
	**/
	static public function _maybe_decompose_dtype(d:Dynamic):Dynamic;
	/**
		Decompose tensors to their composite tensors.
	**/
	static public function _maybe_decompose_tensor(rt:Dynamic):Dynamic;
	/**
		Reconstructs a _RaggedTensorComponents into a RaggedTensor.
	**/
	static public function _maybe_recompose_tensor(t:Dynamic):Dynamic;
