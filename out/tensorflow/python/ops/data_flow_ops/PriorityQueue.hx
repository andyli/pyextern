...
@:pythonImport("tensorflow.python.ops.data_flow_ops", "PriorityQueue") extern class PriorityQueue {
	...
	**/
	@:native("__init__")
	public function ___init__(capacity:Dynamic, types:Dynamic, ?shapes:Dynamic, ?names:Dynamic, ?shared_name:Dynamic, ?name:Dynamic):Dynamic;
	/**
		Creates a queue that dequeues elements in a first-in first-out order.
		...
		Args:
		  ...
		  name: Optional name for the queue operation.
	**/
	public function new(capacity:Dynamic, types:Dynamic, ?shapes:Dynamic, ?names:Dynamic, ?shared_name:Dynamic, ?name:Dynamic):Void;
	/**
