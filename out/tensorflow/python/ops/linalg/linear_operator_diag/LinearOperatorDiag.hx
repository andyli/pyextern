...
package tensorflow.python.ops.linalg.linear_operator_diag;
@:pythonImport("tensorflow.python.ops.linalg.linear_operator_diag", "LinearOperatorDiag") extern class LinearOperatorDiag {
