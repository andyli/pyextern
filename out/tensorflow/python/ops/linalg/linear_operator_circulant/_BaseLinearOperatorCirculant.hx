...
@:pythonImport("tensorflow.python.ops.linalg.linear_operator_circulant", "_BaseLinearOperatorCirculant") extern class _BaseLinearOperatorCirculant {
	...
	**/
	@:native("__init__")
	public function ___init__(spectrum:Dynamic, block_depth:Dynamic, ?input_output_dtype:Dynamic, ?is_non_singular:Dynamic, ?is_self_adjoint:Dynamic, ?is_positive_definite:Dynamic, ?is_square:Dynamic, ?name:Dynamic):Dynamic;
	/**
		Initialize an `_BaseLinearOperatorCirculant`.
		...
		Raises:
		  ...
		  TypeError:  If `spectrum` is not an allowed type.
	**/
	public function new(spectrum:Dynamic, block_depth:Dynamic, ?input_output_dtype:Dynamic, ?is_non_singular:Dynamic, ?is_self_adjoint:Dynamic, ?is_positive_definite:Dynamic, ?is_square:Dynamic, ?name:Dynamic):Void;
	/**
