...
package tensorflow.python.ops.linalg.linear_operator_identity;
@:pythonImport("tensorflow.python.ops.linalg.linear_operator_identity", "LinearOperatorIdentity") extern class LinearOperatorIdentity {
	...
	**/
	public function _min_matrix_dim():Dynamic;
	/**
		Minimum of domain/range dimension, as a tensor.
	**/
	public function _min_matrix_dim_tensor():Dynamic;
	/**
