...
@:pythonImport("tensorflow.python.ops.gen_parsing_ops") extern class Gen_parsing_ops_Module {
	...
	static public var _parse_example_outputs : Dynamic;
	static public var _parse_sequence_example_outputs : Dynamic;
	static public var _parse_single_example_outputs : Dynamic;
	static public var _parse_single_sequence_example_outputs : Dynamic;
	/**
		Decompress strings.
