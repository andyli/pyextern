...
package tensorflow.python.ops.seq2seq;
@:pythonImport("tensorflow.python.ops.seq2seq") extern class Seq2seq_Module {
	...
	**/
	static public function linear(args:Dynamic, output_size:Dynamic, bias:Dynamic, ?bias_start:Dynamic, ?scope:Dynamic):Dynamic;
	/**
	...
	**/
	static public function one2many_rnn_seq2seq(encoder_inputs:Dynamic, decoder_inputs_dict:Dynamic, cell:Dynamic, num_encoder_symbols:Dynamic, num_decoder_symbols_dict:Dynamic, embedding_size:Dynamic, ?feed_previous:Dynamic, ?dtype:Dynamic, ?scope:Dynamic):Dynamic;
