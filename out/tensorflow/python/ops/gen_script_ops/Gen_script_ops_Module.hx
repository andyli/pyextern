...
@:pythonImport("tensorflow.python.ops.gen_script_ops") extern class Gen_script_ops_Module {
	...
	**/
	static public function eager_py_func(input:Dynamic, token:Dynamic, Tout:Dynamic, ?name:Dynamic):Dynamic;
	/**
		This is the slowpath function for Eager mode.
		This is for function eager_py_func
	**/
	static public function eager_py_func_eager_fallback(input:Dynamic, token:Dynamic, Tout:Dynamic, ?name:Dynamic, ?ctx:Dynamic):Dynamic;
	/**
