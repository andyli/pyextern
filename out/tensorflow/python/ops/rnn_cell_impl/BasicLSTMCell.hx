...
@:pythonImport("tensorflow.python.ops.rnn_cell_impl", "BasicLSTMCell") extern class BasicLSTMCell {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(num_units:Dynamic, ?forget_bias:Dynamic, ?state_is_tuple:Dynamic, ?activation:Dynamic, ?reuse:Dynamic):Dynamic;
	/**
		Initialize the basic LSTM cell.
		...
		Args:
		  ...
		  reuse: (optional) Python boolean describing whether to reuse variables
		    ...
		    the given variables, an error is raised.
	**/
	public function new(num_units:Dynamic, ?forget_bias:Dynamic, ?state_is_tuple:Dynamic, ?activation:Dynamic, ?reuse:Dynamic):Void;
	/**
