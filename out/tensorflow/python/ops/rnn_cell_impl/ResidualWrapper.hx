...
@:pythonImport("tensorflow.python.ops.rnn_cell_impl", "ResidualWrapper") extern class ResidualWrapper {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(cell:Dynamic, ?residual_fn:Dynamic):Dynamic;
	/**
		Constructs a `ResidualWrapper` for `cell`.
		...
		Args:
		  ...
		  residual_fn: (Optional) The function to map raw cell inputs and raw cell
		    ...
		    and outputs.
	**/
	public function new(cell:Dynamic, ?residual_fn:Dynamic):Void;
	/**
