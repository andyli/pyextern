...
@:pythonImport("tensorflow.python.ops.rnn_cell_impl", "_SlimRNNCell") extern class _SlimRNNCell {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(cell_fn:Dynamic):Dynamic;
	/**
		Create a SlimRNNCell from a cell_fn.
		...
		Raises:
		  ...
		  ValueError: if cell_fn cannot produce a valid initial state.
	**/
	public function new(cell_fn:Dynamic):Void;
	/**
