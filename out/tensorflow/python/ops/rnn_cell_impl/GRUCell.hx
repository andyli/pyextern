...
@:pythonImport("tensorflow.python.ops.rnn_cell_impl", "GRUCell") extern class GRUCell {
	...
	**/
	@:native("__init__")
	public function ___init__(num_units:Dynamic, ?activation:Dynamic, ?reuse:Dynamic, ?kernel_initializer:Dynamic, ?bias_initializer:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(num_units:Dynamic, ?activation:Dynamic, ?reuse:Dynamic, ?kernel_initializer:Dynamic, ?bias_initializer:Dynamic):Void;
	/**
