...
@:pythonImport("tensorflow.python.ops.rnn_cell_impl", "BasicRNNCell") extern class BasicRNNCell {
	...
	**/
	@:native("__init__")
	public function ___init__(num_units:Dynamic, ?activation:Dynamic, ?reuse:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(num_units:Dynamic, ?activation:Dynamic, ?reuse:Dynamic):Void;
	/**
