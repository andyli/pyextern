...
@:pythonImport("tensorflow.python.ops.rnn_cell_impl", "DropoutWrapper") extern class DropoutWrapper {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(cell:Dynamic, ?input_keep_prob:Dynamic, ?output_keep_prob:Dynamic, ?state_keep_prob:Dynamic, ?variational_recurrent:Dynamic, ?input_size:Dynamic, ?dtype:Dynamic, ?seed:Dynamic):Dynamic;
	/**
		Create a cell with added input, state, and/or output dropout.
		...
		Raises:
		  ...
		  ValueError: if any of the keep_probs are not between 0 and 1.
	**/
	public function new(cell:Dynamic, ?input_keep_prob:Dynamic, ?output_keep_prob:Dynamic, ?state_keep_prob:Dynamic, ?variational_recurrent:Dynamic, ?input_size:Dynamic, ?dtype:Dynamic, ?seed:Dynamic):Void;
	/**
	...
	**/
	public function _dropout(values:Dynamic, salt_prefix:Dynamic, recurrent_noise:Dynamic, keep_prob:Dynamic):Dynamic;
	...
	**/
	public function _variational_recurrent_dropout_value(index:Dynamic, value:Dynamic, noise:Dynamic, keep_prob:Dynamic):Dynamic;
	/**
