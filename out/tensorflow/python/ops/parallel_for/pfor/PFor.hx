...
@:pythonImport("tensorflow.python.ops.parallel_for.pfor", "PFor") extern class PFor {
	...
	**/
	@:native("__init__")
	public function ___init__(loop_var:Dynamic, loop_len:Dynamic, pfor_ops:Dynamic, ?all_indices:Dynamic, ?all_indices_partitioned:Dynamic):Dynamic;
	/**
		Creates an object to rewrite a parallel-for loop.
		...
		Args:
		  ...
		  all_indices_partitioned: If True, this object is being constructed from a
		   ...
		   to be active.
	**/
	public function new(loop_var:Dynamic, loop_len:Dynamic, pfor_ops:Dynamic, ?all_indices:Dynamic, ?all_indices_partitioned:Dynamic):Void;
	/**
