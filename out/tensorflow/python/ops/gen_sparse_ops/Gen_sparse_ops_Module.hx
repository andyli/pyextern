...
@:pythonImport("tensorflow.python.ops.gen_sparse_ops") extern class Gen_sparse_ops_Module {
	...
	static public var __deserialize_many_sparse_outputs : Dynamic;
	...
	**/
	static public function _deserialize_many_sparse(serialized_sparse:Dynamic, dtype:Dynamic, ?name:Dynamic):Dynamic;
	...
	**/
	static public function _serialize_many_sparse(sparse_indices:Dynamic, sparse_values:Dynamic, sparse_shape:Dynamic, ?name:Dynamic):Dynamic;
	/**
		...
		Returns:
		  A `Tensor` of type `string`.
	**/
	static public function _serialize_sparse(sparse_indices:Dynamic, sparse_values:Dynamic, sparse_shape:Dynamic, ?name:Dynamic):Dynamic;
	/**
	...
	**/
	static public function _sparse_add(a_indices:Dynamic, a_values:Dynamic, a_shape:Dynamic, b_indices:Dynamic, b_values:Dynamic, b_shape:Dynamic, thresh:Dynamic, ?name:Dynamic):Dynamic;
	/**
	...
	**/
	static public function _sparse_add_grad(backprop_val_grad:Dynamic, a_indices:Dynamic, b_indices:Dynamic, sum_indices:Dynamic, ?name:Dynamic):Dynamic;
	/**
	...
	**/
	static public function _sparse_reorder(input_indices:Dynamic, input_values:Dynamic, input_shape:Dynamic, ?name:Dynamic):Dynamic;
	/**
	...
	**/
	static public function _sparse_tensor_dense_add(a_indices:Dynamic, a_values:Dynamic, a_shape:Dynamic, b:Dynamic, ?name:Dynamic):Dynamic;
	/**
		...
		Returns:
		  A `Tensor`. Has the same type as `a_values`.
	**/
	static public function _sparse_tensor_dense_mat_mul(a_indices:Dynamic, a_values:Dynamic, a_shape:Dynamic, b:Dynamic, ?adjoint_a:Dynamic, ?adjoint_b:Dynamic, ?name:Dynamic):Dynamic;
	/**
