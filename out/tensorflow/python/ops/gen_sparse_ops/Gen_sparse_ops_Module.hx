...
@:pythonImport("tensorflow.python.ops.gen_sparse_ops") extern class Gen_sparse_ops_Module {
	...
	static public var _deserialize_many_sparse_outputs : Dynamic;
	static public var _deserialize_sparse_outputs : Dynamic;
	static public var _op_def_lib : Dynamic;
	static public var _sparse_add_grad_outputs : Dynamic;
	static public var _sparse_add_outputs : Dynamic;
	static public var _sparse_concat_outputs : Dynamic;
	static public var _sparse_cross_outputs : Dynamic;
	static public var _sparse_fill_empty_rows_grad_outputs : Dynamic;
	static public var _sparse_fill_empty_rows_outputs : Dynamic;
	static public var _sparse_reduce_max_sparse_outputs : Dynamic;
	static public var _sparse_reduce_sum_sparse_outputs : Dynamic;
	static public var _sparse_reorder_outputs : Dynamic;
	static public var _sparse_reshape_outputs : Dynamic;
	static public var _sparse_slice_outputs : Dynamic;
	static public var _sparse_sparse_maximum_outputs : Dynamic;
	static public var _sparse_sparse_minimum_outputs : Dynamic;
	static public var _sparse_split_outputs : Dynamic;
	static public var _take_many_sparse_from_tensors_map_outputs : Dynamic;
	/**
