...
@:pythonImport("tensorflow.python.ops.init_ops", "Identity") extern class Identity {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(?gain:Dynamic, ?dtype:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(?gain:Dynamic, ?dtype:Dynamic):Void;
	/**
