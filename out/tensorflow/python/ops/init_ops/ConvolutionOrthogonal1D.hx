...
@:pythonImport("tensorflow.python.ops.init_ops", "ConvolutionOrthogonal1D") extern class ConvolutionOrthogonal1D {
	/**
	...
	**/
	public function _block_orth(projection_matrix:Dynamic):Dynamic;
	/**
	...
	**/
	public function _dict_to_tensor(x:Dynamic, k:Dynamic):Dynamic;
	/**
		Matrix convolution.
