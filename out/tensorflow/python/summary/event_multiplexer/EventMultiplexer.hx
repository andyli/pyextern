...
package tensorflow.python.summary.event_multiplexer;
@:pythonImport("tensorflow.python.summary.event_multiplexer", "EventMultiplexer") extern class EventMultiplexer {
	/**
