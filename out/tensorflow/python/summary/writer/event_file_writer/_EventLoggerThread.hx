...
@:pythonImport("tensorflow.python.summary.writer.event_file_writer", "_EventLoggerThread") extern class _EventLoggerThread {
	...
	**/
	@:native("__init__")
	public function ___init__(queue:Dynamic, ev_writer:Dynamic, flush_secs:Dynamic, sentinel_event:Dynamic):Dynamic;
	/**
		Creates an _EventLoggerThread.
		...
		Args:
		  ...
		  sentinel_event: A sentinel element in queue that tells this thread to
		    terminate.
	**/
	public function new(queue:Dynamic, ev_writer:Dynamic, flush_secs:Dynamic, sentinel_event:Dynamic):Void;
	/**
