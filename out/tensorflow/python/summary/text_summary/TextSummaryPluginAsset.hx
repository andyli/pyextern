...
@:pythonImport("tensorflow.python.summary.text_summary", "TextSummaryPluginAsset") extern class TextSummaryPluginAsset {
	...
	**/
	public function register_tensor(name:Dynamic):Dynamic;
}