...
package tensorflow.python.summary.impl.directory_watcher;
@:pythonImport("tensorflow.python.summary.impl.directory_watcher", "DirectoryWatcher") extern class DirectoryWatcher {
	/**
		Loads new values.
