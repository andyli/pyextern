...
@:pythonImport("tensorflow.python.summary.impl.reservoir", "_ReservoirBucket") extern class _ReservoirBucket {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(_max_size:Dynamic, ?_random:Dynamic):Dynamic;
	/**
		Create the _ReservoirBucket.
		...
		Raises:
		  ValueError: if the size is not a nonnegative integer.
	**/
	public function new(_max_size:Dynamic, ?_random:Dynamic):Void;
	/**
		Return self<=value.
	**/
