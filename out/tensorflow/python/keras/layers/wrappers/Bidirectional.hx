...
@:pythonImport("tensorflow.python.keras.layers.wrappers", "Bidirectional") extern class Bidirectional {
	...
	**/
	...
	@:native("__init__")
	public function ___init__(layer:Dynamic, ?merge_mode:Dynamic, ?weights:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	public function new(layer:Dynamic, ?merge_mode:Dynamic, ?weights:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Void;
	/**
