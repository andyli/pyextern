...
@:pythonImport("tensorflow.python.keras.layers.recurrent", "GRUCell") extern class GRUCell {
	/**
	...
	**/
	...
	@:native("__init__")
	public function ___init__(units:Dynamic, ?activation:Dynamic, ?recurrent_activation:Dynamic, ?use_bias:Dynamic, ?kernel_initializer:Dynamic, ?recurrent_initializer:Dynamic, ?bias_initializer:Dynamic, ?kernel_regularizer:Dynamic, ?recurrent_regularizer:Dynamic, ?bias_regularizer:Dynamic, ?kernel_constraint:Dynamic, ?recurrent_constraint:Dynamic, ?bias_constraint:Dynamic, ?dropout:Dynamic, ?recurrent_dropout:Dynamic, ?implementation:Dynamic, ?reset_after:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
