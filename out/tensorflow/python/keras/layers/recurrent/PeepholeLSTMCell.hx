...
@:pythonImport("tensorflow.python.keras.layers.recurrent", "PeepholeLSTMCell") extern class PeepholeLSTMCell {
	/**
	...
	**/
	public function _compute_carry_and_output(x:Dynamic, h_tm1:Dynamic, c_tm1:Dynamic):Dynamic;
	/**
		Computes carry and output using fused kernels.
	**/
	public function _compute_carry_and_output_fused(z:Dynamic, c_tm1:Dynamic):Dynamic;
	/**
