...
package tensorflow.python.keras.layers.noise;
@:pythonImport("tensorflow.python.keras.layers.noise", "AlphaDropout") extern class AlphaDropout {
	/**
	...
	**/
	...
	@:native("__init__")
	public function ___init__(rate:Dynamic, ?noise_shape:Dynamic, ?seed:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	public function new(rate:Dynamic, ?noise_shape:Dynamic, ?seed:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Void;
	/**
