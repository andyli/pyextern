...
@:pythonImport("tensorflow.python.keras.layers.noise", "GaussianNoise") extern class GaussianNoise {
	/**
	...
	**/
	...
	@:native("__init__")
	public function ___init__(stddev:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	public function new(stddev:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Void;
	/**
