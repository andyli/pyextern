...
@:pythonImport("tensorflow.python.keras.layers.noise", "GaussianDropout") extern class GaussianDropout {
	/**
	...
	**/
	...
	@:native("__init__")
	public function ___init__(rate:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	public function new(rate:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Void;
	/**
