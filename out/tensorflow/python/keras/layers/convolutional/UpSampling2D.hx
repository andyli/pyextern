...
@:pythonImport("tensorflow.python.keras.layers.convolutional", "UpSampling2D") extern class UpSampling2D {
	/**
	...
	**/
	...
	@:native("__init__")
	public function ___init__(?size:Dynamic, ?data_format:Dynamic, ?interpolation:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	public function new(?size:Dynamic, ?data_format:Dynamic, ?interpolation:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Void;
	/**
