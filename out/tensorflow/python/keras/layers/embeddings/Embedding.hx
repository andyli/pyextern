...
package tensorflow.python.keras.layers.embeddings;
@:pythonImport("tensorflow.python.keras.layers.embeddings", "Embedding") extern class Embedding {
	/**
	...
	**/
	...
	@:native("__init__")
	public function ___init__(input_dim:Dynamic, output_dim:Dynamic, ?embeddings_initializer:Dynamic, ?embeddings_regularizer:Dynamic, ?activity_regularizer:Dynamic, ?embeddings_constraint:Dynamic, ?mask_zero:Dynamic, ?input_length:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	public function new(input_dim:Dynamic, output_dim:Dynamic, ?embeddings_initializer:Dynamic, ?embeddings_regularizer:Dynamic, ?activity_regularizer:Dynamic, ?embeddings_constraint:Dynamic, ?mask_zero:Dynamic, ?input_length:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Void;
	/**
