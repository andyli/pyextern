...
@:pythonImport("tensorflow.python.keras.layers.advanced_activations", "LeakyReLU") extern class LeakyReLU {
	/**
	...
	**/
	...
	@:native("__init__")
	public function ___init__(?alpha:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	public function new(?alpha:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Void;
	/**
