...
package tensorflow.python.keras.layers.pooling;
@:pythonImport("tensorflow.python.keras.layers.pooling", "Pooling1D") extern class Pooling1D {
	/**
	...
	**/
	...
	@:native("__init__")
	public function ___init__(pool_function:Dynamic, pool_size:Dynamic, strides:Dynamic, ?padding:Dynamic, ?data_format:Dynamic, ?name:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	public function new(pool_function:Dynamic, pool_size:Dynamic, strides:Dynamic, ?padding:Dynamic, ?data_format:Dynamic, ?name:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Void;
	/**
