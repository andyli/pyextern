...
@:pythonImport("tensorflow.python.keras.layers.convolutional_recurrent", "ConvLSTM2DCell") extern class ConvLSTM2DCell {
	/**
	...
	**/
	public function call(inputs:Dynamic, states:Dynamic, ?training:Dynamic):Dynamic;
	/**
	...
	**/
	...
	public function recurrent_conv(x:Dynamic, w:Dynamic):Dynamic;
	/**
