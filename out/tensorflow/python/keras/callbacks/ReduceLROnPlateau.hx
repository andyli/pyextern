...
@:pythonImport("tensorflow.python.keras.callbacks", "ReduceLROnPlateau") extern class ReduceLROnPlateau {
	...
	**/
	@:native("__init__")
	public function ___init__(?monitor:Dynamic, ?factor:Dynamic, ?patience:Dynamic, ?verbose:Dynamic, ?mode:Dynamic, ?min_delta:Dynamic, ?cooldown:Dynamic, ?min_lr:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(?monitor:Dynamic, ?factor:Dynamic, ?patience:Dynamic, ?verbose:Dynamic, ?mode:Dynamic, ?min_delta:Dynamic, ?cooldown:Dynamic, ?min_lr:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Void;
	/**
