...
@:pythonImport("tensorflow.python.keras.losses", "CategoricalCrossentropy") extern class CategoricalCrossentropy {
	...
	**/
	@:native("__init__")
	public function ___init__(?from_logits:Dynamic, ?label_smoothing:Dynamic, ?reduction:Dynamic, ?name:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(?from_logits:Dynamic, ?label_smoothing:Dynamic, ?reduction:Dynamic, ?name:Dynamic):Void;
	/**
