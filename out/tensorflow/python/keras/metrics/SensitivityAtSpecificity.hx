...
@:pythonImport("tensorflow.python.keras.metrics", "SensitivityAtSpecificity") extern class SensitivityAtSpecificity {
	...
	**/
	@:native("__init__")
	public function ___init__(specificity:Dynamic, ?num_thresholds:Dynamic, ?name:Dynamic, ?dtype:Dynamic):Dynamic;
	/**
		Creates a `SensitivityAtSpecificity` instance.
		...
		Args:
		  ...
		  dtype: (Optional) data type of the metric result.
	**/
	public function new(specificity:Dynamic, ?num_thresholds:Dynamic, ?name:Dynamic, ?dtype:Dynamic):Void;
	/**
