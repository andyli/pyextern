...
@:pythonImport("tensorflow.python.keras.metrics", "SpecificityAtSensitivity") extern class SpecificityAtSensitivity {
	...
	**/
	@:native("__init__")
	public function ___init__(sensitivity:Dynamic, ?num_thresholds:Dynamic, ?name:Dynamic, ?dtype:Dynamic):Dynamic;
	/**
		Creates a `SpecificityAtSensitivity` instance.
		...
		Args:
		  ...
		  dtype: (Optional) data type of the metric result.
	**/
	public function new(sensitivity:Dynamic, ?num_thresholds:Dynamic, ?name:Dynamic, ?dtype:Dynamic):Void;
	/**
