...
@:pythonImport("tensorflow.python.keras.metrics", "SensitivitySpecificityBase") extern class SensitivitySpecificityBase {
	...
	**/
	...
	@:native("__init__")
	public function ___init__(value:Dynamic, ?num_thresholds:Dynamic, ?name:Dynamic, ?dtype:Dynamic):Dynamic;
	public function new(value:Dynamic, ?num_thresholds:Dynamic, ?name:Dynamic, ?dtype:Dynamic):Void;
	/**
