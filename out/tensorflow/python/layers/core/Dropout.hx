...
@:pythonImport("tensorflow.python.layers.core", "Dropout") extern class Dropout {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(?rate:Dynamic, ?noise_shape:Dynamic, ?seed:Dynamic, ?name:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(?rate:Dynamic, ?noise_shape:Dynamic, ?seed:Dynamic, ?name:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Void;
	/**
	...
	**/
	...
	public function _get_noise_shape(_:Dynamic):Dynamic;
