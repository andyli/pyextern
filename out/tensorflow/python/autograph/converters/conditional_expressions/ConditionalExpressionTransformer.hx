...
package tensorflow.python.autograph.converters.conditional_expressions;
@:pythonImport("tensorflow.python.autograph.converters.conditional_expressions", "ConditionalExpressionTransformer") extern class ConditionalExpressionTransformer {
	...
	**/
	...
	public function _create_branch(expr:Dynamic, name_stem:Dynamic):Dynamic;
	...
	**/
	...
	public function _process_block(scope:Dynamic, block:Dynamic):Dynamic;
	/**
