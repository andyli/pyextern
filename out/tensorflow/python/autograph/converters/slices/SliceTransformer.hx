...
package tensorflow.python.autograph.converters.slices;
@:pythonImport("tensorflow.python.autograph.converters.slices", "SliceTransformer") extern class SliceTransformer {
	...
	**/
	...
	public function _process_single_assignment(target:Dynamic, value:Dynamic):Dynamic;
	/**
