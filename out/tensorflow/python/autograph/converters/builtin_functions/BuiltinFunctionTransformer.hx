...
package tensorflow.python.autograph.converters.builtin_functions;
@:pythonImport("tensorflow.python.autograph.converters.builtin_functions", "BuiltinFunctionTransformer") extern class BuiltinFunctionTransformer {
	...
	**/
	...
	public function _convert_builtin(f:Dynamic, args:Dynamic, as_expression:Dynamic):Dynamic;
