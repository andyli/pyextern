...
@:pythonImport("tensorflow.python.autograph.converters.logical_expressions", "LogicalExpressionTransformer") extern class LogicalExpressionTransformer {
	...
	**/
	...
	public function _as_function(func_name:Dynamic, args:Dynamic, ?args_as_lambda:Dynamic):Dynamic;
	public function _expect_simple_symbol(operand:Dynamic):Dynamic;
	public function _get_source(node:Dynamic):Dynamic;
	public function _has_matching_func(_operator:Dynamic):Dynamic;
	public function _matching_func(_operator:Dynamic):Dynamic;
	/**
