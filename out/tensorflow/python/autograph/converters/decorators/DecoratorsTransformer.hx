...
package tensorflow.python.autograph.converters.decorators;
@:pythonImport("tensorflow.python.autograph.converters.decorators", "DecoratorsTransformer") extern class DecoratorsTransformer {
