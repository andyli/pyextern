...
package tensorflow.python.autograph.converters.side_effect_guards;
@:pythonImport("tensorflow.python.autograph.converters.side_effect_guards", "SideEffectGuardTransformer") extern class SideEffectGuardTransformer {
	...
	**/
	...
	public function _visit_and_reindent(nodes:Dynamic):Dynamic;
	/**
