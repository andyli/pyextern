...
package tensorflow.python.autograph.converters.asserts;
@:pythonImport("tensorflow.python.autograph.converters.asserts", "AssertTransformer") extern class AssertTransformer {
