...
@:pythonImport("tensorflow.python.autograph.converters.return_statements", "BodyVisitor") extern class BodyVisitor {
	...
	**/
	@:native("__init__")
	public function ___init__(ctx:Dynamic, ?depth_first:Dynamic):Dynamic;
	/**
		Initialize the transformer. Subclasses should call this.
		...
		Args:
		  entity_info: An EntityInfo object.
	**/
	public function new(ctx:Dynamic, ?depth_first:Dynamic):Void;
	/**
	...
	**/
	...
	public function visit_nodelist(nodelist:Dynamic):Dynamic;
}