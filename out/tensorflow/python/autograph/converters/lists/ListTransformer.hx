...
package tensorflow.python.autograph.converters.lists;
@:pythonImport("tensorflow.python.autograph.converters.lists", "ListTransformer") extern class ListTransformer {
	...
	**/
	...
	public function _generate_pop_operation(original_call_node:Dynamic, pop_var_name:Dynamic):Dynamic;
	...
	**/
	...
	public function _replace_append_call(node:Dynamic):Dynamic;
	public function _replace_pop_call(node:Dynamic):Dynamic;
	public function _replace_stack_call(node:Dynamic):Dynamic;
	public function _visit_and_process_block(block:Dynamic):Dynamic;
	/**
