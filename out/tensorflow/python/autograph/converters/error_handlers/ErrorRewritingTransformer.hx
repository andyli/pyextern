...
package tensorflow.python.autograph.converters.error_handlers;
@:pythonImport("tensorflow.python.autograph.converters.error_handlers", "ErrorRewritingTransformer") extern class ErrorRewritingTransformer {
