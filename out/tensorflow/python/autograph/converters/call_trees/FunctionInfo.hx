...
@:pythonImport("tensorflow.python.autograph.converters.call_trees", "FunctionInfo") extern class FunctionInfo {
	/**
		Return self+value.
	**/
	...
	**/
	...
	/**
		Create new instance of FunctionInfo(dtype,)
	**/
	static public function __new__(_cls:Dynamic, dtype:Dynamic):Dynamic;
	/**
		helper for pickle
	**/
	...
	**/
	...
	/**
		Make a new FunctionInfo object from a sequence or iterable
	**/
	static public function _make(iterable:Dynamic, ?_new:Dynamic, ?len:Dynamic):Dynamic;
	/**
		Return a new FunctionInfo object replacing specified fields with new values
	**/
