...
@:pythonImport("tensorflow.python.autograph.converters.call_trees", "CallTreeTransformer") extern class CallTreeTransformer {
	...
	**/
	public function _function_is_compilable(target_entity:Dynamic):Dynamic;
	public function _get_source(node:Dynamic):Dynamic;
	/**
		Inlines a dynamic conversion for a dynamic function.
	**/
	public function _insert_dynamic_conversion(node:Dynamic):Dynamic;
	public function _rename_compilable_function(node:Dynamic):Dynamic;
	/**
	...
	**/
	public function _should_compile(node:Dynamic, fqn:Dynamic):Dynamic;
	/**
