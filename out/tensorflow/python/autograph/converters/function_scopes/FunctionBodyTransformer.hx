...
package tensorflow.python.autograph.converters.function_scopes;
@:pythonImport("tensorflow.python.autograph.converters.function_scopes", "FunctionBodyTransformer") extern class FunctionBodyTransformer {
	...
	**/
	...
	public function _name_for_current_scope():Dynamic;
	/**
