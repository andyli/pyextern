...
@:pythonImport("tensorflow.python.autograph.operators.data_structures", "ListPopOpts") extern class ListPopOpts {
	/**
		Return self+value.
	**/
	...
	**/
	...
	/**
		Create new instance of ListPopOpts(element_dtype, element_shape)
	**/
	static public function __new__(_cls:Dynamic, element_dtype:Dynamic, element_shape:Dynamic):Dynamic;
	/**
		helper for pickle
	**/
	...
	**/
	...
	/**
		Make a new ListPopOpts object from a sequence or iterable
	**/
	static public function _make(iterable:Dynamic, ?_new:Dynamic, ?len:Dynamic):Dynamic;
	/**
		Return a new ListPopOpts object replacing specified fields with new values
	**/
