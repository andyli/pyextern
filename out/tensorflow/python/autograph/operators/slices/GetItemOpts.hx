...
@:pythonImport("tensorflow.python.autograph.operators.slices", "GetItemOpts") extern class GetItemOpts {
	/**
		Return self+value.
	**/
	...
	**/
	...
	/**
		Create new instance of GetItemOpts(element_dtype,)
	**/
	static public function __new__(_cls:Dynamic, element_dtype:Dynamic):Dynamic;
	/**
		helper for pickle
	**/
	...
	**/
	...
	/**
		Make a new GetItemOpts object from a sequence or iterable
	**/
	static public function _make(iterable:Dynamic, ?_new:Dynamic, ?len:Dynamic):Dynamic;
	/**
		Return a new GetItemOpts object replacing specified fields with new values
	**/
