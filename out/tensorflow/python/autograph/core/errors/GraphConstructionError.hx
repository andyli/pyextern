...
@:pythonImport("tensorflow.python.autograph.core.errors", "GraphConstructionError") extern class GraphConstructionError {
	/**
		exception cause
	**/
	...
	**/
	@:native("__init__")
	public function ___init__(original_error:Dynamic, custom_traceback:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(original_error:Dynamic, custom_traceback:Dynamic):Void;
	/**
