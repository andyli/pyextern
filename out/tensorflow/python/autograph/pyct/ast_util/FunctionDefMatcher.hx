...
@:pythonImport("tensorflow.python.autograph.pyct.ast_util", "FunctionDefMatcher") extern class FunctionDefMatcher {
	...
	**/
	...
	public function _arg_name(node:Dynamic):Dynamic;
	public function _argspec_matches(node:Dynamic):Dynamic;
	/**
