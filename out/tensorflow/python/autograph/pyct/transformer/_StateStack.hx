...
@:pythonImport("tensorflow.python.autograph.pyct.transformer", "_StateStack") extern class _StateStack {
	...
	**/
	@:native("__init__")
	public function ___init__(type_:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(type_:Dynamic):Void;
	/**
