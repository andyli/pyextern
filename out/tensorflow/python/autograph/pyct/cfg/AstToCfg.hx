...
@:pythonImport("tensorflow.python.autograph.pyct.cfg", "AstToCfg") extern class AstToCfg {
	...
	**/
	...
	public function _get_enclosing_scopes(include:Dynamic, stop_at:Dynamic):Dynamic;
	...
	public function _process_exit_statement(node:Dynamic, ?exits_nodes_of_type:python.VarArgs<Dynamic>):Dynamic;
	/**
