...
package tensorflow.python.autograph.pyct.static_analysis.type_info;
@:pythonImport("tensorflow.python.autograph.pyct.static_analysis.type_info", "TypeInfoResolver") extern class TypeInfoResolver {
	...
	**/
	@:native("__init__")
	public function ___init__(context:Dynamic):Dynamic;
	/**
		Initialize the transformer. Subclasses should call this.
	...
	**/
	...
	public function _process_function_arg(arg_node:Dynamic):Dynamic;
	public function _process_variable_assignment(target:Dynamic, value:Dynamic):Dynamic;
	public function _visit_block(block:Dynamic):Dynamic;
	/**
	...
	**/
	...
	public function visit_arg(node:Dynamic):Dynamic;
	/**
