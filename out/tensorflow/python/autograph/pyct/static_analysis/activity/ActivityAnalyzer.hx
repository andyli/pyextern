...
@:pythonImport("tensorflow.python.autograph.pyct.static_analysis.activity", "ActivityAnalyzer") extern class ActivityAnalyzer {
	...
	**/
	@:native("__init__")
	public function ___init__(context:Dynamic, ?parent_scope:Dynamic, ?add_unknown_symbols:Dynamic):Dynamic;
	/**
		Initialize the transformer. Subclasses should call this.
		...
		Args:
		  entity_info: An EntityInfo object.
	**/
	public function new(context:Dynamic, ?parent_scope:Dynamic, ?add_unknown_symbols:Dynamic):Void;
	/**
	...
	**/
	...
	public function _enter_scope(isolated:Dynamic):Dynamic;
	...
	**/
	...
	public function visit_arguments(node:Dynamic):Dynamic;
	/**
