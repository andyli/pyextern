...
@:pythonImport("tensorflow.python.autograph.pyct.static_analysis.reaching_definitions", "TreeAnnotator") extern class TreeAnnotator {
	...
	**/
	@:native("__init__")
	public function ___init__(source_info:Dynamic, graphs:Dynamic, definition_factory:Dynamic):Dynamic;
	/**
		Initialize the transformer. Subclasses should call this.
		...
		Args:
		  entity_info: An EntityInfo object.
	**/
	public function new(source_info:Dynamic, graphs:Dynamic, definition_factory:Dynamic):Void;
	/**
	...
	**/
	...
	public function _aggregate_predecessors_defined_in(node:Dynamic):Dynamic;
