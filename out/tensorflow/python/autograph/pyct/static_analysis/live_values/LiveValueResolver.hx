...
@:pythonImport("tensorflow.python.autograph.pyct.static_analysis.live_values", "LiveValueResolver") extern class LiveValueResolver {
	...
	**/
	@:native("__init__")
	public function ___init__(context:Dynamic, literals:Dynamic):Dynamic;
	/**
		Initialize the transformer. Subclasses should call this.
		...
		Args:
		  entity_info: An EntityInfo object.
	**/
	public function new(context:Dynamic, literals:Dynamic):Void;
	/**
