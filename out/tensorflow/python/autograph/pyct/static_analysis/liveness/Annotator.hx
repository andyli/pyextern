...
@:pythonImport("tensorflow.python.autograph.pyct.static_analysis.liveness", "Annotator") extern class Annotator {
	...
	**/
	@:native("__init__")
	public function ___init__(source_info:Dynamic, cross_function_analyzer:Dynamic):Dynamic;
	/**
		Initialize the transformer. Subclasses should call this.
		...
		Args:
		  entity_info: An EntityInfo object.
	**/
	public function new(source_info:Dynamic, cross_function_analyzer:Dynamic):Void;
	/**
