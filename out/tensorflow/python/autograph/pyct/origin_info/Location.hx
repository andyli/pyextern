...
@:pythonImport("tensorflow.python.autograph.pyct.origin_info", "Location") extern class Location {
	/**
		Return self+value.
	**/
	...
	**/
	...
	/**
		Create new instance of Location(filename, lineno, col_offset)
	**/
	static public function __new__(_cls:Dynamic, filename:Dynamic, lineno:Dynamic, col_offset:Dynamic):Dynamic;
	/**
		helper for pickle
	**/
