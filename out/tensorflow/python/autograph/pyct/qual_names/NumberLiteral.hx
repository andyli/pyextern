...
@:pythonImport("tensorflow.python.autograph.pyct.qual_names", "NumberLiteral") extern class NumberLiteral {
	/**
		Return self+value.
	**/
	...
	**/
	...
	/**
		Create new instance of NumberLiteral(value,)
	**/
	...
	**/
	...
	/**
		Make a new NumberLiteral object from a sequence or iterable
	**/
	static public function _make(iterable:Dynamic, ?_new:Dynamic, ?len:Dynamic):Dynamic;
	/**
		Return a new NumberLiteral object replacing specified fields with new values
	**/
