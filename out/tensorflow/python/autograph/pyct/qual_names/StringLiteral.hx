...
@:pythonImport("tensorflow.python.autograph.pyct.qual_names", "StringLiteral") extern class StringLiteral {
	/**
		Return self+value.
	**/
	...
	**/
	...
	/**
		Create new instance of StringLiteral(value,)
	**/
	static public function __new__(_cls:Dynamic, value:Dynamic):Dynamic;
	/**
		helper for pickle
	**/
	...
	**/
	...
	/**
		Make a new StringLiteral object from a sequence or iterable
	**/
	static public function _make(iterable:Dynamic, ?_new:Dynamic, ?len:Dynamic):Dynamic;
	/**
		Return a new StringLiteral object replacing specified fields with new values
	**/
