...
package tensorflow.python.autograph.utils.multiple_dispatch;
@:pythonImport("tensorflow.python.autograph.utils.multiple_dispatch") extern class Multiple_dispatch_Module {
	...
	**/
	static public function py_cond(condition:Dynamic, true_fn:Dynamic, false_fn:Dynamic):Dynamic;
	/**
