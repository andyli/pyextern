...
@:pythonImport("tensorflow.python.autograph.utils.py_func", "MatchDType") extern class MatchDType {
	/**
		Return self+value.
	**/
	...
	**/
	...
	/**
		Create new instance of MatchDType(arg_number,)
	**/
	static public function __new__(_cls:Dynamic, arg_number:Dynamic):Dynamic;
	/**
		helper for pickle
	**/
	...
	**/
	...
	/**
		Make a new MatchDType object from a sequence or iterable
	**/
	static public function _make(iterable:Dynamic, ?_new:Dynamic, ?len:Dynamic):Dynamic;
	/**
		Return a new MatchDType object replacing specified fields with new values
	**/
