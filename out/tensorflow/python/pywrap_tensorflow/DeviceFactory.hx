...
@:pythonImport("tensorflow.python.pywrap_tensorflow", "DeviceFactory") extern class DeviceFactory {
	static public function AddDevices(args:haxe.extern.Rest<Dynamic>):Dynamic;
