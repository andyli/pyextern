...
@:pythonImport("tensorflow.python.pywrap_tensorflow", "CheckpointReader") extern class CheckpointReader {
	...
	**/
	@:native("__init__")
	public function ___init__(filepattern:Dynamic, out_status:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(filepattern:Dynamic, out_status:Dynamic):Void;
	/**
		Return self<=value.
	**/
