...
@:pythonImport("tensorflow.python.pywrap_tensorflow_internal", "PyRecordWriter") extern class PyRecordWriter {
	public function Close(out_status:Dynamic):Dynamic;
	public function Flush(out_status:Dynamic):Dynamic;
	static public function New(args:haxe.extern.Rest<Dynamic>):Dynamic;
	public function WriteRecord(record:Dynamic, out_status:Dynamic):Dynamic;
