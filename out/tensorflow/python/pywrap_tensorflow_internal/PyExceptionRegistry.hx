...
@:pythonImport("tensorflow.python.pywrap_tensorflow_internal", "PyExceptionRegistry") extern class PyExceptionRegistry {
	static public function Init(args:haxe.extern.Rest<Dynamic>):Dynamic;
