...
@:pythonImport("tensorflow.python.pywrap_tensorflow_internal", "StatSummarizer") extern class StatSummarizer {
	public function GetOutputString():Dynamic;
	public function PrintStepStats():Dynamic;
	public function ProcessStepStats(step_stats:Dynamic):Dynamic;
	public function ProcessStepStatsStr(step_stats_str:Dynamic):Dynamic;
