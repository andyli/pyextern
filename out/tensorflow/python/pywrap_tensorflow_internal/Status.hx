...
@:pythonImport("tensorflow.python.pywrap_tensorflow_internal", "Status") extern class Status {
	public function IgnoreError():Dynamic;
	static public function OK(args:haxe.extern.Rest<Dynamic>):Dynamic;
	public function ToString():Dynamic;
	public function Update(new_status:Dynamic):Dynamic;
	...
	**/
	...
	/**
		Return self==value.
	**/
	public function __eq__(x:Dynamic):Dynamic;
	/**
	...
	**/
	...
	/**
		Return self!=value.
	**/
	public function __ne__(x:Dynamic):Dynamic;
	/**
	...
	**/
	...
	public function error_message():Dynamic;
	public function ok():Dynamic;
}