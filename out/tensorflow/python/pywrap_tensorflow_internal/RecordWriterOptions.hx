...
@:pythonImport("tensorflow.python.pywrap_tensorflow_internal", "RecordWriterOptions") extern class RecordWriterOptions {
	static public function CreateRecordWriterOptions(args:haxe.extern.Rest<Dynamic>):Dynamic;
	...
	**/
	...
	public var zlib_options : Dynamic;
}