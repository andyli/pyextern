...
@:pythonImport("tensorflow.python.pywrap_tensorflow_internal", "TF_AttrMetadata") extern class TF_AttrMetadata {
	...
	**/
	...
	public var is_list : Dynamic;
	public var list_size : Dynamic;
