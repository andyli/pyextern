...
@:pythonImport("tensorflow.python.pywrap_tensorflow_internal", "FileStatistics") extern class FileStatistics {
	...
	**/
	...
	public var is_directory : Dynamic;
	public var length : Dynamic;
	public var mtime_nsec : Dynamic;
}