...
@:pythonImport("tensorflow.python.pywrap_tensorflow_internal", "BufferedInputStream") extern class BufferedInputStream {
	public function ReadLineAsString():Dynamic;
	public function Seek(position:Dynamic):Dynamic;
