...
@:pythonImport("tensorflow.python.estimator.training", "_EvalResult") extern class _EvalResult {
	/**
		Return self+value.
	**/
	...
	**/
	static public function __new__(cls:Dynamic, status:Dynamic, ?metrics:Dynamic, ?checkpoint_path:Dynamic):Dynamic;
	/**
		helper for pickle
	**/
	...
	**/
	...
	/**
		Make a new EvalResult object from a sequence or iterable
	**/
	static public function _make(iterable:Dynamic, ?_new:Dynamic, ?len:Dynamic):Dynamic;
	/**
		Return a new EvalResult object replacing specified fields with new values
	**/
