...
@:pythonImport("tensorflow.python.estimator.training", "_ContinuousEvalListener") extern class _ContinuousEvalListener {
	...
	**/
	public function after_eval(eval_result:Dynamic):Dynamic;
	/**
	...
	**/
	public function before_eval():Dynamic;
}