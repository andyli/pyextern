...
@:pythonImport("tensorflow.python.estimator.training", "_StopAtSecsHook") extern class _StopAtSecsHook {
	...
	**/
	@:native("__init__")
	public function ___init__(stop_after_secs:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(stop_after_secs:Dynamic):Void;
	/**
