...
@:pythonImport("tensorflow.python.estimator.export.export", "SupervisedInputReceiver") extern class SupervisedInputReceiver {
	/**
		Return self+value.
	**/
	...
	**/
	...
	/**
		Create new instance of SupervisedInputReceiver(features, labels, receiver_tensors)
	**/
	static public function __new__(cls:Dynamic, features:Dynamic, labels:Dynamic, receiver_tensors:Dynamic):Dynamic;
	/**
		helper for pickle
	**/
	...
	**/
	...
	/**
		Make a new SupervisedInputReceiver object from a sequence or iterable
	**/
	static public function _make(iterable:Dynamic, ?_new:Dynamic, ?len:Dynamic):Dynamic;
	/**
		Return a new SupervisedInputReceiver object replacing specified fields with new values
	**/
