...
@:pythonImport("tensorflow.python.estimator.export.export", "TensorServingInputReceiver") extern class TensorServingInputReceiver {
	/**
		Return self+value.
	**/
	...
	**/
	...
	/**
		Make a new TensorServingInputReceiver object from a sequence or iterable
	**/
	static public function _make(iterable:Dynamic, ?_new:Dynamic, ?len:Dynamic):Dynamic;
	/**
		Return a new TensorServingInputReceiver object replacing specified fields with new values
	**/
