...
@:pythonImport("tensorflow.python.estimator.gc") extern class Gc_Module {
	...
	/**
		...
		Returns:
		  ...
		  The parsing function is responsible for populating,
		    - Path.export_version
	**/
	static public function _get_paths(base_dir:Dynamic, parser:Dynamic):Dynamic;
	/**
	...
	**/
	static public function _largest_export_versions(n:Dynamic):Dynamic;
	/**
	...
	**/
	static public function _mod_export_version(n:Dynamic):Dynamic;
	/**
		Negate a filter.
	...
	**/
	static public function _negation(f:Dynamic):Dynamic;
	/**
	...
	**/
	static public function _one_of_every_n_export_versions(n:Dynamic):Dynamic;
	/**
		...
		Returns:
		  A filter function that keeps the n largest paths.
	**/
	static public function _union(lf:Dynamic, rf:Dynamic):Dynamic;
