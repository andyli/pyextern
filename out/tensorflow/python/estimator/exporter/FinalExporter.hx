...
@:pythonImport("tensorflow.python.estimator.exporter", "FinalExporter") extern class FinalExporter {
	...
	**/
	@:native("__init__")
	public function ___init__(name:Dynamic, serving_input_receiver_fn:Dynamic, ?assets_extra:Dynamic, ?as_text:Dynamic):Dynamic;
	/**
		Create an `Exporter` to use with `tf.estimator.EvalSpec`.
		...
		Raises:
		  ValueError: if any arguments is invalid.
	**/
	public function new(name:Dynamic, serving_input_receiver_fn:Dynamic, ?assets_extra:Dynamic, ?as_text:Dynamic):Void;
	/**
