...
@:pythonImport("tensorflow.python.estimator.util", "_DatasetInitializerHook") extern class _DatasetInitializerHook {
	...
	**/
	@:native("__init__")
	public function ___init__(iterator:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(iterator:Dynamic):Void;
	/**
