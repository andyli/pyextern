...
@:pythonImport("tensorflow.python.estimator.util", "StrategyInitFinalizeHook") extern class StrategyInitFinalizeHook {
	...
	**/
	@:native("__init__")
	public function ___init__(initialization_fn:Dynamic, finalize_fn:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(initialization_fn:Dynamic, finalize_fn:Dynamic):Void;
	/**
