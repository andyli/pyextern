...
@:pythonImport("tensorflow.python.estimator.estimator", "WarmStartSettings") extern class WarmStartSettings {
	/**
		Return self+value.
	**/
	...
	**/
	static public function __new__(cls:Dynamic, ckpt_to_initialize_from:Dynamic, ?vars_to_warm_start:Dynamic, ?var_name_to_vocab_info:Dynamic, ?var_name_to_prev_var_name:Dynamic):Dynamic;
	/**
		helper for pickle
	**/
	...
	**/
	...
	/**
		Make a new WarmStartSettings object from a sequence or iterable
	**/
	static public function _make(iterable:Dynamic, ?_new:Dynamic, ?len:Dynamic):Dynamic;
	/**
		Return a new WarmStartSettings object replacing specified fields with new values
	**/
	...
	**/
	public var ckpt_to_initialize_from : Dynamic;
	/**
	...
	**/
	public var var_name_to_prev_var_name : Dynamic;
	/**
		Alias for field number 2
	**/
	public var var_name_to_vocab_info : Dynamic;
	/**
		Alias for field number 1
	**/
	public var vars_to_warm_start : Dynamic;
}