...
@:pythonImport("tensorflow.python.estimator.canned.head", "_BinaryLogisticHeadWithSigmoidCrossEntropyLoss") extern class _BinaryLogisticHeadWithSigmoidCrossEntropyLoss {
	...
	**/
	@:native("__init__")
	public function ___init__(?weight_column:Dynamic, ?thresholds:Dynamic, ?label_vocabulary:Dynamic, ?loss_reduction:Dynamic, ?loss_fn:Dynamic, ?name:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(?weight_column:Dynamic, ?thresholds:Dynamic, ?label_vocabulary:Dynamic, ?loss_reduction:Dynamic, ?loss_fn:Dynamic, ?name:Dynamic):Void;
	/**
	...
	**/
	...
	public function _eval_metric_ops(labels:Dynamic, logits:Dynamic, logistic:Dynamic, class_ids:Dynamic, weights:Dynamic, unreduced_loss:Dynamic, regularization_loss:Dynamic):Dynamic;
	/**
