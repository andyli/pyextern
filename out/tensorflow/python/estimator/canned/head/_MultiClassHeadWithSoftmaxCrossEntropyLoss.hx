...
@:pythonImport("tensorflow.python.estimator.canned.head", "_MultiClassHeadWithSoftmaxCrossEntropyLoss") extern class _MultiClassHeadWithSoftmaxCrossEntropyLoss {
	...
	**/
	@:native("__init__")
	public function ___init__(n_classes:Dynamic, ?weight_column:Dynamic, ?label_vocabulary:Dynamic, ?loss_reduction:Dynamic, ?loss_fn:Dynamic, ?name:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(n_classes:Dynamic, ?weight_column:Dynamic, ?label_vocabulary:Dynamic, ?loss_reduction:Dynamic, ?loss_fn:Dynamic, ?name:Dynamic):Void;
	/**
	...
	**/
	public function _eval_metric_ops(labels:Dynamic, class_ids:Dynamic, weights:Dynamic, unreduced_loss:Dynamic, regularization_loss:Dynamic):Dynamic;
	/**
		Converts labels to integer id space.
	**/
	public function _label_ids(labels:Dynamic):Dynamic;
	/**
