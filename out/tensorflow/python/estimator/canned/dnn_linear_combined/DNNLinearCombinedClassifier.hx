...
@:pythonImport("tensorflow.python.estimator.canned.dnn_linear_combined", "DNNLinearCombinedClassifier") extern class DNNLinearCombinedClassifier {
	...
	**/
	@:native("__init__")
	public function ___init__(?model_dir:Dynamic, ?linear_feature_columns:Dynamic, ?linear_optimizer:Dynamic, ?dnn_feature_columns:Dynamic, ?dnn_optimizer:Dynamic, ?dnn_hidden_units:Dynamic, ?dnn_activation_fn:Dynamic, ?dnn_dropout:Dynamic, ?n_classes:Dynamic, ?weight_column:Dynamic, ?label_vocabulary:Dynamic, ?input_layer_partitioner:Dynamic, ?config:Dynamic, ?warm_start_from:Dynamic, ?loss_reduction:Dynamic, ?batch_norm:Dynamic, ?linear_sparse_combiner:Dynamic):Dynamic;
	/**
		Initializes a DNNLinearCombinedClassifier instance.
		...
		Raises:
		  ValueError: If both linear_feature_columns and dnn_features_columns are
		    empty at the same time.
	**/
	public function new(?model_dir:Dynamic, ?linear_feature_columns:Dynamic, ?linear_optimizer:Dynamic, ?dnn_feature_columns:Dynamic, ?dnn_optimizer:Dynamic, ?dnn_hidden_units:Dynamic, ?dnn_activation_fn:Dynamic, ?dnn_dropout:Dynamic, ?n_classes:Dynamic, ?weight_column:Dynamic, ?label_vocabulary:Dynamic, ?input_layer_partitioner:Dynamic, ?config:Dynamic, ?warm_start_from:Dynamic, ?loss_reduction:Dynamic, ?batch_norm:Dynamic, ?linear_sparse_combiner:Dynamic):Void;
	/**
