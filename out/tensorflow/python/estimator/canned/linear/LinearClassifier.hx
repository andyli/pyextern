...
@:pythonImport("tensorflow.python.estimator.canned.linear", "LinearClassifier") extern class LinearClassifier {
	...
	**/
	@:native("__init__")
	public function ___init__(feature_columns:Dynamic, ?model_dir:Dynamic, ?n_classes:Dynamic, ?weight_column:Dynamic, ?label_vocabulary:Dynamic, ?optimizer:Dynamic, ?config:Dynamic, ?partitioner:Dynamic, ?warm_start_from:Dynamic, ?loss_reduction:Dynamic, ?sparse_combiner:Dynamic):Dynamic;
	/**
		Construct a `LinearClassifier` estimator object.
		...
		Raises:
		  ValueError: if n_classes < 2.
	**/
	public function new(feature_columns:Dynamic, ?model_dir:Dynamic, ?n_classes:Dynamic, ?weight_column:Dynamic, ?label_vocabulary:Dynamic, ?optimizer:Dynamic, ?config:Dynamic, ?partitioner:Dynamic, ?warm_start_from:Dynamic, ?loss_reduction:Dynamic, ?sparse_combiner:Dynamic):Void;
	/**
