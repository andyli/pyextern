...
@:pythonImport("tensorflow.python.estimator.canned.linear", "LinearRegressor") extern class LinearRegressor {
	...
	**/
	@:native("__init__")
	public function ___init__(feature_columns:Dynamic, ?model_dir:Dynamic, ?label_dimension:Dynamic, ?weight_column:Dynamic, ?optimizer:Dynamic, ?config:Dynamic, ?partitioner:Dynamic, ?warm_start_from:Dynamic, ?loss_reduction:Dynamic, ?sparse_combiner:Dynamic):Dynamic;
	/**
		Initializes a `LinearRegressor` instance.
		...
		Args:
		  ...
		  sparse_combiner: A string specifying how to reduce if a categorical column
		    ...
		    `tf.feature_column.linear_model`.
	**/
	public function new(feature_columns:Dynamic, ?model_dir:Dynamic, ?label_dimension:Dynamic, ?weight_column:Dynamic, ?optimizer:Dynamic, ?config:Dynamic, ?partitioner:Dynamic, ?warm_start_from:Dynamic, ?loss_reduction:Dynamic, ?sparse_combiner:Dynamic):Void;
	/**
