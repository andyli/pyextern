...
@:pythonImport("tensorflow.python.estimator.canned.boosted_trees", "_BoostedTreesBase") extern class _BoostedTreesBase {
	...
	**/
	@:native("__init__")
	public function ___init__(model_fn:Dynamic, model_dir:Dynamic, config:Dynamic, feature_columns:Dynamic, head:Dynamic, center_bias:Dynamic, is_classification:Dynamic):Dynamic;
	/**
		Initializes a `_BoostedTreesBase` instance.
		...
		Args:
		  ...
		  is_classification: If the estimator is for classification.
	**/
	public function new(model_fn:Dynamic, model_dir:Dynamic, config:Dynamic, feature_columns:Dynamic, head:Dynamic, center_bias:Dynamic, is_classification:Dynamic):Void;
	/**
