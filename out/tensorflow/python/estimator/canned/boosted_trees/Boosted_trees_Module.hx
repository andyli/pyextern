...
@:pythonImport("tensorflow.python.estimator.canned.boosted_trees") extern class Boosted_trees_Module {
	...
	**/
	static public function _bt_explanations_fn(features:Dynamic, head:Dynamic, sorted_feature_columns:Dynamic, ?name:Dynamic):Dynamic;
	/**
		...
		Raises:
		  ValueError: mode or params are invalid, or features has the wrong type.
	**/
	static public function _bt_model_fn(features:Dynamic, labels:Dynamic, mode:Dynamic, head:Dynamic, feature_columns:Dynamic, tree_hparams:Dynamic, n_batches_per_layer:Dynamic, config:Dynamic, ?closed_form_grad_and_hess_fn:Dynamic, ?example_id_column_name:Dynamic, ?train_in_memory:Dynamic, ?name:Dynamic):Dynamic;
	/**
		Transform features and cache, then returns (cached_features, cache_op).
	**/
	static public function _cache_transformed_features(features:Dynamic, sorted_feature_columns:Dynamic, batch_size:Dynamic):Dynamic;
	...
	**/
	...
	/**
		...
		Raises:
		  ValueError: when unsupported features/columns are tried.
	**/
	static public function _get_transformed_features(features:Dynamic, sorted_feature_columns:Dynamic):Dynamic;
	/**
	...
	**/
	static public function _group_features_by_num_buckets(sorted_feature_columns:Dynamic):Dynamic;
	/**
