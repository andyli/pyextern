...
@:pythonImport("tensorflow.python.estimator.canned.boosted_trees", "GrowerInitializationHook") extern class GrowerInitializationHook {
	...
	**/
	@:native("__init__")
	public function ___init__(init_op:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(init_op:Dynamic):Void;
	/**
