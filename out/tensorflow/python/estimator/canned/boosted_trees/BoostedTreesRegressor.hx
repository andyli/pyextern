...
@:pythonImport("tensorflow.python.estimator.canned.boosted_trees", "BoostedTreesRegressor") extern class BoostedTreesRegressor {
	...
	**/
	@:native("__init__")
	public function ___init__(feature_columns:Dynamic, n_batches_per_layer:Dynamic, ?model_dir:Dynamic, ?label_dimension:Dynamic, ?weight_column:Dynamic, ?n_trees:Dynamic, ?max_depth:Dynamic, ?learning_rate:Dynamic, ?l1_regularization:Dynamic, ?l2_regularization:Dynamic, ?tree_complexity:Dynamic, ?min_node_weight:Dynamic, ?config:Dynamic, ?center_bias:Dynamic, ?pruning_mode:Dynamic):Dynamic;
	/**
		Initializes a `BoostedTreesRegressor` instance.
		...
		Raises:
		  ValueError: when wrong arguments are given or unsupported functionalities
		     are requested.
	**/
	public function new(feature_columns:Dynamic, n_batches_per_layer:Dynamic, ?model_dir:Dynamic, ?label_dimension:Dynamic, ?weight_column:Dynamic, ?n_trees:Dynamic, ?max_depth:Dynamic, ?learning_rate:Dynamic, ?l1_regularization:Dynamic, ?l2_regularization:Dynamic, ?tree_complexity:Dynamic, ?min_node_weight:Dynamic, ?config:Dynamic, ?center_bias:Dynamic, ?pruning_mode:Dynamic):Void;
	/**
