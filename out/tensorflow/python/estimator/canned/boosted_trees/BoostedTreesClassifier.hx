...
@:pythonImport("tensorflow.python.estimator.canned.boosted_trees", "BoostedTreesClassifier") extern class BoostedTreesClassifier {
	...
	**/
	@:native("__init__")
	public function ___init__(feature_columns:Dynamic, n_batches_per_layer:Dynamic, ?model_dir:Dynamic, ?n_classes:Dynamic, ?weight_column:Dynamic, ?label_vocabulary:Dynamic, ?n_trees:Dynamic, ?max_depth:Dynamic, ?learning_rate:Dynamic, ?l1_regularization:Dynamic, ?l2_regularization:Dynamic, ?tree_complexity:Dynamic, ?min_node_weight:Dynamic, ?config:Dynamic, ?center_bias:Dynamic, ?pruning_mode:Dynamic):Dynamic;
	/**
		Initializes a `BoostedTreesClassifier` instance.
		...
		Raises:
		  ValueError: when wrong arguments are given or unsupported functionalities
		     are requested.
	**/
	public function new(feature_columns:Dynamic, n_batches_per_layer:Dynamic, ?model_dir:Dynamic, ?n_classes:Dynamic, ?weight_column:Dynamic, ?label_vocabulary:Dynamic, ?n_trees:Dynamic, ?max_depth:Dynamic, ?learning_rate:Dynamic, ?l1_regularization:Dynamic, ?l2_regularization:Dynamic, ?tree_complexity:Dynamic, ?min_node_weight:Dynamic, ?config:Dynamic, ?center_bias:Dynamic, ?pruning_mode:Dynamic):Void;
	/**
	...
	**/
	public function experimental_feature_importances(?normalize:Dynamic):Dynamic;
	/**
		...
		Raises:
		  ValueError: when wrong arguments are given or unsupported functionalities
		   are requested.
	**/
	public function experimental_predict_with_explanations(input_fn:Dynamic, ?predict_keys:Dynamic, ?hooks:Dynamic, ?checkpoint_path:Dynamic):Dynamic;
	/**
