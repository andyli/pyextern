...
@:pythonImport("tensorflow.python.estimator.canned.boosted_trees", "_AccumulatorEnsembleGrower") extern class _AccumulatorEnsembleGrower {
	...
	**/
	@:native("__init__")
	public function ___init__(tree_ensemble:Dynamic, tree_hparams:Dynamic, stamp_token:Dynamic, n_batches_per_layer:Dynamic, bucket_size_list:Dynamic, is_chief:Dynamic, center_bias:Dynamic, feature_ids_list:Dynamic):Dynamic;
	/**
		Initializes a grower object.
		...
		Raises:
		  ...
		  complexity is set.
	**/
	public function new(tree_ensemble:Dynamic, tree_hparams:Dynamic, stamp_token:Dynamic, n_batches_per_layer:Dynamic, bucket_size_list:Dynamic, is_chief:Dynamic, center_bias:Dynamic, feature_ids_list:Dynamic):Void;
	/**
