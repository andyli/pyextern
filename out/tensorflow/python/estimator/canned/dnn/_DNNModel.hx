...
@:pythonImport("tensorflow.python.estimator.canned.dnn", "_DNNModel") extern class _DNNModel {
	/**
	...
	**/
	...
	@:native("__init__")
	public function ___init__(units:Dynamic, hidden_units:Dynamic, feature_columns:Dynamic, activation_fn:Dynamic, dropout:Dynamic, input_layer_partitioner:Dynamic, batch_norm:Dynamic, shared_state_manager:Dynamic, ?name:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	public function new(units:Dynamic, hidden_units:Dynamic, feature_columns:Dynamic, activation_fn:Dynamic, dropout:Dynamic, input_layer_partitioner:Dynamic, batch_norm:Dynamic, shared_state_manager:Dynamic, ?name:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Void;
	/**
	...
	**/
	...
	public function _add_layer(layer:Dynamic, layer_name:Dynamic):Dynamic;
	/**
	...
	**/
	public function call(features:Dynamic, mode:Dynamic):Dynamic;
	/**
