...
@:pythonImport("tensorflow.python.estimator.canned.dnn", "DNNRegressor") extern class DNNRegressor {
	...
	**/
	@:native("__init__")
	public function ___init__(hidden_units:Dynamic, feature_columns:Dynamic, ?model_dir:Dynamic, ?label_dimension:Dynamic, ?weight_column:Dynamic, ?optimizer:Dynamic, ?activation_fn:Dynamic, ?dropout:Dynamic, ?input_layer_partitioner:Dynamic, ?config:Dynamic, ?warm_start_from:Dynamic, ?loss_reduction:Dynamic, ?batch_norm:Dynamic):Dynamic;
	/**
		Initializes a `DNNRegressor` instance.
		...
		Args:
		  ...
		  batch_norm: Whether to use batch normalization after each hidden layer.
	**/
	public function new(hidden_units:Dynamic, feature_columns:Dynamic, ?model_dir:Dynamic, ?label_dimension:Dynamic, ?weight_column:Dynamic, ?optimizer:Dynamic, ?activation_fn:Dynamic, ?dropout:Dynamic, ?input_layer_partitioner:Dynamic, ?config:Dynamic, ?warm_start_from:Dynamic, ?loss_reduction:Dynamic, ?batch_norm:Dynamic):Void;
	/**
