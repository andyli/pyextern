...
@:pythonImport("tensorflow.python.estimator.canned.baseline", "BaselineClassifier") extern class BaselineClassifier {
	...
	**/
	@:native("__init__")
	public function ___init__(?model_dir:Dynamic, ?n_classes:Dynamic, ?weight_column:Dynamic, ?label_vocabulary:Dynamic, ?optimizer:Dynamic, ?config:Dynamic, ?loss_reduction:Dynamic):Dynamic;
	/**
		Initializes a BaselineClassifier instance.
		...
		Raises:
		  ValueError: If `n_classes` < 2.
	**/
	public function new(?model_dir:Dynamic, ?n_classes:Dynamic, ?weight_column:Dynamic, ?label_vocabulary:Dynamic, ?optimizer:Dynamic, ?config:Dynamic, ?loss_reduction:Dynamic):Void;
	/**
