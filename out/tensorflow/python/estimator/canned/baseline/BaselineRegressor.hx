...
@:pythonImport("tensorflow.python.estimator.canned.baseline", "BaselineRegressor") extern class BaselineRegressor {
	...
	**/
	@:native("__init__")
	public function ___init__(?model_dir:Dynamic, ?label_dimension:Dynamic, ?weight_column:Dynamic, ?optimizer:Dynamic, ?config:Dynamic, ?loss_reduction:Dynamic):Dynamic;
	/**
		Initializes a BaselineRegressor instance.
		...
		Returns:
		  A `BaselineRegressor` estimator.
	**/
	public function new(?model_dir:Dynamic, ?label_dimension:Dynamic, ?weight_column:Dynamic, ?optimizer:Dynamic, ?config:Dynamic, ?loss_reduction:Dynamic):Void;
	/**
