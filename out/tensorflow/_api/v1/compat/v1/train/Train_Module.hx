...
package tensorflow._api.v1.compat.v1.train;
@:pythonImport("tensorflow._api.v1.compat.v1.train") extern class Train_Module {
	/**
	...
	**/
	...
	/**
		...
		@end_compatibility
	**/
	static public function piecewise_constant_decay(x:Dynamic, boundaries:Dynamic, values:Dynamic, ?name:Dynamic):Dynamic;
	/**
