...
package tensorflow._api.v1.compat.v1.saved_model.signature_constants;
@:pythonImport("tensorflow._api.v1.compat.v1.saved_model.signature_constants") extern class Signature_constants_Module {
