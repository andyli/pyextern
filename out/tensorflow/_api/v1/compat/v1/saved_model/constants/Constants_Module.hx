...
package tensorflow._api.v1.compat.v1.saved_model.constants;
@:pythonImport("tensorflow._api.v1.compat.v1.saved_model.constants") extern class Constants_Module {
