...
package tensorflow._api.v1.compat.v1.keras.preprocessing.sequence;
@:pythonImport("tensorflow._api.v1.compat.v1.keras.preprocessing.sequence") extern class Sequence_Module {
