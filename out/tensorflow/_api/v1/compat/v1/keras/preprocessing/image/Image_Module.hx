...
package tensorflow._api.v1.compat.v1.keras.preprocessing.image;
@:pythonImport("tensorflow._api.v1.compat.v1.keras.preprocessing.image") extern class Image_Module {
