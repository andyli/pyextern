...
package tensorflow._api.v1.compat.v1.keras.applications.mobilenet;
@:pythonImport("tensorflow._api.v1.compat.v1.keras.applications.mobilenet") extern class Mobilenet_Module {
