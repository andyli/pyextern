...
package tensorflow._api.v1.compat.v1.keras.applications.inception_resnet_v2;
@:pythonImport("tensorflow._api.v1.compat.v1.keras.applications.inception_resnet_v2") extern class Inception_resnet_v2_Module {
