...
package tensorflow._api.v1.compat.v1.keras.applications.xception;
@:pythonImport("tensorflow._api.v1.compat.v1.keras.applications.xception") extern class Xception_Module {
