...
package tensorflow._api.v1.compat.v1.keras.applications.densenet;
@:pythonImport("tensorflow._api.v1.compat.v1.keras.applications.densenet") extern class Densenet_Module {
