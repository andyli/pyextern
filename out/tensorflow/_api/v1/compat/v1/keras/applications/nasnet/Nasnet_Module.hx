...
package tensorflow._api.v1.compat.v1.keras.applications.nasnet;
@:pythonImport("tensorflow._api.v1.compat.v1.keras.applications.nasnet") extern class Nasnet_Module {
