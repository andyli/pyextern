...
package tensorflow._api.v1.compat.v1.sets;
@:pythonImport("tensorflow._api.v1.compat.v1.sets") extern class Sets_Module {
	...
	/**
		...
		Returns:
		  ...
		  differences.
	**/
	static public function difference(a:Dynamic, b:Dynamic, ?aminusb:Dynamic, ?validate_indices:Dynamic):Dynamic;
	/**
		...
		Returns:
		  ...
		  intersections.
	**/
	static public function intersection(a:Dynamic, b:Dynamic, ?validate_indices:Dynamic):Dynamic;
	/**
		Compute set difference of elements in last dimension of `a` and `b`.
	...
	**/
	...
	/**
		...
		Raises:
		  TypeError: If `a` is an invalid types.
	**/
	static public function size(a:Dynamic, ?validate_indices:Dynamic):Dynamic;
	/**
		Compute set union of elements in last dimension of `a` and `b`.
		...
		Returns:
		  ...
		  unions.
	**/
	static public function union(a:Dynamic, b:Dynamic, ?validate_indices:Dynamic):Dynamic;
}