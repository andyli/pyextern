...
package tensorflow._api.v1.compat.v1.layers.experimental;
@:pythonImport("tensorflow._api.v1.compat.v1.layers.experimental") extern class Experimental_Module {
