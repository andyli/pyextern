...
package tensorflow._api.v1.keras.applications.inception_v3;
@:pythonImport("tensorflow._api.v1.keras.applications.inception_v3") extern class Inception_v3_Module {
