...
package tensorflow._api.v1.sparse;
@:pythonImport("tensorflow._api.v1.sparse") extern class Sparse_Module {
	...
	**/
	static public function add(a:Dynamic, b:Dynamic, ?thresh:Dynamic):Dynamic;
	/**
