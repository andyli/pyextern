...
package tensorflow._api.v1.saved_model.signature_def_utils;
@:pythonImport("tensorflow._api.v1.saved_model.signature_def_utils") extern class Signature_def_utils_Module {
