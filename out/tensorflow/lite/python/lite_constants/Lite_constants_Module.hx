...
package tensorflow.lite.python.lite_constants;
@:pythonImport("tensorflow.lite.python.lite_constants") extern class Lite_constants_Module {
	static public var COMPLEX64 : Dynamic;
	static public var EXPERIMENTAL_USE_TOCO_API_DIRECTLY : Dynamic;
