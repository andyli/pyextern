...
package tensorflow.lite.toco.python.tensorflow_wrap_toco;
@:pythonImport("tensorflow.lite.toco.python.tensorflow_wrap_toco") extern class Tensorflow_wrap_toco_Module {
