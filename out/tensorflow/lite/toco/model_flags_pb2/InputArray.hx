...
@:pythonImport("tensorflow.lite.toco.model_flags_pb2", "InputArray") extern class InputArray {
	/**
	...
	**/
	...
	/**
		Field toco.InputArray.data_type
	**/
	public var data_type : Dynamic;
	/**
		Field toco.InputArray.mean_value
	**/
	public var mean_value : Dynamic;
	/**
		Field toco.InputArray.name
	**/
	public var name : Dynamic;
	/**
		Field toco.InputArray.shape
	**/
	public var shape : Dynamic;
	/**
		Field toco.InputArray.std_value
	**/
	public var std_value : Dynamic;
}