...
@:pythonImport("tensorflow.core.profiler.tfprof_output_pb2", "AdviceProto") extern class AdviceProto {
	/**
	...
	**/
	...
	/**
		A ProtocolMessage
	**/
	public function Checker(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
		A ProtocolMessage
	**/
	...
	**/
	...
	/**
		Field tensorflow.tfprof.AdviceProto.checkers
	**/
