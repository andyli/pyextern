...
@:pythonImport("tensorflow.core.profiler.tfprof_options_pb2", "AdvisorOptionsProto") extern class AdvisorOptionsProto {
	/**
	...
	**/
	...
	/**
		A ProtocolMessage
	**/
	public function CheckerOption(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
		A ProtocolMessage
	**/
	public function CheckersEntry(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
		Clears the message.
	**/
	...
	**/
	...
	/**
		Field tensorflow.tfprof.AdvisorOptionsProto.checkers
	**/
	public var checkers : Dynamic;
}