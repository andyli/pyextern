...
@:pythonImport("tensorflow.core.profiler.profile_pb2", "Line") extern class Line {
	/**
	...
	**/
	...
	/**
		Field tensorflow.tfprof.pprof.Line.function_id
	**/
	public var function_id : Dynamic;
	/**
		Field tensorflow.tfprof.pprof.Line.line
	**/
