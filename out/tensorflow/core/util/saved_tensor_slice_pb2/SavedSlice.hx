...
@:pythonImport("tensorflow.core.util.saved_tensor_slice_pb2", "SavedSlice") extern class SavedSlice {
	/**
	...
	**/
	...
	/**
		Field tensorflow.SavedSlice.data
	**/
	public var data : Dynamic;
	/**
		Field tensorflow.SavedSlice.name
	**/
	public var name : Dynamic;
	/**
		Field tensorflow.SavedSlice.slice
	**/
