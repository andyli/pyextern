...
@:pythonImport("tensorflow.core.util.memmapped_file_system_pb2", "MemmappedFileSystemDirectory") extern class MemmappedFileSystemDirectory {
	...
	**/
	...
	static public var ELEMENT_FIELD_NUMBER : Dynamic;
	/**
	...
	**/
	...
	/**
		Magic attribute generated for "element" proto field.
	**/
