...
@:pythonImport("tensorflow.core.example.feature_pb2", "FeatureLists") extern class FeatureLists {
	/**
	...
	**/
	...
	/**
		A ProtocolMessage
	**/
	public function FeatureListEntry(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	...
	/**
		Field tensorflow.FeatureLists.feature_list
	**/
	public var feature_list : Dynamic;
}