...
@:pythonImport("tensorflow.core.example.example_parser_configuration_pb2", "ExampleParserConfiguration") extern class ExampleParserConfiguration {
	/**
	...
	**/
	...
	/**
		A ProtocolMessage
	**/
	public function FeatureMapEntry(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	...
	/**
		Field tensorflow.ExampleParserConfiguration.feature_map
	**/
	public var feature_map : Dynamic;
}