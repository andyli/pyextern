...
package tensorflow.core.example.example_pb2;
@:pythonImport("tensorflow.core.example.example_pb2", "SequenceExample") extern class SequenceExample {
	public function ByteSize():Dynamic;
	static public var CONTEXT_FIELD_NUMBER : Dynamic;
	...
	**/
	...
	static public var FEATURE_LISTS_FIELD_NUMBER : Dynamic;
	/**
	...
	**/
	public var feature_lists : Dynamic;
}