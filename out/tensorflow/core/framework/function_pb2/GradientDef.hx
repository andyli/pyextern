...
@:pythonImport("tensorflow.core.framework.function_pb2", "GradientDef") extern class GradientDef {
	...
	**/
	...
	static public var FUNCTION_NAME_FIELD_NUMBER : Dynamic;
	/**
	...
	**/
	...
	static public var GRADIENT_FUNC_FIELD_NUMBER : Dynamic;
	...
	**/
	...
	/**
		Magic attribute generated for "function_name" proto field.
	**/
	public var function_name : Dynamic;
	/**
		Magic attribute generated for "gradient_func" proto field.
	**/
	public var gradient_func : Dynamic;
}