...
package tensorflow.core.framework.kernel_def_pb2;
@:pythonImport("tensorflow.core.framework.kernel_def_pb2", "KernelDef") extern class KernelDef {
	/**
		A ProtocolMessage
	**/
	static public function AttrConstraint(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
