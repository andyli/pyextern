...
@:pythonImport("tensorflow.core.framework.summary_pb2", "Summary") extern class Summary {
	/**
		A ProtocolMessage
	**/
	static public function Audio(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	...
	/**
		A ProtocolMessage
	**/
	static public function Image(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	...
	/**
		A ProtocolMessage
	**/
	static public function Value(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
