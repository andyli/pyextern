...
@:pythonImport("tensorflow.core.framework.summary_pb2", "SummaryDescription") extern class SummaryDescription {
	/**
	...
	**/
	...
	/**
		Field tensorflow.SummaryDescription.type_hint
	**/
	public var type_hint : Dynamic;
}