...
@:pythonImport("tensorflow.core.framework.tensor_slice_pb2", "TensorSliceProto") extern class TensorSliceProto {
	/**
	...
	**/
	...
	/**
		A ProtocolMessage
	**/
	static public function Extent(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
