...
@:pythonImport("tensorflow.core.framework.api_def_pb2", "ApiDef") extern class ApiDef {
	...
	/**
		A ProtocolMessage
	**/
	public function Arg(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
		A ProtocolMessage
	**/
	public function Attr(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	...
	/**
		A ProtocolMessage
	**/
	public function Endpoint(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
		Extension dict
	**/
