...
@:pythonImport("tensorflow.core.framework.tensor_shape_pb2", "TensorShapeProto") extern class TensorShapeProto {
	/**
	...
	**/
	...
	/**
		A ProtocolMessage
	**/
	static public function Dim(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
