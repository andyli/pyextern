...
@:pythonImport("tensorflow.core.framework.tensor_shape_pb2", "TensorShapeProto") extern class TensorShapeProto {
	...
	**/
	static public function Dim(?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
	...
	**/
	...
	/**
		Magic attribute generated for "dim" proto field.
	**/
	public var dim : Dynamic;
	/**
		Magic attribute generated for "unknown_rank" proto field.
	**/
