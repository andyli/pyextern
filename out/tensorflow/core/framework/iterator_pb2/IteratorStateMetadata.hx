...
package tensorflow.core.framework.iterator_pb2;
@:pythonImport("tensorflow.core.framework.iterator_pb2", "IteratorStateMetadata") extern class IteratorStateMetadata {
	/**
	...
	**/
	...
	/**
		Field tensorflow.IteratorStateMetadata.keys
	**/
	public var keys : Dynamic;
	/**
		Field tensorflow.IteratorStateMetadata.version
	**/
