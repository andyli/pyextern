...
@:pythonImport("tensorflow.core.framework.op_def_pb2", "OpDeprecation") extern class OpDeprecation {
	...
	**/
	...
	static public var EXPLANATION_FIELD_NUMBER : Dynamic;
	/**
	...
	**/
	...
	/**
		Magic attribute generated for "explanation" proto field.
	**/
	public var explanation : Dynamic;
	/**
