...
package tensorflow.core.framework.remote_fused_graph_execute_info_pb2;
@:pythonImport("tensorflow.core.framework.remote_fused_graph_execute_info_pb2", "RemoteFusedGraphExecuteInfo") extern class RemoteFusedGraphExecuteInfo {
	/**
