...
@:pythonImport("tensorflow.core.framework.versions_pb2", "VersionDef") extern class VersionDef {
	...
	**/
	...
	/**
		Magic attribute generated for "bad_consumers" proto field.
	**/
	public var bad_consumers : Dynamic;
	/**
		Magic attribute generated for "min_consumer" proto field.
	**/
	public var min_consumer : Dynamic;
	/**
		Magic attribute generated for "producer" proto field.
	**/
