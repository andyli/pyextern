...
@:pythonImport("tensorflow.core.framework.step_stats_pb2", "StepStats") extern class StepStats {
	...
	**/
	...
	static public var DEV_STATS_FIELD_NUMBER : Dynamic;
	/**
	...
	**/
	...
	/**
		Magic attribute generated for "dev_stats" proto field.
	**/
	public var dev_stats : Dynamic;
}