...
@:pythonImport("tensorflow.core.framework.step_stats_pb2", "MemoryStats") extern class MemoryStats {
	...
	**/
	...
	static public var DEVICE_PERSISTENT_MEMORY_SIZE_FIELD_NUMBER : Dynamic;
	static public var DEVICE_PERSISTENT_TENSOR_ALLOC_IDS_FIELD_NUMBER : Dynamic;
	static public var DEVICE_TEMP_MEMORY_SIZE_FIELD_NUMBER : Dynamic;
	/**
	...
	**/
	...
	static public var HOST_PERSISTENT_MEMORY_SIZE_FIELD_NUMBER : Dynamic;
	static public var HOST_PERSISTENT_TENSOR_ALLOC_IDS_FIELD_NUMBER : Dynamic;
	static public var HOST_TEMP_MEMORY_SIZE_FIELD_NUMBER : Dynamic;
	/**
