...
@:pythonImport("tensorflow.core.grappler.costs.op_performance_data_pb2", "LogNormalDistribution") extern class LogNormalDistribution {
	/**
	...
	**/
	...
	static public var MU_FIELD_NUMBER : Dynamic;
	/**
	...
	**/
	...
	static public var SIGMA_FIELD_NUMBER : Dynamic;
	/**
