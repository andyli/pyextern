...
@:pythonImport("tensorflow.core.grappler.costs.op_performance_data_pb2", "SessionInfo") extern class SessionInfo {
	/**
	...
	**/
	...
	/**
		Field tensorflow.SessionInfo.intra_op_parallelism
	**/
	public var intra_op_parallelism : Dynamic;
}