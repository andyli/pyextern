...
@:pythonImport("tensorflow.core.protobuf.control_flow_pb2", "ValuesDef") extern class ValuesDef {
	...
	**/
	...
	static public var EXTERNAL_VALUES_FIELD_NUMBER : Dynamic;
	/**
		Extension dict
	**/
	...
	/**
		A ProtocolMessage
	**/
	static public function ExternalValuesEntry(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	...
	static public var VALUES_FIELD_NUMBER : Dynamic;
	/**
