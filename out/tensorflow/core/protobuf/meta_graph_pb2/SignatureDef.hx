...
@:pythonImport("tensorflow.core.protobuf.meta_graph_pb2", "SignatureDef") extern class SignatureDef {
	...
	**/
	static public function InputsEntry(?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
	...
	**/
	...
	/**
		...
		TODO(robinson): Document that the class must also have a static
		  ...
		  Not sure how to best express at this point.
	**/
	static public function OutputsEntry(?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
	...
	**/
	...
	/**
		Magic attribute generated for "inputs" proto field.
	**/
	public var inputs : Dynamic;
	/**
		Magic attribute generated for "method_name" proto field.
	**/
	public var method_name : Dynamic;
	/**
		Magic attribute generated for "outputs" proto field.
	**/
