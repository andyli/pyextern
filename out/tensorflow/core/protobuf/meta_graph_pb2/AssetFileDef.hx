...
@:pythonImport("tensorflow.core.protobuf.meta_graph_pb2", "AssetFileDef") extern class AssetFileDef {
	/**
	...
	**/
	...
	/**
		Field tensorflow.AssetFileDef.filename
	**/
	public var filename : Dynamic;
	/**
		Field tensorflow.AssetFileDef.tensor_info
	**/
	public var tensor_info : Dynamic;
}