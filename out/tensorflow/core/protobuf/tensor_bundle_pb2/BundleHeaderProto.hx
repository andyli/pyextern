...
@:pythonImport("tensorflow.core.protobuf.tensor_bundle_pb2", "BundleHeaderProto") extern class BundleHeaderProto {
	static public var BIG : Dynamic;
	/**
	...
	**/
	...
	static public var LITTLE : Dynamic;
	/**
