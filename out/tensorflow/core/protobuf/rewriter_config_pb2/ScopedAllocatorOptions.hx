...
@:pythonImport("tensorflow.core.protobuf.rewriter_config_pb2", "ScopedAllocatorOptions") extern class ScopedAllocatorOptions {
	/**
	...
	**/
	...
	/**
		Field tensorflow.ScopedAllocatorOptions.enable_op
	**/
	public var enable_op : Dynamic;
}