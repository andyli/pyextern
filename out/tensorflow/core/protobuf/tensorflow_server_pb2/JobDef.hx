...
@:pythonImport("tensorflow.core.protobuf.tensorflow_server_pb2", "JobDef") extern class JobDef {
	...
	**/
	static public function TasksEntry(?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
