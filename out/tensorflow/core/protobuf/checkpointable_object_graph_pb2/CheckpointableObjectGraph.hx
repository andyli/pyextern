...
package tensorflow.core.protobuf.checkpointable_object_graph_pb2;
@:pythonImport("tensorflow.core.protobuf.checkpointable_object_graph_pb2", "CheckpointableObjectGraph") extern class CheckpointableObjectGraph {
	/**
	...
	**/
	...
	/**
		A ProtocolMessage
	**/
	public function CheckpointableObject(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
		Clears the message.
	**/
	...
	**/
	...
	/**
		Field tensorflow.CheckpointableObjectGraph.nodes
	**/
