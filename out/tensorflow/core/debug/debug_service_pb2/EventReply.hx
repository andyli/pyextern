...
@:pythonImport("tensorflow.core.debug.debug_service_pb2", "EventReply") extern class EventReply {
	/**
	...
	**/
	...
	/**
		A ProtocolMessage
	**/
	public function DebugOpStateChange(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	...
	/**
		Field tensorflow.EventReply.debug_op_state_changes
	**/
	public var debug_op_state_changes : Dynamic;
	/**
		Field tensorflow.EventReply.tensor
	**/
