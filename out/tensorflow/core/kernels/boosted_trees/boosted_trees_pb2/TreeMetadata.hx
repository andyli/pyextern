...
@:pythonImport("tensorflow.core.kernels.boosted_trees.boosted_trees_pb2", "TreeMetadata") extern class TreeMetadata {
	/**
	...
	**/
	...
	/**
		A ProtocolMessage
	**/
	public function PostPruneNodeUpdate(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
