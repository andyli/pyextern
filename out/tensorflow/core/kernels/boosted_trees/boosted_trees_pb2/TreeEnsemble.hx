...
@:pythonImport("tensorflow.core.kernels.boosted_trees.boosted_trees_pb2", "TreeEnsemble") extern class TreeEnsemble {
	/**
	...
	**/
	...
	/**
		Field tensorflow.boosted_trees.TreeEnsemble.growing_metadata
	**/
	public var growing_metadata : Dynamic;
	/**
		Field tensorflow.boosted_trees.TreeEnsemble.tree_metadata
	**/
	public var tree_metadata : Dynamic;
	/**
		Field tensorflow.boosted_trees.TreeEnsemble.tree_weights
	**/
	public var tree_weights : Dynamic;
	/**
		Field tensorflow.boosted_trees.TreeEnsemble.trees
	**/
