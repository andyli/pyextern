...
@:pythonImport("tensorflow.compiler.xla.service.hlo_pb2", "HloScheduleProto") extern class HloScheduleProto {
	/**
	...
	**/
	...
	/**
		A ProtocolMessage
	**/
	public function InstructionSequence(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	...
	static public var SEQUENCES_FIELD_NUMBER : Dynamic;
	/**
		A ProtocolMessage
	**/
	public function SequencesEntry(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
