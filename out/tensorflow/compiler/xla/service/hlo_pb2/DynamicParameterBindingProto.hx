...
@:pythonImport("tensorflow.compiler.xla.service.hlo_pb2", "DynamicParameterBindingProto") extern class DynamicParameterBindingProto {
	/**
		A ProtocolMessage
	**/
	public function Binding(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	...
	/**
		Field xla.DynamicParameterBindingProto.entries
	**/
