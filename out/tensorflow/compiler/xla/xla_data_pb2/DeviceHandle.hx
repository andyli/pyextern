...
@:pythonImport("tensorflow.compiler.xla.xla_data_pb2", "DeviceHandle") extern class DeviceHandle {
	/**
	...
	**/
	...
	/**
		Field xla.DeviceHandle.device_count
	**/
	public var device_count : Dynamic;
	/**
		Field xla.DeviceHandle.handle
	**/
