...
@:pythonImport("tensorflow.compiler.xla.xla_data_pb2", "PaddingConfig") extern class PaddingConfig {
	/**
	...
	**/
	...
	/**
		A ProtocolMessage
	**/
	public function PaddingConfigDimension(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	...
	/**
		Field xla.PaddingConfig.dimensions
	**/
