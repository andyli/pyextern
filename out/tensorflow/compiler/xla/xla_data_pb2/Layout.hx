...
@:pythonImport("tensorflow.compiler.xla.xla_data_pb2", "Layout") extern class Layout {
	/**
	...
	**/
	...
	static public var FORMAT_FIELD_NUMBER : Dynamic;
	/**
	...
	**/
	...
	static public var MAX_SPARSE_ELEMENTS_FIELD_NUMBER : Dynamic;
	static public var MINOR_TO_MAJOR_FIELD_NUMBER : Dynamic;
	/**
	...
	**/
	...
	static public var PADDED_DIMENSIONS_FIELD_NUMBER : Dynamic;
	static public var PADDING_VALUE_FIELD_NUMBER : Dynamic;
	/**
