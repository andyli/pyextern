...
@:pythonImport("tensorflow.compiler.xla.xla_data_pb2", "DeviceAssignmentProto") extern class DeviceAssignmentProto {
	/**
	...
	**/
	...
	/**
		A ProtocolMessage
	**/
	public function ComputationDevice(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
