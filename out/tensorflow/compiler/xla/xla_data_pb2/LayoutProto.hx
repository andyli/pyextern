...
@:pythonImport("tensorflow.compiler.xla.xla_data_pb2", "LayoutProto") extern class LayoutProto {
	/**
	...
	**/
	...
	/**
		Field xla.LayoutProto.element_size_in_bits
	**/
	public var element_size_in_bits : Dynamic;
	/**
		Field xla.LayoutProto.format
	**/
	public var format : Dynamic;
	/**
		Field xla.LayoutProto.max_sparse_elements
	**/
	public var max_sparse_elements : Dynamic;
	/**
		Field xla.LayoutProto.minor_to_major
	**/
	public var minor_to_major : Dynamic;
	/**
		Field xla.LayoutProto.tiles
	**/
	public var tiles : Dynamic;
}