...
@:pythonImport("tensorflow.contrib.distributions.python.ops.wishart", "_WishartOperatorPD") extern class _WishartOperatorPD {
	...
	**/
	@:native("__init__")
	public function ___init__(df:Dynamic, scale_operator_pd:Dynamic, ?cholesky_input_output_matrices:Dynamic, ?validate_args:Dynamic, ?allow_nan_stats:Dynamic, ?name:Dynamic):Dynamic;
	/**
		Construct Wishart distributions.
		...
		Raises:
		  ...
		  ValueError: if df < k, where scale operator event shape is
		    `(k, k)`
	**/
	public function new(df:Dynamic, scale_operator_pd:Dynamic, ?cholesky_input_output_matrices:Dynamic, ?validate_args:Dynamic, ?allow_nan_stats:Dynamic, ?name:Dynamic):Void;
	/**
	...
	**/
	public var scale_operator_pd : Dynamic;
	/**
		Standard deviation.
