...
@:pythonImport("tensorflow.contrib.distributions.python.ops.wishart", "WishartCholesky") extern class WishartCholesky {
	...
	**/
	@:native("__init__")
	public function ___init__(df:Dynamic, scale:Dynamic, ?cholesky_input_output_matrices:Dynamic, ?validate_args:Dynamic, ?allow_nan_stats:Dynamic, ?name:Dynamic):Dynamic;
	/**
		Construct Wishart distributions. (deprecated)
		...
		Args:
		  ...
		  name: Python `str` name prefixed to Ops created by this class.
	**/
	public function new(df:Dynamic, scale:Dynamic, ?cholesky_input_output_matrices:Dynamic, ?validate_args:Dynamic, ?allow_nan_stats:Dynamic, ?name:Dynamic):Void;
	/**
