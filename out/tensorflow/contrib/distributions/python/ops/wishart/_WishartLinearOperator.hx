...
package tensorflow.contrib.distributions.python.ops.wishart;
@:pythonImport("tensorflow.contrib.distributions.python.ops.wishart", "_WishartLinearOperator") extern class _WishartLinearOperator {
	...
	**/
	@:native("__init__")
	public function ___init__(df:Dynamic, scale_operator:Dynamic, ?cholesky_input_output_matrices:Dynamic, ?validate_args:Dynamic, ?allow_nan_stats:Dynamic, ?name:Dynamic):Dynamic;
	/**
		Construct Wishart distributions. (deprecated)
		...
		Raises:
		  ...
		  ValueError: if df < k, where scale operator event shape is
		    `(k, k)`
	**/
	public function new(df:Dynamic, scale_operator:Dynamic, ?cholesky_input_output_matrices:Dynamic, ?validate_args:Dynamic, ?allow_nan_stats:Dynamic, ?name:Dynamic):Void;
	/**
	...
	**/
	public function _multi_digamma(a:Dynamic, p:Dynamic, ?name:Dynamic):Dynamic;
	/**
		Creates sequence used in multivariate (di)gamma; shape = shape(a)+[p].
	**/
	public function _multi_gamma_sequence(a:Dynamic, p:Dynamic, ?name:Dynamic):Dynamic;
	/**
		Computes the log multivariate gamma function; log(Gamma_p(a)).
	**/
	public function _multi_lgamma(a:Dynamic, p:Dynamic, ?name:Dynamic):Dynamic;
	/**
	...
	**/
	...
	public function _square_scale_operator():Dynamic;
	...
	**/
	public var cholesky_input_output_matrices : Dynamic;
	/**
	...
	**/
	public function log_normalization(?name:Dynamic):Dynamic;
	/**
	...
	**/
	public function mean_log_det(?name:Dynamic):Dynamic;
	/**
		Mode.
	**/
	...
	**/
	public function scale():Dynamic;
	/**
		Wishart distribution scale matrix as an Linear Operator.
	**/
	public var scale_operator : Dynamic;
	/**
		Standard deviation.
