...
@:pythonImport("tensorflow.contrib.distributions.python.ops.mvn_linear_operator", "MultivariateNormalLinearOperator") extern class MultivariateNormalLinearOperator {
