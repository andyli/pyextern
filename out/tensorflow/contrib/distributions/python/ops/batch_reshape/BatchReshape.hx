...
@:pythonImport("tensorflow.contrib.distributions.python.ops.batch_reshape", "BatchReshape") extern class BatchReshape {
	...
	**/
	@:native("__init__")
	public function ___init__(distribution:Dynamic, batch_shape:Dynamic, ?validate_args:Dynamic, ?allow_nan_stats:Dynamic, ?name:Dynamic):Dynamic;
	/**
		Construct BatchReshape distribution. (deprecated)
		...
		Raises:
		  ...
		  ValueError: if `batch_shape` size is not the same as a
		    `distribution.batch_shape` size.
	**/
	public function new(distribution:Dynamic, batch_shape:Dynamic, ?validate_args:Dynamic, ?allow_nan_stats:Dynamic, ?name:Dynamic):Void;
	/**
	...
	**/
	public function _call_and_reshape_output(fn:Dynamic, ?event_shape_list:Dynamic, ?static_event_shape_list:Dynamic):Dynamic;
	...
	**/
	public function _call_reshape_input_output(fn:Dynamic, x:Dynamic):Dynamic;
	...
	**/
	...
	public function _log_survival_function(x:Dynamic):Dynamic;
