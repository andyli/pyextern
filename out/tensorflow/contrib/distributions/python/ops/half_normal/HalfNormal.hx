...
package tensorflow.contrib.distributions.python.ops.half_normal;
@:pythonImport("tensorflow.contrib.distributions.python.ops.half_normal", "HalfNormal") extern class HalfNormal {
	...
	**/
	@:native("__init__")
	public function ___init__(scale:Dynamic, ?validate_args:Dynamic, ?allow_nan_stats:Dynamic, ?name:Dynamic):Dynamic;
	/**
		Construct HalfNormals with scale `scale`. (deprecated)
		...
		Args:
		  ...
		  name: Python `str` name prefixed to Ops created by this class.
	**/
	public function new(scale:Dynamic, ?validate_args:Dynamic, ?allow_nan_stats:Dynamic, ?name:Dynamic):Void;
	/**
	...
	**/
	...
	public function _quantile(p:Dynamic):Dynamic;
