...
package tensorflow.contrib.distributions.python.ops.mvn_diag;
@:pythonImport("tensorflow.contrib.distributions.python.ops.mvn_diag", "MultivariateNormalDiag") extern class MultivariateNormalDiag {
