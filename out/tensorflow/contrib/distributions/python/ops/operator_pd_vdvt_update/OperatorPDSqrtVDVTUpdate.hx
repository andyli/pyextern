...
package tensorflow.contrib.distributions.python.ops.operator_pd_vdvt_update;
@:pythonImport("tensorflow.contrib.distributions.python.ops.operator_pd_vdvt_update", "OperatorPDSqrtVDVTUpdate") extern class OperatorPDSqrtVDVTUpdate {
	...
	**/
	@:native("__init__")
	public function ___init__(operator:Dynamic, v:Dynamic, ?diag:Dynamic, ?verify_pd:Dynamic, ?verify_shapes:Dynamic, ?name:Dynamic):Dynamic;
	/**
		Initialize an `OperatorPDSqrtVDVTUpdate`.
		...
		Args:
		  ...
		  name:  A name to prepend to `Op` names.
	**/
	public function new(operator:Dynamic, v:Dynamic, ?diag:Dynamic, ?verify_pd:Dynamic, ?verify_shapes:Dynamic, ?name:Dynamic):Void;
	/**
	...
	**/
	public function _check_shapes_dynamic(operator:Dynamic, v:Dynamic, diag:Dynamic):Dynamic;
	/**
		True if they are compatible. Raise if not. False if could not check.
	**/
	public function _check_shapes_static(operator:Dynamic, v:Dynamic, diag:Dynamic):Dynamic;
	public function _check_types(operator:Dynamic, v:Dynamic, diag:Dynamic):Dynamic;
	/**
		Cholesky factorization of the capacitance term.
	**/
	public function _chol_capacitance(batch_mode:Dynamic):Dynamic;
	...
	**/
	public function _get_identity_operator(v:Dynamic):Dynamic;
	...
	**/
	public function _sqrt_log_det_core(diag_chol_c:Dynamic):Dynamic;
