...
package tensorflow.contrib.distributions.python.ops.vector_sinh_arcsinh_diag;
@:pythonImport("tensorflow.contrib.distributions.python.ops.vector_sinh_arcsinh_diag", "VectorSinhArcsinhDiag") extern class VectorSinhArcsinhDiag {
	...
	**/
	@:native("__init__")
	public function ___init__(?loc:Dynamic, ?scale_diag:Dynamic, ?scale_identity_multiplier:Dynamic, ?skewness:Dynamic, ?tailweight:Dynamic, ?distribution:Dynamic, ?validate_args:Dynamic, ?allow_nan_stats:Dynamic, ?name:Dynamic):Dynamic;
	/**
		Construct VectorSinhArcsinhDiag distribution on `R^k`. (deprecated)
		...
		Raises:
		  ValueError: if at most `scale_identity_multiplier` is specified.
	**/
	public function new(?loc:Dynamic, ?scale_diag:Dynamic, ?scale_identity_multiplier:Dynamic, ?skewness:Dynamic, ?tailweight:Dynamic, ?distribution:Dynamic, ?validate_args:Dynamic, ?allow_nan_stats:Dynamic, ?name:Dynamic):Void;
	/**
