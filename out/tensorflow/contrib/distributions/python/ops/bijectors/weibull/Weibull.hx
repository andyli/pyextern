...
package tensorflow.contrib.distributions.python.ops.bijectors.weibull;
@:pythonImport("tensorflow.contrib.distributions.python.ops.bijectors.weibull", "Weibull") extern class Weibull {
	...
	**/
	...
	/**
		Instantiates the `Weibull` bijector. (deprecated)
	...
	**/
	@:native("__init__")
	public function ___init__(?scale:Dynamic, ?concentration:Dynamic, ?validate_args:Dynamic, ?name:Dynamic):Dynamic;
	/**
		Instantiates the `Weibull` bijector. (deprecated)
		...
		Args:
		  ...
		  name: Python `str` name given to ops managed by this object.
	**/
	public function new(?scale:Dynamic, ?concentration:Dynamic, ?validate_args:Dynamic, ?name:Dynamic):Void;
	/**
