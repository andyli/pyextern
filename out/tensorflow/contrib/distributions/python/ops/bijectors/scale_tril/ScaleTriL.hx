...
package tensorflow.contrib.distributions.python.ops.bijectors.scale_tril;
@:pythonImport("tensorflow.contrib.distributions.python.ops.bijectors.scale_tril", "ScaleTriL") extern class ScaleTriL {
	...
	**/
	@:native("__init__")
	public function ___init__(?diag_bijector:Dynamic, ?diag_shift:Dynamic, ?validate_args:Dynamic, ?name:Dynamic):Dynamic;
	/**
		Instantiates the `ScaleTriL` bijector. (deprecated)
		...
		Args:
		  ...
		  name: Python `str` name given to ops managed by this object.
		    Default value: `scale_tril`.
	**/
	public function new(?diag_bijector:Dynamic, ?diag_shift:Dynamic, ?validate_args:Dynamic, ?name:Dynamic):Void;
	/**
