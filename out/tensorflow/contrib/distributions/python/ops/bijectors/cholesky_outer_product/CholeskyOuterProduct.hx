...
package tensorflow.contrib.distributions.python.ops.bijectors.cholesky_outer_product;
@:pythonImport("tensorflow.contrib.distributions.python.ops.bijectors.cholesky_outer_product", "CholeskyOuterProduct") extern class CholeskyOuterProduct {
