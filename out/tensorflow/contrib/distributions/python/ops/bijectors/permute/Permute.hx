...
package tensorflow.contrib.distributions.python.ops.bijectors.permute;
@:pythonImport("tensorflow.contrib.distributions.python.ops.bijectors.permute", "Permute") extern class Permute {
	...
	**/
	@:native("__init__")
	public function ___init__(permutation:Dynamic, ?validate_args:Dynamic, ?name:Dynamic):Dynamic;
	/**
		Creates the `Permute` bijector. (deprecated)
		...
		Raises:
		  ...
		  ValueError: if `permutation` does not contain exactly one of each of
		    `{0, 1, ..., d}`.
	**/
	public function new(permutation:Dynamic, ?validate_args:Dynamic, ?name:Dynamic):Void;
	/**
	...
	**/
	...
	public var permutation : Dynamic;
	/**
