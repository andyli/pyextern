...
@:pythonImport("tensorflow.contrib.distributions.python.ops.bijectors.real_nvp", "RealNVP") extern class RealNVP {
	...
	**/
	@:native("__init__")
	public function ___init__(num_masked:Dynamic, shift_and_log_scale_fn:Dynamic, ?is_constant_jacobian:Dynamic, ?validate_args:Dynamic, ?name:Dynamic):Dynamic;
	/**
		Creates the Real NVP or NICE bijector. (deprecated)
		...
		Raises:
		  ValueError: If num_masked < 1.
	**/
	public function new(num_masked:Dynamic, shift_and_log_scale_fn:Dynamic, ?is_constant_jacobian:Dynamic, ?validate_args:Dynamic, ?name:Dynamic):Void;
	/**
	...
	**/
	...
	public function _cache_input_depth(x:Dynamic):Dynamic;
