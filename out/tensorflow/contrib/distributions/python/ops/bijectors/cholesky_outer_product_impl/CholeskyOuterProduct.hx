...
package tensorflow.contrib.distributions.python.ops.bijectors.cholesky_outer_product_impl;
@:pythonImport("tensorflow.contrib.distributions.python.ops.bijectors.cholesky_outer_product_impl", "CholeskyOuterProduct") extern class CholeskyOuterProduct {
	...
	**/
	@:native("__init__")
	public function ___init__(?event_ndims:Dynamic, ?validate_args:Dynamic, ?name:Dynamic):Dynamic;
	/**
		Instantiates the `CholeskyOuterProduct` bijector.
		...
		Raises:
		  ValueError: if event_ndims is neither 0 or 2.
	**/
	public function new(?event_ndims:Dynamic, ?validate_args:Dynamic, ?name:Dynamic):Void;
	/**
	...
	**/
	public function _make_columnar(x:Dynamic):Dynamic;
	/**
