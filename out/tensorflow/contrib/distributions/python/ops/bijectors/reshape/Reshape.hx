...
package tensorflow.contrib.distributions.python.ops.bijectors.reshape;
@:pythonImport("tensorflow.contrib.distributions.python.ops.bijectors.reshape", "Reshape") extern class Reshape {
	...
	**/
	@:native("__init__")
	public function ___init__(event_shape_out:Dynamic, ?event_shape_in:Dynamic, ?validate_args:Dynamic, ?name:Dynamic):Dynamic;
	/**
		Creates a `Reshape` bijector. (deprecated)
		...
		Raises:
		  ...
		  ValueError: if either of `event_shape_in` or `event_shape_out`
		   ...
		   match.
	**/
	public function new(event_shape_out:Dynamic, ?event_shape_in:Dynamic, ?validate_args:Dynamic, ?name:Dynamic):Void;
	/**
	...
	**/
	public function _maybe_check_valid_shape(shape:Dynamic, validate_args:Dynamic):Dynamic;
	/**
	...
	**/
	public function _reshape_helper(x:Dynamic, event_shape_in:Dynamic, event_shape_out:Dynamic):Dynamic;
	/**
