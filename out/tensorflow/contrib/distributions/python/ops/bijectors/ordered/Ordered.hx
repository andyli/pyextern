...
package tensorflow.contrib.distributions.python.ops.bijectors.ordered;
@:pythonImport("tensorflow.contrib.distributions.python.ops.bijectors.ordered", "Ordered") extern class Ordered {
