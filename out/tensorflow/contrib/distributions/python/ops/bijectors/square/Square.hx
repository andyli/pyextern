...
package tensorflow.contrib.distributions.python.ops.bijectors.square;
@:pythonImport("tensorflow.contrib.distributions.python.ops.bijectors.square", "Square") extern class Square {
	...
	**/
	...
	public function _maybe_assert_valid(t:Dynamic):Dynamic;
	/**
