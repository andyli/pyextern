...
package tensorflow.contrib.distributions.python.ops.bijectors.sigmoid;
@:pythonImport("tensorflow.contrib.distributions.python.ops.bijectors.sigmoid", "Sigmoid") extern class Sigmoid {
