...
package tensorflow.contrib.distributions.python.ops.bijectors.sinh_arcsinh;
@:pythonImport("tensorflow.contrib.distributions.python.ops.bijectors.sinh_arcsinh", "SinhArcsinh") extern class SinhArcsinh {
	...
	**/
	@:native("__init__")
	public function ___init__(?skewness:Dynamic, ?tailweight:Dynamic, ?validate_args:Dynamic, ?name:Dynamic):Dynamic;
	/**
		Instantiates the `SinhArcsinh` bijector. (deprecated)
		...
		Args:
		  ...
		  name: Python `str` name given to ops managed by this object.
	**/
	public function new(?skewness:Dynamic, ?tailweight:Dynamic, ?validate_args:Dynamic, ?name:Dynamic):Void;
	/**
