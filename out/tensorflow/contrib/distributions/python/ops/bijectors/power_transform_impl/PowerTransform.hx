...
package tensorflow.contrib.distributions.python.ops.bijectors.power_transform_impl;
@:pythonImport("tensorflow.contrib.distributions.python.ops.bijectors.power_transform_impl", "PowerTransform") extern class PowerTransform {
	...
	**/
	@:native("__init__")
	public function ___init__(?power:Dynamic, ?event_ndims:Dynamic, ?validate_args:Dynamic, ?name:Dynamic):Dynamic;
	/**
		Instantiates the `PowerTransform` bijector.
		...
		Raises:
		  ValueError: if `power < 0` or is not known statically.
	**/
	public function new(?power:Dynamic, ?event_ndims:Dynamic, ?validate_args:Dynamic, ?name:Dynamic):Void;
	/**
