...
package tensorflow.contrib.distributions.python.ops.bijectors.kumaraswamy;
@:pythonImport("tensorflow.contrib.distributions.python.ops.bijectors.kumaraswamy", "Kumaraswamy") extern class Kumaraswamy {
	...
	**/
	@:native("__init__")
	public function ___init__(?concentration1:Dynamic, ?concentration0:Dynamic, ?validate_args:Dynamic, ?name:Dynamic):Dynamic;
	/**
		Instantiates the `Kumaraswamy` bijector. (deprecated)
		...
		Args:
		  ...
		  name: Python `str` name given to ops managed by this object.
	**/
	public function new(?concentration1:Dynamic, ?concentration0:Dynamic, ?validate_args:Dynamic, ?name:Dynamic):Void;
	/**
	...
	**/
	...
	public function _maybe_assert_valid(x:Dynamic):Dynamic;
	/**
		Checks the validity of a concentration parameter.
	**/
	public function _maybe_assert_valid_concentration(concentration:Dynamic, validate_args:Dynamic):Dynamic;
	/**
	...
	**/
	public var concentration0 : Dynamic;
	/**
		The `a` in: `Y = g(X) = (1 - (1 - X)**(1 / b))**(1 / a)`.
	**/
	public var concentration1 : Dynamic;
	/**
