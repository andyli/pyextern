...
package tensorflow.contrib.distributions.python.ops.bijectors._inline;
@:pythonImport("tensorflow.contrib.distributions.python.ops.bijectors.inline", "Inline") extern class Inline {
