...
package tensorflow.contrib.distributions.python.ops.bijectors.invert_impl;
@:pythonImport("tensorflow.contrib.distributions.python.ops.bijectors.invert_impl", "Invert") extern class Invert {
	...
	**/
	@:native("__init__")
	public function ___init__(bijector:Dynamic, ?validate_args:Dynamic, ?name:Dynamic):Dynamic;
	/**
		Creates a `Bijector` which swaps the meaning of `inverse` and `forward`.
		...
		Args:
		  ...
		  name: Python `str`, name given to ops managed by this object.
	**/
	public function new(bijector:Dynamic, ?validate_args:Dynamic, ?name:Dynamic):Void;
	/**
