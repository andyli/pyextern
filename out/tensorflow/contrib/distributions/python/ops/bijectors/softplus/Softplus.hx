...
package tensorflow.contrib.distributions.python.ops.bijectors.softplus;
@:pythonImport("tensorflow.contrib.distributions.python.ops.bijectors.softplus", "Softplus") extern class Softplus {
	...
	**/
	@:native("__init__")
	public function ___init__(?hinge_softness:Dynamic, ?validate_args:Dynamic, ?name:Dynamic):Dynamic;
	/**
		DEPRECATED FUNCTION
		...
		*  `hinge_softness`: Nonzero floating point `Tensor`.  Controls the softness of what would otherwise be a kink at the origin.  Default is 1.0
	**/
	public function new(?hinge_softness:Dynamic, ?validate_args:Dynamic, ?name:Dynamic):Void;
	/**
