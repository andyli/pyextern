...
@:pythonImport("tensorflow.contrib.distributions.python.ops.bijectors.masked_autoregressive", "MaskedAutoregressiveFlow") extern class MaskedAutoregressiveFlow {
	...
	**/
	@:native("__init__")
	public function ___init__(shift_and_log_scale_fn:Dynamic, ?is_constant_jacobian:Dynamic, ?validate_args:Dynamic, ?unroll_loop:Dynamic, ?name:Dynamic):Dynamic;
	/**
		Creates the MaskedAutoregressiveFlow bijector. (deprecated)
		...
		Args:
		  ...
		  name: Python `str`, name given to ops managed by this object.
	**/
	public function new(shift_and_log_scale_fn:Dynamic, ?is_constant_jacobian:Dynamic, ?validate_args:Dynamic, ?unroll_loop:Dynamic, ?name:Dynamic):Void;
	/**
