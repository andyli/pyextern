...
package tensorflow.contrib.distributions.python.ops.bijectors.transform_diagonal;
@:pythonImport("tensorflow.contrib.distributions.python.ops.bijectors.transform_diagonal", "TransformDiagonal") extern class TransformDiagonal {
	...
	**/
	@:native("__init__")
	public function ___init__(diag_bijector:Dynamic, ?validate_args:Dynamic, ?name:Dynamic):Dynamic;
	/**
		Instantiates the `TransformDiagonal` bijector. (deprecated)
		...
		Args:
		  ...
		  name: Python `str` name given to ops managed by this object.
	**/
	public function new(diag_bijector:Dynamic, ?validate_args:Dynamic, ?name:Dynamic):Void;
	/**
