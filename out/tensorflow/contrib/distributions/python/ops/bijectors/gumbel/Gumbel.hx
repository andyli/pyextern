...
package tensorflow.contrib.distributions.python.ops.bijectors.gumbel;
@:pythonImport("tensorflow.contrib.distributions.python.ops.bijectors.gumbel", "Gumbel") extern class Gumbel {
	...
	**/
	@:native("__init__")
	public function ___init__(?loc:Dynamic, ?scale:Dynamic, ?validate_args:Dynamic, ?name:Dynamic):Dynamic;
	/**
		Instantiates the `Gumbel` bijector. (deprecated)
		...
		Args:
		  ...
		  name: Python `str` name given to ops managed by this object.
	**/
	public function new(?loc:Dynamic, ?scale:Dynamic, ?validate_args:Dynamic, ?name:Dynamic):Void;
	/**
