...
@:pythonImport("tensorflow.contrib.distributions.python.ops.bijectors.fill_triangular", "FillTriangular") extern class FillTriangular {
	...
	**/
	@:native("__init__")
	public function ___init__(?upper:Dynamic, ?validate_args:Dynamic, ?name:Dynamic):Dynamic;
	/**
		Instantiates the `FillTriangular` bijector. (deprecated)
		...
		Args:
		  ...
		  name: Python `str` name given to ops managed by this object.
	**/
	public function new(?upper:Dynamic, ?validate_args:Dynamic, ?name:Dynamic):Void;
	/**
	...
	**/
	public function _forward_event_shape_tensor(input_shape_tensor:Dynamic):Dynamic;
	/**
	...
	**/
	public function _inverse_event_shape_tensor(output_shape_tensor:Dynamic):Dynamic;
	/**
