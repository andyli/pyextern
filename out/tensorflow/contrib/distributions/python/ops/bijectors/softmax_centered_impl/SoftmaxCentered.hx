...
package tensorflow.contrib.distributions.python.ops.bijectors.softmax_centered_impl;
@:pythonImport("tensorflow.contrib.distributions.python.ops.bijectors.softmax_centered_impl", "SoftmaxCentered") extern class SoftmaxCentered {
