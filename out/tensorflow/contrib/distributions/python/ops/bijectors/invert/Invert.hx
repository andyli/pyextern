...
package tensorflow.contrib.distributions.python.ops.bijectors.invert;
@:pythonImport("tensorflow.contrib.distributions.python.ops.bijectors.invert", "Invert") extern class Invert {
