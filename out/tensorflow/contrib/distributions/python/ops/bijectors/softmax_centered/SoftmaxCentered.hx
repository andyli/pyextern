...
package tensorflow.contrib.distributions.python.ops.bijectors.softmax_centered;
@:pythonImport("tensorflow.contrib.distributions.python.ops.bijectors.softmax_centered", "SoftmaxCentered") extern class SoftmaxCentered {
