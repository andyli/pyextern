...
@:pythonImport("tensorflow.contrib.distributions.python.ops.bijectors.batch_normalization", "BatchNormalization") extern class BatchNormalization {
	...
	**/
	@:native("__init__")
	public function ___init__(?batchnorm_layer:Dynamic, ?training:Dynamic, ?validate_args:Dynamic, ?name:Dynamic):Dynamic;
	/**
		Instantiates the `BatchNorm` bijector. (deprecated)
		...
		Raises:
		  ValueError: If bn_layer is not an instance of
		    ...
		    or a virtual batch size.
	**/
	public function new(?batchnorm_layer:Dynamic, ?training:Dynamic, ?validate_args:Dynamic, ?name:Dynamic):Void;
	/**
	...
	**/
	...
	public function _de_normalize(x:Dynamic):Dynamic;
	/**
	...
	**/
	...
	public function _get_broadcast_fn(x:Dynamic):Dynamic;
	/**
	...
	/**
		...
		Returns:
		  inverse_log_det_jacobian: `Tensor`, if this bijector is injective.
		    ...
		    unique `k` points `(x1, ..., xk)` such that `g(xi) = y`.
	**/
	public function _inverse_log_det_jacobian(y:Dynamic, ?use_saved_statistics:Dynamic):Dynamic;
	/**
	...
	**/
	...
	public function _normalize(y:Dynamic):Dynamic;
	/**
	...
	**/
	public function _validate_bn_layer(layer:Dynamic):Dynamic;
	/**
