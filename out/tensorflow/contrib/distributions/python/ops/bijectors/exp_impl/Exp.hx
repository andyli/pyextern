...
package tensorflow.contrib.distributions.python.ops.bijectors.exp_impl;
@:pythonImport("tensorflow.contrib.distributions.python.ops.bijectors.exp_impl", "Exp") extern class Exp {
