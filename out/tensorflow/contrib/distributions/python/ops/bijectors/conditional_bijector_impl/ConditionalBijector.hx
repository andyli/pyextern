...
package tensorflow.contrib.distributions.python.ops.bijectors.conditional_bijector_impl;
@:pythonImport("tensorflow.contrib.distributions.python.ops.bijectors.conditional_bijector_impl", "ConditionalBijector") extern class ConditionalBijector {
	...
	**/
	...
	/**
		...
		*  `**condition_kwargs`: Named arguments forwarded to subclass implementation.
	**/
	public function forward_log_det_jacobian(x:Dynamic, ?name:Dynamic, ?condition_kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
	...
	**/
	...
	/**
		...
		*  `**condition_kwargs`: Named arguments forwarded to subclass implementation.
	**/
	public function inverse_log_det_jacobian(y:Dynamic, ?name:Dynamic, ?condition_kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
