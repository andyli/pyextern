...
package tensorflow.contrib.distributions.python.ops.bijectors.matrix_inverse_tril;
@:pythonImport("tensorflow.contrib.distributions.python.ops.bijectors.matrix_inverse_tril", "MatrixInverseTriL") extern class MatrixInverseTriL {
	...
	**/
	...
	public function _assertions(x:Dynamic):Dynamic;
	/**
