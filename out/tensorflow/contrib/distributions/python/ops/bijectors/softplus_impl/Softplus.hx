...
package tensorflow.contrib.distributions.python.ops.bijectors.softplus_impl;
@:pythonImport("tensorflow.contrib.distributions.python.ops.bijectors.softplus_impl", "Softplus") extern class Softplus {
	...
	**/
	@:native("__init__")
	public function ___init__(?event_ndims:Dynamic, ?hinge_softness:Dynamic, ?validate_args:Dynamic, ?name:Dynamic):Dynamic;
	/**
		##### `kwargs`:
		
		*  `hinge_softness`: Nonzero floating point `Tensor`.  Controls the softness of what would otherwise be a kink at the origin.  Default is 1.0
	**/
	public function new(?event_ndims:Dynamic, ?hinge_softness:Dynamic, ?validate_args:Dynamic, ?name:Dynamic):Void;
	/**
	...
	**/
	...
	public var hinge_softness : Dynamic;
	/**
