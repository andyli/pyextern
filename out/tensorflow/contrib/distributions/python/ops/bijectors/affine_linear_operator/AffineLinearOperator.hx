...
package tensorflow.contrib.distributions.python.ops.bijectors.affine_linear_operator;
@:pythonImport("tensorflow.contrib.distributions.python.ops.bijectors.affine_linear_operator", "AffineLinearOperator") extern class AffineLinearOperator {
	...
	**/
	@:native("__init__")
	public function ___init__(?shift:Dynamic, ?scale:Dynamic, ?validate_args:Dynamic, ?name:Dynamic):Dynamic;
	/**
		Instantiates the `AffineLinearOperator` bijector. (deprecated)
		...
		Raises:
		  ...
		  ValueError: if not `scale.is_non_singular`.
	**/
	public function new(?shift:Dynamic, ?scale:Dynamic, ?validate_args:Dynamic, ?name:Dynamic):Void;
	/**
