...
package tensorflow.contrib.distributions.python.ops.bijectors.inline_impl;
@:pythonImport("tensorflow.contrib.distributions.python.ops.bijectors.inline_impl", "Inline") extern class Inline {
	...
	**/
	@:native("__init__")
	public function ___init__(?forward_fn:Dynamic, ?inverse_fn:Dynamic, ?inverse_log_det_jacobian_fn:Dynamic, ?forward_log_det_jacobian_fn:Dynamic, ?forward_event_shape_fn:Dynamic, ?forward_event_shape_tensor_fn:Dynamic, ?inverse_event_shape_fn:Dynamic, ?inverse_event_shape_tensor_fn:Dynamic, ?is_constant_jacobian:Dynamic, ?validate_args:Dynamic, ?name:Dynamic):Dynamic;
	/**
		Creates a `Bijector` from callables.
		...
		Args:
		  ...
		  name: Python `str`, name given to ops managed by this object.
	**/
	public function new(?forward_fn:Dynamic, ?inverse_fn:Dynamic, ?inverse_log_det_jacobian_fn:Dynamic, ?forward_log_det_jacobian_fn:Dynamic, ?forward_event_shape_fn:Dynamic, ?forward_event_shape_tensor_fn:Dynamic, ?inverse_event_shape_fn:Dynamic, ?inverse_event_shape_tensor_fn:Dynamic, ?is_constant_jacobian:Dynamic, ?validate_args:Dynamic, ?name:Dynamic):Void;
	/**
	...
	**/
	public function _forward_log_det_jacobian(y:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
