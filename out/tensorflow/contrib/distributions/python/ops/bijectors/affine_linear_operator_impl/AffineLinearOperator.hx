...
package tensorflow.contrib.distributions.python.ops.bijectors.affine_linear_operator_impl;
@:pythonImport("tensorflow.contrib.distributions.python.ops.bijectors.affine_linear_operator_impl", "AffineLinearOperator") extern class AffineLinearOperator {
	...
	**/
	@:native("__init__")
	public function ___init__(?shift:Dynamic, ?scale:Dynamic, ?event_ndims:Dynamic, ?validate_args:Dynamic, ?name:Dynamic):Dynamic;
	/**
		Instantiates the `AffineLinearOperator` bijector.
		...
		Raises:
		  ...
		  ValueError: if not `scale.is_non_singular`.
	**/
	public function new(?shift:Dynamic, ?scale:Dynamic, ?event_ndims:Dynamic, ?validate_args:Dynamic, ?name:Dynamic):Void;
	/**
	...
	**/
	...
	public function _maybe_collect_assertions():Dynamic;
	/**
