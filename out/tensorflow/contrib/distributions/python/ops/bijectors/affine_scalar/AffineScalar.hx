...
package tensorflow.contrib.distributions.python.ops.bijectors.affine_scalar;
@:pythonImport("tensorflow.contrib.distributions.python.ops.bijectors.affine_scalar", "AffineScalar") extern class AffineScalar {
