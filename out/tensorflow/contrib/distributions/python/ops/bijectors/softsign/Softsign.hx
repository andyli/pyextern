...
package tensorflow.contrib.distributions.python.ops.bijectors.softsign;
@:pythonImport("tensorflow.contrib.distributions.python.ops.bijectors.softsign", "Softsign") extern class Softsign {
