...
package tensorflow.contrib.distributions.python.ops.bijectors.sigmoid_centered_impl;
@:pythonImport("tensorflow.contrib.distributions.python.ops.bijectors.sigmoid_centered_impl", "SigmoidCentered") extern class SigmoidCentered {
