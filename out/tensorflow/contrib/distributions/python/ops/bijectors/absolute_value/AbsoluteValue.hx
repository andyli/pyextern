...
package tensorflow.contrib.distributions.python.ops.bijectors.absolute_value;
@:pythonImport("tensorflow.contrib.distributions.python.ops.bijectors.absolute_value", "AbsoluteValue") extern class AbsoluteValue {
