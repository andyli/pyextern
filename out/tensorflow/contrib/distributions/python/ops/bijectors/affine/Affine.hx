...
@:pythonImport("tensorflow.contrib.distributions.python.ops.bijectors.affine", "Affine") extern class Affine {
	...
	**/
	@:native("__init__")
	public function ___init__(?shift:Dynamic, ?scale_identity_multiplier:Dynamic, ?scale_diag:Dynamic, ?scale_tril:Dynamic, ?scale_perturb_factor:Dynamic, ?scale_perturb_diag:Dynamic, ?validate_args:Dynamic, ?name:Dynamic):Dynamic;
	/**
		Instantiates the `Affine` bijector. (deprecated)
		...
		Raises:
		  ...
		  TypeError: if `shift` has different `dtype` from `scale` arguments.
	**/
	public function new(?shift:Dynamic, ?scale_identity_multiplier:Dynamic, ?scale_diag:Dynamic, ?scale_tril:Dynamic, ?scale_perturb_factor:Dynamic, ?scale_perturb_diag:Dynamic, ?validate_args:Dynamic, ?name:Dynamic):Void;
	/**
	...
	**/
	public function _create_scale_operator(identity_multiplier:Dynamic, diag:Dynamic, tril:Dynamic, perturb_diag:Dynamic, perturb_factor:Dynamic, shift:Dynamic, validate_args:Dynamic):Dynamic;
	/**
	...
	**/
	...
	public function _maybe_check_scale():Dynamic;
	/**
