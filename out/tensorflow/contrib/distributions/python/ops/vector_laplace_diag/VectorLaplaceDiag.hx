...
package tensorflow.contrib.distributions.python.ops.vector_laplace_diag;
@:pythonImport("tensorflow.contrib.distributions.python.ops.vector_laplace_diag", "VectorLaplaceDiag") extern class VectorLaplaceDiag {
