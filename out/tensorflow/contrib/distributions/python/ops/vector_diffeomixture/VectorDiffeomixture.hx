...
@:pythonImport("tensorflow.contrib.distributions.python.ops.vector_diffeomixture", "VectorDiffeomixture") extern class VectorDiffeomixture {
	...
	**/
	@:native("__init__")
	public function ___init__(mix_loc:Dynamic, temperature:Dynamic, distribution:Dynamic, ?loc:Dynamic, ?scale:Dynamic, ?quadrature_size:Dynamic, ?quadrature_fn:Dynamic, ?validate_args:Dynamic, ?allow_nan_stats:Dynamic, ?name:Dynamic):Dynamic;
	/**
		Constructs the VectorDiffeomixture on `R^d`. (deprecated)
		...
		Raises:
		  ...
		  ValueError: if `not distribution.is_scalar_event`.
	**/
	public function new(mix_loc:Dynamic, temperature:Dynamic, distribution:Dynamic, ?loc:Dynamic, ?scale:Dynamic, ?quadrature_size:Dynamic, ?quadrature_fn:Dynamic, ?validate_args:Dynamic, ?allow_nan_stats:Dynamic, ?name:Dynamic):Void;
	/**
	...
	**/
	...
	public function _covariance_of_mean_given_quadrature_component(diag_only:Dynamic):Dynamic;
	...
	**/
	public function _expand_base_distribution_mean():Dynamic;
	public function _expand_mix_distribution_probs():Dynamic;
	/**
	...
	**/
	...
	public function _mean_of_covariance_given_quadrature_component(diag_only:Dynamic):Dynamic;
	...
	**/
	public var endpoint_affine : Dynamic;
	/**
	...
	**/
	public var interpolated_affine : Dynamic;
	/**
	...
	**/
	public var mixture_distribution : Dynamic;
	/**
		Mode.
	**/
