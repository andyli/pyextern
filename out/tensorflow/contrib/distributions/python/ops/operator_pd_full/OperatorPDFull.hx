...
package tensorflow.contrib.distributions.python.ops.operator_pd_full;
@:pythonImport("tensorflow.contrib.distributions.python.ops.operator_pd_full", "OperatorPDFull") extern class OperatorPDFull {
	...
	**/
	@:native("__init__")
	public function ___init__(matrix:Dynamic, ?verify_pd:Dynamic, ?name:Dynamic):Dynamic;
	/**
		Initialize an OperatorPDFull.
		...
		Args:
		  ...
		  name:  A name to prepend to all ops created by this class.
	**/
	public function new(matrix:Dynamic, ?verify_pd:Dynamic, ?name:Dynamic):Void;
	/**
	...
	**/
	public function _check_chol(chol:Dynamic):Dynamic;
