...
package tensorflow.contrib.distributions.python.ops.exponential;
@:pythonImport("tensorflow.contrib.distributions.python.ops.exponential", "Exponential") extern class Exponential {
	...
	**/
	@:native("__init__")
	public function ___init__(lam:Dynamic, ?validate_args:Dynamic, ?allow_nan_stats:Dynamic, ?name:Dynamic):Dynamic;
	/**
		Construct Exponential distribution with parameter `lam`.
		...
		Args:
		  ...
		  name: The name to prepend to all ops created by this distribution.
	**/
	public function new(lam:Dynamic, ?validate_args:Dynamic, ?allow_nan_stats:Dynamic, ?name:Dynamic):Void;
	/**
		Return self<=value.
	**/
