...
package tensorflow.contrib.distributions.python.ops.logistic;
@:pythonImport("tensorflow.contrib.distributions.python.ops.logistic", "Logistic") extern class Logistic {
