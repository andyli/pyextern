...
package tensorflow.contrib.distributions.python.ops.geometric;
@:pythonImport("tensorflow.contrib.distributions.python.ops.geometric", "Geometric") extern class Geometric {
	...
	**/
	@:native("__init__")
	public function ___init__(?logits:Dynamic, ?probs:Dynamic, ?validate_args:Dynamic, ?allow_nan_stats:Dynamic, ?name:Dynamic):Dynamic;
	/**
		Construct Geometric distributions. (deprecated)
		...
		Args:
		  ...
		  name: Python `str` name prefixed to Ops created by this class.
	**/
	public function new(?logits:Dynamic, ?probs:Dynamic, ?validate_args:Dynamic, ?allow_nan_stats:Dynamic, ?name:Dynamic):Void;
	/**
