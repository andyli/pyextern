...
package tensorflow.contrib.distributions.python.ops.distribution;
@:pythonImport("tensorflow.contrib.distributions.python.ops.distribution", "BaseDistribution") extern class BaseDistribution {
