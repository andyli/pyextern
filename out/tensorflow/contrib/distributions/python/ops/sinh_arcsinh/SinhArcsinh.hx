...
package tensorflow.contrib.distributions.python.ops.sinh_arcsinh;
@:pythonImport("tensorflow.contrib.distributions.python.ops.sinh_arcsinh", "SinhArcsinh") extern class SinhArcsinh {
	...
	**/
	@:native("__init__")
	public function ___init__(loc:Dynamic, scale:Dynamic, ?skewness:Dynamic, ?tailweight:Dynamic, ?distribution:Dynamic, ?validate_args:Dynamic, ?allow_nan_stats:Dynamic, ?name:Dynamic):Dynamic;
	/**
		Construct SinhArcsinh distribution on `(-inf, inf)`. (deprecated)
		...
		Args:
		  ...
		  name: Python `str` name prefixed to Ops created by this class.
	**/
	public function new(loc:Dynamic, scale:Dynamic, ?skewness:Dynamic, ?tailweight:Dynamic, ?distribution:Dynamic, ?validate_args:Dynamic, ?allow_nan_stats:Dynamic, ?name:Dynamic):Void;
	/**
