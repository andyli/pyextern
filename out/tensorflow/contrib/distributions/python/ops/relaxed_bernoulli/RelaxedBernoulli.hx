...
package tensorflow.contrib.distributions.python.ops.relaxed_bernoulli;
@:pythonImport("tensorflow.contrib.distributions.python.ops.relaxed_bernoulli", "RelaxedBernoulli") extern class RelaxedBernoulli {
	...
	**/
	...
	/**
		...
		Raises:
		  ValueError: If both `probs` and `logits` are passed, or if neither.
	**/
	public function new(temperature:Dynamic, ?logits:Dynamic, ?probs:Dynamic, ?validate_args:Dynamic, ?allow_nan_stats:Dynamic, ?name:Dynamic):Void;
	/**
