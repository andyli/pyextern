...
@:pythonImport("tensorflow.contrib.distributions.python.ops.quantized_distribution", "QuantizedDistribution") extern class QuantizedDistribution {
	...
	**/
	...
	/**
		...
		Raises:
		  ...
		  NotImplementedError:  If the base distribution does not implement `cdf`.
	**/
	public function new(distribution:Dynamic, ?low:Dynamic, ?high:Dynamic, ?validate_args:Dynamic, ?name:Dynamic):Void;
	/**
	...
	**/
	...
	public function _log_prob_with_logcdf(y:Dynamic):Dynamic;
	/**
		Compute log_prob(y) using log survival_function and cdf together.
	**/
	public function _log_prob_with_logsf_and_logcdf(y:Dynamic):Dynamic;
	/**
		For whole numbers `y`,
	...
	**/
	...
	public function _prob_with_cdf(y:Dynamic):Dynamic;
	public function _prob_with_sf_and_cdf(y:Dynamic):Dynamic;
