...
@:pythonImport("tensorflow.contrib.distributions.python.ops.vector_student_t", "_VectorStudentT") extern class _VectorStudentT {
	...
	**/
	...
	/**
		...
		Args:
		  ...
		  name: Python `str` name prefixed to Ops created by this class.
	**/
	public function new(df:Dynamic, ?loc:Dynamic, ?scale_identity_multiplier:Dynamic, ?scale_diag:Dynamic, ?scale_tril:Dynamic, ?scale_perturb_factor:Dynamic, ?scale_perturb_diag:Dynamic, ?validate_args:Dynamic, ?allow_nan_stats:Dynamic, ?name:Dynamic):Void;
	/**
