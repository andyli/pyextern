...
@:pythonImport("tensorflow.contrib.distributions.python.ops.chi2", "Chi2WithAbsDf") extern class Chi2WithAbsDf {
	...
	**/
	@:native("__init__")
	public function ___init__(df:Dynamic, ?validate_args:Dynamic, ?allow_nan_stats:Dynamic, ?name:Dynamic):Dynamic;
	/**
		DEPRECATED FUNCTION
		...
		The TensorFlow Distributions library has moved to TensorFlow Probability (https://github.com/tensorflow/probability). You should update all references to use `tfp.distributions` instead of `tf.contrib.distributions`.
	**/
	public function new(df:Dynamic, ?validate_args:Dynamic, ?allow_nan_stats:Dynamic, ?name:Dynamic):Void;
	/**
