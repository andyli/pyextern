...
package tensorflow.contrib.distributions.python.ops.operator_pd_identity;
@:pythonImport("tensorflow.contrib.distributions.python.ops.operator_pd_identity", "OperatorPDIdentity") extern class OperatorPDIdentity {
	...
	**/
	public function _check_shape(shape:Dynamic):Dynamic;
	/**
