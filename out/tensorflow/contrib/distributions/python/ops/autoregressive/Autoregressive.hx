...
package tensorflow.contrib.distributions.python.ops.autoregressive;
@:pythonImport("tensorflow.contrib.distributions.python.ops.autoregressive", "Autoregressive") extern class Autoregressive {
	...
	**/
	@:native("__init__")
	public function ___init__(distribution_fn:Dynamic, ?sample0:Dynamic, ?num_steps:Dynamic, ?validate_args:Dynamic, ?allow_nan_stats:Dynamic, ?name:Dynamic):Dynamic;
	/**
		Construct an `Autoregressive` distribution. (deprecated)
		...
		Raises:
		  ...
		  ValueError: if `num_steps < 1`.
	**/
	public function new(distribution_fn:Dynamic, ?sample0:Dynamic, ?num_steps:Dynamic, ?validate_args:Dynamic, ?allow_nan_stats:Dynamic, ?name:Dynamic):Void;
	/**
	...
	**/
	...
	public var distribution0 : Dynamic;
	public var distribution_fn : Dynamic;
	/**
