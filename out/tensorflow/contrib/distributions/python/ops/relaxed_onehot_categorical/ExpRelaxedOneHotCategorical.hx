...
package tensorflow.contrib.distributions.python.ops.relaxed_onehot_categorical;
@:pythonImport("tensorflow.contrib.distributions.python.ops.relaxed_onehot_categorical", "ExpRelaxedOneHotCategorical") extern class ExpRelaxedOneHotCategorical {
	...
	**/
	@:native("__init__")
	public function ___init__(temperature:Dynamic, ?logits:Dynamic, ?probs:Dynamic, ?dtype:Dynamic, ?validate_args:Dynamic, ?allow_nan_stats:Dynamic, ?name:Dynamic):Dynamic;
	/**
		Initialize ExpRelaxedOneHotCategorical using class log-probabilities. (deprecated)
		...
		Args:
		  ...
		  name: Python `str` name prefixed to Ops created by this class.
	**/
	public function new(temperature:Dynamic, ?logits:Dynamic, ?probs:Dynamic, ?dtype:Dynamic, ?validate_args:Dynamic, ?allow_nan_stats:Dynamic, ?name:Dynamic):Void;
	/**
	...
	**/
	...
	public function _assert_valid_sample(x:Dynamic):Dynamic;
