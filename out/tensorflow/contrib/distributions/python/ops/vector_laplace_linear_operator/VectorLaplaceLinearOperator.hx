...
package tensorflow.contrib.distributions.python.ops.vector_laplace_linear_operator;
@:pythonImport("tensorflow.contrib.distributions.python.ops.vector_laplace_linear_operator", "VectorLaplaceLinearOperator") extern class VectorLaplaceLinearOperator {
