...
package tensorflow.contrib.distributions.python.ops.negative_binomial;
@:pythonImport("tensorflow.contrib.distributions.python.ops.negative_binomial", "NegativeBinomial") extern class NegativeBinomial {
	...
	**/
	...
	public function _cdf(positive_counts:Dynamic):Dynamic;
	...
	**/
	...
	public function _log_normalization(positive_counts:Dynamic):Dynamic;
	public function _log_prob(positive_counts:Dynamic):Dynamic;
	public function _log_survival_function(value:Dynamic):Dynamic;
	public function _log_unnormalized_prob(positive_counts:Dynamic):Dynamic;
