...
package tensorflow.contrib.distributions.python.ops.inverse_gamma;
@:pythonImport("tensorflow.contrib.distributions.python.ops.inverse_gamma", "InverseGammaWithSoftplusConcentrationRate") extern class InverseGammaWithSoftplusConcentrationRate {
