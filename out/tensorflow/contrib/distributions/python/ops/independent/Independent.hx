...
@:pythonImport("tensorflow.contrib.distributions.python.ops.independent", "Independent") extern class Independent {
	...
	**/
	@:native("__init__")
	public function ___init__(distribution:Dynamic, ?reinterpreted_batch_ndims:Dynamic, ?validate_args:Dynamic, ?name:Dynamic):Dynamic;
	/**
		Construct a `Independent` distribution. (deprecated)
		...
		Raises:
		  ValueError: if `reinterpreted_batch_ndims` exceeds
		    `distribution.batch_ndims`
	**/
	public function new(distribution:Dynamic, ?reinterpreted_batch_ndims:Dynamic, ?validate_args:Dynamic, ?name:Dynamic):Void;
	/**
	...
	**/
	public function _get_default_reinterpreted_batch_ndims(distribution:Dynamic):Dynamic;
	/**
	...
	**/
	...
	public function _make_runtime_assertions(distribution:Dynamic, reinterpreted_batch_ndims:Dynamic, validate_args:Dynamic):Dynamic;
	...
	**/
	...
	public function _reduce_sum(stat:Dynamic):Dynamic;
	...
	**/
	...
	public var reinterpreted_batch_ndims : Dynamic;
	/**
