...
@:pythonImport("tensorflow.contrib.distributions.python.ops.operator_pd_cholesky", "OperatorPDCholesky") extern class OperatorPDCholesky {
	...
	**/
	@:native("__init__")
	public function ___init__(chol:Dynamic, ?verify_pd:Dynamic, ?name:Dynamic):Dynamic;
	/**
		Initialize an OperatorPDCholesky.
		...
		Args:
		  ...
		  name:  A name to prepend to all ops created by this class.
	**/
	public function new(chol:Dynamic, ?verify_pd:Dynamic, ?name:Dynamic):Void;
	/**
		Return self<=value.
	**/
