...
@:pythonImport("tensorflow.contrib.distributions.python.ops.deterministic", "VectorDeterministic") extern class VectorDeterministic {
	...
	**/
	@:native("__init__")
	public function ___init__(loc:Dynamic, ?atol:Dynamic, ?rtol:Dynamic, ?validate_args:Dynamic, ?allow_nan_stats:Dynamic, ?name:Dynamic):Dynamic;
	/**
		Initialize a `VectorDeterministic` distribution on `R^k`, for `k >= 0`. (deprecated)
		...
		Args:
		  ...
		  name: Python `str` name prefixed to Ops created by this class.
	**/
	public function new(loc:Dynamic, ?atol:Dynamic, ?rtol:Dynamic, ?validate_args:Dynamic, ?allow_nan_stats:Dynamic, ?name:Dynamic):Void;
	/**
