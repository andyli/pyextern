...
package tensorflow.contrib.distributions.python.ops.deterministic;
@:pythonImport("tensorflow.contrib.distributions.python.ops.deterministic", "_BaseDeterministic") extern class _BaseDeterministic {
	...
	**/
	...
	/**
		Initialize a batch of `_BaseDeterministic` distributions. (deprecated)
	...
	**/
	@:native("__init__")
	public function ___init__(loc:Dynamic, ?atol:Dynamic, ?rtol:Dynamic, ?is_vector:Dynamic, ?validate_args:Dynamic, ?allow_nan_stats:Dynamic, ?name:Dynamic):Dynamic;
	/**
		Initialize a batch of `_BaseDeterministic` distributions. (deprecated)
		...
		Raises:
		  ValueError:  If `loc` is a scalar.
	**/
	public function new(loc:Dynamic, ?atol:Dynamic, ?rtol:Dynamic, ?is_vector:Dynamic, ?validate_args:Dynamic, ?allow_nan_stats:Dynamic, ?name:Dynamic):Void;
	/**
	...
	**/
	...
	public function _get_tol(tol:Dynamic):Dynamic;
	/**
