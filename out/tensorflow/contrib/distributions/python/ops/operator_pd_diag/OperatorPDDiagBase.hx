...
@:pythonImport("tensorflow.contrib.distributions.python.ops.operator_pd_diag", "OperatorPDDiagBase") extern class OperatorPDDiagBase {
	...
	**/
	@:native("__init__")
	public function ___init__(diag:Dynamic, ?verify_pd:Dynamic, ?name:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
