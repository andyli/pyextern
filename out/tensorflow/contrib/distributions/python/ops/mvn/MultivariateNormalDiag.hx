...
@:pythonImport("tensorflow.contrib.distributions.python.ops.mvn", "MultivariateNormalDiag") extern class MultivariateNormalDiag {
	...
	**/
	@:native("__init__")
	public function ___init__(mu:Dynamic, diag_stdev:Dynamic, ?validate_args:Dynamic, ?allow_nan_stats:Dynamic, ?name:Dynamic):Dynamic;
	/**
		Multivariate Normal distributions on `R^k`.
		...
		Raises:
		  TypeError: If `mu` and `diag_stdev` are different dtypes.
	**/
	public function new(mu:Dynamic, diag_stdev:Dynamic, ?validate_args:Dynamic, ?allow_nan_stats:Dynamic, ?name:Dynamic):Void;
	/**
		Return self<=value.
	**/
