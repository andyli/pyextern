...
@:pythonImport("tensorflow.contrib.distributions.python.ops.mvn", "MultivariateNormalDiagPlusVDVT") extern class MultivariateNormalDiagPlusVDVT {
	...
	**/
	@:native("__init__")
	public function ___init__(mu:Dynamic, diag_large:Dynamic, v:Dynamic, ?diag_small:Dynamic, ?validate_args:Dynamic, ?allow_nan_stats:Dynamic, ?name:Dynamic):Dynamic;
	/**
		Multivariate Normal distributions on `R^k`.
		...
		Args:
		  ...
		  name: The name to give Ops created by the initializer.
	**/
	public function new(mu:Dynamic, diag_large:Dynamic, v:Dynamic, ?diag_small:Dynamic, ?validate_args:Dynamic, ?allow_nan_stats:Dynamic, ?name:Dynamic):Void;
	/**
		Return self<=value.
	**/
