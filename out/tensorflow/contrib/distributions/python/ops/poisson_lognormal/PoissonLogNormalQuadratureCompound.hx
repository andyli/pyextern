...
@:pythonImport("tensorflow.contrib.distributions.python.ops.poisson_lognormal", "PoissonLogNormalQuadratureCompound") extern class PoissonLogNormalQuadratureCompound {
	...
	**/
	@:native("__init__")
	public function ___init__(loc:Dynamic, scale:Dynamic, ?quadrature_size:Dynamic, ?quadrature_fn:Dynamic, ?validate_args:Dynamic, ?allow_nan_stats:Dynamic, ?name:Dynamic):Dynamic;
	/**
		Constructs the PoissonLogNormalQuadratureCompound`. (deprecated)
		...
		Raises:
		  TypeError: if `quadrature_grid` and `quadrature_probs` have different base
		    `dtype`.
	**/
	public function new(loc:Dynamic, scale:Dynamic, ?quadrature_size:Dynamic, ?quadrature_fn:Dynamic, ?validate_args:Dynamic, ?allow_nan_stats:Dynamic, ?name:Dynamic):Void;
	/**
	...
	**/
	...
	public function _log_variance():Dynamic;
	...
	**/
	...
	public var quadrature_size : Dynamic;
	/**
