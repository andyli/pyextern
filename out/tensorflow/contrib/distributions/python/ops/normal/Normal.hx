...
package tensorflow.contrib.distributions.python.ops.normal;
@:pythonImport("tensorflow.contrib.distributions.python.ops.normal", "Normal") extern class Normal {
	...
	**/
	@:native("__init__")
	public function ___init__(mu:Dynamic, sigma:Dynamic, ?validate_args:Dynamic, ?allow_nan_stats:Dynamic, ?name:Dynamic):Dynamic;
	/**
		Construct Normal distributions with mean and stddev `mu` and `sigma`.
		...
		Raises:
		  TypeError: if mu and sigma are different dtypes.
	**/
	public function new(mu:Dynamic, sigma:Dynamic, ?validate_args:Dynamic, ?allow_nan_stats:Dynamic, ?name:Dynamic):Void;
	/**
		Return self<=value.
	**/
