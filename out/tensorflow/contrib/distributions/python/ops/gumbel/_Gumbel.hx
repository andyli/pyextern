...
package tensorflow.contrib.distributions.python.ops.gumbel;
@:pythonImport("tensorflow.contrib.distributions.python.ops.gumbel", "_Gumbel") extern class _Gumbel {
	...
	**/
	...
	/**
		Construct Gumbel distributions with location and scale `loc` and `scale`. (deprecated)
