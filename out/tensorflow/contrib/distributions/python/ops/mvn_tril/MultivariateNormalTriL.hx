...
package tensorflow.contrib.distributions.python.ops.mvn_tril;
@:pythonImport("tensorflow.contrib.distributions.python.ops.mvn_tril", "MultivariateNormalTriL") extern class MultivariateNormalTriL {
	...
	**/
	@:native("__init__")
	public function ___init__(?loc:Dynamic, ?scale_tril:Dynamic, ?validate_args:Dynamic, ?allow_nan_stats:Dynamic, ?name:Dynamic):Dynamic;
	/**
		Construct Multivariate Normal distribution on `R^k`.
		...
		Raises:
		  ValueError: if neither `loc` nor `scale_tril` are specified.
	**/
	public function new(?loc:Dynamic, ?scale_tril:Dynamic, ?validate_args:Dynamic, ?allow_nan_stats:Dynamic, ?name:Dynamic):Void;
	/**
