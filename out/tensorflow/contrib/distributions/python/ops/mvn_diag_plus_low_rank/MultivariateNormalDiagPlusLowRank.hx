...
package tensorflow.contrib.distributions.python.ops.mvn_diag_plus_low_rank;
@:pythonImport("tensorflow.contrib.distributions.python.ops.mvn_diag_plus_low_rank", "MultivariateNormalDiagPlusLowRank") extern class MultivariateNormalDiagPlusLowRank {
	...
	**/
	@:native("__init__")
	public function ___init__(?loc:Dynamic, ?scale_diag:Dynamic, ?scale_identity_multiplier:Dynamic, ?scale_perturb_factor:Dynamic, ?scale_perturb_diag:Dynamic, ?validate_args:Dynamic, ?allow_nan_stats:Dynamic, ?name:Dynamic):Dynamic;
	/**
		Construct Multivariate Normal distribution on `R^k`.
		...
		* `scale_perturb_diag.shape = [r]`.
		...
		Raises:
		  ValueError: if at most `scale_identity_multiplier` is specified.
	**/
	public function new(?loc:Dynamic, ?scale_diag:Dynamic, ?scale_identity_multiplier:Dynamic, ?scale_perturb_factor:Dynamic, ?scale_perturb_diag:Dynamic, ?validate_args:Dynamic, ?allow_nan_stats:Dynamic, ?name:Dynamic):Void;
	/**
