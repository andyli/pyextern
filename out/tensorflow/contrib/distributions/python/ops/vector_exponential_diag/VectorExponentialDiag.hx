...
package tensorflow.contrib.distributions.python.ops.vector_exponential_diag;
@:pythonImport("tensorflow.contrib.distributions.python.ops.vector_exponential_diag", "VectorExponentialDiag") extern class VectorExponentialDiag {
	...
	**/
	@:native("__init__")
	public function ___init__(?loc:Dynamic, ?scale_diag:Dynamic, ?scale_identity_multiplier:Dynamic, ?validate_args:Dynamic, ?allow_nan_stats:Dynamic, ?name:Dynamic):Dynamic;
	/**
		Construct Vector Exponential distribution supported on a subset of `R^k`. (deprecated)
		...
		* `scale_identity_multiplier.shape = []`.
		...
		Raises:
		  ValueError: if at most `scale_identity_multiplier` is specified.
	**/
	public function new(?loc:Dynamic, ?scale_diag:Dynamic, ?scale_identity_multiplier:Dynamic, ?validate_args:Dynamic, ?allow_nan_stats:Dynamic, ?name:Dynamic):Void;
	/**
	...
	**/
	public function _mode_mean_shape():Dynamic;
	/**
