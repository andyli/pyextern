...
package tensorflow.contrib.distributions.python.ops.mvn_full_covariance;
@:pythonImport("tensorflow.contrib.distributions.python.ops.mvn_full_covariance", "MultivariateNormalFullCovariance") extern class MultivariateNormalFullCovariance {
	...
	**/
	@:native("__init__")
	public function ___init__(?loc:Dynamic, ?covariance_matrix:Dynamic, ?validate_args:Dynamic, ?allow_nan_stats:Dynamic, ?name:Dynamic):Dynamic;
	/**
		Construct Multivariate Normal distribution on `R^k`. (deprecated)
		...
		Raises:
		  ValueError: if neither `loc` nor `covariance_matrix` are specified.
	**/
	public function new(?loc:Dynamic, ?covariance_matrix:Dynamic, ?validate_args:Dynamic, ?allow_nan_stats:Dynamic, ?name:Dynamic):Void;
	/**
