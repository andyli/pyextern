...
package tensorflow.contrib.distributions.python.ops.mixture_same_family;
@:pythonImport("tensorflow.contrib.distributions.python.ops.mixture_same_family", "MixtureSameFamily") extern class MixtureSameFamily {
	...
	**/
	@:native("__init__")
	public function ___init__(mixture_distribution:Dynamic, components_distribution:Dynamic, ?validate_args:Dynamic, ?allow_nan_stats:Dynamic, ?name:Dynamic):Dynamic;
	/**
		Construct a `MixtureSameFamily` distribution. (deprecated)
		...
		Raises:
		  ...
		  ValueError: if `mixture_distribution` categories does not equal
		    `components_distribution` rightmost batch shape.
	**/
	public function new(mixture_distribution:Dynamic, components_distribution:Dynamic, ?validate_args:Dynamic, ?allow_nan_stats:Dynamic, ?name:Dynamic):Void;
	/**
	...
	**/
	...
	public function _pad_sample_dims(x:Dynamic):Dynamic;
	...
	**/
	...
	public var components_distribution : Dynamic;
	/**
