...
package tensorflow.contrib.distributions.python.ops.vector_exponential_linear_operator;
@:pythonImport("tensorflow.contrib.distributions.python.ops.vector_exponential_linear_operator", "VectorExponentialLinearOperator") extern class VectorExponentialLinearOperator {
