...
@:pythonImport("tensorflow.contrib.factorization.python.ops.wals", "_StopAtSweepHook") extern class _StopAtSweepHook {
	...
	**/
	@:native("__init__")
	public function ___init__(last_sweep:Dynamic):Dynamic;
	/**
		Initializes a `StopAtSweepHook`.
		...
		Args:
		  last_sweep: Integer, number of the last sweep to run.
	**/
	public function new(last_sweep:Dynamic):Void;
	/**
