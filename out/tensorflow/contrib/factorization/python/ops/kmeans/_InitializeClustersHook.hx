...
@:pythonImport("tensorflow.contrib.factorization.python.ops.kmeans", "_InitializeClustersHook") extern class _InitializeClustersHook {
	...
	**/
	@:native("__init__")
	public function ___init__(init_op:Dynamic, is_initialized_var:Dynamic, is_chief:Dynamic):Dynamic;
	/**
		Creates an _InitializeClustersHook.
		...
		Args:
		  ...
		  is_chief: A boolean specifying whether this task is the chief.
	**/
	public function new(init_op:Dynamic, is_initialized_var:Dynamic, is_chief:Dynamic):Void;
	/**
