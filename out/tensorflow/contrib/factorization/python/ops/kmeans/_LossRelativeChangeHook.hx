...
@:pythonImport("tensorflow.contrib.factorization.python.ops.kmeans", "_LossRelativeChangeHook") extern class _LossRelativeChangeHook {
	...
	**/
	@:native("__init__")
	public function ___init__(loss_tensor:Dynamic, tolerance:Dynamic):Dynamic;
	/**
		Creates a _LossRelativeChangeHook.
		...
		Args:
		  ...
		  tolerance: A relative tolerance of loss change between iterations.
	**/
	public function new(loss_tensor:Dynamic, tolerance:Dynamic):Void;
	/**
