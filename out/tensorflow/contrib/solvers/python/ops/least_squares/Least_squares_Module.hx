...
package tensorflow.contrib.solvers.python.ops.least_squares;
@:pythonImport("tensorflow.contrib.solvers.python.ops.least_squares") extern class Least_squares_Module {
