...
package tensorflow.contrib.checkpoint.python.containers;
@:pythonImport("tensorflow.contrib.checkpoint.python.containers", "UniqueNameTracker") extern class UniqueNameTracker {
	...
	**/
	public function track(checkpointable:Dynamic, base_name:Dynamic):Dynamic;
