...
package tensorflow.contrib.checkpoint.python.python_state;
@:pythonImport("tensorflow.contrib.checkpoint.python.python_state", "_NumpyWrapper") extern class _NumpyWrapper {
	...
	**/
	@:native("__init__")
	public function ___init__(array:Dynamic):Dynamic;
	/**
		Specify a NumPy array to wrap.
	...
	**/
	public function _deserialize(string_value:Dynamic):Dynamic;
	/**
