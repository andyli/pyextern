...
@:pythonImport("tensorflow.contrib.checkpoint.python.split_dependency", "_SplitDependency") extern class _SplitDependency {
	...
	**/
	@:native("__init__")
	public function ___init__(save_buffer:Dynamic, restore_buffer:Dynamic, name:Dynamic, dtype:Dynamic, num_components:Dynamic, fill_save_buffer_fn:Dynamic, consume_restore_buffer_fn:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(save_buffer:Dynamic, restore_buffer:Dynamic, name:Dynamic, dtype:Dynamic, num_components:Dynamic, fill_save_buffer_fn:Dynamic, consume_restore_buffer_fn:Dynamic):Void;
	/**
	...
	**/
	public function _restore(tensor:Dynamic):Dynamic;
	/**
