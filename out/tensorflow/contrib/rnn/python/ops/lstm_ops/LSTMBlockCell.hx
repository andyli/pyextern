...
@:pythonImport("tensorflow.contrib.rnn.python.ops.lstm_ops", "LSTMBlockCell") extern class LSTMBlockCell {
	...
	**/
	@:native("__init__")
	public function ___init__(num_units:Dynamic, ?forget_bias:Dynamic, ?cell_clip:Dynamic, ?use_peephole:Dynamic, ?reuse:Dynamic, ?name:Dynamic):Dynamic;
	/**
		Initialize the basic LSTM cell.
		...
		Args:
		  ...
		  CudnnCompatibleLSTMBlockCell instead.
	**/
	public function new(num_units:Dynamic, ?forget_bias:Dynamic, ?cell_clip:Dynamic, ?use_peephole:Dynamic, ?reuse:Dynamic, ?name:Dynamic):Void;
	/**
