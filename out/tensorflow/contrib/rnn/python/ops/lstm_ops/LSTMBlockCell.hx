...
@:pythonImport("tensorflow.contrib.rnn.python.ops.lstm_ops", "LSTMBlockCell") extern class LSTMBlockCell {
	...
	**/
	public function __call__(x:Dynamic, states_prev:Dynamic, ?scope:Dynamic):Dynamic;
	...
	**/
	@:native("__init__")
	public function ___init__(num_units:Dynamic, ?forget_bias:Dynamic, ?use_peephole:Dynamic):Dynamic;
	/**
		Initialize the basic LSTM cell.
		...
		Args:
		  ...
		  use_peephole: Whether to use peephole connections or not.
	**/
	public function new(num_units:Dynamic, ?forget_bias:Dynamic, ?use_peephole:Dynamic):Void;
	/**
