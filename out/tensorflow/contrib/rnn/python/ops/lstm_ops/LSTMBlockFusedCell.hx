...
@:pythonImport("tensorflow.contrib.rnn.python.ops.lstm_ops", "LSTMBlockFusedCell") extern class LSTMBlockFusedCell {
	...
	**/
	@:native("__init__")
	public function ___init__(num_units:Dynamic, ?forget_bias:Dynamic, ?cell_clip:Dynamic, ?use_peephole:Dynamic, ?reuse:Dynamic, ?dtype:Dynamic, ?name:Dynamic):Dynamic;
	/**
		Initialize the LSTM cell.
		...
		Args:
		  ...
		  name: String, the name of the layer. Layers with the same name will
		    ...
		    with `tf.nn.rnn_cell.LSTMCell`.
	**/
	public function new(num_units:Dynamic, ?forget_bias:Dynamic, ?cell_clip:Dynamic, ?use_peephole:Dynamic, ?reuse:Dynamic, ?dtype:Dynamic, ?name:Dynamic):Void;
	/**
	...
	**/
	public function call(inputs:Dynamic, ?initial_state:Dynamic, ?dtype:Dynamic, ?sequence_length:Dynamic):Dynamic;
	/**
