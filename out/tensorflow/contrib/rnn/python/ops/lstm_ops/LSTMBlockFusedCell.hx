...
@:pythonImport("tensorflow.contrib.rnn.python.ops.lstm_ops", "LSTMBlockFusedCell") extern class LSTMBlockFusedCell {
	...
	**/
	@:native("__init__")
	public function ___init__(num_units:Dynamic, ?forget_bias:Dynamic, ?cell_clip:Dynamic, ?use_peephole:Dynamic):Dynamic;
	/**
		Initialize the LSTM cell.
		...
		Args:
		  ...
		  use_peephole: Whether to use peephole connections or not.
	**/
	public function new(num_units:Dynamic, ?forget_bias:Dynamic, ?cell_clip:Dynamic, ?use_peephole:Dynamic):Void;
	/**
