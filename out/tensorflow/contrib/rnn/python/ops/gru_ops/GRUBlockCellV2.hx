...
@:pythonImport("tensorflow.contrib.rnn.python.ops.gru_ops", "GRUBlockCellV2") extern class GRUBlockCellV2 {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(?num_units:Dynamic, ?cell_size:Dynamic, ?reuse:Dynamic, ?name:Dynamic):Dynamic;
	/**
		Initialize the Block GRU cell. (deprecated arguments)
		...
		Raises:
		  ValueError: if both cell_size and num_units are not None;
		    or both are None.
	**/
	public function new(?num_units:Dynamic, ?cell_size:Dynamic, ?reuse:Dynamic, ?name:Dynamic):Void;
	/**
	...
	**/
	...
	/**
		GRU cell.
	**/
	public function call(inputs:Dynamic, h_prev:Dynamic):Dynamic;
	/**
