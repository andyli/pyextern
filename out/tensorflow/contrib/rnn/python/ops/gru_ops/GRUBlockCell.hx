...
@:pythonImport("tensorflow.contrib.rnn.python.ops.gru_ops", "GRUBlockCell") extern class GRUBlockCell {
	/**
		GRU cell.
	**/
	public function __call__(x:Dynamic, h_prev:Dynamic, ?scope:Dynamic):Dynamic;
	...
	**/
	@:native("__init__")
	public function ___init__(cell_size:Dynamic):Dynamic;
	/**
		Initialize the Block GRU cell.
		...
		Args:
		  cell_size: int, GRU cell size.
	**/
	public function new(cell_size:Dynamic):Void;
	/**
