...
@:pythonImport("tensorflow.contrib.rnn.python.ops.fused_rnn_cell", "FusedRNNCellAdaptor") extern class FusedRNNCellAdaptor {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(cell:Dynamic, ?use_dynamic_rnn:Dynamic):Dynamic;
	/**
		Initialize the adaptor.
		...
		Args:
		  ...
		  use_dynamic_rnn: whether to use dynamic (or static) RNN.
	**/
	public function new(cell:Dynamic, ?use_dynamic_rnn:Dynamic):Void;
	/**
