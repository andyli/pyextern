...
@:pythonImport("tensorflow.contrib.rnn.python.ops.rnn_cell", "BidirectionalGridLSTMCell") extern class BidirectionalGridLSTMCell {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(num_units:Dynamic, ?use_peepholes:Dynamic, ?share_time_frequency_weights:Dynamic, ?cell_clip:Dynamic, ?initializer:Dynamic, ?num_unit_shards:Dynamic, ?forget_bias:Dynamic, ?feature_size:Dynamic, ?frequency_skip:Dynamic, ?num_frequency_blocks:Dynamic, ?start_freqindex_list:Dynamic, ?end_freqindex_list:Dynamic, ?couple_input_forget_gates:Dynamic, ?backward_slice_offset:Dynamic, ?reuse:Dynamic):Dynamic;
	/**
		Initialize the parameters for an LSTM cell.
