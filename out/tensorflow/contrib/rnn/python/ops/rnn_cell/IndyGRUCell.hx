...
@:pythonImport("tensorflow.contrib.rnn.python.ops.rnn_cell", "IndyGRUCell") extern class IndyGRUCell {
	/**
	...
	**/
	...
	@:native("__init__")
	public function ___init__(num_units:Dynamic, ?activation:Dynamic, ?reuse:Dynamic, ?kernel_initializer:Dynamic, ?bias_initializer:Dynamic, ?name:Dynamic, ?dtype:Dynamic):Dynamic;
	public function new(num_units:Dynamic, ?activation:Dynamic, ?reuse:Dynamic, ?kernel_initializer:Dynamic, ?bias_initializer:Dynamic, ?name:Dynamic, ?dtype:Dynamic):Void;
	/**
