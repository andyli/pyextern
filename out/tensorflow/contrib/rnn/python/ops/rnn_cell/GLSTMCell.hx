...
@:pythonImport("tensorflow.contrib.rnn.python.ops.rnn_cell", "GLSTMCell") extern class GLSTMCell {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(num_units:Dynamic, ?initializer:Dynamic, ?num_proj:Dynamic, ?number_of_groups:Dynamic, ?forget_bias:Dynamic, ?activation:Dynamic, ?reuse:Dynamic):Dynamic;
	/**
		Initialize the parameters of G-LSTM cell.
		...
		Raises:
		  ValueError: If `num_units` or `num_proj` is not divisible by
		    `number_of_groups`.
	**/
	public function new(num_units:Dynamic, ?initializer:Dynamic, ?num_proj:Dynamic, ?number_of_groups:Dynamic, ?forget_bias:Dynamic, ?activation:Dynamic, ?reuse:Dynamic):Void;
	/**
	...
	**/
	public function _get_input_for_group(inputs:Dynamic, group_id:Dynamic, group_size:Dynamic):Dynamic;
	/**
