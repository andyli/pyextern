...
@:pythonImport("tensorflow.contrib.rnn.python.ops.rnn_cell", "IndRNNCell") extern class IndRNNCell {
	/**
	...
	**/
	...
	@:native("__init__")
	public function ___init__(num_units:Dynamic, ?activation:Dynamic, ?reuse:Dynamic, ?name:Dynamic, ?dtype:Dynamic):Dynamic;
	public function new(num_units:Dynamic, ?activation:Dynamic, ?reuse:Dynamic, ?name:Dynamic, ?dtype:Dynamic):Void;
	/**
