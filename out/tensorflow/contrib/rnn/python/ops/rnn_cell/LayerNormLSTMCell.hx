...
@:pythonImport("tensorflow.contrib.rnn.python.ops.rnn_cell", "LayerNormLSTMCell") extern class LayerNormLSTMCell {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(num_units:Dynamic, ?use_peepholes:Dynamic, ?cell_clip:Dynamic, ?initializer:Dynamic, ?num_proj:Dynamic, ?proj_clip:Dynamic, ?forget_bias:Dynamic, ?activation:Dynamic, ?layer_norm:Dynamic, ?norm_gain:Dynamic, ?norm_shift:Dynamic, ?reuse:Dynamic):Dynamic;
	/**
		Initialize the parameters for an LSTM cell.
		...
		Args:
		  ...
		  CudnnCompatibleLSTMCell instead.
	**/
	public function new(num_units:Dynamic, ?use_peepholes:Dynamic, ?cell_clip:Dynamic, ?initializer:Dynamic, ?num_proj:Dynamic, ?proj_clip:Dynamic, ?forget_bias:Dynamic, ?activation:Dynamic, ?layer_norm:Dynamic, ?norm_gain:Dynamic, ?norm_shift:Dynamic, ?reuse:Dynamic):Void;
	/**
	...
	**/
	public function _linear(args:Dynamic, output_size:Dynamic, bias:Dynamic, ?bias_initializer:Dynamic, ?kernel_initializer:Dynamic, ?layer_norm:Dynamic):Dynamic;
	/**
