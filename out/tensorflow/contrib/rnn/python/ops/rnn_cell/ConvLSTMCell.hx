...
@:pythonImport("tensorflow.contrib.rnn.python.ops.rnn_cell", "ConvLSTMCell") extern class ConvLSTMCell {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(conv_ndims:Dynamic, input_shape:Dynamic, output_channels:Dynamic, kernel_shape:Dynamic, ?use_bias:Dynamic, ?skip_connection:Dynamic, ?forget_bias:Dynamic, ?initializers:Dynamic, ?name:Dynamic):Dynamic;
	/**
		Construct ConvLSTMCell.
		...
		Raises:
		  ValueError: If `skip_connection` is `True` and stride is different from 1
		    or if `input_shape` is incompatible with `conv_ndims`.
	**/
	public function new(conv_ndims:Dynamic, input_shape:Dynamic, output_channels:Dynamic, kernel_shape:Dynamic, ?use_bias:Dynamic, ?skip_connection:Dynamic, ?forget_bias:Dynamic, ?initializers:Dynamic, ?name:Dynamic):Void;
	/**
	...
	**/
	public function call(inputs:Dynamic, state:Dynamic, ?scope:Dynamic):Dynamic;
	/**
