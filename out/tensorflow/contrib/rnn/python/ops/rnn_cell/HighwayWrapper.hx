...
@:pythonImport("tensorflow.contrib.rnn.python.ops.rnn_cell", "HighwayWrapper") extern class HighwayWrapper {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(cell:Dynamic, ?couple_carry_transform_gates:Dynamic, ?carry_bias_init:Dynamic):Dynamic;
	/**
		Constructs a `HighwayWrapper` for `cell`.
		...
		Args:
		  ...
		  carry_bias_init: float, carry gates bias initialization.
	**/
	public function new(cell:Dynamic, ?couple_carry_transform_gates:Dynamic, ?carry_bias_init:Dynamic):Void;
	/**
	...
	**/
	...
	public function _highway(inp:Dynamic, out:Dynamic):Dynamic;
