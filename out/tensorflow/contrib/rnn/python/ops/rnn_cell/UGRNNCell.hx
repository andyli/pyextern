...
@:pythonImport("tensorflow.contrib.rnn.python.ops.rnn_cell", "UGRNNCell") extern class UGRNNCell {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(num_units:Dynamic, ?initializer:Dynamic, ?forget_bias:Dynamic, ?activation:Dynamic, ?reuse:Dynamic):Dynamic;
	/**
		Initialize the parameters for an UGRNN cell.
		...
		Args:
		  ...
		  reuse: (optional) Python boolean describing whether to reuse variables
		    ...
		    the given variables, an error is raised.
	**/
	public function new(num_units:Dynamic, ?initializer:Dynamic, ?forget_bias:Dynamic, ?activation:Dynamic, ?reuse:Dynamic):Void;
	/**
