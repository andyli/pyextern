...
@:pythonImport("tensorflow.contrib.rnn.python.ops.rnn_cell", "IndyLSTMCell") extern class IndyLSTMCell {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(num_units:Dynamic, ?forget_bias:Dynamic, ?activation:Dynamic, ?reuse:Dynamic, ?kernel_initializer:Dynamic, ?bias_initializer:Dynamic, ?name:Dynamic, ?dtype:Dynamic):Dynamic;
	/**
		Initialize the IndyLSTM cell.
		...
		Args:
		  ...
		  dtype: Default dtype of the layer (default of `None` means use the type
		    of the first input). Required when `build` is called before `call`.
	**/
	public function new(num_units:Dynamic, ?forget_bias:Dynamic, ?activation:Dynamic, ?reuse:Dynamic, ?kernel_initializer:Dynamic, ?bias_initializer:Dynamic, ?name:Dynamic, ?dtype:Dynamic):Void;
	/**
