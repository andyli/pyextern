...
@:pythonImport("tensorflow.contrib.rnn.python.ops.rnn_cell", "IntersectionRNNCell") extern class IntersectionRNNCell {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(num_units:Dynamic, ?num_in_proj:Dynamic, ?initializer:Dynamic, ?forget_bias:Dynamic, ?y_activation:Dynamic, ?reuse:Dynamic):Dynamic;
	/**
		Initialize the parameters for an +RNN cell.
		...
		Args:
		  ...
		  reuse: (optional) Python boolean describing whether to reuse variables
		    ...
		    the given variables, an error is raised.
	**/
	public function new(num_units:Dynamic, ?num_in_proj:Dynamic, ?initializer:Dynamic, ?forget_bias:Dynamic, ?y_activation:Dynamic, ?reuse:Dynamic):Void;
	/**
