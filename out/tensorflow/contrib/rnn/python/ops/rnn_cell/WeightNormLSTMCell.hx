...
@:pythonImport("tensorflow.contrib.rnn.python.ops.rnn_cell", "WeightNormLSTMCell") extern class WeightNormLSTMCell {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(num_units:Dynamic, ?norm:Dynamic, ?use_peepholes:Dynamic, ?cell_clip:Dynamic, ?initializer:Dynamic, ?num_proj:Dynamic, ?proj_clip:Dynamic, ?forget_bias:Dynamic, ?activation:Dynamic, ?reuse:Dynamic):Dynamic;
	/**
		Initialize the parameters of a weight-normalized LSTM cell.
		...
		Args:
		  ...
		  reuse: (optional) Python boolean describing whether to reuse variables
		    ...
		    the given variables, an error is raised.
	**/
	public function new(num_units:Dynamic, ?norm:Dynamic, ?use_peepholes:Dynamic, ?cell_clip:Dynamic, ?initializer:Dynamic, ?num_proj:Dynamic, ?proj_clip:Dynamic, ?forget_bias:Dynamic, ?activation:Dynamic, ?reuse:Dynamic):Void;
	/**
	...
	**/
	public function _linear(args:Dynamic, output_size:Dynamic, norm:Dynamic, bias:Dynamic, ?bias_initializer:Dynamic, ?kernel_initializer:Dynamic):Dynamic;
	/**
	...
	**/
	public function _normalize(weight:Dynamic, name:Dynamic):Dynamic;
	/**
