...
@:pythonImport("tensorflow.contrib.rnn.python.ops.rnn_cell", "SRUCell") extern class SRUCell {
	/**
	...
	**/
	...
	@:native("__init__")
	public function ___init__(num_units:Dynamic, ?activation:Dynamic, ?reuse:Dynamic, ?name:Dynamic):Dynamic;
	public function new(num_units:Dynamic, ?activation:Dynamic, ?reuse:Dynamic, ?name:Dynamic):Void;
	/**
