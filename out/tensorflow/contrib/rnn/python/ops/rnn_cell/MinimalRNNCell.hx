...
@:pythonImport("tensorflow.contrib.rnn.python.ops.rnn_cell", "MinimalRNNCell") extern class MinimalRNNCell {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(units:Dynamic, ?activation:Dynamic, ?kernel_initializer:Dynamic, ?bias_initializer:Dynamic, ?name:Dynamic, ?dtype:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
		Initialize the parameters for a MinimalRNN cell.
		...
		Args:
		  ...
		  **kwargs: Dict, keyword named properties for common cell attributes.
	**/
	public function new(units:Dynamic, ?activation:Dynamic, ?kernel_initializer:Dynamic, ?bias_initializer:Dynamic, ?name:Dynamic, ?dtype:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Void;
	/**
