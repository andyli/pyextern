...
@:pythonImport("tensorflow.contrib.rnn.python.ops.rnn_cell", "CompiledWrapper") extern class CompiledWrapper {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(cell:Dynamic, ?compile_stateful:Dynamic):Dynamic;
	/**
		Create CompiledWrapper cell.
		...
		Args:
		  ...
		  compile_stateful: Whether to compile stateful ops like initializers
		    and random number generators (default: False).
	**/
	public function new(cell:Dynamic, ?compile_stateful:Dynamic):Void;
	/**
