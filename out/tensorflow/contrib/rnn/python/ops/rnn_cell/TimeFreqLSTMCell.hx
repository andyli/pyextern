...
@:pythonImport("tensorflow.contrib.rnn.python.ops.rnn_cell", "TimeFreqLSTMCell") extern class TimeFreqLSTMCell {
	...
	**/
	@:native("__init__")
	public function ___init__(num_units:Dynamic, ?use_peepholes:Dynamic, ?cell_clip:Dynamic, ?initializer:Dynamic, ?num_unit_shards:Dynamic, ?forget_bias:Dynamic, ?feature_size:Dynamic, ?frequency_skip:Dynamic):Dynamic;
	/**
		Initialize the parameters for an LSTM cell.
		...
		Args:
		  ...
		  frequency_skip: int, The amount the LSTM filter is shifted by in
		    frequency.
	**/
	public function new(num_units:Dynamic, ?use_peepholes:Dynamic, ?cell_clip:Dynamic, ?initializer:Dynamic, ?num_unit_shards:Dynamic, ?forget_bias:Dynamic, ?feature_size:Dynamic, ?frequency_skip:Dynamic):Void;
	/**
		Return self<=value.
	**/
