...
@:pythonImport("tensorflow.contrib.rnn.python.ops.rnn_cell", "PhasedLSTMCell") extern class PhasedLSTMCell {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(num_units:Dynamic, ?use_peepholes:Dynamic, ?leak:Dynamic, ?ratio_on:Dynamic, ?trainable_ratio_on:Dynamic, ?period_init_min:Dynamic, ?period_init_max:Dynamic, ?reuse:Dynamic):Dynamic;
	/**
		Initialize the Phased LSTM cell.
		...
		Args:
		  ...
		  reuse: (optional) Python boolean describing whether to reuse variables
		    ...
		    the given variables, an error is raised.
	**/
	public function new(num_units:Dynamic, ?use_peepholes:Dynamic, ?leak:Dynamic, ?ratio_on:Dynamic, ?trainable_ratio_on:Dynamic, ?period_init_min:Dynamic, ?period_init_max:Dynamic, ?reuse:Dynamic):Void;
	/**
	...
	**/
	public function _get_cycle_ratio(time:Dynamic, phase:Dynamic, period:Dynamic):Dynamic;
	/**
	...
	**/
	public function _mod(x:Dynamic, y:Dynamic):Dynamic;
	/**
