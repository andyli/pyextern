...
@:pythonImport("tensorflow.contrib.rnn.python.ops.rnn_cell", "NASCell") extern class NASCell {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(num_units:Dynamic, ?num_proj:Dynamic, ?use_biases:Dynamic, ?reuse:Dynamic):Dynamic;
	/**
		Initialize the parameters for a NAS cell.
		...
		Args:
		  ...
		  reuse: (optional) Python boolean describing whether to reuse variables
		    ...
		    the given variables, an error is raised.
	**/
	public function new(num_units:Dynamic, ?num_proj:Dynamic, ?use_biases:Dynamic, ?reuse:Dynamic):Void;
	/**
