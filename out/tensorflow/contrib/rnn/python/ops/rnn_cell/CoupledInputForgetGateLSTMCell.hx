...
@:pythonImport("tensorflow.contrib.rnn.python.ops.rnn_cell", "CoupledInputForgetGateLSTMCell") extern class CoupledInputForgetGateLSTMCell {
	...
	**/
	@:native("__init__")
	public function ___init__(num_units:Dynamic, ?use_peepholes:Dynamic, ?initializer:Dynamic, ?num_proj:Dynamic, ?proj_clip:Dynamic, ?num_unit_shards:Dynamic, ?num_proj_shards:Dynamic, ?forget_bias:Dynamic, ?state_is_tuple:Dynamic, ?activation:Dynamic, ?reuse:Dynamic, ?layer_norm:Dynamic, ?norm_gain:Dynamic, ?norm_shift:Dynamic):Dynamic;
	/**
		Initialize the parameters for an LSTM cell.
		...
		Args:
		  ...
		  norm_shift: float, The layer normalization shift initial value. If
		    `layer_norm` has been set to `False`, this argument will be ignored.
	**/
	public function new(num_units:Dynamic, ?use_peepholes:Dynamic, ?initializer:Dynamic, ?num_proj:Dynamic, ?proj_clip:Dynamic, ?num_unit_shards:Dynamic, ?num_proj_shards:Dynamic, ?forget_bias:Dynamic, ?state_is_tuple:Dynamic, ?activation:Dynamic, ?reuse:Dynamic, ?layer_norm:Dynamic, ?norm_gain:Dynamic, ?norm_shift:Dynamic):Void;
	/**
