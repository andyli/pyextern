...
@:pythonImport("tensorflow.contrib.rnn.python.ops.rnn_cell", "LayerNormBasicLSTMCell") extern class LayerNormBasicLSTMCell {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(num_units:Dynamic, ?forget_bias:Dynamic, ?input_size:Dynamic, ?activation:Dynamic, ?layer_norm:Dynamic, ?norm_gain:Dynamic, ?norm_shift:Dynamic, ?dropout_keep_prob:Dynamic, ?dropout_prob_seed:Dynamic, ?reuse:Dynamic):Dynamic;
	/**
		Initializes the basic LSTM cell.
		...
		Args:
		  ...
		  reuse: (optional) Python boolean describing whether to reuse variables
		    ...
		    the given variables, an error is raised.
	**/
	public function new(num_units:Dynamic, ?forget_bias:Dynamic, ?input_size:Dynamic, ?activation:Dynamic, ?layer_norm:Dynamic, ?norm_gain:Dynamic, ?norm_shift:Dynamic, ?dropout_keep_prob:Dynamic, ?dropout_prob_seed:Dynamic, ?reuse:Dynamic):Void;
	/**
	...
	**/
	...
	public function _linear(args:Dynamic):Dynamic;
	/**
	...
	**/
	...
	public function _norm(inp:Dynamic, scope:Dynamic, ?dtype:Dynamic):Dynamic;
	/**
