...
@:pythonImport("tensorflow.contrib.rnn.python.ops.core_rnn_cell", "EmbeddingWrapper") extern class EmbeddingWrapper {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(cell:Dynamic, embedding_classes:Dynamic, embedding_size:Dynamic, ?initializer:Dynamic, ?reuse:Dynamic):Dynamic;
	/**
		Create a cell with an added input embedding.
		...
		Raises:
		  ...
		  ValueError: if embedding_classes is not positive.
	**/
	public function new(cell:Dynamic, embedding_classes:Dynamic, embedding_size:Dynamic, ?initializer:Dynamic, ?reuse:Dynamic):Void;
	/**
