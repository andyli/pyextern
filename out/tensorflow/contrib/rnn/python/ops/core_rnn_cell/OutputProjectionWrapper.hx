...
@:pythonImport("tensorflow.contrib.rnn.python.ops.core_rnn_cell", "OutputProjectionWrapper") extern class OutputProjectionWrapper {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(cell:Dynamic, output_size:Dynamic, ?activation:Dynamic, ?reuse:Dynamic):Dynamic;
	/**
		Create a cell with output projection.
		...
		Raises:
		  ...
		  ValueError: if output_size is not positive.
	**/
	public function new(cell:Dynamic, output_size:Dynamic, ?activation:Dynamic, ?reuse:Dynamic):Void;
	/**
