...
@:pythonImport("tensorflow.contrib.rnn.python.ops.core_rnn_cell", "InputProjectionWrapper") extern class InputProjectionWrapper {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(cell:Dynamic, num_proj:Dynamic, ?activation:Dynamic, ?input_size:Dynamic, ?reuse:Dynamic):Dynamic;
	/**
		Create a cell with input projection.
		...
		Raises:
		  TypeError: if cell is not an RNNCell.
	**/
	public function new(cell:Dynamic, num_proj:Dynamic, ?activation:Dynamic, ?input_size:Dynamic, ?reuse:Dynamic):Void;
	/**
