...
package tensorflow.contrib.tpu.python.tpu.util;
@:pythonImport("tensorflow.contrib.tpu.python.tpu.util", "MultiHostDatasetInitializerHook") extern class MultiHostDatasetInitializerHook {
	...
	**/
	@:native("__init__")
	public function ___init__(dataset_initializers:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(dataset_initializers:Dynamic):Void;
	/**
