...
@:pythonImport("tensorflow.contrib.tpu.python.tpu.tpu", "TPUReplicateContext") extern class TPUReplicateContext {
	/**
	...
	**/
	public function get_replicated_var_handle(name:Dynamic, vars_:Dynamic):Dynamic;
