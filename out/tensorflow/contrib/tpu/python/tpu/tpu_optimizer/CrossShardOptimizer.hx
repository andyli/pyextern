...
package tensorflow.contrib.tpu.python.tpu.tpu_optimizer;
@:pythonImport("tensorflow.contrib.tpu.python.tpu.tpu_optimizer", "CrossShardOptimizer") extern class CrossShardOptimizer {
	...
	**/
	@:native("__init__")
	public function ___init__(opt:Dynamic, ?reduction:Dynamic, ?name:Dynamic, ?group_assignment:Dynamic):Dynamic;
	/**
		Construct a new cross-shard optimizer.
		...
		Raises:
		  ValueError: If reduction is not a valid cross-shard reduction.
	**/
	public function new(opt:Dynamic, ?reduction:Dynamic, ?name:Dynamic, ?group_assignment:Dynamic):Void;
	/**
	...
	**/
	public function _verify_and_get_subgroup_size(group_assignment:Dynamic, num_shards:Dynamic):Dynamic;
	/**
	...
	/**
		...
		Raises:
		  ValueError: If not within a tpu_shard_context or group_assignment is
		    invalid.
	**/
	public function compute_gradients(loss:Dynamic, ?var_list:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
