...
@:pythonImport("tensorflow.contrib.tpu.python.tpu.tpu_estimator", "_OutfeedHostCallHook") extern class _OutfeedHostCallHook {
	...
	**/
	@:native("__init__")
	public function ___init__(tensors:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(tensors:Dynamic):Void;
	/**
