...
@:pythonImport("tensorflow.contrib.tpu.python.tpu.tpu_estimator", "_Inputs") extern class _Inputs {
	...
	**/
	@:native("__init__")
	public function ___init__(?features:Dynamic, ?labels:Dynamic, ?dataset:Dynamic, ?signals:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(?features:Dynamic, ?labels:Dynamic, ?dataset:Dynamic, ?signals:Dynamic):Void;
	/**
