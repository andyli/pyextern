...
@:pythonImport("tensorflow.contrib.tpu.python.tpu.tpu_estimator", "_SetEvalIterationsHook") extern class _SetEvalIterationsHook {
	...
	**/
	@:native("__init__")
	public function ___init__(num_steps:Dynamic):Dynamic;
	/**
		Initializes a `_SetEvalIterationsHook`.
		...
		Args:
		  num_steps: Number of steps to execute.
	**/
	public function new(num_steps:Dynamic):Void;
	/**
