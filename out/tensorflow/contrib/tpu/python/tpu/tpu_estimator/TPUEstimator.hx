...
@:pythonImport("tensorflow.contrib.tpu.python.tpu.tpu_estimator", "TPUEstimator") extern class TPUEstimator {
	...
	**/
	@:native("__init__")
	public function ___init__(?model_fn:Dynamic, ?model_dir:Dynamic, ?config:Dynamic, ?params:Dynamic, ?use_tpu:Dynamic, ?train_batch_size:Dynamic, ?eval_batch_size:Dynamic, ?predict_batch_size:Dynamic, ?batch_axis:Dynamic, ?eval_on_tpu:Dynamic, ?export_to_tpu:Dynamic, ?warm_start_from:Dynamic):Dynamic;
	/**
		Constructs an `TPUEstimator` instance.
		...
		Raises:
		  ValueError: `params` has reserved keys already.
	**/
	public function new(?model_fn:Dynamic, ?model_dir:Dynamic, ?config:Dynamic, ?params:Dynamic, ?use_tpu:Dynamic, ?train_batch_size:Dynamic, ?eval_batch_size:Dynamic, ?predict_batch_size:Dynamic, ?batch_axis:Dynamic, ?eval_on_tpu:Dynamic, ?export_to_tpu:Dynamic, ?warm_start_from:Dynamic):Void;
	/**
	...
	**/
	public function _call_model_fn_for_inference(features:Dynamic, labels:Dynamic, mode:Dynamic, config:Dynamic):Dynamic;
	/**
