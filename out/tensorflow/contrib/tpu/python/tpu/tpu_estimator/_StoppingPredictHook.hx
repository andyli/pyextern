...
@:pythonImport("tensorflow.contrib.tpu.python.tpu.tpu_estimator", "_StoppingPredictHook") extern class _StoppingPredictHook {
	...
	**/
	@:native("__init__")
	public function ___init__(scalar_stopping_signal:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(scalar_stopping_signal:Dynamic):Void;
	/**
