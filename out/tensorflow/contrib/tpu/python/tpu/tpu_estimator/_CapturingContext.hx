...
@:pythonImport("tensorflow.contrib.tpu.python.tpu.tpu_estimator", "_CapturingContext") extern class _CapturingContext {
	/**
	...
	**/
	...
	public function __exit__(_:Dynamic, __:Dynamic, ___:Dynamic):Dynamic;
	/**
