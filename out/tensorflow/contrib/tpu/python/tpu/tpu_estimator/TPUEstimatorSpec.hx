...
@:pythonImport("tensorflow.contrib.tpu.python.tpu.tpu_estimator", "TPUEstimatorSpec") extern class TPUEstimatorSpec {
	/**
		Return self+value.
	**/
	...
	**/
	static public function __new__(cls:Dynamic, mode:Dynamic, ?predictions:Dynamic, ?loss:Dynamic, ?train_op:Dynamic, ?eval_metrics:Dynamic, ?export_outputs:Dynamic, ?scaffold_fn:Dynamic, ?host_call:Dynamic, ?training_hooks:Dynamic, ?evaluation_hooks:Dynamic, ?prediction_hooks:Dynamic):Dynamic;
	/**
		helper for pickle
	**/
	...
	**/
	...
	/**
		Make a new TPUEstimatorSpec object from a sequence or iterable
	**/
	static public function _make(iterable:Dynamic, ?_new:Dynamic, ?len:Dynamic):Dynamic;
	/**
		Return a new TPUEstimatorSpec object replacing specified fields with new values
	**/
	...
	**/
	public function as_estimator_spec():Dynamic;
	/**
	...
	**/
	public var scaffold_fn : Dynamic;
	/**
