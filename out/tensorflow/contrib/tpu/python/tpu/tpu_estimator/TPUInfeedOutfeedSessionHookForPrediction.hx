...
@:pythonImport("tensorflow.contrib.tpu.python.tpu.tpu_estimator", "TPUInfeedOutfeedSessionHookForPrediction") extern class TPUInfeedOutfeedSessionHookForPrediction {
	...
	**/
	@:native("__init__")
	public function ___init__(ctx:Dynamic, enqueue_ops:Dynamic, dequeue_ops:Dynamic, tpu_compile_op:Dynamic, ?rendezvous:Dynamic, ?master:Dynamic, ?session_config:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(ctx:Dynamic, enqueue_ops:Dynamic, dequeue_ops:Dynamic, tpu_compile_op:Dynamic, ?rendezvous:Dynamic, ?master:Dynamic, ?session_config:Dynamic):Void;
	/**
