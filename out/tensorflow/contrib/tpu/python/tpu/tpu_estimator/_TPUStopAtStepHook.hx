...
@:pythonImport("tensorflow.contrib.tpu.python.tpu.tpu_estimator", "_TPUStopAtStepHook") extern class _TPUStopAtStepHook {
	...
	**/
	@:native("__init__")
	public function ___init__(iterations:Dynamic, ?num_steps:Dynamic, ?last_step:Dynamic):Dynamic;
	/**
		Initializes a `StopAtStepHook`.
		...
		Raises:
		  ValueError: If one of the arguments is invalid.
	**/
	public function new(iterations:Dynamic, ?num_steps:Dynamic, ?last_step:Dynamic):Void;
	/**
	...
	**/
	...
	public function _next_iterations(global_step:Dynamic, last_step:Dynamic):Dynamic;
