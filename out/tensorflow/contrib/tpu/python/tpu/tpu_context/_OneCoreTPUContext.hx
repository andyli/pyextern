...
@:pythonImport("tensorflow.contrib.tpu.python.tpu.tpu_context", "_OneCoreTPUContext") extern class _OneCoreTPUContext {
	...
	**/
	@:native("__init__")
	public function ___init__(config:Dynamic, train_batch_size:Dynamic, eval_batch_size:Dynamic, predict_batch_size:Dynamic, use_tpu:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(config:Dynamic, train_batch_size:Dynamic, eval_batch_size:Dynamic, predict_batch_size:Dynamic, use_tpu:Dynamic):Void;
	/**
