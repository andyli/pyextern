...
@:pythonImport("tensorflow.contrib.tpu.python.tpu.tpu_feed", "InfeedQueue") extern class InfeedQueue {
	...
	**/
	@:native("__init__")
	public function ___init__(?number_of_tuple_elements:Dynamic, ?tuple_types:Dynamic, ?tuple_shapes:Dynamic, ?shard_dimensions:Dynamic, ?name:Dynamic):Dynamic;
	/**
		Creates a new InfeedQueue with the given configuration.
		...
		Raises:
		  ...
		  TypeError: if any element of tuple_types or tuple_shapes can't
		    be converted to a dtype or TensorShape, respectively.
	**/
	public function new(?number_of_tuple_elements:Dynamic, ?tuple_types:Dynamic, ?tuple_shapes:Dynamic, ?shard_dimensions:Dynamic, ?name:Dynamic):Void;
	/**
