...
@:pythonImport("tensorflow.contrib.tpu.python.tpu.keras_support", "KerasCrossShardOptimizer") extern class KerasCrossShardOptimizer {
	...
	**/
	@:native("__init__")
	public function ___init__(opt:Dynamic, ?name:Dynamic):Dynamic;
	/**
		Construct a new cross-shard optimizer.
		...
		Raises:
		  ValueError: If reduction is not a valid cross-shard reduction.
	**/
	public function new(opt:Dynamic, ?name:Dynamic):Void;
	/**
