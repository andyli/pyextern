...
@:pythonImport("tensorflow.contrib.tpu.python.tpu.keras_support", "KerasTPUModel") extern class KerasTPUModel {
	/**
	...
	**/
	...
	@:native("__init__")
	public function ___init__(cpu_model:Dynamic, strategy:Dynamic):Dynamic;
	public function new(cpu_model:Dynamic, strategy:Dynamic):Void;
	/**
	...
	**/
	public function _initialize_weights(cloned_model:Dynamic):Dynamic;
	/**
	...
	**/
	...
	public function _pipeline_fit(x:Dynamic, y:Dynamic, batch_size:Dynamic, epochs:Dynamic, verbose:Dynamic, callbacks:Dynamic, validation_split:Dynamic, validation_data:Dynamic, shuffle:Dynamic, class_weight:Dynamic, sample_weight:Dynamic, initial_epoch:Dynamic, steps_per_epoch:Dynamic, validation_steps:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	public function _pipeline_fit_loop(inputs:Dynamic, targets:Dynamic, sample_weights:Dynamic, batch_size:Dynamic, epochs:Dynamic, verbose:Dynamic, callbacks:Dynamic, val_inputs:Dynamic, val_targets:Dynamic, val_sample_weights:Dynamic, shuffle:Dynamic, initial_epoch:Dynamic, steps_per_epoch:Dynamic, validation_steps:Dynamic):Dynamic;
	public function _pipeline_fit_loop_sample_wise(ins:Dynamic, callbacks:Dynamic, index_array:Dynamic, shuffle:Dynamic, batch_size:Dynamic, num_training_samples:Dynamic, indices_for_conversion_to_dense:Dynamic, do_validation:Dynamic, val_inputs:Dynamic, val_targets:Dynamic, val_sample_weights:Dynamic, validation_steps:Dynamic, epoch_logs:Dynamic):Dynamic;
	public function _pipeline_fit_loop_step_wise(ins:Dynamic, callbacks:Dynamic, steps_per_epoch:Dynamic, epochs:Dynamic, do_validation:Dynamic, val_inputs:Dynamic, val_targets:Dynamic, val_sample_weights:Dynamic, validation_steps:Dynamic, epoch_logs:Dynamic):Dynamic;
	/**
	...
	/**
		...
		Raises:
		  ValueError: If the provided arguments are not compatible with
		    `KerasTPUModel`.
	**/
	public function _prepare_validation_data(validation_data:Dynamic, validation_split:Dynamic, validation_steps:Dynamic, x:Dynamic, y:Dynamic, sample_weights:Dynamic, batch_size:Dynamic):Dynamic;
	/**
	...
	**/
	...
	public var cpu_optimizer : Dynamic;
	...
	**/
	...
	/**
		...
		```
	**/
	public function save(?args:python.VarArgs<Dynamic>, ?kw:python.KwArgs<Dynamic>):Dynamic;
	/**
	...
	**/
	public function save_weights(?args:python.VarArgs<Dynamic>, ?kw:python.KwArgs<Dynamic>):Dynamic;
	/**
	...
	**/
	public function sync_to_cpu():Dynamic;
	/**
