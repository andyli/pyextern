...
@:pythonImport("tensorflow.contrib.tpu.python.tpu.keras_support", "TPUInfeedInstance") extern class TPUInfeedInstance {
	...
	**/
	public function make_feed_dict(tpu_model_op:Dynamic):Dynamic;
	/**
		...
		Returns:
		  A list of
	**/
	public function make_input_specs(input_tensors:Dynamic):Dynamic;
}