...
@:pythonImport("tensorflow.contrib.tpu.python.tpu.tpu_config", "TPUConfig") extern class TPUConfig {
	/**
		Return self+value.
	**/
	...
	**/
	static public function __new__(cls:Dynamic, ?iterations_per_loop:Dynamic, ?num_shards:Dynamic, ?num_cores_per_replica:Dynamic, ?per_host_input_for_training:Dynamic, ?tpu_job_name:Dynamic, ?initial_infeed_sleep_secs:Dynamic, ?input_partition_dims:Dynamic):Dynamic;
	/**
		helper for pickle
	**/
	...
	**/
	...
	/**
		Make a new TPUConfig object from a sequence or iterable
	**/
	static public function _make(iterable:Dynamic, ?_new:Dynamic, ?len:Dynamic):Dynamic;
	/**
		Return a new TPUConfig object replacing specified fields with new values
	**/
	...
	**/
	public var initial_infeed_sleep_secs : Dynamic;
	/**
	...
	**/
	public var iterations_per_loop : Dynamic;
	/**
	...
	**/
	public var per_host_input_for_training : Dynamic;
	/**
		Alias for field number 4
	**/
	public var tpu_job_name : Dynamic;
}