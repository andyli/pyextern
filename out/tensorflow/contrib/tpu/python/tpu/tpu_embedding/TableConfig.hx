...
@:pythonImport("tensorflow.contrib.tpu.python.tpu.tpu_embedding", "TableConfig") extern class TableConfig {
	/**
		Return self+value.
	**/
	...
	**/
	...
	/**
		Embedding table configuration. (experimental)
	...
	**/
	static public function __new__(cls:Dynamic, vocabulary_size:Dynamic, dimension:Dynamic, ?initializer:Dynamic, ?combiner:Dynamic):Dynamic;
	/**
		helper for pickle
	**/
