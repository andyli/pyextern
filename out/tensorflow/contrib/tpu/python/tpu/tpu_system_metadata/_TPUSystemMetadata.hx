...
@:pythonImport("tensorflow.contrib.tpu.python.tpu.tpu_system_metadata", "_TPUSystemMetadata") extern class _TPUSystemMetadata {
	/**
		Return self+value.
	**/
	...
	**/
	...
	/**
		Create new instance of _TPUSystemMetadata(num_cores, num_hosts, num_of_cores_per_host, topology, devices)
	**/
	static public function __new__(_cls:Dynamic, num_cores:Dynamic, num_hosts:Dynamic, num_of_cores_per_host:Dynamic, topology:Dynamic, devices:Dynamic):Dynamic;
	/**
		helper for pickle
	**/
	...
	**/
	...
	/**
		Make a new _TPUSystemMetadata object from a sequence or iterable
	**/
	static public function _make(iterable:Dynamic, ?_new:Dynamic, ?len:Dynamic):Dynamic;
	/**
		Return a new _TPUSystemMetadata object replacing specified fields with new values
	**/
