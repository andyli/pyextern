...
@:pythonImport("tensorflow.contrib.tpu.proto.optimization_parameters_pb2", "AdadeltaParameters") extern class AdadeltaParameters {
	/**
	...
	**/
	...
	/**
		Field tensorflow.tpu.AdadeltaParameters.epsilon
	**/
	public var epsilon : Dynamic;
	/**
		Field tensorflow.tpu.AdadeltaParameters.initial_accumulator
	**/
	public var initial_accumulator : Dynamic;
	/**
		Field tensorflow.tpu.AdadeltaParameters.initial_update
	**/
	public var initial_update : Dynamic;
	/**
		Field tensorflow.tpu.AdadeltaParameters.rho
	**/
