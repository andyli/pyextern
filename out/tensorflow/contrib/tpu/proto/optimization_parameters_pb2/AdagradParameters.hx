...
@:pythonImport("tensorflow.contrib.tpu.proto.optimization_parameters_pb2", "AdagradParameters") extern class AdagradParameters {
	/**
	...
	**/
	...
	/**
		Field tensorflow.tpu.AdagradParameters.initial_accumulator
	**/
