...
@:pythonImport("tensorflow.contrib.tpu.proto.optimization_parameters_pb2", "ProximalAdagradParameters") extern class ProximalAdagradParameters {
	/**
	...
	**/
	...
	/**
		Field tensorflow.tpu.ProximalAdagradParameters.initial_accumulator
	**/
	public var initial_accumulator : Dynamic;
	/**
		Field tensorflow.tpu.ProximalAdagradParameters.l1
	**/
	public var l1 : Dynamic;
	/**
		Field tensorflow.tpu.ProximalAdagradParameters.l2
	**/
