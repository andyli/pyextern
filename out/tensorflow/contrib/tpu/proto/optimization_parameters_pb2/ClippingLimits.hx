...
@:pythonImport("tensorflow.contrib.tpu.proto.optimization_parameters_pb2", "ClippingLimits") extern class ClippingLimits {
	/**
	...
	**/
	...
	static public var LOWER_FIELD_NUMBER : Dynamic;
	/**
	...
	**/
	...
	static public var UPPER_FIELD_NUMBER : Dynamic;
	/**
