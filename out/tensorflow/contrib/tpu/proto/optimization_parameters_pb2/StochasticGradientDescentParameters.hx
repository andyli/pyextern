...
@:pythonImport("tensorflow.contrib.tpu.proto.optimization_parameters_pb2", "StochasticGradientDescentParameters") extern class StochasticGradientDescentParameters {
	/**
