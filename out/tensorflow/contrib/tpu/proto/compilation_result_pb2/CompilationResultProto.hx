...
package tensorflow.contrib.tpu.proto.compilation_result_pb2;
@:pythonImport("tensorflow.contrib.tpu.proto.compilation_result_pb2", "CompilationResultProto") extern class CompilationResultProto {
	/**
