...
package tensorflow.contrib.tpu.proto.tpu_embedding_output_layout_pb2;
@:pythonImport("tensorflow.contrib.tpu.proto.tpu_embedding_output_layout_pb2", "TPUEmbeddingOutputLayout") extern class TPUEmbeddingOutputLayout {
	/**
	...
	**/
	...
	/**
		A ProtocolMessage
	**/
	public function EmbeddingOutputTensor(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
		Extension dict
	**/
	...
	/**
		A ProtocolMessage
	**/
	public function FeatureDescriptor(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
