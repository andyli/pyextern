...
@:pythonImport("tensorflow.contrib.tpu.profiler.trace_events_pb2", "Resource") extern class Resource {
	/**
	...
	**/
	...
	/**
		Field tensorflow.tpu.Resource.name
	**/
	public var name : Dynamic;
	/**
		Field tensorflow.tpu.Resource.resource_id
	**/
