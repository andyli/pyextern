...
@:pythonImport("tensorflow.contrib.tpu.profiler.op_profile_pb2", "Node") extern class Node {
	/**
	...
	**/
	...
	/**
		A ProtocolMessage
	**/
	public function InstructionCategory(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
