...
package tensorflow.contrib.tpu.profiler.op_profile_pb2;
@:pythonImport("tensorflow.contrib.tpu.profiler.op_profile_pb2", "Profile") extern class Profile {
	/**
	...
	**/
	...
	/**
		Field tensorflow.tpu.op_profile.Profile.by_category
	**/
	public var by_category : Dynamic;
	/**
		Field tensorflow.tpu.op_profile.Profile.by_program
	**/
	public var by_program : Dynamic;
}