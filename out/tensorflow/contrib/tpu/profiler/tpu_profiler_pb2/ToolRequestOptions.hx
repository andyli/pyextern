...
package tensorflow.contrib.tpu.profiler.tpu_profiler_pb2;
@:pythonImport("tensorflow.contrib.tpu.profiler.tpu_profiler_pb2", "ToolRequestOptions") extern class ToolRequestOptions {
	/**
	...
	**/
	...
	/**
		Field tensorflow.ToolRequestOptions.output_formats
	**/
	public var output_formats : Dynamic;
	/**
		Field tensorflow.ToolRequestOptions.save_to_repo
	**/
	public var save_to_repo : Dynamic;
}