...
@:pythonImport("tensorflow.contrib.tpu.profiler.tpu_profiler_pb2", "ProfileToolData") extern class ProfileToolData {
	/**
	...
	**/
	...
	/**
		Field tensorflow.ProfileToolData.data
	**/
	public var data : Dynamic;
	/**
		Field tensorflow.ProfileToolData.name
	**/
