...
@:pythonImport("tensorflow.contrib.tpu.profiler.tpu_profiler_analysis_pb2", "EnumProfileSessionsAndToolsResponse") extern class EnumProfileSessionsAndToolsResponse {
	/**
