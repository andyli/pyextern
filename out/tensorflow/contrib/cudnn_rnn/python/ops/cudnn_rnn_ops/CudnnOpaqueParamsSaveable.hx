...
@:pythonImport("tensorflow.contrib.cudnn_rnn.python.ops.cudnn_rnn_ops", "CudnnOpaqueParamsSaveable") extern class CudnnOpaqueParamsSaveable {
	/**
	...
	**/
	public function _TransformSingleLayerCanonical(cu_weights:Dynamic, cu_biases:Dynamic, prefix:Dynamic, tf_weights:Dynamic, tf_weights_names:Dynamic, tf_biases:Dynamic, tf_bias_names:Dynamic):Dynamic;
