...
@:pythonImport("tensorflow.contrib.cudnn_rnn.python.ops.cudnn_rnn_ops", "CudnnCompatibleLSTMCell") extern class CudnnCompatibleLSTMCell {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(num_units:Dynamic, ?reuse:Dynamic):Dynamic;
	/**
		Initialize the basic LSTM cell.
		...
		Args:
		  ...
		  CudnnCompatibleLSTMBlockCell instead.
	**/
	public function new(num_units:Dynamic, ?reuse:Dynamic):Void;
	/**
