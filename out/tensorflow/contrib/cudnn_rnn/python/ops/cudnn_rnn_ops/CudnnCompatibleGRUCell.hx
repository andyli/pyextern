...
@:pythonImport("tensorflow.contrib.cudnn_rnn.python.ops.cudnn_rnn_ops", "CudnnCompatibleGRUCell") extern class CudnnCompatibleGRUCell {
	/**
	...
	**/
	...
	@:native("__init__")
	public function ___init__(num_units:Dynamic, ?reuse:Dynamic, ?kernel_initializer:Dynamic):Dynamic;
	public function new(num_units:Dynamic, ?reuse:Dynamic, ?kernel_initializer:Dynamic):Void;
	/**
