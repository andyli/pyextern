...
package tensorflow.contrib.cudnn_rnn.python.layers.cudnn_rnn;
@:pythonImport("tensorflow.contrib.cudnn_rnn.python.layers.cudnn_rnn", "CudnnLSTM") extern class CudnnLSTM {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(num_layers:Dynamic, num_units:Dynamic, ?input_mode:Dynamic, ?direction:Dynamic, ?dropout:Dynamic, ?seed:Dynamic, ?dtype:Dynamic, ?kernel_initializer:Dynamic, ?bias_initializer:Dynamic, ?name:Dynamic):Dynamic;
	/**
		Creates a CudnnRNN model from model spec.
		...
		Raises:
		  ValueError: if direction is invalid. Or dtype is not supported.
	**/
	public function new(num_layers:Dynamic, num_units:Dynamic, ?input_mode:Dynamic, ?direction:Dynamic, ?dropout:Dynamic, ?seed:Dynamic, ?dtype:Dynamic, ?kernel_initializer:Dynamic, ?bias_initializer:Dynamic, ?name:Dynamic):Void;
	/**
	...
	**/
	public function _canonical_bias_shape(unused_layer:Dynamic):Dynamic;
	public function _canonical_to_opaque(cu_weights:Dynamic, cu_biases:Dynamic):Dynamic;
	/**
		Shapes of Cudnn canonical weight tensors for given layer.
	**/
	public function _canonical_weight_shape(layer:Dynamic):Dynamic;
	/**
	...
	**/
	public function _create_saveable():Dynamic;
	/**
	...
	**/
	...
	public function _forward(inputs:Dynamic, h:Dynamic, c:Dynamic, opaque_params:Dynamic, training:Dynamic):Dynamic;
	...
	**/
	public var _gather_saveables_for_checkpoint : Dynamic;
	...
	**/
	static public function _saveable_cls(opaque_params:Dynamic, num_layers:Dynamic, num_units:Dynamic, input_size:Dynamic, ?input_mode:Dynamic, ?direction:Dynamic, ?scope:Dynamic, ?name:Dynamic):Dynamic;
	...
	**/
	public function _update_trainable_weights(getter:Dynamic, ?args:python.VarArgs<Dynamic>, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	public function _zero_state(batch_size:Dynamic):Dynamic;
	/**
	...
	**/
	public function call(inputs:Dynamic, ?initial_state:Dynamic, ?training:Dynamic):Dynamic;
	/**
		Shapes of Cudnn canonical bias tensors.
	**/
	public var canonical_bias_shapes : Dynamic;
	/**
		Shapes of Cudnn canonical weight tensors.
	**/
	public var canonical_weight_shapes : Dynamic;
	/**
	...
	**/
	public function state_shape(batch_size:Dynamic):Dynamic;
