...
@:pythonImport("tensorflow.contrib.cudnn_rnn.python.layers.cudnn_rnn", "_CudnnRNNNoInputC") extern class _CudnnRNNNoInputC {
	/**
	...
	**/
	...
	static public var _saveable_cls : Dynamic;
