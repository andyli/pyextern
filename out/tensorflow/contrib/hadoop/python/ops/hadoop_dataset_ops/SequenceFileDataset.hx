...
package tensorflow.contrib.hadoop.python.ops.hadoop_dataset_ops;
@:pythonImport("tensorflow.contrib.hadoop.python.ops.hadoop_dataset_ops", "SequenceFileDataset") extern class SequenceFileDataset {
	/**
	...
	**/
	...
	/**
		Create a `SequenceFileDataset`. (deprecated)
		
		Warning: THIS FUNCTION IS DEPRECATED. It will be removed in a future version.
		Instructions for updating:
		tf.contrib.hadoop will be removed in 2.0, the support for Apache Hadoop will continue to be provided through the tensorflow/io GitHub project.
	...
	**/
	@:native("__init__")
	public function ___init__(filenames:Dynamic):Dynamic;
	/**
		Create a `SequenceFileDataset`. (deprecated)
		...
		Args:
		  filenames: A `tf.string` tensor containing one or more filenames.
	**/
	public function new(filenames:Dynamic):Void;
	/**
