...
@:pythonImport("tensorflow.contrib.tensor_forest.proto.fertile_stats_pb2", "GiniStats") extern class GiniStats {
	/**
	...
	**/
	...
	/**
		Field tensorflow.tensorforest.GiniStats.square
	**/
	public var square : Dynamic;
}