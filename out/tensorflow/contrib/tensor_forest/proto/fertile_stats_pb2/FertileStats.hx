...
@:pythonImport("tensorflow.contrib.tensor_forest.proto.fertile_stats_pb2", "FertileStats") extern class FertileStats {
	/**
	...
	**/
	...
	/**
		Field tensorflow.tensorforest.FertileStats.node_to_slot
	**/
	public var node_to_slot : Dynamic;
}