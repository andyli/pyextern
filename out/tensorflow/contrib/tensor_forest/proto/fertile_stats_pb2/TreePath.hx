...
@:pythonImport("tensorflow.contrib.tensor_forest.proto.fertile_stats_pb2", "TreePath") extern class TreePath {
	/**
	...
	**/
	...
	/**
		Field tensorflow.tensorforest.TreePath.nodes_visited
	**/
	public var nodes_visited : Dynamic;
}