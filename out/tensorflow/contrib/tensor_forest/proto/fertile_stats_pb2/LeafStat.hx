...
@:pythonImport("tensorflow.contrib.tensor_forest.proto.fertile_stats_pb2", "LeafStat") extern class LeafStat {
	/**
	...
	**/
	...
	/**
		A ProtocolMessage
	**/
	public function GiniImpurityClassificationStats(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	...
	/**
		A ProtocolMessage
	**/
	public function LeastSquaresRegressionStats(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
