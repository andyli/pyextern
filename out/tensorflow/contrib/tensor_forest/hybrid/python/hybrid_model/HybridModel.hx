...
package tensorflow.contrib.tensor_forest.hybrid.python.hybrid_model;
@:pythonImport("tensorflow.contrib.tensor_forest.hybrid.python.hybrid_model", "HybridModel") extern class HybridModel {
