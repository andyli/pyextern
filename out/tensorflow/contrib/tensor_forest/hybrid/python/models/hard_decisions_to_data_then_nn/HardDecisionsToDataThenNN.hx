...
package tensorflow.contrib.tensor_forest.hybrid.python.models.hard_decisions_to_data_then_nn;
@:pythonImport("tensorflow.contrib.tensor_forest.hybrid.python.models.hard_decisions_to_data_then_nn", "HardDecisionsToDataThenNN") extern class HardDecisionsToDataThenNN {
