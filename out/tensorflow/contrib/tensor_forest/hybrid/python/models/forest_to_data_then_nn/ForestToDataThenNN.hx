...
package tensorflow.contrib.tensor_forest.hybrid.python.models.forest_to_data_then_nn;
@:pythonImport("tensorflow.contrib.tensor_forest.hybrid.python.models.forest_to_data_then_nn", "ForestToDataThenNN") extern class ForestToDataThenNN {
