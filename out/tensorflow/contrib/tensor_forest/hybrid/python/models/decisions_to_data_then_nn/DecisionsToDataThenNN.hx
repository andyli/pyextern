...
package tensorflow.contrib.tensor_forest.hybrid.python.models.decisions_to_data_then_nn;
@:pythonImport("tensorflow.contrib.tensor_forest.hybrid.python.models.decisions_to_data_then_nn", "DecisionsToDataThenNN") extern class DecisionsToDataThenNN {
