...
package tensorflow.contrib.tensor_forest.hybrid.python.models.stochastic_soft_decisions_to_data_then_nn;
@:pythonImport("tensorflow.contrib.tensor_forest.hybrid.python.models.stochastic_soft_decisions_to_data_then_nn", "StochasticSoftDecisionsToDataThenNN") extern class StochasticSoftDecisionsToDataThenNN {
