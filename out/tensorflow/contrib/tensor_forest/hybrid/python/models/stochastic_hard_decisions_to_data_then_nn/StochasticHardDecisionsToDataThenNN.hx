...
package tensorflow.contrib.tensor_forest.hybrid.python.models.stochastic_hard_decisions_to_data_then_nn;
@:pythonImport("tensorflow.contrib.tensor_forest.hybrid.python.models.stochastic_hard_decisions_to_data_then_nn", "StochasticHardDecisionsToDataThenNN") extern class StochasticHardDecisionsToDataThenNN {
	...
	**/
	public function _base_inference(data:Dynamic, ?data_spec:Dynamic, ?soft:Dynamic):Dynamic;
