...
@:pythonImport("tensorflow.contrib.tensor_forest.python.ops.gen_tensor_forest_ops") extern class Gen_tensor_forest_ops_Module {
	...
	static public var _count_extremely_random_stats_outputs : Dynamic;
	static public var _finished_nodes_outputs : Dynamic;
	static public var _grow_tree_outputs : Dynamic;
	static public var _op_def_lib : Dynamic;
	static public var _sample_inputs_outputs : Dynamic;
	static public var _top_n_insert_outputs : Dynamic;
	static public var _top_n_remove_outputs : Dynamic;
	static public var _update_fertile_slots_outputs : Dynamic;
	/**
