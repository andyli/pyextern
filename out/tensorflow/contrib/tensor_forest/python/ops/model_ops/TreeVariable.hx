...
@:pythonImport("tensorflow.contrib.tensor_forest.python.ops.model_ops", "TreeVariable") extern class TreeVariable {
	...
	**/
	@:native("__init__")
	public function ___init__(params:Dynamic, tree_config:Dynamic, stats_handle:Dynamic, name:Dynamic, ?container:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(params:Dynamic, tree_config:Dynamic, stats_handle:Dynamic, name:Dynamic, ?container:Dynamic):Void;
	/**
