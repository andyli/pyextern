...
@:pythonImport("tensorflow.contrib.tensor_forest.python.ops.stats_ops", "FertileStatsVariableSavable") extern class FertileStatsVariableSavable {
	...
	**/
	@:native("__init__")
	public function ___init__(params:Dynamic, stats_handle:Dynamic, create_op:Dynamic, name:Dynamic):Dynamic;
	/**
		Creates a FertileStatsVariableSavable object.
		...
		Args:
		  ...
		  name: the name to save the tree variable under.
	**/
	public function new(params:Dynamic, stats_handle:Dynamic, create_op:Dynamic, name:Dynamic):Void;
	/**
