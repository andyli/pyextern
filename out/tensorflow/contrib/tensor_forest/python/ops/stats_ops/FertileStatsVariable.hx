...
@:pythonImport("tensorflow.contrib.tensor_forest.python.ops.stats_ops", "FertileStatsVariable") extern class FertileStatsVariable {
	...
	**/
	@:native("__init__")
	public function ___init__(params:Dynamic, stats_config:Dynamic, name:Dynamic, ?container:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(params:Dynamic, stats_config:Dynamic, name:Dynamic, ?container:Dynamic):Void;
	/**
