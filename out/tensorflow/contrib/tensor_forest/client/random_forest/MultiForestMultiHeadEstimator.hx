...
@:pythonImport("tensorflow.contrib.tensor_forest.client.random_forest", "MultiForestMultiHeadEstimator") extern class MultiForestMultiHeadEstimator {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(params_list:Dynamic, ?device_assigner:Dynamic, ?model_dir:Dynamic, ?feature_columns:Dynamic, ?graph_builder_class:Dynamic, ?config:Dynamic, ?weight_column:Dynamic, ?keys_column:Dynamic, ?feature_engineering_fn:Dynamic, ?early_stopping_rounds:Dynamic, ?num_trainers:Dynamic, ?trainer_id:Dynamic, ?report_feature_importances:Dynamic, ?local_eval:Dynamic):Dynamic;
	/**
		See TensorForestEstimator.__init__.
	**/
	public function new(params_list:Dynamic, ?device_assigner:Dynamic, ?model_dir:Dynamic, ?feature_columns:Dynamic, ?graph_builder_class:Dynamic, ?config:Dynamic, ?weight_column:Dynamic, ?keys_column:Dynamic, ?feature_engineering_fn:Dynamic, ?early_stopping_rounds:Dynamic, ?num_trainers:Dynamic, ?trainer_id:Dynamic, ?report_feature_importances:Dynamic, ?local_eval:Dynamic):Void;
	/**
