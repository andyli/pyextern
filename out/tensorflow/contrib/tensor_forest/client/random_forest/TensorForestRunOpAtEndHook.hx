...
@:pythonImport("tensorflow.contrib.tensor_forest.client.random_forest", "TensorForestRunOpAtEndHook") extern class TensorForestRunOpAtEndHook {
	...
	**/
	@:native("__init__")
	public function ___init__(op_dict:Dynamic):Dynamic;
	/**
		Ops is a dict of {name: op} to run before the session is destroyed.
	**/
	public function new(op_dict:Dynamic):Void;
	/**
