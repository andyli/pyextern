...
@:pythonImport("tensorflow.contrib.tensor_forest.client.random_forest", "TensorForestLossHook") extern class TensorForestLossHook {
	...
	**/
	@:native("__init__")
	public function ___init__(early_stopping_rounds:Dynamic, ?early_stopping_loss_threshold:Dynamic, ?loss_op:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(early_stopping_rounds:Dynamic, ?early_stopping_loss_threshold:Dynamic, ?loss_op:Dynamic):Void;
	/**
