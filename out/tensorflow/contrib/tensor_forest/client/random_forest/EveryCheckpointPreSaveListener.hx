...
@:pythonImport("tensorflow.contrib.tensor_forest.client.random_forest", "EveryCheckpointPreSaveListener") extern class EveryCheckpointPreSaveListener {
	...
	**/
	...
	/**
		...
		Args:
		  op: An op to run before each checkpoint save.
	**/
	public function new(op:Dynamic):Void;
	/**
