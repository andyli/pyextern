...
@:pythonImport("tensorflow.contrib.lite.python.op_hint", "_LiteSingleOperand") extern class _LiteSingleOperand {
	...
	**/
	@:native("__init__")
	public function ___init__(node:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	...
	**/
	...
	/**
		...
		Raises:
		  RuntimeError: if the method is not implemented.
	**/
	public function aggregate_and_return_name_for_output(fused_op_name:Dynamic, index:Dynamic, out_graphdef:Dynamic):Dynamic;
