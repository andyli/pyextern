...
package tensorflow.contrib.lite.python.convert_saved_model;
@:pythonImport("tensorflow.contrib.lite.python.convert_saved_model") extern class Convert_saved_model_Module {
