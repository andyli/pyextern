...
@:pythonImport("tensorflow.contrib.lite.toco.model_flags_pb2", "ArraysExtraInfo") extern class ArraysExtraInfo {
	/**
	...
	**/
	...
	static public var ENTRIES_FIELD_NUMBER : Dynamic;
	/**
		A ProtocolMessage
	**/
	public function Entry(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
		Extension dict
	**/
