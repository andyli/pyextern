...
package tensorflow.contrib.lite.toco.model_flags_pb2;
@:pythonImport("tensorflow.contrib.lite.toco.model_flags_pb2", "ModelFlags") extern class ModelFlags {
	static public var ALLOW_NONASCII_ARRAYS_FIELD_NUMBER : Dynamic;
	static public var ALLOW_NONEXISTENT_ARRAYS_FIELD_NUMBER : Dynamic;
	static public var ARRAYS_EXTRA_INFO_FIELD_NUMBER : Dynamic;
	/**
		Returns the size of the message in bytes.
	**/
	public function ByteSize(args:haxe.extern.Rest<Dynamic>):Dynamic;
	static public var CHANGE_CONCAT_INPUT_RANGES_FIELD_NUMBER : Dynamic;
	/**
		Clears the message.
	**/
	...
	**/
	...
	static public var INPUT_ARRAYS_FIELD_NUMBER : Dynamic;
	/**
	...
	**/
	...
	static public var MODEL_CHECKS_FIELD_NUMBER : Dynamic;
	/**
	...
	**/
	...
	static public var OUTPUT_ARRAYS_FIELD_NUMBER : Dynamic;
	/**
		Parses a serialized message into the current message.
	**/
	public function ParseFromString(args:haxe.extern.Rest<Dynamic>):Dynamic;
	static public var RNN_STATES_FIELD_NUMBER : Dynamic;
	/**
	...
	**/
	...
	static public var VARIABLE_BATCH_FIELD_NUMBER : Dynamic;
	/**
