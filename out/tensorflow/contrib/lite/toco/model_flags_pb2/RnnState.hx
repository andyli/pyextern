...
@:pythonImport("tensorflow.contrib.lite.toco.model_flags_pb2", "RnnState") extern class RnnState {
	static public var BACK_EDGE_SOURCE_ARRAY_FIELD_NUMBER : Dynamic;
	/**
	...
	**/
	...
	static public var DISCARDABLE_FIELD_NUMBER : Dynamic;
	/**
	...
	**/
	...
	static public var STATE_ARRAY_FIELD_NUMBER : Dynamic;
	/**
