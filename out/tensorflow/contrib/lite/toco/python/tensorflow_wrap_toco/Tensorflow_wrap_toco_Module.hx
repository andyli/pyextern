...
package tensorflow.contrib.lite.toco.python.tensorflow_wrap_toco;
@:pythonImport("tensorflow.contrib.lite.toco.python.tensorflow_wrap_toco") extern class Tensorflow_wrap_toco_Module {
