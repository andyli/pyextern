...
@:pythonImport("tensorflow.contrib.learn.python.learn.estimators.head", "_BinaryLogisticHead") extern class _BinaryLogisticHead {
	...
	**/
	@:native("__init__")
	public function ___init__(?label_name:Dynamic, ?weight_column_name:Dynamic, ?enable_centered_bias:Dynamic, ?head_name:Dynamic, ?loss_fn:Dynamic, ?thresholds:Dynamic):Dynamic;
	/**
		`Head` for binary classification with logistic regression.
		...
		Raises:
		  ValueError: if n_classes is invalid.
	**/
	public function new(?label_name:Dynamic, ?weight_column_name:Dynamic, ?enable_centered_bias:Dynamic, ?head_name:Dynamic, ?loss_fn:Dynamic, ?thresholds:Dynamic):Void;
	/**
