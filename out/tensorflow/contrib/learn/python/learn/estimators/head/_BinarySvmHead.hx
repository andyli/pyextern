...
@:pythonImport("tensorflow.contrib.learn.python.learn.estimators.head", "_BinarySvmHead") extern class _BinarySvmHead {
	...
	**/
	@:native("__init__")
	public function ___init__(label_name:Dynamic, weight_column_name:Dynamic, enable_centered_bias:Dynamic, head_name:Dynamic, thresholds:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(label_name:Dynamic, weight_column_name:Dynamic, enable_centered_bias:Dynamic, head_name:Dynamic, thresholds:Dynamic):Void;
	/**
