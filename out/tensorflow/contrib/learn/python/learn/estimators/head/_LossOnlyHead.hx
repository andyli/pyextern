...
@:pythonImport("tensorflow.contrib.learn.python.learn.estimators.head", "_LossOnlyHead") extern class _LossOnlyHead {
	...
	**/
	@:native("__init__")
	public function ___init__(loss_fn:Dynamic, ?head_name:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(loss_fn:Dynamic, ?head_name:Dynamic):Void;
	/**
