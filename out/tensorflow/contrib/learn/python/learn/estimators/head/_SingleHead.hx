...
@:pythonImport("tensorflow.contrib.learn.python.learn.estimators.head", "_SingleHead") extern class _SingleHead {
	...
	**/
	@:native("__init__")
	public function ___init__(problem_type:Dynamic, logits_dimension:Dynamic, ?label_name:Dynamic, ?weight_column_name:Dynamic, ?head_name:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(problem_type:Dynamic, logits_dimension:Dynamic, ?label_name:Dynamic, ?weight_column_name:Dynamic, ?head_name:Dynamic):Void;
	/**
