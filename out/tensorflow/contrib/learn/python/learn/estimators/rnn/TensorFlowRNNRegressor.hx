...
@:pythonImport("tensorflow.contrib.learn.python.learn.estimators.rnn", "TensorFlowRNNRegressor") extern class TensorFlowRNNRegressor {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(rnn_size:Dynamic, ?cell_type:Dynamic, ?num_layers:Dynamic, ?input_op_fn:Dynamic, ?initial_state:Dynamic, ?bidirectional:Dynamic, ?sequence_length:Dynamic, ?attn_length:Dynamic, ?attn_size:Dynamic, ?attn_vec_size:Dynamic, ?n_classes:Dynamic, ?batch_size:Dynamic, ?steps:Dynamic, ?optimizer:Dynamic, ?learning_rate:Dynamic, ?clip_gradients:Dynamic, ?continue_training:Dynamic, ?config:Dynamic, ?verbose:Dynamic):Dynamic;
	/**
		Initializes a TensorFlowRNNRegressor instance.
		...
		Args:
		  ...
		  verbose: Controls the verbosity, possible values:
		    ...
		    * 2: log device placement is printed.
	**/
	public function new(rnn_size:Dynamic, ?cell_type:Dynamic, ?num_layers:Dynamic, ?input_op_fn:Dynamic, ?initial_state:Dynamic, ?bidirectional:Dynamic, ?sequence_length:Dynamic, ?attn_length:Dynamic, ?attn_size:Dynamic, ?attn_vec_size:Dynamic, ?n_classes:Dynamic, ?batch_size:Dynamic, ?steps:Dynamic, ?optimizer:Dynamic, ?learning_rate:Dynamic, ?clip_gradients:Dynamic, ?continue_training:Dynamic, ?config:Dynamic, ?verbose:Dynamic):Void;
	/**
		Return self<=value.
	**/
