...
package tensorflow.contrib.learn.python.learn.estimators.rnn;
@:pythonImport("tensorflow.contrib.learn.python.learn.estimators.rnn", "TensorFlowRNNClassifier") extern class TensorFlowRNNClassifier {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(rnn_size:Dynamic, n_classes:Dynamic, ?cell_type:Dynamic, ?num_layers:Dynamic, ?input_op_fn:Dynamic, ?initial_state:Dynamic, ?bidirectional:Dynamic, ?sequence_length:Dynamic, ?attn_length:Dynamic, ?attn_size:Dynamic, ?attn_vec_size:Dynamic, ?batch_size:Dynamic, ?steps:Dynamic, ?optimizer:Dynamic, ?learning_rate:Dynamic, ?class_weight:Dynamic, ?clip_gradients:Dynamic, ?continue_training:Dynamic, ?config:Dynamic, ?verbose:Dynamic):Dynamic;
	/**
		Initializes a TensorFlowRNNClassifier instance.
		...
		Args:
		  ...
		  config: RunConfig object that controls the configurations of the session,
		    e.g. num_cores, gpu_memory_fraction, etc.
	**/
	public function new(rnn_size:Dynamic, n_classes:Dynamic, ?cell_type:Dynamic, ?num_layers:Dynamic, ?input_op_fn:Dynamic, ?initial_state:Dynamic, ?bidirectional:Dynamic, ?sequence_length:Dynamic, ?attn_length:Dynamic, ?attn_size:Dynamic, ?attn_vec_size:Dynamic, ?batch_size:Dynamic, ?steps:Dynamic, ?optimizer:Dynamic, ?learning_rate:Dynamic, ?class_weight:Dynamic, ?clip_gradients:Dynamic, ?continue_training:Dynamic, ?config:Dynamic, ?verbose:Dynamic):Void;
	/**
		Return self<=value.
	**/
	...
	**/
	...
	public function _model_fn(x:Dynamic, y:Dynamic):Dynamic;
	...
	**/
	...
	/**
		...
		Returns:
		  Returns self.
	**/
	public function fit(x:Dynamic, y:Dynamic, ?steps:Dynamic, ?monitors:Dynamic, ?logdir:Dynamic):Dynamic;
	/**
