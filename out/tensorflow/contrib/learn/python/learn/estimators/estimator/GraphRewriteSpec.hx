...
@:pythonImport("tensorflow.contrib.learn.python.learn.estimators.estimator", "GraphRewriteSpec") extern class GraphRewriteSpec {
	/**
		Return self+value.
	**/
	...
	**/
	...
	/**
		Create new instance of GraphRewriteSpec(tags, transforms)
	**/
	static public function __new__(_cls:Dynamic, tags:Dynamic, transforms:Dynamic):Dynamic;
	/**
		helper for pickle
	**/
	...
	**/
	...
	/**
		Make a new GraphRewriteSpec object from a sequence or iterable
	**/
	static public function _make(iterable:Dynamic, ?_new:Dynamic, ?len:Dynamic):Dynamic;
	/**
		Return a new GraphRewriteSpec object replacing specified fields with new values
	**/
