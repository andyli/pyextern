...
@:pythonImport("tensorflow.contrib.learn.python.learn.estimators.dnn_linear_combined", "_DNNLinearCombinedBaseEstimator") extern class _DNNLinearCombinedBaseEstimator {
	/**
