...
@:pythonImport("tensorflow.contrib.learn.python.learn.estimators.dnn_linear_combined", "DNNLinearCombinedEstimator") extern class DNNLinearCombinedEstimator {
	/**
