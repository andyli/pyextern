...
@:pythonImport("tensorflow.contrib.learn.python.learn.estimators.random_forest", "LossMonitor") extern class LossMonitor {
	...
	**/
	@:native("__init__")
	public function ___init__(early_stopping_rounds:Dynamic, every_n_steps:Dynamic):Dynamic;
	/**
		Initializes an `EveryN` monitor.
		...
		Args:
		  ...
		  first_n_steps: `int`, specifying the number of initial steps during
		    ...
		    of `every_n_steps`. Note that this value is relative to the global step
	**/
	public function new(early_stopping_rounds:Dynamic, every_n_steps:Dynamic):Void;
	/**
		Return self<=value.
	**/
	...
	**/
	public function set_estimator(est:Dynamic):Dynamic;
	/**
