...
package tensorflow.contrib.learn.python.learn.estimators.random_forest;
@:pythonImport("tensorflow.contrib.learn.python.learn.estimators.random_forest", "TensorForestEstimator") extern class TensorForestEstimator {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(params:Dynamic, ?device_assigner:Dynamic, ?model_dir:Dynamic, ?graph_builder_class:Dynamic, ?master:Dynamic, ?accuracy_metric:Dynamic, ?tf_random_seed:Dynamic, ?config:Dynamic):Dynamic;
	/**
		Initializes a BaseEstimator instance.
		...
		Args:
		  ...
		  config: A RunConfig instance.
	**/
	public function new(params:Dynamic, ?device_assigner:Dynamic, ?model_dir:Dynamic, ?graph_builder_class:Dynamic, ?master:Dynamic, ?accuracy_metric:Dynamic, ?tf_random_seed:Dynamic, ?config:Dynamic):Void;
	/**
		Return self<=value.
	**/
	...
	**/
	public function predict(?x:Dynamic, ?input_fn:Dynamic, ?axis:Dynamic, ?batch_size:Dynamic, ?as_iterable:Dynamic):Dynamic;
	/**
