...
@:pythonImport("tensorflow.contrib.learn.python.learn.estimators.linear", "LinearRegressor") extern class LinearRegressor {
	...
	**/
	@:native("__init__")
	public function ___init__(feature_columns:Dynamic, ?model_dir:Dynamic, ?weight_column_name:Dynamic, ?optimizer:Dynamic, ?gradient_clip_norm:Dynamic, ?enable_centered_bias:Dynamic, ?label_dimension:Dynamic, ?_joint_weights:Dynamic, ?config:Dynamic, ?feature_engineering_fn:Dynamic):Dynamic;
	/**
		Construct a `LinearRegressor` estimator object.
		...
		Returns:
		  A `LinearRegressor` estimator.
	**/
	public function new(feature_columns:Dynamic, ?model_dir:Dynamic, ?weight_column_name:Dynamic, ?optimizer:Dynamic, ?gradient_clip_norm:Dynamic, ?enable_centered_bias:Dynamic, ?label_dimension:Dynamic, ?_joint_weights:Dynamic, ?config:Dynamic, ?feature_engineering_fn:Dynamic):Void;
	/**
