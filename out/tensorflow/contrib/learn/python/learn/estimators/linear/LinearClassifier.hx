...
@:pythonImport("tensorflow.contrib.learn.python.learn.estimators.linear", "LinearClassifier") extern class LinearClassifier {
	...
	**/
	@:native("__init__")
	public function ___init__(?feature_columns:Dynamic, ?model_dir:Dynamic, ?n_classes:Dynamic, ?weight_column_name:Dynamic, ?optimizer:Dynamic, ?gradient_clip_norm:Dynamic, ?enable_centered_bias:Dynamic, ?config:Dynamic):Dynamic;
	/**
		Construct a `LinearClassifier` estimator object.
		...
		Returns:
		  A `LinearClassifier` estimator.
	**/
	public function new(?feature_columns:Dynamic, ?model_dir:Dynamic, ?n_classes:Dynamic, ?weight_column_name:Dynamic, ?optimizer:Dynamic, ?gradient_clip_norm:Dynamic, ?enable_centered_bias:Dynamic, ?config:Dynamic):Void;
	/**
		Return self<=value.
	**/
