...
@:pythonImport("tensorflow.contrib.learn.python.learn.estimators.linear", "LinearEstimator") extern class LinearEstimator {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(feature_columns:Dynamic, head:Dynamic, ?model_dir:Dynamic, ?weight_column_name:Dynamic, ?optimizer:Dynamic, ?gradient_clip_norm:Dynamic, ?_joint_weights:Dynamic, ?config:Dynamic, ?feature_engineering_fn:Dynamic):Dynamic;
	/**
		Construct a `LinearEstimator` object.
		...
		Raises:
		  ValueError: if optimizer is not supported, e.g., SDCAOptimizer
	**/
	public function new(feature_columns:Dynamic, head:Dynamic, ?model_dir:Dynamic, ?weight_column_name:Dynamic, ?optimizer:Dynamic, ?gradient_clip_norm:Dynamic, ?_joint_weights:Dynamic, ?config:Dynamic, ?feature_engineering_fn:Dynamic):Void;
	/**
