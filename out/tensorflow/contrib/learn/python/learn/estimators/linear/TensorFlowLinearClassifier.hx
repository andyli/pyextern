...
@:pythonImport("tensorflow.contrib.learn.python.learn.estimators.linear", "TensorFlowLinearClassifier") extern class TensorFlowLinearClassifier {
	/**
	...
	**/
	...
	public function _loss_type():Dynamic;
