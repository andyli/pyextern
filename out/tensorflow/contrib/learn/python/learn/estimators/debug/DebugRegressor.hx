...
@:pythonImport("tensorflow.contrib.learn.python.learn.estimators.debug", "DebugRegressor") extern class DebugRegressor {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(?model_dir:Dynamic, ?label_dimension:Dynamic, ?weight_column_name:Dynamic, ?config:Dynamic, ?feature_engineering_fn:Dynamic):Dynamic;
	/**
		Initializes a DebugRegressor instance.
		...
		Returns:
		  A `DebugRegressor` estimator.
	**/
	public function new(?model_dir:Dynamic, ?label_dimension:Dynamic, ?weight_column_name:Dynamic, ?config:Dynamic, ?feature_engineering_fn:Dynamic):Void;
	/**
	...
	**/
	public function predict_scores(?input_fn:Dynamic, ?batch_size:Dynamic):Dynamic;
	/**
