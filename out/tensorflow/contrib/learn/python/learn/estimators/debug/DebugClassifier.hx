...
@:pythonImport("tensorflow.contrib.learn.python.learn.estimators.debug", "DebugClassifier") extern class DebugClassifier {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(?model_dir:Dynamic, ?n_classes:Dynamic, ?weight_column_name:Dynamic, ?config:Dynamic, ?feature_engineering_fn:Dynamic, ?label_keys:Dynamic):Dynamic;
	/**
		Initializes a DebugClassifier instance.
		...
		Raises:
		  ValueError: If `n_classes` < 2.
	**/
	public function new(?model_dir:Dynamic, ?n_classes:Dynamic, ?weight_column_name:Dynamic, ?config:Dynamic, ?feature_engineering_fn:Dynamic, ?label_keys:Dynamic):Void;
	/**
	...
	**/
	public function predict_classes(?input_fn:Dynamic, ?batch_size:Dynamic):Dynamic;
	/**
	...
	**/
	public function predict_proba(?input_fn:Dynamic, ?batch_size:Dynamic):Dynamic;
	/**
