...
package tensorflow.contrib.learn.python.learn.estimators.autoencoder;
@:pythonImport("tensorflow.contrib.learn.python.learn.estimators.autoencoder", "TensorFlowDNNAutoencoder") extern class TensorFlowDNNAutoencoder {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(hidden_units:Dynamic, ?n_classes:Dynamic, ?batch_size:Dynamic, ?steps:Dynamic, ?optimizer:Dynamic, ?learning_rate:Dynamic, ?clip_gradients:Dynamic, ?activation:Dynamic, ?add_noise:Dynamic, ?continue_training:Dynamic, ?config:Dynamic, ?verbose:Dynamic, ?dropout:Dynamic):Dynamic;
	/**
		Initializes a TensorFlowDNNAutoencoder instance.
		...
		Args:
		  ...
		  dropout: When not None, the probability we will drop out a given
		           coordinate.
	**/
	public function new(hidden_units:Dynamic, ?n_classes:Dynamic, ?batch_size:Dynamic, ?steps:Dynamic, ?optimizer:Dynamic, ?learning_rate:Dynamic, ?clip_gradients:Dynamic, ?activation:Dynamic, ?add_noise:Dynamic, ?continue_training:Dynamic, ?config:Dynamic, ?verbose:Dynamic, ?dropout:Dynamic):Void;
	/**
		Return self<=value.
	**/
	...
	**/
	public function generate(?hidden:Dynamic):Dynamic;
	/**
