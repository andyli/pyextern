...
@:pythonImport("tensorflow.contrib.learn.python.learn.estimators.dnn", "DNNEstimator") extern class DNNEstimator {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(head:Dynamic, hidden_units:Dynamic, feature_columns:Dynamic, ?model_dir:Dynamic, ?optimizer:Dynamic, ?activation_fn:Dynamic, ?dropout:Dynamic, ?gradient_clip_norm:Dynamic, ?config:Dynamic, ?feature_engineering_fn:Dynamic, ?embedding_lr_multipliers:Dynamic, ?input_layer_min_slice_size:Dynamic):Dynamic;
	/**
		Initializes a `DNNEstimator` instance.
		...
		Returns:
		  A `DNNEstimator` estimator.
	**/
	public function new(head:Dynamic, hidden_units:Dynamic, feature_columns:Dynamic, ?model_dir:Dynamic, ?optimizer:Dynamic, ?activation_fn:Dynamic, ?dropout:Dynamic, ?gradient_clip_norm:Dynamic, ?config:Dynamic, ?feature_engineering_fn:Dynamic, ?embedding_lr_multipliers:Dynamic, ?input_layer_min_slice_size:Dynamic):Void;
	/**
