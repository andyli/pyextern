...
@:pythonImport("tensorflow.contrib.learn.python.learn.estimators.dnn", "DNNClassifier") extern class DNNClassifier {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(hidden_units:Dynamic, ?feature_columns:Dynamic, ?model_dir:Dynamic, ?n_classes:Dynamic, ?weight_column_name:Dynamic, ?optimizer:Dynamic, ?activation_fn:Dynamic, ?dropout:Dynamic, ?gradient_clip_norm:Dynamic, ?enable_centered_bias:Dynamic, ?config:Dynamic):Dynamic;
	/**
		Initializes a DNNClassifier instance.
		...
		Returns:
		  A `DNNClassifier` estimator.
	**/
	public function new(hidden_units:Dynamic, ?feature_columns:Dynamic, ?model_dir:Dynamic, ?n_classes:Dynamic, ?weight_column_name:Dynamic, ?optimizer:Dynamic, ?activation_fn:Dynamic, ?dropout:Dynamic, ?gradient_clip_norm:Dynamic, ?enable_centered_bias:Dynamic, ?config:Dynamic):Void;
	/**
		Return self<=value.
	**/
	...
	**/
	...
	public function _validate_dnn_feature_columns(features:Dynamic):Dynamic;
