...
@:pythonImport("tensorflow.contrib.learn.python.learn.estimators.dnn", "DNNClassifier") extern class DNNClassifier {
	...
	**/
	@:native("__init__")
	public function ___init__(hidden_units:Dynamic, feature_columns:Dynamic, ?model_dir:Dynamic, ?n_classes:Dynamic, ?weight_column_name:Dynamic, ?optimizer:Dynamic, ?activation_fn:Dynamic, ?dropout:Dynamic, ?gradient_clip_norm:Dynamic, ?enable_centered_bias:Dynamic, ?config:Dynamic, ?feature_engineering_fn:Dynamic, ?embedding_lr_multipliers:Dynamic, ?input_layer_min_slice_size:Dynamic, ?label_keys:Dynamic):Dynamic;
	/**
		Initializes a DNNClassifier instance.
		...
		Raises:
		  ValueError: If `n_classes` < 2.
	**/
	public function new(hidden_units:Dynamic, feature_columns:Dynamic, ?model_dir:Dynamic, ?n_classes:Dynamic, ?weight_column_name:Dynamic, ?optimizer:Dynamic, ?activation_fn:Dynamic, ?dropout:Dynamic, ?gradient_clip_norm:Dynamic, ?enable_centered_bias:Dynamic, ?config:Dynamic, ?feature_engineering_fn:Dynamic, ?embedding_lr_multipliers:Dynamic, ?input_layer_min_slice_size:Dynamic, ?label_keys:Dynamic):Void;
	/**
