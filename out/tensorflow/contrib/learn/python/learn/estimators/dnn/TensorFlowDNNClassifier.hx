...
@:pythonImport("tensorflow.contrib.learn.python.learn.estimators.dnn", "TensorFlowDNNClassifier") extern class TensorFlowDNNClassifier {
	/**
	...
	**/
	...
	public function fit(x:Dynamic, y:Dynamic, ?steps:Dynamic, ?batch_size:Dynamic, ?monitors:Dynamic, ?logdir:Dynamic):Dynamic;
	/**
	...
	**/
	public function predict(?x:Dynamic, ?input_fn:Dynamic, ?batch_size:Dynamic, ?outputs:Dynamic, ?axis:Dynamic):Dynamic;
	public function predict_proba(?x:Dynamic, ?input_fn:Dynamic, ?batch_size:Dynamic, ?outputs:Dynamic):Dynamic;
	/**
