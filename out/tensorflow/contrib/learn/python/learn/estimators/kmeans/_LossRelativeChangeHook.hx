...
@:pythonImport("tensorflow.contrib.learn.python.learn.estimators.kmeans", "_LossRelativeChangeHook") extern class _LossRelativeChangeHook {
	...
	**/
	@:native("__init__")
	public function ___init__(tolerance:Dynamic):Dynamic;
	/**
		Initializes _LossRelativeChangeHook.
		...
		Args:
		  tolerance: A relative tolerance of change between iterations.
	**/
	public function new(tolerance:Dynamic):Void;
	/**
