...
@:pythonImport("tensorflow.contrib.learn.python.learn.estimators.svm", "SVM") extern class SVM {
	...
	**/
	@:native("__init__")
	public function ___init__(example_id_column:Dynamic, ?feature_columns:Dynamic, ?weight_column_name:Dynamic, ?model_dir:Dynamic, ?l1_regularization:Dynamic, ?l2_regularization:Dynamic, ?kernels:Dynamic, ?config:Dynamic):Dynamic;
	/**
		Construct a `LinearClassifier` estimator object.
		...
		Returns:
		  A `LinearClassifier` estimator.
	**/
	public function new(example_id_column:Dynamic, ?feature_columns:Dynamic, ?weight_column_name:Dynamic, ?model_dir:Dynamic, ?l1_regularization:Dynamic, ?l2_regularization:Dynamic, ?kernels:Dynamic, ?config:Dynamic):Void;
	/**
		Return self<=value.
	**/
