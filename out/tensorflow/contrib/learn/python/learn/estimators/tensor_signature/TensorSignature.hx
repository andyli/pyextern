...
@:pythonImport("tensorflow.contrib.learn.python.learn.estimators.tensor_signature", "TensorSignature") extern class TensorSignature {
	/**
		Return self+value.
	**/
	...
	**/
	...
	/**
		Create new instance of TensorSignature(dtype, shape, is_sparse)
	**/
	static public function __new__(cls:Dynamic, tensor:Dynamic):Dynamic;
	/**
		helper for pickle
	**/
	...
	**/
	...
	/**
		Make a new TensorSignature object from a sequence or iterable
	**/
	...
	**/
	...
	public function get_feature_spec():Dynamic;
	public function get_placeholder():Dynamic;
	/**
