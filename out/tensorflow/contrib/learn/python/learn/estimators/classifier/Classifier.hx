...
package tensorflow.contrib.learn.python.learn.estimators.classifier;
@:pythonImport("tensorflow.contrib.learn.python.learn.estimators.classifier", "Classifier") extern class Classifier {
	static public var CLASS_OUTPUT : Dynamic;
	static public var PROBABILITY_OUTPUT : Dynamic;
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(model_fn:Dynamic, n_classes:Dynamic, ?model_dir:Dynamic, ?config:Dynamic):Dynamic;
	/**
		Constructor for Classifier.
		...
		Args:
		  ...
		  config: Configuration object (optional)
	**/
	public function new(model_fn:Dynamic, n_classes:Dynamic, ?model_dir:Dynamic, ?config:Dynamic):Void;
	/**
		Return self<=value.
	**/
	...
	**/
	...
	public function _classifier_model(features:Dynamic, targets:Dynamic, mode:Dynamic):Dynamic;
	...
	**/
	public function evaluate(?x:Dynamic, ?y:Dynamic, ?input_fn:Dynamic, ?batch_size:Dynamic, ?steps:Dynamic, ?metrics:Dynamic):Dynamic;
	/**
		See `Trainable`.
