...
@:pythonImport("tensorflow.contrib.learn.python.learn.datasets.base", "Dataset") extern class Dataset {
	/**
		Return self+value.
	**/
	...
	**/
	...
	/**
		Create new instance of Dataset(data, target)
	**/
	static public function __new__(_cls:Dynamic, data:Dynamic, target:Dynamic):Dynamic;
	/**
		helper for pickle
	**/
