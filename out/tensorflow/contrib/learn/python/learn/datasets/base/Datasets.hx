...
@:pythonImport("tensorflow.contrib.learn.python.learn.datasets.base", "Datasets") extern class Datasets {
	/**
		Return self+value.
	**/
	...
	**/
	static public function __new__(_cls:Dynamic, train:Dynamic, validation:Dynamic, test:Dynamic):Dynamic;
	/**
		helper for pickle
	**/
	...
	**/
	public var train : Dynamic;
	/**
		Alias for field number 1
	**/
	public var validation : Dynamic;
}