...
package tensorflow.contrib.learn.python.learn.wrapped_session;
@:pythonImport("tensorflow.contrib.learn.python.learn.wrapped_session", "WrappedSession") extern class WrappedSession {
