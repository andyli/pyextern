...
package tensorflow.contrib.learn.python.learn.coordinated_session;
@:pythonImport("tensorflow.contrib.learn.python.learn.coordinated_session", "CoordinatedSession") extern class CoordinatedSession {
	...
	**/
	@:native("__init__")
	public function ___init__(sess:Dynamic, coord:Dynamic, coordinated_threads_to_join:Dynamic):Dynamic;
	/**
		Create a new `CoordinatedSession`.
		...
		Args:
		  ...
		  coordinated_threads_to_join: A list of threads.
	**/
	public function new(sess:Dynamic, coord:Dynamic, coordinated_threads_to_join:Dynamic):Void;
	/**
		Return self<=value.
	**/
