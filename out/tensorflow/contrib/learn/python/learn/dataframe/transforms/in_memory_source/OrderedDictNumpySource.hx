...
package tensorflow.contrib.learn.python.learn.dataframe.transforms.in_memory_source;
@:pythonImport("tensorflow.contrib.learn.python.learn.dataframe.transforms.in_memory_source", "OrderedDictNumpySource") extern class OrderedDictNumpySource {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(ordered_dict_of_arrays:Dynamic, ?num_threads:Dynamic, ?enqueue_size:Dynamic, ?batch_size:Dynamic, ?queue_capacity:Dynamic, ?shuffle:Dynamic, ?min_after_dequeue:Dynamic, ?seed:Dynamic, ?data_name:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(ordered_dict_of_arrays:Dynamic, ?num_threads:Dynamic, ?enqueue_size:Dynamic, ?batch_size:Dynamic, ?queue_capacity:Dynamic, ?shuffle:Dynamic, ?min_after_dequeue:Dynamic, ?seed:Dynamic, ?data_name:Dynamic):Void;
	/**
	...
	**/
	public function _apply_transform(transform_input:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
	...
	**/
	...
	public var data_name : Dynamic;
	public var enqueue_size : Dynamic;
	/**
	...
	**/
	...
	public var min_after_dequeue : Dynamic;
	/**
		Name of the transform.
	**/
	public var name : Dynamic;
	public var num_threads : Dynamic;
	/**
		The names of `Series` output by the `Transform`.
	...
	**/
	...
	public var queue_capacity : Dynamic;
	/**
