...
@:pythonImport("tensorflow.contrib.learn.python.learn.dataframe.transforms.batch", "Batch") extern class Batch {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(batch_size:Dynamic, output_names:Dynamic, ?num_threads:Dynamic, ?queue_capacity:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(batch_size:Dynamic, output_names:Dynamic, ?num_threads:Dynamic, ?queue_capacity:Dynamic):Void;
	/**
