...
@:pythonImport("tensorflow.contrib.learn.python.learn.dataframe.transforms.in_memory_source", "PandasSource") extern class PandasSource {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(dataframe:Dynamic, ?num_threads:Dynamic, ?enqueue_size:Dynamic, ?batch_size:Dynamic, ?queue_capacity:Dynamic, ?shuffle:Dynamic, ?min_after_dequeue:Dynamic, ?seed:Dynamic, ?data_name:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(dataframe:Dynamic, ?num_threads:Dynamic, ?enqueue_size:Dynamic, ?batch_size:Dynamic, ?queue_capacity:Dynamic, ?shuffle:Dynamic, ?min_after_dequeue:Dynamic, ?seed:Dynamic, ?data_name:Dynamic):Void;
	/**
		Return self<=value.
	**/
