...
package tensorflow.contrib.learn.python.learn.dataframe.transforms.densify;
@:pythonImport("tensorflow.contrib.learn.python.learn.dataframe.transforms.densify", "Densify") extern class Densify {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(default_value:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(default_value:Dynamic):Void;
	/**
		Return self<=value.
	**/
