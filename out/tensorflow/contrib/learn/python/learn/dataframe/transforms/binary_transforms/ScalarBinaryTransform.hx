...
package tensorflow.contrib.learn.python.learn.dataframe.transforms.binary_transforms;
@:pythonImport("tensorflow.contrib.learn.python.learn.dataframe.transforms.binary_transforms", "ScalarBinaryTransform") extern class ScalarBinaryTransform {
	/**
