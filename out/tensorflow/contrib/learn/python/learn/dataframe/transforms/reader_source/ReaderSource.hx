...
package tensorflow.contrib.learn.python.learn.dataframe.transforms.reader_source;
@:pythonImport("tensorflow.contrib.learn.python.learn.dataframe.transforms.reader_source", "ReaderSource") extern class ReaderSource {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(reader_cls:Dynamic, work_units:Dynamic, ?reader_kwargs:Dynamic, ?enqueue_size:Dynamic, ?batch_size:Dynamic, ?queue_capacity:Dynamic, ?shuffle:Dynamic, ?min_after_dequeue:Dynamic, ?num_threads:Dynamic, ?seed:Dynamic):Dynamic;
	/**
		Initializes a ReaderSource.
	...
	**/
	...
	public var reader_cls : Dynamic;
	public var reader_kwargs : Dynamic;
	/**
