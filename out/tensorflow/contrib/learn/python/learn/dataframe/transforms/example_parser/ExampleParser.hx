...
package tensorflow.contrib.learn.python.learn.dataframe.transforms.example_parser;
@:pythonImport("tensorflow.contrib.learn.python.learn.dataframe.transforms.example_parser", "ExampleParser") extern class ExampleParser {
	/**
	...
	**/
	...
	public var feature_definitions : Dynamic;
	/**
