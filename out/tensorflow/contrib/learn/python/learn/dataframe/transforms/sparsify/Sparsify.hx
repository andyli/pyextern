...
package tensorflow.contrib.learn.python.learn.dataframe.transforms.sparsify;
@:pythonImport("tensorflow.contrib.learn.python.learn.dataframe.transforms.sparsify", "Sparsify") extern class Sparsify {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(strip_value:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(strip_value:Dynamic):Void;
	/**
		Return self<=value.
	**/
	...
	**/
	...
	public var strip_value : Dynamic;
}