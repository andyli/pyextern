...
package tensorflow.contrib.learn.python.learn.dataframe.transforms.csv_parser;
@:pythonImport("tensorflow.contrib.learn.python.learn.dataframe.transforms.csv_parser", "CSVParser") extern class CSVParser {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(column_names:Dynamic, default_values:Dynamic):Dynamic;
	/**
		Initialize `CSVParser`.
	...
	**/
	...
	public var default_values : Dynamic;
	/**
