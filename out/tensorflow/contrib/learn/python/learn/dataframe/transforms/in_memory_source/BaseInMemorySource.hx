...
@:pythonImport("tensorflow.contrib.learn.python.learn.dataframe.transforms.in_memory_source", "BaseInMemorySource") extern class BaseInMemorySource {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(data:Dynamic, ?num_threads:Dynamic, ?enqueue_size:Dynamic, ?batch_size:Dynamic, ?queue_capacity:Dynamic, ?shuffle:Dynamic, ?min_after_dequeue:Dynamic, ?seed:Dynamic, ?data_name:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(data:Dynamic, ?num_threads:Dynamic, ?enqueue_size:Dynamic, ?batch_size:Dynamic, ?queue_capacity:Dynamic, ?shuffle:Dynamic, ?min_after_dequeue:Dynamic, ?seed:Dynamic, ?data_name:Dynamic):Void;
	/**
