...
package tensorflow.contrib.learn.python.learn.dataframe.transforms.batch;
@:pythonImport("tensorflow.contrib.learn.python.learn.dataframe.transforms.batch", "ShuffleBatch") extern class ShuffleBatch {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(batch_size:Dynamic, output_names:Dynamic, ?num_threads:Dynamic, ?queue_capacity:Dynamic, ?min_after_dequeue:Dynamic, ?seed:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(batch_size:Dynamic, output_names:Dynamic, ?num_threads:Dynamic, ?queue_capacity:Dynamic, ?min_after_dequeue:Dynamic, ?seed:Dynamic):Void;
	/**
		Return self<=value.
	**/
