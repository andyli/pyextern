...
package tensorflow.contrib.learn.python.learn.dataframe.transforms.difference;
@:pythonImport("tensorflow.contrib.learn.python.learn.dataframe.transforms.difference", "Difference") extern class Difference {
	/**
