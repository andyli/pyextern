...
@:pythonImport("tensorflow.contrib.learn.python.learn.monitors", "PrintTensor") extern class PrintTensor {
	...
	**/
	@:native("__init__")
	public function ___init__(tensor_names:Dynamic, ?every_n:Dynamic, ?first_n:Dynamic):Dynamic;
	/**
		Initializes a PrintTensor monitor.
		...
		Args:
		  ...
		  first_n: `int`, also print the first N steps. See `PrintN.`
	**/
	public function new(tensor_names:Dynamic, ?every_n:Dynamic, ?first_n:Dynamic):Void;
	/**
		Return self<=value.
	**/
