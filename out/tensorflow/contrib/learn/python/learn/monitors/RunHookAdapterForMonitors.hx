...
@:pythonImport("tensorflow.contrib.learn.python.learn.monitors", "RunHookAdapterForMonitors") extern class RunHookAdapterForMonitors {
	...
	**/
	@:native("__init__")
	public function ___init__(monitors:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(monitors:Dynamic):Void;
	/**
