...
@:pythonImport("tensorflow.contrib.learn.python.learn.monitors", "SummarySaver") extern class SummarySaver {
	...
	**/
	@:native("__init__")
	public function ___init__(summary_op:Dynamic, ?save_steps:Dynamic, ?output_dir:Dynamic, ?summary_writer:Dynamic, ?scaffold:Dynamic):Dynamic;
	/**
		Initializes a `SummarySaver` monitor.
