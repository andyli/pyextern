...
@:pythonImport("tensorflow.contrib.learn.python.learn.monitors", "NanLoss") extern class NanLoss {
	...
	**/
	@:native("__init__")
	public function ___init__(loss_tensor:Dynamic, ?every_n_steps:Dynamic, ?fail_on_nan_loss:Dynamic):Dynamic;
	/**
		Initializes NanLoss monitor.
		...
		Args:
		  ...
		  fail_on_nan_loss: `bool`, whether to raise exception when loss is NaN.
	**/
	public function new(loss_tensor:Dynamic, ?every_n_steps:Dynamic, ?fail_on_nan_loss:Dynamic):Void;
	/**
