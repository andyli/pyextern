...
@:pythonImport("tensorflow.contrib.learn.python.learn.monitors", "CheckpointSaver") extern class CheckpointSaver {
	...
	**/
	@:native("__init__")
	public function ___init__(checkpoint_dir:Dynamic, ?save_secs:Dynamic, ?save_steps:Dynamic, ?saver:Dynamic, ?checkpoint_basename:Dynamic, ?scaffold:Dynamic):Dynamic;
	/**
		Initialize CheckpointSaver monitor.
		...
		Raises:
		  ...
		  ValueError: If both `save_steps` and `save_secs` are `None`.
	**/
	public function new(checkpoint_dir:Dynamic, ?save_secs:Dynamic, ?save_steps:Dynamic, ?saver:Dynamic, ?checkpoint_basename:Dynamic, ?scaffold:Dynamic):Void;
	/**
		Return self<=value.
	**/
