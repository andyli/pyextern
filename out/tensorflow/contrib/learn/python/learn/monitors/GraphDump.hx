...
@:pythonImport("tensorflow.contrib.learn.python.learn.monitors", "GraphDump") extern class GraphDump {
	static public var IGNORE_OPS : Dynamic;
	...
	**/
	@:native("__init__")
	public function ___init__(?ignore_ops:Dynamic):Dynamic;
	/**
		Initializes GraphDump monitor.
		...
		Args:
		  ignore_ops: `list` of `string`. Names of ops to ignore.
		      If None, `GraphDump.IGNORE_OPS` is used.
	**/
	public function new(?ignore_ops:Dynamic):Void;
	/**
		Return self<=value.
	**/
	...
	**/
	public function compare(other_dump:Dynamic, step:Dynamic, ?atol:Dynamic):Dynamic;
