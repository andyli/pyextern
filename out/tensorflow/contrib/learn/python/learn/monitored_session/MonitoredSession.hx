...
package tensorflow.contrib.learn.python.learn.monitored_session;
@:pythonImport("tensorflow.contrib.learn.python.learn.monitored_session", "MonitoredSession") extern class MonitoredSession {
	...
	**/
	@:native("__init__")
	public function ___init__(sess:Dynamic, monitors:Dynamic, global_step_tensor:Dynamic):Dynamic;
	/**
		Initializes a MonitoredSession object.
		...
		Args:
		  ...
		  global_step_tensor: A 'Tensor' which holds a scalar int value.
	**/
	public function new(sess:Dynamic, monitors:Dynamic, global_step_tensor:Dynamic):Void;
	/**
		Return self<=value.
	**/
