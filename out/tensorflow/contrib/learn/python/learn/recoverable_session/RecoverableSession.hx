...
@:pythonImport("tensorflow.contrib.learn.python.learn.recoverable_session", "RecoverableSession") extern class RecoverableSession {
	...
	**/
	@:native("__init__")
	public function ___init__(sess_factory:Dynamic):Dynamic;
	/**
		Create a new `RecoverableSession`.
		...
		Args:
		  sess_factory: A callable with no arguments that returns a
		    `tf.Session` when called.
	**/
	public function new(sess_factory:Dynamic):Void;
	/**
		Return self<=value.
	**/
