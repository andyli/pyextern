...
@:pythonImport("tensorflow.contrib.learn.python.learn.utils.input_fn_utils", "InputFnOps") extern class InputFnOps {
	/**
		Return self+value.
	**/
	...
	**/
	static public function __new__(_cls:Dynamic, features:Dynamic, labels:Dynamic, default_inputs:Dynamic):Dynamic;
	/**
		helper for pickle
	**/
	...
	**/
	...
	/**
		Make a new InputFnOps object from a sequence or iterable
	**/
	static public function _make(iterable:Dynamic, ?_new:Dynamic, ?len:Dynamic):Dynamic;
	/**
		Return a new InputFnOps object replacing specified fields with new values
	**/
	...
	**/
	public var default_inputs : Dynamic;
	/**
