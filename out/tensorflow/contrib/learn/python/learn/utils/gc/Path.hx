...
@:pythonImport("tensorflow.contrib.learn.python.learn.utils.gc", "Path") extern class Path {
	/**
		Return self+value.
	**/
	...
	**/
	...
	/**
		Create new instance of Path(path, export_version)
	**/
	static public function __new__(_cls:Dynamic, path:Dynamic, export_version:Dynamic):Dynamic;
	/**
		helper for pickle
	**/
	...
	**/
	...
	/**
		Make a new Path object from a sequence or iterable
	**/
	static public function _make(iterable:Dynamic, ?_new:Dynamic, ?len:Dynamic):Dynamic;
	/**
		Return a new Path object replacing specified fields with new values
	**/
	...
	**/
	public var export_version : Dynamic;
	/**
