...
@:pythonImport("tensorflow.contrib.learn.python.learn.preprocessing.text", "ByteProcessor") extern class ByteProcessor {
	...
	**/
	@:native("__init__")
	public function ___init__(max_document_length:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(max_document_length:Dynamic):Void;
	/**
	...
	**/
	public function fit(x:Dynamic):Dynamic;
	/**
		Calls transform.
	**/
	public function fit_transform(x:Dynamic):Dynamic;
	/**
	...
	**/
	public function reverse(x:Dynamic):Dynamic;
	/**
