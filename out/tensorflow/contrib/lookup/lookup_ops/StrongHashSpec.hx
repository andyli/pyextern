...
@:pythonImport("tensorflow.contrib.lookup.lookup_ops", "StrongHashSpec") extern class StrongHashSpec {
	/**
		Return self+value.
	**/
	...
	**/
	static public function __new__(cls:Dynamic, key:Dynamic):Dynamic;
	/**
		helper for pickle
	**/
