...
@:pythonImport("tensorflow.contrib.lookup.lookup_ops", "HasherSpec") extern class HasherSpec {
	/**
		Return self+value.
	**/
	...
	**/
	static public function __new__(_cls:Dynamic, hasher:Dynamic, key:Dynamic):Dynamic;
	/**
		helper for pickle
	**/
	...
	**/
	...
	/**
		Make a new HasherSpec object from a sequence or iterable
	**/
	static public function _make(iterable:Dynamic, ?_new:Dynamic, ?len:Dynamic):Dynamic;
	/**
		Return a new HasherSpec object replacing specified fields with new values
	**/
