...
@:pythonImport("tensorflow.contrib.lookup.lookup_ops", "LookupInterface") extern class LookupInterface {
	...
	**/
	@:native("__init__")
	public function ___init__(key_dtype:Dynamic, value_dtype:Dynamic, name:Dynamic):Dynamic;
	/**
		Construct a lookup table interface.
		...
		Args:
		  ...
		  name: A name for the operation (optional).
	**/
	public function new(key_dtype:Dynamic, value_dtype:Dynamic, name:Dynamic):Void;
	/**
