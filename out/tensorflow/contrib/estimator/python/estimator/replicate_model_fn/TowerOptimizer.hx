...
@:pythonImport("tensorflow.contrib.estimator.python.estimator.replicate_model_fn", "TowerOptimizer") extern class TowerOptimizer {
	static public var COLLECTION_FOR_GRAPH_STATES : Dynamic;
	...
	**/
	static public function _PerGraphState():Dynamic;
	...
	**/
	@:native("__init__")
	public function ___init__(optimizer_or_optimizer_fn:Dynamic):Dynamic;
	/**
		Wrap an existing optimizer for gathering gradients across towers. (deprecated)
		...
		Args:
		  optimizer_or_optimizer_fn: an instance of optimizer to wrap.  That
		    ...
		    also be a no-argument function that returns such an optimizer instance.
	**/
	public function new(optimizer_or_optimizer_fn:Dynamic):Void;
	/**
	...
	**/
	...
	public function _apply_gathered_gradients(global_step:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
	...
	**/
	...
	static public function _clear_graph_state():Dynamic;
	public function _construct_no_op_train_op():Dynamic;
	/**
	...
	**/
	...
	static public function _did_towers_have_same_optimizer_calls():Dynamic;
	/**
	...
	**/
	...
	static public function _graph_state():Dynamic;
	/**
	...
	**/
	public function apply_gradients(grads_and_vars:Dynamic, ?global_step:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
		Compute gradients, but first, if needed, scale the loss.
	**/
	public function compute_gradients(loss:Dynamic, ?args:python.VarArgs<Dynamic>, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	...
	**/
	...
	static public function has_been_used():Dynamic;
	/**
	...
	**/
	...
	/**
		...
		Returns:
		  A list of variables.
	**/
	public function variables(?args:python.VarArgs<Dynamic>, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
}