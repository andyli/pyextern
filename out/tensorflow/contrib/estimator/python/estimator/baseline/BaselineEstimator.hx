...
package tensorflow.contrib.estimator.python.estimator.baseline;
@:pythonImport("tensorflow.contrib.estimator.python.estimator.baseline", "BaselineEstimator") extern class BaselineEstimator {
	...
	**/
	@:native("__init__")
	public function ___init__(head:Dynamic, ?model_dir:Dynamic, ?optimizer:Dynamic, ?config:Dynamic):Dynamic;
	/**
		Initializes a BaselineEstimator instance.
		...
		Args:
		  ...
		  config: `RunConfig` object to configure the runtime settings.
	**/
	public function new(head:Dynamic, ?model_dir:Dynamic, ?optimizer:Dynamic, ?config:Dynamic):Void;
	/**
