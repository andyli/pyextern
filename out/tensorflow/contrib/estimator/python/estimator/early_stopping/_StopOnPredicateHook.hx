...
@:pythonImport("tensorflow.contrib.estimator.python.estimator.early_stopping", "_StopOnPredicateHook") extern class _StopOnPredicateHook {
	...
	**/
	@:native("__init__")
	public function ___init__(should_stop_fn:Dynamic, ?run_every_secs:Dynamic, ?run_every_steps:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(should_stop_fn:Dynamic, ?run_every_secs:Dynamic, ?run_every_steps:Dynamic):Void;
	/**
