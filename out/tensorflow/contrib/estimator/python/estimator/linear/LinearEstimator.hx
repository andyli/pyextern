...
package tensorflow.contrib.estimator.python.estimator.linear;
@:pythonImport("tensorflow.contrib.estimator.python.estimator.linear", "LinearEstimator") extern class LinearEstimator {
	...
	**/
	@:native("__init__")
	public function ___init__(head:Dynamic, feature_columns:Dynamic, ?model_dir:Dynamic, ?optimizer:Dynamic, ?config:Dynamic, ?partitioner:Dynamic, ?sparse_combiner:Dynamic):Dynamic;
	/**
		Initializes a `LinearEstimator` instance.
		...
		Args:
		  ...
		  sparse_combiner: A string specifying how to reduce if a categorical column
		    ...
		    `tf.feature_column.linear_model`.
	**/
	public function new(head:Dynamic, feature_columns:Dynamic, ?model_dir:Dynamic, ?optimizer:Dynamic, ?config:Dynamic, ?partitioner:Dynamic, ?sparse_combiner:Dynamic):Void;
	/**
