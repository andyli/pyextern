...
@:pythonImport("tensorflow.contrib.estimator.python.estimator.rnn", "RNNEstimator") extern class RNNEstimator {
	...
	**/
	@:native("__init__")
	public function ___init__(head:Dynamic, sequence_feature_columns:Dynamic, ?context_feature_columns:Dynamic, ?num_units:Dynamic, ?cell_type:Dynamic, ?rnn_cell_fn:Dynamic, ?model_dir:Dynamic, ?optimizer:Dynamic, ?input_layer_partitioner:Dynamic, ?config:Dynamic):Dynamic;
	/**
		Initializes a `RNNClassifier` instance.
		...
		Raises:
		  ValueError: If `num_units`, `cell_type`, and `rnn_cell_fn` are not
		    compatible.
	**/
	public function new(head:Dynamic, sequence_feature_columns:Dynamic, ?context_feature_columns:Dynamic, ?num_units:Dynamic, ?cell_type:Dynamic, ?rnn_cell_fn:Dynamic, ?model_dir:Dynamic, ?optimizer:Dynamic, ?input_layer_partitioner:Dynamic, ?config:Dynamic):Void;
	/**
