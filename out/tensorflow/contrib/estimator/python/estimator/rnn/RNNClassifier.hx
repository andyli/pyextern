...
@:pythonImport("tensorflow.contrib.estimator.python.estimator.rnn", "RNNClassifier") extern class RNNClassifier {
	...
	**/
	@:native("__init__")
	public function ___init__(sequence_feature_columns:Dynamic, ?context_feature_columns:Dynamic, ?num_units:Dynamic, ?cell_type:Dynamic, ?rnn_cell_fn:Dynamic, ?model_dir:Dynamic, ?n_classes:Dynamic, ?weight_column:Dynamic, ?label_vocabulary:Dynamic, ?optimizer:Dynamic, ?loss_reduction:Dynamic, ?input_layer_partitioner:Dynamic, ?config:Dynamic):Dynamic;
	/**
		Initializes a `RNNClassifier` instance.
		...
		Raises:
		  ValueError: If `num_units`, `cell_type`, and `rnn_cell_fn` are not
		    compatible.
	**/
	public function new(sequence_feature_columns:Dynamic, ?context_feature_columns:Dynamic, ?num_units:Dynamic, ?cell_type:Dynamic, ?rnn_cell_fn:Dynamic, ?model_dir:Dynamic, ?n_classes:Dynamic, ?weight_column:Dynamic, ?label_vocabulary:Dynamic, ?optimizer:Dynamic, ?loss_reduction:Dynamic, ?input_layer_partitioner:Dynamic, ?config:Dynamic):Void;
	/**
