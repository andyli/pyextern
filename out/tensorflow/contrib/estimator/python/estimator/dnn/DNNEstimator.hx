...
package tensorflow.contrib.estimator.python.estimator.dnn;
@:pythonImport("tensorflow.contrib.estimator.python.estimator.dnn", "DNNEstimator") extern class DNNEstimator {
	...
	**/
	@:native("__init__")
	public function ___init__(head:Dynamic, hidden_units:Dynamic, feature_columns:Dynamic, ?model_dir:Dynamic, ?optimizer:Dynamic, ?activation_fn:Dynamic, ?dropout:Dynamic, ?input_layer_partitioner:Dynamic, ?config:Dynamic, ?warm_start_from:Dynamic, ?batch_norm:Dynamic):Dynamic;
	/**
		Initializes a `DNNEstimator` instance.
		...
		Args:
		  ...
		  batch_norm: Whether to use batch normalization after each hidden layer.
	**/
	public function new(head:Dynamic, hidden_units:Dynamic, feature_columns:Dynamic, ?model_dir:Dynamic, ?optimizer:Dynamic, ?activation_fn:Dynamic, ?dropout:Dynamic, ?input_layer_partitioner:Dynamic, ?config:Dynamic, ?warm_start_from:Dynamic, ?batch_norm:Dynamic):Void;
	/**
