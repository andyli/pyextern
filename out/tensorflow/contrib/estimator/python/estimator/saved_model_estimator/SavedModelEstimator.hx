...
@:pythonImport("tensorflow.contrib.estimator.python.estimator.saved_model_estimator", "SavedModelEstimator") extern class SavedModelEstimator {
	...
	**/
	@:native("__init__")
	public function ___init__(saved_model_dir:Dynamic, ?model_dir:Dynamic):Dynamic;
	/**
		Initialize a SavedModelEstimator.
		...
		Raises:
		  NotImplementedError: If a DistributionStrategy is defined in the config.
		    Unless the SavedModelEstimator is subclassed, this shouldn't happen.
	**/
	public function new(saved_model_dir:Dynamic, ?model_dir:Dynamic):Void;
	/**
	...
	**/
	public function _extract_available_modes():Dynamic;
	/**
	...
	**/
	...
	public function _get_meta_graph_def_for_mode(mode:Dynamic):Dynamic;
	public function _get_signature_def_for_mode(mode:Dynamic):Dynamic;
	public function _maybe_warm_start(checkpoint_path:Dynamic):Dynamic;
	/**
		Load a SavedModel graph and return an EstimatorSpec.
	**/
	public function _model_fn_from_saved_model(features:Dynamic, labels:Dynamic, mode:Dynamic):Dynamic;
	...
	**/
	public function _validate_mode(mode:Dynamic):Dynamic;
