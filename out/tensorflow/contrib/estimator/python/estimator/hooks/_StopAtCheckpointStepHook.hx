...
@:pythonImport("tensorflow.contrib.estimator.python.estimator.hooks", "_StopAtCheckpointStepHook") extern class _StopAtCheckpointStepHook {
	...
	**/
	@:native("__init__")
	public function ___init__(model_dir:Dynamic, last_step:Dynamic, ?wait_after_file_check_secs:Dynamic):Dynamic;
	/**
		Initializes a `StopAtCheckpointStepHook`.
		...
		Raises:
		  ValueError: If one of the arguments is invalid.
	**/
	public function new(model_dir:Dynamic, last_step:Dynamic, ?wait_after_file_check_secs:Dynamic):Void;
	/**
