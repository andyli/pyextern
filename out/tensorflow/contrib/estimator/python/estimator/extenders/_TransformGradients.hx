...
@:pythonImport("tensorflow.contrib.estimator.python.estimator.extenders", "_TransformGradients") extern class _TransformGradients {
	...
	**/
	@:native("__init__")
	public function ___init__(optimizer:Dynamic, transform_grads_fn:Dynamic, ?name:Dynamic):Dynamic;
	/**
		Construct an `tf.Optimizer` wrapper to apply given transformations.
		...
		Args:
		  ...
		  name: A string which will be used for debugging purposes.
	**/
	public function new(optimizer:Dynamic, transform_grads_fn:Dynamic, ?name:Dynamic):Void;
	/**
