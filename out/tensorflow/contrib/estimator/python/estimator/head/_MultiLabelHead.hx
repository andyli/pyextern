...
@:pythonImport("tensorflow.contrib.estimator.python.estimator.head", "_MultiLabelHead") extern class _MultiLabelHead {
	...
	**/
	@:native("__init__")
	public function ___init__(n_classes:Dynamic, ?weight_column:Dynamic, ?thresholds:Dynamic, ?label_vocabulary:Dynamic, ?loss_reduction:Dynamic, ?loss_fn:Dynamic, ?classes_for_class_based_metrics:Dynamic, ?name:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(n_classes:Dynamic, ?weight_column:Dynamic, ?thresholds:Dynamic, ?label_vocabulary:Dynamic, ?loss_reduction:Dynamic, ?loss_fn:Dynamic, ?classes_for_class_based_metrics:Dynamic, ?name:Dynamic):Void;
	/**
	...
	**/
	public function _eval_metric_ops(labels:Dynamic, probabilities:Dynamic, weights:Dynamic, unreduced_loss:Dynamic, regularization_loss:Dynamic):Dynamic;
	public function _process_labels(labels:Dynamic):Dynamic;
	/**
