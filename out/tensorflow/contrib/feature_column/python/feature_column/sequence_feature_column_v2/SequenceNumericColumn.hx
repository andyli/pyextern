...
package tensorflow.contrib.feature_column.python.feature_column.sequence_feature_column_v2;
@:pythonImport("tensorflow.contrib.feature_column.python.feature_column.sequence_feature_column_v2", "SequenceNumericColumn") extern class SequenceNumericColumn {
	/**
	...
	**/
	...
	/**
		Make a new SequenceNumericColumn object from a sequence or iterable
	**/
	static public function _make(iterable:Dynamic, ?_new:Dynamic, ?len:Dynamic):Dynamic;
	/**
		Return a new SequenceNumericColumn object replacing specified fields with new values
	**/
