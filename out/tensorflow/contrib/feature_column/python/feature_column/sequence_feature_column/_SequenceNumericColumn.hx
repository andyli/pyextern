...
package tensorflow.contrib.feature_column.python.feature_column.sequence_feature_column;
@:pythonImport("tensorflow.contrib.feature_column.python.feature_column.sequence_feature_column", "_SequenceNumericColumn") extern class _SequenceNumericColumn {
	/**
	...
	**/
	...
	/**
		Create new instance of _SequenceNumericColumn(key, shape, default_value, dtype, normalizer_fn)
	**/
	...
	**/
	...
	/**
		Make a new _SequenceNumericColumn object from a sequence or iterable
	**/
	...
	**/
	...
	/**
		Return a new _SequenceNumericColumn object replacing specified fields with new values
	**/
