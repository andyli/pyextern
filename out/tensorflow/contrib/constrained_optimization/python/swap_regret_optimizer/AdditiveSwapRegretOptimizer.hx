...
@:pythonImport("tensorflow.contrib.constrained_optimization.python.swap_regret_optimizer", "AdditiveSwapRegretOptimizer") extern class AdditiveSwapRegretOptimizer {
	...
	**/
	@:native("__init__")
	public function ___init__(optimizer:Dynamic, ?constraint_optimizer:Dynamic):Dynamic;
	/**
		Constructs a new `AdditiveSwapRegretOptimizer`.
		...
		Returns:
		  A new `AdditiveSwapRegretOptimizer`.
	**/
	public function new(optimizer:Dynamic, ?constraint_optimizer:Dynamic):Void;
	/**
