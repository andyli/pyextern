...
@:pythonImport("tensorflow.contrib.constrained_optimization.python.swap_regret_optimizer", "MultiplicativeSwapRegretOptimizer") extern class MultiplicativeSwapRegretOptimizer {
	...
	**/
	@:native("__init__")
	public function ___init__(optimizer:Dynamic, ?constraint_optimizer:Dynamic, ?minimum_multiplier_radius:Dynamic, ?initial_multiplier_radius:Dynamic):Dynamic;
	/**
		Constructs a new `MultiplicativeSwapRegretOptimizer`.
		...
		Raises:
		  ValueError: If the two radius parameters are inconsistent.
	**/
	public function new(optimizer:Dynamic, ?constraint_optimizer:Dynamic, ?minimum_multiplier_radius:Dynamic, ?initial_multiplier_radius:Dynamic):Void;
	/**
	...
	**/
	...
	public function _distribution(state:Dynamic):Dynamic;
	...
	**/
	...
	public function _stochastic_matrix(state:Dynamic):Dynamic;
	/**
