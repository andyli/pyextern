...
package tensorflow.contrib.constrained_optimization.python.candidates;
@:pythonImport("tensorflow.contrib.constrained_optimization.python.candidates") extern class Candidates_Module {
	...
	**/
	static public function _find_best_candidate_distribution_helper(objective_vector:Dynamic, constraints_matrix:Dynamic, ?maximum_violation:Dynamic):Dynamic;
