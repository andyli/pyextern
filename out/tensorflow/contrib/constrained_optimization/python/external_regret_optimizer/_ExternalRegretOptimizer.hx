...
@:pythonImport("tensorflow.contrib.constrained_optimization.python.external_regret_optimizer", "_ExternalRegretOptimizer") extern class _ExternalRegretOptimizer {
