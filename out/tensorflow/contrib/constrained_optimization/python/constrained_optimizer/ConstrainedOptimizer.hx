...
package tensorflow.contrib.constrained_optimization.python.constrained_optimizer;
@:pythonImport("tensorflow.contrib.constrained_optimization.python.constrained_optimizer", "ConstrainedOptimizer") extern class ConstrainedOptimizer {
	...
	**/
	@:native("__init__")
	public function ___init__(optimizer:Dynamic):Dynamic;
	/**
		Constructs a new `ConstrainedOptimizer`.
		...
		Returns:
		  A new `ConstrainedOptimizer`.
	**/
	public function new(optimizer:Dynamic):Void;
	/**
