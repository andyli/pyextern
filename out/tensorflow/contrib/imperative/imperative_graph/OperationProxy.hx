...
@:pythonImport("tensorflow.contrib.imperative.imperative_graph", "OperationProxy") extern class OperationProxy {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(real_op:Dynamic):Dynamic;
	/**
		Creates an `Operation`.
		...
		Raises:
		  ...
		  ValueError: if the `node_def` name is not valid.
	**/
	public function new(real_op:Dynamic):Void;
	/**
	...
	**/
	...
	public var _original_graph : Dynamic;
