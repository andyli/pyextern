...
@:pythonImport("tensorflow.contrib.imperative.imperative_graph", "ImperativeGraph") extern class ImperativeGraph {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(?parent_graph:Dynamic):Dynamic;
	/**
		Initializes an ImperativeGraph.
		...
		Args:
		  parent_graph: (Optional) An ImperativeGraph.
	**/
	public function new(?parent_graph:Dynamic):Void;
	/**
	...
	**/
	...
	public function _wrap(op:Dynamic):Dynamic;
	/**
		Records assign ops in `_init_ops`.
	**/
	public function add_pending_init(init_op:Dynamic):Dynamic;
	/**
	...
	**/
	public function create_op(?args:python.VarArgs<Dynamic>, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
	...
	**/
	public function is_child_graph(child_graph:Dynamic):Dynamic;
	/**
	...
	**/
	public function op_in_graph(op:Dynamic):Dynamic;
	/**
	...
	**/
	public function record_variable_inits():Dynamic;
	/**
		Replaces the outputs of `op` with values recorded in `_outputs_map`.
	**/
	public function replace_outputs(op:Dynamic):Dynamic;
	/**
		Prevents adding the extra logic during `create_op`.
	**/
	public function return_as_is():Dynamic;
	/**
		Runs the pending variable initializations using `session`.
	**/
	public function run_pending_inits(session:Dynamic):Dynamic;
	/**
