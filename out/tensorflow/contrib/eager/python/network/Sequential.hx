...
@:pythonImport("tensorflow.contrib.eager.python.network", "Sequential") extern class Sequential {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(?layers_funcs:Dynamic, ?name:Dynamic):Dynamic;
	/**
		Configure the `Network`. (deprecated)
		...
		Raises:
		  ValueError: If `name` is not valid. Note that some naming errors will
		    instead be raised when the `Network` is called.
	**/
	public function new(?layers_funcs:Dynamic, ?name:Dynamic):Void;
	/**
	...
	**/
	public function _name_scope_name(current_variable_scope:Dynamic):Dynamic;
	/**
	...
	**/
	...
	public function add(layer_func:Dynamic):Dynamic;
	/**
	...
	**/
	public function track_layer(layer:Dynamic):Dynamic;
