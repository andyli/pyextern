...
@:pythonImport("tensorflow.contrib.eager.python.examples.rnn_ptb.rnn_ptb", "Embedding") extern class Embedding {
	/**
	...
	**/
	...
	@:native("__init__")
	public function ___init__(vocab_size:Dynamic, embedding_dim:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	public function new(vocab_size:Dynamic, embedding_dim:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Void;
	/**
