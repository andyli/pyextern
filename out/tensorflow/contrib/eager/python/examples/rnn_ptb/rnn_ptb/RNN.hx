...
@:pythonImport("tensorflow.contrib.eager.python.examples.rnn_ptb.rnn_ptb", "RNN") extern class RNN {
	/**
	...
	**/
	...
	@:native("__init__")
	public function ___init__(hidden_dim:Dynamic, num_layers:Dynamic, keep_ratio:Dynamic):Dynamic;
	public function new(hidden_dim:Dynamic, num_layers:Dynamic, keep_ratio:Dynamic):Void;
	/**
