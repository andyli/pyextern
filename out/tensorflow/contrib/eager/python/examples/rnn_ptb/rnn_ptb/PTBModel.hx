...
@:pythonImport("tensorflow.contrib.eager.python.examples.rnn_ptb.rnn_ptb", "PTBModel") extern class PTBModel {
	/**
	...
	**/
	...
	@:native("__init__")
	public function ___init__(vocab_size:Dynamic, embedding_dim:Dynamic, hidden_dim:Dynamic, num_layers:Dynamic, dropout_ratio:Dynamic, ?use_cudnn_rnn:Dynamic):Dynamic;
	public function new(vocab_size:Dynamic, embedding_dim:Dynamic, hidden_dim:Dynamic, num_layers:Dynamic, dropout_ratio:Dynamic, ?use_cudnn_rnn:Dynamic):Void;
	/**
	...
	**/
	public function call(input_seq:Dynamic, training:Dynamic):Dynamic;
	/**
