...
@:pythonImport("tensorflow.contrib.eager.python.examples.gan.mnist", "Discriminator") extern class Discriminator {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(data_format:Dynamic):Dynamic;
	/**
		Creates a model for discriminating between real and generated digits.
		...
		Args:
		  data_format: Either 'channels_first' or 'channels_last'.
		    ...
		    https://www.tensorflow.org/performance/performance_guide#data_formats
	**/
	public function new(data_format:Dynamic):Void;
	/**
