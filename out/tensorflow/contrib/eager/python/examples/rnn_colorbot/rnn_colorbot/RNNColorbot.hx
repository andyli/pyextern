...
@:pythonImport("tensorflow.contrib.eager.python.examples.rnn_colorbot.rnn_colorbot", "RNNColorbot") extern class RNNColorbot {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(rnn_cell_sizes:Dynamic, label_dimension:Dynamic, keep_prob:Dynamic):Dynamic;
	/**
		Constructs an RNNColorbot.
		...
		Args:
		  ...
		  keep_prob: (1 - dropout probability); dropout is applied to the outputs of
		    each LSTM layer
	**/
	public function new(rnn_cell_sizes:Dynamic, label_dimension:Dynamic, keep_prob:Dynamic):Void;
	/**
