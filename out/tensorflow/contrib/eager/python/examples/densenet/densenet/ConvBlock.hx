...
@:pythonImport("tensorflow.contrib.eager.python.examples.densenet.densenet", "ConvBlock") extern class ConvBlock {
	/**
	...
	**/
	...
	@:native("__init__")
	public function ___init__(num_filters:Dynamic, data_format:Dynamic, bottleneck:Dynamic, ?weight_decay:Dynamic, ?dropout_rate:Dynamic):Dynamic;
	public function new(num_filters:Dynamic, data_format:Dynamic, bottleneck:Dynamic, ?weight_decay:Dynamic, ?dropout_rate:Dynamic):Void;
	/**
