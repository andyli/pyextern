...
@:pythonImport("tensorflow.contrib.eager.python.examples.densenet.densenet", "DenseBlock") extern class DenseBlock {
	/**
	...
	**/
	...
	@:native("__init__")
	public function ___init__(num_layers:Dynamic, growth_rate:Dynamic, data_format:Dynamic, bottleneck:Dynamic, ?weight_decay:Dynamic, ?dropout_rate:Dynamic):Dynamic;
	public function new(num_layers:Dynamic, growth_rate:Dynamic, data_format:Dynamic, bottleneck:Dynamic, ?weight_decay:Dynamic, ?dropout_rate:Dynamic):Void;
	/**
