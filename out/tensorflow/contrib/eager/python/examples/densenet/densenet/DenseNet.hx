...
package tensorflow.contrib.eager.python.examples.densenet.densenet;
@:pythonImport("tensorflow.contrib.eager.python.examples.densenet.densenet", "DenseNet") extern class DenseNet {
	/**
	...
	**/
	...
	@:native("__init__")
	public function ___init__(depth_of_model:Dynamic, growth_rate:Dynamic, num_of_blocks:Dynamic, output_classes:Dynamic, num_layers_in_each_block:Dynamic, data_format:Dynamic, ?bottleneck:Dynamic, ?compression:Dynamic, ?weight_decay:Dynamic, ?dropout_rate:Dynamic, ?pool_initial:Dynamic, ?include_top:Dynamic):Dynamic;
	public function new(depth_of_model:Dynamic, growth_rate:Dynamic, num_of_blocks:Dynamic, output_classes:Dynamic, num_layers_in_each_block:Dynamic, data_format:Dynamic, ?bottleneck:Dynamic, ?compression:Dynamic, ?weight_decay:Dynamic, ?dropout_rate:Dynamic, ?pool_initial:Dynamic, ?include_top:Dynamic):Void;
	/**
	...
	**/
	public function call(x:Dynamic, ?training:Dynamic):Dynamic;
	/**
