...
package tensorflow.contrib.eager.python.examples.l2hmc.neural_nets;
@:pythonImport("tensorflow.contrib.eager.python.examples.l2hmc.neural_nets", "GenericNet") extern class GenericNet {
	/**
	...
	**/
	...
	@:native("__init__")
	public function ___init__(x_dim:Dynamic, factor:Dynamic, ?n_hidden:Dynamic):Dynamic;
	public function new(x_dim:Dynamic, factor:Dynamic, ?n_hidden:Dynamic):Void;
	/**
