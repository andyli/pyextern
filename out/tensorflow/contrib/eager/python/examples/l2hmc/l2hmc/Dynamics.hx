...
@:pythonImport("tensorflow.contrib.eager.python.examples.l2hmc.l2hmc", "Dynamics") extern class Dynamics {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(x_dim:Dynamic, minus_loglikelihood_fn:Dynamic, ?n_steps:Dynamic, ?eps:Dynamic, ?np_seed:Dynamic):Dynamic;
	/**
		Initialization.
		...
		Args:
		  ...
		  np_seed: Random seed for numpy; used to control sampled masks.
	**/
	public function new(x_dim:Dynamic, minus_loglikelihood_fn:Dynamic, ?n_steps:Dynamic, ?eps:Dynamic, ?np_seed:Dynamic):Void;
	/**
	...
	**/
	public function _backward_lf(position:Dynamic, momentum:Dynamic, i:Dynamic):Dynamic;
	...
	**/
	public function _compute_accept_prob(position:Dynamic, momentum:Dynamic, position_post:Dynamic, momentum_post:Dynamic, sumlogdet:Dynamic):Dynamic;
	/**
		Construct different binary masks for different time steps.
	**/
	public function _construct_masks():Dynamic;
	/**
		Convert leapfrog step index into sinusoidal time.
	**/
	public function _construct_time():Dynamic;
	/**
	...
	**/
	public function _forward_lf(position:Dynamic, momentum:Dynamic, i:Dynamic):Dynamic;
	/**
	...
	**/
	public function _get_mask(i:Dynamic):Dynamic;
	/**
	...
	**/
	public function _get_time(i:Dynamic):Dynamic;
	...
	**/
	public function _update_momentum_backward(position:Dynamic, momentum:Dynamic, t:Dynamic):Dynamic;
	/**
		Update v in the forward leapfrog step.
	**/
	public function _update_momentum_forward(position:Dynamic, momentum:Dynamic, t:Dynamic):Dynamic;
	/**
		Update x in the backward leapfrog step. Inverting the forward update.
	**/
	public function _update_position_backward(position:Dynamic, momentum:Dynamic, t:Dynamic, mask:Dynamic, mask_inv:Dynamic):Dynamic;
	/**
		Update x in the forward leapfrog step.
	**/
	public function _update_position_forward(position:Dynamic, momentum:Dynamic, t:Dynamic, mask:Dynamic, mask_inv:Dynamic):Dynamic;
	/**
	...
	**/
	public function apply_transition(position:Dynamic):Dynamic;
	/**
	...
	**/
	public function grad_potential(position:Dynamic, ?check_numerics:Dynamic):Dynamic;
	/**
		Compute the overall Hamiltonian.
	**/
	public function hamiltonian(position:Dynamic, momentum:Dynamic):Dynamic;
	/**
	...
	**/
	public function kinetic(v:Dynamic):Dynamic;
	...
	**/
	public function transition_kernel(position:Dynamic, ?forward:Dynamic):Dynamic;
	/**
