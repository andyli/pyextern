...
@:pythonImport("tensorflow.contrib.eager.python.examples.revnet.blocks", "_BottleneckResidualInner") extern class _BottleneckResidualInner {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(filters:Dynamic, strides:Dynamic, input_shape:Dynamic, ?batch_norm_first:Dynamic, ?data_format:Dynamic, ?fused:Dynamic, ?dtype:Dynamic):Dynamic;
	/**
		Initialization.
		...
		Args:
		  ...
		  dtype: float16, float32, or float64
	**/
	public function new(filters:Dynamic, strides:Dynamic, input_shape:Dynamic, ?batch_norm_first:Dynamic, ?data_format:Dynamic, ?fused:Dynamic, ?dtype:Dynamic):Void;
	/**
