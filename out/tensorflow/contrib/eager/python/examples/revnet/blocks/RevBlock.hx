...
@:pythonImport("tensorflow.contrib.eager.python.examples.revnet.blocks", "RevBlock") extern class RevBlock {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(n_res:Dynamic, filters:Dynamic, strides:Dynamic, input_shape:Dynamic, ?batch_norm_first:Dynamic, ?data_format:Dynamic, ?bottleneck:Dynamic, ?fused:Dynamic, ?dtype:Dynamic):Dynamic;
	/**
		Initialization.
		...
		Args:
		  ...
		  dtype: float16, float32, or float64
	**/
	public function new(n_res:Dynamic, filters:Dynamic, strides:Dynamic, input_shape:Dynamic, ?batch_norm_first:Dynamic, ?data_format:Dynamic, ?bottleneck:Dynamic, ?fused:Dynamic, ?dtype:Dynamic):Void;
	/**
	...
	**/
	public function backward_grads(x:Dynamic, y:Dynamic, dy:Dynamic, ?training:Dynamic):Dynamic;
	/**
	...
	**/
	public function call(h:Dynamic, ?training:Dynamic):Dynamic;
	/**
