...
package tensorflow.contrib.eager.python.examples.revnet.blocks;
@:pythonImport("tensorflow.contrib.eager.python.examples.revnet.blocks", "_Residual") extern class _Residual {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(filters:Dynamic, strides:Dynamic, input_shape:Dynamic, ?batch_norm_first:Dynamic, ?data_format:Dynamic, ?bottleneck:Dynamic, ?fused:Dynamic, ?dtype:Dynamic):Dynamic;
	/**
		Initialization.
		...
		Args:
		  ...
		  dtype: float16, float32, or float64
	**/
	public function new(filters:Dynamic, strides:Dynamic, input_shape:Dynamic, ?batch_norm_first:Dynamic, ?data_format:Dynamic, ?bottleneck:Dynamic, ?fused:Dynamic, ?dtype:Dynamic):Void;
	/**
	...
	**/
	public function backward_grads(y:Dynamic, dy:Dynamic, ?training:Dynamic):Dynamic;
	/**
		Manually compute backward gradients given input and output grads.
	**/
	public function backward_grads_with_downsample(x:Dynamic, y:Dynamic, dy:Dynamic, ?training:Dynamic):Dynamic;
	/**
