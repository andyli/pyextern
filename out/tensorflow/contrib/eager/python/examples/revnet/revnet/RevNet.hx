...
package tensorflow.contrib.eager.python.examples.revnet.revnet;
@:pythonImport("tensorflow.contrib.eager.python.examples.revnet.revnet", "RevNet") extern class RevNet {
	/**
	...
	**/
	public function _apply_weight_decay(grads:Dynamic):Dynamic;
	/**
	...
	**/
	...
	public function _construct_intermediate_blocks():Dynamic;
	/**
	...
	**/
	...
	/**
		...
		Returns:
		  ...
		  being the loss
	**/
	public function compute_gradients(saved_hidden:Dynamic, labels:Dynamic, ?training:Dynamic, ?l2_reg:Dynamic):Dynamic;
	/**
		Compute cross entropy loss.
	**/
	public function compute_loss(logits:Dynamic, labels:Dynamic):Dynamic;
	/**
	...
	**/
	public function get_moving_stats():Dynamic;
	/**
	...
	**/
	public var moving_average_variables : Dynamic;
	...
	**/
	public function restore_moving_stats(values:Dynamic):Dynamic;
	/**
