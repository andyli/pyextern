...
package tensorflow.contrib.eager.python.examples.resnet50.resnet50;
@:pythonImport("tensorflow.contrib.eager.python.examples.resnet50.resnet50", "_ConvBlock") extern class _ConvBlock {
	/**
	...
	**/
	...
	@:native("__init__")
	public function ___init__(kernel_size:Dynamic, filters:Dynamic, stage:Dynamic, block:Dynamic, data_format:Dynamic, ?strides:Dynamic):Dynamic;
	public function new(kernel_size:Dynamic, filters:Dynamic, stage:Dynamic, block:Dynamic, data_format:Dynamic, ?strides:Dynamic):Void;
	/**
	...
	**/
	public function call(input_tensor:Dynamic, ?training:Dynamic):Dynamic;
	/**
