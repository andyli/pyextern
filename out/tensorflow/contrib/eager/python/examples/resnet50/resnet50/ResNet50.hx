...
@:pythonImport("tensorflow.contrib.eager.python.examples.resnet50.resnet50", "ResNet50") extern class ResNet50 {
	/**
	...
	**/
	...
	@:native("__init__")
	public function ___init__(data_format:Dynamic, ?name:Dynamic, ?trainable:Dynamic, ?include_top:Dynamic, ?pooling:Dynamic, ?classes:Dynamic):Dynamic;
	public function new(data_format:Dynamic, ?name:Dynamic, ?trainable:Dynamic, ?include_top:Dynamic, ?pooling:Dynamic, ?classes:Dynamic):Void;
	/**
