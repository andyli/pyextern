...
@:pythonImport("tensorflow.contrib.eager.python.examples.resnet50.resnet50", "_IdentityBlock") extern class _IdentityBlock {
	/**
	...
	**/
	...
	@:native("__init__")
	public function ___init__(kernel_size:Dynamic, filters:Dynamic, stage:Dynamic, block:Dynamic, data_format:Dynamic):Dynamic;
	public function new(kernel_size:Dynamic, filters:Dynamic, stage:Dynamic, block:Dynamic, data_format:Dynamic):Void;
	/**
