...
@:pythonImport("tensorflow.contrib.eager.python.metrics_impl", "Mean") extern class Mean {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(?name:Dynamic, ?dtype:Dynamic, ?use_global_variables:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(?name:Dynamic, ?dtype:Dynamic, ?use_global_variables:Dynamic):Void;
	/**
	...
	**/
	public function call(values:Dynamic, ?weights:Dynamic):Dynamic;
	/**
