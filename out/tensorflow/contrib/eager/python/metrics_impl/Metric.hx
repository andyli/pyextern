...
@:pythonImport("tensorflow.contrib.eager.python.metrics_impl", "Metric") extern class Metric {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(?name:Dynamic, ?use_global_variables:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(?name:Dynamic, ?use_global_variables:Dynamic):Void;
	/**
