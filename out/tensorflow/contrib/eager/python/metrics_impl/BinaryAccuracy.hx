...
@:pythonImport("tensorflow.contrib.eager.python.metrics_impl", "BinaryAccuracy") extern class BinaryAccuracy {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(threshold:Dynamic, ?name:Dynamic, ?dtype:Dynamic):Dynamic;
	/**
		Inits BinaryAccuracy with name, threshold and dtype.
	**/
	public function new(threshold:Dynamic, ?name:Dynamic, ?dtype:Dynamic):Void;
	/**
