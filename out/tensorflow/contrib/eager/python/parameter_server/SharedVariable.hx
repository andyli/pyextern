...
@:pythonImport("tensorflow.contrib.eager.python.parameter_server", "SharedVariable") extern class SharedVariable {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(?initial_value:Dynamic, ?trainable:Dynamic, ?name:Dynamic, ?dtype:Dynamic, ?constraint:Dynamic, ?initialize:Dynamic, ?unused_kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
		Creates a variable.
		...
		Raises:
		  ValueError: If the initial value is not specified, or does not have a
		    shape and `validate_shape` is `True`.
	**/
	public function new(?initial_value:Dynamic, ?trainable:Dynamic, ?name:Dynamic, ?dtype:Dynamic, ?constraint:Dynamic, ?initialize:Dynamic, ?unused_kwargs:python.KwArgs<Dynamic>):Void;
	/**
