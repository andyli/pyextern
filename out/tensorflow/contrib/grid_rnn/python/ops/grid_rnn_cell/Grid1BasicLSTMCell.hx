...
@:pythonImport("tensorflow.contrib.grid_rnn.python.ops.grid_rnn_cell", "Grid1BasicLSTMCell") extern class Grid1BasicLSTMCell {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(num_units:Dynamic, ?forget_bias:Dynamic, ?state_is_tuple:Dynamic, ?output_is_tuple:Dynamic):Dynamic;
	/**
		Initialize the parameters of a Grid RNN cell
		...
		Raises:
		  TypeError: if cell_fn does not return an RNNCell instance.
	**/
	public function new(num_units:Dynamic, ?forget_bias:Dynamic, ?state_is_tuple:Dynamic, ?output_is_tuple:Dynamic):Void;
	/**
