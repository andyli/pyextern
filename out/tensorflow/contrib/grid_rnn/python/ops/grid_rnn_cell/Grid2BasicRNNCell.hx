...
@:pythonImport("tensorflow.contrib.grid_rnn.python.ops.grid_rnn_cell", "Grid2BasicRNNCell") extern class Grid2BasicRNNCell {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(num_units:Dynamic, ?tied:Dynamic, ?non_recurrent_fn:Dynamic, ?state_is_tuple:Dynamic, ?output_is_tuple:Dynamic):Dynamic;
	/**
		Initialize the parameters of a Grid RNN cell
		...
		Raises:
		  TypeError: if cell_fn does not return an RNNCell instance.
	**/
	public function new(num_units:Dynamic, ?tied:Dynamic, ?non_recurrent_fn:Dynamic, ?state_is_tuple:Dynamic, ?output_is_tuple:Dynamic):Void;
	/**
