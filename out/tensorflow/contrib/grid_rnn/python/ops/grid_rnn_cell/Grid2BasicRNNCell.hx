...
@:pythonImport("tensorflow.contrib.grid_rnn.python.ops.grid_rnn_cell", "Grid2BasicRNNCell") extern class Grid2BasicRNNCell {
	...
	**/
	@:native("__init__")
	public function ___init__(num_units:Dynamic, ?tied:Dynamic, ?non_recurrent_fn:Dynamic):Dynamic;
	/**
		Initialize the parameters of a Grid RNN cell
		...
		Args:
		  ...
		  non_recurrent_fn: a tensorflow Op that will be the transfer function of the non-recurrent dimensions
	**/
	public function new(num_units:Dynamic, ?tied:Dynamic, ?non_recurrent_fn:Dynamic):Void;
	/**
		Return self<=value.
	**/
