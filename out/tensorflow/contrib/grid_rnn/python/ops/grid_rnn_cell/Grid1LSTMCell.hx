...
@:pythonImport("tensorflow.contrib.grid_rnn.python.ops.grid_rnn_cell", "Grid1LSTMCell") extern class Grid1LSTMCell {
	...
	**/
	@:native("__init__")
	public function ___init__(num_units:Dynamic, ?use_peepholes:Dynamic, ?forget_bias:Dynamic):Dynamic;
	/**
		Initialize the parameters of a Grid RNN cell
		...
		Args:
		  ...
		  non_recurrent_fn: a tensorflow Op that will be the transfer function of the non-recurrent dimensions
	**/
	public function new(num_units:Dynamic, ?use_peepholes:Dynamic, ?forget_bias:Dynamic):Void;
	/**
		Return self<=value.
	**/
