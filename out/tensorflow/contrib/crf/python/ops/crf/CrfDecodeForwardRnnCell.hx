...
@:pythonImport("tensorflow.contrib.crf.python.ops.crf", "CrfDecodeForwardRnnCell") extern class CrfDecodeForwardRnnCell {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(transition_params:Dynamic):Dynamic;
	/**
		Initialize the CrfDecodeForwardRnnCell.
		...
		Args:
		  transition_params: A [num_tags, num_tags] matrix of binary
		    ...
		    summation occurring within the cell.
	**/
	public function new(transition_params:Dynamic):Void;
	/**
