...
@:pythonImport("tensorflow.contrib.crf.python.ops.crf", "CrfDecodeBackwardRnnCell") extern class CrfDecodeBackwardRnnCell {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(num_tags:Dynamic):Dynamic;
	/**
		Initialize the CrfDecodeBackwardRnnCell.
		...
		Args:
		  num_tags: An integer. The number of tags.
	**/
	public function new(num_tags:Dynamic):Void;
	/**
