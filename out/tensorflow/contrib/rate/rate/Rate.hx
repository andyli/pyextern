...
package tensorflow.contrib.rate.rate;
@:pythonImport("tensorflow.contrib.rate.rate", "Rate") extern class Rate {
	/**
	...
	**/
	public function build(values:Dynamic, denominator:Dynamic):Dynamic;
	/**
	...
	**/
	public function call(values:Dynamic, denominator:Dynamic):Dynamic;
