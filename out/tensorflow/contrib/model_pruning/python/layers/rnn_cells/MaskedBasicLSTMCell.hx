...
@:pythonImport("tensorflow.contrib.model_pruning.python.layers.rnn_cells", "MaskedBasicLSTMCell") extern class MaskedBasicLSTMCell {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(num_units:Dynamic, ?forget_bias:Dynamic, ?state_is_tuple:Dynamic, ?activation:Dynamic, ?reuse:Dynamic, ?name:Dynamic):Dynamic;
	/**
		Initialize the basic LSTM cell with pruning.
		...
		Args:
		  ...
		  CudnnCompatibleLSTMCell instead.
	**/
	public function new(num_units:Dynamic, ?forget_bias:Dynamic, ?state_is_tuple:Dynamic, ?activation:Dynamic, ?reuse:Dynamic, ?name:Dynamic):Void;
	/**
