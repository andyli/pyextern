...
package tensorflow.contrib.model_pruning.python.layers.rnn_cells;
@:pythonImport("tensorflow.contrib.model_pruning.python.layers.rnn_cells", "MaskedLSTMCell") extern class MaskedLSTMCell {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(num_units:Dynamic, ?use_peepholes:Dynamic, ?cell_clip:Dynamic, ?initializer:Dynamic, ?num_proj:Dynamic, ?proj_clip:Dynamic, ?num_unit_shards:Dynamic, ?num_proj_shards:Dynamic, ?forget_bias:Dynamic, ?state_is_tuple:Dynamic, ?activation:Dynamic, ?reuse:Dynamic):Dynamic;
	/**
		Initialize the parameters for an LSTM cell with masks for pruning.
		...
		Args:
		  ...
		  CudnnCompatibleLSTMCell instead.
	**/
	public function new(num_units:Dynamic, ?use_peepholes:Dynamic, ?cell_clip:Dynamic, ?initializer:Dynamic, ?num_proj:Dynamic, ?proj_clip:Dynamic, ?num_unit_shards:Dynamic, ?num_proj_shards:Dynamic, ?forget_bias:Dynamic, ?state_is_tuple:Dynamic, ?activation:Dynamic, ?reuse:Dynamic):Void;
	/**
