...
@:pythonImport("tensorflow.contrib.specs.python.specs_lib", "Composition") extern class Composition {
	...
	**/
	@:native("__init__")
	public function ___init__(f:Dynamic, g:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(f:Dynamic, g:Dynamic):Void;
	/**
