...
@:pythonImport("tensorflow.contrib.specs.python.specs_lib", "Operator") extern class Operator {
	...
	**/
	@:native("__init__")
	public function ___init__(op:Dynamic, ?args:python.VarArgs<Dynamic>):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(op:Dynamic, ?args:python.VarArgs<Dynamic>):Void;
	/**
