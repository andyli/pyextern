...
@:pythonImport("tensorflow.contrib.specs.python.specs_ops", "Conc") extern class Conc {
	...
	**/
	@:native("__init__")
	public function ___init__(dim:Dynamic, ?args:python.VarArgs<Dynamic>):Dynamic;
	/**
		Concatenates tensors along the given dimension.
		...
		Args:
		    ...
		    *args: argument tensor functions to be concatenated
	**/
	public function new(dim:Dynamic, ?args:python.VarArgs<Dynamic>):Void;
	/**
