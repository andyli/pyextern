...
package tensorflow.contrib.labeled_tensor.python.ops.sugar;
@:pythonImport("tensorflow.contrib.labeled_tensor.python.ops.sugar", "ReshapeCoder") extern class ReshapeCoder {
	...
	**/
	@:native("__init__")
	public function ___init__(existing_axis_names:Dynamic, new_axes:Dynamic, ?name:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(existing_axis_names:Dynamic, new_axes:Dynamic, ?name:Dynamic):Void;
	/**
	...
	**/
	public function decode(labeled_tensor:Dynamic):Dynamic;
	/**
	...
	**/
	public function encode(labeled_tensor:Dynamic):Dynamic;
}