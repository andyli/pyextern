...
@:pythonImport("tensorflow.contrib.slim.python.slim.nets.resnet_utils", "Block") extern class Block {
	/**
		Return self+value.
	**/
	...
	**/
	...
	/**
		Create new instance of Block(scope, unit_fn, args)
	**/
	static public function __new__(_cls:Dynamic, scope:Dynamic, unit_fn:Dynamic, args:Dynamic):Dynamic;
	/**
		helper for pickle
	**/
	...
	**/
	...
	/**
		Make a new Block object from a sequence or iterable
	**/
	static public function _make(iterable:Dynamic, ?_new:Dynamic, ?len:Dynamic):Dynamic;
	/**
		Return a new Block object replacing specified fields with new values
	**/
