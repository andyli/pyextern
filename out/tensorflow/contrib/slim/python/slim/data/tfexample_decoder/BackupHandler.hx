...
@:pythonImport("tensorflow.contrib.slim.python.slim.data.tfexample_decoder", "BackupHandler") extern class BackupHandler {
	...
	**/
	@:native("__init__")
	public function ___init__(handler:Dynamic, backup:Dynamic):Dynamic;
	/**
		Initializes the BackupHandler handler.
		...
		Raises:
		  ValueError: if either is not an ItemHandler.
	**/
	public function new(handler:Dynamic, backup:Dynamic):Void;
	/**
