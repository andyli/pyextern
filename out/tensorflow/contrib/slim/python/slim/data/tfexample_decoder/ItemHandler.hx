...
@:pythonImport("tensorflow.contrib.slim.python.slim.data.tfexample_decoder", "ItemHandler") extern class ItemHandler {
	...
	**/
	@:native("__init__")
	public function ___init__(keys:Dynamic):Dynamic;
	/**
		Constructs the handler with the name of the tf.Feature keys to use.
		...
		Args:
		  keys: the name of the TensorFlow Example Feature.
	**/
	public function new(keys:Dynamic):Void;
	/**
