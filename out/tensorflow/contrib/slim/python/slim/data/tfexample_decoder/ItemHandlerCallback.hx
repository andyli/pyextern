...
@:pythonImport("tensorflow.contrib.slim.python.slim.data.tfexample_decoder", "ItemHandlerCallback") extern class ItemHandlerCallback {
	...
	**/
	@:native("__init__")
	public function ___init__(keys:Dynamic, func:Dynamic):Dynamic;
	/**
		Initializes the ItemHandler.
