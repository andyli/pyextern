...
package tensorflow.contrib.slim.python.slim.data.data_decoder;
@:pythonImport("tensorflow.contrib.slim.python.slim.data.data_decoder", "DataDecoder") extern class DataDecoder {
	...
	**/
	public function decode(data:Dynamic, items:Dynamic):Dynamic;
	/**
