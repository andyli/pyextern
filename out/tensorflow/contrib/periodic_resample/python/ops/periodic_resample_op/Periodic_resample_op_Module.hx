...
package tensorflow.contrib.periodic_resample.python.ops.periodic_resample_op;
@:pythonImport("tensorflow.contrib.periodic_resample.python.ops.periodic_resample_op") extern class Periodic_resample_op_Module {
	...
	static public function _periodic_resample_grad_cc(op:Dynamic, grad:Dynamic):Dynamic;
