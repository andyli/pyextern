...
@:pythonImport("tensorflow.contrib.bigtable.python.ops.bigtable_api", "_BigtableSampleKeysDataset") extern class _BigtableSampleKeysDataset {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(table:Dynamic):Dynamic;
	/**
		Constructs a _BigtableKeyDataset.
		...
		Args:
		  table: a Bigtable class.
	**/
	public function new(table:Dynamic):Void;
	/**
