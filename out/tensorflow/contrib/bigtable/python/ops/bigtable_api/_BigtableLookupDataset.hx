...
@:pythonImport("tensorflow.contrib.bigtable.python.ops.bigtable_api", "_BigtableLookupDataset") extern class _BigtableLookupDataset {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(dataset:Dynamic, table:Dynamic, normalized:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(dataset:Dynamic, table:Dynamic, normalized:Dynamic):Void;
	/**
