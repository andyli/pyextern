...
@:pythonImport("tensorflow.contrib.bigtable.python.ops.bigtable_api", "_BigtablePrefixKeyDataset") extern class _BigtablePrefixKeyDataset {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(table:Dynamic, prefix:Dynamic):Dynamic;
	/**
		Constructs a _BigtableKeyDataset.
		...
		Args:
		  table: a Bigtable class.
	**/
	public function new(table:Dynamic, prefix:Dynamic):Void;
	/**
