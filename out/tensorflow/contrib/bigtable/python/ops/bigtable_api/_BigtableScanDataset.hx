...
@:pythonImport("tensorflow.contrib.bigtable.python.ops.bigtable_api", "_BigtableScanDataset") extern class _BigtableScanDataset {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(table:Dynamic, prefix:Dynamic, start:Dynamic, end:Dynamic, normalized:Dynamic, probability:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(table:Dynamic, prefix:Dynamic, start:Dynamic, end:Dynamic, normalized:Dynamic, probability:Dynamic):Void;
	/**
