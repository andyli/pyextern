...
@:pythonImport("tensorflow.contrib.bigtable.python.ops.bigtable_api", "_BigtableRangeKeyDataset") extern class _BigtableRangeKeyDataset {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(table:Dynamic, start:Dynamic, end:Dynamic):Dynamic;
	/**
		Constructs a _BigtableKeyDataset.
		...
		Args:
		  table: a Bigtable class.
	**/
	public function new(table:Dynamic, start:Dynamic, end:Dynamic):Void;
	/**
