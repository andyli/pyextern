...
package tensorflow.contrib.kafka.python.ops.kafka_dataset_ops;
@:pythonImport("tensorflow.contrib.kafka.python.ops.kafka_dataset_ops", "KafkaDataset") extern class KafkaDataset {
	/**
	...
	**/
	...
	/**
		Create a KafkaReader. (deprecated)
		
		Warning: THIS FUNCTION IS DEPRECATED. It will be removed in a future version.
		Instructions for updating:
		tf.contrib.kafka will be removed in 2.0, the support for Apache Kafka will continue to be provided through the tensorflow/io GitHub project.
	...
	**/
	@:native("__init__")
	public function ___init__(topics:Dynamic, ?servers:Dynamic, ?group:Dynamic, ?eof:Dynamic, ?timeout:Dynamic):Dynamic;
	/**
		Create a KafkaReader. (deprecated)
		...
		Args:
		  ...
		  timeout: The timeout value for the Kafka Consumer to wait
		           (in millisecond).
	**/
	public function new(topics:Dynamic, ?servers:Dynamic, ?group:Dynamic, ?eof:Dynamic, ?timeout:Dynamic):Void;
	/**
