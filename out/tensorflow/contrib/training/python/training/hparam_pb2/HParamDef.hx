...
@:pythonImport("tensorflow.contrib.training.python.training.hparam_pb2", "HParamDef") extern class HParamDef {
	/**
		A ProtocolMessage
	**/
	...
	**/
	...
	/**
		Field tensorflow.HParamDef.hparam
	**/
	public var hparam : Dynamic;
}