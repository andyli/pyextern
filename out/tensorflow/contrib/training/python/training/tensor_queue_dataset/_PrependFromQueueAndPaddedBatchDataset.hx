...
@:pythonImport("tensorflow.contrib.training.python.training.tensor_queue_dataset", "_PrependFromQueueAndPaddedBatchDataset") extern class _PrependFromQueueAndPaddedBatchDataset {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(input_dataset:Dynamic, batch_size:Dynamic, padded_shapes:Dynamic, padding_values:Dynamic):Dynamic;
	/**
		Initialize `PrependFromQueueAndPaddedBatchDataset`.
	**/
	public function new(input_dataset:Dynamic, batch_size:Dynamic, padded_shapes:Dynamic, padding_values:Dynamic):Void;
	/**
	...
	**/
	...
	public function _as_batch_shape(shape_like:Dynamic):Dynamic;
	/**
