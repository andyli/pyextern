...
@:pythonImport("tensorflow.contrib.training.python.training.device_setter", "GreedyLoadBalancingStrategy") extern class GreedyLoadBalancingStrategy {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(num_tasks:Dynamic, load_fn:Dynamic):Dynamic;
	/**
		Create a new `LoadBalancingStrategy`.
		...
		Args:
		  ...
		  load_fn: A callable that takes an `Operation` and returns a
		    numeric load value for that op.
	**/
	public function new(num_tasks:Dynamic, load_fn:Dynamic):Void;
	/**
