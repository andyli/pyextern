...
@:pythonImport("tensorflow.contrib.training.python.training.evaluation", "SummaryAtEndHook") extern class SummaryAtEndHook {
	...
	**/
	@:native("__init__")
	public function ___init__(?log_dir:Dynamic, ?summary_writer:Dynamic, ?summary_op:Dynamic, ?feed_dict:Dynamic):Dynamic;
	/**
		Constructs the Summary Hook.
		...
		Raises:
		  ValueError: If both `log_dir` and `summary_writer` are `None`.
	**/
	public function new(?log_dir:Dynamic, ?summary_writer:Dynamic, ?summary_op:Dynamic, ?feed_dict:Dynamic):Void;
	/**
