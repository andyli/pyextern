...
@:pythonImport("tensorflow.contrib.linear_optimizer.python.sdca_estimator", "_SDCAEstimator") extern class _SDCAEstimator {
	...
	**/
	@:native("__init__")
	public function ___init__(example_id_column:Dynamic, feature_columns:Dynamic, ?weight_column_name:Dynamic, ?model_dir:Dynamic, ?head:Dynamic, ?l1_regularization:Dynamic, ?l2_regularization:Dynamic, ?num_loss_partitions:Dynamic, ?config:Dynamic, ?feature_engineering_fn:Dynamic):Dynamic;
	/**
		Construct a `_SDCAEstimator` estimator object.
		...
		Raises:
		  ValueError: if head is not supported by SDCA.
	**/
	public function new(example_id_column:Dynamic, feature_columns:Dynamic, ?weight_column_name:Dynamic, ?model_dir:Dynamic, ?head:Dynamic, ?l1_regularization:Dynamic, ?l2_regularization:Dynamic, ?num_loss_partitions:Dynamic, ?config:Dynamic, ?feature_engineering_fn:Dynamic):Void;
	/**
