...
@:pythonImport("tensorflow.contrib.linear_optimizer.python.sdca_estimator", "_SdcaUpdateWeightsHook") extern class _SdcaUpdateWeightsHook {
	...
	**/
	...
	public function set_parameters(sdca_model:Dynamic, train_op:Dynamic):Dynamic;
}