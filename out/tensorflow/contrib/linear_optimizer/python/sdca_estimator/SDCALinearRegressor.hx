...
@:pythonImport("tensorflow.contrib.linear_optimizer.python.sdca_estimator", "SDCALinearRegressor") extern class SDCALinearRegressor {
	/**
	...
	**/
	public function predict_scores(input_fn:Dynamic):Dynamic;
	/**
