...
package tensorflow.contrib.bayesflow.python.ops.variational_inference;
@:pythonImport("tensorflow.contrib.bayesflow.python.ops.variational_inference") extern class Variational_inference_Module {
