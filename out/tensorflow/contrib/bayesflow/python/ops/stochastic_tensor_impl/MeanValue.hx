...
@:pythonImport("tensorflow.contrib.bayesflow.python.ops.stochastic_tensor_impl", "MeanValue") extern class MeanValue {
	...
	**/
	@:native("__init__")
	public function ___init__(?stop_gradient:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(?stop_gradient:Dynamic):Void;
	/**
