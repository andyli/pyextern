...
@:pythonImport("tensorflow.contrib.bayesflow.python.ops.stochastic_tensor_impl", "BaseStochasticTensor") extern class BaseStochasticTensor {
	...
	**/
	public function loss(sample_loss:Dynamic):Dynamic;
