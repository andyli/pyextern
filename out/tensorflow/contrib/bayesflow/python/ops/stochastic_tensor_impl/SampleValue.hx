...
@:pythonImport("tensorflow.contrib.bayesflow.python.ops.stochastic_tensor_impl", "SampleValue") extern class SampleValue {
	...
	**/
	@:native("__init__")
	public function ___init__(?shape:Dynamic, ?stop_gradient:Dynamic):Dynamic;
	/**
		Sample according to shape.
		...
		Args:
		  ...
		  stop_gradient: If `True`, StochasticTensors' values are wrapped in
		    `stop_gradient`, to avoid backpropagation through.
	**/
	public function new(?shape:Dynamic, ?stop_gradient:Dynamic):Void;
	/**
