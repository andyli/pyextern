...
@:pythonImport("tensorflow.contrib.bayesflow.python.ops.stochastic_graph", "StochasticTensor") extern class StochasticTensor {
	...
	**/
	public function loss(sample_losses:Dynamic):Dynamic;
