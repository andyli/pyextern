...
@:pythonImport("tensorflow.contrib.quantization.python.nn_ops") extern class Nn_ops_Module {
	static public function _QuantizedAvgPoolShape(op:Dynamic):Dynamic;
	/**
	...
	**/
	static public function _QuantizedBiasAddShape(op:Dynamic):Dynamic;
	/**
	...
	**/
	static public function _QuantizedConv2DShape(op:Dynamic):Dynamic;
	static public function _QuantizedMaxPoolShape(op:Dynamic):Dynamic;
	static public function _QuantizedSameShape(op:Dynamic):Dynamic;
