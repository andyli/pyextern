...
package tensorflow.contrib.quantization.ops.gen_array_ops;
@:pythonImport("tensorflow.contrib.quantization.ops.gen_array_ops") extern class Gen_array_ops_Module {
	...
	static public var _dequantize_outputs : Dynamic;
