...
package tensorflow.contrib.text.python.ops.skip_gram_ops;
@:pythonImport("tensorflow.contrib.text.python.ops.skip_gram_ops") extern class Skip_gram_ops_Module {
	...
	**/
	static public function _filter_input(input_tensor:Dynamic, vocab_freq_table:Dynamic, vocab_min_count:Dynamic, vocab_subsampling:Dynamic, corpus_size:Dynamic, seed:Dynamic):Dynamic;
