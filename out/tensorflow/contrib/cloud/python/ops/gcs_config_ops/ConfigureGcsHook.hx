...
@:pythonImport("tensorflow.contrib.cloud.python.ops.gcs_config_ops", "ConfigureGcsHook") extern class ConfigureGcsHook {
	...
	**/
	@:native("__init__")
	public function ___init__(?credentials:Dynamic, ?block_cache:Dynamic):Dynamic;
	/**
		Constructs a ConfigureGcsHook.
		...
		Raises:
		  ValueError: If credentials is improperly formatted or block_cache is not a
		    BlockCacheParams.
	**/
	public function new(?credentials:Dynamic, ?block_cache:Dynamic):Void;
	/**
