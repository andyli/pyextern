...
@:pythonImport("tensorflow.contrib.keras.python.keras.optimizers", "Nadam") extern class Nadam {
	...
	**/
	@:native("__init__")
	public function ___init__(?lr:Dynamic, ?beta_1:Dynamic, ?beta_2:Dynamic, ?epsilon:Dynamic, ?schedule_decay:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(?lr:Dynamic, ?beta_1:Dynamic, ?beta_2:Dynamic, ?epsilon:Dynamic, ?schedule_decay:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Void;
	/**
