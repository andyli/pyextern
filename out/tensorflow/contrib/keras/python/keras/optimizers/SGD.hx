...
@:pythonImport("tensorflow.contrib.keras.python.keras.optimizers", "SGD") extern class SGD {
	...
	**/
	@:native("__init__")
	public function ___init__(?lr:Dynamic, ?momentum:Dynamic, ?decay:Dynamic, ?nesterov:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(?lr:Dynamic, ?momentum:Dynamic, ?decay:Dynamic, ?nesterov:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Void;
	/**
