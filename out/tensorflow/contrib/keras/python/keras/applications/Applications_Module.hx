...
package tensorflow.contrib.keras.python.keras.applications;
@:pythonImport("tensorflow.contrib.keras.python.keras.applications") extern class Applications_Module {
	/**
