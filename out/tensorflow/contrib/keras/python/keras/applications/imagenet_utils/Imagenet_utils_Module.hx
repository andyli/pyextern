...
package tensorflow.contrib.keras.python.keras.applications.imagenet_utils;
@:pythonImport("tensorflow.contrib.keras.python.keras.applications.imagenet_utils") extern class Imagenet_utils_Module {
