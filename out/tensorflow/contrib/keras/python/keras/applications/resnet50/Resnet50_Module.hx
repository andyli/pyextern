...
@:pythonImport("tensorflow.contrib.keras.python.keras.applications.resnet50") extern class Resnet50_Module {
	/**
	...
	**/
	static public function conv_block(input_tensor:Dynamic, kernel_size:Dynamic, filters:Dynamic, stage:Dynamic, block:Dynamic, ?strides:Dynamic):Dynamic;
	/**
	...
	**/
	...
	/**
		...
		Returns:
		    Output tensor for the block.
	**/
	static public function identity_block(input_tensor:Dynamic, kernel_size:Dynamic, filters:Dynamic, stage:Dynamic, block:Dynamic):Dynamic;
	/**
