...
@:pythonImport("tensorflow.contrib.keras.python.keras.callbacks", "CallbackList") extern class CallbackList {
	...
	**/
	@:native("__init__")
	public function ___init__(?callbacks:Dynamic, ?queue_length:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(?callbacks:Dynamic, ?queue_length:Dynamic):Void;
	/**
