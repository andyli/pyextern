...
@:pythonImport("tensorflow.contrib.keras.python.keras.callbacks", "CSVLogger") extern class CSVLogger {
	...
	**/
	@:native("__init__")
	public function ___init__(filename:Dynamic, ?separator:Dynamic, ?append:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(filename:Dynamic, ?separator:Dynamic, ?append:Dynamic):Void;
	/**
