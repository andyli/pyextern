...
@:pythonImport("tensorflow.contrib.keras.python.keras.callbacks", "ProgbarLogger") extern class ProgbarLogger {
	...
	**/
	@:native("__init__")
	public function ___init__(?count_mode:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(?count_mode:Dynamic):Void;
	/**
