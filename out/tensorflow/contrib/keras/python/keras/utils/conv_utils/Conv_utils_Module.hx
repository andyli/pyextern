...
package tensorflow.contrib.keras.python.keras.utils.conv_utils;
@:pythonImport("tensorflow.contrib.keras.python.keras.utils.conv_utils") extern class Conv_utils_Module {
