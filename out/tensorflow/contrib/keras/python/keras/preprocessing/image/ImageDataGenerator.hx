...
package tensorflow.contrib.keras.python.keras.preprocessing.image;
@:pythonImport("tensorflow.contrib.keras.python.keras.preprocessing.image", "ImageDataGenerator") extern class ImageDataGenerator {
	...
	**/
	@:native("__init__")
	public function ___init__(?featurewise_center:Dynamic, ?samplewise_center:Dynamic, ?featurewise_std_normalization:Dynamic, ?samplewise_std_normalization:Dynamic, ?zca_whitening:Dynamic, ?rotation_range:Dynamic, ?width_shift_range:Dynamic, ?height_shift_range:Dynamic, ?shear_range:Dynamic, ?zoom_range:Dynamic, ?channel_shift_range:Dynamic, ?fill_mode:Dynamic, ?cval:Dynamic, ?horizontal_flip:Dynamic, ?vertical_flip:Dynamic, ?rescale:Dynamic, ?preprocessing_function:Dynamic, ?data_format:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(?featurewise_center:Dynamic, ?samplewise_center:Dynamic, ?featurewise_std_normalization:Dynamic, ?samplewise_std_normalization:Dynamic, ?zca_whitening:Dynamic, ?rotation_range:Dynamic, ?width_shift_range:Dynamic, ?height_shift_range:Dynamic, ?shear_range:Dynamic, ?zoom_range:Dynamic, ?channel_shift_range:Dynamic, ?fill_mode:Dynamic, ?cval:Dynamic, ?horizontal_flip:Dynamic, ?vertical_flip:Dynamic, ?rescale:Dynamic, ?preprocessing_function:Dynamic, ?data_format:Dynamic):Void;
	/**
	...
	**/
	...
	/**
		...
		Raises:
		    ImportError: if Scipy is not available.
	**/
	public function random_transform(x:Dynamic):Dynamic;
	/**
