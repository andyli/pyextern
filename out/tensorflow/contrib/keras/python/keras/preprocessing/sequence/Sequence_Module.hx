...
package tensorflow.contrib.keras.python.keras.preprocessing.sequence;
@:pythonImport("tensorflow.contrib.keras.python.keras.preprocessing.sequence") extern class Sequence_Module {
