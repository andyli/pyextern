...
package tensorflow.contrib.keras.python.keras.layers.embeddings;
@:pythonImport("tensorflow.contrib.keras.python.keras.layers.embeddings", "Embedding") extern class Embedding {
	/**
