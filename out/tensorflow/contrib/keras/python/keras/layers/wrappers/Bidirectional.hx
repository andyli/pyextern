...
package tensorflow.contrib.keras.python.keras.layers.wrappers;
@:pythonImport("tensorflow.contrib.keras.python.keras.layers.wrappers", "Bidirectional") extern class Bidirectional {
	/**
