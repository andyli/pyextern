...
package tensorflow.contrib.keras.python.keras.layers.recurrent;
@:pythonImport("tensorflow.contrib.keras.python.keras.layers.recurrent", "LSTM") extern class LSTM {
	/**
