...
@:pythonImport("tensorflow.contrib.keras.python.keras.layers.core", "RepeatVector") extern class RepeatVector {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(n:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(n:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Void;
	/**
