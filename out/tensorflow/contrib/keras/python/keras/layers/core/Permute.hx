...
@:pythonImport("tensorflow.contrib.keras.python.keras.layers.core", "Permute") extern class Permute {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(dims:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(dims:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Void;
	/**
