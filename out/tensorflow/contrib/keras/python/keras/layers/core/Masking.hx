...
@:pythonImport("tensorflow.contrib.keras.python.keras.layers.core", "Masking") extern class Masking {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(?mask_value:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(?mask_value:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Void;
	/**
