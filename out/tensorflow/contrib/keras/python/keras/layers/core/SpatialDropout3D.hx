...
@:pythonImport("tensorflow.contrib.keras.python.keras.layers.core", "SpatialDropout3D") extern class SpatialDropout3D {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(rate:Dynamic, ?data_format:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(rate:Dynamic, ?data_format:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Void;
	/**
