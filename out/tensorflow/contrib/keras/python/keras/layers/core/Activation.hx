...
@:pythonImport("tensorflow.contrib.keras.python.keras.layers.core", "Activation") extern class Activation {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(activation:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(activation:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Void;
	/**
