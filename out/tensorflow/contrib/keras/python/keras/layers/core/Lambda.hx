...
@:pythonImport("tensorflow.contrib.keras.python.keras.layers.core", "Lambda") extern class Lambda {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(_function:Dynamic, ?mask:Dynamic, ?arguments:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(_function:Dynamic, ?mask:Dynamic, ?arguments:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Void;
	/**
