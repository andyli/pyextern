...
@:pythonImport("tensorflow.contrib.keras.python.keras.layers.convolutional", "ZeroPadding1D") extern class ZeroPadding1D {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(?padding:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(?padding:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Void;
	/**
