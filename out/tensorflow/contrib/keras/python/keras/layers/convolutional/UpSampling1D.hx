...
@:pythonImport("tensorflow.contrib.keras.python.keras.layers.convolutional", "UpSampling1D") extern class UpSampling1D {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(?size:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(?size:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Void;
	/**
