...
@:pythonImport("tensorflow.contrib.keras.python.keras.layers.convolutional", "Cropping1D") extern class Cropping1D {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(?cropping:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(?cropping:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Void;
	/**
