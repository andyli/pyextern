...
@:pythonImport("tensorflow.contrib.keras.python.keras.layers.convolutional", "ZeroPadding2D") extern class ZeroPadding2D {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(?padding:Dynamic, ?data_format:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(?padding:Dynamic, ?data_format:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Void;
	/**
