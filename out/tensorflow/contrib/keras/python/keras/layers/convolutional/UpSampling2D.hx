...
@:pythonImport("tensorflow.contrib.keras.python.keras.layers.convolutional", "UpSampling2D") extern class UpSampling2D {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(?size:Dynamic, ?data_format:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(?size:Dynamic, ?data_format:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Void;
	/**
