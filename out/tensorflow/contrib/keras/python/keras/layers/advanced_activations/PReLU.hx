...
package tensorflow.contrib.keras.python.keras.layers.advanced_activations;
@:pythonImport("tensorflow.contrib.keras.python.keras.layers.advanced_activations", "PReLU") extern class PReLU {
	/**
