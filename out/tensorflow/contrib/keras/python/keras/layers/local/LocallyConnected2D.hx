...
package tensorflow.contrib.keras.python.keras.layers.local;
@:pythonImport("tensorflow.contrib.keras.python.keras.layers.local", "LocallyConnected2D") extern class LocallyConnected2D {
	/**
