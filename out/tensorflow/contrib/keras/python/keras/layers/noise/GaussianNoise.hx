...
package tensorflow.contrib.keras.python.keras.layers.noise;
@:pythonImport("tensorflow.contrib.keras.python.keras.layers.noise", "GaussianNoise") extern class GaussianNoise {
	/**
