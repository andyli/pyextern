...
@:pythonImport("tensorflow.contrib.keras.python.keras.layers.convolutional_recurrent", "ConvRecurrent2D") extern class ConvRecurrent2D {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(filters:Dynamic, kernel_size:Dynamic, ?strides:Dynamic, ?padding:Dynamic, ?data_format:Dynamic, ?dilation_rate:Dynamic, ?return_sequences:Dynamic, ?go_backwards:Dynamic, ?stateful:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(filters:Dynamic, kernel_size:Dynamic, ?strides:Dynamic, ?padding:Dynamic, ?data_format:Dynamic, ?dilation_rate:Dynamic, ?return_sequences:Dynamic, ?go_backwards:Dynamic, ?stateful:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Void;
	/**
	...
	**/
	...
	public function reset_states(?states_value:Dynamic):Dynamic;
