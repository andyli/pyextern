...
package tensorflow.contrib.keras.python.keras.layers.convolutional_recurrent;
@:pythonImport("tensorflow.contrib.keras.python.keras.layers.convolutional_recurrent", "ConvLSTM2D") extern class ConvLSTM2D {
	/**
	...
	**/
	public function call(inputs:Dynamic, ?mask:Dynamic, ?initial_state:Dynamic, ?training:Dynamic):Dynamic;
	/**
	...
	**/
	...
	public function get_initial_states(inputs:Dynamic):Dynamic;
	/**
