...
package tensorflow.contrib.keras.python.keras.layers.normalization;
@:pythonImport("tensorflow.contrib.keras.python.keras.layers.normalization", "BatchNormalization") extern class BatchNormalization {
	/**
