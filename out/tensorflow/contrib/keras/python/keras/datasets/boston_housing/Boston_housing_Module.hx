...
package tensorflow.contrib.keras.python.keras.datasets.boston_housing;
@:pythonImport("tensorflow.contrib.keras.python.keras.datasets.boston_housing") extern class Boston_housing_Module {
