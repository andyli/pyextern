...
package tensorflow.contrib.keras.python.keras.datasets.cifar10;
@:pythonImport("tensorflow.contrib.keras.python.keras.datasets.cifar10") extern class Cifar10_Module {
