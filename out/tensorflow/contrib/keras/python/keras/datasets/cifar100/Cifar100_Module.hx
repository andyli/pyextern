...
package tensorflow.contrib.keras.python.keras.datasets.cifar100;
@:pythonImport("tensorflow.contrib.keras.python.keras.datasets.cifar100") extern class Cifar100_Module {
