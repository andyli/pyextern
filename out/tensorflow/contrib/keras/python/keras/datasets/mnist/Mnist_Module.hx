...
package tensorflow.contrib.keras.python.keras.datasets.mnist;
@:pythonImport("tensorflow.contrib.keras.python.keras.datasets.mnist") extern class Mnist_Module {
