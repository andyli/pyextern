...
package tensorflow.contrib.keras.api.keras.applications.resnet50;
@:pythonImport("tensorflow.contrib.keras.api.keras.applications.resnet50") extern class Resnet50_Module {
