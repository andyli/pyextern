...
package tensorflow.contrib.keras.api.keras.applications.mobilenet;
@:pythonImport("tensorflow.contrib.keras.api.keras.applications.mobilenet") extern class Mobilenet_Module {
