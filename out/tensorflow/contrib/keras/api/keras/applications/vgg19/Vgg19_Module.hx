...
package tensorflow.contrib.keras.api.keras.applications.vgg19;
@:pythonImport("tensorflow.contrib.keras.api.keras.applications.vgg19") extern class Vgg19_Module {
