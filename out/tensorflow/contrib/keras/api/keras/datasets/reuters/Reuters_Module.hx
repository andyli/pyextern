...
package tensorflow.contrib.keras.api.keras.datasets.reuters;
@:pythonImport("tensorflow.contrib.keras.api.keras.datasets.reuters") extern class Reuters_Module {
