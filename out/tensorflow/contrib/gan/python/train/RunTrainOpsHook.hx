...
@:pythonImport("tensorflow.contrib.gan.python.train", "RunTrainOpsHook") extern class RunTrainOpsHook {
	...
	**/
	@:native("__init__")
	public function ___init__(train_ops:Dynamic, train_steps:Dynamic):Dynamic;
	/**
		Run train ops a certain number of times.
		...
		Args:
		  ...
		  train_steps: The number of times to run the op(s).
	**/
	public function new(train_ops:Dynamic, train_steps:Dynamic):Void;
	/**
