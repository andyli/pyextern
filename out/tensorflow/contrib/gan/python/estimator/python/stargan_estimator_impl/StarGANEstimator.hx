...
@:pythonImport("tensorflow.contrib.gan.python.estimator.python.stargan_estimator_impl", "StarGANEstimator") extern class StarGANEstimator {
	...
	**/
	@:native("__init__")
	public function ___init__(?model_dir:Dynamic, ?generator_fn:Dynamic, ?discriminator_fn:Dynamic, ?loss_fn:Dynamic, ?generator_optimizer:Dynamic, ?discriminator_optimizer:Dynamic, ?get_hooks_fn:Dynamic, ?get_eval_metric_ops_fn:Dynamic, ?add_summaries:Dynamic, ?use_loss_summaries:Dynamic, ?config:Dynamic):Dynamic;
	/**
		Initializes a StarGANEstimator instance.
		...
		Raises:
		  ...
		  ValueError: If `get_hooks_fn` isn't callable or `None`.
	**/
	public function new(?model_dir:Dynamic, ?generator_fn:Dynamic, ?discriminator_fn:Dynamic, ?loss_fn:Dynamic, ?generator_optimizer:Dynamic, ?discriminator_optimizer:Dynamic, ?get_hooks_fn:Dynamic, ?get_eval_metric_ops_fn:Dynamic, ?add_summaries:Dynamic, ?use_loss_summaries:Dynamic, ?config:Dynamic):Void;
	/**
