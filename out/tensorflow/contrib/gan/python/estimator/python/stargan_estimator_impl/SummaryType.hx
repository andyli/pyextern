...
@:pythonImport("tensorflow.contrib.gan.python.estimator.python.stargan_estimator_impl", "SummaryType") extern class SummaryType {
	static public var IMAGES : Dynamic;
	static public var IMAGE_COMPARISON : Dynamic;
