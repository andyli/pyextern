...
@:pythonImport("tensorflow.contrib.gan.python.estimator.python.gan_estimator_impl", "GANEstimator") extern class GANEstimator {
	...
	**/
	@:native("__init__")
	public function ___init__(?model_dir:Dynamic, ?generator_fn:Dynamic, ?discriminator_fn:Dynamic, ?generator_loss_fn:Dynamic, ?discriminator_loss_fn:Dynamic, ?generator_optimizer:Dynamic, ?discriminator_optimizer:Dynamic, ?get_hooks_fn:Dynamic, ?get_eval_metric_ops_fn:Dynamic, ?add_summaries:Dynamic, ?use_loss_summaries:Dynamic, ?config:Dynamic):Dynamic;
	/**
		Initializes a GANEstimator instance.
		...
		Raises:
		  ...
		  ValueError: If `get_hooks_fn` isn't callable or `None`.
	**/
	public function new(?model_dir:Dynamic, ?generator_fn:Dynamic, ?discriminator_fn:Dynamic, ?generator_loss_fn:Dynamic, ?discriminator_loss_fn:Dynamic, ?generator_optimizer:Dynamic, ?discriminator_optimizer:Dynamic, ?get_hooks_fn:Dynamic, ?get_eval_metric_ops_fn:Dynamic, ?add_summaries:Dynamic, ?use_loss_summaries:Dynamic, ?config:Dynamic):Void;
	/**
