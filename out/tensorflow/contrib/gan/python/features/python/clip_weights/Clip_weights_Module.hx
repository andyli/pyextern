...
package tensorflow.contrib.gan.python.features.python.clip_weights;
@:pythonImport("tensorflow.contrib.gan.python.features.python.clip_weights") extern class Clip_weights_Module {
