...
package tensorflow.contrib.gan.python.features.python.random_tensor_pool;
@:pythonImport("tensorflow.contrib.gan.python.features.python.random_tensor_pool") extern class Random_tensor_pool_Module {
