...
package tensorflow.contrib.gan.python.features.python.conditioning_utils;
@:pythonImport("tensorflow.contrib.gan.python.features.python.conditioning_utils") extern class Conditioning_utils_Module {
