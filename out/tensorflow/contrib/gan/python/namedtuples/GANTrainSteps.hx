...
@:pythonImport("tensorflow.contrib.gan.python.namedtuples", "GANTrainSteps") extern class GANTrainSteps {
	/**
		Return self+value.
	**/
	...
	**/
	static public function __new__(_cls:Dynamic, generator_train_steps:Dynamic, discriminator_train_steps:Dynamic):Dynamic;
	/**
		helper for pickle
	**/
	...
	**/
	...
	/**
		Make a new GANTrainSteps object from a sequence or iterable
	**/
	static public function _make(iterable:Dynamic, ?_new:Dynamic, ?len:Dynamic):Dynamic;
	/**
		Return a new GANTrainSteps object replacing specified fields with new values
	**/
	...
	**/
	public var discriminator_train_steps : Dynamic;
	/**
		Alias for field number 0
	**/
	public var generator_train_steps : Dynamic;
	/**
