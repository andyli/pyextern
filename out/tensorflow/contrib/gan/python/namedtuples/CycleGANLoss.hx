...
@:pythonImport("tensorflow.contrib.gan.python.namedtuples", "CycleGANLoss") extern class CycleGANLoss {
	/**
		Return self+value.
	**/
	...
	**/
	static public function __new__(_cls:Dynamic, loss_x2y:Dynamic, loss_y2x:Dynamic):Dynamic;
	/**
		helper for pickle
	**/
	...
	**/
	...
	/**
		Make a new CycleGANLoss object from a sequence or iterable
	**/
	static public function _make(iterable:Dynamic, ?_new:Dynamic, ?len:Dynamic):Dynamic;
	/**
		Return a new CycleGANLoss object replacing specified fields with new values
	**/
	...
	**/
	public var loss_x2y : Dynamic;
	/**
		Alias for field number 1
	**/
	public var loss_y2x : Dynamic;
}