...
@:pythonImport("tensorflow.contrib.gan.python.namedtuples", "GANModel") extern class GANModel {
	/**
		Return self+value.
	**/
	...
	**/
	...
	/**
		Make a new GANModel object from a sequence or iterable
	**/
	static public function _make(iterable:Dynamic, ?_new:Dynamic, ?len:Dynamic):Dynamic;
	/**
		Return a new GANModel object replacing specified fields with new values
	**/
