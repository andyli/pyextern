...
@:pythonImport("tensorflow.contrib.gan.python.namedtuples", "GANTrainOps") extern class GANTrainOps {
	/**
		Return self+value.
	**/
	...
	**/
	...
	/**
		Make a new GANTrainOps object from a sequence or iterable
	**/
	static public function _make(iterable:Dynamic, ?_new:Dynamic, ?len:Dynamic):Dynamic;
	/**
		Return a new GANTrainOps object replacing specified fields with new values
	**/
	...
	**/
	public var discriminator_train_op : Dynamic;
	/**
		Alias for field number 0
	**/
	public var generator_train_op : Dynamic;
	/**
		Alias for field number 2
	**/
	public var global_step_inc_op : Dynamic;
	/**
