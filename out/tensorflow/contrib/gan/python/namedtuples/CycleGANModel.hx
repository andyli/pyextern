...
@:pythonImport("tensorflow.contrib.gan.python.namedtuples", "CycleGANModel") extern class CycleGANModel {
	/**
		Return self+value.
	**/
	...
	**/
	static public function __new__(_cls:Dynamic, model_x2y:Dynamic, model_y2x:Dynamic, reconstructed_x:Dynamic, reconstructed_y:Dynamic):Dynamic;
	/**
		helper for pickle
	**/
	...
	**/
	...
	/**
		Make a new CycleGANModel object from a sequence or iterable
	**/
	static public function _make(iterable:Dynamic, ?_new:Dynamic, ?len:Dynamic):Dynamic;
	/**
		Return a new CycleGANModel object replacing specified fields with new values
	**/
	...
	**/
	public var model_x2y : Dynamic;
	/**
		Alias for field number 1
	**/
	public var model_y2x : Dynamic;
	/**
		Alias for field number 2
	**/
	public var reconstructed_x : Dynamic;
	/**
		Alias for field number 3
	**/
	public var reconstructed_y : Dynamic;
}