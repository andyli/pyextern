...
@:pythonImport("tensorflow.contrib.gan.python.namedtuples", "GANLoss") extern class GANLoss {
	/**
		Return self+value.
	**/
	...
	**/
	static public function __new__(_cls:Dynamic, generator_loss:Dynamic, discriminator_loss:Dynamic):Dynamic;
	/**
		helper for pickle
	**/
	...
	**/
	...
	/**
		Make a new GANLoss object from a sequence or iterable
	**/
	static public function _make(iterable:Dynamic, ?_new:Dynamic, ?len:Dynamic):Dynamic;
	/**
		Return a new GANLoss object replacing specified fields with new values
	**/
	...
	**/
	public var discriminator_loss : Dynamic;
	/**
		Alias for field number 0
	**/
	public var generator_loss : Dynamic;
	/**
