...
@:pythonImport("tensorflow.contrib.gan.python.namedtuples", "InfoGANModel") extern class InfoGANModel {
	/**
		Return self+value.
	**/
	...
	**/
	...
	/**
		Make a new InfoGANModel object from a sequence or iterable
	**/
	static public function _make(iterable:Dynamic, ?_new:Dynamic, ?len:Dynamic):Dynamic;
	/**
		Return a new InfoGANModel object replacing specified fields with new values
	**/
	...
	**/
	public var discriminator_and_aux_fn : Dynamic;
	/**
	...
	**/
	public var predicted_distributions : Dynamic;
	/**
	...
	**/
	public var structured_generator_inputs : Dynamic;
}