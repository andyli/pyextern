...
package tensorflow.contrib.gan.python.eval.python.eval_utils_impl;
@:pythonImport("tensorflow.contrib.gan.python.eval.python.eval_utils_impl") extern class Eval_utils_impl_Module {
	...
	static public function _validate_images(images:Dynamic):Dynamic;
