...
package tensorflow.contrib.gan.python.eval.python.summaries_impl;
@:pythonImport("tensorflow.contrib.gan.python.eval.python.summaries_impl") extern class Summaries_impl_Module {
	...
	static public function _assert_is_image(data:Dynamic):Dynamic;
