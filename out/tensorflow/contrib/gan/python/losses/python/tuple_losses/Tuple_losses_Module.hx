...
package tensorflow.contrib.gan.python.losses.python.tuple_losses;
@:pythonImport("tensorflow.contrib.gan.python.losses.python.tuple_losses") extern class Tuple_losses_Module {
