...
package tensorflow.contrib.predictor.contrib_estimator_predictor;
@:pythonImport("tensorflow.contrib.predictor.contrib_estimator_predictor", "ContribEstimatorPredictor") extern class ContribEstimatorPredictor {
	...
	**/
	@:native("__init__")
	public function ___init__(estimator:Dynamic, prediction_input_fn:Dynamic, ?input_alternative_key:Dynamic, ?output_alternative_key:Dynamic, ?graph:Dynamic, ?config:Dynamic):Dynamic;
	/**
		Initialize a `ContribEstimatorPredictor`.
		...
		Args:
		  ...
		  config: `ConfigProto` proto used to configure the session.
	**/
	public function new(estimator:Dynamic, prediction_input_fn:Dynamic, ?input_alternative_key:Dynamic, ?output_alternative_key:Dynamic, ?graph:Dynamic, ?config:Dynamic):Void;
	/**
