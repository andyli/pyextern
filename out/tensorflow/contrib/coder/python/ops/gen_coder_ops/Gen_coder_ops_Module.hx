...
package tensorflow.contrib.coder.python.ops.gen_coder_ops;
@:pythonImport("tensorflow.contrib.coder.python.ops.gen_coder_ops") extern class Gen_coder_ops_Module {
