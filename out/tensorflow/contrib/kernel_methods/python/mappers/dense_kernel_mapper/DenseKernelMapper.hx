...
package tensorflow.contrib.kernel_methods.python.mappers.dense_kernel_mapper;
@:pythonImport("tensorflow.contrib.kernel_methods.python.mappers.dense_kernel_mapper", "DenseKernelMapper") extern class DenseKernelMapper {
