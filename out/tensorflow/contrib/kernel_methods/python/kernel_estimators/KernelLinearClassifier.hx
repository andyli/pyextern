...
@:pythonImport("tensorflow.contrib.kernel_methods.python.kernel_estimators", "KernelLinearClassifier") extern class KernelLinearClassifier {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(?feature_columns:Dynamic, ?model_dir:Dynamic, ?n_classes:Dynamic, ?weight_column_name:Dynamic, ?optimizer:Dynamic, ?kernel_mappers:Dynamic, ?config:Dynamic):Dynamic;
	/**
		Construct a `KernelLinearClassifier` estimator object.
		...
		Raises:
		  ...
		  ValueError: if mappers provided as kernel_mappers values are invalid.
	**/
	public function new(?feature_columns:Dynamic, ?model_dir:Dynamic, ?n_classes:Dynamic, ?weight_column_name:Dynamic, ?optimizer:Dynamic, ?kernel_mappers:Dynamic, ?config:Dynamic):Void;
	/**
