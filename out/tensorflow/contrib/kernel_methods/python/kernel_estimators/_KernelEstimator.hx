...
@:pythonImport("tensorflow.contrib.kernel_methods.python.kernel_estimators", "_KernelEstimator") extern class _KernelEstimator {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(?feature_columns:Dynamic, ?model_dir:Dynamic, ?weight_column_name:Dynamic, ?head:Dynamic, ?optimizer:Dynamic, ?kernel_mappers:Dynamic, ?config:Dynamic):Dynamic;
	/**
		Constructs a `_KernelEstimator` object.
	**/
	public function new(?feature_columns:Dynamic, ?model_dir:Dynamic, ?weight_column_name:Dynamic, ?head:Dynamic, ?optimizer:Dynamic, ?kernel_mappers:Dynamic, ?config:Dynamic):Void;
	/**
