...
@:pythonImport("tensorflow.contrib.tensorboard.graph_explorer.proto.graph_explorer_pb2", "Edge") extern class Edge {
	/**
	...
	**/
	...
	static public var SOURCE_FIELD_NUMBER : Dynamic;
	/**
