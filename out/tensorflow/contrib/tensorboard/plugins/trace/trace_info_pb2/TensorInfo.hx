...
@:pythonImport("tensorflow.contrib.tensorboard.plugins.trace.trace_info_pb2", "TensorInfo") extern class TensorInfo {
	/**
		Returns the size of the message in bytes.
	**/
	public function ByteSize(args:haxe.extern.Rest<Dynamic>):Dynamic;
	static public var CONSUMERS_FIELD_NUMBER : Dynamic;
	/**
		Clears the message.
	**/
	...
	**/
	...
	static public var NUM_BYTES_PER_ELEM_FIELD_NUMBER : Dynamic;
	/**
