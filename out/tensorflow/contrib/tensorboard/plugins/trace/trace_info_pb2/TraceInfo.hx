...
@:pythonImport("tensorflow.contrib.tensorboard.plugins.trace.trace_info_pb2", "TraceInfo") extern class TraceInfo {
	/**
	...
	**/
	...
	static public var FILES_FIELD_NUMBER : Dynamic;
	/**
	...
	**/
	...
	static public var OPS_FIELD_NUMBER : Dynamic;
	/**
