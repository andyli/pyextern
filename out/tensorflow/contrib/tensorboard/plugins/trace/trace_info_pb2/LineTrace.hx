...
@:pythonImport("tensorflow.contrib.tensorboard.plugins.trace.trace_info_pb2", "LineTrace") extern class LineTrace {
	/**
	...
	**/
	...
	static public var LINE_NUMBER_FIELD_NUMBER : Dynamic;
	/**
