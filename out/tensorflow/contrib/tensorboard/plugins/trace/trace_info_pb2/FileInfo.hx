...
package tensorflow.contrib.tensorboard.plugins.trace.trace_info_pb2;
@:pythonImport("tensorflow.contrib.tensorboard.plugins.trace.trace_info_pb2", "FileInfo") extern class FileInfo {
	/**
	...
	**/
	...
	static public var FILE_PATH_FIELD_NUMBER : Dynamic;
	/**
	...
	**/
	...
	static public var MULTILINE_STATEMENTS_FIELD_NUMBER : Dynamic;
	/**
	...
	**/
	...
	/**
		A ProtocolMessage
	**/
	static public function MultilineStatementsEntry(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	...
	static public var SOURCE_CODE_FIELD_NUMBER : Dynamic;
	/**
