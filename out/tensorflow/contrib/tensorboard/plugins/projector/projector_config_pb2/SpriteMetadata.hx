...
@:pythonImport("tensorflow.contrib.tensorboard.plugins.projector.projector_config_pb2", "SpriteMetadata") extern class SpriteMetadata {
	/**
	...
	**/
	...
	/**
		Field tensorflow.SpriteMetadata.image_path
	**/
	public var image_path : Dynamic;
	/**
		Field tensorflow.SpriteMetadata.single_image_dim
	**/
