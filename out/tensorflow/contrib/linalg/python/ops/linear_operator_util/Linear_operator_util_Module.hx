...
package tensorflow.contrib.linalg.python.ops.linear_operator_util;
@:pythonImport("tensorflow.contrib.linalg.python.ops.linear_operator_util") extern class Linear_operator_util_Module {
	...
	/**
		...
		Returns:
		  `Assert` `Op`.
	**/
	static public function assert_compatible_matrix_dimensions(operator:Dynamic, x:Dynamic):Dynamic;
	/**
	...
	**/
	static public function matrix_adjoint(a:Dynamic, ?name:Dynamic):Dynamic;
