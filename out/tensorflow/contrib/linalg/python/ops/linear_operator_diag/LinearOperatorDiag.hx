...
package tensorflow.contrib.linalg.python.ops.linear_operator_diag;
@:pythonImport("tensorflow.contrib.linalg.python.ops.linear_operator_diag", "LinearOperatorDiag") extern class LinearOperatorDiag {
	...
	**/
	@:native("__init__")
	public function ___init__(diag:Dynamic, ?is_non_singular:Dynamic, ?is_self_adjoint:Dynamic, ?is_positive_definite:Dynamic, ?is_square:Dynamic, ?name:Dynamic):Dynamic;
	/**
		Initialize a `LinearOperatorDiag`.
		...
		Raises:
		  ...
		  ValueError:  If `diag.dtype` is real, and `is_self_adjoint` is not `True`.
	**/
	public function new(diag:Dynamic, ?is_non_singular:Dynamic, ?is_self_adjoint:Dynamic, ?is_positive_definite:Dynamic, ?is_square:Dynamic, ?name:Dynamic):Void;
	/**
	...
	**/
	public function _check_diag(diag:Dynamic):Dynamic;
	/**
