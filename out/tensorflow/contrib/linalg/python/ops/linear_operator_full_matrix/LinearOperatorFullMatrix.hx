...
package tensorflow.contrib.linalg.python.ops.linear_operator_full_matrix;
@:pythonImport("tensorflow.contrib.linalg.python.ops.linear_operator_full_matrix", "LinearOperatorFullMatrix") extern class LinearOperatorFullMatrix {
