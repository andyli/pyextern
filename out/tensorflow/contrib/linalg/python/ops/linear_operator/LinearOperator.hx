...
package tensorflow.contrib.linalg.python.ops.linear_operator;
@:pythonImport("tensorflow.contrib.linalg.python.ops.linear_operator", "LinearOperator") extern class LinearOperator {
