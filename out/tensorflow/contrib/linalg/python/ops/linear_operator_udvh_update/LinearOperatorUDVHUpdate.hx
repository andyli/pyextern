...
package tensorflow.contrib.linalg.python.ops.linear_operator_udvh_update;
@:pythonImport("tensorflow.contrib.linalg.python.ops.linear_operator_udvh_update", "LinearOperatorUDVHUpdate") extern class LinearOperatorUDVHUpdate {
