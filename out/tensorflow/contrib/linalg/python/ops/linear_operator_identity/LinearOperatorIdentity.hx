...
package tensorflow.contrib.linalg.python.ops.linear_operator_identity;
@:pythonImport("tensorflow.contrib.linalg.python.ops.linear_operator_identity", "LinearOperatorIdentity") extern class LinearOperatorIdentity {
	...
	**/
	@:native("__init__")
	public function ___init__(num_rows:Dynamic, ?batch_shape:Dynamic, ?dtype:Dynamic, ?is_non_singular:Dynamic, ?is_self_adjoint:Dynamic, ?is_positive_definite:Dynamic, ?is_square:Dynamic, ?assert_proper_shapes:Dynamic, ?name:Dynamic):Dynamic;
	/**
		Initialize a `LinearOperatorIdentity`.
		...
		Raises:
		  ...
		  ValueError:  If any of the following is not `True`:
		    `{is_self_adjoint, is_non_singular, is_positive_definite}`.
	**/
	public function new(num_rows:Dynamic, ?batch_shape:Dynamic, ?dtype:Dynamic, ?is_non_singular:Dynamic, ?is_self_adjoint:Dynamic, ?is_positive_definite:Dynamic, ?is_square:Dynamic, ?assert_proper_shapes:Dynamic, ?name:Dynamic):Void;
	/**
	...
	**/
	public function _check_batch_shape_possibly_add_asserts():Dynamic;
	/**
	...
	**/
	public function _check_num_rows_possibly_add_asserts():Dynamic;
	public function _determinant():Dynamic;
	/**
		Generic and often inefficient implementation.  Override often.
	**/
	public function _diag_part():Dynamic;
	public function _get_cached_chol():Dynamic;
	public function _get_cached_dense_matrix():Dynamic;
	...
	**/
	public function _ones_diag():Dynamic;
	/**
		Return 'x', possibly after broadcasting the leading dimensions.
	**/
	public function _possibly_broadcast_batch_shape(x:Dynamic):Dynamic;
