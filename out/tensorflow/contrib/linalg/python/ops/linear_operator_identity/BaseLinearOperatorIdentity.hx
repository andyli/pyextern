...
@:pythonImport("tensorflow.contrib.linalg.python.ops.linear_operator_identity", "BaseLinearOperatorIdentity") extern class BaseLinearOperatorIdentity {
	...
	**/
	@:native("__init__")
	public function ___init__(dtype:Dynamic, ?graph_parents:Dynamic, ?is_non_singular:Dynamic, ?is_self_adjoint:Dynamic, ?is_positive_definite:Dynamic, ?is_square:Dynamic, ?name:Dynamic):Dynamic;
	/**
		Initialize the `LinearOperator`.
		...
		**Subclasses should copy-paste this `__init__` documentation.**
		...
		Raises:
		  ...
		  ValueError:  If hints are set incorrectly.
	**/
	public function new(dtype:Dynamic, ?graph_parents:Dynamic, ?is_non_singular:Dynamic, ?is_self_adjoint:Dynamic, ?is_positive_definite:Dynamic, ?is_square:Dynamic, ?name:Dynamic):Void;
	/**
