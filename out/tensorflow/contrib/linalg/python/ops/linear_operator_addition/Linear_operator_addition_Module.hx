...
@:pythonImport("tensorflow.contrib.linalg.python.ops.linear_operator_addition") extern class Linear_operator_addition_Module {
	...
	**/
	static public function _type(operator:Dynamic):Dynamic;
