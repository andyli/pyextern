...
package tensorflow.contrib.linalg.python.ops.linear_operator_tril;
@:pythonImport("tensorflow.contrib.linalg.python.ops.linear_operator_tril", "LinearOperatorTriL") extern class LinearOperatorTriL {
