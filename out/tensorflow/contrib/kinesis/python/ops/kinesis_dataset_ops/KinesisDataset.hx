...
package tensorflow.contrib.kinesis.python.ops.kinesis_dataset_ops;
@:pythonImport("tensorflow.contrib.kinesis.python.ops.kinesis_dataset_ops", "KinesisDataset") extern class KinesisDataset {
	/**
	...
	**/
	...
	/**
		Create a KinesisDataset. (deprecated)
		
		Warning: THIS FUNCTION IS DEPRECATED. It will be removed in a future version.
		Instructions for updating:
		tf.contrib.kinesis will be removed in 2.0, the support for Kinesis will continue to be provided through the tensorflow/io GitHub project.
	...
	**/
	@:native("__init__")
	public function ___init__(stream:Dynamic, ?shard:Dynamic, ?read_indefinitely:Dynamic, ?interval:Dynamic):Dynamic;
	/**
		Create a KinesisDataset. (deprecated)
		...
		Args:
		  ...
		  interval: The interval for the Kinesis Client to wait before
		    it tries to get records again (in millisecond).
	**/
	public function new(stream:Dynamic, ?shard:Dynamic, ?read_indefinitely:Dynamic, ?interval:Dynamic):Void;
	/**
