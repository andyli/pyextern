...
@:pythonImport("tensorflow.contrib.boosted_trees.proto.quantiles_pb2", "QuantileSummaryState") extern class QuantileSummaryState {
	/**
	...
	**/
	...
	/**
		Field boosted_trees.QuantileSummaryState.entries
	**/
