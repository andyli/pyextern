...
package tensorflow.contrib.boosted_trees.proto.quantiles_pb2;
@:pythonImport("tensorflow.contrib.boosted_trees.proto.quantiles_pb2", "QuantileConfig") extern class QuantileConfig {
	/**
	...
	**/
	...
	/**
		Field boosted_trees.QuantileConfig.eps
	**/
	public var eps : Dynamic;
	/**
		Field boosted_trees.QuantileConfig.num_quantiles
	**/
	public var num_quantiles : Dynamic;
}