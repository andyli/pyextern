...
@:pythonImport("tensorflow.contrib.boosted_trees.proto.quantiles_pb2", "QuantileStreamState") extern class QuantileStreamState {
	/**
	...
	**/
	...
	/**
		Field boosted_trees.QuantileStreamState.summaries
	**/
	public var summaries : Dynamic;
}