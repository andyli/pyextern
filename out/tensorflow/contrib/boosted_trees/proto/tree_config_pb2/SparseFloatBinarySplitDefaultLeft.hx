...
@:pythonImport("tensorflow.contrib.boosted_trees.proto.tree_config_pb2", "SparseFloatBinarySplitDefaultLeft") extern class SparseFloatBinarySplitDefaultLeft {
	/**
	...
	**/
	...
	/**
		Field tensorflow.boosted_trees.trees.SparseFloatBinarySplitDefaultLeft.split
	**/
