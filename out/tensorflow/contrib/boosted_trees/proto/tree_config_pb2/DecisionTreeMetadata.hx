...
@:pythonImport("tensorflow.contrib.boosted_trees.proto.tree_config_pb2", "DecisionTreeMetadata") extern class DecisionTreeMetadata {
	/**
	...
	**/
	...
	/**
		Field tensorflow.boosted_trees.trees.DecisionTreeMetadata.is_finalized
	**/
	public var is_finalized : Dynamic;
	/**
		Field tensorflow.boosted_trees.trees.DecisionTreeMetadata.num_layers_grown
	**/
	public var num_layers_grown : Dynamic;
	/**
		Field tensorflow.boosted_trees.trees.DecisionTreeMetadata.num_tree_weight_updates
	**/
	public var num_tree_weight_updates : Dynamic;
}