...
@:pythonImport("tensorflow.contrib.boosted_trees.proto.tree_config_pb2", "CategoricalIdSetMembershipBinarySplit") extern class CategoricalIdSetMembershipBinarySplit {
	/**
