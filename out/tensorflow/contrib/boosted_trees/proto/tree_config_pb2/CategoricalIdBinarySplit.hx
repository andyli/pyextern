...
@:pythonImport("tensorflow.contrib.boosted_trees.proto.tree_config_pb2", "CategoricalIdBinarySplit") extern class CategoricalIdBinarySplit {
	/**
	...
	**/
	...
	/**
		Field tensorflow.boosted_trees.trees.CategoricalIdBinarySplit.feature_column
	**/
	public var feature_column : Dynamic;
	/**
		Field tensorflow.boosted_trees.trees.CategoricalIdBinarySplit.feature_id
	**/
	public var feature_id : Dynamic;
	/**
		Field tensorflow.boosted_trees.trees.CategoricalIdBinarySplit.left_id
	**/
	public var left_id : Dynamic;
	/**
		Field tensorflow.boosted_trees.trees.CategoricalIdBinarySplit.right_id
	**/
