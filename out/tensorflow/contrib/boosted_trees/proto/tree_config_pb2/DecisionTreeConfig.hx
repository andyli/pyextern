...
@:pythonImport("tensorflow.contrib.boosted_trees.proto.tree_config_pb2", "DecisionTreeConfig") extern class DecisionTreeConfig {
	/**
	...
	**/
	...
	/**
		Field tensorflow.boosted_trees.trees.DecisionTreeConfig.nodes
	**/
