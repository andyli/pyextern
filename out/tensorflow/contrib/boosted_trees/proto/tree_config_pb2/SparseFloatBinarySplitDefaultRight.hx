...
@:pythonImport("tensorflow.contrib.boosted_trees.proto.tree_config_pb2", "SparseFloatBinarySplitDefaultRight") extern class SparseFloatBinarySplitDefaultRight {
	/**
	...
	**/
	...
	/**
		Field tensorflow.boosted_trees.trees.SparseFloatBinarySplitDefaultRight.split
	**/
