...
@:pythonImport("tensorflow.contrib.boosted_trees.proto.tree_config_pb2", "ObliviousCategoricalIdBinarySplit") extern class ObliviousCategoricalIdBinarySplit {
	/**
	...
	**/
	...
	/**
		Field tensorflow.boosted_trees.trees.ObliviousCategoricalIdBinarySplit.feature_column
	**/
	public var feature_column : Dynamic;
	/**
		Field tensorflow.boosted_trees.trees.ObliviousCategoricalIdBinarySplit.feature_id
	**/
