...
@:pythonImport("tensorflow.contrib.boosted_trees.proto.tree_config_pb2", "ObliviousDenseFloatBinarySplit") extern class ObliviousDenseFloatBinarySplit {
	/**
	...
	**/
	...
	/**
		Field tensorflow.boosted_trees.trees.ObliviousDenseFloatBinarySplit.feature_column
	**/
	public var feature_column : Dynamic;
	/**
		Field tensorflow.boosted_trees.trees.ObliviousDenseFloatBinarySplit.threshold
	**/
