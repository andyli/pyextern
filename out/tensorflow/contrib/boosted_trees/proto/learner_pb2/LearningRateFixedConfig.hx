...
@:pythonImport("tensorflow.contrib.boosted_trees.proto.learner_pb2", "LearningRateFixedConfig") extern class LearningRateFixedConfig {
	/**
	...
	**/
	...
	/**
		Field tensorflow.boosted_trees.learner.LearningRateFixedConfig.learning_rate
	**/
