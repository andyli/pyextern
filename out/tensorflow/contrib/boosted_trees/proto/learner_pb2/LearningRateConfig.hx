...
@:pythonImport("tensorflow.contrib.boosted_trees.proto.learner_pb2", "LearningRateConfig") extern class LearningRateConfig {
	/**
	...
	**/
	...
	/**
		Field tensorflow.boosted_trees.learner.LearningRateConfig.dropout
	**/
	public var dropout : Dynamic;
	/**
		Field tensorflow.boosted_trees.learner.LearningRateConfig.fixed
	**/
	public var fixed : Dynamic;
	/**
		Field tensorflow.boosted_trees.learner.LearningRateConfig.line_search
	**/
	public var line_search : Dynamic;
}