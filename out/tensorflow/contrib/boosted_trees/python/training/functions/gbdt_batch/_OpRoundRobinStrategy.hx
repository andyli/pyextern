...
@:pythonImport("tensorflow.contrib.boosted_trees.python.training.functions.gbdt_batch", "_OpRoundRobinStrategy") extern class _OpRoundRobinStrategy {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(ps_ops:Dynamic, num_tasks:Dynamic):Dynamic;
	/**
		Create a new `_RoundRobinStrategy`.
		...
		Args:
		  ...
		  num_tasks: Number of ps tasks to cycle among.
	**/
	public function new(ps_ops:Dynamic, num_tasks:Dynamic):Void;
	/**
