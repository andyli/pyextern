...
@:pythonImport("tensorflow.contrib.boosted_trees.python.ops.model_ops", "TreeEnsembleVariable") extern class TreeEnsembleVariable {
	...
	**/
	@:native("__init__")
	public function ___init__(stamp_token:Dynamic, tree_ensemble_config:Dynamic, name:Dynamic, ?container:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(stamp_token:Dynamic, tree_ensemble_config:Dynamic, name:Dynamic, ?container:Dynamic):Void;
	/**
