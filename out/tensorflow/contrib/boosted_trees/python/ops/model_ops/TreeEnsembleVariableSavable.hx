...
@:pythonImport("tensorflow.contrib.boosted_trees.python.ops.model_ops", "TreeEnsembleVariableSavable") extern class TreeEnsembleVariableSavable {
	...
	**/
	@:native("__init__")
	public function ___init__(tree_ensemble_handle:Dynamic, create_op:Dynamic, name:Dynamic):Dynamic;
	/**
		Creates a TreeEnsembleVariableSavable object.
		...
		Args:
		  ...
		  name: the name to save the tree ensemble variable under.
	**/
	public function new(tree_ensemble_handle:Dynamic, create_op:Dynamic, name:Dynamic):Void;
	/**
