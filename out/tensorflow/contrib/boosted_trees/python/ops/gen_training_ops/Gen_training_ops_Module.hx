...
package tensorflow.contrib.boosted_trees.python.ops.gen_training_ops;
@:pythonImport("tensorflow.contrib.boosted_trees.python.ops.gen_training_ops") extern class Gen_training_ops_Module {
	...
	static public var _tree_ensemble_stats_outputs : Dynamic;
	/**
