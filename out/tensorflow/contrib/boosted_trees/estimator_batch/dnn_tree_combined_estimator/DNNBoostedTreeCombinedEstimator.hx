...
@:pythonImport("tensorflow.contrib.boosted_trees.estimator_batch.dnn_tree_combined_estimator", "DNNBoostedTreeCombinedEstimator") extern class DNNBoostedTreeCombinedEstimator {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(dnn_hidden_units:Dynamic, dnn_feature_columns:Dynamic, tree_learner_config:Dynamic, num_trees:Dynamic, tree_examples_per_layer:Dynamic, head:Dynamic, ?model_dir:Dynamic, ?config:Dynamic, ?feature_engineering_fn:Dynamic, ?dnn_optimizer:Dynamic, ?dnn_activation_fn:Dynamic, ?dnn_dropout:Dynamic, ?dnn_input_layer_partitioner:Dynamic, ?dnn_input_layer_to_tree:Dynamic, ?dnn_steps_to_train:Dynamic, ?predict_with_tree_only:Dynamic, ?tree_feature_columns:Dynamic, ?tree_center_bias:Dynamic, ?dnn_to_tree_distillation_param:Dynamic, ?use_core_versions:Dynamic, ?override_global_step_value:Dynamic):Dynamic;
	/**
		Initializes a DNNBoostedTreeCombinedEstimator instance.
		...
		Args:
		  ...
		  override_global_step_value: If after the training is done, global step
		    ...
		    of trees. If None, no override of global step will happen.
	**/
	public function new(dnn_hidden_units:Dynamic, dnn_feature_columns:Dynamic, tree_learner_config:Dynamic, num_trees:Dynamic, tree_examples_per_layer:Dynamic, head:Dynamic, ?model_dir:Dynamic, ?config:Dynamic, ?feature_engineering_fn:Dynamic, ?dnn_optimizer:Dynamic, ?dnn_activation_fn:Dynamic, ?dnn_dropout:Dynamic, ?dnn_input_layer_partitioner:Dynamic, ?dnn_input_layer_to_tree:Dynamic, ?dnn_steps_to_train:Dynamic, ?predict_with_tree_only:Dynamic, ?tree_feature_columns:Dynamic, ?tree_center_bias:Dynamic, ?dnn_to_tree_distillation_param:Dynamic, ?use_core_versions:Dynamic, ?override_global_step_value:Dynamic):Void;
	/**
