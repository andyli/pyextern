...
@:pythonImport("tensorflow.contrib.boosted_trees.estimator_batch.estimator", "GradientBoostedDecisionTreeEstimator") extern class GradientBoostedDecisionTreeEstimator {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(learner_config:Dynamic, examples_per_layer:Dynamic, head:Dynamic, ?num_trees:Dynamic, ?feature_columns:Dynamic, ?weight_column_name:Dynamic, ?model_dir:Dynamic, ?config:Dynamic, ?feature_engineering_fn:Dynamic, ?logits_modifier_function:Dynamic, ?center_bias:Dynamic, ?use_core_libs:Dynamic, ?output_leaf_index:Dynamic, ?override_global_step_value:Dynamic, ?num_quantiles:Dynamic):Dynamic;
	/**
		Initializes a GradientBoostedDecisionTreeEstimator estimator instance.
