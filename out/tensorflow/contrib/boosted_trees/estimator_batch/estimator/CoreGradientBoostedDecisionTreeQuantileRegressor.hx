...
@:pythonImport("tensorflow.contrib.boosted_trees.estimator_batch.estimator", "CoreGradientBoostedDecisionTreeQuantileRegressor") extern class CoreGradientBoostedDecisionTreeQuantileRegressor {
	...
	**/
	@:native("__init__")
	public function ___init__(learner_config:Dynamic, examples_per_layer:Dynamic, quantiles:Dynamic, ?label_dimension:Dynamic, ?num_trees:Dynamic, ?feature_columns:Dynamic, ?weight_column_name:Dynamic, ?model_dir:Dynamic, ?config:Dynamic, ?label_keys:Dynamic, ?feature_engineering_fn:Dynamic, ?logits_modifier_function:Dynamic, ?center_bias:Dynamic, ?output_leaf_index:Dynamic, ?num_quantiles:Dynamic):Dynamic;
	/**
		Initializes a core version of GradientBoostedDecisionTreeEstimator.
		...
		Args:
		  ...
		  num_quantiles: Number of quantiles to build for numeric feature values.
	**/
	public function new(learner_config:Dynamic, examples_per_layer:Dynamic, quantiles:Dynamic, ?label_dimension:Dynamic, ?num_trees:Dynamic, ?feature_columns:Dynamic, ?weight_column_name:Dynamic, ?model_dir:Dynamic, ?config:Dynamic, ?label_keys:Dynamic, ?feature_engineering_fn:Dynamic, ?logits_modifier_function:Dynamic, ?center_bias:Dynamic, ?output_leaf_index:Dynamic, ?num_quantiles:Dynamic):Void;
	/**
