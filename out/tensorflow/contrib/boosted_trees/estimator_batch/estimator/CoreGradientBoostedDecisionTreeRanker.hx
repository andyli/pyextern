...
@:pythonImport("tensorflow.contrib.boosted_trees.estimator_batch.estimator", "CoreGradientBoostedDecisionTreeRanker") extern class CoreGradientBoostedDecisionTreeRanker {
	...
	**/
	@:native("__init__")
	public function ___init__(learner_config:Dynamic, examples_per_layer:Dynamic, head:Dynamic, ranking_model_pair_keys:Dynamic, ?num_trees:Dynamic, ?feature_columns:Dynamic, ?weight_column_name:Dynamic, ?model_dir:Dynamic, ?config:Dynamic, ?label_keys:Dynamic, ?logits_modifier_function:Dynamic, ?center_bias:Dynamic, ?output_leaf_index:Dynamic, ?num_quantiles:Dynamic):Dynamic;
	/**
		Initializes a GradientBoostedDecisionTreeRanker instance.
		...
		Raises:
		  ValueError: If learner_config is not valid.
	**/
	public function new(learner_config:Dynamic, examples_per_layer:Dynamic, head:Dynamic, ranking_model_pair_keys:Dynamic, ?num_trees:Dynamic, ?feature_columns:Dynamic, ?weight_column_name:Dynamic, ?model_dir:Dynamic, ?config:Dynamic, ?label_keys:Dynamic, ?logits_modifier_function:Dynamic, ?center_bias:Dynamic, ?output_leaf_index:Dynamic, ?num_quantiles:Dynamic):Void;
	/**
