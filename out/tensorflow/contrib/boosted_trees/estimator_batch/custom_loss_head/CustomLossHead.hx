...
package tensorflow.contrib.boosted_trees.estimator_batch.custom_loss_head;
@:pythonImport("tensorflow.contrib.boosted_trees.estimator_batch.custom_loss_head", "CustomLossHead") extern class CustomLossHead {
	...
	**/
	@:native("__init__")
	public function ___init__(loss_fn:Dynamic, link_fn:Dynamic, logit_dimension:Dynamic, ?head_name:Dynamic, ?weight_column_name:Dynamic, ?metrics_fn:Dynamic):Dynamic;
	/**
		`Head` for specifying arbitrary loss function.
		...
		Args:
		  ...
		  metrics_fn: a function that takes predictions dict, labels and weights and
		    returns a dictionary of metrics to be calculated.
	**/
	public function new(loss_fn:Dynamic, link_fn:Dynamic, logit_dimension:Dynamic, ?head_name:Dynamic, ?weight_column_name:Dynamic, ?metrics_fn:Dynamic):Void;
	/**
