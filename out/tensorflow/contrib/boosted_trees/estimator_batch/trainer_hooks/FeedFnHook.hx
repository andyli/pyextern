...
@:pythonImport("tensorflow.contrib.boosted_trees.estimator_batch.trainer_hooks", "FeedFnHook") extern class FeedFnHook {
	...
	**/
	@:native("__init__")
	public function ___init__(feed_fn:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(feed_fn:Dynamic):Void;
	/**
