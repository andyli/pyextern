...
@:pythonImport("tensorflow.contrib.boosted_trees.estimator_batch.trainer_hooks", "FeatureImportanceSummarySaver") extern class FeatureImportanceSummarySaver {
	...
	**/
	@:native("__init__")
	public function ___init__(model_dir:Dynamic, ?every_n_steps:Dynamic):Dynamic;
	/**
		Create a FeatureImportanceSummarySaver Hook.
		...
		Raises:
		  ValueError: If one of the arguments is invalid.
	**/
	public function new(model_dir:Dynamic, ?every_n_steps:Dynamic):Void;
	/**
