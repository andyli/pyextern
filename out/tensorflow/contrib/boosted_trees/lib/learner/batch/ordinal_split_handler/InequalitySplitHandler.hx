...
@:pythonImport("tensorflow.contrib.boosted_trees.lib.learner.batch.ordinal_split_handler", "InequalitySplitHandler") extern class InequalitySplitHandler {
	...
	**/
	@:native("__init__")
	public function ___init__(l1_regularization:Dynamic, l2_regularization:Dynamic, tree_complexity_regularization:Dynamic, min_node_weight:Dynamic, feature_column_group_id:Dynamic, epsilon:Dynamic, num_quantiles:Dynamic, gradient_shape:Dynamic, hessian_shape:Dynamic, multiclass_strategy:Dynamic, ?init_stamp_token:Dynamic, ?loss_uses_sum_reduction:Dynamic, ?name:Dynamic):Dynamic;
	/**
		Initialize the internal state for this split handler.
		...
		Args:
		  ...
		  name: An optional handler name.
	**/
	public function new(l1_regularization:Dynamic, l2_regularization:Dynamic, tree_complexity_regularization:Dynamic, min_node_weight:Dynamic, feature_column_group_id:Dynamic, epsilon:Dynamic, num_quantiles:Dynamic, gradient_shape:Dynamic, hessian_shape:Dynamic, multiclass_strategy:Dynamic, ?init_stamp_token:Dynamic, ?loss_uses_sum_reduction:Dynamic, ?name:Dynamic):Void;
	/**
