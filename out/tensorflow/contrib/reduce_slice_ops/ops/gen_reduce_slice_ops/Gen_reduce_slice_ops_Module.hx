...
package tensorflow.contrib.reduce_slice_ops.ops.gen_reduce_slice_ops;
@:pythonImport("tensorflow.contrib.reduce_slice_ops.ops.gen_reduce_slice_ops") extern class Gen_reduce_slice_ops_Module {
	...
	**/
	static public function reduce_slice_max_eager_fallback(data:Dynamic, indices:Dynamic, axis:Dynamic, ?name:Dynamic, ?ctx:Dynamic):Dynamic;
	/**
	...
	**/
	static public function reduce_slice_min_eager_fallback(data:Dynamic, indices:Dynamic, axis:Dynamic, ?name:Dynamic, ?ctx:Dynamic):Dynamic;
	/**
	...
	**/
	static public function reduce_slice_prod_eager_fallback(data:Dynamic, indices:Dynamic, axis:Dynamic, ?name:Dynamic, ?ctx:Dynamic):Dynamic;
	/**
	...
	**/
	static public function reduce_slice_sum_eager_fallback(data:Dynamic, indices:Dynamic, axis:Dynamic, ?name:Dynamic, ?ctx:Dynamic):Dynamic;
