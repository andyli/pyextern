...
package tensorflow.contrib.optimizer_v2.adam;
@:pythonImport("tensorflow.contrib.optimizer_v2.adam", "AdamOptimizer") extern class AdamOptimizer {
	...
	**/
	...
	public function _apply_sparse_shared(grad:Dynamic, _var:Dynamic, indices:Dynamic, scatter_add:Dynamic, state:Dynamic):Dynamic;
	/**
	...
	**/
	...
	public function _get_beta_accumulators(?state:Dynamic):Dynamic;
