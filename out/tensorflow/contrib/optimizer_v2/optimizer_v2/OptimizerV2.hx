...
@:pythonImport("tensorflow.contrib.optimizer_v2.optimizer_v2", "OptimizerV2") extern class OptimizerV2 {
	...
	**/
	@:native("__init__")
	public function ___init__(use_locking:Dynamic, name:Dynamic):Dynamic;
	/**
		Create a new Optimizer.
		...
		Raises:
		  ...
		  RuntimeError: If _create_slots has been overridden instead of
		      _create_vars.
	**/
	public function new(use_locking:Dynamic, name:Dynamic):Void;
	/**
