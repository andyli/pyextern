...
package tensorflow.contrib.optimizer_v2.momentum;
@:pythonImport("tensorflow.contrib.optimizer_v2.momentum", "MomentumOptimizer") extern class MomentumOptimizer {
	...
	**/
	@:native("__init__")
	public function ___init__(learning_rate:Dynamic, momentum:Dynamic, ?use_locking:Dynamic, ?name:Dynamic, ?use_nesterov:Dynamic):Dynamic;
	/**
		Construct a new Momentum optimizer.
		...
		@end_compatibility
	**/
	public function new(learning_rate:Dynamic, momentum:Dynamic, ?use_locking:Dynamic, ?name:Dynamic, ?use_nesterov:Dynamic):Void;
	/**
