...
package tensorflow.contrib.optimizer_v2.gradient_descent;
@:pythonImport("tensorflow.contrib.optimizer_v2.gradient_descent", "GradientDescentOptimizer") extern class GradientDescentOptimizer {
	...
	**/
	@:native("__init__")
	public function ___init__(learning_rate:Dynamic, ?use_locking:Dynamic, ?name:Dynamic):Dynamic;
	/**
		Construct a new gradient descent optimizer.
		...
		Args:
		  ...
		  name: Optional name prefix for the operations created when applying
		    gradients. Defaults to "GradientDescent".
	**/
	public function new(learning_rate:Dynamic, ?use_locking:Dynamic, ?name:Dynamic):Void;
	/**
	...
	**/
	public function _resource_apply_dense(grad:Dynamic, handle:Dynamic, state:Dynamic):Dynamic;
	/**
