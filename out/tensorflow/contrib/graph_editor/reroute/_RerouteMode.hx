...
@:pythonImport("tensorflow.contrib.graph_editor.reroute", "_RerouteMode") extern class _RerouteMode {
	...
	**/
	...
	static public var a2b : Dynamic;
	static public var b2a : Dynamic;
	/**
		Check swap mode.
	...
	**/
	static public function check(mode:Dynamic):Dynamic;
	static public var swap : Dynamic;
}