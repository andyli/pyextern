...
@:pythonImport("tensorflow.contrib.graph_editor.transform", "_TmpInfo") extern class _TmpInfo {
	...
	**/
	@:native("__init__")
	public function ___init__(sgv:Dynamic, dst_graph:Dynamic, dst_scope:Dynamic, src_scope:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(sgv:Dynamic, dst_graph:Dynamic, dst_scope:Dynamic, src_scope:Dynamic):Void;
	/**
