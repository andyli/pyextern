...
@:pythonImport("tensorflow.contrib.timeseries.python.timeseries.estimators", "StateSpaceRegressor") extern class StateSpaceRegressor {
	...
	**/
	@:native("__init__")
	public function ___init__(model:Dynamic, ?state_manager:Dynamic, ?optimizer:Dynamic, ?model_dir:Dynamic, ?config:Dynamic, ?head_type:Dynamic):Dynamic;
	/**
		See TimeSeriesRegressor. Uses the ChainingStateManager by default.
	**/
	public function new(model:Dynamic, ?state_manager:Dynamic, ?optimizer:Dynamic, ?model_dir:Dynamic, ?config:Dynamic, ?head_type:Dynamic):Void;
	/**
