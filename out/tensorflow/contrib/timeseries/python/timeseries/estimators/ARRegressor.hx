...
package tensorflow.contrib.timeseries.python.timeseries.estimators;
@:pythonImport("tensorflow.contrib.timeseries.python.timeseries.estimators", "ARRegressor") extern class ARRegressor {
	...
	**/
	@:native("__init__")
	public function ___init__(periodicities:Dynamic, input_window_size:Dynamic, output_window_size:Dynamic, num_features:Dynamic, ?exogenous_feature_columns:Dynamic, ?num_time_buckets:Dynamic, ?loss:Dynamic, ?hidden_layer_sizes:Dynamic, ?anomaly_prior_probability:Dynamic, ?anomaly_distribution:Dynamic, ?optimizer:Dynamic, ?model_dir:Dynamic, ?config:Dynamic):Dynamic;
	/**
		Initialize the Estimator.
		...
		Raises:
		  ValueError: For invalid combinations of arguments.
	**/
	public function new(periodicities:Dynamic, input_window_size:Dynamic, output_window_size:Dynamic, num_features:Dynamic, ?exogenous_feature_columns:Dynamic, ?num_time_buckets:Dynamic, ?loss:Dynamic, ?hidden_layer_sizes:Dynamic, ?anomaly_prior_probability:Dynamic, ?anomaly_distribution:Dynamic, ?optimizer:Dynamic, ?model_dir:Dynamic, ?config:Dynamic):Void;
	/**
	...
	**/
	public function _model_start_state_placeholders(batch_size_tensor:Dynamic, ?static_batch_size:Dynamic):Dynamic;
		...
		Returns:
		  ...
		  features with the following shapes:
		    ...
		    all exogenous features: [filtering_length + prediction_length, ...]
		      (various dtypes)
	**/
	public function build_one_shot_parsing_serving_input_receiver_fn(filtering_length:Dynamic, prediction_length:Dynamic, ?default_batch_size:Dynamic, ?values_input_dtype:Dynamic, ?truncate_values:Dynamic):Dynamic;
	/**
		...
		Returns:
		  ...
		  export_savedmodel.
	**/
	public function build_raw_serving_input_receiver_fn(?default_batch_size:Dynamic, ?default_series_length:Dynamic):Dynamic;
