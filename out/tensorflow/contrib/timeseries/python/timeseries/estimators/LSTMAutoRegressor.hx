...
@:pythonImport("tensorflow.contrib.timeseries.python.timeseries.estimators", "LSTMAutoRegressor") extern class LSTMAutoRegressor {
	...
	**/
	@:native("__init__")
	public function ___init__(periodicities:Dynamic, input_window_size:Dynamic, output_window_size:Dynamic, ?model_dir:Dynamic, ?num_features:Dynamic, ?extra_feature_columns:Dynamic, ?num_timesteps:Dynamic, ?loss:Dynamic, ?num_units:Dynamic, ?optimizer:Dynamic, ?config:Dynamic):Dynamic;
	/**
		Initialize the Estimator.
		...
		Args:
		  ...
		  config: Optional `estimator.RunConfig` object to configure the runtime
		    settings.
	**/
	public function new(periodicities:Dynamic, input_window_size:Dynamic, output_window_size:Dynamic, ?model_dir:Dynamic, ?num_features:Dynamic, ?extra_feature_columns:Dynamic, ?num_timesteps:Dynamic, ?loss:Dynamic, ?num_units:Dynamic, ?optimizer:Dynamic, ?config:Dynamic):Void;
	/**
