...
@:pythonImport("tensorflow.contrib.timeseries.python.timeseries.estimators", "StructuralEnsembleRegressor") extern class StructuralEnsembleRegressor {
	...
	**/
	@:native("__init__")
	public function ___init__(periodicities:Dynamic, num_features:Dynamic, ?cycle_num_latent_values:Dynamic, ?moving_average_order:Dynamic, ?autoregressive_order:Dynamic, ?exogenous_feature_columns:Dynamic, ?exogenous_update_condition:Dynamic, ?dtype:Dynamic, ?anomaly_prior_probability:Dynamic, ?optimizer:Dynamic, ?model_dir:Dynamic, ?config:Dynamic, ?head_type:Dynamic):Dynamic;
	/**
		Initialize the Estimator.
		...
		Args:
		  ...
		  head_type: The kind of head to use for the model (inheriting from
		      `TimeSeriesRegressionHead`).
	**/
	public function new(periodicities:Dynamic, num_features:Dynamic, ?cycle_num_latent_values:Dynamic, ?moving_average_order:Dynamic, ?autoregressive_order:Dynamic, ?exogenous_feature_columns:Dynamic, ?exogenous_update_condition:Dynamic, ?dtype:Dynamic, ?anomaly_prior_probability:Dynamic, ?optimizer:Dynamic, ?model_dir:Dynamic, ?config:Dynamic, ?head_type:Dynamic):Void;
	/**
