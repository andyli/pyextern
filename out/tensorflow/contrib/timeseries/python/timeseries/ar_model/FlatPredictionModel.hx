...
@:pythonImport("tensorflow.contrib.timeseries.python.timeseries.ar_model", "FlatPredictionModel") extern class FlatPredictionModel {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(num_features:Dynamic, input_window_size:Dynamic, output_window_size:Dynamic, ?hidden_layer_sizes:Dynamic):Dynamic;
	/**
		Construct the flat prediction model.
		...
		Args:
		  ...
		  hidden_layer_sizes: list of sizes of hidden layers.
	**/
	public function new(num_features:Dynamic, input_window_size:Dynamic, output_window_size:Dynamic, ?hidden_layer_sizes:Dynamic):Void;
	/**
	...
	**/
	public function call(input_window_features:Dynamic, output_window_features:Dynamic):Dynamic;
	/**
