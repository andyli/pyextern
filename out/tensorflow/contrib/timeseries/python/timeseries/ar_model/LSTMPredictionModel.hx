...
@:pythonImport("tensorflow.contrib.timeseries.python.timeseries.ar_model", "LSTMPredictionModel") extern class LSTMPredictionModel {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(num_features:Dynamic, input_window_size:Dynamic, output_window_size:Dynamic, ?num_units:Dynamic):Dynamic;
	/**
		Construct the LSTM prediction model.
		...
		Args:
		  ...
		  num_units: The number of units in the encoder and decoder LSTM cells.
	**/
	public function new(num_features:Dynamic, input_window_size:Dynamic, output_window_size:Dynamic, ?num_units:Dynamic):Void;
	/**
