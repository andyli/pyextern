...
@:pythonImport("tensorflow.contrib.timeseries.python.timeseries.math_utils", "Moments") extern class Moments {
	/**
		Return self+value.
	**/
	...
	**/
	...
	/**
		Create new instance of Moments(mean, variance)
	**/
	static public function __new__(_cls:Dynamic, mean:Dynamic, variance:Dynamic):Dynamic;
	/**
		helper for pickle
	**/
	...
	**/
	...
	/**
		Make a new Moments object from a sequence or iterable
	**/
	static public function _make(iterable:Dynamic, ?_new:Dynamic, ?len:Dynamic):Dynamic;
	/**
		Return a new Moments object replacing specified fields with new values
	**/
