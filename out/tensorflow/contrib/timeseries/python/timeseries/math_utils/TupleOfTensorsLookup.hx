...
@:pythonImport("tensorflow.contrib.timeseries.python.timeseries.math_utils", "TupleOfTensorsLookup") extern class TupleOfTensorsLookup {
	...
	**/
	@:native("__init__")
	public function ___init__(key_dtype:Dynamic, default_values:Dynamic, empty_key:Dynamic, deleted_key:Dynamic, name:Dynamic, ?checkpoint:Dynamic):Dynamic;
	/**
		Construct a lookup table interface.
		...
		Args:
		  ...
		  value_dtype: The table value type.
	**/
	public function new(key_dtype:Dynamic, default_values:Dynamic, empty_key:Dynamic, deleted_key:Dynamic, name:Dynamic, ?checkpoint:Dynamic):Void;
	/**
