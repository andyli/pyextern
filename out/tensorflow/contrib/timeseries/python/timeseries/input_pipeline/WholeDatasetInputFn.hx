...
@:pythonImport("tensorflow.contrib.timeseries.python.timeseries.input_pipeline", "WholeDatasetInputFn") extern class WholeDatasetInputFn {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(time_series_reader:Dynamic):Dynamic;
	/**
		Initialize the `TimeSeriesInputFn`.
		...
		Args:
		  time_series_reader: A TimeSeriesReader object.
	**/
	public function new(time_series_reader:Dynamic):Void;
	/**
