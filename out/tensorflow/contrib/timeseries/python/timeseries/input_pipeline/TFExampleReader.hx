...
@:pythonImport("tensorflow.contrib.timeseries.python.timeseries.input_pipeline", "TFExampleReader") extern class TFExampleReader {
	...
	**/
	@:native("__init__")
	public function ___init__(filenames:Dynamic, features:Dynamic):Dynamic;
	/**
		Configure `tf.Example` parsing.
		...
		Raises:
		  ValueError: If required times/values features are not present.
	**/
	public function new(filenames:Dynamic, features:Dynamic):Void;
	/**
	...
	**/
	public function _process_records(examples:Dynamic):Dynamic;
	/**
