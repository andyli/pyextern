...
@:pythonImport("tensorflow.contrib.timeseries.python.timeseries.state_space_models.periodic", "CycleStateSpaceModel") extern class CycleStateSpaceModel {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(periodicity:Dynamic, ?configuration:Dynamic):Dynamic;
	/**
		Initialize a state space model.
		...
		Args:
		  configuration: A StateSpaceModelConfiguration object.
	**/
	public function new(periodicity:Dynamic, ?configuration:Dynamic):Void;
	/**
	...
	**/
	...
	/**
		...
		Returns:
		  ...
		  of the periodicity.
	**/
	public function transition_power_noise_accumulator(num_steps:Dynamic, ?noise_addition_coefficient:Dynamic):Dynamic;
	/**
