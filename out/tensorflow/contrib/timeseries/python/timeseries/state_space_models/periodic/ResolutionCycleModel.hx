...
package tensorflow.contrib.timeseries.python.timeseries.state_space_models.periodic;
@:pythonImport("tensorflow.contrib.timeseries.python.timeseries.state_space_models.periodic", "ResolutionCycleModel") extern class ResolutionCycleModel {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(num_latent_values:Dynamic, periodicity:Dynamic, ?near_integer_threshold:Dynamic, ?configuration:Dynamic):Dynamic;
	/**
		Initialize the ResolutionCycleModel.
		...
		Raises:
		  ValueError: If num_latent_values is not odd.
	**/
	public function new(num_latent_values:Dynamic, periodicity:Dynamic, ?near_integer_threshold:Dynamic, ?configuration:Dynamic):Void;
	/**
	...
	**/
	...
	public function _close_to_integer(value:Dynamic):Dynamic;
	/**
	...
	**/
	...
	/**
		Computes \sum_{i=0}^{N-1} A^i B (A^i)^T for N=0..max_remaining_steps.
		...
		Returns:
		  ...
		  S[N] = \sum_{i=0}^{N-1} A^i B (A^i)^T
		    ...
		    S[2] is A B A^T + B
	**/
	public function _power_sum_array(max_remaining_steps:Dynamic):Dynamic;
	/**
	...
	**/
	public function _whole_period_folding():Dynamic;
	/**
