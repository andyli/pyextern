...
@:pythonImport("tensorflow.contrib.timeseries.python.timeseries.state_space_models.structural_ensemble", "MultiResolutionStructuralEnsemble") extern class MultiResolutionStructuralEnsemble {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(cycle_num_latent_values:Dynamic, moving_average_order:Dynamic, autoregressive_order:Dynamic, periodicities:Dynamic, ?use_level_noise:Dynamic, ?configuration:Dynamic):Dynamic;
	/**
		Initialize the multi-resolution structural ensemble.
		...
		Raises:
		  ValueError: If `cycle_num_latent_values` is neither a scalar nor agrees in
		      size with `periodicities`.
	**/
	public function new(cycle_num_latent_values:Dynamic, moving_average_order:Dynamic, autoregressive_order:Dynamic, periodicities:Dynamic, ?use_level_noise:Dynamic, ?configuration:Dynamic):Void;
	/**
