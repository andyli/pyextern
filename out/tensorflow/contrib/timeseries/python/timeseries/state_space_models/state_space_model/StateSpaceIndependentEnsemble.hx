...
@:pythonImport("tensorflow.contrib.timeseries.python.timeseries.state_space_models.state_space_model", "StateSpaceIndependentEnsemble") extern class StateSpaceIndependentEnsemble {
	/**
