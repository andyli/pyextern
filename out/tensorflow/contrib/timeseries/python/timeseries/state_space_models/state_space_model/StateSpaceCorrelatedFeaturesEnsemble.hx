...
@:pythonImport("tensorflow.contrib.timeseries.python.timeseries.state_space_models.state_space_model", "StateSpaceCorrelatedFeaturesEnsemble") extern class StateSpaceCorrelatedFeaturesEnsemble {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(ensemble_members:Dynamic, configuration:Dynamic):Dynamic;
	/**
		Specify the ensemble's configuration and component models.
		...
		Raises:
		  ValueError: If the length of `ensemble_members` does not equal the number
		    of features in the series, or any component is not univariate.
	**/
	public function new(ensemble_members:Dynamic, configuration:Dynamic):Void;
	/**
