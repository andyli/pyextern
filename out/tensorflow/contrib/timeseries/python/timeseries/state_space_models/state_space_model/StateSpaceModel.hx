...
@:pythonImport("tensorflow.contrib.timeseries.python.timeseries.state_space_models.state_space_model", "StateSpaceModel") extern class StateSpaceModel {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(configuration:Dynamic):Dynamic;
	/**
		Initialize a state space model.
		...
		Args:
		  configuration: A StateSpaceModelConfiguration object.
	**/
	public function new(configuration:Dynamic):Void;
	/**
