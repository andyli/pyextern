...
package tensorflow.contrib.timeseries.python.timeseries.state_space_models.level_trend;
@:pythonImport("tensorflow.contrib.timeseries.python.timeseries.state_space_models.level_trend", "AdderStateSpaceModel") extern class AdderStateSpaceModel {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(?use_level_noise:Dynamic, ?configuration:Dynamic):Dynamic;
	/**
		Configure the model.
		...
		Args:
		  ...
		  configuration: A StateSpaceModelConfiguration object.
	**/
	public function new(?use_level_noise:Dynamic, ?configuration:Dynamic):Void;
	/**
