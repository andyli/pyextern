...
@:pythonImport("tensorflow.contrib.timeseries.python.timeseries.state_space_models.filtering_postprocessor", "FilteringStepPostprocessor") extern class FilteringStepPostprocessor {
