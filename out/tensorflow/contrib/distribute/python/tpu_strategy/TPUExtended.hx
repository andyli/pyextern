...
@:pythonImport("tensorflow.contrib.distribute.python.tpu_strategy", "TPUExtended") extern class TPUExtended {
	...
	**/
	@:native("__init__")
	public function ___init__(container_strategy:Dynamic, tpu_cluster_resolver:Dynamic, steps_per_run:Dynamic, ?num_cores:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(container_strategy:Dynamic, tpu_cluster_resolver:Dynamic, steps_per_run:Dynamic, ?num_cores:Dynamic):Void;
	/**
	...
	**/
	public function _get_enqueue_op_per_host(host_id:Dynamic, multi_worker_iterator:Dynamic, input_shapes:Dynamic, iterations:Dynamic):Dynamic;
	...
	**/
	public function _initialize_tpu():Dynamic;
	static public var _initialized_devices : Dynamic;
	/**
	...
	**/
	...
	public function get_host(host_id:Dynamic):Dynamic;
