...
@:pythonImport("tensorflow.contrib.distribute.python.one_device_strategy", "OneDeviceExtended") extern class OneDeviceExtended {
	...
	**/
	@:native("__init__")
	public function ___init__(container_strategy:Dynamic, device:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(container_strategy:Dynamic, device:Dynamic):Void;
	/**
