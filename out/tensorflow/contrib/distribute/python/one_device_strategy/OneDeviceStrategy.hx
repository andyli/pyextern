...
package tensorflow.contrib.distribute.python.one_device_strategy;
@:pythonImport("tensorflow.contrib.distribute.python.one_device_strategy", "OneDeviceStrategy") extern class OneDeviceStrategy {
	...
	**/
	@:native("__init__")
	public function ___init__(device:Dynamic, ?prefetch_on_device:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(device:Dynamic, ?prefetch_on_device:Dynamic):Void;
	/**
	...
	**/
	...
	public function _unwrap(value:Dynamic):Dynamic;
