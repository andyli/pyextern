...
@:pythonImport("tensorflow.contrib.distribute.python.one_device_strategy", "_OneDeviceTowerContext") extern class _OneDeviceTowerContext {
	...
	**/
	public function _merge_call(merge_fn:Dynamic, ?args:python.VarArgs<Dynamic>, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
