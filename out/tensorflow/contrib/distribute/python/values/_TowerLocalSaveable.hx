...
@:pythonImport("tensorflow.contrib.distribute.python.values", "_TowerLocalSaveable") extern class _TowerLocalSaveable {
	...
	**/
	@:native("__init__")
	public function ___init__(tower_local_variable:Dynamic, name:Dynamic):Dynamic;
	/**
		Creates a `SaveableObject` object.
		...
		Args:
		  ...
		  name: the name to save the object under.
	**/
	public function new(tower_local_variable:Dynamic, name:Dynamic):Void;
	/**
