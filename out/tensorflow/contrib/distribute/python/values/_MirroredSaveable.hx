...
@:pythonImport("tensorflow.contrib.distribute.python.values", "_MirroredSaveable") extern class _MirroredSaveable {
	...
	**/
	@:native("__init__")
	public function ___init__(mirrored_variable:Dynamic, primary_variable:Dynamic, name:Dynamic):Dynamic;
	/**
		Creates a `SaveableObject` object.
		...
		Args:
		  ...
		  name: the name to save the object under.
	**/
	public function new(mirrored_variable:Dynamic, primary_variable:Dynamic, name:Dynamic):Void;
	/**
