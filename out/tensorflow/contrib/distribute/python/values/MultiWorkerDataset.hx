...
@:pythonImport("tensorflow.contrib.distribute.python.values", "MultiWorkerDataset") extern class MultiWorkerDataset {
	...
	**/
	@:native("__init__")
	public function ___init__(dataset_fn:Dynamic, worker_device_map:Dynamic, ?prefetch_on_device:Dynamic, ?auto_shard:Dynamic):Dynamic;
	/**
		Initialize the MultiWorkerDataset object.
		...
		Args:
		  ...
		  auto_shard: whether to auto-shard the dataset.
	**/
	public function new(dataset_fn:Dynamic, worker_device_map:Dynamic, ?prefetch_on_device:Dynamic, ?auto_shard:Dynamic):Void;
	/**
