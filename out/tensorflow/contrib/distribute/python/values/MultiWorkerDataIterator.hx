...
@:pythonImport("tensorflow.contrib.distribute.python.values", "MultiWorkerDataIterator") extern class MultiWorkerDataIterator {
	...
	**/
	@:native("__init__")
	public function ___init__(iterators:Dynamic, worker_device_map:Dynamic):Dynamic;
	/**
		Initialize the MultiWorkerDataIterator object.
		...
		Raises:
		  ValueError: if iterators and worker_device_map are not compatible.
	**/
	public function new(iterators:Dynamic, worker_device_map:Dynamic):Void;
	/**
