...
@:pythonImport("tensorflow.contrib.distribute.python.values", "DistributedVarOp") extern class DistributedVarOp {
	/**
		Return self+value.
	**/
	...
	**/
	...
	/**
		Create new instance of DistributedVarOp(name, graph, type)
	**/
	static public function __new__(_cls:Dynamic, name:Dynamic, graph:Dynamic, type:Dynamic):Dynamic;
	/**
		helper for pickle
	**/
	...
	**/
	...
	/**
		Make a new DistributedVarOp object from a sequence or iterable
	**/
	static public function _make(iterable:Dynamic, ?_new:Dynamic, ?len:Dynamic):Dynamic;
	/**
		Return a new DistributedVarOp object replacing specified fields with new values
	**/
