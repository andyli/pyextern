...
@:pythonImport("tensorflow.contrib.distribute.python.values", "AggregatingVariable") extern class AggregatingVariable {
	...
	**/
	@:native("__init__")
	public function ___init__(v:Dynamic, aggregation:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(v:Dynamic, aggregation:Dynamic):Void;
	/**
