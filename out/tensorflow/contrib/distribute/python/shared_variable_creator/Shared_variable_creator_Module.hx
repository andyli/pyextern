...
package tensorflow.contrib.distribute.python.shared_variable_creator;
@:pythonImport("tensorflow.contrib.distribute.python.shared_variable_creator") extern class Shared_variable_creator_Module {
