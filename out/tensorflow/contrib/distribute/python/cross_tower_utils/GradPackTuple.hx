...
@:pythonImport("tensorflow.contrib.distribute.python.cross_tower_utils", "GradPackTuple") extern class GradPackTuple {
	/**
		Return self+value.
	**/
	...
	**/
	...
	/**
		Create new instance of GradPackTuple(indices, vars, shapes)
	**/
	static public function __new__(_cls:Dynamic, indices:Dynamic, vars:Dynamic, shapes:Dynamic):Dynamic;
	/**
		helper for pickle
	**/
	...
	**/
	...
	/**
		Make a new GradPackTuple object from a sequence or iterable
	**/
	static public function _make(iterable:Dynamic, ?_new:Dynamic, ?len:Dynamic):Dynamic;
	/**
		Return a new GradPackTuple object replacing specified fields with new values
	**/
