...
@:pythonImport("tensorflow.contrib.distribute.python.mirrored_strategy", "MirroredExtended") extern class MirroredExtended {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(container_strategy:Dynamic, ?devices:Dynamic, ?num_gpus_per_worker:Dynamic, ?cross_device_ops:Dynamic, ?auto_shard_dataset:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(container_strategy:Dynamic, ?devices:Dynamic, ?num_gpus_per_worker:Dynamic, ?cross_device_ops:Dynamic, ?auto_shard_dataset:Dynamic):Void;
	/**
