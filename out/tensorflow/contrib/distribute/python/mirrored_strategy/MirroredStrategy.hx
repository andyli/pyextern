...
@:pythonImport("tensorflow.contrib.distribute.python.mirrored_strategy", "MirroredStrategy") extern class MirroredStrategy {
	...
	**/
	@:native("__init__")
	public function ___init__(?devices:Dynamic, ?num_gpus:Dynamic, ?num_gpus_per_worker:Dynamic, ?cross_device_ops:Dynamic, ?auto_shard_dataset:Dynamic, ?cross_tower_ops:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(?devices:Dynamic, ?num_gpus:Dynamic, ?num_gpus_per_worker:Dynamic, ?cross_device_ops:Dynamic, ?auto_shard_dataset:Dynamic, ?cross_tower_ops:Dynamic):Void;
	/**
