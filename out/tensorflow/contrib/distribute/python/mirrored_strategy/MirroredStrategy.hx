...
@:pythonImport("tensorflow.contrib.distribute.python.mirrored_strategy", "MirroredStrategy") extern class MirroredStrategy {
	/**
		A thread that runs() a function on a device.
	**/
	static public function _MirroredTowerThread(dist:Dynamic, coord:Dynamic, device:Dynamic, variable_creator_fn:Dynamic, fn:Dynamic, ?args:python.VarArgs<Dynamic>, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	...
	**/
	@:native("__init__")
	public function ___init__(?devices:Dynamic, ?num_gpus:Dynamic, ?num_gpus_per_worker:Dynamic, ?cross_tower_ops:Dynamic, ?prefetch_on_device:Dynamic, ?auto_shard_dataset:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(?devices:Dynamic, ?num_gpus:Dynamic, ?num_gpus_per_worker:Dynamic, ?cross_tower_ops:Dynamic, ?prefetch_on_device:Dynamic, ?auto_shard_dataset:Dynamic):Void;
	/**
	...
	**/
	...
	public function _get_cross_tower_ops():Dynamic;
	public function _get_devices_from(?colocate_with:Dynamic):Dynamic;
	/**
		Initializes the object for local training.
	**/
	public function _initialize_local(num_gpus:Dynamic, devices:Dynamic):Dynamic;
	/**
		Initializes the object for multi-worker training.
	**/
	public function _initialize_multi_worker(num_gpus:Dynamic, cluster_spec:Dynamic):Dynamic;
