...
@:pythonImport("tensorflow.contrib.distribute.python.prefetching_ops_v2", "_PrefetchToDeviceDataset") extern class _PrefetchToDeviceDataset {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(input_dataset:Dynamic, devices:Dynamic, buffer_size:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(input_dataset:Dynamic, devices:Dynamic, buffer_size:Dynamic):Void;
	/**
