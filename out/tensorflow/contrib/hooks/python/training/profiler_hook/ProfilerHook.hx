...
package tensorflow.contrib.hooks.python.training.profiler_hook;
@:pythonImport("tensorflow.contrib.hooks.python.training.profiler_hook", "ProfilerHook") extern class ProfilerHook {
	...
	**/
	@:native("__init__")
	public function ___init__(?save_steps:Dynamic, ?save_secs:Dynamic, ?output_dir:Dynamic, ?show_dataflow:Dynamic, ?show_memory:Dynamic):Dynamic;
	/**
		Initializes a hook that takes periodic profiling snapshots.
		...
		Args:
		  ...
		  show_memory: `bool`, if True, add object snapshot events to the trace
		      showing the sizes and lifetimes of tensors.
	**/
	public function new(?save_steps:Dynamic, ?save_secs:Dynamic, ?output_dir:Dynamic, ?show_dataflow:Dynamic, ?show_memory:Dynamic):Void;
	/**
	...
	**/
	...
	public function _save(step:Dynamic, save_path:Dynamic, step_stats:Dynamic):Dynamic;
	/**
