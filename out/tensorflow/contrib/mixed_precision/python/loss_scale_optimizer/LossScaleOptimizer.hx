...
package tensorflow.contrib.mixed_precision.python.loss_scale_optimizer;
@:pythonImport("tensorflow.contrib.mixed_precision.python.loss_scale_optimizer", "LossScaleOptimizer") extern class LossScaleOptimizer {
	...
	**/
	@:native("__init__")
	public function ___init__(opt:Dynamic, loss_scale_manager:Dynamic):Dynamic;
	/**
		Construct a loss scaling optimizer.
		...
		Args:
		  ...
		  loss_scale_manager: A LossScaleManager object.
	**/
	public function new(opt:Dynamic, loss_scale_manager:Dynamic):Void;
	/**
	...
	**/
	...
	public function _down_scale(grads_vars:Dynamic, loss_scale:Dynamic):Dynamic;
	/**
