...
@:pythonImport("tensorflow.contrib.layers.python.layers.feature_column", "_SparseColumnKeys") extern class _SparseColumnKeys {
	/**
		Return self+value.
	**/
	...
	**/
	static public function __new__(cls:Dynamic, column_name:Dynamic, keys:Dynamic, ?default_value:Dynamic, ?combiner:Dynamic):Dynamic;
	/**
		helper for pickle
	**/
