...
@:pythonImport("tensorflow.contrib.layers.python.layers.feature_column", "_HashedEmbeddingColumn") extern class _HashedEmbeddingColumn {
	/**
		Return self+value.
	**/
	...
	**/
	...
	/**
		Create new instance of _HashedEmbeddingColumn(column_name, size, dimension, combiner, initializer)
	**/
	static public function __new__(cls:Dynamic, column_name:Dynamic, size:Dynamic, dimension:Dynamic, ?combiner:Dynamic, ?initializer:Dynamic):Dynamic;
	/**
		helper for pickle
	**/
	...
	**/
	...
	/**
		Make a new _HashedEmbeddingColumn object from a sequence or iterable
	**/
	static public function _make(iterable:Dynamic, ?_new:Dynamic, ?len:Dynamic):Dynamic;
	/**
		Return a new _HashedEmbeddingColumn object replacing specified fields with new values
	**/
