...
@:pythonImport("tensorflow.contrib.layers.python.layers.feature_column", "DataFrameColumn") extern class DataFrameColumn {
	/**
		Return self+value.
	**/
	...
	**/
	static public function __new__(cls:Dynamic, column_name:Dynamic, series:Dynamic):Dynamic;
	/**
		helper for pickle
	**/
