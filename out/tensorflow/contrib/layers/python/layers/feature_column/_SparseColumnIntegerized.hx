...
@:pythonImport("tensorflow.contrib.layers.python.layers.feature_column", "_SparseColumnIntegerized") extern class _SparseColumnIntegerized {
	/**
		Return self+value.
	**/
	...
	**/
	static public function __new__(cls:Dynamic, column_name:Dynamic, bucket_size:Dynamic, ?combiner:Dynamic, ?dtype:Dynamic):Dynamic;
	/**
		helper for pickle
	**/
