...
@:pythonImport("tensorflow.contrib.layers.python.layers.feature_column", "_SparseColumnHashed") extern class _SparseColumnHashed {
	/**
	...
	**/
	static public function __new__(cls:Dynamic, column_name:Dynamic, ?is_integerized:Dynamic, ?bucket_size:Dynamic, ?lookup_config:Dynamic, ?combiner:Dynamic, ?dtype:Dynamic, ?hash_keys:Dynamic):Dynamic;
	/**
		helper for pickle
	**/
	...
	**/
	...
	public function _do_transform(input_tensor:Dynamic):Dynamic;
