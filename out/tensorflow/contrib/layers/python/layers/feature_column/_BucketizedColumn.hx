...
@:pythonImport("tensorflow.contrib.layers.python.layers.feature_column", "_BucketizedColumn") extern class _BucketizedColumn {
	/**
	...
	**/
	static public function __new__(cls:Dynamic, source_column:Dynamic, boundaries:Dynamic):Dynamic;
	/**
		helper for pickle
	**/
	...
	**/
	...
	/**
		Make a new _BucketizedColumn object from a sequence or iterable
	**/
	...
	**/
	public function to_sparse_tensor(input_tensor:Dynamic):Dynamic;
}