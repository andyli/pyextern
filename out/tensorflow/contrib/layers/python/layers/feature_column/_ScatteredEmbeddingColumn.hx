...
@:pythonImport("tensorflow.contrib.layers.python.layers.feature_column", "_ScatteredEmbeddingColumn") extern class _ScatteredEmbeddingColumn {
	/**
		Return self+value.
	**/
	...
	**/
	static public function __new__(cls:Dynamic, column_name:Dynamic, size:Dynamic, dimension:Dynamic, hash_key:Dynamic, ?combiner:Dynamic, ?initializer:Dynamic):Dynamic;
	/**
		helper for pickle
	**/
	...
	**/
	...
	/**
		Make a new _ScatteredEmbeddingColumn object from a sequence or iterable
	**/
	...
	**/
	...
	/**
		Return a new _ScatteredEmbeddingColumn object replacing specified fields with new values
	**/
