...
@:pythonImport("tensorflow.contrib.layers.python.layers.layers", "GDN") extern class GDN {
	/**
	...
	**/
	...
	@:native("__init__")
	public function ___init__(?inverse:Dynamic, ?beta_min:Dynamic, ?gamma_init:Dynamic, ?reparam_offset:Dynamic, ?data_format:Dynamic, ?activity_regularizer:Dynamic, ?trainable:Dynamic, ?name:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	public function new(?inverse:Dynamic, ?beta_min:Dynamic, ?gamma_init:Dynamic, ?reparam_offset:Dynamic, ?data_format:Dynamic, ?activity_regularizer:Dynamic, ?trainable:Dynamic, ?name:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Void;
	/**
	...
	**/
	...
	public function _channel_axis():Dynamic;
	/**
	...
	**/
	static public function _lower_bound(inputs:Dynamic, bound:Dynamic, ?name:Dynamic):Dynamic;
	/**
	...
	**/
	static public function _lower_bound_grad(op:Dynamic, grad:Dynamic):Dynamic;
