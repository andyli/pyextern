...
@:pythonImport("tensorflow.contrib.layers.python.layers.utils", "NamedOutputs") extern class NamedOutputs {
	/**
		Return self+value.
	**/
	...
	**/
	...
	/**
		Create new instance of NamedOutputs(name, outputs)
	**/
	static public function __new__(_cls:Dynamic, name:Dynamic, outputs:Dynamic):Dynamic;
	/**
		helper for pickle
	**/
	...
	**/
	...
	/**
		Make a new NamedOutputs object from a sequence or iterable
	**/
	static public function _make(iterable:Dynamic, ?_new:Dynamic, ?len:Dynamic):Dynamic;
	/**
		Return a new NamedOutputs object replacing specified fields with new values
	**/
