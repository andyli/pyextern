...
@:pythonImport("tensorflow.contrib.layers.python.layers.rev_block_lib", "RevBlock") extern class RevBlock {
	/**
	...
	**/
	...
	@:native("__init__")
	public function ___init__(f:Dynamic, g:Dynamic, ?num_layers:Dynamic, ?f_side_input:Dynamic, ?g_side_input:Dynamic, ?use_efficient_backprop:Dynamic, ?name:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	public function new(f:Dynamic, g:Dynamic, ?num_layers:Dynamic, ?f_side_input:Dynamic, ?g_side_input:Dynamic, ?use_efficient_backprop:Dynamic, ?name:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Void;
	/**
	...
	**/
	public function _backward(y1:Dynamic, y2:Dynamic):Dynamic;
	/**
	...
	**/
	public function _forward(x1:Dynamic, x2:Dynamic):Dynamic;
	/**
	...
	**/
	...
	public function _make_efficient_grad_fn(inputs_:Dynamic, ys_:Dynamic):Dynamic;
	...
	**/
	...
	public function backward(y1:Dynamic, y2:Dynamic):Dynamic;
	/**
	...
	**/
	public function call(inputs:Dynamic, ?forward:Dynamic):Dynamic;
	/**
	...
	**/
	...
	public function forward(x1:Dynamic, x2:Dynamic):Dynamic;
	/**
