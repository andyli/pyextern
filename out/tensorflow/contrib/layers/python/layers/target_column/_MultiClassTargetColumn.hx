...
@:pythonImport("tensorflow.contrib.layers.python.layers.target_column", "_MultiClassTargetColumn") extern class _MultiClassTargetColumn {
	...
	**/
	@:native("__init__")
	public function ___init__(loss_fn:Dynamic, n_classes:Dynamic, label_name:Dynamic, weight_column_name:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(loss_fn:Dynamic, n_classes:Dynamic, label_name:Dynamic, weight_column_name:Dynamic):Void;
	/**
		Return self<=value.
	**/
