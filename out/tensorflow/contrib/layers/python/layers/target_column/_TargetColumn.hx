...
@:pythonImport("tensorflow.contrib.layers.python.layers.target_column", "_TargetColumn") extern class _TargetColumn {
	...
	**/
	@:native("__init__")
	public function ___init__(loss_fn:Dynamic, num_label_columns:Dynamic, label_name:Dynamic, weight_column_name:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(loss_fn:Dynamic, num_label_columns:Dynamic, label_name:Dynamic, weight_column_name:Dynamic):Void;
	/**
		Return self<=value.
	**/
