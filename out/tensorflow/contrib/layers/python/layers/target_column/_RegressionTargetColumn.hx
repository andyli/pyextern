...
@:pythonImport("tensorflow.contrib.layers.python.layers.target_column", "_RegressionTargetColumn") extern class _RegressionTargetColumn {
	...
	**/
	@:native("__init__")
	public function ___init__(loss_fn:Dynamic, label_name:Dynamic, weight_column_name:Dynamic, label_dimension:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(loss_fn:Dynamic, label_name:Dynamic, weight_column_name:Dynamic, label_dimension:Dynamic):Void;
	/**
