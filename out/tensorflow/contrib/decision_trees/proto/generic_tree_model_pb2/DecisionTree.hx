...
@:pythonImport("tensorflow.contrib.decision_trees.proto.generic_tree_model_pb2", "DecisionTree") extern class DecisionTree {
	/**
	...
	**/
	...
	/**
		Field tensorflow.decision_trees.DecisionTree.additional_data
	**/
	public var additional_data : Dynamic;
	/**
		Field tensorflow.decision_trees.DecisionTree.nodes
	**/
