...
@:pythonImport("tensorflow.contrib.decision_trees.proto.generic_tree_model_pb2", "Averaging") extern class Averaging {
	/**
	...
	**/
	...
	/**
		Field tensorflow.decision_trees.Averaging.additional_data
	**/
