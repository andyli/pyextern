...
@:pythonImport("tensorflow.contrib.decision_trees.proto.generic_tree_model_pb2", "FeatureId") extern class FeatureId {
	/**
	...
	**/
	...
	/**
		Field tensorflow.decision_trees.FeatureId.additional_data
	**/
	public var additional_data : Dynamic;
	/**
		Field tensorflow.decision_trees.FeatureId.id
	**/
