...
@:pythonImport("tensorflow.contrib.decision_trees.proto.generic_tree_model_pb2", "InequalityTest") extern class InequalityTest {
	/**
	...
	**/
	...
	static public var GREATER_OR_EQUAL : Dynamic;
	...
	**/
	...
	static public var LESS_OR_EQUAL : Dynamic;
