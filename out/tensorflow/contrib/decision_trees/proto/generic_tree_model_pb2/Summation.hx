...
@:pythonImport("tensorflow.contrib.decision_trees.proto.generic_tree_model_pb2", "Summation") extern class Summation {
	/**
	...
	**/
	...
	/**
		Field tensorflow.decision_trees.Summation.additional_data
	**/
