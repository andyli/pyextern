...
@:pythonImport("tensorflow.contrib.seq2seq.python.ops.beam_search_decoder", "FinalBeamSearchDecoderOutput") extern class FinalBeamSearchDecoderOutput {
	/**
		Return self+value.
	**/
	...
	**/
	static public function __new__(_cls:Dynamic, predicted_ids:Dynamic, beam_search_decoder_output:Dynamic):Dynamic;
	/**
		helper for pickle
	**/
	...
	**/
	...
	/**
		Make a new FinalBeamDecoderOutput object from a sequence or iterable
	**/
	static public function _make(iterable:Dynamic, ?_new:Dynamic, ?len:Dynamic):Dynamic;
	/**
		Return a new FinalBeamDecoderOutput object replacing specified fields with new values
	**/
	...
	**/
	public var beam_search_decoder_output : Dynamic;
	/**
	...
	**/
	public var predicted_ids : Dynamic;
}