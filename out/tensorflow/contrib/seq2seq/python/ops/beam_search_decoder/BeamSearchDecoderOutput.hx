...
@:pythonImport("tensorflow.contrib.seq2seq.python.ops.beam_search_decoder", "BeamSearchDecoderOutput") extern class BeamSearchDecoderOutput {
	/**
		Return self+value.
	**/
	...
	**/
	static public function __new__(_cls:Dynamic, scores:Dynamic, predicted_ids:Dynamic, parent_ids:Dynamic):Dynamic;
	/**
		helper for pickle
	**/
	...
	**/
	...
	/**
		Make a new BeamSearchDecoderOutput object from a sequence or iterable
	**/
	static public function _make(iterable:Dynamic, ?_new:Dynamic, ?len:Dynamic):Dynamic;
	/**
		Return a new BeamSearchDecoderOutput object replacing specified fields with new values
	**/
