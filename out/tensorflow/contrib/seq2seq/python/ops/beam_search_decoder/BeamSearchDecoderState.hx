...
@:pythonImport("tensorflow.contrib.seq2seq.python.ops.beam_search_decoder", "BeamSearchDecoderState") extern class BeamSearchDecoderState {
	/**
		Return self+value.
	**/
	...
	**/
	...
	/**
		Make a new BeamSearchDecoderState object from a sequence or iterable
	**/
	...
	**/
	public var lengths : Dynamic;
	/**
		Alias for field number 1
	**/
	public var log_probs : Dynamic;
}