...
@:pythonImport("tensorflow.contrib.seq2seq.python.ops.attention_wrapper", "AttentionWrapper") extern class AttentionWrapper {
	...
	**/
	@:native("__init__")
	public function ___init__(cell:Dynamic, attention_mechanism:Dynamic, ?attention_layer_size:Dynamic, ?alignment_history:Dynamic, ?cell_input_fn:Dynamic, ?output_attention:Dynamic, ?initial_cell_state:Dynamic, ?name:Dynamic, ?attention_layer:Dynamic):Dynamic;
	/**
		Construct the `AttentionWrapper`.
		...
		**NOTE** If you are using the `BeamSearchDecoder` with a cell wrapped in
		...
		Raises:
		  ...
		  ValueError: if `attention_layer_size` is not None, `attention_mechanism`
		    ...
		    if `attention_layer_size` and `attention_layer` are set simultaneously.
	**/
	public function new(cell:Dynamic, attention_mechanism:Dynamic, ?attention_layer_size:Dynamic, ?alignment_history:Dynamic, ?cell_input_fn:Dynamic, ?output_attention:Dynamic, ?initial_cell_state:Dynamic, ?name:Dynamic, ?attention_layer:Dynamic):Void;
	/**
	...
	**/
	...
	public function _batch_size_checks(batch_size:Dynamic, error_message:Dynamic):Dynamic;
	/**
	...
	**/
	public function _item_or_tuple(seq:Dynamic):Dynamic;
	/**
