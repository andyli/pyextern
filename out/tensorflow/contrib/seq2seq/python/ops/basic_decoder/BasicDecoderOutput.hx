...
@:pythonImport("tensorflow.contrib.seq2seq.python.ops.basic_decoder", "BasicDecoderOutput") extern class BasicDecoderOutput {
	/**
		Return self+value.
	**/
	...
	**/
	static public function __new__(_cls:Dynamic, rnn_output:Dynamic, sample_id:Dynamic):Dynamic;
	/**
		helper for pickle
	**/
	...
	**/
	...
	/**
		Make a new BasicDecoderOutput object from a sequence or iterable
	**/
	static public function _make(iterable:Dynamic, ?_new:Dynamic, ?len:Dynamic):Dynamic;
	/**
		Return a new BasicDecoderOutput object replacing specified fields with new values
	**/
	...
	**/
	public var rnn_output : Dynamic;
	/**
		Alias for field number 1
	**/
	public var sample_id : Dynamic;
}