...
package tensorflow.contrib.stateless.gen_stateless_random_ops;
@:pythonImport("tensorflow.contrib.stateless.gen_stateless_random_ops") extern class Gen_stateless_random_ops_Module {
