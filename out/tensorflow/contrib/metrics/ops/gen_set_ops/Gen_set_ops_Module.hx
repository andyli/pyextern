...
@:pythonImport("tensorflow.contrib.metrics.ops.gen_set_ops") extern class Gen_set_ops_Module {
	static public function _InitOpDefLibrary():Dynamic;
	static public var __builtins__ : Dynamic;
	static public var __cached__ : Dynamic;
	static public var __dense_to_dense_set_operation_outputs : Dynamic;
	static public var __dense_to_sparse_set_operation_outputs : Dynamic;
	static public var __doc__ : Dynamic;
	static public var __file__ : Dynamic;
	static public var __loader__ : Dynamic;
	static public var __name__ : Dynamic;
	static public var __package__ : Dynamic;
	static public var __set_size_outputs : Dynamic;
	static public var __sparse_to_sparse_set_operation_outputs : Dynamic;
	...
	**/
	static public function _dense_to_dense_set_operation(set1:Dynamic, set2:Dynamic, set_operation:Dynamic, ?validate_indices:Dynamic, ?name:Dynamic):Dynamic;
	/**
		...
		Returns:
		  ...
		  result_shape: A `Tensor` of type `int64`. 1D `Tensor` shape of a `SparseTensor`. `result_shape[0...n-1]` is
		    ...
		    is the max result set size across all `0...n-1` dimensions.
	**/
	static public function _dense_to_sparse_set_operation(set1:Dynamic, set2_indices:Dynamic, set2_values:Dynamic, set2_shape:Dynamic, set_operation:Dynamic, ?validate_indices:Dynamic, ?name:Dynamic):Dynamic;
	...
	**/
	static public function _set_size(set_indices:Dynamic, set_values:Dynamic, set_shape:Dynamic, ?validate_indices:Dynamic, ?name:Dynamic):Dynamic;
	/**
		...
		Returns:
		  ...
		  result_shape: A `Tensor` of type `int64`. 1D `Tensor` shape of a `SparseTensor`. `result_shape[0...n-1]` is
		    ...
		    is the max result set size across all `0...n-1` dimensions.
	**/
	static public function _sparse_to_sparse_set_operation(set1_indices:Dynamic, set1_values:Dynamic, set1_shape:Dynamic, set2_indices:Dynamic, set2_values:Dynamic, set2_shape:Dynamic, set_operation:Dynamic, ?validate_indices:Dynamic, ?name:Dynamic):Dynamic;
}