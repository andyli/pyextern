...
package tensorflow.contrib.tensorrt.python.trt_convert;
@:pythonImport("tensorflow.contrib.tensorrt.python.trt_convert") extern class Trt_convert_Module {
	...
	static public function calib_convert(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	...
	static public function get_linked_tensorrt_version(args:haxe.extern.Rest<Dynamic>):Dynamic;
	static public function get_loaded_tensorrt_version(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	static public function get_tensorrt_rewriter_config(?rewriter_config:Dynamic, ?max_batch_size:Dynamic, ?max_workspace_size_bytes:Dynamic, ?precision_mode:Dynamic, ?minimum_segment_size:Dynamic, ?is_dynamic_op:Dynamic, ?maximum_cached_engines:Dynamic, ?cached_engine_batch_sizes:Dynamic, ?use_calibration:Dynamic):Dynamic;
