...
@:pythonImport("tensorflow.contrib.tensorrt.python.trt_convert") extern class Trt_convert_Module {
	...
	**/
	static public function tensorrt_rewriter_config(?max_batch_size:Dynamic, ?max_workspace_size_bytes:Dynamic, ?precision_mode:Dynamic, ?minimum_segment_size:Dynamic, ?is_dynamic_op:Dynamic, ?maximum_cached_engines:Dynamic, ?cached_engine_batch_sizes:Dynamic):Dynamic;
}