...
@:pythonImport("tensorflow.contrib.data.python.ops.dataset_ops", "PaddedBatchDataset") extern class PaddedBatchDataset {
	...
	**/
	...
	public function _default_padding(input_dataset:Dynamic):Dynamic;
	/**
