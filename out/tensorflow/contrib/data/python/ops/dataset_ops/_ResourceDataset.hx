...
@:pythonImport("tensorflow.contrib.data.python.ops.dataset_ops", "_ResourceDataset") extern class _ResourceDataset {
	...
	**/
	@:native("__init__")
	public function ___init__(dataset_resource:Dynamic, output_types:Dynamic, output_shapes:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(dataset_resource:Dynamic, output_types:Dynamic, output_shapes:Dynamic):Void;
	/**
