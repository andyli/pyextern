...
@:pythonImport("tensorflow.contrib.data.python.ops.dataset_ops", "SparseTensorSliceDataset") extern class SparseTensorSliceDataset {
	...
	**/
	@:native("__init__")
	public function ___init__(sparse_tensor:Dynamic):Dynamic;
	/**
		See `Dataset.from_sparse_tensor_slices()` for details.
	**/
	public function new(sparse_tensor:Dynamic):Void;
	/**
