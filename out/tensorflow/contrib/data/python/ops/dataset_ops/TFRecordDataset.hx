...
@:pythonImport("tensorflow.contrib.data.python.ops.dataset_ops", "TFRecordDataset") extern class TFRecordDataset {
	...
	**/
	@:native("__init__")
	public function ___init__(filenames:Dynamic, ?compression_type:Dynamic):Dynamic;
	/**
		Creates a `TFRecordDataset`.
		...
		Args:
		  ...
		  compression_type: A `tf.string` scalar evaluating to one of `""` (no
		    compression), `"ZLIB"`, or `"GZIP"`.
	**/
	public function new(filenames:Dynamic, ?compression_type:Dynamic):Void;
	/**
