...
@:pythonImport("tensorflow.contrib.data.python.ops.dataset_ops", "MapDataset") extern class MapDataset {
	...
	**/
	@:native("__init__")
	public function ___init__(input_dataset:Dynamic, map_func:Dynamic, ?num_threads:Dynamic, ?output_buffer_size:Dynamic):Dynamic;
	/**
		See `Dataset.map()` for details.
	**/
	public function new(input_dataset:Dynamic, map_func:Dynamic, ?num_threads:Dynamic, ?output_buffer_size:Dynamic):Void;
	/**
