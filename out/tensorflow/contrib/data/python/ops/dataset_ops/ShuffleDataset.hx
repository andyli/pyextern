...
@:pythonImport("tensorflow.contrib.data.python.ops.dataset_ops", "ShuffleDataset") extern class ShuffleDataset {
	...
	**/
	@:native("__init__")
	public function ___init__(input_dataset:Dynamic, buffer_size:Dynamic, ?seed:Dynamic):Dynamic;
	/**
		See `Dataset.shuffle()` for details.
	**/
	public function new(input_dataset:Dynamic, buffer_size:Dynamic, ?seed:Dynamic):Void;
	/**
