...
@:pythonImport("tensorflow.contrib.data.python.ops.dataset_ops", "FixedLengthRecordDataset") extern class FixedLengthRecordDataset {
	...
	**/
	@:native("__init__")
	public function ___init__(filenames:Dynamic, record_bytes:Dynamic, ?header_bytes:Dynamic, ?footer_bytes:Dynamic):Dynamic;
	/**
		Creates a `FixedLengthRecordDataset`.
		...
		Args:
		  ...
		  footer_bytes: (Optional.) A `tf.int64` scalar representing the number of
		    bytes to ignore at the end of a file.
	**/
	public function new(filenames:Dynamic, record_bytes:Dynamic, ?header_bytes:Dynamic, ?footer_bytes:Dynamic):Void;
	/**
