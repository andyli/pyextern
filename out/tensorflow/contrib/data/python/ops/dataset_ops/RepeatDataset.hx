...
@:pythonImport("tensorflow.contrib.data.python.ops.dataset_ops", "RepeatDataset") extern class RepeatDataset {
	...
	**/
	@:native("__init__")
	public function ___init__(input_dataset:Dynamic, count:Dynamic):Dynamic;
	/**
		See `Dataset.repeat()` for details.
	**/
	public function new(input_dataset:Dynamic, count:Dynamic):Void;
	/**
