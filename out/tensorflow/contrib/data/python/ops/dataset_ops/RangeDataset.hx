...
@:pythonImport("tensorflow.contrib.data.python.ops.dataset_ops", "RangeDataset") extern class RangeDataset {
	...
	**/
	...
	public function _parse_args(?args:python.VarArgs<Dynamic>):Dynamic;
	/**
