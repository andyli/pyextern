...
@:pythonImport("tensorflow.contrib.data.python.ops.sliding", "_SlideDataset") extern class _SlideDataset {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(input_dataset:Dynamic, window_size:Dynamic, window_shift:Dynamic, window_stride:Dynamic):Dynamic;
	/**
		See `sliding_window_batch` for details.
	**/
	public function new(input_dataset:Dynamic, window_size:Dynamic, window_shift:Dynamic, window_stride:Dynamic):Void;
	/**
