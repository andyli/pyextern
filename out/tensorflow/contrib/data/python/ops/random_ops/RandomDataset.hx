...
package tensorflow.contrib.data.python.ops.random_ops;
@:pythonImport("tensorflow.contrib.data.python.ops.random_ops", "RandomDataset") extern class RandomDataset {
	/**
