...
package tensorflow.contrib.data.python.ops.iterator_ops;
@:pythonImport("tensorflow.contrib.data.python.ops.iterator_ops", "CheckpointInputPipelineHook") extern class CheckpointInputPipelineHook {
