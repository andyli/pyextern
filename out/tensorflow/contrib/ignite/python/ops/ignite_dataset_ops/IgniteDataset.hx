...
@:pythonImport("tensorflow.contrib.ignite.python.ops.ignite_dataset_ops", "IgniteDataset") extern class IgniteDataset {
	/**
	...
	**/
	...
	/**
		Create a IgniteDataset. (deprecated)
		
		Warning: THIS FUNCTION IS DEPRECATED. It will be removed in a future version.
		Instructions for updating:
		tf.contrib.ignite will be removed in 2.0, the support for Apache Ignite will continue to be provided through the tensorflow/io GitHub project.
	...
	**/
	@:native("__init__")
	public function ___init__(cache_name:Dynamic, ?host:Dynamic, ?port:Dynamic, ?local:Dynamic, ?part:Dynamic, ?page_size:Dynamic, ?username:Dynamic, ?password:Dynamic, ?certfile:Dynamic, ?keyfile:Dynamic, ?cert_password:Dynamic):Dynamic;
	/**
		Create a IgniteDataset. (deprecated)
		...
		Args:
		  ...
		  cert_password: Password to be used if the private key is encrypted and a
		    password is necessary.
	**/
	public function new(cache_name:Dynamic, ?host:Dynamic, ?port:Dynamic, ?local:Dynamic, ?part:Dynamic, ?page_size:Dynamic, ?username:Dynamic, ?password:Dynamic, ?certfile:Dynamic, ?keyfile:Dynamic, ?cert_password:Dynamic):Void;
	/**
