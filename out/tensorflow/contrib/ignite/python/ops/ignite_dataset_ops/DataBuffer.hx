...
@:pythonImport("tensorflow.contrib.ignite.python.ops.ignite_dataset_ops", "DataBuffer") extern class DataBuffer {
	...
	**/
	@:native("__init__")
	public function ___init__(data_buffer:Dynamic):Dynamic;
	/**
		Constructs a new instance based on the specified byte  buffer.
		...
		Args:
		  data_buffer: Buffer to be read.
	**/
	public function new(data_buffer:Dynamic):Void;
	/**
