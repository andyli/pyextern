...
@:pythonImport("tensorflow.contrib.session_bundle.manifest_pb2", "RegressionSignature") extern class RegressionSignature {
	/**
	...
	**/
	...
	/**
		Field tensorflow.serving.RegressionSignature.input
	**/
	public var input : Dynamic;
	/**
		Field tensorflow.serving.RegressionSignature.output
	**/
