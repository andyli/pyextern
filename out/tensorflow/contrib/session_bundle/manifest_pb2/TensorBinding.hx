...
@:pythonImport("tensorflow.contrib.session_bundle.manifest_pb2", "TensorBinding") extern class TensorBinding {
	...
	**/
	...
	/**
		Magic attribute generated for "tensor_name" proto field.
	**/
