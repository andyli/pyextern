...
@:pythonImport("tensorflow.contrib.session_bundle.manifest_pb2", "AssetFile") extern class AssetFile {
	...
	**/
	...
	static public var TENSOR_BINDING_FIELD_NUMBER : Dynamic;
	/**
	...
	**/
	...
	/**
		Magic attribute generated for "filename" proto field.
	**/
	public var filename : Dynamic;
	/**
		Magic attribute generated for "tensor_binding" proto field.
	**/
	public var tensor_binding : Dynamic;
}