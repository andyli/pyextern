...
@:pythonImport("tensorflow.contrib.session_bundle.manifest_pb2", "GenericSignature") extern class GenericSignature {
	/**
	...
	**/
	...
	static public var MAP_FIELD_NUMBER : Dynamic;
	/**
		A ProtocolMessage
	**/
	static public function MapEntry(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
