...
@:pythonImport("tensorflow.contrib.session_bundle.manifest_pb2", "Signatures") extern class Signatures {
	...
	**/
	static public function NamedSignaturesEntry(?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
	...
	**/
	...
	/**
		Magic attribute generated for "default_signature" proto field.
	**/
	public var default_signature : Dynamic;
	/**
		Magic attribute generated for "named_signatures" proto field.
	**/
