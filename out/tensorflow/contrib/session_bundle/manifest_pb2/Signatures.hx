...
@:pythonImport("tensorflow.contrib.session_bundle.manifest_pb2", "Signatures") extern class Signatures {
	/**
	...
	**/
	...
	/**
		A ProtocolMessage
	**/
	static public function NamedSignaturesEntry(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
