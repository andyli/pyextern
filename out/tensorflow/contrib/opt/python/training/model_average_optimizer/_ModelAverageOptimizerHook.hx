...
@:pythonImport("tensorflow.contrib.opt.python.training.model_average_optimizer", "_ModelAverageOptimizerHook") extern class _ModelAverageOptimizerHook {
	...
	**/
	@:native("__init__")
	public function ___init__(ma_optimizer:Dynamic, is_chief:Dynamic):Dynamic;
	/**
		Creates hook to handle ModelAverageOptimizer initialization ops.
		...
		Args:
		  ...
		  is_chief: `Bool`, whether is this a chief replica or not.
	**/
	public function new(ma_optimizer:Dynamic, is_chief:Dynamic):Void;
	/**
