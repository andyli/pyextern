...
package tensorflow.contrib.opt.python.training.model_average_optimizer;
@:pythonImport("tensorflow.contrib.opt.python.training.model_average_optimizer", "ModelAverageOptimizer") extern class ModelAverageOptimizer {
	...
	**/
	@:native("__init__")
	public function ___init__(opt:Dynamic, num_worker:Dynamic, is_chief:Dynamic, ma_custom_getter:Dynamic, ?interval_steps:Dynamic, ?use_locking:Dynamic, ?name:Dynamic):Dynamic;
	/**
		Construct a new model average optimizer.
		...
		Args:
		  ...
		  name: string. Optional name of the returned operation
	**/
	public function new(opt:Dynamic, num_worker:Dynamic, is_chief:Dynamic, ma_custom_getter:Dynamic, ?interval_steps:Dynamic, ?use_locking:Dynamic, ?name:Dynamic):Void;
	/**
	...
	**/
	public function _local_vars_update(var_list:Dynamic):Dynamic;
	/**
	...
	**/
	public function get_init_op():Dynamic;
	...
	**/
	public function make_session_run_hook():Dynamic;
	/**
