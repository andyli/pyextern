...
package tensorflow.contrib.opt.python.training.addsign;
@:pythonImport("tensorflow.contrib.opt.python.training.addsign", "AddSignOptimizer") extern class AddSignOptimizer {
	...
	**/
	@:native("__init__")
	public function ___init__(?learning_rate:Dynamic, ?alpha:Dynamic, ?beta:Dynamic, ?sign_decay_fn:Dynamic, ?use_locking:Dynamic, ?name:Dynamic):Dynamic;
	/**
		Constructs a new AddSignOptimizer object.
		...
		Args:
		  ...
		  name: Optional name for the operations created when applying gradients.
		    Defaults to "AddSignOptimizer".
	**/
	public function new(?learning_rate:Dynamic, ?alpha:Dynamic, ?beta:Dynamic, ?sign_decay_fn:Dynamic, ?use_locking:Dynamic, ?name:Dynamic):Void;
	/**
