...
@:pythonImport("tensorflow.contrib.opt.python.training.weight_decay_optimizers", "MomentumWOptimizer") extern class MomentumWOptimizer {
	...
	**/
	@:native("__init__")
	public function ___init__(weight_decay:Dynamic, learning_rate:Dynamic, momentum:Dynamic, ?use_locking:Dynamic, ?name:Dynamic, ?use_nesterov:Dynamic):Dynamic;
	/**
		Construct a new MomentumW optimizer.
		...
		@end_compatibility
	**/
	public function new(weight_decay:Dynamic, learning_rate:Dynamic, momentum:Dynamic, ?use_locking:Dynamic, ?name:Dynamic, ?use_nesterov:Dynamic):Void;
	/**
