...
@:pythonImport("tensorflow.contrib.opt.python.training.weight_decay_optimizers", "AdamWOptimizer") extern class AdamWOptimizer {
	...
	**/
	@:native("__init__")
	public function ___init__(weight_decay:Dynamic, ?learning_rate:Dynamic, ?beta1:Dynamic, ?beta2:Dynamic, ?epsilon:Dynamic, ?use_locking:Dynamic, ?name:Dynamic):Dynamic;
	/**
		Construct a new AdamW optimizer.
		...
		Args:
		  ...
		  name: Optional name for the operations created when applying gradients.
		    Defaults to "Adam".
	**/
	public function new(weight_decay:Dynamic, ?learning_rate:Dynamic, ?beta1:Dynamic, ?beta2:Dynamic, ?epsilon:Dynamic, ?use_locking:Dynamic, ?name:Dynamic):Void;
	/**
