...
package tensorflow.contrib.opt.python.training.ggt;
@:pythonImport("tensorflow.contrib.opt.python.training.ggt", "GGTOptimizer") extern class GGTOptimizer {
	...
	**/
	@:native("__init__")
	public function ___init__(?learning_rate:Dynamic, ?beta1:Dynamic, ?use_locking:Dynamic, ?name:Dynamic, ?window:Dynamic, ?eps:Dynamic, ?svd_eps:Dynamic, ?sigma_eps:Dynamic):Dynamic;
	/**
		Construct a new GGT optimizer.
		...
		Args:
		  ...
		  sigma_eps: A float hyperparameter. Used to regularize matrix inversion.
	**/
	public function new(?learning_rate:Dynamic, ?beta1:Dynamic, ?use_locking:Dynamic, ?name:Dynamic, ?window:Dynamic, ?eps:Dynamic, ?svd_eps:Dynamic, ?sigma_eps:Dynamic):Void;
	/**
	...
	**/
	...
	public function _get_flat_grad(?state:Dynamic):Dynamic;
	public function _get_global_step(?state:Dynamic):Dynamic;
	public function _get_grad_buffer(?state:Dynamic):Dynamic;
	public function _get_moment1(?state:Dynamic):Dynamic;
	...
	**/
	...
	/**
		...
		Returns:
		  An `Operation` which updates the value of the variable.
	**/
	public function _resource_apply_sparse(grad:Dynamic, handle:Dynamic, indices:Dynamic, state:Dynamic):Dynamic;
	/**
