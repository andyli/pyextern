...
package tensorflow.contrib.opt.python.training.shampoo;
@:pythonImport("tensorflow.contrib.opt.python.training.shampoo", "ShampooOptimizer") extern class ShampooOptimizer {
	...
	**/
	...
	/**
		...
		Returns:
		  An `Operation` which updates the value of the variable.
	**/
	public function _resource_apply_sparse(grad_values:Dynamic, _var:Dynamic, grad_indices:Dynamic):Dynamic;
	/**
