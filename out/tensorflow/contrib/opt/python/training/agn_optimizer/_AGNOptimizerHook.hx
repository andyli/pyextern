...
@:pythonImport("tensorflow.contrib.opt.python.training.agn_optimizer", "_AGNOptimizerHook") extern class _AGNOptimizerHook {
	...
	**/
	@:native("__init__")
	public function ___init__(agn_optimizer:Dynamic, is_chief:Dynamic, task_index:Dynamic):Dynamic;
	/**
		Creates hook to handle AGNOptimizer initialization ops.
		...
		Args:
		  ...
		  task_index: int, task_index of worker
	**/
	public function new(agn_optimizer:Dynamic, is_chief:Dynamic, task_index:Dynamic):Void;
	/**
