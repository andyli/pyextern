...
package tensorflow.contrib.opt.python.training.agn_optimizer;
@:pythonImport("tensorflow.contrib.opt.python.training.agn_optimizer", "AGNOptimizer") extern class AGNOptimizer {
	...
	**/
	@:native("__init__")
	public function ___init__(optimizer:Dynamic, num_worker:Dynamic, custom_getter:Dynamic, ?communication_period:Dynamic, ?use_locking:Dynamic, ?name:Dynamic):Dynamic;
	/**
		Construct a new AGN optimizer.
		...
		Args:
		  ...
		  name: Optional name prefix for the operations created when applying
		    gradients. Defaults to "AGNOptimizer".
	**/
	public function new(optimizer:Dynamic, num_worker:Dynamic, custom_getter:Dynamic, ?communication_period:Dynamic, ?use_locking:Dynamic, ?name:Dynamic):Void;
	/**
