...
package tensorflow.contrib.opt.python.training.drop_stale_gradient_optimizer;
@:pythonImport("tensorflow.contrib.opt.python.training.drop_stale_gradient_optimizer", "DropStaleGradientOptimizer") extern class DropStaleGradientOptimizer {
	...
	**/
	@:native("__init__")
	public function ___init__(opt:Dynamic, staleness:Dynamic, ?use_locking:Dynamic, ?name:Dynamic):Dynamic;
	/**
		Constructs a new DropStaleGradientOptimizer.
		...
		Args:
		  ...
		  name: Optional name prefix for the operations created when applying
		        gradients. Defaults to "DropStaleGradient".
	**/
	public function new(opt:Dynamic, staleness:Dynamic, ?use_locking:Dynamic, ?name:Dynamic):Void;
	/**
