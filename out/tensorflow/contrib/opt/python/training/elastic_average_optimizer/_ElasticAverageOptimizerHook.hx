...
@:pythonImport("tensorflow.contrib.opt.python.training.elastic_average_optimizer", "_ElasticAverageOptimizerHook") extern class _ElasticAverageOptimizerHook {
	...
	**/
	@:native("__init__")
	public function ___init__(ea_optimizer:Dynamic, is_chief:Dynamic, task_index:Dynamic):Dynamic;
	/**
		Creates hook to handle ElasticAverageOptimizer initialization ops.
		...
		Args:
		  ...
		  is_chief: `Bool`, whether is this a chief replica or not.
	**/
	public function new(ea_optimizer:Dynamic, is_chief:Dynamic, task_index:Dynamic):Void;
	/**
