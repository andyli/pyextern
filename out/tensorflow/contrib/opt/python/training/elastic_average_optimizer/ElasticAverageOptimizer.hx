...
@:pythonImport("tensorflow.contrib.opt.python.training.elastic_average_optimizer", "ElasticAverageOptimizer") extern class ElasticAverageOptimizer {
	...
	**/
	@:native("__init__")
	public function ___init__(opt:Dynamic, num_worker:Dynamic, ea_custom_getter:Dynamic, ?communication_period:Dynamic, ?moving_rate:Dynamic, ?rho:Dynamic, ?use_locking:Dynamic, ?synchronous:Dynamic, ?name:Dynamic):Dynamic;
	/**
		Construct a new gradient descent optimizer.
		...
		Args:
		  ...
		  name: Optional name prefix for the operations created when applying
		    gradients. Defaults to "ElasticAverageOptimizer".
	**/
	public function new(opt:Dynamic, num_worker:Dynamic, ea_custom_getter:Dynamic, ?communication_period:Dynamic, ?moving_rate:Dynamic, ?rho:Dynamic, ?use_locking:Dynamic, ?synchronous:Dynamic, ?name:Dynamic):Void;
	/**
	...
	**/
	public function get_init_op(task_index:Dynamic):Dynamic;
	...
	**/
	public function make_session_run_hook(is_chief:Dynamic, task_index:Dynamic):Dynamic;
	/**
	...
	**/
	public function swapping_saver(?var_list:Dynamic, ?name:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
