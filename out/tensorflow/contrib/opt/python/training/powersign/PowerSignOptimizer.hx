...
package tensorflow.contrib.opt.python.training.powersign;
@:pythonImport("tensorflow.contrib.opt.python.training.powersign", "PowerSignOptimizer") extern class PowerSignOptimizer {
	...
	**/
	@:native("__init__")
	public function ___init__(?learning_rate:Dynamic, ?base:Dynamic, ?beta:Dynamic, ?sign_decay_fn:Dynamic, ?use_locking:Dynamic, ?name:Dynamic):Dynamic;
	/**
		Constructs a new PowerSignOptimizer object.
		...
		Args:
		  ...
		  name: Optional name for the operations created iwhen applying gradients.
		    Defaults to "PowerSignOptimizer".
	**/
	public function new(?learning_rate:Dynamic, ?base:Dynamic, ?beta:Dynamic, ?sign_decay_fn:Dynamic, ?use_locking:Dynamic, ?name:Dynamic):Void;
	/**
