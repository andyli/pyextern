...
package tensorflow.contrib.opt.python.training.lars_optimizer;
@:pythonImport("tensorflow.contrib.opt.python.training.lars_optimizer", "LARSOptimizer") extern class LARSOptimizer {
	...
	**/
	@:native("__init__")
	public function ___init__(learning_rate:Dynamic, ?momentum:Dynamic, ?weight_decay:Dynamic, ?eeta:Dynamic, ?epsilon:Dynamic, ?name:Dynamic, ?skip_list:Dynamic, ?use_nesterov:Dynamic):Dynamic;
	/**
		Construct a new LARS Optimizer.
		...
		Raises:
		  ValueError: If a hyperparameter is set to a non-sensical value.
	**/
	public function new(learning_rate:Dynamic, ?momentum:Dynamic, ?weight_decay:Dynamic, ?eeta:Dynamic, ?epsilon:Dynamic, ?name:Dynamic, ?skip_list:Dynamic, ?use_nesterov:Dynamic):Void;
	/**
	...
	**/
	...
	public function compute_lr(grad:Dynamic, _var:Dynamic):Dynamic;
