...
package tensorflow.contrib.opt.python.training.adam_gs_optimizer;
@:pythonImport("tensorflow.contrib.opt.python.training.adam_gs_optimizer", "AdamGSOptimizer") extern class AdamGSOptimizer {
