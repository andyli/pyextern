...
package tensorflow.contrib.opt.python.training.nadam_optimizer;
@:pythonImport("tensorflow.contrib.opt.python.training.nadam_optimizer", "NadamOptimizer") extern class NadamOptimizer {
