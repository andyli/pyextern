...
package tensorflow.contrib.opt.python.training.variable_clipping_optimizer;
@:pythonImport("tensorflow.contrib.opt.python.training.variable_clipping_optimizer", "VariableClippingOptimizer") extern class VariableClippingOptimizer {
	...
	**/
	@:native("__init__")
	public function ___init__(opt:Dynamic, vars_to_clip_dims:Dynamic, max_norm:Dynamic, ?use_locking:Dynamic, ?colocate_clip_ops_with_vars:Dynamic, ?name:Dynamic):Dynamic;
	/**
		Construct a new clip-norm optimizer.
		...
		Args:
		  ...
		  name: Optional name prefix for the operations created when applying
		    gradients.  Defaults to "VariableClipping".
	**/
	public function new(opt:Dynamic, vars_to_clip_dims:Dynamic, max_norm:Dynamic, ?use_locking:Dynamic, ?colocate_clip_ops_with_vars:Dynamic, ?name:Dynamic):Void;
	/**
		Return self<=value.
	**/
	...
	**/
	...
	public function _clip_dense(_var:Dynamic):Dynamic;
	public function _clip_sparse(grad:Dynamic, _var:Dynamic):Dynamic;
	/**
	...
	**/
	public function _maybe_colocate_with(_var:Dynamic):Dynamic;
	/**
