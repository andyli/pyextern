...
package tensorflow.contrib.opt.python.training.reg_adagrad_optimizer;
@:pythonImport("tensorflow.contrib.opt.python.training.reg_adagrad_optimizer", "RegAdagradOptimizer") extern class RegAdagradOptimizer {
	...
	**/
	@:native("__init__")
	public function ___init__(learning_rate:Dynamic, ?initial_accumulator_value:Dynamic, ?use_locking:Dynamic, ?name:Dynamic):Dynamic;
	/**
		Construct a new Adagrad optimizer.
		...
		@end_compatibility
	**/
	public function new(learning_rate:Dynamic, ?initial_accumulator_value:Dynamic, ?use_locking:Dynamic, ?name:Dynamic):Void;
	/**
	...
	**/
	...
	/**
		...
		Returns:
		  An `Operation`.
	**/
	public function _apply_sparse(grad:Dynamic, _var:Dynamic, ?update_slots:Dynamic):Dynamic;
	/**
	...
	**/
	...
	public function _init_constant_op(v:Dynamic, dtype:Dynamic):Dynamic;
	/**
	...
	**/
	public function _resource_apply_dense(grad:Dynamic, _var:Dynamic, ?update_slots:Dynamic):Dynamic;
	/**
		...
		Returns:
		  An `Operation` which updates the value of the variable.
	**/
	public function _resource_apply_sparse(grad:Dynamic, _var:Dynamic, indices:Dynamic, ?update_slots:Dynamic):Dynamic;
	/**
	...
	**/
	...
	public function avoid_updating_slots():Dynamic;
	/**
