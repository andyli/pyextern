...
@:pythonImport("tensorflow.contrib.opt.python.training.multitask_optimizer_wrapper", "MultitaskOptimizerWrapper") extern class MultitaskOptimizerWrapper {
	...
	**/
	@:native("__init__")
	public function ___init__(opt:Dynamic):Dynamic;
	/**
		Constructor.
