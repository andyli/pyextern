...
package tensorflow.contrib.opt.python.training.adamax;
@:pythonImport("tensorflow.contrib.opt.python.training.adamax", "AdaMaxOptimizer") extern class AdaMaxOptimizer {
	...
	**/
	...
	public function _apply_sparse_shared(grad:Dynamic, _var:Dynamic, indices:Dynamic, scatter_add:Dynamic, scatter_update:Dynamic):Dynamic;
	/**
