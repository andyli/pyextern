...
package tensorflow.contrib.opt.python.training.moving_average_optimizer;
@:pythonImport("tensorflow.contrib.opt.python.training.moving_average_optimizer", "MovingAverageOptimizer") extern class MovingAverageOptimizer {
	...
	**/
	@:native("__init__")
	public function ___init__(opt:Dynamic, ?average_decay:Dynamic, ?num_updates:Dynamic, ?sequential_update:Dynamic):Dynamic;
	/**
		Construct a new MovingAverageOptimizer.
		...
		Args:
		  ...
		  sequential_update: Bool. If False, will compute the moving average at the
		                     ...
		                     updates.
	**/
	public function new(opt:Dynamic, ?average_decay:Dynamic, ?num_updates:Dynamic, ?sequential_update:Dynamic):Void;
	/**
