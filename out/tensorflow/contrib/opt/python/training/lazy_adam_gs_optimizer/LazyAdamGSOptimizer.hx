...
package tensorflow.contrib.opt.python.training.lazy_adam_gs_optimizer;
@:pythonImport("tensorflow.contrib.opt.python.training.lazy_adam_gs_optimizer", "LazyAdamGSOptimizer") extern class LazyAdamGSOptimizer {
	...
	**/
	@:native("__init__")
	public function ___init__(?global_step:Dynamic, ?learning_rate:Dynamic, ?beta1:Dynamic, ?beta2:Dynamic, ?epsilon:Dynamic, ?use_locking:Dynamic, ?name:Dynamic):Dynamic;
	/**
		Construct a new Adam optimizer.
		...
		@end_compatibility
	**/
	public function new(?global_step:Dynamic, ?learning_rate:Dynamic, ?beta1:Dynamic, ?beta2:Dynamic, ?epsilon:Dynamic, ?use_locking:Dynamic, ?name:Dynamic):Void;
	/**
