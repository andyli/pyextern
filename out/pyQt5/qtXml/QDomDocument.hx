...
package pyQt5.qtXml;
@:pythonImport("PyQt5.QtXml", "QDomDocument") extern class QDomDocument {
	...
	**/
	public function createAttribute(str:String):Dynamic;
	/**
		createAttributeNS(self, str, str) -> QDomAttr
	**/
	public function createAttributeNS(str:String, str:String):Dynamic;
	/**
		createCDATASection(self, str) -> QDomCDATASection
	**/
	public function createCDATASection(str:String):Dynamic;
	/**
		createComment(self, str) -> QDomComment
	**/
	public function createComment(str:String):Dynamic;
	/**
		createDocumentFragment(self) -> QDomDocumentFragment
	**/
	public function createDocumentFragment():Dynamic;
	/**
		createElement(self, str) -> QDomElement
	**/
	public function createElement(str:String):Dynamic;
	/**
		createElementNS(self, str, str) -> QDomElement
	**/
	public function createElementNS(str:String, str:String):Dynamic;
	/**
		createEntityReference(self, str) -> QDomEntityReference
	**/
	public function createEntityReference(str:String):Dynamic;
	/**
		createProcessingInstruction(self, str, str) -> QDomProcessingInstruction
	**/
	public function createProcessingInstruction(str:String, str:String):Dynamic;
	/**
		createTextNode(self, str) -> QDomText
	**/
	public function createTextNode(str:String):Dynamic;
	/**
		doctype(self) -> QDomDocumentType
	**/
	public function doctype():Dynamic;
	/**
	...
	**/
	public function elementById(str:String):Dynamic;
	/**
		elementsByTagName(self, str) -> QDomNodeList
	**/
	public function elementsByTagName(str:String):Dynamic;
	/**
		elementsByTagNameNS(self, str, str) -> QDomNodeList
	**/
	public function elementsByTagNameNS(str:String, str:String):Dynamic;
	/**
	...
	**/
	public function implementation():Dynamic;
	/**
		importNode(self, QDomNode, bool) -> QDomNode
	**/
	public function importNode(QDomNode:Dynamic, bool:Bool):Dynamic;
	/**
	...
	**/
	public function toByteArray(?indent:Dynamic):Dynamic;
	/**
	...
	**/
	public function toString(?indent:Dynamic):String;
	/**
