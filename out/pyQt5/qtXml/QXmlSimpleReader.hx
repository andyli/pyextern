...
package pyQt5.qtXml;
@:pythonImport("PyQt5.QtXml", "QXmlSimpleReader") extern class QXmlSimpleReader {
	/**
	...
	**/
	public function parse(QXmlInputSource:Dynamic, args:haxe.extern.Rest<Dynamic>):Bool;
	/**
