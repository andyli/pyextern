...
@:pythonImport("PyQt5.uic.uiparser", "UIParser") extern class UIParser {
	...
	**/
	@:native("__init__")
	public function ___init__(qtcore_module:Dynamic, qtgui_module:Dynamic, qtwidgets_module:Dynamic, creatorPolicy:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(qtcore_module:Dynamic, qtgui_module:Dynamic, qtwidgets_module:Dynamic, creatorPolicy:Dynamic):Void;
	/**
