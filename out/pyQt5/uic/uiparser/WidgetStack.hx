...
@:pythonImport("PyQt5.uic.uiparser", "WidgetStack") extern class WidgetStack {
	...
	**/
	static public function append(object:Dynamic):Dynamic;
	/**
	...
	**/
	static public function count(value:Dynamic):Dynamic;
	/**
		L.extend(iterable) -> None -- extend list by appending elements from the iterable
	**/
	static public function extend(iterable:Dynamic):Dynamic;
	/**
	...
	**/
	static public function sort(?key:Dynamic, ?reverse:Dynamic):Dynamic;
