...
@:pythonImport("PyQt5.uic.Compiler.qtproxies", "ProxyClassMember") extern class ProxyClassMember {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(proxy:Dynamic, function_name:Dynamic, flags:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(proxy:Dynamic, function_name:Dynamic, flags:Dynamic):Void;
	/**
