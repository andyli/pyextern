...
@:pythonImport("PyQt5.QtCore", "QSaveFile") extern class QSaveFile {
	...
	**/
	public function resize(int:Int):Bool;
	/**
		seek(self, int) -> bool
	**/
	...
	**/
	public function setDirectWriteFallback(bool:Bool):Void;
	/**
	...
	**/
	public function setPermissions(Union:Dynamic):Bool;
	/**
