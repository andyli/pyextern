...
@:pythonImport("PyQt5.QtCore", "QTranslator") extern class QTranslator {
	...
	**/
	public function loadFromData(bytes:Dynamic, ?directory:Dynamic):Bool;
	/**
	...
	**/
	public function translate(str:String, str:String, ?disambiguation:Dynamic, ?n:Dynamic):String;
}