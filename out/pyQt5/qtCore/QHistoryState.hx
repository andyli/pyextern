...
@:pythonImport("PyQt5.QtCore", "QHistoryState") extern class QHistoryState {
	...
	**/
	public function defaultState():Dynamic;
	/**
		defaultStateChanged(self) [signal]
	**/
	public var defaultStateChanged : Dynamic;
	/**
		defaultTransition(self) -> QAbstractTransition
	**/
	public function defaultTransition():Dynamic;
	/**
		defaultTransitionChanged(self) [signal]
	**/
	public var defaultTransitionChanged : Dynamic;
	/**
		deleteLater(self)
	**/
	...
	**/
	public function historyType():Dynamic;
	/**
		historyTypeChanged(self) [signal]
	**/
	public var historyTypeChanged : Dynamic;
	/**
	...
	**/
	public function setDefaultState(QAbstractState:Dynamic):Void;
	/**
		setDefaultTransition(self, QAbstractTransition)
	**/
	public function setDefaultTransition(QAbstractTransition:Dynamic):Void;
	/**
		setHistoryType(self, QHistoryState.HistoryType)
	**/
	public function setHistoryType(QHistoryState:Dynamic):Void;
	/**
