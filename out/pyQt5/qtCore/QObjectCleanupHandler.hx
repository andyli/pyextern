...
@:pythonImport("PyQt5.QtCore", "QObjectCleanupHandler") extern class QObjectCleanupHandler {
	...
	**/
	public function add(QObject:Dynamic):Dynamic;
	/**
	...
	**/
	...
	/**
		remove(self, QObject)
	**/
	public function remove(QObject:Dynamic):Void;
	/**
