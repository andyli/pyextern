...
@:pythonImport("PyQt5.QtCore", "QLibrary") extern class QLibrary {
	static public var DeepBindHint : Dynamic;
	static public var ExportExternalSymbolsHint : Dynamic;
	static public var LoadArchiveMemberHint : Dynamic;
	/**
		int(x=0) -> integer
		...
		4
	**/
	public function LoadHint(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
		QLibrary.LoadHints()
		QLibrary.LoadHints(Union[QLibrary.LoadHints, QLibrary.LoadHint])
		QLibrary.LoadHints(QLibrary.LoadHints)
	**/
	static public function LoadHints(args:haxe.extern.Rest<Dynamic>):Void;
	static public var PreventUnloadHint : Dynamic;
	static public var ResolveAllSymbolsHint : Dynamic;
	...
	**/
	...
	/**
		isLibrary(str) -> bool
	**/
	static public function isLibrary(str:String):Bool;
	/**
		isLoaded(self) -> bool
	**/
	...
	**/
	public function loadHints():Dynamic;
	/**
	...
	**/
	static public function resolve(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
		sender(self) -> QObject
	**/
	...
	**/
	public function setFileNameAndVersion(str:String, args:haxe.extern.Rest<Dynamic>):Void;
	/**
		setLoadHints(self, Union[QLibrary.LoadHints, QLibrary.LoadHint])
	**/
	public function setLoadHints(Union:Dynamic):Void;
	/**
