...
@:pythonImport("PyQt5.QtCore", "QResource") extern class QResource {
	...
	**/
	static public function registerResourceData(str:String, ?mapRoot:Dynamic):Bool;
	/**
	...
	**/
	static public function unregisterResourceData(str:String, ?mapRoot:Dynamic):Bool;
}