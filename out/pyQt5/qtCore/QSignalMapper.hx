...
@:pythonImport("PyQt5.QtCore", "QSignalMapper") extern class QSignalMapper {
	...
	**/
	...
	/**
		...
		map(self, QObject)
	**/
	public function map(args:haxe.extern.Rest<Dynamic>):Void;
	/**
		mapped(self, int) [signal]
		mapped(self, str) [signal]
		mapped(self, QWidget) [signal]
		mapped(self, QObject) [signal]
	**/
	public var mapped : Dynamic;
	/**
	...
	**/
	public function mapping(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	public function removeMappings(QObject:Dynamic):Void;
	/**
		sender(self) -> QObject
	**/
	...
	**/
	public function setMapping(QObject:Dynamic, args:haxe.extern.Rest<Dynamic>):Void;
	/**
