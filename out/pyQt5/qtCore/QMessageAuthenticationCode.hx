...
@:pythonImport("PyQt5.QtCore", "QMessageAuthenticationCode") extern class QMessageAuthenticationCode {
	...
	**/
	static public function hash(Union:Dynamic, Union:Dynamic, QCryptographicHash:Dynamic):Dynamic;
	/**
		reset(self)
	**/
	...
	**/
	public function setKey(Union:Dynamic):Void;
}