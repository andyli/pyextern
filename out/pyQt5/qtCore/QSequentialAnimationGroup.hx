...
@:pythonImport("PyQt5.QtCore", "QSequentialAnimationGroup") extern class QSequentialAnimationGroup {
	...
	**/
	public function addPause(int:Int):Dynamic;
	/**
		animationAt(self, int) -> QAbstractAnimation
	**/
	public function animationAt(int:Int):Dynamic;
	/**
	...
	**/
	public function currentAnimation():Dynamic;
	/**
		currentAnimationChanged(self, QAbstractAnimation) [signal]
	**/
	public var currentAnimationChanged : Dynamic;
	/**
	...
	**/
	public function indexOfAnimation(QAbstractAnimation:Dynamic):Int;
	/**
	...
	**/
	public function insertAnimation(int:Int, QAbstractAnimation:Dynamic):Void;
	/**
		insertPause(self, int, int) -> QPauseAnimation
	**/
	public function insertPause(int:Int, int:Int):Dynamic;
	/**
	...
	**/
	public function takeAnimation(int:Int):Dynamic;
	/**
		thread(self) -> QThread
	**/
