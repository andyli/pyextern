...
@:pythonImport("PyQt5.QtCore", "QSignalTransition") extern class QSignalTransition {
	...
	**/
	public function senderObject():Dynamic;
	/**
		senderObjectChanged(self) [signal]
	**/
	public var senderObjectChanged : Dynamic;
	/**
	...
	**/
	public function setSenderObject(QObject:Dynamic):Void;
	/**
		setSignal(self, Union[QByteArray, bytes, bytearray])
	**/
	public function setSignal(Union:Dynamic):Void;
	/**
	...
	**/
	public function signal():Dynamic;
	/**
		signalChanged(self) [signal]
	**/
	public var signalChanged : Dynamic;
	/**
