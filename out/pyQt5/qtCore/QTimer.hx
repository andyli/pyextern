...
@:pythonImport("PyQt5.QtCore", "QTimer") extern class QTimer {
	...
	**/
	public function setInterval(int:Int):Void;
	/**
	...
	**/
	public function setSingleShot(bool:Bool):Void;
	/**
	...
	**/
	static public function singleShot(int:Int, args:haxe.extern.Rest<Dynamic>):Void;
	/**
		start(self, int)
		start(self)
	**/
