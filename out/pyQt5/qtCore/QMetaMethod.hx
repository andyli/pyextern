...
@:pythonImport("PyQt5.QtCore", "QMetaMethod") extern class QMetaMethod {
	/**
		int(x=0) -> integer
	...
	**/
	public function access():Dynamic;
	/**
	...
	**/
	public function invoke(QObject:Dynamic, args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
		isValid(self) -> bool
	**/
	...
	**/
	public function methodSignature():Dynamic;
	/**
		methodType(self) -> QMetaMethod.MethodType
	**/
	public function methodType():Dynamic;
	/**
	...
	**/
	public function parameterNames():Dynamic;
	/**
		parameterType(self, int) -> int
	**/
	public function parameterType(int:Int):Int;
	/**
		parameterTypes(self) -> List[QByteArray]
	**/
	public function parameterTypes():Dynamic;
	/**
		returnType(self) -> int
	**/
