...
@:pythonImport("PyQt5.QtXmlPatterns", "QAbstractMessageHandler") extern class QAbstractMessageHandler {
	...
	**/
	public function handleMessage(QtMsgType:Dynamic, str:String, QUrl:Dynamic, QSourceLocation:Dynamic):Void;
	/**
	...
	**/
	public function message(QtMsgType:Dynamic, str:String, ?identifier:Dynamic, ?sourceLocation:Dynamic):Void;
	/**
