...
@:pythonImport("PyQt5.QtBluetooth", "QBluetoothServiceDiscoveryAgent") extern class QBluetoothServiceDiscoveryAgent {
	/**
		int(x=0) -> integer
		...
		4
	**/
	public function DiscoveryMode(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
		int(x=0) -> integer
		int(x, base=10) -> integer
	...
	**/
	public function discoveredServices():Dynamic;
	/**
		dumpObjectInfo(self)
	**/
	...
	**/
	public function setRemoteAddress(QBluetoothAddress:Dynamic):Bool;
	/**
		setUuidFilter(self, Iterable[QBluetoothUuid])
		setUuidFilter(self, QBluetoothUuid)
	**/
	public function setUuidFilter(args:haxe.extern.Rest<Dynamic>):Void;
	/**
	...
	**/
	public function uuidFilter():Dynamic;
}