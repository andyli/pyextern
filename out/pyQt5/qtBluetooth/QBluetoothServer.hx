...
@:pythonImport("PyQt5.QtBluetooth", "QBluetoothServer") extern class QBluetoothServer {
	/**
		int(x=0) -> integer
	...
	**/
	...
	static public var ServiceAlreadyRegisteredError : Dynamic;
	...
	**/
	public function securityFlags():Dynamic;
	/**
		sender(self) -> QObject
	**/
	...
	**/
	public function serverType():Dynamic;
	/**
	...
	**/
	public function setSecurityFlags(Union:Dynamic):Void;
	/**
