...
@:pythonImport("PyQt5.QtBluetooth", "QBluetoothTransferReply") extern class QBluetoothTransferReply {
	static public var FileNotFoundError : Dynamic;
	static public var HostNotFoundError : Dynamic;
	static public var IODeviceNotReadableError : Dynamic;
	static public var NoError : Dynamic;
	static public var ResourceBusyError : Dynamic;
	static public var SessionError : Dynamic;
	/**
		int(x=0) -> integer
		...
		4
	**/
	public function TransferError(args:haxe.extern.Rest<Dynamic>):Dynamic;
	static public var UnknownError : Dynamic;
	static public var UserCanceledTransferError : Dynamic;
	...
	**/
	public function setManager(QBluetoothTransferManager:Dynamic):Void;
	/**
	...
	**/
	public function setRequest(QBluetoothTransferRequest:Dynamic):Void;
	/**
	...
	**/
	public var transferProgress : Dynamic;
}