...
@:pythonImport("PyQt5.QtBluetooth", "QBluetoothTransferManager") extern class QBluetoothTransferManager {
	...
	**/
	public function put(QBluetoothTransferRequest:Dynamic, QIODevice:Dynamic):Dynamic;
	/**
