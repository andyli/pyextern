...
@:pythonImport("PyQt5.QtMultimedia", "QCameraInfo") extern class QCameraInfo {
	...
	**/
	static public function availableCameras(?position:Dynamic):Dynamic;
	/**
		defaultCamera() -> QCameraInfo
	**/
	static public function defaultCamera():Dynamic;
	/**
