...
@:pythonImport("PyQt5.QtMultimedia", "QAbstractVideoSurface") extern class QAbstractVideoSurface {
	/**
		int(x=0) -> integer
	...
	**/
	public function isFormatSupported(QVideoSurfaceFormat:Dynamic):Bool;
	/**
	...
	**/
	public function nativeResolution():Dynamic;
	/**
		nativeResolutionChanged(self, QSize) [signal]
	**/
	public var nativeResolutionChanged : Dynamic;
	/**
		nearestFormat(self, QVideoSurfaceFormat) -> QVideoSurfaceFormat
	**/
	public function nearestFormat(QVideoSurfaceFormat:Dynamic):Dynamic;
	/**
		objectName(self) -> str
	**/
	...
	**/
	public function present(QVideoFrame:Dynamic):Bool;
	/**
	...
	**/
	public function setError(QAbstractVideoSurface:Dynamic):Void;
	/**
		setNativeResolution(self, QSize)
	**/
	public function setNativeResolution(QSize:Dynamic):Void;
	/**
	...
	**/
	public function start(QVideoSurfaceFormat:Dynamic):Bool;
	/**
	...
	**/
	public var supportedFormatsChanged : Dynamic;
	/**
	...
	**/
	public function supportedPixelFormats(?type:Dynamic):Dynamic;
	/**
		surfaceFormat(self) -> QVideoSurfaceFormat
	**/
	public function surfaceFormat():Dynamic;
	/**
		surfaceFormatChanged(self, QVideoSurfaceFormat) [signal]
	**/
	public var surfaceFormatChanged : Dynamic;
	/**
		thread(self) -> QThread
	**/
