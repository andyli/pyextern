...
@:pythonImport("PyQt5.QtMultimedia", "QCameraFocus") extern class QCameraFocus {
	static public var AutoFocus : Dynamic;
	static public var ContinuousFocus : Dynamic;
	/**
		int(x=0) -> integer
		...
		4
	**/
	public function FocusMode(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	static public function FocusModes(args:haxe.extern.Rest<Dynamic>):Void;
	static public var FocusPointAuto : Dynamic;
	static public var FocusPointCenter : Dynamic;
	static public var FocusPointCustom : Dynamic;
	static public var FocusPointFaceDetection : Dynamic;
	/**
		int(x=0) -> integer
		int(x, base=10) -> integer
		...
		4
	**/
	public function FocusPointMode(args:haxe.extern.Rest<Dynamic>):Dynamic;
	static public var HyperfocalFocus : Dynamic;
	static public var InfinityFocus : Dynamic;
	static public var MacroFocus : Dynamic;
	static public var ManualFocus : Dynamic;
	...
	**/
	public function customFocusPoint():Dynamic;
	/**
		deleteLater(self)
	**/
	...
	**/
	public var digitalZoomChanged : Dynamic;
	/**
		disconnect(self)
	**/
	...
	**/
	public function focusMode():Dynamic;
	/**
		focusPointMode(self) -> QCameraFocus.FocusPointMode
	**/
	public function focusPointMode():Dynamic;
	/**
		focusZones(self) -> object
	**/
	public function focusZones():Dynamic;
	/**
		focusZonesChanged(self) [signal]
	**/
	public var focusZonesChanged : Dynamic;
	/**
	...
	**/
	public function isFocusModeSupported(QCameraFocus:Dynamic):Bool;
	/**
		isFocusPointModeSupported(self, QCameraFocus.FocusPointMode) -> bool
	**/
	public function isFocusPointModeSupported(QCameraFocus:Dynamic):Bool;
	/**
	...
	**/
	public var maximumDigitalZoomChanged : Dynamic;
	/**
	...
	**/
	public var maximumOpticalZoomChanged : Dynamic;
	/**
	...
	**/
	public var opticalZoomChanged : Dynamic;
	/**
		parent(self) -> QObject
	**/
	...
	**/
	public function setCustomFocusPoint(Union:Dynamic):Void;
	/**
		setFocusMode(self, QCameraFocus.FocusModes)
	**/
	public function setFocusMode(QCameraFocus:Dynamic):Void;
	/**
		setFocusPointMode(self, QCameraFocus.FocusPointMode)
	**/
	public function setFocusPointMode(QCameraFocus:Dynamic):Void;
	/**
	...
	**/
	public function zoomTo(float:Float, float:Float):Void;
}