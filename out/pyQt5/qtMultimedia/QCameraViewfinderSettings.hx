...
@:pythonImport("PyQt5.QtMultimedia", "QCameraViewfinderSettings") extern class QCameraViewfinderSettings {
	...
	**/
	public function setMaximumFrameRate(float:Float):Void;
	/**
		setMinimumFrameRate(self, float)
	**/
	public function setMinimumFrameRate(float:Float):Void;
	/**
	...
	**/
	public function setPixelFormat(QVideoFrame:Dynamic):Void;
	/**
	...
	**/
	public function swap(QCameraViewfinderSettings:Dynamic):Void;
}