...
@:pythonImport("PyQt5.QtMultimedia", "QAudioProbe") extern class QAudioProbe {
	...
	**/
	public var audioBufferProbed : Dynamic;
	/**
	...
	**/
	public function setSource(args:haxe.extern.Rest<Dynamic>):Bool;
	/**
