...
@:pythonImport("PyQt5.QtMultimedia", "QMediaService") extern class QMediaService {
	...
	**/
	public function releaseControl(QMediaControl:Dynamic):Void;
	/**
	...
	**/
	public function requestControl(str:String):Dynamic;
	/**
		sender(self) -> QObject
	**/
