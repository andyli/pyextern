...
@:pythonImport("PyQt5.QtDesigner", "QDesignerPropertyEditorInterface") extern class QDesignerPropertyEditorInterface {
	...
	**/
	public var propertyChanged : Dynamic;
	/**
	...
	**/
	public function setObject(QObject:Dynamic):Void;
	/**
	...
	**/
	public function setPropertyValue(str:String, Any:Dynamic, ?changed:Dynamic):Void;
	/**
