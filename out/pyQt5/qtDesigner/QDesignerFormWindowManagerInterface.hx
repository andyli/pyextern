...
@:pythonImport("PyQt5.QtDesigner", "QDesignerFormWindowManagerInterface") extern class QDesignerFormWindowManagerInterface {
	/**
		int(x=0) -> integer
	...
	**/
	...
	static public var AdjustSizeAction : Dynamic;
	static public var BreakLayoutAction : Dynamic;
	static public var CopyAction : Dynamic;
	static public var CutAction : Dynamic;
	static public var DefaultPreviewAction : Dynamic;
	static public var DeleteAction : Dynamic;
	static public var FormLayoutAction : Dynamic;
	static public var FormWindowSettingsDialogAction : Dynamic;
	static public var GridLayoutAction : Dynamic;
	static public var HorizontalLayoutAction : Dynamic;
	static public var LowerAction : Dynamic;
	static public var PasteAction : Dynamic;
	static public var RaiseAction : Dynamic;
	static public var RedoAction : Dynamic;
	static public var SelectAllAction : Dynamic;
	static public var SimplifyLayoutAction : Dynamic;
	static public var SplitHorizontalAction : Dynamic;
	static public var SplitVerticalAction : Dynamic;
	static public var StyledPreviewActionGroup : Dynamic;
	static public var UndoAction : Dynamic;
	static public var VerticalLayoutAction : Dynamic;
	...
	**/
	public function action(QDesignerFormWindowManagerInterface:Dynamic):Dynamic;
	/**
		actionFormLayout(self) -> QAction
	**/
	public function actionFormLayout():Dynamic;
	/**
		actionGroup(self, QDesignerFormWindowManagerInterface.ActionGroup) -> QActionGroup
	**/
	public function actionGroup(QDesignerFormWindowManagerInterface:Dynamic):Dynamic;
	/**
		actionSimplifyLayout(self) -> QAction
	**/
	public function actionSimplifyLayout():Dynamic;
	/**
		activeFormWindow(self) -> QDesignerFormWindowInterface
	**/
	public function activeFormWindow():Dynamic;
	/**
		activeFormWindowChanged(self, QDesignerFormWindowInterface) [signal]
	**/
	public var activeFormWindowChanged : Dynamic;
	/**
		addFormWindow(self, QDesignerFormWindowInterface)
	**/
	public function addFormWindow(QDesignerFormWindowInterface:Dynamic):Void;
	/**
	...
	**/
	public function closeAllPreviews():Void;
	/**
	...
	**/
	public function createFormWindow(?parent:Dynamic, ?flags:Dynamic):Dynamic;
	/**
	...
	**/
	public function formWindow(int:Int):Dynamic;
	/**
		formWindowAdded(self, QDesignerFormWindowInterface) [signal]
	**/
	public var formWindowAdded : Dynamic;
	/**
	...
	**/
	public var formWindowRemoved : Dynamic;
	/**
		formWindowSettingsChanged(self, QDesignerFormWindowInterface) [signal]
	**/
	public var formWindowSettingsChanged : Dynamic;
	/**
	...
	**/
	public function removeFormWindow(QDesignerFormWindowInterface:Dynamic):Void;
	/**
		sender(self) -> QObject
	**/
	...
	**/
	public function setActiveFormWindow(QDesignerFormWindowInterface:Dynamic):Void;
	/**
	...
	**/
	public function showPluginDialog():Void;
	/**
		showPreview(self)
	**/
