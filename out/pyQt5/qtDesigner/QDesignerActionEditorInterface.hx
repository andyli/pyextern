...
@:pythonImport("PyQt5.QtDesigner", "QDesignerActionEditorInterface") extern class QDesignerActionEditorInterface {
	...
	**/
	public function manageAction(QAction:Dynamic):Void;
	/**
	...
	**/
	public function setFormWindow(QDesignerFormWindowInterface:Dynamic):Void;
	/**
	...
	**/
	public function unmanageAction(QAction:Dynamic):Void;
	/**
		unsetCursor(self)
	**/
