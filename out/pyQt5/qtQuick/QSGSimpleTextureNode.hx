...
@:pythonImport("PyQt5.QtQuick", "QSGSimpleTextureNode") extern class QSGSimpleTextureNode {
	...
	**/
	public function setTextureCoordinatesTransform(QSGSimpleTextureNode:Dynamic):Void;
	/**
