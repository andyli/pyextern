...
@:pythonImport("PyQt5.QtQuick", "QQuickTextureFactory") extern class QQuickTextureFactory {
	...
	**/
	public function createTexture(QQuickWindow:Dynamic):Dynamic;
	/**
	...
	**/
	static public function textureFactoryForImage(QImage:Dynamic):Dynamic;
	/**
