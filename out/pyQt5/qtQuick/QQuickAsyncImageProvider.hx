...
@:pythonImport("PyQt5.QtQuick", "QQuickAsyncImageProvider") extern class QQuickAsyncImageProvider {
	/**
		int(x=0) -> integer
	...
	**/
	...
	static public var ForceAsynchronousImageLoading : Dynamic;
	static public var Image : Dynamic;
	static public var ImageResponse : Dynamic;
	/**
		int(x=0) -> integer
		int(x, base=10) -> integer
		...
		4
	**/
	public function ImageType(args:haxe.extern.Rest<Dynamic>):Dynamic;
	...
	**/
	public function imageType():Dynamic;
	/**
		requestImage(self, str, QSize) -> Tuple[QImage, QSize]
	**/
	public function requestImage(str:String, QSize:Dynamic):Dynamic;
	/**
		requestImageResponse(self, str, QSize) -> QQuickImageResponse
	**/
	public function requestImageResponse(str:String, QSize:Dynamic):Dynamic;
	/**
		requestPixmap(self, str, QSize) -> Tuple[QPixmap, QSize]
	**/
	public function requestPixmap(str:String, QSize:Dynamic):Dynamic;
	/**
		requestTexture(self, str, QSize) -> Tuple[QQuickTextureFactory, QSize]
	**/
	public function requestTexture(str:String, QSize:Dynamic):Dynamic;
}