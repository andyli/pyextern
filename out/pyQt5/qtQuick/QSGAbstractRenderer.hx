...
@:pythonImport("PyQt5.QtQuick", "QSGAbstractRenderer") extern class QSGAbstractRenderer {
	...
	**/
	static public function ClearMode(args:haxe.extern.Rest<Dynamic>):Void;
	/**
		int(x=0) -> integer
	...
	**/
	public function clearColor():Dynamic;
	/**
		clearMode(self) -> QSGAbstractRenderer.ClearMode
	**/
	public function clearMode():Dynamic;
	/**
	...
	**/
	public function deviceRect():Dynamic;
	/**
		disconnect(self)
	**/
	...
	**/
	public function projectionMatrix():Dynamic;
	/**
	...
	**/
	public function renderScene(?fboId:Dynamic):Void;
	/**
		sceneGraphChanged(self) [signal]
	**/
	public var sceneGraphChanged : Dynamic;
	/**
		sender(self) -> QObject
	**/
	...
	**/
	public function setClearColor(Union:Dynamic):Void;
	/**
		setClearMode(self, QSGAbstractRenderer.ClearMode)
	**/
	public function setClearMode(QSGAbstractRenderer:Dynamic):Void;
	/**
		setDeviceRect(self, QRect)
		setDeviceRect(self, QSize)
	**/
	public function setDeviceRect(args:haxe.extern.Rest<Dynamic>):Void;
	/**
	...
	**/
	public function setProjectionMatrix(QMatrix4x4:Dynamic):Void;
	/**
		setProjectionMatrixToRect(self, QRectF)
	**/
	public function setProjectionMatrixToRect(QRectF:Dynamic):Void;
	/**
	...
	**/
	public function setViewportRect(args:haxe.extern.Rest<Dynamic>):Void;
	/**
	...
	**/
	public function viewportRect():Dynamic;
}