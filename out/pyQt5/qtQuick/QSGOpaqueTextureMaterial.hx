...
@:pythonImport("PyQt5.QtQuick", "QSGOpaqueTextureMaterial") extern class QSGOpaqueTextureMaterial {
	...
	**/
	public function setFlag(QSGMaterial:Dynamic, ?enabled:Dynamic):Void;
	/**
