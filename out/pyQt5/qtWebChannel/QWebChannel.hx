...
package pyQt5.qtWebChannel;
@:pythonImport("PyQt5.QtWebChannel", "QWebChannel") extern class QWebChannel {
	...
	**/
	public var blockUpdatesChanged : Dynamic;
	/**
	...
	**/
	public function connectTo(QWebChannelAbstractTransport:Dynamic):Void;
	/**
	...
	**/
	public function deregisterObject(QObject:Dynamic):Void;
	/**
	...
	**/
	public function disconnectFrom(QWebChannelAbstractTransport:Dynamic):Void;
	/**
	...
	**/
	public function registerObject(str:String, QObject:Dynamic):Void;
	/**
		registerObjects(self, object)
	**/
	public function registerObjects(object:Dynamic):Void;
	/**
		registeredObjects(self) -> Dict[str, QObject]
	**/
	public function registeredObjects():Dynamic;
	/**
	...
	**/
	public function setBlockUpdates(bool:Bool):Void;
	/**
