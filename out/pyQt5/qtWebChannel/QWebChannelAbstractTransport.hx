...
@:pythonImport("PyQt5.QtWebChannel", "QWebChannelAbstractTransport") extern class QWebChannelAbstractTransport {
	...
	**/
	public var messageReceived : Dynamic;
	/**
	...
	**/
	public function sendMessage(Dict:Dynamic):Void;
	/**
		sender(self) -> QObject
	**/
