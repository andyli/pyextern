...
@:pythonImport("PyQt5.QtOpenGL", "QGLWidget") extern class QGLWidget {
	...
	**/
	public function autoBufferSwap():Bool;
	/**
	...
	**/
	static public function convertToGLFormat(QImage:Dynamic):Dynamic;
	/**
	...
	**/
	...
	/**
		glDraw(self)
	**/
	public function glDraw():Void;
	/**
		glInit(self)
	**/
	public function glInit():Void;
	/**
	...
	**/
	public function grabFrameBuffer(?withAlpha:Dynamic):Dynamic;
	/**
	...
	**/
	...
	/**
		initializeGL(self)
	**/
	public function initializeGL():Void;
	/**
		initializeOverlayGL(self)
	**/
	public function initializeOverlayGL():Void;
	/**
	...
	**/
	public function makeOverlayCurrent():Void;
	/**
	...
	**/
	public function overlayContext():Dynamic;
	/**
	...
	**/
	...
	/**
		paintGL(self)
	**/
	public function paintGL():Void;
	/**
		paintOverlayGL(self)
	**/
	public function paintOverlayGL():Void;
	/**
	...
	**/
	public function qglClearColor(Union:Dynamic):Void;
	/**
		qglColor(self, Union[QColor, Qt.GlobalColor])
	**/
	public function qglColor(Union:Dynamic):Void;
	/**
		raise_(self)
	**/
	...
	**/
	public function renderPixmap(?width:Dynamic, ?height:Dynamic, ?useContext:Dynamic):Dynamic;
	/**
		renderText(self, int, int, str, font: QFont = QFont())
		renderText(self, float, float, float, str, font: QFont = QFont())
	**/
	public function renderText(args:haxe.extern.Rest<Dynamic>):Void;
	/**
		repaint(self)
	...
	**/
	public function resizeGL(int:Int, int:Int):Void;
	/**
		resizeOverlayGL(self, int, int)
	**/
	public function resizeOverlayGL(int:Int, int:Int):Void;
	/**
	...
	**/
	public function setAutoBufferSwap(bool:Bool):Void;
	/**
	...
	**/
	public function setContext(QGLContext:Dynamic, ?shareContext:Dynamic, ?deleteOldContext:Dynamic):Void;
	/**
	...
	**/
	public function updateOverlayGL():Void;
	/**
