...
package pyQt5.qtSql;
@:pythonImport("PyQt5.QtSql", "QSqlRelationalTableModel") extern class QSqlRelationalTableModel {
	/**
		int(x=0) -> integer
	...
	**/
	public function relation(int:Int):Dynamic;
	/**
		relationModel(self, int) -> QSqlTableModel
	**/
	public function relationModel(int:Int):Dynamic;
	/**
	...
	**/
	public function setJoinMode(QSqlRelationalTableModel:Dynamic):Void;
	/**
	...
	**/
	public function setRelation(int:Int, QSqlRelation:Dynamic):Void;
	/**
