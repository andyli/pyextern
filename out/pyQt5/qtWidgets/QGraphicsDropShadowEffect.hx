...
@:pythonImport("PyQt5.QtWidgets", "QGraphicsDropShadowEffect") extern class QGraphicsDropShadowEffect {
	/**
		int(x=0) -> integer
	...
	**/
	public var offsetChanged : Dynamic;
	/**
		parent(self) -> QObject
	**/
	...
	**/
	public function setXOffset(float:Float):Void;
	/**
		setYOffset(self, float)
	**/
	public function setYOffset(float:Float):Void;
	/**
