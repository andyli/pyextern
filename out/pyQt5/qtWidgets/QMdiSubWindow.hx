...
@:pythonImport("PyQt5.QtWidgets", "QMdiSubWindow") extern class QMdiSubWindow {
	...
	**/
	static public function SubWindowOptions(args:haxe.extern.Rest<Dynamic>):Void;
	...
	**/
	public var aboutToActivate : Dynamic;
	/**
	...
	**/
	public function mdiArea():Dynamic;
	/**
	...
	**/
	public function setKeyboardPageStep(int:Int):Void;
	/**
		setKeyboardSingleStep(self, int)
	**/
	public function setKeyboardSingleStep(int:Int):Void;
	/**
	...
	**/
	public function setOption(QMdiSubWindow:Dynamic, ?on:Dynamic):Void;
	/**
	...
	**/
	public function setSystemMenu(QMenu:Dynamic):Void;
	/**
	...
	**/
	...
	/**
		showShaded(self)
	**/
	public function showShaded():Void;
	/**
		showSystemMenu(self)
	**/
	public function showSystemMenu():Void;
	/**
	...
	**/
	public function systemMenu():Dynamic;
	/**
	...
	**/
	public function testOption(QMdiSubWindow:Dynamic):Bool;
	/**
		thread(self) -> QThread
	**/
