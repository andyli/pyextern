...
@:pythonImport("PyQt5.QtWidgets", "QGraphicsBlurEffect") extern class QGraphicsBlurEffect {
	...
	**/
	static public function BlurHints(args:haxe.extern.Rest<Dynamic>):Void;
	/**
		int(x=0) -> integer
		int(x, base=10) -> integer
	...
	**/
	public var blurRadiusChanged : Dynamic;
	/**
	...
	**/
	public function boundingRectFor(QRectF:Dynamic):Dynamic;
	/**
	...
	**/
	...
	/**
		draw(self, QPainter)
	**/
	public function draw(QPainter:Dynamic):Void;
	/**
		drawSource(self, QPainter)
	**/
	public function drawSource(QPainter:Dynamic):Void;
	/**
		dumpObjectInfo(self)
	**/
	...
	**/
	public function setBlurHints(Union:Dynamic):Void;
	/**
		setBlurRadius(self, float)
	**/
	public function setBlurRadius(float:Float):Void;
	/**
	...
	**/
	public function sourceBoundingRect(?system:Dynamic):Dynamic;
	/**
		sourceChanged(self, Union[QGraphicsEffect.ChangeFlags, QGraphicsEffect.ChangeFlag])
	**/
	public function sourceChanged(Union:Dynamic):Void;
	/**
	...
	**/
	public function sourcePixmap(?system:Dynamic, ?mode:Dynamic):Dynamic;
	/**
	...
	**/
	public function updateBoundingRect():Void;
}