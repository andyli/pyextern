...
@:pythonImport("PyQt5.QtWidgets", "QStyleOptionMenuItem") extern class QStyleOptionMenuItem {
	/**
		int(x=0) -> integer
		...
		4
	**/
	public function CheckType(args:haxe.extern.Rest<Dynamic>):Dynamic;
	static public var DefaultItem : Dynamic;
	static public var EmptyArea : Dynamic;
	static public var Exclusive : Dynamic;
	static public var Margin : Dynamic;
	/**
		int(x=0) -> integer
		int(x, base=10) -> integer
		...
		4
	**/
	public function MenuItemType(args:haxe.extern.Rest<Dynamic>):Dynamic;
	static public var NonExclusive : Dynamic;
	static public var Normal : Dynamic;
	static public var NotCheckable : Dynamic;
	/**
		int(x=0) -> integer
		int(x, base=10) -> integer
	...
	**/
	...
	static public var Scroller : Dynamic;
	...
	**/
	...
	static public var SubMenu : Dynamic;
	static public var TearOff : Dynamic;
	...
	**/
	...
	public var maxIconWidth : Dynamic;
	public var menuHasCheckableItems : Dynamic;
	public var menuItemType : Dynamic;
	public var menuRect : Dynamic;
	public var palette : Dynamic;
	public var rect : Dynamic;
	public var state : Dynamic;
	public var styleObject : Dynamic;
	public var tabWidth : Dynamic;
