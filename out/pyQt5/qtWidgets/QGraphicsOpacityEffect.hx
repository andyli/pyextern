...
@:pythonImport("PyQt5.QtWidgets", "QGraphicsOpacityEffect") extern class QGraphicsOpacityEffect {
	/**
		int(x=0) -> integer
	...
	**/
	public function setOpacityMask(Union:Dynamic):Void;
	/**
