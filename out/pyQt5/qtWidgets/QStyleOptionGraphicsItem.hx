...
@:pythonImport("PyQt5.QtWidgets", "QStyleOptionGraphicsItem") extern class QStyleOptionGraphicsItem {
	/**
		int(x=0) -> integer
	...
	**/
	static public function levelOfDetailFromTransform(QTransform:Dynamic):Float;
