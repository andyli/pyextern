...
@:pythonImport("PyQt5.QtWidgets", "QMouseEventTransition") extern class QMouseEventTransition {
	...
	**/
	public function addAnimation(QAbstractAnimation:Dynamic):Void;
	/**
		animations(self) -> object
	**/
	public function animations():Dynamic;
	/**
	...
	**/
	public function eventSource():Dynamic;
	/**
		eventTest(self, QEvent) -> bool
	**/
	public function eventTest(QEvent:Dynamic):Bool;
	/**
		eventType(self) -> QEvent.Type
	**/
	public function eventType():Dynamic;
	/**
	...
	**/
	public function hitTestPath():Dynamic;
	/**
	...
	**/
	public function modifierMask():Dynamic;
	/**
	...
	**/
	public function onTransition(QEvent:Dynamic):Void;
	/**
		parent(self) -> QObject
	**/
	...
	**/
	public function removeAnimation(QAbstractAnimation:Dynamic):Void;
	/**
	...
	**/
	public function setButton(Qt:Dynamic):Void;
	/**
		setEventSource(self, QObject)
	**/
	public function setEventSource(QObject:Dynamic):Void;
	/**
		setEventType(self, QEvent.Type)
	**/
	public function setEventType(QEvent:Dynamic):Void;
	/**
		setHitTestPath(self, QPainterPath)
	**/
	public function setHitTestPath(QPainterPath:Dynamic):Void;
	/**
		setModifierMask(self, Union[Qt.KeyboardModifiers, Qt.KeyboardModifier])
	**/
	public function setModifierMask(Union:Dynamic):Void;
	/**
	...
	**/
	public function setTargetState(QAbstractState:Dynamic):Void;
	/**
		setTargetStates(self, Iterable[QAbstractState])
	**/
	public function setTargetStates(Iterable:Dynamic):Void;
	/**
		setTransitionType(self, QAbstractTransition.TransitionType)
	**/
	public function setTransitionType(QAbstractTransition:Dynamic):Void;
	/**
	...
	**/
	public function sourceState():Dynamic;
	/**
	...
	**/
	public function targetState():Dynamic;
	/**
		targetStateChanged(self) [signal]
	**/
	public var targetStateChanged : Dynamic;
	/**
		targetStates(self) -> object
	**/
	public function targetStates():Dynamic;
	/**
		targetStatesChanged(self) [signal]
	**/
	public var targetStatesChanged : Dynamic;
	/**
		thread(self) -> QThread
	**/
	...
	**/
	public function transitionType():Dynamic;
	/**
