...
@:pythonImport("PyQt5.QtWidgets", "QToolBox") extern class QToolBox {
	...
	**/
	public function addItem(QWidget:Dynamic, args:haxe.extern.Rest<Dynamic>):Int;
	/**
		adjustSize(self)
	**/
	...
	**/
	public function insertItem(int:Int, QWidget:Dynamic, args:haxe.extern.Rest<Dynamic>):Int;
	/**
	...
	**/
	public function isItemEnabled(int:Int):Bool;
	/**
	...
	**/
	public function itemInserted(int:Int):Void;
	/**
		itemRemoved(self, int)
	**/
	public function itemRemoved(int:Int):Void;
	/**
	...
	**/
	public function itemToolTip(int:Int):String;
	/**
	...
	**/
	public function setItemEnabled(int:Int, bool:Bool):Void;
	/**
	...
	**/
	public function setItemToolTip(int:Int, str:String):Void;
	/**
