...
@:pythonImport("PyQt5.QtWidgets", "QStyledItemDelegate") extern class QStyledItemDelegate {
	...
	**/
	public function displayText(Any:Dynamic, QLocale:Dynamic):String;
	/**
		dumpObjectInfo(self)
	**/
	...
	**/
	public function initStyleOption(QStyleOptionViewItem:Dynamic, QModelIndex:Dynamic):Void;
	/**
