...
@:pythonImport("PyQt5.QtWidgets", "QToolButton") extern class QToolButton {
	...
	**/
	public function animateClick(?msecs:Dynamic):Void;
	/**
		arrowType(self) -> Qt.ArrowType
	**/
	public function arrowType():Dynamic;
	/**
	...
	**/
	...
	/**
		checkStateSet(self)
	**/
	public function checkStateSet():Void;
	/**
	...
	**/
	public function hitButton(QPoint:Dynamic):Bool;
	/**
		icon(self) -> QIcon
	**/
	...
	**/
	public function initStyleOption(QStyleOptionToolButton:Dynamic):Void;
	/**
	...
	**/
	...
	/**
		nextCheckState(self)
	**/
	public function nextCheckState():Void;
	/**
	...
	**/
	public function popupMode():Dynamic;
	/**
		pos(self) -> QPoint
	**/
	...
	**/
	public function setArrowType(Qt:Dynamic):Void;
	/**
	...
	**/
	public function setAutoExclusive(bool:Bool):Void;
	/**
	...
	**/
	public function setAutoRaise(bool:Bool):Void;
	/**
	...
	**/
	public function setAutoRepeatDelay(int:Int):Void;
	/**
		setAutoRepeatInterval(self, int)
	**/
	public function setAutoRepeatInterval(int:Int):Void;
	/**
	...
	**/
	...
	/**
		setDown(self, bool)
	**/
	public function setDown(bool:Bool):Void;
	/**
	...
	**/
	public function setPopupMode(QToolButton:Dynamic):Void;
	/**
