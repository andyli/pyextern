...
@:pythonImport("PyQt5.QtWidgets", "QStyleOptionDockWidget") extern class QStyleOptionDockWidget {
	/**
		int(x=0) -> integer
	...
	**/
	...
	public var verticalTitleBar : Dynamic;
}