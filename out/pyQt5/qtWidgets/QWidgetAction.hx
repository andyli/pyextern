...
@:pythonImport("PyQt5.QtWidgets", "QWidgetAction") extern class QWidgetAction {
	...
	**/
	public function createWidget(QWidget:Dynamic):Dynamic;
	/**
		createdWidgets(self) -> List[QWidget]
	**/
	public function createdWidgets():Dynamic;
	/**
	...
	**/
	public function defaultWidget():Dynamic;
	/**
		deleteLater(self)
	**/
	...
	**/
	public function deleteWidget(QWidget:Dynamic):Void;
	/**
	...
	**/
	public function releaseWidget(QWidget:Dynamic):Void;
	/**
	...
	**/
	public function requestWidget(QWidget:Dynamic):Dynamic;
	/**
		sender(self) -> QObject
	**/
	...
	**/
	public function setDefaultWidget(QWidget:Dynamic):Void;
	/**
