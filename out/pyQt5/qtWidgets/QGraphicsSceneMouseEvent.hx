...
@:pythonImport("PyQt5.QtWidgets", "QGraphicsSceneMouseEvent") extern class QGraphicsSceneMouseEvent {
	...
	**/
	public function buttonDownPos(Qt:Dynamic):Dynamic;
	/**
		buttonDownScenePos(self, Qt.MouseButton) -> QPointF
	**/
	public function buttonDownScenePos(Qt:Dynamic):Dynamic;
	/**
		buttonDownScreenPos(self, Qt.MouseButton) -> QPoint
	**/
	public function buttonDownScreenPos(Qt:Dynamic):Dynamic;
	/**
	...
	**/
	public function lastPos():Dynamic;
	/**
		lastScenePos(self) -> QPointF
	**/
	public function lastScenePos():Dynamic;
	/**
		lastScreenPos(self) -> QPoint
	**/
	public function lastScreenPos():Dynamic;
	/**
	...
	**/
	public function screenPos():Dynamic;
	/**
