...
@:pythonImport("PyQt5.QtWidgets", "QCommandLinkButton") extern class QCommandLinkButton {
	...
	**/
	public function initStyleOption(QStyleOptionButton:Dynamic):Void;
	/**
	...
	**/
	public function setAutoDefault(bool:Bool):Void;
	/**
	...
	**/
	public function setDefault(bool:Bool):Void;
	/**
	...
	**/
	...
	/**
		setFlat(self, bool)
	**/
	public function setFlat(bool:Bool):Void;
	/**
		setFocus(self)
