...
@:pythonImport("PyQt5.QtWidgets", "QStyleOptionTabWidgetFrame") extern class QStyleOptionTabWidgetFrame {
	/**
		int(x=0) -> integer
	...
	**/
	...
	public var leftCornerWidgetSize : Dynamic;
	public var lineWidth : Dynamic;
	public var midLineWidth : Dynamic;
	public var palette : Dynamic;
	public var rect : Dynamic;
	public var rightCornerWidgetSize : Dynamic;
	public var selectedTabRect : Dynamic;
	public var shape : Dynamic;
	public var state : Dynamic;
	public var styleObject : Dynamic;
	public var tabBarRect : Dynamic;
	public var tabBarSize : Dynamic;
