...
@:pythonImport("PyQt5.QtWidgets", "QFileIconProvider") extern class QFileIconProvider {
	static public var Computer : Dynamic;
	...
	static public var Folder : Dynamic;
	/**
		int(x=0) -> integer
		...
		4
	**/
	public function IconType(args:haxe.extern.Rest<Dynamic>):Dynamic;
	static public var Network : Dynamic;
	/**
		int(x=0) -> integer
		int(x, base=10) -> integer
	...
	**/
	...
	static public var Trashcan : Dynamic;
	...
	**/
	public function setOptions(QFileIconProvider:Dynamic):Void;
	/**
		type(self, QFileInfo) -> str
	**/
	public function type(QFileInfo:Dynamic):String;
}