...
@:pythonImport("PyQt5.QtWidgets", "QToolTip") extern class QToolTip {
	...
	**/
	static public function showText(QPoint:Dynamic, str:String, args:haxe.extern.Rest<Dynamic>):Void;
	/**
		text() -> str
	**/
