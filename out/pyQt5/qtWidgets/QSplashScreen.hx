...
@:pythonImport("PyQt5.QtWidgets", "QSplashScreen") extern class QSplashScreen {
	...
	**/
	public function drawContents(QPainter:Dynamic):Void;
	/**
	...
	**/
	...
	/**
		finish(self, QWidget)
	**/
	public function finish(QWidget:Dynamic):Void;
	/**
	...
	**/
	public function showMessage(str:String, ?alignment:Dynamic, ?color:Dynamic):Void;
	/**
		showMinimized(self)
	**/
