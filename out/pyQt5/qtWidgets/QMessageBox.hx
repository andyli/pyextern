...
@:pythonImport("PyQt5.QtWidgets", "QMessageBox") extern class QMessageBox {
	...
	**/
	static public function StandardButtons(args:haxe.extern.Rest<Dynamic>):Void;
	...
	**/
	static public function about(QWidget:Dynamic, str:String, str:String):Void;
	/**
		aboutQt(QWidget, title: str = '')
	**/
	static public function aboutQt(QWidget:Dynamic, ?title:Dynamic):Void;
	/**
		accept(self)
	**/
	...
	**/
	public function button(QMessageBox:Dynamic):Dynamic;
	/**
	...
	**/
	public function buttonRole(QAbstractButton:Dynamic):Dynamic;
	/**
	...
	**/
	public function checkBox():Dynamic;
	/**
	...
	**/
	public function clickedButton():Dynamic;
	/**
		close(self) -> bool
	**/
	...
	**/
	static public function critical(QWidget:Dynamic, str:String, str:String, ?buttons:Dynamic, ?defaultButton:Dynamic):Dynamic;
	/**
		cursor(self) -> QCursor
	**/
	...
	**/
	public function defaultButton():Dynamic;
	/**
		deleteLater(self)
	**/
	...
	**/
	public function escapeButton():Dynamic;
	/**
	...
	**/
	public function iconPixmap():Dynamic;
	/**
	...
	**/
	static public function information(QWidget:Dynamic, str:String, str:String, ?buttons:Dynamic, ?defaultButton:Dynamic):Dynamic;
	/**
	...
	**/
	static public function question(QWidget:Dynamic, str:String, str:String, ?buttons:Dynamic, ?defaultButton:Dynamic):Dynamic;
	/**
		raise_(self)
	**/
	...
	**/
	public function setCheckBox(QCheckBox:Dynamic):Void;
	/**
	...
	**/
	public function setDefaultButton(args:haxe.extern.Rest<Dynamic>):Void;
	/**
		setDetailedText(self, str)
	**/
	public function setDetailedText(str:String):Void;
	/**
	...
	**/
	public function setEscapeButton(args:haxe.extern.Rest<Dynamic>):Void;
	/**
	...
	**/
	public function setIcon(QMessageBox:Dynamic):Void;
	/**
		setIconPixmap(self, QPixmap)
	**/
	public function setIconPixmap(QPixmap:Dynamic):Void;
	/**
		setInformativeText(self, str)
	**/
	public function setInformativeText(str:String):Void;
	/**
	...
	**/
	public function setStandardButtons(Union:Dynamic):Void;
	/**
	...
	**/
	public function setTextFormat(Qt:Dynamic):Void;
	/**
	...
	**/
	public function standardButton(QAbstractButton:Dynamic):Dynamic;
	/**
		standardButtons(self) -> QMessageBox.StandardButtons
	**/
	public function standardButtons():Dynamic;
	/**
		standardIcon(QMessageBox.Icon) -> QPixmap
	**/
	static public function standardIcon(QMessageBox:Dynamic):Dynamic;
	/**
	...
	**/
	public function textFormat():Dynamic;
	/**
	...
	**/
	static public function warning(QWidget:Dynamic, str:String, str:String, ?buttons:Dynamic, ?defaultButton:Dynamic):Dynamic;
	/**
		whatsThis(self) -> str
	**/
