...
@:pythonImport("PyQt5.QtWidgets", "QTapAndHoldGesture") extern class QTapAndHoldGesture {
	...
	**/
	...
	/**
		setTimeout(int)
	**/
	static public function setTimeout(int:Int):Void;
	/**
	...
	**/
	...
	/**
		timeout() -> int
	**/
	static public function timeout():Int;
	/**
