...
@:pythonImport("PyQt5.QtWidgets", "QErrorMessage") extern class QErrorMessage {
	...
	**/
	static public function qtHandler():Dynamic;
	/**
		raise_(self)
	**/
	...
	**/
	public function showMessage(str:String, args:haxe.extern.Rest<Dynamic>):Void;
	/**
		showMinimized(self)
	**/
