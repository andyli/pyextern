...
@:pythonImport("PyQt5.QtWidgets", "QSwipeGesture") extern class QSwipeGesture {
	...
	**/
	public function horizontalDirection():Dynamic;
	/**
	...
	**/
	public function setSwipeAngle(float:Float):Void;
	/**
	...
	**/
	public function verticalDirection():Dynamic;
}