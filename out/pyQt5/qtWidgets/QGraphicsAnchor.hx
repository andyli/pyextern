...
@:pythonImport("PyQt5.QtWidgets", "QGraphicsAnchor") extern class QGraphicsAnchor {
	...
	**/
	public function setSizePolicy(QSizePolicy:Dynamic):Void;
	/**
	...
	**/
	...
	/**
		unsetSpacing(self)
	**/
	public function unsetSpacing():Void;
}