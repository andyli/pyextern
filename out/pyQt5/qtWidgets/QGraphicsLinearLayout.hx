...
@:pythonImport("PyQt5.QtWidgets", "QGraphicsLinearLayout") extern class QGraphicsLinearLayout {
	...
	**/
	public function addItem(QGraphicsLayoutItem:Dynamic):Void;
	/**
	...
	**/
	public function insertItem(int:Int, QGraphicsLayoutItem:Dynamic):Void;
	/**
	...
	**/
	public function itemSpacing(int:Int):Float;
	/**
	...
	**/
	public function setItemSpacing(int:Int, float:Float):Void;
	/**
	...
	**/
	public function setStretchFactor(QGraphicsLayoutItem:Dynamic, int:Int):Void;
	/**
	...
	**/
	public function stretchFactor(QGraphicsLayoutItem:Dynamic):Int;
	/**
		updateGeometry(self)
	**/
