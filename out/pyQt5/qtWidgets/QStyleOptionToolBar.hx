...
@:pythonImport("PyQt5.QtWidgets", "QStyleOptionToolBar") extern class QStyleOptionToolBar {
	...
	**/
	static public function ToolBarFeatures(args:haxe.extern.Rest<Dynamic>):Void;
	/**
		int(x=0) -> integer
		int(x, base=10) -> integer
