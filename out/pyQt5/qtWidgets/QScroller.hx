...
@:pythonImport("PyQt5.QtWidgets", "QScroller") extern class QScroller {
	static public var Dragging : Dynamic;
	...
	/**
		...
		4
	**/
	public function Input(args:haxe.extern.Rest<Dynamic>):Dynamic;
	static public var InputMove : Dynamic;
	static public var InputPress : Dynamic;
	static public var InputRelease : Dynamic;
	static public var LeftMouseButtonGesture : Dynamic;
	static public var MiddleMouseButtonGesture : Dynamic;
	static public var Pressed : Dynamic;
	static public var RightMouseButtonGesture : Dynamic;
	/**
		int(x=0) -> integer
		int(x, base=10) -> integer
		...
		4
	**/
	public function ScrollerGestureType(args:haxe.extern.Rest<Dynamic>):Dynamic;
	static public var Scrolling : Dynamic;
	/**
		int(x=0) -> integer
		int(x, base=10) -> integer
	...
	**/
	...
	static public var TouchGesture : Dynamic;
	...
	**/
	static public function activeScrollers():Dynamic;
	/**
	...
	**/
	public function ensureVisible(QRectF:Dynamic, float:Float, float:Float, args:haxe.extern.Rest<Dynamic>):Void;
	/**
	...
	**/
	public function finalPosition():Dynamic;
	/**
	...
	**/
	static public function grabGesture(QObject:Dynamic, ?scrollGestureType:Dynamic):Dynamic;
	/**
		grabbedGesture(QObject) -> Qt.GestureType
	**/
	static public function grabbedGesture(QObject:Dynamic):Dynamic;
	/**
		handleInput(self, QScroller.Input, Union[QPointF, QPoint], timestamp: int = 0) -> bool
	**/
	public function handleInput(QScroller:Dynamic, Union:Dynamic, ?timestamp:Dynamic):Bool;
	/**
		hasScroller(QObject) -> bool
	**/
	static public function hasScroller(QObject:Dynamic):Bool;
	/**
	...
	**/
	public function pixelPerMeter():Dynamic;
	/**
	...
	**/
	public function resendPrepareEvent():Void;
	/**
		scrollTo(self, Union[QPointF, QPoint])
		scrollTo(self, Union[QPointF, QPoint], int)
	**/
	public function scrollTo(Union:Dynamic, args:haxe.extern.Rest<Dynamic>):Void;
	/**
		scroller(QObject) -> QScroller
	**/
	static public function scroller(QObject:Dynamic):Dynamic;
	/**
		scrollerProperties(self) -> QScrollerProperties
	**/
	public function scrollerProperties():Dynamic;
	/**
		scrollerPropertiesChanged(self, QScrollerProperties) [signal]
	**/
	public var scrollerPropertiesChanged : Dynamic;
	/**
		sender(self) -> QObject
	**/
	...
	**/
	public function setScrollerProperties(QScrollerProperties:Dynamic):Void;
	/**
		setSnapPositionsX(self, Iterable[float])
		setSnapPositionsX(self, float, float)
	**/
	public function setSnapPositionsX(args:haxe.extern.Rest<Dynamic>):Void;
	/**
		setSnapPositionsY(self, Iterable[float])
		setSnapPositionsY(self, float, float)
	**/
	public function setSnapPositionsY(args:haxe.extern.Rest<Dynamic>):Void;
	/**
	...
	**/
	static public function ungrabGesture(QObject:Dynamic):Void;
	/**
		velocity(self) -> QPointF
	**/
	public function velocity():Dynamic;
}