...
@:pythonImport("PyQt5.QtWidgets", "QGraphicsSceneResizeEvent") extern class QGraphicsSceneResizeEvent {
	...
	**/
	...
	/**
		newSize(self) -> QSizeF
	**/
	public function newSize():Dynamic;
	/**
		oldSize(self) -> QSizeF
	**/
	public function oldSize():Dynamic;
	/**
