...
@:pythonImport("PyQt5.QtWidgets", "QMdiArea") extern class QMdiArea {
	...
	**/
	static public function AreaOptions(args:haxe.extern.Rest<Dynamic>):Void;
	...
	**/
	public function activateNextSubWindow():Void;
	/**
		activatePreviousSubWindow(self)
	**/
	public function activatePreviousSubWindow():Void;
	/**
		activateWindow(self)
	**/
	...
	**/
	public function activationOrder():Dynamic;
	/**
		activeSubWindow(self) -> QMdiSubWindow
	**/
	public function activeSubWindow():Dynamic;
	/**
	...
	**/
	public function addSubWindow(QWidget:Dynamic, ?flags:Dynamic):Dynamic;
	/**
		adjustSize(self)
	**/
	...
	**/
	public function cascadeSubWindows():Void;
	/**
	...
	**/
	public function closeActiveSubWindow():Void;
	/**
		closeAllSubWindows(self)
	**/
	public function closeAllSubWindows():Void;
	/**
	...
	**/
	public function currentSubWindow():Dynamic;
	/**
		cursor(self) -> QCursor
	**/
	...
	**/
	public function removeSubWindow(QWidget:Dynamic):Void;
	/**
	...
	**/
	public function setActivationOrder(QMdiArea:Dynamic):Void;
	/**
		setActiveSubWindow(self, QMdiSubWindow)
	**/
	public function setActiveSubWindow(QMdiSubWindow:Dynamic):Void;
	/**
	...
	**/
	public function setOption(QMdiArea:Dynamic, ?on:Dynamic):Void;
	/**
	...
	**/
	public function setTabsMovable(bool:Bool):Void;
	/**
		setToolTip(self, str)
	**/
	...
	**/
	public function setViewMode(QMdiArea:Dynamic):Void;
	/**
	...
	**/
	public var subWindowActivated : Dynamic;
	/**
		subWindowList(self, order: QMdiArea.WindowOrder = QMdiArea.CreationOrder) -> object
	**/
	public function subWindowList(?order:Dynamic):Dynamic;
	/**
	...
	**/
	public function testOption(QMdiArea:Dynamic):Bool;
	/**
		thread(self) -> QThread
	**/
	...
	/**
		tileSubWindows(self)
	**/
	public function tileSubWindows():Void;
	/**
