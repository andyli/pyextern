...
@:pythonImport("PyQt5.QtWidgets", "QGraphicsProxyWidget") extern class QGraphicsProxyWidget {
	/**
		int(x=0) -> integer
	...
	**/
	public function createProxyForChildWidget(QWidget:Dynamic):Dynamic;
	/**
		cursor(self) -> QCursor
	**/
	...
	**/
	public function newProxyWidget(QWidget:Dynamic):Dynamic;
	/**
		objectName(self) -> str
	**/
	...
	**/
	public function paint(QPainter:Dynamic, QStyleOptionGraphicsItem:Dynamic, QWidget:Dynamic):Void;
	/**
	...
	**/
	public function subWidgetRect(QWidget:Dynamic):Dynamic;
	/**
