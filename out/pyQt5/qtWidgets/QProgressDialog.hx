...
@:pythonImport("PyQt5.QtWidgets", "QProgressDialog") extern class QProgressDialog {
	...
	**/
	public function setAutoClose(bool:Bool):Void;
	/**
	...
	**/
	public function setAutoReset(bool:Bool):Void;
	/**
	...
	**/
	public function setBar(QProgressBar:Dynamic):Void;
	/**
	...
	**/
	public function setCancelButton(QPushButton:Dynamic):Void;
	/**
	...
	**/
	public function setLabel(QLabel:Dynamic):Void;
	/**
	...
	**/
	public function setMinimumDuration(int:Int):Void;
	/**
