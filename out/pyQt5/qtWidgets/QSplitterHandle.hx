...
@:pythonImport("PyQt5.QtWidgets", "QSplitterHandle") extern class QSplitterHandle {
	...
	**/
	public function closestLegalPosition(int:Int):Int;
	/**
		colorCount(self) -> int
	**/
	...
	**/
	public function moveSplitter(int:Int):Void;
	/**
	...
	**/
	public function splitter():Dynamic;
	/**
