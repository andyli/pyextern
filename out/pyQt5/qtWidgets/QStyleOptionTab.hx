...
@:pythonImport("PyQt5.QtWidgets", "QStyleOptionTab") extern class QStyleOptionTab {
	...
	**/
	static public function CornerWidgets(args:haxe.extern.Rest<Dynamic>):Void;
	static public var End : Dynamic;
	static public var HasFrame : Dynamic;
	static public var LeftCornerWidget : Dynamic;
	static public var Middle : Dynamic;
	static public var NextIsSelected : Dynamic;
	static public var NoCornerWidgets : Dynamic;
	static public var None_ : Dynamic;
	static public var NotAdjacent : Dynamic;
	static public var OnlyOneTab : Dynamic;
	/**
		int(x=0) -> integer
		int(x, base=10) -> integer
	...
	**/
	...
	static public var PreviousIsSelected : Dynamic;
	static public var RightCornerWidget : Dynamic;
	...
	/**
		...
		4
	**/
	public function SelectedPosition(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
		int(x=0) -> integer
		int(x, base=10) -> integer
	...
	**/
	...
	/**
		...
		4
	**/
	public function TabFeature(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	static public function TabFeatures(args:haxe.extern.Rest<Dynamic>):Void;
	/**
		int(x=0) -> integer
		int(x, base=10) -> integer
	...
	**/
	...
	public var cornerWidgets : Dynamic;
	public var direction : Dynamic;
	public var documentMode : Dynamic;
	public var features : Dynamic;
	public var fontMetrics : Dynamic;
	public var icon : Dynamic;
	public var iconSize : Dynamic;
	/**
		initFrom(self, QWidget)
	**/
	public function initFrom(QWidget:Dynamic):Void;
	public var leftButtonSize : Dynamic;
	public var palette : Dynamic;
	public var position : Dynamic;
	public var rect : Dynamic;
	public var rightButtonSize : Dynamic;
	public var row : Dynamic;
	public var selectedPosition : Dynamic;
