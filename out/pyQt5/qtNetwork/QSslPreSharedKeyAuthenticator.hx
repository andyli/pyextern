...
@:pythonImport("PyQt5.QtNetwork", "QSslPreSharedKeyAuthenticator") extern class QSslPreSharedKeyAuthenticator {
	...
	**/
	public function identityHint():Dynamic;
	/**
	...
	**/
	public function preSharedKey():Dynamic;
	/**
		setIdentity(self, Union[QByteArray, bytes, bytearray])
	**/
	public function setIdentity(Union:Dynamic):Void;
	/**
		setPreSharedKey(self, Union[QByteArray, bytes, bytearray])
	**/
	public function setPreSharedKey(Union:Dynamic):Void;
	/**
		swap(self, QSslPreSharedKeyAuthenticator)
	**/
	public function swap(QSslPreSharedKeyAuthenticator:Dynamic):Void;
}