...
@:pythonImport("PyQt5.QtNetwork", "QNetworkCookieJar") extern class QNetworkCookieJar {
	...
	**/
	public function allCookies():Dynamic;
	/**
	...
	**/
	public function cookiesForUrl(QUrl:Dynamic):Dynamic;
	/**
	...
	**/
	public function deleteCookie(QNetworkCookie:Dynamic):Bool;
	/**
		deleteLater(self)
	**/
	...
	**/
	public function insertCookie(QNetworkCookie:Dynamic):Bool;
	/**
	...
	**/
	public function setAllCookies(Iterable:Dynamic):Void;
	/**
		setCookiesFromUrl(self, Iterable[QNetworkCookie], QUrl) -> bool
	**/
	public function setCookiesFromUrl(Iterable:Dynamic, QUrl:Dynamic):Bool;
	/**
	...
	**/
	public function updateCookie(QNetworkCookie:Dynamic):Bool;
	/**
		validateCookie(self, QNetworkCookie, QUrl) -> bool
	**/
	public function validateCookie(QNetworkCookie:Dynamic, QUrl:Dynamic):Bool;
}