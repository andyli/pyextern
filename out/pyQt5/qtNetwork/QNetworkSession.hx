...
@:pythonImport("PyQt5.QtNetwork", "QNetworkSession") extern class QNetworkSession {
	...
	static public var InvalidConfigurationError : Dynamic;
	static public var NoBackgroundTrafficPolicy : Dynamic;
	static public var NoPolicy : Dynamic;
	static public var NotAvailable : Dynamic;
	static public var OperationNotSupportedError : Dynamic;
	static public var Roaming : Dynamic;
	static public var RoamingError : Dynamic;
	static public var SessionAbortedError : Dynamic;
	/**
		int(x=0) -> integer
		...
		4
	**/
	public function SessionError(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
		int(x=0) -> integer
		int(x, base=10) -> integer
	...
	**/
	...
	static public var UnknownSessionError : Dynamic;
	/**
	...
	**/
	static public function UsagePolicies(args:haxe.extern.Rest<Dynamic>):Void;
	/**
		int(x=0) -> integer
		int(x, base=10) -> integer
		...
		4
	**/
	public function UsagePolicy(args:haxe.extern.Rest<Dynamic>):Dynamic;
	...
	**/
	public var newConfigurationActivated : Dynamic;
	/**
		objectName(self) -> str
	**/
	...
	**/
	public var preferredConfigurationChanged : Dynamic;
	/**
	...
	**/
	public function sessionProperty(str:String):Dynamic;
	/**
	...
	**/
	public function setSessionProperty(str:String, Any:Dynamic):Void;
	/**
