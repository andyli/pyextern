...
@:pythonImport("PyQt5.QtNetwork", "QDnsLookup") extern class QDnsLookup {
	static public var A : Dynamic;
	static public var AAAA : Dynamic;
	static public var ANY : Dynamic;
	static public var CNAME : Dynamic;
	/**
		int(x=0) -> integer
	...
	**/
	...
	static public var InvalidReplyError : Dynamic;
	static public var InvalidRequestError : Dynamic;
	static public var MX : Dynamic;
	static public var NS : Dynamic;
	static public var NoError : Dynamic;
	static public var NotFoundError : Dynamic;
	static public var OperationCancelledError : Dynamic;
	static public var PTR : Dynamic;
	static public var ResolverError : Dynamic;
	static public var SRV : Dynamic;
	static public var ServerFailureError : Dynamic;
	static public var ServerRefusedError : Dynamic;
	static public var TXT : Dynamic;
	/**
		int(x=0) -> integer
		int(x, base=10) -> integer
	...
	**/
	public function canonicalNameRecords():Dynamic;
	/**
	...
	**/
	public function hostAddressRecords():Dynamic;
	/**
	...
	**/
	public function mailExchangeRecords():Dynamic;
	/**
	...
	**/
	public function nameServerRecords():Dynamic;
	/**
		nameserver(self) -> QHostAddress
	**/
	public function nameserver():Dynamic;
	/**
		nameserverChanged(self, Union[QHostAddress, QHostAddress.SpecialAddress]) [signal]
	**/
	public var nameserverChanged : Dynamic;
	/**
		objectName(self) -> str
	**/
	...
	**/
	public function pointerRecords():Dynamic;
	/**
	...
	**/
	public function serviceRecords():Dynamic;
	/**
		setName(self, str)
	**/
	...
	**/
	public function setNameserver(Union:Dynamic):Void;
	/**
	...
	**/
	public function setType(QDnsLookup:Dynamic):Void;
	/**
	...
	**/
	public function textRecords():Dynamic;
	/**
		thread(self) -> QThread
	**/
	...
	**/
	public var typeChanged : Dynamic;
}