...
@:pythonImport("PyQt5.QtNetwork", "QHttpMultiPart") extern class QHttpMultiPart {
	static public var AlternativeType : Dynamic;
	/**
		int(x=0) -> integer
		...
		4
	**/
	public function ContentType(args:haxe.extern.Rest<Dynamic>):Dynamic;
	static public var FormDataType : Dynamic;
	static public var MixedType : Dynamic;
	static public var RelatedType : Dynamic;
	...
	**/
	public function append(QHttpPart:Dynamic):Void;
	/**
	...
	**/
	public function boundary():Dynamic;
	/**
	...
	**/
	public function setBoundary(Union:Dynamic):Void;
	/**
		setContentType(self, QHttpMultiPart.ContentType)
	**/
	public function setContentType(QHttpMultiPart:Dynamic):Void;
	/**
