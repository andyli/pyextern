...
@:pythonImport("PyQt5.QtMultimediaWidgets", "QCameraViewfinder") extern class QCameraViewfinder {
	...
	**/
	public var brightnessChanged : Dynamic;
	/**
	...
	**/
	public var contrastChanged : Dynamic;
	/**
	...
	**/
	public var fullScreenChanged : Dynamic;
	/**
		geometry(self) -> QRect
	**/
	...
	**/
	public var saturationChanged : Dynamic;
	/**
	...
	**/
	public function setBrightness(int:Int):Void;
	/**
	...
	**/
	public function setContrast(int:Int):Void;
	/**
	...
	**/
	public function setFullScreen(bool:Bool):Void;
	/**
	...
	**/
	...
	/**
		setHue(self, int)
	**/
	public function setHue(int:Int):Void;
	/**
	...
	**/
	public function setSaturation(int:Int):Void;
	/**
