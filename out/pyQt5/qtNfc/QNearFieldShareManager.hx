...
package pyQt5.qtNfc;
@:pythonImport("PyQt5.QtNfc", "QNearFieldShareManager") extern class QNearFieldShareManager {
	static public var FileShare : Dynamic;
	static public var InvalidShareContentError : Dynamic;
	static public var NdefShare : Dynamic;
	static public var NoError : Dynamic;
	static public var NoShare : Dynamic;
	static public var ShareAlreadyInProgressError : Dynamic;
	static public var ShareCanceledError : Dynamic;
	/**
		int(x=0) -> integer
		...
		4
	**/
	public function ShareError(args:haxe.extern.Rest<Dynamic>):Dynamic;
	static public var ShareInterruptedError : Dynamic;
	/**
		int(x=0) -> integer
		int(x, base=10) -> integer
		...
		4
	**/
	public function ShareMode(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	static public function ShareModes(args:haxe.extern.Rest<Dynamic>):Void;
	static public var SharePermissionDeniedError : Dynamic;
	static public var ShareRejectedError : Dynamic;
	static public var UnknownError : Dynamic;
	static public var UnsupportedShareModeError : Dynamic;
	...
	**/
	...
	/**
		setShareModes(self, QNearFieldShareManager.ShareModes)
	**/
	public function setShareModes(QNearFieldShareManager:Dynamic):Void;
	/**
		shareError(self) -> QNearFieldShareManager.ShareError
	**/
	public function shareError():Dynamic;
	/**
		shareModes(self) -> QNearFieldShareManager.ShareModes
	**/
	public function shareModes():Dynamic;
	/**
		shareModesChanged(self, QNearFieldShareManager.ShareModes) [signal]
	**/
	public var shareModesChanged : Dynamic;
	/**
	...
	**/
	static public function supportedShareModes():Dynamic;
	/**
		targetDetected(self, QNearFieldShareTarget) [signal]
	**/
	public var targetDetected : Dynamic;
	/**
		thread(self) -> QThread
	**/
