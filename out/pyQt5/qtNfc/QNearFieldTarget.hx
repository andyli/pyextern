...
package pyQt5.qtNfc;
@:pythonImport("PyQt5.QtNfc", "QNearFieldTarget") extern class QNearFieldTarget {
	/**
		int(x=0) -> integer
		...
		4
	**/
	public function AccessMethod(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	static public function AccessMethods(args:haxe.extern.Rest<Dynamic>):Void;
	static public var ChecksumMismatchError : Dynamic;
	/**
		int(x=0) -> integer
		int(x, base=10) -> integer
	...
	**/
	...
	static public var InvalidParametersError : Dynamic;
	static public var LlcpAccess : Dynamic;
	static public var MifareTag : Dynamic;
	static public var NdefAccess : Dynamic;
	static public var NdefReadError : Dynamic;
	static public var NdefWriteError : Dynamic;
	static public var NfcTagType1 : Dynamic;
	static public var NfcTagType2 : Dynamic;
	static public var NfcTagType3 : Dynamic;
	static public var NfcTagType4 : Dynamic;
	static public var NoError : Dynamic;
	static public var NoResponseError : Dynamic;
	static public var ProprietaryTag : Dynamic;
	/**
		QNearFieldTarget.RequestId()
		QNearFieldTarget.RequestId(QNearFieldTarget.RequestId)
	**/
	static public function RequestId(args:haxe.extern.Rest<Dynamic>):Void;
	static public var TagTypeSpecificAccess : Dynamic;
	static public var TargetOutOfRangeError : Dynamic;
	/**
		int(x=0) -> integer
		int(x, base=10) -> integer
	...
	**/
	...
	static public var UnknownAccess : Dynamic;
	static public var UnknownError : Dynamic;
	static public var UnsupportedError : Dynamic;
	...
	**/
	public function accessMethods():Dynamic;
	/**
	...
	**/
	public function handleResponse(QNearFieldTarget:Dynamic, Union:Dynamic):Bool;
	/**
	...
	**/
	public var ndefMessageRead : Dynamic;
	/**
		ndefMessagesWritten(self) [signal]
	**/
	public var ndefMessagesWritten : Dynamic;
	/**
		objectName(self) -> str
	**/
	...
	**/
	public function readNdefMessages():Dynamic;
	/**
	...
	**/
	public function setResponseForRequest(QNearFieldTarget:Dynamic, Any:Dynamic, ?emitRequestCompleted:Dynamic):Void;
	/**
	...
	**/
	public function waitForRequestCompleted(QNearFieldTarget:Dynamic, ?msecs:Dynamic):Bool;
	/**
		writeNdefMessages(self, object) -> QNearFieldTarget.RequestId
	**/
	public function writeNdefMessages(object:Dynamic):Dynamic;
}