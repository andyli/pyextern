...
package pyQt5.qtQml;
@:pythonImport("PyQt5.QtQml", "QQmlIncubator") extern class QQmlIncubator {
	...
	**/
	public function incubationMode():Dynamic;
	/**
		isError(self) -> bool
	**/
	...
	**/
	public function setInitialState(QObject:Dynamic):Void;
	/**
	...
	**/
	public function statusChanged(QQmlIncubator:Dynamic):Void;
}