...
package pyQt5.qtQml;
@:pythonImport("PyQt5.QtQml", "QQmlExtensionPlugin") extern class QQmlExtensionPlugin {
	...
	**/
	public function initializeEngine(QQmlEngine:Dynamic, str:String):Void;
	/**
	...
	**/
	public function registerTypes(str:String):Void;
	/**
