...
package pyQt5.qtQml;
@:pythonImport("PyQt5.QtQml", "QQmlPropertyMap") extern class QQmlPropertyMap {
	...
	**/
	...
	/**
		clear(self, str)
	**/
	public function clear(str:String):Void;
	/**
	...
	**/
	...
	/**
		insert(self, str, Any)
	**/
	public function insert(str:String, Any:Dynamic):Void;
	/**
	...
	**/
	public function updateValue(str:String, Any:Dynamic):Dynamic;
	/**
		value(self, str) -> Any
	**/
	public function value(str:String):Dynamic;
	/**
