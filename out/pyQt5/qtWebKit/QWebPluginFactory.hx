...
@:pythonImport("PyQt5.QtWebKit", "QWebPluginFactory") extern class QWebPluginFactory {
	/**
		int(x=0) -> integer
	...
	**/
	static public function ExtensionOption(args:haxe.extern.Rest<Dynamic>):Void;
	/**
		QWebPluginFactory.ExtensionReturn()
		QWebPluginFactory.ExtensionReturn(QWebPluginFactory.ExtensionReturn)
	**/
	static public function ExtensionReturn(args:haxe.extern.Rest<Dynamic>):Void;
	/**
		QWebPluginFactory.MimeType()
		QWebPluginFactory.MimeType(QWebPluginFactory.MimeType)
	**/
	static public function MimeType(args:haxe.extern.Rest<Dynamic>):Void;
	/**
		QWebPluginFactory.Plugin()
		QWebPluginFactory.Plugin(QWebPluginFactory.Plugin)
	**/
	static public function Plugin(args:haxe.extern.Rest<Dynamic>):Void;
	...
	**/
	public function create(str:String, QUrl:Dynamic, Iterable:Dynamic, Iterable:Dynamic):Dynamic;
	/**
	...
	**/
	public function extension(QWebPluginFactory:Dynamic, ?option:Dynamic, ?output:Dynamic):Bool;
	/**
	...
	**/
	...
	/**
		plugins(self) -> object
	**/
	public function plugins():Dynamic;
	/**
	...
	**/
	public function supportsExtension(QWebPluginFactory:Dynamic):Bool;
	/**
		thread(self) -> QThread
	**/
