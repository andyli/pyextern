...
@:pythonImport("PyQt5.QtWebKit", "QWebHistoryInterface") extern class QWebHistoryInterface {
	...
	**/
	public function addHistoryEntry(str:String):Void;
	/**
	...
	**/
	static public function defaultInterface():Dynamic;
	/**
		deleteLater(self)
	**/
	...
	**/
	public function historyContains(str:String):Bool;
	/**
	...
	**/
	static public function setDefaultInterface(QWebHistoryInterface:Dynamic):Void;
	/**
