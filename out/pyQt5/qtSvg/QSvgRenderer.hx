...
package pyQt5.qtSvg;
@:pythonImport("PyQt5.QtSvg", "QSvgRenderer") extern class QSvgRenderer {
	...
	**/
	public function boundsOnElement(str:String):Dynamic;
	/**
	...
	**/
	public function defaultSize():Dynamic;
	/**
		deleteLater(self)
	**/
	...
	**/
	public function elementExists(str:String):Bool;
	/**
	...
	**/
	public var repaintNeeded : Dynamic;
	/**
		sender(self) -> QObject
	**/
	...
	**/
	public function setCurrentFrame(int:Int):Void;
	/**
		setFramesPerSecond(self, int)
	**/
	public function setFramesPerSecond(int:Int):Void;
	/**
