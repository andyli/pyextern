...
package pyQt5.qtGui;
@:pythonImport("PyQt5.QtGui", "QTextInlineObject") extern class QTextInlineObject {
	...
	**/
	public function setAscent(float:Float):Void;
	/**
		setDescent(self, float)
	**/
	public function setDescent(float:Float):Void;
	/**
		setWidth(self, float)
	**/
