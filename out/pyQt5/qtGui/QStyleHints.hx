...
package pyQt5.qtGui;
@:pythonImport("PyQt5.QtGui", "QStyleHints") extern class QStyleHints {
	...
	**/
	public var cursorFlashTimeChanged : Dynamic;
	/**
	...
	**/
	public var keyboardInputIntervalChanged : Dynamic;
	/**
		killTimer(self, int)
	**/
	...
	**/
	public var mouseDoubleClickIntervalChanged : Dynamic;
	/**
	...
	**/
	public function passwordMaskCharacter():String;
	/**
	...
	**/
	public var startDragDistanceChanged : Dynamic;
	/**
	...
	**/
	public var startDragTimeChanged : Dynamic;
	/**
	...
	**/
	public function tabFocusBehavior():Dynamic;
	/**
		thread(self) -> QThread
	**/
