...
package pyQt5.qtGui;
@:pythonImport("PyQt5.QtGui", "QStandardItem") extern class QStandardItem {
	/**
		int(x=0) -> integer
	...
	**/
	public function appendRows(Iterable:Dynamic):Void;
	/**
	...
	**/
	public function child(int:Int, ?column:Dynamic):Dynamic;
	/**
	...
	**/
	public function index():Dynamic;
	/**
		insertColumn(self, int, Iterable[QStandardItem])
	**/
	public function insertColumn(int:Int, Iterable:Dynamic):Void;
	/**
	...
	**/
	public function insertRows(int:Int, args:haxe.extern.Rest<Dynamic>):Void;
	/**
	...
	**/
	public function setAccessibleText(str:String):Void;
	/**
		setAutoTristate(self, bool)
	**/
	public function setAutoTristate(bool:Bool):Void;
	/**
	...
	**/
	public function setChild(int:Int, args:haxe.extern.Rest<Dynamic>):Void;
	/**
	...
	**/
	public function setData(Any:Dynamic, ?role:Dynamic):Void;
	/**
	...
	**/
	public function setDropEnabled(bool:Bool):Void;
	/**
	...
	**/
	public function setTextAlignment(Union:Dynamic):Void;
	/**
		setToolTip(self, str)
	**/
	...
	**/
	public function setTristate(bool:Bool):Void;
	/**
		setUserTristate(self, bool)
	**/
	public function setUserTristate(bool:Bool):Void;
	/**
	...
	**/
	public function sortChildren(int:Int, ?order:Dynamic):Void;
	/**
		statusTip(self) -> str
	**/
	...
	**/
	public function takeChild(int:Int, ?column:Dynamic):Dynamic;
	/**
