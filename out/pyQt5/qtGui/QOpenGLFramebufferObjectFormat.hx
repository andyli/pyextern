...
package pyQt5.qtGui;
@:pythonImport("PyQt5.QtGui", "QOpenGLFramebufferObjectFormat") extern class QOpenGLFramebufferObjectFormat {
	...
	**/
	public function setInternalTextureFormat(int:Int):Void;
	/**
		setMipmap(self, bool)
	**/
	...
	**/
	public function setTextureTarget(int:Int):Void;
	/**
