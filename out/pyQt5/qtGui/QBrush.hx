...
package pyQt5.qtGui;
@:pythonImport("PyQt5.QtGui", "QBrush") extern class QBrush {
	...
	**/
	public function gradient():Dynamic;
	/**
		isOpaque(self) -> bool
	**/
	...
	**/
	public function setColor(args:haxe.extern.Rest<Dynamic>):Void;
	/**
	...
	**/
	public function setTexture(QPixmap:Dynamic):Void;
	/**
		setTextureImage(self, QImage)
	**/
	public function setTextureImage(QImage:Dynamic):Void;
	/**
		setTransform(self, QTransform)
	**/
	public function setTransform(QTransform:Dynamic):Void;
	/**
	...
	**/
	...
	/**
		swap(self, QBrush)
	**/
	public function swap(QBrush:Dynamic):Void;
	/**
	...
	**/
	public function textureImage():Dynamic;
	/**
