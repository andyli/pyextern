...
package pyQt5.qtGui;
@:pythonImport("PyQt5.QtGui", "QDoubleValidator") extern class QDoubleValidator {
	...
	**/
	public function notation():Dynamic;
	/**
		objectName(self) -> str
	**/
	...
	**/
	public function setNotation(QDoubleValidator:Dynamic):Void;
	/**
	...
	**/
	public function setRange(float:Float, float:Float, ?decimals:Dynamic):Void;
	/**
		setTop(self, float)
	**/
