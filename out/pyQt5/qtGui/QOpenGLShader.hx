...
package pyQt5.qtGui;
@:pythonImport("PyQt5.QtGui", "QOpenGLShader") extern class QOpenGLShader {
	...
	**/
	static public function ShaderType(args:haxe.extern.Rest<Dynamic>):Void;
	/**
		int(x=0) -> integer
	...
	**/
	public function compileSourceCode(args:haxe.extern.Rest<Dynamic>):Bool;
	/**
		compileSourceFile(self, str) -> bool
	**/
	public function compileSourceFile(str:String):Bool;
	/**
	...
	**/
	static public function hasOpenGLShaders(Union:Dynamic, ?context:Dynamic):Bool;
	/**
	...
	**/
	public function shaderType():Dynamic;
	/**
	...
	**/
	public function sourceCode():Dynamic;
	/**
