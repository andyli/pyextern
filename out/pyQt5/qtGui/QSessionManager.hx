...
package pyQt5.qtGui;
@:pythonImport("PyQt5.QtGui", "QSessionManager") extern class QSessionManager {
	...
	**/
	public function discardCommand():Dynamic;
	/**
		disconnect(self)
	**/
	...
	**/
	...
	/**
		requestPhase2(self)
	**/
	public function requestPhase2():Void;
	/**
		restartCommand(self) -> List[str]
	**/
	public function restartCommand():Dynamic;
	/**
		restartHint(self) -> QSessionManager.RestartHint
	**/
	public function restartHint():Dynamic;
	/**
		sender(self) -> QObject
	**/
	...
	**/
	public function setDiscardCommand(Iterable:Dynamic):Void;
	/**
		setManagerProperty(self, str, str)
		setManagerProperty(self, str, Iterable[str])
	**/
	public function setManagerProperty(str:String, args:haxe.extern.Rest<Dynamic>):Void;
	/**
	...
	**/
	public function setRestartCommand(Iterable:Dynamic):Void;
	/**
		setRestartHint(self, QSessionManager.RestartHint)
	**/
	public function setRestartHint(QSessionManager:Dynamic):Void;
	/**
