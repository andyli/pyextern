...
package pyQt5.qtGui;
@:pythonImport("PyQt5.QtGui", "QDragEnterEvent") extern class QDragEnterEvent {
	...
	**/
	...
	/**
		...
		accept(self, QRect)
	**/
	public function accept(args:haxe.extern.Rest<Dynamic>):Void;
	/**
		acceptProposedAction(self)
	**/
	public function acceptProposedAction():Void;
	/**
		answerRect(self) -> QRect
	**/
	public function answerRect():Dynamic;
	/**
		dropAction(self) -> Qt.DropAction
	**/
	public function dropAction():Dynamic;
	/**
		ignore(self)
		ignore(self, QRect)
	**/
	public function ignore(args:haxe.extern.Rest<Dynamic>):Void;
	/**
	...
	**/
	public function keyboardModifiers():Dynamic;
	/**
		mimeData(self) -> QMimeData
	**/
	public function mimeData():Dynamic;
	/**
		mouseButtons(self) -> Qt.MouseButtons
	**/
	public function mouseButtons():Dynamic;
	/**
		pos(self) -> QPoint
	**/
	...
	**/
	public function possibleActions():Dynamic;
	/**
		proposedAction(self) -> Qt.DropAction
	**/
	public function proposedAction():Dynamic;
	/**
	...
	**/
	public function setDropAction(Qt:Dynamic):Void;
	/**
		source(self) -> QObject
	**/
