...
package pyQt5.qtGui;
@:pythonImport("PyQt5.QtGui", "QTabletEvent") extern class QTabletEvent {
	...
	**/
	public function globalPos():Dynamic;
	/**
		globalPosF(self) -> QPointF
	**/
	public function globalPosF():Dynamic;
	/**
		globalX(self) -> int
	**/
	...
	**/
	public function pointerType():Dynamic;
	/**
		pos(self) -> QPoint
	**/
