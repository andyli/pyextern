...
package pyQt5.qtGui;
@:pythonImport("PyQt5.QtGui", "QPainterPathStroker") extern class QPainterPathStroker {
	...
	**/
	public function createStroke(QPainterPath:Dynamic):Dynamic;
	/**
	...
	**/
	public function setCurveThreshold(float:Float):Void;
	/**
	...
	**/
	public function setDashPattern(args:haxe.extern.Rest<Dynamic>):Void;
	/**
