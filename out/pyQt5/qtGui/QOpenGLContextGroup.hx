...
package pyQt5.qtGui;
@:pythonImport("PyQt5.QtGui", "QOpenGLContextGroup") extern class QOpenGLContextGroup {
	...
	**/
	static public function currentContextGroup():Dynamic;
	/**
	...
	**/
	...
	/**
		shares(self) -> object
	**/
	public function shares():Dynamic;
	/**
