...
package pyQt5.qtGui;
@:pythonImport("PyQt5.QtGui", "QWheelEvent") extern class QWheelEvent {
	...
	**/
	public function angleDelta():Dynamic;
	/**
	...
	**/
	public function phase():Dynamic;
	/**
		pixelDelta(self) -> QPoint
	**/
	public function pixelDelta():Dynamic;
	/**
		pos(self) -> QPoint
	**/
