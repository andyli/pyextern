...
package pyQt5.qtGui;
@:pythonImport("PyQt5.QtGui", "QTouchDevice") extern class QTouchDevice {
	...
	**/
	...
	/**
		devices() -> object
	**/
	static public function devices():Dynamic;
	/**
	...
	**/
	public function setCapabilities(QTouchDevice:Dynamic):Void;
	/**
		setMaximumTouchPoints(self, int)
	**/
	public function setMaximumTouchPoints(int:Int):Void;
	/**
		setName(self, str)
	**/
	...
	**/
	public function setType(QTouchDevice:Dynamic):Void;
	/**
