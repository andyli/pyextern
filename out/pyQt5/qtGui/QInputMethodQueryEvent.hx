...
package pyQt5.qtGui;
@:pythonImport("PyQt5.QtGui", "QInputMethodQueryEvent") extern class QInputMethodQueryEvent {
	...
	**/
	public function queries():Dynamic;
	/**
	...
	**/
	public function setValue(Qt:Dynamic, Any:Dynamic):Void;
	/**
	...
	**/
	public function value(Qt:Dynamic):Dynamic;
}