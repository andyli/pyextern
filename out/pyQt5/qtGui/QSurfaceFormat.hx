...
@:pythonImport("PyQt5.QtGui", "QSurfaceFormat") extern class QSurfaceFormat {
	...
	**/
	public function setOption(QSurfaceFormat:Dynamic, args:haxe.extern.Rest<Dynamic>):Void;
	/**
		setOptions(self, QSurfaceFormat.FormatOptions)
	**/
	public function setOptions(QSurfaceFormat:Dynamic):Void;
	/**
	...
	**/
	public function testOption(QSurfaceFormat:Dynamic):Bool;
	/**
