...
package pyQt5.qtGui;
@:pythonImport("PyQt5.QtGui", "QOpenGLVertexArrayObject") extern class QOpenGLVertexArrayObject {
	/**
		QOpenGLVertexArrayObject.Binder(QOpenGLVertexArrayObject)
	**/
	static public function Binder(QOpenGLVertexArrayObject:Dynamic):Void;
