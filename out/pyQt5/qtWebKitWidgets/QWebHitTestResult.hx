...
@:pythonImport("PyQt5.QtWebKitWidgets", "QWebHitTestResult") extern class QWebHitTestResult {
	...
	**/
	public function element():Dynamic;
	/**
		enclosingBlockElement(self) -> QWebElement
	**/
	public function enclosingBlockElement():Dynamic;
	/**
	...
	**/
	...
	/**
		imageUrl(self) -> QUrl
	**/
	public function imageUrl():Dynamic;
	/**
	...
	**/
	public function linkElement():Dynamic;
	/**
		linkTargetFrame(self) -> QWebFrame
	**/
	public function linkTargetFrame():Dynamic;
	/**
		linkText(self) -> str
	**/
	...
	/**
		linkTitle(self) -> QUrl
	**/
	public function linkTitle():Dynamic;
	/**
		linkTitleString(self) -> str
	**/
	public function linkTitleString():String;
	/**
		linkUrl(self) -> QUrl
	**/
