...
@:pythonImport("PyQt5.QtWebKitWidgets", "QGraphicsWebView") extern class QGraphicsWebView {
	/**
		int(x=0) -> integer
	...
	**/
	public function findText(str:String, ?options:Dynamic):Bool;
	/**
	...
	**/
	public function history():Dynamic;
	/**
	...
	**/
	public function isTiledBackingStoreFrozen():Bool;
	/**
	...
	**/
	public var linkClicked : Dynamic;
	/**
		load(self, QUrl)
	...
	**/
	public var loadProgress : Dynamic;
	/**
	...
	**/
	public function pageAction(QWebPage:Dynamic):Dynamic;
	/**
	...
	**/
	public function resizesToContents():Bool;
	/**
		rotation(self) -> float
	**/
	...
	**/
	public function setPage(QWebPage:Dynamic):Void;
	/**
	...
	**/
	public function setRenderHint(QPainter:Dynamic, ?enabled:Dynamic):Void;
	/**
		setRenderHints(self, QPainter.RenderHints)
	**/
	public function setRenderHints(QPainter:Dynamic):Void;
	/**
		setResizesToContents(self, bool)
	**/
	public function setResizesToContents(bool:Bool):Void;
	/**
	...
	**/
	public function setTiledBackingStoreFrozen(bool:Bool):Void;
	/**
		setToolTip(self, str)
	**/
	...
	**/
	public function sizeHint(Qt:Dynamic, QSizeF:Dynamic):Dynamic;
	/**
	...
	**/
	public var statusBarMessage : Dynamic;
	/**
		stop(self)
	**/
	...
	**/
	public function triggerPageAction(QWebPage:Dynamic, ?checked:Dynamic):Void;
	/**
		type(self) -> int
	**/
