...
@:pythonImport("PyQt5.QtPrintSupport", "QPrintDialog") extern class QPrintDialog {
	...
	**/
	static public function PrintDialogOptions(args:haxe.extern.Rest<Dynamic>):Void;
	...
	**/
	public function enabledOptions():Dynamic;
	/**
		ensurePolished(self)
	**/
	...
	**/
	public function printer():Dynamic;
	/**
	...
	**/
	public function setEnabledOptions(Union:Dynamic):Void;
	/**
	...
	**/
	public function setMinMax(int:Int, int:Int):Void;
	/**
	...
	**/
	public function setOption(QAbstractPrintDialog:Dynamic, ?on:Dynamic):Void;
	/**
		setOptionTabs(self, Iterable[QWidget])
	**/
	public function setOptionTabs(Iterable:Dynamic):Void;
	/**
	...
	**/
	public function setPrintRange(QAbstractPrintDialog:Dynamic):Void;
	/**
	...
	**/
	public function testOption(QAbstractPrintDialog:Dynamic):Bool;
	/**
		thread(self) -> QThread
	**/
