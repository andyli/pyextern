...
@:pythonImport("docutils.utils.math.math2html", "BracketCommand") extern class BracketCommand {
	...
	**/
	public function create(direction:Dynamic, character:Dynamic):Dynamic;
	/**
