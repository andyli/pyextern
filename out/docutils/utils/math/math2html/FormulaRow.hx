...
@:pythonImport("docutils.utils.math.math2html", "FormulaRow") extern class FormulaRow {
	...
	**/
	...
	static public var cellseparator : Dynamic;
	/**
	...
	**/
	public function createcell(index:Dynamic):Dynamic;
	/**
	...
	**/
	...
	public function setalignments(alignments:Dynamic):Dynamic;
	/**
