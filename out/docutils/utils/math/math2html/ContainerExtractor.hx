...
@:pythonImport("docutils.utils.math.math2html", "ContainerExtractor") extern class ContainerExtractor {
	...
	**/
	public function extract(container:Dynamic):Dynamic;
	/**
		Add allowed containers, clone cloned containers and add the clone.
	**/
	public function process(container:Dynamic, list:Dynamic):Dynamic;
	/**
		Return a new container with contents only in a safe list, recursively.
	**/
	public function safeclone(container:Dynamic):Dynamic;
}