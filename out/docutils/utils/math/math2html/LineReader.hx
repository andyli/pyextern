...
@:pythonImport("docutils.utils.math.math2html", "LineReader") extern class LineReader {
	...
	**/
	public function currentline():Dynamic;
	/**
	...
	**/
	...
	/**
		Go to next line
	**/
	public function nextline():Dynamic;
	/**
	...
	**/
	public function setend(lastline:Dynamic):Dynamic;
	/**
		Set the first line to read.
	**/
	public function setstart(firstline:Dynamic):Dynamic;
}