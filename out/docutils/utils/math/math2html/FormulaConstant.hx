...
@:pythonImport("docutils.utils.math.math2html", "FormulaConstant") extern class FormulaConstant {
	...
	**/
	...
	public function changeline(line:Dynamic):Dynamic;
	/**
	...
	**/
	...
	static public var parsed : Dynamic;
	...
	**/
	public function replacespecial(line:Dynamic):Dynamic;
	/**
