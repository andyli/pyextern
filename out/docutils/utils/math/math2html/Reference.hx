...
@:pythonImport("docutils.utils.math.math2html", "Reference") extern class Reference {
	...
	**/
	public function formatcontents():Dynamic;
	/**
	...
	**/
	...
	static public var references : Dynamic;
	/**
	...
	**/
	public function replace(key:Dynamic, value:Dynamic):Dynamic;
	/**
