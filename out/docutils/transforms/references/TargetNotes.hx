...
@:pythonImport("docutils.transforms.references", "TargetNotes") extern class TargetNotes {
	...
	**/
	...
	public function make_target_footnote(refuri:Dynamic, refs:Dynamic, notes:Dynamic):Dynamic;
}