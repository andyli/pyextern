...
package docutils.parsers.rst.directives.parts;
@:pythonImport("docutils.parsers.rst.directives.parts", "Contents") extern class Contents {
	...
	**/
	...
	static public function backlinks(arg:Dynamic):Dynamic;
	static public var backlinks_values : Dynamic;
