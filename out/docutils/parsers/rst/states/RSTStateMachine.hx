...
@:pythonImport("docutils.parsers.rst.states", "RSTStateMachine") extern class RSTStateMachine {
	...
	**/
	public function run(input_lines:Dynamic, document:Dynamic, ?input_offset:Dynamic, ?match_titles:Dynamic, ?inliner:Dynamic):Dynamic;
	/**
