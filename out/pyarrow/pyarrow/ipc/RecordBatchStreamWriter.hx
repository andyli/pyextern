...
package pyarrow.ipc;
@:pythonImport("pyarrow.ipc", "RecordBatchStreamWriter") extern class RecordBatchStreamWriter {
	...
	**/
	@:native("__init__")
	public function ___init__(sink:Dynamic, schema:Dynamic, ?use_legacy_format:Dynamic, ?options:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(sink:Dynamic, schema:Dynamic, ?use_legacy_format:Dynamic, ?options:Dynamic):Void;
	/**
