...
package pyarrow.ipc;
@:pythonImport("pyarrow.ipc", "RecordBatchFileReader") extern class RecordBatchFileReader {
	...
	**/
	@:native("__init__")
	public function ___init__(source:Dynamic, ?footer_offset:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(source:Dynamic, ?footer_offset:Dynamic):Void;
	/**
	...
	**/
	...
	/**
		_RecordBatchFileReader._open(self, source, footer_offset=None)
	**/
	...
	**/
	...
	/**
		_RecordBatchFileReader.get_batch(self, int i)
	**/
	public function get_record_batch(args:haxe.extern.Rest<Dynamic>):Dynamic;
