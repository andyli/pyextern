...
@:pythonImport("pyarrow.filesystem", "LocalFileSystem") extern class LocalFileSystem {
	...
	**/
	...
	static public function _get_instance():Dynamic;
	...
	**/
	...
	static public function get_instance():Dynamic;
	/**
	...
	**/
	public function walk(path:Dynamic):Dynamic;
}