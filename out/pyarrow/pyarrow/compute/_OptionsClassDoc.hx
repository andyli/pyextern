...
@:pythonImport("pyarrow.compute", "_OptionsClassDoc") extern class _OptionsClassDoc {
	/**
		Return self+value.
	**/
	...
	**/
	...
	/**
		Create new instance of _OptionsClassDoc(params,)
	**/
	static public function __new__(_cls:Dynamic, params:Dynamic):Dynamic;
	/**
		Helper for pickle.
	**/
	...
	**/
	...
	/**
		Make a new _OptionsClassDoc object from a sequence or iterable
	**/
	static public function _make(iterable:Dynamic):Dynamic;
	/**
		Return a new _OptionsClassDoc object replacing specified fields with new values
	**/
