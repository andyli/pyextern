...
@:pythonImport("pyarrow.vendored.version", "_Version") extern class _Version {
	/**
		Return self+value.
	**/
	...
	**/
	static public function __new__(_cls:Dynamic, epoch:Dynamic, release:Dynamic, dev:Dynamic, pre:Dynamic, post:Dynamic, local:Dynamic):Dynamic;
	/**
		Helper for pickle.
	**/
