...
package pyarrow.lib;
@:pythonImport("pyarrow.lib", "UnionArray") extern class UnionArray {
	/**
	...
	**/
	static public function from_dense(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	...
	/**
		...
		union_array : UnionArray
	**/
	static public function from_sparse(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
