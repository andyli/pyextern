...
package pyarrow.lib;
@:pythonImport("pyarrow.lib", "LargeListArray") extern class LargeListArray {
	/**
	...
	**/
	...
	/**
		LargeListArray.from_arrays(offsets, values, MemoryPool pool=None)
	...
	**/
	public function value_lengths(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	public function value_parent_indices(args:haxe.extern.Rest<Dynamic>):Dynamic;
