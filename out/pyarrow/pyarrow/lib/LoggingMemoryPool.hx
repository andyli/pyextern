...
package pyarrow.lib;
@:pythonImport("pyarrow.lib", "LoggingMemoryPool") extern class LoggingMemoryPool {
	...
	**/
	public var backend_name : Dynamic;
	/**
		...
		memory pool.
	**/
	public function bytes_allocated(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
		...
		compute this number.
	**/
	public function max_memory(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	public function release_unused(args:haxe.extern.Rest<Dynamic>):Dynamic;
}