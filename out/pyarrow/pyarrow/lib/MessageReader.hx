...
package pyarrow.lib;
@:pythonImport("pyarrow.lib", "MessageReader") extern class MessageReader {
	...
	**/
	static public function open_stream(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
		...
		StopIteration
		    At end of stream
	**/
	public function read_next_message(args:haxe.extern.Rest<Dynamic>):Dynamic;
}