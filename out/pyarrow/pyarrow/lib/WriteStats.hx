...
package pyarrow.lib;
@:pythonImport("pyarrow.lib", "WriteStats") extern class WriteStats {
	/**
		Return self+value.
	**/
	...
	**/
	static public function __new__(_cls:Dynamic, num_messages:Dynamic, num_record_batches:Dynamic, num_dictionary_batches:Dynamic, num_dictionary_deltas:Dynamic, num_replaced_dictionaries:Dynamic):Dynamic;
	/**
		Helper for pickle.
	**/
	...
	**/
	public var num_dictionary_batches : Dynamic;
	/**
		Alias for field number 3
	**/
	public var num_dictionary_deltas : Dynamic;
	/**
		Alias for field number 0
	**/
	public var num_messages : Dynamic;
	/**
		Alias for field number 1
	**/
	public var num_record_batches : Dynamic;
	/**
		Alias for field number 4
	**/
	public var num_replaced_dictionaries : Dynamic;
}