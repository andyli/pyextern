...
@:pythonImport("pyarrow.parquet", "ParquetPartitions") extern class ParquetPartitions {
	...
	**/
	...
	public function filter_accepts_partition(part_key:Dynamic, filter:Dynamic, level:Dynamic):Dynamic;
	/**
		...
		key : str or int
		    The partition value
	**/
	public function get_index(level:Dynamic, name:Dynamic, key:Dynamic):Dynamic;
}