...
@:pythonImport("pyarrow.gandiva", "Expression") extern class Expression {
	...
	**/
	...
	/**
		Expression.__reduce_cython__(self)
	**/
	...
	**/
	...
	/**
		Expression.__setstate_cython__(self, __pyx_state)
	**/
