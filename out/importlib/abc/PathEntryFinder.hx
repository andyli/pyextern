...
@:pythonImport("importlib.abc", "PathEntryFinder") extern class PathEntryFinder {
	...
	**/
	public function find_loader(fullname:Dynamic):Dynamic;
	/**
	...
	**/
	public function find_module(fullname:Dynamic):Dynamic;
	/**
