...
package importlib;
@:pythonImport("importlib._bootstrap") extern class _Bootstrap {
	...
	**/
	...
	/**
		...
		module code)
	**/
	static public function _call_with_frames_removed(f:Dynamic, args:Dynamic, kwds:Dynamic):Dynamic;
	/**
	...
	**/
	static public function _verbose_message(message:Dynamic, args:Dynamic, ?verbosity:Dynamic):Dynamic;
	/**
