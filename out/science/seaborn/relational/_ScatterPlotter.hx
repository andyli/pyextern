...
@:pythonImport("seaborn.relational", "_ScatterPlotter") extern class _ScatterPlotter {
	...
	**/
	@:native("__init__")
	public function ___init__(?data:Dynamic, ?variables:Dynamic, ?x_bins:Dynamic, ?y_bins:Dynamic, ?estimator:Dynamic, ?ci:Dynamic, ?n_boot:Dynamic, ?alpha:Dynamic, ?x_jitter:Dynamic, ?y_jitter:Dynamic, ?legend:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(?data:Dynamic, ?variables:Dynamic, ?x_bins:Dynamic, ?y_bins:Dynamic, ?estimator:Dynamic, ?ci:Dynamic, ?n_boot:Dynamic, ?alpha:Dynamic, ?x_jitter:Dynamic, ?y_jitter:Dynamic, ?legend:Dynamic):Void;
	/**
