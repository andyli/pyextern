...
@:pythonImport("seaborn.relational", "_LinePlotter") extern class _LinePlotter {
	...
	**/
	@:native("__init__")
	public function ___init__(?data:Dynamic, ?variables:Dynamic, ?estimator:Dynamic, ?ci:Dynamic, ?n_boot:Dynamic, ?seed:Dynamic, ?sort:Dynamic, ?err_style:Dynamic, ?err_kws:Dynamic, ?legend:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(?data:Dynamic, ?variables:Dynamic, ?estimator:Dynamic, ?ci:Dynamic, ?n_boot:Dynamic, ?seed:Dynamic, ?sort:Dynamic, ?err_style:Dynamic, ?err_kws:Dynamic, ?legend:Dynamic):Void;
	/**
	...
	**/
	public function aggregate(vals:Dynamic, grouper:Dynamic, ?units:Dynamic):Dynamic;
	/**
	...
	**/
	...
	static public var sort : Dynamic;
	/**
