...
@:pythonImport("seaborn.categorical", "_CountPlotter") extern class _CountPlotter {
	...
	**/
	@:native("__init__")
	public function ___init__(x:Dynamic, y:Dynamic, hue:Dynamic, data:Dynamic, order:Dynamic, hue_order:Dynamic, estimator:Dynamic, ci:Dynamic, n_boot:Dynamic, units:Dynamic, seed:Dynamic, orient:Dynamic, color:Dynamic, palette:Dynamic, saturation:Dynamic, errcolor:Dynamic, errwidth:Dynamic, capsize:Dynamic, dodge:Dynamic):Dynamic;
	/**
		Initialize the plotter.
	**/
	public function new(x:Dynamic, y:Dynamic, hue:Dynamic, data:Dynamic, order:Dynamic, hue_order:Dynamic, estimator:Dynamic, ci:Dynamic, n_boot:Dynamic, units:Dynamic, seed:Dynamic, orient:Dynamic, color:Dynamic, palette:Dynamic, saturation:Dynamic, errcolor:Dynamic, errwidth:Dynamic, capsize:Dynamic, dodge:Dynamic):Void;
	/**
