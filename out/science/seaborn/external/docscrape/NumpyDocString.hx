...
@:pythonImport("seaborn.external.docscrape", "NumpyDocString") extern class NumpyDocString {
	...
	**/
	@:native("__init__")
	public function ___init__(docstring:Dynamic, ?config:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(docstring:Dynamic, ?config:Dynamic):Void;
	/**
