...
@:pythonImport("seaborn.external.docscrape", "FunctionDoc") extern class FunctionDoc {
	...
	**/
	@:native("__init__")
	public function ___init__(func:Dynamic, ?role:Dynamic, ?doc:Dynamic, ?config:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(func:Dynamic, ?role:Dynamic, ?doc:Dynamic, ?config:Dynamic):Void;
	/**
	...
	**/
	...
	public function get_func():Dynamic;
	/**
