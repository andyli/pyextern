...
@:pythonImport("seaborn.external.docscrape") extern class Docscrape_Module {
	...
	**/
	...
	static public function header(text:Dynamic, ?style:Dynamic):Dynamic;
	static public function indent(str:Dynamic, ?indent:Dynamic):Dynamic;
	/**
