...
@:pythonImport("seaborn.external.docscrape", "Parameter") extern class Parameter {
	/**
		Return self+value.
	**/
	...
	**/
	static public function __new__(_cls:Dynamic, name:Dynamic, type:Dynamic, desc:Dynamic):Dynamic;
	/**
		Helper for pickle.
	**/
