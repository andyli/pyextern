...
package seaborn.external.docscrape;
@:pythonImport("seaborn.external.docscrape", "ClassDoc") extern class ClassDoc {
	...
	**/
	@:native("__init__")
	public function ___init__(cls:Dynamic, ?doc:Dynamic, ?modulename:Dynamic, ?func_doc:Dynamic, ?config:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(cls:Dynamic, ?doc:Dynamic, ?modulename:Dynamic, ?func_doc:Dynamic, ?config:Dynamic):Void;
	/**
	...
	**/
	...
	public function _is_show_member(name:Dynamic):Dynamic;
	...
	**/
	...
	static public var extra_public_methods : Dynamic;
	/**
