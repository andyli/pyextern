...
@:pythonImport("numpy", "float64") extern class Float64 {
	...
	**/
	static public function __getformat__(typestr:Dynamic):Dynamic;
	/**
		Return self[key].
	**/
	...
	**/
	static public function __set_format__(typestr:Dynamic, fmt:Dynamic):Dynamic;
	/**
	...
	**/
	public function __trunc__():Dynamic;
	/**
		Return self^value.
	**/
