...
@:pythonImport("numpy.array_api.linalg", "SVDResult") extern class SVDResult {
	/**
	...
	**/
	static public function __new__(_cls:Dynamic, U:Dynamic, S:Dynamic, Vh:Dynamic):Dynamic;
	/**
		Helper for pickle.
	**/
