...
@:pythonImport("numpy.array_api.linalg", "EighResult") extern class EighResult {
	/**
		Return self+value.
	**/
	...
	**/
	static public function __new__(_cls:Dynamic, eigenvalues:Dynamic, eigenvectors:Dynamic):Dynamic;
	/**
		Helper for pickle.
	**/
	...
	**/
	public var eigenvalues : Dynamic;
	/**
		Alias for field number 1
	**/
	public var eigenvectors : Dynamic;
	/**
