...
@:pythonImport("numpy.array_api.linalg", "SlogdetResult") extern class SlogdetResult {
	/**
		Return self+value.
	**/
	...
	**/
	static public function __new__(_cls:Dynamic, sign:Dynamic, logabsdet:Dynamic):Dynamic;
	/**
		Helper for pickle.
	**/
