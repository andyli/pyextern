...
package numpy.f2py.common_rules;
@:pythonImport("numpy.f2py.common_rules") extern class Common_rules_Module {
	...
	static public function buildhooks(m:Dynamic):Dynamic;
	static public var f2py_version : Dynamic;
	static public function findcommonblocks(block:Dynamic, ?top:Dynamic):Dynamic;
