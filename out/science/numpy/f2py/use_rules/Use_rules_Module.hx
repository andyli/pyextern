...
package numpy.f2py.use_rules;
@:pythonImport("numpy.f2py.use_rules") extern class Use_rules_Module {
	...
	static public function buildusevar(name:Dynamic, realname:Dynamic, vars:Dynamic, usemodulename:Dynamic):Dynamic;
	static public function buildusevars(m:Dynamic, r:Dynamic):Dynamic;
	...
	static public var usemodule_rules : Dynamic;
}