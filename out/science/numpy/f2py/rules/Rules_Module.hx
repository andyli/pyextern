...
package numpy.f2py.rules;
@:pythonImport("numpy.f2py.rules") extern class Rules_Module {
	...
	static public var arg_rules : Dynamic;
	static public var aux_rules : Dynamic;
	static public function buildapi(rout:Dynamic):Dynamic;
	/**
		Return
	**/
	static public function buildmodule(m:Dynamic, um:Dynamic):Dynamic;
	static public var check_rules : Dynamic;
	static public function debugcapi(_var:Dynamic):Dynamic;
	static public var defmod_rules : Dynamic;
	...
	**/
	...
	static public var module_rules : Dynamic;
	...
	static public var rout_rules : Dynamic;
	static public var routine_rules : Dynamic;
	static public var sepdict : Dynamic;
	static public var stnd : Dynamic;
	static public function stripcomma(s:Dynamic):Dynamic;
	static public var typedef_need_dict : Dynamic;
}