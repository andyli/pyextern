...
@:pythonImport("numpy.random.bit_generator", "ISpawnableSeedSequence") extern class ISpawnableSeedSequence {
	...
	**/
	public function generate_state(n_words:Dynamic, ?dtype:Dynamic):Dynamic;
	/**
		spawn(n_children)
	...
	**/
	public function spawn(n_children:Dynamic):Dynamic;
}