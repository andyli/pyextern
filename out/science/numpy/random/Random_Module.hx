...
@:pythonImport("numpy.random") extern class Random_Module {
	/**
	...
	**/
	static public function __RandomState_ctor():Dynamic;
	...
	**/
	...
	/**
		...
		array([[0.77395605, 0.43887844, 0.85859792],
		       ...
		       [0.7611397 , 0.78606431, 0.12811363]])
	**/
	static public function default_rng(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
