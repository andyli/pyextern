...
@:pythonImport("numpy.core.shape_base") extern class Shape_base_Module {
	...
	**/
	...
	/**
		...
		masked_array(data=[0, --, 2, 2, 3, 4],
		       ...
		       fill_value=999999)
	**/
	static public function _concatenate(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	...
	/**
		...
		0
	**/
	static public function _ndim(a:Dynamic):Int;
	/**
		...
		2
	**/
	static public function _size(a:Dynamic, ?axis:Dynamic):Int;
