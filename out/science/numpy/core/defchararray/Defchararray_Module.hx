...
@:pythonImport("numpy.core.defchararray") extern class Defchararray_Module {
	...
	**/
	static public function equal(x1:Dynamic, x2:Dynamic):numpy.Ndarray;
	/**
	...
	**/
	static public function greater(x1:Dynamic, x2:Dynamic):numpy.Ndarray;
	/**
		Return (x1 >= x2) element-wise.
	...
	**/
	static public function greater_equal(x1:Dynamic, x2:Dynamic):numpy.Ndarray;
	/**
	...
	**/
	static public function less(x1:Dynamic, x2:Dynamic):numpy.Ndarray;
	/**
		Return (x1 <= x2) element-wise.
	...
	**/
	static public function less_equal(x1:Dynamic, x2:Dynamic):numpy.Ndarray;
	/**
	...
	**/
	static public function not_equal(x1:Dynamic, x2:Dynamic):numpy.Ndarray;
	/**
