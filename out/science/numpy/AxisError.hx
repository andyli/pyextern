...
package numpy;
@:pythonImport("numpy", "AxisError") extern class AxisError {
	/**
		exception cause
	**/
	...
	**/
	@:native("__init__")
	public function ___init__(axis:Dynamic, ?ndim:Dynamic, ?msg_prefix:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(axis:Dynamic, ?ndim:Dynamic, ?msg_prefix:Dynamic):Void;
	/**
