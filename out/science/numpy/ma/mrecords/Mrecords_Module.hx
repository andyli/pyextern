...
@:pythonImport("numpy.ma.mrecords") extern class Mrecords_Module {
	...
	**/
	static public function fromtextfile(fname:Dynamic, ?delimiter:Dynamic, ?commentchar:Dynamic, ?missingchar:Dynamic, ?varnames:Dynamic, ?vartypes:Dynamic, ?delimitor:Dynamic):Dynamic;
	/**
