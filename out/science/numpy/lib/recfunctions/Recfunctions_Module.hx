...
@:pythonImport("numpy.lib.recfunctions") extern class Recfunctions_Module {
	...
	**/
	static public function _get_fieldspec(dtype:Dynamic):Dynamic;
	/**
	...
	**/
	...
	/**
		...
		flatten : {True, False},
		    Whether to
	**/
	static public function _izip_records(seqarrays:Dynamic, ?fill_value:Dynamic, ?flatten:Dynamic):Dynamic;
	...
	**/
	static public function _zip_descr(seqarrays:Dynamic, ?flatten:Dynamic):Dynamic;
	static public function _zip_dtype(seqarrays:Dynamic, ?flatten:Dynamic):Dynamic;
	/**
