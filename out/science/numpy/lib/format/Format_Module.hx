...
@:pythonImport("numpy.lib.format") extern class Format_Module {
	...
	static public var EXPECTED_KEYS : Dynamic;
	...
	**/
	...
	static public function _has_metadata(dt:Dynamic):Dynamic;
	static public var _header_size_info : Dynamic;
	/**
	...
	**/
	static public function _wrap_header(header:Dynamic, version:Dynamic):Dynamic;
	/**
		Like `_wrap_header`, but chooses an appropriate version given the contents
	**/
	static public function _wrap_header_guess_version(header:Dynamic):Dynamic;
	/**
