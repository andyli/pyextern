...
@:pythonImport("numpy.lib.utils", "_Deprecate") extern class _Deprecate {
	/**
		Decorator call.  Refer to ``decorate``.
	**/
	public function __call__(func:Dynamic, ?args:python.VarArgs<Dynamic>, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
