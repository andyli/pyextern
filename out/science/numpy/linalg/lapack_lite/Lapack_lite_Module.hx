...
@:pythonImport("numpy.linalg.lapack_lite") extern class Lapack_lite_Module {
	...
	static public var _ilp64 : Dynamic;
	...
	static public function xerbla(args:haxe.extern.Rest<Dynamic>):Dynamic;
