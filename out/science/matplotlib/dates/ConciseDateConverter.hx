...
@:pythonImport("matplotlib.dates", "ConciseDateConverter") extern class ConciseDateConverter {
	...
	**/
	@:native("__init__")
	public function ___init__(?formats:Dynamic, ?zero_formats:Dynamic, ?offset_formats:Dynamic, ?show_offset:Dynamic, ?interval_multiples:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(?formats:Dynamic, ?zero_formats:Dynamic, ?offset_formats:Dynamic, ?show_offset:Dynamic, ?interval_multiples:Dynamic):Void;
	/**
