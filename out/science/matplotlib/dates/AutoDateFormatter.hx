...
@:pythonImport("matplotlib.dates", "AutoDateFormatter") extern class AutoDateFormatter {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(locator:Dynamic, ?tz:Dynamic, ?defaultfmt:Dynamic, ?usetex:Dynamic):Dynamic;
	/**
		Autoformat the date labels.
		...
		usetex : bool, default: :rc:`text.usetex`
		    ...
		    disable TeX's math mode itself.
	**/
	public function new(locator:Dynamic, ?tz:Dynamic, ?defaultfmt:Dynamic, ?usetex:Dynamic):Void;
	/**
