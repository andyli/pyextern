...
@:pythonImport("matplotlib.dates", "ConciseDateFormatter") extern class ConciseDateFormatter {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(locator:Dynamic, ?tz:Dynamic, ?formats:Dynamic, ?offset_formats:Dynamic, ?zero_formats:Dynamic, ?show_offset:Dynamic, ?usetex:Dynamic):Dynamic;
	/**
		Autoformat the date labels.  The default format is used to form an
		initial string, and then redundant elements are removed.
	**/
	public function new(locator:Dynamic, ?tz:Dynamic, ?formats:Dynamic, ?offset_formats:Dynamic, ?zero_formats:Dynamic, ?show_offset:Dynamic, ?usetex:Dynamic):Void;
	/**
