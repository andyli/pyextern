...
@:pythonImport("matplotlib.widgets", "LassoSelector") extern class LassoSelector {
	...
	**/
	@:native("__init__")
	public function ___init__(ax:Dynamic, ?onselect:Dynamic, ?useblit:Dynamic, ?props:Dynamic, ?button:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(ax:Dynamic, ?onselect:Dynamic, ?useblit:Dynamic, ?props:Dynamic, ?button:Dynamic):Void;
	/**
