...
@:pythonImport("matplotlib.widgets", "SliderBase") extern class SliderBase {
	...
	**/
	@:native("__init__")
	public function ___init__(ax:Dynamic, orientation:Dynamic, closedmin:Dynamic, closedmax:Dynamic, valmin:Dynamic, valmax:Dynamic, valfmt:Dynamic, dragging:Dynamic, valstep:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(ax:Dynamic, orientation:Dynamic, closedmin:Dynamic, closedmax:Dynamic, valmin:Dynamic, valmax:Dynamic, valfmt:Dynamic, dragging:Dynamic, valstep:Dynamic):Void;
	/**
