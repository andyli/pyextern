...
@:pythonImport("matplotlib.widgets", "SpanSelector") extern class SpanSelector {
	...
	**/
	@:native("__init__")
	public function ___init__(ax:Dynamic, onselect:Dynamic, direction:Dynamic, ?minspan:Dynamic, ?useblit:Dynamic, ?props:Dynamic, ?onmove_callback:Dynamic, ?interactive:Dynamic, ?button:Dynamic, ?handle_props:Dynamic, ?grab_range:Dynamic, ?drag_from_anywhere:Dynamic, ?ignore_event_outside:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(ax:Dynamic, onselect:Dynamic, direction:Dynamic, ?minspan:Dynamic, ?useblit:Dynamic, ?props:Dynamic, ?onmove_callback:Dynamic, ?interactive:Dynamic, ?button:Dynamic, ?handle_props:Dynamic, ?grab_range:Dynamic, ?drag_from_anywhere:Dynamic, ?ignore_event_outside:Dynamic):Void;
	/**
	...
	**/
	...
	public function _draw_shape(vmin:Dynamic, vmax:Dynamic):Dynamic;
	/**
	...
	**/
	public function _hover(event:Dynamic):Dynamic;
	/**
	...
	**/
	public function _set_cursor(enabled:Dynamic):Dynamic;
	public function _setup_edge_handles(props:Dynamic):Dynamic;
	/**
	...
	**/
	...
	public var pressv : Dynamic;
	public var prev : Dynamic;
	public var rect : Dynamic;
	public var rectprops : Dynamic;
	/**
