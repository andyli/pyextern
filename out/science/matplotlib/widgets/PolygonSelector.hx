...
@:pythonImport("matplotlib.widgets", "PolygonSelector") extern class PolygonSelector {
	...
	**/
	@:native("__init__")
	public function ___init__(ax:Dynamic, onselect:Dynamic, ?useblit:Dynamic, ?props:Dynamic, ?handle_props:Dynamic, ?grab_range:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(ax:Dynamic, onselect:Dynamic, ?useblit:Dynamic, ?props:Dynamic, ?handle_props:Dynamic, ?grab_range:Dynamic):Void;
	/**
	...
	**/
	public function _remove_vertex(i:Dynamic):Dynamic;
	/**
	...
	**/
	...
	public var vertex_select_radius : Dynamic;
	/**
