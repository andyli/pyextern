	...
	**/
	...
	/**
		...
		**kwargs
		    ...
		    zorder: float
	**/
	public function new(axes:Dynamic, spine_type:Dynamic, path:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Void;
	/**
