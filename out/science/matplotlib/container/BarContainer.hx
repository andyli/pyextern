...
@:pythonImport("matplotlib.container", "BarContainer") extern class BarContainer {
	/**
		Return self+value.
	**/
	...
	**/
	@:native("__init__")
	public function ___init__(patches:Dynamic, ?errorbar:Dynamic, ?datavalues:Dynamic, ?orientation:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(patches:Dynamic, ?errorbar:Dynamic, ?datavalues:Dynamic, ?orientation:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Void;
	/**
