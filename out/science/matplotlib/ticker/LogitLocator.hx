...
@:pythonImport("matplotlib.ticker", "LogitLocator") extern class LogitLocator {
	...
	**/
	@:native("__init__")
	public function ___init__(?minor:Dynamic, ?nbins:Dynamic):Dynamic;
	/**
		Place ticks on the logit locations
		...
		minor : bool, default: False
		    Indicate if this locator is for minor ticks or not.
	**/
	public function new(?minor:Dynamic, ?nbins:Dynamic):Void;
	/**
	...
	**/
	public function set_params(?minor:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
		[*Deprecated*] 
