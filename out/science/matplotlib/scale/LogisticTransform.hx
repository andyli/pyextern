...
@:pythonImport("matplotlib.scale", "LogisticTransform") extern class LogisticTransform {
	...
	**/
	@:native("__init__")
	public function ___init__(?nonpositive:Dynamic):Dynamic;
	/**
		Parameters
		----------
		shorthand_name : str
		    ...
		    ``str(transform)`` when DEBUG=True.
	**/
	public function new(?nonpositive:Dynamic):Void;
	/**
