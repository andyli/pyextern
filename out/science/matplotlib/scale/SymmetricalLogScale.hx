...
@:pythonImport("matplotlib.scale", "SymmetricalLogScale") extern class SymmetricalLogScale {
	...
	**/
	@:native("__init__")
	public function ___init__(axis:Dynamic, ?base:Dynamic, ?linthresh:Dynamic, ?subs:Dynamic, ?linscale:Dynamic):Dynamic;
	/**
		Construct a new scale.
		...
		`~matplotlib.axis.Axis`\es at the same time.
	**/
	public function new(axis:Dynamic, ?base:Dynamic, ?linthresh:Dynamic, ?subs:Dynamic, ?linscale:Dynamic):Void;
	/**
	...
	**/
	...
	public var linscale : Dynamic;
	public var linthresh : Dynamic;
