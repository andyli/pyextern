...
@:pythonImport("matplotlib.scale", "LogTransform") extern class LogTransform {
	...
	**/
	@:native("__init__")
	public function ___init__(base:Dynamic, ?nonpositive:Dynamic):Dynamic;
	/**
		Parameters
		----------
		shorthand_name : str
		    ...
		    ``str(transform)`` when DEBUG=True.
	**/
	public function new(base:Dynamic, ?nonpositive:Dynamic):Void;
	/**
