...
@:pythonImport("matplotlib.animation", "AbstractMovieWriter") extern class AbstractMovieWriter {
	...
	**/
	@:native("__init__")
	public function ___init__(?fps:Dynamic, ?metadata:Dynamic, ?codec:Dynamic, ?bitrate:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(?fps:Dynamic, ?metadata:Dynamic, ?codec:Dynamic, ?bitrate:Dynamic):Void;
	/**
