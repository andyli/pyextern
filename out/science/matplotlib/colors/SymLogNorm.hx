...
@:pythonImport("matplotlib.colors", "SymLogNorm") extern class SymLogNorm {
	...
	**/
	...
	@:native("__init__")
	public function ___init__(linthresh:Dynamic, ?linscale:Dynamic, ?vmin:Dynamic, ?vmax:Dynamic, ?clip:Dynamic, ?base:Dynamic):Dynamic;
	public function new(linthresh:Dynamic, ?linscale:Dynamic, ?vmin:Dynamic, ?vmax:Dynamic, ?clip:Dynamic, ?base:Dynamic):Void;
	/**
