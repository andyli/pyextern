...
@:pythonImport("matplotlib.colors", "FuncNorm") extern class FuncNorm {
	...
	**/
	...
	@:native("__init__")
	public function ___init__(functions:Dynamic, ?vmin:Dynamic, ?vmax:Dynamic, ?clip:Dynamic):Dynamic;
	public function new(functions:Dynamic, ?vmin:Dynamic, ?vmax:Dynamic, ?clip:Dynamic):Void;
	/**
