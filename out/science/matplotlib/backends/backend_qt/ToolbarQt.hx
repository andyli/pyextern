...
@:pythonImport("matplotlib.backends.backend_qt", "ToolbarQt") extern class ToolbarQt {
	...
	**/
	@:native("__init__")
	public function ___init__(toolmanager:Dynamic, parent:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(toolmanager:Dynamic, parent:Dynamic):Void;
	/**
	...
	**/
	...
	public function _add_to_group(group:Dynamic, name:Dynamic, button:Dynamic, position:Dynamic):Dynamic;
	/**
