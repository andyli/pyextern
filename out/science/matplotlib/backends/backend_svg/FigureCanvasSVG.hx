...
@:pythonImport("matplotlib.backends.backend_svg", "FigureCanvasSVG") extern class FigureCanvasSVG {
	...
	/**
		...
		metadata : dict[str, Any], optional
		    ...
		    * *str*, *date*, *datetime*, or *tuple* of same: ``'Date'``. If a
		    ...
		    __ DC_
	**/
	public function print_svg(filename:Dynamic, ?args:python.VarArgs<Dynamic>, ?dpi:Dynamic, ?bbox_inches_restore:Dynamic, ?metadata:Dynamic):Dynamic;
