...
@:pythonImport("matplotlib.backends.backend_svg", "RendererSVG") extern class RendererSVG {
	...
	**/
	@:native("__init__")
	public function ___init__(width:Dynamic, height:Dynamic, svgwriter:Dynamic, ?basename:Dynamic, ?image_dpi:Dynamic, ?metadata:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(width:Dynamic, height:Dynamic, svgwriter:Dynamic, ?basename:Dynamic, ?image_dpi:Dynamic, ?metadata:Dynamic):Void;
	/**
	...
	**/
	public function _draw_text_as_path(gc:Dynamic, x:Dynamic, y:Dynamic, s:Dynamic, prop:Dynamic, angle:Dynamic, ismath:Dynamic, ?mtext:Dynamic):Dynamic;
	public function _draw_text_as_text(gc:Dynamic, x:Dynamic, y:Dynamic, s:Dynamic, prop:Dynamic, angle:Dynamic, ismath:Dynamic, ?mtext:Dynamic):Dynamic;
	public function _get_clip_attrs(gc:Dynamic):Dynamic;
	public function _get_font(prop:Dynamic):Dynamic;
	/**
		Create a new hatch pattern
	**/
	public function _get_hatch(gc:Dynamic, rgbFace:Dynamic):Dynamic;
	public function _get_style(gc:Dynamic, rgbFace:Dynamic):Dynamic;
	/**
		Generate a style string from the GraphicsContext and rgbFace.
	**/
	public function _get_style_dict(gc:Dynamic, rgbFace:Dynamic):Dynamic;
	/**
	...
	**/
	...
	public function _make_flip_transform(transform:Dynamic):Dynamic;
	public function _make_id(type:Dynamic, content:Dynamic):Dynamic;
	/**
		Emit definitions for not-yet-defined glyphs, and record them as having
		been defined.
	**/
	public function _update_glyph_map_defs(glyph_map_new:Dynamic):Dynamic;
	public function _write_clips():Dynamic;
	public function _write_default_style():Dynamic;
	public function _write_hatches():Dynamic;
	public function _write_metadata(metadata:Dynamic):Dynamic;
	/**
