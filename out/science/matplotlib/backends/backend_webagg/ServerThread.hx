...
@:pythonImport("matplotlib.backends.backend_webagg", "ServerThread") extern class ServerThread {
	...
	**/
	public function new(?group:Dynamic, ?target:Dynamic, ?name:Dynamic, ?args:Dynamic, ?kwargs:Dynamic, ?daemon:Dynamic):Void;
	/**
