...
@:pythonImport("matplotlib.backends.backend_pgf", "LatexManager") extern class LatexManager {
	...
	**/
	...
	static public function _build_latex_header():Dynamic;
	...
	**/
	public function _get_box_metrics(tex:Dynamic):Dynamic;
	/**
	...
	**/
	...
	public function _setup_latex_process():Dynamic;
