...
@:pythonImport("matplotlib.backends.backend_pgf", "FigureCanvasPgf") extern class FigureCanvasPgf {
	...
	**/
	...
	public function _print_pgf_to_fh(fh:Dynamic, ?bbox_inches_restore:Dynamic):Dynamic;
	/**
	...
	**/
	...
	public function get_renderer():Dynamic;
	/**
	...
	**/
	public function print_pdf(fname_or_fh:Dynamic, ?metadata:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
		Output pgf macros for drawing the figure so it can be included and
		rendered in latex documents.
	**/
	public function print_pgf(fname_or_fh:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
		Use LaTeX to compile a pgf figure to pdf and convert it to png.
	**/
	public function print_png(fname_or_fh:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
