...
@:pythonImport("matplotlib.backends.backend_webagg_core", "FigureCanvasWebAggCore") extern class FigureCanvasWebAggCore {
	...
	**/
	...
	public function _handle_key(event:Dynamic):Dynamic;
	public function _handle_mouse(event:Dynamic):Dynamic;
	public function _handle_set_device_pixel_ratio(device_pixel_ratio:Dynamic):Dynamic;
	...
	**/
	...
	public function get_diff_image():Dynamic;
	...
	**/
	...
	public function handle_ack(event:Dynamic):Dynamic;
	public function handle_button_press(event:Dynamic):Dynamic;
	public function handle_button_release(event:Dynamic):Dynamic;
	public function handle_dblclick(event:Dynamic):Dynamic;
	public function handle_draw(event:Dynamic):Dynamic;
	public function handle_event(event:Dynamic):Dynamic;
	public function handle_figure_enter(event:Dynamic):Dynamic;
	public function handle_figure_leave(event:Dynamic):Dynamic;
	public function handle_key_press(event:Dynamic):Dynamic;
	public function handle_key_release(event:Dynamic):Dynamic;
	public function handle_motion_notify(event:Dynamic):Dynamic;
	public function handle_refresh(event:Dynamic):Dynamic;
	public function handle_resize(event:Dynamic):Dynamic;
	public function handle_scroll(event:Dynamic):Dynamic;
	public function handle_send_image_mode(event:Dynamic):Dynamic;
	public function handle_set_device_pixel_ratio(event:Dynamic):Dynamic;
	...
	**/
	...
	public function send_event(event_type:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
	...
	**/
	public function set_image_mode(mode:Dynamic):Dynamic;
	/**
