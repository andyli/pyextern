...
@:pythonImport("matplotlib.backends.backend_ps", "FigureCanvasPS") extern class FigureCanvasPS {
	...
	**/
	public function _print_figure(outfile:Dynamic, format:Dynamic, dpi:Dynamic, dsc_comments:Dynamic, orientation:Dynamic, papertype:Dynamic, ?bbox_inches_restore:Dynamic):Dynamic;
	/**
	...
	**/
	public function _print_figure_tex(outfile:Dynamic, format:Dynamic, dpi:Dynamic, dsc_comments:Dynamic, orientation:Dynamic, papertype:Dynamic, ?bbox_inches_restore:Dynamic):Dynamic;
	public function _print_ps(outfile:Dynamic, format:Dynamic, ?dpi:Dynamic, ?metadata:Dynamic, ?papertype:Dynamic, ?orientation:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
	...
	**/
	public function get_default_filetype():Dynamic;
	/**
