...
@:pythonImport("matplotlib.backends.backend_ps", "RendererPS") extern class RendererPS {
	...
	**/
	public function _draw_ps(ps:Dynamic, gc:Dynamic, rgbFace:Dynamic, ?fill:Dynamic, ?stroke:Dynamic):Dynamic;
	/**
	...
	**/
	...
	public function _get_clip_cmd(gc:Dynamic):Dynamic;
	...
	**/
	...
	public function _is_transparent(rgb_or_rgba:Dynamic):Dynamic;
	/**
	...
	**/
	...
	static public function _linecap_cmd(linecap:Dynamic):Dynamic;
	static public function _linejoin_cmd(linejoin:Dynamic):Dynamic;
