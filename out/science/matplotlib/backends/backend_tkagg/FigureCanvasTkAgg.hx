...
@:pythonImport("matplotlib.backends.backend_tkagg", "FigureCanvasTkAgg") extern class FigureCanvasTkAgg {
	...
	**/
	...
	public function _event_mpl_coords(event:Dynamic):Dynamic;
	...
	**/
	...
	public function _update_device_pixel_ratio(?event:Dynamic):Dynamic;
	/**
