	...
	**/
	...
	/**
		...
		Properties:
		    ...
		    zorder: float
	**/
	public function set(?agg_filter:Dynamic, ?alpha:Dynamic, ?animated:Dynamic, ?clip_box:Dynamic, ?clip_on:Dynamic, ?clip_path:Dynamic, ?gid:Dynamic, ?height:Dynamic, ?in_layout:Dynamic, ?label:Dynamic, ?minimumdescent:Dynamic, ?multilinebaseline:Dynamic, ?offset:Dynamic, ?path_effects:Dynamic, ?picker:Dynamic, ?rasterized:Dynamic, ?sketch_params:Dynamic, ?snap:Dynamic, ?text:Dynamic, ?transform:Dynamic, ?url:Dynamic, ?visible:Dynamic, ?width:Dynamic, ?zorder:Dynamic):Dynamic;
	/**
		Set the agg filter.
