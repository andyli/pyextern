...
@:pythonImport("matplotlib.offsetbox", "AnnotationBbox") extern class AnnotationBbox {
	...
	**/
	public function _update_position_xybox(renderer:Dynamic, xy_pixel:Dynamic):Dynamic;
	/**
	...
	**/
	...
	/**
		...
		Properties:
		    ...
		    zorder: float
	**/
	public function set(?agg_filter:Dynamic, ?alpha:Dynamic, ?animated:Dynamic, ?annotation_clip:Dynamic, ?clip_box:Dynamic, ?clip_on:Dynamic, ?clip_path:Dynamic, ?fontsize:Dynamic, ?gid:Dynamic, ?in_layout:Dynamic, ?label:Dynamic, ?path_effects:Dynamic, ?picker:Dynamic, ?rasterized:Dynamic, ?sketch_params:Dynamic, ?snap:Dynamic, ?transform:Dynamic, ?url:Dynamic, ?visible:Dynamic, ?zorder:Dynamic):Dynamic;
	/**
		Set the agg filter.
	...
	**/
	public function set_fontsize(?s:Dynamic):Dynamic;
	/**
