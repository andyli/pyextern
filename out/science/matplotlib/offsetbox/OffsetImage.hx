...
@:pythonImport("matplotlib.offsetbox", "OffsetImage") extern class OffsetImage {
	...
	**/
	@:native("__init__")
	public function ___init__(arr:Dynamic, ?zoom:Dynamic, ?cmap:Dynamic, ?norm:Dynamic, ?interpolation:Dynamic, ?origin:Dynamic, ?filternorm:Dynamic, ?filterrad:Dynamic, ?resample:Dynamic, ?dpi_cor:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(arr:Dynamic, ?zoom:Dynamic, ?cmap:Dynamic, ?norm:Dynamic, ?interpolation:Dynamic, ?origin:Dynamic, ?filternorm:Dynamic, ?filterrad:Dynamic, ?resample:Dynamic, ?dpi_cor:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Void;
	/**
	...
	**/
	...
	public function get_zoom():Dynamic;
	/**
	...
	**/
	...
	/**
		...
		Properties:
		    ...
		    zorder: float
	**/
	public function set(?agg_filter:Dynamic, ?alpha:Dynamic, ?animated:Dynamic, ?clip_box:Dynamic, ?clip_on:Dynamic, ?clip_path:Dynamic, ?data:Dynamic, ?gid:Dynamic, ?height:Dynamic, ?in_layout:Dynamic, ?label:Dynamic, ?offset:Dynamic, ?path_effects:Dynamic, ?picker:Dynamic, ?rasterized:Dynamic, ?sketch_params:Dynamic, ?snap:Dynamic, ?transform:Dynamic, ?url:Dynamic, ?visible:Dynamic, ?width:Dynamic, ?zoom:Dynamic, ?zorder:Dynamic):Dynamic;
	/**
		Set the agg filter.
	...
	**/
	...
	public function set_data(arr:Dynamic):Dynamic;
	/**
	...
	**/
	...
	public function set_zoom(zoom:Dynamic):Dynamic;
	/**
