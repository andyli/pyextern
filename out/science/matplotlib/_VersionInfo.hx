...
package matplotlib;
@:pythonImport("matplotlib", "_VersionInfo") extern class _VersionInfo {
	/**
		Return self+value.
	**/
	...
	**/
	...
	/**
		Create new instance of _VersionInfo(major, minor, micro, releaselevel, serial)
	**/
	static public function __new__(_cls:Dynamic, major:Dynamic, minor:Dynamic, micro:Dynamic, releaselevel:Dynamic, serial:Dynamic):Dynamic;
	/**
		Helper for pickle.
	**/
	...
	**/
	...
	/**
		Make a new _VersionInfo object from a sequence or iterable
	**/
	...
	**/
	public var major : Dynamic;
	/**
		Alias for field number 2
	**/
	public var micro : Dynamic;
	/**
		Alias for field number 1
	**/
	public var minor : Dynamic;
	/**
		Alias for field number 3
	**/
	public var releaselevel : Dynamic;
	/**
		Alias for field number 4
	**/
	public var serial : Dynamic;
}