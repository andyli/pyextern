...
@:pythonImport("matplotlib.cm", "ColormapRegistry") extern class ColormapRegistry {
	...
	**/
	@:native("__init__")
	public function ___init__(cmaps:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(cmaps:Dynamic):Void;
	/**
	...
	**/
	public function register(cmap:Dynamic, ?name:Dynamic, ?force:Dynamic):Dynamic;
	/**
