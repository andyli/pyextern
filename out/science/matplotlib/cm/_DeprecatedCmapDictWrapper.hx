...
@:pythonImport("matplotlib.cm", "_DeprecatedCmapDictWrapper") extern class _DeprecatedCmapDictWrapper {
	...
	**/
	@:native("__init__")
	public function ___init__(cmap_registry:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(cmap_registry:Dynamic):Void;
	/**
	...
	**/
	...
	public function _warn_deprecated():Dynamic;
	/**
