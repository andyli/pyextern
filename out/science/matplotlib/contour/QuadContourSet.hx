...
@:pythonImport("matplotlib.contour", "QuadContourSet") extern class QuadContourSet {
	...
	**/
	@:native("__init__")
	public function ___init__(ax:Dynamic, ?args:python.VarArgs<Dynamic>, ?levels:Dynamic, ?filled:Dynamic, ?linewidths:Dynamic, ?linestyles:Dynamic, ?hatches:Dynamic, ?alpha:Dynamic, ?origin:Dynamic, ?extent:Dynamic, ?cmap:Dynamic, ?colors:Dynamic, ?norm:Dynamic, ?vmin:Dynamic, ?vmax:Dynamic, ?extend:Dynamic, ?antialiased:Dynamic, ?nchunk:Dynamic, ?locator:Dynamic, ?transform:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
		Draw contour lines or filled regions, depending on
		whether keyword arg *filled* is ``False`` (default) or ``True``.
		...
		**kwargs
		    ...
		    `~.Axes.contour`.
	**/
	public function new(ax:Dynamic, ?args:python.VarArgs<Dynamic>, ?levels:Dynamic, ?filled:Dynamic, ?linewidths:Dynamic, ?linestyles:Dynamic, ?hatches:Dynamic, ?alpha:Dynamic, ?origin:Dynamic, ?extent:Dynamic, ?cmap:Dynamic, ?colors:Dynamic, ?norm:Dynamic, ?vmin:Dynamic, ?vmax:Dynamic, ?extend:Dynamic, ?antialiased:Dynamic, ?nchunk:Dynamic, ?locator:Dynamic, ?transform:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Void;
	/**
	...
	**/
	public function _initialize_x_y(z:Dynamic):Dynamic;
	/**
	...
	**/
	public function _process_args(?args:python.VarArgs<Dynamic>, ?corner_mask:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
