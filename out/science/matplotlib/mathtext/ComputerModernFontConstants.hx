...
@:pythonImport("matplotlib.mathtext", "ComputerModernFontConstants") extern class ComputerModernFontConstants {
	...
	**/
	...
	static public var delta_integral : Dynamic;
	static public var delta_slanted : Dynamic;
