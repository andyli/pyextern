...
@:pythonImport("matplotlib.table", "Cell") extern class Cell {
	...
	**/
	@:native("__init__")
	public function ___init__(xy:Dynamic, width:Dynamic, height:Dynamic, ?edgecolor:Dynamic, ?facecolor:Dynamic, ?fill:Dynamic, ?text:Dynamic, ?loc:Dynamic, ?fontproperties:Dynamic, ?visible_edges:Dynamic):Dynamic;
	/**
		Parameters
		----------
		xy : 2-tuple
		...
		visible_edges : str, default: 'closed'
		    ...
		    'vertical' (right and left).
	**/
	public function new(xy:Dynamic, width:Dynamic, height:Dynamic, ?edgecolor:Dynamic, ?facecolor:Dynamic, ?fill:Dynamic, ?text:Dynamic, ?loc:Dynamic, ?fontproperties:Dynamic, ?visible_edges:Dynamic):Void;
	/**
	...
	**/
	public function _convert_units():Dynamic;
	/**
	...
	**/
	...
	static public var _edge_aliases : Dynamic;
	static public var _edge_default : Dynamic;
	static public var _edges : Dynamic;
	/**
	...
	**/
	...
	/**
		...
		Properties:
		    ...
		    zorder: float
	**/
	public function set(?agg_filter:Dynamic, ?alpha:Dynamic, ?angle:Dynamic, ?animated:Dynamic, ?antialiased:Dynamic, ?bounds:Dynamic, ?capstyle:Dynamic, ?clip_box:Dynamic, ?clip_on:Dynamic, ?clip_path:Dynamic, ?color:Dynamic, ?edgecolor:Dynamic, ?facecolor:Dynamic, ?fill:Dynamic, ?fontsize:Dynamic, ?gid:Dynamic, ?hatch:Dynamic, ?height:Dynamic, ?in_layout:Dynamic, ?joinstyle:Dynamic, ?label:Dynamic, ?linestyle:Dynamic, ?linewidth:Dynamic, ?path_effects:Dynamic, ?picker:Dynamic, ?rasterized:Dynamic, ?sketch_params:Dynamic, ?snap:Dynamic, ?text_props:Dynamic, ?transform:Dynamic, ?url:Dynamic, ?visible:Dynamic, ?width:Dynamic, ?x:Dynamic, ?xy:Dynamic, ?y:Dynamic, ?zorder:Dynamic):Dynamic;
	/**
	...
	**/
	public var visible_edges : Dynamic;
	/**
		Return the left and bottom coords of the rectangle as a tuple.
	**/
