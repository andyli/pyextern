...
@:pythonImport("matplotlib.image", "NonUniformImage") extern class NonUniformImage {
	...
	**/
	@:native("__init__")
	public function ___init__(ax:Dynamic, ?interpolation:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
		Parameters
		----------
		interpolation : {'nearest', 'bilinear'}, default: 'nearest'
		...
		**kwargs
		    All other keyword arguments are identical to those of `.AxesImage`.
	**/
	public function new(ax:Dynamic, ?interpolation:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Void;
	/**
	...
	**/
	...
	static public var mouseover : Dynamic;
	...
	**/
	...
	/**
		...
		filternorm : bool
	**/
	public function set_filternorm(s:Dynamic):Dynamic;
	/**
	...
	**/
	public function set_filterrad(s:Dynamic):Dynamic;
	/**
