...
@:pythonImport("matplotlib.image", "AxesImage") extern class AxesImage {
	...
	**/
	@:native("__init__")
	public function ___init__(ax:Dynamic, ?cmap:Dynamic, ?norm:Dynamic, ?interpolation:Dynamic, ?origin:Dynamic, ?extent:Dynamic, ?filternorm:Dynamic, ?filterrad:Dynamic, ?resample:Dynamic, ?interpolation_stage:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
		Parameters
		----------
		norm : `matplotlib.colors.Normalize` (or subclass thereof)
		...
		cmap : str or `~matplotlib.colors.Colormap`
		    The colormap used to map normalized data values to RGBA colors.
	**/
	public function new(ax:Dynamic, ?cmap:Dynamic, ?norm:Dynamic, ?interpolation:Dynamic, ?origin:Dynamic, ?extent:Dynamic, ?filternorm:Dynamic, ?filterrad:Dynamic, ?resample:Dynamic, ?interpolation_stage:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Void;
	/**
