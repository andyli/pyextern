...
@:pythonImport("matplotlib.image", "BboxImage") extern class BboxImage {
	...
	**/
	@:native("__init__")
	public function ___init__(bbox:Dynamic, ?cmap:Dynamic, ?norm:Dynamic, ?interpolation:Dynamic, ?origin:Dynamic, ?filternorm:Dynamic, ?filterrad:Dynamic, ?resample:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
		cmap is a colors.Colormap instance
		norm is a colors.Normalize instance to map luminance to 0-1
		...
		kwargs are an optional list of Artist keyword args
	**/
	public function new(bbox:Dynamic, ?cmap:Dynamic, ?norm:Dynamic, ?interpolation:Dynamic, ?origin:Dynamic, ?filternorm:Dynamic, ?filterrad:Dynamic, ?resample:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Void;
	/**
