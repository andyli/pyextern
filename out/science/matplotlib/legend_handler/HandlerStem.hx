...
@:pythonImport("matplotlib.legend_handler", "HandlerStem") extern class HandlerStem {
	...
	**/
	@:native("__init__")
	public function ___init__(?marker_pad:Dynamic, ?numpoints:Dynamic, ?bottom:Dynamic, ?yoffsets:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
		Parameters
		----------
		marker_pad : float, default: 0.3
		...
		**kwargs
		    Keyword arguments forwarded to `.HandlerNpointsYoffsets`.
	**/
	public function new(?marker_pad:Dynamic, ?numpoints:Dynamic, ?bottom:Dynamic, ?yoffsets:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Void;
	/**
