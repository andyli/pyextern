...
@:pythonImport("matplotlib.legend_handler", "HandlerLine2DCompound") extern class HandlerLine2DCompound {
	...
	**/
	@:native("__init__")
	public function ___init__(?marker_pad:Dynamic, ?numpoints:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
		Parameters
		----------
		marker_pad : float
		...
		**kwargs
		    Keyword arguments forwarded to `.HandlerNpoints`.
	**/
	public function new(?marker_pad:Dynamic, ?numpoints:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Void;
	/**
