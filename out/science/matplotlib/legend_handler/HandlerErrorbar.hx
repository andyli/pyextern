...
@:pythonImport("matplotlib.legend_handler", "HandlerErrorbar") extern class HandlerErrorbar {
	...
	**/
	@:native("__init__")
	public function ___init__(?xerr_size:Dynamic, ?yerr_size:Dynamic, ?marker_pad:Dynamic, ?numpoints:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
		Parameters
		----------
		marker_pad : float
		...
		**kwargs
		    Keyword arguments forwarded to `.HandlerNpoints`.
	**/
	public function new(?xerr_size:Dynamic, ?yerr_size:Dynamic, ?marker_pad:Dynamic, ?numpoints:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Void;
	/**
	...
	**/
	...
	public function get_err_size(legend:Dynamic, xdescent:Dynamic, ydescent:Dynamic, width:Dynamic, height:Dynamic, fontsize:Dynamic):Dynamic;
