...
@:pythonImport("matplotlib.legend_handler", "_Line2DHandleList") extern class _Line2DHandleList {
	...
	**/
	@:native("__init__")
	public function ___init__(legline:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(legline:Dynamic):Void;
	/**
