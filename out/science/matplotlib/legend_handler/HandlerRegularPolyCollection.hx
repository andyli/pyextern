...
@:pythonImport("matplotlib.legend_handler", "HandlerRegularPolyCollection") extern class HandlerRegularPolyCollection {
	...
	**/
	@:native("__init__")
	public function ___init__(?yoffsets:Dynamic, ?sizes:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
		Parameters
		----------
		numpoints : int
		...
		**kwargs
		    Keyword arguments forwarded to `.HandlerNpoints`.
	**/
	public function new(?yoffsets:Dynamic, ?sizes:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Void;
	/**
