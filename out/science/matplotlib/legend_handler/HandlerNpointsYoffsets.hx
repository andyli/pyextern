...
@:pythonImport("matplotlib.legend_handler", "HandlerNpointsYoffsets") extern class HandlerNpointsYoffsets {
	...
	**/
	@:native("__init__")
	public function ___init__(?numpoints:Dynamic, ?yoffsets:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
		Parameters
		----------
		numpoints : int
		...
		**kwargs
		    Keyword arguments forwarded to `.HandlerNpoints`.
	**/
	public function new(?numpoints:Dynamic, ?yoffsets:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Void;
	/**
