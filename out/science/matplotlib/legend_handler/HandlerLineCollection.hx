...
@:pythonImport("matplotlib.legend_handler", "HandlerLineCollection") extern class HandlerLineCollection {
	...
	**/
	...
	/**
		...
		**kwargs
		    Keyword arguments forwarded to `.HandlerNpoints`.
	**/
	public function new(?marker_pad:Dynamic, ?numpoints:Dynamic, ?kw:python.KwArgs<Dynamic>):Void;
	/**
