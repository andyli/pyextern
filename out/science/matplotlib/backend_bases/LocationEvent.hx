...
@:pythonImport("matplotlib.backend_bases", "LocationEvent") extern class LocationEvent {
	...
	**/
	@:native("__init__")
	public function ___init__(name:Dynamic, canvas:Dynamic, x:Dynamic, y:Dynamic, ?guiEvent:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(name:Dynamic, canvas:Dynamic, x:Dynamic, y:Dynamic, ?guiEvent:Dynamic):Void;
	/**
