...
@:pythonImport("matplotlib.patches", "FancyArrowPatch") extern class FancyArrowPatch {
	...
	**/
	@:native("__init__")
	public function ___init__(?posA:Dynamic, ?posB:Dynamic, ?path:Dynamic, ?arrowstyle:Dynamic, ?connectionstyle:Dynamic, ?patchA:Dynamic, ?patchB:Dynamic, ?shrinkA:Dynamic, ?shrinkB:Dynamic, ?mutation_scale:Dynamic, ?mutation_aspect:Dynamic, ?dpi_cor:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
		There are two ways for defining an arrow:
		...
		**kwargs : `.Patch` properties, optional
		...
		Properties:
		    ...
		    ``joinstyle`` for `FancyArrowPatch` are set to ``"round"``.
	**/
	public function new(?posA:Dynamic, ?posB:Dynamic, ?path:Dynamic, ?arrowstyle:Dynamic, ?connectionstyle:Dynamic, ?patchA:Dynamic, ?patchB:Dynamic, ?shrinkA:Dynamic, ?shrinkB:Dynamic, ?mutation_scale:Dynamic, ?mutation_aspect:Dynamic, ?dpi_cor:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Void;
	/**
