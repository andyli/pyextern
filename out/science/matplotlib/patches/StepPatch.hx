...
@:pythonImport("matplotlib.patches", "StepPatch") extern class StepPatch {
	...
	**/
	@:native("__init__")
	public function ___init__(values:Dynamic, edges:Dynamic, ?orientation:Dynamic, ?baseline:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
		Parameters
		----------
		values : array-like
		...
		Properties:
		    ...
		    zorder: float
	**/
	public function new(values:Dynamic, edges:Dynamic, ?orientation:Dynamic, ?baseline:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Void;
	/**
	...
	**/
	...
	public function _update_path():Dynamic;
	/**
	...
	**/
	...
	/**
		...
		Properties:
		    ...
		    zorder: float
	**/
	public function set(?agg_filter:Dynamic, ?alpha:Dynamic, ?animated:Dynamic, ?antialiased:Dynamic, ?capstyle:Dynamic, ?clip_box:Dynamic, ?clip_on:Dynamic, ?clip_path:Dynamic, ?color:Dynamic, ?data:Dynamic, ?edgecolor:Dynamic, ?facecolor:Dynamic, ?fill:Dynamic, ?gid:Dynamic, ?hatch:Dynamic, ?in_layout:Dynamic, ?joinstyle:Dynamic, ?label:Dynamic, ?linestyle:Dynamic, ?linewidth:Dynamic, ?path:Dynamic, ?path_effects:Dynamic, ?picker:Dynamic, ?rasterized:Dynamic, ?sketch_params:Dynamic, ?snap:Dynamic, ?transform:Dynamic, ?url:Dynamic, ?visible:Dynamic, ?zorder:Dynamic):Dynamic;
	/**
	...
	**/
	public function set_data(?values:Dynamic, ?edges:Dynamic, ?baseline:Dynamic):Dynamic;
	/**
	...
	**/
	...
	public function set_path(path:Dynamic):Dynamic;
	/**
