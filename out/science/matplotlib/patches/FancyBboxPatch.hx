...
@:pythonImport("matplotlib.patches", "FancyBboxPatch") extern class FancyBboxPatch {
	...
	**/
	public function get_boxstyle():Dynamic;
	/**
		Return the capstyle.
	**/
	...
	**/
	...
	/**
		...
		Properties:
		    ...
		    zorder: float
	**/
	public function set(?agg_filter:Dynamic, ?alpha:Dynamic, ?animated:Dynamic, ?antialiased:Dynamic, ?bounds:Dynamic, ?boxstyle:Dynamic, ?capstyle:Dynamic, ?clip_box:Dynamic, ?clip_on:Dynamic, ?clip_path:Dynamic, ?color:Dynamic, ?edgecolor:Dynamic, ?facecolor:Dynamic, ?fill:Dynamic, ?gid:Dynamic, ?hatch:Dynamic, ?height:Dynamic, ?in_layout:Dynamic, ?joinstyle:Dynamic, ?label:Dynamic, ?linestyle:Dynamic, ?linewidth:Dynamic, ?mutation_aspect:Dynamic, ?mutation_scale:Dynamic, ?path_effects:Dynamic, ?picker:Dynamic, ?rasterized:Dynamic, ?sketch_params:Dynamic, ?snap:Dynamic, ?transform:Dynamic, ?url:Dynamic, ?visible:Dynamic, ?width:Dynamic, ?x:Dynamic, ?y:Dynamic, ?zorder:Dynamic):Dynamic;
	/**
	...
	**/
	...
	/**
		...
		boxstyle : str or `matplotlib.patches.BoxStyle`
		    ...
		    .. ACCEPTS: [ 'square' | 'circle' | 'larrow' | 'rarrow' | 'darrow' | 'round' | 'round4' | 'sawtooth' | 'roundtooth' ]
		...
		**kwargs
		...
		::
		    ...
		    set_boxstyle("round", pad=0.2)
	**/
	public function set_boxstyle(?boxstyle:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
		Set the `.CapStyle`.
