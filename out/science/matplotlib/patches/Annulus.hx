...
@:pythonImport("matplotlib.patches", "Annulus") extern class Annulus {
	...
	**/
	@:native("__init__")
	public function ___init__(xy:Dynamic, r:Dynamic, width:Dynamic, ?angle:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
		Parameters
		----------
		xy : (float, float)
		...
		**kwargs
		    ...
		    zorder: float
	**/
	public function new(xy:Dynamic, r:Dynamic, width:Dynamic, ?angle:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Void;
	/**
	...
	**/
	...
	public function _recompute_path():Dynamic;
	/**
	...
	**/
	...
	public function _transform_verts(verts:Dynamic, a:Dynamic, b:Dynamic):Dynamic;
	/**
	...
	**/
	...
	/**
		Return the center of the annulus.
	**/
	public function get_center():Dynamic;
	/**
	...
	**/
	public function get_radii():Dynamic;
	/**
	...
	**/
	...
	/**
		...
		Properties:
		    ...
		    zorder: float
	**/
	public function set(?agg_filter:Dynamic, ?alpha:Dynamic, ?angle:Dynamic, ?animated:Dynamic, ?antialiased:Dynamic, ?capstyle:Dynamic, ?center:Dynamic, ?clip_box:Dynamic, ?clip_on:Dynamic, ?clip_path:Dynamic, ?color:Dynamic, ?edgecolor:Dynamic, ?facecolor:Dynamic, ?fill:Dynamic, ?gid:Dynamic, ?hatch:Dynamic, ?in_layout:Dynamic, ?joinstyle:Dynamic, ?label:Dynamic, ?linestyle:Dynamic, ?linewidth:Dynamic, ?path_effects:Dynamic, ?picker:Dynamic, ?radii:Dynamic, ?rasterized:Dynamic, ?semimajor:Dynamic, ?semiminor:Dynamic, ?sketch_params:Dynamic, ?snap:Dynamic, ?transform:Dynamic, ?url:Dynamic, ?visible:Dynamic, ?width:Dynamic, ?zorder:Dynamic):Dynamic;
	/**
	...
	**/
	...
	/**
		...
		angle : float
	**/
	public function set_angle(angle:Dynamic):Dynamic;
	/**
	...
	**/
	...
	/**
		...
		xy : (float, float)
	**/
	public function set_center(xy:Dynamic):Dynamic;
	/**
	...
	**/
	...
	/**
		...
		r : float or (float, float)
		    ...
		    - If two floats: semi-major and -minor axes of outer ellipse.
	**/
	public function set_radii(r:Dynamic):Dynamic;
	/**
	...
	**/
	...
	/**
		...
		a : float
	**/
	public function set_semimajor(a:Dynamic):Dynamic;
	/**
		...
		b : float
	**/
	public function set_semiminor(b:Dynamic):Dynamic;
	/**
