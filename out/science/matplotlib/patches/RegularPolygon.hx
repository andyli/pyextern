...
@:pythonImport("matplotlib.patches", "RegularPolygon") extern class RegularPolygon {
	...
	**/
	@:native("__init__")
	public function ___init__(xy:Dynamic, numVertices:Dynamic, ?radius:Dynamic, ?orientation:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
		Parameters
		----------
		xy : (float, float)
		...
		**kwargs
		    ...
		    zorder: float
	**/
	public function new(xy:Dynamic, numVertices:Dynamic, ?radius:Dynamic, ?orientation:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Void;
	/**
	...
	**/
	...
	/**
		...
		Properties:
		    ...
		    zorder: float
	**/
	public function set(?agg_filter:Dynamic, ?alpha:Dynamic, ?animated:Dynamic, ?antialiased:Dynamic, ?capstyle:Dynamic, ?clip_box:Dynamic, ?clip_on:Dynamic, ?clip_path:Dynamic, ?color:Dynamic, ?edgecolor:Dynamic, ?facecolor:Dynamic, ?fill:Dynamic, ?gid:Dynamic, ?hatch:Dynamic, ?in_layout:Dynamic, ?joinstyle:Dynamic, ?label:Dynamic, ?linestyle:Dynamic, ?linewidth:Dynamic, ?path_effects:Dynamic, ?picker:Dynamic, ?rasterized:Dynamic, ?sketch_params:Dynamic, ?snap:Dynamic, ?transform:Dynamic, ?url:Dynamic, ?visible:Dynamic, ?zorder:Dynamic):Dynamic;
	/**
