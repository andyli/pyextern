...
@:pythonImport("matplotlib.patches", "Arc") extern class Arc {
	...
	**/
	@:native("__init__")
	public function ___init__(xy:Dynamic, width:Dynamic, height:Dynamic, ?angle:Dynamic, ?theta1:Dynamic, ?theta2:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
		Parameters
		----------
		xy : (float, float)
		...
		**kwargs : `.Patch` properties
		...
		Properties:
		    ...
		    zorder: float
	**/
	public function new(xy:Dynamic, width:Dynamic, height:Dynamic, ?angle:Dynamic, ?theta1:Dynamic, ?theta2:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Void;
	/**
	...
	**/
	...
	/**
		...
		Properties:
		    ...
		    zorder: float
	**/
	public function set(?agg_filter:Dynamic, ?alpha:Dynamic, ?angle:Dynamic, ?animated:Dynamic, ?antialiased:Dynamic, ?capstyle:Dynamic, ?center:Dynamic, ?clip_box:Dynamic, ?clip_on:Dynamic, ?clip_path:Dynamic, ?color:Dynamic, ?edgecolor:Dynamic, ?facecolor:Dynamic, ?fill:Dynamic, ?gid:Dynamic, ?hatch:Dynamic, ?height:Dynamic, ?in_layout:Dynamic, ?joinstyle:Dynamic, ?label:Dynamic, ?linestyle:Dynamic, ?linewidth:Dynamic, ?path_effects:Dynamic, ?picker:Dynamic, ?rasterized:Dynamic, ?sketch_params:Dynamic, ?snap:Dynamic, ?transform:Dynamic, ?url:Dynamic, ?visible:Dynamic, ?width:Dynamic, ?zorder:Dynamic):Dynamic;
	/**
