...
@:pythonImport("matplotlib.patches", "FancyArrow") extern class FancyArrow {
	...
	**/
	...
	public function _make_verts():Dynamic;
	...
	**/
	...
	/**
		...
		Properties:
		    ...
		    zorder: float
	**/
	public function set(?agg_filter:Dynamic, ?alpha:Dynamic, ?animated:Dynamic, ?antialiased:Dynamic, ?capstyle:Dynamic, ?clip_box:Dynamic, ?clip_on:Dynamic, ?clip_path:Dynamic, ?closed:Dynamic, ?color:Dynamic, ?data:Dynamic, ?edgecolor:Dynamic, ?facecolor:Dynamic, ?fill:Dynamic, ?gid:Dynamic, ?hatch:Dynamic, ?in_layout:Dynamic, ?joinstyle:Dynamic, ?label:Dynamic, ?linestyle:Dynamic, ?linewidth:Dynamic, ?path_effects:Dynamic, ?picker:Dynamic, ?rasterized:Dynamic, ?sketch_params:Dynamic, ?snap:Dynamic, ?transform:Dynamic, ?url:Dynamic, ?visible:Dynamic, ?xy:Dynamic, ?zorder:Dynamic):Dynamic;
	/**
	...
	**/
	...
	/**
		...
		head_length: float or None, default: None
		    Length of arrow head.
	**/
	public function set_data(?x:Dynamic, ?y:Dynamic, ?dx:Dynamic, ?dy:Dynamic, ?width:Dynamic, ?head_width:Dynamic, ?head_length:Dynamic):Dynamic;
	/**
