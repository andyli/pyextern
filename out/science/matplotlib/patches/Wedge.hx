...
@:pythonImport("matplotlib.patches", "Wedge") extern class Wedge {
	...
	**/
	@:native("__init__")
	public function ___init__(center:Dynamic, r:Dynamic, theta1:Dynamic, theta2:Dynamic, ?width:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
		A wedge centered at *x*, *y* center with radius *r* that
		sweeps *theta1* to *theta2* (in degrees).  If *width* is given,
		then a partial wedge is drawn from inner radius *r* - *width*
		...
		Properties:
		    ...
		    zorder: float
	**/
	public function new(center:Dynamic, r:Dynamic, theta1:Dynamic, theta2:Dynamic, ?width:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Void;
	/**
	...
	**/
	...
	/**
		...
		Properties:
		    ...
		    zorder: float
	**/
	public function set(?agg_filter:Dynamic, ?alpha:Dynamic, ?animated:Dynamic, ?antialiased:Dynamic, ?capstyle:Dynamic, ?center:Dynamic, ?clip_box:Dynamic, ?clip_on:Dynamic, ?clip_path:Dynamic, ?color:Dynamic, ?edgecolor:Dynamic, ?facecolor:Dynamic, ?fill:Dynamic, ?gid:Dynamic, ?hatch:Dynamic, ?in_layout:Dynamic, ?joinstyle:Dynamic, ?label:Dynamic, ?linestyle:Dynamic, ?linewidth:Dynamic, ?path_effects:Dynamic, ?picker:Dynamic, ?radius:Dynamic, ?rasterized:Dynamic, ?sketch_params:Dynamic, ?snap:Dynamic, ?theta1:Dynamic, ?theta2:Dynamic, ?transform:Dynamic, ?url:Dynamic, ?visible:Dynamic, ?width:Dynamic, ?zorder:Dynamic):Dynamic;
	/**
	...
	**/
	...
	public function set_center(center:Dynamic):Dynamic;
	/**
	...
	**/
	...
	public function set_radius(radius:Dynamic):Dynamic;
	/**
	...
	**/
	...
	public function set_theta1(theta1:Dynamic):Dynamic;
	public function set_theta2(theta2:Dynamic):Dynamic;
	/**
