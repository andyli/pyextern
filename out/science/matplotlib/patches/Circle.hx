...
@:pythonImport("matplotlib.patches", "Circle") extern class Circle {
	...
	**/
	@:native("__init__")
	public function ___init__(xy:Dynamic, ?radius:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
		Create a true circle at center *xy* = (*x*, *y*) with given *radius*.
		...
		Properties:
		    ...
		    zorder: float
	**/
	public function new(xy:Dynamic, ?radius:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Void;
	/**
	...
	**/
	public function get_radius():Dynamic;
	/**
