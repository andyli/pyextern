...
@:pythonImport("matplotlib.patches", "Shadow") extern class Shadow {
	...
	**/
	@:native("__init__")
	public function ___init__(patch:Dynamic, ox:Dynamic, oy:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
		Create a shadow of the given *patch*.
		...
		**kwargs
		    ...
		    zorder: float
	**/
	public function new(patch:Dynamic, ox:Dynamic, oy:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Void;
	/**
	...
	**/
	...
	public function _update_transform(renderer:Dynamic):Dynamic;
	/**
