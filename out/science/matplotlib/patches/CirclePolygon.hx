...
@:pythonImport("matplotlib.patches", "CirclePolygon") extern class CirclePolygon {
	...
	**/
	@:native("__init__")
	public function ___init__(xy:Dynamic, ?radius:Dynamic, ?resolution:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
		Create a circle at *xy* = (*x*, *y*) with given *radius*.
		...
		Properties:
		    ...
		    zorder: float
	**/
	public function new(xy:Dynamic, ?radius:Dynamic, ?resolution:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Void;
	/**
