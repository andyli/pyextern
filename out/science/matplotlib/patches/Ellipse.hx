...
@:pythonImport("matplotlib.patches", "Ellipse") extern class Ellipse {
	...
	**/
	...
	/**
		...
		Properties:
		    ...
		    zorder: float
	**/
	public function new(xy:Dynamic, width:Dynamic, height:Dynamic, ?angle:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Void;
	/**
