...
@:pythonImport("matplotlib.projections.geo", "_GeoTransform") extern class _GeoTransform {
	...
	**/
	@:native("__init__")
	public function ___init__(resolution:Dynamic):Dynamic;
	/**
		Create a new geographical transform.
		...
		line segment to approximate its path in curved space.
	**/
	public function new(resolution:Dynamic):Void;
	/**
