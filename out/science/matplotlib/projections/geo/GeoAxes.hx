...
@:pythonImport("matplotlib.projections.geo", "GeoAxes") extern class GeoAxes {
	...
	**/
	@:native("__init__")
	public function ___init__(fig:Dynamic, rect:Dynamic, ?facecolor:Dynamic, ?frameon:Dynamic, ?sharex:Dynamic, ?sharey:Dynamic, ?label:Dynamic, ?xscale:Dynamic, ?yscale:Dynamic, ?box_aspect:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
		Build an Axes in a figure.
		...
		**kwargs
		...
		`~.axes.Axes`
		    The new `~.axes.Axes` object.
	**/
	public function new(fig:Dynamic, rect:Dynamic, ?facecolor:Dynamic, ?frameon:Dynamic, ?sharex:Dynamic, ?sharey:Dynamic, ?label:Dynamic, ?xscale:Dynamic, ?yscale:Dynamic, ?box_aspect:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Void;
	/**
