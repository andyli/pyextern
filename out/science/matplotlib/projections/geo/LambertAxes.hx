...
@:pythonImport("matplotlib.projections.geo", "LambertAxes") extern class LambertAxes {
	...
	**/
	@:native("__init__")
	public function ___init__(?args:python.VarArgs<Dynamic>, ?center_longitude:Dynamic, ?center_latitude:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
		Build an Axes in a figure.
		...
		**kwargs
		...
		`~.axes.Axes`
		    The new `~.axes.Axes` object.
	**/
	public function new(?args:python.VarArgs<Dynamic>, ?center_longitude:Dynamic, ?center_latitude:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Void;
	/**
	...
	**/
	...
	/**
		...
		Properties:
		    ...
		    zorder: float
	**/
	public function set(?adjustable:Dynamic, ?agg_filter:Dynamic, ?alpha:Dynamic, ?anchor:Dynamic, ?animated:Dynamic, ?aspect:Dynamic, ?autoscale_on:Dynamic, ?autoscalex_on:Dynamic, ?autoscaley_on:Dynamic, ?axes_locator:Dynamic, ?axisbelow:Dynamic, ?box_aspect:Dynamic, ?clip_box:Dynamic, ?clip_on:Dynamic, ?clip_path:Dynamic, ?facecolor:Dynamic, ?frame_on:Dynamic, ?gid:Dynamic, ?in_layout:Dynamic, ?label:Dynamic, ?latitude_grid:Dynamic, ?longitude_grid:Dynamic, ?longitude_grid_ends:Dynamic, ?navigate:Dynamic, ?path_effects:Dynamic, ?picker:Dynamic, ?position:Dynamic, ?prop_cycle:Dynamic, ?rasterization_zorder:Dynamic, ?rasterized:Dynamic, ?sketch_params:Dynamic, ?snap:Dynamic, ?title:Dynamic, ?transform:Dynamic, ?url:Dynamic, ?visible:Dynamic, ?xbound:Dynamic, ?xlabel:Dynamic, ?xlim:Dynamic, ?xmargin:Dynamic, ?xscale:Dynamic, ?xticklabels:Dynamic, ?xticks:Dynamic, ?ybound:Dynamic, ?ylabel:Dynamic, ?ylim:Dynamic, ?ymargin:Dynamic, ?yscale:Dynamic, ?yticklabels:Dynamic, ?yticks:Dynamic, ?zorder:Dynamic):Dynamic;
	/**
		Set how the Axes adjusts to achieve the required aspect ratio.
	...
	**/
	public function set_xlim(?args:python.VarArgs<Dynamic>, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
	...
	**/
	...
	/**
		...
		**kwargs
		...
		be used here.
	**/
	public function set_xscale(?args:python.VarArgs<Dynamic>, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
	...
	**/
	...
	/**
		Not supported. Please consider using Cartopy.
	**/
	public function set_ylim(?args:python.VarArgs<Dynamic>, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
