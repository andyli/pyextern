...
@:pythonImport("matplotlib.projections.polar", "InvertedPolarTransform") extern class InvertedPolarTransform {
	...
	**/
	@:native("__init__")
	public function ___init__(?axis:Dynamic, ?use_rmin:Dynamic, ?_apply_theta_transforms:Dynamic):Dynamic;
	/**
		Parameters
		----------
		shorthand_name : str
		    ...
		    ``str(transform)`` when DEBUG=True.
	**/
	public function new(?axis:Dynamic, ?use_rmin:Dynamic, ?_apply_theta_transforms:Dynamic):Void;
	/**
	...
	**/
	...
	/**
		...
		array
		    ...
		    shape (N x :attr:`output_dims`), depending on the input.
	**/
	public function transform_non_affine(xy:Dynamic):Dynamic;
	/**
