...
@:pythonImport("matplotlib.transforms", "AffineDeltaTransform") extern class AffineDeltaTransform {
	...
	**/
	@:native("__init__")
	public function ___init__(transform:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
		Parameters
		----------
		shorthand_name : str
		    ...
		    ``str(transform)`` when DEBUG=True.
	**/
	public function new(transform:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Void;
	/**
