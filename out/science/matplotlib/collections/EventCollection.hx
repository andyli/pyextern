...
@:pythonImport("matplotlib.collections", "EventCollection") extern class EventCollection {
	...
	**/
	public function add_positions(position:Dynamic):Dynamic;
	/**
		Add one or more events at the specified positions.
	**/
	public function append_positions(position:Dynamic):Dynamic;
	/**
	...
	**/
	...
	/**
		Add one or more events at the specified positions.
	**/
	public function extend_positions(position:Dynamic):Dynamic;
	/**
		Find artist objects.
	...
	**/
	...
	public function get_colors():Dynamic;
	/**
	...
	**/
	public function get_linelength():Dynamic;
	/**
	...
	**/
	public function get_orientation():Dynamic;
	...
	**/
	public function is_horizontal():Dynamic;
	/**
	...
	**/
	...
	/**
		...
		Properties:
		    ...
		    zorder: float
	**/
	public function set(?agg_filter:Dynamic, ?alpha:Dynamic, ?animated:Dynamic, ?antialiased:Dynamic, ?array:Dynamic, ?capstyle:Dynamic, ?clim:Dynamic, ?clip_box:Dynamic, ?clip_on:Dynamic, ?clip_path:Dynamic, ?cmap:Dynamic, ?color:Dynamic, ?colors:Dynamic, ?edgecolor:Dynamic, ?facecolor:Dynamic, ?gid:Dynamic, ?hatch:Dynamic, ?in_layout:Dynamic, ?joinstyle:Dynamic, ?label:Dynamic, ?linelength:Dynamic, ?lineoffset:Dynamic, ?linestyle:Dynamic, ?linewidth:Dynamic, ?norm:Dynamic, ?offset_transform:Dynamic, ?offsets:Dynamic, ?orientation:Dynamic, ?path_effects:Dynamic, ?paths:Dynamic, ?picker:Dynamic, ?pickradius:Dynamic, ?positions:Dynamic, ?rasterized:Dynamic, ?segments:Dynamic, ?sketch_params:Dynamic, ?snap:Dynamic, ?transform:Dynamic, ?url:Dynamic, ?urls:Dynamic, ?verts:Dynamic, ?visible:Dynamic, ?zorder:Dynamic):Dynamic;
	/**
	...
	**/
	...
	/**
		...
		c : color or list of colors
		    ...
		    cycle through the sequence.
	**/
	public function set_colors(c:Dynamic):Dynamic;
	/**
	...
	**/
	public function set_linelength(linelength:Dynamic):Dynamic;
	/**
		Set the offset of the lines used to mark each event.
	**/
	public function set_lineoffset(lineoffset:Dynamic):Dynamic;
	/**
	...
	**/
	public function set_positions(positions:Dynamic):Dynamic;
	/**
	...
	**/
	public function switch_orientation():Dynamic;
	/**
