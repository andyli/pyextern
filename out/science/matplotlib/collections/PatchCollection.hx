...
@:pythonImport("matplotlib.collections", "PatchCollection") extern class PatchCollection {
	...
	**/
	@:native("__init__")
	public function ___init__(patches:Dynamic, ?match_original:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
		*patches*
		    a sequence of Patch objects.  This list may include
		    a heterogeneous assortment of different patch types.
		...
		*match_original*
		...
		mappable will be made to set the face colors.
	**/
	public function new(patches:Dynamic, ?match_original:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Void;
	/**
	...
	**/
	...
	/**
		...
		Properties:
		    ...
		    zorder: float
	**/
	public function set(?agg_filter:Dynamic, ?alpha:Dynamic, ?animated:Dynamic, ?antialiased:Dynamic, ?array:Dynamic, ?capstyle:Dynamic, ?clim:Dynamic, ?clip_box:Dynamic, ?clip_on:Dynamic, ?clip_path:Dynamic, ?cmap:Dynamic, ?color:Dynamic, ?edgecolor:Dynamic, ?facecolor:Dynamic, ?gid:Dynamic, ?hatch:Dynamic, ?in_layout:Dynamic, ?joinstyle:Dynamic, ?label:Dynamic, ?linestyle:Dynamic, ?linewidth:Dynamic, ?norm:Dynamic, ?offset_transform:Dynamic, ?offsets:Dynamic, ?path_effects:Dynamic, ?paths:Dynamic, ?picker:Dynamic, ?pickradius:Dynamic, ?rasterized:Dynamic, ?sketch_params:Dynamic, ?snap:Dynamic, ?transform:Dynamic, ?url:Dynamic, ?urls:Dynamic, ?visible:Dynamic, ?zorder:Dynamic):Dynamic;
	/**
	...
	**/
	...
	public function set_paths(patches:Dynamic):Dynamic;
	/**
