...
@:pythonImport("matplotlib.collections", "CircleCollection") extern class CircleCollection {
	...
	**/
	@:native("__init__")
	public function ___init__(sizes:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
		Parameters
		----------
		sizes : float or array-like
		...
		**kwargs
		    Forwarded to `.Collection`.
	**/
	public function new(sizes:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Void;
	/**
