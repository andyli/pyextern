...
@:pythonImport("matplotlib.collections", "Collection") extern class Collection {
	...
	**/
	...
	/**
		...
		capstyle : `.CapStyle`-like, default: :rc:`patch.capstyle`
		    ...
		    Allowed values are {'butt', 'projecting', 'round'}.
		joinstyle : `.JoinStyle`-like, default: :rc:`patch.joinstyle`
		    Style to use for joining lines for all paths in the collection.
		    Allowed values are {'miter', 'round', 'bevel'}.
	...
	**/
	@:native("__init__")
	public function ___init__(?edgecolors:Dynamic, ?facecolors:Dynamic, ?linewidths:Dynamic, ?linestyles:Dynamic, ?capstyle:Dynamic, ?joinstyle:Dynamic, ?antialiaseds:Dynamic, ?offsets:Dynamic, ?transOffset:Dynamic, ?norm:Dynamic, ?cmap:Dynamic, ?pickradius:Dynamic, ?hatch:Dynamic, ?urls:Dynamic, ?zorder:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
		Parameters
		----------
		edgecolors : color or list of colors, default: :rc:`patch.edgecolor`
		...
		zorder : float, default: 1
		    ...
		    :doc:`/gallery/misc/zorder_demo` for all defaults and examples.
	**/
	public function new(?edgecolors:Dynamic, ?facecolors:Dynamic, ?linewidths:Dynamic, ?linestyles:Dynamic, ?capstyle:Dynamic, ?joinstyle:Dynamic, ?antialiaseds:Dynamic, ?offsets:Dynamic, ?transOffset:Dynamic, ?norm:Dynamic, ?cmap:Dynamic, ?pickradius:Dynamic, ?hatch:Dynamic, ?urls:Dynamic, ?zorder:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Void;
	/**
	...
	**/
	...
	/**
		...
		Properties:
		    ...
		    zorder: float
	**/
	public function set(?agg_filter:Dynamic, ?alpha:Dynamic, ?animated:Dynamic, ?antialiased:Dynamic, ?array:Dynamic, ?capstyle:Dynamic, ?clim:Dynamic, ?clip_box:Dynamic, ?clip_on:Dynamic, ?clip_path:Dynamic, ?cmap:Dynamic, ?color:Dynamic, ?edgecolor:Dynamic, ?facecolor:Dynamic, ?gid:Dynamic, ?hatch:Dynamic, ?in_layout:Dynamic, ?joinstyle:Dynamic, ?label:Dynamic, ?linestyle:Dynamic, ?linewidth:Dynamic, ?norm:Dynamic, ?offset_transform:Dynamic, ?offsets:Dynamic, ?path_effects:Dynamic, ?picker:Dynamic, ?pickradius:Dynamic, ?rasterized:Dynamic, ?sketch_params:Dynamic, ?snap:Dynamic, ?transform:Dynamic, ?url:Dynamic, ?urls:Dynamic, ?visible:Dynamic, ?zorder:Dynamic):Dynamic;
	/**
