...
@:pythonImport("matplotlib.collections", "QuadMesh") extern class QuadMesh {
	...
	**/
	@:native("__init__")
	public function ___init__(coordinates:Dynamic, ?antialiased:Dynamic, ?shading:Dynamic, ?pickradius:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
		Parameters
		----------
		edgecolors : color or list of colors, default: :rc:`patch.edgecolor`
		...
		zorder : float, default: 1
		    ...
		    :doc:`/gallery/misc/zorder_demo` for all defaults and examples.
	**/
	public function new(coordinates:Dynamic, ?antialiased:Dynamic, ?shading:Dynamic, ?pickradius:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Void;
	/**
	...
	**/
	static public function _convert_mesh_to_paths(coordinates:Dynamic):Dynamic;
	/**
		Convert a given mesh into a sequence of triangles, each point
		with its own color.  The result can be used to construct a call to
		`~.RendererBase.draw_gouraud_triangle`.
	**/
	public function _convert_mesh_to_triangles(coordinates:Dynamic):Dynamic;
	/**
	...
	**/
	public function get_coordinates():Dynamic;
	/**
