...
@:pythonImport("matplotlib.collections", "PathCollection") extern class PathCollection {
	...
	**/
	public function legend_elements(?prop:Dynamic, ?num:Dynamic, ?fmt:Dynamic, ?func:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
	...
	**/
	...
	/**
		...
		Properties:
		    ...
		    zorder: float
	**/
	public function set(?agg_filter:Dynamic, ?alpha:Dynamic, ?animated:Dynamic, ?antialiased:Dynamic, ?array:Dynamic, ?capstyle:Dynamic, ?clim:Dynamic, ?clip_box:Dynamic, ?clip_on:Dynamic, ?clip_path:Dynamic, ?cmap:Dynamic, ?color:Dynamic, ?edgecolor:Dynamic, ?facecolor:Dynamic, ?gid:Dynamic, ?hatch:Dynamic, ?in_layout:Dynamic, ?joinstyle:Dynamic, ?label:Dynamic, ?linestyle:Dynamic, ?linewidth:Dynamic, ?norm:Dynamic, ?offset_transform:Dynamic, ?offsets:Dynamic, ?path_effects:Dynamic, ?paths:Dynamic, ?picker:Dynamic, ?pickradius:Dynamic, ?rasterized:Dynamic, ?sizes:Dynamic, ?sketch_params:Dynamic, ?snap:Dynamic, ?transform:Dynamic, ?url:Dynamic, ?urls:Dynamic, ?visible:Dynamic, ?zorder:Dynamic):Dynamic;
	/**
