...
@:pythonImport("matplotlib.category", "StrCategoryFormatter") extern class StrCategoryFormatter {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(units_mapping:Dynamic):Dynamic;
	/**
		Parameters
		----------
		units_mapping : dict
		    Mapping of category names (str) to indices (int).
	**/
	public function new(units_mapping:Dynamic):Void;
	/**
	...
	**/
	static public function _text(value:Dynamic):Dynamic;
