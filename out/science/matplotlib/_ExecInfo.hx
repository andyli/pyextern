...
package matplotlib;
@:pythonImport("matplotlib", "_ExecInfo") extern class _ExecInfo {
	/**
		Return self+value.
	**/
	...
	**/
	...
	/**
		Create new instance of _ExecInfo(executable, version)
	**/
	static public function __new__(_cls:Dynamic, executable:Dynamic, version:Dynamic):Dynamic;
	/**
		Helper for pickle.
	**/
	...
	**/
	...
	/**
		Make a new _ExecInfo object from a sequence or iterable
	**/
