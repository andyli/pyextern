...
@:pythonImport("matplotlib.dviread", "Text") extern class Text {
	/**
		Return self+value.
	**/
	...
	**/
	static public function __new__(_cls:Dynamic, x:Dynamic, y:Dynamic, font:Dynamic, glyph:Dynamic, width:Dynamic):Dynamic;
	/**
		Helper for pickle.
	**/
	...
	**/
	...
	/**
		Make a new Text object from a sequence or iterable
	**/
	static public function _make(iterable:Dynamic):Dynamic;
	/**
		Return a new Text object replacing specified fields with new values
	**/
