...
@:pythonImport("matplotlib.dviread", "Box") extern class Box {
	/**
		Return self+value.
	**/
	...
	**/
	static public function __new__(_cls:Dynamic, x:Dynamic, y:Dynamic, height:Dynamic, width:Dynamic):Dynamic;
	/**
		Helper for pickle.
	**/
	...
	**/
	...
	/**
		Make a new Box object from a sequence or iterable
	**/
	static public function _make(iterable:Dynamic):Dynamic;
	/**
		Return a new Box object replacing specified fields with new values
	**/
