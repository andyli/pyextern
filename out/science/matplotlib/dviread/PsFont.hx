...
@:pythonImport("matplotlib.dviread", "PsFont") extern class PsFont {
	/**
		Return self+value.
	**/
	...
	**/
	static public function __new__(_cls:Dynamic, texname:Dynamic, psname:Dynamic, effects:Dynamic, encoding:Dynamic, filename:Dynamic):Dynamic;
	/**
		Helper for pickle.
	**/
	...
	**/
	...
	/**
		Make a new PsFont object from a sequence or iterable
	**/
	static public function _make(iterable:Dynamic):Dynamic;
	/**
		Return a new PsFont object replacing specified fields with new values
	**/
