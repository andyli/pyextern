...
@:pythonImport("matplotlib.colorbar", "_ColorbarSpine") extern class _ColorbarSpine {
	...
	**/
	@:native("__init__")
	public function ___init__(axes:Dynamic):Dynamic;
	/**
		Parameters
		----------
		axes : `~matplotlib.axes.Axes`
		...
		**kwargs
		    ...
		    zorder: float
	**/
	public function new(axes:Dynamic):Void;
	/**
	...
	**/
	public function _adjust_location():Dynamic;
	...
	**/
	...
	public function _ensure_position_is_set():Dynamic;
	/**
	...
	**/
	...
	/**
		...
		member variable.
	**/
	public function _recompute_transform():Dynamic;
	/**
	...
	**/
	static public function arc_spine(axes:Dynamic, spine_type:Dynamic, center:Dynamic, radius:Dynamic, theta1:Dynamic, theta2:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
	...
	**/
	public function get_spine_transform():Dynamic;
	/**
	...
	**/
	public function register_axis(axis:Dynamic):Dynamic;
	/**
	...
	**/
	...
	/**
		...
		Properties:
		    ...
		    zorder: float
	**/
	public function set(?agg_filter:Dynamic, ?alpha:Dynamic, ?animated:Dynamic, ?antialiased:Dynamic, ?bounds:Dynamic, ?capstyle:Dynamic, ?clip_box:Dynamic, ?clip_on:Dynamic, ?clip_path:Dynamic, ?color:Dynamic, ?edgecolor:Dynamic, ?facecolor:Dynamic, ?fill:Dynamic, ?gid:Dynamic, ?hatch:Dynamic, ?in_layout:Dynamic, ?joinstyle:Dynamic, ?label:Dynamic, ?linestyle:Dynamic, ?linewidth:Dynamic, ?patch_arc:Dynamic, ?patch_circle:Dynamic, ?path_effects:Dynamic, ?picker:Dynamic, ?position:Dynamic, ?rasterized:Dynamic, ?sketch_params:Dynamic, ?snap:Dynamic, ?transform:Dynamic, ?url:Dynamic, ?visible:Dynamic, ?xy:Dynamic, ?zorder:Dynamic):Dynamic;
	/**
	...
	**/
	public function set_bounds(?low:Dynamic, ?high:Dynamic):Dynamic;
	/**
		Set the `.CapStyle`.
	...
	**/
	public function set_patch_arc(center:Dynamic, radius:Dynamic, theta1:Dynamic, theta2:Dynamic):Dynamic;
	/**
		Set the spine to be circular.
	**/
	public function set_patch_circle(center:Dynamic, radius:Dynamic):Dynamic;
	/**
		Set the spine to be linear.
	**/
	public function set_patch_line():Dynamic;
	/**
	...
	**/
	...
	/**
		...
		* 'zero' -> ('data', 0.0)
	**/
	public function set_position(position:Dynamic):Dynamic;
	/**
