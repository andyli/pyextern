...
@:pythonImport("scipy.special.setup") extern class Setup_Module {
	...
	**/
	static public function set_c_flags_hook(build_ext:Dynamic, ext:Dynamic):Dynamic;
	/**
		Sets basic compiler flags for compiling C++11 code
	**/
	static public function set_cxx_flags_hook(build_ext:Dynamic, ext:Dynamic):Dynamic;
}