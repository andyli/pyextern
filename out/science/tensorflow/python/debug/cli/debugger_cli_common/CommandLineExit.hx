...
@:pythonImport("tensorflow.python.debug.cli.debugger_cli_common", "CommandLineExit") extern class CommandLineExit {
	/**
		exception cause
	**/
	...
	**/
	@:native("__init__")
	public function ___init__(?exit_token:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(?exit_token:Dynamic):Void;
	/**
