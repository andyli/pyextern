...
@:pythonImport("tensorflow.python.debug.lib.common", "RunKey") extern class RunKey {
	/**
		Return self+value.
	**/
	...
	**/
	...
	/**
		Create new instance of RunKey(feed_names, fetch_names)
	**/
	static public function __new__(_cls:Dynamic, feed_names:Dynamic, fetch_names:Dynamic):Dynamic;
	/**
		Helper for pickle.
	**/
	...
	**/
	...
	/**
		Make a new RunKey object from a sequence or iterable
	**/
	static public function _make(iterable:Dynamic):Dynamic;
	/**
		Return a new RunKey object replacing specified fields with new values
	**/
	...
	**/
	public var feed_names : Dynamic;
	/**
		Alias for field number 1
	**/
	public var fetch_names : Dynamic;
	/**
