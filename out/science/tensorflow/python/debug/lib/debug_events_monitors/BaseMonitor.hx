...
@:pythonImport("tensorflow.python.debug.lib.debug_events_monitors", "BaseMonitor") extern class BaseMonitor {
	...
	**/
	@:native("__init__")
	public function ___init__(debug_events_reader:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(debug_events_reader:Dynamic):Void;
	/**
