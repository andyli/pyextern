...
@:pythonImport("tensorflow.python.debug.lib.debug_events_reader", "DebugEventWithOffset") extern class DebugEventWithOffset {
	/**
		Return self+value.
	**/
	...
	**/
	...
	/**
		Create new instance of DebugEventWithOffset(debug_event, offset)
	**/
	static public function __new__(_cls:Dynamic, debug_event:Dynamic, offset:Dynamic):Dynamic;
	/**
		Helper for pickle.
	**/
	...
	**/
	...
	/**
		Make a new DebugEventWithOffset object from a sequence or iterable
	**/
	static public function _make(iterable:Dynamic):Dynamic;
	/**
		Return a new DebugEventWithOffset object replacing specified fields with new values
	**/
	...
	**/
	public var debug_event : Dynamic;
	/**
