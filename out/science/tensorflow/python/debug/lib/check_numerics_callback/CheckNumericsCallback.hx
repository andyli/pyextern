...
@:pythonImport("tensorflow.python.debug.lib.check_numerics_callback", "CheckNumericsCallback") extern class CheckNumericsCallback {
	...
	**/
	@:native("__init__")
	public function ___init__(stack_height_limit:Dynamic, path_length_limit:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(stack_height_limit:Dynamic, path_length_limit:Dynamic):Void;
	/**
	...
	**/
	public function _get_output_tensor(op_type:Dynamic, tensor:Dynamic, checked_tensor:Dynamic, is_v1_graph_mode:Dynamic):Dynamic;
	/**
