...
@:pythonImport("tensorflow.python.debug.wrappers.hooks", "LocalCLIDebugHook") extern class LocalCLIDebugHook {
	...
	**/
	@:native("__init__")
	public function ___init__(?ui_type:Dynamic, ?dump_root:Dynamic, ?thread_name_filter:Dynamic, ?config_file_path:Dynamic):Dynamic;
	/**
		Create a local debugger command-line interface (CLI) hook.
		...
		Args:
		  ...
		  config_file_path: Optional override to the default configuration file
		    path, which is at `${HOME}/.tfdbg_config`.
	**/
	public function new(?ui_type:Dynamic, ?dump_root:Dynamic, ?thread_name_filter:Dynamic, ?config_file_path:Dynamic):Void;
	/**
