...
@:pythonImport("tensorflow.python.debug.wrappers.local_cli_wrapper", "LocalCLIDebugWrapperSession") extern class LocalCLIDebugWrapperSession {
	...
	**/
	@:native("__init__")
	public function ___init__(sess:Dynamic, ?dump_root:Dynamic, ?log_usage:Dynamic, ?ui_type:Dynamic, ?thread_name_filter:Dynamic, ?config_file_path:Dynamic):Dynamic;
	/**
		Constructor of LocalCLIDebugWrapperSession.
		...
		Raises:
		  ValueError: If dump_root is an existing and non-empty directory or if
		    dump_root is a file.
	**/
	public function new(sess:Dynamic, ?dump_root:Dynamic, ?log_usage:Dynamic, ?ui_type:Dynamic, ?thread_name_filter:Dynamic, ?config_file_path:Dynamic):Void;
	/**
