...
@:pythonImport("tensorflow.python.debug.wrappers.framework", "WatchOptions") extern class WatchOptions {
	...
	**/
	@:native("__init__")
	public function ___init__(?debug_ops:Dynamic, ?node_name_regex_allowlist:Dynamic, ?op_type_regex_allowlist:Dynamic, ?tensor_dtype_regex_allowlist:Dynamic, ?tolerate_debug_op_creation_failures:Dynamic):Dynamic;
	/**
		Constructor of WatchOptions: Debug watch options.
		...
		Args:
		  ...
		  tolerate_debug_op_creation_failures: (`bool`) whether debug op creation
		    ...
		    throwing exceptions.
	**/
	public function new(?debug_ops:Dynamic, ?node_name_regex_allowlist:Dynamic, ?op_type_regex_allowlist:Dynamic, ?tensor_dtype_regex_allowlist:Dynamic, ?tolerate_debug_op_creation_failures:Dynamic):Void;
	/**
