...
@:pythonImport("tensorflow.python.debug.wrappers.framework", "OnRunStartResponse") extern class OnRunStartResponse {
	...
	**/
	@:native("__init__")
	public function ___init__(action:Dynamic, debug_urls:Dynamic, ?debug_ops:Dynamic, ?node_name_regex_allowlist:Dynamic, ?op_type_regex_allowlist:Dynamic, ?tensor_dtype_regex_allowlist:Dynamic, ?tolerate_debug_op_creation_failures:Dynamic):Dynamic;
	/**
		Constructor of `OnRunStartResponse`.
		...
		Args:
		  ...
		  tolerate_debug_op_creation_failures: Whether debug op creation failures
		    are to be tolerated.
	**/
	public function new(action:Dynamic, debug_urls:Dynamic, ?debug_ops:Dynamic, ?node_name_regex_allowlist:Dynamic, ?op_type_regex_allowlist:Dynamic, ?tensor_dtype_regex_allowlist:Dynamic, ?tolerate_debug_op_creation_failures:Dynamic):Void;
	/**
