...
@:pythonImport("tensorflow.python.tpu.tpu_system_metadata", "TPUSystemMetadata") extern class TPUSystemMetadata {
	/**
		Return self+value.
	**/
	...
	**/
	...
	/**
		Create new instance of TPUSystemMetadata(num_cores, num_hosts, num_of_cores_per_host, topology, devices)
	**/
	static public function __new__(cls:Dynamic, num_cores:Dynamic, num_hosts:Dynamic, num_of_cores_per_host:Dynamic, topology:Dynamic, devices:Dynamic):Dynamic;
	/**
		Helper for pickle.
	**/
	...
	**/
	...
	/**
		Make a new TPUSystemMetadata object from a sequence or iterable
	**/
	static public function _make(iterable:Dynamic):Dynamic;
	/**
		Return a new TPUSystemMetadata object replacing specified fields with new values
	**/
