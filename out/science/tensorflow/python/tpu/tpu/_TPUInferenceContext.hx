...
@:pythonImport("tensorflow.python.tpu.tpu", "_TPUInferenceContext") extern class _TPUInferenceContext {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(name:Dynamic, ?check_ops:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(name:Dynamic, ?check_ops:Dynamic):Void;
	/**
