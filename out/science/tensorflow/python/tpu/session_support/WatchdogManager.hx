...
@:pythonImport("tensorflow.python.tpu.session_support", "WatchdogManager") extern class WatchdogManager {
	...
	**/
	@:native("__init__")
	public function ___init__(session:Dynamic, ?devices:Dynamic, ?ping_interval:Dynamic, ?shutdown_timeout:Dynamic):Dynamic;
	/**
		Initialize a watchdog manager.
		...
		Args:
		  ...
		  shutdown_timeout: Time, in seconds, before watchdog timeout.
	**/
	public function new(session:Dynamic, ?devices:Dynamic, ?ping_interval:Dynamic, ?shutdown_timeout:Dynamic):Void;
	/**
	...
	**/
	public function _reset_manager(?stopping:Dynamic):Dynamic;
	...
	**/
	...
	public function configure_and_run():Dynamic;
	/**
