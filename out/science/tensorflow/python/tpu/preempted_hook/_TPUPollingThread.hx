...
package tensorflow.python.tpu.preempted_hook;
@:pythonImport("tensorflow.python.tpu.preempted_hook", "_TPUPollingThread") extern class _TPUPollingThread {
	...
	**/
	@:native("__init__")
	public function ___init__(cluster:Dynamic, session:Dynamic):Dynamic;
	/**
		This constructor should always be called with keyword arguments. Arguments are:
	...
	**/
	public function new(cluster:Dynamic, session:Dynamic):Void;
	/**
