...
@:pythonImport("tensorflow.python.tpu.tpu_embedding_v2_utils", "FTRL") extern class FTRL {
	...
	**/
	@:native("__init__")
	public function ___init__(?learning_rate:Dynamic, ?learning_rate_power:Dynamic, ?l1_regularization_strength:Dynamic, ?l2_regularization_strength:Dynamic, ?beta:Dynamic, ?initial_accumulator_value:Dynamic, ?use_gradient_accumulation:Dynamic, ?clip_weight_min:Dynamic, ?clip_weight_max:Dynamic, ?weight_decay_factor:Dynamic, ?multiply_weight_decay_factor_by_learning_rate:Dynamic, ?slot_variable_creation_fn:Dynamic, ?clipvalue:Dynamic, ?multiply_linear_by_learning_rate:Dynamic, ?allow_zero_accumulator:Dynamic):Dynamic;
	/**
		Optimization parameters for Adagrad.
		...
		Args:
		  ...
		  allow_zero_accumulator: If set to True, changes some internal formulas to
		    ...
		    accumulator value of zero, which is uncommon.
	**/
	public function new(?learning_rate:Dynamic, ?learning_rate_power:Dynamic, ?l1_regularization_strength:Dynamic, ?l2_regularization_strength:Dynamic, ?beta:Dynamic, ?initial_accumulator_value:Dynamic, ?use_gradient_accumulation:Dynamic, ?clip_weight_min:Dynamic, ?clip_weight_max:Dynamic, ?weight_decay_factor:Dynamic, ?multiply_weight_decay_factor_by_learning_rate:Dynamic, ?slot_variable_creation_fn:Dynamic, ?clipvalue:Dynamic, ?multiply_linear_by_learning_rate:Dynamic, ?allow_zero_accumulator:Dynamic):Void;
	/**
