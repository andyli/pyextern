...
@:pythonImport("tensorflow.python.tpu.tpu_embedding_v2_utils", "FeatureConfig") extern class FeatureConfig {
	...
	**/
	@:native("__init__")
	public function ___init__(table:Dynamic, ?max_sequence_length:Dynamic, ?validate_weights_and_indices:Dynamic, ?name:Dynamic):Dynamic;
	/**
		Feature configuration.
		...
		Raises:
		  ...
		  ValueError: if `max_sequence_length` not an integer or is negative.
	**/
	public function new(table:Dynamic, ?max_sequence_length:Dynamic, ?validate_weights_and_indices:Dynamic, ?name:Dynamic):Void;
	/**
