...
@:pythonImport("tensorflow.python.tpu.tpu_embedding_v2_utils", "Adam") extern class Adam {
	...
	/**
		...
		Args:
		  ...
		  clipvalue: Controls clipping of the gradient. Set to either a single
		    ...
		    None, then there will be no clipping that direction.
	**/
	public function new(?learning_rate:Dynamic, ?beta_1:Dynamic, ?beta_2:Dynamic, ?epsilon:Dynamic, ?lazy_adam:Dynamic, ?sum_inside_sqrt:Dynamic, ?use_gradient_accumulation:Dynamic, ?clip_weight_min:Dynamic, ?clip_weight_max:Dynamic, ?weight_decay_factor:Dynamic, ?multiply_weight_decay_factor_by_learning_rate:Dynamic, ?slot_variable_creation_fn:Dynamic, ?clipvalue:Dynamic):Void;
	/**
