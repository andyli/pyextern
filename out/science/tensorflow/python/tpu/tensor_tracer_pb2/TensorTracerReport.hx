...
package tensorflow.python.tpu.tensor_tracer_pb2;
@:pythonImport("tensorflow.python.tpu.tensor_tracer_pb2", "TensorTracerReport") extern class TensorTracerReport {
	/**
	...
	**/
	...
	/**
		A ProtocolMessage
	**/
	public function TensorTracerConfig(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
		A ProtocolMessage
	**/
	public function TensordefEntry(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
		A ProtocolMessage
	**/
	public function TracedTensorDef(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	...
	/**
		Field tensorflow.TensorTracerReport.config
	**/
	public var config : Dynamic;
	/**
		Field tensorflow.TensorTracerReport.fingerprint
	**/
	public var fingerprint : Dynamic;
	/**
		Field tensorflow.TensorTracerReport.graphdef
	**/
	public var graphdef : Dynamic;
	/**
		Field tensorflow.TensorTracerReport.tensordef
	**/
	public var tensordef : Dynamic;
}