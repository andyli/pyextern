...
@:pythonImport("tensorflow.python.tpu.tpu_embedding", "FtrlSlotVariable") extern class FtrlSlotVariable {
	/**
		Return self+value.
	**/
	...
	**/
	...
	/**
		Create new instance of FtrlSlotVariable(accumulator, linear)
	**/
	...
	**/
	...
	/**
		Make a new FtrlSlotVariable object from a sequence or iterable
	**/
	static public function _make(iterable:Dynamic):Dynamic;
	/**
		Return a new FtrlSlotVariable object replacing specified fields with new values
	**/
