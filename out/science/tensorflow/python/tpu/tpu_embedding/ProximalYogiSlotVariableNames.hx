...
@:pythonImport("tensorflow.python.tpu.tpu_embedding", "ProximalYogiSlotVariableNames") extern class ProximalYogiSlotVariableNames {
	/**
		Return self+value.
	**/
	...
	**/
	...
	/**
		Create new instance of ProximalYogiSlotVariableNames(v, m)
	**/
	static public function __new__(_cls:Dynamic, v:Dynamic, m:Dynamic):Dynamic;
	/**
		Helper for pickle.
	**/
	...
	**/
	...
	/**
		Make a new ProximalYogiSlotVariableNames object from a sequence or iterable
	**/
	static public function _make(iterable:Dynamic):Dynamic;
	/**
		Return a new ProximalYogiSlotVariableNames object replacing specified fields with new values
	**/
