...
@:pythonImport("tensorflow.python.tpu.tpu_embedding", "AdagradSlotVariableNames") extern class AdagradSlotVariableNames {
	/**
		Return self+value.
	**/
	...
	**/
	...
	/**
		Create new instance of AdagradSlotVariableNames(accumulator,)
	**/
	...
	**/
	...
	/**
		Make a new AdagradSlotVariableNames object from a sequence or iterable
	**/
	static public function _make(iterable:Dynamic):Dynamic;
	/**
		Return a new AdagradSlotVariableNames object replacing specified fields with new values
	**/
