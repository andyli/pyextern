...
@:pythonImport("tensorflow.python.tpu.tpu_embedding", "RMSPropSlotVariableNames") extern class RMSPropSlotVariableNames {
	/**
		Return self+value.
	**/
	...
	**/
	...
	/**
		Create new instance of RMSPropSlotVariableNames(ms, mom)
	**/
	static public function __new__(_cls:Dynamic, ms:Dynamic, mom:Dynamic):Dynamic;
	/**
		Helper for pickle.
	**/
	...
	**/
	...
	/**
		Make a new RMSPropSlotVariableNames object from a sequence or iterable
	**/
	static public function _make(iterable:Dynamic):Dynamic;
	/**
		Return a new RMSPropSlotVariableNames object replacing specified fields with new values
	**/
