...
@:pythonImport("tensorflow.python.tpu.tpu_embedding", "AdamSlotVariableNames") extern class AdamSlotVariableNames {
	/**
		Return self+value.
	**/
	...
	**/
	...
	/**
		Create new instance of AdamSlotVariableNames(m, v)
	**/
	static public function __new__(_cls:Dynamic, m:Dynamic, v:Dynamic):Dynamic;
	/**
		Helper for pickle.
	**/
	...
	**/
	...
	/**
		Make a new AdamSlotVariableNames object from a sequence or iterable
	**/
	static public function _make(iterable:Dynamic):Dynamic;
	/**
		Return a new AdamSlotVariableNames object replacing specified fields with new values
	**/
