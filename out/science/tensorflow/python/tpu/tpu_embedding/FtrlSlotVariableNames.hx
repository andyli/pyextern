...
@:pythonImport("tensorflow.python.tpu.tpu_embedding", "FtrlSlotVariableNames") extern class FtrlSlotVariableNames {
	/**
		Return self+value.
	**/
	...
	**/
	...
	/**
		Create new instance of FtrlSlotVariableNames(accumulator, linear)
	**/
	static public function __new__(_cls:Dynamic, accumulator:Dynamic, linear:Dynamic):Dynamic;
	/**
		Helper for pickle.
	**/
	...
	**/
	...
	/**
		Make a new FtrlSlotVariableNames object from a sequence or iterable
	**/
	static public function _make(iterable:Dynamic):Dynamic;
	/**
		Return a new FtrlSlotVariableNames object replacing specified fields with new values
	**/
