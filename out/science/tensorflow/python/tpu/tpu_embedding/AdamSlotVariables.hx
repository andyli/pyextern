...
@:pythonImport("tensorflow.python.tpu.tpu_embedding", "AdamSlotVariables") extern class AdamSlotVariables {
	/**
		Return self+value.
	**/
	...
	**/
	...
	/**
		Create new instance of AdamSlotVariables(m, v)
	**/
	...
	**/
	...
	/**
		Make a new AdamSlotVariables object from a sequence or iterable
	**/
	static public function _make(iterable:Dynamic):Dynamic;
	/**
		Return a new AdamSlotVariables object replacing specified fields with new values
	**/
