...
@:pythonImport("tensorflow.python.tpu.tpu_embedding", "MomentumSlotVariables") extern class MomentumSlotVariables {
	/**
		Return self+value.
	**/
	...
	**/
	...
	/**
		Create new instance of MomentumSlotVariables(momenta,)
	**/
	...
	**/
	...
	/**
		Make a new MomentumSlotVariables object from a sequence or iterable
	**/
	static public function _make(iterable:Dynamic):Dynamic;
	/**
		Return a new MomentumSlotVariables object replacing specified fields with new values
	**/
