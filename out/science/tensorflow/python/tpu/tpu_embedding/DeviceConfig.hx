...
@:pythonImport("tensorflow.python.tpu.tpu_embedding", "DeviceConfig") extern class DeviceConfig {
	/**
		Return self+value.
	**/
	...
	**/
	...
	/**
		Create new instance of DeviceConfig(num_hosts, num_cores, job_name)
	**/
	static public function __new__(_cls:Dynamic, num_hosts:Dynamic, num_cores:Dynamic, job_name:Dynamic):Dynamic;
	/**
		Helper for pickle.
	**/
	...
	**/
	...
	/**
		Make a new DeviceConfig object from a sequence or iterable
	**/
	static public function _make(iterable:Dynamic):Dynamic;
	/**
		Return a new DeviceConfig object replacing specified fields with new values
	**/
