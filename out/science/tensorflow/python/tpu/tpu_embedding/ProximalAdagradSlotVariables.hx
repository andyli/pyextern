...
@:pythonImport("tensorflow.python.tpu.tpu_embedding", "ProximalAdagradSlotVariables") extern class ProximalAdagradSlotVariables {
	/**
		Return self+value.
	**/
	...
	**/
	...
	/**
		Create new instance of ProximalAdagradSlotVariables(accumulator,)
	**/
	...
	**/
	...
	/**
		Make a new ProximalAdagradSlotVariables object from a sequence or iterable
	**/
	static public function _make(iterable:Dynamic):Dynamic;
	/**
		Return a new ProximalAdagradSlotVariables object replacing specified fields with new values
	**/
