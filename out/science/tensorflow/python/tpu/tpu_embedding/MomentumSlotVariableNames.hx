...
@:pythonImport("tensorflow.python.tpu.tpu_embedding", "MomentumSlotVariableNames") extern class MomentumSlotVariableNames {
	/**
		Return self+value.
	**/
	...
	**/
	...
	/**
		Create new instance of MomentumSlotVariableNames(momenta,)
	**/
	static public function __new__(_cls:Dynamic, momenta:Dynamic):Dynamic;
	/**
		Helper for pickle.
	**/
	...
	**/
	...
	/**
		Make a new MomentumSlotVariableNames object from a sequence or iterable
	**/
	static public function _make(iterable:Dynamic):Dynamic;
	/**
		Return a new MomentumSlotVariableNames object replacing specified fields with new values
	**/
