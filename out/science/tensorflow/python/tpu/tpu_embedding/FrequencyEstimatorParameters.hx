...
@:pythonImport("tensorflow.python.tpu.tpu_embedding", "FrequencyEstimatorParameters") extern class FrequencyEstimatorParameters {
	...
	**/
	@:native("__init__")
	public function ___init__(tau:Dynamic, max_delta:Dynamic, outlier_threshold:Dynamic, weight_exponent:Dynamic):Dynamic;
	/**
		Optimization parameters for frequency estimator.
		...
		Args:
		  ...
		  weight_exponent: The weight exponent used to transform the estimated delta
		    into weights.
	**/
	public function new(tau:Dynamic, max_delta:Dynamic, outlier_threshold:Dynamic, weight_exponent:Dynamic):Void;
	/**
