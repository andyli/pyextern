...
@:pythonImport("tensorflow.python.tpu.tpu_embedding", "ProximalYogiSlotVariables") extern class ProximalYogiSlotVariables {
	/**
		Return self+value.
	**/
	...
	**/
	...
	/**
		Create new instance of ProximalYogiSlotVariables(v, m)
	**/
	...
	**/
	...
	/**
		Make a new ProximalYogiSlotVariables object from a sequence or iterable
	**/
	static public function _make(iterable:Dynamic):Dynamic;
	/**
		Return a new ProximalYogiSlotVariables object replacing specified fields with new values
	**/
