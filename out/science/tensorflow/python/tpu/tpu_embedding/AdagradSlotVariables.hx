...
@:pythonImport("tensorflow.python.tpu.tpu_embedding", "AdagradSlotVariables") extern class AdagradSlotVariables {
	/**
		Return self+value.
	**/
	...
	**/
	...
	/**
		Create new instance of AdagradSlotVariables(accumulator,)
	**/
	...
	**/
	...
	/**
		Make a new AdagradSlotVariables object from a sequence or iterable
	**/
	static public function _make(iterable:Dynamic):Dynamic;
	/**
		Return a new AdagradSlotVariables object replacing specified fields with new values
	**/
