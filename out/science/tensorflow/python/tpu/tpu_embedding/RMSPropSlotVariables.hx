...
@:pythonImport("tensorflow.python.tpu.tpu_embedding", "RMSPropSlotVariables") extern class RMSPropSlotVariables {
	/**
		Return self+value.
	**/
	...
	**/
	...
	/**
		Create new instance of RMSPropSlotVariables(ms, mom)
	**/
	...
	**/
	...
	/**
		Make a new RMSPropSlotVariables object from a sequence or iterable
	**/
	static public function _make(iterable:Dynamic):Dynamic;
	/**
		Return a new RMSPropSlotVariables object replacing specified fields with new values
	**/
