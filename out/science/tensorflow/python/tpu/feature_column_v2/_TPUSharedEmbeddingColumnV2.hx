...
@:pythonImport("tensorflow.python.tpu.feature_column_v2", "_TPUSharedEmbeddingColumnV2") extern class _TPUSharedEmbeddingColumnV2 {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(categorical_column:Dynamic, shared_embedding_column_creator:Dynamic, ?combiner:Dynamic, ?initializer:Dynamic, ?shared_embedding_collection_name:Dynamic, ?max_sequence_length:Dynamic, ?learning_rate_fn:Dynamic, ?use_safe_embedding_lookup:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(categorical_column:Dynamic, shared_embedding_column_creator:Dynamic, ?combiner:Dynamic, ?initializer:Dynamic, ?shared_embedding_collection_name:Dynamic, ?max_sequence_length:Dynamic, ?learning_rate_fn:Dynamic, ?use_safe_embedding_lookup:Dynamic):Void;
	/**
	...
	**/
	static public function __new__(cls:Dynamic, categorical_column:Dynamic, shared_embedding_column_creator:Dynamic, ?combiner:Dynamic, ?initializer:Dynamic, ?shared_embedding_collection_name:Dynamic, ?max_sequence_length:Dynamic, ?learning_rate_fn:Dynamic, ?use_safe_embedding_lookup:Dynamic):Dynamic;
	/**
		Helper for pickle.
	**/
