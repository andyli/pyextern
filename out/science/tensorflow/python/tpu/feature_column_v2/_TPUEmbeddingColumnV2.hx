...
@:pythonImport("tensorflow.python.tpu.feature_column_v2", "_TPUEmbeddingColumnV2") extern class _TPUEmbeddingColumnV2 {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(categorical_column:Dynamic, dimension:Dynamic, ?combiner:Dynamic, ?initializer:Dynamic, ?max_sequence_length:Dynamic, ?learning_rate_fn:Dynamic, ?use_safe_embedding_lookup:Dynamic, ?bypass_scope_validation:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(categorical_column:Dynamic, dimension:Dynamic, ?combiner:Dynamic, ?initializer:Dynamic, ?max_sequence_length:Dynamic, ?learning_rate_fn:Dynamic, ?use_safe_embedding_lookup:Dynamic, ?bypass_scope_validation:Dynamic):Void;
	/**
	...
	**/
	static public function __new__(cls:Dynamic, categorical_column:Dynamic, dimension:Dynamic, ?combiner:Dynamic, ?initializer:Dynamic, ?max_sequence_length:Dynamic, ?learning_rate_fn:Dynamic, ?use_safe_embedding_lookup:Dynamic, ?bypass_scope_validation:Dynamic):Dynamic;
	/**
		Helper for pickle.
	**/
	...
	**/
	public function _get_dense_tensor_internal(sparse_tensors:Dynamic, state_manager:Dynamic):Dynamic;
	public function _get_dense_tensor_internal_helper(sparse_tensors:Dynamic, embedding_weights:Dynamic):Dynamic;
	/**
		DEPRECATED FUNCTION
	...
	**/
	public function _old_get_dense_tensor_internal(sparse_tensors:Dynamic, weight_collections:Dynamic, trainable:Dynamic):Dynamic;
	/**
		DEPRECATED FUNCTION
