...
@:pythonImport("tensorflow.python.tpu.feature_column", "_TPUEmbeddingColumn") extern class _TPUEmbeddingColumn {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(categorical_column:Dynamic, dimension:Dynamic, ?combiner:Dynamic, ?layer_creator:Dynamic, ?ckpt_to_load_from:Dynamic, ?tensor_name_in_ckpt:Dynamic, ?max_norm:Dynamic, ?trainable:Dynamic, ?max_sequence_length:Dynamic, ?learning_rate_fn:Dynamic, ?use_safe_embedding_lookup:Dynamic, ?bypass_scope_validation:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(categorical_column:Dynamic, dimension:Dynamic, ?combiner:Dynamic, ?layer_creator:Dynamic, ?ckpt_to_load_from:Dynamic, ?tensor_name_in_ckpt:Dynamic, ?max_norm:Dynamic, ?trainable:Dynamic, ?max_sequence_length:Dynamic, ?learning_rate_fn:Dynamic, ?use_safe_embedding_lookup:Dynamic, ?bypass_scope_validation:Dynamic):Void;
	/**
	...
	**/
	static public function __new__(cls:Dynamic, categorical_column:Dynamic, dimension:Dynamic, ?combiner:Dynamic, ?layer_creator:Dynamic, ?ckpt_to_load_from:Dynamic, ?tensor_name_in_ckpt:Dynamic, ?max_norm:Dynamic, ?trainable:Dynamic, ?max_sequence_length:Dynamic, ?learning_rate_fn:Dynamic, ?use_safe_embedding_lookup:Dynamic, ?bypass_scope_validation:Dynamic):Dynamic;
	/**
		Helper for pickle.
	**/
