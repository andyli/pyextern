...
@:pythonImport("tensorflow.python.tpu.tpu_embedding_v2", "TPUEmbeddingSaveable") extern class TPUEmbeddingSaveable {
	...
	**/
	@:native("__init__")
	public function ___init__(name:Dynamic, load:Dynamic, retrieve:Dynamic):Dynamic;
	/**
		Creates a `SaveableHook` object.
		...
		Args:
		  name: the name to save the object under.
	**/
	public function new(name:Dynamic, load:Dynamic, retrieve:Dynamic):Void;
	/**
	...
	**/
	public function after_restore():Dynamic;
	/**
		This method will be called before iterating devices for saving.
	**/
	public function before_save():Dynamic;
	/**
