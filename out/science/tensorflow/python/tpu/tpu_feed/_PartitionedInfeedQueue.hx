...
@:pythonImport("tensorflow.python.tpu.tpu_feed", "_PartitionedInfeedQueue") extern class _PartitionedInfeedQueue {
	...
	**/
	public function _check_dims_and_partition_or_replicate_on_host(tensor:Dynamic, dims:Dynamic):Dynamic;
	/**
	...
	**/
	public function generate_enqueue_ops(sharded_inputs:Dynamic):Dynamic;
	/**
