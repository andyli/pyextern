...
@:pythonImport("tensorflow.python.util.deprecation", "HiddenTfApiAttribute") extern class HiddenTfApiAttribute {
	...
	**/
	@:native("__init__")
	public function ___init__(deprecation_message:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(deprecation_message:Dynamic):Void;
	/**
