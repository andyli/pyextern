...
package tensorflow.python.profiler.profiler_client;
@:pythonImport("tensorflow.python.profiler.profiler_client") extern class Profiler_client_Module {
	...
	static public function _strip_addresses(addresses:Dynamic, prefix:Dynamic):Dynamic;
