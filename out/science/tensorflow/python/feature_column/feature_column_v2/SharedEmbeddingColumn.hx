...
@:pythonImport("tensorflow.python.feature_column.feature_column_v2", "SharedEmbeddingColumn") extern class SharedEmbeddingColumn {
	...
	**/
	static public function __new__(cls:Dynamic, categorical_column:Dynamic, shared_embedding_column_creator:Dynamic, combiner:Dynamic, max_norm:Dynamic, ?use_safe_embedding_lookup:Dynamic):Dynamic;
	/**
		Helper for pickle.
	**/
