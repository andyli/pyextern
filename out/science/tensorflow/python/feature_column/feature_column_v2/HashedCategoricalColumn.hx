...
@:pythonImport("tensorflow.python.feature_column.feature_column_v2", "HashedCategoricalColumn") extern class HashedCategoricalColumn {
	/**
	...
	**/
	...
	/**
		Make a new HashedCategoricalColumn object from a sequence or iterable
	**/
	...
	**/
	...
	/**
		Return a new HashedCategoricalColumn object replacing specified fields with new values
	**/
