...
@:pythonImport("tensorflow.python.feature_column.feature_column_v2", "BucketizedColumn") extern class BucketizedColumn {
	/**
	...
	**/
	static public function __new__(_cls:Dynamic, source_column:Dynamic, boundaries:Dynamic):Dynamic;
	/**
		Helper for pickle.
	**/
	...
	**/
	...
	public function _get_dense_tensor_for_input_tensor(input_tensor:Dynamic):Dynamic;
	/**
		Converts dense inputs to SparseTensor so downstream code can use it. (deprecated)
	...
	**/
	...
	public function _get_sparse_tensors_for_input_tensor(input_tensor:Dynamic):Dynamic;
	/**
	...
	**/
	...
	/**
		Make a new BucketizedColumn object from a sequence or iterable
	**/
	...
	**/
	...
	/**
		Return a new BucketizedColumn object replacing specified fields with new values
	**/
	...
	**/
	...
	/**
		Returns bucketized categorical `source_column` tensor. (deprecated)
	...
	**/
	public var source_column : Dynamic;
	/**
