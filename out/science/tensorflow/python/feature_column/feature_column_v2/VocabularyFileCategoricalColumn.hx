...
@:pythonImport("tensorflow.python.feature_column.feature_column_v2", "VocabularyFileCategoricalColumn") extern class VocabularyFileCategoricalColumn {
	/**
	...
	**/
	static public function __new__(cls:Dynamic, key:Dynamic, vocabulary_file:Dynamic, vocabulary_size:Dynamic, num_oov_buckets:Dynamic, dtype:Dynamic, default_value:Dynamic, ?file_format:Dynamic):Dynamic;
	/**
		Helper for pickle.
	**/
	...
	**/
	...
	/**
		Make a new VocabularyFileCategoricalColumn object from a sequence or iterable
	**/
	static public function _make(iterable:Dynamic):Dynamic;
	public function _make_table(key_dtype:Dynamic, state_manager:Dynamic):Dynamic;
	public function _make_table_from_tfrecord_gzip_file(key_dtype:Dynamic, name:Dynamic):Dynamic;
	/**
		DEPRECATED FUNCTION
	...
	**/
	...
	/**
		Return a new VocabularyFileCategoricalColumn object replacing specified fields with new values
	**/
	...
	**/
	public var file_format : Dynamic;
	/**
	...
	**/
	public var vocabulary_file : Dynamic;
	/**
