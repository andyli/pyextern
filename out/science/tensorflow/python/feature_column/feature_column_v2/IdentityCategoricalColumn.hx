...
@:pythonImport("tensorflow.python.feature_column.feature_column_v2", "IdentityCategoricalColumn") extern class IdentityCategoricalColumn {
	/**
	...
	**/
	static public function __new__(_cls:Dynamic, key:Dynamic, number_buckets:Dynamic, default_value:Dynamic):Dynamic;
	/**
		Helper for pickle.
	**/
	...
	**/
	...
	/**
		Make a new IdentityCategoricalColumn object from a sequence or iterable
	**/
	...
	**/
	...
	/**
		Return a new IdentityCategoricalColumn object replacing specified fields with new values
	**/
	...
	**/
	public var number_buckets : Dynamic;
	/**
		See 'FeatureColumn` base class.
	**/
