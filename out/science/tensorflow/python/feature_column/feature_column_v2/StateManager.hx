...
@:pythonImport("tensorflow.python.feature_column.feature_column_v2", "StateManager") extern class StateManager {
	...
	**/
	...
	/**
		...
		Args:
		  ...
		  name: Name of the resource.
	**/
	public function has_resource(feature_column:Dynamic, name:Dynamic):Dynamic;
}