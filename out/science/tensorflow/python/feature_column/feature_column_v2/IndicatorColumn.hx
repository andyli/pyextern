...
@:pythonImport("tensorflow.python.feature_column.feature_column_v2", "IndicatorColumn") extern class IndicatorColumn {
	/**
	...
	**/
	...
	/**
		Make a new IndicatorColumn object from a sequence or iterable
	**/
	...
	**/
	...
	/**
		Return a new IndicatorColumn object replacing specified fields with new values
	**/
	...
	**/
	...
	public function _transform_id_weight_pair(id_weight_pair:Dynamic, size:Dynamic):Dynamic;
	/**
