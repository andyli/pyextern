...
@:pythonImport("tensorflow.python.feature_column.feature_column", "_NumericColumn") extern class _NumericColumn {
	...
	**/
	...
	/**
		Create new instance of _NumericColumn(key, shape, default_value, dtype, normalizer_fn)
	**/
	...
	**/
	...
	/**
		Make a new _NumericColumn object from a sequence or iterable
	**/
	...
	**/
	...
	/**
		Return a new _NumericColumn object replacing specified fields with new values
	**/
