...
@:pythonImport("tensorflow.python.feature_column.feature_column", "_EmbeddingColumnLayer") extern class _EmbeddingColumnLayer {
	...
	**/
	@:native("__init__")
	public function ___init__(embedding_shape:Dynamic, initializer:Dynamic, ?weight_collections:Dynamic, ?trainable:Dynamic, ?name:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
		Constructor.
		...
		Args:
		  ...
		  **kwargs: keyword named properties.
	**/
	public function new(embedding_shape:Dynamic, initializer:Dynamic, ?weight_collections:Dynamic, ?trainable:Dynamic, ?name:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Void;
	/**
	...
	**/
	public function call(_:Dynamic):Dynamic;
	/**
	...
	/**
		...
		Args:
		  weight_collections: A list of collection names to which the Variable will
		    be added.
	**/
	public function set_weight_collections(weight_collections:Dynamic):Dynamic;
	/**
