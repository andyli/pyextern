...
@:pythonImport("tensorflow.python.feature_column.feature_column", "_SharedEmbeddingColumn") extern class _SharedEmbeddingColumn {
	/**
	...
	**/
	...
	/**
		Create new instance of _SharedEmbeddingColumn(categorical_column, dimension, combiner, initializer, shared_embedding_collection_name, ckpt_to_load_from, tensor_name_in_ckpt, max_norm, trainable, use_safe_embedding_lookup)
	**/
	static public function __new__(_cls:Dynamic, categorical_column:Dynamic, dimension:Dynamic, combiner:Dynamic, initializer:Dynamic, shared_embedding_collection_name:Dynamic, ckpt_to_load_from:Dynamic, tensor_name_in_ckpt:Dynamic, max_norm:Dynamic, trainable:Dynamic, use_safe_embedding_lookup:Dynamic):Dynamic;
	/**
		Helper for pickle.
	**/
