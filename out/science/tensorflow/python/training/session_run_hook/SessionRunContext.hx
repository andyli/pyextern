...
@:pythonImport("tensorflow.python.training.session_run_hook", "SessionRunContext") extern class SessionRunContext {
	...
	**/
	@:native("__init__")
	public function ___init__(original_args:Dynamic, session:Dynamic):Dynamic;
	/**
		Initializes SessionRunContext.
	**/
	public function new(original_args:Dynamic, session:Dynamic):Void;
	/**
	...
	**/
	public var original_args : Dynamic;
	/**
	...
	**/
	public function request_stop():Dynamic;
	/**
	...
	**/
	...
	/**
		...
		Returns:
		  A `bool`
	**/
	public var stop_requested : Dynamic;
}