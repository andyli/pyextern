...
@:pythonImport("tensorflow.python.training.checkpoint_state_pb2", "CheckpointState") extern class CheckpointState {
	...
	**/
	...
	/**
		Field tensorflow.CheckpointState.all_model_checkpoint_paths
	**/
	public var all_model_checkpoint_paths : Dynamic;
	/**
		Field tensorflow.CheckpointState.all_model_checkpoint_timestamps
	**/
	public var all_model_checkpoint_timestamps : Dynamic;
	/**
		Field tensorflow.CheckpointState.last_preserved_timestamp
	**/
	public var last_preserved_timestamp : Dynamic;
	/**
		Field tensorflow.CheckpointState.model_checkpoint_path
	**/
