...
@:pythonImport("tensorflow.python.training.saver", "Saver") extern class Saver {
	...
	**/
	public function save(sess:Dynamic, save_path:Dynamic, ?global_step:Dynamic, ?latest_filename:Dynamic, ?meta_graph_suffix:Dynamic, ?write_meta_graph:Dynamic, ?write_state:Dynamic, ?strip_default_attrs:Dynamic, ?save_debug_info:Dynamic):Dynamic;
	/**
