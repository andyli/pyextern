...
@:pythonImport("tensorflow.python.training.evaluation", "_MultiStepStopAfterNEvalsHook") extern class _MultiStepStopAfterNEvalsHook {
	...
	**/
	@:native("__init__")
	public function ___init__(num_evals:Dynamic, ?steps_per_run:Dynamic):Dynamic;
	/**
		Constructs the run hook.
		...
		Args:
		  ...
		  steps_per_run: Number of steps executed per run call.
	**/
	public function new(num_evals:Dynamic, ?steps_per_run:Dynamic):Void;
	/**
