...
@:pythonImport("tensorflow.python.training.sync_replicas_optimizer", "SyncReplicasOptimizer") extern class SyncReplicasOptimizer {
	...
	**/
	...
	/**
		...
		The `SyncReplicaOptimizer` class is deprecated. For synchronous training, please use [Distribution Strategies](https://github.com/tensorflow/tensorflow/tree/master/tensorflow/contrib/distribute).
