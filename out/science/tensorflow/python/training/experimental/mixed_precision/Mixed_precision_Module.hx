...
package tensorflow.python.training.experimental.mixed_precision;
@:pythonImport("tensorflow.python.training.experimental.mixed_precision") extern class Mixed_precision_Module {
	static public var _REGISTERED_WRAPPER_OPTIMIZER_CLS : Dynamic;
	...
	**/
	static public function _wrap_optimizer(opt:Dynamic, loss_scale:Dynamic):Dynamic;
	...
	**/
	static public function disable_mixed_precision_graph_rewrite_v1():Dynamic;
	...
	**/
	static public function register_loss_scale_wrapper(optimizer_cls:Dynamic, wrapper_cls:Dynamic):Dynamic;
