...
package tensorflow.python.training.experimental.loss_scale_optimizer;
@:pythonImport("tensorflow.python.training.experimental.loss_scale_optimizer", "MixedPrecisionLossScaleOptimizer") extern class MixedPrecisionLossScaleOptimizer {
	...
	**/
	@:native("__init__")
	public function ___init__(opt:Dynamic, loss_scale:Dynamic):Dynamic;
	/**
		Create a new Optimizer.
		...
		Raises:
		  ValueError: If name is malformed.
	**/
	public function new(opt:Dynamic, loss_scale:Dynamic):Void;
	/**
	...
	**/
	public function _apply_gradients(distribution:Dynamic, grads_and_vars:Dynamic, global_step:Dynamic, name:Dynamic):Dynamic;
	/**
		This function should never be called.
	**/
	...
	**/
	public function _doing_dynamic_loss_scaling():Dynamic;
	/**
	...
	**/
	...
	public function _scale_grad(grad:Dynamic, loss_scale_reciprocal:Dynamic):Dynamic;
	public function _scale_loss(loss:Dynamic):Dynamic;
	/**
	...
	**/
	...
	public function _unscale_grads(grads:Dynamic):Dynamic;
