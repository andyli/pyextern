...
@:pythonImport("tensorflow.python.training.experimental.loss_scale", "FixedLossScale") extern class FixedLossScale {
	...
	**/
	...
	/**
		Creates the fixed loss scale. (deprecated)
	...
	**/
	@:native("__init__")
	public function ___init__(loss_scale_value:Dynamic):Dynamic;
	/**
		Creates the fixed loss scale. (deprecated)
		...
		Raises:
		  ValueError: If loss_scale_value is less than 1.
	**/
	public function new(loss_scale_value:Dynamic):Void;
	/**
