...
@:pythonImport("tensorflow.python.training.experimental.loss_scale", "DynamicLossScale") extern class DynamicLossScale {
	...
	**/
	...
	/**
		Creates the dynamic loss scale. (deprecated)
	...
	**/
	@:native("__init__")
	public function ___init__(?initial_loss_scale:Dynamic, ?increment_period:Dynamic, ?multiplier:Dynamic):Dynamic;
	/**
		Creates the dynamic loss scale. (deprecated)
		...
		Args:
		  ...
		  multiplier: The multiplier to use when increasing or decreasing the loss
		    scale.
	**/
	public function new(?initial_loss_scale:Dynamic, ?increment_period:Dynamic, ?multiplier:Dynamic):Void;
	/**
	...
	**/
	...
	public var increment_period : Dynamic;
