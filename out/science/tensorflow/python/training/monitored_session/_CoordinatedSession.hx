...
@:pythonImport("tensorflow.python.training.monitored_session", "_CoordinatedSession") extern class _CoordinatedSession {
	...
	**/
	@:native("__init__")
	public function ___init__(sess:Dynamic, coord:Dynamic, ?stop_grace_period_secs:Dynamic):Dynamic;
	/**
		Create a new `_CoordinatedSession`.
		...
		Args:
		  ...
		  stop_grace_period_secs: Number of seconds given to threads to stop after
		    `close()` has been called.
	**/
	public function new(sess:Dynamic, coord:Dynamic, ?stop_grace_period_secs:Dynamic):Void;
	/**
