...
@:pythonImport("tensorflow.python.training.tracking.util", "_NameBasedRestoreCoordinator") extern class _NameBasedRestoreCoordinator {
	...
	**/
	public function eager_restore(trackable:Dynamic):Dynamic;
	/**
	...
	**/
	public function globally_named_object_attributes(trackable:Dynamic):Dynamic;
}