...
@:pythonImport("tensorflow.python.training.tracking.util", "CheckpointLoadStatus") extern class CheckpointLoadStatus {
	...
	**/
	@:native("__init__")
	public function ___init__(checkpoint:Dynamic, feed_dict:Dynamic, graph_view:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(checkpoint:Dynamic, feed_dict:Dynamic, graph_view:Dynamic):Void;
	/**
