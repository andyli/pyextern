...
package tensorflow.python.training.tracking.python_state;
@:pythonImport("tensorflow.python.training.tracking.python_state", "PythonState") extern class PythonState {
	...
	**/
	public function deserialize(string_value:Dynamic):Dynamic;
	/**
