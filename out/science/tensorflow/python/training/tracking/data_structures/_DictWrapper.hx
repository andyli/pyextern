...
@:pythonImport("tensorflow.python.training.tracking.data_structures", "_DictWrapper") extern class _DictWrapper {
	/**
		abs(self)
	**/
	...
	**/
	@:native("__init__")
	public function ___init__(?wrapped_dict:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(?wrapped_dict:Dynamic):Void;
	/**
	...
	**/
	...
	public var _attribute_sentinel : Dynamic;
	/**
		Checks for any changes to the wrapped dict not through the wrapper.
	**/
	public function _check_self_external_modification():Dynamic;
	/**
	...
	**/
	public function _name_element(key:Dynamic):Dynamic;
	/**
