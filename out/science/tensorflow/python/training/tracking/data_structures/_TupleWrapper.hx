...
@:pythonImport("tensorflow.python.training.tracking.data_structures", "_TupleWrapper") extern class _TupleWrapper {
	/**
		abs(self)
	**/
	...
	**/
	public function __iadd__(y:Dynamic):Dynamic;
	/**
		Return self&=value.
	**/
	...
	**/
	...
	/**
		Avoid running self.__wrapped__ *= y, which mutates `self`.
	**/
	public function __imul__(y:Dynamic):Dynamic;
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(?original_wrapped_tuple:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(?original_wrapped_tuple:Dynamic):Void;
	/**
