...
@:pythonImport("tensorflow.python.training.tracking.data_structures", "Mapping") extern class Mapping {
	...
	**/
	...
	public function _make_storage(?args:python.VarArgs<Dynamic>, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
