...
@:pythonImport("tensorflow.python.training.tracking.graph_view", "_CheckpointFactoryData") extern class _CheckpointFactoryData {
	/**
		Return self+value.
	**/
	...
	**/
	...
	/**
		Create new instance of _CheckpointFactoryData(factory, name, checkpoint_key)
	**/
	static public function __new__(_cls:Dynamic, factory:Dynamic, name:Dynamic, checkpoint_key:Dynamic):Dynamic;
	/**
		Helper for pickle.
	**/
	...
	**/
	...
	/**
		Make a new _CheckpointFactoryData object from a sequence or iterable
	**/
	static public function _make(iterable:Dynamic):Dynamic;
	/**
		Return a new _CheckpointFactoryData object replacing specified fields with new values
	**/
	public function _replace(?kwds:python.KwArgs<Dynamic>):Dynamic;
	/**
		Alias for field number 2
	**/
	public var checkpoint_key : Dynamic;
	/**
