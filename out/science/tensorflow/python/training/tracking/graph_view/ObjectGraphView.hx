...
@:pythonImport("tensorflow.python.training.tracking.graph_view", "ObjectGraphView") extern class ObjectGraphView {
	...
	**/
	@:native("__init__")
	public function ___init__(root:Dynamic, ?saveables_cache:Dynamic, ?attached_dependencies:Dynamic):Dynamic;
	/**
		Configure the graph view.
		...
		Args:
		  ...
		  attached_dependencies: Dependencies to attach to the root object. Used
		    when saving a Checkpoint with a defined root object.
	**/
	public function new(root:Dynamic, ?saveables_cache:Dynamic, ?attached_dependencies:Dynamic):Void;
	/**
