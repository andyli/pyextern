...
@:pythonImport("tensorflow.python.training.tracking.base", "TrackableReference") extern class TrackableReference {
	/**
		Return self+value.
	**/
	...
	**/
	...
	/**
		Create new instance of TrackableReference(name, ref)
	**/
	...
	**/
	...
	/**
		Make a new TrackableReference object from a sequence or iterable
	**/
	static public function _make(iterable:Dynamic):Dynamic;
	/**
		Return a new TrackableReference object replacing specified fields with new values
	**/
