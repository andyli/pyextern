...
@:pythonImport("tensorflow.python.training.tracking.base", "NoRestoreSaveable") extern class NoRestoreSaveable {
	...
	**/
	@:native("__init__")
	public function ___init__(tensor:Dynamic, name:Dynamic, ?dtype:Dynamic, ?device:Dynamic):Dynamic;
	/**
		Creates a `SaveableObject` object.
		...
		Args:
		  ...
		  name: the name to save the object under.
	**/
	public function new(tensor:Dynamic, name:Dynamic, ?dtype:Dynamic, ?device:Dynamic):Void;
	/**
