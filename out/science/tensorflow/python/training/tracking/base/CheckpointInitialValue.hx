...
@:pythonImport("tensorflow.python.training.tracking.base", "CheckpointInitialValue") extern class CheckpointInitialValue {
	...
	**/
	@:native("__init__")
	public function ___init__(checkpoint_position:Dynamic, ?shape:Dynamic, ?shard_info:Dynamic):Dynamic;
	/**
		Creates a new `Tensor`.
		...
		Raises:
		  TypeError: If the op is not an `Operation`.
	**/
	public function new(checkpoint_position:Dynamic, ?shape:Dynamic, ?shard_info:Dynamic):Void;
	/**
