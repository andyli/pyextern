...
@:pythonImport("tensorflow.python.training.basic_session_run_hooks", "SummarySaverHook") extern class SummarySaverHook {
	...
	**/
	@:native("__init__")
	public function ___init__(?save_steps:Dynamic, ?save_secs:Dynamic, ?output_dir:Dynamic, ?summary_writer:Dynamic, ?scaffold:Dynamic, ?summary_op:Dynamic):Dynamic;
	/**
		Initializes a `SummarySaverHook`.
		...
		Raises:
		  ValueError: Exactly one of scaffold or summary_op should be set.
	**/
	public function new(?save_steps:Dynamic, ?save_secs:Dynamic, ?output_dir:Dynamic, ?summary_writer:Dynamic, ?scaffold:Dynamic, ?summary_op:Dynamic):Void;
	/**
	...
	**/
	public function _get_summary_op():Dynamic;
