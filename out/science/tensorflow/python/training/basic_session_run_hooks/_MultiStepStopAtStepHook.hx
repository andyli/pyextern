...
@:pythonImport("tensorflow.python.training.basic_session_run_hooks", "_MultiStepStopAtStepHook") extern class _MultiStepStopAtStepHook {
	...
	**/
	@:native("__init__")
	public function ___init__(?num_steps:Dynamic, ?last_step:Dynamic, ?steps_per_run:Dynamic):Dynamic;
	/**
		Initializes a `MultiStepStopAtStepHook`.
		...
		Raises:
		  ValueError: If one of the arguments is invalid.
	**/
	public function new(?num_steps:Dynamic, ?last_step:Dynamic, ?steps_per_run:Dynamic):Void;
	/**
