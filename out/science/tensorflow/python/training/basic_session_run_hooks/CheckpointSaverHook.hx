...
@:pythonImport("tensorflow.python.training.basic_session_run_hooks", "CheckpointSaverHook") extern class CheckpointSaverHook {
	...
	**/
	@:native("__init__")
	public function ___init__(checkpoint_dir:Dynamic, ?save_secs:Dynamic, ?save_steps:Dynamic, ?saver:Dynamic, ?checkpoint_basename:Dynamic, ?scaffold:Dynamic, ?listeners:Dynamic, ?save_graph_def:Dynamic):Dynamic;
	/**
		Initializes a `CheckpointSaverHook`.
		...
		Raises:
		  ...
		  ValueError: At most one of `saver` or `scaffold` should be set.
	**/
	public function new(checkpoint_dir:Dynamic, ?save_secs:Dynamic, ?save_steps:Dynamic, ?saver:Dynamic, ?checkpoint_basename:Dynamic, ?scaffold:Dynamic, ?listeners:Dynamic, ?save_graph_def:Dynamic):Void;
	/**
	...
	**/
	public function _save(session:Dynamic, step:Dynamic):Dynamic;
