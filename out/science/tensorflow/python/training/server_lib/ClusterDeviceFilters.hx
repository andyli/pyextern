...
@:pythonImport("tensorflow.python.training.server_lib", "ClusterDeviceFilters") extern class ClusterDeviceFilters {
	...
	**/
	public function _as_cluster_device_filters():Dynamic;
	/**
	...
	**/
	public function _make_cluster_device_filters():Dynamic;
	static public var _tf_api_names : Dynamic;
	static public var _tf_api_names_v1 : Dynamic;
	/**
		Set the device filters for given job name and task id.
	**/
	public function set_device_filters(job_name:Dynamic, task_index:Dynamic, device_filters:Dynamic):Dynamic;
}