...
@:pythonImport("tensorflow.python.training.saving.functional_saver", "MultiDeviceSaver") extern class MultiDeviceSaver {
	...
	**/
	...
	public function _traced_restore(file_prefix:Dynamic):Dynamic;
	public function _traced_save(file_prefix:Dynamic):Dynamic;
	/**
