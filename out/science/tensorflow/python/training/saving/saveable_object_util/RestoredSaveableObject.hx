...
@:pythonImport("tensorflow.python.training.saving.saveable_object_util", "RestoredSaveableObject") extern class RestoredSaveableObject {
	...
	**/
	@:native("__init__")
	public function ___init__(save_function:Dynamic, restore_function:Dynamic, name:Dynamic):Dynamic;
	/**
		Creates a `SaveableObject` object.
		...
		Args:
		  ...
		  name: the name to save the object under.
	**/
	public function new(save_function:Dynamic, restore_function:Dynamic, name:Dynamic):Void;
	/**
