...
package tensorflow.python.training.saving.saveable_hook;
@:pythonImport("tensorflow.python.training.saving.saveable_hook", "SaveableHook") extern class SaveableHook {
