...
@:pythonImport("tensorflow.python.keras.layers.advanced_activations", "ReLU") extern class ReLU {
	...
	**/
	...
	@:native("__init__")
	public function ___init__(?max_value:Dynamic, ?negative_slope:Dynamic, ?threshold:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	public function new(?max_value:Dynamic, ?negative_slope:Dynamic, ?threshold:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Void;
	/**
