...
@:pythonImport("tensorflow.python.keras.layers.advanced_activations", "ThresholdedReLU") extern class ThresholdedReLU {
	...
	**/
	...
	@:native("__init__")
	public function ___init__(?theta:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	public function new(?theta:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Void;
	/**
