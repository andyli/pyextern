...
@:pythonImport("tensorflow.python.keras.layers.advanced_activations", "PReLU") extern class PReLU {
	...
	**/
	...
	@:native("__init__")
	public function ___init__(?alpha_initializer:Dynamic, ?alpha_regularizer:Dynamic, ?alpha_constraint:Dynamic, ?shared_axes:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	public function new(?alpha_initializer:Dynamic, ?alpha_regularizer:Dynamic, ?alpha_constraint:Dynamic, ?shared_axes:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Void;
	/**
