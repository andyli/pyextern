...
@:pythonImport("tensorflow.python.keras.layers.wrappers", "TimeDistributed") extern class TimeDistributed {
	...
	**/
	...
	public function _remove_timesteps(dims:Dynamic):Dynamic;
	/**
