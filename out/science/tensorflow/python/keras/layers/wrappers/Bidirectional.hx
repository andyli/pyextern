...
@:pythonImport("tensorflow.python.keras.layers.wrappers", "Bidirectional") extern class Bidirectional {
	...
	**/
	...
	@:native("__init__")
	public function ___init__(layer:Dynamic, ?merge_mode:Dynamic, ?weights:Dynamic, ?backward_layer:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	public function new(layer:Dynamic, ?merge_mode:Dynamic, ?weights:Dynamic, ?backward_layer:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Void;
	/**
	...
	**/
	...
	public function _recreate_layer_from_config(layer:Dynamic, ?go_backwards:Dynamic):Dynamic;
	/**
	...
	**/
	public function _verify_layer_config():Dynamic;
	/**
	...
	**/
	public function call(inputs:Dynamic, ?training:Dynamic, ?mask:Dynamic, ?initial_state:Dynamic, ?constants:Dynamic):Dynamic;
	/**
