...
@:pythonImport("tensorflow.python.keras.layers.wrappers", "Wrapper") extern class Wrapper {
	...
	**/
	...
	@:native("__init__")
	public function ___init__(layer:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	public function new(layer:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Void;
	/**
