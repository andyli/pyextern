...
package tensorflow.python.keras.layers.kernelized;
@:pythonImport("tensorflow.python.keras.layers.kernelized", "RandomFourierFeatures") extern class RandomFourierFeatures {
	...
	**/
	...
	@:native("__init__")
	public function ___init__(output_dim:Dynamic, ?kernel_initializer:Dynamic, ?scale:Dynamic, ?trainable:Dynamic, ?name:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	public function new(output_dim:Dynamic, ?kernel_initializer:Dynamic, ?scale:Dynamic, ?trainable:Dynamic, ?name:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Void;
	/**
