...
@:pythonImport("tensorflow.python.keras.layers.pooling", "GlobalAveragePooling2D") extern class GlobalAveragePooling2D {
	...
	**/
	...
	@:native("__init__")
	public function ___init__(?data_format:Dynamic, ?keepdims:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	public function new(?data_format:Dynamic, ?keepdims:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Void;
	/**
