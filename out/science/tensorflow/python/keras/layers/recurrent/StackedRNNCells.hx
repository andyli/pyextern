...
@:pythonImport("tensorflow.python.keras.layers.recurrent", "StackedRNNCells") extern class StackedRNNCells {
	...
	**/
	...
	@:native("__init__")
	public function ___init__(cells:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	public function new(cells:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Void;
	/**
	...
	**/
	public function call(inputs:Dynamic, states:Dynamic, ?constants:Dynamic, ?training:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
