...
@:pythonImport("tensorflow.python.keras.layers.recurrent", "AbstractRNNCell") extern class AbstractRNNCell {
	...
	**/
	public function call(inputs:Dynamic, states:Dynamic):Dynamic;
	/**
