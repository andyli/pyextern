...
@:pythonImport("tensorflow.python.keras.layers.recurrent", "RNN") extern class RNN {
	...
	**/
	...
	@:native("__init__")
	public function ___init__(cell:Dynamic, ?return_sequences:Dynamic, ?return_state:Dynamic, ?go_backwards:Dynamic, ?stateful:Dynamic, ?unroll:Dynamic, ?time_major:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	public function new(cell:Dynamic, ?return_sequences:Dynamic, ?return_state:Dynamic, ?go_backwards:Dynamic, ?stateful:Dynamic, ?unroll:Dynamic, ?time_major:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Void;
	/**
