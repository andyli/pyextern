...
@:pythonImport("tensorflow.python.keras.layers.normalization.batch_normalization", "SyncBatchNormalization") extern class SyncBatchNormalization {
	...
	**/
	...
	public function _calculate_mean_and_var(x:Dynamic, axes:Dynamic, keep_dims:Dynamic):Dynamic;
