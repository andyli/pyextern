...
package tensorflow.python.keras.layers.normalization.batch_normalization;
@:pythonImport("tensorflow.python.keras.layers.normalization.batch_normalization", "BatchNormalizationBase") extern class BatchNormalizationBase {
	static public var _TF_MODULE_IGNORED_PROPERTIES : Dynamic;
	static public var _USE_V2_BEHAVIOR : Dynamic;
	/**
	...
	**/
	...
	@:native("__init__")
	public function ___init__(?axis:Dynamic, ?momentum:Dynamic, ?epsilon:Dynamic, ?center:Dynamic, ?scale:Dynamic, ?beta_initializer:Dynamic, ?gamma_initializer:Dynamic, ?moving_mean_initializer:Dynamic, ?moving_variance_initializer:Dynamic, ?beta_regularizer:Dynamic, ?gamma_regularizer:Dynamic, ?beta_constraint:Dynamic, ?gamma_constraint:Dynamic, ?renorm:Dynamic, ?renorm_clipping:Dynamic, ?renorm_momentum:Dynamic, ?fused:Dynamic, ?trainable:Dynamic, ?virtual_batch_size:Dynamic, ?adjustment:Dynamic, ?name:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	public function new(?axis:Dynamic, ?momentum:Dynamic, ?epsilon:Dynamic, ?center:Dynamic, ?scale:Dynamic, ?beta_initializer:Dynamic, ?gamma_initializer:Dynamic, ?moving_mean_initializer:Dynamic, ?moving_variance_initializer:Dynamic, ?beta_regularizer:Dynamic, ?gamma_regularizer:Dynamic, ?beta_constraint:Dynamic, ?gamma_constraint:Dynamic, ?renorm:Dynamic, ?renorm_clipping:Dynamic, ?renorm_momentum:Dynamic, ?fused:Dynamic, ?trainable:Dynamic, ?virtual_batch_size:Dynamic, ?adjustment:Dynamic, ?name:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Void;
	/**
	...
	**/
	...
	public function _assign_moving_average(variable:Dynamic, value:Dynamic, momentum:Dynamic, inputs_size:Dynamic):Dynamic;
	public function _assign_new_value(variable:Dynamic, value:Dynamic):Dynamic;
	public function _autographed_call():Dynamic;
	public function _calculate_mean_and_var(inputs:Dynamic, reduction_axes:Dynamic, keep_dims:Dynamic):Dynamic;
	...
	**/
	public function _fused_batch_norm(inputs:Dynamic, training:Dynamic):Dynamic;
	public function _fused_can_be_used():Dynamic;
	...
	**/
	...
	public function _get_training_value(?training:Dynamic):Dynamic;
	...
	**/
	...
	public function _moments(inputs:Dynamic, reduction_axes:Dynamic, keep_dims:Dynamic):Dynamic;
	...
	**/
	...
	public var _param_dtype : Dynamic;
	/**
	...
	**/
	...
	/**
		...
		known.
	**/
	public function _raise_if_fused_cannot_be_used():Dynamic;
	/**
		Returns the correction and update values for renorm.
	**/
	public function _renorm_correction_and_moments(mean:Dynamic, variance:Dynamic, training:Dynamic, inputs_size:Dynamic):Dynamic;
	/**
	...
	**/
	...
	public function _support_zero_size_input():Dynamic;
	...
	**/
	public function call(inputs:Dynamic, ?training:Dynamic):Dynamic;
	/**
