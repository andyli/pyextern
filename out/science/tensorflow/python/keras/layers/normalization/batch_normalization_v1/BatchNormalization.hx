...
package tensorflow.python.keras.layers.normalization.batch_normalization_v1;
@:pythonImport("tensorflow.python.keras.layers.normalization.batch_normalization_v1", "BatchNormalization") extern class BatchNormalization {
