...
package tensorflow.python.keras.layers.normalization.layer_normalization;
@:pythonImport("tensorflow.python.keras.layers.normalization.layer_normalization", "LayerNormalization") extern class LayerNormalization {
	...
	**/
	...
	@:native("__init__")
	public function ___init__(?axis:Dynamic, ?epsilon:Dynamic, ?center:Dynamic, ?scale:Dynamic, ?beta_initializer:Dynamic, ?gamma_initializer:Dynamic, ?beta_regularizer:Dynamic, ?gamma_regularizer:Dynamic, ?beta_constraint:Dynamic, ?gamma_constraint:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	public function new(?axis:Dynamic, ?epsilon:Dynamic, ?center:Dynamic, ?scale:Dynamic, ?beta_initializer:Dynamic, ?gamma_initializer:Dynamic, ?beta_regularizer:Dynamic, ?gamma_regularizer:Dynamic, ?beta_constraint:Dynamic, ?gamma_constraint:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Void;
	/**
	...
	**/
	public function _fused_can_be_used(ndims:Dynamic):Dynamic;
