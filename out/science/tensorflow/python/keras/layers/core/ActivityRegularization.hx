...
@:pythonImport("tensorflow.python.keras.layers.core", "ActivityRegularization") extern class ActivityRegularization {
	...
	**/
	...
	@:native("__init__")
	public function ___init__(?l1:Dynamic, ?l2:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	public function new(?l1:Dynamic, ?l2:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Void;
	/**
