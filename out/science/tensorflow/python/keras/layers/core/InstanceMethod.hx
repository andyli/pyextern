...
@:pythonImport("tensorflow.python.keras.layers.core", "InstanceMethod") extern class InstanceMethod {
	...
	**/
	...
	@:native("__init__")
	public function ___init__(attr_name:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	public function new(attr_name:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Void;
	/**
	...
	**/
	public function call(obj:Dynamic, args:Dynamic, kwargs:Dynamic):Dynamic;
	/**
