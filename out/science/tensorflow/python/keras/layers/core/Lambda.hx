...
@:pythonImport("tensorflow.python.keras.layers.core", "Lambda") extern class Lambda {
	...
	**/
	...
	@:native("__init__")
	public function ___init__(_function:Dynamic, ?output_shape:Dynamic, ?mask:Dynamic, ?arguments:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	public function new(_function:Dynamic, ?output_shape:Dynamic, ?mask:Dynamic, ?arguments:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Void;
	/**
	...
	**/
	...
	public function _check_variables(created_variables:Dynamic, accessed_variables:Dynamic):Dynamic;
	/**
	...
	**/
	...
	static public function _parse_function_from_config(config:Dynamic, custom_objects:Dynamic, func_attr_name:Dynamic, module_attr_name:Dynamic, func_type_attr_name:Dynamic):Dynamic;
	/**
	...
	**/
	...
	public function _serialize_function_to_config(inputs:Dynamic, ?allow_raw:Dynamic):Dynamic;
	/**
	...
	**/
	...
	public function _warn(msg:Dynamic):Dynamic;
	/**
	...
	**/
	public function call(inputs:Dynamic, ?mask:Dynamic, ?training:Dynamic):Dynamic;
	/**
