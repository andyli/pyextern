...
@:pythonImport("tensorflow.python.keras.layers.core", "TFClassMethodDispatcher") extern class TFClassMethodDispatcher {
	...
	**/
	@:native("__init__")
	public function ___init__(cls:Dynamic, method_name:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(cls:Dynamic, method_name:Dynamic):Void;
	/**
