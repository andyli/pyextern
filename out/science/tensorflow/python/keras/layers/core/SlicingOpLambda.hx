...
@:pythonImport("tensorflow.python.keras.layers.core", "SlicingOpLambda") extern class SlicingOpLambda {
	...
	**/
	...
	@:native("__init__")
	public function ___init__(_function:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	public function new(_function:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Void;
	/**
	...
	**/
	...
	public function _call_wrapper(?args:python.VarArgs<Dynamic>, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
