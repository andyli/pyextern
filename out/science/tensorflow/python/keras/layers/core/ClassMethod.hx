...
@:pythonImport("tensorflow.python.keras.layers.core", "ClassMethod") extern class ClassMethod {
	...
	**/
	...
	@:native("__init__")
	public function ___init__(cls_ref:Dynamic, method_name:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	public function new(cls_ref:Dynamic, method_name:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Void;
	/**
