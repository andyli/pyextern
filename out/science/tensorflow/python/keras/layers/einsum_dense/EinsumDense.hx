...
@:pythonImport("tensorflow.python.keras.layers.einsum_dense", "EinsumDense") extern class EinsumDense {
	...
	**/
	...
	@:native("__init__")
	public function ___init__(equation:Dynamic, output_shape:Dynamic, ?activation:Dynamic, ?bias_axes:Dynamic, ?kernel_initializer:Dynamic, ?bias_initializer:Dynamic, ?kernel_regularizer:Dynamic, ?bias_regularizer:Dynamic, ?activity_regularizer:Dynamic, ?kernel_constraint:Dynamic, ?bias_constraint:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	public function new(equation:Dynamic, output_shape:Dynamic, ?activation:Dynamic, ?bias_axes:Dynamic, ?kernel_initializer:Dynamic, ?bias_initializer:Dynamic, ?kernel_regularizer:Dynamic, ?bias_regularizer:Dynamic, ?activity_regularizer:Dynamic, ?kernel_constraint:Dynamic, ?bias_constraint:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Void;
	/**
	...
	**/
	public function compute_output_shape(_:Dynamic):Dynamic;
	/**
