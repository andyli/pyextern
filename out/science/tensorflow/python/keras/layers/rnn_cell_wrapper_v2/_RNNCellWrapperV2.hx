...
package tensorflow.python.keras.layers.rnn_cell_wrapper_v2;
@:pythonImport("tensorflow.python.keras.layers.rnn_cell_wrapper_v2", "_RNNCellWrapperV2") extern class _RNNCellWrapperV2 {
	...
	**/
	...
	@:native("__init__")
	public function ___init__(cell:Dynamic, ?args:python.VarArgs<Dynamic>, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	public function new(cell:Dynamic, ?args:python.VarArgs<Dynamic>, ?kwargs:python.KwArgs<Dynamic>):Void;
	/**
	...
	**/
	public function call(inputs:Dynamic, state:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
