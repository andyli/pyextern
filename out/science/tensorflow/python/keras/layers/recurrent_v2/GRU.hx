...
@:pythonImport("tensorflow.python.keras.layers.recurrent_v2", "GRU") extern class GRU {
	...
	**/
	...
	@:native("__init__")
	public function ___init__(units:Dynamic, ?activation:Dynamic, ?recurrent_activation:Dynamic, ?use_bias:Dynamic, ?kernel_initializer:Dynamic, ?recurrent_initializer:Dynamic, ?bias_initializer:Dynamic, ?kernel_regularizer:Dynamic, ?recurrent_regularizer:Dynamic, ?bias_regularizer:Dynamic, ?activity_regularizer:Dynamic, ?kernel_constraint:Dynamic, ?recurrent_constraint:Dynamic, ?bias_constraint:Dynamic, ?dropout:Dynamic, ?recurrent_dropout:Dynamic, ?return_sequences:Dynamic, ?return_state:Dynamic, ?go_backwards:Dynamic, ?stateful:Dynamic, ?unroll:Dynamic, ?time_major:Dynamic, ?reset_after:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	public function new(units:Dynamic, ?activation:Dynamic, ?recurrent_activation:Dynamic, ?use_bias:Dynamic, ?kernel_initializer:Dynamic, ?recurrent_initializer:Dynamic, ?bias_initializer:Dynamic, ?kernel_regularizer:Dynamic, ?recurrent_regularizer:Dynamic, ?bias_regularizer:Dynamic, ?activity_regularizer:Dynamic, ?kernel_constraint:Dynamic, ?recurrent_constraint:Dynamic, ?bias_constraint:Dynamic, ?dropout:Dynamic, ?recurrent_dropout:Dynamic, ?return_sequences:Dynamic, ?return_state:Dynamic, ?go_backwards:Dynamic, ?stateful:Dynamic, ?unroll:Dynamic, ?time_major:Dynamic, ?reset_after:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Void;
	/**
	...
	**/
	...
	public function _defun_gru_call(inputs:Dynamic, initial_state:Dynamic, training:Dynamic, mask:Dynamic, sequence_lengths:Dynamic):Dynamic;
	/**
	...
	**/
	...
	public var reset_after : Dynamic;
	/**
