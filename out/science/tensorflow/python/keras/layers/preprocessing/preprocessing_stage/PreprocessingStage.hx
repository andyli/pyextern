...
@:pythonImport("tensorflow.python.keras.layers.preprocessing.preprocessing_stage", "PreprocessingStage") extern class PreprocessingStage {
	...
	**/
	...
	public function _build_graph_network_for_inferred_shape(input_shape:Dynamic, ?input_dtype:Dynamic):Dynamic;
	...
	**/
	...
	public function _is_layer_name_unique(layer:Dynamic):Dynamic;
