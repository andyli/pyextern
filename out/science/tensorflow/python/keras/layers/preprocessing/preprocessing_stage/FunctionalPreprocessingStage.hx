...
@:pythonImport("tensorflow.python.keras.layers.preprocessing.preprocessing_stage", "FunctionalPreprocessingStage") extern class FunctionalPreprocessingStage {
	...
	**/
	...
	@:native("__init__")
	public function ___init__(inputs:Dynamic, outputs:Dynamic, ?name:Dynamic, ?trainable:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	public function new(inputs:Dynamic, outputs:Dynamic, ?name:Dynamic, ?trainable:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Void;
	/**
	...
	**/
	public function _compute_tensor_usage_count():Dynamic;
	...
	**/
	public function _conform_to_reference_input(tensor:Dynamic, ref_input:Dynamic):Dynamic;
	/**
	...
	**/
	public function _flatten_to_reference_inputs(tensors:Dynamic):Dynamic;
	...
	**/
	...
	public function _graph_network_add_loss(symbolic_loss:Dynamic):Dynamic;
	public function _graph_network_add_metric(value:Dynamic, aggregation:Dynamic, name:Dynamic):Dynamic;
	...
	**/
	public function _handle_deferred_layer_dependencies(layers:Dynamic):Dynamic;
	/**
	...
	**/
	...
	public function _init_graph_network(inputs:Dynamic, outputs:Dynamic):Dynamic;
	...
	**/
	public function _insert_layers(layers:Dynamic, ?relevant_nodes:Dynamic):Dynamic;
	...
	**/
	public var _layer_checkpoint_dependencies : Dynamic;
	/**
	...
	**/
	public function _set_output_names():Dynamic;
	...
	**/
	public function fit(?args:python.VarArgs<Dynamic>, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
