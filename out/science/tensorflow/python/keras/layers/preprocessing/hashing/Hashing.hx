...
package tensorflow.python.keras.layers.preprocessing.hashing;
@:pythonImport("tensorflow.python.keras.layers.preprocessing.hashing", "Hashing") extern class Hashing {
	...
	**/
	...
	@:native("__init__")
	public function ___init__(num_bins:Dynamic, ?mask_value:Dynamic, ?salt:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	public function new(num_bins:Dynamic, ?mask_value:Dynamic, ?salt:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Void;
	/**
	...
	**/
	public function _get_string_to_hash_bucket_fn():Dynamic;
	/**
	...
	**/
	public function _hash_values_to_bins(values:Dynamic):Dynamic;
	...
	**/
	...
	public function _preprocess_inputs(inputs:Dynamic):Dynamic;
	public function _preprocess_single_input(inp:Dynamic):Dynamic;
	/**
