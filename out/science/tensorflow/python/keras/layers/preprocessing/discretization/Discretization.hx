...
@:pythonImport("tensorflow.python.keras.layers.preprocessing.discretization", "Discretization") extern class Discretization {
	...
	**/
	...
	@:native("__init__")
	public function ___init__(?bin_boundaries:Dynamic, ?num_bins:Dynamic, ?epsilon:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	public function new(?bin_boundaries:Dynamic, ?num_bins:Dynamic, ?epsilon:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Void;
	/**
