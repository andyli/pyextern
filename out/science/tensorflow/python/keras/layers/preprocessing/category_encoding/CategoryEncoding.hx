...
@:pythonImport("tensorflow.python.keras.layers.preprocessing.category_encoding", "CategoryEncoding") extern class CategoryEncoding {
	...
	**/
	...
	@:native("__init__")
	public function ___init__(?num_tokens:Dynamic, ?output_mode:Dynamic, ?sparse:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	public function new(?num_tokens:Dynamic, ?output_mode:Dynamic, ?sparse:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Void;
	/**
	...
	**/
	public function call(inputs:Dynamic, ?count_weights:Dynamic):Dynamic;
	/**
