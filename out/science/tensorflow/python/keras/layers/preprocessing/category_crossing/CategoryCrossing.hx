...
package tensorflow.python.keras.layers.preprocessing.category_crossing;
@:pythonImport("tensorflow.python.keras.layers.preprocessing.category_crossing", "CategoryCrossing") extern class CategoryCrossing {
	...
	**/
	...
	@:native("__init__")
	public function ___init__(?depth:Dynamic, ?name:Dynamic, ?separator:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	public function new(?depth:Dynamic, ?name:Dynamic, ?separator:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Void;
	/**
	...
	**/
	...
	public function _preprocess_input(inp:Dynamic):Dynamic;
	/**
	...
	**/
	public function partial_crossing(partial_inputs:Dynamic, ragged_out:Dynamic, sparse_out:Dynamic):Dynamic;
	/**
