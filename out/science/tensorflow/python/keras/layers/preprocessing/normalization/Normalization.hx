...
package tensorflow.python.keras.layers.preprocessing.normalization;
@:pythonImport("tensorflow.python.keras.layers.preprocessing.normalization", "Normalization") extern class Normalization {
	...
	**/
	...
	@:native("__init__")
	public function ___init__(?axis:Dynamic, ?mean:Dynamic, ?variance:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	public function new(?axis:Dynamic, ?mean:Dynamic, ?variance:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Void;
	/**
	...
	**/
	...
	public function _convert_to_list(inputs:Dynamic):Dynamic;
	/**
	...
	**/
	...
	public function _standardize_inputs(inputs:Dynamic):Dynamic;
