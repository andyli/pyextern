...
package tensorflow.python.keras.layers.preprocessing.reduction;
@:pythonImport("tensorflow.python.keras.layers.preprocessing.reduction", "Reduction") extern class Reduction {
	...
	**/
	...
	@:native("__init__")
	public function ___init__(reduction:Dynamic, ?axis:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	public function new(reduction:Dynamic, ?axis:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Void;
	/**
	...
	**/
	public function call(inputs:Dynamic, ?weights:Dynamic):Dynamic;
	/**
