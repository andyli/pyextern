...
@:pythonImport("tensorflow.python.keras.layers.preprocessing.image_preprocessing", "RandomHeight") extern class RandomHeight {
	...
	**/
	...
	@:native("__init__")
	public function ___init__(factor:Dynamic, ?interpolation:Dynamic, ?seed:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	public function new(factor:Dynamic, ?interpolation:Dynamic, ?seed:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Void;
	/**
