...
@:pythonImport("tensorflow.python.keras.layers.preprocessing.image_preprocessing", "RandomContrast") extern class RandomContrast {
	...
	**/
	...
	@:native("__init__")
	public function ___init__(factor:Dynamic, ?seed:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	public function new(factor:Dynamic, ?seed:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Void;
	/**
