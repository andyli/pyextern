...
@:pythonImport("tensorflow.python.keras.layers.preprocessing.image_preprocessing", "RandomRotation") extern class RandomRotation {
	...
	**/
	...
	@:native("__init__")
	public function ___init__(factor:Dynamic, ?fill_mode:Dynamic, ?interpolation:Dynamic, ?seed:Dynamic, ?fill_value:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	public function new(factor:Dynamic, ?fill_mode:Dynamic, ?interpolation:Dynamic, ?seed:Dynamic, ?fill_value:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Void;
	/**
