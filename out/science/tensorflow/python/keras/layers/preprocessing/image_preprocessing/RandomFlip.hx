...
@:pythonImport("tensorflow.python.keras.layers.preprocessing.image_preprocessing", "RandomFlip") extern class RandomFlip {
	...
	**/
	...
	@:native("__init__")
	public function ___init__(?mode:Dynamic, ?seed:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	public function new(?mode:Dynamic, ?seed:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Void;
	/**
