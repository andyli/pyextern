...
@:pythonImport("tensorflow.python.keras.layers.preprocessing.image_preprocessing", "RandomTranslation") extern class RandomTranslation {
	...
	**/
	...
	@:native("__init__")
	public function ___init__(height_factor:Dynamic, width_factor:Dynamic, ?fill_mode:Dynamic, ?interpolation:Dynamic, ?seed:Dynamic, ?fill_value:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	public function new(height_factor:Dynamic, width_factor:Dynamic, ?fill_mode:Dynamic, ?interpolation:Dynamic, ?seed:Dynamic, ?fill_value:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Void;
	/**
