...
@:pythonImport("tensorflow.python.keras.layers.preprocessing.image_preprocessing", "Rescaling") extern class Rescaling {
	...
	**/
	...
	@:native("__init__")
	public function ___init__(scale:Dynamic, ?offset:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	public function new(scale:Dynamic, ?offset:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Void;
	/**
