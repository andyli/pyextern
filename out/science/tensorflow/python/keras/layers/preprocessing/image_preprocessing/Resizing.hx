...
@:pythonImport("tensorflow.python.keras.layers.preprocessing.image_preprocessing", "Resizing") extern class Resizing {
	...
	**/
	...
	@:native("__init__")
	public function ___init__(height:Dynamic, width:Dynamic, ?interpolation:Dynamic, ?crop_to_aspect_ratio:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	public function new(height:Dynamic, width:Dynamic, ?interpolation:Dynamic, ?crop_to_aspect_ratio:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Void;
	/**
