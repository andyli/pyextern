...
@:pythonImport("tensorflow.python.keras.layers.preprocessing.image_preprocessing", "CenterCrop") extern class CenterCrop {
	...
	**/
	...
	@:native("__init__")
	public function ___init__(height:Dynamic, width:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	public function new(height:Dynamic, width:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Void;
	/**
