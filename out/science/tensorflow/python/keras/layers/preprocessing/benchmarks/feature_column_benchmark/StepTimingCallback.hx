...
@:pythonImport("tensorflow.python.keras.layers.preprocessing.benchmarks.feature_column_benchmark", "StepTimingCallback") extern class StepTimingCallback {
	...
	/**
		...
		Args:
		    ...
		    logs: Dict, contains the return value of `model.predict_step`,
		      ...
		      the model's outputs.
	**/
	public function on_predict_batch_begin(batch_index:Dynamic, _:Dynamic):Dynamic;
	/**
	...
	/**
		...
		Args:
		    logs: Dict. Currently no data is passed to this argument for this method
		      but that may change in the future.
	**/
	public function on_predict_end(_:Dynamic):Dynamic;
	/**
