...
@:pythonImport("tensorflow.python.keras.layers.preprocessing.benchmarks.feature_column_benchmark", "LayerBenchmark") extern class LayerBenchmark {
	/**
	...
	**/
	public function report(name:Dynamic, keras_time:Dynamic, fc_time:Dynamic, iters:Dynamic):Dynamic;
	/**
		Report a benchmark.
