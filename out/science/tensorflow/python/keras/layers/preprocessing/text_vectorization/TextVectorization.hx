...
package tensorflow.python.keras.layers.preprocessing.text_vectorization;
@:pythonImport("tensorflow.python.keras.layers.preprocessing.text_vectorization", "TextVectorization") extern class TextVectorization {
	...
	**/
	...
	@:native("__init__")
	public function ___init__(?max_tokens:Dynamic, ?standardize:Dynamic, ?split:Dynamic, ?ngrams:Dynamic, ?output_mode:Dynamic, ?output_sequence_length:Dynamic, ?pad_to_max_tokens:Dynamic, ?vocabulary:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	public function new(?max_tokens:Dynamic, ?standardize:Dynamic, ?split:Dynamic, ?ngrams:Dynamic, ?output_mode:Dynamic, ?output_sequence_length:Dynamic, ?pad_to_max_tokens:Dynamic, ?vocabulary:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Void;
	/**
	...
	**/
	...
	public function _assert_same_type(expected_type:Dynamic, values:Dynamic, value_name:Dynamic):Dynamic;
	...
	**/
	...
	public function _preprocess(inputs:Dynamic):Dynamic;
	/**
