...
package tensorflow.python.keras.layers.preprocessing.integer_lookup;
@:pythonImport("tensorflow.python.keras.layers.preprocessing.integer_lookup", "IntegerLookup") extern class IntegerLookup {
	...
	**/
	...
	@:native("__init__")
	public function ___init__(?max_tokens:Dynamic, ?num_oov_indices:Dynamic, ?mask_token:Dynamic, ?oov_token:Dynamic, ?vocabulary:Dynamic, ?invert:Dynamic, ?output_mode:Dynamic, ?sparse:Dynamic, ?pad_to_max_tokens:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	public function new(?max_tokens:Dynamic, ?num_oov_indices:Dynamic, ?mask_token:Dynamic, ?oov_token:Dynamic, ?vocabulary:Dynamic, ?invert:Dynamic, ?output_mode:Dynamic, ?sparse:Dynamic, ?pad_to_max_tokens:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Void;
	/**
