...
package tensorflow.python.keras.layers.preprocessing.string_lookup;
@:pythonImport("tensorflow.python.keras.layers.preprocessing.string_lookup", "StringLookup") extern class StringLookup {
	...
	**/
	...
	@:native("__init__")
	public function ___init__(?max_tokens:Dynamic, ?num_oov_indices:Dynamic, ?mask_token:Dynamic, ?oov_token:Dynamic, ?vocabulary:Dynamic, ?encoding:Dynamic, ?invert:Dynamic, ?output_mode:Dynamic, ?sparse:Dynamic, ?pad_to_max_tokens:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	public function new(?max_tokens:Dynamic, ?num_oov_indices:Dynamic, ?mask_token:Dynamic, ?oov_token:Dynamic, ?vocabulary:Dynamic, ?encoding:Dynamic, ?invert:Dynamic, ?output_mode:Dynamic, ?sparse:Dynamic, ?pad_to_max_tokens:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Void;
	/**
	...
	**/
	...
	public function _adapt_maybe_build(data:Dynamic):Dynamic;
	/**
	...
	**/
	public function _add_state_variable(name:Dynamic, shape:Dynamic, dtype:Dynamic, ?initializer:Dynamic, ?partitioner:Dynamic, ?use_resource:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
	...
	**/
	...
	public function _convert_to_ndarray(x:Dynamic):Dynamic;
	/**
	...
	**/
	...
	public function _encode_output(lookup_result:Dynamic):Dynamic;
	/**
	...
	**/
	...
	public function _get_accumulator():Dynamic;
	...
	**/
	...
	public function _oov_start_index():Dynamic;
	...
	**/
	public function _reset_state_wrapper():Dynamic;
	/**
	...
	**/
	public function _restore_updates():Dynamic;
	/**
	...
	**/
	...
	public function _set_accumulator(accumulator:Dynamic):Dynamic;
	...
	**/
	public function _set_state_variables(updates:Dynamic):Dynamic;
	/**
	...
	**/
	public function _tensor_vocab_to_numpy(vocabulary:Dynamic):Dynamic;
	static public var _tf_api_names : Dynamic;
	static public var _tf_api_names_v1 : Dynamic;
	public function _token_start_index():Dynamic;
	/**
	...
	**/
	public function adapt(data:Dynamic, ?reset_state:Dynamic):Dynamic;
	/**
	...
	**/
	public function compile(?run_eagerly:Dynamic, ?steps_per_execution:Dynamic):Dynamic;
	/**
	...
	**/
	public function compute_output_signature(input_spec:Dynamic):Dynamic;
	/**
	...
	**/
	public function get_vocabulary(?include_special_tokens:Dynamic):Dynamic;
	/**
	...
	**/
	...
	/**
		...
		Returns:
		  ...
		  layer.
	**/
	public function make_adapt_function():Dynamic;
	/**
		...
		Arguments:
		  layers: Layers whose statistics should be merge with the statistics of
		    this layer.
	**/
	public function merge_state(layers:Dynamic):Dynamic;
	/**
	...
	**/
	public function set_vocabulary(vocabulary:Dynamic, ?idf_weights:Dynamic):Dynamic;
	/**
	...
	**/
	...
	public function update_state(data:Dynamic):Dynamic;
	...
	**/
	...
	public function vocab_size():Dynamic;
	/**
	...
	**/
	public function vocabulary_size():Dynamic;
	/**
		Returns the list of all layer variables/weights.
