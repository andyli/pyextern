...
@:pythonImport("tensorflow.python.keras.layers.preprocessing.index_lookup", "_NullInitializer") extern class _NullInitializer {
	...
	**/
	@:native("__init__")
	public function ___init__(key_dtype:Dynamic, value_dtype:Dynamic):Dynamic;
	/**
		Construct a table initializer object.
		...
		Args:
		  ...
		  value_dtype: Type of the table values.
	**/
	public function new(key_dtype:Dynamic, value_dtype:Dynamic):Void;
	/**
