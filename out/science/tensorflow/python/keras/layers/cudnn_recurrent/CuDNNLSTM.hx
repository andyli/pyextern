...
package tensorflow.python.keras.layers.cudnn_recurrent;
@:pythonImport("tensorflow.python.keras.layers.cudnn_recurrent", "CuDNNLSTM") extern class CuDNNLSTM {
	...
	**/
	...
	@:native("__init__")
	public function ___init__(units:Dynamic, ?kernel_initializer:Dynamic, ?recurrent_initializer:Dynamic, ?bias_initializer:Dynamic, ?unit_forget_bias:Dynamic, ?kernel_regularizer:Dynamic, ?recurrent_regularizer:Dynamic, ?bias_regularizer:Dynamic, ?activity_regularizer:Dynamic, ?kernel_constraint:Dynamic, ?recurrent_constraint:Dynamic, ?bias_constraint:Dynamic, ?return_sequences:Dynamic, ?return_state:Dynamic, ?go_backwards:Dynamic, ?stateful:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	...
	**/
	...
	public function _process_batch(inputs:Dynamic, initial_state:Dynamic):Dynamic;
