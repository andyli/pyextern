...
@:pythonImport("tensorflow.python.keras.layers.multi_head_attention", "MultiHeadAttention") extern class MultiHeadAttention {
	...
	**/
	...
	@:native("__init__")
	public function ___init__(num_heads:Dynamic, key_dim:Dynamic, ?value_dim:Dynamic, ?dropout:Dynamic, ?use_bias:Dynamic, ?output_shape:Dynamic, ?attention_axes:Dynamic, ?kernel_initializer:Dynamic, ?bias_initializer:Dynamic, ?kernel_regularizer:Dynamic, ?bias_regularizer:Dynamic, ?activity_regularizer:Dynamic, ?kernel_constraint:Dynamic, ?bias_constraint:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	public function new(num_heads:Dynamic, key_dim:Dynamic, ?value_dim:Dynamic, ?dropout:Dynamic, ?use_bias:Dynamic, ?output_shape:Dynamic, ?attention_axes:Dynamic, ?kernel_initializer:Dynamic, ?bias_initializer:Dynamic, ?kernel_regularizer:Dynamic, ?bias_regularizer:Dynamic, ?activity_regularizer:Dynamic, ?kernel_constraint:Dynamic, ?bias_constraint:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Void;
	/**
	...
	**/
	public function _build_attention(rank:Dynamic):Dynamic;
	/**
	...
	**/
	public function _build_from_signature(query:Dynamic, value:Dynamic, ?key:Dynamic):Dynamic;
	...
	**/
	public function _compute_attention(query:Dynamic, key:Dynamic, value:Dynamic, ?attention_mask:Dynamic, ?training:Dynamic):Dynamic;
	/**
	...
	**/
	...
	/**
		...
		Returns:
		  Projection layer.
	**/
	public function _make_output_dense(free_dims:Dynamic, common_kwargs:Dynamic, ?name:Dynamic):Dynamic;
	/**
	...
	**/
	...
	public function _masked_softmax(attention_scores:Dynamic, ?attention_mask:Dynamic):Dynamic;
	...
	**/
	public function call(query:Dynamic, value:Dynamic, ?key:Dynamic, ?attention_mask:Dynamic, ?return_attention_scores:Dynamic, ?training:Dynamic):Dynamic;
	/**
