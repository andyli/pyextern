...
@:pythonImport("tensorflow.python.keras.layers.merge", "Dot") extern class Dot {
	...
	**/
	@:native("__init__")
	public function ___init__(axes:Dynamic, ?normalize:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
		Initializes a layer that computes the element-wise dot product.
		...
		Args:
		  ...
		  **kwargs: Standard layer keyword arguments.
	**/
	public function new(axes:Dynamic, ?normalize:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Void;
	/**
	...
	**/
	public function _compute_elemwise_op_output_shape(shape1:Dynamic, shape2:Dynamic):Dynamic;
	/**
	...
	**/
	...
	public function _merge_function(inputs:Dynamic):Dynamic;
