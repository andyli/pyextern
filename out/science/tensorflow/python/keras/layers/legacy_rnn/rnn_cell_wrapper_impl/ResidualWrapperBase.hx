...
@:pythonImport("tensorflow.python.keras.layers.legacy_rnn.rnn_cell_wrapper_impl", "ResidualWrapperBase") extern class ResidualWrapperBase {
	...
	**/
	@:native("__init__")
	public function ___init__(cell:Dynamic, ?residual_fn:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
		Constructs a `ResidualWrapper` for `cell`.
		...
		Args:
		  ...
		  **kwargs: dict of keyword arguments for base layer.
	**/
	public function new(cell:Dynamic, ?residual_fn:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Void;
	/**
