...
@:pythonImport("tensorflow.python.keras.layers.legacy_rnn.rnn_cell_impl", "BasicRNNCell") extern class BasicRNNCell {
	...
	**/
	...
	@:native("__init__")
	public function ___init__(num_units:Dynamic, ?activation:Dynamic, ?reuse:Dynamic, ?name:Dynamic, ?dtype:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	public function new(num_units:Dynamic, ?activation:Dynamic, ?reuse:Dynamic, ?name:Dynamic, ?dtype:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Void;
	/**
