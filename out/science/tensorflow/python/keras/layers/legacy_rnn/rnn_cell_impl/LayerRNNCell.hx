...
@:pythonImport("tensorflow.python.keras.layers.legacy_rnn.rnn_cell_impl", "LayerRNNCell") extern class LayerRNNCell {
	...
	**/
	...
	@:native("__init__")
	public function ___init__(?trainable:Dynamic, ?name:Dynamic, ?dtype:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	public function new(?trainable:Dynamic, ?name:Dynamic, ?dtype:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Void;
	/**
