...
@:pythonImport("tensorflow.python.keras.layers.legacy_rnn.rnn_cell_impl", "LSTMStateTuple") extern class LSTMStateTuple {
	/**
		Return self+value.
	**/
	...
	**/
	static public function __new__(_cls:Dynamic, c:Dynamic, h:Dynamic):Dynamic;
	/**
		Helper for pickle.
	**/
