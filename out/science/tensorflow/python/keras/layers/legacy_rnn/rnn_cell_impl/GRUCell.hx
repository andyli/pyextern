...
@:pythonImport("tensorflow.python.keras.layers.legacy_rnn.rnn_cell_impl", "GRUCell") extern class GRUCell {
	...
	**/
	...
	@:native("__init__")
	public function ___init__(num_units:Dynamic, ?activation:Dynamic, ?reuse:Dynamic, ?kernel_initializer:Dynamic, ?bias_initializer:Dynamic, ?name:Dynamic, ?dtype:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	public function new(num_units:Dynamic, ?activation:Dynamic, ?reuse:Dynamic, ?kernel_initializer:Dynamic, ?bias_initializer:Dynamic, ?name:Dynamic, ?dtype:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Void;
	/**
