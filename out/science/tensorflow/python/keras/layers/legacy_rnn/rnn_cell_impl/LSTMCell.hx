...
@:pythonImport("tensorflow.python.keras.layers.legacy_rnn.rnn_cell_impl", "LSTMCell") extern class LSTMCell {
	...
	**/
	@:native("__init__")
	public function ___init__(num_units:Dynamic, ?use_peepholes:Dynamic, ?cell_clip:Dynamic, ?initializer:Dynamic, ?num_proj:Dynamic, ?proj_clip:Dynamic, ?num_unit_shards:Dynamic, ?num_proj_shards:Dynamic, ?forget_bias:Dynamic, ?state_is_tuple:Dynamic, ?activation:Dynamic, ?reuse:Dynamic, ?name:Dynamic, ?dtype:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
		Initialize the parameters for an LSTM cell.
		...
		Args:
		  ...
		  **kwargs: Dict, keyword named properties for common layer attributes, like
		    ...
		    `CudnnCompatibleLSTMCell` instead.
	**/
	public function new(num_units:Dynamic, ?use_peepholes:Dynamic, ?cell_clip:Dynamic, ?initializer:Dynamic, ?num_proj:Dynamic, ?proj_clip:Dynamic, ?num_unit_shards:Dynamic, ?num_proj_shards:Dynamic, ?forget_bias:Dynamic, ?state_is_tuple:Dynamic, ?activation:Dynamic, ?reuse:Dynamic, ?name:Dynamic, ?dtype:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Void;
	/**
