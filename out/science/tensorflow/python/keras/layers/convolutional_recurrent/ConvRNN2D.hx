...
@:pythonImport("tensorflow.python.keras.layers.convolutional_recurrent", "ConvRNN2D") extern class ConvRNN2D {
	...
	**/
	...
	@:native("__init__")
	public function ___init__(cell:Dynamic, ?return_sequences:Dynamic, ?return_state:Dynamic, ?go_backwards:Dynamic, ?stateful:Dynamic, ?unroll:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	public function new(cell:Dynamic, ?return_sequences:Dynamic, ?return_state:Dynamic, ?go_backwards:Dynamic, ?stateful:Dynamic, ?unroll:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Void;
	/**
	...
	**/
	public function call(inputs:Dynamic, ?mask:Dynamic, ?training:Dynamic, ?initial_state:Dynamic, ?constants:Dynamic):Dynamic;
	/**
