...
@:pythonImport("tensorflow.python.keras.layers.convolutional_recurrent", "ConvLSTM2D") extern class ConvLSTM2D {
	...
	**/
	...
	@:native("__init__")
	public function ___init__(filters:Dynamic, kernel_size:Dynamic, ?strides:Dynamic, ?padding:Dynamic, ?data_format:Dynamic, ?dilation_rate:Dynamic, ?activation:Dynamic, ?recurrent_activation:Dynamic, ?use_bias:Dynamic, ?kernel_initializer:Dynamic, ?recurrent_initializer:Dynamic, ?bias_initializer:Dynamic, ?unit_forget_bias:Dynamic, ?kernel_regularizer:Dynamic, ?recurrent_regularizer:Dynamic, ?bias_regularizer:Dynamic, ?activity_regularizer:Dynamic, ?kernel_constraint:Dynamic, ?recurrent_constraint:Dynamic, ?bias_constraint:Dynamic, ?return_sequences:Dynamic, ?return_state:Dynamic, ?go_backwards:Dynamic, ?stateful:Dynamic, ?dropout:Dynamic, ?recurrent_dropout:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	public function new(filters:Dynamic, kernel_size:Dynamic, ?strides:Dynamic, ?padding:Dynamic, ?data_format:Dynamic, ?dilation_rate:Dynamic, ?activation:Dynamic, ?recurrent_activation:Dynamic, ?use_bias:Dynamic, ?kernel_initializer:Dynamic, ?recurrent_initializer:Dynamic, ?bias_initializer:Dynamic, ?unit_forget_bias:Dynamic, ?kernel_regularizer:Dynamic, ?recurrent_regularizer:Dynamic, ?bias_regularizer:Dynamic, ?activity_regularizer:Dynamic, ?kernel_constraint:Dynamic, ?recurrent_constraint:Dynamic, ?bias_constraint:Dynamic, ?return_sequences:Dynamic, ?return_state:Dynamic, ?go_backwards:Dynamic, ?stateful:Dynamic, ?dropout:Dynamic, ?recurrent_dropout:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Void;
	/**
	...
	**/
	...
	public function _maybe_reset_cell_dropout_mask(cell:Dynamic):Dynamic;
	...
	**/
	...
	public function _process_inputs(inputs:Dynamic, initial_state:Dynamic, constants:Dynamic):Dynamic;
	/**
	...
	**/
	...
	public function _validate_args_if_ragged(is_ragged_input:Dynamic, mask:Dynamic):Dynamic;
	/**
	...
	**/
	static public function _validate_state_spec(cell_state_sizes:Dynamic, init_state_specs:Dynamic):Dynamic;
	...
	**/
	public function call(inputs:Dynamic, ?mask:Dynamic, ?training:Dynamic, ?initial_state:Dynamic):Dynamic;
	/**
	...
	**/
	...
	static public function compute_output_shape(instance:Dynamic, input_shape:Dynamic):Dynamic;
	/**
