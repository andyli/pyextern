...
@:pythonImport("tensorflow.python.keras.layers.dense_attention", "AdditiveAttention") extern class AdditiveAttention {
	...
	**/
	...
	@:native("__init__")
	public function ___init__(?use_scale:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	public function new(?use_scale:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Void;
	/**
