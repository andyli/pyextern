...
package tensorflow.python.keras.layers.dense_attention;
@:pythonImport("tensorflow.python.keras.layers.dense_attention", "BaseDenseAttention") extern class BaseDenseAttention {
	...
	**/
	...
	@:native("__init__")
	public function ___init__(?causal:Dynamic, ?dropout:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	public function new(?causal:Dynamic, ?dropout:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Void;
	/**
		...
		* Apply `query_mask` and return the result.
		...
		Returns:
		  ...
		  Attention scores after masking and softmax with shape
		    `[batch_size, Tq, Tv]`.
	**/
	public function _apply_scores(scores:Dynamic, value:Dynamic, ?scores_mask:Dynamic, ?training:Dynamic):Dynamic;
	...
	**/
	public function _calculate_scores(query:Dynamic, key:Dynamic):Dynamic;
	...
	**/
	public function _validate_call_args(inputs:Dynamic, mask:Dynamic):Dynamic;
	/**
	...
	**/
	public function call(inputs:Dynamic, ?mask:Dynamic, ?training:Dynamic, ?return_attention_scores:Dynamic):Dynamic;
	/**
