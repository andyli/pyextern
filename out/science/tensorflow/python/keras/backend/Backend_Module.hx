...
@:pythonImport("tensorflow.python.keras.backend") extern class Backend_Module {
	static public var OBSERVED_NAMES : Dynamic;
	static public var PER_GRAPH_OBJECT_NAME_UIDS : Dynamic;
	static public var _CURRENT_SCRATCH_GRAPH : Dynamic;
	...
	static public var _VALUE_SET_CODE_STRING : Dynamic;
	...
	**/
	...
	static public var _config : Dynamic;
	static public var _config_path : Dynamic;
	/**
		...
		Returns:
		    A tensor.
	**/
	static public function _constant_to_tensor(x:Dynamic, dtype:Dynamic):Dynamic;
	/**
	...
	**/
	static public function _current_graph(op_input_list:Dynamic, ?graph:Dynamic):Dynamic;
	static public function _default_learning_phase():Dynamic;
	/**
	...
	**/
	static public function _get_session(?op_input_list:Dynamic):Dynamic;
	/**
	...
	**/
	static public function _initialize_variables(session:Dynamic):Dynamic;
	/**
	...
	**/
	...
	static public function _is_tpu_strategy_class(clz:Dynamic):Dynamic;
	static public var _keras_base_dir : Dynamic;
	static public var _keras_dir : Dynamic;
	/**
	...
	**/
	static public function _mark_func_graph_as_unsaveable(graph:Dynamic, learning_phase:Dynamic):Dynamic;
	/**
	...
	**/
	static public function _scratch_graph(?graph:Dynamic):Dynamic;
	/**
		Convert the input `x` to a tensor of type `dtype`.
	...
	**/
	...
	static public function cast_variables_to_tensor(tensors:Dynamic):Dynamic;
	/**
	...
	**/
	static public function configure_and_create_distributed_session(distribution_strategy:Dynamic):Dynamic;
	/**
	...
	**/
	static public function convert_inputs_if_ragged(inputs:Dynamic):Dynamic;
	/**
	...
	**/
	static public function deprecated_internal_learning_phase_scope(value:Dynamic):Dynamic;
	/**
		...
		Raises:
		    ValueError: if `value` is neither `0` nor `1`.
	**/
	static public function deprecated_internal_set_learning_phase(value:Dynamic):Dynamic;
	/**
	...
	**/
	static public function dtype_numpy(x:Dynamic):Dynamic;
	/**
		...
		Raises:
		   ValueError: if `value` is neither `0` nor `1`.
	**/
	static public function eager_learning_phase_scope(value:Dynamic):Dynamic;
	/**
	...
	**/
	...
	static public function global_learning_phase_is_set():Dynamic;
	/**
	...
	**/
	static public function local_conv(inputs:Dynamic, kernel:Dynamic, kernel_size:Dynamic, strides:Dynamic, output_shape:Dynamic, ?data_format:Dynamic):Dynamic;
	/**
	...
	**/
	static public function maybe_convert_to_ragged(is_ragged_input:Dynamic, output:Dynamic, nested_row_lengths:Dynamic, ?go_backwards:Dynamic):Dynamic;
	/**
	...
	**/
	static public function observe_object_name(name:Dynamic):Dynamic;
	/**
	...
	**/
	static public function track_tf_optimizer(tf_optimizer:Dynamic):Dynamic;
	/**
		Tracks the given variable for initialization.
	**/
	static public function track_variable(v:Dynamic):Dynamic;
	/**
	...
	**/
	static public function unique_object_name(name:Dynamic, ?name_uid_map:Dynamic, ?avoid_names:Dynamic, ?namespace:Dynamic, ?zero_based:Dynamic, ?avoid_observed_names:Dynamic):Dynamic;
