...
@:pythonImport("tensorflow.python.keras.callbacks", "ProgbarLogger") extern class ProgbarLogger {
	...
	**/
	@:native("__init__")
	public function ___init__(?count_mode:Dynamic, ?stateful_metrics:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(?count_mode:Dynamic, ?stateful_metrics:Dynamic):Void;
	/**
	...
	**/
	...
	/**
		Updates the progbar.
	**/
	public function _batch_update_progbar(batch:Dynamic, ?logs:Dynamic):Dynamic;
	public function _finalize_progbar(logs:Dynamic, counter:Dynamic):Dynamic;
	/**
	...
	**/
	public function _maybe_init_progbar():Dynamic;
	public function _reset_progbar():Dynamic;
	/**
