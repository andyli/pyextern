...
@:pythonImport("tensorflow.python.keras.callbacks", "TensorBoard") extern class TensorBoard {
	...
	**/
	@:native("__init__")
	public function ___init__(?log_dir:Dynamic, ?histogram_freq:Dynamic, ?write_graph:Dynamic, ?write_images:Dynamic, ?write_steps_per_second:Dynamic, ?update_freq:Dynamic, ?profile_batch:Dynamic, ?embeddings_freq:Dynamic, ?embeddings_metadata:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(?log_dir:Dynamic, ?histogram_freq:Dynamic, ?write_graph:Dynamic, ?write_images:Dynamic, ?write_steps_per_second:Dynamic, ?update_freq:Dynamic, ?profile_batch:Dynamic, ?embeddings_freq:Dynamic, ?embeddings_metadata:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Void;
	/**
	...
	**/
	public function _start_profiler(logdir:Dynamic):Dynamic;
	...
	**/
	public function _stop_profiler(?save:Dynamic):Dynamic;
	/**
