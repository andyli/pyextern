...
@:pythonImport("tensorflow.python.keras.callbacks", "EarlyStopping") extern class EarlyStopping {
	...
	**/
	...
	public function _is_improvement(monitor_value:Dynamic, reference_value:Dynamic):Dynamic;
