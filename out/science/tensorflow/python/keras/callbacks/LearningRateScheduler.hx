...
@:pythonImport("tensorflow.python.keras.callbacks", "LearningRateScheduler") extern class LearningRateScheduler {
	...
	**/
	@:native("__init__")
	public function ___init__(schedule:Dynamic, ?verbose:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(schedule:Dynamic, ?verbose:Dynamic):Void;
	/**
