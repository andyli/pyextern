...
@:pythonImport("tensorflow.python.keras.callbacks", "ModelCheckpoint") extern class ModelCheckpoint {
	...
	**/
	@:native("__init__")
	public function ___init__(filepath:Dynamic, ?monitor:Dynamic, ?verbose:Dynamic, ?save_best_only:Dynamic, ?save_weights_only:Dynamic, ?mode:Dynamic, ?save_freq:Dynamic, ?options:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(filepath:Dynamic, ?monitor:Dynamic, ?verbose:Dynamic, ?save_best_only:Dynamic, ?save_weights_only:Dynamic, ?mode:Dynamic, ?save_freq:Dynamic, ?options:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Void;
	/**
	...
	**/
	public function _checkpoint_exists(filepath:Dynamic):Dynamic;
	/**
		Returns the file path for checkpoint.
	**/
	public function _get_file_path(epoch:Dynamic, logs:Dynamic):Dynamic;
	/**
	...
	**/
	public function _get_most_recently_modified_file_matching_pattern(pattern:Dynamic):Dynamic;
	/**
	...
	**/
	...
	public function _maybe_remove_file():Dynamic;
	/**
		Saves the model.
	...
	**/
	public function _save_model(epoch:Dynamic, logs:Dynamic):Dynamic;
	/**
		Handles batch-level saving logic, supports steps_per_execution.
	**/
	public function _should_save_on_batch(batch:Dynamic):Dynamic;
	/**
