...
@:pythonImport("tensorflow.python.keras.callbacks", "BaseLogger") extern class BaseLogger {
	...
	**/
	@:native("__init__")
	public function ___init__(?stateful_metrics:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(?stateful_metrics:Dynamic):Void;
	/**
