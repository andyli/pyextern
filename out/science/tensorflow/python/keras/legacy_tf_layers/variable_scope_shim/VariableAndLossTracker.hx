...
@:pythonImport("tensorflow.python.keras.legacy_tf_layers.variable_scope_shim", "VariableAndLossTracker") extern class VariableAndLossTracker {
	...
	**/
	...
	public function _variable_creator(next_creator:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	public function get_regularization_losses():Dynamic;
	/**
