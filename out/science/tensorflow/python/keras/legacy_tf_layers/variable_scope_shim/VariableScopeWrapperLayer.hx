...
@:pythonImport("tensorflow.python.keras.legacy_tf_layers.variable_scope_shim", "VariableScopeWrapperLayer") extern class VariableScopeWrapperLayer {
	...
	**/
	...
	public function forward_pass(?args:python.VarArgs<Dynamic>, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
