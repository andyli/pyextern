...
package tensorflow.python.keras.legacy_tf_layers.convolutional;
@:pythonImport("tensorflow.python.keras.legacy_tf_layers.convolutional", "SeparableConv2D") extern class SeparableConv2D {
	...
	**/
	...
	@:native("__init__")
	public function ___init__(filters:Dynamic, kernel_size:Dynamic, ?strides:Dynamic, ?padding:Dynamic, ?data_format:Dynamic, ?dilation_rate:Dynamic, ?depth_multiplier:Dynamic, ?activation:Dynamic, ?use_bias:Dynamic, ?depthwise_initializer:Dynamic, ?pointwise_initializer:Dynamic, ?bias_initializer:Dynamic, ?depthwise_regularizer:Dynamic, ?pointwise_regularizer:Dynamic, ?bias_regularizer:Dynamic, ?activity_regularizer:Dynamic, ?depthwise_constraint:Dynamic, ?pointwise_constraint:Dynamic, ?bias_constraint:Dynamic, ?trainable:Dynamic, ?name:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	public function new(filters:Dynamic, kernel_size:Dynamic, ?strides:Dynamic, ?padding:Dynamic, ?data_format:Dynamic, ?dilation_rate:Dynamic, ?depth_multiplier:Dynamic, ?activation:Dynamic, ?use_bias:Dynamic, ?depthwise_initializer:Dynamic, ?pointwise_initializer:Dynamic, ?bias_initializer:Dynamic, ?depthwise_regularizer:Dynamic, ?pointwise_regularizer:Dynamic, ?bias_regularizer:Dynamic, ?activity_regularizer:Dynamic, ?depthwise_constraint:Dynamic, ?pointwise_constraint:Dynamic, ?bias_constraint:Dynamic, ?trainable:Dynamic, ?name:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Void;
	/**
	...
	**/
	public function _compute_causal_padding(inputs:Dynamic):Dynamic;
	/**
	...
	**/
	...
	public function _get_channel_axis():Dynamic;
	public function _get_existing_metric(?name:Dynamic):Dynamic;
	public function _get_input_channel(input_shape:Dynamic):Dynamic;
	...
	**/
	...
	public function _get_padding_op():Dynamic;
	...
	**/
	...
	public function _recreate_conv_op(inputs:Dynamic):Dynamic;
	/**
	...
	**/
	...
	public function _spatial_output_shape(spatial_input_shape:Dynamic):Dynamic;
	...
	**/
	...
	public function _validate_init():Dynamic;
	/**
