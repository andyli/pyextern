...
package tensorflow.python.keras.legacy_tf_layers.pooling;
@:pythonImport("tensorflow.python.keras.legacy_tf_layers.pooling", "AveragePooling1D") extern class AveragePooling1D {
	...
	**/
	...
	@:native("__init__")
	public function ___init__(pool_size:Dynamic, strides:Dynamic, ?padding:Dynamic, ?data_format:Dynamic, ?name:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	public function new(pool_size:Dynamic, strides:Dynamic, ?padding:Dynamic, ?data_format:Dynamic, ?name:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Void;
	/**
