...
@:pythonImport("tensorflow.python.keras.saving.saved_model.json_utils", "Encoder") extern class Encoder {
	...
	**/
	@:native("default")
	public function _default(obj:Dynamic):Dynamic;
	/**
		...
		'{"foo": ["bar", "baz"]}'
	**/
	public function encode(obj:Dynamic):Dynamic;
