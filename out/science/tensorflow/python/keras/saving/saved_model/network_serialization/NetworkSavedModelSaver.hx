...
package tensorflow.python.keras.saving.saved_model.network_serialization;
@:pythonImport("tensorflow.python.keras.saving.saved_model.network_serialization", "NetworkSavedModelSaver") extern class NetworkSavedModelSaver {
