...
package tensorflow.python.keras.saving.saved_model.model_serialization;
@:pythonImport("tensorflow.python.keras.saving.saved_model.model_serialization", "SequentialSavedModelSaver") extern class SequentialSavedModelSaver {
