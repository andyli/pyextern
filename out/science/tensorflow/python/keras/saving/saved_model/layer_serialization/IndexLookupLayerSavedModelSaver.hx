...
@:pythonImport("tensorflow.python.keras.saving.saved_model.layer_serialization", "IndexLookupLayerSavedModelSaver") extern class IndexLookupLayerSavedModelSaver {
