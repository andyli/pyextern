...
package tensorflow.python.keras.saving.saved_model.base_serialization;
@:pythonImport("tensorflow.python.keras.saving.saved_model.base_serialization", "SavedModelSaver") extern class SavedModelSaver {
