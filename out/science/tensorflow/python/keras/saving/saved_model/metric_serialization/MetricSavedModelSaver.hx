...
package tensorflow.python.keras.saving.saved_model.metric_serialization;
@:pythonImport("tensorflow.python.keras.saving.saved_model.metric_serialization", "MetricSavedModelSaver") extern class MetricSavedModelSaver {
	...
	**/
	public function _get_serialized_attributes_internal(unused_serialization_cache:Dynamic):Dynamic;
	/**
