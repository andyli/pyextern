...
package tensorflow.python.keras.api.keras.preprocessing.image;
@:pythonImport("tensorflow.python.keras.api.keras.preprocessing.image") extern class Image_Module {
