...
package tensorflow.python.keras.api.keras.applications.imagenet_utils;
@:pythonImport("tensorflow.python.keras.api.keras.applications.imagenet_utils") extern class Imagenet_utils_Module {
