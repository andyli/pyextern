...
package tensorflow.python.keras.api.keras.applications.resnet_v2;
@:pythonImport("tensorflow.python.keras.api.keras.applications.resnet_v2") extern class Resnet_v2_Module {
	/**
