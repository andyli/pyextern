...
package tensorflow.python.keras.api.keras.applications.nasnet;
@:pythonImport("tensorflow.python.keras.api.keras.applications.nasnet") extern class Nasnet_Module {
	/**
