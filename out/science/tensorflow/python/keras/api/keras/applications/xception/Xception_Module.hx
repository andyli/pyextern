...
package tensorflow.python.keras.api.keras.applications.xception;
@:pythonImport("tensorflow.python.keras.api.keras.applications.xception") extern class Xception_Module {
	/**
