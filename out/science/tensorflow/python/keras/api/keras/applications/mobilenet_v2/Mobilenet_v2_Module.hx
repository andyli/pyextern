...
package tensorflow.python.keras.api.keras.applications.mobilenet_v2;
@:pythonImport("tensorflow.python.keras.api.keras.applications.mobilenet_v2") extern class Mobilenet_v2_Module {
	/**
