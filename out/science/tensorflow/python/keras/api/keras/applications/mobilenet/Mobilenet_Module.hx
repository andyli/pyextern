...
package tensorflow.python.keras.api.keras.applications.mobilenet;
@:pythonImport("tensorflow.python.keras.api.keras.applications.mobilenet") extern class Mobilenet_Module {
	/**
