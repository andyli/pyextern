...
package tensorflow.python.keras.api.keras.applications.inception_resnet_v2;
@:pythonImport("tensorflow.python.keras.api.keras.applications.inception_resnet_v2") extern class Inception_resnet_v2_Module {
	/**
