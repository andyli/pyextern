...
package tensorflow.python.keras.api.keras.applications.resnet;
@:pythonImport("tensorflow.python.keras.api.keras.applications.resnet") extern class Resnet_Module {
	/**
