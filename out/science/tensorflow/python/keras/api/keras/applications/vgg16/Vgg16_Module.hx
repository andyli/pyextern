...
package tensorflow.python.keras.api.keras.applications.vgg16;
@:pythonImport("tensorflow.python.keras.api.keras.applications.vgg16") extern class Vgg16_Module {
	/**
