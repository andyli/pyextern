...
package tensorflow.python.keras.api.keras.applications.efficientnet;
@:pythonImport("tensorflow.python.keras.api.keras.applications.efficientnet") extern class Efficientnet_Module {
	/**
