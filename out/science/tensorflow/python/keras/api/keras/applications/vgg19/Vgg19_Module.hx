...
package tensorflow.python.keras.api.keras.applications.vgg19;
@:pythonImport("tensorflow.python.keras.api.keras.applications.vgg19") extern class Vgg19_Module {
	/**
