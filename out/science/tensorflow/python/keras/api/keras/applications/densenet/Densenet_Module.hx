...
package tensorflow.python.keras.api.keras.applications.densenet;
@:pythonImport("tensorflow.python.keras.api.keras.applications.densenet") extern class Densenet_Module {
	/**
