...
package tensorflow.python.keras.api.keras.applications.mobilenet_v3;
@:pythonImport("tensorflow.python.keras.api.keras.applications.mobilenet_v3") extern class Mobilenet_v3_Module {
