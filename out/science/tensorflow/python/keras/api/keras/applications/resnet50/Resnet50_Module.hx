...
package tensorflow.python.keras.api.keras.applications.resnet50;
@:pythonImport("tensorflow.python.keras.api.keras.applications.resnet50") extern class Resnet50_Module {
	/**
