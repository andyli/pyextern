...
package tensorflow.python.keras.api.keras.applications.inception_v3;
@:pythonImport("tensorflow.python.keras.api.keras.applications.inception_v3") extern class Inception_v3_Module {
	/**
