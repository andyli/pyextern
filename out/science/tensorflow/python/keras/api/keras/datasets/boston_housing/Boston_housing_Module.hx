...
package tensorflow.python.keras.api.keras.datasets.boston_housing;
@:pythonImport("tensorflow.python.keras.api.keras.datasets.boston_housing") extern class Boston_housing_Module {
