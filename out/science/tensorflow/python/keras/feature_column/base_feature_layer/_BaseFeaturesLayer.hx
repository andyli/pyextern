...
@:pythonImport("tensorflow.python.keras.feature_column.base_feature_layer", "_BaseFeaturesLayer") extern class _BaseFeaturesLayer {
	...
	**/
	...
	@:native("__init__")
	public function ___init__(feature_columns:Dynamic, expected_column_type:Dynamic, trainable:Dynamic, name:Dynamic, ?partitioner:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	public function new(feature_columns:Dynamic, expected_column_type:Dynamic, trainable:Dynamic, name:Dynamic, ?partitioner:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Void;
	/**
