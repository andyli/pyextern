...
package tensorflow.python.keras.feature_column.dense_features;
@:pythonImport("tensorflow.python.keras.feature_column.dense_features", "DenseFeatures") extern class DenseFeatures {
	...
	**/
	@:native("__init__")
	public function ___init__(feature_columns:Dynamic, ?trainable:Dynamic, ?name:Dynamic, ?partitioner:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
		Constructs a DenseFeatures layer.
		...
		Raises:
		  ValueError: if an item in `feature_columns` is not a `DenseColumn`.
	**/
	public function new(feature_columns:Dynamic, ?trainable:Dynamic, ?name:Dynamic, ?partitioner:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Void;
	/**
	...
	**/
	...
	public var _is_feature_layer : Dynamic;
	...
	**/
	public function _output_shape(input_shape:Dynamic, num_elements:Dynamic):Dynamic;
	/**
	...
	**/
	public function _process_dense_tensor(column:Dynamic, tensor:Dynamic):Dynamic;
	/**
	...
	**/
	...
	public function _target_shape(input_shape:Dynamic, total_elements:Dynamic):Dynamic;
	...
	**/
	public function _verify_and_concat_tensors(output_tensors:Dynamic):Dynamic;
	/**
	...
	**/
	public function call(features:Dynamic, ?cols_to_output_tensors:Dynamic, ?training:Dynamic):Dynamic;
	/**
