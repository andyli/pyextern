...
package tensorflow.python.keras.feature_column.sequence_feature_column;
@:pythonImport("tensorflow.python.keras.feature_column.sequence_feature_column", "SequenceFeatures") extern class SequenceFeatures {
	...
	**/
	@:native("__init__")
	public function ___init__(feature_columns:Dynamic, ?trainable:Dynamic, ?name:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
		"Constructs a SequenceFeatures layer.
		...
		Raises:
		  ValueError: If any of the `feature_columns` is not a
		    `SequenceDenseColumn`.
	**/
	public function new(feature_columns:Dynamic, ?trainable:Dynamic, ?name:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Void;
	/**
	...
	**/
	public function call(features:Dynamic, ?training:Dynamic):Dynamic;
	/**
