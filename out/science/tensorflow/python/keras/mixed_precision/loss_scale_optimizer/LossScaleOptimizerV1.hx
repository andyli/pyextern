...
@:pythonImport("tensorflow.python.keras.mixed_precision.loss_scale_optimizer", "LossScaleOptimizerV1") extern class LossScaleOptimizerV1 {
	...
	**/
	@:native("__init__")
	public function ___init__(optimizer:Dynamic, loss_scale:Dynamic):Dynamic;
	/**
		Create a new Optimizer.
		...
		Raises:
		  ValueError: in case of any invalid argument.
	**/
	public function new(optimizer:Dynamic, loss_scale:Dynamic):Void;
	/**
