...
@:pythonImport("tensorflow.python.keras.mixed_precision.loss_scale_optimizer", "_DynamicLossScaleState") extern class _DynamicLossScaleState {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(initial_loss_scale:Dynamic, growth_steps:Dynamic, multiplier:Dynamic):Dynamic;
	/**
		Creates the dynamic loss scale.
	**/
	public function new(initial_loss_scale:Dynamic, growth_steps:Dynamic, multiplier:Dynamic):Void;
	/**
	...
	**/
	public function _add_weight(name:Dynamic, initial_value:Dynamic, ?dtype:Dynamic):Dynamic;
	/**
	...
	**/
	public var counter : Dynamic;
	/**
		Returns the current loss scale as a float32 `tf.Variable`.
	**/
	public var current_loss_scale : Dynamic;
	public var growth_steps : Dynamic;
	public var initial_loss_scale : Dynamic;
	...
	/**
		...
		Returns:
		  ...
		  should_apply_gradients: Either a bool or a scalar boolean tensor. If
		    ...
		    step.
	**/
	public function update(grads:Dynamic):Dynamic;
}