...
@:pythonImport("tensorflow.python.keras.mixed_precision.autocast_variable", "AutoCastVariable") extern class AutoCastVariable {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(variable:Dynamic):Dynamic;
	/**
		Creates an AutoCastVariable instance.
		...
		Raises:
		  ValueError: If `variable` is not a floating-point resource variable
	**/
	public function new(variable:Dynamic):Void;
	/**
	...
	**/
	...
	public function _apply_assign_update(update_fn:Dynamic, value:Dynamic, ?use_locking:Dynamic, ?name:Dynamic, ?read_value:Dynamic):Dynamic;
	public function _apply_update(update_fn:Dynamic, ?args:python.VarArgs<Dynamic>, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	public function _as_graph_element():Dynamic;
	public var _cast_dtype : Dynamic;
	/**
	...
	**/
	...
	public var _handle_name : Dynamic;
	public var _initializer_op : Dynamic;
	/**
	...
	**/
	public function _should_cast():Dynamic;
	/**
	...
	**/
	public function from_proto(variable_def:Dynamic, ?import_scope:Dynamic):Dynamic;
	/**
