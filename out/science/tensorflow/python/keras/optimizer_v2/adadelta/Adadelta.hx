...
package tensorflow.python.keras.optimizer_v2.adadelta;
@:pythonImport("tensorflow.python.keras.optimizer_v2.adadelta", "Adadelta") extern class Adadelta {
	...
	**/
	@:native("__init__")
	public function ___init__(?learning_rate:Dynamic, ?rho:Dynamic, ?epsilon:Dynamic, ?name:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
		Create a new Optimizer.
		...
		Raises:
		  ValueError: in case of any invalid argument.
	**/
	public function new(?learning_rate:Dynamic, ?rho:Dynamic, ?epsilon:Dynamic, ?name:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Void;
	/**
