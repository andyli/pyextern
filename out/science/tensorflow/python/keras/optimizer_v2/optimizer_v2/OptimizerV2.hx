...
@:pythonImport("tensorflow.python.keras.optimizer_v2.optimizer_v2", "OptimizerV2") extern class OptimizerV2 {
	...
	**/
	@:native("__init__")
	public function ___init__(name:Dynamic, ?gradient_aggregator:Dynamic, ?gradient_transformers:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
		Create a new Optimizer.
		...
		Raises:
		  ValueError: in case of any invalid argument.
	**/
	public function new(name:Dynamic, ?gradient_aggregator:Dynamic, ?gradient_transformers:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Void;
	/**
