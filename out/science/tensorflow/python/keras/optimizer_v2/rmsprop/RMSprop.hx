...
package tensorflow.python.keras.optimizer_v2.rmsprop;
@:pythonImport("tensorflow.python.keras.optimizer_v2.rmsprop", "RMSprop") extern class RMSprop {
	...
	**/
	@:native("__init__")
	public function ___init__(?learning_rate:Dynamic, ?rho:Dynamic, ?momentum:Dynamic, ?epsilon:Dynamic, ?centered:Dynamic, ?name:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
		Construct a new RMSprop optimizer.
		...
		@end_compatibility
	**/
	public function new(?learning_rate:Dynamic, ?rho:Dynamic, ?momentum:Dynamic, ?epsilon:Dynamic, ?centered:Dynamic, ?name:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Void;
	/**
