...
package tensorflow.python.keras.optimizer_v2.legacy_learning_rate_decay;
@:pythonImport("tensorflow.python.keras.optimizer_v2.legacy_learning_rate_decay") extern class Legacy_learning_rate_decay_Module {
