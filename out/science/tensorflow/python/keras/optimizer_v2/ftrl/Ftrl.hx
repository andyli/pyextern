...
package tensorflow.python.keras.optimizer_v2.ftrl;
@:pythonImport("tensorflow.python.keras.optimizer_v2.ftrl", "Ftrl") extern class Ftrl {
	...
	**/
	@:native("__init__")
	public function ___init__(?learning_rate:Dynamic, ?learning_rate_power:Dynamic, ?initial_accumulator_value:Dynamic, ?l1_regularization_strength:Dynamic, ?l2_regularization_strength:Dynamic, ?name:Dynamic, ?l2_shrinkage_regularization_strength:Dynamic, ?beta:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
		Create a new Optimizer.
		...
		Raises:
		  ValueError: in case of any invalid argument.
	**/
	public function new(?learning_rate:Dynamic, ?learning_rate_power:Dynamic, ?initial_accumulator_value:Dynamic, ?l1_regularization_strength:Dynamic, ?l2_regularization_strength:Dynamic, ?name:Dynamic, ?l2_shrinkage_regularization_strength:Dynamic, ?beta:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Void;
	/**
