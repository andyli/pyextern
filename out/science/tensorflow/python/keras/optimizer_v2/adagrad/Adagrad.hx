...
package tensorflow.python.keras.optimizer_v2.adagrad;
@:pythonImport("tensorflow.python.keras.optimizer_v2.adagrad", "Adagrad") extern class Adagrad {
	...
	**/
	@:native("__init__")
	public function ___init__(?learning_rate:Dynamic, ?initial_accumulator_value:Dynamic, ?epsilon:Dynamic, ?name:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
		Create a new Optimizer.
		...
		Raises:
		  ValueError: in case of any invalid argument.
	**/
	public function new(?learning_rate:Dynamic, ?initial_accumulator_value:Dynamic, ?epsilon:Dynamic, ?name:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Void;
	/**
