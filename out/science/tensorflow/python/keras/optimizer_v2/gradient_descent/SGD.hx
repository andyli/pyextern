...
package tensorflow.python.keras.optimizer_v2.gradient_descent;
@:pythonImport("tensorflow.python.keras.optimizer_v2.gradient_descent", "SGD") extern class SGD {
	...
	**/
	@:native("__init__")
	public function ___init__(?learning_rate:Dynamic, ?momentum:Dynamic, ?nesterov:Dynamic, ?name:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
		Create a new Optimizer.
		...
		Raises:
		  ValueError: in case of any invalid argument.
	**/
	public function new(?learning_rate:Dynamic, ?momentum:Dynamic, ?nesterov:Dynamic, ?name:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Void;
	/**
	...
	**/
	...
	/**
		...
		Returns:
		  An `Operation` which updates the value of the variable.
	**/
	public function _resource_apply_sparse_duplicate_indices(grad:Dynamic, _var:Dynamic, indices:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
