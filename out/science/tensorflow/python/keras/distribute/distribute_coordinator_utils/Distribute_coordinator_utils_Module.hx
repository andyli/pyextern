...
package tensorflow.python.keras.distribute.distribute_coordinator_utils;
@:pythonImport("tensorflow.python.keras.distribute.distribute_coordinator_utils") extern class Distribute_coordinator_utils_Module {
	...
	**/
	...
	/**
		...
		Returns:
		  ...
		  otherwise.
	**/
	static public function run_distribute_coordinator(worker_fn:Dynamic, strategy:Dynamic, ?eval_fn:Dynamic, ?eval_strategy:Dynamic, ?cluster_spec:Dynamic, ?task_type:Dynamic, ?task_id:Dynamic, ?session_config:Dynamic, ?rpc_layer:Dynamic):Dynamic;
}