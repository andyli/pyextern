...
package tensorflow.python.keras.utils.tf_inspect;
@:pythonImport("tensorflow.python.keras.utils.tf_inspect") extern class Tf_inspect_Module {
	...
	static public function _convert_maybe_argspec_to_fullargspec(argspec:Dynamic):Dynamic;
	/**
