...
@:pythonImport("tensorflow.python.keras.utils.generic_utils", "SharedObjectLoadingScope") extern class SharedObjectLoadingScope {
	...
	**/
	public function get(object_id:Dynamic):Dynamic;
	/**
		Stores an instantiated object for future lookup and sharing.
	**/
	public function set(object_id:Dynamic, obj:Dynamic):Dynamic;
}