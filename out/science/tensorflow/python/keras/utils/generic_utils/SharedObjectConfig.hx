...
@:pythonImport("tensorflow.python.keras.utils.generic_utils", "SharedObjectConfig") extern class SharedObjectConfig {
	...
	**/
	@:native("__init__")
	public function ___init__(base_config:Dynamic, object_id:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(base_config:Dynamic, object_id:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Void;
	/**
	...
	**/
	...
	public function increment_ref_count():Dynamic;
	/**
