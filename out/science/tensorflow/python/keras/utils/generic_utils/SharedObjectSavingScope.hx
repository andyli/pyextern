...
@:pythonImport("tensorflow.python.keras.utils.generic_utils", "SharedObjectSavingScope") extern class SharedObjectSavingScope {
	...
	**/
	public function create_config(base_config:Dynamic, obj:Dynamic):Dynamic;
	/**
		...
		Returns:
		  The SharedObjectConfig for a given object, if already seen. Else,
		    `None`.
	**/
	public function get_config(obj:Dynamic):Dynamic;
}