...
@:pythonImport("tensorflow.python.keras.utils.data_utils", "GeneratorEnqueuer") extern class GeneratorEnqueuer {
	...
	**/
	@:native("__init__")
	public function ___init__(generator:Dynamic, ?use_multiprocessing:Dynamic, ?random_seed:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(generator:Dynamic, ?use_multiprocessing:Dynamic, ?random_seed:Dynamic):Void;
	/**
