...
package tensorflow.python.keras.initializers.initializers_v1;
@:pythonImport("tensorflow.python.keras.initializers.initializers_v1", "TruncatedNormal") extern class TruncatedNormal {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(?mean:Dynamic, ?stddev:Dynamic, ?seed:Dynamic, ?dtype:Dynamic):Dynamic;
	/**
		DEPRECATED FUNCTION ARGUMENTS
		...
		Call initializer instance with the dtype argument instead of passing it to the constructor
	**/
	public function new(?mean:Dynamic, ?stddev:Dynamic, ?seed:Dynamic, ?dtype:Dynamic):Void;
	/**
