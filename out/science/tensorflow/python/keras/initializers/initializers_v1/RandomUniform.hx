...
@:pythonImport("tensorflow.python.keras.initializers.initializers_v1", "RandomUniform") extern class RandomUniform {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(?minval:Dynamic, ?maxval:Dynamic, ?seed:Dynamic, ?dtype:Dynamic):Dynamic;
	/**
		DEPRECATED FUNCTION ARGUMENTS
		...
		Call initializer instance with the dtype argument instead of passing it to the constructor
	**/
	public function new(?minval:Dynamic, ?maxval:Dynamic, ?seed:Dynamic, ?dtype:Dynamic):Void;
	/**
