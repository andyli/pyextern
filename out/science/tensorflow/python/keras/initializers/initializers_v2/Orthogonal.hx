...
@:pythonImport("tensorflow.python.keras.initializers.initializers_v2", "Orthogonal") extern class Orthogonal {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(?gain:Dynamic, ?seed:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(?gain:Dynamic, ?seed:Dynamic):Void;
	/**
