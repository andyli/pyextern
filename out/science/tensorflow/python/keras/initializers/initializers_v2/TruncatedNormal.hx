...
@:pythonImport("tensorflow.python.keras.initializers.initializers_v2", "TruncatedNormal") extern class TruncatedNormal {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(?mean:Dynamic, ?stddev:Dynamic, ?seed:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(?mean:Dynamic, ?stddev:Dynamic, ?seed:Dynamic):Void;
	/**
