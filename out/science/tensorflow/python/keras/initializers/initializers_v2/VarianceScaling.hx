...
@:pythonImport("tensorflow.python.keras.initializers.initializers_v2", "VarianceScaling") extern class VarianceScaling {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(?scale:Dynamic, ?mode:Dynamic, ?distribution:Dynamic, ?seed:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(?scale:Dynamic, ?mode:Dynamic, ?distribution:Dynamic, ?seed:Dynamic):Void;
	/**
