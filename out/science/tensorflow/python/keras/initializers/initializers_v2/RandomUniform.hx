...
@:pythonImport("tensorflow.python.keras.initializers.initializers_v2", "RandomUniform") extern class RandomUniform {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(?minval:Dynamic, ?maxval:Dynamic, ?seed:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(?minval:Dynamic, ?maxval:Dynamic, ?seed:Dynamic):Void;
	/**
