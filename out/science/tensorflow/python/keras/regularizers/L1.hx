...
@:pythonImport("tensorflow.python.keras.regularizers", "L1") extern class L1 {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(?l1:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(?l1:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Void;
	/**
