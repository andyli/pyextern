...
@:pythonImport("tensorflow.python.keras.constraints", "RadialConstraint") extern class RadialConstraint {
	/**
	...
	**/
	public function _kernel_constraint(kernel:Dynamic):Dynamic;
	/**
