...
@:pythonImport("tensorflow.python.keras.optimizer_v1", "TFOptimizer") extern class TFOptimizer {
	...
	**/
	@:native("__init__")
	public function ___init__(optimizer:Dynamic, ?iterations:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(optimizer:Dynamic, ?iterations:Dynamic):Void;
	/**
	...
	**/
	public function _clip_gradients(grads:Dynamic):Dynamic;
	/**
	...
	**/
	...
	public function apply_gradients(grads_and_vars:Dynamic):Dynamic;
	public function from_config(config:Dynamic):Dynamic;
	...
	**/
	...
	public function get_grads(loss:Dynamic, params:Dynamic):Dynamic;
	...
	**/
	public function minimize(loss:Dynamic, var_list:Dynamic, ?grad_loss:Dynamic, ?tape:Dynamic):Dynamic;
	/**
