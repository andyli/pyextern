...
@:pythonImport("tensorflow.python.keras.estimator") extern class Estimator_Module {
	...
	**/
	...
	/**
		...
		Raises:
		  ...
		  ValueError: If an invalid checkpoint_format was given.
	**/
	static public function model_to_estimator_v2(?keras_model:Dynamic, ?keras_model_path:Dynamic, ?custom_objects:Dynamic, ?model_dir:Dynamic, ?config:Dynamic, ?checkpoint_format:Dynamic, ?metric_names_map:Dynamic, ?export_outputs:Dynamic):Dynamic;
}