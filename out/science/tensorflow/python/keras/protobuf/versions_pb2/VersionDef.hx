...
package tensorflow.python.keras.protobuf.versions_pb2;
@:pythonImport("tensorflow.python.keras.protobuf.versions_pb2", "VersionDef") extern class VersionDef {
	/**
	...
	**/
	...
	/**
		Field third_party.tensorflow.python.keras.protobuf.VersionDef.bad_consumers
	**/
	public var bad_consumers : Dynamic;
	/**
		Field third_party.tensorflow.python.keras.protobuf.VersionDef.min_consumer
	**/
	public var min_consumer : Dynamic;
	/**
		Field third_party.tensorflow.python.keras.protobuf.VersionDef.producer
	**/
