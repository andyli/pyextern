...
@:pythonImport("tensorflow.python.keras.protobuf.projector_config_pb2", "SpriteMetadata") extern class SpriteMetadata {
	/**
	...
	**/
	...
	/**
		Field third_party.tensorflow.python.keras.protobuf.SpriteMetadata.image_path
	**/
	public var image_path : Dynamic;
	/**
		Field third_party.tensorflow.python.keras.protobuf.SpriteMetadata.single_image_dim
	**/
	public var single_image_dim : Dynamic;
}