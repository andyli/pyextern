...
@:pythonImport("tensorflow.python.keras.protobuf.projector_config_pb2", "ProjectorConfig") extern class ProjectorConfig {
	/**
	...
	**/
	...
	/**
		Field third_party.tensorflow.python.keras.protobuf.ProjectorConfig.embeddings
	**/
	public var embeddings : Dynamic;
	/**
		Field third_party.tensorflow.python.keras.protobuf.ProjectorConfig.model_checkpoint_dir
	**/
	public var model_checkpoint_dir : Dynamic;
	/**
		Field third_party.tensorflow.python.keras.protobuf.ProjectorConfig.model_checkpoint_path
	**/
