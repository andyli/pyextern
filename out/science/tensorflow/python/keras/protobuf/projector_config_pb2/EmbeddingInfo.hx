...
package tensorflow.python.keras.protobuf.projector_config_pb2;
@:pythonImport("tensorflow.python.keras.protobuf.projector_config_pb2", "EmbeddingInfo") extern class EmbeddingInfo {
	/**
	...
	**/
	...
	/**
		Field third_party.tensorflow.python.keras.protobuf.EmbeddingInfo.bookmarks_path
	**/
	public var bookmarks_path : Dynamic;
	/**
		Field third_party.tensorflow.python.keras.protobuf.EmbeddingInfo.metadata_path
	**/
	public var metadata_path : Dynamic;
	/**
		Field third_party.tensorflow.python.keras.protobuf.EmbeddingInfo.sprite
	**/
	public var sprite : Dynamic;
	/**
		Field third_party.tensorflow.python.keras.protobuf.EmbeddingInfo.tensor_name
	**/
	public var tensor_name : Dynamic;
	/**
		Field third_party.tensorflow.python.keras.protobuf.EmbeddingInfo.tensor_path
	**/
	public var tensor_path : Dynamic;
	/**
		Field third_party.tensorflow.python.keras.protobuf.EmbeddingInfo.tensor_shape
	**/
