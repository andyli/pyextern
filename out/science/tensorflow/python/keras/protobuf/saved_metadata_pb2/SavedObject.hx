...
package tensorflow.python.keras.protobuf.saved_metadata_pb2;
@:pythonImport("tensorflow.python.keras.protobuf.saved_metadata_pb2", "SavedObject") extern class SavedObject {
	/**
	...
	**/
	...
	/**
		Field third_party.tensorflow.python.keras.protobuf.SavedObject.identifier
	**/
	public var identifier : Dynamic;
	/**
		Field third_party.tensorflow.python.keras.protobuf.SavedObject.metadata
	**/
	public var metadata : Dynamic;
	/**
		Field third_party.tensorflow.python.keras.protobuf.SavedObject.node_id
	**/
	public var node_id : Dynamic;
	/**
		Field third_party.tensorflow.python.keras.protobuf.SavedObject.node_path
	**/
	public var node_path : Dynamic;
	/**
		Field third_party.tensorflow.python.keras.protobuf.SavedObject.version
	**/
