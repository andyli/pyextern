...
@:pythonImport("tensorflow.python.keras.protobuf.saved_metadata_pb2", "SavedMetadata") extern class SavedMetadata {
	/**
	...
	**/
	...
	/**
		Field third_party.tensorflow.python.keras.protobuf.SavedMetadata.nodes
	**/
