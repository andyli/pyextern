...
package tensorflow.python.keras.applications.xception;
@:pythonImport("tensorflow.python.keras.applications.xception") extern class Xception_Module {
	static public var TF_WEIGHTS_PATH : Dynamic;
	static public var TF_WEIGHTS_PATH_NO_TOP : Dynamic;
	/**
