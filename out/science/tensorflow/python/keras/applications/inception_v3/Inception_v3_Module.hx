...
package tensorflow.python.keras.applications.inception_v3;
@:pythonImport("tensorflow.python.keras.applications.inception_v3") extern class Inception_v3_Module {
	/**
	...
	**/
	static public function conv2d_bn(x:Dynamic, filters:Dynamic, num_row:Dynamic, num_col:Dynamic, ?padding:Dynamic, ?strides:Dynamic, ?name:Dynamic):Dynamic;
	/**
