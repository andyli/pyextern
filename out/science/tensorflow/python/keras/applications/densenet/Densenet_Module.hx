...
package tensorflow.python.keras.applications.densenet;
@:pythonImport("tensorflow.python.keras.applications.densenet") extern class Densenet_Module {
	static public var BASE_WEIGHTS_PATH : Dynamic;
	static public var DENSENET121_WEIGHT_PATH : Dynamic;
	static public var DENSENET121_WEIGHT_PATH_NO_TOP : Dynamic;
	static public var DENSENET169_WEIGHT_PATH : Dynamic;
	static public var DENSENET169_WEIGHT_PATH_NO_TOP : Dynamic;
	static public var DENSENET201_WEIGHT_PATH : Dynamic;
	static public var DENSENET201_WEIGHT_PATH_NO_TOP : Dynamic;
	...
	**/
	static public function DenseNet(blocks:Dynamic, ?include_top:Dynamic, ?weights:Dynamic, ?input_tensor:Dynamic, ?input_shape:Dynamic, ?pooling:Dynamic, ?classes:Dynamic, ?classifier_activation:Dynamic):Dynamic;
	/**
	...
	**/
	static public function conv_block(x:Dynamic, growth_rate:Dynamic, name:Dynamic):Dynamic;
	/**
	...
	**/
	...
	/**
		...
		Returns:
		  Output tensor for the block.
	**/
	static public function dense_block(x:Dynamic, blocks:Dynamic, name:Dynamic):Dynamic;
	...
	**/
	...
	/**
		...
		Returns:
		  output tensor for the block.
	**/
	static public function transition_block(x:Dynamic, reduction:Dynamic, name:Dynamic):Dynamic;
}