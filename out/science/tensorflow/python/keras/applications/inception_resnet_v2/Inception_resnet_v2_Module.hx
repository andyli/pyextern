...
@:pythonImport("tensorflow.python.keras.applications.inception_resnet_v2") extern class Inception_resnet_v2_Module {
	static public var BASE_WEIGHT_URL : Dynamic;
	/**
	...
	**/
	static public function conv2d_bn(x:Dynamic, filters:Dynamic, kernel_size:Dynamic, ?strides:Dynamic, ?padding:Dynamic, ?activation:Dynamic, ?use_bias:Dynamic, ?name:Dynamic):Dynamic;
	/**
	...
	/**
		...
		Raises:
		  ValueError: if `block_type` is not one of `'block35'`,
		    `'block17'` or `'block8'`.
	**/
	static public function inception_resnet_block(x:Dynamic, scale:Dynamic, block_type:Dynamic, block_idx:Dynamic, ?activation:Dynamic):Dynamic;
