...
package tensorflow.python.keras.applications.mobilenet_v2;
@:pythonImport("tensorflow.python.keras.applications.mobilenet_v2") extern class Mobilenet_v2_Module {
	...
	**/
	static public function _inverted_res_block(inputs:Dynamic, expansion:Dynamic, stride:Dynamic, alpha:Dynamic, filters:Dynamic, block_id:Dynamic):Dynamic;
	static public function _make_divisible(v:Dynamic, divisor:Dynamic, ?min_value:Dynamic):Dynamic;
	/**
