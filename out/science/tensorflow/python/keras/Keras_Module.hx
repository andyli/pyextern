...
@:pythonImport("tensorflow.python.keras") extern class Keras_Module {
	/**
	...
	**/
	...
	static public var _keras_api_constants : Dynamic;
	static public var _keras_api_constants_v1 : Dynamic;
