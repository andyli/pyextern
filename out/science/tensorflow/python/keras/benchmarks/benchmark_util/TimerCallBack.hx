...
@:pythonImport("tensorflow.python.keras.benchmarks.benchmark_util", "TimerCallBack") extern class TimerCallBack {
	...
	**/
	public function on_batch_end(e:Dynamic, logs:Dynamic):Dynamic;
	/**
	...
	**/
	public function on_epoch_begin(e:Dynamic, logs:Dynamic):Dynamic;
	/**
		...
		Args:
		    ...
		    logs: Dict, metric results for this training epoch, and for the
		     ...
		     `Model`'s metrics are returned. Example : `{'loss': 0.2, 'accuracy':
		       0.7}`.
	**/
	public function on_epoch_end(e:Dynamic, logs:Dynamic):Dynamic;
	/**
