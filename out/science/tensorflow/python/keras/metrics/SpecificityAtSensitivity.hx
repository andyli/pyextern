...
@:pythonImport("tensorflow.python.keras.metrics", "SpecificityAtSensitivity") extern class SpecificityAtSensitivity {
	...
	**/
	...
	@:native("__init__")
	public function ___init__(sensitivity:Dynamic, ?num_thresholds:Dynamic, ?class_id:Dynamic, ?name:Dynamic, ?dtype:Dynamic):Dynamic;
	public function new(sensitivity:Dynamic, ?num_thresholds:Dynamic, ?class_id:Dynamic, ?name:Dynamic, ?dtype:Dynamic):Void;
	/**
	...
	**/
	public function _find_max_under_constraint(constrained:Dynamic, dependent:Dynamic, predicate:Dynamic):Dynamic;
	/**
