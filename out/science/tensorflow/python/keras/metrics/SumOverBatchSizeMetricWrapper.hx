...
@:pythonImport("tensorflow.python.keras.metrics", "SumOverBatchSizeMetricWrapper") extern class SumOverBatchSizeMetricWrapper {
	...
	**/
	@:native("__init__")
	public function ___init__(fn:Dynamic, ?name:Dynamic, ?dtype:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
		Creates a `SumOverBatchSizeMetricWrapper` instance.
		...
		Args:
		  ...
		  **kwargs: The keyword arguments that are passed on to `fn`.
	**/
	public function new(fn:Dynamic, ?name:Dynamic, ?dtype:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Void;
	/**
