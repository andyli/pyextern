...
@:pythonImport("tensorflow.python.keras.metrics", "SensitivityAtSpecificity") extern class SensitivityAtSpecificity {
	...
	**/
	...
	@:native("__init__")
	public function ___init__(specificity:Dynamic, ?num_thresholds:Dynamic, ?class_id:Dynamic, ?name:Dynamic, ?dtype:Dynamic):Dynamic;
	public function new(specificity:Dynamic, ?num_thresholds:Dynamic, ?class_id:Dynamic, ?name:Dynamic, ?dtype:Dynamic):Void;
	/**
