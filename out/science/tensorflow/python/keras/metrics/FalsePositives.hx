...
@:pythonImport("tensorflow.python.keras.metrics", "FalsePositives") extern class FalsePositives {
	...
	**/
	...
	@:native("__init__")
	public function ___init__(?thresholds:Dynamic, ?name:Dynamic, ?dtype:Dynamic):Dynamic;
	public function new(?thresholds:Dynamic, ?name:Dynamic, ?dtype:Dynamic):Void;
	/**
