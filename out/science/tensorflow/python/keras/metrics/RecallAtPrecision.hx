...
@:pythonImport("tensorflow.python.keras.metrics", "RecallAtPrecision") extern class RecallAtPrecision {
	...
	**/
	...
	@:native("__init__")
	public function ___init__(precision:Dynamic, ?num_thresholds:Dynamic, ?class_id:Dynamic, ?name:Dynamic, ?dtype:Dynamic):Dynamic;
	public function new(precision:Dynamic, ?num_thresholds:Dynamic, ?class_id:Dynamic, ?name:Dynamic, ?dtype:Dynamic):Void;
	/**
