...
@:pythonImport("tensorflow.python.keras.metrics", "MeanTensor") extern class MeanTensor {
	...
	**/
	...
	@:native("__init__")
	public function ___init__(?name:Dynamic, ?dtype:Dynamic, ?shape:Dynamic):Dynamic;
	public function new(?name:Dynamic, ?dtype:Dynamic, ?shape:Dynamic):Void;
	/**
	...
	**/
	...
	/**
		...
		Returns:
		  Update op.
	**/
	public function update_state(values:Dynamic, ?sample_weight:Dynamic):Dynamic;
