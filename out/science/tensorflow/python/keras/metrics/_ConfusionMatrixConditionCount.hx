...
@:pythonImport("tensorflow.python.keras.metrics", "_ConfusionMatrixConditionCount") extern class _ConfusionMatrixConditionCount {
	...
	**/
	...
	@:native("__init__")
	public function ___init__(confusion_matrix_cond:Dynamic, ?thresholds:Dynamic, ?name:Dynamic, ?dtype:Dynamic):Dynamic;
	public function new(confusion_matrix_cond:Dynamic, ?thresholds:Dynamic, ?name:Dynamic, ?dtype:Dynamic):Void;
	/**
