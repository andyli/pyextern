...
@:pythonImport("tensorflow.python.keras.metrics", "MeanRelativeError") extern class MeanRelativeError {
	...
	**/
	...
	@:native("__init__")
	public function ___init__(normalizer:Dynamic, ?name:Dynamic, ?dtype:Dynamic):Dynamic;
	public function new(normalizer:Dynamic, ?name:Dynamic, ?dtype:Dynamic):Void;
	/**
