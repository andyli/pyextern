...
@:pythonImport("tensorflow.python.keras.metrics", "Metric") extern class Metric {
	...
	**/
	...
	@:native("__init__")
	public function ___init__(?name:Dynamic, ?dtype:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	public function new(?name:Dynamic, ?dtype:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Void;
	/**
	...
	**/
	...
	/**
		...
		Args:
		  ...
		  **kwargs: A mini-batch of inputs to the Metric.
	**/
	public function update_state(?args:python.VarArgs<Dynamic>, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
