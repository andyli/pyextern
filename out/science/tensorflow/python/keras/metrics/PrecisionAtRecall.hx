...
@:pythonImport("tensorflow.python.keras.metrics", "PrecisionAtRecall") extern class PrecisionAtRecall {
	...
	**/
	...
	@:native("__init__")
	public function ___init__(recall:Dynamic, ?num_thresholds:Dynamic, ?class_id:Dynamic, ?name:Dynamic, ?dtype:Dynamic):Dynamic;
	public function new(recall:Dynamic, ?num_thresholds:Dynamic, ?class_id:Dynamic, ?name:Dynamic, ?dtype:Dynamic):Void;
	/**
