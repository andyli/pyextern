...
@:pythonImport("tensorflow.python.keras.metrics", "CosineSimilarity") extern class CosineSimilarity {
	...
	**/
	...
	@:native("__init__")
	public function ___init__(?name:Dynamic, ?dtype:Dynamic, ?axis:Dynamic):Dynamic;
	public function new(?name:Dynamic, ?dtype:Dynamic, ?axis:Dynamic):Void;
	/**
