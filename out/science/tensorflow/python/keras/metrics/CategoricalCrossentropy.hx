...
@:pythonImport("tensorflow.python.keras.metrics", "CategoricalCrossentropy") extern class CategoricalCrossentropy {
	...
	**/
	...
	@:native("__init__")
	public function ___init__(?name:Dynamic, ?dtype:Dynamic, ?from_logits:Dynamic, ?label_smoothing:Dynamic):Dynamic;
	public function new(?name:Dynamic, ?dtype:Dynamic, ?from_logits:Dynamic, ?label_smoothing:Dynamic):Void;
	/**
