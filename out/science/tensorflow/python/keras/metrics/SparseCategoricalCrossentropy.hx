...
@:pythonImport("tensorflow.python.keras.metrics", "SparseCategoricalCrossentropy") extern class SparseCategoricalCrossentropy {
	...
	**/
	...
	@:native("__init__")
	public function ___init__(?name:Dynamic, ?dtype:Dynamic, ?from_logits:Dynamic, ?axis:Dynamic):Dynamic;
	public function new(?name:Dynamic, ?dtype:Dynamic, ?from_logits:Dynamic, ?axis:Dynamic):Void;
	/**
