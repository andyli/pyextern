...
@:pythonImport("tensorflow.python.keras.metrics", "BinaryAccuracy") extern class BinaryAccuracy {
	...
	**/
	...
	@:native("__init__")
	public function ___init__(?name:Dynamic, ?dtype:Dynamic, ?threshold:Dynamic):Dynamic;
	public function new(?name:Dynamic, ?dtype:Dynamic, ?threshold:Dynamic):Void;
	/**
