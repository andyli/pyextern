...
@:pythonImport("tensorflow.python.keras.metrics", "MeanIoU") extern class MeanIoU {
	...
	**/
	...
	@:native("__init__")
	public function ___init__(num_classes:Dynamic, ?name:Dynamic, ?dtype:Dynamic):Dynamic;
	public function new(num_classes:Dynamic, ?name:Dynamic, ?dtype:Dynamic):Void;
	/**
