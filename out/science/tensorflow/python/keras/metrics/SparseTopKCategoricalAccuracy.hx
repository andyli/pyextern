...
@:pythonImport("tensorflow.python.keras.metrics", "SparseTopKCategoricalAccuracy") extern class SparseTopKCategoricalAccuracy {
	...
	**/
	...
	@:native("__init__")
	public function ___init__(?k:Dynamic, ?name:Dynamic, ?dtype:Dynamic):Dynamic;
	public function new(?k:Dynamic, ?name:Dynamic, ?dtype:Dynamic):Void;
	/**
