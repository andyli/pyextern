...
@:pythonImport("tensorflow.python.keras.metrics", "Reduce") extern class Reduce {
	...
	**/
	...
	@:native("__init__")
	public function ___init__(reduction:Dynamic, name:Dynamic, ?dtype:Dynamic):Dynamic;
	public function new(reduction:Dynamic, name:Dynamic, ?dtype:Dynamic):Void;
	/**
