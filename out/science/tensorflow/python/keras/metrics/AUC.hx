...
@:pythonImport("tensorflow.python.keras.metrics", "AUC") extern class AUC {
	...
	**/
	...
	@:native("__init__")
	public function ___init__(?num_thresholds:Dynamic, ?curve:Dynamic, ?summation_method:Dynamic, ?name:Dynamic, ?dtype:Dynamic, ?thresholds:Dynamic, ?multi_label:Dynamic, ?num_labels:Dynamic, ?label_weights:Dynamic, ?from_logits:Dynamic):Dynamic;
	public function new(?num_thresholds:Dynamic, ?curve:Dynamic, ?summation_method:Dynamic, ?name:Dynamic, ?dtype:Dynamic, ?thresholds:Dynamic, ?multi_label:Dynamic, ?num_labels:Dynamic, ?label_weights:Dynamic, ?from_logits:Dynamic):Void;
	/**
	...
	**/
	public function _build(shape:Dynamic):Dynamic;
	...
	**/
	public function add_weight(name:Dynamic, ?shape:Dynamic, ?aggregation:Dynamic, ?synchronization:Dynamic, ?initializer:Dynamic, ?dtype:Dynamic):Dynamic;
	/**
	...
	**/
	public function interpolate_pr_auc():Dynamic;
	/**
