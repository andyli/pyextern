...
@:pythonImport("tensorflow.python.keras.metrics", "Precision") extern class Precision {
	...
	**/
	...
	@:native("__init__")
	public function ___init__(?thresholds:Dynamic, ?top_k:Dynamic, ?class_id:Dynamic, ?name:Dynamic, ?dtype:Dynamic):Dynamic;
	public function new(?thresholds:Dynamic, ?top_k:Dynamic, ?class_id:Dynamic, ?name:Dynamic, ?dtype:Dynamic):Void;
	/**
