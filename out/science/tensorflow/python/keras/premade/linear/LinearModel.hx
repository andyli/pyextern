...
package tensorflow.python.keras.premade.linear;
@:pythonImport("tensorflow.python.keras.premade.linear", "LinearModel") extern class LinearModel {
	...
	**/
	@:native("__init__")
	public function ___init__(?units:Dynamic, ?activation:Dynamic, ?use_bias:Dynamic, ?kernel_initializer:Dynamic, ?bias_initializer:Dynamic, ?kernel_regularizer:Dynamic, ?bias_regularizer:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
		Create a Linear Model.
		...
		Args:
		  ...
		  **kwargs: The keyword arguments that are passed on to BaseLayer.__init__.
	**/
	public function new(?units:Dynamic, ?activation:Dynamic, ?use_bias:Dynamic, ?kernel_initializer:Dynamic, ?bias_initializer:Dynamic, ?kernel_regularizer:Dynamic, ?bias_regularizer:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Void;
	/**
