...
package tensorflow.python.keras.premade.wide_deep;
@:pythonImport("tensorflow.python.keras.premade.wide_deep", "WideDeepModel") extern class WideDeepModel {
	...
	**/
	@:native("__init__")
	public function ___init__(linear_model:Dynamic, dnn_model:Dynamic, ?activation:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
		Create a Wide & Deep Model.
		...
		Args:
		  ...
		  **kwargs: The keyword arguments that are passed on to BaseLayer.__init__.
		    Allowed keyword arguments include `name`.
	**/
	public function new(linear_model:Dynamic, dnn_model:Dynamic, ?activation:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Void;
	/**
