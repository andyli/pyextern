...
@:pythonImport("tensorflow.python.keras.engine.base_preprocessing_layer", "CombinerPreprocessingLayer") extern class CombinerPreprocessingLayer {
	...
	**/
	...
	@:native("__init__")
	public function ___init__(combiner:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	public function new(combiner:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Void;
	/**
	...
	**/
	public function adapt(data:Dynamic, ?batch_size:Dynamic, ?steps:Dynamic, ?reset_state:Dynamic):Dynamic;
	/**
	...
	**/
	public function call(inputs:Dynamic, ?args:python.VarArgs<Dynamic>, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
