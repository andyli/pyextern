...
@:pythonImport("tensorflow.python.keras.engine.base_preprocessing_layer", "PreprocessingLayer") extern class PreprocessingLayer {
	...
	**/
	...
	@:native("__init__")
	public function ___init__(?streaming:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	public function new(?streaming:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Void;
	/**
