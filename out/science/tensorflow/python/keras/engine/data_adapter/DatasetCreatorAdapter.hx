...
@:pythonImport("tensorflow.python.keras.engine.data_adapter", "DatasetCreatorAdapter") extern class DatasetCreatorAdapter {
	...
	**/
	@:native("__init__")
	public function ___init__(x:Dynamic, y:Dynamic, ?steps:Dynamic, ?distribution_strategy:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
		Create a DataAdapter based on data inputs.
		...
		Args:
		  ...
		  **kwargs: Other keyword arguments for DataAdapter during the construction
		    ...
		    use it, or raise exception if any required argument is not provide.
	**/
	public function new(x:Dynamic, y:Dynamic, ?steps:Dynamic, ?distribution_strategy:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Void;
	/**
