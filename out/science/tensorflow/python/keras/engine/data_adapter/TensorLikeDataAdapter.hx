...
@:pythonImport("tensorflow.python.keras.engine.data_adapter", "TensorLikeDataAdapter") extern class TensorLikeDataAdapter {
	...
	**/
	@:native("__init__")
	public function ___init__(x:Dynamic, ?y:Dynamic, ?sample_weights:Dynamic, ?sample_weight_modes:Dynamic, ?batch_size:Dynamic, ?epochs:Dynamic, ?steps:Dynamic, ?shuffle:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
		Create a DataAdapter based on data inputs.
		...
		Args:
		  ...
		  **kwargs: Other keyword arguments for DataAdapter during the construction
		    ...
		    use it, or raise exception if any required argument is not provide.
	**/
	public function new(x:Dynamic, ?y:Dynamic, ?sample_weights:Dynamic, ?sample_weight_modes:Dynamic, ?batch_size:Dynamic, ?epochs:Dynamic, ?steps:Dynamic, ?shuffle:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Void;
	/**
	...
	**/
	public function slice_inputs(indices_dataset:Dynamic, inputs:Dynamic):Dynamic;
}