...
@:pythonImport("tensorflow.python.keras.engine.data_adapter", "_ClusterCoordinatorDataHandler") extern class _ClusterCoordinatorDataHandler {
	...
	**/
	@:native("__init__")
	public function ___init__(x:Dynamic, ?y:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
		Initializes a `DataHandler`.
		...
		Arguments:
		  ...
		  distribute: Whether to distribute the `tf.dataset`.
		    ...
		    `Model` should always set this to `True`.
	**/
	public function new(x:Dynamic, ?y:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Void;
	/**
	...
	**/
	public function _convert_to_dataset_creator(x:Dynamic, y:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
