...
@:pythonImport("tensorflow.python.keras.engine.data_adapter", "GeneratorDataAdapter") extern class GeneratorDataAdapter {
	...
	**/
	@:native("__init__")
	public function ___init__(x:Dynamic, ?y:Dynamic, ?sample_weights:Dynamic, ?workers:Dynamic, ?use_multiprocessing:Dynamic, ?max_queue_size:Dynamic, ?model:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
		Create a DataAdapter based on data inputs.
		...
		Args:
		  ...
		  **kwargs: Other keyword arguments for DataAdapter during the construction
		    ...
		    use it, or raise exception if any required argument is not provide.
	**/
	public function new(x:Dynamic, ?y:Dynamic, ?sample_weights:Dynamic, ?workers:Dynamic, ?use_multiprocessing:Dynamic, ?max_queue_size:Dynamic, ?model:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Void;
	/**
