...
@:pythonImport("tensorflow.python.keras.engine.data_adapter", "KerasSequenceAdapter") extern class KerasSequenceAdapter {
	...
	**/
	@:native("__init__")
	public function ___init__(x:Dynamic, ?y:Dynamic, ?sample_weights:Dynamic, ?shuffle:Dynamic, ?workers:Dynamic, ?use_multiprocessing:Dynamic, ?max_queue_size:Dynamic, ?model:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
		Create a DataAdapter based on data inputs.
		...
		Args:
		  ...
		  **kwargs: Other keyword arguments for DataAdapter during the construction
		    ...
		    use it, or raise exception if any required argument is not provide.
	**/
	public function new(x:Dynamic, ?y:Dynamic, ?sample_weights:Dynamic, ?shuffle:Dynamic, ?workers:Dynamic, ?use_multiprocessing:Dynamic, ?max_queue_size:Dynamic, ?model:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Void;
	/**
	...
	**/
	public function _handle_multiprocessing(x:Dynamic, workers:Dynamic, use_multiprocessing:Dynamic, max_queue_size:Dynamic):Dynamic;
	static public function _peek_and_restore(x:Dynamic):Dynamic;
	/**
		Standardizes a batch output by a generator.
	**/
	public function _standardize_batch(data:Dynamic):Dynamic;
	/**
