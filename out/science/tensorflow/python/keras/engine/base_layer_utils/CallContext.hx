...
@:pythonImport("tensorflow.python.keras.engine.base_layer_utils", "CallContext") extern class CallContext {
	...
	**/
	...
	public var build_graph : Dynamic;
	/**
		...
		Returns:
		  Context manager.
	**/
	public function enter(layer:Dynamic, inputs:Dynamic, build_graph:Dynamic, training:Dynamic, ?saving:Dynamic):Dynamic;
	public var frozen : Dynamic;
	public var in_keras_graph : Dynamic;
	public var inputs : Dynamic;
	public var layer : Dynamic;
	public var saving : Dynamic;
	public var training : Dynamic;
}