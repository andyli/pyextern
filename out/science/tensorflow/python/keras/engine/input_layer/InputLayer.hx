...
package tensorflow.python.keras.engine.input_layer;
@:pythonImport("tensorflow.python.keras.engine.input_layer", "InputLayer") extern class InputLayer {
	...
	**/
	...
	@:native("__init__")
	public function ___init__(?input_shape:Dynamic, ?batch_size:Dynamic, ?dtype:Dynamic, ?input_tensor:Dynamic, ?sparse:Dynamic, ?name:Dynamic, ?ragged:Dynamic, ?type_spec:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	public function new(?input_shape:Dynamic, ?batch_size:Dynamic, ?dtype:Dynamic, ?input_tensor:Dynamic, ?sparse:Dynamic, ?name:Dynamic, ?ragged:Dynamic, ?type_spec:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Void;
	/**
