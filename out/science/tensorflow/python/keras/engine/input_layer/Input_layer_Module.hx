...
@:pythonImport("tensorflow.python.keras.engine.input_layer") extern class Input_layer_Module {
	/**
	...
	**/
	...
	static public function _assert_other_arg_none(arg_name:Dynamic, arg:Dynamic):Dynamic;
