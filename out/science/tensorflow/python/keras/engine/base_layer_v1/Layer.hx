...
package tensorflow.python.keras.engine.base_layer_v1;
@:pythonImport("tensorflow.python.keras.engine.base_layer_v1", "Layer") extern class Layer {
	...
	**/
	...
	@:native("__init__")
	public function ___init__(?trainable:Dynamic, ?name:Dynamic, ?dtype:Dynamic, ?_dynamic:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	public function new(?trainable:Dynamic, ?name:Dynamic, ?dtype:Dynamic, ?_dynamic:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Void;
	/**
	...
	**/
	...
	public function _assert_built_as_v1():Dynamic;
	...
	**/
	public function _collect_input_masks(inputs:Dynamic, args:Dynamic, kwargs:Dynamic):Dynamic;
	/**
	...
	**/
	public function _maybe_cast_inputs(inputs:Dynamic):Dynamic;
	/**
