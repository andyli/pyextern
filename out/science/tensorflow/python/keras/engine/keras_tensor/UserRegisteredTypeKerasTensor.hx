...
@:pythonImport("tensorflow.python.keras.engine.keras_tensor", "UserRegisteredTypeKerasTensor") extern class UserRegisteredTypeKerasTensor {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(user_registered_symbolic_object:Dynamic):Dynamic;
	/**
		Constructs a KerasTensor.
	**/
	public function new(user_registered_symbolic_object:Dynamic):Void;
	/**
