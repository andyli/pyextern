...
@:pythonImport("tensorflow.python.keras.engine.keras_tensor", "UserRegisteredSpec") extern class UserRegisteredSpec {
	/**
	...
	**/
	...
	/**
		...
		Returns:
		  ...
		  ```
	**/
	public function _component_specs():Dynamic;
	/**
	...
	**/
	public function value_type():Dynamic;
}