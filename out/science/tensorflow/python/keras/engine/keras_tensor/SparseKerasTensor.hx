...
@:pythonImport("tensorflow.python.keras.engine.keras_tensor", "SparseKerasTensor") extern class SparseKerasTensor {
	/**
	...
	**/
	...
	public function with_values(?args:python.VarArgs<Dynamic>, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
}