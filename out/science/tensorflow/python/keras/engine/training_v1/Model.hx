...
@:pythonImport("tensorflow.python.keras.engine.training_v1", "Model") extern class Model {
	...
	/**
		...
		Raises:
		    ...
		    ValueError: If `skip_mismatch` is set to `True` when `by_name` is
		      `False`.
	**/
	public function load_weights(filepath:Dynamic, ?by_name:Dynamic, ?skip_mismatch:Dynamic):Dynamic;
	/**
