...
@:pythonImport("tensorflow.python.keras.engine.training_v1", "DistributedCallbackModel") extern class DistributedCallbackModel {
	...
	**/
	...
	public function __getattr__(item:Dynamic):Dynamic;
	/**
	...
	**/
	...
	@:native("__init__")
	public function ___init__(model:Dynamic):Dynamic;
	public function new(model:Dynamic):Void;
	/**
	...
	**/
	public function _add_unique_metric_name(metric_name:Dynamic, metric_fn:Dynamic, output_index:Dynamic):Dynamic;
	/**
	...
	**/
	public function _build_model_with_inputs(inputs:Dynamic, targets:Dynamic):Dynamic;
	/**
	...
	**/
	...
	public function _compile_eagerly(metrics:Dynamic, weighted_metrics:Dynamic, sample_weight_mode:Dynamic):Dynamic;
	public function _compile_from_inputs(all_inputs:Dynamic, target:Dynamic, orig_inputs:Dynamic, orig_target:Dynamic):Dynamic;
	...
	/**
		...
		Args:
		  sample_weights: List of tensors to use as the sample weights. Must be the
		    ...
		    are used instead.
	**/
	public function _compile_weights_loss_and_weighted_metrics(?sample_weights:Dynamic):Dynamic;
	/**
	...
	**/
	public function _distribution_standardize_user_data(x:Dynamic, ?y:Dynamic, ?sample_weight:Dynamic, ?class_weight:Dynamic, ?batch_size:Dynamic, ?validation_split:Dynamic, ?shuffle:Dynamic, ?epochs:Dynamic, ?allow_partial_batch:Dynamic):Dynamic;
	public var _dtype : Dynamic;
	public var _eager_losses : Dynamic;
	public var _feed_loss_fns : Dynamic;
	public var _feed_output_names : Dynamic;
	public var _feed_output_shapes : Dynamic;
	public var _feed_sample_weights : Dynamic;
	public var _feed_targets : Dynamic;
	/**
	...
	**/
	...
	/**
		...
		add_metric metrics.
	**/
	public function _get_training_eval_metrics():Dynamic;
	...
	**/
	public function _handle_metrics(outputs:Dynamic, ?targets:Dynamic, ?skip_target_masks:Dynamic, ?sample_weights:Dynamic, ?masks:Dynamic, ?return_weighted_metrics:Dynamic, ?return_weighted_and_unweighted_metrics:Dynamic):Dynamic;
	/**
	...
	**/
	...
	public function _init_distributed_function_cache_if_not_compiled():Dynamic;
	/**
	...
	**/
	...
	public var _loss_weights_list : Dynamic;
	...
	**/
	public function _maybe_load_initial_epoch_from_ckpt(initial_epoch:Dynamic, mode:Dynamic):Dynamic;
	...
	**/
	...
	public var _output_loss_metrics : Dynamic;
	/**
	...
	**/
	public function _prepare_output_masks():Dynamic;
	/**
		Sets sample weight attribute on the model.
	**/
	public function _prepare_sample_weights(?sample_weights:Dynamic):Dynamic;
	/**
	...
	**/
	public function _prepare_skip_target_masks():Dynamic;
	/**
	...
	**/
	public function _prepare_total_loss(masks:Dynamic):Dynamic;
	/**
		Unpack and check the validation data.
	**/
	public function _prepare_validation_data(validation_data:Dynamic, batch_size:Dynamic, validation_steps:Dynamic):Dynamic;
	public function _process_target_tensor_for_compile(target_tensors:Dynamic):Dynamic;
	public function _recompile_weights_loss_and_weighted_metrics():Dynamic;
	...
	**/
	...
	public var _sample_weight_modes : Dynamic;
	/**
		Select training loop for fit/eval/predict based on the inputs.
	**/
	public function _select_training_loop(inputs:Dynamic):Dynamic;
	/**
	...
	**/
	public function _set_input_attrs(inputs:Dynamic):Dynamic;
	/**
	...
	**/
	public function _set_metric_attributes():Dynamic;
	/**
		Sets self.optimizer.
	...
	**/
	public function _set_optimizer(optimizer:Dynamic):Dynamic;
	/**
		Sets attributes related to the outputs of the Model.
	**/
	public function _set_output_attrs(outputs:Dynamic):Dynamic;
	/**
	...
	**/
	...
	public function _set_strategy(strategy:Dynamic):Dynamic;
	/**
	...
	**/
	...
	public function _standardize_tensors(x:Dynamic, y:Dynamic, sample_weight:Dynamic, run_eagerly:Dynamic, dict_inputs:Dynamic, is_dataset:Dynamic, ?class_weight:Dynamic, ?batch_size:Dynamic):Dynamic;
	/**
		Runs validation checks on input and target data passed by the user.
		...
		Raises:
		  ...
		  RuntimeError: If the model was never compiled.
	**/
	public function _standardize_user_data(x:Dynamic, ?y:Dynamic, ?sample_weight:Dynamic, ?class_weight:Dynamic, ?batch_size:Dynamic, ?check_steps:Dynamic, ?steps_name:Dynamic, ?steps:Dynamic, ?validation_split:Dynamic, ?shuffle:Dynamic, ?extract_tensors_from_dataset:Dynamic):Dynamic;
	public function _symbolic_call(inputs:Dynamic):Dynamic;
	/**
		The output target tensors for the model.
	**/
	public var _targets : Dynamic;
	...
	/**
		...
		Args:
		  sample_weights: List of sample weights of the same length as model outputs
		    or None.
	**/
	public function _update_sample_weight_modes(?sample_weights:Dynamic):Dynamic;
	...
	**/
	...
	public function _validate_compile_param_for_distribution_strategy(run_eagerly:Dynamic, sample_weight_mode:Dynamic, target_tensors:Dynamic, weighted_metrics:Dynamic):Dynamic;
	/**
	...
	**/
	public function evaluate(?x:Dynamic, ?y:Dynamic, ?batch_size:Dynamic, ?verbose:Dynamic, ?sample_weight:Dynamic, ?steps:Dynamic, ?callbacks:Dynamic, ?max_queue_size:Dynamic, ?workers:Dynamic, ?use_multiprocessing:Dynamic):Dynamic;
	/**
	...
	**/
	public function fit(?x:Dynamic, ?y:Dynamic, ?batch_size:Dynamic, ?epochs:Dynamic, ?verbose:Dynamic, ?callbacks:Dynamic, ?validation_split:Dynamic, ?validation_data:Dynamic, ?shuffle:Dynamic, ?class_weight:Dynamic, ?sample_weight:Dynamic, ?initial_epoch:Dynamic, ?steps_per_epoch:Dynamic, ?validation_steps:Dynamic, ?validation_freq:Dynamic, ?max_queue_size:Dynamic, ?workers:Dynamic, ?use_multiprocessing:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
	...
	**/
	...
	public var sample_weights : Dynamic;
	/**
	...
	**/
	...
	public function set_original_model(orig_model:Dynamic):Dynamic;
	/**
