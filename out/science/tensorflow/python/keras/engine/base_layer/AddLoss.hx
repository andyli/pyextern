...
@:pythonImport("tensorflow.python.keras.engine.base_layer", "AddLoss") extern class AddLoss {
	...
	**/
	...
	@:native("__init__")
	public function ___init__(unconditional:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	public function new(unconditional:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Void;
	/**
