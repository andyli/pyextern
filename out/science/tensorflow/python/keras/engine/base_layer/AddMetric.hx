...
@:pythonImport("tensorflow.python.keras.engine.base_layer", "AddMetric") extern class AddMetric {
	...
	**/
	...
	@:native("__init__")
	public function ___init__(?aggregation:Dynamic, ?metric_name:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	public function new(?aggregation:Dynamic, ?metric_name:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Void;
	/**
