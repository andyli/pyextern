...
@:pythonImport("tensorflow.python.keras.engine.base_layer", "TensorFlowOpLayer") extern class TensorFlowOpLayer {
	...
	**/
	...
	@:native("__init__")
	public function ___init__(node_def:Dynamic, name:Dynamic, ?constants:Dynamic, ?trainable:Dynamic, ?dtype:Dynamic):Dynamic;
	public function new(node_def:Dynamic, name:Dynamic, ?constants:Dynamic, ?trainable:Dynamic, ?dtype:Dynamic):Void;
	/**
	...
	**/
	public function _defun_call(inputs:Dynamic):Dynamic;
	/**
	...
	**/
	...
	public function _make_node_def(graph:Dynamic):Dynamic;
	public function _make_op(inputs:Dynamic):Dynamic;
	/**
