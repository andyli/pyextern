...
@:pythonImport("tensorflow.python.keras.engine.functional", "ModuleWrapper") extern class ModuleWrapper {
	...
	**/
	@:native("__init__")
	public function ___init__(module:Dynamic, ?method_name:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
		Initializes the wrapper Layer for this module.
		...
		Raises:
		  ValueError: If `method` is not defined on `module`.
	**/
	public function new(module:Dynamic, ?method_name:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Void;
	/**
	...
	**/
	public function call(?args:python.VarArgs<Dynamic>, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
