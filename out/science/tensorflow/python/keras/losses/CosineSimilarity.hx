...
@:pythonImport("tensorflow.python.keras.losses", "CosineSimilarity") extern class CosineSimilarity {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(?axis:Dynamic, ?reduction:Dynamic, ?name:Dynamic):Dynamic;
	/**
		Initializes `LossFunctionWrapper` class.
		...
		Args:
		  ...
		  **kwargs: The keyword arguments that are passed on to `fn`.
	**/
	public function new(?axis:Dynamic, ?reduction:Dynamic, ?name:Dynamic):Void;
	/**
