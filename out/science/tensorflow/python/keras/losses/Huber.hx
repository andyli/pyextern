...
@:pythonImport("tensorflow.python.keras.losses", "Huber") extern class Huber {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(?delta:Dynamic, ?reduction:Dynamic, ?name:Dynamic):Dynamic;
	/**
		Initializes `Huber` instance.
		...
		Args:
		  ...
		  name: Optional name for the instance. Defaults to 'huber_loss'.
	**/
	public function new(?delta:Dynamic, ?reduction:Dynamic, ?name:Dynamic):Void;
	/**
