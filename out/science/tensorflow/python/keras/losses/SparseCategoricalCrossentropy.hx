...
@:pythonImport("tensorflow.python.keras.losses", "SparseCategoricalCrossentropy") extern class SparseCategoricalCrossentropy {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(?from_logits:Dynamic, ?reduction:Dynamic, ?name:Dynamic):Dynamic;
	/**
		Initializes `SparseCategoricalCrossentropy` instance.
		...
		Args:
		  ...
		  name: Optional name for the instance. Defaults to
		    'sparse_categorical_crossentropy'.
	**/
	public function new(?from_logits:Dynamic, ?reduction:Dynamic, ?name:Dynamic):Void;
	/**
