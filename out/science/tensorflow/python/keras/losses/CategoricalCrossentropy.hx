...
@:pythonImport("tensorflow.python.keras.losses", "CategoricalCrossentropy") extern class CategoricalCrossentropy {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(?from_logits:Dynamic, ?label_smoothing:Dynamic, ?axis:Dynamic, ?reduction:Dynamic, ?name:Dynamic):Dynamic;
	/**
		Initializes `CategoricalCrossentropy` instance.
		...
		Args:
		  ...
		  name: Optional name for the instance.
		    Defaults to 'categorical_crossentropy'.
	**/
	public function new(?from_logits:Dynamic, ?label_smoothing:Dynamic, ?axis:Dynamic, ?reduction:Dynamic, ?name:Dynamic):Void;
	/**
