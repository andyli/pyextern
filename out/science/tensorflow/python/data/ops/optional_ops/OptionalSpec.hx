...
@:pythonImport("tensorflow.python.data.ops.optional_ops", "OptionalSpec") extern class OptionalSpec {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(element_spec:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(element_spec:Dynamic):Void;
	/**
	...
	**/
	...
	/**
		...
		Returns:
		  A value that is compatible with this `TypeSpec`.
	**/
	public function _from_components(flat_value:Dynamic):Dynamic;
	/**
