...
@:pythonImport("tensorflow.python.data.ops.dataset_ops", "WindowDataset") extern class WindowDataset {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(input_dataset:Dynamic, size:Dynamic, shift:Dynamic, stride:Dynamic, drop_remainder:Dynamic, ?name:Dynamic):Dynamic;
	/**
		See `window()` for more details.
	**/
	public function new(input_dataset:Dynamic, size:Dynamic, shift:Dynamic, stride:Dynamic, drop_remainder:Dynamic, ?name:Dynamic):Void;
	/**
