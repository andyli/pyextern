...
@:pythonImport("tensorflow.python.data.ops.dataset_ops", "TensorSliceDataset") extern class TensorSliceDataset {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(element:Dynamic, ?is_files:Dynamic, ?name:Dynamic):Dynamic;
	/**
		See `Dataset.from_tensor_slices()` for details.
	**/
	public function new(element:Dynamic, ?is_files:Dynamic, ?name:Dynamic):Void;
	/**
