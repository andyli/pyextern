...
@:pythonImport("tensorflow.python.data.ops.dataset_ops", "_TakeWhileDataset") extern class _TakeWhileDataset {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(input_dataset:Dynamic, predicate:Dynamic, ?name:Dynamic):Dynamic;
	/**
		See `take_while()` for details.
	**/
	public function new(input_dataset:Dynamic, predicate:Dynamic, ?name:Dynamic):Void;
	/**
