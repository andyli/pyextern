...
@:pythonImport("tensorflow.python.data.ops.dataset_ops", "ShardDataset") extern class ShardDataset {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(input_dataset:Dynamic, num_shards:Dynamic, index:Dynamic, ?name:Dynamic):Dynamic;
	/**
		See `Dataset.shard()` for details.
	**/
	public function new(input_dataset:Dynamic, num_shards:Dynamic, index:Dynamic, ?name:Dynamic):Void;
	/**
