...
@:pythonImport("tensorflow.python.data.ops.dataset_ops", "RepeatDataset") extern class RepeatDataset {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(input_dataset:Dynamic, count:Dynamic, ?name:Dynamic):Dynamic;
	/**
		See `Dataset.repeat()` for details.
	**/
	public function new(input_dataset:Dynamic, count:Dynamic, ?name:Dynamic):Void;
	/**
