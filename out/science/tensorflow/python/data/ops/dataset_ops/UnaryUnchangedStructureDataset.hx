...
@:pythonImport("tensorflow.python.data.ops.dataset_ops", "UnaryUnchangedStructureDataset") extern class UnaryUnchangedStructureDataset {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(input_dataset:Dynamic, variant_tensor:Dynamic):Dynamic;
	/**
		Creates a DatasetV2 object.
		...
		Args:
		  variant_tensor: A DT_VARIANT tensor that represents the dataset.
	**/
	public function new(input_dataset:Dynamic, variant_tensor:Dynamic):Void;
	/**
