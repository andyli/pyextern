...
@:pythonImport("tensorflow.python.data.ops.dataset_ops", "DatasetSpec") extern class DatasetSpec {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(element_spec:Dynamic, ?dataset_shape:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(element_spec:Dynamic, ?dataset_shape:Dynamic):Void;
	/**
	...
	**/
	...
	public var _dataset_shape : Dynamic;
	/**
