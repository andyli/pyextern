...
@:pythonImport("tensorflow.python.data.ops.dataset_ops", "_SnapshotDataset") extern class _SnapshotDataset {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(input_dataset:Dynamic, path:Dynamic, shard_func:Dynamic, ?compression:Dynamic, ?reader_func:Dynamic, ?pending_snapshot_expiry_seconds:Dynamic, ?use_legacy_function:Dynamic, ?name:Dynamic):Dynamic;
	/**
		Creates a DatasetV2 object.
		...
		Args:
		  variant_tensor: A DT_VARIANT tensor that represents the dataset.
	**/
	public function new(input_dataset:Dynamic, path:Dynamic, shard_func:Dynamic, ?compression:Dynamic, ?reader_func:Dynamic, ?pending_snapshot_expiry_seconds:Dynamic, ?use_legacy_function:Dynamic, ?name:Dynamic):Void;
	/**
