...
@:pythonImport("tensorflow.python.data.ops.dataset_ops", "_VariantTracker") extern class _VariantTracker {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(variant_tensor:Dynamic, resource_creator:Dynamic):Dynamic;
	/**
		Record that `variant_tensor` is associated with `resource_creator`.
		...
		Args:
		  ...
		  resource_creator: A zero-argument function which creates a new
		    ...
		    run to re-create the Dataset's variant Tensor on restore.
	**/
	public function new(variant_tensor:Dynamic, resource_creator:Dynamic):Void;
	/**
