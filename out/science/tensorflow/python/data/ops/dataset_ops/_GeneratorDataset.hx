...
@:pythonImport("tensorflow.python.data.ops.dataset_ops", "_GeneratorDataset") extern class _GeneratorDataset {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(init_args:Dynamic, init_func:Dynamic, next_func:Dynamic, finalize_func:Dynamic, output_signature:Dynamic, ?name:Dynamic):Dynamic;
	/**
		Constructs a `_GeneratorDataset`.
		...
		Args:
		  ...
		  name: Optional. A name for the tf.data transformation.
	**/
	public function new(init_args:Dynamic, init_func:Dynamic, next_func:Dynamic, finalize_func:Dynamic, output_signature:Dynamic, ?name:Dynamic):Void;
	/**
