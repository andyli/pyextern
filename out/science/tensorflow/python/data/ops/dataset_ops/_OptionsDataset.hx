...
@:pythonImport("tensorflow.python.data.ops.dataset_ops", "_OptionsDataset") extern class _OptionsDataset {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(input_dataset:Dynamic, options:Dynamic, ?name:Dynamic):Dynamic;
	/**
		Creates a DatasetV2 object.
		...
		Args:
		  variant_tensor: A DT_VARIANT tensor that represents the dataset.
	**/
	public function new(input_dataset:Dynamic, options:Dynamic, ?name:Dynamic):Void;
	/**
