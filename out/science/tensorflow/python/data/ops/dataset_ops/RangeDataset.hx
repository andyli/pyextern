...
@:pythonImport("tensorflow.python.data.ops.dataset_ops", "RangeDataset") extern class RangeDataset {
	/**
	...
	**/
	...
	public function _build_tensor(int64_value:Dynamic, name:Dynamic):Dynamic;
	/**
	...
	**/
	public function _parse_args(?args:python.VarArgs<Dynamic>, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
