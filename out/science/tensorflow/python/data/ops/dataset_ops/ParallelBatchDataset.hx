...
@:pythonImport("tensorflow.python.data.ops.dataset_ops", "ParallelBatchDataset") extern class ParallelBatchDataset {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(input_dataset:Dynamic, batch_size:Dynamic, drop_remainder:Dynamic, num_parallel_calls:Dynamic, deterministic:Dynamic, ?name:Dynamic):Dynamic;
	/**
		See `Dataset.batch()` for details.
	**/
	public function new(input_dataset:Dynamic, batch_size:Dynamic, drop_remainder:Dynamic, num_parallel_calls:Dynamic, deterministic:Dynamic, ?name:Dynamic):Void;
	/**
