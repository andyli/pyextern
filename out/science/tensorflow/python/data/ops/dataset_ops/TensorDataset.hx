...
@:pythonImport("tensorflow.python.data.ops.dataset_ops", "TensorDataset") extern class TensorDataset {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(element:Dynamic, ?name:Dynamic):Dynamic;
	/**
		See `Dataset.from_tensors()` for details.
	**/
	public function new(element:Dynamic, ?name:Dynamic):Void;
	/**
