...
@:pythonImport("tensorflow.python.data.ops.dataset_ops", "CacheDataset") extern class CacheDataset {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(input_dataset:Dynamic, filename:Dynamic, ?name:Dynamic):Dynamic;
	/**
		See `Dataset.cache()` for details.
	**/
	public function new(input_dataset:Dynamic, filename:Dynamic, ?name:Dynamic):Void;
	/**
