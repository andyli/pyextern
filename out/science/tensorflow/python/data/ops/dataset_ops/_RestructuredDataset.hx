...
@:pythonImport("tensorflow.python.data.ops.dataset_ops", "_RestructuredDataset") extern class _RestructuredDataset {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(dataset:Dynamic, structure:Dynamic):Dynamic;
	/**
		Creates a DatasetV2 object.
		...
		Args:
		  variant_tensor: A DT_VARIANT tensor that represents the dataset.
	**/
	public function new(dataset:Dynamic, structure:Dynamic):Void;
	/**
