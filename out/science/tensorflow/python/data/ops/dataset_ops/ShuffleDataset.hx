...
@:pythonImport("tensorflow.python.data.ops.dataset_ops", "ShuffleDataset") extern class ShuffleDataset {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(input_dataset:Dynamic, buffer_size:Dynamic, ?seed:Dynamic, ?reshuffle_each_iteration:Dynamic, ?name:Dynamic):Dynamic;
	/**
		See `Dataset.shuffle()` for details.
	**/
	public function new(input_dataset:Dynamic, buffer_size:Dynamic, ?seed:Dynamic, ?reshuffle_each_iteration:Dynamic, ?name:Dynamic):Void;
	/**
