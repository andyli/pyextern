...
@:pythonImport("tensorflow.python.data.ops.dataset_ops", "FlatMapDataset") extern class FlatMapDataset {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(input_dataset:Dynamic, map_func:Dynamic, ?name:Dynamic):Dynamic;
	/**
		See `Dataset.flat_map()` for details.
	**/
	public function new(input_dataset:Dynamic, map_func:Dynamic, ?name:Dynamic):Void;
	/**
