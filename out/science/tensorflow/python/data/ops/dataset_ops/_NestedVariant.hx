...
@:pythonImport("tensorflow.python.data.ops.dataset_ops", "_NestedVariant") extern class _NestedVariant {
	...
	**/
	@:native("__init__")
	public function ___init__(variant_tensor:Dynamic, element_spec:Dynamic, dataset_shape:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(variant_tensor:Dynamic, element_spec:Dynamic, dataset_shape:Dynamic):Void;
	/**
