...
@:pythonImport("tensorflow.python.data.ops.dataset_ops", "_ScanDataset") extern class _ScanDataset {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(input_dataset:Dynamic, initial_state:Dynamic, scan_func:Dynamic, ?use_default_device:Dynamic, ?name:Dynamic):Dynamic;
	/**
		See `scan()` for details.
	**/
	public function new(input_dataset:Dynamic, initial_state:Dynamic, scan_func:Dynamic, ?use_default_device:Dynamic, ?name:Dynamic):Void;
	/**
