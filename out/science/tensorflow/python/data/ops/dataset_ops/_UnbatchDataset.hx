...
@:pythonImport("tensorflow.python.data.ops.dataset_ops", "_UnbatchDataset") extern class _UnbatchDataset {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(input_dataset:Dynamic, ?name:Dynamic):Dynamic;
	/**
		See `unbatch()` for more details.
	**/
	public function new(input_dataset:Dynamic, ?name:Dynamic):Void;
	/**
