...
@:pythonImport("tensorflow.python.data.ops.dataset_ops", "FilterDataset") extern class FilterDataset {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(input_dataset:Dynamic, predicate:Dynamic, ?use_legacy_function:Dynamic, ?name:Dynamic):Dynamic;
	/**
		See `Dataset.filter()` for details.
	**/
	public function new(input_dataset:Dynamic, predicate:Dynamic, ?use_legacy_function:Dynamic, ?name:Dynamic):Void;
	/**
