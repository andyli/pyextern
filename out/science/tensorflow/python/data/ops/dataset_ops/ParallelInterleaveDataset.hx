...
@:pythonImport("tensorflow.python.data.ops.dataset_ops", "ParallelInterleaveDataset") extern class ParallelInterleaveDataset {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(input_dataset:Dynamic, map_func:Dynamic, cycle_length:Dynamic, block_length:Dynamic, num_parallel_calls:Dynamic, ?buffer_output_elements:Dynamic, ?prefetch_input_elements:Dynamic, ?deterministic:Dynamic, ?name:Dynamic):Dynamic;
	/**
		See `Dataset.interleave()` for details.
	**/
	public function new(input_dataset:Dynamic, map_func:Dynamic, cycle_length:Dynamic, block_length:Dynamic, num_parallel_calls:Dynamic, ?buffer_output_elements:Dynamic, ?prefetch_input_elements:Dynamic, ?deterministic:Dynamic, ?name:Dynamic):Void;
	/**
