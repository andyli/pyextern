...
@:pythonImport("tensorflow.python.data.ops.dataset_ops", "DatasetSource") extern class DatasetSource {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(variant_tensor:Dynamic):Dynamic;
	/**
		Creates a DatasetV2 object.
		...
		Args:
		  variant_tensor: A DT_VARIANT tensor that represents the dataset.
	**/
	public function new(variant_tensor:Dynamic):Void;
	/**
