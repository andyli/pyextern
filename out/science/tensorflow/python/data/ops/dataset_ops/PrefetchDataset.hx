...
@:pythonImport("tensorflow.python.data.ops.dataset_ops", "PrefetchDataset") extern class PrefetchDataset {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(input_dataset:Dynamic, buffer_size:Dynamic, ?slack_period:Dynamic, ?name:Dynamic):Dynamic;
	/**
		See `Dataset.prefetch()` for details.
	**/
	public function new(input_dataset:Dynamic, buffer_size:Dynamic, ?slack_period:Dynamic, ?name:Dynamic):Void;
	/**
