...
@:pythonImport("tensorflow.python.data.ops.dataset_ops", "PaddedBatchDataset") extern class PaddedBatchDataset {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(input_dataset:Dynamic, batch_size:Dynamic, padded_shapes:Dynamic, padding_values:Dynamic, drop_remainder:Dynamic, ?name:Dynamic):Dynamic;
	/**
		See `Dataset.batch()` for details.
	**/
	public function new(input_dataset:Dynamic, batch_size:Dynamic, padded_shapes:Dynamic, padding_values:Dynamic, drop_remainder:Dynamic, ?name:Dynamic):Void;
	/**
