...
@:pythonImport("tensorflow.python.data.ops.dataset_ops", "_DirectedInterleaveDataset") extern class _DirectedInterleaveDataset {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(selector_input:Dynamic, data_inputs:Dynamic, ?stop_on_empty_dataset:Dynamic):Dynamic;
	/**
		Creates a DatasetV2 object.
		...
		Args:
		  variant_tensor: A DT_VARIANT tensor that represents the dataset.
	**/
	public function new(selector_input:Dynamic, data_inputs:Dynamic, ?stop_on_empty_dataset:Dynamic):Void;
	/**
