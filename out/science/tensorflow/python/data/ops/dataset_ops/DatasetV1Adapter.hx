...
@:pythonImport("tensorflow.python.data.ops.dataset_ops", "DatasetV1Adapter") extern class DatasetV1Adapter {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(dataset:Dynamic):Dynamic;
	/**
		Creates a DatasetV2 object.
		...
		Args:
		  variant_tensor: A DT_VARIANT tensor that represents the dataset.
	**/
	public function new(dataset:Dynamic):Void;
	/**
