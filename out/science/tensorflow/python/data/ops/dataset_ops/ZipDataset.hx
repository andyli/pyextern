...
@:pythonImport("tensorflow.python.data.ops.dataset_ops", "ZipDataset") extern class ZipDataset {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(datasets:Dynamic, ?name:Dynamic):Dynamic;
	/**
		See `Dataset.zip()` for details.
	**/
	public function new(datasets:Dynamic, ?name:Dynamic):Void;
	/**
