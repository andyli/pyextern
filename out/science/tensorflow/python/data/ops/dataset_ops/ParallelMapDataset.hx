...
@:pythonImport("tensorflow.python.data.ops.dataset_ops", "ParallelMapDataset") extern class ParallelMapDataset {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(input_dataset:Dynamic, map_func:Dynamic, num_parallel_calls:Dynamic, deterministic:Dynamic, ?use_inter_op_parallelism:Dynamic, ?preserve_cardinality:Dynamic, ?use_legacy_function:Dynamic, ?name:Dynamic):Dynamic;
	/**
		See `Dataset.map()` for details.
	**/
	public function new(input_dataset:Dynamic, map_func:Dynamic, num_parallel_calls:Dynamic, deterministic:Dynamic, ?use_inter_op_parallelism:Dynamic, ?preserve_cardinality:Dynamic, ?use_legacy_function:Dynamic, ?name:Dynamic):Void;
	/**
