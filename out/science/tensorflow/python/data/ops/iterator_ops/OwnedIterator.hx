...
@:pythonImport("tensorflow.python.data.ops.iterator_ops", "OwnedIterator") extern class OwnedIterator {
	...
	**/
	@:native("__init__")
	public function ___init__(?dataset:Dynamic, ?components:Dynamic, ?element_spec:Dynamic):Dynamic;
	/**
		Creates a new iterator from the given dataset.
		...
		Raises:
		  ValueError: If `dataset` is not provided and either `components` or
		    ...
		    `components` and `element_spec` is provided.
	**/
	public function new(?dataset:Dynamic, ?components:Dynamic, ?element_spec:Dynamic):Void;
	/**
	...
	**/
	...
	public function _create_iterator(dataset:Dynamic):Dynamic;
	/**
	...
	**/
	...
	public function _next_internal():Dynamic;
	/**
