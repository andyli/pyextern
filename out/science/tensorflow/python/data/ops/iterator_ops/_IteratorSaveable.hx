...
@:pythonImport("tensorflow.python.data.ops.iterator_ops", "_IteratorSaveable") extern class _IteratorSaveable {
	...
	**/
	@:native("__init__")
	public function ___init__(iterator_resource:Dynamic, name:Dynamic, ?external_state_policy:Dynamic):Dynamic;
	/**
		Creates a `SaveableObject` object.
		...
		Args:
		  ...
		  name: the name to save the object under.
	**/
	public function new(iterator_resource:Dynamic, name:Dynamic, ?external_state_policy:Dynamic):Void;
	/**
