...
@:pythonImport("tensorflow.python.data.ops.readers", "FixedLengthRecordDatasetV1") extern class FixedLengthRecordDatasetV1 {
	...
	**/
	@:native("__init__")
	public function ___init__(filenames:Dynamic, record_bytes:Dynamic, ?header_bytes:Dynamic, ?footer_bytes:Dynamic, ?buffer_size:Dynamic, ?compression_type:Dynamic, ?num_parallel_reads:Dynamic, ?name:Dynamic):Dynamic;
	/**
		Creates a `FixedLengthRecordDataset`.
		...
		Args:
		  ...
		  name: (Optional.) A name for the tf.data operation.
	**/
	public function new(filenames:Dynamic, record_bytes:Dynamic, ?header_bytes:Dynamic, ?footer_bytes:Dynamic, ?buffer_size:Dynamic, ?compression_type:Dynamic, ?num_parallel_reads:Dynamic, ?name:Dynamic):Void;
	/**
