...
@:pythonImport("tensorflow.python.data.ops.readers", "ParallelInterleaveDataset") extern class ParallelInterleaveDataset {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(input_dataset:Dynamic, map_func:Dynamic, cycle_length:Dynamic, block_length:Dynamic, sloppy:Dynamic, buffer_output_elements:Dynamic, prefetch_input_elements:Dynamic, ?name:Dynamic):Dynamic;
	/**
		See `tf.data.experimental.parallel_interleave()` for details.
	**/
	public function new(input_dataset:Dynamic, map_func:Dynamic, cycle_length:Dynamic, block_length:Dynamic, sloppy:Dynamic, buffer_output_elements:Dynamic, prefetch_input_elements:Dynamic, ?name:Dynamic):Void;
	/**
