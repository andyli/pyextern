...
@:pythonImport("tensorflow.python.data.ops.readers", "_FixedLengthRecordDataset") extern class _FixedLengthRecordDataset {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(filenames:Dynamic, record_bytes:Dynamic, ?header_bytes:Dynamic, ?footer_bytes:Dynamic, ?buffer_size:Dynamic, ?compression_type:Dynamic, ?name:Dynamic):Dynamic;
	/**
		Creates a `FixedLengthRecordDataset`.
		...
		Args:
		  ...
		  name: (Optional.) A name for the tf.data operation.
	**/
	public function new(filenames:Dynamic, record_bytes:Dynamic, ?header_bytes:Dynamic, ?footer_bytes:Dynamic, ?buffer_size:Dynamic, ?compression_type:Dynamic, ?name:Dynamic):Void;
	/**
