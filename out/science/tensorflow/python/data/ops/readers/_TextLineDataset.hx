...
@:pythonImport("tensorflow.python.data.ops.readers", "_TextLineDataset") extern class _TextLineDataset {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(filenames:Dynamic, ?compression_type:Dynamic, ?buffer_size:Dynamic, ?name:Dynamic):Dynamic;
	/**
		Creates a `TextLineDataset`.
		...
		Args:
		  ...
		  name: (Optional.) A name for the tf.data operation.
	**/
	public function new(filenames:Dynamic, ?compression_type:Dynamic, ?buffer_size:Dynamic, ?name:Dynamic):Void;
	/**
