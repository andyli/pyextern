...
@:pythonImport("tensorflow.python.data.ops.readers", "TextLineDatasetV1") extern class TextLineDatasetV1 {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(filenames:Dynamic, ?compression_type:Dynamic, ?buffer_size:Dynamic, ?num_parallel_reads:Dynamic, ?name:Dynamic):Dynamic;
	/**
		Creates a `TextLineDataset`.
		...
		Args:
		  ...
		  name: (Optional.) A name for the tf.data operation.
	**/
	public function new(filenames:Dynamic, ?compression_type:Dynamic, ?buffer_size:Dynamic, ?num_parallel_reads:Dynamic, ?name:Dynamic):Void;
	/**
