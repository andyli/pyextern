...
@:pythonImport("tensorflow.python.data.ops.multi_device_iterator_ops", "_ReincarnatedPerDeviceGenerator") extern class _ReincarnatedPerDeviceGenerator {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(per_device_dataset:Dynamic, incarnation_id:Dynamic):Dynamic;
	/**
		Creates a DatasetV2 object.
		...
		Args:
		  variant_tensor: A DT_VARIANT tensor that represents the dataset.
	**/
	public function new(per_device_dataset:Dynamic, incarnation_id:Dynamic):Void;
	/**
