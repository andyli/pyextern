...
@:pythonImport("tensorflow.python.data.ops.multi_device_iterator_ops", "_PerDeviceGenerator") extern class _PerDeviceGenerator {
	...
	**/
	@:native("__init__")
	public function ___init__(shard_num:Dynamic, multi_device_iterator_resource:Dynamic, incarnation_id:Dynamic, source_device:Dynamic, element_spec:Dynamic):Dynamic;
	/**
		Creates a DatasetV2 object.
		...
		Args:
		  variant_tensor: A DT_VARIANT tensor that represents the dataset.
	**/
	public function new(shard_num:Dynamic, multi_device_iterator_resource:Dynamic, incarnation_id:Dynamic, source_device:Dynamic, element_spec:Dynamic):Void;
	/**
