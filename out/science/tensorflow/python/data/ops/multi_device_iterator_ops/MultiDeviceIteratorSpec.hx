...
@:pythonImport("tensorflow.python.data.ops.multi_device_iterator_ops", "MultiDeviceIteratorSpec") extern class MultiDeviceIteratorSpec {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(devices:Dynamic, source_device:Dynamic, element_spec:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(devices:Dynamic, source_device:Dynamic, element_spec:Dynamic):Void;
	/**
	...
	**/
	...
	public var _source_device : Dynamic;
