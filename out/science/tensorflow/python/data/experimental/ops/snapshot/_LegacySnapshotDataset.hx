...
@:pythonImport("tensorflow.python.data.experimental.ops.snapshot", "_LegacySnapshotDataset") extern class _LegacySnapshotDataset {
	/**
	...
	**/
	...
	/**
		...
		Args:
		  variant_tensor: A DT_VARIANT tensor that represents the dataset.
	**/
	public function new(input_dataset:Dynamic, path:Dynamic, ?compression:Dynamic, ?reader_path_prefix:Dynamic, ?writer_path_prefix:Dynamic, ?shard_size_bytes:Dynamic, ?pending_snapshot_expiry_seconds:Dynamic, ?num_reader_threads:Dynamic, ?reader_buffer_size:Dynamic, ?num_writer_threads:Dynamic, ?writer_buffer_size:Dynamic, ?shuffle_on_read:Dynamic, ?shuffle_seed:Dynamic, ?mode:Dynamic, ?snapshot_name:Dynamic):Void;
	/**
