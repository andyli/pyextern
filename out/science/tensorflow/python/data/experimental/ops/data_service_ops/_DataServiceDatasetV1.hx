...
@:pythonImport("tensorflow.python.data.experimental.ops.data_service_ops", "_DataServiceDatasetV1") extern class _DataServiceDatasetV1 {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(dataset_id:Dynamic, processing_mode:Dynamic, address:Dynamic, element_spec:Dynamic, protocol:Dynamic, data_transfer_protocol:Dynamic, ?job_name:Dynamic, ?consumer_index:Dynamic, ?num_consumers:Dynamic, ?max_outstanding_requests:Dynamic, ?task_refresh_interval_hint_ms:Dynamic, ?target_workers:Dynamic):Dynamic;
	/**
		Constructs a _DataServiceDatasetV2.
		...
		Args:
		  ...
		  target_workers: (Optional.) Which workers to read from. If `"AUTO"`,
		    ...
		    `target_workers`. Defaults to `"AUTO"`.
	**/
	public function new(dataset_id:Dynamic, processing_mode:Dynamic, address:Dynamic, element_spec:Dynamic, protocol:Dynamic, data_transfer_protocol:Dynamic, ?job_name:Dynamic, ?consumer_index:Dynamic, ?num_consumers:Dynamic, ?max_outstanding_requests:Dynamic, ?task_refresh_interval_hint_ms:Dynamic, ?target_workers:Dynamic):Void;
	/**
	...
	/**
		...
		Returns:
		  Dataset: The `Dataset` containing the elements of this dataset for which
		      `predicate` is `True`.
	**/
	public function filter_with_legacy_function(predicate:Dynamic):Dynamic;
	/**
	...
	**/
	...
	/**
		...
		Returns:
		  Dataset: A `Dataset`.
	**/
	public function map_with_legacy_function(map_func:Dynamic, ?num_parallel_calls:Dynamic, ?deterministic:Dynamic):Dynamic;
	/**
