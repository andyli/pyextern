...
@:pythonImport("tensorflow.python.data.experimental.ops.io", "_SaveDataset") extern class _SaveDataset {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(dataset:Dynamic, path:Dynamic, shard_func:Dynamic, compression:Dynamic):Dynamic;
	/**
		Creates a DatasetV2 object.
		...
		Args:
		  variant_tensor: A DT_VARIANT tensor that represents the dataset.
	**/
	public function new(dataset:Dynamic, path:Dynamic, shard_func:Dynamic, compression:Dynamic):Void;
	/**
