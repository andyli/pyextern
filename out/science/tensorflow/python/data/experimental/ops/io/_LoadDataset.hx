...
@:pythonImport("tensorflow.python.data.experimental.ops.io", "_LoadDataset") extern class _LoadDataset {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(path:Dynamic, ?element_spec:Dynamic, ?compression:Dynamic, ?reader_func:Dynamic):Dynamic;
	/**
		Creates a DatasetV2 object.
		...
		Args:
		  variant_tensor: A DT_VARIANT tensor that represents the dataset.
	**/
	public function new(path:Dynamic, ?element_spec:Dynamic, ?compression:Dynamic, ?reader_func:Dynamic):Void;
	/**
