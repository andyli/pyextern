...
@:pythonImport("tensorflow.python.data.experimental.ops.error_ops", "_IgnoreErrorsDataset") extern class _IgnoreErrorsDataset {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(input_dataset:Dynamic, log_warning:Dynamic):Dynamic;
	/**
		See `Dataset.ignore_errors()` for details.
	**/
	public function new(input_dataset:Dynamic, log_warning:Dynamic):Void;
	/**
