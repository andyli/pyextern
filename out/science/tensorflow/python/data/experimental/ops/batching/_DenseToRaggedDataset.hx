...
@:pythonImport("tensorflow.python.data.experimental.ops.batching", "_DenseToRaggedDataset") extern class _DenseToRaggedDataset {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(input_dataset:Dynamic, row_splits_dtype:Dynamic):Dynamic;
	/**
		Constructs a new _DenseToRaggedDataset.
		...
		Args:
		  ...
		  row_splits_dtype: The dtype that should be used for the `row_splits` of
		    ...
		    have their row_splits dtype changed.
	**/
	public function new(input_dataset:Dynamic, row_splits_dtype:Dynamic):Void;
	/**
