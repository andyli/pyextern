...
@:pythonImport("tensorflow.python.data.experimental.ops.batching", "_DenseToSparseBatchDataset") extern class _DenseToSparseBatchDataset {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(input_dataset:Dynamic, batch_size:Dynamic, row_shape:Dynamic):Dynamic;
	/**
		See `Dataset.dense_to_sparse_batch()` for more details.
	**/
	public function new(input_dataset:Dynamic, batch_size:Dynamic, row_shape:Dynamic):Void;
	/**
