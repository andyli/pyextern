...
@:pythonImport("tensorflow.python.data.experimental.ops.cardinality", "_AssertCardinalityDataset") extern class _AssertCardinalityDataset {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(input_dataset:Dynamic, expected_cardinality:Dynamic):Dynamic;
	/**
		Creates a DatasetV2 object.
		...
		Args:
		  variant_tensor: A DT_VARIANT tensor that represents the dataset.
	**/
	public function new(input_dataset:Dynamic, expected_cardinality:Dynamic):Void;
	/**
