...
@:pythonImport("tensorflow.python.data.experimental.ops.parsing_ops", "_ParseExampleDataset") extern class _ParseExampleDataset {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(input_dataset:Dynamic, features:Dynamic, num_parallel_calls:Dynamic, deterministic:Dynamic):Dynamic;
	/**
		Creates a DatasetV2 object.
		...
		Args:
		  variant_tensor: A DT_VARIANT tensor that represents the dataset.
	**/
	public function new(input_dataset:Dynamic, features:Dynamic, num_parallel_calls:Dynamic, deterministic:Dynamic):Void;
	/**
