...
package tensorflow.python.data.experimental.ops.matching_files;
@:pythonImport("tensorflow.python.data.experimental.ops.matching_files", "MatchingFilesDataset") extern class MatchingFilesDataset {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(patterns:Dynamic):Dynamic;
	/**
		Creates a DatasetV2 object.
		...
		Args:
		  variant_tensor: A DT_VARIANT tensor that represents the dataset.
	**/
	public function new(patterns:Dynamic):Void;
	/**
