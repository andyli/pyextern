...
@:pythonImport("tensorflow.python.data.experimental.ops.readers", "SqlDatasetV1") extern class SqlDatasetV1 {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(driver_name:Dynamic, data_source_name:Dynamic, query:Dynamic, output_types:Dynamic):Dynamic;
	/**
		Creates a `SqlDataset`.
		...
		Args:
		  ...
		  output_types: A tuple of `tf.DType` objects representing the types of the
		    columns returned by `query`.
	**/
	public function new(driver_name:Dynamic, data_source_name:Dynamic, query:Dynamic, output_types:Dynamic):Void;
	/**
