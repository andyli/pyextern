...
@:pythonImport("tensorflow.python.data.experimental.ops.readers", "CsvDatasetV1") extern class CsvDatasetV1 {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(filenames:Dynamic, record_defaults:Dynamic, ?compression_type:Dynamic, ?buffer_size:Dynamic, ?header:Dynamic, ?field_delim:Dynamic, ?use_quote_delim:Dynamic, ?na_value:Dynamic, ?select_cols:Dynamic, ?exclude_cols:Dynamic):Dynamic;
	/**
		Creates a `CsvDataset` by reading and decoding CSV files.
		...
		Args:
		  ...
		  select_cols: (Optional.) A sorted list of column indices to select from
		    ...
		    and `exclude_cols` can be specified.
	**/
	public function new(filenames:Dynamic, record_defaults:Dynamic, ?compression_type:Dynamic, ?buffer_size:Dynamic, ?header:Dynamic, ?field_delim:Dynamic, ?use_quote_delim:Dynamic, ?na_value:Dynamic, ?select_cols:Dynamic, ?exclude_cols:Dynamic):Void;
	/**
