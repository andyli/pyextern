...
package tensorflow.python.data.experimental.ops.random_ops;
@:pythonImport("tensorflow.python.data.experimental.ops.random_ops", "RandomDatasetV1") extern class RandomDatasetV1 {
	/**
	...
	**/
	...
	/**
		A `Dataset` of pseudorandom values. (deprecated) (deprecated)
	...
	**/
	@:native("__init__")
	public function ___init__(?seed:Dynamic, ?name:Dynamic):Dynamic;
	/**
		A `Dataset` of pseudorandom values. (deprecated) (deprecated)
		...
		Use `tf.data.Dataset.random(...)`.
	**/
	public function new(?seed:Dynamic, ?name:Dynamic):Void;
	/**
