...
@:pythonImport("tensorflow.python.data.experimental.ops.distribute", "_LegacyRebatchDataset") extern class _LegacyRebatchDataset {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(input_dataset:Dynamic, num_replicas:Dynamic):Dynamic;
	/**
		Creates a _LegacyRebatchDataset.
		...
		Args:
		  ...
		  num_replicas: A `tf.int64` scalar, representing the number of sub-batches
		    to split each batch from `input_dataset` into.
	**/
	public function new(input_dataset:Dynamic, num_replicas:Dynamic):Void;
	/**
