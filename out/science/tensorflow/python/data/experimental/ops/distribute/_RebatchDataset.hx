...
@:pythonImport("tensorflow.python.data.experimental.ops.distribute", "_RebatchDataset") extern class _RebatchDataset {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(input_dataset:Dynamic, batch_sizes:Dynamic, ?drop_remainder:Dynamic):Dynamic;
	/**
		Creates a _RebatchDataset.
		...
		Args:
		  ...
		  drop_remainder: (Optional.) A `tf.bool` scalar `tf.Tensor`, representing
		    ...
		    the smaller batch.
	**/
	public function new(input_dataset:Dynamic, batch_sizes:Dynamic, ?drop_remainder:Dynamic):Void;
	/**
	...
	**/
	...
	/**
		...
		Raises:
		  ...
		  other.
	**/
	public function _compute_static_batch_dim():Dynamic;
	/**
	...
	**/
	public function _may_form_partial_batches(desired_batch_size:Dynamic):Dynamic;
	/**
