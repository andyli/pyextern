...
@:pythonImport("tensorflow.python.data.experimental.ops.distribute", "_AutoShardDataset") extern class _AutoShardDataset {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(input_dataset:Dynamic, num_workers:Dynamic, index:Dynamic, ?num_replicas:Dynamic):Dynamic;
	/**
		Creates a DatasetV2 object.
		...
		Args:
		  variant_tensor: A DT_VARIANT tensor that represents the dataset.
	**/
	public function new(input_dataset:Dynamic, num_workers:Dynamic, index:Dynamic, ?num_replicas:Dynamic):Void;
	/**
