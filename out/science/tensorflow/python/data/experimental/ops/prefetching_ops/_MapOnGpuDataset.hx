...
@:pythonImport("tensorflow.python.data.experimental.ops.prefetching_ops", "_MapOnGpuDataset") extern class _MapOnGpuDataset {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(input_dataset:Dynamic, map_func:Dynamic, ?use_inter_op_parallelism:Dynamic):Dynamic;
	/**
		See `Dataset.map()` for details.
	**/
	public function new(input_dataset:Dynamic, map_func:Dynamic, ?use_inter_op_parallelism:Dynamic):Void;
	/**
