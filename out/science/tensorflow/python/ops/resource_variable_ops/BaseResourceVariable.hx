...
@:pythonImport("tensorflow.python.ops.resource_variable_ops", "BaseResourceVariable") extern class BaseResourceVariable {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(?trainable:Dynamic, ?shape:Dynamic, ?dtype:Dynamic, ?handle:Dynamic, ?constraint:Dynamic, ?synchronization:Dynamic, ?aggregation:Dynamic, ?distribute_strategy:Dynamic, ?name:Dynamic, ?unique_id:Dynamic, ?handle_name:Dynamic, ?graph_element:Dynamic, ?initial_value:Dynamic, ?initializer_op:Dynamic, ?is_initialized_op:Dynamic, ?cached_value:Dynamic, ?save_slice_info:Dynamic, ?handle_deleter:Dynamic, ?caching_device:Dynamic, ?in_graph_mode:Dynamic, ?unused_kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
		Creates a variable from a handle.
		...
		Args:
		  ...
		  in_graph_mode: whether we are executing in TF1 graph mode. If None, will
		    ...
		    conetxt entrances which can add up.
	**/
	public function new(?trainable:Dynamic, ?shape:Dynamic, ?dtype:Dynamic, ?handle:Dynamic, ?constraint:Dynamic, ?synchronization:Dynamic, ?aggregation:Dynamic, ?distribute_strategy:Dynamic, ?name:Dynamic, ?unique_id:Dynamic, ?handle_name:Dynamic, ?graph_element:Dynamic, ?initial_value:Dynamic, ?initializer_op:Dynamic, ?is_initialized_op:Dynamic, ?cached_value:Dynamic, ?save_slice_info:Dynamic, ?handle_deleter:Dynamic, ?caching_device:Dynamic, ?in_graph_mode:Dynamic, ?unused_kwargs:python.KwArgs<Dynamic>):Void;
	/**
	...
	**/
	...
	public function __tf_function_cache_spec__():Dynamic;
	public function __tf_resource_id__():Dynamic;
	/**
		Divides x / y elementwise (using Python 3 division operator semantics).
	...
	**/
	...
	/**
		...
		Returns:
		  The updated variable.
	**/
	public function scatter_nd_max(indices:Dynamic, updates:Dynamic, ?name:Dynamic):Dynamic;
	/**
		Updates this variable with the min of `tf.IndexedSlices` and itself.
		...
		Returns:
		  The updated variable.
	**/
	public function scatter_nd_min(indices:Dynamic, updates:Dynamic, ?name:Dynamic):Dynamic;
	/**
