...
@:pythonImport("tensorflow.python.ops.resource_variable_ops", "UninitializedVariable") extern class UninitializedVariable {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(?trainable:Dynamic, ?caching_device:Dynamic, ?name:Dynamic, ?shape:Dynamic, ?dtype:Dynamic, ?constraint:Dynamic, ?synchronization:Dynamic, ?aggregation:Dynamic, ?extra_handle_data:Dynamic, ?distribute_strategy:Dynamic, ?unused_kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
		Creates the variable handle.
		...
		Args:
		  ...
		  distribute_strategy: The tf.distribute.Strategy this variable is being
		    created inside of.
	**/
	public function new(?trainable:Dynamic, ?caching_device:Dynamic, ?name:Dynamic, ?shape:Dynamic, ?dtype:Dynamic, ?constraint:Dynamic, ?synchronization:Dynamic, ?aggregation:Dynamic, ?extra_handle_data:Dynamic, ?distribute_strategy:Dynamic, ?unused_kwargs:python.KwArgs<Dynamic>):Void;
	/**
