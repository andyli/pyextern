...
@:pythonImport("tensorflow.python.ops.boosted_trees_ops", "QuantileAccumulatorSaveable") extern class QuantileAccumulatorSaveable {
	...
	**/
	@:native("__init__")
	public function ___init__(resource_handle:Dynamic, create_op:Dynamic, num_streams:Dynamic, name:Dynamic):Dynamic;
	/**
		Creates a `SaveableObject` object.
		...
		Args:
		  ...
		  name: the name to save the object under.
	**/
	public function new(resource_handle:Dynamic, create_op:Dynamic, num_streams:Dynamic, name:Dynamic):Void;
	/**
