...
@:pythonImport("tensorflow.python.ops.gen_io_ops") extern class Gen_io_ops_Module {
	...
	**/
	static public function _dispatcher_for_matching_files(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
		Dispatch(self: tensorflow.python.framework._pywrap_python_api_dispatcher.PythonAPIDispatcher, arg0: handle, arg1: handle) -> object
	**/
	static public function _dispatcher_for_write_file(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
