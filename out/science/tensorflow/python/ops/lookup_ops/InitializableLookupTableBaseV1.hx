...
@:pythonImport("tensorflow.python.ops.lookup_ops", "InitializableLookupTableBaseV1") extern class InitializableLookupTableBaseV1 {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(default_value:Dynamic, initializer:Dynamic):Dynamic;
	/**
		Construct a table object from a table reference.
		...
		Args:
		  ...
		  initializer: The table initializer to use.
	**/
	public function new(default_value:Dynamic, initializer:Dynamic):Void;
	/**
