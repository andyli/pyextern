...
@:pythonImport("tensorflow.python.ops.lookup_ops", "TextFileInitializer") extern class TextFileInitializer {
	...
	**/
	@:native("__init__")
	public function ___init__(filename:Dynamic, key_dtype:Dynamic, key_index:Dynamic, value_dtype:Dynamic, value_index:Dynamic, ?vocab_size:Dynamic, ?delimiter:Dynamic, ?name:Dynamic, ?value_index_offset:Dynamic):Dynamic;
	/**
		Constructs a table initializer object to populate from a text file.
		...
		Raises:
		  ...
		  data types do not match the expected data types.
	**/
	public function new(filename:Dynamic, key_dtype:Dynamic, key_index:Dynamic, value_dtype:Dynamic, value_index:Dynamic, ?vocab_size:Dynamic, ?delimiter:Dynamic, ?name:Dynamic, ?value_index_offset:Dynamic):Void;
	/**
