...
@:pythonImport("tensorflow.python.ops.lookup_ops", "MutableHashTable") extern class MutableHashTable {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(key_dtype:Dynamic, value_dtype:Dynamic, default_value:Dynamic, ?name:Dynamic, ?checkpoint:Dynamic):Dynamic;
	/**
		Creates an empty `MutableHashTable` object.
		...
		Raises:
		  ValueError: If checkpoint is True and no name was specified.
	**/
	public function new(key_dtype:Dynamic, value_dtype:Dynamic, default_value:Dynamic, ?name:Dynamic, ?checkpoint:Dynamic):Void;
	/**
	...
	**/
	public function lookup(keys:Dynamic, ?dynamic_default_values:Dynamic, ?name:Dynamic):Dynamic;
	/**
