...
@:pythonImport("tensorflow.python.ops.lookup_ops", "DenseHashTable") extern class DenseHashTable {
	/**
		SaveableObject implementation for DenseHashTable.
	**/
	static public function _Saveable(table:Dynamic, name:Dynamic, ?table_name:Dynamic):Dynamic;
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(key_dtype:Dynamic, value_dtype:Dynamic, default_value:Dynamic, empty_key:Dynamic, deleted_key:Dynamic, ?initial_num_buckets:Dynamic, ?name:Dynamic, ?checkpoint:Dynamic):Dynamic;
	/**
		Creates an empty `DenseHashTable` object.
		...
		Raises:
		  ValueError: If checkpoint is True and no name was specified.
	**/
	public function new(key_dtype:Dynamic, value_dtype:Dynamic, default_value:Dynamic, empty_key:Dynamic, deleted_key:Dynamic, ?initial_num_buckets:Dynamic, ?name:Dynamic, ?checkpoint:Dynamic):Void;
	/**
	...
	**/
	public function erase(keys:Dynamic, ?name:Dynamic):Dynamic;
	/**
	...
	/**
		...
		Raises:
		  TypeError: when `keys` or `values` doesn't match the table data
		    types.
	**/
	public function insert_or_assign(keys:Dynamic, values:Dynamic, ?name:Dynamic):Dynamic;
	/**
		The table key dtype.
	**/
