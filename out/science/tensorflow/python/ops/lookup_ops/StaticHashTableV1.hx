...
@:pythonImport("tensorflow.python.ops.lookup_ops", "StaticHashTableV1") extern class StaticHashTableV1 {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(initializer:Dynamic, default_value:Dynamic, ?name:Dynamic):Dynamic;
	/**
		Creates a non-initialized `HashTable` object.
		...
		Returns:
		  A `HashTable` object.
	**/
	public function new(initializer:Dynamic, default_value:Dynamic, ?name:Dynamic):Void;
	/**
