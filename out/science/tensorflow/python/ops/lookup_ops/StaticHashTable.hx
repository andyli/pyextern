...
@:pythonImport("tensorflow.python.ops.lookup_ops", "StaticHashTable") extern class StaticHashTable {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(initializer:Dynamic, default_value:Dynamic, ?name:Dynamic, ?experimental_is_anonymous:Dynamic):Dynamic;
	/**
		Creates a non-initialized `HashTable` object.
		...
		Returns:
		  A `HashTable` object.
	**/
	public function new(initializer:Dynamic, default_value:Dynamic, ?name:Dynamic, ?experimental_is_anonymous:Dynamic):Void;
	/**
