...
@:pythonImport("tensorflow.python.ops.variables", "RefVariable") extern class RefVariable {
	/**
	...
	**/
	...
	/**
		...
		Raises:
		  ...
		  RuntimeError: If eager execution is enabled.
	**/
	public function new(?initial_value:Dynamic, ?trainable:Dynamic, ?collections:Dynamic, ?validate_shape:Dynamic, ?caching_device:Dynamic, ?name:Dynamic, ?variable_def:Dynamic, ?dtype:Dynamic, ?expected_shape:Dynamic, ?import_scope:Dynamic, ?constraint:Dynamic, ?synchronization:Dynamic, ?aggregation:Dynamic, ?shape:Dynamic):Void;
	/**
	...
	**/
	public var _distribute_strategy : Dynamic;
	/**
	...
	**/
	public function _init_from_args(?initial_value:Dynamic, ?trainable:Dynamic, ?collections:Dynamic, ?validate_shape:Dynamic, ?caching_device:Dynamic, ?name:Dynamic, ?dtype:Dynamic, ?expected_shape:Dynamic, ?constraint:Dynamic, ?synchronization:Dynamic, ?aggregation:Dynamic, ?shape:Dynamic):Dynamic;
	/**
