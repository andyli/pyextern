...
@:pythonImport("tensorflow.python.ops.variables", "Variable") extern class Variable {
	...
	**/
	@:native("__init__")
	public function ___init__(?initial_value:Dynamic, ?trainable:Dynamic, ?validate_shape:Dynamic, ?caching_device:Dynamic, ?name:Dynamic, ?variable_def:Dynamic, ?dtype:Dynamic, ?import_scope:Dynamic, ?constraint:Dynamic, ?synchronization:Dynamic, ?aggregation:Dynamic, ?shape:Dynamic):Dynamic;
	/**
		Creates a new variable with value `initial_value`. (deprecated arguments)
		...
		Raises:
		  ...
		  ValueError: If the initial value is not specified, or does not have a
		    shape and `validate_shape` is `True`.
	**/
	public function new(?initial_value:Dynamic, ?trainable:Dynamic, ?validate_shape:Dynamic, ?caching_device:Dynamic, ?name:Dynamic, ?variable_def:Dynamic, ?dtype:Dynamic, ?import_scope:Dynamic, ?constraint:Dynamic, ?synchronization:Dynamic, ?aggregation:Dynamic, ?shape:Dynamic):Void;
	/**
