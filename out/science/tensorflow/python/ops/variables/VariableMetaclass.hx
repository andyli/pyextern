...
@:pythonImport("tensorflow.python.ops.variables", "VariableMetaclass") extern class VariableMetaclass {
	...
	static public function __call__(cls:Dynamic, ?args:python.VarArgs<Dynamic>, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	...
	**/
	static public function _variable_v1_call(cls:Dynamic, ?initial_value:Dynamic, ?trainable:Dynamic, ?collections:Dynamic, ?validate_shape:Dynamic, ?caching_device:Dynamic, ?name:Dynamic, ?variable_def:Dynamic, ?dtype:Dynamic, ?expected_shape:Dynamic, ?import_scope:Dynamic, ?constraint:Dynamic, ?use_resource:Dynamic, ?synchronization:Dynamic, ?aggregation:Dynamic, ?shape:Dynamic):Dynamic;
	/**
		Call on Variable class. Useful to force the signature.
	**/
	static public function _variable_v2_call(cls:Dynamic, ?initial_value:Dynamic, ?trainable:Dynamic, ?validate_shape:Dynamic, ?caching_device:Dynamic, ?name:Dynamic, ?variable_def:Dynamic, ?dtype:Dynamic, ?import_scope:Dynamic, ?constraint:Dynamic, ?synchronization:Dynamic, ?aggregation:Dynamic, ?shape:Dynamic):Dynamic;
	/**
