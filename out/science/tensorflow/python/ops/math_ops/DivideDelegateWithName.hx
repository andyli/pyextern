...
@:pythonImport("tensorflow.python.ops.math_ops", "DivideDelegateWithName") extern class DivideDelegateWithName {
	...
	**/
	@:native("__init__")
	public function ___init__(x:Dynamic, name:Dynamic):Dynamic;
	/**
		Construct DivideDelegateWithName.
		...
		Args:
		  ...
		  name: The name that is preferred for the op created.
	**/
	public function new(x:Dynamic, name:Dynamic):Void;
	/**
