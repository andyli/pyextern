...
@:pythonImport("tensorflow.python.ops.linalg.linear_operator_circulant", "LinearOperatorCirculant2D") extern class LinearOperatorCirculant2D {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(spectrum:Dynamic, ?input_output_dtype:Dynamic, ?is_non_singular:Dynamic, ?is_self_adjoint:Dynamic, ?is_positive_definite:Dynamic, ?is_square:Dynamic, ?name:Dynamic):Dynamic;
	/**
		Initialize an `LinearOperatorCirculant2D`.
		...
		* Values returned by all methods, such as `matmul` or `determinant` will be
		...
		Args:
		  ...
		  name:  A name to prepend to all ops created by this class.
	**/
	public function new(spectrum:Dynamic, ?input_output_dtype:Dynamic, ?is_non_singular:Dynamic, ?is_self_adjoint:Dynamic, ?is_positive_definite:Dynamic, ?is_square:Dynamic, ?name:Dynamic):Void;
	/**
