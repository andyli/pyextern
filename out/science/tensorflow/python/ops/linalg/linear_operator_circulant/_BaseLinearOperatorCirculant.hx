...
@:pythonImport("tensorflow.python.ops.linalg.linear_operator_circulant", "_BaseLinearOperatorCirculant") extern class _BaseLinearOperatorCirculant {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(spectrum:Dynamic, block_depth:Dynamic, ?input_output_dtype:Dynamic, ?is_non_singular:Dynamic, ?is_self_adjoint:Dynamic, ?is_positive_definite:Dynamic, ?is_square:Dynamic, ?parameters:Dynamic, ?name:Dynamic):Dynamic;
	/**
		Initialize an `_BaseLinearOperatorCirculant`.
		...
		Raises:
		  ...
		  TypeError:  If `spectrum` is not an allowed type.
	**/
	public function new(spectrum:Dynamic, block_depth:Dynamic, ?input_output_dtype:Dynamic, ?is_non_singular:Dynamic, ?is_self_adjoint:Dynamic, ?is_positive_definite:Dynamic, ?is_square:Dynamic, ?parameters:Dynamic, ?name:Dynamic):Void;
	/**
	...
	**/
	...
	public function _block_shape_tensor(?spectrum_shape:Dynamic):Dynamic;
	/**
		Broadcast batch dims of batch matrix `x` and spectrum.
	**/
	public function _broadcast_batch_dims(x:Dynamic, spectrum:Dynamic):Dynamic;
	...
	**/
	public function _check_spectrum_and_return_tensor(spectrum:Dynamic):Dynamic;
	/**
	...
	**/
	public function _fft(x:Dynamic):Dynamic;
	/**
	...
	**/
	...
	/**
		...
		Returns:
		  `Tensor` with `dtype` `complex64`.
	**/
	public function _ifft(x:Dynamic):Dynamic;
	/**
	...
	**/
	...
	public function _shape_tensor(?spectrum:Dynamic):Dynamic;
	/**
	...
	**/
	public function _unblockify_then_matricize(vec:Dynamic):Dynamic;
	...
	**/
	public function _vectorize_then_blockify(matrix:Dynamic):Dynamic;
	/**
	...
	**/
	public function assert_hermitian_spectrum(?name:Dynamic):Dynamic;
	/**
	...
	**/
	...
	/**
		...
		Returns:
		  Python `integer`.
	**/
	public var block_depth : Dynamic;
	public var block_shape : Dynamic;
	/**
	...
	**/
	public function convolution_kernel(?name:Dynamic):Dynamic;
	/**
