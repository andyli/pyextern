...
package tensorflow.python.ops.linalg.linear_operator_lower_triangular;
@:pythonImport("tensorflow.python.ops.linalg.linear_operator_lower_triangular", "LinearOperatorLowerTriangular") extern class LinearOperatorLowerTriangular {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(tril:Dynamic, ?is_non_singular:Dynamic, ?is_self_adjoint:Dynamic, ?is_positive_definite:Dynamic, ?is_square:Dynamic, ?name:Dynamic):Dynamic;
	/**
		Initialize a `LinearOperatorLowerTriangular`.
		...
		Raises:
		  ValueError:  If `is_square` is `False`.
	**/
	public function new(tril:Dynamic, ?is_non_singular:Dynamic, ?is_self_adjoint:Dynamic, ?is_positive_definite:Dynamic, ?is_square:Dynamic, ?name:Dynamic):Void;
	/**
	...
	**/
	public function _check_tril(tril:Dynamic):Dynamic;
	/**
	...
	**/
	public function _get_diag():Dynamic;
	/**
		Gets the `tril` kwarg, with upper part zero-d out.
	**/
	public function _get_tril():Dynamic;
	/**
