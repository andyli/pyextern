...
@:pythonImport("tensorflow.python.ops.linalg.linear_operator_kronecker", "LinearOperatorKronecker") extern class LinearOperatorKronecker {
	/**
	...
	**/
	...
	public function _solve_matmul_internal(x:Dynamic, solve_matmul_fn:Dynamic, ?adjoint:Dynamic, ?adjoint_arg:Dynamic):Dynamic;
	/**
