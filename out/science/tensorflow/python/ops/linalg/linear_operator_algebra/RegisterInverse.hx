...
@:pythonImport("tensorflow.python.ops.linalg.linear_operator_algebra", "RegisterInverse") extern class RegisterInverse {
	/**
	...
	**/
	public function __call__(inverse_fn:Dynamic):Dynamic;
