...
@:pythonImport("tensorflow.python.ops.linalg.linear_operator_algebra") extern class Linear_operator_algebra_Module {
	static public var _ADJOINTS : Dynamic;
	static public var _CHOLESKY_DECOMPS : Dynamic;
	static public var _INVERSES : Dynamic;
	static public var _MATMUL : Dynamic;
	static public var _SOLVE : Dynamic;
	...
	**/
	static public function _registered_adjoint(type_a:Dynamic):Dynamic;
	/**
	...
	**/
	...
	/**
		Get the Cholesky function registered for class a.
	**/
	static public function _registered_inverse(type_a:Dynamic):Dynamic;
	/**
	...
	**/
	static public function _registered_solve(type_a:Dynamic, type_b:Dynamic):Dynamic;
	...
	/**
		...
		Raises:
		  NotImplementedError: If no Adjoint method is defined for the LinearOperator
		    type of `lin_op_a`.
	**/
	static public function adjoint(lin_op_a:Dynamic, ?name:Dynamic):Dynamic;
	/**
	...
	/**
		...
		Raises:
		  NotImplementedError: If no Inverse method is defined for the LinearOperator
		    type of `lin_op_a`.
	**/
	static public function inverse(lin_op_a:Dynamic, ?name:Dynamic):Dynamic;
	/**
	...
	/**
		...
		Raises:
		  NotImplementedError: If no solve method is defined between types of
		    `lin_op_a` and `lin_op_b`.
	**/
	static public function solve(lin_op_a:Dynamic, lin_op_b:Dynamic, ?name:Dynamic):Dynamic;
}