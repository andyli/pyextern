...
@:pythonImport("tensorflow.python.ops.linalg.linear_operator_algebra", "RegisterAdjoint") extern class RegisterAdjoint {
	/**
	...
	**/
	public function __call__(adjoint_fn:Dynamic):Dynamic;
