...
@:pythonImport("tensorflow.python.ops.linalg.linear_operator_algebra", "RegisterCholesky") extern class RegisterCholesky {
	/**
	...
	**/
	public function __call__(cholesky_fn:Dynamic):Dynamic;
	...
	**/
	@:native("__init__")
	public function ___init__(lin_op_cls_a:Dynamic):Dynamic;
	/**
		Initialize the LinearOperator registrar.
		...
		Args:
		  lin_op_cls_a: the class of the LinearOperator to decompose.
	**/
	public function new(lin_op_cls_a:Dynamic):Void;
	/**
