...
@:pythonImport("tensorflow.python.ops.linalg.linear_operator_identity", "LinearOperatorScaledIdentity") extern class LinearOperatorScaledIdentity {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(num_rows:Dynamic, multiplier:Dynamic, ?is_non_singular:Dynamic, ?is_self_adjoint:Dynamic, ?is_positive_definite:Dynamic, ?is_square:Dynamic, ?assert_proper_shapes:Dynamic, ?name:Dynamic):Dynamic;
	/**
		Initialize a `LinearOperatorScaledIdentity`.
		...
		Raises:
		  ValueError:  If `num_rows` is determined statically to be non-scalar, or
		    negative.
	**/
	public function new(num_rows:Dynamic, multiplier:Dynamic, ?is_non_singular:Dynamic, ?is_self_adjoint:Dynamic, ?is_positive_definite:Dynamic, ?is_square:Dynamic, ?assert_proper_shapes:Dynamic, ?name:Dynamic):Void;
	/**
	...
	**/
	...
	public function _make_multiplier_matrix(?conjugate:Dynamic):Dynamic;
	/**
