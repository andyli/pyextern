...
package tensorflow.python.ops.linalg.sparse.conjugate_gradient;
@:pythonImport("tensorflow.python.ops.linalg.sparse.conjugate_gradient") extern class Conjugate_gradient_Module {
