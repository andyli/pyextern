...
@:pythonImport("tensorflow.python.ops.linalg.sparse.sparse_csr_matrix_ops", "CSRSparseMatrix") extern class CSRSparseMatrix {
	...
	**/
	@:native("__init__")
	public function ___init__(value:Dynamic, ?indices:Dynamic, ?name:Dynamic):Dynamic;
	/**
		Construct a CSRSparseMatrix from a dense matrix or SparseTensor.
		...
		Raises:
		  ValueError: if `value` is a `SparseTensor` and `indices` is not `None`.
	**/
	public function new(value:Dynamic, ?indices:Dynamic, ?name:Dynamic):Void;
	/**
	...
	**/
	...
	public function _from_matrix(matrix:Dynamic, ?handle_data:Dynamic):Dynamic;
	public var _matrix : Dynamic;
	public function conj():Dynamic;
	public var dtype : Dynamic;
	/**
		Return the matrix's handle data iff in eager mode.
	**/
	public var eager_handle_data : Dynamic;
	public var graph : Dynamic;
	/**
		Return the hermitian transpose of the matrix.
	**/
	public function hermitian_transpose():Dynamic;
	/**
		Number of stored values, including explicit zeros.
	**/
	public function nnz():Dynamic;
	/**
		Number of stored values, including explicit zeros.
	**/
	...
	public function to_sparse_tensor():Dynamic;
