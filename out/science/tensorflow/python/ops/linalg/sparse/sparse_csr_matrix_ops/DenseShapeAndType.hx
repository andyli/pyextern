...
@:pythonImport("tensorflow.python.ops.linalg.sparse.sparse_csr_matrix_ops", "DenseShapeAndType") extern class DenseShapeAndType {
	/**
		Return self+value.
	**/
	...
	**/
	...
	/**
		Create new instance of DenseShapeAndType(shape, dtype)
	**/
	static public function __new__(_cls:Dynamic, shape:Dynamic, dtype:Dynamic):Dynamic;
	/**
		Helper for pickle.
	**/
	...
	**/
	...
	/**
		Make a new DenseShapeAndType object from a sequence or iterable
	**/
	static public function _make(iterable:Dynamic):Dynamic;
	/**
		Return a new DenseShapeAndType object replacing specified fields with new values
	**/
