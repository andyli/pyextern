...
@:pythonImport("tensorflow.python.ops.linalg.matmul_registrations") extern class Matmul_registrations_Module {
	...
	**/
	...
	static public function _matmul_linear_operator_block_diag_block_diag(linop_a:Dynamic, linop_b:Dynamic):Dynamic;
	...
	**/
	static public function _matmul_linear_operator_scaled_identity(linop_a:Dynamic, linop_b:Dynamic):Dynamic;
