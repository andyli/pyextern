...
package tensorflow.python.ops.linalg.linear_operator_block_diag;
@:pythonImport("tensorflow.python.ops.linalg.linear_operator_block_diag", "LinearOperatorBlockDiag") extern class LinearOperatorBlockDiag {
	/**
