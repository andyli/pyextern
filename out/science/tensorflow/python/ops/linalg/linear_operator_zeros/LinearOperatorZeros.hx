...
@:pythonImport("tensorflow.python.ops.linalg.linear_operator_zeros", "LinearOperatorZeros") extern class LinearOperatorZeros {
	...
	**/
	@:native("__init__")
	public function ___init__(num_rows:Dynamic, ?num_columns:Dynamic, ?batch_shape:Dynamic, ?dtype:Dynamic, ?is_non_singular:Dynamic, ?is_self_adjoint:Dynamic, ?is_positive_definite:Dynamic, ?is_square:Dynamic, ?assert_proper_shapes:Dynamic, ?name:Dynamic):Dynamic;
	/**
		Initialize a `LinearOperatorZeros`.
		...
		Raises:
		  ...
		  ValueError:  If any of the following is not `True`:
		    `{is_self_adjoint, is_non_singular, is_positive_definite}`.
	**/
	public function new(num_rows:Dynamic, ?num_columns:Dynamic, ?batch_shape:Dynamic, ?dtype:Dynamic, ?is_non_singular:Dynamic, ?is_self_adjoint:Dynamic, ?is_positive_definite:Dynamic, ?is_square:Dynamic, ?assert_proper_shapes:Dynamic, ?name:Dynamic):Void;
	/**
	...
	**/
	public function _check_domain_range_possibly_add_asserts():Dynamic;
	/**
	...
	**/
	public function _zeros_diag():Dynamic;
	/**
