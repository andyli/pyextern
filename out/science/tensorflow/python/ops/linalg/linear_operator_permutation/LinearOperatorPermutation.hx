...
package tensorflow.python.ops.linalg.linear_operator_permutation;
@:pythonImport("tensorflow.python.ops.linalg.linear_operator_permutation", "LinearOperatorPermutation") extern class LinearOperatorPermutation {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(perm:Dynamic, ?dtype:Dynamic, ?is_non_singular:Dynamic, ?is_self_adjoint:Dynamic, ?is_positive_definite:Dynamic, ?is_square:Dynamic, ?name:Dynamic):Dynamic;
	/**
		Initialize a `LinearOperatorPermutation`.
		...
		Raises:
		  ValueError:  `is_self_adjoint` is not `True`, `is_positive_definite` is
		    not `False` or `is_square` is not `True`.
	**/
	public function new(perm:Dynamic, ?dtype:Dynamic, ?is_non_singular:Dynamic, ?is_self_adjoint:Dynamic, ?is_positive_definite:Dynamic, ?is_square:Dynamic, ?name:Dynamic):Void;
	/**
	...
	**/
	public function _check_perm(perm:Dynamic):Dynamic;
	/**
	...
	**/
	...
	public function _domain_dimension_tensor(?perm:Dynamic):Dynamic;
