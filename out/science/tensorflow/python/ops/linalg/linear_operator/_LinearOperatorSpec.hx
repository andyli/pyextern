...
@:pythonImport("tensorflow.python.ops.linalg.linear_operator", "_LinearOperatorSpec") extern class _LinearOperatorSpec {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(param_specs:Dynamic, non_tensor_params:Dynamic, prefer_static_fields:Dynamic):Dynamic;
	/**
		Initializes a new `_LinearOperatorSpec`.
		...
		Args:
		  ...
		  prefer_static_fields: Python `tuple` of strings corresponding to the names
		    ...
		    or axis values.
	**/
	public function new(param_specs:Dynamic, non_tensor_params:Dynamic, prefer_static_fields:Dynamic):Void;
	/**
	...
	**/
	...
	public var _non_tensor_params : Dynamic;
	public var _param_specs : Dynamic;
	public var _prefer_static_fields : Dynamic;
	/**
	...
	**/
	public function _to_components(obj:Dynamic):Dynamic;
	...
	**/
	static public function from_operator(_operator:Dynamic):Dynamic;
	/**
