...
package tensorflow.python.ops.linalg.linear_operator_block_lower_triangular;
@:pythonImport("tensorflow.python.ops.linalg.linear_operator_block_lower_triangular", "LinearOperatorBlockLowerTriangular") extern class LinearOperatorBlockLowerTriangular {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(operators:Dynamic, ?is_non_singular:Dynamic, ?is_self_adjoint:Dynamic, ?is_positive_definite:Dynamic, ?is_square:Dynamic, ?name:Dynamic):Dynamic;
	/**
		Initialize a `LinearOperatorBlockLowerTriangular`.
		...
		Raises:
		  ...
		  ValueError:  If `operators` is empty, contains an erroneous number of
		    elements, or contains operators with incompatible shapes.
	**/
	public function new(operators:Dynamic, ?is_non_singular:Dynamic, ?is_self_adjoint:Dynamic, ?is_positive_definite:Dynamic, ?is_square:Dynamic, ?name:Dynamic):Void;
	/**
	...
	**/
	...
	public function _block_domain_dimension_tensors():Dynamic;
	public function _block_domain_dimensions():Dynamic;
	public function _block_range_dimension_tensors():Dynamic;
	public function _block_range_dimensions():Dynamic;
	...
	**/
	...
	public function _validate_non_singular(is_non_singular:Dynamic):Dynamic;
	public function _validate_num_operators():Dynamic;
	/**
		Check that `operators` have compatible dimensions.
	**/
	public function _validate_operator_dimensions():Dynamic;
	public function _validate_square(is_square:Dynamic):Dynamic;
	/**
