...
package tensorflow.python.ops.linalg.linear_operator_toeplitz;
@:pythonImport("tensorflow.python.ops.linalg.linear_operator_toeplitz", "LinearOperatorToeplitz") extern class LinearOperatorToeplitz {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(col:Dynamic, row:Dynamic, ?is_non_singular:Dynamic, ?is_self_adjoint:Dynamic, ?is_positive_definite:Dynamic, ?is_square:Dynamic, ?name:Dynamic):Dynamic;
	/**
		Initialize a `LinearOperatorToeplitz`.
		...
		Args:
		  ...
		  name: A name for this `LinearOperator`.
	**/
	public function new(col:Dynamic, row:Dynamic, ?is_non_singular:Dynamic, ?is_self_adjoint:Dynamic, ?is_positive_definite:Dynamic, ?is_square:Dynamic, ?name:Dynamic):Void;
	/**
	...
	**/
	public function _check_row_col(row:Dynamic, col:Dynamic):Dynamic;
	/**
	...
	**/
	...
	public function _shape_tensor(?row:Dynamic, ?col:Dynamic):Dynamic;
	/**
