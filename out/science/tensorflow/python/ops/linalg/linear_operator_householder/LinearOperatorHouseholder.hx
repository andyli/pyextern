...
package tensorflow.python.ops.linalg.linear_operator_householder;
@:pythonImport("tensorflow.python.ops.linalg.linear_operator_householder", "LinearOperatorHouseholder") extern class LinearOperatorHouseholder {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(reflection_axis:Dynamic, ?is_non_singular:Dynamic, ?is_self_adjoint:Dynamic, ?is_positive_definite:Dynamic, ?is_square:Dynamic, ?name:Dynamic):Dynamic;
	/**
		Initialize a `LinearOperatorHouseholder`.
		...
		Raises:
		  ValueError:  `is_self_adjoint` is not `True`, `is_positive_definite` is
		    not `False` or `is_square` is not `True`.
	**/
	public function new(reflection_axis:Dynamic, ?is_non_singular:Dynamic, ?is_self_adjoint:Dynamic, ?is_positive_definite:Dynamic, ?is_square:Dynamic, ?name:Dynamic):Void;
	/**
	...
	**/
	public function _check_reflection_axis(reflection_axis:Dynamic):Dynamic;
	/**
	...
	**/
	...
	public var reflection_axis : Dynamic;
	/**
