...
package tensorflow.python.ops.linalg.linear_operator_inversion;
@:pythonImport("tensorflow.python.ops.linalg.linear_operator_inversion", "LinearOperatorInversion") extern class LinearOperatorInversion {
	/**
