...
package tensorflow.python.ops.linalg.linear_operator_composition;
@:pythonImport("tensorflow.python.ops.linalg.linear_operator_composition", "LinearOperatorComposition") extern class LinearOperatorComposition {
	/**
