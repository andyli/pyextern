...
package tensorflow.python.ops.linalg.linear_operator_tridiag;
@:pythonImport("tensorflow.python.ops.linalg.linear_operator_tridiag", "LinearOperatorTridiag") extern class LinearOperatorTridiag {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(diagonals:Dynamic, ?diagonals_format:Dynamic, ?is_non_singular:Dynamic, ?is_self_adjoint:Dynamic, ?is_positive_definite:Dynamic, ?is_square:Dynamic, ?name:Dynamic):Dynamic;
	/**
		Initialize a `LinearOperatorTridiag`.
		...
		Raises:
		  ...
		  ValueError:  If `diag.dtype` is real, and `is_self_adjoint` is not `True`.
	**/
	public function new(diagonals:Dynamic, ?diagonals_format:Dynamic, ?is_non_singular:Dynamic, ?is_self_adjoint:Dynamic, ?is_positive_definite:Dynamic, ?is_square:Dynamic, ?name:Dynamic):Void;
	/**
	...
	**/
	...
	public function _construct_adjoint_diagonals(diagonals:Dynamic):Dynamic;
	/**
	...
	**/
	...
	public function _shape_tensor(?diagonals:Dynamic):Dynamic;
	/**
	...
	**/
	...
	public var diagonals : Dynamic;
	public var diagonals_format : Dynamic;
	/**
