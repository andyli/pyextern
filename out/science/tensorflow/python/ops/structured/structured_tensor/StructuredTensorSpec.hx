...
@:pythonImport("tensorflow.python.ops.structured.structured_tensor", "StructuredTensorSpec") extern class StructuredTensorSpec {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(shape:Dynamic, field_specs:Dynamic):Dynamic;
	/**
		Build a type specification for a StructuredTensor.
		...
		Args:
		  ...
		  field_specs: A dictionary mapping from field name to TypeSpec, specifying
		    ...
		    `field_specs['x']` should be `tf.TensorSpec([2, 3, 10], tf.int32)`.
	**/
	public function new(shape:Dynamic, field_specs:Dynamic):Void;
	/**
	...
	**/
	...
	public var _field_specs : Dynamic;
	/**
	...
	**/
	...
	/**
		...
		Returns:
		  A dict.
	**/
	public function _to_tensor_list_internal(value:Dynamic, batched:Dynamic):Dynamic;
	/**
