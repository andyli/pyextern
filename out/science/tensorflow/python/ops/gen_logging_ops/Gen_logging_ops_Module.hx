...
@:pythonImport("tensorflow.python.ops.gen_logging_ops") extern class Gen_logging_ops_Module {
	...
	**/
	static public function _dispatcher_for_timestamp(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
		Prints a list of tensors.
	...
	**/
	...
	/**
		...
		Returns:
		  The created Operation.
	**/
	static public function print_v2(input:Dynamic, ?output_stream:Dynamic, ?end:Dynamic, ?name:Dynamic):Dynamic;
