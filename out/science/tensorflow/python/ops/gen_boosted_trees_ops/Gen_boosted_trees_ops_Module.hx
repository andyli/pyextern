...
@:pythonImport("tensorflow.python.ops.gen_boosted_trees_ops") extern class Gen_boosted_trees_ops_Module {
	...
	**/
	...
	static public function boosted_trees_aggregate_stats_eager_fallback(node_ids:Dynamic, gradients:Dynamic, hessians:Dynamic, feature:Dynamic, max_splits:Dynamic, num_buckets:Dynamic, name:Dynamic, ctx:Dynamic):Dynamic;
	/**
		Bucketize each feature based on bucket boundaries.
	...
	**/
	...
	/**
		...
		Returns:
		  ...
		  split_with_default_directions: A `Tensor` of type `string`.
	**/
	static public function boosted_trees_calculate_best_feature_split(node_id_range:Dynamic, stats_summary:Dynamic, l1:Dynamic, l2:Dynamic, tree_complexity:Dynamic, min_node_weight:Dynamic, logits_dimension:Dynamic, ?split_type:Dynamic, ?name:Dynamic):Dynamic;
	static public function boosted_trees_calculate_best_feature_split_eager_fallback(node_id_range:Dynamic, stats_summary:Dynamic, l1:Dynamic, l2:Dynamic, tree_complexity:Dynamic, min_node_weight:Dynamic, logits_dimension:Dynamic, split_type:Dynamic, name:Dynamic, ctx:Dynamic):Dynamic;
	/**
		Calculates gains for each feature and returns the best possible split information for each node. However, if no split is found, then no split information is returned for that node.
		...
		Returns:
		  ...
		  split_with_default_directions: A `Tensor` of type `string`.
	**/
	static public function boosted_trees_calculate_best_feature_split_v2(node_id_range:Dynamic, stats_summaries_list:Dynamic, split_types:Dynamic, candidate_feature_ids:Dynamic, l1:Dynamic, l2:Dynamic, tree_complexity:Dynamic, min_node_weight:Dynamic, logits_dimension:Dynamic, ?name:Dynamic):Dynamic;
	static public function boosted_trees_calculate_best_feature_split_v2_eager_fallback(node_id_range:Dynamic, stats_summaries_list:Dynamic, split_types:Dynamic, candidate_feature_ids:Dynamic, l1:Dynamic, l2:Dynamic, tree_complexity:Dynamic, min_node_weight:Dynamic, logits_dimension:Dynamic, name:Dynamic, ctx:Dynamic):Dynamic;
	/**
		Calculates gains for each feature and returns the best possible split information for the feature.
	...
	**/
	...
	/**
		...
		Returns:
		  A list of `num_features` `Tensor` objects with type `float32`.
	**/
	static public function boosted_trees_flush_quantile_summaries(quantile_stream_resource_handle:Dynamic, num_features:Dynamic, ?name:Dynamic):Dynamic;
	static public function boosted_trees_flush_quantile_summaries_eager_fallback(quantile_stream_resource_handle:Dynamic, num_features:Dynamic, name:Dynamic, ctx:Dynamic):Dynamic;
	/**
		Retrieves the tree ensemble resource stamp token, number of trees and growing statistics.
	...
	**/
	...
	static public function boosted_trees_sparse_aggregate_stats_eager_fallback(node_ids:Dynamic, gradients:Dynamic, hessians:Dynamic, feature_indices:Dynamic, feature_values:Dynamic, feature_shape:Dynamic, max_splits:Dynamic, num_buckets:Dynamic, name:Dynamic, ctx:Dynamic):Dynamic;
	/**
		Calculates gains for each feature and returns the best possible split information for the feature.
		...
		Returns:
		  ...
		  split_with_default_directions: A `Tensor` of type `string`.
	**/
	static public function boosted_trees_sparse_calculate_best_feature_split(node_id_range:Dynamic, stats_summary_indices:Dynamic, stats_summary_values:Dynamic, stats_summary_shape:Dynamic, l1:Dynamic, l2:Dynamic, tree_complexity:Dynamic, min_node_weight:Dynamic, logits_dimension:Dynamic, ?split_type:Dynamic, ?name:Dynamic):Dynamic;
	static public function boosted_trees_sparse_calculate_best_feature_split_eager_fallback(node_id_range:Dynamic, stats_summary_indices:Dynamic, stats_summary_values:Dynamic, stats_summary_shape:Dynamic, l1:Dynamic, l2:Dynamic, tree_complexity:Dynamic, min_node_weight:Dynamic, logits_dimension:Dynamic, split_type:Dynamic, name:Dynamic, ctx:Dynamic):Dynamic;
	/**
		Runs multiple additive regression ensemble predictors on input instances and
	...
	**/
	...
	/**
		...
		Returns:
		  The created Operation.
	**/
	static public function boosted_trees_update_ensemble_v2(tree_ensemble_handle:Dynamic, feature_ids:Dynamic, dimension_ids:Dynamic, node_ids:Dynamic, gains:Dynamic, thresholds:Dynamic, left_node_contribs:Dynamic, right_node_contribs:Dynamic, split_types:Dynamic, max_depth:Dynamic, learning_rate:Dynamic, pruning_mode:Dynamic, ?logits_dimension:Dynamic, ?name:Dynamic):Dynamic;
	static public function boosted_trees_update_ensemble_v2_eager_fallback(tree_ensemble_handle:Dynamic, feature_ids:Dynamic, dimension_ids:Dynamic, node_ids:Dynamic, gains:Dynamic, thresholds:Dynamic, left_node_contribs:Dynamic, right_node_contribs:Dynamic, split_types:Dynamic, max_depth:Dynamic, learning_rate:Dynamic, pruning_mode:Dynamic, logits_dimension:Dynamic, name:Dynamic, ctx:Dynamic):Dynamic;
	/**
