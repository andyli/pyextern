...
@:pythonImport("tensorflow.python.ops.ragged.row_partition", "RowPartitionSpec") extern class RowPartitionSpec {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(?nrows:Dynamic, ?nvals:Dynamic, ?uniform_row_length:Dynamic, ?dtype:Dynamic):Dynamic;
	/**
		Constructs a new RowPartitionSpec.
		...
		Args:
		  ...
		  dtype: The data type used to encode the partition.  One of `tf.int64` or
		    `tf.int32`.
	**/
	public function new(?nrows:Dynamic, ?nvals:Dynamic, ?uniform_row_length:Dynamic, ?dtype:Dynamic):Void;
	/**
	...
	**/
	static public function _dimensions_compatible(nrows:Dynamic, nvals:Dynamic, uniform_row_length:Dynamic):Dynamic;
	...
	**/
	...
	/**
		...
		Returns:
		  A value that is compatible with this `TypeSpec`.
	**/
	public function _from_components(tensor:Dynamic):Dynamic;
	/**
	...
	**/
	...
	public var _nrows : Dynamic;
	public var _nvals : Dynamic;
	/**
	...
	**/
	...
	public var _uniform_row_length : Dynamic;
	/**
