...
@:pythonImport("tensorflow.python.ops.ragged.ragged_tensor", "RaggedTensorSpec") extern class RaggedTensorSpec {
	/**
	...
	**/
	...
	static public var __batch_encoder__ : Dynamic;
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(?shape:Dynamic, ?dtype:Dynamic, ?ragged_rank:Dynamic, ?row_splits_dtype:Dynamic, ?flat_values_spec:Dynamic):Dynamic;
	/**
		Constructs a type specification for a `tf.RaggedTensor`.
		...
		Args:
		  ...
		  flat_values_spec: TypeSpec for flat_value of the RaggedTensor. It shall be
		    ...
		    be the same as `flat_values_spec.dtype`. (experimental)
	**/
	public function new(?shape:Dynamic, ?dtype:Dynamic, ?ragged_rank:Dynamic, ?row_splits_dtype:Dynamic, ?flat_values_spec:Dynamic):Void;
	/**
	...
	**/
	...
	public var _flat_values_spec : Dynamic;
	/**
	...
	**/
	public function _from_components(tensor_list:Dynamic):Dynamic;
	/**
	...
	**/
	...
	public var _ragged_rank : Dynamic;
	public var _row_splits_dtype : Dynamic;
	/**
	...
	**/
	public var flat_values_spec : Dynamic;
