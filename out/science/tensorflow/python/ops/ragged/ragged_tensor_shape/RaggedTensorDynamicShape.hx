...
@:pythonImport("tensorflow.python.ops.ragged.ragged_tensor_shape", "RaggedTensorDynamicShape") extern class RaggedTensorDynamicShape {
	...
	**/
	@:native("__init__")
	public function ___init__(partitioned_dim_sizes:Dynamic, inner_dim_sizes:Dynamic, ?dim_size_dtype:Dynamic):Dynamic;
	/**
		Creates a RaggedTensorDynamicShape.
		...
		Args:
		  ...
		  dim_size_dtype: dtype for dimension sizes.  If not specified, then it
		    ...
		    `inner_dim_sizes`.
	**/
	public function new(partitioned_dim_sizes:Dynamic, inner_dim_sizes:Dynamic, ?dim_size_dtype:Dynamic):Void;
	/**
	...
	**/
	public var dim_size_dtype : Dynamic;
	/**
	...
	**/
	static public function from_tensor(rt_input:Dynamic, ?dim_size_dtype:Dynamic):Dynamic;
	/**
	...
	**/
	...
	public function with_dim_size_dtype(dtype:Dynamic):Dynamic;
}