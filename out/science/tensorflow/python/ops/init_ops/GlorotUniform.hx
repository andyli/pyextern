...
@:pythonImport("tensorflow.python.ops.init_ops", "GlorotUniform") extern class GlorotUniform {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(?seed:Dynamic, ?dtype:Dynamic):Dynamic;
	/**
		DEPRECATED FUNCTION ARGUMENTS
		...
		Call initializer instance with the dtype argument instead of passing it to the constructor
	**/
	public function new(?seed:Dynamic, ?dtype:Dynamic):Void;
	/**
