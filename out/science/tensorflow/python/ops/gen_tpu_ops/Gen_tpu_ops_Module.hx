...
package tensorflow.python.ops.gen_tpu_ops;
@:pythonImport("tensorflow.python.ops.gen_tpu_ops") extern class Gen_tpu_ops_Module {
	/**
	...
	**/
	...
	/**
		...
		Returns:
		  The created Operation.
	**/
	static public function enqueue_tpu_embedding_integer_batch(batch:Dynamic, mode_override:Dynamic, ?device_ordinal:Dynamic, ?name:Dynamic):Dynamic;
	...
	/**
		...
		Returns:
		  The created Operation.
	**/
	static public function enqueue_tpu_embedding_ragged_tensor_batch(sample_splits:Dynamic, embedding_indices:Dynamic, aggregation_weights:Dynamic, mode_override:Dynamic, table_ids:Dynamic, ?device_ordinal:Dynamic, ?combiners:Dynamic, ?max_sequence_lengths:Dynamic, ?num_features:Dynamic, ?name:Dynamic):Dynamic;
	...
	/**
		...
		Returns:
		  The created Operation.
	**/
	static public function enqueue_tpu_embedding_sparse_batch(sample_indices:Dynamic, embedding_indices:Dynamic, aggregation_weights:Dynamic, mode_override:Dynamic, ?device_ordinal:Dynamic, ?combiners:Dynamic, ?name:Dynamic):Dynamic;
	...
	/**
		...
		Returns:
		  The created Operation.
	**/
	static public function enqueue_tpu_embedding_sparse_tensor_batch(sample_indices:Dynamic, embedding_indices:Dynamic, aggregation_weights:Dynamic, mode_override:Dynamic, table_ids:Dynamic, ?device_ordinal:Dynamic, ?combiners:Dynamic, ?max_sequence_lengths:Dynamic, ?num_features:Dynamic, ?name:Dynamic):Dynamic;
	...
	**/
	...
	/**
		...
		Returns:
		  The created Operation.
	**/
	static public function send_tpu_embedding_gradients(inputs:Dynamic, learning_rates:Dynamic, config:Dynamic, ?name:Dynamic):Dynamic;
