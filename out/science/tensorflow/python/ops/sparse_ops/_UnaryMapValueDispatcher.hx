...
@:pythonImport("tensorflow.python.ops.sparse_ops", "_UnaryMapValueDispatcher") extern class _UnaryMapValueDispatcher {
	...
	**/
	@:native("__init__")
	public function ___init__(original_func:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(original_func:Dynamic):Void;
	/**
