...
@:pythonImport("tensorflow.python.ops.variable_scope", "EagerVariableStore") extern class EagerVariableStore {
	...
	**/
	@:native("__init__")
	public function ___init__(?store:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(?store:Dynamic):Void;
	/**
