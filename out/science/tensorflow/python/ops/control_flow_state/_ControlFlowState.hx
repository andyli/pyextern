...
@:pythonImport("tensorflow.python.ops.control_flow_state", "_ControlFlowState") extern class _ControlFlowState {
	/**
	...
	**/
	public function ZerosLikeV1WhileLoop(op:Dynamic, index:Dynamic):Dynamic;
