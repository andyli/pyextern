...
@:pythonImport("tensorflow.python.ops.parsing_config", "FixedLenSequenceFeature") extern class FixedLenSequenceFeature {
	/**
		Return self+value.
	**/
	...
	**/
	static public function __new__(cls:Dynamic, shape:Dynamic, dtype:Dynamic, ?allow_missing:Dynamic, ?default_value:Dynamic):Dynamic;
	/**
		Helper for pickle.
	**/
	...
	**/
	public var allow_missing : Dynamic;
	/**
