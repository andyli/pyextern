...
@:pythonImport("tensorflow.python.ops.parsing_config", "SparseFeature") extern class SparseFeature {
	/**
		Return self+value.
	**/
	...
	**/
	static public function __new__(cls:Dynamic, index_key:Dynamic, value_key:Dynamic, dtype:Dynamic, size:Dynamic, ?already_sorted:Dynamic):Dynamic;
	/**
		Helper for pickle.
	**/
	...
	**/
	public var already_sorted : Dynamic;
	/**
