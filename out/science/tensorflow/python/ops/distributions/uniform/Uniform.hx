...
package tensorflow.python.ops.distributions.uniform;
@:pythonImport("tensorflow.python.ops.distributions.uniform", "Uniform") extern class Uniform {
	...
	**/
	@:native("__init__")
	public function ___init__(?low:Dynamic, ?high:Dynamic, ?validate_args:Dynamic, ?allow_nan_stats:Dynamic, ?name:Dynamic):Dynamic;
	/**
		Initialize a batch of Uniform distributions. (deprecated)
		...
		Raises:
		  InvalidArgumentError: if `low >= high` and `validate_args=False`.
	**/
	public function new(?low:Dynamic, ?high:Dynamic, ?validate_args:Dynamic, ?allow_nan_stats:Dynamic, ?name:Dynamic):Void;
	/**
