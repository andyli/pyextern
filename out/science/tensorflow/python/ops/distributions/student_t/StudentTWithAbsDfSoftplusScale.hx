...
package tensorflow.python.ops.distributions.student_t;
@:pythonImport("tensorflow.python.ops.distributions.student_t", "StudentTWithAbsDfSoftplusScale") extern class StudentTWithAbsDfSoftplusScale {
