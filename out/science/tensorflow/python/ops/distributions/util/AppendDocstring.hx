...
@:pythonImport("tensorflow.python.ops.distributions.util", "AppendDocstring") extern class AppendDocstring {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(?additional_note:Dynamic, ?kwargs_dict:Dynamic):Dynamic;
	/**
		Initializes the AppendDocstring object.
		...
		Raises:
		  ...
		  ValueError: if kwargs_dict.value contains newlines.
	**/
	public function new(?additional_note:Dynamic, ?kwargs_dict:Dynamic):Void;
	/**
