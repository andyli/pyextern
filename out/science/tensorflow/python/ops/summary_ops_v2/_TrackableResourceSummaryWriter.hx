...
@:pythonImport("tensorflow.python.ops.summary_ops_v2", "_TrackableResourceSummaryWriter") extern class _TrackableResourceSummaryWriter {
	...
	**/
	@:native("__init__")
	public function ___init__(create_fn:Dynamic, init_op_fn:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(create_fn:Dynamic, init_op_fn:Dynamic):Void;
	/**
	...
	**/
	...
	public function _set_up_resource_deleter():Dynamic;
	...
	**/
	public function as_default(?step:Dynamic):Dynamic;
	/**
	...
	**/
	public function set_as_default(?step:Dynamic):Dynamic;
}