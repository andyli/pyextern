...
@:pythonImport("tensorflow.python.ops.summary_ops_v2", "_LegacyResourceSummaryWriter") extern class _LegacyResourceSummaryWriter {
	...
	**/
	@:native("__init__")
	public function ___init__(resource:Dynamic, init_op_fn:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(resource:Dynamic, init_op_fn:Dynamic):Void;
	/**
