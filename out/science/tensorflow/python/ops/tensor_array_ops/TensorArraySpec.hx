...
@:pythonImport("tensorflow.python.ops.tensor_array_ops", "TensorArraySpec") extern class TensorArraySpec {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(?element_shape:Dynamic, ?dtype:Dynamic, ?dynamic_size:Dynamic, ?infer_shape:Dynamic):Dynamic;
	/**
		Constructs a type specification for a `tf.TensorArray`.
		...
		Args:
		  ...
		  infer_shape: Whether shape inference is enabled.
	**/
	public function new(?element_shape:Dynamic, ?dtype:Dynamic, ?dynamic_size:Dynamic, ?infer_shape:Dynamic):Void;
	/**
	...
	**/
	...
	public var _dynamic_size : Dynamic;
