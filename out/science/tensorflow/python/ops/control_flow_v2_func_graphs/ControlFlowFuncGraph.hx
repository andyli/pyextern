...
package tensorflow.python.ops.control_flow_v2_func_graphs;
@:pythonImport("tensorflow.python.ops.control_flow_v2_func_graphs", "ControlFlowFuncGraph") extern class ControlFlowFuncGraph {
	/**
	...
	**/
	...
	public function _capture_helper(tensor:Dynamic, name:Dynamic, ?shape:Dynamic):Dynamic;
	/**
