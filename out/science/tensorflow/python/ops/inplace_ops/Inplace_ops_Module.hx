...
@:pythonImport("tensorflow.python.ops.inplace_ops") extern class Inplace_ops_Module {
	...
	**/
	...
	/**
		Applies an inplace add on input x at index i with value v. Aliases x. (deprecated)
	...
	**/
	...
	/**
		Applies an inplace sub on input x at index i with value v. Aliases x. (deprecated)
		
		Warning: THIS FUNCTION IS DEPRECATED. It will be removed in a future version.
		Instructions for updating:
		Prefer tf.tensor_scatter_nd_sub, which offers the same functionality with well-defined read-write semantics.
	...
	**/
	...
	/**
		Applies an inplace update on input x at index i with value v. Aliases x. (deprecated)
	...
	**/
	...
	/**
		Applies an inplace add on input x at index i with value v. (deprecated)
	...
	**/
	...
	/**
		Applies an inplace sub on input x at index i with value v. (deprecated)
	...
	**/
	...
	/**
		Applies an inplace update on input x at index i with value v. (deprecated)
