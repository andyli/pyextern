...
@:pythonImport("tensorflow.python.ops.list_ops") extern class List_ops_Module {
	...
	**/
	...
	static public function _TensorListResizeGrad(op:Dynamic, dlist:Dynamic):Dynamic;
	/**
	...
	**/
	static public function _TensorListScatterIntoExistingListGrad(op:Dynamic, dlist:Dynamic):Dynamic;
	/**
	...
	**/
	static public function _set_handle_data(list_handle:Dynamic, element_shape:Dynamic, element_dtype:Dynamic):Dynamic;
	...
	**/
	...
	static public function tensor_list_gather(input_handle:Dynamic, indices:Dynamic, element_dtype:Dynamic, ?element_shape:Dynamic, ?name:Dynamic):Dynamic;
	...
	static public function tensor_list_get_item(input_handle:Dynamic, index:Dynamic, element_dtype:Dynamic, ?element_shape:Dynamic, ?name:Dynamic):Dynamic;
	...
	**/
	static public function tensor_list_scatter(tensor:Dynamic, indices:Dynamic, ?element_shape:Dynamic, ?input_handle:Dynamic, ?name:Dynamic):Dynamic;
	...
	**/
	static public function tensor_list_set_item(input_handle:Dynamic, index:Dynamic, item:Dynamic, ?resize_if_index_out_of_bounds:Dynamic, ?name:Dynamic):Dynamic;
	...
	static public function tensor_list_stack(input_handle:Dynamic, element_dtype:Dynamic, ?num_elements:Dynamic, ?element_shape:Dynamic, ?name:Dynamic):Dynamic;
