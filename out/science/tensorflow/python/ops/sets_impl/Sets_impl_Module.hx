...
package tensorflow.python.ops.sets_impl;
@:pythonImport("tensorflow.python.ops.sets_impl") extern class Sets_impl_Module {
	...
	**/
	static public function _convert_to_tensors_or_sparse_tensors(a:Dynamic, b:Dynamic):Dynamic;
	/**
