...
@:pythonImport("tensorflow.python.ops.while_v2", "_WhileBodyGradFuncGraph") extern class _WhileBodyGradFuncGraph {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(name:Dynamic, forward_cond_graph:Dynamic, forward_body_graph:Dynamic, maximum_iterations:Dynamic, forward_while_op:Dynamic, body_graph_inputs:Dynamic, body_graph_outputs:Dynamic):Dynamic;
	/**
		Construct a new FuncGraph.
		...
		Args:
		  ...
		  capture_by_value: An optional boolean. If True, the func graph will
		    ...
		    from outer graphs, and failing that will default to False.
	**/
	public function new(name:Dynamic, forward_cond_graph:Dynamic, forward_body_graph:Dynamic, maximum_iterations:Dynamic, forward_while_op:Dynamic, body_graph_inputs:Dynamic, body_graph_outputs:Dynamic):Void;
	/**
	...
	**/
	...
	public function _get_optimized_reduction_ops_cache_key(op_type:Dynamic, inputs:Dynamic, ?dtypes:Dynamic, ?input_types:Dynamic, ?name:Dynamic, ?attrs:Dynamic, ?op_def:Dynamic, ?compute_device:Dynamic):Dynamic;
	/**
	...
	**/
	...
	public function _move_op_to_forward_graph(op_type:Dynamic, inputs:Dynamic, ?dtypes:Dynamic, ?input_types:Dynamic, ?name:Dynamic, ?attrs:Dynamic, ?op_def:Dynamic, ?compute_device:Dynamic):Dynamic;
	/**
	...
	**/
	public function _resource_capture_helper(tensor:Dynamic):Dynamic;
	/**
