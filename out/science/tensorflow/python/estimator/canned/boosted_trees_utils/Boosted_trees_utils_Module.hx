...
@:pythonImport("tensorflow.python.estimator.canned.boosted_trees_utils") extern class Boosted_trees_utils_Module {
	...
	**/
	static public function _compute_directional_feature_contributions(example_feature_ids:Dynamic, example_logits_paths:Dynamic, activation:Dynamic, feature_col_names:Dynamic):Dynamic;
	...
	**/
	static public function _parse_explanations_from_prediction(serialized_debug_proto:Dynamic, feature_col_names:Dynamic, ?classification:Dynamic):Dynamic;
	...
	**/
	static public function _sum_by_feature_col_name_and_sort(names:Dynamic, vals:Dynamic):Dynamic;
