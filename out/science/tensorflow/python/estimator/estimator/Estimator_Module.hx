...
@:pythonImport("tensorflow.python.estimator.estimator") extern class Estimator_Module {
	...
	**/
	...
	static public var _canned_estimator_api_gauge : Dynamic;
	...
	**/
	...
	static public var _estimator_api_gauge : Dynamic;
	/**
	...
	**/
	...
	static public function _get_loss_reduce_op_for_reporting():Dynamic;
	/**
