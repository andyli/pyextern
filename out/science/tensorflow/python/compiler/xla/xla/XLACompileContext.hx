...
@:pythonImport("tensorflow.python.compiler.xla.xla", "XLACompileContext") extern class XLACompileContext {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(name:Dynamic, pivot:Dynamic):Dynamic;
	/**
		Builds a new XLACompileContext.
		...
		Args:
		  ...
		  pivot: a pivot node. Nodes in the XLACompileContext that do not have any
		    ...
		    contexts.
	**/
	public function new(name:Dynamic, pivot:Dynamic):Void;
	/**
