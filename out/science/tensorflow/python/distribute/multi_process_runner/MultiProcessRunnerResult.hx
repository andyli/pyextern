...
@:pythonImport("tensorflow.python.distribute.multi_process_runner", "MultiProcessRunnerResult") extern class MultiProcessRunnerResult {
	/**
		Return self+value.
	**/
	...
	**/
	...
	/**
		Create new instance of MultiProcessRunnerResult(return_value, stdout)
	**/
	static public function __new__(_cls:Dynamic, return_value:Dynamic, stdout:Dynamic):Dynamic;
	/**
		Helper for pickle.
	**/
	...
	**/
	...
	/**
		Make a new MultiProcessRunnerResult object from a sequence or iterable
	**/
	static public function _make(iterable:Dynamic):Dynamic;
	/**
		Return a new MultiProcessRunnerResult object replacing specified fields with new values
	**/
