...
@:pythonImport("tensorflow.python.distribute.multi_process_runner", "_Process") extern class _Process {
	...
	**/
	@:native("__init__")
	public function ___init__(test_env:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(test_env:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Void;
	/**
	...
	**/
	...
	public function _run_with_setenv():Dynamic;
