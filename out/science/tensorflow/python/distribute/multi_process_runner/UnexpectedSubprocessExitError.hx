...
@:pythonImport("tensorflow.python.distribute.multi_process_runner", "UnexpectedSubprocessExitError") extern class UnexpectedSubprocessExitError {
	/**
		exception cause
	**/
	...
	**/
	@:native("__init__")
	public function ___init__(msg:Dynamic, mpr_result:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(msg:Dynamic, mpr_result:Dynamic):Void;
	/**
