...
@:pythonImport("tensorflow.python.distribute.ps_values", "RestoredDistributedTable") extern class RestoredDistributedTable {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(strategy:Dynamic, wrapped_creator:Dynamic):Dynamic;
	/**
		Creates a non-initialized `HashTable` object.
		...
		Returns:
		  A `HashTable` object.
	**/
	public function new(strategy:Dynamic, wrapped_creator:Dynamic):Void;
	/**
	...
	/**
		...
		**Avoid creating duplicate trackables**
		...
		Returns:
		  A new object.
	**/
	static public function _deserialize_from_proto(proto:Dynamic, ?unused_kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
	...
	**/
	public function _maybe_build_distributed_table():Dynamic;
	/**
	...
	**/
	...
	/**
		...
		Returns:
		  A new proto
	**/
	public function _serialize_to_proto(?unused_kwargs:python.KwArgs<Dynamic>):Dynamic;
	...
	**/
	public function resource_handle_call_time_value():Dynamic;
	/**
