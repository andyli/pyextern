...
package tensorflow.python.distribute.ps_values;
@:pythonImport("tensorflow.python.distribute.ps_values", "CachingVariable") extern class CachingVariable {
	/**
	...
	**/
	...
	static public function __getitem__(v:Dynamic, ?args:python.VarArgs<Dynamic>, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	...
	**/
	@:native("__init__")
	public function ___init__(v:Dynamic):Dynamic;
	/**
		Creates a variable from a handle.
	...
	**/
	...
	/**
		Register overloads for all operators.
	**/
	static public function _overload_overloadable_operators():Dynamic;
	/**
	...
	**/
	static public function _tensor_overload_operator(_operator:Dynamic):Dynamic;
	...
	**/
	...
	public function cached_read_value():Dynamic;
	/**
