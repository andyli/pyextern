...
@:pythonImport("tensorflow.python.distribute.ps_values", "AggregatingVariable") extern class AggregatingVariable {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(strategy:Dynamic, v:Dynamic, aggregation:Dynamic):Dynamic;
	/**
		Creates a variable from a handle.
		...
		Args:
		  ...
		  in_graph_mode: whether we are executing in TF1 graph mode. If None, will
		    ...
		    conetxt entrances which can add up.
	**/
	public function new(strategy:Dynamic, v:Dynamic, aggregation:Dynamic):Void;
	/**
