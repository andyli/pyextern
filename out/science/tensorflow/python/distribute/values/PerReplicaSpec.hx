...
@:pythonImport("tensorflow.python.distribute.values", "PerReplicaSpec") extern class PerReplicaSpec {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(?value_specs:python.VarArgs<Dynamic>):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(?value_specs:python.VarArgs<Dynamic>):Void;
	/**
	...
	**/
	...
	public var _value_specs : Dynamic;
	/**
