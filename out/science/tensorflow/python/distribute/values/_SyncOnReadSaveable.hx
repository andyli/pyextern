...
@:pythonImport("tensorflow.python.distribute.values", "_SyncOnReadSaveable") extern class _SyncOnReadSaveable {
	...
	**/
	@:native("__init__")
	public function ___init__(sync_on_read_variable:Dynamic, name:Dynamic):Dynamic;
	/**
		Creates a `SaveableObject` object.
		...
		Args:
		  ...
		  name: the name to save the object under.
	**/
	public function new(sync_on_read_variable:Dynamic, name:Dynamic):Void;
	/**
