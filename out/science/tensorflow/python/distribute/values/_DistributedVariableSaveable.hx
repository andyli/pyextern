...
@:pythonImport("tensorflow.python.distribute.values", "_DistributedVariableSaveable") extern class _DistributedVariableSaveable {
	...
	**/
	@:native("__init__")
	public function ___init__(distributed_variable:Dynamic, primary_variable:Dynamic, name:Dynamic):Dynamic;
	/**
		Creates a `SaveableObject` object.
		...
		Args:
		  ...
		  name: the name to save the object under.
	**/
	public function new(distributed_variable:Dynamic, primary_variable:Dynamic, name:Dynamic):Void;
	/**
