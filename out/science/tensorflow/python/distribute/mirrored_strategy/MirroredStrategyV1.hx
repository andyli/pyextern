...
@:pythonImport("tensorflow.python.distribute.mirrored_strategy", "MirroredStrategyV1") extern class MirroredStrategyV1 {
	...
	**/
	@:native("__init__")
	public function ___init__(?devices:Dynamic, ?cross_device_ops:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(?devices:Dynamic, ?cross_device_ops:Dynamic):Void;
	/**
