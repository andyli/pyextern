...
@:pythonImport("tensorflow.python.distribute.collective_all_reduce_strategy", "_CollectiveAllReduceStrategyExperimentalMeta") extern class _CollectiveAllReduceStrategyExperimentalMeta {
	...
	**/
	static public function __instancecheck__(instance:Dynamic):Dynamic;
