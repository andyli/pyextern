...
@:pythonImport("tensorflow.python.distribute.collective_all_reduce_strategy", "CollectiveAllReduceExtended") extern class CollectiveAllReduceExtended {
	...
	**/
	@:native("__init__")
	public function ___init__(container_strategy:Dynamic, cluster_resolver:Dynamic, communication_options:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(container_strategy:Dynamic, cluster_resolver:Dynamic, communication_options:Dynamic):Void;
	/**
	...
	**/
	...
	public function _check_health():Dynamic;
	static public var _check_health_initial_timeout : Dynamic;
	static public var _check_health_interval : Dynamic;
	static public var _check_health_retry_limit : Dynamic;
	static public var _check_health_timeout : Dynamic;
	/**
	...
	**/
	...
	static public var _enable_check_health : Dynamic;
	...
	**/
	public function _initialize_local(cluster_resolver:Dynamic, ?devices:Dynamic):Dynamic;
	public function _initialize_local_devices(cluster_resolver:Dynamic, worker_device:Dynamic):Dynamic;
	/**
		Initializes the object for multi-worker training.
	**/
	public function _initialize_multi_worker(cluster_resolver:Dynamic):Dynamic;
	/**
		Initializes the object for single-worker training.
	**/
	public function _initialize_single_worker(devices:Dynamic):Dynamic;
	public function _initialize_strategy(cluster_resolver:Dynamic):Dynamic;
	...
	**/
	...
	public function _make_input_context():Dynamic;
	/**
	...
	**/
	...
	public function _start_check_health_thread():Dynamic;
	public function _stop_check_health_thread():Dynamic;
	...
	**/
	...
	public function _warn_nccl_no_gpu():Dynamic;
	/**
