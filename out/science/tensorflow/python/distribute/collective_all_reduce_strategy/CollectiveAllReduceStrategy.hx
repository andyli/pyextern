...
@:pythonImport("tensorflow.python.distribute.collective_all_reduce_strategy", "CollectiveAllReduceStrategy") extern class CollectiveAllReduceStrategy {
	...
	**/
	@:native("__init__")
	public function ___init__(?cluster_resolver:Dynamic, ?communication_options:Dynamic):Dynamic;
	/**
		Creates the strategy.
		...
		Args:
		  ...
		  communication_options: optional
		    ...
		    `tf.distribute.experimental.CommunicationOptions` for details.
	**/
	public function new(?cluster_resolver:Dynamic, ?communication_options:Dynamic):Void;
	/**
	...
	**/
	static public function _from_local_devices(devices:Dynamic, ?communication_options:Dynamic):Dynamic;
	/**
