...
@:pythonImport("tensorflow.python.distribute.combinations", "_TestResult") extern class _TestResult {
	/**
		Return self+value.
	**/
	...
	**/
	...
	/**
		Create new instance of _TestResult(status, message)
	**/
	static public function __new__(_cls:Dynamic, status:Dynamic, message:Dynamic):Dynamic;
	/**
		Helper for pickle.
	**/
	...
	**/
	...
	/**
		Make a new _TestResult object from a sequence or iterable
	**/
	static public function _make(iterable:Dynamic):Dynamic;
	/**
		Return a new _TestResult object replacing specified fields with new values
	**/
