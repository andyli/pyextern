...
@:pythonImport("tensorflow.python.distribute.combinations", "GPUCombination") extern class GPUCombination {
	static public var GPU_TEST : Dynamic;
	...
	**/
	public function context_managers(kwargs:Dynamic):Dynamic;
	/**
		Returns `ParameterModifier` instances that customize the arguments.
	**/
	public function parameter_modifiers():Dynamic;
	/**
	...
	**/
	public function should_execute_combination(kwargs:Dynamic):Dynamic;
}