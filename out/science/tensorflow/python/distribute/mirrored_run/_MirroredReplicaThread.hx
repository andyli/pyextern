...
@:pythonImport("tensorflow.python.distribute.mirrored_run", "_MirroredReplicaThread") extern class _MirroredReplicaThread {
	...
	**/
	@:native("__init__")
	public function ___init__(dist:Dynamic, coord:Dynamic, replica_id:Dynamic, devices:Dynamic, variable_creator_fn:Dynamic, fn:Dynamic, caching_scope:Dynamic, args:Dynamic, kwargs:Dynamic):Dynamic;
	/**
		This constructor should always be called with keyword arguments. Arguments are:
	...
	**/
	public function new(dist:Dynamic, coord:Dynamic, replica_id:Dynamic, devices:Dynamic, variable_creator_fn:Dynamic, fn:Dynamic, caching_scope:Dynamic, args:Dynamic, kwargs:Dynamic):Void;
	/**
	...
	**/
	...
	public function record_thread_local_eager_context_state():Dynamic;
	/**
		Record the thread local summary state in self.
	**/
	public function record_thread_local_summary_state():Dynamic;
	public function restore_thread_local_eager_context_state():Dynamic;
	/**
		Restore thread local summary state from self.
	**/
	public function restore_thread_local_summary_state():Dynamic;
	/**
