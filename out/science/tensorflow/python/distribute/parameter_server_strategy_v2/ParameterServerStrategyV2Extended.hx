...
@:pythonImport("tensorflow.python.distribute.parameter_server_strategy_v2", "ParameterServerStrategyV2Extended") extern class ParameterServerStrategyV2Extended {
	...
	**/
	@:native("__init__")
	public function ___init__(container_strategy:Dynamic, cluster_resolver:Dynamic, variable_partitioner:Dynamic):Dynamic;
	/**
		Initialization of ParameterServerStrategyV2Extended.
	**/
	public function new(container_strategy:Dynamic, cluster_resolver:Dynamic, variable_partitioner:Dynamic):Void;
	/**
	...
	**/
	...
	public function _assert_being_scheduled_by_cluster_coordinator():Dynamic;
	public function _assert_used_with_cluster_coordinator():Dynamic;
	...
	**/
	...
	public function _create_var_creator(next_creator:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
	...
	**/
	...
	public function _create_variable_round_robin(next_creator:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	...
	**/
	public function _initialize_local(compute_devices:Dynamic, parameter_device:Dynamic, ?cluster_resolver:Dynamic):Dynamic;
	/**
	...
	**/
	...
	public function _initialize_strategy(?cluster_resolver:Dynamic, ?compute_devices:Dynamic, ?parameter_device:Dynamic):Dynamic;
	...
	**/
	...
	public function _set_num_gpus():Dynamic;
