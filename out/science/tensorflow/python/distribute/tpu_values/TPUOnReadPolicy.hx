...
@:pythonImport("tensorflow.python.distribute.tpu_values", "TPUOnReadPolicy") extern class TPUOnReadPolicy {
	...
	**/
	...
	public function assign(_var:Dynamic, ?args:python.VarArgs<Dynamic>, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
		Adds a value to this variable.
	**/
	public function assign_add(_var:Dynamic, ?args:python.VarArgs<Dynamic>, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
		Subtracts a value from this variable.
	**/
	public function assign_sub(_var:Dynamic, ?args:python.VarArgs<Dynamic>, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
