...
@:pythonImport("tensorflow.python.distribute.tpu_values", "TPUOnWritePolicy") extern class TPUOnWritePolicy {
	...
	**/
	...
	public function _scatter_xxx(raw_scater_xxx_fn:Dynamic, op_name:Dynamic, _var:Dynamic, sparse_delta:Dynamic, ?use_locking:Dynamic, ?name:Dynamic):Dynamic;
