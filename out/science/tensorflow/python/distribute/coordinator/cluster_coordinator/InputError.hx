...
@:pythonImport("tensorflow.python.distribute.coordinator.cluster_coordinator", "InputError") extern class InputError {
	/**
		exception cause
	**/
	...
	**/
	@:native("__init__")
	public function ___init__(original_exception:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(original_exception:Dynamic):Void;
	/**
