...
@:pythonImport("tensorflow.python.distribute.coordinator.cluster_coordinator", "WorkerPreemptionHandler") extern class WorkerPreemptionHandler {
	...
	**/
	@:native("__init__")
	public function ___init__(server_def:Dynamic, cluster:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(server_def:Dynamic, cluster:Dynamic):Void;
	/**
	...
	**/
	...
	/**
		...
		restarted workers.
	**/
	public function _preemption_handler():Dynamic;
	/**
		Validates that the given exception represents worker preemption.
	**/
	public function _validate_preemption_failure(e:Dynamic):Dynamic;
	/**
	...
	**/
	...
	/**
		...
		Yields:
		  None.
	**/
	public function wait_on_failure(?on_failure_fn:Dynamic, ?on_transient_failure_fn:Dynamic, ?on_recovery_fn:Dynamic, ?worker_device_name:Dynamic):Dynamic;
}