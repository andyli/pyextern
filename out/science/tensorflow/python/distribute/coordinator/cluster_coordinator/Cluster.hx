...
@:pythonImport("tensorflow.python.distribute.coordinator.cluster_coordinator", "Cluster") extern class Cluster {
	...
	**/
	public function _record_and_ignore_transient_ps_failure(e:Dynamic):Dynamic;
	/**
	...
	**/
	public function schedule(_function:Dynamic, args:Dynamic, kwargs:Dynamic):Dynamic;
	/**
