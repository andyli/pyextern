...
@:pythonImport("tensorflow.python.distribute.coordinator.values", "_RemoteDataset") extern class _RemoteDataset {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(graph_def:Dynamic, element_spec:Dynamic):Dynamic;
	/**
		Creates a DatasetV2 object.
		...
		Args:
		  variant_tensor: A DT_VARIANT tensor that represents the dataset.
	**/
	public function new(graph_def:Dynamic, element_spec:Dynamic):Void;
	/**
