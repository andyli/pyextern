...
@:pythonImport("tensorflow.python.distribute.coordinator.values", "PerWorkerValuesTypeSpec") extern class PerWorkerValuesTypeSpec {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(value_spec:Dynamic, descendant_type:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(value_spec:Dynamic, descendant_type:Dynamic):Void;
	/**
	...
	**/
	...
	/**
		...
		Returns:
		  A value that is compatible with this `TypeSpec`.
	**/
	public function _from_components(value:Dynamic):Dynamic;
	/**
