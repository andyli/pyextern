...
@:pythonImport("tensorflow.python.distribute.coordinator.values", "PerWorkerDatasetFromDataset") extern class PerWorkerDatasetFromDataset {
	...
	**/
	@:native("__init__")
	public function ___init__(dataset:Dynamic, coordinator:Dynamic):Dynamic;
	/**
		Makes an iterable from datasets created by the given dataset.
		...
		Args:
		  ...
		  coordinator: a `ClusterCoordinator` object, used to create dataset
		    resources.
	**/
	public function new(dataset:Dynamic, coordinator:Dynamic):Void;
	/**
