...
@:pythonImport("tensorflow.python.distribute.cross_device_ops", "AllReduceCrossDeviceOps") extern class AllReduceCrossDeviceOps {
	...
	**/
	@:native("__init__")
	public function ___init__(?all_reduce_alg:Dynamic, ?num_packs:Dynamic):Dynamic;
	/**
		Initializes the object.
		...
		Args:
		  ...
		  num_packs: a non-negative integer. The number of packs to split values
		    into. If zero, no packing will be done.
	**/
	public function new(?all_reduce_alg:Dynamic, ?num_packs:Dynamic):Void;
	/**
