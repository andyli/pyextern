...
@:pythonImport("tensorflow.python.distribute.input_lib", "_IterableInput") extern class _IterableInput {
	...
	**/
	@:native("__init__")
	public function ___init__(input_workers:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(input_workers:Dynamic):Void;
	/**
