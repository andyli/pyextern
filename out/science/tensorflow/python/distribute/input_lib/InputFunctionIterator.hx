...
@:pythonImport("tensorflow.python.distribute.input_lib", "InputFunctionIterator") extern class InputFunctionIterator {
	...
	**/
	@:native("__init__")
	public function ___init__(input_fn:Dynamic, input_workers:Dynamic, input_contexts:Dynamic, strategy:Dynamic):Dynamic;
	/**
		Make an iterator for input provided via an input function.
		...
		Args:
		  ...
		  strategy: a `tf.distribute.Strategy` object, used to run all-reduce to
		    handle last partial batch.
	**/
	public function new(input_fn:Dynamic, input_workers:Dynamic, input_contexts:Dynamic, strategy:Dynamic):Void;
	/**
