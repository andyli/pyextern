...
@:pythonImport("tensorflow.python.distribute.input_lib", "DistributedIteratorBase") extern class DistributedIteratorBase {
	...
	**/
	@:native("__init__")
	public function ___init__(input_workers:Dynamic, iterators:Dynamic, strategy:Dynamic, cardinality:Dynamic, enable_get_next_as_optional:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(input_workers:Dynamic, iterators:Dynamic, strategy:Dynamic, cardinality:Dynamic, enable_get_next_as_optional:Dynamic):Void;
	/**
