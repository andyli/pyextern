...
@:pythonImport("tensorflow.python.distribute.input_lib", "DistributedDataset") extern class DistributedDataset {
	...
	**/
	@:native("__init__")
	public function ___init__(input_workers:Dynamic, strategy:Dynamic, ?dataset:Dynamic, ?num_replicas_in_sync:Dynamic, ?input_context:Dynamic, ?components:Dynamic, ?element_spec:Dynamic, ?enable_get_next_as_optional:Dynamic, ?build:Dynamic, ?options:Dynamic):Dynamic;
	/**
		Distribute the dataset on all workers.
		...
		Args:
		  ...
		  options: `tf.distribute.InputOptions` used to control options on how this
		    dataset is distributed.
	**/
	public function new(input_workers:Dynamic, strategy:Dynamic, ?dataset:Dynamic, ?num_replicas_in_sync:Dynamic, ?input_context:Dynamic, ?components:Dynamic, ?element_spec:Dynamic, ?enable_get_next_as_optional:Dynamic, ?build:Dynamic, ?options:Dynamic):Void;
	/**
