...
@:pythonImport("tensorflow.python.distribute.input_lib", "_SingleWorkerCallableIterator") extern class _SingleWorkerCallableIterator {
	...
	**/
	@:native("__init__")
	public function ___init__(fn:Dynamic, worker:Dynamic, devices:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(fn:Dynamic, worker:Dynamic, devices:Dynamic):Void;
	/**
