...
@:pythonImport("tensorflow.python.distribute.input_lib", "DistributedDatasetsFromFunctionSpec") extern class DistributedDatasetsFromFunctionSpec {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(input_workers:Dynamic, element_spec:Dynamic, strategy:Dynamic, options:Dynamic, ?cardinality:Dynamic, ?enable_get_next_as_optional:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(input_workers:Dynamic, element_spec:Dynamic, strategy:Dynamic, options:Dynamic, ?cardinality:Dynamic, ?enable_get_next_as_optional:Dynamic):Void;
	/**
	...
	**/
	...
	public var _cardinality : Dynamic;
	/**
	...
	**/
	public function _deserialize():Dynamic;
	public var _element_spec : Dynamic;
	public var _enable_get_next_as_optional : Dynamic;
	/**
	...
	/**
		...
		Raises:
		  ValueError: If there is no TypeSpec that is compatible with both `self`
		    and `other`.
	**/
	public function sanity_check_type(other:Dynamic):Dynamic;
	/**
