...
@:pythonImport("tensorflow.python.distribute.parallel_device.saving", "_ParallelComponentSaveable") extern class _ParallelComponentSaveable {
	...
	**/
	@:native("__init__")
	public function ___init__(name:Dynamic, handle:Dynamic, dtype:Dynamic, shape:Dynamic):Dynamic;
	/**
		Creates a `SaveableObject` object.
		...
		Args:
		  ...
		  name: the name to save the object under.
	**/
	public function new(name:Dynamic, handle:Dynamic, dtype:Dynamic, shape:Dynamic):Void;
	/**
	...
	/**
		...
		Raises:
		  ValueError: If the object cannot be restored using the provided
		    parameters.
	**/
	public function restore(tensors:Dynamic, ?restored_shapes:Dynamic):Dynamic;
}