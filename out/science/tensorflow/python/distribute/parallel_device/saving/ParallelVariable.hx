...
@:pythonImport("tensorflow.python.distribute.parallel_device.saving", "ParallelVariable") extern class ParallelVariable {
	/**
	...
	**/
	...
	public var __annotations__ : Dynamic;
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(parallel_device:Dynamic, wrapped_variable:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(parallel_device:Dynamic, wrapped_variable:Dynamic):Void;
	/**
	...
	**/
	...
	public function __mro_entries__(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
		Return self*value.
	**/
	...
	**/
	...
	public var __wrapped__ : Dynamic;
	/**
		Return self^value.
	**/
