...
package tensorflow.python.distribute.values_v2;
@:pythonImport("tensorflow.python.distribute.values_v2", "DistributedVariable") extern class DistributedVariable {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(variables:Dynamic, ?enable_packed_handle:Dynamic):Dynamic;
	/**
		Creates a variable from a handle.
		...
		Args:
		  ...
		  in_graph_mode: whether we are executing in TF1 graph mode. If None, will
		    ...
		    conetxt entrances which can add up.
	**/
	public function new(variables:Dynamic, ?enable_packed_handle:Dynamic):Void;
	/**
	...
	**/
	...
	public function _device_scope():Dynamic;
	/**
	...
	**/
	...
	public function _strided_slice_assign(?args:python.VarArgs<Dynamic>, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
