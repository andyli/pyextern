...
@:pythonImport("tensorflow.python.distribute.one_device_strategy", "OneDeviceExtended") extern class OneDeviceExtended {
	...
	**/
	public function _local_results(value:Dynamic):Dynamic;
	/**
	...
	**/
	...
	public var _support_per_replica_values : Dynamic;
