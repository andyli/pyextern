...
@:pythonImport("tensorflow.python.distribute.packed_distributed_variable", "PackedDistributedVariable") extern class PackedDistributedVariable {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(?distributed_variables:Dynamic, ?name:Dynamic, ?unused_kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
		Packs a list of variables which are distributed across devices.
		...
		Args:
		  ...
		  name: Optional name for the variable. Defaults to `'Variable'` and gets
		    uniquified automatically.
	**/
	public function new(?distributed_variables:Dynamic, ?name:Dynamic, ?unused_kwargs:python.KwArgs<Dynamic>):Void;
	/**
	...
	**/
	...
	public function get_var_on_current_device():Dynamic;
	public function get_var_on_device(device:Dynamic):Dynamic;
	/**
	...
	**/
	public function initial_value(device:Dynamic):Dynamic;
	/**
	...
	**/
	...
	public var packed_handle : Dynamic;
	/**
