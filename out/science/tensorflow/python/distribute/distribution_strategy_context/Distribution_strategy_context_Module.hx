...
@:pythonImport("tensorflow.python.distribute.distribution_strategy_context") extern class Distribution_strategy_context_Module {
	...
	static public function _assert_strategy(strategy:Dynamic):Dynamic;
	static public var _default_replica_context_lock : Dynamic;
	static public var _default_replica_mode_lock : Dynamic;
	static public var _default_strategy_lock : Dynamic;
	...
	static public function _get_default_strategy():Dynamic;
	...
	static public var _variable_sync_on_read_context : Dynamic;
