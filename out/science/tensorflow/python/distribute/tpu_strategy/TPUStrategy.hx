...
@:pythonImport("tensorflow.python.distribute.tpu_strategy", "TPUStrategy") extern class TPUStrategy {
	...
	**/
	@:native("__init__")
	public function ___init__(?tpu_cluster_resolver:Dynamic, ?device_assignment:Dynamic):Dynamic;
	/**
		Synchronous training in TPU donuts or Pods.
		...
		Args:
		  ...
		  device_assignment: Optional `tf.tpu.experimental.DeviceAssignment` to
		    specify the placement of replicas on the TPU cluster.
	**/
	public function new(?tpu_cluster_resolver:Dynamic, ?device_assignment:Dynamic):Void;
	/**
