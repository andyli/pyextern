...
@:pythonImport("tensorflow.python.distribute.tpu_strategy", "TPUStrategyV1") extern class TPUStrategyV1 {
	...
	**/
	@:native("__init__")
	public function ___init__(?tpu_cluster_resolver:Dynamic, ?steps_per_run:Dynamic, ?device_assignment:Dynamic):Dynamic;
	/**
		Initializes the TPUStrategy object.
		...
		Args:
		  ...
		  device_assignment: Optional `tf.tpu.experimental.DeviceAssignment` to
		      ...
		      supports the usecase of using a single core within a TPU cluster.
	**/
	public function new(?tpu_cluster_resolver:Dynamic, ?steps_per_run:Dynamic, ?device_assignment:Dynamic):Void;
	/**
