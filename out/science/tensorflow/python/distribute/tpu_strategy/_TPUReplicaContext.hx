...
@:pythonImport("tensorflow.python.distribute.tpu_strategy", "_TPUReplicaContext") extern class _TPUReplicaContext {
	...
	**/
	...
	public function _compute_all_gather_output_shape(value_shape:Dynamic, value_rank:Dynamic, axis:Dynamic):Dynamic;
	/**
	...
	**/
	public function all_gather(value:Dynamic, axis:Dynamic, ?experimental_hints:Dynamic):Dynamic;
	/**
