...
@:pythonImport("tensorflow.python.distribute.tpu_strategy", "TPUStrategyV2") extern class TPUStrategyV2 {
	...
	**/
	@:native("__init__")
	public function ___init__(?tpu_cluster_resolver:Dynamic, ?experimental_device_assignment:Dynamic):Dynamic;
	/**
		Synchronous training in TPU donuts or Pods.
		...
		Args:
		  ...
		  experimental_device_assignment: Optional
		    ...
		    replicas on the TPU cluster.
	**/
	public function new(?tpu_cluster_resolver:Dynamic, ?experimental_device_assignment:Dynamic):Void;
	/**
	...
	**/
	public function experimental_assign_to_logical_device(tensor:Dynamic, logical_device_id:Dynamic):Dynamic;
	/**
	...
	**/
	...
	/**
		...
		Returns:
		  Annotated tensor with identical value as `tensor`.
	**/
	public function experimental_replicate_to_logical_devices(tensor:Dynamic):Dynamic;
	/**
	...
	**/
	...
	/**
		...
		Returns:
		  Annotated tensor with identical value as `tensor`.
	**/
	public function experimental_split_to_logical_devices(tensor:Dynamic, partition_dimensions:Dynamic):Dynamic;
	/**
