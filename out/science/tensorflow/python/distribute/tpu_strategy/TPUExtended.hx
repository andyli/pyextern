...
@:pythonImport("tensorflow.python.distribute.tpu_strategy", "TPUExtended") extern class TPUExtended {
	...
	**/
	@:native("__init__")
	public function ___init__(container_strategy:Dynamic, ?tpu_cluster_resolver:Dynamic, ?steps_per_run:Dynamic, ?device_assignment:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(container_strategy:Dynamic, ?tpu_cluster_resolver:Dynamic, ?steps_per_run:Dynamic, ?device_assignment:Dynamic):Void;
	/**
	...
	**/
	...
	public function _broadcast_output(destinations:Dynamic, output:Dynamic):Dynamic;
	...
	public function _check_spec(element_spec:Dynamic):Dynamic;
	/**
	...
	**/
	public function _experimental_initialize_system():Dynamic;
	public function _experimental_make_numpy_dataset(numpy_input:Dynamic, session:Dynamic):Dynamic;
	public function _experimental_run_steps_on_iterator(fn:Dynamic, multi_worker_iterator:Dynamic, iterations:Dynamic, ?initial_loop_values:Dynamic):Dynamic;
	/**
	...
	**/
	...
	public function _get_input_workers(options:Dynamic):Dynamic;
	...
	**/
	...
	public function _tpu_function_creator(fn:Dynamic, options:Dynamic):Dynamic;
	...
	**/
	public function experimental_logical_device(logical_device_id:Dynamic):Dynamic;
	/**
	...
	**/
	...
	public var num_replicas_per_host : Dynamic;
	/**
	...
	**/
	...
	public function tpu_run(fn:Dynamic, args:Dynamic, kwargs:Dynamic, ?options:Dynamic):Dynamic;
	/**
