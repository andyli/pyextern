...
@:pythonImport("tensorflow.python.distribute.cluster_resolver.cluster_resolver", "SimpleClusterResolver") extern class SimpleClusterResolver {
	...
	**/
	@:native("__init__")
	public function ___init__(cluster_spec:Dynamic, ?master:Dynamic, ?task_type:Dynamic, ?task_id:Dynamic, ?environment:Dynamic, ?num_accelerators:Dynamic, ?rpc_layer:Dynamic):Dynamic;
	/**
		Creates a SimpleClusterResolver from a ClusterSpec.
	**/
	public function new(cluster_spec:Dynamic, ?master:Dynamic, ?task_type:Dynamic, ?task_id:Dynamic, ?environment:Dynamic, ?num_accelerators:Dynamic, ?rpc_layer:Dynamic):Void;
	/**
