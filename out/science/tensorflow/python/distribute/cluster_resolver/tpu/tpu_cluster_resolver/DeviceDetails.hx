...
@:pythonImport("tensorflow.python.distribute.cluster_resolver.tpu.tpu_cluster_resolver", "DeviceDetails") extern class DeviceDetails {
	/**
		Return self+value.
	**/
	...
	**/
	...
	/**
		Create new instance of DeviceDetails(device_map, total_cores)
	**/
	static public function __new__(_cls:Dynamic, device_map:Dynamic, total_cores:Dynamic):Dynamic;
	/**
		Helper for pickle.
	**/
	...
	**/
	...
	/**
		Make a new DeviceDetails object from a sequence or iterable
	**/
	static public function _make(iterable:Dynamic):Dynamic;
	/**
		Return a new DeviceDetails object replacing specified fields with new values
	**/
	...
	**/
	public var total_cores : Dynamic;
}