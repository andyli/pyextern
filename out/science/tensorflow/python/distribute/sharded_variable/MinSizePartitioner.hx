...
@:pythonImport("tensorflow.python.distribute.sharded_variable", "MinSizePartitioner") extern class MinSizePartitioner {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(?min_shard_bytes:Dynamic, ?max_shards:Dynamic, ?bytes_per_string:Dynamic):Dynamic;
	/**
		Creates a new `MinSizePartitioner`.
		...
		Args:
		  ...
		  bytes_per_string: If the partition value is of type string, this provides
		    an estimate of how large each string is.
	**/
	public function new(?min_shard_bytes:Dynamic, ?max_shards:Dynamic, ?bytes_per_string:Dynamic):Void;
	/**
