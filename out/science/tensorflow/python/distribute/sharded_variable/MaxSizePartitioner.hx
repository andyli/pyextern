...
@:pythonImport("tensorflow.python.distribute.sharded_variable", "MaxSizePartitioner") extern class MaxSizePartitioner {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(max_shard_bytes:Dynamic, ?max_shards:Dynamic, ?bytes_per_string:Dynamic):Dynamic;
	/**
		Creates a new `MaxSizePartitioner`.
		...
		Args:
		  ...
		  bytes_per_string: If the partition value is of type string, this provides
		    an estimate of how large each string is.
	**/
	public function new(max_shard_bytes:Dynamic, ?max_shards:Dynamic, ?bytes_per_string:Dynamic):Void;
	/**
