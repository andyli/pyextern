...
@:pythonImport("tensorflow.python.distribute.sharded_variable", "ShardedVariableSpec") extern class ShardedVariableSpec {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(?variable_specs:python.VarArgs<Dynamic>):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(?variable_specs:python.VarArgs<Dynamic>):Void;
	/**
	...
	**/
	...
	/**
		...
		Returns:
		  A value that is compatible with this `TypeSpec`.
	**/
	public function _from_components(variables:Dynamic):Dynamic;
	/**
	...
	**/
	...
	public var _variable_specs : Dynamic;
	/**
