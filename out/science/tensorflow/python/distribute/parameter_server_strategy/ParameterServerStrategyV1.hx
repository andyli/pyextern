...
@:pythonImport("tensorflow.python.distribute.parameter_server_strategy", "ParameterServerStrategyV1") extern class ParameterServerStrategyV1 {
	...
	**/
	@:native("__init__")
	public function ___init__(?cluster_resolver:Dynamic):Dynamic;
	/**
		Initializes this strategy with an optional `cluster_resolver`.
		...
		Args:
		  cluster_resolver: Optional
		    ...
		    `tf.distribute.cluster_resolver.TFConfigClusterResolver`.
	**/
	public function new(?cluster_resolver:Dynamic):Void;
	/**
	...
	**/
	...
	public function _raise_pss_error_if_eager():Dynamic;
	/**
