...
package tensorflow.python.distribute.parameter_server_strategy;
@:pythonImport("tensorflow.python.distribute.parameter_server_strategy", "ParameterServerStrategyExtended") extern class ParameterServerStrategyExtended {
	...
	**/
	@:native("__init__")
	public function ___init__(container_strategy:Dynamic, ?cluster_resolver:Dynamic, ?compute_devices:Dynamic, ?parameter_device:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(container_strategy:Dynamic, ?cluster_resolver:Dynamic, ?compute_devices:Dynamic, ?parameter_device:Dynamic):Void;
	/**
