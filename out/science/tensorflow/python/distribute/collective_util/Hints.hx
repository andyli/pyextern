...
@:pythonImport("tensorflow.python.distribute.collective_util", "Hints") extern class Hints {
	...
	**/
	@:native("__init__")
	public function ___init__(?bytes_per_pack:Dynamic, ?timeout_seconds:Dynamic):Dynamic;
	/**
		Creates a CollectiveHints.
		...
		Raises:
		  ValueError: When arguments have invalid value.
	**/
	public function new(?bytes_per_pack:Dynamic, ?timeout_seconds:Dynamic):Void;
	/**
	...
	**/
	static public function __new__(cls:Dynamic, ?bytes_per_pack:Dynamic, ?timeout_seconds:Dynamic):Dynamic;
	/**
		Helper for pickle.
	**/
