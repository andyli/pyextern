...
@:pythonImport("tensorflow.python.distribute.experimental.rpc.rpc_ops", "StatusOrResult") extern class StatusOrResult {
	...
	**/
	@:native("__init__")
	public function ___init__(status_or:Dynamic, deleter:Dynamic, ?output_specs:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(status_or:Dynamic, deleter:Dynamic, ?output_specs:Dynamic):Void;
	/**
