...
@:pythonImport("tensorflow.python.distribute.distribute_lib", "_DefaultDistributionContext") extern class _DefaultDistributionContext {
	...
	**/
	...
	public var _nested_count : Dynamic;
	public var _strategy : Dynamic;
	public var _var_creator_scope : Dynamic;
}