...
@:pythonImport("tensorflow.python.eager.function", "FunctionAlreadyGarbageCollectedError") extern class FunctionAlreadyGarbageCollectedError {
	/**
		exception cause
	**/
	...
	**/
	@:native("__init__")
	public function ___init__(function_name:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(function_name:Dynamic):Void;
	/**
