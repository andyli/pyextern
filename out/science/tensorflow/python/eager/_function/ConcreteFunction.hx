...
@:pythonImport("tensorflow.python.eager.function", "ConcreteFunction") extern class ConcreteFunction {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(func_graph:Dynamic, ?attrs:Dynamic, ?shared_func_graph:Dynamic, ?function_spec:Dynamic):Dynamic;
	/**
		Initialize a `ConcreteFunction`.
		...
		Raises:
		  ValueError: If number of input_placeholders is not equal to the number
		    of function inputs.
	**/
	public function new(func_graph:Dynamic, ?attrs:Dynamic, ?shared_func_graph:Dynamic, ?function_spec:Dynamic):Void;
	/**
