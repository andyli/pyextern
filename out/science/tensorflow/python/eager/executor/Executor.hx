...
package tensorflow.python.eager.executor;
@:pythonImport("tensorflow.python.eager.executor", "Executor") extern class Executor {
	...
	**/
	@:native("__init__")
	public function ___init__(handle:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	...
	**/
	public function clear_error():Dynamic;
