...
@:pythonImport("tensorflow.python.eager.monitoring", "CounterCell") extern class CounterCell {
	...
	**/
	public function increase_by(value:Dynamic):Dynamic;
	/**
