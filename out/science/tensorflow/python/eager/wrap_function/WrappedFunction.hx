...
@:pythonImport("tensorflow.python.eager.wrap_function", "WrappedFunction") extern class WrappedFunction {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(fn_graph:Dynamic, variable_holder:Dynamic, ?attrs:Dynamic, ?signature:Dynamic):Dynamic;
	/**
		Initialize a `ConcreteFunction`.
		...
		Raises:
		  ValueError: If number of input_placeholders is not equal to the number
		    of function inputs.
	**/
	public function new(fn_graph:Dynamic, variable_holder:Dynamic, ?attrs:Dynamic, ?signature:Dynamic):Void;
	/**
	...
	**/
	public function prune(feeds:Dynamic, fetches:Dynamic, ?name:Dynamic, ?input_signature:Dynamic):Dynamic;
	/**
