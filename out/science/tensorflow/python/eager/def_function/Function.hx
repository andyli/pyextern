...
@:pythonImport("tensorflow.python.eager.def_function", "Function") extern class Function {
	...
	**/
	@:native("__init__")
	public function ___init__(python_function:Dynamic, name:Dynamic, ?input_signature:Dynamic, ?autograph:Dynamic, ?jit_compile:Dynamic, ?experimental_implements:Dynamic, ?experimental_autograph_options:Dynamic, ?experimental_relax_shapes:Dynamic, ?experimental_follow_type_hints:Dynamic):Dynamic;
	/**
		Initializes a `Function`.
		...
		Raises:
		  ValueError: if `input_signature` is not None and the `python_function`'s
		    argspec has keyword arguments.
	**/
	public function new(python_function:Dynamic, name:Dynamic, ?input_signature:Dynamic, ?autograph:Dynamic, ?jit_compile:Dynamic, ?experimental_implements:Dynamic, ?experimental_autograph_options:Dynamic, ?experimental_relax_shapes:Dynamic, ?experimental_follow_type_hints:Dynamic):Void;
	/**
