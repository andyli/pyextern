...
@:pythonImport("tensorflow.python.eager.lift_to_graph", "_ControlMutation") extern class _ControlMutation {
	/**
		Return self+value.
	**/
	...
	**/
	...
	/**
		Create new instance of _ControlMutation(copied_op, old_graph_op)
	**/
	static public function __new__(_cls:Dynamic, copied_op:Dynamic, old_graph_op:Dynamic):Dynamic;
	/**
		Helper for pickle.
	**/
	...
	**/
	...
	/**
		Make a new _ControlMutation object from a sequence or iterable
	**/
	static public function _make(iterable:Dynamic):Dynamic;
	/**
		Return a new _ControlMutation object replacing specified fields with new values
	**/
	...
	**/
	public var old_graph_op : Dynamic;
}