...
@:pythonImport("tensorflow.python.eager.context", "LogicalDevice") extern class LogicalDevice {
	/**
		Return self+value.
	**/
	...
	**/
	...
	/**
		Make a new LogicalDevice object from a sequence or iterable
	**/
	static public function _make(iterable:Dynamic):Dynamic;
	/**
		Return a new LogicalDevice object replacing specified fields with new values
	**/
