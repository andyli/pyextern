...
@:pythonImport("tensorflow.python.eager.context", "FunctionCallOptions") extern class FunctionCallOptions {
	...
	**/
	@:native("__init__")
	public function ___init__(?executor_type:Dynamic, ?config_proto:Dynamic):Dynamic;
	/**
		Constructor.
		...
		Args:
		  ...
		  config_proto: (optional) a `config_pb2.ConfigProto` proto or a serialized
		    ...
		    config_proto is None, an empty RewriterConfig will be used.
	**/
	public function new(?executor_type:Dynamic, ?config_proto:Dynamic):Void;
	/**
	...
	**/
	...
	public var _config_proto_serialized : Dynamic;
	public var _executor_type : Dynamic;
	public var config_proto_serialized : Dynamic;
	public var executor_type : Dynamic;
}