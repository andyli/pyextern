...
@:pythonImport("tensorflow.python.eager.context", "_ContextSwitchStack") extern class _ContextSwitchStack {
	...
	**/
	@:native("__init__")
	public function ___init__(eager:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(eager:Dynamic):Void;
	/**
	...
	/**
		...
		Args:
		  ...
		  device_stack: If applicable, the device function stack for this graph.
		    ...
		    used.
	**/
	public function push(is_building_function:Dynamic, enter_context_fn:Dynamic, device_stack:Dynamic):Dynamic;
}