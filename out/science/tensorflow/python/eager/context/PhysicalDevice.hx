...
@:pythonImport("tensorflow.python.eager.context", "PhysicalDevice") extern class PhysicalDevice {
	/**
		Return self+value.
	**/
	...
	**/
	static public function __new__(_cls:Dynamic, name:Dynamic, device_type:Dynamic):Dynamic;
	/**
		Helper for pickle.
	**/
	...
	**/
	...
	/**
		Make a new PhysicalDevice object from a sequence or iterable
	**/
	static public function _make(iterable:Dynamic):Dynamic;
	/**
		Return a new PhysicalDevice object replacing specified fields with new values
	**/
