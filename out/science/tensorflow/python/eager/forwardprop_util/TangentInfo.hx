...
@:pythonImport("tensorflow.python.eager.forwardprop_util", "TangentInfo") extern class TangentInfo {
	/**
		Return self+value.
	**/
	...
	**/
	...
	/**
		Create new instance of TangentInfo(indices, tangents)
	**/
	static public function __new__(cls:Dynamic, ?indices:Dynamic, ?tangents:Dynamic):Dynamic;
	/**
		Helper for pickle.
	**/
	...
	**/
	...
	/**
		Make a new TangentInfo object from a sequence or iterable
	**/
	static public function _make(iterable:Dynamic):Dynamic;
	/**
		Return a new TangentInfo object replacing specified fields with new values
	**/
