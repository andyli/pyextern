...
@:pythonImport("tensorflow.python.tools.inspect_checkpoint") extern class Inspect_checkpoint_Module {
	...
	**/
	static public function _count_total_params(reader:Dynamic, ?count_exclude_pattern:Dynamic):Dynamic;
	...
	**/
	static public function print_tensors_in_checkpoint_file(file_name:Dynamic, tensor_name:Dynamic, all_tensors:Dynamic, ?all_tensor_names:Dynamic, ?count_exclude_pattern:Dynamic):Dynamic;
}