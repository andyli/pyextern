...
@:pythonImport("tensorflow.python.tools.saved_model_cli") extern class Saved_model_cli_Module {
	static public var _OP_DENYLIST : Dynamic;
	static public var _XLA_DEBUG_OPTIONS_URL : Dynamic;
	...
	/**
		...
		Args:
		  ...
		  indent: How far (in increments of 2 spaces) to indent each line of
		   output.
	**/
	static public function _print_args(arguments:Dynamic, ?argument_type:Dynamic, ?indent:Dynamic):Dynamic;
	/**
	...
	**/
	...
	/**
		...
		Args:
		  saved_model_dir: Directory containing the SavedModel to inspect.
	**/
	static public function _show_defined_functions(saved_model_dir:Dynamic):Dynamic;
	/**
	...
	**/
	static public function add_aot_compile_cpu_subparser(subparsers:Dynamic):Dynamic;
	/**
		Add parser for `convert`.
	**/
	static public function add_convert_subparser(subparsers:Dynamic):Dynamic;
	/**
		Add parser for `run`.
	**/
	static public function add_run_subparser(subparsers:Dynamic):Dynamic;
	/**
		Add parser for `scan`.
	**/
	static public function add_scan_subparser(subparsers:Dynamic):Dynamic;
	/**
		Add parser for `show`.
	**/
	static public function add_show_subparser(subparsers:Dynamic):Dynamic;
	/**
	...
	**/
	static public function aot_compile_cpu(args:Dynamic):Dynamic;
	/**
	...
	**/
	static public function preprocess_input_exprs_arg_string(input_exprs_str:Dynamic, ?safe:Dynamic):Dynamic;
	/**
