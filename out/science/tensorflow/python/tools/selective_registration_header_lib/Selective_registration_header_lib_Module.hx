...
@:pythonImport("tensorflow.python.tools.selective_registration_header_lib") extern class Selective_registration_header_lib_Module {
	static public var FLEX_PREFIX : Dynamic;
	static public var FLEX_PREFIX_LENGTH : Dynamic;
	static public var OPS_WITHOUT_KERNEL_ALLOWLIST : Dynamic;
	...
	**/
	static public function _get_ops_from_graphdef(graph_def:Dynamic):Dynamic;
	/**
		Gets the ops and kernels needed from the ops list file.
	**/
	static public function _get_ops_from_ops_list(input_file:Dynamic):Dynamic;
