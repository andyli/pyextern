...
@:pythonImport("tensorflow.python.platform.benchmark", "ParameterizedBenchmark") extern class ParameterizedBenchmark {
	public var __abstractmethods__ : Dynamic;
	/**
		The Benchmark class registrar.  Used by abstract Benchmark class.
	**/
	static public function __base__(clsname:Dynamic, base:Dynamic, attrs:Dynamic):Dynamic;
	...
	**/
	static public function __new__(mcs:Dynamic, clsname:Dynamic, base:Dynamic, attrs:Dynamic):Dynamic;
	/**
		__prepare__() -> dict
