...
@:pythonImport("tensorflow.python.framework.func_graph", "FuncGraph") extern class FuncGraph {
	...
	**/
	@:native("__init__")
	public function ___init__(name:Dynamic, ?collections:Dynamic, ?capture_by_value:Dynamic):Dynamic;
	/**
		Construct a new FuncGraph.
		...
		Args:
		  ...
		  capture_by_value: An optional boolean. If True, the func graph will
		    ...
		    from outer graphs, and failing that will default to False.
	**/
	public function new(name:Dynamic, ?collections:Dynamic, ?capture_by_value:Dynamic):Void;
	/**
