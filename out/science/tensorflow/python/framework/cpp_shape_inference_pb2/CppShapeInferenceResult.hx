...
@:pythonImport("tensorflow.python.framework.cpp_shape_inference_pb2", "CppShapeInferenceResult") extern class CppShapeInferenceResult {
	/**
	...
	**/
	...
	/**
		Field tensorflow.CppShapeInferenceResult.handle_data
	**/
	public var handle_data : Dynamic;
	/**
		Field tensorflow.CppShapeInferenceResult.shape
	**/
