...
@:pythonImport("tensorflow.python.framework.function") extern class _Function_Module {
	...
	**/
	...
	/**
		Creates an AttrValue for a python object.
	**/
	static public function _get_kwarg_as_str_attr(attr_name:Dynamic, value:Dynamic):Dynamic;
	/**
	...
	**/
	static public function func_graph_from_py_func(func:Dynamic, arg_names:Dynamic, arg_types:Dynamic, ?name:Dynamic, ?capture_by_value:Dynamic, ?device:Dynamic, ?colocation_stack:Dynamic, ?container:Dynamic, ?collections_ref:Dynamic, ?arg_shapes:Dynamic, ?allowlisted_stateful_ops:Dynamic, ?capture_resource_var_by_value:Dynamic):Dynamic;
	/**
