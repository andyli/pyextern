...
@:pythonImport("tensorflow.python.framework.errors_impl", "OpError") extern class OpError {
	/**
		exception cause
	**/
	...
	**/
	@:native("__init__")
	public function ___init__(node_def:Dynamic, op:Dynamic, message:Dynamic, error_code:Dynamic, ?args:python.VarArgs<Dynamic>):Dynamic;
	/**
		Creates a new `OpError` indicating that a particular op failed.
		...
		Args:
		  ...
		  *args: If not empty, it should contain a dictionary describing details
		    ...
		    https://github.com/abseil/abseil-cpp/blob/master/absl/status/status.h
	**/
	public function new(node_def:Dynamic, op:Dynamic, message:Dynamic, error_code:Dynamic, ?args:python.VarArgs<Dynamic>):Void;
	/**
