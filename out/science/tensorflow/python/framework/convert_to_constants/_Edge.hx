...
@:pythonImport("tensorflow.python.framework.convert_to_constants", "_Edge") extern class _Edge {
	/**
		Return self+value.
	**/
	...
	**/
	...
	/**
		Create new instance of _Edge(source, destination)
	**/
	static public function __new__(_cls:Dynamic, source:Dynamic, destination:Dynamic):Dynamic;
	/**
		Helper for pickle.
	**/
	...
	**/
	...
	/**
		Make a new _Edge object from a sequence or iterable
	**/
	static public function _make(iterable:Dynamic):Dynamic;
	/**
		Return a new _Edge object replacing specified fields with new values
	**/
