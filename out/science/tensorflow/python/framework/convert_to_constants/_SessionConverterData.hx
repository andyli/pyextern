...
@:pythonImport("tensorflow.python.framework.convert_to_constants", "_SessionConverterData") extern class _SessionConverterData {
	...
	**/
	@:native("__init__")
	public function ___init__(session:Dynamic, graph_def:Dynamic, output_node_names:Dynamic, ?variable_names_allowlist:Dynamic, ?variable_names_denylist:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(session:Dynamic, graph_def:Dynamic, output_node_names:Dynamic, ?variable_names_allowlist:Dynamic, ?variable_names_denylist:Dynamic):Void;
	/**
