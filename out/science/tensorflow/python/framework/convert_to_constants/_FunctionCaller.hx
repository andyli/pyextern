...
@:pythonImport("tensorflow.python.framework.convert_to_constants", "_FunctionCaller") extern class _FunctionCaller {
	...
	**/
	@:native("__init__")
	public function ___init__(node:Dynamic, _function:Dynamic, enclosing_graph:Dynamic, first_function_input:Dynamic, type_attribute:Dynamic, function_attributes:Dynamic):Dynamic;
	/**
		Initializes a _FunctionCaller.
		...
		Args:
		  ...
		  function_attributes: The names of the NodeDef attributes containing
		    references to functions.
	**/
	public function new(node:Dynamic, _function:Dynamic, enclosing_graph:Dynamic, first_function_input:Dynamic, type_attribute:Dynamic, function_attributes:Dynamic):Void;
	/**
