...
@:pythonImport("tensorflow.python.framework.convert_to_constants", "_ConverterData") extern class _ConverterData {
	...
	**/
	@:native("__init__")
	public function ___init__(graph_def:Dynamic, ?variable_names_allowlist:Dynamic, ?variable_names_denylist:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(graph_def:Dynamic, ?variable_names_allowlist:Dynamic, ?variable_names_denylist:Dynamic):Void;
	/**
