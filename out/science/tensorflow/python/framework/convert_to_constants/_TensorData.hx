...
@:pythonImport("tensorflow.python.framework.convert_to_constants", "_TensorData") extern class _TensorData {
	/**
		Return self+value.
	**/
	...
	**/
	...
	/**
		Create new instance of _TensorData(numpy, dtype, index)
	**/
	static public function __new__(_cls:Dynamic, numpy:Dynamic, dtype:Dynamic, index:Dynamic):Dynamic;
	/**
		Helper for pickle.
	**/
	...
	**/
	...
	/**
		Make a new _TensorData object from a sequence or iterable
	**/
	static public function _make(iterable:Dynamic):Dynamic;
	/**
		Return a new _TensorData object replacing specified fields with new values
	**/
