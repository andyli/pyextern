...
@:pythonImport("tensorflow.python.framework.convert_to_constants", "_FunctionConverterDataInGraph") extern class _FunctionConverterDataInGraph {
	...
	**/
	@:native("__init__")
	public function ___init__(func:Dynamic, lower_control_flow:Dynamic, aggressive_inlining:Dynamic, ?variable_names_allowlist:Dynamic, ?variable_names_denylist:Dynamic, ?session:Dynamic):Dynamic;
	/**
		Creates the conversion data for the given function.
		...
		Args:
		  ...
		  session: Session object.
	**/
	public function new(func:Dynamic, lower_control_flow:Dynamic, aggressive_inlining:Dynamic, ?variable_names_allowlist:Dynamic, ?variable_names_denylist:Dynamic, ?session:Dynamic):Void;
	/**
