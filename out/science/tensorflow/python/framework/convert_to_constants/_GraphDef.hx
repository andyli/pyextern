...
@:pythonImport("tensorflow.python.framework.convert_to_constants", "_GraphDef") extern class _GraphDef {
	...
	**/
	@:native("__init__")
	public function ___init__(graph_def:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(graph_def:Dynamic):Void;
	/**
	...
	**/
	public var converted_function_names : Dynamic;
	/**
	...
	**/
	...
	public function rename_function(old_name:Dynamic, new_name:Dynamic):Dynamic;
}