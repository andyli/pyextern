...
@:pythonImport("tensorflow.python.framework.convert_to_constants", "_EndPoint") extern class _EndPoint {
	/**
		Return self+value.
	**/
	...
	**/
	...
	/**
		Create new instance of _EndPoint(convertible, index)
	**/
	static public function __new__(_cls:Dynamic, convertible:Dynamic, index:Dynamic):Dynamic;
	/**
		Helper for pickle.
	**/
	...
	**/
	...
	/**
		Make a new _EndPoint object from a sequence or iterable
	**/
	static public function _make(iterable:Dynamic):Dynamic;
	/**
		Return a new _EndPoint object replacing specified fields with new values
	**/
	public function _replace(?kwds:python.KwArgs<Dynamic>):Dynamic;
	/**
		Alias for field number 0
	**/
	public var convertible : Dynamic;
	/**
