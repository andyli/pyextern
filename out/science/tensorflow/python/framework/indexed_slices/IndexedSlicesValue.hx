...
@:pythonImport("tensorflow.python.framework.indexed_slices", "IndexedSlicesValue") extern class IndexedSlicesValue {
	/**
		Return self+value.
	**/
	...
	**/
	...
	/**
		Create new instance of IndexedSlicesValue(values, indices, dense_shape)
	**/
	static public function __new__(_cls:Dynamic, values:Dynamic, indices:Dynamic, dense_shape:Dynamic):Dynamic;
	/**
		Helper for pickle.
	**/
	...
	**/
	...
	/**
		Make a new IndexedSlicesValue object from a sequence or iterable
	**/
	static public function _make(iterable:Dynamic):Dynamic;
	/**
		Return a new IndexedSlicesValue object replacing specified fields with new values
	**/
