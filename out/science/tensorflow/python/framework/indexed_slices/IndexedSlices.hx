...
@:pythonImport("tensorflow.python.framework.indexed_slices", "IndexedSlices") extern class IndexedSlices {
	...
	**/
	@:native("__init__")
	public function ___init__(values:Dynamic, indices:Dynamic, ?dense_shape:Dynamic):Dynamic;
	/**
		Creates an `IndexedSlices`.
	**/
	public function new(values:Dynamic, indices:Dynamic, ?dense_shape:Dynamic):Void;
	/**
