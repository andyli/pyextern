...
@:pythonImport("tensorflow.python.framework.indexed_slices", "IndexedSlicesSpec") extern class IndexedSlicesSpec {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(?shape:Dynamic, ?dtype:Dynamic, ?indices_dtype:Dynamic, ?dense_shape_dtype:Dynamic, ?indices_shape:Dynamic):Dynamic;
	/**
		Constructs a type specification for a `tf.IndexedSlices`.
		...
		Args:
		  ...
		  indices_shape: The shape of the `indices` component, which indicates
		    how many slices are in the `IndexedSlices`.
	**/
	public function new(?shape:Dynamic, ?dtype:Dynamic, ?indices_dtype:Dynamic, ?dense_shape_dtype:Dynamic, ?indices_shape:Dynamic):Void;
	/**
	...
	**/
	...
	public var _dense_shape_dtype : Dynamic;
	/**
	...
	**/
	...
	public var _indices_dtype : Dynamic;
	public var _indices_shape : Dynamic;
	/**
	...
	**/
	...
	public var _values_dtype : Dynamic;
	/**
