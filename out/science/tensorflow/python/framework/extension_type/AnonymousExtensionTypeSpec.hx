...
@:pythonImport("tensorflow.python.framework.extension_type", "AnonymousExtensionTypeSpec") extern class AnonymousExtensionTypeSpec {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(?fields:python.KwArgs<Dynamic>):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(?fields:python.KwArgs<Dynamic>):Void;
	/**
	...
	**/
	static public function _deserialize(state:Dynamic):Dynamic;
	/**
	...
	**/
	...
	static public var _tf_extension_type_is_packed : Dynamic;
	/**
	...
	**/
	public function _tf_extension_type_with_packed(value:Dynamic):Dynamic;
	/**
	...
	**/
	static public function value_type(?fields:python.KwArgs<Dynamic>):Dynamic;
}