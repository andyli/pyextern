...
@:pythonImport("tensorflow.python.framework.auto_control_deps", "AutomaticControlDependencies") extern class AutomaticControlDependencies {
	...
	**/
	@:native("__init__")
	public function ___init__(?record_initial_resource_uses:Dynamic, ?record_uses_of_resource_ids:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(?record_initial_resource_uses:Dynamic, ?record_uses_of_resource_ids:Dynamic):Void;
	/**
	...
	/**
		...
		Args:
		  ...
		  merge_for_resource: map from resource tensor to merge which must follow
		    all usages of it.
	**/
	public function _process_switch(switch_op:Dynamic, ops_which_must_run:Dynamic, last_write_to_resource:Dynamic, merge_for_resource:Dynamic):Dynamic;
	/**
