...
@:pythonImport("tensorflow.python.framework.error_interpolation", "_ParseTag") extern class _ParseTag {
	/**
		Return self+value.
	**/
	...
	**/
	...
	/**
		Create new instance of _ParseTag(type, name)
	**/
	static public function __new__(_cls:Dynamic, type:Dynamic, name:Dynamic):Dynamic;
	/**
		Helper for pickle.
	**/
	...
	**/
	...
	/**
		Make a new _ParseTag object from a sequence or iterable
	**/
	static public function _make(iterable:Dynamic):Dynamic;
	/**
		Return a new _ParseTag object replacing specified fields with new values
	**/
