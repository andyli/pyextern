...
package tensorflow.python.framework.registry;
@:pythonImport("tensorflow.python.framework.registry", "Registry") extern class Registry {
	...
	**/
	public function lookup(name:Dynamic):Dynamic;
	/**
	...
	**/
	public function register(candidate:Dynamic, ?name:Dynamic):Dynamic;
}