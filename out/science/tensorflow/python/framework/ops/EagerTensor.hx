...
@:pythonImport("tensorflow.python.framework.ops", "EagerTensor") extern class EagerTensor {
	...
	**/
	...
	/**
		Copies the tensor to the desired device.
	**/
	...
	/**
		The DType of the tensor as an enum.
	**/
	...
	/**
		Shape/DType data if the EagerTensor is a DT_RESOURCE
	**/
	...
	**/
	...
	public function _numpy():Dynamic;
	/**
		Internal method to get a NumPy array for the tensor.
	**/
	public function _numpy_internal(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	...
	/**
		Indicates whether _numpy_internal loses information.
	**/
	public function _prefer_custom_summarizer(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	...
	/**
		The shape of the tensor as a python tuple.
	**/
	public function _shape_tuple(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
		A string which summarizes the value of this tensor.
	**/
	public function _summarize_value(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
		Shape of the tensor.
	**/
	...
	/**
		Device on which tensor's memory is resident.
	**/
	public var backing_device : Dynamic;
	/**
	...
	**/
	...
	/**
		A copy of this Tensor with contents backed by host memory. (deprecated)
	...
	**/
	...
	/**
		Device of op that produced the tensor.
	**/
	...
	**/
	...
	/**
		A copy of this Tensor with contents backed by memory on the GPU. (deprecated)
	...
	**/
	...
	/**
		Whether the EagerTensor is a packed tensor or not.
	**/
	public var is_packed : Dynamic;
	/**
