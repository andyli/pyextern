...
@:pythonImport("tensorflow.python.framework.ops", "_EagerTensorBase") extern class _EagerTensorBase {
	...
	**/
	public function _num_elements():Dynamic;
	public function _numpy():Dynamic;
	public function _numpy_internal():Dynamic;
	/**
