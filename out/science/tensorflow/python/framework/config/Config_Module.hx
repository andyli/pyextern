...
package tensorflow.python.framework.config;
@:pythonImport("tensorflow.python.framework.config") extern class Config_Module {
	...
	**/
	static public function disable_op_determinism():Dynamic;
	...
	**/
	static public function enable_op_determinism():Dynamic;
	/**
	...
	**/
	static public function get_optimizer_experimental_options():Dynamic;
	/**
	...
	**/
	static public function get_optimizer_jit():Dynamic;
	/**
	...
	**/
	static public function is_op_determinism_enabled():Dynamic;
	/**
	...
	**/
	static public function set_optimizer_experimental_options(options:Dynamic):Dynamic;
	/**
	...
	**/
	static public function set_optimizer_jit(enabled:Dynamic):Dynamic;
	/**
