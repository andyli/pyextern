...
@:pythonImport("tensorflow.python.framework.type_spec", "LegacyTypeSpecBatchEncoder") extern class LegacyTypeSpecBatchEncoder {
	...
	**/
	public function batch(type_spec:Dynamic, batch_size:Dynamic):Dynamic;
	/**
	...
	**/
	public function decode(type_spec:Dynamic, encoded_value:Dynamic):Dynamic;
	/**
	...
	**/
	public function encode(type_spec:Dynamic, value:Dynamic, ?minimum_rank:Dynamic):Dynamic;
	/**
	...
	**/
	public function unbatch(type_spec:Dynamic):Dynamic;
}