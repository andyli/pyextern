...
@:pythonImport("tensorflow.python.autograph.operators.data_structures", "ListStackOpts") extern class ListStackOpts {
	/**
		Return self+value.
	**/
	...
	**/
	...
	/**
		Create new instance of ListStackOpts(element_dtype, original_call)
	**/
	static public function __new__(_cls:Dynamic, element_dtype:Dynamic, original_call:Dynamic):Dynamic;
	/**
		Helper for pickle.
	**/
	...
	**/
	...
	/**
		Make a new ListStackOpts object from a sequence or iterable
	**/
	static public function _make(iterable:Dynamic):Dynamic;
	/**
		Return a new ListStackOpts object replacing specified fields with new values
	**/
	...
	**/
	public var element_dtype : Dynamic;
	/**
	...
	**/
	public var original_call : Dynamic;
}