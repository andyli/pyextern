...
package tensorflow.python.autograph.pyct.errors;
@:pythonImport("tensorflow.python.autograph.pyct.errors", "UnsupportedLanguageElementError") extern class UnsupportedLanguageElementError {
	/**
		exception cause
	**/
