...
@:pythonImport("tensorflow.python.autograph.pyct.static_analysis.liveness", "Analyzer") extern class Analyzer {
	...
	**/
	@:native("__init__")
	public function ___init__(graph:Dynamic, include_annotations:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(graph:Dynamic, include_annotations:Dynamic):Void;
	/**
