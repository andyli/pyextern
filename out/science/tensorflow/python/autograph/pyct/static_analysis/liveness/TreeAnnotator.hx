...
@:pythonImport("tensorflow.python.autograph.pyct.static_analysis.liveness", "TreeAnnotator") extern class TreeAnnotator {
	...
	**/
	@:native("__init__")
	public function ___init__(source_info:Dynamic, graphs:Dynamic, include_annotations:Dynamic):Dynamic;
	/**
		Initialize the transformer.
		...
		Args:
		  ctx: A Context object.
	**/
	public function new(source_info:Dynamic, graphs:Dynamic, include_annotations:Dynamic):Void;
	/**
	...
	**/
	...
	public function _analyze_function(node:Dynamic, is_lambda:Dynamic):Dynamic;
	public function _block_statement_live_in(node:Dynamic, entry_node:Dynamic):Dynamic;
	public function _block_statement_live_out(node:Dynamic):Dynamic;
	/**
