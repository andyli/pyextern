...
@:pythonImport("tensorflow.python.autograph.pyct.static_analysis.reaching_definitions", "Analyzer") extern class Analyzer {
	...
	**/
	@:native("__init__")
	public function ___init__(graph:Dynamic, definition_factory:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(graph:Dynamic, definition_factory:Dynamic):Void;
	/**
