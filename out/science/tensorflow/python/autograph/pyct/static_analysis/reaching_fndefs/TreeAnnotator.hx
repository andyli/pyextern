...
@:pythonImport("tensorflow.python.autograph.pyct.static_analysis.reaching_fndefs", "TreeAnnotator") extern class TreeAnnotator {
	...
	**/
	@:native("__init__")
	public function ___init__(source_info:Dynamic, graphs:Dynamic):Dynamic;
	/**
		Initialize the transformer.
		...
		Args:
		  ctx: A Context object.
	**/
	public function new(source_info:Dynamic, graphs:Dynamic):Void;
	/**
	...
	**/
	...
	public function _proces_function(node:Dynamic):Dynamic;
	/**
