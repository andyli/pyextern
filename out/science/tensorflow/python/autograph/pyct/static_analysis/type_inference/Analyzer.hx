...
@:pythonImport("tensorflow.python.autograph.pyct.static_analysis.type_inference", "Analyzer") extern class Analyzer {
	...
	**/
	@:native("__init__")
	public function ___init__(graph:Dynamic, resolver:Dynamic, namespace:Dynamic, scope:Dynamic, closure_types:Dynamic):Dynamic;
	/**
		Creates a new analyzer.
		...
		Args:
		  ...
		  closure_types: Dict[QN, Set]
	**/
	public function new(graph:Dynamic, resolver:Dynamic, namespace:Dynamic, scope:Dynamic, closure_types:Dynamic):Void;
	/**
	...
	**/
	...
	public function _update_closure_types(ast_node:Dynamic, types:Dynamic):Dynamic;
	/**
