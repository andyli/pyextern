...
@:pythonImport("tensorflow.python.autograph.pyct.static_analysis.type_inference", "FunctionVisitor") extern class FunctionVisitor {
	...
	**/
	@:native("__init__")
	public function ___init__(source_info:Dynamic, graphs:Dynamic, resolver:Dynamic):Dynamic;
	/**
		Initialize the transformer.
		...
		Args:
		  ctx: A Context object.
	**/
	public function new(source_info:Dynamic, graphs:Dynamic, resolver:Dynamic):Void;
	/**
