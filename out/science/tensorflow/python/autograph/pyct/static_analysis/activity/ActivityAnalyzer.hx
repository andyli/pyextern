...
@:pythonImport("tensorflow.python.autograph.pyct.static_analysis.activity", "ActivityAnalyzer") extern class ActivityAnalyzer {
	...
	**/
	@:native("__init__")
	public function ___init__(context:Dynamic, ?parent_scope:Dynamic):Dynamic;
	/**
		Initialize the transformer.
		...
		Args:
		  ctx: A Context object.
	**/
	public function new(context:Dynamic, ?parent_scope:Dynamic):Void;
	/**
	...
	**/
	...
	public function _enter_scope(isolated:Dynamic, ?f_name:Dynamic):Dynamic;
	public function _exit_and_record_scope(node:Dynamic, ?tag:Dynamic):Dynamic;
	public function _exit_scope():Dynamic;
	public var _in_constructor : Dynamic;
	public function _node_sets_self_attribute(node:Dynamic):Dynamic;
	public function _process_annotation(node:Dynamic):Dynamic;
	public function _process_block_node(node:Dynamic, block:Dynamic, scope_name:Dynamic):Dynamic;
	public function _process_comprehension(node:Dynamic, ?is_list_comp:Dynamic, ?is_dict_comp:Dynamic):Dynamic;
	...
	public function _visit_arg_annotations(node:Dynamic):Dynamic;
	public function _visit_arg_declarations(node:Dynamic):Dynamic;
	public function _visit_node_list(nodes:Dynamic):Dynamic;
	/**
	...
	**/
	...
	public function visit_alias(node:Dynamic):Dynamic;
	/**
	...
	**/
	...
	public function visit_comprehension(node:Dynamic):Dynamic;
