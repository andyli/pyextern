...
@:pythonImport("tensorflow.python.autograph.pyct.cfg", "Graph") extern class Graph {
	/**
		Return self+value.
	**/
	...
	**/
	...
	/**
		Create new instance of Graph(entry, exit, error, index, stmt_prev, stmt_next)
	**/
	static public function __new__(_cls:Dynamic, entry:Dynamic, exit:Dynamic, error:Dynamic, index:Dynamic, stmt_prev:Dynamic, stmt_next:Dynamic):Dynamic;
	/**
		Helper for pickle.
	**/
	...
	**/
	public function as_dot():Dynamic;
	/**
	...
	**/
	public var stmt_next : Dynamic;
	/**
		Alias for field number 4
	**/
	public var stmt_prev : Dynamic;
}