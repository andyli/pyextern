...
@:pythonImport("tensorflow.python.autograph.pyct.transformer", "EntityInfo") extern class EntityInfo {
	/**
		Return self+value.
	**/
	...
	**/
	...
	/**
		Create new instance of EntityInfo(name, source_code, source_file, future_features, namespace)
	**/
	static public function __new__(_cls:Dynamic, name:Dynamic, source_code:Dynamic, source_file:Dynamic, future_features:Dynamic, namespace:Dynamic):Dynamic;
	/**
		Helper for pickle.
	**/
	...
	**/
	...
	/**
		Make a new EntityInfo object from a sequence or iterable
	**/
	static public function _make(iterable:Dynamic):Dynamic;
	/**
		Return a new EntityInfo object replacing specified fields with new values
	**/
	...
	**/
	public var future_features : Dynamic;
	/**
	...
	**/
	public var source_code : Dynamic;
	/**
