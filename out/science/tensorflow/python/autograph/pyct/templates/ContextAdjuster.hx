...
@:pythonImport("tensorflow.python.autograph.pyct.templates", "ContextAdjuster") extern class ContextAdjuster {
	...
	**/
	@:native("__init__")
	public function ___init__(override_value:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(override_value:Dynamic):Void;
	/**
	...
	**/
	...
	public function _apply_override(node:Dynamic):Dynamic;
	/**
