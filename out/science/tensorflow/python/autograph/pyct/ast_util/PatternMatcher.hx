...
@:pythonImport("tensorflow.python.autograph.pyct.ast_util", "PatternMatcher") extern class PatternMatcher {
	...
	**/
	...
	public function compare_and_visit(node:Dynamic, pattern:Dynamic):Dynamic;
	/**
		Called if no explicit visitor function exists for a node.
	**/
	public function generic_visit(node:Dynamic):Dynamic;
	public function is_wildcard(p:Dynamic):Dynamic;
	public function no_match():Dynamic;
	/**
		Visit a node.
	**/
