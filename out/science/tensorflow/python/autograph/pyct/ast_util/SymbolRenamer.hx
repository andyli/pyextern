...
@:pythonImport("tensorflow.python.autograph.pyct.ast_util", "SymbolRenamer") extern class SymbolRenamer {
	...
	**/
	@:native("__init__")
	public function ___init__(name_map:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(name_map:Dynamic):Void;
	/**
	...
	**/
	...
	public function _process_list_of_strings(names:Dynamic):Dynamic;
	public function _process_name_node(node:Dynamic):Dynamic;
	/**
