...
@:pythonImport("tensorflow.python.autograph.pyct.common_transformers.anf", "ASTEdgePattern") extern class ASTEdgePattern {
	/**
		Return self+value.
	**/
	...
	**/
	...
	/**
		Create new instance of ASTEdgePattern(parent, field, child)
	**/
	static public function __new__(_cls:Dynamic, parent:Dynamic, field:Dynamic, child:Dynamic):Dynamic;
	/**
		Helper for pickle.
	**/
	...
	**/
	...
	/**
		Make a new ASTEdgePattern object from a sequence or iterable
	**/
	static public function _make(iterable:Dynamic):Dynamic;
	/**
		Return a new ASTEdgePattern object replacing specified fields with new values
	**/
	...
	**/
	public function matches(parent:Dynamic, field:Dynamic, child:Dynamic):Dynamic;
	/**
