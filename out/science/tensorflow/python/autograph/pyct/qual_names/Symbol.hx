...
@:pythonImport("tensorflow.python.autograph.pyct.qual_names", "Symbol") extern class Symbol {
	/**
		Return self+value.
	**/
	...
	**/
	...
	/**
		Create new instance of Symbol(name,)
	**/
	static public function __new__(_cls:Dynamic, name:Dynamic):Dynamic;
	/**
		Helper for pickle.
	**/
	...
	**/
	...
	/**
		Make a new Symbol object from a sequence or iterable
	**/
	static public function _make(iterable:Dynamic):Dynamic;
	/**
		Return a new Symbol object replacing specified fields with new values
	**/
