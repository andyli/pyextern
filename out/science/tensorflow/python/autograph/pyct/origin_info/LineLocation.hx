...
@:pythonImport("tensorflow.python.autograph.pyct.origin_info", "LineLocation") extern class LineLocation {
	/**
		Return self+value.
	**/
	...
	**/
	...
	/**
		Create new instance of LineLocation(filename, lineno)
	**/
	static public function __new__(_cls:Dynamic, filename:Dynamic, lineno:Dynamic):Dynamic;
	/**
		Helper for pickle.
	**/
	...
	**/
	...
	/**
		Make a new LineLocation object from a sequence or iterable
	**/
	static public function _make(iterable:Dynamic):Dynamic;
	/**
		Return a new LineLocation object replacing specified fields with new values
	**/
