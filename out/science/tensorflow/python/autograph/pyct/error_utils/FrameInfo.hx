...
@:pythonImport("tensorflow.python.autograph.pyct.error_utils", "FrameInfo") extern class FrameInfo {
	/**
		Return self+value.
	**/
	...
	**/
	...
	/**
		Create new instance of FrameInfo(filename, lineno, function_name, code, is_converted, is_allowlisted)
	**/
	static public function __new__(_cls:Dynamic, filename:Dynamic, lineno:Dynamic, function_name:Dynamic, code:Dynamic, is_converted:Dynamic, is_allowlisted:Dynamic):Dynamic;
	/**
		Helper for pickle.
	**/
	...
	**/
	public var is_allowlisted : Dynamic;
	/**
		Alias for field number 4
	**/
	public var is_converted : Dynamic;
	/**
