...
@:pythonImport("tensorflow.python.autograph.impl.api", "PyToTF") extern class PyToTF {
	...
	**/
	public function get_caching_key(ctx:Dynamic):Dynamic;
	/**
	...
	**/
	...
	public function initial_analysis(node:Dynamic, ctx:Dynamic):Dynamic;
	/**
