...
package tensorflow.python.autograph.converters.control_flow_deprecated_py2;
@:pythonImport("tensorflow.python.autograph.converters.control_flow_deprecated_py2", "ControlFlowTransformer") extern class ControlFlowTransformer {
	...
	**/
	...
	public function _create_cond_expr(results:Dynamic, test:Dynamic, body_name:Dynamic, orelse_name:Dynamic, state_getter_name:Dynamic, state_setter_name:Dynamic, basic_symbol_names:Dynamic, composite_symbol_names:Dynamic):Dynamic;
	public function _create_loop_options(node:Dynamic):Dynamic;
	public function _create_state_functions(composites:Dynamic, state_getter_name:Dynamic, state_setter_name:Dynamic):Dynamic;
	public function _create_undefined_assigns(undefined_symbols:Dynamic):Dynamic;
	public function _determine_aliased_symbols(scope:Dynamic, node_defined_in:Dynamic):Dynamic;
	public function _fmt_symbols(symbol_set:Dynamic):Dynamic;
	public function _get_basic_loop_vars(modified_symbols:Dynamic, live_in:Dynamic, live_out:Dynamic):Dynamic;
	public function _get_composite_loop_vars(modified_symbols:Dynamic, live_in:Dynamic):Dynamic;
	public function _get_loop_vars(node:Dynamic, modified_symbols:Dynamic):Dynamic;
	public function _loop_var_constructs(basic_loop_vars:Dynamic):Dynamic;
	/**
