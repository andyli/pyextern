...
@:pythonImport("tensorflow.python.autograph.converters.directives", "DirectivesTransformer") extern class DirectivesTransformer {
	...
	**/
	...
	public function _process_statement_directive(call_node:Dynamic, directive:Dynamic):Dynamic;
	public function _process_symbol_directive(call_node:Dynamic, directive:Dynamic):Dynamic;
	public function _track_and_visit_loop(node:Dynamic):Dynamic;
	/**
