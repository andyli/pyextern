...
package tensorflow.python.autograph.converters.break_statements;
@:pythonImport("tensorflow.python.autograph.converters.break_statements", "BreakTransformer") extern class BreakTransformer {
	...
	**/
	public function _guard_if_present(block:Dynamic, var_name:Dynamic):Dynamic;
	public function _process_body(nodes:Dynamic, break_var:Dynamic):Dynamic;
	/**
