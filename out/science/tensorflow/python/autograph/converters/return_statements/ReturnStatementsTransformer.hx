...
@:pythonImport("tensorflow.python.autograph.converters.return_statements", "ReturnStatementsTransformer") extern class ReturnStatementsTransformer {
	...
	**/
	@:native("__init__")
	public function ___init__(ctx:Dynamic, allow_missing_return:Dynamic):Dynamic;
	/**
		Initialize the transformer.
		...
		Args:
		  ctx: A Context object.
	**/
	public function new(ctx:Dynamic, allow_missing_return:Dynamic):Void;
	/**
	...
	**/
	...
	public function _visit_statement_block(node:Dynamic, nodes:Dynamic):Dynamic;
	/**
