...
package tensorflow.python.autograph.converters.control_flow;
@:pythonImport("tensorflow.python.autograph.converters.control_flow", "ControlFlowTransformer") extern class ControlFlowTransformer {
	...
	**/
	...
	public function _create_nonlocal_declarations(vars_:Dynamic):Dynamic;
	public function _create_state_functions(block_vars:Dynamic, nonlocal_declarations:Dynamic, getter_name:Dynamic, setter_name:Dynamic):Dynamic;
	public function _create_undefined_assigns(undefined_symbols:Dynamic):Dynamic;
	public function _get_block_basic_vars(modified:Dynamic, live_in:Dynamic, live_out:Dynamic):Dynamic;
	public function _get_block_composite_vars(modified:Dynamic, live_in:Dynamic):Dynamic;
	/**
		Determines the variables affected inside a control flow statement.
	**/
	public function _get_block_vars(node:Dynamic, modified:Dynamic):Dynamic;
	/**
