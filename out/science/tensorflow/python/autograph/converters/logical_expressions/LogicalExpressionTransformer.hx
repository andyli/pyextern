...
package tensorflow.python.autograph.converters.logical_expressions;
@:pythonImport("tensorflow.python.autograph.converters.logical_expressions", "LogicalExpressionTransformer") extern class LogicalExpressionTransformer {
	...
	**/
	...
	public function _as_binary_function(func_name:Dynamic, arg1:Dynamic, arg2:Dynamic):Dynamic;
	public function _as_binary_operation(op:Dynamic, arg1:Dynamic, arg2:Dynamic):Dynamic;
	public function _as_lambda(expr:Dynamic):Dynamic;
	public function _as_unary_function(func_name:Dynamic, arg:Dynamic):Dynamic;
	public function _overload_of(_operator:Dynamic):Dynamic;
	/**
