...
package tensorflow.python.autograph.converters.variables;
@:pythonImport("tensorflow.python.autograph.converters.variables", "VariableAccessTransformer") extern class VariableAccessTransformer {
