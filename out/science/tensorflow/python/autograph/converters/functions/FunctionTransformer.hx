...
package tensorflow.python.autograph.converters.functions;
@:pythonImport("tensorflow.python.autograph.converters.functions", "FunctionTransformer") extern class FunctionTransformer {
	...
	**/
	public function _function_scope_options(fn_scope:Dynamic):Dynamic;
	/**
