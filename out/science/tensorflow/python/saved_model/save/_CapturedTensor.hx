...
@:pythonImport("tensorflow.python.saved_model.save", "_CapturedTensor") extern class _CapturedTensor {
	/**
		Return self+value.
	**/
	...
	**/
	...
	/**
		Create new instance of _CapturedTensor(name, concrete_function)
	**/
	static public function __new__(_cls:Dynamic, name:Dynamic, concrete_function:Dynamic):Dynamic;
	/**
		Helper for pickle.
	**/
	...
	**/
	...
	/**
		Make a new _CapturedTensor object from a sequence or iterable
	**/
	static public function _make(iterable:Dynamic):Dynamic;
	/**
		Return a new _CapturedTensor object replacing specified fields with new values
	**/
	public function _replace(?kwds:python.KwArgs<Dynamic>):Dynamic;
	/**
		Alias for field number 1
	**/
	public var concrete_function : Dynamic;
	/**
