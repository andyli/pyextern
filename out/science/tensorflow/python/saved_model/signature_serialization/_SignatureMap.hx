...
@:pythonImport("tensorflow.python.saved_model.signature_serialization", "_SignatureMap") extern class _SignatureMap {
	...
	**/
	public function _add_signature(name:Dynamic, concrete_function:Dynamic):Dynamic;
	/**
