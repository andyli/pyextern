...
package tensorflow.python.saved_model.signature_def_utils;
@:pythonImport("tensorflow.python.saved_model.signature_def_utils") extern class Signature_def_utils_Module {
