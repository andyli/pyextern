...
@:pythonImport("tensorflow.python.saved_model.load_v1_in_v2", "_Initializer") extern class _Initializer {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(init_fn:Dynamic, asset_paths:Dynamic):Dynamic;
	/**
		Initialize the `CapturableResource`.
		...
		Args:
		  device: A string indicating a required placement for this resource,
		    ...
		    should be blank unless the resource only makes sense on one device.
	**/
	public function new(init_fn:Dynamic, asset_paths:Dynamic):Void;
	/**
