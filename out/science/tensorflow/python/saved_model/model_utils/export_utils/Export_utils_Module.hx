...
package tensorflow.python.saved_model.model_utils.export_utils;
@:pythonImport("tensorflow.python.saved_model.model_utils.export_utils") extern class Export_utils_Module {
	...
	static public var SINGLE_FEATURE_DEFAULT_NAME : Dynamic;
	static public var SINGLE_LABEL_DEFAULT_NAME : Dynamic;
	static public var SINGLE_RECEIVER_DEFAULT_NAME : Dynamic;
