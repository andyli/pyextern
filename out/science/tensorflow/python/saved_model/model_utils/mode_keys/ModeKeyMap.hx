...
@:pythonImport("tensorflow.python.saved_model.model_utils.mode_keys", "ModeKeyMap") extern class ModeKeyMap {
	...
	**/
	public function _get_internal_key(key:Dynamic):Dynamic;
	/**
