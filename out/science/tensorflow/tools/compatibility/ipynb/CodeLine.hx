...
@:pythonImport("tensorflow.tools.compatibility.ipynb", "CodeLine") extern class CodeLine {
	/**
		Return self+value.
	**/
	...
	**/
	...
	/**
		Create new instance of CodeLine(cell_number, code)
	**/
	static public function __new__(_cls:Dynamic, cell_number:Dynamic, code:Dynamic):Dynamic;
	/**
		Helper for pickle.
	**/
	...
	**/
	...
	/**
		Make a new CodeLine object from a sequence or iterable
	**/
	static public function _make(iterable:Dynamic):Dynamic;
	/**
		Return a new CodeLine object replacing specified fields with new values
	**/
	public function _replace(?kwds:python.KwArgs<Dynamic>):Dynamic;
	/**
		Alias for field number 0
	**/
	public var cell_number : Dynamic;
	/**
