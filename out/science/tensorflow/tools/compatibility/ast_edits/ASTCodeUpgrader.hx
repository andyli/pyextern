...
@:pythonImport("tensorflow.tools.compatibility.ast_edits", "ASTCodeUpgrader") extern class ASTCodeUpgrader {
	...
	**/
	...
	public function _format_log(log:Dynamic, in_filename:Dynamic, out_filename:Dynamic):Dynamic;
	public function format_log(log:Dynamic, in_filename:Dynamic):Dynamic;
	/**
	...
	**/
	public function process_file(in_filename:Dynamic, out_filename:Dynamic, ?no_change_to_outfile_on_error:Dynamic):Dynamic;
	/**
		Process the given python file for incompatible changes.
	...
	**/
	public function process_tree_inplace(root_directory:Dynamic):Dynamic;
	/**
		Updates a file using pasta.
	**/
	public function update_string_pasta(text:Dynamic, in_filename:Dynamic):Dynamic;
}