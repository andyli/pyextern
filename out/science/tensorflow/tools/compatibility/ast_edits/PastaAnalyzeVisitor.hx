...
@:pythonImport("tensorflow.tools.compatibility.ast_edits", "PastaAnalyzeVisitor") extern class PastaAnalyzeVisitor {
	...
	**/
	@:native("__init__")
	public function ___init__(api_analysis_spec:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(api_analysis_spec:Dynamic):Void;
	/**
	...
	**/
	...
	public function add_result(analysis_result:Dynamic):Dynamic;
