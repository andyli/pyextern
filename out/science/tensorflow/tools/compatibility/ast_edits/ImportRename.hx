...
@:pythonImport("tensorflow.tools.compatibility.ast_edits", "ImportRename") extern class ImportRename {
	/**
		Return self+value.
	**/
	...
	**/
	...
	/**
		Create new instance of ImportRename(new_name, excluded_prefixes)
	**/
	static public function __new__(_cls:Dynamic, new_name:Dynamic, excluded_prefixes:Dynamic):Dynamic;
	/**
		Helper for pickle.
	**/
	...
	**/
	...
	/**
		Make a new ImportRename object from a sequence or iterable
	**/
	static public function _make(iterable:Dynamic):Dynamic;
	/**
		Return a new ImportRename object replacing specified fields with new values
	**/
	...
	**/
	public var excluded_prefixes : Dynamic;
	/**
