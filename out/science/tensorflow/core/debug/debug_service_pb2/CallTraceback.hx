...
@:pythonImport("tensorflow.core.debug.debug_service_pb2", "CallTraceback") extern class CallTraceback {
	/**
	...
	**/
	...
	static public var EAGER_EXECUTION : Dynamic;
	/**
		Extension dict
	**/
	...
	**/
	...
	/**
		A ProtocolMessage
	**/
	public function OriginIdToStringEntry(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
