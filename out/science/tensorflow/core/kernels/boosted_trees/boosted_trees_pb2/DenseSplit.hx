...
@:pythonImport("tensorflow.core.kernels.boosted_trees.boosted_trees_pb2", "DenseSplit") extern class DenseSplit {
	/**
	...
	**/
	...
	/**
		Field tensorflow.boosted_trees.DenseSplit.feature_id
	**/
	public var feature_id : Dynamic;
	/**
		Field tensorflow.boosted_trees.DenseSplit.left_id
	**/
	public var left_id : Dynamic;
	/**
		Field tensorflow.boosted_trees.DenseSplit.right_id
	**/
	public var right_id : Dynamic;
	/**
		Field tensorflow.boosted_trees.DenseSplit.threshold
	**/
