...
@:pythonImport("tensorflow.core.kernels.boosted_trees.boosted_trees_pb2", "DebugOutput") extern class DebugOutput {
	/**
	...
	**/
	...
	/**
		Field tensorflow.boosted_trees.DebugOutput.leaf_node_ids
	**/
	public var leaf_node_ids : Dynamic;
	/**
