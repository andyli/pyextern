...
@:pythonImport("tensorflow.core.kernels.boosted_trees.boosted_trees_pb2", "SparseVector") extern class SparseVector {
	/**
	...
	**/
	...
	/**
		Field tensorflow.boosted_trees.SparseVector.index
	**/
	public var index : Dynamic;
	/**
		Field tensorflow.boosted_trees.SparseVector.value
	**/
