...
@:pythonImport("tensorflow.core.kernels.boosted_trees.boosted_trees_pb2", "CategoricalSplit") extern class CategoricalSplit {
	/**
	...
	**/
	...
	/**
		Field tensorflow.boosted_trees.CategoricalSplit.dimension_id
	**/
	public var dimension_id : Dynamic;
	/**
		Field tensorflow.boosted_trees.CategoricalSplit.feature_id
	**/
	public var feature_id : Dynamic;
	/**
		Field tensorflow.boosted_trees.CategoricalSplit.left_id
	**/
	public var left_id : Dynamic;
	/**
		Field tensorflow.boosted_trees.CategoricalSplit.right_id
	**/
	public var right_id : Dynamic;
	/**
		Field tensorflow.boosted_trees.CategoricalSplit.value
	**/
