...
@:pythonImport("tensorflow.core.grappler.costs.op_performance_data_pb2", "OpPerformance") extern class OpPerformance {
	/**
	...
	**/
	...
	/**
		A ProtocolMessage
	**/
	public function OpMemory(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
