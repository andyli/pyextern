...
@:pythonImport("tensorflow.core.grappler.costs.op_performance_data_pb2", "OpPerformanceList") extern class OpPerformanceList {
	/**
	...
	**/
	...
	/**
		Field tensorflow.OpPerformanceList.op_performance
	**/
	public var op_performance : Dynamic;
}