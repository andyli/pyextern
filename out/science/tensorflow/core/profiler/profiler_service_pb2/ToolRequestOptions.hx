...
package tensorflow.core.profiler.profiler_service_pb2;
@:pythonImport("tensorflow.core.profiler.profiler_service_pb2", "ToolRequestOptions") extern class ToolRequestOptions {
	/**
