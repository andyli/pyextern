...
@:pythonImport("tensorflow.core.profiler.profiler_service_pb2", "MonitorResponse") extern class MonitorResponse {
	/**
	...
	**/
	...
	/**
		Field tensorflow.MonitorResponse.data
	**/
	public var data : Dynamic;
	/**
		Field tensorflow.MonitorResponse.monitor_result
	**/
	public var monitor_result : Dynamic;
}