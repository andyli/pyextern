...
@:pythonImport("tensorflow.core.profiler.tfprof_log_pb2", "Tuple") extern class Tuple {
	/**
	...
	**/
	...
	/**
		Field tensorflow.tfprof.Tuple.int64_values
	**/
	public var int64_values : Dynamic;
}