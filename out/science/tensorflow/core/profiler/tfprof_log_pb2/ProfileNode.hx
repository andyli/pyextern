...
@:pythonImport("tensorflow.core.profiler.tfprof_log_pb2", "ProfileNode") extern class ProfileNode {
	/**
		A ProtocolMessage
	**/
	public function AttrsEntry(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	...
	/**
		A ProtocolMessage
	**/
	public function ExecsEntry(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
		Extension dict
	**/
	...
	**/
	...
	/**
		A ProtocolMessage
	**/
	public function OutputShapesEntry(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
		A ProtocolMessage
	**/
