...
@:pythonImport("tensorflow.core.profiler.profiler_options_pb2", "RemoteProfilerSessionManagerOptions") extern class RemoteProfilerSessionManagerOptions {
	/**
	...
	**/
	...
	/**
		Field tensorflow.RemoteProfilerSessionManagerOptions.delay_ms
	**/
	public var delay_ms : Dynamic;
	/**
		Field tensorflow.RemoteProfilerSessionManagerOptions.max_session_duration_ms
	**/
	public var max_session_duration_ms : Dynamic;
	/**
		Field tensorflow.RemoteProfilerSessionManagerOptions.profiler_options
	**/
	public var profiler_options : Dynamic;
	/**
		Field tensorflow.RemoteProfilerSessionManagerOptions.service_addresses
	**/
	public var service_addresses : Dynamic;
	/**
		Field tensorflow.RemoteProfilerSessionManagerOptions.session_creation_timestamp_ns
	**/
	public var session_creation_timestamp_ns : Dynamic;
}