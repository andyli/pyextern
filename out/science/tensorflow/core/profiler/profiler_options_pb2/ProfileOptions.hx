...
package tensorflow.core.profiler.profiler_options_pb2;
@:pythonImport("tensorflow.core.profiler.profiler_options_pb2", "ProfileOptions") extern class ProfileOptions {
	/**
	...
	**/
	...
	static public var DeviceType : Dynamic;
	/**
	...
	**/
	...
	static public var PLUGGABLE_DEVICE : Dynamic;
	/**
	...
	**/
	...
	/**
		Field tensorflow.ProfileOptions.device_tracer_level
	**/
	public var device_tracer_level : Dynamic;
	/**
		Field tensorflow.ProfileOptions.device_type
	**/
	public var device_type : Dynamic;
	/**
		Field tensorflow.ProfileOptions.duration_ms
	**/
	public var duration_ms : Dynamic;
	/**
		Field tensorflow.ProfileOptions.enable_hlo_proto
	**/
	public var enable_hlo_proto : Dynamic;
	/**
		Field tensorflow.ProfileOptions.host_tracer_level
	**/
	public var host_tracer_level : Dynamic;
	/**
		Field tensorflow.ProfileOptions.include_dataset_ops
	**/
	public var include_dataset_ops : Dynamic;
	/**
		Field tensorflow.ProfileOptions.python_tracer_level
	**/
	public var python_tracer_level : Dynamic;
	/**
		Field tensorflow.ProfileOptions.repository_path
	**/
	public var repository_path : Dynamic;
	/**
		Field tensorflow.ProfileOptions.start_timestamp_ns
	**/
	public var start_timestamp_ns : Dynamic;
	/**
		Field tensorflow.ProfileOptions.version
	**/
