...
@:pythonImport("tensorflow.core.profiler.profile_pb2", "ValueType") extern class ValueType {
	/**
	...
	**/
	...
	/**
		Field tensorflow.tfprof.pprof.ValueType.type
	**/
	public var type : Dynamic;
	/**
		Field tensorflow.tfprof.pprof.ValueType.unit
	**/
