...
package tensorflow.core.profiler.profiler_service_monitor_result_pb2;
@:pythonImport("tensorflow.core.profiler.profiler_service_monitor_result_pb2", "ProfilerServiceMonitorResult") extern class ProfilerServiceMonitorResult {
	/**
	...
	**/
	...
	static public var EMPTY_RESULT : Dynamic;
	/**
		Extension dict
	**/
	...
	**/
	...
	static public var ResponseType : Dynamic;
	/**
	...
	**/
	...
	static public var UTIL_IDLE : Dynamic;
	static public var UTIL_IDLE_STEP : Dynamic;
	static public var UTIL_ONLY : Dynamic;
	/**
	...
	**/
	...
	/**
		Field tensorflow.ProfilerServiceMonitorResult.device_idle_time_percent
	**/
	public var device_idle_time_percent : Dynamic;
	/**
		Field tensorflow.ProfilerServiceMonitorResult.infeed_percent_avg
	**/
	public var infeed_percent_avg : Dynamic;
	/**
		Field tensorflow.ProfilerServiceMonitorResult.infeed_percent_max
	**/
	public var infeed_percent_max : Dynamic;
	/**
		Field tensorflow.ProfilerServiceMonitorResult.infeed_percent_min
	**/
	public var infeed_percent_min : Dynamic;
	/**
		Field tensorflow.ProfilerServiceMonitorResult.matrix_unit_utilization_percent
	**/
	public var matrix_unit_utilization_percent : Dynamic;
	/**
		Field tensorflow.ProfilerServiceMonitorResult.response_type
	**/
	public var response_type : Dynamic;
	/**
		Field tensorflow.ProfilerServiceMonitorResult.step_time_ms_avg
	**/
	public var step_time_ms_avg : Dynamic;
	/**
		Field tensorflow.ProfilerServiceMonitorResult.step_time_ms_max
	**/
	public var step_time_ms_max : Dynamic;
	/**
		Field tensorflow.ProfilerServiceMonitorResult.step_time_ms_min
	**/
	public var step_time_ms_min : Dynamic;
}