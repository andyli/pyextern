...
@:pythonImport("tensorflow.core.profiler.protobuf.xplane_pb2", "XSpace") extern class XSpace {
	/**
	...
	**/
	...
	/**
		Field tensorflow.profiler.XSpace.errors
	**/
	public var errors : Dynamic;
	/**
		Field tensorflow.profiler.XSpace.hostnames
	**/
	public var hostnames : Dynamic;
	/**
		Field tensorflow.profiler.XSpace.planes
	**/
	public var planes : Dynamic;
	/**
		Field tensorflow.profiler.XSpace.warnings
	**/
