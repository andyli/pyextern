...
@:pythonImport("tensorflow.core.profiler.protobuf.xplane_pb2", "XStatMetadata") extern class XStatMetadata {
	/**
	...
	**/
	...
	/**
		Field tensorflow.profiler.XStatMetadata.description
	**/
	public var description : Dynamic;
	/**
		Field tensorflow.profiler.XStatMetadata.id
	**/
	public var id : Dynamic;
	/**
		Field tensorflow.profiler.XStatMetadata.name
	**/
