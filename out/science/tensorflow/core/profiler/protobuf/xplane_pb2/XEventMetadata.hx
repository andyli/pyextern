...
@:pythonImport("tensorflow.core.profiler.protobuf.xplane_pb2", "XEventMetadata") extern class XEventMetadata {
	/**
	...
	**/
	...
	/**
		Field tensorflow.profiler.XEventMetadata.child_id
	**/
	public var child_id : Dynamic;
	/**
		Field tensorflow.profiler.XEventMetadata.display_name
	**/
	public var display_name : Dynamic;
	/**
		Field tensorflow.profiler.XEventMetadata.id
	**/
	public var id : Dynamic;
	/**
		Field tensorflow.profiler.XEventMetadata.metadata
	**/
	public var metadata : Dynamic;
	/**
		Field tensorflow.profiler.XEventMetadata.name
	**/
	public var name : Dynamic;
	/**
		Field tensorflow.profiler.XEventMetadata.stats
	**/
