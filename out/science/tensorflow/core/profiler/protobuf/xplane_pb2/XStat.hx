...
package tensorflow.core.profiler.protobuf.xplane_pb2;
@:pythonImport("tensorflow.core.profiler.protobuf.xplane_pb2", "XStat") extern class XStat {
	/**
	...
	**/
	...
	/**
		Field tensorflow.profiler.XStat.bytes_value
	**/
	public var bytes_value : Dynamic;
	/**
		Field tensorflow.profiler.XStat.double_value
	**/
	public var double_value : Dynamic;
	/**
		Field tensorflow.profiler.XStat.int64_value
	**/
	public var int64_value : Dynamic;
	/**
		Field tensorflow.profiler.XStat.metadata_id
	**/
	public var metadata_id : Dynamic;
	/**
		Field tensorflow.profiler.XStat.ref_value
	**/
	public var ref_value : Dynamic;
	/**
		Field tensorflow.profiler.XStat.str_value
	**/
	public var str_value : Dynamic;
	/**
		Field tensorflow.profiler.XStat.uint64_value
	**/
	public var uint64_value : Dynamic;
}