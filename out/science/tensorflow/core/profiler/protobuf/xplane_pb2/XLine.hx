...
@:pythonImport("tensorflow.core.profiler.protobuf.xplane_pb2", "XLine") extern class XLine {
	/**
	...
	**/
	...
	/**
		Field tensorflow.profiler.XLine.display_id
	**/
	public var display_id : Dynamic;
	/**
		Field tensorflow.profiler.XLine.display_name
	**/
	public var display_name : Dynamic;
	/**
		Field tensorflow.profiler.XLine.duration_ps
	**/
	public var duration_ps : Dynamic;
	/**
		Field tensorflow.profiler.XLine.events
	**/
	public var events : Dynamic;
	/**
		Field tensorflow.profiler.XLine.id
	**/
	public var id : Dynamic;
	/**
		Field tensorflow.profiler.XLine.name
	**/
	public var name : Dynamic;
	/**
		Field tensorflow.profiler.XLine.timestamp_ns
	**/
	public var timestamp_ns : Dynamic;
}