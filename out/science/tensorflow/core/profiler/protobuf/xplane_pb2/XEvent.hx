...
@:pythonImport("tensorflow.core.profiler.protobuf.xplane_pb2", "XEvent") extern class XEvent {
	/**
	...
	**/
	...
	/**
		Field tensorflow.profiler.XEvent.duration_ps
	**/
	public var duration_ps : Dynamic;
	/**
		Field tensorflow.profiler.XEvent.metadata_id
	**/
	public var metadata_id : Dynamic;
	/**
		Field tensorflow.profiler.XEvent.num_occurrences
	**/
	public var num_occurrences : Dynamic;
	/**
		Field tensorflow.profiler.XEvent.offset_ps
	**/
	public var offset_ps : Dynamic;
	/**
		Field tensorflow.profiler.XEvent.stats
	**/
