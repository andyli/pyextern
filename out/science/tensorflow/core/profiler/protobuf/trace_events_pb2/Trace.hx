...
@:pythonImport("tensorflow.core.profiler.protobuf.trace_events_pb2", "Trace") extern class Trace {
	/**
	...
	**/
	...
	/**
		A ProtocolMessage
	**/
	public function DevicesEntry(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	...
	/**
		Field tensorflow.profiler.Trace.devices
	**/
	public var devices : Dynamic;
	/**
		Field tensorflow.profiler.Trace.trace_events
	**/
