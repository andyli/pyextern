...
package tensorflow.core.profiler.protobuf.trace_events_pb2;
@:pythonImport("tensorflow.core.profiler.protobuf.trace_events_pb2", "TraceEvent") extern class TraceEvent {
	/**
		A ProtocolMessage
	**/
	public function ArgsEntry(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	...
	/**
		Field tensorflow.profiler.TraceEvent.args
	**/
	public var args : Dynamic;
	/**
		Field tensorflow.profiler.TraceEvent.device_id
	**/
	public var device_id : Dynamic;
	/**
		Field tensorflow.profiler.TraceEvent.duration_ps
	**/
	public var duration_ps : Dynamic;
	/**
		Field tensorflow.profiler.TraceEvent.name
	**/
	public var name : Dynamic;
	/**
		Field tensorflow.profiler.TraceEvent.resource_id
	**/
	public var resource_id : Dynamic;
	/**
		Field tensorflow.profiler.TraceEvent.timestamp_ps
	**/
