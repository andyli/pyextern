...
@:pythonImport("tensorflow.core.profiler.protobuf.trace_events_pb2", "Device") extern class Device {
	/**
	...
	**/
	...
	/**
		A ProtocolMessage
	**/
	public function ResourcesEntry(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	...
	/**
		Field tensorflow.profiler.Device.device_id
	**/
	public var device_id : Dynamic;
	/**
		Field tensorflow.profiler.Device.name
	**/
	public var name : Dynamic;
	/**
		Field tensorflow.profiler.Device.resources
	**/
