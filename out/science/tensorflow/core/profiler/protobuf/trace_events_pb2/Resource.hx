...
@:pythonImport("tensorflow.core.profiler.protobuf.trace_events_pb2", "Resource") extern class Resource {
	/**
	...
	**/
	...
	/**
		Field tensorflow.profiler.Resource.name
	**/
	public var name : Dynamic;
	/**
		Field tensorflow.profiler.Resource.resource_id
	**/
	public var resource_id : Dynamic;
	/**
		Field tensorflow.profiler.Resource.sort_index
	**/
	public var sort_index : Dynamic;
}