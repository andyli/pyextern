...
@:pythonImport("tensorflow.core.profiler.profiler_analysis_pb2", "EnumProfileSessionsAndToolsRequest") extern class EnumProfileSessionsAndToolsRequest {
	/**
	...
	**/
	...
	/**
		Field tensorflow.EnumProfileSessionsAndToolsRequest.repository_root
	**/
