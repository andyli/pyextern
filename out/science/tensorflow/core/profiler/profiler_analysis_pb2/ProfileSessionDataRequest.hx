...
@:pythonImport("tensorflow.core.profiler.profiler_analysis_pb2", "ProfileSessionDataRequest") extern class ProfileSessionDataRequest {
	/**
	...
	**/
	...
	/**
		A ProtocolMessage
	**/
	public function ParametersEntry(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
