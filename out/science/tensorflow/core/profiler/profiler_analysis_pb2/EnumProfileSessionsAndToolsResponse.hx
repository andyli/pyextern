...
package tensorflow.core.profiler.profiler_analysis_pb2;
@:pythonImport("tensorflow.core.profiler.profiler_analysis_pb2", "EnumProfileSessionsAndToolsResponse") extern class EnumProfileSessionsAndToolsResponse {
	/**
	...
	**/
	...
	/**
		Field tensorflow.EnumProfileSessionsAndToolsResponse.error_message
	**/
	public var error_message : Dynamic;
	/**
		Field tensorflow.EnumProfileSessionsAndToolsResponse.sessions
	**/
	public var sessions : Dynamic;
}