...
@:pythonImport("tensorflow.core.profiler.tfprof_output_pb2", "TFProfTensorProto") extern class TFProfTensorProto {
	/**
	...
	**/
	...
	/**
		Field tensorflow.tfprof.TFProfTensorProto.dtype
	**/
	public var dtype : Dynamic;
	/**
		Field tensorflow.tfprof.TFProfTensorProto.value_double
	**/
	public var value_double : Dynamic;
	/**
		Field tensorflow.tfprof.TFProfTensorProto.value_int64
	**/
	public var value_int64 : Dynamic;
	/**
		Field tensorflow.tfprof.TFProfTensorProto.value_str
	**/
	public var value_str : Dynamic;
}