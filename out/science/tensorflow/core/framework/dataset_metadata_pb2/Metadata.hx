...
package tensorflow.core.framework.dataset_metadata_pb2;
@:pythonImport("tensorflow.core.framework.dataset_metadata_pb2", "Metadata") extern class Metadata {
	/**
	...
	**/
	...
	/**
		Field tensorflow.data.Metadata.name
	**/
