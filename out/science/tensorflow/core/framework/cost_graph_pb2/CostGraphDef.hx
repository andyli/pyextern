...
@:pythonImport("tensorflow.core.framework.cost_graph_pb2", "CostGraphDef") extern class CostGraphDef {
	/**
		A ProtocolMessage
	**/
	public function AggregatedCost(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	...
	/**
		Field tensorflow.CostGraphDef.cost
	**/
	public var cost : Dynamic;
	/**
		Field tensorflow.CostGraphDef.node
	**/
