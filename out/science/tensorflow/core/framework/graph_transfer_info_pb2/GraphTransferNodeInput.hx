...
@:pythonImport("tensorflow.core.framework.graph_transfer_info_pb2", "GraphTransferNodeInput") extern class GraphTransferNodeInput {
	/**
	...
	**/
	...
	/**
		Field tensorflow.GraphTransferNodeInput.node_id
	**/
	public var node_id : Dynamic;
	/**
		Field tensorflow.GraphTransferNodeInput.output_port
	**/
	public var output_port : Dynamic;
}