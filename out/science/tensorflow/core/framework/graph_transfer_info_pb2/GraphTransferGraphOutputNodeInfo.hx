...
@:pythonImport("tensorflow.core.framework.graph_transfer_info_pb2", "GraphTransferGraphOutputNodeInfo") extern class GraphTransferGraphOutputNodeInfo {
	/**
	...
	**/
	...
	/**
		Field tensorflow.GraphTransferGraphOutputNodeInfo.dtype
	**/
	public var dtype : Dynamic;
	/**
		Field tensorflow.GraphTransferGraphOutputNodeInfo.name
	**/
	public var name : Dynamic;
	/**
		Field tensorflow.GraphTransferGraphOutputNodeInfo.shape
	**/
