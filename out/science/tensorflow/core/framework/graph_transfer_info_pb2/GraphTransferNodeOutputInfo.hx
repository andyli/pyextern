...
@:pythonImport("tensorflow.core.framework.graph_transfer_info_pb2", "GraphTransferNodeOutputInfo") extern class GraphTransferNodeOutputInfo {
	/**
	...
	**/
	...
	/**
		Field tensorflow.GraphTransferNodeOutputInfo.max_byte_size
	**/
	public var max_byte_size : Dynamic;
	/**
		Field tensorflow.GraphTransferNodeOutputInfo.node_id
	**/
