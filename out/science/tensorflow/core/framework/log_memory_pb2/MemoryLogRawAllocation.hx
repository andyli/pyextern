...
@:pythonImport("tensorflow.core.framework.log_memory_pb2", "MemoryLogRawAllocation") extern class MemoryLogRawAllocation {
	...
	**/
	...
	/**
		Field tensorflow.MemoryLogRawAllocation.allocation_id
	**/
	public var allocation_id : Dynamic;
	/**
		Field tensorflow.MemoryLogRawAllocation.allocator_name
	**/
	public var allocator_name : Dynamic;
	/**
		Field tensorflow.MemoryLogRawAllocation.num_bytes
	**/
	public var num_bytes : Dynamic;
	/**
		Field tensorflow.MemoryLogRawAllocation.operation
	**/
	public var operation : Dynamic;
	/**
		Field tensorflow.MemoryLogRawAllocation.ptr
	**/
	public var ptr : Dynamic;
	/**
		Field tensorflow.MemoryLogRawAllocation.step_id
	**/
