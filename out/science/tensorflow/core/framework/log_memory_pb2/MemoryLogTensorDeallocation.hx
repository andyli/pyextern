...
@:pythonImport("tensorflow.core.framework.log_memory_pb2", "MemoryLogTensorDeallocation") extern class MemoryLogTensorDeallocation {
	/**
	...
	**/
	...
	/**
		Field tensorflow.MemoryLogTensorDeallocation.allocation_id
	**/
	public var allocation_id : Dynamic;
	/**
		Field tensorflow.MemoryLogTensorDeallocation.allocator_name
	**/
