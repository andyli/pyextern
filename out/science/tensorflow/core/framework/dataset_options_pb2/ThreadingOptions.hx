...
@:pythonImport("tensorflow.core.framework.dataset_options_pb2", "ThreadingOptions") extern class ThreadingOptions {
	/**
	...
	**/
	...
	/**
		Field tensorflow.data.ThreadingOptions.max_intra_op_parallelism
	**/
	public var max_intra_op_parallelism : Dynamic;
	/**
		Field tensorflow.data.ThreadingOptions.private_threadpool_size
	**/
	public var private_threadpool_size : Dynamic;
}