...
@:pythonImport("tensorflow.core.framework.dataset_options_pb2", "AutotuneOptions") extern class AutotuneOptions {
	/**
	...
	**/
	...
	/**
		Field tensorflow.data.AutotuneOptions.cpu_budget
	**/
	public var cpu_budget : Dynamic;
	/**
		Field tensorflow.data.AutotuneOptions.enabled
	**/
	public var enabled : Dynamic;
	/**
		Field tensorflow.data.AutotuneOptions.ram_budget
	**/
	public var ram_budget : Dynamic;
}