...
@:pythonImport("tensorflow.core.framework.dataset_options_pb2", "DistributeOptions") extern class DistributeOptions {
	/**
	...
	**/
	...
	/**
		Field tensorflow.data.DistributeOptions.auto_shard_policy
	**/
	public var auto_shard_policy : Dynamic;
	/**
		Field tensorflow.data.DistributeOptions.num_devices
	**/
	public var num_devices : Dynamic;
}