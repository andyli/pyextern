...
@:pythonImport("tensorflow.core.framework.dataset_options_pb2", "Options") extern class Options {
	/**
	...
	**/
	...
	/**
		Field tensorflow.data.Options.autotune_options
	**/
	public var autotune_options : Dynamic;
	/**
		Field tensorflow.data.Options.deterministic
	**/
	public var deterministic : Dynamic;
	/**
		Field tensorflow.data.Options.distribute_options
	**/
	public var distribute_options : Dynamic;
	/**
		Field tensorflow.data.Options.external_state_policy
	**/
	public var external_state_policy : Dynamic;
	/**
		Field tensorflow.data.Options.optimization_options
	**/
	public var optimization_options : Dynamic;
	/**
		Field tensorflow.data.Options.slack
	**/
	public var slack : Dynamic;
	/**
		Field tensorflow.data.Options.threading_options
	**/
	public var threading_options : Dynamic;
}