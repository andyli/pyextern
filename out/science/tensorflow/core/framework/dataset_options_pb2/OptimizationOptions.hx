...
package tensorflow.core.framework.dataset_options_pb2;
@:pythonImport("tensorflow.core.framework.dataset_options_pb2", "OptimizationOptions") extern class OptimizationOptions {
	/**
	...
	**/
	...
	/**
		Field tensorflow.data.OptimizationOptions.apply_default_optimizations
	**/
	public var apply_default_optimizations : Dynamic;
	/**
		Field tensorflow.data.OptimizationOptions.filter_fusion
	**/
	public var filter_fusion : Dynamic;
	/**
		Field tensorflow.data.OptimizationOptions.map_and_batch_fusion
	**/
	public var map_and_batch_fusion : Dynamic;
	/**
		Field tensorflow.data.OptimizationOptions.map_and_filter_fusion
	**/
	public var map_and_filter_fusion : Dynamic;
	/**
		Field tensorflow.data.OptimizationOptions.map_fusion
	**/
	public var map_fusion : Dynamic;
	/**
		Field tensorflow.data.OptimizationOptions.map_parallelization
	**/
	public var map_parallelization : Dynamic;
	/**
		Field tensorflow.data.OptimizationOptions.noop_elimination
	**/
	public var noop_elimination : Dynamic;
	/**
		Field tensorflow.data.OptimizationOptions.parallel_batch
	**/
	public var parallel_batch : Dynamic;
	/**
		Field tensorflow.data.OptimizationOptions.shuffle_and_repeat_fusion
	**/
