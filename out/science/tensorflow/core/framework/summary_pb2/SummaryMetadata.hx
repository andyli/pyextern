...
@:pythonImport("tensorflow.core.framework.summary_pb2", "SummaryMetadata") extern class SummaryMetadata {
	/**
	...
	**/
	...
	/**
		A ProtocolMessage
	**/
	public function PluginData(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	...
	/**
		Field tensorflow.SummaryMetadata.data_class
	**/
	public var data_class : Dynamic;
	/**
