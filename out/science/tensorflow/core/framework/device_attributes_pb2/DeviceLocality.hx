...
@:pythonImport("tensorflow.core.framework.device_attributes_pb2", "DeviceLocality") extern class DeviceLocality {
	/**
	...
	**/
	...
	/**
		Field tensorflow.DeviceLocality.bus_id
	**/
	public var bus_id : Dynamic;
	/**
		Field tensorflow.DeviceLocality.links
	**/
	public var links : Dynamic;
	/**
		Field tensorflow.DeviceLocality.numa_node
	**/
	public var numa_node : Dynamic;
}