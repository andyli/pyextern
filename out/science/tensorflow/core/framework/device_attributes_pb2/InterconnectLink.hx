...
@:pythonImport("tensorflow.core.framework.device_attributes_pb2", "InterconnectLink") extern class InterconnectLink {
	/**
	...
	**/
	...
	/**
		Field tensorflow.InterconnectLink.device_id
	**/
	public var device_id : Dynamic;
	/**
		Field tensorflow.InterconnectLink.strength
	**/
	public var strength : Dynamic;
	/**
		Field tensorflow.InterconnectLink.type
	**/
