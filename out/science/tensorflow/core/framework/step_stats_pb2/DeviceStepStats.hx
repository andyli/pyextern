...
@:pythonImport("tensorflow.core.framework.step_stats_pb2", "DeviceStepStats") extern class DeviceStepStats {
	/**
	...
	**/
	...
	/**
		A ProtocolMessage
	**/
	public function ThreadNamesEntry(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	...
	/**
		Field tensorflow.DeviceStepStats.device
	**/
	public var device : Dynamic;
	/**
		Field tensorflow.DeviceStepStats.node_stats
	**/
	public var node_stats : Dynamic;
	/**
		Field tensorflow.DeviceStepStats.thread_names
	**/
	public var thread_names : Dynamic;
}