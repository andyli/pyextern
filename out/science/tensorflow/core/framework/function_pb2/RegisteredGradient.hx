...
@:pythonImport("tensorflow.core.framework.function_pb2", "RegisteredGradient") extern class RegisteredGradient {
	/**
	...
	**/
	...
	/**
		Field tensorflow.RegisteredGradient.gradient_func
	**/
	public var gradient_func : Dynamic;
	/**
		Field tensorflow.RegisteredGradient.registered_op_type
	**/
	public var registered_op_type : Dynamic;
}