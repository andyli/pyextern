...
@:pythonImport("tensorflow.core.framework.function_pb2", "FunctionDefLibrary") extern class FunctionDefLibrary {
	/**
	...
	**/
	...
	/**
		Field tensorflow.FunctionDefLibrary.function
	**/
	@:native("function")
	public var _function : Dynamic;
	/**
		Field tensorflow.FunctionDefLibrary.gradient
	**/
	public var gradient : Dynamic;
	/**
		Field tensorflow.FunctionDefLibrary.registered_gradients
	**/
	public var registered_gradients : Dynamic;
}