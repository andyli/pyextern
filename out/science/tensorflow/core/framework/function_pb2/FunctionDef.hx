...
@:pythonImport("tensorflow.core.framework.function_pb2", "FunctionDef") extern class FunctionDef {
	/**
		A ProtocolMessage
	**/
	public function ArgAttrEntry(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
		A ProtocolMessage
	**/
	public function ArgAttrs(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
		A ProtocolMessage
	**/
	public function AttrEntry(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	...
	/**
		A ProtocolMessage
	**/
	public function ControlRetEntry(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	...
	/**
		A ProtocolMessage
	**/
	public function ResourceArgUniqueIdEntry(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
		A ProtocolMessage
	**/
	...
	**/
	...
	/**
		Field tensorflow.FunctionDef.arg_attr
	**/
	public var arg_attr : Dynamic;
	/**
		Field tensorflow.FunctionDef.attr
	**/
	public var attr : Dynamic;
	/**
		Field tensorflow.FunctionDef.control_ret
	**/
	public var control_ret : Dynamic;
	/**
		Field tensorflow.FunctionDef.node_def
	**/
	public var node_def : Dynamic;
	/**
		Field tensorflow.FunctionDef.resource_arg_unique_id
	**/
	public var resource_arg_unique_id : Dynamic;
	/**
