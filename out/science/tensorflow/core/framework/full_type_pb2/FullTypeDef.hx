...
@:pythonImport("tensorflow.core.framework.full_type_pb2", "FullTypeDef") extern class FullTypeDef {
	/**
	...
	**/
	...
	/**
		Field tensorflow.FullTypeDef.args
	**/
	public var args : Dynamic;
	/**
		Field tensorflow.FullTypeDef.i
	**/
	public var i : Dynamic;
	/**
		Field tensorflow.FullTypeDef.s
	**/
	public var s : Dynamic;
	/**
		Field tensorflow.FullTypeDef.type_id
	**/
	public var type_id : Dynamic;
}