...
@:pythonImport("tensorflow.core.framework.op_def_pb2", "OpDef") extern class OpDef {
	...
	**/
	...
	/**
		Field tensorflow.OpDef.control_output
	**/
	public var control_output : Dynamic;
	/**
	...
	**/
	...
	/**
		Field tensorflow.OpDef.is_distributed_communication
	**/
	public var is_distributed_communication : Dynamic;
	/**
