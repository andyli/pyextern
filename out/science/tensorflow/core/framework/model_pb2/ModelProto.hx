...
package tensorflow.core.framework.model_pb2;
@:pythonImport("tensorflow.core.framework.model_pb2", "ModelProto") extern class ModelProto {
	/**
	...
	**/
	...
	/**
		A ProtocolMessage
	**/
	public function OptimizationParams(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	...
	/**
		Field tensorflow.data.model.ModelProto.id_counter
	**/
	public var id_counter : Dynamic;
	/**
		Field tensorflow.data.model.ModelProto.nodes
	**/
	public var nodes : Dynamic;
	/**
		Field tensorflow.data.model.ModelProto.optimization_params
	**/
	public var optimization_params : Dynamic;
	/**
		Field tensorflow.data.model.ModelProto.output
	**/
