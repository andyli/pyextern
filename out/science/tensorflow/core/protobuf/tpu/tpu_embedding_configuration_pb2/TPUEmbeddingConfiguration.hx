...
@:pythonImport("tensorflow.core.protobuf.tpu.tpu_embedding_configuration_pb2", "TPUEmbeddingConfiguration") extern class TPUEmbeddingConfiguration {
	...
	**/
	...
	static public var DIV_DEFAULT : Dynamic;
	/**
	...
	**/
	...
	/**
		Field tensorflow.tpu.TPUEmbeddingConfiguration.profile_data_directory
	**/
	public var profile_data_directory : Dynamic;
	/**
