...
package tensorflow.core.protobuf.tpu.dynamic_padding_pb2;
@:pythonImport("tensorflow.core.protobuf.tpu.dynamic_padding_pb2", "PaddingMap") extern class PaddingMap {
	/**
	...
	**/
	...
	/**
		Field tensorflow.tpu.PaddingMap.arg_index
	**/
	public var arg_index : Dynamic;
	/**
		Field tensorflow.tpu.PaddingMap.padding_arg_index
	**/
	public var padding_arg_index : Dynamic;
	/**
		Field tensorflow.tpu.PaddingMap.shape_index
	**/
	public var shape_index : Dynamic;
}