...
@:pythonImport("tensorflow.core.protobuf.tpu.optimization_parameters_pb2", "LearningRate") extern class LearningRate {
	/**
	...
	**/
	...
	/**
		Field tensorflow.tpu.LearningRate.constant
	**/
	public var constant : Dynamic;
	/**
		Field tensorflow.tpu.LearningRate.dynamic
	**/
	@:native("dynamic")
