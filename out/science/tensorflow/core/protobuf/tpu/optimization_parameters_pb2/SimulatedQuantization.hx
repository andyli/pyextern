...
@:pythonImport("tensorflow.core.protobuf.tpu.optimization_parameters_pb2", "SimulatedQuantization") extern class SimulatedQuantization {
	/**
	...
	**/
	...
	/**
		Field tensorflow.tpu.SimulatedQuantization.clipping_limits
	**/
	public var clipping_limits : Dynamic;
	/**
		Field tensorflow.tpu.SimulatedQuantization.enabled
	**/
	public var enabled : Dynamic;
	/**
		Field tensorflow.tpu.SimulatedQuantization.num_buckets
	**/
