...
@:pythonImport("tensorflow.core.protobuf.tpu.optimization_parameters_pb2", "DynamicLearningRate") extern class DynamicLearningRate {
	/**
	...
	**/
	...
	/**
		Field tensorflow.tpu.DynamicLearningRate.tag
	**/
