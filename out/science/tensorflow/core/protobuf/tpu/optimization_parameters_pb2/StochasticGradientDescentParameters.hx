...
@:pythonImport("tensorflow.core.protobuf.tpu.optimization_parameters_pb2", "StochasticGradientDescentParameters") extern class StochasticGradientDescentParameters {
	/**
