...
@:pythonImport("tensorflow.core.protobuf.tpu.optimization_parameters_pb2", "ClippingLimits") extern class ClippingLimits {
	/**
	...
	**/
	...
	/**
		Field tensorflow.tpu.ClippingLimits.lower
	**/
	public var lower : Dynamic;
	/**
		Field tensorflow.tpu.ClippingLimits.upper
	**/
