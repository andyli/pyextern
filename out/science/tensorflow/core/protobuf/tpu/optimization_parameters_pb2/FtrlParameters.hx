...
@:pythonImport("tensorflow.core.protobuf.tpu.optimization_parameters_pb2", "FtrlParameters") extern class FtrlParameters {
	/**
	...
	**/
	...
	/**
		Field tensorflow.tpu.FtrlParameters.allow_zero_accumulator
	**/
	public var allow_zero_accumulator : Dynamic;
	/**
		Field tensorflow.tpu.FtrlParameters.beta
	**/
	public var beta : Dynamic;
	/**
		Field tensorflow.tpu.FtrlParameters.l1
	**/
	public var l1 : Dynamic;
	/**
		Field tensorflow.tpu.FtrlParameters.l2
	**/
	public var l2 : Dynamic;
	/**
		Field tensorflow.tpu.FtrlParameters.lr_power
	**/
	public var lr_power : Dynamic;
	/**
		Field tensorflow.tpu.FtrlParameters.multiply_linear_by_lr
	**/
	public var multiply_linear_by_lr : Dynamic;
}