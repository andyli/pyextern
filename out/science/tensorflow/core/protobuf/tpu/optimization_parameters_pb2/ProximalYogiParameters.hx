...
@:pythonImport("tensorflow.core.protobuf.tpu.optimization_parameters_pb2", "ProximalYogiParameters") extern class ProximalYogiParameters {
	/**
	...
	**/
	...
	/**
		Field tensorflow.tpu.ProximalYogiParameters.beta1
	**/
	public var beta1 : Dynamic;
	/**
		Field tensorflow.tpu.ProximalYogiParameters.beta2
	**/
	public var beta2 : Dynamic;
	/**
		Field tensorflow.tpu.ProximalYogiParameters.epsilon
	**/
	public var epsilon : Dynamic;
	/**
		Field tensorflow.tpu.ProximalYogiParameters.l1
	**/
	public var l1 : Dynamic;
	/**
		Field tensorflow.tpu.ProximalYogiParameters.l2
	**/
