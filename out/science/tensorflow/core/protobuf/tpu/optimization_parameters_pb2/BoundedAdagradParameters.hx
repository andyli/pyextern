...
@:pythonImport("tensorflow.core.protobuf.tpu.optimization_parameters_pb2", "BoundedAdagradParameters") extern class BoundedAdagradParameters {
	/**
	...
	**/
	...
	/**
		Field tensorflow.tpu.BoundedAdagradParameters.max_accumulator
	**/
	public var max_accumulator : Dynamic;
	/**
		Field tensorflow.tpu.BoundedAdagradParameters.max_var_update
	**/
	public var max_var_update : Dynamic;
	/**
		Field tensorflow.tpu.BoundedAdagradParameters.update_accumulator_first
	**/
	public var update_accumulator_first : Dynamic;
}