...
@:pythonImport("tensorflow.core.protobuf.tpu.optimization_parameters_pb2", "OptimizationParameters") extern class OptimizationParameters {
	/**
	...
	**/
	...
	/**
		Field tensorflow.tpu.OptimizationParameters.adagrad_momentum
	**/
	public var adagrad_momentum : Dynamic;
	/**
		Field tensorflow.tpu.OptimizationParameters.adam
	**/
	public var adam : Dynamic;
	/**
		Field tensorflow.tpu.OptimizationParameters.assign
	**/
	public var assign : Dynamic;
	/**
		Field tensorflow.tpu.OptimizationParameters.bounded_adagrad
	**/
	public var bounded_adagrad : Dynamic;
	/**
	...
	**/
	...
	/**
		Field tensorflow.tpu.OptimizationParameters.frequency_estimator
	**/
	public var frequency_estimator : Dynamic;
	/**
		Field tensorflow.tpu.OptimizationParameters.ftrl
	**/
	public var ftrl : Dynamic;
	/**
		Field tensorflow.tpu.OptimizationParameters.gradient_accumulation_status
	**/
	public var gradient_accumulation_status : Dynamic;
	/**
		Field tensorflow.tpu.OptimizationParameters.gradient_clipping_limits
	**/
	public var gradient_clipping_limits : Dynamic;
	/**
		Field tensorflow.tpu.OptimizationParameters.hot_id_replication_configuration
	**/
	public var hot_id_replication_configuration : Dynamic;
	/**
	...
	**/
	...
	/**
		Field tensorflow.tpu.OptimizationParameters.multiply_weight_decay_factor_by_learning_rate
	**/
	public var multiply_weight_decay_factor_by_learning_rate : Dynamic;
	/**
		Field tensorflow.tpu.OptimizationParameters.online_yogi
	**/
	public var online_yogi : Dynamic;
	/**
		Field tensorflow.tpu.OptimizationParameters.proximal_adagrad
	**/
	public var proximal_adagrad : Dynamic;
	/**
		Field tensorflow.tpu.OptimizationParameters.proximal_yogi
	**/
	public var proximal_yogi : Dynamic;
	/**
		Field tensorflow.tpu.OptimizationParameters.rms_prop
	**/
	public var rms_prop : Dynamic;
	/**
		Field tensorflow.tpu.OptimizationParameters.simulated_quantization
	**/
	public var simulated_quantization : Dynamic;
	/**
		Field tensorflow.tpu.OptimizationParameters.stochastic_gradient_descent
	**/
	public var stochastic_gradient_descent : Dynamic;
	/**
		Field tensorflow.tpu.OptimizationParameters.user_defined_program
	**/
	public var user_defined_program : Dynamic;
	/**
