...
@:pythonImport("tensorflow.core.protobuf.tpu.optimization_parameters_pb2", "UserDefinedProgramParameters") extern class UserDefinedProgramParameters {
	/**
	...
	**/
	...
	/**
		Field tensorflow.tpu.UserDefinedProgramParameters.program
	**/
