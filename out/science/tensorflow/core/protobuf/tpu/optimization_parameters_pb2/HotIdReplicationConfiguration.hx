...
@:pythonImport("tensorflow.core.protobuf.tpu.optimization_parameters_pb2", "HotIdReplicationConfiguration") extern class HotIdReplicationConfiguration {
	/**
	...
	**/
	...
	/**
		Field tensorflow.tpu.HotIdReplicationConfiguration.status
	**/
