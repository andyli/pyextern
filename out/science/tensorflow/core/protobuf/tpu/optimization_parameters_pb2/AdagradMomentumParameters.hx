...
@:pythonImport("tensorflow.core.protobuf.tpu.optimization_parameters_pb2", "AdagradMomentumParameters") extern class AdagradMomentumParameters {
	/**
	...
	**/
	...
	/**
		Field tensorflow.tpu.AdagradMomentumParameters.beta2
	**/
	public var beta2 : Dynamic;
	/**
		Field tensorflow.tpu.AdagradMomentumParameters.exponent
	**/
	public var exponent : Dynamic;
	/**
		Field tensorflow.tpu.AdagradMomentumParameters.momentum
	**/
	public var momentum : Dynamic;
	/**
		Field tensorflow.tpu.AdagradMomentumParameters.use_nesterov
	**/
