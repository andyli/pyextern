...
@:pythonImport("tensorflow.core.protobuf.tpu.optimization_parameters_pb2", "FrequencyEstimatorParameters") extern class FrequencyEstimatorParameters {
	/**
	...
	**/
	...
	/**
		Field tensorflow.tpu.FrequencyEstimatorParameters.max_delta
	**/
	public var max_delta : Dynamic;
	/**
		Field tensorflow.tpu.FrequencyEstimatorParameters.outlier_threshold
	**/
	public var outlier_threshold : Dynamic;
	/**
		Field tensorflow.tpu.FrequencyEstimatorParameters.tau
	**/
	public var tau : Dynamic;
	/**
		Field tensorflow.tpu.FrequencyEstimatorParameters.weight_exponent
	**/
	public var weight_exponent : Dynamic;
}