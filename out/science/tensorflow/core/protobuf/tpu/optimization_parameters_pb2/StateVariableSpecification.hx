...
@:pythonImport("tensorflow.core.protobuf.tpu.optimization_parameters_pb2", "StateVariableSpecification") extern class StateVariableSpecification {
	/**
	...
	**/
	...
	/**
		A ProtocolMessage
	**/
	public function FillWithConstant(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	...
	/**
		A ProtocolMessage
	**/
	public function UserDefined(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
