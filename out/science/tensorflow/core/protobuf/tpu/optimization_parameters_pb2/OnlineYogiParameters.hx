...
@:pythonImport("tensorflow.core.protobuf.tpu.optimization_parameters_pb2", "OnlineYogiParameters") extern class OnlineYogiParameters {
	/**
	...
	**/
	...
	/**
		Field tensorflow.tpu.OnlineYogiParameters.beta2
	**/
	public var beta2 : Dynamic;
	/**
		Field tensorflow.tpu.OnlineYogiParameters.l1
	**/
	public var l1 : Dynamic;
	/**
		Field tensorflow.tpu.OnlineYogiParameters.l2
	**/
