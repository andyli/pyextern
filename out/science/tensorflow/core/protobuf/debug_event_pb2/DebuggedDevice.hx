...
@:pythonImport("tensorflow.core.protobuf.debug_event_pb2", "DebuggedDevice") extern class DebuggedDevice {
	/**
	...
	**/
	...
	/**
		Field tensorflow.DebuggedDevice.device_id
	**/
	public var device_id : Dynamic;
	/**
		Field tensorflow.DebuggedDevice.device_name
	**/
