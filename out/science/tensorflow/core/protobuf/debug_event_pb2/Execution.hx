...
@:pythonImport("tensorflow.core.protobuf.debug_event_pb2", "Execution") extern class Execution {
	/**
	...
	**/
	...
	/**
		Field tensorflow.Execution.code_location
	**/
	public var code_location : Dynamic;
	/**
		Field tensorflow.Execution.graph_id
	**/
	public var graph_id : Dynamic;
	/**
		Field tensorflow.Execution.input_tensor_ids
	**/
	public var input_tensor_ids : Dynamic;
	/**
		Field tensorflow.Execution.num_outputs
	**/
	public var num_outputs : Dynamic;
	/**
		Field tensorflow.Execution.op_type
	**/
	public var op_type : Dynamic;
	/**
		Field tensorflow.Execution.output_tensor_device_ids
	**/
	public var output_tensor_device_ids : Dynamic;
	/**
		Field tensorflow.Execution.output_tensor_ids
	**/
	public var output_tensor_ids : Dynamic;
	/**
		Field tensorflow.Execution.tensor_debug_mode
	**/
	public var tensor_debug_mode : Dynamic;
	/**
		Field tensorflow.Execution.tensor_protos
	**/
	public var tensor_protos : Dynamic;
}