...
@:pythonImport("tensorflow.core.protobuf.debug_event_pb2", "DebuggedGraph") extern class DebuggedGraph {
	/**
	...
	**/
	...
	/**
		Field tensorflow.DebuggedGraph.graph_id
	**/
	public var graph_id : Dynamic;
	/**
		Field tensorflow.DebuggedGraph.graph_name
	**/
	public var graph_name : Dynamic;
	/**
		Field tensorflow.DebuggedGraph.instrumented_graph_def
	**/
	public var instrumented_graph_def : Dynamic;
	/**
		Field tensorflow.DebuggedGraph.instrumented_ops
	**/
	public var instrumented_ops : Dynamic;
	/**
		Field tensorflow.DebuggedGraph.original_graph_def
	**/
	public var original_graph_def : Dynamic;
	/**
		Field tensorflow.DebuggedGraph.outer_context_id
	**/
	public var outer_context_id : Dynamic;
}