...
package tensorflow.core.protobuf.debug_event_pb2;
@:pythonImport("tensorflow.core.protobuf.debug_event_pb2", "DebugEvent") extern class DebugEvent {
	/**
	...
	**/
	...
	/**
		Field tensorflow.DebugEvent.debug_metadata
	**/
	public var debug_metadata : Dynamic;
	/**
		Field tensorflow.DebugEvent.debugged_device
	**/
	public var debugged_device : Dynamic;
	/**
		Field tensorflow.DebugEvent.debugged_graph
	**/
	public var debugged_graph : Dynamic;
	/**
		Field tensorflow.DebugEvent.execution
	**/
	public var execution : Dynamic;
	/**
		Field tensorflow.DebugEvent.graph_execution_trace
	**/
	public var graph_execution_trace : Dynamic;
	/**
		Field tensorflow.DebugEvent.graph_id
	**/
	public var graph_id : Dynamic;
	/**
		Field tensorflow.DebugEvent.graph_op_creation
	**/
	public var graph_op_creation : Dynamic;
	/**
		Field tensorflow.DebugEvent.source_file
	**/
	public var source_file : Dynamic;
	/**
		Field tensorflow.DebugEvent.stack_frame_with_id
	**/
	public var stack_frame_with_id : Dynamic;
	/**
		Field tensorflow.DebugEvent.step
	**/
	public var step : Dynamic;
	/**
		Field tensorflow.DebugEvent.wall_time
	**/
