...
@:pythonImport("tensorflow.core.protobuf.debug_event_pb2", "DebugMetadata") extern class DebugMetadata {
	/**
	...
	**/
	...
	/**
		Field tensorflow.DebugMetadata.file_version
	**/
	public var file_version : Dynamic;
	/**
		Field tensorflow.DebugMetadata.tensorflow_version
	**/
	public var tensorflow_version : Dynamic;
	/**
		Field tensorflow.DebugMetadata.tfdbg_run_id
	**/
