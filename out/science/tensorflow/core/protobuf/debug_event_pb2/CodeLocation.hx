...
@:pythonImport("tensorflow.core.protobuf.debug_event_pb2", "CodeLocation") extern class CodeLocation {
	/**
	...
	**/
	...
	/**
		Field tensorflow.CodeLocation.host_name
	**/
	public var host_name : Dynamic;
	/**
		Field tensorflow.CodeLocation.stack_frame_ids
	**/
