...
@:pythonImport("tensorflow.core.protobuf.debug_event_pb2", "GraphExecutionTrace") extern class GraphExecutionTrace {
	/**
	...
	**/
	...
	/**
		Field tensorflow.GraphExecutionTrace.device_name
	**/
	public var device_name : Dynamic;
	/**
		Field tensorflow.GraphExecutionTrace.op_name
	**/
	public var op_name : Dynamic;
	/**
		Field tensorflow.GraphExecutionTrace.output_slot
	**/
	public var output_slot : Dynamic;
	/**
		Field tensorflow.GraphExecutionTrace.tensor_debug_mode
	**/
	public var tensor_debug_mode : Dynamic;
	/**
		Field tensorflow.GraphExecutionTrace.tensor_proto
	**/
	public var tensor_proto : Dynamic;
	/**
		Field tensorflow.GraphExecutionTrace.tfdbg_context_id
	**/
	public var tfdbg_context_id : Dynamic;
}