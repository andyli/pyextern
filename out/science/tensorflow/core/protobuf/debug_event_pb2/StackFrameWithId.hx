...
@:pythonImport("tensorflow.core.protobuf.debug_event_pb2", "StackFrameWithId") extern class StackFrameWithId {
	/**
	...
	**/
	...
	/**
		Field tensorflow.StackFrameWithId.file_line_col
	**/
	public var file_line_col : Dynamic;
	/**
		Field tensorflow.StackFrameWithId.id
	**/
