...
@:pythonImport("tensorflow.core.protobuf.debug_event_pb2", "SourceFile") extern class SourceFile {
	/**
	...
	**/
	...
	/**
		Field tensorflow.SourceFile.file_path
	**/
	public var file_path : Dynamic;
	/**
		Field tensorflow.SourceFile.host_name
	**/
	public var host_name : Dynamic;
	/**
		Field tensorflow.SourceFile.lines
	**/
