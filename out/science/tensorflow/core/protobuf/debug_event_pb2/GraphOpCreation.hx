...
@:pythonImport("tensorflow.core.protobuf.debug_event_pb2", "GraphOpCreation") extern class GraphOpCreation {
	/**
	...
	**/
	...
	/**
		Field tensorflow.GraphOpCreation.code_location
	**/
	public var code_location : Dynamic;
	/**
		Field tensorflow.GraphOpCreation.device_name
	**/
	public var device_name : Dynamic;
	/**
		Field tensorflow.GraphOpCreation.graph_id
	**/
	public var graph_id : Dynamic;
	/**
		Field tensorflow.GraphOpCreation.graph_name
	**/
	public var graph_name : Dynamic;
	/**
		Field tensorflow.GraphOpCreation.input_names
	**/
	public var input_names : Dynamic;
	/**
		Field tensorflow.GraphOpCreation.num_outputs
	**/
	public var num_outputs : Dynamic;
	/**
		Field tensorflow.GraphOpCreation.op_name
	**/
	public var op_name : Dynamic;
	/**
		Field tensorflow.GraphOpCreation.op_type
	**/
	public var op_type : Dynamic;
	/**
		Field tensorflow.GraphOpCreation.output_tensor_ids
	**/
