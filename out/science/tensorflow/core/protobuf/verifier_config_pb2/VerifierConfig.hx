...
package tensorflow.core.protobuf.verifier_config_pb2;
@:pythonImport("tensorflow.core.protobuf.verifier_config_pb2", "VerifierConfig") extern class VerifierConfig {
	/**
	...
	**/
	...
	/**
		Field tensorflow.VerifierConfig.structure_verifier
	**/
	public var structure_verifier : Dynamic;
	/**
		Field tensorflow.VerifierConfig.verification_timeout_in_ms
	**/
	public var verification_timeout_in_ms : Dynamic;
}