...
@:pythonImport("tensorflow.core.protobuf.meta_graph_pb2", "TensorInfo") extern class TensorInfo {
	/**
	...
	**/
	...
	/**
		A ProtocolMessage
	**/
	public function CompositeTensor(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
		A ProtocolMessage
	**/
	public function CooSparse(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	public var composite_tensor : Dynamic;
	/**
