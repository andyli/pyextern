...
@:pythonImport("tensorflow.core.protobuf.device_properties_pb2", "NamedDevice") extern class NamedDevice {
	/**
	...
	**/
	...
	/**
		Field tensorflow.NamedDevice.name
	**/
	public var name : Dynamic;
	/**
		Field tensorflow.NamedDevice.properties
	**/
