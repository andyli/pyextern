...
@:pythonImport("tensorflow.core.protobuf.config_pb2", "SessionMetadata") extern class SessionMetadata {
	/**
	...
	**/
	...
	/**
		Field tensorflow.SessionMetadata.name
	**/
	public var name : Dynamic;
	/**
		Field tensorflow.SessionMetadata.version
	**/
