...
@:pythonImport("tensorflow.core.protobuf.config_pb2", "RunMetadata") extern class RunMetadata {
	/**
	...
	**/
	...
	/**
		A ProtocolMessage
	**/
	public function FunctionGraphs(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	public var function_graphs : Dynamic;
	/**
