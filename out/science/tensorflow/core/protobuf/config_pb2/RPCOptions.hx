...
@:pythonImport("tensorflow.core.protobuf.config_pb2", "RPCOptions") extern class RPCOptions {
	/**
	...
	**/
	...
	/**
		Field tensorflow.RPCOptions.cache_rpc_response
	**/
	public var cache_rpc_response : Dynamic;
	/**
		Field tensorflow.RPCOptions.compression_algorithm
	**/
	public var compression_algorithm : Dynamic;
	/**
		Field tensorflow.RPCOptions.compression_level
	**/
	public var compression_level : Dynamic;
	/**
		Field tensorflow.RPCOptions.disable_session_connection_sharing
	**/
	public var disable_session_connection_sharing : Dynamic;
	/**
		Field tensorflow.RPCOptions.num_channels_per_target
	**/
	public var num_channels_per_target : Dynamic;
	/**
		Field tensorflow.RPCOptions.use_rpc_for_inprocess_master
	**/
	public var use_rpc_for_inprocess_master : Dynamic;
}