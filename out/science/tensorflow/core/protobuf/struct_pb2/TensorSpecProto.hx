...
@:pythonImport("tensorflow.core.protobuf.struct_pb2", "TensorSpecProto") extern class TensorSpecProto {
	/**
	...
	**/
	...
	/**
		Field tensorflow.TensorSpecProto.dtype
	**/
	public var dtype : Dynamic;
	/**
		Field tensorflow.TensorSpecProto.name
	**/
	public var name : Dynamic;
	/**
		Field tensorflow.TensorSpecProto.shape
	**/
