...
package tensorflow.core.protobuf.struct_pb2;
@:pythonImport("tensorflow.core.protobuf.struct_pb2", "StructuredValue") extern class StructuredValue {
	/**
	...
	**/
	...
	/**
		Field tensorflow.StructuredValue.bool_value
	**/
	public var bool_value : Dynamic;
	/**
		Field tensorflow.StructuredValue.bounded_tensor_spec_value
	**/
	public var bounded_tensor_spec_value : Dynamic;
	/**
		Field tensorflow.StructuredValue.dict_value
	**/
	public var dict_value : Dynamic;
	/**
		Field tensorflow.StructuredValue.float64_value
	**/
	public var float64_value : Dynamic;
	/**
		Field tensorflow.StructuredValue.int64_value
	**/
	public var int64_value : Dynamic;
	/**
		Field tensorflow.StructuredValue.list_value
	**/
	public var list_value : Dynamic;
	/**
		Field tensorflow.StructuredValue.named_tuple_value
	**/
	public var named_tuple_value : Dynamic;
	/**
		Field tensorflow.StructuredValue.none_value
	**/
	public var none_value : Dynamic;
	/**
		Field tensorflow.StructuredValue.string_value
	**/
	public var string_value : Dynamic;
	/**
		Field tensorflow.StructuredValue.tensor_dtype_value
	**/
	public var tensor_dtype_value : Dynamic;
	/**
		Field tensorflow.StructuredValue.tensor_shape_value
	**/
	public var tensor_shape_value : Dynamic;
	/**
		Field tensorflow.StructuredValue.tensor_spec_value
	**/
	public var tensor_spec_value : Dynamic;
	/**
		Field tensorflow.StructuredValue.tuple_value
	**/
	public var tuple_value : Dynamic;
	/**
		Field tensorflow.StructuredValue.type_spec_value
	**/
	public var type_spec_value : Dynamic;
}