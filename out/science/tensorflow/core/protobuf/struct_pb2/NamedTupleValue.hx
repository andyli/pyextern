...
@:pythonImport("tensorflow.core.protobuf.struct_pb2", "NamedTupleValue") extern class NamedTupleValue {
	/**
	...
	**/
	...
	/**
		Field tensorflow.NamedTupleValue.name
	**/
	public var name : Dynamic;
	/**
		Field tensorflow.NamedTupleValue.values
	**/
