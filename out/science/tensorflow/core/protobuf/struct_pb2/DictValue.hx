...
@:pythonImport("tensorflow.core.protobuf.struct_pb2", "DictValue") extern class DictValue {
	/**
	...
	**/
	...
	/**
		A ProtocolMessage
	**/
	public function FieldsEntry(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	...
	/**
		Field tensorflow.DictValue.fields
	**/
