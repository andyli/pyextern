...
@:pythonImport("tensorflow.core.protobuf.struct_pb2", "BoundedTensorSpecProto") extern class BoundedTensorSpecProto {
	/**
	...
	**/
	...
	/**
		Field tensorflow.BoundedTensorSpecProto.dtype
	**/
	public var dtype : Dynamic;
	/**
		Field tensorflow.BoundedTensorSpecProto.maximum
	**/
	public var maximum : Dynamic;
	/**
		Field tensorflow.BoundedTensorSpecProto.minimum
	**/
	public var minimum : Dynamic;
	/**
		Field tensorflow.BoundedTensorSpecProto.name
	**/
	public var name : Dynamic;
	/**
		Field tensorflow.BoundedTensorSpecProto.shape
	**/
