...
@:pythonImport("tensorflow.core.protobuf.bfc_memory_map_pb2", "SnapShot") extern class SnapShot {
	/**
	...
	**/
	...
	/**
		Field tensorflow.SnapShot.action_count
	**/
	public var action_count : Dynamic;
	/**
		Field tensorflow.SnapShot.size
	**/
