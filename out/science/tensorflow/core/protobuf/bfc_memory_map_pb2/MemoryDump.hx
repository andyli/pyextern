...
@:pythonImport("tensorflow.core.protobuf.bfc_memory_map_pb2", "MemoryDump") extern class MemoryDump {
	/**
	...
	**/
	...
	/**
		Field tensorflow.MemoryDump.allocator_name
	**/
	public var allocator_name : Dynamic;
	/**
		Field tensorflow.MemoryDump.bin_summary
	**/
	public var bin_summary : Dynamic;
	/**
		Field tensorflow.MemoryDump.chunk
	**/
	public var chunk : Dynamic;
	/**
		Field tensorflow.MemoryDump.snap_shot
	**/
	public var snap_shot : Dynamic;
	/**
		Field tensorflow.MemoryDump.stats
	**/
