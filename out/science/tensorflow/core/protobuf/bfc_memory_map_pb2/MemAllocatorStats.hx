...
@:pythonImport("tensorflow.core.protobuf.bfc_memory_map_pb2", "MemAllocatorStats") extern class MemAllocatorStats {
	/**
	...
	**/
	...
	/**
		Field tensorflow.MemAllocatorStats.bytes_in_use
	**/
	public var bytes_in_use : Dynamic;
	/**
		Field tensorflow.MemAllocatorStats.fragmentation_metric
	**/
	public var fragmentation_metric : Dynamic;
	/**
		Field tensorflow.MemAllocatorStats.largest_alloc_size
	**/
	public var largest_alloc_size : Dynamic;
	/**
		Field tensorflow.MemAllocatorStats.num_allocs
	**/
	public var num_allocs : Dynamic;
	/**
		Field tensorflow.MemAllocatorStats.peak_bytes_in_use
	**/
	public var peak_bytes_in_use : Dynamic;
}