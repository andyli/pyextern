...
@:pythonImport("tensorflow.core.protobuf.bfc_memory_map_pb2", "BinSummary") extern class BinSummary {
	/**
	...
	**/
	...
	/**
		Field tensorflow.BinSummary.bin
	**/
	public var bin : Dynamic;
	/**
		Field tensorflow.BinSummary.total_bytes_in_bin
	**/
	public var total_bytes_in_bin : Dynamic;
	/**
		Field tensorflow.BinSummary.total_bytes_in_use
	**/
	public var total_bytes_in_use : Dynamic;
	/**
		Field tensorflow.BinSummary.total_chunks_in_bin
	**/
	public var total_chunks_in_bin : Dynamic;
	/**
		Field tensorflow.BinSummary.total_chunks_in_use
	**/
	public var total_chunks_in_use : Dynamic;
}