...
package tensorflow.core.protobuf.bfc_memory_map_pb2;
@:pythonImport("tensorflow.core.protobuf.bfc_memory_map_pb2", "MemChunk") extern class MemChunk {
	/**
	...
	**/
	...
	/**
		Field tensorflow.MemChunk.action_count
	**/
	public var action_count : Dynamic;
	/**
		Field tensorflow.MemChunk.address
	**/
	public var address : Dynamic;
	/**
		Field tensorflow.MemChunk.bin
	**/
	public var bin : Dynamic;
	/**
		Field tensorflow.MemChunk.freed_at_count
	**/
	public var freed_at_count : Dynamic;
	/**
		Field tensorflow.MemChunk.in_use
	**/
	public var in_use : Dynamic;
	/**
		Field tensorflow.MemChunk.op_name
	**/
	public var op_name : Dynamic;
	/**
		Field tensorflow.MemChunk.requested_size
	**/
	public var requested_size : Dynamic;
	/**
		Field tensorflow.MemChunk.size
	**/
	public var size : Dynamic;
	/**
		Field tensorflow.MemChunk.step_id
	**/
