...
package tensorflow.core.protobuf.composite_tensor_variant_pb2;
@:pythonImport("tensorflow.core.protobuf.composite_tensor_variant_pb2", "CompositeTensorVariantMetadata") extern class CompositeTensorVariantMetadata {
	/**
	...
	**/
	...
	/**
		Field tensorflow.CompositeTensorVariantMetadata.type_spec_proto
	**/
	public var type_spec_proto : Dynamic;
}