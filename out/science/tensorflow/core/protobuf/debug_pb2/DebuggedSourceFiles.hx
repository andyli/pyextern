...
@:pythonImport("tensorflow.core.protobuf.debug_pb2", "DebuggedSourceFiles") extern class DebuggedSourceFiles {
	/**
	...
	**/
	...
	/**
		Field tensorflow.DebuggedSourceFiles.source_files
	**/
	public var source_files : Dynamic;
}