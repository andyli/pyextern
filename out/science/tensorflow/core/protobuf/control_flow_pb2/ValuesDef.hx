...
@:pythonImport("tensorflow.core.protobuf.control_flow_pb2", "ValuesDef") extern class ValuesDef {
	/**
	...
	**/
	...
	/**
		A ProtocolMessage
	**/
	public function ExternalValuesEntry(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	...
	/**
		Field tensorflow.ValuesDef.external_values
	**/
	public var external_values : Dynamic;
	/**
		Field tensorflow.ValuesDef.values
	**/
