...
package tensorflow.core.protobuf.device_filters_pb2;
@:pythonImport("tensorflow.core.protobuf.device_filters_pb2", "JobDeviceFilters") extern class JobDeviceFilters {
	/**
	...
	**/
	...
	/**
		Field tensorflow.JobDeviceFilters.name
	**/
	public var name : Dynamic;
	/**
		Field tensorflow.JobDeviceFilters.tasks
	**/
