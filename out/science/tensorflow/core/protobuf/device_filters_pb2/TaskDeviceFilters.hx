...
@:pythonImport("tensorflow.core.protobuf.device_filters_pb2", "TaskDeviceFilters") extern class TaskDeviceFilters {
	/**
	...
	**/
	...
	/**
		Field tensorflow.TaskDeviceFilters.device_filters
	**/
