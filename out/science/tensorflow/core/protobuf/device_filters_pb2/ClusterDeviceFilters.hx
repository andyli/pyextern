...
@:pythonImport("tensorflow.core.protobuf.device_filters_pb2", "ClusterDeviceFilters") extern class ClusterDeviceFilters {
	/**
	...
	**/
	...
	/**
		Field tensorflow.ClusterDeviceFilters.jobs
	**/
