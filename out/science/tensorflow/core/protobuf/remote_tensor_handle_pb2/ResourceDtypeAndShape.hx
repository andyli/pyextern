...
@:pythonImport("tensorflow.core.protobuf.remote_tensor_handle_pb2", "ResourceDtypeAndShape") extern class ResourceDtypeAndShape {
	/**
	...
	**/
	...
	/**
		Field tensorflow.eager.ResourceDtypeAndShape.dtype
	**/
	public var dtype : Dynamic;
	/**
		Field tensorflow.eager.ResourceDtypeAndShape.shape
	**/
