...
package tensorflow.core.protobuf.remote_tensor_handle_pb2;
@:pythonImport("tensorflow.core.protobuf.remote_tensor_handle_pb2", "RemoteTensorHandle") extern class RemoteTensorHandle {
	/**
	...
	**/
	...
	/**
		Field tensorflow.eager.RemoteTensorHandle.device
	**/
	public var device : Dynamic;
	/**
		Field tensorflow.eager.RemoteTensorHandle.dtype
	**/
	public var dtype : Dynamic;
	/**
		Field tensorflow.eager.RemoteTensorHandle.op_device
	**/
	public var op_device : Dynamic;
	/**
		Field tensorflow.eager.RemoteTensorHandle.op_id
	**/
	public var op_id : Dynamic;
	/**
		Field tensorflow.eager.RemoteTensorHandle.output_num
	**/
	public var output_num : Dynamic;
	/**
		Field tensorflow.eager.RemoteTensorHandle.resource_dtypes_and_shapes
	**/
	public var resource_dtypes_and_shapes : Dynamic;
}