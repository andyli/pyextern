...
@:pythonImport("tensorflow.core.protobuf.tensorflow_server_pb2", "ServerDef") extern class ServerDef {
	/**
	...
	**/
	...
	/**
		Field tensorflow.ServerDef.cluster_device_filters
	**/
	public var cluster_device_filters : Dynamic;
	/**
	...
	**/
	...
	/**
		Field tensorflow.ServerDef.port
	**/
