...
package tensorflow.core.protobuf.named_tensor_pb2;
@:pythonImport("tensorflow.core.protobuf.named_tensor_pb2", "NamedTensorProto") extern class NamedTensorProto {
	/**
	...
	**/
	...
	/**
		Field tensorflow.NamedTensorProto.name
	**/
	public var name : Dynamic;
	/**
		Field tensorflow.NamedTensorProto.tensor
	**/
