...
@:pythonImport("tensorflow.core.protobuf.rewriter_config_pb2", "RewriterConfig") extern class RewriterConfig {
	...
	**/
	...
	static public var CpuLayout : Dynamic;
	/**
		A ProtocolMessage
	**/
	...
	**/
	...
	static public var NCHW_TO_NHWC : Dynamic;
	static public var NHWC_TO_NCHW : Dynamic;
	static public var NO_CONVERSION_ON_CPU : Dynamic;
	...
	**/
	...
	/**
		Field tensorflow.RewriterConfig.auto_mixed_precision
	**/
	public var auto_mixed_precision : Dynamic;
	/**
		Field tensorflow.RewriterConfig.auto_mixed_precision_mkl
	**/
	public var auto_mixed_precision_mkl : Dynamic;
	/**
		Field tensorflow.RewriterConfig.auto_parallel
	**/
	public var auto_parallel : Dynamic;
	/**
		Field tensorflow.RewriterConfig.common_subgraph_elimination
	**/
	public var common_subgraph_elimination : Dynamic;
	/**
		Field tensorflow.RewriterConfig.constant_folding
	**/
	public var constant_folding : Dynamic;
	/**
		Field tensorflow.RewriterConfig.cpu_layout_conversion
	**/
	public var cpu_layout_conversion : Dynamic;
	/**
	...
	**/
	...
	/**
		Field tensorflow.RewriterConfig.experimental_disable_compressed_tensor_optimization
	**/
	public var experimental_disable_compressed_tensor_optimization : Dynamic;
	/**
		Field tensorflow.RewriterConfig.experimental_disable_folding_quantization_emulation
	**/
	public var experimental_disable_folding_quantization_emulation : Dynamic;
	/**
	...
	**/
	...
	/**
		Field tensorflow.RewriterConfig.implementation_selector
	**/
	public var implementation_selector : Dynamic;
	/**
		Field tensorflow.RewriterConfig.inter_optimizer_verifier_config
	**/
	public var inter_optimizer_verifier_config : Dynamic;
	/**
	...
	**/
	...
	/**
		Field tensorflow.RewriterConfig.post_optimization_verifier_config
	**/
	public var post_optimization_verifier_config : Dynamic;
	/**
	...
	**/
	...
	/**
		Field tensorflow.RewriterConfig.use_plugin_optimizers
	**/
	public var use_plugin_optimizers : Dynamic;
}