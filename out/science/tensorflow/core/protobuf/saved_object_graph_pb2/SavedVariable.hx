...
@:pythonImport("tensorflow.core.protobuf.saved_object_graph_pb2", "SavedVariable") extern class SavedVariable {
	/**
	...
	**/
	...
	/**
		Field tensorflow.SavedVariable.aggregation
	**/
	public var aggregation : Dynamic;
	/**
		Field tensorflow.SavedVariable.device
	**/
	public var device : Dynamic;
	/**
		Field tensorflow.SavedVariable.dtype
	**/
	public var dtype : Dynamic;
	/**
		Field tensorflow.SavedVariable.experimental_distributed_variable_components
	**/
	public var experimental_distributed_variable_components : Dynamic;
	/**
		Field tensorflow.SavedVariable.name
	**/
	public var name : Dynamic;
	/**
		Field tensorflow.SavedVariable.shape
	**/
	public var shape : Dynamic;
	/**
		Field tensorflow.SavedVariable.synchronization
	**/
	public var synchronization : Dynamic;
	/**
		Field tensorflow.SavedVariable.trainable
	**/
