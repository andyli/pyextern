...
@:pythonImport("tensorflow.core.protobuf.saved_object_graph_pb2", "CapturedTensor") extern class CapturedTensor {
	/**
	...
	**/
	...
	/**
		Field tensorflow.CapturedTensor.concrete_function
	**/
	public var concrete_function : Dynamic;
	/**
		Field tensorflow.CapturedTensor.name
	**/
