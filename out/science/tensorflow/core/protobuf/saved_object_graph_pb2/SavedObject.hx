...
package tensorflow.core.protobuf.saved_object_graph_pb2;
@:pythonImport("tensorflow.core.protobuf.saved_object_graph_pb2", "SavedObject") extern class SavedObject {
	/**
	...
	**/
	...
	/**
		A ProtocolMessage
	**/
	public function SaveableObjectsEntry(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	...
	/**
		Field tensorflow.SavedObject.asset
	**/
	public var asset : Dynamic;
	/**
		Field tensorflow.SavedObject.bare_concrete_function
	**/
	public var bare_concrete_function : Dynamic;
	/**
		Field tensorflow.SavedObject.captured_tensor
	**/
	public var captured_tensor : Dynamic;
	/**
		Field tensorflow.SavedObject.children
	**/
	public var children : Dynamic;
	/**
		Field tensorflow.SavedObject.constant
	**/
	public var constant : Dynamic;
	/**
		Field tensorflow.SavedObject.function
	**/
	@:native("function")
	public var _function : Dynamic;
	/**
		Field tensorflow.SavedObject.registered_name
	**/
	public var registered_name : Dynamic;
	/**
		Field tensorflow.SavedObject.resource
	**/
	public var resource : Dynamic;
	/**
		Field tensorflow.SavedObject.saveable_objects
	**/
	public var saveable_objects : Dynamic;
	/**
		Field tensorflow.SavedObject.serialized_user_proto
	**/
	public var serialized_user_proto : Dynamic;
	/**
		Field tensorflow.SavedObject.slot_variables
	**/
	public var slot_variables : Dynamic;
	/**
		Field tensorflow.SavedObject.user_object
	**/
	public var user_object : Dynamic;
	/**
		Field tensorflow.SavedObject.variable
	**/
