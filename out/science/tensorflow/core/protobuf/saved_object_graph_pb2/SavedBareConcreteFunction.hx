...
@:pythonImport("tensorflow.core.protobuf.saved_object_graph_pb2", "SavedBareConcreteFunction") extern class SavedBareConcreteFunction {
	/**
	...
	**/
	...
	/**
		Field tensorflow.SavedBareConcreteFunction.allowed_positional_arguments
	**/
	public var allowed_positional_arguments : Dynamic;
	/**
		Field tensorflow.SavedBareConcreteFunction.argument_keywords
	**/
	public var argument_keywords : Dynamic;
	/**
		Field tensorflow.SavedBareConcreteFunction.concrete_function_name
	**/
	public var concrete_function_name : Dynamic;
	/**
		Field tensorflow.SavedBareConcreteFunction.function_spec
	**/
