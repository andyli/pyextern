...
@:pythonImport("tensorflow.core.protobuf.saved_object_graph_pb2", "SavedObjectGraph") extern class SavedObjectGraph {
	/**
	...
	**/
	...
	/**
		A ProtocolMessage
	**/
	public function ConcreteFunctionsEntry(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	...
	/**
		Field tensorflow.SavedObjectGraph.concrete_functions
	**/
	public var concrete_functions : Dynamic;
	/**
		Field tensorflow.SavedObjectGraph.nodes
	**/
