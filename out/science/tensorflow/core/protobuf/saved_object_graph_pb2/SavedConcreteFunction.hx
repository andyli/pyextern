...
@:pythonImport("tensorflow.core.protobuf.saved_object_graph_pb2", "SavedConcreteFunction") extern class SavedConcreteFunction {
	/**
	...
	**/
	...
	/**
		Field tensorflow.SavedConcreteFunction.bound_inputs
	**/
	public var bound_inputs : Dynamic;
	/**
		Field tensorflow.SavedConcreteFunction.canonicalized_input_signature
	**/
	public var canonicalized_input_signature : Dynamic;
	/**
		Field tensorflow.SavedConcreteFunction.output_signature
	**/
	public var output_signature : Dynamic;
}