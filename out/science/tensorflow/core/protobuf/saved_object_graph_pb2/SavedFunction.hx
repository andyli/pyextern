...
@:pythonImport("tensorflow.core.protobuf.saved_object_graph_pb2", "SavedFunction") extern class SavedFunction {
	/**
	...
	**/
	...
	/**
		Field tensorflow.SavedFunction.concrete_functions
	**/
	public var concrete_functions : Dynamic;
	/**
		Field tensorflow.SavedFunction.function_spec
	**/
