...
@:pythonImport("tensorflow.core.protobuf.saved_object_graph_pb2", "SavedUserObject") extern class SavedUserObject {
	/**
	...
	**/
	...
	/**
		Field tensorflow.SavedUserObject.identifier
	**/
	public var identifier : Dynamic;
	/**
		Field tensorflow.SavedUserObject.metadata
	**/
	public var metadata : Dynamic;
	/**
		Field tensorflow.SavedUserObject.version
	**/
