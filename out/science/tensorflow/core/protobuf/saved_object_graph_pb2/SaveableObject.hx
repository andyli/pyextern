...
@:pythonImport("tensorflow.core.protobuf.saved_object_graph_pb2", "SaveableObject") extern class SaveableObject {
	/**
	...
	**/
	...
	/**
		Field tensorflow.SaveableObject.restore_function
	**/
	public var restore_function : Dynamic;
	/**
		Field tensorflow.SaveableObject.save_function
	**/
	public var save_function : Dynamic;
}