...
@:pythonImport("tensorflow.core.protobuf.saved_object_graph_pb2", "FunctionSpec") extern class FunctionSpec {
	/**
	...
	**/
	...
	static public var JitCompile : Dynamic;
	/**
	...
	**/
	...
	/**
		Field tensorflow.FunctionSpec.fullargspec
	**/
	public var fullargspec : Dynamic;
	/**
		Field tensorflow.FunctionSpec.input_signature
	**/
	public var input_signature : Dynamic;
	/**
		Field tensorflow.FunctionSpec.is_method
	**/
	public var is_method : Dynamic;
	/**
		Field tensorflow.FunctionSpec.jit_compile
	**/
