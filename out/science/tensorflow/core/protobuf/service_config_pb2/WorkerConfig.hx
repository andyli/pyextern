...
package tensorflow.core.protobuf.service_config_pb2;
@:pythonImport("tensorflow.core.protobuf.service_config_pb2", "WorkerConfig") extern class WorkerConfig {
	/**
	...
	**/
	...
	/**
		Field tensorflow.data.experimental.WorkerConfig.data_transfer_address
	**/
	public var data_transfer_address : Dynamic;
	/**
		Field tensorflow.data.experimental.WorkerConfig.data_transfer_protocol
	**/
	public var data_transfer_protocol : Dynamic;
	/**
		Field tensorflow.data.experimental.WorkerConfig.dispatcher_address
	**/
	public var dispatcher_address : Dynamic;
	/**
		Field tensorflow.data.experimental.WorkerConfig.dispatcher_timeout_ms
	**/
	public var dispatcher_timeout_ms : Dynamic;
	/**
		Field tensorflow.data.experimental.WorkerConfig.heartbeat_interval_ms
	**/
	public var heartbeat_interval_ms : Dynamic;
	/**
		Field tensorflow.data.experimental.WorkerConfig.port
	**/
	public var port : Dynamic;
	/**
		Field tensorflow.data.experimental.WorkerConfig.protocol
	**/
	public var protocol : Dynamic;
	/**
		Field tensorflow.data.experimental.WorkerConfig.shutdown_quiet_period_ms
	**/
	public var shutdown_quiet_period_ms : Dynamic;
	/**
		Field tensorflow.data.experimental.WorkerConfig.worker_address
	**/
	public var worker_address : Dynamic;
	/**
		Field tensorflow.data.experimental.WorkerConfig.worker_tags
	**/
	public var worker_tags : Dynamic;
}