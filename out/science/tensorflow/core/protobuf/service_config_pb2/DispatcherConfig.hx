...
@:pythonImport("tensorflow.core.protobuf.service_config_pb2", "DispatcherConfig") extern class DispatcherConfig {
	/**
	...
	**/
	...
	/**
		Field tensorflow.data.experimental.DispatcherConfig.client_timeout_ms
	**/
	public var client_timeout_ms : Dynamic;
	/**
		Field tensorflow.data.experimental.DispatcherConfig.fault_tolerant_mode
	**/
	public var fault_tolerant_mode : Dynamic;
	/**
		Field tensorflow.data.experimental.DispatcherConfig.job_gc_check_interval_ms
	**/
	public var job_gc_check_interval_ms : Dynamic;
	/**
		Field tensorflow.data.experimental.DispatcherConfig.job_gc_timeout_ms
	**/
	public var job_gc_timeout_ms : Dynamic;
	/**
		Field tensorflow.data.experimental.DispatcherConfig.port
	**/
	public var port : Dynamic;
	/**
		Field tensorflow.data.experimental.DispatcherConfig.protocol
	**/
	public var protocol : Dynamic;
	/**
		Field tensorflow.data.experimental.DispatcherConfig.work_dir
	**/
	public var work_dir : Dynamic;
	/**
		Field tensorflow.data.experimental.DispatcherConfig.worker_addresses
	**/
