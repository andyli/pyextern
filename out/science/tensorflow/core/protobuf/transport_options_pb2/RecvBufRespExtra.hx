...
@:pythonImport("tensorflow.core.protobuf.transport_options_pb2", "RecvBufRespExtra") extern class RecvBufRespExtra {
	/**
	...
	**/
	...
	/**
		Field tensorflow.RecvBufRespExtra.tensor_content
	**/
