...
package tensorflow.core.protobuf.snapshot_pb2;
@:pythonImport("tensorflow.core.protobuf.snapshot_pb2", "SnapshotMetadataRecord") extern class SnapshotMetadataRecord {
	/**
	...
	**/
	...
	/**
		Field tensorflow.data.experimental.SnapshotMetadataRecord.creation_timestamp
	**/
	public var creation_timestamp : Dynamic;
	/**
		Field tensorflow.data.experimental.SnapshotMetadataRecord.dtype
	**/
	public var dtype : Dynamic;
	/**
		Field tensorflow.data.experimental.SnapshotMetadataRecord.finalized
	**/
	public var finalized : Dynamic;
	/**
		Field tensorflow.data.experimental.SnapshotMetadataRecord.graph_hash
	**/
	public var graph_hash : Dynamic;
	/**
		Field tensorflow.data.experimental.SnapshotMetadataRecord.num_elements
	**/
	public var num_elements : Dynamic;
	/**
		Field tensorflow.data.experimental.SnapshotMetadataRecord.run_id
	**/
	public var run_id : Dynamic;
	/**
		Field tensorflow.data.experimental.SnapshotMetadataRecord.version
	**/
