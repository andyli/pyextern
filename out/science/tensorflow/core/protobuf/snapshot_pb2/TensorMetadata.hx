...
@:pythonImport("tensorflow.core.protobuf.snapshot_pb2", "TensorMetadata") extern class TensorMetadata {
	/**
	...
	**/
	...
	/**
		Field tensorflow.data.experimental.TensorMetadata.tensor_shape
	**/
	public var tensor_shape : Dynamic;
	/**
		Field tensorflow.data.experimental.TensorMetadata.tensor_size_bytes
	**/
	public var tensor_size_bytes : Dynamic;
}