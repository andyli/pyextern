...
@:pythonImport("tensorflow.core.protobuf.snapshot_pb2", "SnapshotTensorMetadata") extern class SnapshotTensorMetadata {
	/**
	...
	**/
	...
	/**
		Field tensorflow.data.experimental.SnapshotTensorMetadata.tensor_metadata
	**/
	public var tensor_metadata : Dynamic;
}