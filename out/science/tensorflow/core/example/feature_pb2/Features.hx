...
@:pythonImport("tensorflow.core.example.feature_pb2", "Features") extern class Features {
	/**
	...
	**/
	...
	/**
		A ProtocolMessage
	**/
	public function FeatureEntry(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	...
	/**
		Field tensorflow.Features.feature
	**/
