...
package tensorflow.core.util.memmapped_file_system_pb2;
@:pythonImport("tensorflow.core.util.memmapped_file_system_pb2", "MemmappedFileSystemDirectoryElement") extern class MemmappedFileSystemDirectoryElement {
	/**
	...
	**/
	...
	/**
		Field tensorflow.MemmappedFileSystemDirectoryElement.length
	**/
	public var length : Dynamic;
	/**
		Field tensorflow.MemmappedFileSystemDirectoryElement.name
	**/
	public var name : Dynamic;
	/**
		Field tensorflow.MemmappedFileSystemDirectoryElement.offset
	**/
