...
@:pythonImport("tensorflow.core.util.event_pb2", "WorkerHeartbeatRequest") extern class WorkerHeartbeatRequest {
	/**
	...
	**/
	...
	/**
		Field tensorflow.WorkerHeartbeatRequest.exit_code
	**/
	public var exit_code : Dynamic;
	/**
		Field tensorflow.WorkerHeartbeatRequest.shutdown_mode
	**/
	public var shutdown_mode : Dynamic;
	/**
		Field tensorflow.WorkerHeartbeatRequest.watchdog_config
	**/
	public var watchdog_config : Dynamic;
}