...
@:pythonImport("tensorflow.core.util.event_pb2", "WatchdogConfig") extern class WatchdogConfig {
	/**
	...
	**/
	...
	/**
		Field tensorflow.WatchdogConfig.timeout_ms
	**/
	public var timeout_ms : Dynamic;
}