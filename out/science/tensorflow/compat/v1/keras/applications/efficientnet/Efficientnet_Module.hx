...
package tensorflow.compat.v1.keras.applications.efficientnet;
@:pythonImport("tensorflow.compat.v1.keras.applications.efficientnet") extern class Efficientnet_Module {
	/**
