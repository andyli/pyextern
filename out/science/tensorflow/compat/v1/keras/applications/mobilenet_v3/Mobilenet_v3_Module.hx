...
package tensorflow.compat.v1.keras.applications.mobilenet_v3;
@:pythonImport("tensorflow.compat.v1.keras.applications.mobilenet_v3") extern class Mobilenet_v3_Module {
