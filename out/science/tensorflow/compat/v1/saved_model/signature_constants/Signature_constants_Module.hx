...
package tensorflow.compat.v1.saved_model.signature_constants;
@:pythonImport("tensorflow.compat.v1.saved_model.signature_constants") extern class Signature_constants_Module {
