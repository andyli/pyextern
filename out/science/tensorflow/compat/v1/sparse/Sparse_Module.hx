...
@:pythonImport("tensorflow.compat.v1.sparse") extern class Sparse_Module {
	...
	**/
	static public function concat(axis:Dynamic, sp_inputs:Dynamic, ?name:Dynamic, ?expand_nonconcat_dim:Dynamic, ?concat_dim:Dynamic, ?expand_nonconcat_dims:Dynamic):Dynamic;
	/**
