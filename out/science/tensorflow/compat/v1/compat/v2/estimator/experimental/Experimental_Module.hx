...
package tensorflow.compat.v1.compat.v2.estimator.experimental;
@:pythonImport("tensorflow.compat.v1.compat.v2.estimator.experimental") extern class Experimental_Module {
