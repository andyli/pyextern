...
package tensorflow.compat.v1.compat.v2.keras.applications.resnet;
@:pythonImport("tensorflow.compat.v1.compat.v2.keras.applications.resnet") extern class Resnet_Module {
	/**
