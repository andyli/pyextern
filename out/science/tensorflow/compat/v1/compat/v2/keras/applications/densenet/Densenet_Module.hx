...
package tensorflow.compat.v1.compat.v2.keras.applications.densenet;
@:pythonImport("tensorflow.compat.v1.compat.v2.keras.applications.densenet") extern class Densenet_Module {
	/**
