...
package tensorflow.compat.v1.compat.v2.keras.applications.xception;
@:pythonImport("tensorflow.compat.v1.compat.v2.keras.applications.xception") extern class Xception_Module {
	/**
