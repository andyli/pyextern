...
package tensorflow.compat.v1.compat.v2.keras.datasets.reuters;
@:pythonImport("tensorflow.compat.v1.compat.v2.keras.datasets.reuters") extern class Reuters_Module {
