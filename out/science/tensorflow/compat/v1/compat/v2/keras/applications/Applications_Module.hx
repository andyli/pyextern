...
package tensorflow.compat.v1.compat.v2.keras.applications;
@:pythonImport("tensorflow.compat.v1.compat.v2.keras.applications") extern class Applications_Module {
	/**
