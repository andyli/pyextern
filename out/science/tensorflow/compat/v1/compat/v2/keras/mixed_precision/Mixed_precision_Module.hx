...
package tensorflow.compat.v1.compat.v2.keras.mixed_precision;
@:pythonImport("tensorflow.compat.v1.compat.v2.keras.mixed_precision") extern class Mixed_precision_Module {
