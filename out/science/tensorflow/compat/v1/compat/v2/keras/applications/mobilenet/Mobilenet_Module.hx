...
package tensorflow.compat.v1.compat.v2.keras.applications.mobilenet;
@:pythonImport("tensorflow.compat.v1.compat.v2.keras.applications.mobilenet") extern class Mobilenet_Module {
	/**
