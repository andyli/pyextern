...
package tensorflow.compat.v1.compat.v2.keras.regularizers;
@:pythonImport("tensorflow.compat.v1.compat.v2.keras.regularizers") extern class Regularizers_Module {
