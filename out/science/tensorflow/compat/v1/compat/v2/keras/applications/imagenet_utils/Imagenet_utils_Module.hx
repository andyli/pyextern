...
package tensorflow.compat.v1.compat.v2.keras.applications.imagenet_utils;
@:pythonImport("tensorflow.compat.v1.compat.v2.keras.applications.imagenet_utils") extern class Imagenet_utils_Module {
