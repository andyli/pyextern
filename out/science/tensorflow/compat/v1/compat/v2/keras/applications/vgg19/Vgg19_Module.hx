...
package tensorflow.compat.v1.compat.v2.keras.applications.vgg19;
@:pythonImport("tensorflow.compat.v1.compat.v2.keras.applications.vgg19") extern class Vgg19_Module {
	/**
