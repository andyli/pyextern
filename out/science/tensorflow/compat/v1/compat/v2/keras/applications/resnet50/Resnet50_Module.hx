...
package tensorflow.compat.v1.compat.v2.keras.applications.resnet50;
@:pythonImport("tensorflow.compat.v1.compat.v2.keras.applications.resnet50") extern class Resnet50_Module {
	/**
