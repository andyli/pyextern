...
package tensorflow.compat.v1.compat.v1.layers.experimental;
@:pythonImport("tensorflow.compat.v1.compat.v1.layers.experimental") extern class Experimental_Module {
