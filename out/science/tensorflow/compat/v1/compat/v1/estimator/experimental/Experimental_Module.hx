...
package tensorflow.compat.v1.compat.v1.estimator.experimental;
@:pythonImport("tensorflow.compat.v1.compat.v1.estimator.experimental") extern class Experimental_Module {
