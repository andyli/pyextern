...
package tensorflow.compat.v1.compat.v1.keras.preprocessing.image;
@:pythonImport("tensorflow.compat.v1.compat.v1.keras.preprocessing.image") extern class Image_Module {
