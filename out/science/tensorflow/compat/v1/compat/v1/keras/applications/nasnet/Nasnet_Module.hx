...
package tensorflow.compat.v1.compat.v1.keras.applications.nasnet;
@:pythonImport("tensorflow.compat.v1.compat.v1.keras.applications.nasnet") extern class Nasnet_Module {
	/**
