...
package tensorflow.compat.v1.compat.v1.keras.preprocessing.sequence;
@:pythonImport("tensorflow.compat.v1.compat.v1.keras.preprocessing.sequence") extern class Sequence_Module {
