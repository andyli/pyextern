...
package tensorflow.compat.v1.compat.v1.keras.applications.vgg16;
@:pythonImport("tensorflow.compat.v1.compat.v1.keras.applications.vgg16") extern class Vgg16_Module {
	/**
