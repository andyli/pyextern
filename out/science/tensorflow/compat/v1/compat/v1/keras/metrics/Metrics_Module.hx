...
package tensorflow.compat.v1.compat.v1.keras.metrics;
@:pythonImport("tensorflow.compat.v1.compat.v1.keras.metrics") extern class Metrics_Module {
	/**
	...
	**/
	static public function cosine(y_true:Dynamic, y_pred:Dynamic, ?axis:Dynamic):Dynamic;
	/**
		Computes the cosine similarity between labels and predictions.
