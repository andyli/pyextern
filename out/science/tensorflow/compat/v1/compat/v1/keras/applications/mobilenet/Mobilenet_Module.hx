...
package tensorflow.compat.v1.compat.v1.keras.applications.mobilenet;
@:pythonImport("tensorflow.compat.v1.compat.v1.keras.applications.mobilenet") extern class Mobilenet_Module {
	/**
