...
package tensorflow.compat.v1.compat.v1.keras.applications.resnet;
@:pythonImport("tensorflow.compat.v1.compat.v1.keras.applications.resnet") extern class Resnet_Module {
	/**
