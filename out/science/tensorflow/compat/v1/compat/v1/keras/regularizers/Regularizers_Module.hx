...
package tensorflow.compat.v1.compat.v1.keras.regularizers;
@:pythonImport("tensorflow.compat.v1.compat.v1.keras.regularizers") extern class Regularizers_Module {
