...
package tensorflow.compat.v1.compat.v1.keras.applications.mobilenet_v2;
@:pythonImport("tensorflow.compat.v1.compat.v1.keras.applications.mobilenet_v2") extern class Mobilenet_v2_Module {
	/**
