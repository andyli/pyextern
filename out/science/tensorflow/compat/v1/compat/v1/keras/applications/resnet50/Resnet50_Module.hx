...
package tensorflow.compat.v1.compat.v1.keras.applications.resnet50;
@:pythonImport("tensorflow.compat.v1.compat.v1.keras.applications.resnet50") extern class Resnet50_Module {
	/**
