...
package tensorflow.compat.v1.compat.v1.keras.preprocessing.text;
@:pythonImport("tensorflow.compat.v1.compat.v1.keras.preprocessing.text") extern class Text_Module {
