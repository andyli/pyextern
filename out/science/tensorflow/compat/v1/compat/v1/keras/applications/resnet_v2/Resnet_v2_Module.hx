...
package tensorflow.compat.v1.compat.v1.keras.applications.resnet_v2;
@:pythonImport("tensorflow.compat.v1.compat.v1.keras.applications.resnet_v2") extern class Resnet_v2_Module {
	/**
