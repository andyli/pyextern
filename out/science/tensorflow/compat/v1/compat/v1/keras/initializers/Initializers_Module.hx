...
package tensorflow.compat.v1.compat.v1.keras.initializers;
@:pythonImport("tensorflow.compat.v1.compat.v1.keras.initializers") extern class Initializers_Module {
