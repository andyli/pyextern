...
package tensorflow.compat.v2.feature_column;
@:pythonImport("tensorflow.compat.v2.feature_column") extern class Feature_column_Module {
	...
	**/
	...
	/**
		...
		Raises:
		  ...
		  ValueError: `dtype` is neither string nor integer.
	**/
	static public function categorical_column_with_vocabulary_file(key:Dynamic, vocabulary_file:Dynamic, ?vocabulary_size:Dynamic, ?dtype:Dynamic, ?default_value:Dynamic, ?num_oov_buckets:Dynamic, ?file_format:Dynamic):Dynamic;
	/**
	...
	**/
	...
	/**
		...
		Raises:
		  ...
		  RuntimeError: if eager execution is enabled.
	**/
	static public function shared_embeddings(categorical_columns:Dynamic, dimension:Dynamic, ?combiner:Dynamic, ?initializer:Dynamic, ?shared_embedding_collection_name:Dynamic, ?ckpt_to_load_from:Dynamic, ?tensor_name_in_ckpt:Dynamic, ?max_norm:Dynamic, ?trainable:Dynamic, ?use_safe_embedding_lookup:Dynamic):Dynamic;
	/**
