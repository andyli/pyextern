...
package tensorflow.compat.v2.strings;
@:pythonImport("tensorflow.compat.v2.strings") extern class Strings_Module {
	...
	**/
	static public function length(input:Dynamic, ?unit:Dynamic, ?name:Dynamic):Dynamic;
	/**
	...
	**/
	...
	/**
		...
		Returns:
		  ...
		  delimiter.
	**/
	static public function split(input:Dynamic, ?sep:Dynamic, ?maxsplit:Dynamic, ?name:Dynamic):Dynamic;
	/**
	...
	**/
	static public function to_hash_bucket(input:Dynamic, num_buckets:Dynamic, ?name:Dynamic):Dynamic;
	/**
		Converts each string in the input Tensor to its hash mod by a number of buckets.
	...
	**/
	static public function to_number(input:Dynamic, ?out_type:Dynamic, ?name:Dynamic):Dynamic;
	/**
