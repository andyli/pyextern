...
package tensorflow.compat.v2.compat.v2.estimator.experimental;
@:pythonImport("tensorflow.compat.v2.compat.v2.estimator.experimental") extern class Experimental_Module {
