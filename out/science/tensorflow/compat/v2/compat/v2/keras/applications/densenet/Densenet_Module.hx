...
package tensorflow.compat.v2.compat.v2.keras.applications.densenet;
@:pythonImport("tensorflow.compat.v2.compat.v2.keras.applications.densenet") extern class Densenet_Module {
	/**
