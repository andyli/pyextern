...
package tensorflow.compat.v2.compat.v2.keras.initializers;
@:pythonImport("tensorflow.compat.v2.compat.v2.keras.initializers") extern class Initializers_Module {
