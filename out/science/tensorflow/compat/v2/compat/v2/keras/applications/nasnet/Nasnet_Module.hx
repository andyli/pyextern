...
package tensorflow.compat.v2.compat.v2.keras.applications.nasnet;
@:pythonImport("tensorflow.compat.v2.compat.v2.keras.applications.nasnet") extern class Nasnet_Module {
	/**
