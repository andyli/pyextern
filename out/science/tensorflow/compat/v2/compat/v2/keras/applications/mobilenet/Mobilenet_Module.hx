...
package tensorflow.compat.v2.compat.v2.keras.applications.mobilenet;
@:pythonImport("tensorflow.compat.v2.compat.v2.keras.applications.mobilenet") extern class Mobilenet_Module {
	/**
