...
package tensorflow.compat.v2.compat.v2.keras.preprocessing;
@:pythonImport("tensorflow.compat.v2.compat.v2.keras.preprocessing") extern class Preprocessing_Module {
