...
package tensorflow.compat.v2.compat.v2.keras.applications;
@:pythonImport("tensorflow.compat.v2.compat.v2.keras.applications") extern class Applications_Module {
	/**
