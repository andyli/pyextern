...
package tensorflow.compat.v2.compat.v2.keras.mixed_precision;
@:pythonImport("tensorflow.compat.v2.compat.v2.keras.mixed_precision") extern class Mixed_precision_Module {
