...
package tensorflow.compat.v2.compat.v2.keras.applications.inception_resnet_v2;
@:pythonImport("tensorflow.compat.v2.compat.v2.keras.applications.inception_resnet_v2") extern class Inception_resnet_v2_Module {
	/**
