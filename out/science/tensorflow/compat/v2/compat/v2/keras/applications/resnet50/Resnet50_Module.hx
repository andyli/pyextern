...
package tensorflow.compat.v2.compat.v2.keras.applications.resnet50;
@:pythonImport("tensorflow.compat.v2.compat.v2.keras.applications.resnet50") extern class Resnet50_Module {
	/**
