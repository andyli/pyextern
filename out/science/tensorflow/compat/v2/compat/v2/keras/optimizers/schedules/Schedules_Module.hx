...
package tensorflow.compat.v2.compat.v2.keras.optimizers.schedules;
@:pythonImport("tensorflow.compat.v2.compat.v2.keras.optimizers.schedules") extern class Schedules_Module {
