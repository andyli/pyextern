...
package tensorflow.compat.v2.compat.v1.keras.applications.efficientnet;
@:pythonImport("tensorflow.compat.v2.compat.v1.keras.applications.efficientnet") extern class Efficientnet_Module {
	/**
