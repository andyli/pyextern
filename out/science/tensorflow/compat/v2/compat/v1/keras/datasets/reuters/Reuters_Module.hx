...
package tensorflow.compat.v2.compat.v1.keras.datasets.reuters;
@:pythonImport("tensorflow.compat.v2.compat.v1.keras.datasets.reuters") extern class Reuters_Module {
