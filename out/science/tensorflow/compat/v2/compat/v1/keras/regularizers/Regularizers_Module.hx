...
package tensorflow.compat.v2.compat.v1.keras.regularizers;
@:pythonImport("tensorflow.compat.v2.compat.v1.keras.regularizers") extern class Regularizers_Module {
