...
package tensorflow.compat.v2.compat.v1.keras.optimizers.schedules;
@:pythonImport("tensorflow.compat.v2.compat.v1.keras.optimizers.schedules") extern class Schedules_Module {
