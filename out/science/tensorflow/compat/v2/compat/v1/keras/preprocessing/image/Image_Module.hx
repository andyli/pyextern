...
package tensorflow.compat.v2.compat.v1.keras.preprocessing.image;
@:pythonImport("tensorflow.compat.v2.compat.v1.keras.preprocessing.image") extern class Image_Module {
