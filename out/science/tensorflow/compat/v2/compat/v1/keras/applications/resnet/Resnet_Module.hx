...
package tensorflow.compat.v2.compat.v1.keras.applications.resnet;
@:pythonImport("tensorflow.compat.v2.compat.v1.keras.applications.resnet") extern class Resnet_Module {
	/**
