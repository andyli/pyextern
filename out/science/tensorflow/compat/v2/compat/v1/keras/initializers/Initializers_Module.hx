...
package tensorflow.compat.v2.compat.v1.keras.initializers;
@:pythonImport("tensorflow.compat.v2.compat.v1.keras.initializers") extern class Initializers_Module {
