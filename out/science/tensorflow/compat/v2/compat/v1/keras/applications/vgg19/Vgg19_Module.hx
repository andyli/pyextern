...
package tensorflow.compat.v2.compat.v1.keras.applications.vgg19;
@:pythonImport("tensorflow.compat.v2.compat.v1.keras.applications.vgg19") extern class Vgg19_Module {
	/**
