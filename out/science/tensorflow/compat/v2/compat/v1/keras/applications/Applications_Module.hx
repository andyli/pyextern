...
package tensorflow.compat.v2.compat.v1.keras.applications;
@:pythonImport("tensorflow.compat.v2.compat.v1.keras.applications") extern class Applications_Module {
	/**
