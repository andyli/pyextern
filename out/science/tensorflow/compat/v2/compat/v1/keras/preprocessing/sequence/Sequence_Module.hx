...
package tensorflow.compat.v2.compat.v1.keras.preprocessing.sequence;
@:pythonImport("tensorflow.compat.v2.compat.v1.keras.preprocessing.sequence") extern class Sequence_Module {
