...
package tensorflow.compat.v2.compat.v1.layers.experimental;
@:pythonImport("tensorflow.compat.v2.compat.v1.layers.experimental") extern class Experimental_Module {
