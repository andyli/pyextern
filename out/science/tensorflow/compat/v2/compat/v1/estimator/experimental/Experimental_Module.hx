...
package tensorflow.compat.v2.compat.v1.estimator.experimental;
@:pythonImport("tensorflow.compat.v2.compat.v1.estimator.experimental") extern class Experimental_Module {
