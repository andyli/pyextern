...
package tensorflow.compat.v2.keras.applications.mobilenet_v3;
@:pythonImport("tensorflow.compat.v2.keras.applications.mobilenet_v3") extern class Mobilenet_v3_Module {
