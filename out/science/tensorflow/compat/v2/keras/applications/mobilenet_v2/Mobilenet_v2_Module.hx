...
package tensorflow.compat.v2.keras.applications.mobilenet_v2;
@:pythonImport("tensorflow.compat.v2.keras.applications.mobilenet_v2") extern class Mobilenet_v2_Module {
	/**
