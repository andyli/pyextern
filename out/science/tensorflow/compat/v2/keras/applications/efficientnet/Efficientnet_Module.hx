...
package tensorflow.compat.v2.keras.applications.efficientnet;
@:pythonImport("tensorflow.compat.v2.keras.applications.efficientnet") extern class Efficientnet_Module {
	/**
