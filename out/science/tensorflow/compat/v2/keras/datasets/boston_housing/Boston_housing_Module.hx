...
package tensorflow.compat.v2.keras.datasets.boston_housing;
@:pythonImport("tensorflow.compat.v2.keras.datasets.boston_housing") extern class Boston_housing_Module {
