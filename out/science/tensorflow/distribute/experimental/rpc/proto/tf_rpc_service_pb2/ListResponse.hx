...
@:pythonImport("tensorflow.distribute.experimental.rpc.proto.tf_rpc_service_pb2", "ListResponse") extern class ListResponse {
	/**
	...
	**/
	...
	/**
		Field tensorflow.rpc.ListResponse.registered_methods
	**/
	public var registered_methods : Dynamic;
}