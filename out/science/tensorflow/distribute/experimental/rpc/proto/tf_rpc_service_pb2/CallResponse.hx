...
@:pythonImport("tensorflow.distribute.experimental.rpc.proto.tf_rpc_service_pb2", "CallResponse") extern class CallResponse {
	/**
	...
	**/
	...
	/**
		Field tensorflow.rpc.CallResponse.output_tensors
	**/
