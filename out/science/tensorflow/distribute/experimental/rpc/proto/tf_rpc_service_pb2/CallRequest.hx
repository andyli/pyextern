...
@:pythonImport("tensorflow.distribute.experimental.rpc.proto.tf_rpc_service_pb2", "CallRequest") extern class CallRequest {
	/**
	...
	**/
	...
	/**
		Field tensorflow.rpc.CallRequest.input_tensors
	**/
	public var input_tensors : Dynamic;
	/**
		Field tensorflow.rpc.CallRequest.method
	**/
