...
package tensorflow.distribute.experimental.rpc.proto.tf_rpc_service_pb2;
@:pythonImport("tensorflow.distribute.experimental.rpc.proto.tf_rpc_service_pb2", "RegisteredMethod") extern class RegisteredMethod {
	/**
	...
	**/
	...
	/**
		Field tensorflow.rpc.RegisteredMethod.input_specs
	**/
	public var input_specs : Dynamic;
	/**
		Field tensorflow.rpc.RegisteredMethod.method
	**/
	public var method : Dynamic;
	/**
		Field tensorflow.rpc.RegisteredMethod.output_specs
	**/
	public var output_specs : Dynamic;
}