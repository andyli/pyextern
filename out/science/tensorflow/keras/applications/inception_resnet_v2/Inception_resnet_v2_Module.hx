...
package tensorflow.keras.applications.inception_resnet_v2;
@:pythonImport("tensorflow.keras.applications.inception_resnet_v2") extern class Inception_resnet_v2_Module {
	/**
