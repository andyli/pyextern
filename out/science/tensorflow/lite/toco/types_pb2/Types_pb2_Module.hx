...
package tensorflow.lite.toco.types_pb2;
@:pythonImport("tensorflow.lite.toco.types_pb2") extern class Types_pb2_Module {
	...
	static public var QUANTIZED_INT8 : Dynamic;
