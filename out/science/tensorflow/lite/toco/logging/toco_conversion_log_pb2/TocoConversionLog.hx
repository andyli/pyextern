...
package tensorflow.lite.toco.logging.toco_conversion_log_pb2;
@:pythonImport("tensorflow.lite.toco.logging.toco_conversion_log_pb2", "TocoConversionLog") extern class TocoConversionLog {
	/**
		A ProtocolMessage
	**/
	public function BuiltInOpsEntry(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	...
	/**
		A ProtocolMessage
	**/
	public function CustomOpsEntry(args:haxe.extern.Rest<Dynamic>):Dynamic;
	...
	**/
	...
	/**
		A ProtocolMessage
	**/
	public function SelectOpsEntry(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	...
	/**
		Field toco.TocoConversionLog.built_in_ops
	**/
	public var built_in_ops : Dynamic;
	/**
		Field toco.TocoConversionLog.custom_ops
	**/
	public var custom_ops : Dynamic;
	/**
		Field toco.TocoConversionLog.input_tensor_types
	**/
	public var input_tensor_types : Dynamic;
	/**
		Field toco.TocoConversionLog.log_generation_ts
	**/
	public var log_generation_ts : Dynamic;
	/**
		Field toco.TocoConversionLog.model_hash
	**/
	public var model_hash : Dynamic;
	/**
		Field toco.TocoConversionLog.model_size
	**/
	public var model_size : Dynamic;
	/**
		Field toco.TocoConversionLog.op_list
	**/
	public var op_list : Dynamic;
	/**
		Field toco.TocoConversionLog.op_signatures
	**/
	public var op_signatures : Dynamic;
	/**
		Field toco.TocoConversionLog.os_version
	**/
	public var os_version : Dynamic;
	/**
		Field toco.TocoConversionLog.output_tensor_types
	**/
	public var output_tensor_types : Dynamic;
	/**
		Field toco.TocoConversionLog.select_ops
	**/
	public var select_ops : Dynamic;
	/**
		Field toco.TocoConversionLog.tf_lite_version
	**/
	public var tf_lite_version : Dynamic;
	/**
		Field toco.TocoConversionLog.toco_err_logs
	**/
	public var toco_err_logs : Dynamic;
}