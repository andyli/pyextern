...
@:pythonImport("tensorflow.lite.toco.model_flags_pb2", "InputArrayShape") extern class InputArrayShape {
	/**
	...
	**/
	...
	/**
		Field toco.InputArrayShape.dims
	**/
	public var dims : Dynamic;
	/**
		Field toco.InputArrayShape.unknown_rank
	**/
