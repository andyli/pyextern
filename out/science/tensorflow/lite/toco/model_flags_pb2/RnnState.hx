...
@:pythonImport("tensorflow.lite.toco.model_flags_pb2", "RnnState") extern class RnnState {
	/**
	...
	**/
	...
	/**
		Field toco.RnnState.back_edge_source_array
	**/
	public var back_edge_source_array : Dynamic;
	/**
		Field toco.RnnState.discardable
	**/
	public var discardable : Dynamic;
	/**
		Field toco.RnnState.num_dims
	**/
	public var num_dims : Dynamic;
	/**
		Field toco.RnnState.size
	**/
	public var size : Dynamic;
	/**
		Field toco.RnnState.state_array
	**/
	public var state_array : Dynamic;
}