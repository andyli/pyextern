...
package tensorflow.lite.python.metrics_wrapper.converter_error_data_pb2;
@:pythonImport("tensorflow.lite.python.metrics_wrapper.converter_error_data_pb2", "ConverterErrorData") extern class ConverterErrorData {
	/**
		Returns the size of the message in bytes.
	**/
	public function ByteSize(args:haxe.extern.Rest<Dynamic>):Dynamic;
	static public var CALLSITELOC : Dynamic;
	/**
		Clears the message.
	**/
	...
	**/
	...
	static public var ERROR_GPU_NOT_COMPATIBLE : Dynamic;
	static public var ERROR_NEEDS_CUSTOM_OPS : Dynamic;
	static public var ERROR_NEEDS_FLEX_OPS : Dynamic;
	static public var ERROR_UNSUPPORTED_CONTROL_FLOW_V1 : Dynamic;
	static public var ErrorCode : Dynamic;
	/**
		Extension dict
	**/
	public var Extensions : Dynamic;
	static public var FUSEDLOC : Dynamic;
	/**
		A ProtocolMessage
	**/
	public function FileLoc(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	...
	static public var LocationType : Dynamic;
	/**
	...
	**/
	...
	static public var NAMELOC : Dynamic;
	/**
		A ProtocolMessage
	**/
	public function Operator(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	...
	/**
		A ProtocolMessage
	**/
	public function SourceLoc(args:haxe.extern.Rest<Dynamic>):Dynamic;
	static public var UNKNOWN : Dynamic;
	static public var UNKNOWNLOC : Dynamic;
	/**
	...
	**/
	...
	/**
		Field tflite.metrics.ConverterErrorData.component
	**/
	public var component : Dynamic;
	/**
		Field tflite.metrics.ConverterErrorData.error_code
	**/
	public var error_code : Dynamic;
	/**
		Field tflite.metrics.ConverterErrorData.error_message
	**/
	public var error_message : Dynamic;
	/**
		Field tflite.metrics.ConverterErrorData.location
	**/
	public var location : Dynamic;
	/**
		Field tflite.metrics.ConverterErrorData.operator
	**/
	@:native("operator")
	public var _operator : Dynamic;
	/**
		Field tflite.metrics.ConverterErrorData.subcomponent
	**/
	public var subcomponent : Dynamic;
}