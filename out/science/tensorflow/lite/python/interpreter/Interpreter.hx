...
@:pythonImport("tensorflow.lite.python.interpreter", "Interpreter") extern class Interpreter {
	...
	**/
	@:native("__init__")
	public function ___init__(?model_path:Dynamic, ?model_content:Dynamic, ?experimental_delegates:Dynamic, ?num_threads:Dynamic, ?experimental_op_resolver_type:Dynamic, ?experimental_preserve_all_tensors:Dynamic):Dynamic;
	/**
		Constructor.
		...
		Raises:
		  ValueError: If the interpreter was unable to create.
	**/
	public function new(?model_path:Dynamic, ?model_content:Dynamic, ?experimental_delegates:Dynamic, ?num_threads:Dynamic, ?experimental_op_resolver_type:Dynamic, ?experimental_preserve_all_tensors:Dynamic):Void;
	/**
