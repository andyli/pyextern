...
package tensorflow.lite.python.analyzer;
@:pythonImport("tensorflow.lite.python.analyzer", "ModelAnalyzer") extern class ModelAnalyzer {
	...
	**/
	static public function analyze(?model_path:Dynamic, ?model_content:Dynamic, ?gpu_compatibility:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
}