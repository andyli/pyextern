...
package tensorflow.lite.python.convert_phase;
@:pythonImport("tensorflow.lite.python.convert_phase", "SubComponentItem") extern class SubComponentItem {
	/**
		Return self+value.
	**/
	...
	**/
	...
	/**
		Create new instance of SubComponentItem(name, component)
	**/
	static public function __new__(_cls:Dynamic, name:Dynamic, component:Dynamic):Dynamic;
	/**
		Helper for pickle.
	**/
	...
	**/
	...
	/**
		Make a new SubComponentItem object from a sequence or iterable
	**/
	static public function _make(iterable:Dynamic):Dynamic;
	/**
		Return a new SubComponentItem object replacing specified fields with new values
	**/
