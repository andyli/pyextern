...
@:pythonImport("tensorflow.lite.python.convert_phase", "ConverterError") extern class ConverterError {
	/**
		exception cause
	**/
	...
	**/
	...
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(message:Dynamic):Void;
	/**
	...
	**/
	public function _parse_error_message(message:Dynamic):Dynamic;
	public function append_error(error_data:Dynamic):Dynamic;
