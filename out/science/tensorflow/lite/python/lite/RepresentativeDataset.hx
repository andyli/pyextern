...
@:pythonImport("tensorflow.lite.python.lite", "RepresentativeDataset") extern class RepresentativeDataset {
	...
	**/
	@:native("__init__")
	public function ___init__(input_gen:Dynamic):Dynamic;
	/**
		Creates a representative dataset.
		...
		Args:
		  input_gen: A generator function that generates input samples for the
		    ...
		    chosen, in no particular order, from the training or evaluation dataset.
	**/
	public function new(input_gen:Dynamic):Void;
	/**
