...
@:pythonImport("tensorflow.lite.python.lite", "TFLiteSavedModelConverter") extern class TFLiteSavedModelConverter {
	...
	**/
	@:native("__init__")
	public function ___init__(saved_model_dir:Dynamic, saved_model_tags:Dynamic, saved_model_exported_names:Dynamic, ?experimental_debug_info_func:Dynamic):Dynamic;
	/**
		Constructor for TFLiteConverter.
		...
		Raises:
		  ValueError: Invalid arguments.
	**/
	public function new(saved_model_dir:Dynamic, saved_model_tags:Dynamic, saved_model_exported_names:Dynamic, ?experimental_debug_info_func:Dynamic):Void;
	/**
