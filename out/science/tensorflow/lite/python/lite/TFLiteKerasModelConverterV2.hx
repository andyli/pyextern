...
@:pythonImport("tensorflow.lite.python.lite", "TFLiteKerasModelConverterV2") extern class TFLiteKerasModelConverterV2 {
	...
	**/
	@:native("__init__")
	public function ___init__(keras_model:Dynamic, ?trackable_obj:Dynamic):Dynamic;
	/**
		Constructor for TFLiteConverter.
		...
		Args:
		  ...
		  trackable_obj: tf.AutoTrackable object associated with `funcs`. A
		    ...
		    maintained by the user (e.g. `from_saved_model`).
	**/
	public function new(keras_model:Dynamic, ?trackable_obj:Dynamic):Void;
	/**
	...
	**/
	public function _convert_keras_to_saved_model(output_dir:Dynamic):Dynamic;
	/**
	...
	**/
	public function _freeze_keras_model():Dynamic;
	/**
