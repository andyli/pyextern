...
@:pythonImport("tensorflow.lite.python.lite", "TFLiteSavedModelConverterV2") extern class TFLiteSavedModelConverterV2 {
	...
	**/
	@:native("__init__")
	public function ___init__(saved_model_dir:Dynamic, ?saved_model_tags:Dynamic, ?saved_model_exported_names:Dynamic, ?trackable_obj:Dynamic):Dynamic;
	/**
		Constructor for TFLiteConverter.
		...
		Args:
		  ...
		  trackable_obj: tf.AutoTrackable object associated with `funcs`. A
		    ...
		    maintained by the user (e.g. `from_saved_model`).
	**/
	public function new(saved_model_dir:Dynamic, ?saved_model_tags:Dynamic, ?saved_model_exported_names:Dynamic, ?trackable_obj:Dynamic):Void;
	/**
