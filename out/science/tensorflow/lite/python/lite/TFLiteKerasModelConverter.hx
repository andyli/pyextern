...
@:pythonImport("tensorflow.lite.python.lite", "TFLiteKerasModelConverter") extern class TFLiteKerasModelConverter {
	...
	**/
	@:native("__init__")
	public function ___init__(model_file:Dynamic, ?input_arrays:Dynamic, ?input_shapes:Dynamic, ?output_arrays:Dynamic, ?custom_objects:Dynamic):Dynamic;
	/**
		Constructor for TFLiteConverter.
		...
		Raises:
		  ValueError: Invalid arguments.
	**/
	public function new(model_file:Dynamic, ?input_arrays:Dynamic, ?input_shapes:Dynamic, ?output_arrays:Dynamic, ?custom_objects:Dynamic):Void;
	/**
	...
	**/
	public function _freeze_keras_model(output_dir:Dynamic):Dynamic;
	/**
