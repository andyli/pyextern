...
@:pythonImport("tensorflow.lite.python.lite", "TFLiteConverterV2") extern class TFLiteConverterV2 {
	...
	**/
	static public function experimental_from_jax(serving_funcs:Dynamic, inputs:Dynamic):Dynamic;
	/**
		...
		Raises:
		  Invalid input type.
	**/
	static public function from_concrete_functions(funcs:Dynamic, ?trackable_obj:Dynamic):Dynamic;
	/**
		...
		Returns:
		  TFLiteConverter object.
	**/
	static public function from_keras_model(model:Dynamic):Dynamic;
	/**
	...
	**/
	static public function from_saved_model(saved_model_dir:Dynamic, ?signature_keys:Dynamic, ?tags:Dynamic):Dynamic;
}