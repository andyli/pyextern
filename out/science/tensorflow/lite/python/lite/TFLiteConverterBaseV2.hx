...
@:pythonImport("tensorflow.lite.python.lite", "TFLiteConverterBaseV2") extern class TFLiteConverterBaseV2 {
	...
	/**
		...
		Raises:
		  ValueError:
		    ...
		    Invalid quantization parameters.
	**/
	public function convert(graph_def:Dynamic, input_tensors:Dynamic, output_tensors:Dynamic):Dynamic;
}