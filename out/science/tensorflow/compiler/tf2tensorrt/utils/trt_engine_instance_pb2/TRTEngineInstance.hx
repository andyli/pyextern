...
package tensorflow.compiler.tf2tensorrt.utils.trt_engine_instance_pb2;
@:pythonImport("tensorflow.compiler.tf2tensorrt.utils.trt_engine_instance_pb2", "TRTEngineInstance") extern class TRTEngineInstance {
	/**
	...
	**/
	...
	/**
		Field tensorflow.tensorrt.TRTEngineInstance.input_shapes
	**/
	public var input_shapes : Dynamic;
	/**
		Field tensorflow.tensorrt.TRTEngineInstance.serialized_engine
	**/
	public var serialized_engine : Dynamic;
}