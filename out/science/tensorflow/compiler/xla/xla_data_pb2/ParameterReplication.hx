...
@:pythonImport("tensorflow.compiler.xla.xla_data_pb2", "ParameterReplication") extern class ParameterReplication {
	/**
	...
	**/
	...
	/**
		Field xla.ParameterReplication.replicated_at_leaf_buffers
	**/
	public var replicated_at_leaf_buffers : Dynamic;
}