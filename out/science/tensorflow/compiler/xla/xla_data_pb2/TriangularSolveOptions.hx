...
@:pythonImport("tensorflow.compiler.xla.xla_data_pb2", "TriangularSolveOptions") extern class TriangularSolveOptions {
	static public var ADJOINT : Dynamic;
	/**
	...
	**/
	...
	static public var NO_TRANSPOSE : Dynamic;
	/**
	...
	**/
	...
	static public var TRANSPOSE_INVALID : Dynamic;
	static public var Transpose : Dynamic;
	/**
	...
	**/
	...
	/**
		Field xla.TriangularSolveOptions.left_side
	**/
	public var left_side : Dynamic;
	/**
		Field xla.TriangularSolveOptions.lower
	**/
	public var lower : Dynamic;
	/**
		Field xla.TriangularSolveOptions.transpose_a
	**/
	public var transpose_a : Dynamic;
	/**
		Field xla.TriangularSolveOptions.unit_diagonal
	**/
	public var unit_diagonal : Dynamic;
}