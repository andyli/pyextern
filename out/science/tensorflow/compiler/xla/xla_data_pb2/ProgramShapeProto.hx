...
@:pythonImport("tensorflow.compiler.xla.xla_data_pb2", "ProgramShapeProto") extern class ProgramShapeProto {
	/**
	...
	**/
	...
	/**
		Field xla.ProgramShapeProto.parameter_names
	**/
	public var parameter_names : Dynamic;
	/**
		Field xla.ProgramShapeProto.parameters
	**/
	public var parameters : Dynamic;
	/**
		Field xla.ProgramShapeProto.result
	**/
