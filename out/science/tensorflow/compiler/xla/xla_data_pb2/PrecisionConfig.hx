...
@:pythonImport("tensorflow.compiler.xla.xla_data_pb2", "PrecisionConfig") extern class PrecisionConfig {
	/**
	...
	**/
	...
	/**
		Field xla.PrecisionConfig.operand_precision
	**/
	public var operand_precision : Dynamic;
}