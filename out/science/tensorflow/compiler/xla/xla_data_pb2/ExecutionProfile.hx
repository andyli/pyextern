...
@:pythonImport("tensorflow.compiler.xla.xla_data_pb2", "ExecutionProfile") extern class ExecutionProfile {
	/**
	...
	**/
	...
	/**
		Field xla.ExecutionProfile.profile_cache_hit
	**/
	public var profile_cache_hit : Dynamic;
}