...
@:pythonImport("tensorflow.compiler.xla.xla_data_pb2", "WhileLoopBackendConfig") extern class WhileLoopBackendConfig {
	/**
	...
	**/
	...
	/**
		A ProtocolMessage
	**/
	public function KnownTripCount(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	...
	/**
		Field xla.WhileLoopBackendConfig.known_trip_count
	**/
	public var known_trip_count : Dynamic;
}