...
@:pythonImport("tensorflow.compiler.xla.xla_data_pb2", "ShapeProto") extern class ShapeProto {
	/**
	...
	**/
	...
	/**
		Field xla.ShapeProto.dimensions
	**/
	public var dimensions : Dynamic;
	/**
		Field xla.ShapeProto.element_type
	**/
	public var element_type : Dynamic;
	/**
		Field xla.ShapeProto.is_dynamic_dimension
	**/
	public var is_dynamic_dimension : Dynamic;
	/**
		Field xla.ShapeProto.layout
	**/
	public var layout : Dynamic;
	/**
		Field xla.ShapeProto.tuple_shapes
	**/
