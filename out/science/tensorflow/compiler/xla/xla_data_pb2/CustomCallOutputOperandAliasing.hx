...
@:pythonImport("tensorflow.compiler.xla.xla_data_pb2", "CustomCallOutputOperandAliasing") extern class CustomCallOutputOperandAliasing {
	/**
	...
	**/
	...
	/**
		Field xla.CustomCallOutputOperandAliasing.operand_index
	**/
	public var operand_index : Dynamic;
	/**
		Field xla.CustomCallOutputOperandAliasing.operand_shape_index
	**/
	public var operand_shape_index : Dynamic;
	/**
		Field xla.CustomCallOutputOperandAliasing.output_shape_index
	**/
	public var output_shape_index : Dynamic;
}