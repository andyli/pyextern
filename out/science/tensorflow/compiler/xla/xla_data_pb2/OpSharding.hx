...
@:pythonImport("tensorflow.compiler.xla.xla_data_pb2", "OpSharding") extern class OpSharding {
	/**
	...
	**/
	...
	static public var MAXIMAL : Dynamic;
	/**
	...
	**/
	...
	static public var REPLICATED : Dynamic;
	/**
	...
	**/
	...
	/**
		Field xla.OpSharding.last_tile_dims
	**/
	public var last_tile_dims : Dynamic;
	/**
		Field xla.OpSharding.metadata
	**/
	public var metadata : Dynamic;
	/**
		Field xla.OpSharding.replicate_on_last_tile_dim
	**/
	public var replicate_on_last_tile_dim : Dynamic;
	/**
