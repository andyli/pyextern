...
@:pythonImport("tensorflow.compiler.xla.xla_data_pb2", "ChannelHandle") extern class ChannelHandle {
	/**
		Returns the size of the message in bytes.
	**/
	public function ByteSize(args:haxe.extern.Rest<Dynamic>):Dynamic;
	static public var CHANNEL_TYPE_INVALID : Dynamic;
	static public var ChannelType : Dynamic;
	/**
		Clears the message.
	**/
	...
	**/
	...
	static public var DEVICE_TO_DEVICE : Dynamic;
	static public var DEVICE_TO_HOST : Dynamic;
	/**
