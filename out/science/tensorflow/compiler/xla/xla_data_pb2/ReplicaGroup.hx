...
@:pythonImport("tensorflow.compiler.xla.xla_data_pb2", "ReplicaGroup") extern class ReplicaGroup {
	/**
	...
	**/
	...
	/**
		Field xla.ReplicaGroup.replica_ids
	**/
	public var replica_ids : Dynamic;
}