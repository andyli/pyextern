...
@:pythonImport("tensorflow.compiler.xla.xla_data_pb2", "OpMetadata") extern class OpMetadata {
	/**
	...
	**/
	...
	/**
		Field xla.OpMetadata.creation_pass_id
	**/
	public var creation_pass_id : Dynamic;
	/**
		Field xla.OpMetadata.logical_creation_pass_id
	**/
	public var logical_creation_pass_id : Dynamic;
	/**
	...
	**/
	...
	/**
		Field xla.OpMetadata.profile_type
	**/
	public var profile_type : Dynamic;
	/**
		Field xla.OpMetadata.size_of_generated_code_in_bytes
	**/
	public var size_of_generated_code_in_bytes : Dynamic;
	/**
		Field xla.OpMetadata.size_of_memory_working_set_in_bytes
	**/
	public var size_of_memory_working_set_in_bytes : Dynamic;
	/**
