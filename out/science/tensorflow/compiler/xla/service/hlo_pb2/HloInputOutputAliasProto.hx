...
@:pythonImport("tensorflow.compiler.xla.service.hlo_pb2", "HloInputOutputAliasProto") extern class HloInputOutputAliasProto {
	/**
		A ProtocolMessage
	**/
	public function AliasEntryProto(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	...
	/**
		Field xla.HloInputOutputAliasProto.entries
	**/
