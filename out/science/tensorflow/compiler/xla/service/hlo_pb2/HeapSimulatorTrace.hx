...
@:pythonImport("tensorflow.compiler.xla.service.hlo_pb2", "HeapSimulatorTrace") extern class HeapSimulatorTrace {
	/**
	...
	**/
	...
	/**
		Field xla.HeapSimulatorTrace.buffer_allocation_index
	**/
	public var buffer_allocation_index : Dynamic;
	/**
		Field xla.HeapSimulatorTrace.events
	**/
	public var events : Dynamic;
	/**
		Field xla.HeapSimulatorTrace.whole_module_simulation
	**/
	public var whole_module_simulation : Dynamic;
}