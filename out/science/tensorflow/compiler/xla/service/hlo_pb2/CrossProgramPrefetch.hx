...
@:pythonImport("tensorflow.compiler.xla.service.hlo_pb2", "CrossProgramPrefetch") extern class CrossProgramPrefetch {
	/**
	...
	**/
	...
	/**
		Field xla.CrossProgramPrefetch.index
	**/
	public var index : Dynamic;
	/**
		Field xla.CrossProgramPrefetch.parameter
	**/
