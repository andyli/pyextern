...
@:pythonImport("tensorflow.compiler.xla.service.hlo_pb2", "HloPassMetadata") extern class HloPassMetadata {
	/**
	...
	**/
	...
	/**
		Field xla.HloPassMetadata.dump_filenames
	**/
	public var dump_filenames : Dynamic;
	/**
		Field xla.HloPassMetadata.end_timestamp_usec
	**/
	public var end_timestamp_usec : Dynamic;
	/**
		Field xla.HloPassMetadata.module_changed
	**/
	public var module_changed : Dynamic;
	/**
		Field xla.HloPassMetadata.module_group_module_ids
	**/
	public var module_group_module_ids : Dynamic;
	/**
		Field xla.HloPassMetadata.module_id
	**/
	public var module_id : Dynamic;
	/**
		Field xla.HloPassMetadata.pass_id
	**/
	public var pass_id : Dynamic;
	/**
		Field xla.HloPassMetadata.pass_name
	**/
	public var pass_name : Dynamic;
	/**
		Field xla.HloPassMetadata.pipeline_name
	**/
	public var pipeline_name : Dynamic;
	/**
		Field xla.HloPassMetadata.start_timestamp_usec
	**/
	public var start_timestamp_usec : Dynamic;
}