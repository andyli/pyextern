...
@:pythonImport("tensorflow.compiler.xla.service.hlo_pb2", "HloModuleProto") extern class HloModuleProto {
	/**
	...
	**/
	...
	/**
		Field xla.HloModuleProto.cross_program_prefetches
	**/
	public var cross_program_prefetches : Dynamic;
	/**
	...
	**/
	...
	/**
		Field xla.HloModuleProto.is_dynamic
	**/
	public var is_dynamic : Dynamic;
	/**
