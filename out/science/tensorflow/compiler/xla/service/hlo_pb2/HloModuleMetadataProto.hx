...
@:pythonImport("tensorflow.compiler.xla.service.hlo_pb2", "HloModuleMetadataProto") extern class HloModuleMetadataProto {
	/**
	...
	**/
	...
	/**
		Field xla.HloModuleMetadataProto.canonical_module_id
	**/
	public var canonical_module_id : Dynamic;
	/**
		Field xla.HloModuleMetadataProto.module_group_name
	**/
	public var module_group_name : Dynamic;
	/**
		Field xla.HloModuleMetadataProto.original_module_id
	**/
	public var original_module_id : Dynamic;
	/**
		Field xla.HloModuleMetadataProto.partitioned_module_ids
	**/
	public var partitioned_module_ids : Dynamic;
	/**
		Field xla.HloModuleMetadataProto.pass_metadata
	**/
	public var pass_metadata : Dynamic;
}