...
@:pythonImport("tensorflow.compiler.xla.service.hlo_pb2", "HloModuleGroupProto") extern class HloModuleGroupProto {
	/**
	...
	**/
	...
	/**
		Field xla.HloModuleGroupProto.hlo_modules
	**/
	public var hlo_modules : Dynamic;
	/**
		Field xla.HloModuleGroupProto.name
	**/
