...
@:pythonImport("tensorflow.compiler.jit.ops.xla_ops") extern class Xla_ops_Module {
	...
	**/
	static public function XlaClusterOutput(input:Dynamic, ?name:Dynamic):Dynamic;
	/**
	...
	**/
	static public function XlaLaunch(constants:Dynamic, args:Dynamic, resources:Dynamic, Tresults:Dynamic, _function:Dynamic, ?name:Dynamic):Dynamic;
	...
	**/
	static public function _dispatcher_for_xla_cluster_output(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
		Dispatch(self: tensorflow.python.framework._pywrap_python_api_dispatcher.PythonAPIDispatcher, arg0: handle, arg1: handle) -> object
	**/
	static public function _dispatcher_for_xla_launch(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
