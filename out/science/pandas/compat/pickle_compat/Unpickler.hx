...
@:pythonImport("pandas.compat.pickle_compat", "Unpickler") extern class Unpickler {
	...
	**/
	@:native("__init__")
	public function ___init__(file:Dynamic, ?fix_imports:Dynamic, ?encoding:Dynamic, ?errors:Dynamic, ?buffers:Dynamic):Dynamic;
	/**
		This takes a binary file for reading a pickle data stream.
		...
		*errors*, which are used to control compatibility support for
		...
		'bytes' to read theses 8-bit string instances as bytes objects.
	**/
	public function new(file:Dynamic, ?fix_imports:Dynamic, ?encoding:Dynamic, ?errors:Dynamic, ?buffers:Dynamic):Void;
	/**
