...
@:pythonImport("pandas.plotting._matplotlib.converter", "TimeSeries_DateLocator") extern class TimeSeries_DateLocator {
	...
	**/
	...
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(freq:Dynamic, ?minor_locator:Dynamic, ?dynamic_mode:Dynamic, ?base:Dynamic, ?quarter:Dynamic, ?month:Dynamic, ?day:Dynamic, ?plot_obj:Dynamic):Void;
	/**
	...
	**/
	public function _get_default_locs(vmin:Dynamic, vmax:Dynamic):Dynamic;
	/**
