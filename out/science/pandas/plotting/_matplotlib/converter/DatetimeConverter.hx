...
@:pythonImport("pandas.plotting._matplotlib.converter", "DatetimeConverter") extern class DatetimeConverter {
	...
	**/
	...
	static public function _convert_1d(values:Dynamic, unit:Dynamic, axis:Dynamic):Dynamic;
	/**
	...
	**/
	static public function convert(values:Dynamic, unit:Dynamic, axis:Dynamic):Dynamic;
	/**
