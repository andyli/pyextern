...
@:pythonImport("pandas.plotting._matplotlib.hist", "HistPlot") extern class HistPlot {
	...
	**/
	@:native("__init__")
	public function ___init__(data:Dynamic, ?bins:Dynamic, ?bottom:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(data:Dynamic, ?bins:Dynamic, ?bottom:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Void;
	/**
	...
	**/
	...
	static public function _plot(ax:Dynamic, y:Dynamic, ?style:Dynamic, ?bins:Dynamic, ?bottom:Dynamic, ?column_num:Dynamic, ?stacking_id:Dynamic, ?kwds:python.KwArgs<Dynamic>):Dynamic;
	/**
