...
@:pythonImport("pandas.plotting._matplotlib.hist", "KdePlot") extern class KdePlot {
	...
	**/
	@:native("__init__")
	public function ___init__(data:Dynamic, ?bw_method:Dynamic, ?ind:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(data:Dynamic, ?bw_method:Dynamic, ?ind:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Void;
	/**
	...
	**/
	public function _calculate_bins(data:Dynamic):Dynamic;
	...
	**/
	...
	public function _get_ind(y:Dynamic):Dynamic;
	...
	**/
	public function _make_plot_keywords(kwds:Dynamic, y:Dynamic):Dynamic;
	/**
	...
	**/
	...
	static public function _plot(ax:Dynamic, y:Dynamic, ?style:Dynamic, ?bw_method:Dynamic, ?ind:Dynamic, ?column_num:Dynamic, ?stacking_id:Dynamic, ?kwds:python.KwArgs<Dynamic>):Dynamic;
	/**
