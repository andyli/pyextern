...
@:pythonImport("pandas.plotting._matplotlib.boxplot", "BoxPlot") extern class BoxPlot {
	/**
		BP(ax, lines)
	**/
	...
	**/
	...
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(data:Dynamic, ?return_type:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Void;
	/**
