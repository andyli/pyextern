...
@:pythonImport("pandas.plotting._matplotlib.core", "PlanePlot") extern class PlanePlot {
	...
	**/
	@:native("__init__")
	public function ___init__(data:Dynamic, x:Dynamic, y:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(data:Dynamic, x:Dynamic, y:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Void;
	/**
