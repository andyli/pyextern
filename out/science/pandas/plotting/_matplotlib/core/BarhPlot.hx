...
@:pythonImport("pandas.plotting._matplotlib.core", "BarhPlot") extern class BarhPlot {
	...
	**/
	...
	static public function _plot(ax:Dynamic, x:Dynamic, y:Dynamic, w:Dynamic, ?start:Dynamic, ?log:Dynamic, ?kwds:python.KwArgs<Dynamic>):Dynamic;
	/**
	...
	**/
	...
	public var _start_base : Dynamic;
