...
@:pythonImport("pandas.plotting._matplotlib.core", "ScatterPlot") extern class ScatterPlot {
	...
	**/
	@:native("__init__")
	public function ___init__(data:Dynamic, x:Dynamic, y:Dynamic, ?s:Dynamic, ?c:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(data:Dynamic, x:Dynamic, y:Dynamic, ?s:Dynamic, ?c:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Void;
	/**
