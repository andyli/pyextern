...
@:pythonImport("pandas.plotting._matplotlib.core", "LinePlot") extern class LinePlot {
	...
	**/
	...
	static public function _plot(ax:Dynamic, x:Dynamic, y:Dynamic, ?style:Dynamic, ?column_num:Dynamic, ?stacking_id:Dynamic, ?kwds:python.KwArgs<Dynamic>):Dynamic;
	/**
