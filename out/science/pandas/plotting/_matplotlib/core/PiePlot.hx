...
@:pythonImport("pandas.plotting._matplotlib.core", "PiePlot") extern class PiePlot {
	...
	**/
	...
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(data:Dynamic, ?kind:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Void;
	/**
