...
@:pythonImport("pandas._typing", "WriteExcelBuffer") extern class WriteExcelBuffer {
	...
	**/
	...
	public function seek(_BaseBuffer__offset:Dynamic, ?_BaseBuffer__whence:Dynamic):Dynamic;
	public function seekable():Dynamic;
	public function tell():Dynamic;
	public function truncate(?size:Dynamic):Dynamic;
	public function write(_WriteBuffer__b:Dynamic):Dynamic;
}