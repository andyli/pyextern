...
@:pythonImport("pandas.core.window.ewm", "OnlineExponentialMovingWindow") extern class OnlineExponentialMovingWindow {
	...
	**/
	@:native("__init__")
	public function ___init__(obj:Dynamic, ?com:Dynamic, ?span:Dynamic, ?halflife:Dynamic, ?alpha:Dynamic, ?min_periods:Dynamic, ?adjust:Dynamic, ?ignore_na:Dynamic, ?axis:Dynamic, ?times:Dynamic, ?engine:Dynamic, ?engine_kwargs:Dynamic, ?selection:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(obj:Dynamic, ?com:Dynamic, ?span:Dynamic, ?halflife:Dynamic, ?alpha:Dynamic, ?min_periods:Dynamic, ?adjust:Dynamic, ?ignore_na:Dynamic, ?axis:Dynamic, ?times:Dynamic, ?engine:Dynamic, ?engine_kwargs:Dynamic, ?selection:Dynamic):Void;
	/**
	...
	**/
	...
	/**
		...
		1  0.75  5.75
	**/
	public function mean(?args:python.VarArgs<Dynamic>, ?update:Dynamic, ?update_times:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
