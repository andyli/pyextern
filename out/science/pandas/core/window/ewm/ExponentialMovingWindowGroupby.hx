...
@:pythonImport("pandas.core.window.ewm", "ExponentialMovingWindowGroupby") extern class ExponentialMovingWindowGroupby {
	...
	**/
	@:native("__init__")
	public function ___init__(obj:Dynamic, ?args:python.VarArgs<Dynamic>, ?_grouper:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(obj:Dynamic, ?args:python.VarArgs<Dynamic>, ?_grouper:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Void;
	/**
