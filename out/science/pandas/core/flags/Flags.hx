...
@:pythonImport("pandas.core.flags", "Flags") extern class Flags {
	...
	**/
	@:native("__init__")
	public function ___init__(obj:Dynamic, allows_duplicate_labels:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(obj:Dynamic, allows_duplicate_labels:Dynamic):Void;
	/**
	...
	**/
	...
	/**
		...
		a        [0, 1]
	**/
	public var allows_duplicate_labels : Dynamic;
}