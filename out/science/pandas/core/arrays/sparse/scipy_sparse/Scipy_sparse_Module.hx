...
@:pythonImport("pandas.core.arrays.sparse.scipy_sparse") extern class Scipy_sparse_Module {
	...
	**/
	static public function _levels_to_axis(ss:Dynamic, levels:Dynamic, valid_ilocs:Dynamic, ?sort_labels:Dynamic):Dynamic;
	/**
	...
	**/
	static public function coo_to_sparse_series(A:Dynamic, ?dense_index:Dynamic):Dynamic;
	/**
	...
	**/
	static public function sparse_series_to_coo(ss:Dynamic, ?row_levels:Dynamic, ?column_levels:Dynamic, ?sort_labels:Dynamic):Dynamic;
}