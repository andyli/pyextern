...
@:pythonImport("pandas.core.arrays.boolean", "BooleanArray") extern class BooleanArray {
	public var T : Dynamic;
	static public var _FALSE_VALUES : Dynamic;
	static public var _HANDLED_TYPES : Dynamic;
	static public var _TRUE_VALUES : Dynamic;
	...
	**/
	...
	public function _coerce_to_array(value:Dynamic):Dynamic;
	/**
	...
	**/
	...
	static public var _falsey_value : Dynamic;
	/**
	...
	**/
	...
	/**
		...
		ExtensionArray
	**/
	static public function _from_sequence_of_strings(strings:Dynamic, ?dtype:Dynamic, ?copy:Dynamic, ?true_values:Dynamic, ?false_values:Dynamic):Dynamic;
	/**
	...
	**/
	...
	static public var _internal_fill_value : Dynamic;
	...
	**/
	...
	static public var _truthy_value : Dynamic;
