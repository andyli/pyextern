...
@:pythonImport("pandas.core.arrays.base", "ExtensionScalarOpsMixin") extern class ExtensionScalarOpsMixin {
	...
	**/
	...
	static public function _add_logical_ops():Dynamic;
	...
	static public function _create_logical_method(op:Dynamic):Dynamic;
	/**
	...
	**/
	static public function _create_method(op:Dynamic, ?coerce_to_dtype:Dynamic, ?result_dtype:Dynamic):Dynamic;
}