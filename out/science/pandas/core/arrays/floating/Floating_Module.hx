...
@:pythonImport("pandas.core.arrays.floating") extern class Floating_Module {
	...
	static public var FLOAT_STR_TO_DTYPE : Dynamic;
	...
	static public var _dtype_docstring : Dynamic;
