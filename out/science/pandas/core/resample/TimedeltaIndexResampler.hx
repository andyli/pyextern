...
@:pythonImport("pandas.core.resample", "TimedeltaIndexResampler") extern class TimedeltaIndexResampler {
	...
	**/
	@:native("__init__")
	public function ___init__(obj:Dynamic, groupby:Dynamic, ?axis:Dynamic, ?kind:Dynamic, ?selection:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(obj:Dynamic, groupby:Dynamic, ?axis:Dynamic, ?kind:Dynamic, ?selection:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Void;
	/**
	...
	**/
	public function _groupby_and_aggregate(how:Dynamic, ?args:python.VarArgs<Dynamic>, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
