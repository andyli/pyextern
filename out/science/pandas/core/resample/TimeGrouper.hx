...
@:pythonImport("pandas.core.resample", "TimeGrouper") extern class TimeGrouper {
	...
	**/
	@:native("__init__")
	public function ___init__(?freq:Dynamic, ?closed:Dynamic, ?label:Dynamic, ?how:Dynamic, ?axis:Dynamic, ?fill_method:Dynamic, ?limit:Dynamic, ?loffset:Dynamic, ?kind:Dynamic, ?convention:Dynamic, ?base:Dynamic, ?origin:Dynamic, ?offset:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(?freq:Dynamic, ?closed:Dynamic, ?label:Dynamic, ?how:Dynamic, ?axis:Dynamic, ?fill_method:Dynamic, ?limit:Dynamic, ?loffset:Dynamic, ?kind:Dynamic, ?convention:Dynamic, ?base:Dynamic, ?origin:Dynamic, ?offset:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Void;
	/**
