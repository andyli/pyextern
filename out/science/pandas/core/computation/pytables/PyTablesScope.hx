...
@:pythonImport("pandas.core.computation.pytables", "PyTablesScope") extern class PyTablesScope {
	...
	**/
	@:native("__init__")
	public function ___init__(level:Dynamic, ?global_dict:Dynamic, ?local_dict:Dynamic, ?queryables:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(level:Dynamic, ?global_dict:Dynamic, ?local_dict:Dynamic, ?queryables:Dynamic):Void;
	/**
