...
@:pythonImport("pandas.core.computation.ops", "UndefinedVariableError") extern class UndefinedVariableError {
	/**
		exception cause
	**/
	...
	**/
	...
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(name:Dynamic, ?is_local:Dynamic):Void;
	/**
