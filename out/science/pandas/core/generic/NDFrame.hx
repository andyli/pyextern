...
@:pythonImport("pandas.core.generic", "NDFrame") extern class NDFrame {
	...
	**/
	@:native("__init__")
	public function ___init__(data:Dynamic, ?copy:Dynamic, ?attrs:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(data:Dynamic, ?copy:Dynamic, ?attrs:Dynamic):Void;
	/**
	...
	**/
	...
	/**
		...
		Returns
		-------
		(left, right) : (Series/DataFrame, type of other)
		    Aligned objects.
	...
	**/
	...
	/**
		...
		See Also
		--------
		Series/DataFrame.fillna : Fill NA values.
		Series/DataFrame.where : Replace values based on boolean condition.
