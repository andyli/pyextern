...
@:pythonImport("pandas.core.apply", "FrameColumnApply") extern class FrameColumnApply {
	...
	**/
	...
	public function apply_broadcast(target:Dynamic):Dynamic;
	/**
	...
	**/
	public function infer_to_same_shape(results:Dynamic, res_index:Dynamic):Dynamic;
	/**
	...
	**/
	...
	public var res_columns : Dynamic;
	...
	**/
	...
	public function wrap_results(results:Dynamic, res_index:Dynamic):Dynamic;
	/**
		return the results for the columns
	**/
	public function wrap_results_for_axis(results:Dynamic, res_index:Dynamic):Dynamic;
}