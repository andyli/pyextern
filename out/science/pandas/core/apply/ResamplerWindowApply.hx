...
@:pythonImport("pandas.core.apply", "ResamplerWindowApply") extern class ResamplerWindowApply {
	...
	**/
	@:native("__init__")
	public function ___init__(obj:Dynamic, func:Dynamic, args:Dynamic, kwargs:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(obj:Dynamic, func:Dynamic, args:Dynamic, kwargs:Dynamic):Void;
	/**
