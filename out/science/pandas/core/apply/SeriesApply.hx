...
@:pythonImport("pandas.core.apply", "SeriesApply") extern class SeriesApply {
	...
	**/
	@:native("__init__")
	public function ___init__(obj:Dynamic, func:Dynamic, convert_dtype:Dynamic, args:Dynamic, kwargs:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(obj:Dynamic, func:Dynamic, convert_dtype:Dynamic, args:Dynamic, kwargs:Dynamic):Void;
	/**
