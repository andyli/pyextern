...
@:pythonImport("pandas.core.indexes.timedeltas", "TimedeltaIndex") extern class TimedeltaIndex {
	...
	**/
	static public function __new__(cls:Dynamic, ?data:Dynamic, ?unit:Dynamic, ?freq:Dynamic, ?closed:Dynamic, ?dtype:Dynamic, ?copy:Dynamic, ?name:Dynamic):Dynamic;
	public function __nonzero__():Dynamic;
	public function __or__(other:Dynamic):Dynamic;
	public function __pos__(?args:python.VarArgs<Dynamic>, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	...
	**/
	...
	public function median(?args:python.VarArgs<Dynamic>, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
		Memory usage of the values.
	...
	**/
	public function to_pytimedelta(?args:python.VarArgs<Dynamic>, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
