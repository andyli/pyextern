...
@:pythonImport("pandas.core.indexes.interval", "IntervalIndex") extern class IntervalIndex {
	...
	**/
	static public function _data_cls(data:Dynamic, ?closed:Dynamic, ?dtype:Dynamic, ?copy:Dynamic, ?verify_integrity:Dynamic):Dynamic;
	/**
	...
	**/
	public function _get_indexer_pointwise(target:Dynamic):Dynamic;
	/**
	...
	**/
	public function _get_indexer_unique_sides(target:Dynamic):Dynamic;
	...
	**/
	...
	/**
		...
		IntervalIndex
	**/
	public function _intersection_non_unique(other:Dynamic):Dynamic;
	/**
		...
		IntervalIndex
	**/
	public function _intersection_unique(other:Dynamic):Dynamic;
	/**
	...
	**/
	public function contains(?args:python.VarArgs<Dynamic>, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
	...
	**/
	public function overlaps(?args:python.VarArgs<Dynamic>, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
	...
	**/
	public function set_closed(?args:python.VarArgs<Dynamic>, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
	...
	**/
	...
	/**
		...
		tuples: ndarray
	**/
	public function to_tuples(?args:python.VarArgs<Dynamic>, ?kwargs:python.KwArgs<Dynamic>):numpy.Ndarray;
	/**
		Return a list of the values.
