...
@:pythonImport("pandas.core.indexes.numeric", "Int64Index") extern class Int64Index {
	/**
	...
	**/
	static public function __new__(cls:Dynamic, ?data:Dynamic, ?dtype:Dynamic, ?copy:Dynamic, ?name:Dynamic):Dynamic;
	...
	**/
	...
	static public var _index_descr_args : Dynamic;
