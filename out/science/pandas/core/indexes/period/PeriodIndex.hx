...
@:pythonImport("pandas.core.indexes.period", "PeriodIndex") extern class PeriodIndex {
	...
	**/
	static public function __new__(cls:Dynamic, ?data:Dynamic, ?ordinal:Dynamic, ?freq:Dynamic, ?dtype:Dynamic, ?copy:Dynamic, ?name:Dynamic, ?fields:python.KwArgs<Dynamic>):Dynamic;
