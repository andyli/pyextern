...
@:pythonImport("pandas.core.groupby.ops", "BaseGrouper") extern class BaseGrouper {
	...
	**/
	@:native("__init__")
	public function ___init__(axis:Dynamic, groupings:Dynamic, ?sort:Dynamic, ?group_keys:Dynamic, ?mutated:Dynamic, ?indexer:Dynamic, ?dropna:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(axis:Dynamic, groupings:Dynamic, ?sort:Dynamic, ?group_keys:Dynamic, ?mutated:Dynamic, ?indexer:Dynamic, ?dropna:Dynamic):Void;
	/**
