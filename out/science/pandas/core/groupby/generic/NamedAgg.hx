...
@:pythonImport("pandas.core.groupby.generic", "NamedAgg") extern class NamedAgg {
	/**
		Return self+value.
	**/
	...
	**/
	static public function __new__(_cls:Dynamic, column:Dynamic, aggfunc:Dynamic):Dynamic;
	/**
		Helper for pickle.
	**/
