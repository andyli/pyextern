...
@:pythonImport("pandas.core.groupby.indexing", "GroupByPositionalSelector") extern class GroupByPositionalSelector {
	...
	**/
	public function __getitem__(arg:Dynamic):Dynamic;
	/**
		Return self>value.
	**/
	...
	**/
	@:native("__init__")
	public function ___init__(groupby_object:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(groupby_object:Dynamic):Void;
	/**
