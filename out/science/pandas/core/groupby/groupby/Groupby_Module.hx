...
@:pythonImport("pandas.core.groupby.groupby") extern class Groupby_Module {
	...
	**/
	...
	static public var OutputFrameOrSeries : Dynamic;
	...
	static public function _KeysArgType(?args:python.VarArgs<Dynamic>, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	...
	static public var _groupby_agg_method_template : Dynamic;
	/**
		...
		MultiIndex
	**/
	static public function _insert_quantile_level(idx:Dynamic, qs:Dynamic):Dynamic;
