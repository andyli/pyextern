...
@:pythonImport("pandas.core.internals.managers", "SingleBlockManager") extern class SingleBlockManager {
	...
	**/
	@:native("__init__")
	public function ___init__(block:Dynamic, axis:Dynamic, ?verify_integrity:Dynamic, ?fastpath:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(block:Dynamic, axis:Dynamic, ?verify_integrity:Dynamic, ?fastpath:Dynamic):Void;
	/**
	...
	**/
	...
	static public var is_single_block : Dynamic;
	/**
