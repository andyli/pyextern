...
@:pythonImport("pandas.core.internals.base", "SingleDataManager") extern class SingleDataManager {
	...
	**/
	...
	static public function from_array(arr:Dynamic, index:Dynamic):Dynamic;
	/**
