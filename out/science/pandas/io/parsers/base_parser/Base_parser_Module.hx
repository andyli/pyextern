...
@:pythonImport("pandas.io.parsers.base_parser") extern class Base_parser_Module {
	...
	**/
	static public function _is_potential_multi_index(columns:Dynamic, ?index_col:Dynamic):Dynamic;
	static public function _make_date_converter(?date_parser:Dynamic, ?dayfirst:Dynamic, ?infer_datetime_format:Dynamic, ?cache_dates:Dynamic):Dynamic;
