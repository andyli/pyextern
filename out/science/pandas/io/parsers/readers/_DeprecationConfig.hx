...
@:pythonImport("pandas.io.parsers.readers", "_DeprecationConfig") extern class _DeprecationConfig {
	/**
		Return self+value.
	**/
	...
	**/
	...
	/**
		Create new instance of _DeprecationConfig(default_value, msg)
	**/
	static public function __new__(_cls:Dynamic, default_value:Dynamic, msg:Dynamic):Dynamic;
	/**
		Helper for pickle.
	**/
	...
	**/
	...
	/**
		Make a new _DeprecationConfig object from a sequence or iterable
	**/
	static public function _make(iterable:Dynamic):Dynamic;
	/**
		Return a new _DeprecationConfig object replacing specified fields with new values
	**/
