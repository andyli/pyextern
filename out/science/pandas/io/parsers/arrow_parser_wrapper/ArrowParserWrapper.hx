...
package pandas.io.parsers.arrow_parser_wrapper;
@:pythonImport("pandas.io.parsers.arrow_parser_wrapper", "ArrowParserWrapper") extern class ArrowParserWrapper {
	/**
		An enumeration.
	**/
	...
	**/
	public function _finalize_output(frame:Dynamic):Dynamic;
	...
	**/
	public function _get_pyarrow_options():Dynamic;
	...
	**/
	public function _parse_kwds():Dynamic;
	/**
