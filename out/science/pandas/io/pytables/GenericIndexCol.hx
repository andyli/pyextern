...
@:pythonImport("pandas.io.pytables", "GenericIndexCol") extern class GenericIndexCol {
	...
	**/
	@:native("__init__")
	public function ___init__(name:Dynamic, ?values:Dynamic, ?kind:Dynamic, ?typ:Dynamic, ?cname:Dynamic, ?axis:Dynamic, ?pos:Dynamic, ?freq:Dynamic, ?tz:Dynamic, ?index_name:Dynamic, ?ordered:Dynamic, ?table:Dynamic, ?meta:Dynamic, ?metadata:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(name:Dynamic, ?values:Dynamic, ?kind:Dynamic, ?typ:Dynamic, ?cname:Dynamic, ?axis:Dynamic, ?pos:Dynamic, ?freq:Dynamic, ?tz:Dynamic, ?index_name:Dynamic, ?ordered:Dynamic, ?table:Dynamic, ?meta:Dynamic, ?metadata:Dynamic):Void;
	/**
