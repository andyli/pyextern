...
package pandas.io.excel._pyxlsb;
@:pythonImport("pandas.io.excel._pyxlsb", "PyxlsbReader") extern class PyxlsbReader {
	...
	**/
	...
	public function _convert_cell(cell:Dynamic, convert_float:Dynamic):Dynamic;
