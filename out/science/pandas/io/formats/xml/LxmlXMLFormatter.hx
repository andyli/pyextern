...
@:pythonImport("pandas.io.formats.xml", "LxmlXMLFormatter") extern class LxmlXMLFormatter {
	...
	**/
	public function convert_empty_str_key():Dynamic;
	/**
	...
	**/
	public function transform_doc():Dynamic;
	/**
