...
@:pythonImport("pandas.io.formats.info") extern class Info_Module {
	...
	**/
	static public function _get_dataframe_dtype_counts(df:Dynamic):Dynamic;
	/**
		Get memory usage based on inputs and display options.
	**/
	static public function _initialize_memory_usage(?memory_usage:Dynamic):Dynamic;
	/**
	...
	**/
	...
	/**
		...
		'22.5+ KB'
	**/
	static public function _sizeof_fmt(num:Dynamic, size_qualifier:Dynamic):Dynamic;
	/**
	...
	**/
	...
	static public var frame_examples_sub : Dynamic;
	static public var frame_max_cols_sub : Dynamic;
	static public var frame_see_also_sub : Dynamic;
	...
	**/
	...
	static public var null_counts_sub : Dynamic;
	/**
	...
	**/
	...
	static public var series_examples_sub : Dynamic;
	static public var series_see_also_sub : Dynamic;
	static public var series_sub_kwargs : Dynamic;
	static public var show_counts_sub : Dynamic;
}