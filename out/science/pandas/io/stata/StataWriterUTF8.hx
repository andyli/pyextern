...
@:pythonImport("pandas.io.stata", "StataWriterUTF8") extern class StataWriterUTF8 {
	...
	**/
	@:native("__init__")
	public function ___init__(fname:Dynamic, data:Dynamic, ?convert_dates:Dynamic, ?write_index:Dynamic, ?byteorder:Dynamic, ?time_stamp:Dynamic, ?data_label:Dynamic, ?variable_labels:Dynamic, ?convert_strl:Dynamic, ?version:Dynamic, ?compression:Dynamic, ?storage_options:Dynamic, ?value_labels:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(fname:Dynamic, data:Dynamic, ?convert_dates:Dynamic, ?write_index:Dynamic, ?byteorder:Dynamic, ?time_stamp:Dynamic, ?data_label:Dynamic, ?variable_labels:Dynamic, ?convert_strl:Dynamic, ?version:Dynamic, ?compression:Dynamic, ?storage_options:Dynamic, ?value_labels:Dynamic):Void;
	/**
	...
	**/
	...
	static public var _dta_version : Dynamic;
	/**
