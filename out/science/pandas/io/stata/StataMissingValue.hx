...
@:pythonImport("pandas.io.stata", "StataMissingValue") extern class StataMissingValue {
	static public var BASE_MISSING_VALUES : Dynamic;
	...
	**/
	...
	static public var float64_base : Dynamic;
	static public function get_base_missing_value(dtype:Dynamic):Dynamic;
	static public var i : Dynamic;
	static public var increment : Dynamic;
	static public var int_value : Dynamic;
