...
package pandas._config.config;
@:pythonImport("pandas._config.config", "RegisteredOption") extern class RegisteredOption {
	/**
		Return self+value.
	**/
	...
	**/
	...
	/**
		Create new instance of RegisteredOption(key, defval, doc, validator, cb)
	**/
	static public function __new__(_cls:Dynamic, key:Dynamic, defval:Dynamic, doc:Dynamic, validator:Dynamic, cb:Dynamic):Dynamic;
	/**
		Helper for pickle.
	**/
	...
	**/
	...
	/**
		Make a new RegisteredOption object from a sequence or iterable
	**/
	static public function _make(iterable:Dynamic):Dynamic;
	/**
		Return a new RegisteredOption object replacing specified fields with new values
	**/
