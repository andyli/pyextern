...
@:pythonImport("pandas._config.config", "DeprecatedOption") extern class DeprecatedOption {
	/**
		Return self+value.
	**/
	...
	**/
	...
	/**
		Create new instance of DeprecatedOption(key, msg, rkey, removal_ver)
	**/
	static public function __new__(_cls:Dynamic, key:Dynamic, msg:Dynamic, rkey:Dynamic, removal_ver:Dynamic):Dynamic;
	/**
		Helper for pickle.
	**/
	...
	**/
	...
	/**
		Make a new DeprecatedOption object from a sequence or iterable
	**/
	static public function _make(iterable:Dynamic):Dynamic;
	/**
		Return a new DeprecatedOption object replacing specified fields with new values
	**/
