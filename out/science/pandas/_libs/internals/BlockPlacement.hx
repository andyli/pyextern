...
@:pythonImport("pandas._libs.internals", "BlockPlacement") extern class BlockPlacement {
	...
	**/
	public function increment_above(args:haxe.extern.Rest<Dynamic>):Dynamic;
	public var indexer : Dynamic;
	public var is_slice_like : Dynamic;
	/**
		Find the new mgr_locs for the un-stacked version of a Block.
	**/
	public function tile_for_unstack(args:haxe.extern.Rest<Dynamic>):Dynamic;
}