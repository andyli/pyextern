...
@:pythonImport("pandas._libs.tslibs.strptime", "TimeRE") extern class TimeRE {
	/**
	...
	**/
	public function _TimeRE__seqToRE(to_convert:Dynamic, directive:Dynamic):Dynamic;
	...
	**/
	public function compile(format:Dynamic):Dynamic;
	/**
	...
	**/
	public function pattern(format:Dynamic):Dynamic;
	/**
