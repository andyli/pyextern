...
@:pythonImport("pandas._libs.tslibs.offsets", "CustomBusinessDay") extern class CustomBusinessDay {
	/**
		Return self+value.
	**/
	...
	**/
	...
	public function _apply_array(args:haxe.extern.Rest<Dynamic>):Dynamic;
	...
	**/
	...
	public function apply_index(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
