...
@:pythonImport("pandas._libs.tslibs.offsets", "Second") extern class Second {
	/**
		Return self+value.
	**/
	...
	**/
	...
	public function _apply(args:haxe.extern.Rest<Dynamic>):Dynamic;
	...
	static public var _nanos_inc : Dynamic;
	public function _next_higher_resolution(args:haxe.extern.Rest<Dynamic>):Dynamic;
	...
	**/
	...
	static public var _period_dtype_code : Dynamic;
