...
@:pythonImport("pandas._libs.tslibs.offsets", "CustomBusinessMonthBegin") extern class CustomBusinessMonthBegin {
	/**
		Return self+value.
	**/
	...
	**/
	...
	public var m_offset : Dynamic;
	/**
		Define default roll function to be called in apply method.
	**/
	public var month_roll : Dynamic;
