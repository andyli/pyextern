...
@:pythonImport("pandas._libs.tslibs.offsets", "OffsetMeta") extern class OffsetMeta {
	...
	**/
	static public function __instancecheck__(obj:Dynamic):Dynamic;
	...
	**/
	static public function __subclasscheck__(obj:Dynamic):Dynamic;
	/**
