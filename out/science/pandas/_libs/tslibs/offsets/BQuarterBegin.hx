...
@:pythonImport("pandas._libs.tslibs.offsets", "BQuarterBegin") extern class BQuarterBegin {
	/**
		Return self+value.
	**/
	...
	**/
	...
	static public var _output_name : Dynamic;
	/**
