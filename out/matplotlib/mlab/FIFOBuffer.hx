...
@:pythonImport("matplotlib.mlab", "FIFOBuffer") extern class FIFOBuffer {
	...
	**/
	...
	/**
		.. deprecated:: 1.3
		    The FIFOBuffer class was deprecated in version 1.3.
	...
	**/
	...
	/**
		...
		data added or *nmax*.
	**/
	public function asarrays():Dynamic;
	/**
	...
	**/
	...
	/**
		...
		is ``func(fifo)``.
	**/
	public function register(func:Dynamic, N:Dynamic):Dynamic;
	/**
		Update the *datalim* in the current data in the fifo.
	**/
	public function update_datalim_to_current():Dynamic;
}