...
@:pythonImport("matplotlib.ticker", "FixedLocator") extern class FixedLocator {
	...
	**/
	...
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(locs:Dynamic, ?nbins:Dynamic):Void;
	/**
		Return self<=value.
	**/
	...
	**/
	public function set_params(?nbins:Dynamic):Dynamic;
