...
@:pythonImport("matplotlib.patheffects", "PathEffectRenderer") extern class PathEffectRenderer {
	...
	**/
	...
	public function copy_with_path_effect(path_effects:Dynamic):Dynamic;
	/**
	...
	**/
	public function draw_path(gc:Dynamic, tpath:Dynamic, affine:Dynamic, ?rgbFace:Dynamic):Dynamic;
	/**
