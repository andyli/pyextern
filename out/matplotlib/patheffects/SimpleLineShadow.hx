...
@:pythonImport("matplotlib.patheffects", "SimpleLineShadow") extern class SimpleLineShadow {
	...
	**/
	@:native("__init__")
	public function ___init__(?offset:Dynamic, ?shadow_color:Dynamic, ?alpha:Dynamic, ?rho:Dynamic, kwargs:Dynamic):Dynamic;
	/**
		Return self<=value.
	**/
