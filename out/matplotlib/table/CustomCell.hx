...
@:pythonImport("matplotlib.table", "CustomCell") extern class CustomCell {
	...
	**/
	@:native("__init__")
	public function ___init__(?args:python.VarArgs<Dynamic>, visible_edges:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
		Parameters
		----------
		xy : (float, float)
		...
		Valid kwargs are:
		  ...
		  zorder: float
	**/
	public function new(?args:python.VarArgs<Dynamic>, visible_edges:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Void;
	/**
	...
	**/
	...
	public function _update_x1():Dynamic;
	public function _update_y1():Dynamic;
	/**
