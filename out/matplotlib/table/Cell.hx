	...
	**/
	...
	/**
		...
		Valid kwargs are:
		  ...
		  zorder: float
	**/
	public function new(xy:Dynamic, width:Dynamic, height:Dynamic, ?edgecolor:Dynamic, ?facecolor:Dynamic, ?fill:Dynamic, ?text:Dynamic, ?loc:Dynamic, ?fontproperties:Dynamic):Void;
	/**
