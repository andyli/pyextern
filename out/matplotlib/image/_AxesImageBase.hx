...
@:pythonImport("matplotlib.image", "_AxesImageBase") extern class _AxesImageBase {
	...
	**/
	public function __init__(ax:Dynamic, ?cmap:Dynamic, ?norm:Dynamic, ?interpolation:Dynamic, ?origin:Dynamic, ?filternorm:Dynamic, ?filterrad:Dynamic, ?resample:Dynamic, kwargs:Dynamic):Dynamic;
	/**
		Return self<=value.
	**/
