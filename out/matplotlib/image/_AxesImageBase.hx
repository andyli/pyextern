...
@:pythonImport("matplotlib.image", "_AxesImageBase") extern class _AxesImageBase {
	...
	**/
	...
	/**
		...
		Additional kwargs are matplotlib.artist properties
	**/
	public function new(ax:Dynamic, ?cmap:Dynamic, ?norm:Dynamic, ?interpolation:Dynamic, ?origin:Dynamic, ?filternorm:Dynamic, ?filterrad:Dynamic, ?resample:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Void;
	/**
		Return self<=value.
	**/
