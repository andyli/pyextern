...
@:pythonImport("matplotlib.patches", "RegularPolygon") extern class RegularPolygon {
	...
	**/
	...
	public function _set_numvertices(numVertices:Dynamic):Dynamic;
	public function _set_orientation(orientation:Dynamic):Dynamic;
	public function _set_radius(radius:Dynamic):Dynamic;
	public function _set_xy(xy:Dynamic):Dynamic;
	public function _update_transform():Dynamic;
	/**
