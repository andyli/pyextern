...
@:pythonImport("matplotlib.patches", "YAArrow") extern class YAArrow {
	...
	**/
	@:native("__init__")
	public function ___init__(figure:Dynamic, xytip:Dynamic, xybase:Dynamic, ?width:Dynamic, ?frac:Dynamic, ?headwidth:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
		Constructor arguments:
		...
		*headwidth*
		...
		Valid kwargs are:
		  ...
		  zorder: any number 
	**/
	public function new(figure:Dynamic, xytip:Dynamic, xybase:Dynamic, ?width:Dynamic, ?frac:Dynamic, ?headwidth:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Void;
	/**
		Return self<=value.
	**/
	...
	**/
	public function getpoints(x1:Dynamic, y1:Dynamic, x2:Dynamic, y2:Dynamic, k:Dynamic):Dynamic;
	/**
