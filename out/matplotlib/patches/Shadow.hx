...
@:pythonImport("matplotlib.patches", "Shadow") extern class Shadow {
	...
	**/
	@:native("__init__")
	public function ___init__(patch:Dynamic, ox:Dynamic, oy:Dynamic, ?props:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
		Create a shadow of the given *patch* offset by *ox*, *oy*.
		*props*, if not *None*, is a patch property update dictionary.
		If *None*, the shadow will have have the same color as the face,
		...
		kwargs are
		  ...
		  zorder: any number         
	**/
	public function new(patch:Dynamic, ox:Dynamic, oy:Dynamic, ?props:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Void;
	/**
		Return self<=value.
	**/
	...
	**/
	...
	public function _get_ox():Dynamic;
	public function _get_oy():Dynamic;
	/**
		Set the clip properly for the gc
	**/
	public function _set_gc_clip(gc:Dynamic):Dynamic;
	public function _set_ox(ox:Dynamic):Dynamic;
	public function _set_oy(oy:Dynamic):Dynamic;
