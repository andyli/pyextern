...
@:pythonImport("matplotlib.projections.geo", "AitoffAxes") extern class AitoffAxes {
	/**
		The base Aitoff transform.
	**/
	static public function AitoffTransform(resolution:Dynamic):Dynamic;
	/**
		...
		where there were once line segments, it should override:
		  ...
		  - :meth:`transform_path`
	**/
	static public function InvertedAitoffTransform(resolution:Dynamic):Dynamic;
