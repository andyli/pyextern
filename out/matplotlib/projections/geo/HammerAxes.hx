...
@:pythonImport("matplotlib.projections.geo", "HammerAxes") extern class HammerAxes {
	/**
		The base Hammer transform.
	**/
	static public function HammerTransform(resolution:Dynamic):Dynamic;
	/**
		...
		where there were once line segments, it should override:
		  ...
		  - :meth:`transform_path`
	**/
	static public function InvertedHammerTransform(resolution:Dynamic):Dynamic;
