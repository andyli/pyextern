...
@:pythonImport("matplotlib.projections.geo", "MollweideAxes") extern class MollweideAxes {
	/**
		...
		where there were once line segments, it should override:
		  ...
		  - :meth:`transform_path`
	**/
	static public function InvertedMollweideTransform(resolution:Dynamic):Dynamic;
	/**
		The base Mollweide transform.
	**/
	static public function MollweideTransform(resolution:Dynamic):Dynamic;
