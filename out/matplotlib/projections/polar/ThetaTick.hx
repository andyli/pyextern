...
@:pythonImport("matplotlib.projections.polar", "ThetaTick") extern class ThetaTick {
	...
	**/
	@:native("__init__")
	public function ___init__(axes:Dynamic, ?args:python.VarArgs<Dynamic>, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
		bbox is the Bound2D bounding box in display coords of the Axes
		loc is the tick location in data coords
		size is the tick size in points
	**/
	public function new(axes:Dynamic, ?args:python.VarArgs<Dynamic>, ?kwargs:python.KwArgs<Dynamic>):Void;
	/**
	...
	**/
	...
	public function _update_padding(pad:Dynamic, angle:Dynamic):Dynamic;
	/**
