...
@:pythonImport("matplotlib.projections.polar", "RadialTick") extern class RadialTick {
	...
	**/
	...
	public function _determine_anchor(mode:Dynamic, angle:Dynamic, start:Dynamic):Dynamic;
	/**
