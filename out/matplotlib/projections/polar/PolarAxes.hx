...
@:pythonImport("matplotlib.projections.polar", "PolarAxes") extern class PolarAxes {
	...
	**/
	static public function InvertedPolarTransform(?axis:Dynamic, ?use_rmin:Dynamic):Dynamic;
	/**
	...
	**/
	...
	/**
		...
		*r* into Cartesian coordinate space *x* and *y*, but does not
		...
		position.
	**/
	static public function PolarTransform(?axis:Dynamic, ?use_rmin:Dynamic):Dynamic;
	/**
	...
	**/
	static public function RadialLocator(base:Dynamic):Dynamic;
	/**
	...
	**/
	public function set_theta_zero_location(loc:Dynamic):Dynamic;
	/**
