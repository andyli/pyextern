...
@:pythonImport("matplotlib.projections.polar", "_ThetaShift") extern class _ThetaShift {
	...
	**/
	@:native("__init__")
	public function ___init__(axes:Dynamic, pad:Dynamic, mode:Dynamic):Dynamic;
	/**
		Creates a new :class:`TransformNode`.
		...
		shorthand_name : str
		    ...
		    ``str(transform)`` when DEBUG=True.
	**/
	public function new(axes:Dynamic, pad:Dynamic, mode:Dynamic):Void;
	/**
