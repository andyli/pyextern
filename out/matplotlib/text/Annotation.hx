	...
	/**
		...
		*xycoords* and *textcoords* are strings that indicate the
		...
		Additional kwargs are `~matplotlib.text.Text` properties:
		  ...
		  zorder: any number         
	**/
	public function __init__(s:Dynamic, xy:Dynamic, ?xytext:Dynamic, ?xycoords:Dynamic, ?textcoords:Dynamic, ?arrowprops:Dynamic, ?annotation_clip:Dynamic, kwargs:Dynamic):Dynamic;
	/**
		Return self<=value.
	**/
