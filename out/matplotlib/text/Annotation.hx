...
@:pythonImport("matplotlib.text", "Annotation") extern class Annotation {
	...
	**/
	@:native("__init__")
	public function ___init__(s:Dynamic, xy:Dynamic, ?xytext:Dynamic, ?xycoords:Dynamic, ?textcoords:Dynamic, ?arrowprops:Dynamic, ?annotation_clip:Dynamic, kwargs:Dynamic):Dynamic;
	/**
		Return self<=value.
	**/
