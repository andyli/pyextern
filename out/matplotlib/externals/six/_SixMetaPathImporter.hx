...
@:pythonImport("matplotlib.externals.six", "_SixMetaPathImporter") extern class _SixMetaPathImporter {
	public function _SixMetaPathImporter__get_module(fullname:Dynamic):Dynamic;
	...
	**/
	@:native("__init__")
	public function ___init__(six_module_name:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(six_module_name:Dynamic):Void;
	/**
		Return self<=value.
	**/
