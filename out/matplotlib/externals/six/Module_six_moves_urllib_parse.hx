...
@:pythonImport("matplotlib.externals.six", "Module_six_moves_urllib_parse") extern class Module_six_moves_urllib_parse {
	...
	**/
	...
	static public var urlencode : Dynamic;
	static public var urljoin : Dynamic;
	static public var urlparse : Dynamic;
