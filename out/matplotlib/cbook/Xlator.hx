...
@:pythonImport("matplotlib.cbook", "Xlator") extern class Xlator {
	/**
		Handler invoked for each regex *match* 
	**/
	public function __call__(match:Dynamic):Dynamic;
	...
	**/
	public function _make_regex():Dynamic;
	/**
	...
	**/
	public function xlat(text:Dynamic):Dynamic;
}