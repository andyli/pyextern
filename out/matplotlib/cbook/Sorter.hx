...
@:pythonImport("matplotlib.cbook", "Sorter") extern class Sorter {
	public function __call__(data:Dynamic, ?itemindex:Dynamic, ?inplace:Dynamic):Dynamic;
	...
	**/
	...
	public function sort(data:Dynamic, ?itemindex:Dynamic, ?inplace:Dynamic):Dynamic;
}