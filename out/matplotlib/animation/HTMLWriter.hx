...
@:pythonImport("matplotlib.animation", "HTMLWriter") extern class HTMLWriter {
	...
	**/
	@:native("__init__")
	public function ___init__(?fps:Dynamic, ?codec:Dynamic, ?bitrate:Dynamic, ?extra_args:Dynamic, ?metadata:Dynamic, ?embed_frames:Dynamic, ?default_mode:Dynamic, ?embed_limit:Dynamic):Dynamic;
	/**
		MovieWriter
		...
		metadata : Dict[str, str] or None
		    ...
		    title, artist, genre, subject, copyright, srcform, comment.
	**/
	public function new(?fps:Dynamic, ?codec:Dynamic, ?bitrate:Dynamic, ?extra_args:Dynamic, ?metadata:Dynamic, ?embed_frames:Dynamic, ?default_mode:Dynamic, ?embed_limit:Dynamic):Void;
	/**
	...
	**/
	public function setup(fig:Dynamic, outfile:Dynamic, dpi:Dynamic, ?frame_dir:Dynamic):Dynamic;
