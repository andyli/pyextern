...
@:pythonImport("matplotlib.animation", "MencoderWriter") extern class MencoderWriter {
	...
	**/
	...
	/**
		.. deprecated:: 2.0
		    Support for mencoder is only partially functional, and will be removed entirely in 2.2. Please use ffmpeg instead.
