...
@:pythonImport("matplotlib.collections", "BrokenBarHCollection") extern class BrokenBarHCollection {
	...
	public function set_paths(verts:Dynamic, ?closed:Dynamic = true, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	...
	public function set_verts(verts:Dynamic, ?closed:Dynamic = true, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	...
	static public function span_where(?varargs:python.VarArgs<Dynamic>, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
