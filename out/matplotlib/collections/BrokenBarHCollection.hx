...
@:native("matplotlib.collections.BrokenBarHCollection") extern class BrokenBarHCollection {
	...
	public function set_paths(verts:Dynamic, ?closed:Dynamic = true):Void;
	...
	public function set_sizes(sizes:Dynamic, ?dpi:Dynamic):Void;
	...
	public function set_verts(verts:Dynamic, ?closed:Dynamic = true):Void;
	public function set_visible(b:Dynamic):Void;
	public function set_zorder(level:Dynamic):Void;
	static public function span_where(args:haxe.extern.Rest<Dynamic>):Void;
