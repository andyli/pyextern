...
@:pythonImport("matplotlib.collections", "QuadMesh") extern class QuadMesh {
	...
	static public function convert_mesh_to_paths(meshWidth:Dynamic, meshHeight:Dynamic, coordinates:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	public function convert_mesh_to_triangles(meshWidth:Dynamic, meshHeight:Dynamic, coordinates:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
