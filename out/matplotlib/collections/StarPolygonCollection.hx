...
@:pythonImport("matplotlib.collections", "StarPolygonCollection") extern class StarPolygonCollection {
	...
	**/
	...
	/**
		...
		0).
	**/
	static public function _path_generator(numVertices:Dynamic, ?innerCircle:Dynamic):Dynamic;
	/**
