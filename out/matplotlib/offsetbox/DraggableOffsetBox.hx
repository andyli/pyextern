...
@:pythonImport("matplotlib.offsetbox", "DraggableOffsetBox") extern class DraggableOffsetBox {
	...
	**/
	@:native("__init__")
	public function ___init__(ref_artist:Dynamic, offsetbox:Dynamic, ?use_blit:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(ref_artist:Dynamic, offsetbox:Dynamic, ?use_blit:Dynamic):Void;
	/**
	...
	**/
	...
	public function on_motion_blit(evt:Dynamic):Dynamic;
