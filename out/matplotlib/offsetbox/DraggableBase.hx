...
@:pythonImport("matplotlib.offsetbox", "DraggableBase") extern class DraggableBase {
	...
	**/
	@:native("__init__")
	public function ___init__(ref_artist:Dynamic, ?use_blit:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(ref_artist:Dynamic, ?use_blit:Dynamic):Void;
	/**
