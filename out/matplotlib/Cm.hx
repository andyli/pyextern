...
package matplotlib;
@:pythonImport("matplotlib.cm") extern class Cm {
	...
	**/
	...
	static public function _reverser(f:Dynamic):Dynamic;
	...
	**/
	...
	static public var spec : Dynamic;
	static public var spec_reversed : Dynamic;
	static public function spectral(X:Dynamic, ?alpha:Dynamic, ?bytes:Dynamic):Dynamic;
	static public function spectral_r(X:Dynamic, ?alpha:Dynamic, ?bytes:Dynamic):Dynamic;
