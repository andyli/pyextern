...
@:pythonImport("matplotlib.backends._backend_tk", "FigureManagerTk") extern class FigureManagerTk {
	...
	**/
	...
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(canvas:Dynamic, num:Dynamic, window:Dynamic):Void;
	/**
