...
@:pythonImport("matplotlib.backends._backend_tk", "NavigationToolbar2Tk") extern class NavigationToolbar2Tk {
	...
	**/
	...
	public function _Spacer():Dynamic;
	...
	**/
	...
	/**
		...
		highlightcolor, highlightthickness, relief, takefocus, visual, width.
	**/
	public function new(canvas:Dynamic, window:Dynamic):Void;
	/**
