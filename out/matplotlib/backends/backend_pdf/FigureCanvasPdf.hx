...
@:pythonImport("matplotlib.backends.backend_pdf", "FigureCanvasPdf") extern class FigureCanvasPdf {
	...
	**/
	...
	public function print_pdf(filename:Dynamic, ?dpi:Dynamic, ?bbox_inches_restore:Dynamic, ?metadata:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
