...
@:pythonImport("matplotlib.backends.backend_webagg_core") extern class Backend_webagg_core {
	static public var _JQUERY_ICON_CLASSES : Dynamic;
	static public var _LUT : Dynamic;
	static public var _SHIFT_LUT : Dynamic;
