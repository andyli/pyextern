...
@:pythonImport("matplotlib.backends.backend_template", "FigureManagerTemplate") extern class FigureManagerTemplate {
	...
	**/
	public function __init__(canvas:Dynamic, num:Dynamic):Dynamic;
	/**
		Return self<=value.
	**/
