...
@:pythonImport("matplotlib.backends.backend_template", "FigureCanvasTemplate") extern class FigureCanvasTemplate {
	...
	**/
	public function print_foo(filename:Dynamic, args:Dynamic, kwargs:Dynamic):Dynamic;
	/**
