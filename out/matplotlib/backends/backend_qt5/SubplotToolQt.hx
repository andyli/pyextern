...
@:pythonImport("matplotlib.backends.backend_qt5", "SubplotToolQt") extern class SubplotToolQt {
	...
	**/
	...
	public function _setSliderPositions():Dynamic;
	/**
		accept(self)
	**/
	static public function accept(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	...
	public function funchspace(val:Dynamic):Dynamic;
	public function funcleft(val:Dynamic):Dynamic;
	public function funcright(val:Dynamic):Dynamic;
	public function functight():Dynamic;
	...
	**/
	...
	/**
		reject(self)
	**/
	static public function reject(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
