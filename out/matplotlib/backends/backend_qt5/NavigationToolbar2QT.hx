...
@:pythonImport("matplotlib.backends.backend_qt5", "NavigationToolbar2QT") extern class NavigationToolbar2QT {
	...
	**/
	@:native("__init__")
	public function ___init__(canvas:Dynamic, parent:Dynamic, ?coordinates:Dynamic):Dynamic;
	/**
		coordinates: should we show the coordinates on the right? 
	**/
	public function new(canvas:Dynamic, parent:Dynamic, ?coordinates:Dynamic):Void;
	/**
		Return self<=value.
	**/
	...
	**/
	...
	public function _icon(name:Dynamic):Dynamic;
	/**
	...
	**/
	...
	public function _update_buttons_checked():Dynamic;
	/**
	...
	**/
	static public function actionAt(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	static public function actionGeometry(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	...
	/**
		...
		addAction(self, object, QObject, QT_SLOT) -> QAction
		addAction(self, object, Callable[..., None]) -> QAction
		addAction(self, QIcon, object, QObject, QT_SLOT) -> QAction
		addAction(self, QIcon, object, Callable[..., None]) -> QAction
	**/
	...
	**/
	static public function addSeparator(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	static public function allowedAreas(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
		allowedAreasChanged(self, Qt.ToolBarAreas) [signal]
	**/
	public function allowedAreasChanged(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	...
	/**
		clear(self)
	**/
	static public function clear(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
		clearFocus(self)
	**/
	...
	**/
	...
	public function edit_parameters():Dynamic;
	/**
	...
	**/
	static public function insertSeparator(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	static public function isAreaAllowed(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
		isEnabled(self) -> bool
	**/
	...
	**/
	static public function isFloatable(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
		isFloating(self) -> bool
	**/
	static public function isFloating(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	...
	/**
		isMovable(self) -> bool
	**/
	static public function isMovable(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	...
	public function message(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	public function movableChanged(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
		move(self, QPoint)
		move(self, int, int)
	**/
	...
	**/
	static public function orientation(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
		orientationChanged(self, Qt.Orientation) [signal]
	**/
	public function orientationChanged(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	static public function setAllowedAreas(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	static public function setFloatable(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
		setFocus(self)
	...
	**/
	static public function setMovable(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	static public function setOrientation(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	static public function toggleViewAction(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	public function topLevelChanged(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	static public function widgetForAction(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
		width(self) -> int
	**/
