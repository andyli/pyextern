...
@:pythonImport("matplotlib.backends.qt_editor.formlayout", "FormDialog") extern class FormDialog {
	...
	/**
		...
		4
	**/
	static public function DialogCode(args:haxe.extern.Rest<Dynamic>):Dynamic;
	...
	**/
	@:native("__init__")
	public function ___init__(data:Dynamic, ?title:Dynamic, ?comment:Dynamic, ?icon:Dynamic, ?parent:Dynamic, ?apply:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(data:Dynamic, ?title:Dynamic, ?comment:Dynamic, ?icon:Dynamic, ?parent:Dynamic, ?apply:Dynamic):Void;
	/**
		Return self<=value.
	**/
	...
	**/
	static public function done(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	...
	/**
		exec(self) -> int
	**/
	static public function exec(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
		exec_(self) -> int
	**/
	static public function exec_(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
		extension(self) -> QWidget
	**/
	...
	**/
	static public function isSizeGripEnabled(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	...
	/**
		open(self)
	**/
	static public function open(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	...
	public function register_float_field(field:Dynamic):Dynamic;
	/**
		reject(self)
	**/
	public function reject():Dynamic;
	/**
	...
	**/
	...
	/**
		result(self) -> int
	**/
	static public function result(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	static public function setExtension(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	...
	/**
		setModal(self, bool)
	**/
	static public function setModal(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	...
	/**
		setResult(self, int)
	**/
	static public function setResult(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	static public function setSizeGripEnabled(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
	...
	**/
	static public function showExtension(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
		showFullScreen(self)
	**/
	...
	**/
	...
	public function update_buttons():Dynamic;
	/**
