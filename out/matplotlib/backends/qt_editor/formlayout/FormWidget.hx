...
@:pythonImport("matplotlib.backends.qt_editor.formlayout", "FormWidget") extern class FormWidget {
	...
	**/
	@:native("__init__")
	public function ___init__(data:Dynamic, ?comment:Dynamic, ?parent:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(data:Dynamic, ?comment:Dynamic, ?parent:Dynamic):Void;
	/**
		Return self<=value.
	**/
	...
	**/
	public function get_dialog():Dynamic;
	/**
