...
package matplotlib.backends.qt_editor.formsubplottool;
@:pythonImport("matplotlib.backends.qt_editor.formsubplottool", "UiSubplotTool") extern class UiSubplotTool {
