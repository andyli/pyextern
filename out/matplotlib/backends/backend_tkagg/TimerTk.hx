...
@:pythonImport("matplotlib.backends.backend_tkagg", "TimerTk") extern class TimerTk {
	...
	**/
	@:native("__init__")
	public function ___init__(parent:Dynamic, ?args:python.VarArgs<Dynamic>, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(parent:Dynamic, ?args:python.VarArgs<Dynamic>, ?kwargs:python.KwArgs<Dynamic>):Void;
	/**
		Return self<=value.
	**/
