...
@:pythonImport("matplotlib.backends.backend_tkagg", "StatusbarTk") extern class StatusbarTk {
	/**
		Internal function.
	**/
	...
	**/
	@:native("__init__")
	public function ___init__(window:Dynamic, args:Dynamic, kwargs:Dynamic):Dynamic;
	/**
		Return self<=value.
	**/
	...
	**/
	public function _message_cbk(event:Dynamic):Dynamic;
	/**
