...
@:pythonImport("matplotlib.backends.backend_tkagg", "_BackendTkAgg") extern class _BackendTkAgg {
	/**
	...
	**/
	static public function FigureCanvas(figure:Dynamic, ?master:Dynamic, ?resize_callback:Dynamic):Dynamic;
	/**
		Attributes
		----------
		canvas : `FigureCanvas`
		...
		window : tk.Window
		    The tk.Window
	**/
	static public function FigureManager(canvas:Dynamic, num:Dynamic, window:Dynamic):Dynamic;
	...
	**/
	...
	static public function mainloop():Dynamic;
	/**
	...
	**/
	...
	static public function trigger_manager_draw(manager:Dynamic):Dynamic;
}