...
@:pythonImport("matplotlib.backends.backend_ps", "FigureCanvasPS") extern class FigureCanvasPS {
	...
	**/
	public function _print_figure(outfile:Dynamic, format:Dynamic, ?dpi:Dynamic, ?facecolor:Dynamic, ?edgecolor:Dynamic, ?orientation:Dynamic, ?isLandscape:Dynamic, ?papertype:Dynamic, ?metadata:Dynamic, ?dryrun:Dynamic, ?bbox_inches_restore:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
