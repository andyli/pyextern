...
@:pythonImport("matplotlib.backends.backend_webagg", "_BackendWebAgg") extern class _BackendWebAgg {
	/**
	...
	**/
	static public function FigureCanvas(?args:python.VarArgs<Dynamic>, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
