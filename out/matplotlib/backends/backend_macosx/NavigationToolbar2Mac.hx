...
@:pythonImport("matplotlib.backends.backend_macosx", "NavigationToolbar2Mac") extern class NavigationToolbar2Mac {
	...
	**/
	public function __init__(canvas:Dynamic):Dynamic;
	/**
		Return self<=value.
	**/
	...
	**/
	...
	public function prepare_configure_subplots():Dynamic;
	/**
	...
	**/
	public function set_message(message:Dynamic):Dynamic;
