...
@:pythonImport("matplotlib.dviread", "Page") extern class Page {
	/**
		Return self+value.
	**/
	...
	**/
	static public function __new__(_cls:Dynamic, text:Dynamic, boxes:Dynamic, height:Dynamic, width:Dynamic, descent:Dynamic):Dynamic;
	/**
		helper for pickle
	**/
	...
	**/
	...
	/**
		Make a new Page object from a sequence or iterable
	**/
	static public function _make(iterable:Dynamic, ?_new:Dynamic, ?len:Dynamic):Dynamic;
	/**
		Return a new Page object replacing specified fields with new values
	**/
