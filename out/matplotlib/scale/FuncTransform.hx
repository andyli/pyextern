...
@:pythonImport("matplotlib.scale", "FuncTransform") extern class FuncTransform {
	...
	**/
	@:native("__init__")
	public function ___init__(forward:Dynamic, inverse:Dynamic):Dynamic;
	/**
		Parameters
		----------
		...
		inverse : callable
		    The inverse of the forward function.  Signature as ``forward``.
	**/
	public function new(forward:Dynamic, inverse:Dynamic):Void;
	/**
