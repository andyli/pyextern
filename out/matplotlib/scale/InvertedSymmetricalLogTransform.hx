...
@:pythonImport("matplotlib.scale", "InvertedSymmetricalLogTransform") extern class InvertedSymmetricalLogTransform {
	...
	**/
	@:native("__init__")
	public function ___init__(base:Dynamic, linthresh:Dynamic, linscale:Dynamic):Dynamic;
	/**
		Creates a new :class:`TransformNode`.
		...
		shorthand_name : str
		    ...
		    ``str(transform)`` when DEBUG=True.
	**/
	public function new(base:Dynamic, linthresh:Dynamic, linscale:Dynamic):Void;
	/**
