...
@:pythonImport("matplotlib.colorbar", "_ColorbarAutoMinorLocator") extern class _ColorbarAutoMinorLocator {
	...
	**/
	@:native("__init__")
	public function ___init__(colorbar:Dynamic, ?n:Dynamic):Dynamic;
	/**
		This ticker needs to know the *colorbar* so that it can access
		its *vmin* and *vmax*.
	**/
	public function new(colorbar:Dynamic, ?n:Dynamic):Void;
	/**
