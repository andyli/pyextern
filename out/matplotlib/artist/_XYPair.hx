...
@:pythonImport("matplotlib.artist", "_XYPair") extern class _XYPair {
	/**
		Return self+value.
	**/
	...
	**/
	...
	/**
		Create new instance of _XYPair(x, y)
	**/
	...
	**/
	...
	/**
		Make a new _XYPair object from a sequence or iterable
	**/
	static public function _make(iterable:Dynamic, ?_new:Dynamic, ?len:Dynamic):Dynamic;
	/**
		Return a new _XYPair object replacing specified fields with new values
	**/
