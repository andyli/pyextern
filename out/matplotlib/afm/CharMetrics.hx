...
@:pythonImport("matplotlib.afm", "CharMetrics") extern class CharMetrics {
	/**
		Return self+value.
	**/
	...
	**/
	static public function __new__(_cls:Dynamic, width:Dynamic, name:Dynamic, bbox:Dynamic):Dynamic;
	/**
		helper for pickle
	**/
	...
	**/
	...
	/**
		Make a new CharMetrics object from a sequence or iterable
	**/
	static public function _make(iterable:Dynamic, ?_new:Dynamic, ?len:Dynamic):Dynamic;
	/**
		Return a new CharMetrics object replacing specified fields with new values
	**/
