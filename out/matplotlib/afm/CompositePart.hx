...
@:pythonImport("matplotlib.afm", "CompositePart") extern class CompositePart {
	/**
		Return self+value.
	**/
	...
	**/
	static public function __new__(_cls:Dynamic, name:Dynamic, dx:Dynamic, dy:Dynamic):Dynamic;
	/**
		helper for pickle
	**/
	...
	**/
	...
	/**
		Make a new CompositePart object from a sequence or iterable
	**/
	static public function _make(iterable:Dynamic, ?_new:Dynamic, ?len:Dynamic):Dynamic;
	/**
		Return a new CompositePart object replacing specified fields with new values
	**/
