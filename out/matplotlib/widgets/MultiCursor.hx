...
@:pythonImport("matplotlib.widgets", "MultiCursor") extern class MultiCursor {
	...
	**/
	@:native("__init__")
	public function ___init__(canvas:Dynamic, axes:Dynamic, ?useblit:Dynamic, ?horizOn:Dynamic, ?vertOn:Dynamic, lineprops:Dynamic):Dynamic;
	/**
		Return self<=value.
	**/
