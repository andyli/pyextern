...
@:pythonImport("matplotlib.widgets", "PolygonSelector") extern class PolygonSelector {
	...
	**/
	@:native("__init__")
	public function ___init__(ax:Dynamic, onselect:Dynamic, ?useblit:Dynamic, ?lineprops:Dynamic, ?markerprops:Dynamic, ?vertex_select_radius:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(ax:Dynamic, onselect:Dynamic, ?useblit:Dynamic, ?lineprops:Dynamic, ?markerprops:Dynamic, ?vertex_select_radius:Dynamic):Void;
	/**
