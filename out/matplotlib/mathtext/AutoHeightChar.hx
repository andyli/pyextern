...
@:pythonImport("matplotlib.mathtext", "AutoHeightChar") extern class AutoHeightChar {
	...
	**/
	@:native("__init__")
	public function ___init__(c:Dynamic, height:Dynamic, depth:Dynamic, state:Dynamic, ?always:Dynamic, ?factor:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	...
	**/
	public function hpack(?w:Dynamic, ?m:Dynamic):Dynamic;
	/**
