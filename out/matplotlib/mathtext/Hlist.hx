...
@:pythonImport("matplotlib.mathtext", "Hlist") extern class Hlist {
	...
	**/
	@:native("__init__")
	public function ___init__(elements:Dynamic, ?w:Dynamic, ?m:Dynamic, ?do_kern:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(elements:Dynamic, ?w:Dynamic, ?m:Dynamic, ?do_kern:Dynamic):Void;
	/**
