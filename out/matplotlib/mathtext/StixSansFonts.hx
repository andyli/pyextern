...
@:pythonImport("matplotlib.mathtext", "StixSansFonts") extern class StixSansFonts {
	...
	**/
	...
	public function _map_virtual_font(fontname:Dynamic, font_class:Dynamic, uniindex:Dynamic):Dynamic;
	static public var _sans : Dynamic;
	static public var _size_alternatives : Dynamic;
	static public var _slanted_symbols : Dynamic;
	static public var cm_fallback : Dynamic;
	/**
	...
	**/
	...
	static public var use_cmex : Dynamic;
}