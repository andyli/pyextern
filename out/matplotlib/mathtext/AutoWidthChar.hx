...
@:pythonImport("matplotlib.mathtext", "AutoWidthChar") extern class AutoWidthChar {
	...
	**/
	public function __init__(c:Dynamic, width:Dynamic, state:Dynamic, ?always:Dynamic, ?char_class:Dynamic):Dynamic;
