...
@:pythonImport("matplotlib.transforms", "Affine2D") extern class Affine2D {
	...
	**/
	...
	/**
		...
		.
	**/
	static public function from_values(a:Dynamic, b:Dynamic, c:Dynamic, d:Dynamic, e:Dynamic, f:Dynamic):Dynamic;
	/**
	...
	**/
	static public function identity():Dynamic;
	...
	**/
	...
	/**
		...
		numpy array of the form::
		  ...
		  0 0 1
	**/
	static public function matrix_from_values(a:Dynamic, b:Dynamic, c:Dynamic, d:Dynamic, e:Dynamic, f:Dynamic):Dynamic;
	...
	/**
		...
		and :meth:`scale`.
	**/
	public function rotate(theta:Dynamic):Dynamic;
	/**
		...
		and :meth:`scale`.
	**/
	public function rotate_around(x:Dynamic, y:Dynamic, theta:Dynamic):Dynamic;
	/**
		...
		and :meth:`scale`.
	**/
	public function rotate_deg(degrees:Dynamic):Dynamic;
	/**
		...
		and :meth:`scale`.
	**/
	public function rotate_deg_around(x:Dynamic, y:Dynamic, degrees:Dynamic):Dynamic;
	/**
		...
		*y*-directions.
		...
		and :meth:`scale`.
	**/
	public function scale(sx:Dynamic, ?sy:Dynamic):Dynamic;
	/**
	...
	**/
	...
	/**
		...
		.
	**/
	public function set_matrix(mtx:Dynamic):Dynamic;
	/**
		...
		*y*-axes, respectively, in radians.
		...
		and :meth:`scale`.
	**/
	public function skew(xShear:Dynamic, yShear:Dynamic):Dynamic;
	/**
		Adds a skew in place.
		...
		*y*-axes, respectively, in degrees.
		...
		and :meth:`scale`.
	**/
	public function skew_deg(xShear:Dynamic, yShear:Dynamic):Dynamic;
	/**
	...
	**/
	...
	/**
		...
		and :meth:`scale`.
	**/
	public function translate(tx:Dynamic, ty:Dynamic):Dynamic;
}