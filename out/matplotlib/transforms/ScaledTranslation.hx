...
@:pythonImport("matplotlib.transforms", "ScaledTranslation") extern class ScaledTranslation {
	...
	**/
	@:native("__init__")
	public function ___init__(xt:Dynamic, yt:Dynamic, scale_trans:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
		Creates a new :class:`TransformNode`.
		...
		shorthand_name : str
		    ...
		    ``str(transform)`` when DEBUG=True.
	**/
	public function new(xt:Dynamic, yt:Dynamic, scale_trans:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Void;
	/**
