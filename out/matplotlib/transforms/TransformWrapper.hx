...
@:pythonImport("matplotlib.transforms", "TransformWrapper") extern class TransformWrapper {
	...
	**/
	public function __init__(child:Dynamic):Dynamic;
	/**
		Return self<=value.
	**/
	...
	**/
	...
	public function _set(child:Dynamic):Dynamic;
	/**
	...
	**/
	public function set(child:Dynamic):Dynamic;
	/**
