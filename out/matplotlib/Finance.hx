...
package matplotlib;
@:native("matplotlib.finance") extern class Finance {
	...
	static public function fetch_historical_yahoo(ticker:Dynamic, date1:Dynamic, date2:Dynamic, ?cachename:Dynamic = null, ?dividends:Dynamic = false):Dynamic;
	...
	static public function md5(x:Dynamic):Void;
	static public function parse_yahoo_historical(fh:Dynamic, ?adjusted:Dynamic = true, ?asobject:Dynamic = false):Void;
	static public function parse_yahoo_historical_ochl(fh:Dynamic, ?adjusted:Dynamic = true, ?asobject:Dynamic = false):Void;
	static public function parse_yahoo_historical_ohlc(fh:Dynamic, ?adjusted:Dynamic = true, ?asobject:Dynamic = false):Void;
	...
	static public function quotes_historical_yahoo(ticker:Dynamic, date1:Dynamic, date2:Dynamic, ?asobject:Dynamic = false, ?adjusted:Dynamic = true, ?cachename:Dynamic = null):Void;
	static public function quotes_historical_yahoo_ochl(ticker:Dynamic, date1:Dynamic, date2:Dynamic, ?asobject:Dynamic = false, ?adjusted:Dynamic = true, ?cachename:Dynamic = null):Void;
	static public function quotes_historical_yahoo_ohlc(ticker:Dynamic, date1:Dynamic, date2:Dynamic, ?asobject:Dynamic = false, ?adjusted:Dynamic = true, ?cachename:Dynamic = null):Void;
