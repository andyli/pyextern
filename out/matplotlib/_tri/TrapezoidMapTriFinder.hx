...
@:pythonImport("matplotlib._tri", "TrapezoidMapTriFinder") extern class TrapezoidMapTriFinder {
	...
	**/
	public function find_many(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
		get_tree_stats()
		
		Return statistics about the tree used by the trapezoid map
	**/
	public function get_tree_stats(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
		initialize()
	...
	**/
	public function print_tree(args:haxe.extern.Rest<Dynamic>):Dynamic;
}