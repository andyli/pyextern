...
@:pythonImport("matplotlib.tri.triinterpolate", "_DOF_estimator_min_E") extern class _DOF_estimator_min_E {
	...
	**/
	@:native("__init__")
	public function ___init__(Interpolator:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(Interpolator:Dynamic):Void;
	/**
