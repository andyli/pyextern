...
@:pythonImport("matplotlib.tri.triinterpolate", "LinearTriInterpolator") extern class LinearTriInterpolator {
	/**
	...
	**/
	public function __init__(triangulation:Dynamic, z:Dynamic, ?trifinder:Dynamic):Dynamic;
	/**
		Return self<=value.
	**/
