...
@:pythonImport("matplotlib.tri.triinterpolate", "_DOF_estimator_user") extern class _DOF_estimator_user {
	...
	**/
	public function __init__(interpolator:Dynamic, kwargs:Dynamic):Dynamic;
	/**
		Return self<=value.
	**/
	...
	**/
	...
	public function compute_dz(dz:Dynamic):Dynamic;
	/**
