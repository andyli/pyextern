...
@:pythonImport("matplotlib.tests.test_dates") extern class Test_dates {
	...
	**/
	...
	static public function test_auto_date_locator():Dynamic;
	static public function test_date_formatter_callable():Dynamic;
	/**
		This test should check if drange works as expected, and if all the
		rounding errors are fixed
	**/
	static public function test_drange():Dynamic;
	static public function test_empty_date_with_year_formatter():Dynamic;
	static public function test_too_many_date_ticks():Dynamic;
