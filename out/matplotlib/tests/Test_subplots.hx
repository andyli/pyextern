...
@:pythonImport("matplotlib.tests.test_subplots") extern class Test_subplots {
	...
	**/
	static public function check_shared(results:Dynamic, f:Dynamic, axs:Dynamic):Dynamic;
	static public function check_visible(result:Dynamic, f:Dynamic, axs:Dynamic):Dynamic;
	...
	**/
	...
	static public function test_exceptions():Dynamic;
	static public function test_shared():Dynamic;
	static public function test_subplots():Dynamic;
