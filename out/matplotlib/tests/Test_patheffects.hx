...
@:pythonImport("matplotlib.tests.test_patheffects") extern class Test_patheffects {
	...
	**/
	...
	static public function test_PathEffect_get_proxy():Dynamic;
	static public function test_PathEffect_points_to_pixels():Dynamic;
	static public function test_SimplePatchShadow_offset_xy():Dynamic;
