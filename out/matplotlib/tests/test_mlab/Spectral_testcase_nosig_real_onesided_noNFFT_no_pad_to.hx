...
@:pythonImport("matplotlib.tests.test_mlab", "spectral_testcase_nosig_real_onesided_noNFFT_no_pad_to") extern class Spectral_testcase_nosig_real_onesided_noNFFT_no_pad_to {
	/**
