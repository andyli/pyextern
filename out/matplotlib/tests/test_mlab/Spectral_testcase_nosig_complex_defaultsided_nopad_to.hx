...
@:pythonImport("matplotlib.tests.test_mlab", "spectral_testcase_nosig_complex_defaultsided_nopad_to") extern class Spectral_testcase_nosig_complex_defaultsided_nopad_to {
	/**
