...
@:pythonImport("matplotlib.tests.test_mlab", "spectral_testcase_nosig_complex_onesided_overlap") extern class Spectral_testcase_nosig_complex_onesided_overlap {
	/**
