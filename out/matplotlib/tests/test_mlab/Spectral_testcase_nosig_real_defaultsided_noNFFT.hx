...
@:pythonImport("matplotlib.tests.test_mlab", "spectral_testcase_nosig_real_defaultsided_noNFFT") extern class Spectral_testcase_nosig_real_defaultsided_noNFFT {
	/**
