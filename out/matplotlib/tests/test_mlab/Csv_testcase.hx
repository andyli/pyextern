...
@:pythonImport("matplotlib.tests.test_mlab", "csv_testcase") extern class Csv_testcase {
	/**
	...
	**/
	...
	public function test_rec2csv_bad_shape_ValueError():Dynamic;
	public function test_recarray_csv_roundtrip():Dynamic;
}