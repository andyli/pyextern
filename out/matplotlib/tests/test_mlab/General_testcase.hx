...
@:pythonImport("matplotlib.tests.test_mlab", "general_testcase") extern class General_testcase {
	/**
	...
	**/
	...
	public function test_colinear_pca():Dynamic;
	public function test_norm():Dynamic;
	public function test_prctile():Dynamic;
}