...
@:pythonImport("matplotlib.tests.test_mlab", "spacing_testcase") extern class Spacing_testcase {
	/**
	...
	**/
	...
	public function test_logspace_none():Dynamic;
	public function test_logspace_primes():Dynamic;
	public function test_logspace_single():Dynamic;
	public function test_logspace_tens():Dynamic;
}