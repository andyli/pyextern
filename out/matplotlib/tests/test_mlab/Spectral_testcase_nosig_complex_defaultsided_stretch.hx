...
@:pythonImport("matplotlib.tests.test_mlab", "spectral_testcase_nosig_complex_defaultsided_stretch") extern class Spectral_testcase_nosig_complex_defaultsided_stretch {
	/**
