...
@:pythonImport("matplotlib.tests.test_mlab", "spectral_testcase_nosig_complex_defaultsided_noNFFT_no_pad_to") extern class Spectral_testcase_nosig_complex_defaultsided_noNFFT_no_pad_to {
	/**
	...
	**/
	...
	public function check_freqs(vals:Dynamic, targfreqs:Dynamic, resfreqs:Dynamic, fstims:Dynamic):Dynamic;
	public function check_maxfreq(spec:Dynamic, fsp:Dynamic, fstims:Dynamic):Dynamic;
	public function countTestCases():Dynamic;
	public function createStim(fstims:Dynamic, iscomplex:Dynamic, sides:Dynamic, nsides:Dynamic, ?len_x:Dynamic, ?NFFT_density:Dynamic, ?nover_density:Dynamic, ?pad_to_density:Dynamic, ?pad_to_spectrum:Dynamic):Dynamic;
	/**
	...
	**/
	...
	public function test_angle_spectrum():Dynamic;
	public function test_complex_spectrum():Dynamic;
	public function test_csd():Dynamic;
	public function test_magnitude_spectrum():Dynamic;
	public function test_phase_spectrum():Dynamic;
	public function test_psd():Dynamic;
	public function test_psd_csd_equal():Dynamic;
	public function test_psd_detrend_linear_func_trend():Dynamic;
	public function test_psd_detrend_linear_str_trend():Dynamic;
	public function test_psd_detrend_mean_func_offset():Dynamic;
	public function test_psd_detrend_mean_str_offset():Dynamic;
	public function test_psd_window_hanning():Dynamic;
	public function test_psd_window_hanning_detrend_linear():Dynamic;
	public function test_psd_windowarray():Dynamic;
	public function test_psd_windowarray_equal():Dynamic;
	public function test_psd_windowarray_scale_by_freq():Dynamic;
	public function test_single_spectrum_helper_raises_mode_default():Dynamic;
	public function test_single_spectrum_helper_raises_mode_psd():Dynamic;
	public function test_specgram_angle():Dynamic;
	public function test_specgram_angle_phase_equivalent():Dynamic;
	public function test_specgram_auto():Dynamic;
	/**
		test that mlab.specgram without mode and with mode 'default' and
		'psd' are all the same
	**/
	public function test_specgram_auto_default_equal():Dynamic;
	/**
		test that mlab.specgram without mode and with mode 'default' and
		'psd' are all the same
	**/
	public function test_specgram_auto_psd_equal():Dynamic;
	public function test_specgram_complex():Dynamic;
	public function test_specgram_complex_angle_equivalent():Dynamic;
	public function test_specgram_complex_mag_equivalent():Dynamic;
	public function test_specgram_complex_phase_equivalent():Dynamic;
	public function test_specgram_default():Dynamic;
	public function test_specgram_magnitude():Dynamic;
	public function test_specgram_phase():Dynamic;
	public function test_specgram_psd():Dynamic;
	public function test_spectral_helper_magnitude_magnitude_spectrum():Dynamic;
	public function test_spectral_helper_magnitude_specgram():Dynamic;
	public function test_spectral_helper_psd():Dynamic;
	public function test_spectral_helper_raises_angle_same_data():Dynamic;
	public function test_spectral_helper_raises_complex_same_data():Dynamic;
	public function test_spectral_helper_raises_magnitude_same_data():Dynamic;
	public function test_spectral_helper_raises_noverlap_eq_NFFT():Dynamic;
	public function test_spectral_helper_raises_noverlap_gt_NFFT():Dynamic;
	public function test_spectral_helper_raises_phase_same_data():Dynamic;
	public function test_spectral_helper_raises_unknown_mode():Dynamic;
	public function test_spectral_helper_raises_unknown_sides():Dynamic;
	public function test_spectral_helper_raises_winlen_ne_NFFT():Dynamic;
}