...
@:pythonImport("matplotlib.tests.test_mlab", "spectral_testcase_nosig_complex_twosided_nopad_to") extern class Spectral_testcase_nosig_complex_twosided_nopad_to {
	/**
