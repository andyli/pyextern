...
@:pythonImport("matplotlib.tests.test_quiver") extern class Test_quiver {
	...
	static public function draw_quiver(ax:Dynamic, kw:Dynamic):Dynamic;
	/**
		call signature::
	...
	**/
	...
	static public function test_quiver_key_memory_leak():Dynamic;
	static public function test_quiver_memory_leak():Dynamic;
}