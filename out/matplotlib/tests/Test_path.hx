...
@:pythonImport("matplotlib.tests.test_path") extern class Test_path {
	...
	**/
	...
	static public function test_contains_points_negative_radius():Dynamic;
	static public function test_point_in_path():Dynamic;
	static public function test_point_in_path_nan():Dynamic;
	static public function test_readonly_path():Dynamic;
