...
@:pythonImport("matplotlib.tests.test_artist") extern class Test_artist {
	...
	**/
	...
	static public function test_collection_transform_of_none():Dynamic;
	static public function test_cull_markers():Dynamic;
	static public function test_patch_transform_of_none():Dynamic;
