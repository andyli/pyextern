...
@:pythonImport("matplotlib.tests.test_arrow_patches") extern class Test_arrow_patches {
	...
	static public function draw_arrow(ax:Dynamic, t:Dynamic, r:Dynamic):Dynamic;
	/**
		call signature::
