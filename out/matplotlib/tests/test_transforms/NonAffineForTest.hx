...
@:pythonImport("matplotlib.tests.test_transforms", "NonAffineForTest") extern class NonAffineForTest {
	...
	**/
	@:native("__init__")
	public function ___init__(real_trans:Dynamic, args:Dynamic, kwargs:Dynamic):Dynamic;
	/**
		Return self<=value.
	**/
