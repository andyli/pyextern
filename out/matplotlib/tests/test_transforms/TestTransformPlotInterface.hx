...
package matplotlib.tests.test_transforms;
@:pythonImport("matplotlib.tests.test_transforms", "TestTransformPlotInterface") extern class TestTransformPlotInterface {
	/**
	...
	**/
	...
	public function test_line_extent_axes_coords():Dynamic;
	public function test_line_extent_compound_coords1():Dynamic;
	public function test_line_extent_compound_coords2():Dynamic;
	public function test_line_extent_data_coords():Dynamic;
	public function test_line_extent_predata_transform_coords():Dynamic;
	public function test_line_extents_affine():Dynamic;
	public function test_line_extents_for_non_affine_transData():Dynamic;
	public function test_line_extents_non_affine():Dynamic;
	public function test_pathc_extents_affine():Dynamic;
	public function test_pathc_extents_non_affine():Dynamic;
}