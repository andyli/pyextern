...
@:pythonImport("matplotlib.tests.test_transforms", "BasicTransformTests") extern class BasicTransformTests {
	/**
	...
	**/
	...
	public function test_affine_simplification():Dynamic;
	public function test_contains_branch():Dynamic;
	public function test_left_to_right_iteration():Dynamic;
	public function test_transform_depth():Dynamic;
	public function test_transform_shortcuts():Dynamic;
}