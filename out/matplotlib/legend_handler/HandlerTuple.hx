...
@:pythonImport("matplotlib.legend_handler", "HandlerTuple") extern class HandlerTuple {
	...
	**/
	@:native("__init__")
	public function ___init__(?ndivide:Dynamic, ?pad:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(?ndivide:Dynamic, ?pad:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Void;
	/**
