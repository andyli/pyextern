...
@:pythonImport("matplotlib.legend_handler", "HandlerBase") extern class HandlerBase {
	...
	**/
	public function __init__(?xpad:Dynamic, ?ypad:Dynamic, ?update_func:Dynamic):Dynamic;
	/**
		Return self<=value.
	**/
