...
@:pythonImport("torch.autograd.profiler_util", "Kernel") extern class Kernel {
	/**
		Return self+value.
	**/
	...
	**/
	...
	/**
		Create new instance of Kernel(name, device, duration)
	**/
	static public function __new__(_cls:Dynamic, name:Dynamic, device:Dynamic, duration:Dynamic):Dynamic;
	/**
		Helper for pickle.
	**/
	...
	**/
	...
	/**
		Make a new Kernel object from a sequence or iterable
	**/
	static public function _make(iterable:Dynamic):Dynamic;
	/**
		Return a new Kernel object replacing specified fields with new values
	**/
