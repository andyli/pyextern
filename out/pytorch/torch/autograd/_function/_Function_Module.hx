...
@:pythonImport("torch.autograd.function") extern class _Function_Module {
	...
	static public function _iter_filter(condition:Dynamic, ?allow_unknown:Dynamic, ?condition_msg:Dynamic, ?conversion:Dynamic):Dynamic;
	...
	static public function _jit_unwrap_structured(obj:Dynamic):Dynamic;
