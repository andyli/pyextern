...
@:pythonImport("torch.autograd.function", "NestedIOFunction") extern class NestedIOFunction {
	...
	**/
	...
	public function backward_extended(?grad_output:python.VarArgs<Dynamic>):Dynamic;
	...
	**/
	...
	public function forward_extended(?input:python.VarArgs<Dynamic>):Dynamic;
