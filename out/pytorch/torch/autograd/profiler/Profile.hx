...
@:pythonImport("torch.autograd.profiler", "profile") extern class Profile {
	...
	**/
	@:native("__init__")
	public function ___init__(?enabled:Dynamic, ?use_cuda:Dynamic, ?record_shapes:Dynamic, ?with_flops:Dynamic, ?profile_memory:Dynamic, ?with_stack:Dynamic, ?with_modules:Dynamic, ?use_kineto:Dynamic, ?use_cpu:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(?enabled:Dynamic, ?use_cuda:Dynamic, ?record_shapes:Dynamic, ?with_flops:Dynamic, ?profile_memory:Dynamic, ?with_stack:Dynamic, ?with_modules:Dynamic, ?use_kineto:Dynamic, ?use_cpu:Dynamic):Void;
	/**
	...
	**/
	...
	public function _parse_kineto_results(result:Dynamic):Dynamic;
	public function _prepare_trace():Dynamic;
