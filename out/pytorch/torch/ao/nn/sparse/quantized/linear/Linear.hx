...
package torch.ao.nn.sparse.quantized.linear;
@:pythonImport("torch.ao.nn.sparse.quantized.linear", "Linear") extern class Linear {
	...
	**/
	...
	static public function _get_name():Dynamic;
	/**
