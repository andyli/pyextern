...
@:pythonImport("torch.ao.nn.sparse.quantized.linear", "LinearPackedParams") extern class LinearPackedParams {
	...
	**/
	@:native("__init__")
	public function ___init__(?row_block_size:Dynamic, ?col_block_size:Dynamic, ?dtype:Dynamic):Dynamic;
	/**
		Initializes internal Module state, shared by both nn.Module and ScriptModule.
	**/
	public function new(?row_block_size:Dynamic, ?col_block_size:Dynamic, ?dtype:Dynamic):Void;
	/**
	...
	**/
	...
	public function set_weight_bias(weight:Dynamic, bias:Dynamic, row_block_size:Dynamic, col_block_size:Dynamic):Dynamic;
	/**
