...
package torch.ao.nn.sparse.quantized._dynamic.linear;
@:pythonImport("torch.ao.nn.sparse.quantized.dynamic.linear", "Linear") extern class Linear {
	...
	/**
		...
		Examples::
		    ...
		    torch.Size([128, 30])
	**/
	static public function _FLOAT_MODULE(in_features:Dynamic, out_features:Dynamic, ?bias:Dynamic, ?device:Dynamic, ?dtype:Dynamic):Dynamic;
	...
	**/
	@:native("__init__")
	public function ___init__(in_features:Dynamic, out_features:Dynamic, row_block_size:Dynamic, col_block_size:Dynamic, ?bias:Dynamic, ?dtype:Dynamic):Dynamic;
	/**
		Initializes internal Module state, shared by both nn.Module and ScriptModule.
	**/
	public function new(in_features:Dynamic, out_features:Dynamic, row_block_size:Dynamic, col_block_size:Dynamic, ?bias:Dynamic, ?dtype:Dynamic):Void;
	/**
	...
	**/
	...
	static public var _op_type : Dynamic;
	/**
	...
	**/
	...
	public function set_weight_bias(w:Dynamic, b:Dynamic, row_block_size:Dynamic, col_block_size:Dynamic):Dynamic;
	/**
