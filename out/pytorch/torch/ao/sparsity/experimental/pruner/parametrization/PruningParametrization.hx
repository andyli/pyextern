...
@:pythonImport("torch.ao.sparsity.experimental.pruner.parametrization", "PruningParametrization") extern class PruningParametrization {
	...
	**/
	@:native("__init__")
	public function ___init__(original_outputs:Dynamic):Dynamic;
	/**
		Initializes internal Module state, shared by both nn.Module and ScriptModule.
	**/
	public function new(original_outputs:Dynamic):Void;
	/**
