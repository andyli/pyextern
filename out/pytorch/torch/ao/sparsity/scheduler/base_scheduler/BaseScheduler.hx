...
package torch.ao.sparsity.scheduler.base_scheduler;
@:pythonImport("torch.ao.sparsity.scheduler.base_scheduler", "BaseScheduler") extern class BaseScheduler {
	...
	**/
	@:native("__init__")
	public function ___init__(sparsifier:Dynamic, ?last_epoch:Dynamic, ?verbose:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(sparsifier:Dynamic, ?last_epoch:Dynamic, ?verbose:Dynamic):Void;
	/**
