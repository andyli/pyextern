...
package torch.ao.sparsity.sparsifier.base_sparsifier;
@:pythonImport("torch.ao.sparsity.sparsifier.base_sparsifier", "BaseSparsifier") extern class BaseSparsifier {
	...
	**/
	@:native("__init__")
	public function ___init__(defaults:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(defaults:Dynamic):Void;
	/**
