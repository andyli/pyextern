...
@:pythonImport("torch.ao.quantization.qconfig", "QConfigDynamic") extern class QConfigDynamic {
	/**
		Return self+value.
	**/
	...
	**/
	...
	/**
		Create new instance of QConfigDynamic(activation, weight)
	**/
	static public function __new__(cls:Dynamic, ?activation:Dynamic, ?weight:Dynamic):Dynamic;
	/**
		Helper for pickle.
	**/
	...
	**/
	...
	/**
		Make a new QConfigDynamic object from a sequence or iterable
	**/
	static public function _make(iterable:Dynamic):Dynamic;
	/**
		Return a new QConfigDynamic object replacing specified fields with new values
	**/
