...
@:pythonImport("torch.ao.quantization.qconfig", "QConfig") extern class QConfig {
	/**
		Return self+value.
	**/
	...
	**/
	...
	/**
		Create new instance of QConfig(activation, weight)
	**/
	...
	**/
	...
	/**
		Make a new QConfig object from a sequence or iterable
	**/
	static public function _make(iterable:Dynamic):Dynamic;
	/**
		Return a new QConfig object replacing specified fields with new values
	**/
