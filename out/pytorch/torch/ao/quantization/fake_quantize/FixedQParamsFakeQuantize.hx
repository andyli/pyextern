...
@:pythonImport("torch.ao.quantization.fake_quantize", "FixedQParamsFakeQuantize") extern class FixedQParamsFakeQuantize {
	...
	**/
	@:native("__init__")
	public function ___init__(scale:Dynamic, zero_point:Dynamic, ?dtype:Dynamic, ?qscheme:Dynamic, ?quant_min:Dynamic, ?quant_max:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(scale:Dynamic, zero_point:Dynamic, ?dtype:Dynamic, ?qscheme:Dynamic, ?quant_min:Dynamic, ?quant_max:Dynamic):Void;
	/**
	...
	**/
	...
	public function disable_fake_quant():Dynamic;
	public function disable_observer():Dynamic;
	/**
	...
	**/
	...
	public function enable_fake_quant(?enabled:Dynamic):Dynamic;
	public function enable_observer(?enabled:Dynamic):Dynamic;
	/**
