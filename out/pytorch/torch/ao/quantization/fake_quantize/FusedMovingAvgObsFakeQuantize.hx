...
@:pythonImport("torch.ao.quantization.fake_quantize", "FusedMovingAvgObsFakeQuantize") extern class FusedMovingAvgObsFakeQuantize {
	...
	**/
	@:native("__init__")
	public function ___init__(?observer:Dynamic, ?quant_min:Dynamic, ?quant_max:Dynamic, ?observer_kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(?observer:Dynamic, ?quant_min:Dynamic, ?quant_max:Dynamic, ?observer_kwargs:python.KwArgs<Dynamic>):Void;
	/**
