...
@:pythonImport("torch.ao.quantization.observer", "MovingAverageMinMaxObserver") extern class MovingAverageMinMaxObserver {
	...
	**/
	@:native("__init__")
	public function ___init__(?averaging_constant:Dynamic, ?dtype:Dynamic, ?qscheme:Dynamic, ?reduce_range:Dynamic, ?quant_min:Dynamic, ?quant_max:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(?averaging_constant:Dynamic, ?dtype:Dynamic, ?qscheme:Dynamic, ?reduce_range:Dynamic, ?quant_min:Dynamic, ?quant_max:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Void;
	/**
