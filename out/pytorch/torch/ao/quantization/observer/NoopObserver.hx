...
@:pythonImport("torch.ao.quantization.observer", "NoopObserver") extern class NoopObserver {
	...
	**/
	@:native("__init__")
	public function ___init__(?dtype:Dynamic, ?custom_op_name:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(?dtype:Dynamic, ?custom_op_name:Dynamic):Void;
	/**
