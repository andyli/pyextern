...
@:pythonImport("torch.ao.quantization.observer", "MovingAveragePerChannelMinMaxObserver") extern class MovingAveragePerChannelMinMaxObserver {
	...
	**/
	@:native("__init__")
	public function ___init__(?averaging_constant:Dynamic, ?ch_axis:Dynamic, ?dtype:Dynamic, ?qscheme:Dynamic, ?reduce_range:Dynamic, ?quant_min:Dynamic, ?quant_max:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(?averaging_constant:Dynamic, ?ch_axis:Dynamic, ?dtype:Dynamic, ?qscheme:Dynamic, ?reduce_range:Dynamic, ?quant_min:Dynamic, ?quant_max:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Void;
	/**
	...
	**/
	...
	public function _forward(x_orig:Dynamic):Dynamic;
	/**
	...
	**/
	...
	public function _load_from_state_dict_script(state_dict:Dynamic, prefix:Dynamic, local_metadata:Dynamic, strict:Dynamic, missing_keys:Dynamic, unexpected_keys:Dynamic, error_msgs:Dynamic):Dynamic;
