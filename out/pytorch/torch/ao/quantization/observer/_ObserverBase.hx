...
@:pythonImport("torch.ao.quantization.observer", "_ObserverBase") extern class _ObserverBase {
	...
	**/
	...
	public function calculate_qparams(?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
