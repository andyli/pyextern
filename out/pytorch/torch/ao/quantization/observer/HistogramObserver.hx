...
@:pythonImport("torch.ao.quantization.observer", "HistogramObserver") extern class HistogramObserver {
	...
	**/
	@:native("__init__")
	public function ___init__(?bins:Dynamic, ?upsample_rate:Dynamic, ?dtype:Dynamic, ?qscheme:Dynamic, ?reduce_range:Dynamic, ?factory_kwargs:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(?bins:Dynamic, ?upsample_rate:Dynamic, ?dtype:Dynamic, ?qscheme:Dynamic, ?reduce_range:Dynamic, ?factory_kwargs:Dynamic):Void;
	/**
	...
	**/
	...
	public function _adjust_min_max(combined_min:Dynamic, combined_max:Dynamic, upsample_rate:Dynamic):Dynamic;
	...
	**/
	public function _calculate_qparams(min_val:Dynamic, max_val:Dynamic):Dynamic;
	public function _call_impl(?input:python.VarArgs<Dynamic>, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	public function _combine_histograms(orig_hist:Dynamic, new_hist:Dynamic, upsample_rate:Dynamic, downsample_rate:Dynamic, start_idx:Dynamic, Nbins:Dynamic):Dynamic;
	/**
		Compute the quantization error if we use start_bin to end_bin as the
		min and max to do the quantization.
	**/
	public function _compute_quantization_error(next_start_bin:Dynamic, next_end_bin:Dynamic):Dynamic;
	/**
	...
	**/
	public function _get_norm(delta_begin:Dynamic, delta_end:Dynamic, density:Dynamic):Dynamic;
	/**
	...
	**/
	public function _non_linear_param_search():Dynamic;
	/**
	...
	**/
	public function _validate_qmin_qmax(quant_min:Dynamic, quant_max:Dynamic):Dynamic;
	...
	**/
	...
	public function calculate_qparams():Dynamic;
	/**
	...
	**/
	public function forward(x_orig:Dynamic):Dynamic;
	/**
	...
	**/
	...
	public function reset_min_max_vals():Dynamic;
	/**
	...
	**/
	...
	/**
		...
		Example::
		    ...
		    False
	**/
	static public function with_args(?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
		...
		Example::
		    ...
		    False
	**/
	static public function with_callable_args(?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
