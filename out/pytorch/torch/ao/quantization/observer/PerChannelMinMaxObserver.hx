...
@:pythonImport("torch.ao.quantization.observer", "PerChannelMinMaxObserver") extern class PerChannelMinMaxObserver {
	...
	**/
	@:native("__init__")
	public function ___init__(?ch_axis:Dynamic, ?dtype:Dynamic, ?qscheme:Dynamic, ?reduce_range:Dynamic, ?quant_min:Dynamic, ?quant_max:Dynamic, ?factory_kwargs:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(?ch_axis:Dynamic, ?dtype:Dynamic, ?qscheme:Dynamic, ?reduce_range:Dynamic, ?quant_min:Dynamic, ?quant_max:Dynamic, ?factory_kwargs:Dynamic):Void;
	/**
