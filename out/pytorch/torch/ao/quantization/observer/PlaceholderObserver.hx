...
@:pythonImport("torch.ao.quantization.observer", "PlaceholderObserver") extern class PlaceholderObserver {
	...
	**/
	@:native("__init__")
	public function ___init__(?dtype:Dynamic, ?custom_op_name:Dynamic, ?compute_dtype:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(?dtype:Dynamic, ?custom_op_name:Dynamic, ?compute_dtype:Dynamic):Void;
	/**
