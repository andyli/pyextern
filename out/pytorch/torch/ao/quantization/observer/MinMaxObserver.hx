...
@:pythonImport("torch.ao.quantization.observer", "MinMaxObserver") extern class MinMaxObserver {
	...
	**/
	@:native("__init__")
	public function ___init__(?dtype:Dynamic, ?qscheme:Dynamic, ?reduce_range:Dynamic, ?quant_min:Dynamic, ?quant_max:Dynamic, ?factory_kwargs:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(?dtype:Dynamic, ?qscheme:Dynamic, ?reduce_range:Dynamic, ?quant_min:Dynamic, ?quant_max:Dynamic, ?factory_kwargs:Dynamic):Void;
	/**
