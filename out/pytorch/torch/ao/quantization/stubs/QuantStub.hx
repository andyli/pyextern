...
package torch.ao.quantization.stubs;
@:pythonImport("torch.ao.quantization.stubs", "QuantStub") extern class QuantStub {
	...
	**/
	@:native("__init__")
	public function ___init__(?qconfig:Dynamic):Dynamic;
	/**
		Initializes internal Module state, shared by both nn.Module and ScriptModule.
	**/
	public function new(?qconfig:Dynamic):Void;
	/**
