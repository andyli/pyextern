...
@:pythonImport("torch.special") extern class Special_Module {
	...
	**/
	...
	static public var multi_dim_common : Dynamic;
	/**
	...
	**/
	static public function multigammaln(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
