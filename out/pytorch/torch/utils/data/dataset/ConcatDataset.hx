...
@:pythonImport("torch.utils.data.dataset", "ConcatDataset") extern class ConcatDataset {
	...
	**/
	@:native("__init__")
	public function ___init__(datasets:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(datasets:Dynamic):Void;
	/**
	...
	**/
	...
	public var cummulative_sizes : Dynamic;
	static public function cumsum(sequence:Dynamic):Dynamic;
