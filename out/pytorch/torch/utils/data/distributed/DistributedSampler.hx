...
@:pythonImport("torch.utils.data.distributed", "DistributedSampler") extern class DistributedSampler {
	...
	**/
	@:native("__init__")
	public function ___init__(dataset:Dynamic, ?num_replicas:Dynamic, ?rank:Dynamic, ?shuffle:Dynamic, ?seed:Dynamic, ?drop_last:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(dataset:Dynamic, ?num_replicas:Dynamic, ?rank:Dynamic, ?shuffle:Dynamic, ?seed:Dynamic, ?drop_last:Dynamic):Void;
	/**
