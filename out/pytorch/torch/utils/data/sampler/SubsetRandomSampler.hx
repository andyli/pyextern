...
@:pythonImport("torch.utils.data.sampler", "SubsetRandomSampler") extern class SubsetRandomSampler {
	...
	**/
	@:native("__init__")
	public function ___init__(indices:Dynamic, ?generator:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(indices:Dynamic, ?generator:Dynamic):Void;
	/**
