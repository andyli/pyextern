...
@:pythonImport("torch.utils.data.sampler", "WeightedRandomSampler") extern class WeightedRandomSampler {
	...
	**/
	@:native("__init__")
	public function ___init__(weights:Dynamic, num_samples:Dynamic, ?replacement:Dynamic, ?generator:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(weights:Dynamic, num_samples:Dynamic, ?replacement:Dynamic, ?generator:Dynamic):Void;
	/**
