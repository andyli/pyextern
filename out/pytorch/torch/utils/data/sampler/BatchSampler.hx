...
@:pythonImport("torch.utils.data.sampler", "BatchSampler") extern class BatchSampler {
	...
	**/
	@:native("__init__")
	public function ___init__(sampler:Dynamic, batch_size:Dynamic, drop_last:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(sampler:Dynamic, batch_size:Dynamic, drop_last:Dynamic):Void;
	/**
