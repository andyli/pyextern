...
@:pythonImport("torch.utils.data.sampler", "RandomSampler") extern class RandomSampler {
	...
	**/
	@:native("__init__")
	public function ___init__(data_source:Dynamic, ?replacement:Dynamic, ?num_samples:Dynamic, ?generator:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(data_source:Dynamic, ?replacement:Dynamic, ?num_samples:Dynamic, ?generator:Dynamic):Void;
	/**
