...
@:pythonImport("torch.utils.data.communication.iter", "QueueWrapper") extern class QueueWrapper {
	...
	**/
	@:native("__init__")
	public function ___init__(protocol:Dynamic, ?response_wait_time:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(protocol:Dynamic, ?response_wait_time:Dynamic):Void;
