...
package torch.utils.data.datapipes.dataframe.structures;
@:pythonImport("torch.utils.data.datapipes.dataframe.structures", "DataChunkDF") extern class DataChunkDF {
	/**
		Return self+value.
	**/
