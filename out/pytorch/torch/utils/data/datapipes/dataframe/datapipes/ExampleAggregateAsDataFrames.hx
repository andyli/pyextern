...
package torch.utils.data.datapipes.dataframe.datapipes;
@:pythonImport("torch.utils.data.datapipes.dataframe.datapipes", "ExampleAggregateAsDataFrames") extern class ExampleAggregateAsDataFrames {
	...
	**/
	@:native("__init__")
	public function ___init__(source_datapipe:Dynamic, ?dataframe_size:Dynamic, ?columns:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(source_datapipe:Dynamic, ?dataframe_size:Dynamic, ?columns:Dynamic):Void;
	...
	**/
	...
	public function _as_list(item:Dynamic):Dynamic;
	public function _is_dfpipe():Dynamic;
