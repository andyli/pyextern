...
@:pythonImport("torch.utils.data.datapipes.dataframe.datapipes", "FilterDataFramesPipe") extern class FilterDataFramesPipe {
	...
	**/
	@:native("__init__")
	public function ___init__(source_datapipe:Dynamic, filter_fn:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(source_datapipe:Dynamic, filter_fn:Dynamic):Void;
