...
@:pythonImport("torch.utils.data.datapipes.dataframe.datapipes", "ConcatDataFramesPipe") extern class ConcatDataFramesPipe {
	...
	**/
	@:native("__init__")
	public function ___init__(source_datapipe:Dynamic, ?batch:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(source_datapipe:Dynamic, ?batch:Dynamic):Void;
