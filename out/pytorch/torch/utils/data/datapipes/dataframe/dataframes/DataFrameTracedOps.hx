...
@:pythonImport("torch.utils.data.datapipes.dataframe.dataframes", "DataFrameTracedOps") extern class DataFrameTracedOps {
	...
	**/
	@:native("__init__")
	public function ___init__(source_datapipe:Dynamic, output_var:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(source_datapipe:Dynamic, output_var:Dynamic):Void;
