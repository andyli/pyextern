...
@:pythonImport("torch.utils.data.datapipes.dataframe.dataframes", "CaptureGetItem") extern class CaptureGetItem {
	...
	**/
	@:native("__init__")
	public function ___init__(left:Dynamic, key:Dynamic, ctx:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(left:Dynamic, key:Dynamic, ctx:Dynamic):Void;
	/**
