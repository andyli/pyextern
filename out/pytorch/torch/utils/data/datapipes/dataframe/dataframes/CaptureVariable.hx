...
@:pythonImport("torch.utils.data.datapipes.dataframe.dataframes", "CaptureVariable") extern class CaptureVariable {
	...
	**/
	@:native("__init__")
	public function ___init__(value:Dynamic, ctx:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(value:Dynamic, ctx:Dynamic):Void;
	/**
