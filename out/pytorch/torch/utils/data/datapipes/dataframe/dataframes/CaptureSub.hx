...
@:pythonImport("torch.utils.data.datapipes.dataframe.dataframes", "CaptureSub") extern class CaptureSub {
	...
	**/
	@:native("__init__")
	public function ___init__(left:Dynamic, right:Dynamic, ctx:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(left:Dynamic, right:Dynamic, ctx:Dynamic):Void;
	/**
