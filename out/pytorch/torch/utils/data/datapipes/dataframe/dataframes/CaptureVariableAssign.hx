...
@:pythonImport("torch.utils.data.datapipes.dataframe.dataframes", "CaptureVariableAssign") extern class CaptureVariableAssign {
	...
	**/
	@:native("__init__")
	public function ___init__(?ctx:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(?ctx:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Void;
	/**
