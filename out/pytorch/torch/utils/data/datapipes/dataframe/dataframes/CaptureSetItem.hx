...
@:pythonImport("torch.utils.data.datapipes.dataframe.dataframes", "CaptureSetItem") extern class CaptureSetItem {
	...
	**/
	@:native("__init__")
	public function ___init__(left:Dynamic, key:Dynamic, value:Dynamic, ctx:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(left:Dynamic, key:Dynamic, value:Dynamic, ctx:Dynamic):Void;
	/**
