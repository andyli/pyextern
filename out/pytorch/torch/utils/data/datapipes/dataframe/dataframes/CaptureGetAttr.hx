...
@:pythonImport("torch.utils.data.datapipes.dataframe.dataframes", "CaptureGetAttr") extern class CaptureGetAttr {
	...
	**/
	@:native("__init__")
	public function ___init__(src:Dynamic, name:Dynamic, ctx:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(src:Dynamic, name:Dynamic, ctx:Dynamic):Void;
	/**
