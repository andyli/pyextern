...
package torch.utils.data.datapipes.iter.fileloader;
@:pythonImport("torch.utils.data.datapipes.iter.fileloader", "FileLoaderIterDataPipe") extern class FileLoaderIterDataPipe {
