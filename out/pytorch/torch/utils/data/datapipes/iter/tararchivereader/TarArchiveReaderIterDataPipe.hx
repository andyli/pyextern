...
package torch.utils.data.datapipes.iter.tararchivereader;
@:pythonImport("torch.utils.data.datapipes.iter.tararchivereader", "TarArchiveReaderIterDataPipe") extern class TarArchiveReaderIterDataPipe {
	...
	**/
	@:native("__init__")
	public function ___init__(datapipe:Dynamic, ?mode:Dynamic, ?length:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(datapipe:Dynamic, ?mode:Dynamic, ?length:Dynamic):Void;
