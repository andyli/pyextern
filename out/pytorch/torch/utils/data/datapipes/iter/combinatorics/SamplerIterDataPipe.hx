...
@:pythonImport("torch.utils.data.datapipes.iter.combinatorics", "SamplerIterDataPipe") extern class SamplerIterDataPipe {
	...
	**/
	@:native("__init__")
	public function ___init__(datapipe:Dynamic, ?sampler:Dynamic, ?sampler_args:Dynamic, ?sampler_kwargs:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(datapipe:Dynamic, ?sampler:Dynamic, ?sampler_args:Dynamic, ?sampler_kwargs:Dynamic):Void;
