...
package torch.utils.data.datapipes.iter.combinatorics;
@:pythonImport("torch.utils.data.datapipes.iter.combinatorics", "ShufflerIterDataPipe") extern class ShufflerIterDataPipe {
	...
	**/
	@:native("__init__")
	public function ___init__(datapipe:Dynamic, ?buffer_size:Dynamic, ?unbatch_level:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(datapipe:Dynamic, ?buffer_size:Dynamic, ?unbatch_level:Dynamic):Void;
	...
	**/
	...
	static public function buffer_replace(buffer:Dynamic, x:Dynamic):Dynamic;
