...
package torch.utils.data.datapipes.iter.ziparchivereader;
@:pythonImport("torch.utils.data.datapipes.iter.ziparchivereader", "ZipArchiveReaderIterDataPipe") extern class ZipArchiveReaderIterDataPipe {
	...
	**/
	@:native("__init__")
	public function ___init__(datapipe:Dynamic, ?length:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(datapipe:Dynamic, ?length:Dynamic):Void;
