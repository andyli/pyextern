...
package torch.utils.data.datapipes.iter.filelister;
@:pythonImport("torch.utils.data.datapipes.iter.filelister", "FileListerIterDataPipe") extern class FileListerIterDataPipe {
	...
	**/
	@:native("__init__")
	public function ___init__(?root:Dynamic, ?masks:Dynamic, ?recursive:Dynamic, ?abspath:Dynamic, ?length:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(?root:Dynamic, ?masks:Dynamic, ?recursive:Dynamic, ?abspath:Dynamic, ?length:Dynamic):Void;
