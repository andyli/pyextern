...
package torch.utils.data.datapipes.iter.selecting;
@:pythonImport("torch.utils.data.datapipes.iter.selecting", "FilterIterDataPipe") extern class FilterIterDataPipe {
	...
	**/
	@:native("__init__")
	public function ___init__(datapipe:Dynamic, filter_fn:Dynamic, ?fn_args:Dynamic, ?fn_kwargs:Dynamic, ?drop_empty_batches:Dynamic, ?nesting_level:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(datapipe:Dynamic, filter_fn:Dynamic, ?fn_args:Dynamic, ?fn_kwargs:Dynamic, ?drop_empty_batches:Dynamic, ?nesting_level:Dynamic):Void;
	...
	**/
	...
	public function _applyFilter(data:Dynamic, nesting_level:Dynamic):Dynamic;
	public function _isNonEmpty(data:Dynamic):Dynamic;
	static public var _is_protocol : Dynamic;
	public function _returnIfTrue(data:Dynamic):Dynamic;
