...
@:pythonImport("torch.utils.data.datapipes.iter.grouping", "BatcherIterDataPipe") extern class BatcherIterDataPipe {
	...
	**/
	@:native("__init__")
	public function ___init__(datapipe:Dynamic, batch_size:Dynamic, ?drop_last:Dynamic, ?unbatch_level:Dynamic, ?wrapper_class:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(datapipe:Dynamic, batch_size:Dynamic, ?drop_last:Dynamic, ?unbatch_level:Dynamic, ?wrapper_class:Dynamic):Void;
