...
@:pythonImport("torch.utils.data.datapipes.iter.grouping", "UnBatcherIterDataPipe") extern class UnBatcherIterDataPipe {
	...
	**/
	@:native("__init__")
	public function ___init__(datapipe:Dynamic, ?unbatch_level:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(datapipe:Dynamic, ?unbatch_level:Dynamic):Void;
	...
	**/
	...
	public function _dive(element:Dynamic, unbatch_level:Dynamic):Dynamic;
