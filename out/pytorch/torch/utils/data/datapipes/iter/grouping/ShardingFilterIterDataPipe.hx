...
@:pythonImport("torch.utils.data.datapipes.iter.grouping", "ShardingFilterIterDataPipe") extern class ShardingFilterIterDataPipe {
	...
	**/
	...
	public function apply_sharding(num_of_instances:Dynamic, instance_id:Dynamic):Dynamic;
	static public var functions : Dynamic;
	public function is_shardable():Dynamic;
