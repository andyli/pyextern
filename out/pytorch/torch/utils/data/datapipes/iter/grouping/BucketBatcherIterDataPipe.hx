...
@:pythonImport("torch.utils.data.datapipes.iter.grouping", "BucketBatcherIterDataPipe") extern class BucketBatcherIterDataPipe {
	...
	**/
	@:native("__init__")
	public function ___init__(datapipe:Dynamic, batch_size:Dynamic, ?drop_last:Dynamic, ?batch_num:Dynamic, ?bucket_num:Dynamic, ?sort_key:Dynamic, ?in_batch_shuffle:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(datapipe:Dynamic, batch_size:Dynamic, ?drop_last:Dynamic, ?batch_num:Dynamic, ?bucket_num:Dynamic, ?sort_key:Dynamic, ?in_batch_shuffle:Dynamic):Void;
