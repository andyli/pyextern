...
package torch.utils.data.datapipes.iter.grouping;
@:pythonImport("torch.utils.data.datapipes.iter.grouping", "GrouperIterDataPipe") extern class GrouperIterDataPipe {
	...
	**/
	@:native("__init__")
	public function ___init__(datapipe:Dynamic, group_key_fn:Dynamic, ?buffer_size:Dynamic, ?group_size:Dynamic, ?unbatch_level:Dynamic, ?guaranteed_group_size:Dynamic, ?drop_remaining:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(datapipe:Dynamic, group_key_fn:Dynamic, ?buffer_size:Dynamic, ?group_size:Dynamic, ?unbatch_level:Dynamic, ?guaranteed_group_size:Dynamic, ?drop_remaining:Dynamic):Void;
	...
	**/
	...
	public function _remove_biggest_key(buffer_elements:Dynamic, buffer_size:Dynamic):Dynamic;
