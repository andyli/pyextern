...
package torch.utils.data.datapipes.iter.streamreader;
@:pythonImport("torch.utils.data.datapipes.iter.streamreader", "StreamReaderIterDataPipe") extern class StreamReaderIterDataPipe {
	...
	**/
	@:native("__init__")
	public function ___init__(datapipe:Dynamic, ?chunk:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(datapipe:Dynamic, ?chunk:Dynamic):Void;
