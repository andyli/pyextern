...
package torch.utils.data.datapipes.iter.httpreader;
@:pythonImport("torch.utils.data.datapipes.iter.httpreader", "HTTPReaderIterDataPipe") extern class HTTPReaderIterDataPipe {
	...
	**/
	@:native("__init__")
	public function ___init__(datapipe:Dynamic, ?timeout:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(datapipe:Dynamic, ?timeout:Dynamic):Void;
