...
package torch.utils.data.datapipes.iter.utils;
@:pythonImport("torch.utils.data.datapipes.iter.utils", "IterableWrapperIterDataPipe") extern class IterableWrapperIterDataPipe {
	...
	**/
	@:native("__init__")
	public function ___init__(iterable:Dynamic, ?deepcopy:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(iterable:Dynamic, ?deepcopy:Dynamic):Void;
