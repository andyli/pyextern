...
@:pythonImport("torch.utils.data.datapipes.iter.combining", "_ForkerIterDataPipe") extern class _ForkerIterDataPipe {
	...
	**/
	@:native("__init__")
	public function ___init__(datapipe:Dynamic, num_instances:Dynamic, ?buffer_size:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(datapipe:Dynamic, num_instances:Dynamic, ?buffer_size:Dynamic):Void;
