...
@:pythonImport("torch.utils.data.datapipes.iter.combining", "DemultiplexerIterDataPipe") extern class DemultiplexerIterDataPipe {
	...
	**/
	static public function __new__(cls:Dynamic, datapipe:Dynamic, num_instances:Dynamic, classifier_fn:Dynamic, ?drop_none:Dynamic, ?buffer_size:Dynamic):Dynamic;
