...
@:pythonImport("torch.utils.data.datapipes.iter.combining", "_ChildDataPipe") extern class _ChildDataPipe {
	...
	**/
	@:native("__init__")
	public function ___init__(main_datapipe:Dynamic, instance_id:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(main_datapipe:Dynamic, instance_id:Dynamic):Void;
	...
	**/
	...
	public function get_generator_by_instance(instance_id:Dynamic):Dynamic;
