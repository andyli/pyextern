...
@:pythonImport("torch.utils.data.datapipes.iter.combining", "MultiplexerIterDataPipe") extern class MultiplexerIterDataPipe {
	...
	**/
	@:native("__init__")
	public function ___init__(?datapipes:python.VarArgs<Dynamic>):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(?datapipes:python.VarArgs<Dynamic>):Void;
