...
@:pythonImport("torch.utils.data.datapipes.iter.combining", "ForkerIterDataPipe") extern class ForkerIterDataPipe {
	...
	**/
	static public function __new__(cls:Dynamic, datapipe:Dynamic, num_instances:Dynamic, ?buffer_size:Dynamic):Dynamic;
