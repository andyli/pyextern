...
package torch.utils.data.datapipes.iter.combining;
@:pythonImport("torch.utils.data.datapipes.iter.combining", "_DemultiplexerIterDataPipe") extern class _DemultiplexerIterDataPipe {
	...
	**/
	@:native("__init__")
	public function ___init__(datapipe:Dynamic, num_instances:Dynamic, classifier_fn:Dynamic, drop_none:Dynamic, buffer_size:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(datapipe:Dynamic, num_instances:Dynamic, classifier_fn:Dynamic, drop_none:Dynamic, buffer_size:Dynamic):Void;
	...
	**/
	...
	public function _find_next(instance_id:Dynamic):Dynamic;
	static public var _is_protocol : Dynamic;
	static public var functions : Dynamic;
	public function get_next_element_by_instance(instance_id:Dynamic):Dynamic;
	public function is_every_instance_exhausted():Dynamic;
	public function is_instance_started(instance_id:Dynamic):Dynamic;
