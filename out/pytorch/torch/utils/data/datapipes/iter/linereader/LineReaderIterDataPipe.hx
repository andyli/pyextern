...
package torch.utils.data.datapipes.iter.linereader;
@:pythonImport("torch.utils.data.datapipes.iter.linereader", "LineReaderIterDataPipe") extern class LineReaderIterDataPipe {
	...
	**/
	@:native("__init__")
	public function ___init__(datapipe:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(datapipe:Dynamic):Void;
