...
package torch.utils.data.datapipes.iter.routeddecoder;
@:pythonImport("torch.utils.data.datapipes.iter.routeddecoder", "RoutedDecoderIterDataPipe") extern class RoutedDecoderIterDataPipe {
	...
	**/
	@:native("__init__")
	public function ___init__(datapipe:Dynamic, ?handlers:python.VarArgs<Dynamic>, ?key_fn:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(datapipe:Dynamic, ?handlers:python.VarArgs<Dynamic>, ?key_fn:Dynamic):Void;
	...
	**/
	...
	public function add_handler(?handler:python.VarArgs<Dynamic>):Dynamic;
