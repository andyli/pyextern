...
@:pythonImport("torch.utils.data.datapipes.iter.callable", "CollatorIterDataPipe") extern class CollatorIterDataPipe {
	...
	**/
	@:native("__init__")
	public function ___init__(datapipe:Dynamic, ?collate_fn:Dynamic, ?fn_args:Dynamic, ?fn_kwargs:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(datapipe:Dynamic, ?collate_fn:Dynamic, ?fn_args:Dynamic, ?fn_kwargs:Dynamic):Void;
