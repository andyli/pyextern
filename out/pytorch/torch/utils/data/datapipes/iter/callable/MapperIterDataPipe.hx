...
package torch.utils.data.datapipes.iter.callable;
@:pythonImport("torch.utils.data.datapipes.iter.callable", "MapperIterDataPipe") extern class MapperIterDataPipe {
	...
	**/
	@:native("__init__")
	public function ___init__(datapipe:Dynamic, fn:Dynamic, ?input_col:Dynamic, ?output_col:Dynamic, ?fn_args:Dynamic, ?fn_kwargs:Dynamic, ?nesting_level:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(datapipe:Dynamic, fn:Dynamic, ?input_col:Dynamic, ?output_col:Dynamic, ?fn_args:Dynamic, ?fn_kwargs:Dynamic, ?nesting_level:Dynamic):Void;
	...
	**/
	...
	public function _apply(data:Dynamic, nesting_level:Dynamic):Dynamic;
	public function _apply_fn(data:Dynamic):Dynamic;
