...
package torch.utils.data.datapipes.map.callable;
@:pythonImport("torch.utils.data.datapipes.map.callable", "MapperMapDataPipe") extern class MapperMapDataPipe {
	...
	**/
	@:native("__init__")
	public function ___init__(datapipe:Dynamic, ?fn:Dynamic, ?fn_args:Dynamic, ?fn_kwargs:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(datapipe:Dynamic, ?fn:Dynamic, ?fn_args:Dynamic, ?fn_kwargs:Dynamic):Void;
	/**
