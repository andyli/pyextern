...
package torch.utils.data.datapipes.map.combining;
@:pythonImport("torch.utils.data.datapipes.map.combining", "ConcaterMapDataPipe") extern class ConcaterMapDataPipe {
