...
@:pythonImport("torch.utils.benchmark.utils.fuzzer") extern class Fuzzer_Module {
	...
	**/
	...
	static public var _DISTRIBUTIONS : Dynamic;
	...
	static public function dtype_size(dtype:Dynamic):Dynamic;
	/**
	...
	**/
	static public function prod(values:Dynamic, ?base:Dynamic):Dynamic;
}