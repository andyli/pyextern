...
@:pythonImport("torch.utils.benchmark.utils.fuzzer", "Fuzzer") extern class Fuzzer {
	...
	**/
	@:native("__init__")
	public function ___init__(parameters:Dynamic, tensors:Dynamic, ?constraints:Dynamic, ?seed:Dynamic):Dynamic;
	/**
		Args:
		    parameters:
		        List of FuzzedParameters which provide specifications
		    ...
		    seed:
		        ...
		        ops will create reproducible Tensors.
	**/
	public function new(parameters:Dynamic, tensors:Dynamic, ?constraints:Dynamic, ?seed:Dynamic):Void;
	/**
