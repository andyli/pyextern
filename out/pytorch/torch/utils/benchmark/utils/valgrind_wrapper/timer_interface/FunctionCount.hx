...
@:pythonImport("torch.utils.benchmark.utils.valgrind_wrapper.timer_interface", "FunctionCount") extern class FunctionCount {
	/**
		Return self+value.
	**/
	...
	**/
	...
	/**
		Create new instance of FunctionCount(count, function)
	**/
	static public function __new__(_cls:Dynamic, count:Dynamic, _function:Dynamic):Dynamic;
	/**
		Helper for pickle.
	**/
	...
	**/
	...
	/**
		Make a new FunctionCount object from a sequence or iterable
	**/
	static public function _make(iterable:Dynamic):Dynamic;
	/**
		Return a new FunctionCount object replacing specified fields with new values
	**/
