...
package torch.utils.benchmark.op_fuzzers.spectral;
@:pythonImport("torch.utils.benchmark.op_fuzzers.spectral", "SpectralOpFuzzer") extern class SpectralOpFuzzer {
	...
	**/
	@:native("__init__")
	public function ___init__(seed:Dynamic, ?dtype:Dynamic, ?cuda:Dynamic, ?probability_regular:Dynamic):Dynamic;
	/**
		Args:
		    parameters:
		        List of FuzzedParameters which provide specifications
		    ...
		    seed:
		        ...
		        ops will create reproducible Tensors.
	**/
	public function new(seed:Dynamic, ?dtype:Dynamic, ?cuda:Dynamic, ?probability_regular:Dynamic):Void;
	/**
