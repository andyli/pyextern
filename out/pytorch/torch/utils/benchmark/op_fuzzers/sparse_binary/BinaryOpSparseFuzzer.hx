...
package torch.utils.benchmark.op_fuzzers.sparse_binary;
@:pythonImport("torch.utils.benchmark.op_fuzzers.sparse_binary", "BinaryOpSparseFuzzer") extern class BinaryOpSparseFuzzer {
