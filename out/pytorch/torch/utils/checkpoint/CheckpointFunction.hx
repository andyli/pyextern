...
@:pythonImport("torch.utils.checkpoint", "CheckpointFunction") extern class CheckpointFunction {
	/**
	...
	**/
	...
	/**
		...
		output.
	**/
	static public function backward(ctx:Dynamic, ?args:python.VarArgs<Dynamic>):Dynamic;
	...
	**/
	static public function forward(ctx:Dynamic, run_function:Dynamic, preserve_rng_state:Dynamic, ?args:python.VarArgs<Dynamic>):Dynamic;
