...
@:pythonImport("torch.utils.bundled_inputs", "InflatableArg") extern class InflatableArg {
	/**
		Return self+value.
	**/
	...
	**/
	...
	/**
		Create new instance of InflatableArg(value, fmt, fmt_fn)
	**/
	static public function __new__(_cls:Dynamic, value:Dynamic, ?fmt:Dynamic, ?fmt_fn:Dynamic):Dynamic;
	/**
		Helper for pickle.
	**/
	...
	**/
	...
	/**
		Make a new InflatableArg object from a sequence or iterable
	**/
	static public function _make(iterable:Dynamic):Dynamic;
	/**
		Return a new InflatableArg object replacing specified fields with new values
	**/
	...
	**/
	public var fmt : Dynamic;
	/**
		Alias for field number 2
	**/
	public var fmt_fn : Dynamic;
	/**
