...
@:pythonImport("torch.utils.hipify.hipify_python", "bcolors") extern class Bcolors {
	static public var BOLD : Dynamic;
	static public var ENDC : Dynamic;
	static public var FAIL : Dynamic;
	static public var HEADER : Dynamic;
	static public var OKBLUE : Dynamic;
	static public var OKGREEN : Dynamic;
