...
@:pythonImport("torch.utils.mkldnn", "MkldnnBatchNorm") extern class MkldnnBatchNorm {
	...
	**/
	@:native("__init__")
	public function ___init__(dense_module:Dynamic):Dynamic;
	/**
		Initializes internal Module state, shared by both nn.Module and ScriptModule.
	**/
	public function new(dense_module:Dynamic):Void;
	/**
