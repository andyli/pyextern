...
package torch.utils.mkldnn;
@:pythonImport("torch.utils.mkldnn", "MkldnnConv2d") extern class MkldnnConv2d {
	...
	**/
	@:native("__init__")
	public function ___init__(dense_module:Dynamic, dtype:Dynamic):Dynamic;
	/**
		Initializes internal Module state, shared by both nn.Module and ScriptModule.
	**/
	public function new(dense_module:Dynamic, dtype:Dynamic):Void;
	/**
