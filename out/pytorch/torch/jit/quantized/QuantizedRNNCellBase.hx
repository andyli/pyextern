...
@:pythonImport("torch.jit.quantized", "QuantizedRNNCellBase") extern class QuantizedRNNCellBase {
	...
	**/
	@:native("__init__")
	public function ___init__(other:Dynamic):Dynamic;
	/**
		Initializes internal Module state, shared by both nn.Module and ScriptModule.
	**/
	public function new(other:Dynamic):Void;
	/**
