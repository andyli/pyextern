...
@:pythonImport("torch.jit.frontend", "UnsupportedNodeError") extern class UnsupportedNodeError {
	/**
		exception cause
	**/
	...
	**/
	@:native("__init__")
	public function ___init__(ctx:Dynamic, offending_node:Dynamic, ?reason:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(ctx:Dynamic, offending_node:Dynamic, ?reason:Dynamic):Void;
	/**
