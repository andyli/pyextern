...
@:pythonImport("torch.nn.modules.transformer", "TransformerEncoderLayer") extern class TransformerEncoderLayer {
	...
	**/
	public function forward(src:Dynamic, ?src_mask:Dynamic, ?src_key_padding_mask:Dynamic):Dynamic;
	/**
