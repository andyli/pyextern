...
@:pythonImport("torch.nn.modules.transformer", "TransformerEncoder") extern class TransformerEncoder {
	...
	**/
	@:native("__init__")
	public function ___init__(encoder_layer:Dynamic, num_layers:Dynamic, ?norm:Dynamic):Dynamic;
	/**
		Initializes internal Module state, shared by both nn.Module and ScriptModule.
	**/
	public function new(encoder_layer:Dynamic, num_layers:Dynamic, ?norm:Dynamic):Void;
	/**
	...
	**/
	public function forward(src:Dynamic, ?mask:Dynamic, ?src_key_padding_mask:Dynamic):Dynamic;
	/**
