...
@:pythonImport("torch.nn.modules.transformer", "Transformer") extern class Transformer {
	...
	**/
	@:native("__init__")
	public function ___init__(?d_model:Dynamic, ?nhead:Dynamic, ?num_encoder_layers:Dynamic, ?num_decoder_layers:Dynamic, ?dim_feedforward:Dynamic, ?dropout:Dynamic, ?activation:Dynamic, ?custom_encoder:Dynamic, ?custom_decoder:Dynamic, ?layer_norm_eps:Dynamic, ?batch_first:Dynamic, ?norm_first:Dynamic, ?device:Dynamic, ?dtype:Dynamic):Dynamic;
	/**
		Initializes internal Module state, shared by both nn.Module and ScriptModule.
	**/
	public function new(?d_model:Dynamic, ?nhead:Dynamic, ?num_encoder_layers:Dynamic, ?num_decoder_layers:Dynamic, ?dim_feedforward:Dynamic, ?dropout:Dynamic, ?activation:Dynamic, ?custom_encoder:Dynamic, ?custom_decoder:Dynamic, ?layer_norm_eps:Dynamic, ?batch_first:Dynamic, ?norm_first:Dynamic, ?device:Dynamic, ?dtype:Dynamic):Void;
	/**
	...
	**/
	public function forward(src:Dynamic, tgt:Dynamic, ?src_mask:Dynamic, ?tgt_mask:Dynamic, ?memory_mask:Dynamic, ?src_key_padding_mask:Dynamic, ?tgt_key_padding_mask:Dynamic, ?memory_key_padding_mask:Dynamic):Dynamic;
	/**
		Generate a square mask for the sequence. The masked positions are filled with float('-inf').
		Unmasked positions are filled with float(0.0).
	**/
	static public function generate_square_subsequent_mask(sz:Dynamic):Dynamic;
	/**
