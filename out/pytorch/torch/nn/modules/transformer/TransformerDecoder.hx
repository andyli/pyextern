...
@:pythonImport("torch.nn.modules.transformer", "TransformerDecoder") extern class TransformerDecoder {
	...
	**/
	@:native("__init__")
	public function ___init__(decoder_layer:Dynamic, num_layers:Dynamic, ?norm:Dynamic):Dynamic;
	/**
		Initializes internal Module state, shared by both nn.Module and ScriptModule.
	**/
	public function new(decoder_layer:Dynamic, num_layers:Dynamic, ?norm:Dynamic):Void;
	/**
