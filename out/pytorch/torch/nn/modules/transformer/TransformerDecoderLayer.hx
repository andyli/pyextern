...
@:pythonImport("torch.nn.modules.transformer", "TransformerDecoderLayer") extern class TransformerDecoderLayer {
	...
	**/
	@:native("__init__")
	public function ___init__(d_model:Dynamic, nhead:Dynamic, ?dim_feedforward:Dynamic, ?dropout:Dynamic, ?activation:Dynamic, ?layer_norm_eps:Dynamic, ?batch_first:Dynamic, ?norm_first:Dynamic, ?device:Dynamic, ?dtype:Dynamic):Dynamic;
	/**
		Initializes internal Module state, shared by both nn.Module and ScriptModule.
	**/
	public function new(d_model:Dynamic, nhead:Dynamic, ?dim_feedforward:Dynamic, ?dropout:Dynamic, ?activation:Dynamic, ?layer_norm_eps:Dynamic, ?batch_first:Dynamic, ?norm_first:Dynamic, ?device:Dynamic, ?dtype:Dynamic):Void;
	/**
	...
	**/
	...
	public function _ff_block(x:Dynamic):Dynamic;
	/**
	...
	**/
	...
	public function _mha_block(x:Dynamic, mem:Dynamic, attn_mask:Dynamic, key_padding_mask:Dynamic):Dynamic;
	/**
	...
	**/
	...
	public function _sa_block(x:Dynamic, attn_mask:Dynamic, key_padding_mask:Dynamic):Dynamic;
	/**
	...
	**/
	public function forward(tgt:Dynamic, memory:Dynamic, ?tgt_mask:Dynamic, ?memory_mask:Dynamic, ?tgt_key_padding_mask:Dynamic, ?memory_key_padding_mask:Dynamic):Dynamic;
	/**
