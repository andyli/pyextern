...
@:pythonImport("torch.nn.modules.activation", "Hardtanh") extern class Hardtanh {
	...
	**/
	@:native("__init__")
	public function ___init__(?min_val:Dynamic, ?max_val:Dynamic, ?inplace:Dynamic, ?min_value:Dynamic, ?max_value:Dynamic):Dynamic;
	/**
		Initializes internal Module state, shared by both nn.Module and ScriptModule.
	**/
	public function new(?min_val:Dynamic, ?max_val:Dynamic, ?inplace:Dynamic, ?min_value:Dynamic, ?max_value:Dynamic):Void;
	/**
