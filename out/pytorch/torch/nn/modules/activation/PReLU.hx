...
@:pythonImport("torch.nn.modules.activation", "PReLU") extern class PReLU {
	...
	**/
	@:native("__init__")
	public function ___init__(?num_parameters:Dynamic, ?init:Dynamic, ?device:Dynamic, ?dtype:Dynamic):Dynamic;
	/**
		Initializes internal Module state, shared by both nn.Module and ScriptModule.
	**/
	public function new(?num_parameters:Dynamic, ?init:Dynamic, ?device:Dynamic, ?dtype:Dynamic):Void;
	/**
