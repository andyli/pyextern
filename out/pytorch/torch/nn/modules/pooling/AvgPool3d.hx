...
@:pythonImport("torch.nn.modules.pooling", "AvgPool3d") extern class AvgPool3d {
	...
	**/
	@:native("__init__")
	public function ___init__(kernel_size:Dynamic, ?stride:Dynamic, ?padding:Dynamic, ?ceil_mode:Dynamic, ?count_include_pad:Dynamic, ?divisor_override:Dynamic):Dynamic;
	/**
		Initializes internal Module state, shared by both nn.Module and ScriptModule.
	**/
	public function new(kernel_size:Dynamic, ?stride:Dynamic, ?padding:Dynamic, ?ceil_mode:Dynamic, ?count_include_pad:Dynamic, ?divisor_override:Dynamic):Void;
	/**
