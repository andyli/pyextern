...
@:pythonImport("torch.nn.modules.pooling", "_LPPoolNd") extern class _LPPoolNd {
	...
	**/
	@:native("__init__")
	public function ___init__(norm_type:Dynamic, kernel_size:Dynamic, ?stride:Dynamic, ?ceil_mode:Dynamic):Dynamic;
	/**
		Initializes internal Module state, shared by both nn.Module and ScriptModule.
	**/
	public function new(norm_type:Dynamic, kernel_size:Dynamic, ?stride:Dynamic, ?ceil_mode:Dynamic):Void;
	/**
