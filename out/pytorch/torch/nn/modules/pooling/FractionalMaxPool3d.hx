...
@:pythonImport("torch.nn.modules.pooling", "FractionalMaxPool3d") extern class FractionalMaxPool3d {
	...
	**/
	@:native("__init__")
	public function ___init__(kernel_size:Dynamic, ?output_size:Dynamic, ?output_ratio:Dynamic, ?return_indices:Dynamic, ?_random_samples:Dynamic):Dynamic;
	/**
		Initializes internal Module state, shared by both nn.Module and ScriptModule.
	**/
	public function new(kernel_size:Dynamic, ?output_size:Dynamic, ?output_ratio:Dynamic, ?return_indices:Dynamic, ?_random_samples:Dynamic):Void;
	/**
