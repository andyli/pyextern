...
package torch.nn.modules.fold;
@:pythonImport("torch.nn.modules.fold", "Fold") extern class Fold {
	...
	**/
	@:native("__init__")
	public function ___init__(output_size:Dynamic, kernel_size:Dynamic, ?dilation:Dynamic, ?padding:Dynamic, ?stride:Dynamic):Dynamic;
	/**
		Initializes internal Module state, shared by both nn.Module and ScriptModule.
	**/
	public function new(output_size:Dynamic, kernel_size:Dynamic, ?dilation:Dynamic, ?padding:Dynamic, ?stride:Dynamic):Void;
	/**
