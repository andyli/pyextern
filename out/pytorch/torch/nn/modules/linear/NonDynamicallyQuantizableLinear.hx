...
@:pythonImport("torch.nn.modules.linear", "NonDynamicallyQuantizableLinear") extern class NonDynamicallyQuantizableLinear {
	...
	**/
	@:native("__init__")
	public function ___init__(in_features:Dynamic, out_features:Dynamic, ?bias:Dynamic, ?device:Dynamic, ?dtype:Dynamic):Dynamic;
	/**
		Initializes internal Module state, shared by both nn.Module and ScriptModule.
	**/
	public function new(in_features:Dynamic, out_features:Dynamic, ?bias:Dynamic, ?device:Dynamic, ?dtype:Dynamic):Void;
	/**
