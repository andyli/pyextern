...
@:pythonImport("torch.nn.modules.linear", "LazyLinear") extern class LazyLinear {
	...
	**/
	@:native("__init__")
	public function ___init__(out_features:Dynamic, ?bias:Dynamic, ?device:Dynamic, ?dtype:Dynamic):Dynamic;
	/**
		Initializes internal Module state, shared by both nn.Module and ScriptModule.
	**/
	public function new(out_features:Dynamic, ?bias:Dynamic, ?device:Dynamic, ?dtype:Dynamic):Void;
	/**
	...
	**/
	...
	/**
		...
		Examples::
		    ...
		    torch.Size([128, 30])
	**/
	static public function cls_to_become(in_features:Dynamic, out_features:Dynamic, ?bias:Dynamic, ?device:Dynamic, ?dtype:Dynamic):Dynamic;
	/**
