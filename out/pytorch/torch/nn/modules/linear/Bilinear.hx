...
@:pythonImport("torch.nn.modules.linear", "Bilinear") extern class Bilinear {
	...
	**/
	@:native("__init__")
	public function ___init__(in1_features:Dynamic, in2_features:Dynamic, out_features:Dynamic, ?bias:Dynamic, ?device:Dynamic, ?dtype:Dynamic):Dynamic;
	/**
		Initializes internal Module state, shared by both nn.Module and ScriptModule.
	**/
	public function new(in1_features:Dynamic, in2_features:Dynamic, out_features:Dynamic, ?bias:Dynamic, ?device:Dynamic, ?dtype:Dynamic):Void;
	/**
	...
	**/
	public function forward(input1:Dynamic, input2:Dynamic):Dynamic;
	/**
