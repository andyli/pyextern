...
@:pythonImport("torch.nn.modules.lazy", "_LazyProtocol") extern class _LazyProtocol {
	...
	**/
	...
	public var _load_hook : Dynamic;
	public var _non_persistent_buffers_set : Dynamic;
