...
@:pythonImport("torch.nn.modules.container", "ModuleDict") extern class ModuleDict {
	...
	**/
	...
	public function __setitem__(key:Dynamic, module:Dynamic):Dynamic;
	...
	**/
	public function update(modules:Dynamic):Dynamic;
	/**
