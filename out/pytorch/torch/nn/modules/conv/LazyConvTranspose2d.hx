...
@:pythonImport("torch.nn.modules.conv", "LazyConvTranspose2d") extern class LazyConvTranspose2d {
	...
	**/
	@:native("__init__")
	public function ___init__(out_channels:Dynamic, kernel_size:Dynamic, ?stride:Dynamic, ?padding:Dynamic, ?output_padding:Dynamic, ?groups:Dynamic, ?bias:Dynamic, ?dilation:Dynamic, ?padding_mode:Dynamic, ?device:Dynamic, ?dtype:Dynamic):Dynamic;
	/**
		Initializes internal Module state, shared by both nn.Module and ScriptModule.
	**/
	public function new(out_channels:Dynamic, kernel_size:Dynamic, ?stride:Dynamic, ?padding:Dynamic, ?output_padding:Dynamic, ?groups:Dynamic, ?bias:Dynamic, ?dilation:Dynamic, ?padding_mode:Dynamic, ?device:Dynamic, ?dtype:Dynamic):Void;
	/**
	...
	**/
	...
	public function _output_padding(input:Dynamic, output_size:Dynamic, stride:Dynamic, padding:Dynamic, kernel_size:Dynamic, ?dilation:Dynamic):Dynamic;
	/**
	...
	**/
	static public function cls_to_become(in_channels:Dynamic, out_channels:Dynamic, kernel_size:Dynamic, ?stride:Dynamic, ?padding:Dynamic, ?output_padding:Dynamic, ?groups:Dynamic, ?bias:Dynamic, ?dilation:Dynamic, ?padding_mode:Dynamic, ?device:Dynamic, ?dtype:Dynamic):Dynamic;
	/**
	...
	**/
	public function initialize_parameters(input:Dynamic):Dynamic;
	/**
