...
@:pythonImport("torch.nn.modules.conv") extern class Conv_Module {
	...
	**/
	...
	static public function _size_3_t(?args:python.VarArgs<Dynamic>, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	static public function _triple(x:Dynamic):Dynamic;
	static public var convolution_notes : Dynamic;
