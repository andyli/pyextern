...
@:pythonImport("torch.nn.modules.conv", "_ConvTransposeNd") extern class _ConvTransposeNd {
	...
	**/
	@:native("__init__")
	public function ___init__(in_channels:Dynamic, out_channels:Dynamic, kernel_size:Dynamic, stride:Dynamic, padding:Dynamic, dilation:Dynamic, transposed:Dynamic, output_padding:Dynamic, groups:Dynamic, bias:Dynamic, padding_mode:Dynamic, ?device:Dynamic, ?dtype:Dynamic):Dynamic;
	/**
		Initializes internal Module state, shared by both nn.Module and ScriptModule.
	**/
	public function new(in_channels:Dynamic, out_channels:Dynamic, kernel_size:Dynamic, stride:Dynamic, padding:Dynamic, dilation:Dynamic, transposed:Dynamic, output_padding:Dynamic, groups:Dynamic, bias:Dynamic, padding_mode:Dynamic, ?device:Dynamic, ?dtype:Dynamic):Void;
	/**
