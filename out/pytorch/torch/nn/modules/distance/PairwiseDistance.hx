...
package torch.nn.modules.distance;
@:pythonImport("torch.nn.modules.distance", "PairwiseDistance") extern class PairwiseDistance {
	...
	**/
	@:native("__init__")
	public function ___init__(?p:Dynamic, ?eps:Dynamic, ?keepdim:Dynamic):Dynamic;
	/**
		Initializes internal Module state, shared by both nn.Module and ScriptModule.
	**/
	public function new(?p:Dynamic, ?eps:Dynamic, ?keepdim:Dynamic):Void;
	/**
