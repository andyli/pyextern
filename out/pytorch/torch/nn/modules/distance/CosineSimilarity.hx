...
@:pythonImport("torch.nn.modules.distance", "CosineSimilarity") extern class CosineSimilarity {
	...
	**/
	@:native("__init__")
	public function ___init__(?dim:Dynamic, ?eps:Dynamic):Dynamic;
	/**
		Initializes internal Module state, shared by both nn.Module and ScriptModule.
	**/
	public function new(?dim:Dynamic, ?eps:Dynamic):Void;
	/**
