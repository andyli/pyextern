...
@:pythonImport("torch.nn.modules.sparse", "EmbeddingBag") extern class EmbeddingBag {
	...
	**/
	@:native("__init__")
	public function ___init__(num_embeddings:Dynamic, embedding_dim:Dynamic, ?max_norm:Dynamic, ?norm_type:Dynamic, ?scale_grad_by_freq:Dynamic, ?mode:Dynamic, ?sparse:Dynamic, ?_weight:Dynamic, ?include_last_offset:Dynamic, ?padding_idx:Dynamic, ?device:Dynamic, ?dtype:Dynamic):Dynamic;
	/**
		Initializes internal Module state, shared by both nn.Module and ScriptModule.
	**/
	public function new(num_embeddings:Dynamic, embedding_dim:Dynamic, ?max_norm:Dynamic, ?norm_type:Dynamic, ?scale_grad_by_freq:Dynamic, ?mode:Dynamic, ?sparse:Dynamic, ?_weight:Dynamic, ?include_last_offset:Dynamic, ?padding_idx:Dynamic, ?device:Dynamic, ?dtype:Dynamic):Void;
	/**
	...
	**/
	...
	public function _fill_padding_idx_with_zero():Dynamic;
	/**
	...
	**/
	public function forward(input:Dynamic, ?offsets:Dynamic, ?per_sample_weights:Dynamic):Dynamic;
	/**
	...
	**/
	static public function from_pretrained(embeddings:Dynamic, ?freeze:Dynamic, ?max_norm:Dynamic, ?norm_type:Dynamic, ?scale_grad_by_freq:Dynamic, ?mode:Dynamic, ?sparse:Dynamic, ?include_last_offset:Dynamic, ?padding_idx:Dynamic):Dynamic;
	/**
