...
@:pythonImport("torch.nn.modules.adaptive", "_ASMoutput") extern class _ASMoutput {
	/**
		Return self+value.
	**/
	...
	**/
	...
	/**
		Create new instance of _ASMoutput(output, loss)
	**/
	static public function __new__(_cls:Dynamic, output:Dynamic, loss:Dynamic):Dynamic;
	/**
		Helper for pickle.
	**/
	...
	**/
	...
	/**
		Make a new _ASMoutput object from a sequence or iterable
	**/
	static public function _make(iterable:Dynamic):Dynamic;
	/**
		Return a new _ASMoutput object replacing specified fields with new values
	**/
