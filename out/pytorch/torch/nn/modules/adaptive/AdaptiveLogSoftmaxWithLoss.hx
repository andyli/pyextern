...
@:pythonImport("torch.nn.modules.adaptive", "AdaptiveLogSoftmaxWithLoss") extern class AdaptiveLogSoftmaxWithLoss {
	...
	**/
	@:native("__init__")
	public function ___init__(in_features:Dynamic, n_classes:Dynamic, cutoffs:Dynamic, ?div_value:Dynamic, ?head_bias:Dynamic, ?device:Dynamic, ?dtype:Dynamic):Dynamic;
	/**
		Initializes internal Module state, shared by both nn.Module and ScriptModule.
	**/
	public function new(in_features:Dynamic, n_classes:Dynamic, cutoffs:Dynamic, ?div_value:Dynamic, ?head_bias:Dynamic, ?device:Dynamic, ?dtype:Dynamic):Void;
	/**
	...
	**/
	public function _get_full_log_prob(input:Dynamic, head_output:Dynamic):Dynamic;
	...
	**/
	public function log_prob(input:Dynamic):Dynamic;
	/**
	...
	**/
	...
	/**
		...
		Shape:
		    ...
		    - Output: :math:`(N)`
	**/
	public function predict(input:Dynamic):Dynamic;
	/**
