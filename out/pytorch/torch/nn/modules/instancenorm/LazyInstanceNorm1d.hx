...
@:pythonImport("torch.nn.modules.instancenorm", "LazyInstanceNorm1d") extern class LazyInstanceNorm1d {
	...
	**/
	@:native("__init__")
	public function ___init__(?eps:Dynamic, ?momentum:Dynamic, ?affine:Dynamic, ?track_running_stats:Dynamic, ?device:Dynamic, ?dtype:Dynamic):Dynamic;
	/**
		Initializes internal Module state, shared by both nn.Module and ScriptModule.
	**/
	public function new(?eps:Dynamic, ?momentum:Dynamic, ?affine:Dynamic, ?track_running_stats:Dynamic, ?device:Dynamic, ?dtype:Dynamic):Void;
	/**
	...
	**/
	...
	/**
		...
		Examples::
		    ...
		    >>> output = m(input)
	**/
	static public function cls_to_become(num_features:Dynamic, ?eps:Dynamic, ?momentum:Dynamic, ?affine:Dynamic, ?track_running_stats:Dynamic, ?device:Dynamic, ?dtype:Dynamic):Dynamic;
	/**
