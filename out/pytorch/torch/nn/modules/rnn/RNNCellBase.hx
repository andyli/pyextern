...
@:pythonImport("torch.nn.modules.rnn", "RNNCellBase") extern class RNNCellBase {
	...
	**/
	@:native("__init__")
	public function ___init__(input_size:Dynamic, hidden_size:Dynamic, bias:Dynamic, num_chunks:Dynamic, ?device:Dynamic, ?dtype:Dynamic):Dynamic;
	/**
		Initializes internal Module state, shared by both nn.Module and ScriptModule.
	**/
	public function new(input_size:Dynamic, hidden_size:Dynamic, bias:Dynamic, num_chunks:Dynamic, ?device:Dynamic, ?dtype:Dynamic):Void;
	/**
