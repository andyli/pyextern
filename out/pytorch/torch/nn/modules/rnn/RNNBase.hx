...
@:pythonImport("torch.nn.modules.rnn", "RNNBase") extern class RNNBase {
	...
	**/
	@:native("__init__")
	public function ___init__(mode:Dynamic, input_size:Dynamic, hidden_size:Dynamic, ?num_layers:Dynamic, ?bias:Dynamic, ?batch_first:Dynamic, ?dropout:Dynamic, ?bidirectional:Dynamic, ?proj_size:Dynamic, ?device:Dynamic, ?dtype:Dynamic):Dynamic;
	/**
		Initializes internal Module state, shared by both nn.Module and ScriptModule.
	**/
	public function new(mode:Dynamic, input_size:Dynamic, hidden_size:Dynamic, ?num_layers:Dynamic, ?bias:Dynamic, ?batch_first:Dynamic, ?dropout:Dynamic, ?bidirectional:Dynamic, ?proj_size:Dynamic, ?device:Dynamic, ?dtype:Dynamic):Void;
	/**
	...
	**/
	...
	public var all_weights : Dynamic;
	/**
	...
	**/
	public function flatten_parameters():Dynamic;
	/**
