...
@:pythonImport("torch.nn.modules.rnn", "RNNCell") extern class RNNCell {
	...
	**/
	@:native("__init__")
	public function ___init__(input_size:Dynamic, hidden_size:Dynamic, ?bias:Dynamic, ?nonlinearity:Dynamic, ?device:Dynamic, ?dtype:Dynamic):Dynamic;
	/**
		Initializes internal Module state, shared by both nn.Module and ScriptModule.
	**/
	public function new(input_size:Dynamic, hidden_size:Dynamic, ?bias:Dynamic, ?nonlinearity:Dynamic, ?device:Dynamic, ?dtype:Dynamic):Void;
	/**
