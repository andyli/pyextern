...
@:pythonImport("torch.nn.modules.normalization", "LayerNorm") extern class LayerNorm {
	...
	**/
	@:native("__init__")
	public function ___init__(normalized_shape:Dynamic, ?eps:Dynamic, ?elementwise_affine:Dynamic, ?device:Dynamic, ?dtype:Dynamic):Dynamic;
	/**
		Initializes internal Module state, shared by both nn.Module and ScriptModule.
	**/
	public function new(normalized_shape:Dynamic, ?eps:Dynamic, ?elementwise_affine:Dynamic, ?device:Dynamic, ?dtype:Dynamic):Void;
	/**
