...
@:pythonImport("torch.nn.modules.batchnorm", "SyncBatchNorm") extern class SyncBatchNorm {
	...
	**/
	@:native("__init__")
	public function ___init__(num_features:Dynamic, ?eps:Dynamic, ?momentum:Dynamic, ?affine:Dynamic, ?track_running_stats:Dynamic, ?process_group:Dynamic, ?device:Dynamic, ?dtype:Dynamic):Dynamic;
	/**
		Initializes internal Module state, shared by both nn.Module and ScriptModule.
	**/
	public function new(num_features:Dynamic, ?eps:Dynamic, ?momentum:Dynamic, ?affine:Dynamic, ?track_running_stats:Dynamic, ?process_group:Dynamic, ?device:Dynamic, ?dtype:Dynamic):Void;
	/**
	...
	**/
	...
	public function _check_input_dim(input:Dynamic):Dynamic;
	public function _check_non_zero_input_channels(input:Dynamic):Dynamic;
	/**
	...
	**/
	static public function convert_sync_batchnorm(module:Dynamic, ?process_group:Dynamic):Dynamic;
	/**
