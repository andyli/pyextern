...
@:pythonImport("torch.nn.modules.batchnorm", "_NormBase") extern class _NormBase {
	...
	**/
	@:native("__init__")
	public function ___init__(num_features:Dynamic, ?eps:Dynamic, ?momentum:Dynamic, ?affine:Dynamic, ?track_running_stats:Dynamic, ?device:Dynamic, ?dtype:Dynamic):Dynamic;
	/**
		Initializes internal Module state, shared by both nn.Module and ScriptModule.
	**/
	public function new(num_features:Dynamic, ?eps:Dynamic, ?momentum:Dynamic, ?affine:Dynamic, ?track_running_stats:Dynamic, ?device:Dynamic, ?dtype:Dynamic):Void;
	/**
