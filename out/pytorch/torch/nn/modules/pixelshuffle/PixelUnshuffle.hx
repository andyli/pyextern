...
@:pythonImport("torch.nn.modules.pixelshuffle", "PixelUnshuffle") extern class PixelUnshuffle {
	...
	**/
	@:native("__init__")
	public function ___init__(downscale_factor:Dynamic):Dynamic;
	/**
		Initializes internal Module state, shared by both nn.Module and ScriptModule.
	**/
	public function new(downscale_factor:Dynamic):Void;
	/**
