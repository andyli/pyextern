...
package torch.nn.modules.channelshuffle;
@:pythonImport("torch.nn.modules.channelshuffle", "ChannelShuffle") extern class ChannelShuffle {
	...
	**/
	@:native("__init__")
	public function ___init__(groups:Dynamic):Dynamic;
	/**
		Initializes internal Module state, shared by both nn.Module and ScriptModule.
	**/
	public function new(groups:Dynamic):Void;
	/**
