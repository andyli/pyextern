...
package torch.nn.modules.flatten;
@:pythonImport("torch.nn.modules.flatten", "Unflatten") extern class Unflatten {
	static public function NamedShape(?args:python.VarArgs<Dynamic>, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	...
	**/
	@:native("__init__")
	public function ___init__(dim:Dynamic, unflattened_size:Dynamic):Dynamic;
	/**
		Initializes internal Module state, shared by both nn.Module and ScriptModule.
	**/
	public function new(dim:Dynamic, unflattened_size:Dynamic):Void;
	/**
	...
	**/
	...
	public function _require_tuple_int(input:Dynamic):Dynamic;
	public function _require_tuple_tuple(input:Dynamic):Dynamic;
	/**
