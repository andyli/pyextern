...
@:pythonImport("torch.nn.modules.flatten", "Flatten") extern class Flatten {
	...
	**/
	@:native("__init__")
	public function ___init__(?start_dim:Dynamic, ?end_dim:Dynamic):Dynamic;
	/**
		Initializes internal Module state, shared by both nn.Module and ScriptModule.
	**/
	public function new(?start_dim:Dynamic, ?end_dim:Dynamic):Void;
	/**
