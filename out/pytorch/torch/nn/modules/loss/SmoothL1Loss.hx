...
@:pythonImport("torch.nn.modules.loss", "SmoothL1Loss") extern class SmoothL1Loss {
	...
	**/
	@:native("__init__")
	public function ___init__(?size_average:Dynamic, ?reduce:Dynamic, ?reduction:Dynamic, ?beta:Dynamic):Dynamic;
	/**
		Initializes internal Module state, shared by both nn.Module and ScriptModule.
	**/
	public function new(?size_average:Dynamic, ?reduce:Dynamic, ?reduction:Dynamic, ?beta:Dynamic):Void;
	/**
