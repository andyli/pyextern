...
@:pythonImport("torch.nn.modules.loss", "CTCLoss") extern class CTCLoss {
	...
	**/
	@:native("__init__")
	public function ___init__(?blank:Dynamic, ?reduction:Dynamic, ?zero_infinity:Dynamic):Dynamic;
	/**
		Initializes internal Module state, shared by both nn.Module and ScriptModule.
	**/
	public function new(?blank:Dynamic, ?reduction:Dynamic, ?zero_infinity:Dynamic):Void;
	/**
	...
	**/
	public function forward(log_probs:Dynamic, targets:Dynamic, input_lengths:Dynamic, target_lengths:Dynamic):Dynamic;
	/**
