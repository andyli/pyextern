...
@:pythonImport("torch.nn.modules.loss", "GaussianNLLLoss") extern class GaussianNLLLoss {
	...
	**/
	@:native("__init__")
	public function ___init__(?full:Dynamic, ?eps:Dynamic, ?reduction:Dynamic):Dynamic;
	/**
		Initializes internal Module state, shared by both nn.Module and ScriptModule.
	**/
	public function new(?full:Dynamic, ?eps:Dynamic, ?reduction:Dynamic):Void;
	/**
	...
	**/
	public function forward(input:Dynamic, target:Dynamic, _var:Dynamic):Dynamic;
	/**
