...
@:pythonImport("torch.nn.modules.loss", "MultiMarginLoss") extern class MultiMarginLoss {
	...
	**/
	@:native("__init__")
	public function ___init__(?p:Dynamic, ?margin:Dynamic, ?weight:Dynamic, ?size_average:Dynamic, ?reduce:Dynamic, ?reduction:Dynamic):Dynamic;
	/**
		Initializes internal Module state, shared by both nn.Module and ScriptModule.
	**/
	public function new(?p:Dynamic, ?margin:Dynamic, ?weight:Dynamic, ?size_average:Dynamic, ?reduce:Dynamic, ?reduction:Dynamic):Void;
	/**
