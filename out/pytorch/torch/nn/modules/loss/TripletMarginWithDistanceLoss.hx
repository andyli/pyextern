...
@:pythonImport("torch.nn.modules.loss", "TripletMarginWithDistanceLoss") extern class TripletMarginWithDistanceLoss {
	...
	**/
	@:native("__init__")
	public function ___init__(?distance_function:Dynamic, ?margin:Dynamic, ?swap:Dynamic, ?reduction:Dynamic):Dynamic;
	/**
		Initializes internal Module state, shared by both nn.Module and ScriptModule.
	**/
	public function new(?distance_function:Dynamic, ?margin:Dynamic, ?swap:Dynamic, ?reduction:Dynamic):Void;
	/**
