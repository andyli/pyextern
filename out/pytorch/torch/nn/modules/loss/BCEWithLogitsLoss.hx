...
@:pythonImport("torch.nn.modules.loss", "BCEWithLogitsLoss") extern class BCEWithLogitsLoss {
	...
	**/
	@:native("__init__")
	public function ___init__(?weight:Dynamic, ?size_average:Dynamic, ?reduce:Dynamic, ?reduction:Dynamic, ?pos_weight:Dynamic):Dynamic;
	/**
		Initializes internal Module state, shared by both nn.Module and ScriptModule.
	**/
	public function new(?weight:Dynamic, ?size_average:Dynamic, ?reduce:Dynamic, ?reduction:Dynamic, ?pos_weight:Dynamic):Void;
	/**
