...
@:pythonImport("torch.nn.modules.loss", "CrossEntropyLoss") extern class CrossEntropyLoss {
	...
	**/
	@:native("__init__")
	public function ___init__(?weight:Dynamic, ?size_average:Dynamic, ?ignore_index:Dynamic, ?reduce:Dynamic, ?reduction:Dynamic, ?label_smoothing:Dynamic):Dynamic;
	/**
		Initializes internal Module state, shared by both nn.Module and ScriptModule.
	**/
	public function new(?weight:Dynamic, ?size_average:Dynamic, ?ignore_index:Dynamic, ?reduce:Dynamic, ?reduction:Dynamic, ?label_smoothing:Dynamic):Void;
	/**
