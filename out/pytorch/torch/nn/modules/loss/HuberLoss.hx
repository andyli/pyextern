...
@:pythonImport("torch.nn.modules.loss", "HuberLoss") extern class HuberLoss {
	...
	**/
	@:native("__init__")
	public function ___init__(?reduction:Dynamic, ?delta:Dynamic):Dynamic;
	/**
		Initializes internal Module state, shared by both nn.Module and ScriptModule.
	**/
	public function new(?reduction:Dynamic, ?delta:Dynamic):Void;
	/**
