...
@:pythonImport("torch.nn.modules.loss", "KLDivLoss") extern class KLDivLoss {
	...
	**/
	@:native("__init__")
	public function ___init__(?size_average:Dynamic, ?reduce:Dynamic, ?reduction:Dynamic, ?log_target:Dynamic):Dynamic;
	/**
		Initializes internal Module state, shared by both nn.Module and ScriptModule.
	**/
	public function new(?size_average:Dynamic, ?reduce:Dynamic, ?reduction:Dynamic, ?log_target:Dynamic):Void;
	/**
