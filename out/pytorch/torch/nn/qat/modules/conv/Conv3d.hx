...
package torch.nn.qat.modules.conv;
@:pythonImport("torch.nn.qat.modules.conv", "Conv3d") extern class Conv3d {
	...
	**/
	@:native("__init__")
	public function ___init__(in_channels:Dynamic, out_channels:Dynamic, kernel_size:Dynamic, ?stride:Dynamic, ?padding:Dynamic, ?dilation:Dynamic, ?groups:Dynamic, ?bias:Dynamic, ?padding_mode:Dynamic, ?qconfig:Dynamic, ?device:Dynamic, ?dtype:Dynamic):Dynamic;
	/**
		Initializes internal Module state, shared by both nn.Module and ScriptModule.
	**/
	public function new(in_channels:Dynamic, out_channels:Dynamic, kernel_size:Dynamic, ?stride:Dynamic, ?padding:Dynamic, ?dilation:Dynamic, ?groups:Dynamic, ?bias:Dynamic, ?padding_mode:Dynamic, ?qconfig:Dynamic, ?device:Dynamic, ?dtype:Dynamic):Void;
	/**
