...
package torch.nn.qat.modules.linear;
@:pythonImport("torch.nn.qat.modules.linear", "Linear") extern class Linear {
	...
	**/
	@:native("__init__")
	public function ___init__(in_features:Dynamic, out_features:Dynamic, ?bias:Dynamic, ?qconfig:Dynamic, ?device:Dynamic, ?dtype:Dynamic):Dynamic;
	/**
		Initializes internal Module state, shared by both nn.Module and ScriptModule.
	**/
	public function new(in_features:Dynamic, out_features:Dynamic, ?bias:Dynamic, ?qconfig:Dynamic, ?device:Dynamic, ?dtype:Dynamic):Void;
	/**
