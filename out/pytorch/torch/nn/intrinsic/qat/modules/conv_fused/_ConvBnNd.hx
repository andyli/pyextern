...
@:pythonImport("torch.nn.intrinsic.qat.modules.conv_fused", "_ConvBnNd") extern class _ConvBnNd {
	static public var T_destination : Dynamic;
	static public var _FLOAT_MODULE : Dynamic;
	...
	**/
	@:native("__init__")
	public function ___init__(in_channels:Dynamic, out_channels:Dynamic, kernel_size:Dynamic, stride:Dynamic, padding:Dynamic, dilation:Dynamic, transposed:Dynamic, output_padding:Dynamic, groups:Dynamic, bias:Dynamic, padding_mode:Dynamic, ?eps:Dynamic, ?momentum:Dynamic, ?freeze_bn:Dynamic, ?qconfig:Dynamic, ?dim:Dynamic):Dynamic;
	/**
		Initializes internal Module state, shared by both nn.Module and ScriptModule.
	**/
	public function new(in_channels:Dynamic, out_channels:Dynamic, kernel_size:Dynamic, stride:Dynamic, padding:Dynamic, dilation:Dynamic, transposed:Dynamic, output_padding:Dynamic, groups:Dynamic, bias:Dynamic, padding_mode:Dynamic, ?eps:Dynamic, ?momentum:Dynamic, ?freeze_bn:Dynamic, ?qconfig:Dynamic, ?dim:Dynamic):Void;
	/**
