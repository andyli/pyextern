...
@:pythonImport("torch.nn.intrinsic.qat.modules.conv_fused", "ConvReLU2d") extern class ConvReLU2d {
	static public var T_destination : Dynamic;
	static public var _FLOAT_BN_MODULE : Dynamic;
	/**
	...
	**/
	static public function _FLOAT_MODULE(conv:Dynamic, relu:Dynamic):Dynamic;
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(in_channels:Dynamic, out_channels:Dynamic, kernel_size:Dynamic, ?stride:Dynamic, ?padding:Dynamic, ?dilation:Dynamic, ?groups:Dynamic, ?bias:Dynamic, ?padding_mode:Dynamic, ?qconfig:Dynamic):Dynamic;
	/**
		Initializes internal Module state, shared by both nn.Module and ScriptModule.
	**/
	public function new(in_channels:Dynamic, out_channels:Dynamic, kernel_size:Dynamic, ?stride:Dynamic, ?padding:Dynamic, ?dilation:Dynamic, ?groups:Dynamic, ?bias:Dynamic, ?padding_mode:Dynamic, ?qconfig:Dynamic):Void;
	/**
