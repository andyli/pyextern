...
@:pythonImport("torch.nn.intrinsic.qat.modules.conv_fused", "ConvBn1d") extern class ConvBn1d {
	...
	**/
	static public function _FLOAT_MODULE(conv:Dynamic, bn:Dynamic):Dynamic;
	static public var _FLOAT_RELU_MODULE : Dynamic;
