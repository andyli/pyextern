...
package torch.nn.intrinsic.qat.modules.conv_fused;
@:pythonImport("torch.nn.intrinsic.qat.modules.conv_fused", "ConvBnReLU3d") extern class ConvBnReLU3d {
	...
	/**
		...
		Examples::
		    ...
		    >>> output = m(input)
	**/
	static public function _FLOAT_BN_MODULE(num_features:Dynamic, ?eps:Dynamic, ?momentum:Dynamic, ?affine:Dynamic, ?track_running_stats:Dynamic, ?device:Dynamic, ?dtype:Dynamic):Dynamic;
	/**
	...
	**/
	static public function _FLOAT_CONV_MODULE(in_channels:Dynamic, out_channels:Dynamic, kernel_size:Dynamic, ?stride:Dynamic, ?padding:Dynamic, ?dilation:Dynamic, ?groups:Dynamic, ?bias:Dynamic, ?padding_mode:Dynamic, ?device:Dynamic, ?dtype:Dynamic):Dynamic;
	/**
		This is a sequential container which calls the Conv 3d, Batch Norm 3d, and ReLU modules.
		During quantization this will be replaced with the corresponding fused module.
	**/
	static public function _FLOAT_MODULE(conv:Dynamic, bn:Dynamic, relu:Dynamic):Dynamic;
	/**
	...
	**/
	static public function _FLOAT_RELU_MODULE(?inplace:Dynamic):Dynamic;
	...
	**/
	...
	public function __delitem__(idx:Dynamic):Dynamic;
	...
	**/
	@:native("__init__")
	public function ___init__(in_channels:Dynamic, out_channels:Dynamic, kernel_size:Dynamic, ?stride:Dynamic, ?padding:Dynamic, ?dilation:Dynamic, ?groups:Dynamic, ?bias:Dynamic, ?padding_mode:Dynamic, ?eps:Dynamic, ?momentum:Dynamic, ?freeze_bn:Dynamic, ?qconfig:Dynamic):Dynamic;
	/**
		Initializes internal Module state, shared by both nn.Module and ScriptModule.
	**/
	public function new(in_channels:Dynamic, out_channels:Dynamic, kernel_size:Dynamic, ?stride:Dynamic, ?padding:Dynamic, ?dilation:Dynamic, ?groups:Dynamic, ?bias:Dynamic, ?padding_mode:Dynamic, ?eps:Dynamic, ?momentum:Dynamic, ?freeze_bn:Dynamic, ?qconfig:Dynamic):Void;
	/**
	...
	**/
	...
	public function __setitem__(idx:Dynamic, module:Dynamic):Dynamic;
	...
	**/
	...
	public function _conv_forward(input:Dynamic, weight:Dynamic, bias:Dynamic):Dynamic;
	public function _forward(input:Dynamic):Dynamic;
	/**
	...
	**/
	public function _get_item_by_idx(iterator:Dynamic, idx:Dynamic):Dynamic;
	...
	**/
	...
	public function freeze_bn_stats():Dynamic;
	/**
	...
	**/
	...
	public function reset_bn_parameters():Dynamic;
	public function reset_parameters():Dynamic;
	public function reset_running_stats():Dynamic;
	/**
	...
	**/
	...
	public function to_float():Dynamic;
	/**
	...
	**/
	...
	public function update_bn_stats():Dynamic;
	/**
