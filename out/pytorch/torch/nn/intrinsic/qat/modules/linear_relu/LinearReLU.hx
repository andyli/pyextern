...
package torch.nn.intrinsic.qat.modules.linear_relu;
@:pythonImport("torch.nn.intrinsic.qat.modules.linear_relu", "LinearReLU") extern class LinearReLU {
	static public var T_destination : Dynamic;
	/**
		This is a sequential container which calls the Linear and ReLU modules.
		During quantization this will be replaced with the corresponding fused module.
	**/
	static public function _FLOAT_MODULE(linear:Dynamic, relu:Dynamic):Dynamic;
	...
	**/
	@:native("__init__")
	public function ___init__(in_features:Dynamic, out_features:Dynamic, ?bias:Dynamic, ?qconfig:Dynamic):Dynamic;
	/**
		Initializes internal Module state, shared by both nn.Module and ScriptModule.
	**/
	public function new(in_features:Dynamic, out_features:Dynamic, ?bias:Dynamic, ?qconfig:Dynamic):Void;
	/**
