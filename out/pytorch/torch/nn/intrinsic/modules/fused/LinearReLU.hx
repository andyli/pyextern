...
@:pythonImport("torch.nn.intrinsic.modules.fused", "LinearReLU") extern class LinearReLU {
	...
	**/
	@:native("__init__")
	public function ___init__(linear:Dynamic, relu:Dynamic):Dynamic;
	/**
		Initializes internal Module state, shared by both nn.Module and ScriptModule.
	**/
	public function new(linear:Dynamic, relu:Dynamic):Void;
	/**
