...
@:pythonImport("torch.nn.intrinsic.modules.fused", "ConvBn1d") extern class ConvBn1d {
	...
	**/
	@:native("__init__")
	public function ___init__(conv:Dynamic, bn:Dynamic):Dynamic;
	/**
		Initializes internal Module state, shared by both nn.Module and ScriptModule.
	**/
	public function new(conv:Dynamic, bn:Dynamic):Void;
	/**
