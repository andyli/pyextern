...
@:pythonImport("torch.nn.intrinsic.modules.fused", "BNReLU3d") extern class BNReLU3d {
	...
	**/
	@:native("__init__")
	public function ___init__(batch_norm:Dynamic, relu:Dynamic):Dynamic;
	/**
		Initializes internal Module state, shared by both nn.Module and ScriptModule.
	**/
	public function new(batch_norm:Dynamic, relu:Dynamic):Void;
	/**
