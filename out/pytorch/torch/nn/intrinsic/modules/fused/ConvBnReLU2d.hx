...
package torch.nn.intrinsic.modules.fused;
@:pythonImport("torch.nn.intrinsic.modules.fused", "ConvBnReLU2d") extern class ConvBnReLU2d {
	...
	**/
	@:native("__init__")
	public function ___init__(conv:Dynamic, bn:Dynamic, relu:Dynamic):Dynamic;
	/**
		Initializes internal Module state, shared by both nn.Module and ScriptModule.
	**/
	public function new(conv:Dynamic, bn:Dynamic, relu:Dynamic):Void;
	/**
