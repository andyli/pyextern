...
@:pythonImport("torch.nn.intrinsic.modules.fused", "ConvReLU2d") extern class ConvReLU2d {
	...
	**/
	@:native("__init__")
	public function ___init__(conv:Dynamic, relu:Dynamic):Dynamic;
	/**
		Initializes internal Module state, shared by both nn.Module and ScriptModule.
	**/
	public function new(conv:Dynamic, relu:Dynamic):Void;
	/**
