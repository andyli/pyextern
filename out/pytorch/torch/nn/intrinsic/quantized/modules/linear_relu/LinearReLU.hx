...
package torch.nn.intrinsic.quantized.modules.linear_relu;
@:pythonImport("torch.nn.intrinsic.quantized.modules.linear_relu", "LinearReLU") extern class LinearReLU {
