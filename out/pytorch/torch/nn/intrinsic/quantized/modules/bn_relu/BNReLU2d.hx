...
package torch.nn.intrinsic.quantized.modules.bn_relu;
@:pythonImport("torch.nn.intrinsic.quantized.modules.bn_relu", "BNReLU2d") extern class BNReLU2d {
	...
	**/
	static public function _FLOAT_MODULE(batch_norm:Dynamic, relu:Dynamic):Dynamic;
	...
	**/
	@:native("__init__")
	public function ___init__(num_features:Dynamic, ?eps:Dynamic, ?momentum:Dynamic):Dynamic;
	/**
		Initializes internal Module state, shared by both nn.Module and ScriptModule.
	**/
	public function new(num_features:Dynamic, ?eps:Dynamic, ?momentum:Dynamic):Void;
	/**
