...
package torch.nn.intrinsic.quantized.modules.conv_relu;
@:pythonImport("torch.nn.intrinsic.quantized.modules.conv_relu", "ConvReLU2d") extern class ConvReLU2d {
	...
	**/
	@:native("__init__")
	public function ___init__(in_channels:Dynamic, out_channels:Dynamic, kernel_size:Dynamic, ?stride:Dynamic, ?padding:Dynamic, ?dilation:Dynamic, ?groups:Dynamic, ?bias:Dynamic, ?padding_mode:Dynamic):Dynamic;
	/**
		Initializes internal Module state, shared by both nn.Module and ScriptModule.
	**/
	public function new(in_channels:Dynamic, out_channels:Dynamic, kernel_size:Dynamic, ?stride:Dynamic, ?padding:Dynamic, ?dilation:Dynamic, ?groups:Dynamic, ?bias:Dynamic, ?padding_mode:Dynamic):Void;
	/**
