...
package torch.nn.intrinsic.quantized._dynamic.modules.linear_relu;
@:pythonImport("torch.nn.intrinsic.quantized.dynamic.modules.linear_relu", "LinearReLU") extern class LinearReLU {
	...
	**/
	@:native("__init__")
	public function ___init__(in_features:Dynamic, out_features:Dynamic, ?bias:Dynamic, ?dtype:Dynamic):Dynamic;
	/**
		Initializes internal Module state, shared by both nn.Module and ScriptModule.
	**/
	public function new(in_features:Dynamic, out_features:Dynamic, ?bias:Dynamic, ?dtype:Dynamic):Void;
	/**
