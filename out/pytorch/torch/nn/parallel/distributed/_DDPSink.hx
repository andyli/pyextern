...
@:pythonImport("torch.nn.parallel.distributed", "_DDPSink") extern class _DDPSink {
	/**
	...
	**/
	static public function forward(ctx:Dynamic, reducer:Dynamic, state_dict:Dynamic, ?inputs:python.VarArgs<Dynamic>):Dynamic;
