...
@:pythonImport("torch.nn.utils.prune", "L1Unstructured") extern class L1Unstructured {
	...
	**/
	static public function apply(module:Dynamic, name:Dynamic, amount:Dynamic, ?importance_scores:Dynamic):Dynamic;
	/**
