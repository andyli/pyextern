...
@:pythonImport("torch.nn.utils.prune", "RandomStructured") extern class RandomStructured {
	...
	**/
	@:native("__init__")
	public function ___init__(amount:Dynamic, ?dim:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(amount:Dynamic, ?dim:Dynamic):Void;
	/**
	...
	**/
	static public function apply(module:Dynamic, name:Dynamic, amount:Dynamic, ?dim:Dynamic):Dynamic;
	/**
