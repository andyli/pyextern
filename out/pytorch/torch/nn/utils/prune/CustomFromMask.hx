...
@:pythonImport("torch.nn.utils.prune", "CustomFromMask") extern class CustomFromMask {
	...
	**/
	@:native("__init__")
	public function ___init__(mask:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	...
	/**
		...
		Args:
		    ...
		    name (str): parameter name within ``module`` on which pruning
		        will act.
	**/
	static public function apply(module:Dynamic, name:Dynamic, mask:Dynamic):Dynamic;
	/**
