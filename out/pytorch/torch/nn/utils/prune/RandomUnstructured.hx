...
@:pythonImport("torch.nn.utils.prune", "RandomUnstructured") extern class RandomUnstructured {
	...
	**/
	static public function apply(module:Dynamic, name:Dynamic, amount:Dynamic):Dynamic;
	/**
