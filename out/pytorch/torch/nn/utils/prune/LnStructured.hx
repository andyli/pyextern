...
@:pythonImport("torch.nn.utils.prune", "LnStructured") extern class LnStructured {
	static public var PRUNING_TYPE : Dynamic;
	...
	**/
	@:native("__init__")
	public function ___init__(amount:Dynamic, n:Dynamic, ?dim:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(amount:Dynamic, n:Dynamic, ?dim:Dynamic):Void;
	/**
	...
	**/
	static public function apply(module:Dynamic, name:Dynamic, amount:Dynamic, n:Dynamic, dim:Dynamic, ?importance_scores:Dynamic):Dynamic;
	/**
