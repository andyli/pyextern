...
@:pythonImport("torch.nn.utils.rnn", "PackedSequence") extern class PackedSequence {
	...
	**/
	...
	/**
		Create new instance of PackedSequence_(data, batch_sizes, sorted_indices, unsorted_indices)
	**/
	static public function __new__(cls:Dynamic, data:Dynamic, ?batch_sizes:Dynamic, ?sorted_indices:Dynamic, ?unsorted_indices:Dynamic):Dynamic;
	/**
		Helper for pickle.
	**/
	...
	**/
	...
	/**
		Make a new PackedSequence_ object from a sequence or iterable
	**/
	static public function _make(iterable:Dynamic):Dynamic;
	/**
		Return a new PackedSequence_ object replacing specified fields with new values
	**/
	...
	**/
	...
	public function cpu(?args:python.VarArgs<Dynamic>, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	...
	**/
	public var sorted_indices : Dynamic;
	/**
	...
	**/
	public var unsorted_indices : Dynamic;
}