...
@:pythonImport("torch.nn.utils.parametrizations", "_SpectralNorm") extern class _SpectralNorm {
	...
	**/
	@:native("__init__")
	public function ___init__(weight:Dynamic, ?n_power_iterations:Dynamic, ?dim:Dynamic, ?eps:Dynamic):Dynamic;
	/**
		Initializes internal Module state, shared by both nn.Module and ScriptModule.
	**/
	public function new(weight:Dynamic, ?n_power_iterations:Dynamic, ?dim:Dynamic, ?eps:Dynamic):Void;
	/**
	...
	**/
	...
	public function _power_method(weight_mat:Dynamic, n_power_iterations:Dynamic):Dynamic;
	/**
	...
	**/
	...
	public function _reshape_weight_to_matrix(weight:Dynamic):Dynamic;
	/**
	...
	**/
	public function forward(weight:Dynamic):Dynamic;
	/**
