...
@:pythonImport("torch.nn.utils.parametrizations", "_Orthogonal") extern class _Orthogonal {
	...
	**/
	@:native("__init__")
	public function ___init__(weight:Dynamic, orthogonal_map:Dynamic, ?use_trivialization:Dynamic):Dynamic;
	/**
		Initializes internal Module state, shared by both nn.Module and ScriptModule.
	**/
	public function new(weight:Dynamic, orthogonal_map:Dynamic, ?use_trivialization:Dynamic):Void;
	/**
	...
	**/
	...
	public function right_inverse(Q:Dynamic):Dynamic;
	/**
