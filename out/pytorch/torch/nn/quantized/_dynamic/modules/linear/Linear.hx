...
package torch.nn.quantized._dynamic.modules.linear;
@:pythonImport("torch.nn.quantized.dynamic.modules.linear", "Linear") extern class Linear {
	...
	**/
	@:native("__init__")
	public function ___init__(in_features:Dynamic, out_features:Dynamic, ?bias_:Dynamic, ?dtype:Dynamic):Dynamic;
	/**
		Initializes internal Module state, shared by both nn.Module and ScriptModule.
	**/
	public function new(in_features:Dynamic, out_features:Dynamic, ?bias_:Dynamic, ?dtype:Dynamic):Void;
	/**
