...
@:pythonImport("torch.nn.quantized.dynamic.modules.rnn", "PackedParameter") extern class PackedParameter {
	...
	**/
	@:native("__init__")
	public function ___init__(param:Dynamic):Dynamic;
	/**
		Initializes internal Module state, shared by both nn.Module and ScriptModule.
	**/
	public function new(param:Dynamic):Void;
	/**
