...
@:pythonImport("torch.nn.quantized.dynamic.modules.rnn", "LSTM") extern class LSTM {
	...
	**/
	static public function _FLOAT_MODULE(?args:python.VarArgs<Dynamic>, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	...
	**/
	...
	public function forward_impl(input:Dynamic, hx:Dynamic, batch_sizes:Dynamic, max_batch_size:Dynamic, sorted_indices:Dynamic):Dynamic;
	public function forward_packed(input:Dynamic, ?hx:Dynamic):Dynamic;
	public function forward_tensor(input:Dynamic, ?hx:Dynamic):Dynamic;
