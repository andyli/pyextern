...
@:pythonImport("torch.nn.quantized.dynamic.modules.rnn", "RNNCellBase") extern class RNNCellBase {
	...
	**/
	@:native("__init__")
	public function ___init__(input_size:Dynamic, hidden_size:Dynamic, ?bias:Dynamic, ?num_chunks:Dynamic, ?dtype:Dynamic):Dynamic;
	/**
		Initializes internal Module state, shared by both nn.Module and ScriptModule.
	**/
	public function new(input_size:Dynamic, hidden_size:Dynamic, ?bias:Dynamic, ?num_chunks:Dynamic, ?dtype:Dynamic):Void;
	/**
	...
	**/
	...
	public function check_forward_hidden(input:Dynamic, hx:Dynamic, ?hidden_label:Dynamic):Dynamic;
	public function check_forward_input(input:Dynamic):Dynamic;
	/**
