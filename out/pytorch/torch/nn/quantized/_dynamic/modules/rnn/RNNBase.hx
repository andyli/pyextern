...
package torch.nn.quantized._dynamic.modules.rnn;
@:pythonImport("torch.nn.quantized.dynamic.modules.rnn", "RNNBase") extern class RNNBase {
	...
	**/
	static public function _FLOAT_MODULE(mode:Dynamic, input_size:Dynamic, hidden_size:Dynamic, ?num_layers:Dynamic, ?bias:Dynamic, ?batch_first:Dynamic, ?dropout:Dynamic, ?bidirectional:Dynamic, ?proj_size:Dynamic, ?device:Dynamic, ?dtype:Dynamic):Dynamic;
	...
	**/
	@:native("__init__")
	public function ___init__(mode:Dynamic, input_size:Dynamic, hidden_size:Dynamic, ?num_layers:Dynamic, ?bias:Dynamic, ?batch_first:Dynamic, ?dropout:Dynamic, ?bidirectional:Dynamic, ?dtype:Dynamic):Dynamic;
	/**
		Initializes internal Module state, shared by both nn.Module and ScriptModule.
	**/
	public function new(mode:Dynamic, input_size:Dynamic, hidden_size:Dynamic, ?num_layers:Dynamic, ?bias:Dynamic, ?batch_first:Dynamic, ?dropout:Dynamic, ?bidirectional:Dynamic, ?dtype:Dynamic):Void;
	/**
	...
	**/
	...
	public function check_forward_args(input:Dynamic, hidden:Dynamic, batch_sizes:Dynamic):Dynamic;
	public function check_hidden_size(hx:Dynamic, expected_hidden_size:Dynamic, ?msg:Dynamic):Dynamic;
	public function check_input(input:Dynamic, batch_sizes:Dynamic):Dynamic;
	/**
	...
	**/
	public function forward(?input:python.VarArgs<Dynamic>):Dynamic;
	static public function from_float(mod:Dynamic):Dynamic;
	public function get_bias():Dynamic;
	/**
	...
	**/
	...
	public function get_expected_hidden_size(input:Dynamic, batch_sizes:Dynamic):Dynamic;
	/**
	...
	**/
	...
	public function permute_hidden(hx:Dynamic, permutation:Dynamic):Dynamic;
	/**
