...
package torch.nn.quantized.modules.functional_modules;
@:pythonImport("torch.nn.quantized.modules.functional_modules", "FXFloatFunctional") extern class FXFloatFunctional {
	...
	**/
	...
	public function add(x:Dynamic, y:Dynamic):Dynamic;
	/**
	...
	**/
	...
	public function add_relu(x:Dynamic, y:Dynamic):Dynamic;
	public function add_scalar(x:Dynamic, y:Dynamic):Dynamic;
	/**
	...
	**/
	...
	public function cat(x:Dynamic, ?dim:Dynamic):Dynamic;
	/**
	...
	**/
	...
	public function mul(x:Dynamic, y:Dynamic):Dynamic;
	public function mul_scalar(x:Dynamic, y:Dynamic):Dynamic;
	/**
