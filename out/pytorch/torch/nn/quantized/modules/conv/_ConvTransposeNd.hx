...
@:pythonImport("torch.nn.quantized.modules.conv", "_ConvTransposeNd") extern class _ConvTransposeNd {
	...
	**/
	...
	public function set_weight_bias(qweight:Dynamic, bias_float:Dynamic):Dynamic;
	/**
