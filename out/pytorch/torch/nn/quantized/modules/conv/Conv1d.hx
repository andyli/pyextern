...
@:pythonImport("torch.nn.quantized.modules.conv", "Conv1d") extern class Conv1d {
	...
	**/
	static public function _FLOAT_MODULE(in_channels:Dynamic, out_channels:Dynamic, kernel_size:Dynamic, ?stride:Dynamic, ?padding:Dynamic, ?dilation:Dynamic, ?groups:Dynamic, ?bias:Dynamic, ?padding_mode:Dynamic, ?device:Dynamic, ?dtype:Dynamic):Dynamic;
	/**
	...
	**/
	static public function _NNIQAT_CONV_BN_MODULE(in_channels:Dynamic, out_channels:Dynamic, kernel_size:Dynamic, ?stride:Dynamic, ?padding:Dynamic, ?dilation:Dynamic, ?groups:Dynamic, ?bias:Dynamic, ?padding_mode:Dynamic, ?eps:Dynamic, ?momentum:Dynamic, ?freeze_bn:Dynamic, ?qconfig:Dynamic):Dynamic;
	/**
		This is a sequential container which calls the Conv1d and ReLU modules.
		During quantization this will be replaced with the corresponding fused module.
	**/
	static public function _NNI_CONV_RELU_MODULE(conv:Dynamic, relu:Dynamic):Dynamic;
	...
	**/
	@:native("__init__")
	public function ___init__(in_channels:Dynamic, out_channels:Dynamic, kernel_size:Dynamic, ?stride:Dynamic, ?padding:Dynamic, ?dilation:Dynamic, ?groups:Dynamic, ?bias:Dynamic, ?padding_mode:Dynamic, ?device:Dynamic, ?dtype:Dynamic):Dynamic;
	/**
		Initializes internal Module state, shared by both nn.Module and ScriptModule.
	**/
	public function new(in_channels:Dynamic, out_channels:Dynamic, kernel_size:Dynamic, ?stride:Dynamic, ?padding:Dynamic, ?dilation:Dynamic, ?groups:Dynamic, ?bias:Dynamic, ?padding_mode:Dynamic, ?device:Dynamic, ?dtype:Dynamic):Void;
	/**
