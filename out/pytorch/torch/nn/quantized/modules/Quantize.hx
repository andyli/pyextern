...
@:pythonImport("torch.nn.quantized.modules", "Quantize") extern class Quantize {
	...
	**/
	@:native("__init__")
	public function ___init__(scale:Dynamic, zero_point:Dynamic, dtype:Dynamic, ?factory_kwargs:Dynamic):Dynamic;
	/**
		Initializes internal Module state, shared by both nn.Module and ScriptModule.
	**/
	public function new(scale:Dynamic, zero_point:Dynamic, dtype:Dynamic, ?factory_kwargs:Dynamic):Void;
	/**
