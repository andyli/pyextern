...
package torch.nn.quantized.modules.batchnorm;
@:pythonImport("torch.nn.quantized.modules.batchnorm", "BatchNorm3d") extern class BatchNorm3d {
	...
	**/
	@:native("__init__")
	public function ___init__(num_features:Dynamic, ?eps:Dynamic, ?momentum:Dynamic, ?device:Dynamic, ?dtype:Dynamic):Dynamic;
	/**
		Initializes internal Module state, shared by both nn.Module and ScriptModule.
	**/
	public function new(num_features:Dynamic, ?eps:Dynamic, ?momentum:Dynamic, ?device:Dynamic, ?dtype:Dynamic):Void;
	/**
