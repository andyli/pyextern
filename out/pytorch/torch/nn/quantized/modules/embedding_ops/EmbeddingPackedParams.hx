...
@:pythonImport("torch.nn.quantized.modules.embedding_ops", "EmbeddingPackedParams") extern class EmbeddingPackedParams {
	...
	**/
	@:native("__init__")
	public function ___init__(num_embeddings:Dynamic, embedding_dim:Dynamic, ?dtype:Dynamic):Dynamic;
	/**
		Initializes internal Module state, shared by both nn.Module and ScriptModule.
	**/
	public function new(num_embeddings:Dynamic, embedding_dim:Dynamic, ?dtype:Dynamic):Void;
	/**
	...
	**/
	...
	public function _weight():Dynamic;
	/**
