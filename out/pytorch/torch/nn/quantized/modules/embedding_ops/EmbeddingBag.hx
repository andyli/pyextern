...
package torch.nn.quantized.modules.embedding_ops;
@:pythonImport("torch.nn.quantized.modules.embedding_ops", "EmbeddingBag") extern class EmbeddingBag {
	...
	**/
	@:native("__init__")
	public function ___init__(num_embeddings:Dynamic, embedding_dim:Dynamic, ?max_norm:Dynamic, ?norm_type:Dynamic, ?scale_grad_by_freq:Dynamic, ?mode:Dynamic, ?sparse:Dynamic, ?_weight:Dynamic, ?include_last_offset:Dynamic, ?dtype:Dynamic):Dynamic;
	/**
		Initializes internal Module state, shared by both nn.Module and ScriptModule.
	**/
	public function new(num_embeddings:Dynamic, embedding_dim:Dynamic, ?max_norm:Dynamic, ?norm_type:Dynamic, ?scale_grad_by_freq:Dynamic, ?mode:Dynamic, ?sparse:Dynamic, ?_weight:Dynamic, ?include_last_offset:Dynamic, ?dtype:Dynamic):Void;
	/**
	...
	**/
	public function forward(indices:Dynamic, ?offsets:Dynamic, ?per_sample_weights:Dynamic, ?compressed_indices_mapping:Dynamic):Dynamic;
	/**
	...
	**/
	...
	public function set_weight(w:Dynamic):Dynamic;
	/**
