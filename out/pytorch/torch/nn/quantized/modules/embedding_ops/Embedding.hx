...
@:pythonImport("torch.nn.quantized.modules.embedding_ops", "Embedding") extern class Embedding {
	...
	**/
	@:native("__init__")
	public function ___init__(num_embeddings:Dynamic, embedding_dim:Dynamic, ?padding_idx:Dynamic, ?max_norm:Dynamic, ?norm_type:Dynamic, ?scale_grad_by_freq:Dynamic, ?sparse:Dynamic, ?_weight:Dynamic, ?dtype:Dynamic):Dynamic;
	/**
		Initializes internal Module state, shared by both nn.Module and ScriptModule.
	**/
	public function new(num_embeddings:Dynamic, embedding_dim:Dynamic, ?padding_idx:Dynamic, ?max_norm:Dynamic, ?norm_type:Dynamic, ?scale_grad_by_freq:Dynamic, ?sparse:Dynamic, ?_weight:Dynamic, ?dtype:Dynamic):Void;
	/**
	...
	**/
	public function forward(indices:Dynamic):Dynamic;
	/**
