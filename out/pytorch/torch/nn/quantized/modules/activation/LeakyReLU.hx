...
package torch.nn.quantized.modules.activation;
@:pythonImport("torch.nn.quantized.modules.activation", "LeakyReLU") extern class LeakyReLU {
	...
	**/
	@:native("__init__")
	public function ___init__(scale:Dynamic, zero_point:Dynamic, ?negative_slope:Dynamic, ?inplace:Dynamic, ?device:Dynamic, ?dtype:Dynamic):Dynamic;
	/**
		Initializes internal Module state, shared by both nn.Module and ScriptModule.
	**/
	public function new(scale:Dynamic, zero_point:Dynamic, ?negative_slope:Dynamic, ?inplace:Dynamic, ?device:Dynamic, ?dtype:Dynamic):Void;
	/**
