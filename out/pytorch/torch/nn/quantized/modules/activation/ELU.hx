...
@:pythonImport("torch.nn.quantized.modules.activation", "ELU") extern class ELU {
	...
	**/
	@:native("__init__")
	public function ___init__(scale:Dynamic, zero_point:Dynamic, ?alpha:Dynamic):Dynamic;
	/**
		Initializes internal Module state, shared by both nn.Module and ScriptModule.
	**/
	public function new(scale:Dynamic, zero_point:Dynamic, ?alpha:Dynamic):Void;
	/**
