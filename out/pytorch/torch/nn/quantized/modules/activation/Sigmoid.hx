...
@:pythonImport("torch.nn.quantized.modules.activation", "Sigmoid") extern class Sigmoid {
	...
	**/
	@:native("__init__")
	public function ___init__(output_scale:Dynamic, output_zero_point:Dynamic):Dynamic;
	/**
		Initializes internal Module state, shared by both nn.Module and ScriptModule.
	**/
	public function new(output_scale:Dynamic, output_zero_point:Dynamic):Void;
	/**
