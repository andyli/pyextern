...
@:pythonImport("torch.nn.quantized.modules.activation", "Hardswish") extern class Hardswish {
	...
	**/
	@:native("__init__")
	public function ___init__(scale:Dynamic, zero_point:Dynamic):Dynamic;
	/**
		Initializes internal Module state, shared by both nn.Module and ScriptModule.
	**/
	public function new(scale:Dynamic, zero_point:Dynamic):Void;
	/**
