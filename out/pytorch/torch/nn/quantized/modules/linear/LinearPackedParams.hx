...
@:pythonImport("torch.nn.quantized.modules.linear", "LinearPackedParams") extern class LinearPackedParams {
	...
	**/
	...
	public function set_weight_bias(weight:Dynamic, bias:Dynamic):Dynamic;
	/**
