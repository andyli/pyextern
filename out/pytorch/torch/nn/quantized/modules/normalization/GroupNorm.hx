...
@:pythonImport("torch.nn.quantized.modules.normalization", "GroupNorm") extern class GroupNorm {
	...
	**/
	@:native("__init__")
	public function ___init__(num_groups:Dynamic, num_channels:Dynamic, weight:Dynamic, bias:Dynamic, scale:Dynamic, zero_point:Dynamic, ?eps:Dynamic, ?affine:Dynamic, ?device:Dynamic, ?dtype:Dynamic):Dynamic;
	/**
		Initializes internal Module state, shared by both nn.Module and ScriptModule.
	**/
	public function new(num_groups:Dynamic, num_channels:Dynamic, weight:Dynamic, bias:Dynamic, scale:Dynamic, zero_point:Dynamic, ?eps:Dynamic, ?affine:Dynamic, ?device:Dynamic, ?dtype:Dynamic):Void;
	/**
