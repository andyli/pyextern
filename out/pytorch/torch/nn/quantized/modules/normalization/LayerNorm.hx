...
@:pythonImport("torch.nn.quantized.modules.normalization", "LayerNorm") extern class LayerNorm {
	...
	**/
	@:native("__init__")
	public function ___init__(normalized_shape:Dynamic, weight:Dynamic, bias:Dynamic, scale:Dynamic, zero_point:Dynamic, ?eps:Dynamic, ?elementwise_affine:Dynamic, ?device:Dynamic, ?dtype:Dynamic):Dynamic;
	/**
		Initializes internal Module state, shared by both nn.Module and ScriptModule.
	**/
	public function new(normalized_shape:Dynamic, weight:Dynamic, bias:Dynamic, scale:Dynamic, zero_point:Dynamic, ?eps:Dynamic, ?elementwise_affine:Dynamic, ?device:Dynamic, ?dtype:Dynamic):Void;
	/**
