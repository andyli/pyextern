...
package torch.nn.quantized.modules.normalization;
@:pythonImport("torch.nn.quantized.modules.normalization", "InstanceNorm2d") extern class InstanceNorm2d {
	...
	**/
	@:native("__init__")
	public function ___init__(num_features:Dynamic, weight:Dynamic, bias:Dynamic, scale:Dynamic, zero_point:Dynamic, ?eps:Dynamic, ?momentum:Dynamic, ?affine:Dynamic, ?track_running_stats:Dynamic, ?device:Dynamic, ?dtype:Dynamic):Dynamic;
	/**
		Initializes internal Module state, shared by both nn.Module and ScriptModule.
	**/
	public function new(num_features:Dynamic, weight:Dynamic, bias:Dynamic, scale:Dynamic, zero_point:Dynamic, ?eps:Dynamic, ?momentum:Dynamic, ?affine:Dynamic, ?track_running_stats:Dynamic, ?device:Dynamic, ?dtype:Dynamic):Void;
	/**
