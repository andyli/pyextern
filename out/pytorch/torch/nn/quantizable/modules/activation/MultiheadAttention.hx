...
package torch.nn.quantizable.modules.activation;
@:pythonImport("torch.nn.quantizable.modules.activation", "MultiheadAttention") extern class MultiheadAttention {
	...
	**/
	static public function _FLOAT_MODULE(embed_dim:Dynamic, num_heads:Dynamic, ?dropout:Dynamic, ?bias:Dynamic, ?add_bias_kv:Dynamic, ?add_zero_attn:Dynamic, ?kdim:Dynamic, ?vdim:Dynamic, ?batch_first:Dynamic, ?device:Dynamic, ?dtype:Dynamic):Dynamic;
	...
	**/
	@:native("__init__")
	public function ___init__(embed_dim:Dynamic, num_heads:Dynamic, ?dropout:Dynamic, ?bias:Dynamic, ?add_bias_kv:Dynamic, ?add_zero_attn:Dynamic, ?kdim:Dynamic, ?vdim:Dynamic, ?batch_first:Dynamic, ?device:Dynamic, ?dtype:Dynamic):Dynamic;
	/**
		Initializes internal Module state, shared by both nn.Module and ScriptModule.
	**/
	public function new(embed_dim:Dynamic, num_heads:Dynamic, ?dropout:Dynamic, ?bias:Dynamic, ?add_bias_kv:Dynamic, ?add_zero_attn:Dynamic, ?kdim:Dynamic, ?vdim:Dynamic, ?batch_first:Dynamic, ?device:Dynamic, ?dtype:Dynamic):Void;
	/**
	...
	**/
	...
	public function _forward_impl(query:Dynamic, key:Dynamic, value:Dynamic, ?key_padding_mask:Dynamic, ?need_weights:Dynamic, ?attn_mask:Dynamic):Dynamic;
	/**
	...
	**/
	...
	public function _reset_parameters():Dynamic;
	/**
	...
	**/
	...
	/**
		...
		float.
	**/
	public function dequantize():Dynamic;
	/**
	...
	**/
	public function forward(query:Dynamic, key:Dynamic, value:Dynamic, ?key_padding_mask:Dynamic, ?need_weights:Dynamic, ?attn_mask:Dynamic):Dynamic;
	static public function from_float(other:Dynamic):Dynamic;
	static public function from_observed(other:Dynamic):Dynamic;
	/**
