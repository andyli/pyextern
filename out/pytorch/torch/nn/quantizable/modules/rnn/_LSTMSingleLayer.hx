...
@:pythonImport("torch.nn.quantizable.modules.rnn", "_LSTMSingleLayer") extern class _LSTMSingleLayer {
	...
	**/
	...
	static public function from_params(?args:python.VarArgs<Dynamic>, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
