...
@:pythonImport("torch.nn.quantizable.modules.rnn", "LSTMCell") extern class LSTMCell {
	...
	**/
	static public function _FLOAT_MODULE(input_size:Dynamic, hidden_size:Dynamic, ?bias:Dynamic, ?device:Dynamic, ?dtype:Dynamic):Dynamic;
	...
	**/
	@:native("__init__")
	public function ___init__(input_dim:Dynamic, hidden_dim:Dynamic, ?bias:Dynamic, ?device:Dynamic, ?dtype:Dynamic):Dynamic;
	/**
		Initializes internal Module state, shared by both nn.Module and ScriptModule.
	**/
	public function new(input_dim:Dynamic, hidden_dim:Dynamic, ?bias:Dynamic, ?device:Dynamic, ?dtype:Dynamic):Void;
	/**
	...
	**/
	static public function from_params(wi:Dynamic, wh:Dynamic, ?bi:Dynamic, ?bh:Dynamic):Dynamic;
	/**
	...
	**/
	...
	public function initialize_hidden(batch_size:Dynamic, ?is_quantized:Dynamic):Dynamic;
	/**
