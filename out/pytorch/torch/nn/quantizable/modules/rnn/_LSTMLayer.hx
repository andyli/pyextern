...
@:pythonImport("torch.nn.quantizable.modules.rnn", "_LSTMLayer") extern class _LSTMLayer {
	...
	**/
	@:native("__init__")
	public function ___init__(input_dim:Dynamic, hidden_dim:Dynamic, ?bias:Dynamic, ?batch_first:Dynamic, ?bidirectional:Dynamic, ?device:Dynamic, ?dtype:Dynamic):Dynamic;
	/**
		Initializes internal Module state, shared by both nn.Module and ScriptModule.
	**/
	public function new(input_dim:Dynamic, hidden_dim:Dynamic, ?bias:Dynamic, ?batch_first:Dynamic, ?bidirectional:Dynamic, ?device:Dynamic, ?dtype:Dynamic):Void;
	/**
	...
	**/
	...
	/**
		...
		flow.
	**/
	static public function from_float(other:Dynamic, ?layer_idx:Dynamic, ?qconfig:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
