...
package torch.nn.quantizable.modules.rnn;
@:pythonImport("torch.nn.quantizable.modules.rnn", "LSTM") extern class LSTM {
	...
	**/
	@:native("__init__")
	public function ___init__(input_size:Dynamic, hidden_size:Dynamic, ?num_layers:Dynamic, ?bias:Dynamic, ?batch_first:Dynamic, ?dropout:Dynamic, ?bidirectional:Dynamic, ?device:Dynamic, ?dtype:Dynamic):Dynamic;
	/**
		Initializes internal Module state, shared by both nn.Module and ScriptModule.
	**/
	public function new(input_size:Dynamic, hidden_size:Dynamic, ?num_layers:Dynamic, ?bias:Dynamic, ?batch_first:Dynamic, ?dropout:Dynamic, ?bidirectional:Dynamic, ?device:Dynamic, ?dtype:Dynamic):Void;
	/**
	...
	**/
	public function forward(x:Dynamic, ?hidden:Dynamic):Dynamic;
	static public function from_float(other:Dynamic, ?qconfig:Dynamic):Dynamic;
