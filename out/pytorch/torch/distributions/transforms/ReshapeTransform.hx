...
@:pythonImport("torch.distributions.transforms", "ReshapeTransform") extern class ReshapeTransform {
	...
	**/
	@:native("__init__")
	public function ___init__(in_shape:Dynamic, out_shape:Dynamic, ?cache_size:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(in_shape:Dynamic, out_shape:Dynamic, ?cache_size:Dynamic):Void;
	/**
