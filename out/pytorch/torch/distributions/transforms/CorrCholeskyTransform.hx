...
@:pythonImport("torch.distributions.transforms", "CorrCholeskyTransform") extern class CorrCholeskyTransform {
	...
	**/
	public function log_abs_det_jacobian(x:Dynamic, y:Dynamic, ?intermediates:Dynamic):Dynamic;
	/**
