...
@:pythonImport("torch.distributions.transforms", "CatTransform") extern class CatTransform {
	...
	**/
	@:native("__init__")
	public function ___init__(tseq:Dynamic, ?dim:Dynamic, ?lengths:Dynamic, ?cache_size:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(tseq:Dynamic, ?dim:Dynamic, ?lengths:Dynamic, ?cache_size:Dynamic):Void;
	/**
