...
@:pythonImport("torch.distributions.transforms", "_InverseTransform") extern class _InverseTransform {
	...
	**/
	@:native("__init__")
	public function ___init__(transform:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(transform:Dynamic):Void;
	/**
