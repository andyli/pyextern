...
@:pythonImport("torch.distributions.transforms", "IndependentTransform") extern class IndependentTransform {
	...
	**/
	@:native("__init__")
	public function ___init__(base_transform:Dynamic, reinterpreted_batch_ndims:Dynamic, ?cache_size:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(base_transform:Dynamic, reinterpreted_batch_ndims:Dynamic, ?cache_size:Dynamic):Void;
	/**
