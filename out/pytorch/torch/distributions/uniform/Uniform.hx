...
@:pythonImport("torch.distributions.uniform", "Uniform") extern class Uniform {
	...
	**/
	@:native("__init__")
	public function ___init__(low:Dynamic, high:Dynamic, ?validate_args:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(low:Dynamic, high:Dynamic, ?validate_args:Dynamic):Void;
	/**
