...
@:pythonImport("torch.distributions.von_mises", "VonMises") extern class VonMises {
	...
	**/
	@:native("__init__")
	public function ___init__(loc:Dynamic, concentration:Dynamic, ?validate_args:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(loc:Dynamic, concentration:Dynamic, ?validate_args:Dynamic):Void;
	/**
	...
	**/
	...
	/**
		...
		Returns:
		    ...
		    `batch_size`.
	**/
	public function expand(batch_shape:Dynamic):Dynamic;
