...
@:pythonImport("torch.distributions.independent", "Independent") extern class Independent {
	...
	**/
	@:native("__init__")
	public function ___init__(base_distribution:Dynamic, reinterpreted_batch_ndims:Dynamic, ?validate_args:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(base_distribution:Dynamic, reinterpreted_batch_ndims:Dynamic, ?validate_args:Dynamic):Void;
	/**
	...
	**/
	public var has_enumerate_support : Dynamic;
	/**
		bool(x) -> bool
