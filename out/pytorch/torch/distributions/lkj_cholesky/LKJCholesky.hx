...
package torch.distributions.lkj_cholesky;
@:pythonImport("torch.distributions.lkj_cholesky", "LKJCholesky") extern class LKJCholesky {
	...
	**/
	@:native("__init__")
	public function ___init__(dim:Dynamic, ?concentration:Dynamic, ?validate_args:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(dim:Dynamic, ?concentration:Dynamic, ?validate_args:Dynamic):Void;
	/**
