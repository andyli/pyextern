...
package torch.distributions.dirichlet;
@:pythonImport("torch.distributions.dirichlet", "Dirichlet") extern class Dirichlet {
	...
	**/
	@:native("__init__")
	public function ___init__(concentration:Dynamic, ?validate_args:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(concentration:Dynamic, ?validate_args:Dynamic):Void;
	/**
