...
package torch.distributions.relaxed_categorical;
@:pythonImport("torch.distributions.relaxed_categorical", "ExpRelaxedCategorical") extern class ExpRelaxedCategorical {
