...
package torch.distributions.continuous_bernoulli;
@:pythonImport("torch.distributions.continuous_bernoulli", "ContinuousBernoulli") extern class ContinuousBernoulli {
	...
	**/
	@:native("__init__")
	public function ___init__(?probs:Dynamic, ?logits:Dynamic, ?lims:Dynamic, ?validate_args:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(?probs:Dynamic, ?logits:Dynamic, ?lims:Dynamic, ?validate_args:Dynamic):Void;
	/**
	...
	**/
	public function _cont_bern_log_norm():Dynamic;
	public function _cut_probs():Dynamic;
	/**
	...
	**/
	public function _log_normalizer(x:Dynamic):Dynamic;
	static public var _mean_carrier_measure : Dynamic;
	/**
	...
	**/
	...
	public function _outside_unstable_region():Dynamic;
	...
	**/
	...
	public var param_shape : Dynamic;
	/**
