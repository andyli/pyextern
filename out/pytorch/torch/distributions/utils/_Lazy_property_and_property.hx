...
@:pythonImport("torch.distributions.utils", "_lazy_property_and_property") extern class _Lazy_property_and_property {
	...
	**/
	...
	public function __get__(instance:Dynamic, ?obj_type:Dynamic):Dynamic;
	/**
