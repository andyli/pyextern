...
package torch.distributions.one_hot_categorical;
@:pythonImport("torch.distributions.one_hot_categorical", "OneHotCategoricalStraightThrough") extern class OneHotCategoricalStraightThrough {
