...
package torch.distributions.mixture_same_family;
@:pythonImport("torch.distributions.mixture_same_family", "MixtureSameFamily") extern class MixtureSameFamily {
	...
	**/
	@:native("__init__")
	public function ___init__(mixture_distribution:Dynamic, component_distribution:Dynamic, ?validate_args:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(mixture_distribution:Dynamic, component_distribution:Dynamic, ?validate_args:Dynamic):Void;
	/**
	...
	**/
	...
	public function _pad(x:Dynamic):Dynamic;
	public function _pad_mixture_dimensions(x:Dynamic):Dynamic;
	...
	**/
	...
	public var component_distribution : Dynamic;
	/**
	...
	**/
	...
	/**
		...
		Args:
		    value (Tensor):
	**/
	public function log_prob(x:Dynamic):Dynamic;
	/**
	...
	**/
	static public function support(fn:Dynamic):Dynamic;
	/**
