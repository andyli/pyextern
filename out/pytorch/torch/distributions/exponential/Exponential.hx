...
package torch.distributions.exponential;
@:pythonImport("torch.distributions.exponential", "Exponential") extern class Exponential {
	...
	**/
	@:native("__init__")
	public function ___init__(rate:Dynamic, ?validate_args:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(rate:Dynamic, ?validate_args:Dynamic):Void;
	/**
