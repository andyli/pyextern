...
@:pythonImport("torch.distributions.constraints") extern class Constraints_Module {
	...
	static public var corr_cholesky : Dynamic;
	static public function dependent(?is_discrete:Dynamic, ?event_dim:Dynamic):Dynamic;
	...
	static public var nonnegative : Dynamic;
