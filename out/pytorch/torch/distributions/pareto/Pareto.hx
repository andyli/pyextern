...
package torch.distributions.pareto;
@:pythonImport("torch.distributions.pareto", "Pareto") extern class Pareto {
	...
	**/
	@:native("__init__")
	public function ___init__(scale:Dynamic, alpha:Dynamic, ?validate_args:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(scale:Dynamic, alpha:Dynamic, ?validate_args:Dynamic):Void;
	/**
