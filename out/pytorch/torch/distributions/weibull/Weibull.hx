...
package torch.distributions.weibull;
@:pythonImport("torch.distributions.weibull", "Weibull") extern class Weibull {
	...
	**/
	@:native("__init__")
	public function ___init__(scale:Dynamic, concentration:Dynamic, ?validate_args:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(scale:Dynamic, concentration:Dynamic, ?validate_args:Dynamic):Void;
	/**
