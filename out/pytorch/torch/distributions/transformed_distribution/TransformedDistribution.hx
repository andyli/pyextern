...
package torch.distributions.transformed_distribution;
@:pythonImport("torch.distributions.transformed_distribution", "TransformedDistribution") extern class TransformedDistribution {
	...
	**/
	@:native("__init__")
	public function ___init__(base_distribution:Dynamic, transforms:Dynamic, ?validate_args:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(base_distribution:Dynamic, transforms:Dynamic, ?validate_args:Dynamic):Void;
	/**
	...
	**/
	public var has_rsample : Dynamic;
	/**
