...
package torch.optim.asgd;
@:pythonImport("torch.optim.asgd", "ASGD") extern class ASGD {
	...
	**/
	@:native("__init__")
	public function ___init__(params:Dynamic, ?lr:Dynamic, ?lambd:Dynamic, ?alpha:Dynamic, ?t0:Dynamic, ?weight_decay:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(params:Dynamic, ?lr:Dynamic, ?lambd:Dynamic, ?alpha:Dynamic, ?t0:Dynamic, ?weight_decay:Dynamic):Void;
	/**
