...
package torch.optim.optimizer;
@:pythonImport("torch.optim.optimizer", "Optimizer") extern class Optimizer {
	...
	**/
	@:native("__init__")
	public function ___init__(params:Dynamic, defaults:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(params:Dynamic, defaults:Dynamic):Void;
	/**
