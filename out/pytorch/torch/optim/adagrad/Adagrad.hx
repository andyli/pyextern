...
package torch.optim.adagrad;
@:pythonImport("torch.optim.adagrad", "Adagrad") extern class Adagrad {
	...
	**/
	@:native("__init__")
	public function ___init__(params:Dynamic, ?lr:Dynamic, ?lr_decay:Dynamic, ?weight_decay:Dynamic, ?initial_accumulator_value:Dynamic, ?eps:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(params:Dynamic, ?lr:Dynamic, ?lr_decay:Dynamic, ?weight_decay:Dynamic, ?initial_accumulator_value:Dynamic, ?eps:Dynamic):Void;
	/**
