...
@:pythonImport("torch.optim.lbfgs", "LBFGS") extern class LBFGS {
	...
	**/
	...
	public function _clone_param():Dynamic;
	public function _directional_evaluate(closure:Dynamic, x:Dynamic, t:Dynamic, d:Dynamic):Dynamic;
	public function _gather_flat_grad():Dynamic;
	public function _hook_for_profile():Dynamic;
	public function _numel():Dynamic;
	public function _set_param(params_data:Dynamic):Dynamic;
	/**
