...
@:pythonImport("torch.optim.lr_scheduler", "ConstantLR") extern class ConstantLR {
	...
	**/
	@:native("__init__")
	public function ___init__(optimizer:Dynamic, ?factor:Dynamic, ?total_iters:Dynamic, ?last_epoch:Dynamic, ?verbose:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(optimizer:Dynamic, ?factor:Dynamic, ?total_iters:Dynamic, ?last_epoch:Dynamic, ?verbose:Dynamic):Void;
	/**
