...
@:pythonImport("torch.optim.lr_scheduler", "LinearLR") extern class LinearLR {
	...
	**/
	@:native("__init__")
	public function ___init__(optimizer:Dynamic, ?start_factor:Dynamic, ?end_factor:Dynamic, ?total_iters:Dynamic, ?last_epoch:Dynamic, ?verbose:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(optimizer:Dynamic, ?start_factor:Dynamic, ?end_factor:Dynamic, ?total_iters:Dynamic, ?last_epoch:Dynamic, ?verbose:Dynamic):Void;
	/**
