...
@:pythonImport("torch.optim.lr_scheduler", "StepLR") extern class StepLR {
	...
	**/
	@:native("__init__")
	public function ___init__(optimizer:Dynamic, step_size:Dynamic, ?gamma:Dynamic, ?last_epoch:Dynamic, ?verbose:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(optimizer:Dynamic, step_size:Dynamic, ?gamma:Dynamic, ?last_epoch:Dynamic, ?verbose:Dynamic):Void;
	/**
