...
@:pythonImport("torch.optim.lr_scheduler", "ChainedScheduler") extern class ChainedScheduler {
	...
	**/
	@:native("__init__")
	public function ___init__(schedulers:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(schedulers:Dynamic):Void;
	/**
