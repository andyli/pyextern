...
@:pythonImport("torch.optim.lr_scheduler", "_LRScheduler") extern class _LRScheduler {
	...
	**/
	@:native("__init__")
	public function ___init__(optimizer:Dynamic, ?last_epoch:Dynamic, ?verbose:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(optimizer:Dynamic, ?last_epoch:Dynamic, ?verbose:Dynamic):Void;
	/**
