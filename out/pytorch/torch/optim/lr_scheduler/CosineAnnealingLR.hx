...
@:pythonImport("torch.optim.lr_scheduler", "CosineAnnealingLR") extern class CosineAnnealingLR {
	...
	**/
	@:native("__init__")
	public function ___init__(optimizer:Dynamic, T_max:Dynamic, ?eta_min:Dynamic, ?last_epoch:Dynamic, ?verbose:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(optimizer:Dynamic, T_max:Dynamic, ?eta_min:Dynamic, ?last_epoch:Dynamic, ?verbose:Dynamic):Void;
	/**
