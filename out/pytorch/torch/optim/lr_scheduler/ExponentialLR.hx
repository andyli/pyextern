...
@:pythonImport("torch.optim.lr_scheduler", "ExponentialLR") extern class ExponentialLR {
	...
	**/
	@:native("__init__")
	public function ___init__(optimizer:Dynamic, gamma:Dynamic, ?last_epoch:Dynamic, ?verbose:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(optimizer:Dynamic, gamma:Dynamic, ?last_epoch:Dynamic, ?verbose:Dynamic):Void;
	/**
