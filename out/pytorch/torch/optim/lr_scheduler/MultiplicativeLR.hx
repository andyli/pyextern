...
@:pythonImport("torch.optim.lr_scheduler", "MultiplicativeLR") extern class MultiplicativeLR {
	...
	**/
	@:native("__init__")
	public function ___init__(optimizer:Dynamic, lr_lambda:Dynamic, ?last_epoch:Dynamic, ?verbose:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(optimizer:Dynamic, lr_lambda:Dynamic, ?last_epoch:Dynamic, ?verbose:Dynamic):Void;
	/**
