...
@:pythonImport("torch.optim.swa_utils", "AveragedModel") extern class AveragedModel {
	...
	**/
	@:native("__init__")
	public function ___init__(model:Dynamic, ?device:Dynamic, ?avg_fn:Dynamic):Dynamic;
	/**
		Initializes internal Module state, shared by both nn.Module and ScriptModule.
	**/
	public function new(model:Dynamic, ?device:Dynamic, ?avg_fn:Dynamic):Void;
	/**
	...
	**/
	...
	public function update_parameters(model:Dynamic):Dynamic;
	/**
