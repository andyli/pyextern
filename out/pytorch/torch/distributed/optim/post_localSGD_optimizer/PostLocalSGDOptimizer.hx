...
package torch.distributed.optim.post_localSGD_optimizer;
@:pythonImport("torch.distributed.optim.post_localSGD_optimizer", "PostLocalSGDOptimizer") extern class PostLocalSGDOptimizer {
	...
	**/
	@:native("__init__")
	public function ___init__(optim:Dynamic, averager:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(optim:Dynamic, averager:Dynamic):Void;
	/**
