...
@:pythonImport("torch.distributed.optim.optimizer", "_ScriptLocalOptimizer") extern class _ScriptLocalOptimizer {
	...
	**/
	@:native("__init__")
	public function ___init__(optim_cls:Dynamic, local_params_rref:Dynamic, ?args:python.VarArgs<Dynamic>, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
		Initializes internal Module state, shared by both nn.Module and ScriptModule.
	**/
	public function new(optim_cls:Dynamic, local_params_rref:Dynamic, ?args:python.VarArgs<Dynamic>, ?kwargs:python.KwArgs<Dynamic>):Void;
	/**
	...
	**/
	...
	static public var compile_lock : Dynamic;
	/**
	...
	**/
	...
	public function step(autograd_ctx_id:Dynamic):Dynamic;
	/**
