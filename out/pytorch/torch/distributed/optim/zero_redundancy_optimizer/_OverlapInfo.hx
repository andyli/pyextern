...
@:pythonImport("torch.distributed.optim.zero_redundancy_optimizer", "_OverlapInfo") extern class _OverlapInfo {
	...
	**/
	@:native("__init__")
	public function ___init__(world_size:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(world_size:Dynamic):Void;
	/**
	...
	**/
	public function clear_per_iter_info():Dynamic;
	/**
		...
		next iteration.
	**/
	public function wait_for_broadcasts():Dynamic;
}