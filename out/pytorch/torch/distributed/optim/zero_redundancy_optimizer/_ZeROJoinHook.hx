...
@:pythonImport("torch.distributed.optim.zero_redundancy_optimizer", "_ZeROJoinHook") extern class _ZeROJoinHook {
	...
	**/
	@:native("__init__")
	public function ___init__(zero:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(zero:Dynamic):Void;
	/**
