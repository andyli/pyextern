...
@:pythonImport("torch.distributed.elastic.multiprocessing.api", "MultiprocessContext") extern class MultiprocessContext {
	...
	**/
	@:native("__init__")
	public function ___init__(name:Dynamic, entrypoint:Dynamic, args:Dynamic, envs:Dynamic, stdouts:Dynamic, stderrs:Dynamic, tee_stdouts:Dynamic, tee_stderrs:Dynamic, error_files:Dynamic, start_method:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(name:Dynamic, entrypoint:Dynamic, args:Dynamic, envs:Dynamic, stdouts:Dynamic, stderrs:Dynamic, tee_stdouts:Dynamic, tee_stderrs:Dynamic, error_files:Dynamic, start_method:Dynamic):Void;
	/**
	...
	**/
	...
	public function _is_done():Dynamic;
	/**
