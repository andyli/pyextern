...
@:pythonImport("torch.distributed.elastic.multiprocessing.api", "SignalException") extern class SignalException {
	/**
		exception cause
	**/
	...
	**/
	@:native("__init__")
	public function ___init__(msg:Dynamic, sigval:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(msg:Dynamic, sigval:Dynamic):Void;
	/**
