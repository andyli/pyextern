...
package torch.distributed.elastic.multiprocessing.errors.error_handler;
@:pythonImport("torch.distributed.elastic.multiprocessing.errors.error_handler", "ErrorHandler") extern class ErrorHandler {
	...
	**/
	public function _get_error_file_path():Dynamic;
	public function _rm(my_error_file:Dynamic):Dynamic;
	/**
		Writes error message to the file.
	**/
	public function _write_error_file(file_path:Dynamic, error_msg:Dynamic):Dynamic;
	/**
		Dumps parent error file from child process's root cause error and error code.
	**/
	public function dump_error_file(rootcause_error_file:Dynamic, ?error_code:Dynamic):Dynamic;
	/**
	...
	**/
	public function record_exception(e:Dynamic):Dynamic;
}