...
@:pythonImport("torch.distributed.elastic.metrics.api", "MetricData") extern class MetricData {
	/**
		Return self+value.
	**/
	...
	**/
	...
	/**
		Create new instance of MetricData(timestamp, group_name, name, value)
	**/
	static public function __new__(_cls:Dynamic, timestamp:Dynamic, group_name:Dynamic, name:Dynamic, value:Dynamic):Dynamic;
	/**
		Helper for pickle.
	**/
	...
	**/
	...
	/**
		Make a new MetricData object from a sequence or iterable
	**/
	static public function _make(iterable:Dynamic):Dynamic;
	/**
		Return a new MetricData object replacing specified fields with new values
	**/
