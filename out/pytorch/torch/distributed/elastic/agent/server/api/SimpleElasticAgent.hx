...
@:pythonImport("torch.distributed.elastic.agent.server.api", "SimpleElasticAgent") extern class SimpleElasticAgent {
	...
	**/
	@:native("__init__")
	public function ___init__(spec:Dynamic, ?exit_barrier_timeout:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(spec:Dynamic, ?exit_barrier_timeout:Dynamic):Void;
	/**
