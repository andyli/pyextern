...
@:pythonImport("torch.distributed.elastic.timer.local_timer", "MultiprocessingRequestQueue") extern class MultiprocessingRequestQueue {
	...
	**/
	public function get(size:Dynamic, timeout:Dynamic):Dynamic;
	/**
