...
package torch.distributed.distributed_c10d;
@:pythonImport("torch.distributed.distributed_c10d") extern class Distributed_c10d_Module {
	...
	**/
	...
	static public var _GLOO_AVAILABLE : Dynamic;
	static public var _MPI_AVAILABLE : Dynamic;
	static public var _NCCL_AVAILABLE : Dynamic;
	...
	**/
	...
	static public function _batch_p2p_manager(backend:Dynamic):Dynamic;
	/**
		Helper to check that the ``op`` is either isend or irecv.
	**/
	static public function _check_op(op:Dynamic):Dynamic;
	/**
		Helper to check that the ``p2p_op_list`` is a list of P2POp instances and
		all ops use the same backend.
	**/
	static public function _check_p2p_op_list(p2p_op_list:Dynamic):Dynamic;
	/**
		Helper to check that the parameter ``param_name`` is a single tensor.
	**/
	static public function _check_single_tensor(param:Dynamic, param_name:Dynamic):Dynamic;
	/**
		Helper to check that the parameter ``param_name`` is a list of tensors.
	**/
	static public function _check_tensor_list(param:Dynamic, param_name:Dynamic):Dynamic;
	...
	static public var _default_pg_init_method : Dynamic;
	/**
	...
	**/
	static public function _get_default_store():Dynamic;
	/**
		Helper that gets a given group's global rank from a given local rank in the
		group.
	**/
	static public function _get_global_rank(group:Dynamic, group_rank:Dynamic):Dynamic;
	/**
		Helper that gets a given group's local rank in the group from a given global
		rank.
	**/
	static public function _get_group_rank(group:Dynamic, rank:Dynamic):Dynamic;
	/**
		Helper that gets a given group's world size.
	**/
	static public function _get_group_size(group:Dynamic):Dynamic;
	static public var _group_count : Dynamic;
	/**
	...
	**/
	static public function _new_process_group_helper(world_size:Dynamic, rank:Dynamic, group_ranks:Dynamic, backend:Dynamic, store:Dynamic, ?pg_options:Dynamic, ?group_name:Dynamic, ?timeout:Dynamic):Dynamic;
	static public function _object_to_tensor(obj:Dynamic):Dynamic;
	static public var _pg_group_ranks : Dynamic;
	static public var _pg_map : Dynamic;
	static public var _pg_names : Dynamic;
	/**
	...
	**/
	static public function _store_based_barrier(rank:Dynamic, store:Dynamic, timeout:Dynamic):Dynamic;
	static public function _tensor_to_object(tensor:Dynamic, tensor_size:Dynamic):Dynamic;
	static public function _update_default_pg(pg:Dynamic):Dynamic;
	static public function _validate_output_list_for_rank(my_rank:Dynamic, dst:Dynamic, gather_list:Dynamic):Dynamic;
	/**
