...
@:pythonImport("torch.distributed.algorithms.join", "_JoinConfig") extern class _JoinConfig {
	/**
		Return self+value.
	**/
	...
	**/
	...
	/**
		Create new instance of _JoinConfig(enable, throw_on_early_termination, is_first_joinable)
	**/
	static public function __new__(_cls:Dynamic, enable:Dynamic, throw_on_early_termination:Dynamic, is_first_joinable:Dynamic):Dynamic;
	/**
		Helper for pickle.
	**/
	...
	**/
	...
	/**
		Make a new _JoinConfig object from a sequence or iterable
	**/
	static public function _make(iterable:Dynamic):Dynamic;
	/**
		Return a new _JoinConfig object replacing specified fields with new values
	**/
	...
	/**
		...
		manager.
	**/
	static public function construct_disabled_join_config():Dynamic;
	/**
	...
	**/
	public var is_first_joinable : Dynamic;
	/**
		Alias for field number 1
	**/
	public var throw_on_early_termination : Dynamic;
}