...
@:pythonImport("torch.distributed.nn.functional", "_Broadcast") extern class _Broadcast {
	/**
	...
	**/
	static public function forward(ctx:Dynamic, src:Dynamic, group:Dynamic, tensor:Dynamic):Dynamic;
