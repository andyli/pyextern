...
@:pythonImport("torch.distributed.nn.functional", "_Gather") extern class _Gather {
	/**
	...
	**/
	static public function forward(ctx:Dynamic, dst:Dynamic, group:Dynamic, tensor:Dynamic):Dynamic;
