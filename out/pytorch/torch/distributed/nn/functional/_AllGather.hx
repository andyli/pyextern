...
@:pythonImport("torch.distributed.nn.functional", "_AllGather") extern class _AllGather {
	/**
	...
	**/
	static public function forward(ctx:Dynamic, group:Dynamic, tensor:Dynamic):Dynamic;
