...
@:pythonImport("torch.distributed.nn.functional", "_AlltoAll") extern class _AlltoAll {
	/**
	...
	**/
	static public function forward(ctx:Dynamic, group:Dynamic, ?tensors:python.VarArgs<Dynamic>):Dynamic;
