...
@:pythonImport("torch.distributed.nn.functional", "_Scatter") extern class _Scatter {
	/**
	...
	**/
	static public function forward(ctx:Dynamic, src:Dynamic, group:Dynamic, ?tensors:python.VarArgs<Dynamic>):Dynamic;
