...
@:pythonImport("torch.distributed.nn.functional", "_Reduce") extern class _Reduce {
	/**
	...
	**/
	static public function forward(ctx:Dynamic, src:Dynamic, op:Dynamic, group:Dynamic, tensor:Dynamic):Dynamic;
