...
@:pythonImport("torch.distributed.nn.api.remote_module", "_RemoteModule") extern class _RemoteModule {
	...
	**/
	@:native("__init__")
	public function ___init__(remote_device:Dynamic, module_cls:Dynamic, ?args:Dynamic, ?kwargs:Dynamic, ?_module_interface_cls:Dynamic):Dynamic;
	/**
		A RemoteModule instance can only be created after RPC initialization.
		It creates a user-specified module on a specified remote node.
		It behaves like a regular ``nn.Module`` except that the ``forward`` method is
		...
		Example::
		    ...
		    >>> rpc.shutdown()
	**/
	public function new(remote_device:Dynamic, module_cls:Dynamic, ?args:Dynamic, ?kwargs:Dynamic, ?_module_interface_cls:Dynamic):Void;
	/**
	...
	**/
	public function _check_attribute_picklability():Dynamic;
	/**
	...
	**/
	public function _init_template(module_interface_cls:Dynamic, enable_moving_cpu_tensors_to_cuda:Dynamic):Dynamic;
	public function _install_generated_methods():Dynamic;
	/**
	...
	**/
	public function _prepare_init(remote_device_str:Dynamic):Dynamic;
	/**
	...
	**/
	...
	/**
		...
		pointing to the remote module.
	**/
	public function get_module_rref():Dynamic;
	/**
	...
	**/
	...
	/**
		...
		Returns:
		    ...
		    on the user-provided module on the remote side.
	**/
	static public function init_from_module_rref(remote_device:Dynamic, module_rref:Dynamic, ?_module_interface_cls:Dynamic):Dynamic;
	/**
	...
	**/
	public function remote_parameters(?recurse:Dynamic):Dynamic;
	/**
