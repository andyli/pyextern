...
@:pythonImport("torch.distributed.nn.api.remote_module", "RemoteModule") extern class RemoteModule {
	...
	**/
	@:native("__init__")
	public function ___init__(remote_device:Dynamic, module_cls:Dynamic, ?args:Dynamic, ?kwargs:Dynamic):Dynamic;
	/**
		A RemoteModule instance can only be created after RPC initialization.
		It creates a user-specified module on a specified remote node.
		It behaves like a regular ``nn.Module`` except that the ``forward`` method is
		...
		Example::
		    ...
		    >>> rpc.shutdown()
	**/
	public function new(remote_device:Dynamic, module_cls:Dynamic, ?args:Dynamic, ?kwargs:Dynamic):Void;
	/**
