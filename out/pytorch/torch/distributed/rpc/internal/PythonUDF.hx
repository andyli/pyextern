...
@:pythonImport("torch.distributed.rpc.internal", "PythonUDF") extern class PythonUDF {
	/**
		Return self+value.
	**/
	...
	**/
	...
	/**
		Create new instance of PythonUDF(func, args, kwargs)
	**/
	static public function __new__(_cls:Dynamic, func:Dynamic, args:Dynamic, kwargs:Dynamic):Dynamic;
	/**
		Helper for pickle.
	**/
	...
	**/
	...
	/**
		Make a new PythonUDF object from a sequence or iterable
	**/
	static public function _make(iterable:Dynamic):Dynamic;
	/**
		Return a new PythonUDF object replacing specified fields with new values
	**/
