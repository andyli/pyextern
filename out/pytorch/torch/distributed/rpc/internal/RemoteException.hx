...
@:pythonImport("torch.distributed.rpc.internal", "RemoteException") extern class RemoteException {
	/**
		Return self+value.
	**/
	...
	**/
	...
	/**
		Create new instance of RemoteException(msg, exception_type)
	**/
	static public function __new__(_cls:Dynamic, msg:Dynamic, exception_type:Dynamic):Dynamic;
	/**
		Helper for pickle.
	**/
	...
	**/
	...
	/**
		Make a new RemoteException object from a sequence or iterable
	**/
	static public function _make(iterable:Dynamic):Dynamic;
	/**
		Return a new RemoteException object replacing specified fields with new values
	**/
	...
	**/
	public var exception_type : Dynamic;
	/**
