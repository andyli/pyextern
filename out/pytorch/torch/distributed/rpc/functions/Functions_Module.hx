...
package torch.distributed.rpc.functions;
@:pythonImport("torch.distributed.rpc.functions") extern class Functions_Module {
	...
	/**
		...
		Example::
		    ...
		    >>> print(ret)  # prints tensor([4., 4.])
	**/
	static public function async_execution(fn:Dynamic):Dynamic;
}