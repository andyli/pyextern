...
@:pythonImport("torch.distributed.pipeline.sync.pipe", "WithDevice") extern class WithDevice {
	...
	**/
	@:native("__init__")
	public function ___init__(module:Dynamic, device:Dynamic):Dynamic;
	/**
		Initializes internal Module state, shared by both nn.Module and ScriptModule.
	**/
	public function new(module:Dynamic, device:Dynamic):Void;
	/**
