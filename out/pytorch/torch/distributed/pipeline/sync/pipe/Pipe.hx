...
@:pythonImport("torch.distributed.pipeline.sync.pipe", "Pipe") extern class Pipe {
	...
	**/
	@:native("__init__")
	public function ___init__(module:Dynamic, ?chunks:Dynamic, ?checkpoint:Dynamic, ?deferred_batch_norm:Dynamic):Dynamic;
	/**
		Initializes internal Module state, shared by both nn.Module and ScriptModule.
	**/
	public function new(module:Dynamic, ?chunks:Dynamic, ?checkpoint:Dynamic, ?deferred_batch_norm:Dynamic):Void;
	/**
	...
	**/
	public function _ensure_copy_streams():Dynamic;
	/**
	...
	**/
	public function forward(?inputs:python.VarArgs<Dynamic>):Dynamic;
	/**
