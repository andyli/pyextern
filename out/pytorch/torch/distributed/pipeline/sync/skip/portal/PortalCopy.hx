...
@:pythonImport("torch.distributed.pipeline.sync.skip.portal", "PortalCopy") extern class PortalCopy {
	/**
	...
	**/
	...
	/**
		...
		output.
	**/
	static public function backward(ctx:Dynamic, grad_phony:Dynamic):Dynamic;
	...
	**/
	static public function forward(ctx:Dynamic, portal:Dynamic, prev_stream:Dynamic, next_stream:Dynamic, phony:Dynamic):Dynamic;
