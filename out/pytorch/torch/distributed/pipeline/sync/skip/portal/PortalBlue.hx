...
@:pythonImport("torch.distributed.pipeline.sync.skip.portal", "PortalBlue") extern class PortalBlue {
	/**
	...
	**/
	static public function forward(ctx:Dynamic, portal:Dynamic, tensor:Dynamic):Dynamic;
