...
@:pythonImport("torch.distributed.pipeline.sync.skip.portal", "PortalOrange") extern class PortalOrange {
	/**
	...
	**/
	...
	/**
		...
		output.
	**/
	static public function backward(ctx:Dynamic, grad:Dynamic):Dynamic;
	...
	**/
	static public function forward(ctx:Dynamic, portal:Dynamic, phony:Dynamic):Dynamic;
