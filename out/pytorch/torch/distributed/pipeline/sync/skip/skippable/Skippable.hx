...
@:pythonImport("torch.distributed.pipeline.sync.skip.skippable", "Skippable") extern class Skippable {
	...
	**/
	...
	/**
		...
		module's ``forward()``.
	**/
	public function dispatch(input:Dynamic, handle_stash:Dynamic, handle_pop:Dynamic):Dynamic;
	/**
	...
	**/
	...
	/**
		...
		Returns:
		    this module itself
	**/
	public function isolate(ns:Dynamic, ?only:Dynamic):Dynamic;
	/**
	...
	**/
	public function namespaced(name:Dynamic):Dynamic;
	/**
	...
	**/
	public function poppable():Dynamic;
	/**
	...
	**/
	public function stashable():Dynamic;
	/**
