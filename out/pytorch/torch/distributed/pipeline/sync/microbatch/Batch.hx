...
@:pythonImport("torch.distributed.pipeline.sync.microbatch", "Batch") extern class Batch {
	...
	**/
	...
	public function _setitem_by_index(index:Dynamic, value:Dynamic):Dynamic;
	public function _setitem_by_slice(index:Dynamic, value:Dynamic):Dynamic;
	/**
		Calls a function on the microbatch. It also wraps
		the output with :class:`Batch`.
	**/
	public function call(_function:Dynamic):Dynamic;
	/**
		Retrieves the index of first tensor found.
	**/
	public function find_tensor_idx():Dynamic;
	/**
