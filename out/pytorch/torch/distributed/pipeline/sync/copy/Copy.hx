...
@:pythonImport("torch.distributed.pipeline.sync.copy", "Copy") extern class Copy {
	/**
	...
	**/
	static public function forward(ctx:Dynamic, prev_stream:Dynamic, next_stream:Dynamic, ?input:python.VarArgs<Dynamic>):Dynamic;
