...
@:pythonImport("torch.distributed.pipeline.sync.copy", "Wait") extern class Wait {
	/**
	...
	**/
	...
	/**
		...
		output.
	**/
	static public function backward(ctx:Dynamic, ?grad_input:python.VarArgs<Dynamic>):Dynamic;
