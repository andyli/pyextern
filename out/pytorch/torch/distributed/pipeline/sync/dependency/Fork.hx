...
package torch.distributed.pipeline.sync.dependency;
@:pythonImport("torch.distributed.pipeline.sync.dependency", "Fork") extern class Fork {
	/**
	...
	**/
	...
	/**
		...
		output.
	**/
	static public function backward(ctx:Dynamic, grad_input:Dynamic, grad_grad:Dynamic):Dynamic;
	...
	**/
	static public function forward(ctx:Dynamic, input:Dynamic):Dynamic;
