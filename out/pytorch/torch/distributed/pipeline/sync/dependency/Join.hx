...
@:pythonImport("torch.distributed.pipeline.sync.dependency", "Join") extern class Join {
	/**
	...
	**/
	...
	/**
		...
		output.
	**/
	static public function backward(ctx:Dynamic, grad_input:Dynamic):Dynamic;
	...
	**/
	static public function forward(ctx:Dynamic, input:Dynamic, phony:Dynamic):Dynamic;
