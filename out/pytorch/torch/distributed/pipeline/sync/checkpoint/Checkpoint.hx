...
@:pythonImport("torch.distributed.pipeline.sync.checkpoint", "Checkpoint") extern class Checkpoint {
	/**
	...
	**/
	...
	/**
		...
		output.
	**/
	static public function backward(ctx:Dynamic, ?grad_output:python.VarArgs<Dynamic>):Dynamic;
	...
	**/
	static public function forward(ctx:Dynamic, phony:Dynamic, recomputed:Dynamic, rng_states:Dynamic, _function:Dynamic, input_atomic:Dynamic, ?inputs:python.VarArgs<Dynamic>):Dynamic;
