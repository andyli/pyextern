...
package torch.distributed.pipeline.sync.phony;
@:pythonImport("torch.distributed.pipeline.sync.phony") extern class Phony_Module {
	...
	**/
	...
	static public var _phonies : Dynamic;
	/**
