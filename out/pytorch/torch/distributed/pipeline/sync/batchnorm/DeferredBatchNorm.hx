...
@:pythonImport("torch.distributed.pipeline.sync.batchnorm", "DeferredBatchNorm") extern class DeferredBatchNorm {
	...
	**/
	@:native("__init__")
	public function ___init__(num_features:Dynamic, ?eps:Dynamic, ?momentum:Dynamic, ?affine:Dynamic, ?chunks:Dynamic):Dynamic;
	/**
		Initializes internal Module state, shared by both nn.Module and ScriptModule.
	**/
	public function new(num_features:Dynamic, ?eps:Dynamic, ?momentum:Dynamic, ?affine:Dynamic, ?chunks:Dynamic):Void;
	/**
	...
	**/
	public function _commit():Dynamic;
	/**
	...
	**/
	public function _track(input:Dynamic):Dynamic;
	...
	**/
	static public function convert_deferred_batch_norm(module:Dynamic, ?chunks:Dynamic):Dynamic;
	/**
