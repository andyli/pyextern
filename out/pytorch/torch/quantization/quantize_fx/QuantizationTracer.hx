...
@:pythonImport("torch.quantization.quantize_fx", "QuantizationTracer") extern class QuantizationTracer {
	...
	**/
	@:native("__init__")
	public function ___init__(skipped_module_names:Dynamic, skipped_module_classes:Dynamic):Dynamic;
	/**
		Construct a Tracer object.
		...
		.. note::
		    Backwards-compatibility for this API is guaranteed.
	**/
	public function new(skipped_module_names:Dynamic, skipped_module_classes:Dynamic):Void;
	/**
