...
package torch.quantization.fx.graph_module;
@:pythonImport("torch.quantization.fx.graph_module", "ObservedStandaloneGraphModule") extern class ObservedStandaloneGraphModule {
	...
	**/
	@:native("__init__")
	public function ___init__(root:Dynamic, graph:Dynamic, preserved_attr_names:Dynamic):Dynamic;
	/**
		Construct a GraphModule.
		...
		.. note::
		    Backwards-compatibility for this API is guaranteed.
	**/
	public function new(root:Dynamic, graph:Dynamic, preserved_attr_names:Dynamic):Void;
	/**
