...
@:pythonImport("torch.package.package_exporter", "PackagingError") extern class PackagingError {
	/**
		exception cause
	**/
	...
	**/
	@:native("__init__")
	public function ___init__(dependency_graph:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(dependency_graph:Dynamic):Void;
	/**
