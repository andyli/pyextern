...
@:pythonImport("torch.multiprocessing.reductions", "SharedCache") extern class SharedCache {
	...
	**/
	public function __setitem__(key:Dynamic, storage_ref:Dynamic):Dynamic;
	/**
	...
	**/
	...
	public function free_dead_references():Dynamic;
	/**
