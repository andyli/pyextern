...
@:pythonImport("torch.onnx") extern class Onnx_Module {
	...
	static public var PYTORCH_ONNX_CAFFE2_BUNDLE : Dynamic;
	...
	static public function _optimize_trace(graph:Dynamic, operator_export_type:Dynamic):Dynamic;
	...
	static public var constant_folding_opset_versions : Dynamic;
	/**
	...
	**/
	...
	static public var ir_version : Dynamic;
	/**
		Returns True iff :func:`export` is running in the current thread
	**/
	static public function is_in_onnx_export():Dynamic;
	static public var producer_name : Dynamic;
	static public var producer_version : Dynamic;
	/**
