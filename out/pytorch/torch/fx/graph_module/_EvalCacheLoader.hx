...
@:pythonImport("torch.fx.graph_module", "_EvalCacheLoader") extern class _EvalCacheLoader {
	...
	**/
	...
	public function _get_key():Dynamic;
	/**
	...
	**/
	public function cache(src:Dynamic, globals:Dynamic):Dynamic;
