...
@:pythonImport("torch.fx.graph_module", "GraphModule") extern class GraphModule {
	...
	**/
	@:native("__init__")
	public function ___init__(root:Dynamic, graph:Dynamic, ?class_name:Dynamic):Dynamic;
	/**
		Construct a GraphModule.
		...
		.. note::
		    Backwards-compatibility for this API is guaranteed.
	**/
	public function new(root:Dynamic, graph:Dynamic, ?class_name:Dynamic):Void;
	/**
