...
@:pythonImport("torch.fx.graph", "_PyTreeInfo") extern class _PyTreeInfo {
	/**
		Return self+value.
	**/
	...
	**/
	...
	/**
		Create new instance of _PyTreeInfo(orig_args, in_spec, out_spec)
	**/
	static public function __new__(_cls:Dynamic, orig_args:Dynamic, in_spec:Dynamic, out_spec:Dynamic):Dynamic;
	/**
		Helper for pickle.
	**/
	...
	**/
	...
	/**
		Make a new _PyTreeInfo object from a sequence or iterable
	**/
	static public function _make(iterable:Dynamic):Dynamic;
	/**
		Return a new _PyTreeInfo object replacing specified fields with new values
	**/
	...
	**/
	public var orig_args : Dynamic;
	/**
		Alias for field number 2
	**/
	public var out_spec : Dynamic;
}