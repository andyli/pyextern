...
@:pythonImport("torch.fx.graph", "_CustomBuiltin") extern class _CustomBuiltin {
	/**
		Return self+value.
	**/
	...
	**/
	...
	/**
		Create new instance of _CustomBuiltin(import_str, obj)
	**/
	static public function __new__(_cls:Dynamic, import_str:Dynamic, obj:Dynamic):Dynamic;
	/**
		Helper for pickle.
	**/
	...
	**/
	...
	/**
		Make a new _CustomBuiltin object from a sequence or iterable
	**/
	static public function _make(iterable:Dynamic):Dynamic;
	/**
		Return a new _CustomBuiltin object replacing specified fields with new values
	**/
