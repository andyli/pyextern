...
@:pythonImport("torch.fx.proxy", "ParameterProxy") extern class ParameterProxy {
	...
	**/
	@:native("__init__")
	public function ___init__(tracer:Dynamic, node:Dynamic, name:Dynamic, param:Dynamic):Dynamic;
	/**
		.. note::
		    Backwards-compatibility for this API is guaranteed.
	**/
	public function new(tracer:Dynamic, node:Dynamic, name:Dynamic, param:Dynamic):Void;
	/**
	...
	**/
	...
	public function nelement():Dynamic;
	public function numel():Dynamic;
