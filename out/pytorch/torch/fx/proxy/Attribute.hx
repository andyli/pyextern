...
@:pythonImport("torch.fx.proxy", "Attribute") extern class Attribute {
	...
	**/
	@:native("__init__")
	public function ___init__(root:Dynamic, attr:Dynamic):Dynamic;
	/**
		.. note::
		    Backwards-compatibility for this API is guaranteed.
	**/
	public function new(root:Dynamic, attr:Dynamic):Void;
	/**
