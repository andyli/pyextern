...
@:pythonImport("torch.fx.operator_schemas", "ArgsKwargsPair") extern class ArgsKwargsPair {
	/**
		Return self+value.
	**/
	...
	**/
	...
	/**
		Create new instance of ArgsKwargsPair(args, kwargs)
	**/
	static public function __new__(_cls:Dynamic, args:Dynamic, kwargs:Dynamic):Dynamic;
	/**
		Helper for pickle.
	**/
	...
	**/
	...
	/**
		Make a new ArgsKwargsPair object from a sequence or iterable
	**/
	static public function _make(iterable:Dynamic):Dynamic;
	/**
		Return a new ArgsKwargsPair object replacing specified fields with new values
	**/
