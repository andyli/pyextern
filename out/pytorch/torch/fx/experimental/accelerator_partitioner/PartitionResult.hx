...
@:pythonImport("torch.fx.experimental.accelerator_partitioner", "PartitionResult") extern class PartitionResult {
	/**
		Return self+value.
	**/
	...
	**/
	...
	/**
		Create new instance of PartitionResult(dag, module_with_submodules)
	**/
	static public function __new__(_cls:Dynamic, dag:Dynamic, module_with_submodules:Dynamic):Dynamic;
	/**
		Helper for pickle.
	**/
	...
	**/
	...
	/**
		Make a new PartitionResult object from a sequence or iterable
	**/
	static public function _make(iterable:Dynamic):Dynamic;
	/**
		Return a new PartitionResult object replacing specified fields with new values
	**/
	...
	**/
	public var module_with_submodules : Dynamic;
}