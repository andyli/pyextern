...
@:pythonImport("torch.fx.experimental.normalize", "NormalizeArgs") extern class NormalizeArgs {
	...
	**/
	@:native("__init__")
	public function ___init__(module:Dynamic, ?normalize_to_only_use_kwargs:Dynamic):Dynamic;
	/**
		.. note::
		    Backwards-compatibility for this API is guaranteed.
	**/
	public function new(module:Dynamic, ?normalize_to_only_use_kwargs:Dynamic):Void;
	/**
	...
	**/
	...
	/**
		.. note::
		    Backwards-compatibility for this API is guaranteed.
	**/
	public function call_function(target:Dynamic, args:Dynamic, kwargs:Dynamic, ?arg_types:Dynamic, ?kwarg_types:Dynamic):Dynamic;
	/**
