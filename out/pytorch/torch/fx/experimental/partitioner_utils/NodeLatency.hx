...
@:pythonImport("torch.fx.experimental.partitioner_utils", "NodeLatency") extern class NodeLatency {
	/**
		Return self+value.
	**/
	...
	**/
	...
	/**
		Create new instance of NodeLatency(mem_latency_sec, computer_latency_sec)
	**/
	static public function __new__(_cls:Dynamic, mem_latency_sec:Dynamic, computer_latency_sec:Dynamic):Dynamic;
	/**
		Helper for pickle.
	**/
	...
	**/
	...
	/**
		Make a new NodeLatency object from a sequence or iterable
	**/
	static public function _make(iterable:Dynamic):Dynamic;
	/**
		Return a new NodeLatency object replacing specified fields with new values
	**/
