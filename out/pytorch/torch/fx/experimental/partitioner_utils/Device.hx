...
@:pythonImport("torch.fx.experimental.partitioner_utils", "Device") extern class Device {
	/**
		Return self+value.
	**/
	...
	**/
	...
	/**
		Create new instance of Device(name, available_mem_bytes, logical_id)
	**/
	static public function __new__(_cls:Dynamic, name:Dynamic, available_mem_bytes:Dynamic, logical_id:Dynamic):Dynamic;
	/**
		Helper for pickle.
	**/
	...
	**/
	...
	/**
		Make a new Device object from a sequence or iterable
	**/
	static public function _make(iterable:Dynamic):Dynamic;
	/**
		Return a new Device object replacing specified fields with new values
	**/
	public function _replace(?kwds:python.KwArgs<Dynamic>):Dynamic;
	/**
		Alias for field number 1
	**/
	public var available_mem_bytes : Dynamic;
	/**
