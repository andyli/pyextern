...
@:pythonImport("torch.fx.experimental.const_fold", "FoldedGraphModule") extern class FoldedGraphModule {
	...
	**/
	@:native("__init__")
	public function ___init__(root:Dynamic, graph:Dynamic, ?const_subgraph:Dynamic, ?const_output_names:Dynamic):Dynamic;
	/**
		Construct a GraphModule.
		...
		.. note::
		    Backwards-compatibility for this API is guaranteed.
	**/
	public function new(root:Dynamic, graph:Dynamic, ?const_subgraph:Dynamic, ?const_output_names:Dynamic):Void;
	/**
	...
	**/
	...
	public function __reduce_deploy__(importer:Dynamic):Dynamic;
	/**
		Helper for pickle.
	**/
	...
	**/
	...
	/**
		...
		.. note::
		    Backwards-compatibility for this API is guaranteed.
	**/
	public function add_submodule(target:Dynamic, m:Dynamic):Dynamic;
	/**
	...
	**/
	...
	/**
		...
		.. note::
		    Backwards-compatibility for this API is guaranteed.
	**/
	public function delete_all_unused_submodules():Dynamic;
	/**
		...
		.. note::
		    Backwards-compatibility for this API is guaranteed.
	**/
	public function delete_submodule(target:Dynamic):Dynamic;
	/**
	...
	**/
	...
	/**
		...
		.. note::
		    Backwards-compatibility for this API is guaranteed.
	**/
	public function recompile():Dynamic;
	/**
	...
	**/
	...
	public function run_folding():Dynamic;
	/**
	...
	**/
	public function to_folder(folder:Dynamic, ?module_name:Dynamic):Dynamic;
	/**
