...
@:pythonImport("torch.fx.experimental.fx_acc.acc_tracer", "AccRewritingTracer") extern class AccRewritingTracer {
	static public var DEFAULT_LEAF_MODULE_LIST : Dynamic;
	...
	**/
	...
	/**
		...
		.. note::
		    Backwards-compatibility for this API is guaranteed.
	**/
	public function is_leaf_module(m:Dynamic, mod_qual_name:Dynamic):Dynamic;
	/**
	...
	**/
	...
	/**
		...
		.. note::
		    Backwards-compatibility for this API is guaranteed.
	**/
	public function trace(root:Dynamic, ?concrete_args:Dynamic, ?ast_rewriter_allow_list:Dynamic, ?leaf_module_list:Dynamic):Dynamic;
}