...
@:pythonImport("torch.fx.experimental.fx_acc.acc_tracer", "ConditionalExceptionWrapper") extern class ConditionalExceptionWrapper {
	...
	**/
	@:native("__init__")
	public function ___init__(exc:Dynamic):Dynamic;
	/**
		Initializes internal Module state, shared by both nn.Module and ScriptModule.
	**/
	public function new(exc:Dynamic):Void;
	/**
	...
	**/
	...
	static public var _is_impure : Dynamic;
	/**
	...
	**/
	public function forward(cond:Dynamic, msg:Dynamic):Dynamic;
	/**
