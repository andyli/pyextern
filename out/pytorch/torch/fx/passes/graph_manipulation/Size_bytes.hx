...
@:pythonImport("torch.fx.passes.graph_manipulation", "size_bytes") extern class Size_bytes {
	/**
		Return self+value.
	**/
	...
	**/
	...
	/**
		Create new instance of size_bytes(output_size, total_size)
	**/
	static public function __new__(_cls:Dynamic, output_size:Dynamic, total_size:Dynamic):Dynamic;
	/**
		Helper for pickle.
	**/
	...
	**/
	...
	/**
		Make a new size_bytes object from a sequence or iterable
	**/
	static public function _make(iterable:Dynamic):Dynamic;
	/**
		Return a new size_bytes object replacing specified fields with new values
	**/
