...
@:pythonImport("torch.fx.passes.splitter_base", "FxNetAccNodesFinder") extern class FxNetAccNodesFinder {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(module:Dynamic, operator_support:Dynamic, allow_non_tensor:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(module:Dynamic, operator_support:Dynamic, allow_non_tensor:Dynamic):Void;
	/**
	...
	**/
	public function reduce_acc_nodes_non_tensor_input():Dynamic;
	/**
	...
	**/
	public function reduce_acc_nodes_non_tensor_input_helper(cpu_worklist:Dynamic):Dynamic;
	/**
		Excludes nodes from ACC supported set that produce non-tensor
		outputs and have downstream CPU nodes.
	**/
	public function reduce_acc_nodes_non_tensor_output():Dynamic;
}