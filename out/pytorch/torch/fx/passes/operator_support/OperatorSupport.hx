...
@:pythonImport("torch.fx.passes.operator_support", "OperatorSupport") extern class OperatorSupport {
	...
	**/
	...
	static public var _support_dict : Dynamic;
	/**
		Args:
	...
	**/
	public function is_node_supported(submodules:Dynamic, node:Dynamic):Dynamic;
}