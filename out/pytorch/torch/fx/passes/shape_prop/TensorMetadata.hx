...
package torch.fx.passes.shape_prop;
@:pythonImport("torch.fx.passes.shape_prop", "TensorMetadata") extern class TensorMetadata {
	/**
		Return self+value.
	**/
	...
	**/
	...
	/**
		Create new instance of TensorMetadata(shape, dtype, requires_grad, stride, memory_format, is_quantized, qscheme, q_scale, q_zero_point)
	**/
	static public function __new__(_cls:Dynamic, shape:Dynamic, dtype:Dynamic, requires_grad:Dynamic, stride:Dynamic, memory_format:Dynamic, is_quantized:Dynamic, qscheme:Dynamic, q_scale:Dynamic, q_zero_point:Dynamic):Dynamic;
	/**
		Helper for pickle.
	**/
	...
	**/
	public var memory_format : Dynamic;
	/**
		Alias for field number 7
	**/
	public var q_scale : Dynamic;
	/**
		Alias for field number 8
	**/
	public var q_zero_point : Dynamic;
	/**
		Alias for field number 6
	**/
	public var qscheme : Dynamic;
	/**
