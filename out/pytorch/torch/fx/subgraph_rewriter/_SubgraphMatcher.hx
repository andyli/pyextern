...
@:pythonImport("torch.fx.subgraph_rewriter", "_SubgraphMatcher") extern class _SubgraphMatcher {
	...
	**/
	...
	public function _match_nodes(pn:Dynamic, gn:Dynamic):Dynamic;
	/**
	...
	**/
	public function matches_subgraph_from_anchor(anchor:Dynamic):Dynamic;
}