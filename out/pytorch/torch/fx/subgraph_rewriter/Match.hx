...
@:pythonImport("torch.fx.subgraph_rewriter", "Match") extern class Match {
	/**
		Return self+value.
	**/
	...
	**/
	...
	/**
		Create new instance of Match(anchor, nodes_map)
	**/
	static public function __new__(_cls:Dynamic, anchor:Dynamic, nodes_map:Dynamic):Dynamic;
	/**
		Helper for pickle.
	**/
