...
package inspect;
@:pythonImport("inspect", "ClosureVars") extern class ClosureVars {
	/**
		Return self+value.
	**/
	...
	**/
	static public function __new__(_cls:Dynamic, nonlocals:Dynamic, globals:Dynamic, builtins:Dynamic, unbound:Dynamic):Dynamic;
	/**
		helper for pickle
	**/
	...
	**/
	static public var builtins : Dynamic;
	/**
	...
	**/
	static public var globals : Dynamic;
	/**
	...
	**/
	static public var nonlocals : Dynamic;
	/**
		Alias for field number 3
	**/
	static public var unbound : Dynamic;
}