...
package inspect;
@:pythonImport("inspect", "Traceback") extern class Traceback {
	/**
		Return self+value.
	**/
	...
	**/
	static public function __new__(_cls:Dynamic, filename:Dynamic, lineno:Dynamic, _function:Dynamic, code_context:Dynamic, index:Dynamic):Dynamic;
	/**
		helper for pickle
	**/
