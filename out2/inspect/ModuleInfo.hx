...
package inspect;
@:pythonImport("inspect", "ModuleInfo") extern class ModuleInfo {
	/**
		Return self+value.
	**/
	...
	**/
	static public function __new__(_cls:Dynamic, name:Dynamic, suffix:Dynamic, mode:Dynamic, module_type:Dynamic):Dynamic;
	/**
		helper for pickle
	**/
	...
	**/
	static public var module_type : Dynamic;
	/**
